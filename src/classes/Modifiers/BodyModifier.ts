...
export default class BodyModifier {
    public static displayModThickness(character: Character, goal: number, strength: number = 1): string {
    ...
    public static displayModTone(character: Character, goal: number, strength: number = 1): string {
    ...
    public static displayModFem(character: Character, goal: number, strength: number = 1): string {
        let output: string = "";
        ...
        if (!character.perks.has(PerkType.Androgyny))
            BodyModifier.displayFixFemininity(character);
    ...
    public static displayFixFemininity(character: Character): string {
        let output: string = "";
    ...
    public static displayGoIntoHeat(character: Character, intensity: number = 1) {
    ...
    // Second parameter: intensity, an integer multiplier that can increase the
    // duration and intensity. Defaults to 1.
    public static displayGoIntoRut(character: Character, intensity: number = 1) {
