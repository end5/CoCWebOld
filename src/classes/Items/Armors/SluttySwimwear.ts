	...
	public useText():void { //Produces any text seen when equipping the armor normally
		...
		if (player.totalCocks() == 0) {
			...
			if (player.lowerBody.balls > 0) {
				if (player.lowerBody.ballSize > 5) outputText("You do your best to put the thong on, and while the material is very stretchy, it simply can't even begin to cover everything, and your " + player.ballsDescriptLight() + " hang on the sides, exposed.  Maybe if you shrunk your male parts down a little...");
