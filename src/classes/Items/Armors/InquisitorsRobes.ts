...
export default class InquisitorsRobes extends ArmorWithPerk {
	...
	public useText():void {
		...
		MainScreen.text("To finish the look, you take the two fingerless alchemical gloves and slide them over your hands.  What seems to be a prayer is embroidered in gold on their back.\n\n");
		MainScreen.text("You feel pious.\n\n\n\n(<b>Perk Gained - Blood Mage</b>: Spells consume HP (minimum 5) instead of fatigue!)\n\n");
	}
}
