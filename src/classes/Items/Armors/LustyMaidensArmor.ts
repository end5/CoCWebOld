...
export default class LustyMaidensArmor extends Armor {
    ...
    public canUse(player: Player): boolean {
        ...
        player.stats.lustResisted = true;
        player.stats.bimboIntReduction = false;
        ...
        if (player.lowerBody.vaginaSpot.list[0].vaginalWetness >= 3)
    ...
    public lustyMaidenPaizuri(player: Player = null, monster: Monster = null): void {
        ...
        if (monster.type == MonsterType.Minotaur || monster.type == MonsterType.MinotaurMob)
