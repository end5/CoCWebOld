...
export default class LustyMaidensArmor extends Armor {
    ...
    public canUse(player: Player): boolean {
        ...
        player.stats.lustChange(25, true);
    ...
    public lustyMaidenPaizuri(player: Player = null, monster: Character = null): void {
        ...
        MainScreen.text("\n\n" + monster.capitalA + monster.desc.short + " nods solemnly while " + monster.desc.possessivePronoun + " eyes half-cross from pleasure.  You bottom out around " + monster.desc.possessivePronoun + " base");
        ...
        MainScreen.text("\n\n" + monster.capitalA + monster.desc.short + " groans and shakes");
        ...
        if (monster.charType == PlayerType.Minotaur || monster.charType == PlayerType.MinotaurMob)
