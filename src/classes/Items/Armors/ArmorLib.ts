...
export default class ArmorLib extends ConstantLibrary<Armor> {
    public constructor() {
        super();
        this.add(ArmorName.ComfortUndercloth, new GenericArmor(ArmorName.ComfortUndercloth, new ItemDesc("c.under", "comfortable underclothes", "comfortable underclothes"), "comfortable underclothes", 0, 0, ""));

        this.add(ArmorName.GreenClothes, new GenericArmor(
        ...
        this.add(ArmorName.LongDress, new GenericArmor(
            ArmorName.LongDress,
        ...
        this.add(ArmorName.BeeArmor, new GenericArmor(
            ArmorName.BeeArmor,
        ...
        this.add(ArmorName.BimboSkirt, new GenericArmorWithPerk(
        ...
        this.add(ArmorName.BondageStraps, new GenericArmorWithPerk(
        ...
        this.add(ArmorName.ComfortClothes, new ComfortableClothes());
        this.add(ArmorName.ChainmailBikini, new GenericArmorWithPerk(
        ...
        this.add(ArmorName.SuitClothes, new GenericArmor(
        ...
        this.add(ArmorName.FullChainmail, new GenericArmor(
        ...
        this.add(ArmorName.FullPlatemail, new GenericArmor(
        ...
        this.add(ArmorName.GelArmor, new GenericArmor(
            ArmorName.GelArmor,
        ...
        this.add(ArmorName.GooArmor, new GooArmor());
        this.add(ArmorName.InquisitorsCorset, new InquisitorsCorset());
        this.add(ArmorName.InquisitorsRobes, new InquisitorsRobes());
        this.add(ArmorName.IndecentSteelArmor, new GenericArmorWithPerk(
        ...
        this.add(ArmorName.LeatherArmor, new GenericArmor(
        ...
        this.add(ArmorName.LeatherArmorSegments, new LeatherArmorSegments());
        this.add(ArmorName.LustyMaidensArmor, new LustyMaidensArmor());
        this.add(ArmorName.TightLeatherPants, new GenericArmor(
        ...
        this.add(ArmorName.LeatherRobes, new GenericArmor(
        ...
        this.add(ArmorName.ModestRobes, new GenericArmor(
        ...
        this.add(ArmorName.NurseOutfit, new GenericArmorWithPerk(
        ...
        this.add(ArmorName.Overalls, new GenericArmor(
            ArmorName.Overalls,
        ...
        this.add(ArmorName.RedBodysuit, new GenericArmor(
        ...
        this.add(ArmorName.RubberFetishClothes, new GenericArmorWithPerk(
        ...
        this.add(ArmorName.SluttySwimwear, new SluttySwimwear());
        this.add(ArmorName.Scalemail, new GenericArmor(
            ArmorName.Scalemail,
        ...
        this.add(ArmorName.SeductiveArmor, new SeductiveArmor());
        this.add(ArmorName.SpidersilkRobes, new GenericArmorWithPerk(
        ...
        this.add(ArmorName.SpidersilkArmor, new GenericArmor(
        ...
        this.add(ArmorName.SemiTransBodysuit, new GenericArmorWithPerk(
        ...
        this.add(ArmorName.TubeTop, new GenericArmor(
            ArmorName.TubeTop,
        ...
        this.add(ArmorName.WizardRobes, new GenericArmorWithPerk(
