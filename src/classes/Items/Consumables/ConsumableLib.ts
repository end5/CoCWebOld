...
export default class ConsumableLib extends Library<Consumable>
{
    ...
    public constructor() {
        ...
        this.add(new Consumable("B.Gossr", "B.Gossr", "a bundle of black, gossamer webbing", 0, "These strands of gooey black gossamer seem quite unlike the normal silk that driders produce.  It smells sweet and is clearly edible, but who knows what it might do to you?", Utils.curry(m.sweetGossamer, 1));
        ...
        this.add(new Consumable("S.Gossr", "S.Gossr", "a bundle of pink, gossamer webbing", 0, "These strands of gooey pink gossamer seem quite unlike the normal silk that spider-morphs produce.  It smells sweet and is clearly edible, but who knows what it might do to you?", Utils.curry(m.sweetGossamer, 0));
