    ...
    public use(character: Character) {
        ...
        if (character.torso.cocks.count > 0) {
            ...
            if (character.torso.cocks.get(0).length < 12) {
                const growthAmount = CockModifier.growCock(character, character.torso.cocks.get(0), Utils.rand(2) + 2);
                DisplayText("\n\n");
            ...
            // Shrinkage!
            if (Utils.rand(2) === 0 && character.tallness > 42) {
                ...
                character.tallness -= 1 + Utils.rand(3);
            }
            // Red skin!
            if (Utils.rand(30) === 0 && character.skin.tone !== "red") {
                if (character.skin.type === SkinType.FUR) DisplayText("\n\nUnderneath your fur, your skin ");
                else DisplayText("\n\nYour " + character.skin.desc + " ");
                if (Utils.rand(2) === 0) character.skin.tone = "red";
