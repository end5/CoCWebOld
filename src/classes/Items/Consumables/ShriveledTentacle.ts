...
export default class ShriveledTentacle extends Consumable {
    ...
    public use(character: Character) {
        ...
        if (Utils.rand(3) === 0 && character.stats.tou < 50 && changes < changeLimit) {
        ...
        // - speed down
        if (Utils.rand(3) === 0 && character.stats.spe > 40 && changes < changeLimit) {
        ...
        if (Utils.rand(3) === 0 && character.stats.cor < 20 && changes < changeLimit) {
        ...
        if (Utils.rand(4) === 0 && changes < changeLimit && character.torso.tails.reduce(Tail.HasType(TailType.BEE_ABDOMEN), false)) {
        ...
        if (Utils.rand(4) === 0 && (character.torso.wings.type === WingType.BEE_LIKE_SMALL || character.torso.wings.type === WingType.BEE_LIKE_LARGE) && changes < changeLimit) {
        ...
        if (character.torso.neck.gills && character.torso.neck.head.hair.type !== 4 && changes < changeLimit && Utils.rand(5) === 0) {
        ...
        if (Utils.rand(5) === 0 && !character.torso.neck.gills && character.skin.tone === "aphotic blue-black" && changes < changeLimit) {
        ...
        if (Utils.rand(5) === 0 && changes < changeLimit && character.skin.tone !== "aphotic blue-black") {
