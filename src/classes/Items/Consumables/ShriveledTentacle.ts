...
export default class ShriveledTentacle extends Consumable {
    ...
    public use(player: Player) {
        DisplayText.clear();
        DisplayText.text("You chew on the rubbery tentacle; its texture and taste are somewhat comparable to squid, but the half-dormant nematocysts cause your mouth to tingle sensitively.");
