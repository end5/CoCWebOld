    ...
    public use(character: Character) {
        ...
        switch (this.phoukaWhiskeyDrink(character)) {
            case 0: // Character isn't pregnant
                ...
                character.stats.cor += Utils.rand(2) + 1; // These gains are permanent
                character.stats.lust += Utils.rand(8) + 1;
                break;
        ...
        Flags.list[FlagEnum.PREGNANCY_CORRUPTION]++; // Faerie or phouka babies become more corrupted, no effect if the character is not pregnant or on other types of babies
