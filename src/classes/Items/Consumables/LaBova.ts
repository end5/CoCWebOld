...
export default class LaBova extends Consumable {
    ...
    public use(player: Player) {
        ...
        if (this.tainted && !player.torso.tails.reduce(Tail.HasType(TailType.COW), false) && changes < changeLimit && Utils.rand(3) === 0) {
        ...
        if (this.tainted && player.torso.neck.head.ears.type !== EarType.COW && changes < changeLimit && Utils.rand(4) === 0 && player.torso.tails.reduce(Tail.HasType(TailType.COW), false)) {
