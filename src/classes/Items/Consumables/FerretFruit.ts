...
export default class FerretFruit extends Consumable {
    ...
    public use(player: Player) {
        ...
        if (player.torso.neck.head.face.type === FaceType.FERRET_MASK && player.skin.type === SkinType.FUR && player.torso.neck.head.ears.type === EarType.FERRET && player.torso.tails.reduce(Tail.HasType(TailType.FERRET), false) && player.torso.hips.legs.type === LegType.FERRET && Utils.rand(4) === 0 && changes < changeLimit) {
        ...
        if (player.skin.type !== SkinType.FUR && player.torso.neck.head.ears.type === EarType.FERRET && player.torso.tails.reduce(Tail.HasType(TailType.FERRET), false) && player.torso.hips.legs.type === LegType.FERRET && Utils.rand(4) === 0 && changes < changeLimit) {
        ...
        // Tail TFs!
        if (!player.torso.tails.reduce(Tail.HasType(TailType.FERRET), false) && player.torso.neck.head.ears.type === EarType.FERRET && Utils.rand(3) === 0 && changes < changeLimit) {
        ...
        if (player.torso.hips.legs.type !== LegType.FERRET && player.torso.neck.head.ears.type === EarType.FERRET && player.torso.tails.reduce(Tail.HasType(TailType.FERRET), false) && Utils.rand(4) === 0 && changes < changeLimit) {
