    ...
    public use(character: Character) {
        ...
        if (RaceScore.ferretScore(character) >= 6) {
            ...
            if (Flags.list[FlagEnum.FERRET_BAD_END_WARNING] === 0) {
                ...
                character.stats.int -= 5 + Utils.rand(3);
        ...
        // - + Thin:
        if (character.thickness > 15 && changes < changeLimit && Utils.rand(3) === 0) {
        ...
        if (((cocks.count <= 0 && character.torso.hips.rating > 6) || (cocks.count > 0 && character.torso.hips.rating > 4)) && Utils.rand(3) === 0 && changes < changeLimit) {
        ...
        if (character.torso.butt.rating >= 8 && Utils.rand(3) === 0 && changes < changeLimit) {
        ...
        // If the PC has gills:
        if (character.torso.neck.gills && Utils.rand(4) === 0 && changes < changeLimit) {
        ...
        if (character.torso.neck.head.hair.type === HairType.ANEMONE && Utils.rand(4) === 0 && changes < changeLimit) {
        ...
        if (character.torso.neck.head.hair.type === HairType.GOO && Utils.rand(3) === 0 && changes < changeLimit) {
        ...
        if (character.torso.neck.head.face.eyes.type === EyeType.FOUR_SPIDER_EYES && Utils.rand(3) === 0 && changes < changeLimit) {
        ...
        if (character.torso.neck.head.face.type === FaceType.FERRET_MASK && character.skin.type === SkinType.FUR && character.torso.neck.head.ears.type === EarType.FERRET && character.torso.tails.reduce(Tail.HasType(TailType.FERRET), false) && character.torso.hips.legs.type === LegType.FERRET && Utils.rand(4) === 0 && changes < changeLimit) {
        ...
        // If face is human:
        if (character.torso.neck.head.face.type === 0 && Utils.rand(3) === 0 && changes < changeLimit) {
        ...
        if (character.torso.neck.head.face.type !== FaceType.HUMAN && character.torso.neck.head.face.type !== FaceType.FERRET_MASK && character.torso.neck.head.face.type !== FaceType.FERRET && Utils.rand(3) === 0 && changes < changeLimit) {
        ...
        if (character.skin.type !== SkinType.FUR && character.torso.neck.head.ears.type === EarType.FERRET && character.torso.tails.reduce(Tail.HasType(TailType.FERRET), false) && character.torso.hips.legs.type === LegType.FERRET && Utils.rand(4) === 0 && changes < changeLimit) {
            ...
            if (character.torso.neck.head.hair.color !== "sandy brown" && character.torso.neck.head.hair.color !== "silver" && character.torso.neck.head.hair.color !== "white" && character.torso.neck.head.hair.color !== "brown") {
                ...
                if (Utils.rand(4) === 0) character.torso.neck.head.hair.color = "sandy brown";
                else if (Utils.rand(3) === 0) character.torso.neck.head.hair.color = "silver";
                else if (Utils.rand(2) === 0) character.torso.neck.head.hair.color = "white";
        ...
        // Tail TFs!
        if (!character.torso.tails.reduce(Tail.HasType(TailType.FERRET), false) && character.torso.neck.head.ears.type === EarType.FERRET && Utils.rand(3) === 0 && changes < changeLimit) {
        ...
        else if (character.torso.hips.legs.isNaga() && character.torso.neck.head.ears.type === EarType.FERRET && Utils.rand(4) === 0 && changes < changeLimit) {
        ...
        if (character.torso.hips.legs.type !== LegType.FERRET && character.torso.neck.head.ears.type === EarType.FERRET && character.torso.tails.reduce(Tail.HasType(TailType.FERRET), false) && Utils.rand(4) === 0 && changes < changeLimit) {
        ...
        if (character.torso.neck.head.ears.type !== EarType.FERRET && Utils.rand(4) === 0 && changes < changeLimit && Utils.rand(2.5) === 0 && changes < changeLimit) {
