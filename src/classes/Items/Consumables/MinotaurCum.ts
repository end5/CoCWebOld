...
export default class MinotaurCum extends Consumable {
    ...
    public use(character: Character) {
        ...
        if (!Game.inCombat && Utils.rand(10) === 1) {
            ...
            character.stats.lust += Utils.rand(5) + character.stats.cor / 20 + Flags.list[FlagEnum.MINOTAUR_CUM_ADDICTION_TRACKER] / 5;
        }
        ...
        if (character.perks.has(PerkType.MinotaurCumAddict) && Flags.list[FlagEnum.MINOTAUR_CUM_REALLY_ADDICTED_STATE] <= 0) {
