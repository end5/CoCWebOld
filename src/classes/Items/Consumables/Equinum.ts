...
export default class Equinum extends Consumable {
    public constructor() {
        super("Equinum", "Equinum", "a vial of Equinum", 0, "This is a long flared vial with a small label that reads, \"<i>Equinum</i>\".  It is likely this potion is tied to horses in some way.");
    }
