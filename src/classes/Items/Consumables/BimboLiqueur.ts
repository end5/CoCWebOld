    ...
    public use(character: Character) {
        if (character.perks.has(PerkType.BroBody)) {
            ...
            if (character.torso.neck.head.hair.color !== "platinum blonde") {
                ...
                DisplayText("  You grab a lock of the silken stUtils.rands and watch open-mouthed while streaks so blonde they're almost white flow down the " + character.torso.neck.head.hair.color + " hair.  It goes faster and faster until your hair has changed into perfectly bimbo-blonde, flowing locks.\n\n");
            ...
            if (character.torso.chest.get(0).rating < 10) {
                character.torso.chest.get(0).rating += 5 + Utils.rand(5);
