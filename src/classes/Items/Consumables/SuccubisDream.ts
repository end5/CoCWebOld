...
export default class SuccubisDream extends Consumable {
    public constructor() {
        super("S.Dream", "S.Dream", "a bottle of 'Succubus' Dream'", 0, "This precious fluid is often given to men a succubus intends to play with for a long time, though this batch has been enhanced by Lumi to have even greater potency.");
    }
