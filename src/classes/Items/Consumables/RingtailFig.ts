    ...
    public use(player: Player) {
        ...
        if (player.upperBody.head.earType == EarType.RACCOON && player.lowerBody.type != LowerBodyType.RACCOON && changes < changeLimit && Utils.rand(4) == 0) {
            ...
            //from hooves or hard feet, including centaurs and bees
                ...
                if (player.lowerBody.type == LowerBodyType.HOOFED || player.lowerBody.type == LowerBodyType.CENTAUR || player.lowerBody.type == LowerBodyType.PONY) MainScreen.text("pops right out of its hoof just in time");
