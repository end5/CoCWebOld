...
export default class WetCloth extends Consumable {
    ...
    public use(character: Character) {
        ...
        if (character.skin.adj === "slimy" && character.skin.desc === "skin" && character.torso.hips.legs.type !== LegType.GOO) {
            ...
            character.tallness -= 3 + Utils.rand(2);
        ...
        else if (character.tallness < 100 && Utils.rand(3) <= 1) {
        ...
        if (Utils.rand(2) === 0) DisplayText(BodyModifier.displayModFem(character, 85, 3));
        if (Utils.rand(2) === 0) DisplayText(BodyModifier.displayModThickness(character, 20, 3));
        if (Utils.rand(2) === 0) DisplayText(BodyModifier.displayModTone(character, 15, 5));
    }
}
