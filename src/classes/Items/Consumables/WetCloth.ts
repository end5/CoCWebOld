...
export default class WetCloth extends Consumable {
    ...
    public use(player: Player) {
        ...
        if (player.upperBody.head.hairType == 3 && (player.skinDesc != "skin" || player.skinAdj != "slimy")) {
            if (player.skinType == SkinType.PLAIN) MainScreen.text("\n\nYou sigh, feeling your " + player.inventory.armor.displayName + " sink into you as your skin becomes less solid, gooey even.  You realize your entire body has become semi-solid and partly liquid!", false);
            else if (player.skinType == SkinType.FUR) MainScreen.text("\n\nYou sigh, suddenly feeling your fur become hot and wet.  You look down as your " + player.inventory.armor.displayName + " sinks partway into you.  With a start you realize your fur has melted away, melding into the slime-like coating that now serves as your skin.  You've become partly liquid and incredibly gooey!", false);
            else if (player.skinType == SkinType.SCALES) MainScreen.text("\n\nYou sigh, feeling slippery wetness over your scales.  You reach to scratch it and come away with a slippery wet coating.  Your scales have transformed into a slimy goop!  Looking closer, you realize your entire body has become far more liquid in nature, and is semi-solid.  Your " + player.inventory.armor.displayName + " has even sunk partway into you.", false);
            else if (player.skinType > SkinType.GOO) MainScreen.text("\n\nYou sigh, feeling your " + player.inventory.armor.displayName + " sink into you as your " + player.skinDesc + " becomes less solid, gooey even.  You realize your entire body has become semi-solid and partly liquid!", false);
