...
export default class Eggs extends Consumable {
    ...
    private purpleEgg(player: Player): void {
        ...
        if (!this.large || player.torso.hips.rating > 20) {
            DisplayText("You stumble as you feel your " + LowerBodyDescriptor.describeHips(player) + " widen, altering your gait slightly.");
    ...
    private blueEgg(player: Player): void {
        ...
        // LARGE
            ...
            if (player.torso.hips.rating > 5) {
                DisplayText("Feeling the sudden burning of lactic acid in your " + LowerBodyDescriptor.describeHips(player) + ", you realize they have slimmed down and firmed up some.");
