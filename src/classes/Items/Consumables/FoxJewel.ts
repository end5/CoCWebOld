...
export default class FoxJewel extends Consumable {
    ...
    public use(player: Player) {
        ...
        if (player.lowerBody.vaginaSpot.hasVagina() && ((this.mystic && Utils.rand(2) == 0) || (!this.mystic && Utils.rand(3) == 0)) && player.statusAffects.get("BonusVCapacity").value1 < 200 && changes < changeLimit) {
        ...
        //[Vag of Holding] - rare effect, only if PC has high vaginal looseness
        else if (player.lowerBody.vaginaSpot.hasVagina() && ((this.mystic) || (!this.mystic && Utils.rand(5) == 0)) && player.statusAffects.get("BonusVCapacity").value1 >= 200 && player.statusAffects.get("BonusVCapacity").value1 < 8000 && changes < changeLimit) {
            ...
            if (Game.silly()) MainScreen.text("  <b>Your vagina has become a universe unto itself, capable of accepting colossal insertions beyond the scope of human comprehension!</b>");
            ...
            player.statusAffects.get("BonusVCapacity").value1 = 8000;
            changes++;
        }
        ...
        //[Grow 9th tail and gain Corrupted Nine-tails perk]
            ...
            player.perks.add(new Perk("CorruptedNinetails", 0, 0, 0, 0));
            player.stats.lib += 2;
            player.stats.lust += 10;
            player.stats.cor += 10;
