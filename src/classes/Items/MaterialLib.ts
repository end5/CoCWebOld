...
export default class MaterialLib extends Library<Material>
{
    public constructor() {
        super();
        this.add(new Material("B.Chitn", "B.Chitn", "a large shard of chitinous plating", 6,
        ...
        this.add(new Material("GldStat", "GldStat", "a golden statue", 600,
		    ...
		    Game.sceneManager.area.forest.kitsuneScene.kitsuneStatue()));
        this.add(new Material("GreenGl", "GreenGl", "a clump of green gel", 6,
        ...
        this.add(new Material("T.SSilk", "T.SSilk", "a bundle of tough spider-silk", 6,
