...
export default class WeaponLib extends Dictionary<Weapon> {
    public constructor() {
        ...
        this.set(WeaponName.UrtaHalberd, new Weapon(WeaponName.UrtaHalberd, new ItemDesc("UrtaHlb", "a halberd"), "halberd", "slash", 11, 10, "Large"));
        this.set(WeaponName.HookedGauntlet, new Weapon(WeaponName.HookedGauntlet, new ItemDesc("H.Gaunt", "a set of hooked gauntlets", "These metal gauntlets are covered in nasty looking hooks that are sure to tear at your foes flesh and cause them harm."), "hooked gauntlets", "clawing punch", 8, 300));
        this.set(WeaponName.JeweledRapier, new Weapons.JeweledRapier());
        this.set(WeaponName.Katana, new Weapon(WeaponName.Katana, new ItemDesc("Katana", "a katana", "A curved bladed weapon that cuts through flesh with the greatest of ease."), "katana", "keen cut", 10, 500));
        this.set(WeaponName.LargeAxe, new Weapon(WeaponName.LargeAxe, new ItemDesc("L. Axe ", "an axe large enough for a minotaur", "This massive axe once belonged to a minotaur.  It'd be hard for anyone smaller than a giant to wield effectively.  The axe is double-bladed and deadly-looking."), "large axe", "cleave", 15, 100, "Large"));
        this.set(WeaponName.AphroDagger, new Weapon(WeaponName.AphroDagger, new ItemDesc("L.Daggr", "an aphrodisiac-coated dagger", "A dagger with a short blade in a wavy pattern.  Its edge seems to have been enchanted to always be covered in a light aphrodisiac to arouse anything cut with it."), "lust-enchanted dagger", "stab", 3, 150, "Aphrodisiac Weapon"));
        ...
        this.set(WeaponName.Spear, new Weapon(WeaponName.Spear, new ItemDesc("Spear", "a deadly spear", "A staff with a sharp blade at the tip designed to pierce through the toughest armor.  This would ignore most armors."), "deadly spear", "piercing stab", 8, 450));
        ...
        this.set(WeaponName.Whip, new Weapon(WeaponName.Whip, new ItemDesc("Whip", "a coiled whip", "A coiled length of leather designed to lash your foes into submission.  There's a chance the bondage inclined might enjoy it!"), "coiled whip", "whip-crack", 5, 500));
    }
}
