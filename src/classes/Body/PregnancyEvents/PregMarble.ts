...
export default class PregMarble implements IPregnancyEvent {
    ...
    public birth(player: Player) {
        ...
        if (flags[FlagEnum.MARBLE_NURSERY_CONSTRUCTION] < 100) {
            ...
            MainScreen.text("You push and heave with all your might, little else going through your mind. You somehow register when the head comes out, and soon the shoulders along with the rest of the body follow.  You lean back and pant for a while before feeling a pair of hands grab a hold of you. They slowly and clumsily feel up your body before finding your " + player.chestDesc() + " and a mouth quickly closes down on a " + BreastDescriptor.describeNipple(0) + ".  You sigh softly, and drift off to sleep.", false);
            ...
            //it's a boy!
            {
                ...
                if (player.lowerBody.hipRating < 10) {
                    ...
                    MainScreen.text("After the birth your " + player.inventory.armor.displayName + " fits a bit more snugly about your " + hipDescript() + ".", false);
                }
            ...
            //it's a girl!
            {
                ...
                if (player.statusAffects.get("Marble").value4 >= 20) {
                    MainScreen.text("As the child contentedly drinks from your " + BreastDescriptor.describeNipple(0) + ", Marble tells you, \"<i>Sweetie, somehow I know that our kids won't have to worry about the addictive milk.  It will only make them healthy and strong.</i>\"  You nod at her and put the child into the nursery.  ", false);
                }
                else {
