...
export default class PregOvielixirEggs implements IPregnancyEvent {
    ...
    public birth(player: Player) {
        ...
        if (player.pregnancyIncubation == 1) {
            ...
            //Large egg scene
                ...
                if (player.lowerBody.vaginaSpot.get(0).vaginalLooseness < VaginaLooseness.LOOSE) MainScreen.text("stretching your tight cunt painfully, the lips opening wide ", false);
                if (player.lowerBody.vaginaSpot.get(0).vaginalLooseness >= VaginaLooseness.LOOSE && player.lowerBody.vaginaSpot.get(0).vaginalLooseness <= VaginaLooseness.GAPING_WIDE) MainScreen.text("temporarily stretching your cunt-lips wide-open ", false);
                if (player.lowerBody.vaginaSpot.get(0).vaginalLooseness > VaginaLooseness.GAPING_WIDE) MainScreen.text("parting your already gaping lips wide ", false);
