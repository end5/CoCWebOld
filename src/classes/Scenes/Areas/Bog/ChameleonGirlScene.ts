...
// TIMES_MET_CHAMELEON: number = 561;
		...
		private function fuckDatChameleonAsACoolGuyGirlHerm():void
		{
			...
			outputText("\n\nNot ");
			if (player.stats.cor < 50) outputText("one to be selfish");
			...
			if (player.stats.cor < 50) outputText("and guiltily ");
		...
		private function manFucksChameleonWithBiggishWang():void
		{
			...
			if (player.lowerBody.balls > 0) outputText("your " + ballsDescriptLight() + " clench and ");
		...
		private function femaleHasWinSexWithChamCham():void
		{
			...
			if (player.stats.cor < 50) outputText("and somewhat guiltily ");
