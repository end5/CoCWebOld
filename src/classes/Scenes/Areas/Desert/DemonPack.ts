export default class DemonPack extends Monster {
	...
	public won(hpVictory: boolean, pcCameWorms: boolean): void {
		if (player.gender == 0) {
			...
			if (player.lowerBody.cockSpot.count() > 0) {
				...
				MainScreen.text("our " + player.CockDescriptor.describeMultiCockShort(player) + " throbs ", false);
			...
			if (player.lowerBody.vaginaSpot.count() > 0) {
				...
				MainScreen.text(game.VaginaDescriptor.describeVagina(player, player.lowerBody.vaginaSpot.get(0)) + " burns ", false);
			}
