...
private function wandererEpilogueHuman():void {
	...
	if(player.statusAffects.has("WandererHuman")) {
		...
		if(player.statusAffects.get("WandererHuman").value1 == 0) {
			...
			if(player.stats.cor < 33) outputText("You duck back behind a dune, blushing furiously.", false);
			else if(player.stats.cor < 66) outputText("You blush crimson as you swear you see Lucia look right at you and wink.", false);
