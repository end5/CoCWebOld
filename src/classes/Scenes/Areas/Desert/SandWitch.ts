	...
	public class SandWitch extends Monster
	{
		...
		private lustMagicAttack():void {
			...
			if (player.statusAffects.has("StoneLust")) {
				...
				MainScreen.text("You feel the sands shift by your " + player.feet() + ", and look down to see something slip out of the sands and into your clothes!  It feels incredibly smooth and circular as it glides upward along your " + player.leg() + ", its progress unaffected by your frantic effort to dislodge it.  ");
