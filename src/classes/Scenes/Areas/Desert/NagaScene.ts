...
public nagaEncounter():void {
	...
	if(player.findStatusAffect(StatusAffects.Naga) < 0) player.statusAffects.add(new StatusAffect("Naga",0,0,0,0)));
	Render.text("", true);
	if(player.lowerBody == LOWER_BODY.NAGA) {
		...
		if(player.statusAffects.get("Naga").value2 == 0) {
			...
			Render.text("You wander into the desert, noting how good the sand feels on your underbelly compared to rocks and dirt. You are wondering to yourself if maybe it wouldn't be a bad idea to come out here more often when you spot something moving a little farther ahead of you.\n\n", false);
			Render.text("As you get closer, you see that it is the naga that inhabits this dry desert. You stop in your tracks, wondering if it isn't too late to turn and run, when she turns her head and looks straight at you. You slowly tense your hands, ready to raise your " + player.weaponName + " as the naga eyes your new snake-like body hungrily. Just before you can ready yourself, the naga opens her mouth. But instead of hissing, you find that you can understand her speech. \"<i>Your new body looks so much better than it did before,</i>\" she says, \"<i>It looks far more... delectable now.</i>\"\n\n", false);
			
			Render.text("You wonder how it is that you can understand her now. Perhaps eating and drinking everything you find isn't the greatest idea after all, and as a result you're hallucinating? \"<i>It's been so long since I last saw another of my scaly kin,</i>\" she hisses softly, pulling you out of your introspection. \"<i>I had almost forgotten how good it is to be able to look at the sleek and powerful curves our kind possess. This place can make you forget, if you aren't too careful.</i>\" As strange as it sounds in your head, you are surprised at how she doesn't hold her s's. You aren't quite sure why you thought that would make sense.\n\n", false);
			Render.text("You relax a little as she slithers over to you, though you're still wary of possibly being attacked despite the bright smile on her face. When she is close enough to you, she surprises you again by draping her arms around your shoulders in a friendly hug and pressing her chest firmly against you. You jump slightly at the sudden embrace, but slowly wrap your arms around her waist and pull her closer to you.\n\n", false);
		}
		//[If already encountered as a naga]
		else {
			Render.text("You slide over the hot sand of the desert, enjoying the soft hiss that it makes as your scaled body slides over it. You see a strange yet familiar shape in the distance, and as you approach you realize that it is the naga from before. You quickly slither up behind her and wrap your arms around her. You can feel her tense up momentarily, before recognizing that it's you and turning herself to face you. \"<i>You came back!</i>\" She wraps her arms around your waist and you draw her closer to you.\n\n", false);
		}
		Render.text("She lets out a soft moan and leans her head forward, pressing her lips against yours. You squeeze her body even more firmly against yours in response, the tips of your tails wrapping around one another. You open your mouth slightly and press your tongue against her lips. She offers no resistance and you begin caressing the inside of her mouth with your tongue, circling her fangs as she uses her own tongue to gently stroke ", false);
		//[If player has fangs]
		if(player.faceType == FACE.SNAKE_FANGS) Render.text("your own.", false);
		//[player has no fangs]
		else Render.text("the inside of your mouth.", false);
		Render.text("\n\n", false);
		//dude secks
		if(player.gender == 1 || (player.gender == 3 && rand(2) == 0)) {
			//[Player cock is too big]
			if(player.cockArea(0) > 35) {
				Render.text("The kiss continues as both of your bodies rub together sensually, your tails continuing to wrap around one another. There is a pulsing in your " + cockDescript(0) + " as it starts to grow hard against the naga's soft belly. Feeling this, the naga gently pulls away, slowly letting your tongue out of her mouth as she does so. Her hands make their way over your shoulders, down your abs, and stop at your " + multiCockDescriptLight() +".\n\n", false); 
				Render.text("\"<i>You're quite the big boy, aren't you?</i>\" she says as she wraps both of her hands around your now throbbing " + cockDescript(0) + ". She starts to slide her hands up and down your length. Sticking out her tongue, she wraps it around the tip and licks at the pre that is starting to leak out.\n\n", false);
				...
				Render.text("You moan in pleasure as the naga takes the tip of your member into her mouth and starts to suck. You can feel her deft tongue licking every inch of your cock head.\n\n", false);
				Render.text("At your limit, you let out a yell as you cum into her mouth. ", false);
				//[lots of jizz]
				if(player.cumQ() > 250) Render.text("Her cheeks bulge with the volume and she struggles to swallow as much of it as she can. ", false);
				//[JIZZOFTHEGODS]
				if(player.cumQ() > 1000) Render.text("Her cheeks bulge out with the sheer volume of your cum and she is forced to release you from her mouth to avoid drowning in your seed. ", false);
				Render.text("You collapse onto the sand and lay there, basking in the warm glow of your orgasm. The naga slides onto your chest and gives you a kiss. \"<i>I rather enjoyed that,</i>\" she hisses into your ear, \"<i>We should do this more often.</i>\"\n\n", false);
				Render.text("She gives you one last kiss before slithering off into the desert. You watch as she leaves and blow her a kiss goodbye before she disappears from your sight.\n\n", false);
			}
			//[Cock isn't too big]
			else {
				Render.text("The kiss continues and both of your bodies rub together sensually, your tails continuing to wrap around one another. There is a pulsing in your " + multiCockDescriptLight() + " as ", false);
				if(player.lowerBody.cockSpot.count() == 1) Render.text("it starts ", false);
				else Render.text("they start ", false);
				Render.text("to grow hard against the naga's soft belly. Feeling this, the naga gently pulls away, slowly letting your tongue out of her mouth as she does so. Her hands make their way over your shoulders, down your abs, and stop at your " + multiCockDescriptLight() + ".\n\n", false);
				//[player has one dick]
				if(player.totalCocks() == 1) Render.text("Gently she starts to stroke the length of your " + cockDescript(0) + " with one hand while circling the tip with the other. ", false);
				//[player has two dicks]
				if(player.totalCocks() == 2) Render.text("She takes one in each of her hands and gently strokes them up and down. Every few seconds she stops at the tip to rub her palms over them. ", false);
				//[player has three or more dicks]
				if(player.totalCocks() >= 3) Render.text("She takes one in each hand, stroking them slowly and making sure to pay attention to the tip. Every so often she switches to a different dick to make sure that each and every one of your throbbing cocks has some love given to them. ", false);
				Render.text("A hiss of pleasure escapes your lips as the naga strokes your " + multiCockDescriptLight() + ", her talented fingers bringing you further into a state of arousal. She stops her caress and brings her hand to a scaly covering at her crotch, spreading it wide to reveal her soft pussy.\n\n", false);
				
				//[player has one dick] 
				if(player.totalCocks() == 1) Render.text("She carefully lines it up with your member and starts to tease the tip before gently inserting the first few inches. ", false);
				//[player has two dicks]
				if(player.totalCocks() == 2) Render.text("She carefully lines it up with both of your members and starts to tease their tips before gently inserting the first few inches. ", false);
				//[player has three or more dicks]
				if(player.totalCocks() >= 3) Render.text("She carefully lines it up with one of your members and starts to tease the tip before gently inserting the first few inches. ", false);
				Render.text("She pulls her hips back slightly before pushing them back down, swallowing a bit more of you into her.  As she pulls back the second time, she shifts her arms to rest on your shoulders and grips your back tightly as she pushes you deeper inside of her.\n\n", false);
				Render.text("Every thrust brings you deeper inside of her pussy, its soft walls massaging you. It seems like her pussy managed to swallow your entire cock in no time at all. The naga pauses for a moment, your hips pressed together, panting. You shift your arms up a little higher to rest at her waist and lower your head to nuzzle at her neck. The naga leans her head into yours and wraps one of her arms around your head. Once more she pulls back her hips before thrusting them back onto your cock. No longer is she slowly bringing you inside her, now she thrusts herself onto you, going faster and faster. Your tails tighten around each other as you reach climax. A sudden yell escapes your throat as you cum inside of her, your tail squeezing hard enough to crush a lesser being. The naga shudders in your grip as she reaches her own climax. ", false);
				//[lots of jizz]
				if(player.cumQ() > 250) Render.text("You quickly fill her with your seed to the point where she overflows, leaving her pussy dripping with semen afterwards.", false);
				//[JIZZ, JIZZ EVERYWHERE] 
				else if(player.cumQ() > 1000) Render.text("Her stomach quickly swells from the sheer volume of seed pumped into her. The sperm that her womb is unable to hold starts to gush out from her stuffed cunt.", false);
...
private gooNagaRape():void {
	Render.text("", true);
	player.orgasm();
	Render.text("You look over at the prone form of the naga lying in the sand, her ", false);
	if(monster.HP < 0) Render.text("weak ", false);
	else Render.text("flushed ", false);
	Render.text("form only serving to arouse you further. You slide over to her, your gooey lower half leaving a wet trail behind you. As you stand over the defeated form of the snake woman, an idea pops into your head, ", false);
	if(player.stats.cor > 50) {
		//(if corrupt male)
		if(player.gender == 1) {
			Render.text("your " + cockDescript(0) + " growing harder at the thought.", false);
		}
		//(if corrupt female)
		else if(player.gender == 2) {
			Render.text("your cunt grows moist at the thought.", false);
		} 
		else if(player.gender == 3) {
			Render.text("your cock twitches and your pussy becomes moist from the thought.", false);
		}
		else Render.text("you feel a tingle at your groin from the thought.", false);
	}
	//(if not corrupt)
	else {
		Render.text("the thought is almost too horrible to consider, but still...", false);
	}
	Render.text("  You slide your gooey form over her body, resting at her crotch. She tries to push you off, but you easily resist her.\n\n", false);
    Render.text("Looking down, you see a scale covered slit at her crotch. Bringing a hand down to it, you stroke it gently and feel the naga twitch beneath you. You slowly open the slit to reveal the moist folds of her pussy. You start to tease her by stroking her netherlips, the naga moaning in response. You gradually slide your fingers in, moving them inside of her to see just how far her lips can spread. The naga continues to pant and moan under your touch, her tail thrashing in the sand.\n\n", false);
    Render.text("You decide that you've played with her enough and withdraw your hand, now wet with her juices, from her pussy. A hiss escapes the naga's lips and she tries to bring your hand back to her needy cunt. You pull your hand out of her grip and instead shift your gooey form over her lips and start to push some of your lower half into her. She starts to coo as you shove the first few inches in, her hips thrusting into the air. You continue to push more of your slimy form into her, sliding deeper and deeper into her as her walls convulse around you.\n\n", false);
	Render.text("Soon you feel yourself hit a wall as your body hits the opening of the naga's cervix. A stray thought crosses your mind as you think that maybe this is far enough, ", false);
	//(if corrupt)
	if(player.stats.cor > 50) Render.text("but immediately after, you decide that this is going to be too much fun to not push on.", false);
	//(if not corrupt)
	else Render.text("but a nagging voice at the back of your head urges you to push further.", false);
	Render.text("You grab the naga's shoulders and thrust yourself down, HARD. The naga screams as you push past her cervix and fill her womb with your gooey form. Her entire body writhes as you push more of yourself into her womb, her stomach starting to bulge out at the sheer amount filling her. The screams of the naga intensify as you push more and more of yourself into her, her stomach swelling enough to look pregnant. You finally stop pushing into her, almost your entire lower half inside of the naga.\n\n", false);
    
	Render.text("You pause for a moment, enjoying the sensation of filling someone up with your body, surprised at just how good it feels. Grabbing the naga's hips you slowly push yourself in and out of her now full pussy, ", false);
	//(if male)
	if(player.totalCocks() > 0) {
		if(player.lowerBody.cockSpot.count() == 1) Render.text("your " + cockDescript(0), false);
		else Render.text("one of your " + multiCockDescriptLight(), false);
		Render.text(" hitting the naga's pleasure buzzer with each downward thrust.", false);
	} 
	//(if female)
	else if(player.gender == 2) {
		Render.text("your clit rubbing against the naga's pleasure buzzer with each downward thrust.", false);
	} 
	//(if herm) 
	else if(player.gender == 3) {
		if(player.lowerBody.cockSpot.count() == 1) Render.text("your " + cockDescript(0), false);
		else Render.text("your " + multiCockDescriptLight(), false);
		Render.text(" and clit rubbing against the naga's pleasure buzzer with each downward thrust.", false);
	}
	//(if genderless)
	else {
		Render.text("your bare crotch hitting the naga's pleasure buzzer with each downward thrust.", false);
	}
	
    Render.text("\n\nYou continue to relentlessly push yourself into the naga, stretching her wide.  ", false);
	//(if male)
	if(player.gender == 1) {
		Render.text("You let out a yell as ", false);
		//(normal) 
		if(player.cumQ() < 250) Render.text("you come all over the naga's stomach.", false);
		else if(player.cumQ() < 1000) Render.text("you come all over the naga's face and stomach.", false);
		//(if THE LEVEYS HAVE BROKE RUN FOR THE HILLS) 
		else Render.text("you come violently, covering the naga in a layer of your sperm.", false);
	}
	//(if female)
	else if(player.gender == 2) {
		Render.text("You shriek in delight as wave after wave of orgasms rush over you", false);
		//(if squirter)
		if(player.vaginas[0].vaginalWetness == VAGINA_WETNESS.SLAVERING) Render.text(", your girlcum gushing out and pooling on the stomach of the naga", false);
		Render.text(".", false);
	}
	//(if herm)
	if(player.gender == 3) {
		Render.text("You scream in ecstasy as you hit your peak, your girlcum ", false);
		if(player.vaginas[0].vaginalWetness < VAGINA_WETNESS.SLAVERING) Render.text("leaking out", false);
		else Render.text("gushing out to form a pool on the naga's stomach", false);
		Render.text(" and your " + multiCockDescriptLight(), false);
		//(normal)
		if(player.cumQ() < 250) Render.text(" spurting onto her stomach as well.", false);
		//(lots of jizz)
		else if(player.cumQ() < 1000) Render.text(" spurting onto her stomach and face.", false);
		else Render.text(" completely covering the naga in a layer of your spooge.", false);
	}
	//(if genderless)
	if(player.gender == 0) {
		Render.text("You cry out and shudder as you feel wave after wave of the naga's orgasm rushing over your body, bringing you to a strange orgasmic bliss of your own.", false);
	} 
...
private nagaVictoryMale():void {
	...
	     	}
			...
			if(player.cumQ() > 250) Render.text("  Your spooge explodes from the naga's abused cunt, flooding the desert sands as you black out.\n\n", false);
			else Render.text("\n\n", false);
			
			Render.text("When you awaken, the naga is long gone. All that remains of your encounter is a depression in the landscape", false);
			//[lots of jizz] 
			if(player.cumQ() > 250) Render.text(" with traces of semen in it", false);
			//[if OMGWTFBBQGALLONSOFCUM]
			else if(player.cumQ() > 2000) Render.text(" that's filled with your thick seed", false);
			Render.text(".\n\n", false);
			Render.text("As you retrieve your clothes, you notice red marks around your chest and arms. It seems that while the naga did have the opportunity to kill you while you were unconscious, she preferred to keep you alive.\n\n", false);
		}
	}
	Render.text("You think it would be a very good idea to come to the desert more often.", false);
	player.orgasm();
...
    		//(If you've been a bad boy during victory scenes)
	...
	//b) female //http://nekomimichan.org/mg/src/12844585127.jpg
		...
		if(player.lust > 99) 
		{
			Render.text("You fall to your knees, your body shaking with desire.\n\n", false);
		}
		//If defeated by KO)
		else 
		{
			Render.text("You fall to your knees, your battered body unable to hold itself up any longer.\n\n", false);
		}
		Render.text("The naga slowly approaches you with a smile of delight, devouring you with her eyes like the helpless morsel you are. When she's close enough, she slides her tail under you and brings you closer to her. As she hisses in your ear, a chill goes down your spine: you don't understand a word she is saying, but you can tell just by the variations that this lovely lady won't be going easy on you, ", false);
		//(if corrupted)
		if(player.stats.cor > 50) 
		{
			Render.text("and the sheer thought of it is making you wet already.  ", false);
		}
		//(if uncorrupted)
		else Render.text("and while you know you probably won't like it, your " + vaginaDescript(0) + " says otherwise.  ", false);
		Render.text("Now astride the base of her tail and facing towards her, your eyes are drawn to the place on her scaly pelvis where a vagina should be. With one hand the naga begins gently caressing her nether regions, which begin to swell in her excitement into the outlines of a recognizable reptilian vulva. Her expectations are perfectly clear ", false);
		//(If defeated by lust) 
		if(player.lust > 99) 
		{
			Render.text("and you can feel the need to have sex with her burn inside you. You quickly strip yourself of your " + player.armorName + " and throw yourself on her awaiting pussy.", false);
		} 
		//(If defeated by KO)
		else 
		{
			Render.text("and you're too weak to resist anyway; you might as well just comply. You attempt to remove your " + player.armorName + " before the naga grabs you in pity and decides to help you with it. Now naked,  she lays you down on her tail and you let her guide you to her awaiting pussy.", false);
		}
		Render.text("  Without any further complaints, you pull her lips apart and start licking. The creature lets out a sigh of pleasure as you move your tongue around the outside of her netherlips.\n\n", false);
		
		Render.text("Slowly you move your tongue around her folds, hearing her soft moans of arousal. Bringing your lips to the bottom of her slit, you gently kiss at it, carefully working your way up to the top. You pause a moment once at the top to plant a gentle kiss on her love button and feel her twitch slightly before you make your way back down to her glistening cunt and lick at the moisture, savoring its taste.\n\n", false);
		
		Render.text("You continue your loving assault on her love canal as the naga's moans gradually become louder. Her hands make their way to your head and she curls her fingers through your " + hairDescript() + " to get a better grip on your head as you bring your mouth up to her pleasure buzzer. You give one final, slow lick up the length of her pussy and twirl your tongue around her now engorged clit. The naga involuntarily bucks her hips into your face as you start to suck on her pleasure buzzer. As you continue to play with her clit, she begins to lose control, grinding her soaking pussy against your face, and vice-versa. She forces herself onto you so hard, it becomes hard to breathe, and the warm juices of her excited love-slit coat your face. ", false);
		//(If you are a naughty girl)
		if(player.stats.cor > 80) {
			Render.text("You attempt to bite at her clit, in an attempt to have her let off a bit, but instead of causing her to pull away, it drives her over the edge, sending her into a crushing climax. She squeals and her hips begin to buck with more ferocity than ever before. Her warm reptilian love juices fill your mouth and splash across your face and upper body, and she hisses something, which you can only assume is encouragement.", false);
		} 
		//(If you are a good girl)
		else {
			Render.text("You attempt to pull away from her hot snatch, pulling your mouth from her swollen clit. She overpowers you, pulling your face back down upon her lovebuzzer. The feeling of your warm, wet lips as they rub against her clit is apparently just enough for her as it pushes her past her limit, sending her into a passionate orgasm.", false);
		} 
		Render.text("  You finally pull away from her as her body is wracked with powerful contractions, wiping the excess ladycum from your face.\n\n", false);
   		
...
internal function nagaRapeChoice():void {
	if(monster.HP < 1) Render.text("You've defeated the naga!  ", true);
	else Render.text("The naga writhes in the sand, masturbating feverishly!  She's completely forgotten about fighting you.  ", true);
	...
	if(player.lust >= 33) {
		Render.text("Your body aches for further satisfaction - do you rape the snake woman?", false);
		if(player.lowerBody == LOWER_BODY.GOO) {
...
public nagaPlayerConstrict():void {
	...
	if(player.fatigue + kGAMECLASS.physicalCost(10) > 100) {
		Render.text("You just don't have the energy to wrap yourself so tightly around someone right now...", true);
//Gone		menuLoc = 1;
		menu();
	...
	if(monster.plural) {
		Render.text("You launch yourself at " + monster.a + monster.short + ", but with multiple enemies, wrapping one up would leave you completely open to attack.  You hastily slither backwards before you expose yourself to danger.", true);
		Render.text("\n\n", false);
		kGAMECLASS.enemyAI();
		return;
	}
	if(monster.short == "pod") {
		Render.text("You can't constrict something you're trapped inside of!", true);
//Gone		menuLoc = 1;
		menu();
		addButton(0, "Next", kGAMECLASS.combatMenu, false);
		return;
	...
	//Failure
		...
		//Failure (-10 HPs) -
		Render.text("You launch yourself at your opponent and attempt to wrap yourself around " + monster.pronoun2 + ". Before you can even get close enough, " +monster.a + monster.short + " jumps out of the way, causing you to fall flat on your face. You quickly pick yourself up and jump back.", false);
		player.takeDamage(5);
		if(player.HP <= 0) {
...
public naggaSqueeze():void {
	Render.text("", true);
	//Squeeze -
	Render.text("Your coils wrap tighter around your prey, leaving " + monster.pronoun2 + " short of breath. You can feel it in your tail as " + monster.pronoun3 + " struggles are briefly intensified.", false);
    monster.HP -= monster.eMaxHP() * (.10 + rand(15)/100);
	//Enemy faints -
	if(monster.HP < 1) {
		Render.text("You can feel " + monster.a + monster.short + "'s life signs beginning to fade, and before you crush all the life from " + monster.pronoun2 + ", you let go, dropping " +monster.pronoun2 + " to the floor, unconscious but alive.  In no time, " + monster.pronoun3 + "'s eyelids begin fluttering, and you've no doubt they'll regain consciousness soon.  ", false);
		if(monster.short == "demons")
			Render.text("The others quickly back off, terrified at the idea of what you might do to them.", false);
		Render.text("\n\n", false);
...
public naggaTease():void {
	...
	{
		Render.text("You attempt to stimulate " + monster.a + monster.short + " by rubbing " + monster.pronoun3 + " nether regions, but " + monster.pronoun3 + " seems too affected by your poison to react.\n\n", false);
	}
	else if(monster.gender == 0)
	{
		Render.text("You look over " + monster.a + monster.short + ", but can't figure out how to tease such an unusual foe.\n\n", false);
	}
	//(Otherwise)
	else {
...
        if(monster.short == "demons") {
			Render.text("As you stimulate one of their brethren, the other demons can't help but to feel more aroused by this sight, all wishing to touch and feel the contact of your smooth, scaly body.", false);
		}
		else if(monster.short == "slime") {
			Render.text("You attempt to stimulate the slime despite its lack of any sex organs. Somehow, it works!", false);
		}
		//Normal cases for other monsters
		else {
			if(monster.gender == 1)
			{
				Render.text("Your nimble tail begins to gently stroke his " + monster.cockDescriptShort(0) + ", and you can see it on his face as he tries to hold back the fact that it feels good.", false);
			}
			if(monster.gender == 2)
			{
				Render.text("Your nimble tail manages to work its way between her legs, grinding your tail's scaly skin against her clit. She appears to enjoy it, but it is obvious she is trying to hide it from you.", false);
			}
			if(monster.gender == 3)
			{
				Render.text("Your nimble tail manages to work its way between " + monster.pronoun3 + " legs, gaining access to both sets of genitals. As your rough, scaly skin rubs past " + monster.pronoun3 + " clit, your tail gently begins to stroke " + monster.pronoun3 + " cock. The repressed expression on " + monster.pronoun3 + " face betrays " + monster.pronoun3 + " own enjoyment of this kind of treatment.", false); 
            }
		}
		//Land the hit!
		if(rand(100) <= chance) {
...
public nagaLeggoMyEggo():void {
	Render.text("", true);
	Render.text("You release " + monster.a + monster.short + " from " + monster.pronoun3 + " bonds, and " + monster.pronoun1 + " drops to the ground, catching " + monster.pronoun3 + " breath before " + monster.pronoun1 + " stands back up, apparently prepared to fight some more.", false);
	Render.text("\n\n", false);
...
private eggUpANagaSpiderLike():void {
	clearOutput();
	Render.text("As the shiny-scaled girl collapses against the sand, you scramble forward, panting not so much with the exertion of the fight as with lust and excitement.  Surely a creature as large as her has enough room to fit all your eggs?  You feel so full, and it's been so long since you last had release.");
	...
	if(player.gender > 0) {
		Render.text(", ");
		if(player.lowerBody.cockSpot.hasCock()) Render.text("jizz");
		if(player.gender == 3) Render.text(" and ");
		if(player.lowerBody.vaginaSpot.hasVagina()) Render.text("femcum");
		Render.text(" raining down on the prone naga");
	}
	Render.text(".  You crumple into a heap on top of your reptilian lover, unconscious before you hit the sand.  Her eyes drift closed as well, as she coils around you, settling in for a well-deserved rest.");
...
private beePositANagaPlease():void {
	...
	Render.text(" you relax against her, two bodies twined into one passionate shape.  The naga's tail circles one of your [legs] and your abdomen affectionately, and your ovipositor suddenly thickens, stretched a bit wider at the base as your first egg drops into the chute.  The scaly seductress wiggles a little at this, but her sultry gaze leaves no doubt as to her enjoyment of it.  You flex muscles you don't truly understand and force another egg in behind the first... and a third... and a fourth.");
	...
	if(player.lowerBody.cockSpot.hasCock()) Render.text("  [EachCock] erupts to splatter her with white");
	if(player.lowerBody.cockSpot.hasCock() && player.lowerBody.vaginaSpot.hasVagina()) Render.text(" and y");
	else if(player.lowerBody.vaginaSpot.hasVagina()) Render.text("  Y");
	if(player.lowerBody.vaginaSpot.hasVagina()) {
		Render.text("our [vagina] ");
		if(player.wetness() < 3) Render.text("drools");
		else if(player.wetness() < 5) Render.text("gushes");
		else Render.text("splatters");
		Render.text(" clear femcum over the Naga's tight belly");
		if(player.lowerBody.cockSpot.hasCock()) Render.text(" as well");
	}
	...
	if(player.eggs() > 30) Render.text(" from the outside at least.  You stuffed her so full that she looks positively pregnant, bulging to a picture of utter fertility");
	Render.text(".  She idly runs her hands across her body, pinching her nipples and gasping in delight.  Your venom is clearly keeping her quite aroused, even with such a powerful orgasm.  After such a workout, you feel like you might have a little bit of venom left, so you give the new ");
	if(player.fertilizedEggs() == 0) Render.text("egg-bearer");
	else Render.text("mother");
	Render.text(" a parting sting.  Her moans of excitement jump an octave, and you listen to them with a happy, almost gloating smile while you get dressed.");
