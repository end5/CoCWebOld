...
private rapeMinotaurTentacles():void {
	...
	if(monster.HP <= 0) MainScreen.text("The minotaur collapses backwards after your last blow. Defeated and tired, he can barely stand up as you approach.  ", false);
		...
		MainScreen.text(". Transfixed by your " + multiCockDescript() + " in front of his face, he barely notices as you walk closer.  ", false);
	}
	...
	if(player.stats.cor < 25) MainScreen.text("You cry, petting his hair, smoothing it across his horns, justifying to yourself that you are raping this beast because this is how this world works as you maneuver your " + multiCockDescript() + " towards his tailhole.  ", false);
	if(player.stats.cor >= 25 && player.stats.cor < 50) MainScreen.text("You smoothly guide your " + multiCockDescript() + " toward his tailhole.  ", false);
	if(player.stats.cor >= 50 && player.stats.cor < 80) MainScreen.text("You roughly grab him, slamming him close to your " + multiCockDescript() + " - just how this beast likes it.  ", false);
	if(player.stats.cor >= 80) MainScreen.text("You grin and roughly pull his horns towards your " + multiCockDescript() + ", ready to roughly ride this beast.  ", false);
	//Mixed dix
	if(player.lowerBody.cockSpot.count() != player.tentacleCocks()) {
		...
		MainScreen.text("Your " + cockDescript(temp2) + " slams into his tailhole, spreading it wider as you thrust in and out of the opening, relishing in the feeling of the rough, yet lubricated insides of the minotaur.  ", false);
	}
	//Not mismatched
	else {
		temp2 = 0;
	...
	if((player.tentacleCocks() == 2 || player.tentacleCocks() == 3)) MainScreen.text("Your next tentacle dick, saddened by not having anything to writhe around, turns to the minotaurs protruding member. It darts out from your crotch, wrapping around his monstrous meat and constricting, like a snake might around its prey. Your tongue lolls out as you feel that cock twist and grab his dick, pulsing with both your blood and the beast's twitching member.  ", false);
	if(player.tentacleCocks() > 3) MainScreen.text("Your remaining tentacle dicks wave around the minotaur, tending to his balls, weaving around his limbs, and generally rubbing and throbbing all over him, spreading pre-cum around and through him, leaving both of you moaning in pleasure.  ", false);
	//Cum
...
private rapeMinotaurTentacle():void {
	...
	if(player.lowerBody.cockSpot.count() > 2 && temp != 1) {
		temp = 1;
		MainScreen.text("It's not enough! Your other dicks demand attention too! Fortunately, he has a large hole for you to abuse... you stuff as many of your " + multiCockDescript() + " as you can, the rest hanging underneath him, slapping against his sack. ");
	}
	...
	if(player.lowerBody.vaginaSpot.count() > 0) {
		temp = 2;
		MainScreen.text("You're a woman, and it's about time you got some pussy action too!  You slide your " + vaginaDescript(0) + " onto " + player.cockDescript(x) + "-wrapped minotaur-prick, further driving the beast mad with lust.  He plaintatively groans, struggling to get his dick free or to cum, you aren't quite sure.  ", false);
		MainScreen.text("Eventually, the moment is right.  You smile as you feel a boiling heat building in your groin, surging through your " + multiCockDescript() + " in a tide of white-hot pleasure.  You groan and shiver, lost in the pleasure until you begin to calm down.  ", false);
		if(player.cumQ() < 50) MainScreen.text("Your cock made quite a mess of things, and when you pull him out, your " + vaginaDescript(0) + " makes a wet sucking sound.  ", false);
		if(player.cumQ() >= 50 && player.cumQ() < 400) MainScreen.text("Your cock made quite a mess of things inside your " + vaginaDescript(0) + ".  As you pull free, cum drips freely down your thighs.  The heavenly scent of minotaur spunk fills your nose, and begin scooping the mixed jizz up to sample.  ", false);
		if(player.cumQ() >= 400) MainScreen.text("Your cock made quite a mess of things inside your " + vaginaDescript(0) + ".  As you pull free, a river of cum pours from betwixt your thighs.  The heavenly scent of minotaur spunk fills your nose, and you begin scooping the mixed jizz up to sample.  ", false);
	}
	//Free ass!
	else {
		temp = 2;
...
private AddictNagaOnMinotaur():void {
	...
	if(player.lowerBody.cockSpot.hasCock()) MainScreen.text("furiously stroke your own " + multiCockDescriptLight() + ". Your muffled vocalizations of pleaure weakly join his own.\n\n", false);
	else MainScreen.text("part the folds of your " + vaginaDescript(0) + ", sliding it inside and masturbating with a furious vigor. Your muffled vocalizations of pleaure weakly join his own.\n\n", false);
...
private minoUrethralPen():void {
	...
	if(player.statusAffects.get("Infested").value1 == 5) {
		...
		MainScreen.text("The minotaur writhes and moans, openly panicking but too weak to resist, as you saw your " + cockDescript(x) + " back and forth into his cock-hole, relishing the helpless look the once-mighty beast is displaying as you feel your worms steadily making their way down your cock. He must feel how the worms bulge your tool as they work their way down, nearing the end of your length as he shudders and shakes his head in denial. You give a tiny spasm of delight, tongue lolling out of your " + player.face() + " as the first of your worms pour out of your tip and directly into the beast's urethra.\n\n", false);
		...
		MainScreen.text("Overcome with lust and fatigue, the minotaur falls to the ground as you unhurriedly remove your " + player.armorName + ". The minotaur's eyes roam all over your body, his massive cock hard and throbbing. You slowly begin to stroke your own hard cock, pre-cum beginning to drool thickly from the head and over your hand. You slide your hand up and down your long shaft, lubing it with your juices as you decide what to do with the fallen brute before you. An idea forms in your mind and your cock throbs with anticipation, your imagination already working out the entertaining details.\n\n", true);
...
private minoRapeIntro():void {	
	...
	if(monster.HP <= 0) {
		...
		if(player.lowerBody.vaginaSpot.count() > 0) MainScreen.text("  Glancing back at you with hope in his eyes, the minotaur's " + monster.cockDescriptShort(0) + " twitches as he lays his gaze upon your " + vaginaDescript(0) + ".", false);
		else MainScreen.text("  Glancing back at you with eyes full of despair, the minotaur seems to realize you won't be helping the predicament his " + monster.ballsDescriptLight() + " are in.", false);
	}
	//Monster lost to lust
	else {
		MainScreen.text("You rip off the minotaur's loincloth with a savage grin, slapping his ass and admiring the jiggle of his " + monster.ballsDescriptLight() + " as they wobble from the force of your blow.  The cow-man moos softly with desire, ropes of pre splattering the ground from his arousal.   The musk pouring off him and his puddle of slick pre-cum is overpowering, making it difficult to think as you feel your blood rush to your groin ", false);
		//NIPPULAR ENJOYMENT
		if(player.upperBody.chest.countNipples() > 1) MainScreen.text(" and nipples", false);
		MainScreen.text(".", false);
		//Vagina or not flavor texts
		if(player.lowerBody.vaginaSpot.count() > 0) MainScreen.text("  Glancing back at you with hope in its eyes, the minotaur's " + monster.cockDescriptShort(0) + " twitches as he lays his gaze upon your " + vaginaDescript(0) + ".", false);
		else MainScreen.text("  Glancing back at you with eyes full of despair, the minotaur doubts you'll help relieve the predicament his " + monster.ballsDescriptLight() + " are in.", false);
	}
}
...
private bumRapeaMinotaur():void {
	...
	//Regular or multi...
	if(player.lowerBody.cockSpot.count() == 1) MainScreen.text(cockDescript(x), false);
	else MainScreen.text(multiCockDescriptLight(), false);
...
private girlRapeAMinotaur():void {
	...
	if(player.lowerBody == LOWER_BODY.CENTAUR) MainScreen.text("hindquarters, forcefully grinding your vagina along his length like a toy.  ", false);
	else MainScreen.text(hipDescript() + ", forcefully grinding up and down along his length like a cheap sex-toy.  ", false);
	//Size variants
	//Too small
	...
	//Too big
	if(player.vaginalCapacity() *1.5 >= monster.cockArea(0)) MainScreen.text("Every stroke of his " + monster.cockDescriptShort(0) + " slides easily into your " + vaginaDescript(0) + ", allowing him to slowly build up a puddle of his wondrous druggy pre-seed into your aching womb.  ", false);
	//Resume!
	...
	//ITS OVER
	MainScreen.text("He passes out with a contented sigh, balls shrunk down to the size of baseballs and his cock still dribbling cum.  You pull yourself to your feet unsteadily, drunk with pleasure as you stagger away, clamping your " + vaginaDescript(0) + " down unconsciously to hold in his wonderful seed.", false);
...
public getRapedByMinotaur(autoRape:boolean = false):void {
	...
	//Normal RAEP
	if(player.lowerBody.vaginaSpot.count() > 0) {
		MainScreen.text("The bull-man roughly grabs your hair and begins rubbing the flared head of his penis along your " + vaginaDescript(0) + ".  ", false);
		if(player.averageVaginalWetness() < 2) MainScreen.text("You aren't very wet, and fear the damage this beast will inflict on your " + vaginaDescript(0) + ".  ", false);
	...
	if(player.upperBody.chest.BreastRatingLargest[0].breastRating > 0 && player.mostBreastsPerRow() > 1 && player.upperBody.chest.count() > 0) {
		...
		if(player.biggestLactation() > 1.5) MainScreen.text("He then gives a grunt in what you take to be approval as your milk begins to squirt out. He licks a milk-coated finger in satisfaction.  ", false);
	}
	if(player.lowerBody.cockSpot.count() == 1) MainScreen.text("The bull-man bends forward a little, and grabs your " + cockDescript(0) + " in a crushing grip. He makes short jerking motions as he keeps thrusting into you.", false);
	if(player.lowerBody.cockSpot.count() > 1) 	MainScreen.text("The bull-man bends forward a little, and grabs one of your " + cockDescript(0) + "s in a crushing grip. He makes short jerking motions as he keeps thrusting into you.", false);
	if(player.lowerBody.vaginaSpot.count() > 0) {
	...
	if(player.lowerBody.vaginaSpot.count() > 0) {
		if(player.averageVaginalWetness() >= 2) {
			...
			if(player.averageVaginalWetness() == 4) MainScreen.text("You squirm and quiver, orgasming from the beast's rough usage, soaking him with your " + vaginaDescript(0) + ".  ", false);
	...
	if(player.lowerBody.cockSpot.count() > 0 && (player.stats.sens + rand(40) > 50)) {
		...
		if(player.cumQ() >= 500) MainScreen.text("erupting a thick torrent of seed that seems to go on forever, spurred by the constant pressure of the huge minotaur cock.  You paint the cave wall with cum, the beast egging you on as it roughly jacks your " + cockDescript(0) + ".  You are vaguely aware of your orgasm dragging on and on, until eventually your orgasm stops, leaving a sizable puddle of cum on the floor.  ", false);
		player.orgasm();
		dynStats("lib", .5, "sen", 1, "cor", 1);
	}
...
private getOralRapedByMinotaur():void {
	...
	if(player.lowerBody.cockSpot.count() >= 1) {
		MainScreen.text("  Your " + multiCockDescriptLight() + " slap", false);
	...
	if(player.hasBreasts()) MainScreen.text(", painfully grinding your " + nippleDescript(0) + " against his wiry fur", false);
	if(player.lowerBody.balls > 0) MainScreen.text(", and you can feel the minotaur's hot breath on your " + ballsDescriptLight(), false);
...
private minoGetsTitFucked():void {
	...
	MainScreen.text("He's yours for the moment, and for right now, you want to see if that throbbing horse-cock will splatter its heavenly spunk all over your " + player.allBreastsDescript() + " and " + player.face() + ".  You really could use a fix, just enough to fuzz over all the worry and stress you've had to deal with.\n\n", false);
	...
	if(player.totalCocks() > 0) MainScreen.text("  Your " + cockDescript(0) + " grows harder and more aroused than ever before while your ", false);
	else MainScreen.text("  Your body aches with arousal while your ", false);
	if(player.lowerBody.vaginaSpot.hasVagina()) MainScreen.text(vaginaDescript(0) + " grows hotter and hotter, begging to be taken.", false);
	else MainScreen.text(assholeDescript() + " puckers slightly, as if begging to be taken by another monstrous beast.", false);
	MainScreen.text("\n\n", false);
	...
	MainScreen.text("Out to prove him wrong by letting him release all over your face, you wrap your " + player.allBreastsDescript() + " tightly around him and begin sliding your body along his length.  The constant drizzling pre-cum easily lubricates you, and soon your orbs are shiny and slick with his drug-like fluid.\n\n", false);
...
private takeMinoCumDirectly():void {
	...
	MainScreen.text("You shed your " + player.armorName + " and step over its waist, trembling slightly with anticipation of your next fix.  Taking his flared drug-nozzle in hand, you hold it steady and lower yourself down, feeling his slippery narcotic pre-cum smearing over your hole.  ", false);
	//Too tight!
	...
	MainScreen.text("An hour or so later, you pick yourself up out of a puddle of mud that reeks of sex.  Still feeling groggy and euphoric, you get dressed, not bothering to clean up.  You have to work to keep your " + assholeDescript() + " clenched, lest you lose some of the drug making you so happy.", false);
...
private minotaurBlowjob():void {
	...
	if(!player.isTaur()) MainScreen.text("peeling away your " + player.armorName + " and ", false);
	MainScreen.text("revealing your " + multiCockDescriptLight() + " to the defeated bull.  The beast looks to you in both arousal and shock, mouth parting slightly at the idea of another creature taking charge.  Within the musky stench of its dripping shaft you nearly lose yourself, and ", false);
	if(!player.isTaur()) MainScreen.text("taking the bull by the horns", false);
	else MainScreen.text("pinning his horns in the crook of your forelegs", false);
	MainScreen.text(", you guide its mouth closer to your member as if on autopilot.  \"<i>Let's see just how good you are at milking,</i>\" you blurt; the minotaur moos in defiance but is soon silenced when the head of your " + Appearance.cockNoun(player.lowerBody.cockSpot.list[x].cockType) + " presses into its bovine mouth.\n\n", false);
	...
	if(!player.isTaur()) MainScreen.text("finding your hands leaving his horns for the back of his head ", false);
	...
	if(!player.isTaur()) MainScreen.text("your hand", false);
...
private layBeeEggsInCowbutt():void {
	...
	if(!player.isTaur()) MainScreen.text("  Wrapping his tail around one hand, you lift his furred flanks up");
