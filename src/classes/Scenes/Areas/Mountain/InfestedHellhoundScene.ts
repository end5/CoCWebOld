...
package classes.Scenes.Areas.Mountain
{
	...
	public class InfestedHellhoundScene extends BaseContent
	{
		...
		public function infestedHellhoundEncounter():void
		{
			...
			if (player.lowerBody == LOWER_BODY.GOO) outputText("making your jello-like body jiggle", false);
		...
		public function infestedHellhoundLossRape():void
		{
			...
			if (player.totalCocks() > 0 && player.statusAffects.has("Infested")) {
				...
				if (player.lust > 99) {
					...
					if (player.stats.cor < 33) outputText("In spite of your revulsion ", false);
					else if (player.stats.cor < 66) outputText("In spite of your better sense ", false);
			...
			//[PLAYER'S COCKS ARE BIG ENOUGH TO BE INFECTED]
				...
				if (player.totalCocks() > 1) {
					...
					if (player.lowerBody.balls > 0) outputText(ballsDescriptLight() + " shiver as hot doggie-cum and wiggling worms are pumped directly into them.  ", false);
			...
			//[HAS PUSSY AND NO DICK BIG ENOUGH TO BE INFECTED]
				...
				if (player.stats.cor < 66) outputText("You beg, \"<i>Please, no, no!  I don't want them... in me!</i>\"\n\n", false);
			...
			//[GENDERLESS OR MALE WITH DICK TOO SMALL]
				...
				outputText("The hell-hound rises up, looking nearly humanoid in shape for a moment before it drops down, planting its paws on your shoulders.  ", false);
				if (player.stats.cor < 80) outputText("You beg, \"<i>Please, no, no!  I don't want it... in me!</i>\"\n\n", false);
