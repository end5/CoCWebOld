...
package classes.Scenes.Areas
{
	...
	public class HighMountains extends BaseContent
	{
		...
		public chickenHarpy():void
		{
			...
			menu();
			if (player.hasItem(consumables.OVIELIX, 2)) MainScreen.addButton(0, "Give Two", giveTwoOviElix);
			if (player.hasItem(consumables.OVIELIX, 3)) MainScreen.addButton(1, "Give Three", giveThreeOviElix);
