...
package classes.Scenes.Areas.Lake
{
	...
	public class FetishCultistScene extends AbstractLakeContent
	{
		...
		public cultistRapesYou():void
		{
			...
			if (player.lowerBody == LOWER_BODY.CENTAUR || player.lowerBody == LOWER_BODY.NAGA) {
				//Special centaur version by Astronomy
				if (player.lowerBody == LOWER_BODY.CENTAUR && player.lowerBody.balls > 0 && player.totalCocks() > 0 && rand(4) < 3) {
					if (player.lowerBody.cockSpot.list[0].cockType == CockType.HORSE) {
						...
						MainScreen.text("As she stands there, she sets her stool down beside her. With a hungry grin, she snaps the buttons to her overalls off and lets them fall down around her feet, revealing her cunt. She grips the bottom of her t-shirt and pulls it up and off of her, tossing it to the side. You can see she's got a big pair of tits, roughly DD-cup you guess. You feel confused as she walks up to you and starts to stroke her hands along your torso, feeling the shape of your 'human' upper body with her fingers. You know what she's planning and whicker excitedly, eager for her to get on with it. The girl leans her head into your torso and kisses the skin gently, her tongue slipping beyond her lips to taste your skin. You gasp in surprise as you feel the warm tickle of her tongue on your " + player.skinDesc + ". Your " + cockDescript(0) + " twitches beneath you, surging with blood as it fills to full erectness.  She kisses you again, licking her tongue over more of your body this time. You gasp again, her touches and kisses arousing you as you feel a light sweat break out over your skin. Seeing the beads of moisture beginning to drip from you, she hungrily licks across your skin, tasting you as she closes her eyes and sighs with joy.  An animalistic hunger grows from your crotch as your " + cockDescript(0) + " gradually throbs, growing harder and harder. The zoo-keeper presses herself right up against you, her breasts squishing against your skin as she rubs herself over you, clearly getting more and more aroused herself at the feel of your bestial body.\n\n", false);
						...
						//(ending after all cultist rape scenes)
							...
							if (player.armorValue > 0) MainScreen.text("You find your " + player.armorName + " back on your body with no sign of the strange clothes you were wearing before.  ", false);
							else MainScreen.text("You are still wearing the " + player.armorName + " that she gave you, and there is no sign of your old clothes.  ", false);
				...
				//Naga
				else if (player.lowerBody == LOWER_BODY.NAGA) {
					...
					//boy's surprise
						...
						MainScreen.text("your " + multiCockDescriptLight() + " poke out of your pelvic slit, growing to full erectness.  You strain against your bonds, desperate to bring release to ", false);
						if (player.totalCocks() > 1) MainScreen.text("each of ", false);
						MainScreen.text("your " + multiCockDescriptLight() + ", but there is nothing you can do and you keeper laughs at you.  \"<i>Oh so eager to bury that eager cock of yours inside my snatch?  Too bad, I'm the one who gets to choose what goes in there, and it's not your cock.</i>\" she says to you, clearly enjoying the frustration you're going through.\n\n", false);
					}
					//girl's surprise
			...
			if (rand(2) == 0 && !sexed) {
				...
				if (player.lowerBody == LOWER_BODY.CENTAUR) {
					...
					if (player.lowerBody.cockSpot.count() > 0) MainScreen.text("  As you see your " + multiCockDescriptLight() + ", 'incredibly large' is the only qualifier you can think of.", false);
				}
				MainScreen.text("\n\n", false);
				...
				if (player.upperBody.chest.BreastRatingLargest[0].breastRating > 1 && !changed) {
					...
					if (player.upperBody.chest.count() == 2) MainScreen.text("Once about a quarter of the fluid has been injected into the first breast, she moves on to the second and you feel a similar sharp pain followed by the glowing pleasure.  She continues this until all of your " + player.allBreastsDescript() + " have been injected.  ", false);
					//[if the player has three rows of breasts]
					if (player.upperBody.chest.count() > 2)  MainScreen.text("Once about a sixth of the fluid has been injected into the first breast, she moves on to the second and you feel a similar sharp pain followed by the glowing pleasure.  She continues this until all of your " + player.allBreastsDescript() + " have been injected.  ", false);
					MainScreen.text("Soon the glowing pleasure fills your breasts completely and you feel an orgasm shoot through your body as your " + player.allBreastsDescript(), false);
					//[if breasts are already lactating]
					if (player.biggestLactation() >= 1) MainScreen.text(" start lactating even more.  ", false);
					//[if breasts are not lactating]
				...
				//(ending after all cultist rape scenes)
					...
					if (player.armorValue > 0) {
						MainScreen.text("You find your " + player.armorName + " back on your body with no sign of the strange clothes you were wearing before.  ", false);
					}
					else MainScreen.text("You are still wearing the " + player.armorName + " that she gave you, and there is no sign of your old clothes.  ", false);
					MainScreen.text("The ordeal has also left you with a slightly dulled mind, and some of the desire you felt still lingers.  ", false);
					player.orgasm();
				...
				if (player.lowerBody.vaginaSpot.count() > 0 && player.lowerBody.cockSpot.count() > 0) {
					MainScreen.text("You see your " + player.armorName + " becoming a nice, comfortable outfit of a white shirt and black pants that make you look well-suited to work in a manor... if they didn't have an exposed crotch and butt that puts your " + multiCockDescriptLight() + ", your " + vaginaDescript(0) + ", and your " + buttDescript() + " on full display.  Any undergarments you had are now gone.\n\n", false);
					...
					MainScreen.text("After a minute of this, she stops you and says, \"<i>Good; I am now ready to have you inside of me, toy.  Lie down and start fingering your " + vaginaDescript(0) + " while I use the " + multiCockDescriptLight() + " that I keep you here for.</i>\"\n\n", false);
					MainScreen.text("With your hands slightly trembling in anticipation, you lie down and grab at your very erect " + multiCockDescriptLight() + " just before you slip your fingers into your " + vaginaDescript(0) + ", ready to please your mistress the best way you can.  You watch your mistress rise off her chair and slowly lower herself onto your " + cockDescript(0) + ", moaning in pleasure.  Her interior is so familiar and so wonderful.  You increase the pace that your fingers plunge into your depths, moaning in the way you know your mistress loves. She starts to rock back and forth, your " + cockDescript(0) + " bringing her to the height of ecstasy. ", false);
					//[if player has 2 dicks] 
					if (player.lowerBody.cockSpot.count() == 2) MainScreen.text("Your " + cockDescript(1) + " rubs against her skin pleasantly.  ", false);
					//[if player has more than 2 dicks] 
					if (player.lowerBody.cockSpot.count() > 2) MainScreen.text("The rest of your " + multiCockDescriptLight() + " rubs against her skin pleasantly.  ", false);
					...
					if (player.lowerBody.cockSpot.count() > 0 && (player.lowerBody.vaginaSpot.count() == 0 || rand(2) == 0)) {
						MainScreen.text("  You see that your " + player.armorName + " have become a nice looking, if simple, frilled white shirt and bow tie along with black pants and matching shoes.  They make you look like you would be at home in a manor attending the needs of a noble, if it were not for the flaps on the front and back of your pants that give easy access to your " + multiCockDescriptLight(), false);
						if (player.lowerBody.vaginaSpot.count()) MainScreen.text(", your " + vaginaDescript(0) + ",", false);
						MainScreen.text(" and your " + buttDescript() + ".  Any undergarments you had are now gone.\n\n", false);
						...
						MainScreen.text("After a minute of this, she stops you and says, 'Good, I am now ready to have you inside of me boy.  Show me your " + multiCockDescriptLight() + " that I keep you here for.'\n\n", false);
						MainScreen.text("With a cry of joy you lift the front flap on your pants revealing your very erect " + multiCockDescriptLight() + " and lie on the ground ready to please your mistress the best way you can.  You watch your mistress rise off her chair and slowly lower herself onto your " + cockDescript(0) + " moaning in pleasure.  Her interior is so familiar and so wonderful.  ", false);
						if (player.lowerBody.vaginaSpot.count() > 0) MainScreen.text("You feel desire start to well up in your " + vaginaDescript(0) + ", but you resist the urge to act on it; that's not why your mistress keeps you. ", false);
						MainScreen.text("She starts to rock back and forth, your " + cockDescript(0) + " bringing her to the height of pleasure. ", false);
						if (player.lowerBody.cockSpot.count() == 2) MainScreen.text("Your " + cockDescript(1) + " rubs against her skin pleasantly.  ", false);
						if (player.lowerBody.cockSpot.count() > 2) MainScreen.text("The rest of your " + multiCockDescriptLight() + " rub against her skin pleasantly.  ", false);
					...
					//(variant 2: maid, requires vagina)
						...
						MainScreen.text("You see that your " + player.armorName + " have become an apron over a plain dress with high stockings and simple black shoes.  They make you look like you would be at home keeping a manor clean and tidy, if it were not for the rather short skirt and lack of undergarments that give easy access to your " + vaginaDescript(0), false);
						//[if player has a dick] 
						if (player.lowerBody.cockSpot.count() > 0) MainScreen.text(", your " + multiCockDescriptLight() + ",", false);
						MainScreen.text(" and your " + buttDescript() + ".\n\n", false);
						...
						MainScreen.text("'I'm glad to see you remember your place.  I wish you to first rub my feet, then move up my legs, and finally, start relieving the tension in my lower lips with your capable hands.'\n\n", false);
						MainScreen.text("Eager to please your mistress, now reclining on a lovely chair, you crawl to her, remove her shoes, and start to massage her feet.  Your hands seem to move with the will of some outside force and they expertly work to please your mistress.  Pushed on by her approving groans, you work your way up her legs, removing clothing as you go, until you reach her hips.  There, to your mistress' great delight, you run your hands over her hips, butt, and then start to rub her hips, lower lips, and clit.\n\n", false);
						MainScreen.text("After a minute of this, she says, 'Good.  Now finger yourself before me, girl.  Show me that " + vaginaDescript(0) + " that I keep you here for.'\n\n", false);
						MainScreen.text("You lay back on the ground and raise your skirt, showing off your engorged " + clitDescript() + " and " + vaginaDescript(0) + ".  With a pleased squeal you plunge your fingers into your waiting " + vaginaDescript(0) + " and start wriggling them around in the way that your mistress loves.  ", false);
						//[if player has a dick]
						if (player.lowerBody.cockSpot.count() > 0) MainScreen.text("You feel a desire rising in your erect " + multiCockDescriptLight() + " but you ignore it; that's not what your mistress told you to play with.  ", false);
				...
				if (player.gender == 0) {
					MainScreen.text("You see that your " + player.armorName + " have become a nice and comfortable outfit of a shirt white and black pants, that make you look well suited to work in a manor.  However, you notice that there is a flap on your pants that gives easy access to your " + buttDescript() + ".\n\n", false);
		...
		public playerRapesCultist():void
		{
			...
			if (monster.armorName == "pervy nun's clothing") {
				...
				if (player.lowerBody.cockSpot.count() > 0 && (player.gender != 3 || rand(2))) {
					...
					if (player.lowerBody == LOWER_BODY.CENTAUR) MainScreen.text("You command her to get on all fours, then cover her and push ", false);
					...
					MainScreen.text(multiCockDescriptLight() + " into her waiting love hole.  ", false);
					if (player.lowerBody.cockSpot.count() > 1) {
						MainScreen.text("You thrust once, before using one of your hands to guide the second of your " + multiCockDescriptLight() + " inside her.  You are rather surprised at how easily she seems to accommodate your size", false);
				...
				else if (player.lowerBody.vaginaSpot.count() > 0 && player.lowerBody != LOWER_BODY.CENTAUR) {
					MainScreen.text("She meekly lies back on the ground and spreads her legs, one slightly in the air.  You have a clear view of her needy hole through the large opening in her clothing.  \"<i>My lord, please scissor me!</i>\" she begs you.  You stand and stride over to her. \"<i>Yes little girl, accept my divine lips on your pussy,</i>\" you reply.  You grab the leg she had in the air and pull yourself between her legs, pressing your " + vaginaDescript(0) + " against her own.  With a firm tug on her leg, you begin to push and rub your pussies together in earnest, and her eager moans soon fill the air.  The cultist climaxes unexpectedly quickly, and the feeling soon rushes through you as well.  You pull back and the cultist slumps onto the ground contentedly.  Looking at the cultist you wonder if she was able to make you spontaneously orgasm just from having an orgasm herself, or if she has the power of a real sex god?\n\n", false);
				}
				//Horsey
				if (player.lowerBody.vaginaSpot.count() > 0 && player.lowerBody == LOWER_BODY.CENTAUR) {
				...
				if (flags[FlagEnum.PC_FETISH] > 0) MainScreen.text("Given your experience with Ceraph, you can definitely understand why she is having so much fun showing off her body.  In fact, you think you'll start to do the same.", false);
				...
				//(if player has a dick)
				if (player.lowerBody.cockSpot.count() > 0 && (player.gender != 3 || rand(2))) {
					MainScreen.text("Telling her that she is going to please you whether she wants to or not, you reveal your " + multiCockDescriptLight() + ".  She screams for help and starts struggling against your grip, but you tell her that no one is going to save her now.  Easily overpowering her, you force her to the ground with no care for her comfort and start tearing off her clothes.  Once you have a clear view of her love hole, you look back up at her face and see that she has stopped struggling and is now crying.  ", false);
					//[if not corrupted] 
					...
					MainScreen.text("Filled with new determination, you push your " + cockDescript(0) + " into her love hole and start to rape her roughly.  Despite the tears, she starts moaning, clearly enjoying the rough treatment.  A little while into the rape, she starts to move against you, almost lovingly.  It is quite clear that she has a lot of experience, but is giving you free reign to do whatever you want.   Feeling in complete control, you decide that this game isn't too bad.  Before long you reach your orgasm and you blow your load deep inside her.", false);
				...
				//(if player has a vagina)
					...
					MainScreen.text("Telling her that she is going to please you whether she wants to or not, you reveal your " + vaginaDescript(0) + ".  Pushing your " + clitDescript() + " to her mouth, you order her to lick you if she wants you to leave her mother alone.  ", false);
					...
					MainScreen.text("A few minutes later, you close your " + player.armorName + " back up, and look back at the cultist.  She is lying on the ground in her farm hand outfit with a look of utter bliss on her face.  Satisfied, you continue on your way.", false);
					player.orgasm();
				}
				if (player.gender == 0) {
		...
		private plugSwimsuitVag():void
		{
			...
			MainScreen.text("When you push your " + cockDescript(x) + " inside her, she goes absolutely insane underneath you.  She squirms and wriggles all over your " + cockDescript(x) + ", as you ", false);
		...
		private swimsuitVibrators():void
		{
			...
			if (player.vaginalCapacity() <= 30) {//PC does not have a very loose or looser vagina)
				...
				MainScreen.text("she puts the vibrating toy to the entrance to your " + vaginaDescript(0) + ".  The next instant leaves you on your back as the cultist roughly shoves the thing inside you, forcing you to painfully stretch around the toy.", false);
				//if (PC was a virgin)
			...
			//It fits!
				...
				MainScreen.text("The cultist shows you how to activate the toy and they hum to life.  Quivering slightly, the two of you push the vibrating toys deep inside of yourselves.  The feeling of the toy filling up your " + vaginaDescript(0) + " is quite an experience.  ", false);
		...
		{
			MainScreen.text("", true);
			MainScreen.text("You remove your " + player.armorName + ", standing naked in front of the beaten fetish-girl with your lactating " + breastDescript(0) + " dripping milk. You pick the cultist up and sit down on the ground with her resting on your lap, her soft warm ass up against your thighs. You hold the nipple up to her mouth; she suckles on it without the slightest sign of rebellion.\n\n", false);
			...
			MainScreen.text("Soon her thong becomes wet with arousal and her mouth comes off your " + nippleDescript(0) + " to ask, \"<i>Please " + player.mf("Master", "Mistress") + ", will you fix the aching in my loins?</i>\"\n\n", false);
			...
			if (player.lowerBody.cockSpot.hasCock()) {
				...
				MainScreen.text("our " + multiCockDescriptLight() + " becomes fully erect as it rubs up against her warm ass cheeks, which is enough to fulfill its desire.   Her cum bubbles into the palm of your hand while your cum drizzles her ass with sticky whiteness.\n\n", false);
			}
			//[ELSE Pussy]
