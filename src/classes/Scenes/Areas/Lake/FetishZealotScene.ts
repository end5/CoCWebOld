		...
		public zealotLossRape():void
		{
			...
			if (broseph == "dude") {
				...
				if (player.lowerBody.cockSpot.count() > 0) {
					MainScreen.text(multiCockDescriptLight() + ".  You feel yourself grow hard ", false);
				...
				if (player.lowerBody.cockSpot.count() > 0) {
					MainScreen.text(", and your " + multiCockDescriptLight() + " start", false);
			...
			if (broseph == "dude") {
				MainScreen.text("You're standing in front of your student behind your desk in your empty classroom.  You are in regular teacher's attire: an open vest and tie over your otherwise bare " + player.allBreastsDescript() + ", with formal dress pant legs attached to your vest with suspenders, plus your black dress shoes for dancing.  Your student is wearing the standard male student uniform, a collection of pieces of material held together with straps, that will all fall away easily when one gets pulled; but otherwise gives full coverage.\n\n", false);
				...
				if (player.gender != 0) {
					...
					if (player.lowerBody.vaginaSpot.hasVagina()) MainScreen.text("You slip one of your fingers inside your " + vaginaDescript(0) + ", wishing that it could get some attention, but this lesson is about pleasing <i>men</i>.  ", false);
					...
					//jerking off contest
					MainScreen.text("He eagerly stands up and wraps his hands around his fine cock, you quickly try to do the same with your " + multiCockDescript() + ".  \"<i>I won't lose to you so easily, professor!</i>\" he declares to you, \"<i>Don't act so confidently on your first time.</i>\" you reply.  Then the two of you are madly jerking yourselves off in a mad effort to get off before the other, your respective cocks already moist from the blowjobs they just received.  ", false);
					//just one cock
					if (player.totalCocks() == 1) {
						MainScreen.text("You piston your hands on your " + cockDescript(0) + ", ", false);
					}
					//nope two
					else if (player.totalCocks() == 2) {
						MainScreen.text("With one hand on each of your " + multiCockDescriptLight() + ", you piston them like mad, ", false);
					}
					//oh no, is more than that
					else {
						MainScreen.text("Rapidly moving your hands between each rod in your " + multiCockDescriptLight() + ", you manage to piston each of them at an incredible rate, ", false);
					}
				...
				if (player.gender != 0) {
					...
					MainScreen.text("You take a hold of his nicely sized balls in one hand and the base of his cock in the other.  You give the tip a few licks before running your tongue down its length,  making sure to coat every bit of it in your saliva along the way.  His aroused groans let you know that you are giving a good demonstration.  You give his balls a soft rub as you stick the end inside your mouth and run your tongue around it; the taste of his pre is almost like candy to you.\n\n", false);
					//cunalinguss
					MainScreen.text("You stand up and indicate that it is now his turn, and while he is disappointed that the blowjob ended before he came, he still eagerly kneels down in front of your " + vaginaDescript(0) + ".  You gingerly lift up your skirt ", false);
					if (player.lowerBody.balls > 0) {
						MainScreen.text("and move your " + ballsDescriptLight() + " out of the way ", false);
					}
					MainScreen.text("so he has access to your " + vaginaDescript(0) + ".  He sets to work, and you give him careful instructions on where to lick, how hard, and such.  He easily catches on, and soon he is probing all the right places, and giving the right amount of attention to every part of you.  ", false);
					if (player.lowerBody.cockSpot.count() > 0) {
						MainScreen.text("You give your " + multiCockDescriptLight() + " a few gentle strokes, wishing he would give that a little attention too, but this is a lesson on how to please a <i>woman</i>.  ", false);
					}
					MainScreen.text("You feel yourself getting close to the edge and tell him to stop.  He looks up at you uncertain for a moment, and you tell him \"<i>It's time for the main event.</i>\"\n\n", false);
					//prick in the twat
					MainScreen.text("He eagerly stands up and starts to push you back against your desk, his fine cock already inside your " + vaginaDescript(0) + ".  He pushes you onto your back and grabs ahold of your legs, starting to make strong thrusts deep inside you, his cock seeming to fit your " + vaginaDescript(0) + " perfectly.  Any pretense of professionalism is lost in the moment, as all you can care about is the feeling of his exquisite cock perfectly filling you, pushing in and out.  All too soon, you hear him gasp, and the wonderful feeling of sweet release fills you.  ", false);
					if (player.lowerBody.cockSpot.count() > 0) {
						MainScreen.text("Your " + multiCockDescriptLight() + " spasms and covers you with a liberal amount of your own fluids.  ", false);
					}
...
//Raped by the player
		private zealotWinRape():void
		{
			...
			if (player.lowerBody.cockSpot.count() > 0 && (player.gender != 3 || rand(2) == 0)) {
				...
				MainScreen.text("Your lusts sated for now, you rise up off of him and put your " + player.armorName + " back on.  You decide to leave him lying there, still doubled over in pain from the damage you did to his balls.\n\n", false);
			}
			//If player has a vagina, again, if both, chose one at random
				...
				MainScreen.text("Your lusts sated for now, you rise up off of him and put your " + player.armorName + " back on.  You decide to leave him lying there, still coughing from the blow to his stomach.  ", false);
