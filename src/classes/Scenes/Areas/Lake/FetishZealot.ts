...
//Special1: Tease
	...
	private function zealotSpecial1():void {
		...
		if(armorName == MILITARY_CLOTHES) {
			...
			//[player is corrupt] 
			if(player.stats.cor > 50) outputText("You eagerly cry out \"<i>Yes, sir!</i>\" and show yourself off to the best of your ability.  The whole act is extremely arousing.", false);
	...
	private function zealotSpecial2():void {
		...
		override protected function postAttack(damage: number):void
		{
			if (damage > 0){
				...
				if (player.stats.int > 50) outputText(", was there some kind of aphrodisiac on the knife?", false);
