...
//goo-girl Bad End – If the player loses to 3-5 goo encounters while under full goo Transformation
		...
		private function gooGirlBadEnd2():void
		{
			...
			if (player.lowerBody.cockSpot.hasCock()) outputText("A pseudopod extends from your crotch, a gooey penis the size of a minotaur. It snakes through the air toward the girl, its tip flaring to expose a wide, urethra-like opening.  ", false);
		...
		public function beatUpGoo():void
		{
			...
			if (player.gender == 0 || player.lust < 33) {
				...
				if (valeria != null) {
					...
					if (flags[FlagEnum.TIMES_VALERIA_GOO_THREESOMED] == 0) outputText("Do you offer a threesome with the girl to Valeria? It could get a little weird....");
...
//[Feeder perk] 
		private function victoryRapeAGooGalAsFeeder():void
		{
			...
			if (player.lowerBody.vaginaSpot.hasVagina()) outputText("Even without stimulation, your clit practically vibrates under your climax, squeezing your body to its limits until everything fades into a pearl haze and you lose yourself to the euphoria.\n\n", false);
			else if (player.lowerBody.cockSpot.hasCock()) if (player.lowerBody.vaginaSpot.hasVagina()) outputText("Even without stimulation, your cock practically vibrates under your climax, squeezing your body to its limits until everything fades into a pearl haze and you lose yourself to the euphoria.\n\n", false);
			else if (player.lowerBody.vaginaSpot.hasVagina()) outputText("Even without stimulation, your tingling anus practically vibrates under your climax, squeezing to its limits until everything fades into a pearl haze and you lose yourself to the euphoria.\n\n", false);
