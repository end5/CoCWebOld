...
package classes.Scenes.Areas
{
	...
	public class Mountain extends BaseContent
	{
			...
			if (chooser == 1) {
				...
				if (player.findStatusAffect(StatusAffects.MinoPlusCowgirl) < 0 || rand(10) == 0) {
					if (flags[FlagEnum.HAS_SEEN_MINO_AND_COWGIRL] == 1 && player.horns > 0 && player.hornType == HORNS.COW_MINOTAUR && player.upperBody.head.earType == EARS.COW && player.tailType == TAIL.COW && player.lactationQ() >= 200 && player.upperBody.chest.BreastRatingLargest[0].breastRating >= 3 && player.minotaurAddicted()) {
						...
						if (player.lowerBody.vaginaSpot.hasVagina()) outputText("dampens");
						else outputText("twinges");
						outputText(", aching to be filled");
						if (player.lowerBody.cockSpot.hasCock()) outputText(", while [eachCock] rises to attention, straining at your [armor]");
						outputText(".");
		...
		private function joinBeingAMinoCumSlut():void
		{
			...
			if (player.lowerBody.vaginaSpot.hasVagina()) outputText("swirls around your clitoris");
			...
			if (player.lowerBody.cockSpot.hasCock()) outputText(", once again ignoring your manhood completely");
			outputText(", dives tongue first into your wet ");
			if (player.lowerBody.vaginaSpot.hasVagina()) outputText("quim");
			...
			if (player.lowerBody.vaginaSpot.hasVagina()) outputText("sodden box");
			...
			if (player.lowerBody.vaginaSpot.hasVagina()) outputText("within your womb, knocked up by this manly beast");
			...
			if (player.lowerBody.vaginaSpot.hasVagina()) outputText("cow-pussy");
			else outputText("ass");
			...
			if (player.lowerBody.vaginaSpot.hasVagina()) outputText("g-spot");
			else outputText("prostate");
			outputText(" as the minotaur's wide flare strokes it through your ");
			if (player.lowerBody.vaginaSpot.hasVagina()) outputText("vaginal");
			...
			if (player.lowerBody.vaginaSpot.hasVagina()) outputText("womb");
			else outputText("back door");
			...
			if (!player.lowerBody.vaginaSpot.hasVagina()) outputText("new ");
