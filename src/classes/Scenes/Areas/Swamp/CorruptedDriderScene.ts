...
//*Encounter Intro (done)
		public driderEncounter():void
		{
			...
			//repeat intro:
				...
				if (player.tailType > TAIL.NONE) MainScreen.text("tail ", false);
...
//*Victory Rape: PC Penis goes in Vagina (done)
		private winDriderPCDickInSpiderCunt():void
		{
			...
			MainScreen.text("Eager to plumb the depths of this greedy spider's snatch, you practically tear your way out of your " + player.armorName + " in your hurry to get naked.  Through it all ", false);
			if (monster.lust > 99) {
			...
			else MainScreen.text("Your " + cockDescript(x) + " seems to bulge inside her, giving itself over to the silken caresses of her glorious vagina.", false);
			...
			MainScreen.text(" breasts mash against your " + allChestDesc() + ", sweaty skin sliding back and forth and drawing gasps from each of you every time one of her nipples brushes one of yours.  She coos, \"<i>Please fuck my slutty drider-cunt harder, " + player.mf("master", "mistress") + "!  It was so naughty and cruel when I tried to rape you.  Don't let me cum... deny me over and over until I'm your good little spider-pet that'll do anything for release!</i>\"  She emphasizes every sentence by clamping her quim down on your " + cockDescript(x) + ", the dozens of lubricant-soaked folds rolling back and forth, milking you until you cannot help but ejaculate inside her.\n\n", false);
			...
			MainScreen.text("While you're distracted by the repeated contrast of tension and relief emanating from " + sMultiCockDesc() + ", the drider leans up and kisses your neck, humming against your throat as you squirt the last of your orgasmic goop into her vagina.  You slump into her arms, spent by the effort of fucking her so fast and cumming so hard.  As you lie there, her lips sucking hard enough to leave hickeys on your neck with every crushing, passionate kiss, you feel the patterns of glossy fluid tingling on your " + player.skin() + ".  A jolt of fear runs up your spine, and you try to push away from her envenomed affections.  It doesn't work!  You can barely lift your arms, let alone pull out of the amorous arachnid's embrace!\n\n", false);
			...
			else MainScreen.text("No, that's not right.  You're not some rutting beast, you're the champion.  Sure, you've got your " + cockDescript(x) + " locked hilt-deep inside her squirming slit, but that doesn't mean you're some kind of " + player.mf("stud", "slut") + " who jumps on a cunt without a second thought, does it?  You blink your eyes while you try to think.  She does have a point though, if you hadn't been in such a hurry for some sex, you wouldn't be sagging into her tits and feeling so awfully relaxed.\n\n", false);
			...
			MainScreen.text("A plaintive whining, almost exactly like that of an animal, vocalizes subconsciously.  Your " + cockDescript(x) + " feels afire, constantly leaking pre-cum while you're held immobile in your spidery mistress' arms; you lick your lips and start to beg, mumbling out your desire to cum for her, anything for her, so long as she lets your dick orgasm again and again.  You want to climax so bad, but you want her to control your cock so much more.  It's always getting you in trouble, and it feels so good to let her use you as her cum-drooling mount.\n\n", false);
			...
			MainScreen.text("You mewl out an affirmation, forgetting how to speak with all the venom pumping through you and the mind-crushing levels of arousal pouring out of your " + cockDescript(x) + ".\n\n", false);
...
//Part 2 of the above
		private winDriderPCDickInSpiderCunt2():void
		{
			...
			MainScreen.text("A low growl rips through your throat as you pull back and plaster her face white, coating the caked-on residue of a few previous loads with fresh moisture.  You shift position and force your " + cockDescript(x) + " between her two pairs of breasts, sandwiching it in there for the titty-fuck of a lifetime.  Pistoning back and forth, humping the glorious orbs relentlessly, you give yourself over completely to your sore dick, letting your world dissolve into the feelings of each of the spider-woman's orifices around your member.\n\n", false);
...
//*Victory Rape: Ride Spider-Cawk in Vagoo (done)
		private winVSDriderTakeItsCockInCunt():void
		{
			...
			if (player.tongueType > TONUGE.HUMAN) MainScreen.text(" as the rest of its demonic length lashes out and wraps around her pillowy bosom", false);
...
//*Victory Rape: Ride Ovi Vaginal (done)
		private victoryVSDriderRideOviVaginal():void
		{
			...
			player.slimeFeed();
			MainScreen.text("Eyeing the small lump of the spider's retracted ovipositor, you resolve to have a little fun with it, even if it means giving the spider exactly what she wants in a way that she doesn't.  You tear off your " + player.armorName + " while the drider watches with ", false);
			...
			if (monster.HP < 1) {
				...
				if (player.lowerBody.cockSpot.hasCock()) MainScreen.text(" and " + sMultiCockDesc() + " twitch", false);
			...
			MainScreen.text("  You gasp, arching your back and sliding your " + vaginaDescript() + " forward, as if your quim could somehow devour the entire length on its own.\n\n", false);

			MainScreen.text("Once you get about halfway down the drider's ovipositor, it stops sliding in so easily, leaving you to hump away at the drider's abdomen in a futile quest for further penetration.  You mewl in disappointment and prepare to pull back and fuck the portion you've already taken like no tomorrow.  The flexible shaft undulates, then pistons forward, spear-like.  You feel your " + vaginaDescript() + " stretching wide, then relaxing as one of the segmented rings nestles into your canal's sopping embrace.  A fresh gush of green slime sprays out of your tightly-stretched labia, strings of the stuff shooting fanwise over the drider's glossy, black abdomen.", false);
			...
			if (player.lowerBody.cockSpot.hasCock()) {
				MainScreen.text("  Your own " + multiCockDescriptLight() + " retaliate", false);
...
//*Victory Rape: Ride Ovi Anal sex-insenitive (done)
		private victoryVSDriderRideOviAnal():void
		{
			...
			if (player.lowerBody.cockSpot.hasCock()) {
				MainScreen.text("  The warm organ brushes past your prostate, the slippery caress making " + sMultiCockDesc() + " dribble a ", false);
			...
			if (player.lowerBody.vaginaSpot.hasVagina()) {
				MainScreen.text("  Your " + vaginaDescript(0) + " quivers", false);
				if (player.wetness() >= 3) MainScreen.text(" and drips", false);
				MainScreen.text(" sympathetically with the sensation, and your " + clitDescript() + " peeks from the wet lips.", false);
			}
			...
			if (player.lowerBody.vaginaSpot.list[0].clitLength >= 4 && player.lowerBody.vaginaSpot.hasVagina()) MainScreen.text(", and pressing your monster chick-stick into it; the gooey heat sends a tingle of shock up your spine and your pussy convulses", false);
			...
			if (player.lowerBody.cockSpot.hasCock()) MainScreen.text("while your " + multiCockDescriptLight() + " dribbles white, wasted goo onto the black and " + monster.hairColor + " striped carapace below", false);
			else if (player.lowerBody.vaginaSpot.hasVagina()) MainScreen.text("while your " + vaginaDescript(0) + " dribbles fem-slime onto the black and " + monster.hairColor + " striped carapace below", false);
			else MainScreen.text("while your fingers tweak your " + nippleDescript(0) + "s and your starved sphincter sucks at its slimy, squirming stuffing", false);
			MainScreen.text(".  Without warning, the ovipositor dilates, pulling your " + assholeDescript() + " even wider.  An explosion of warmth goes off in your guts, and you realize that your term as an incubator has begun with a sense of perverse delight.\n\n", false);
...
//(please view the spinneret as a spider-horsecock because for all intents and purposes that is really what it is) - shambadibs (1.5-inch width max because i'm racist against buur-bous american penis) (also probably a corruption minimum this is a pretty dick move) (I GET IT)
		private victoryVSDriderStickDickInSpinneret():void
		{
			...
			if (player.upperBody.chest.BreastRatingLargest[0].breastRating >= 3) MainScreen.text("  The semi-sticky stuff soaks into the cleavage of your " + player.allBreastsDescript() + ", the feeling surprisingly enjoyable.  You even knead the web in a bit, biting your bottom lip from the sensation.", false);
			...
			MainScreen.text("\n\n", false);
			MainScreen.text("Your lust sated, you disengage from her with a little pop, leaving her to lick her lips happily and groan unintelligible babble.  You wipe your " + cockDescript(x) + " off on her hair to clean it off a bit, then redress and head out.  With a glance at the snoozing drider over your shoulder, you head out of the smelly swamp and start back towards camp.", false);
			player.orgasm();
			dynStats("cor", .5);
			cleanupAfterCombat();
		}
...
//*Loss Ride Ovi Anal unsexed - gats (done)
		private loseVSDriderGetAnalledOvi():void
		{
			...
			MainScreen.text(" slapping against her slavering cunt.  She grabs on to your " + hipDescript() + ", using you as leverage to pump her pole inside of you while you jerk against the ground, eyes closed tight while your cheek rubs against the cold dirt.\n\n", false);
			...
			if (player.tallness < 66) MainScreen.text(player.face() + ", sliding down across your cheeks and along your lips", false);
			else MainScreen.text("chest, trickling between your " + nippleDescript(0) + "s", false);
...
//*Loss Vaginal Impregnation and forced BJ - Symphonie (done)
		private loseVSDriderAndVaginallyImpreggleOvi():void
		{
			...
			if (player.isBiped() || player.isGoo()) MainScreen.text("down onto your back", false);
			...
			if (!player.isNaga()) MainScreen.text("pull your own " + player.feet() + " apart", false);
			...
			if (!player.isNaga()) {
				...
				if (player.isTaur()) MainScreen.text("rear ", false);
				MainScreen.text(player.legs() + " and pinning you in that prone, separated position", false);
			}
			...
			if (!player.isTaur()) MainScreen.text("wrists", false);
			...
			if (!player.isTaur()) MainScreen.text("Her fingers then move to the sides of your head, lacing webbing through your hair and sticking it firmly to the ground. More vulnerable than ever, you can't lift your head without ripping your hair from your scalp in chunks.", false);
			else {
				...
				if (player.upperBody.chest.BreastRatingLargest[0].breastRating > 4) MainScreen.text("With pain and then a pop, your " + player.allBreastsDescript() + " squash out to the sides as she presses your torso into your knees.  ", false);
			...
			if (player.lowerBody.cockSpot.hasCock() && monster.nipplesPierced > 0) MainScreen.text("  Chains brush over " + sMultiCockDesc() + " as her chest passes your crotch.", false);
			...
			if (player.lowerBody.cockSpot.hasCock()) MainScreen.text("  Even your " + cockDescript(0) + " spurts some pre-cum of its own.", false);
			...
			if (!player.isTaur()) MainScreen.text(", cutting your head loose from the imposed bondage with sharp, hard fingertips", false);
			...
			if (!player.isTaur()) MainScreen.text("land against the ground", false);
...
//*Loss Ride & Impregnate Butt (done)
		private loseVSDriderAndGetFuckedANDAnalImpreggegity():void
		{
			...
			MainScreen.text("", true);
			if (player.lust > 99) MainScreen.text("Unable to resist the desire coursing through your body, you strip off your " + player.armorName + " and start stroking " + sMultiCockDesc() + ", displaying it in the hope that it will draw the drider's attention, while at the same time just trying to get yourself off and attain release.", false);
			else {
				MainScreen.text("You slump down, too beat up to mount an effective defense, let alone stay up on your " + player.feet() + ".  The drider skitters over to you and effortlessly peels you out of your " + player.armorName + ", exposing your ", false);
				if (player.lust < 50) MainScreen.text("soft", false);
			...
			MainScreen.text("  You shudder from the anal violation and twist against the legs holding you in place, but with your " + cockDescript(x) + " locked inside her, it's a useless endeavor.  It isn't shaped like a dick, and besides, that's currently dripping on your belly.  Oh gods... she mentioned eggs.\n\n", false);

			MainScreen.text("The strange organ keeps forcing its way deeper, slipping the steadily-widening, rib-like segments of its bulk into your " + assholeDescript() + ".  ", false);
			MainScreen.text("  Once it gets deep enough to push on your prostate, an upsurge of pleasure hits you hard enough to make " + sMultiCockDesc() + " dribble.  You moan against the drider's neck, pulsing pathetically inside the spider-woman's slit.  You know you'll soon be giving her exactly what she wants - all of it - and there's nothing you can do about it.\n\n", false);
			...
			MainScreen.text(".  Then, the constant application and release of pressure on your prostate utterly destroys the orgasmic timing of your muscles' contractions, making " + sMultiCockDesc() + " release a weak, but constant trickle of cum.\n\n", false);
...
//Summary: what goes up must come down
		public birthSpiderEggsFromAnusITSBLEEDINGYAYYYYY():void
		{
			...
			if (player.lowerBody.cockSpot.hasCock()) MainScreen.text(SMultiCockDesc() + " stays limp, but drools a heavy flow of semen, puddling up a nice thick batch of your pleasure alongside your goo-pile.  ", false);
			if (player.lowerBody.vaginaSpot.hasVagina()) {
				MainScreen.text("Your pussy clenches and ", false);
				if (player.wetness() < 3) MainScreen.text("drips", false);
				else if (player.wetness() < 4) MainScreen.text("dribbles", false);
				else if (player.wetness() < 5) MainScreen.text("gives a tiny squirt", false);
				else MainScreen.text("gushes a river of lady-spunk", false);
				MainScreen.text(" into the dirt, getting off along with your " + assholeDescript() + ".  ", false);
			}
		...
		public driderPregVagBirth():void
		{
			...
			if (player.isNaga()) MainScreen.text("At last, when no more eggs seem to be coming, you flop over onto your back, careful not to crush any of your dormant offspring.", false);
			...
			if (player.upperBody.chest.BreastRatingLargest[0].breastRating >= 2) {
				MainScreen.text("One drider girl cautiously makes her way over to you.  Her legs tickle your stomach as she climbs up to one of your " + breastDescript(0) + ".  Grasping the flesh tightly in her tiny hands she begins to suckle at your " + nippleDescript(0) + ".", false);
				if (player.bRows() > 1) MainScreen.text("  Following their sister's lead, more little driders take their place at each of your nipples and begin to drink.", false);
			...
			if (player.eyeType != EYES.FOUR_SPIDER_EYES) MainScreen.text("  Suddenly she flops forward, leaning against your eyebrows and causing you to cross your eyes in an attempt to focus on her.  She seems confused by the way your eyes are different to hers.", false);
			if (player.isNaga()) MainScreen.text("  A few baby driders crawl ponderously across your scaled tail.  You give your tail a little wiggle and suddenly they go wild crawling around it and letting out the faintest, cute little squeals.", false);
...
//Win Drider Male Anal (OH BABY)
		private buttFuckADriderOhBaby():void
		{
			...
			MainScreen.text("Without warning, the drider cums.  She cries out and grabs her fully-engaged corrupted cock, hosing down the trees in front of her with spider-cum as her butt squeezes down on your " + cockDescript(x) + ", milking your dick with her anal passage.  You pick up the tempo of your fucking to break-pelvis speeds, ramming your cock into her backdoor and letting loose a torrent of your spunk, shooting it deep inside her", false);
			//(if Vagina: 
			if (player.lowerBody.vaginaSpot.hasVagina()) {
		...
		private driderVagSmartFuck():void
		{
			...
			if (player.tailType == TAIL.SPIDER_ADBOMEN) {
				...
				if (player.isDrider()) MainScreen.text("scuttle");
