		...
		public function getBitten():void
		{
			...
			if (player.stats.spe < 2 && player.statusAffects.has("Web")) {
				...
				if (player.lowerBody.cockSpot.hasCock()) {
					...
					if (player.lowerBody.vaginaSpot.hasVagina()) outputText(" along with your " + player.vaginaDescript(), false);
					outputText(".  ", false);
				}
				else if (player.lowerBody.vaginaSpot.hasVagina()) outputText("Your " + player.vaginaDescript() + " grows wet as hell and so sensitive that every step and movement reminds you of the powerful need for something between your sopping nether-lips.  ", false);
