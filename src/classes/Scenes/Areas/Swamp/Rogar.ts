...
((Scenario 4, [Frot]))*/
	...
	public encounterRogarSwamp(): void {
		...
		spriteSelect(86);
		if (Flags.list[FlagEnum.ROGAR_PHASE] == 0) {
		...
		//((Ro'gar phase = 1)) (edited)
			...
			//((androgynous or masculine and breasts <= A-cup, libido less than 50))
				...
				if (player.stats.int < 30) MainScreen.text("leftovers from that fight in the swamp still linger on his body.", false);
				else MainScreen.text("it makes you wonder what Ro'gar was up to.", false);
				MainScreen.text("  Ro'gar follows your gaze, then his eyes glint oddly as he snickers.  \"<i>Care ta... return the favor?</i>\"  He slyly winks at you, eyes flicking from you to the bucket and back again.", false);
				//goto sexy choices
			}
			...
			//((androgynous or masculine and breasts <= A-cup))
				...
				//(if player has been to Tel'Adre)
					...
					//(if Dirt Mc Girt = 2) 
						...
						MainScreen.text("As you exit the door you suddenly feel a strong grip on your wrist, making you turn around.", false);
						//(if player height is shorter than 4 feet) 
						if (player.tallness < 48) MainScreen.text("  Hands hook under your armpits to lift you up gently.", false);
						//(if player height is taller than 7 feet)
						if (player.tallness >= 84) MainScreen.text("  A hand on your shoulder tugs you to lower your head.", false);
						MainScreen.text("  Lips press to yours and you taste Ro'gar's long, orcish tongue flicking out, trying to coax its way into your mouth.  With a faint moan you open wide, locking tongues with him as your eyes close in bliss.  You wrap your arms around the orc's neck in embrace, your hands curling around to hold him near.  His own strong hands carefully settle at your " + LowerBodyDescriptor.describeHips(player) + " roughly clenching down as his fingertips press over your " + ButtDescriptor.describeButt(player) + ".  The two tongues wrestle in your mouth before Ro'gar slowly pulls away.  \"<i>Thanks fer everythin', " + player.short + ".  Y'all take care.  I'll be keepin' my eyes peeled for ya.</i>\"  With his usual toothy grin he waves you off.\n\n", false);

						MainScreen.text("You wander toward your camp through the swamp, making it there without any problems beside the heat in your loins.", false);
	...
	private dontWaitForRogar(): void {
		MainScreen.text("", true);
		spriteSelect(86);
		MainScreen.text("Time passes with no sign of Ro'gar.  You decide it would be a waste of time to sit and wait for him, and head off in hopes of finding something interesting.\n\n", false);

		MainScreen.text("Instead, you find only more mud.  You return to camp.", false);
		//<set Crying Game = 1>
		Flags.list[FlagEnum.ROGAR_DISABLED] = 1;
		doNext(camp.returnToCampUseOneHour);
	}
	...
	private waitForChunkyOrcLoe(): void {
		...
		spriteSelect(86);
		if (Flags.list[FlagEnum.ROGAR_PHASE] == 0) {
			MainScreen.text("It feels like several hours pass with no sign of Ro'gar, but you decide to wait and use what little cloth you have to clean yourself off.  Eventually you hear the slow trod of heavy footsteps as Ro'gar comes into view with a smile on his face and a bucket and towel in his hands.  He sets the steaming bucket down as he draws near.  \"<i>Here ya go!</i>\" he says with a grunt, dipping the towel in the bucket.  He rubs your body with the towel to wipe away the mud for you, seeming not to realize - or perhaps, not minding - the intimacy of the gesture.\n\n", false);

			//((If libido is less than 50))
			if (player.stats.lib < 50) MainScreen.text("The hulking orc is surprisingly gentle as he cleans you like a young child.  The warm waters and careful touch soothe your tired muscles.  Your skin becomes textured with goose bumps as the tickles of droplets roll down your body and the filth is washed down to the waters below.  You find yourself sighing in relaxation from the treatment.  A smile curls your lips as you look down at Ro'gar, and he returns the pleased look with a toothy smirk.\n\n", false);
			//((If libido is 50 or more))
			else {
				MainScreen.text("  Something about the burly orc rubbing you down with warm water excites you.", false);
				if (player.lowerBody.vaginaSpot.hasVagina()) {
					MainScreen.text("  Your " + VaginaDescriptor.describeVagina(player, player.lowerBody.vaginaSpot.get(0)) + " starts to quiver as the warm water rolls over its lips, moistening in excitement as your skin is rubbed over by strong hands.  Your chest heaves as it relaxes to his touch, your " + BreastDescriptor.describeNipple(0) + "s becoming stiff under his rubbing.", false);
					MainScreen.text("  Even your " + LowerBodyDescriptor.describeFeet(player) + " and fingers curl as you smell the sweat and musk of Ro'gar's closeness, the animalistic scent arousing you.", false);
				}
				else if (player.lowerBody.cockSpot.hasCock()) MainScreen.text("  " + CockDescriptor.describeMultiCockSimpleOne(player, true) + " stirs to life, making it obvious how much you are enjoying the rub down, then begins to drool with lust.  Through lidded eyes you faintly make out Ro'gar's toothy smirk becoming a hungry grin.", false);
				dynStats("lus", 5 + player.stats.lib / 20 + player.stats.sens / 20);
				MainScreen.text("\n\n", false);
			}
			MainScreen.text("\"<i>Clean as a whistle.</i>\"  Ro'gar chuckles as he drops the towel in the bucket with a splash.  His face beams with pride at his work, chest puffing out as he looks you over.  He eyes you up and down again, and your curious look just makes him snicker.  \"<i>Don't meet too many friendly folk 'round here, but it would be nice to have a " + player.mf("feller", "lass") + " to talk with.</i>\"  After a few moments of awkward rummaging through his pocket he pulls out a scrunched up piece of paper and hands it to you.  \"<i>This's so you can find me.</i>\"  Ro'gar grins from ear to pointy ear.  You unfold the paper, and see a crudely drawn map that vaguely explains how to get to Ro'gar's hut.  You wonder if making this map was why he took so long.  \"<i>Y'all take care now, y'hear!</i>\" he hollers, turning summarily and walking away, waving over his shoulder at you as he tromps through his natural habitat.  You wander back to your camp, wondering if you should see him again.\n\n", false);

			MainScreen.text("<b>You can now find Ro'gar's hut when wandering the swamp occasionally!</b>", false);
			//pass 2 hours, set Ro'gar phase flag = 1
			Flags.list[FlagEnum.ROGAR_PHASE] = 1;
			doNext(camp.returnToCampUseTwoHours);
		}
	}
	...
	private noSlowBroIDontWantPokeSex(): void {
		...
		Flags.list[FlagEnum.ROGAR_DIRT] = 1;
		Flags.list[FlagEnum.ROGAR_PHASE] = 2;
		doNext(camp.returnToCampUseTwoHours);
	}
	...
	private okayBroLetsHaveAGayCarwash(): void {
		...
		else MainScreen.text("your " + ButtDescriptor.describeButthole(player), false);
		MainScreen.text(" as Ro'gar penetrates your mouth.  Soon the orc gives out a low groan and slams his cock down your throat, holding you impaled on the green monster as he begins pumping you full of thick seed.  You can feel the heavy spunk sliding down your throat and filling your stomach with each throatful of cum he pumps into you.  Eventually his member slips out of your soaked mouth and blasts the last few ropes out over your " + HeadDescriptor.describeFace(player) + ", 'dirtying' you with a starchy load as he promised.\n\n", false);

		MainScreen.text("\"<i>F-fuck, yer amazin', " + player.short + "!</i>\" Ro'gar pants heavily as his body lays out on the bed with eyes shut.  Your tongue flicks out against his spent orc cock, licking clean what you can, then you rub the globs of spooge from your " + HeadDescriptor.describeFace(player) + " before popping your cumslicked fingers into your mouth one by one.  You swirl the cum in your mouth before swallowing, the taste of the thick seed clinging to your tongue.  After you're done cleaning yourself and Ro'gar's mess, you notice the orc is snoring.  You chuckle, realizing just how exhausted he must have been.", false);
		//(int <30)
		if (player.stats.int < 30) MainScreen.text("  That fight between him and his opponent went on for quite a while, so it makes some sense.", false);
		MainScreen.text("  You smile warmly and plant a kiss wet with cum on Ro'gar's forehead, deciding to let him rest while you collect your things and head back to camp.  Your needy ", false);
		if (player.lowerBody.cockSpot.hasCock()) MainScreen.text("erection", false);
		else if (player.lowerBody.vaginaSpot.hasVagina()) MainScreen.text("pussy", false);
		else MainScreen.text("ass", false);
		MainScreen.text(" aches, each step of the way rubbing the sensitive", false);
		if (player.gender > 0) MainScreen.text(", drooling", false);
		MainScreen.text(" parts against the fabric of your clothes.\n\n", false);
		//<Lust increased, slimefeed,
		player.slimeFeed();
		player.stats.lust += 40;
		// set Dirt Mc Girt flag = 2 and Ro'gar phase = 2>
		Flags.list[FlagEnum.ROGAR_DIRT] = 2;
		Flags.list[FlagEnum.ROGAR_PHASE] = 2;
		if (player.stats.int < 30) doNext(camp.returnToCampUseTwoHours);
	...
	public rogarPhaseFour(): void {
		...
		if ((player.upperBody.chest.BreastRatingLargest[0].breastRating >= 2) && Flags.list[FlagEnum.ROGAR_WARNING] == 0) {
			MainScreen.text("Ro'gar the orc is drinking at the bar again, two crushed cans sitting by his half-empty one.  The bartender is casting irritated glances at them as though she'd like to throw them away, but doesn't dare take them from the enormous, burly orc until he finishes or leaves.  You tug on his cloak as you take a seat next to him, and he turns to you with a toothy smile.  That smile dims to a frown as he looks you over, eyes lingering on the womanly contours of your face", false);
			if (player.upperBody.chest.BreastRatingLargest[0].breastRating >= 2) MainScreen.text(" and your " + chestDesc(), false);
			MainScreen.text(".  \"<i>Gee, ya look... different.  Been samplin' some of the local foods, huh?</i>\"  You agree cautiously, and he flags the bartender over and buys you a drink.  \"<i>I'm just bein' polite since we're pals,</i>\" the orc ventures.  \"<i>Ya kin pay me back another time.</i>\"  You nod, sip your drink, and converse reservedly with him for a while, then go on your way.", false);
			//set Ro'roh Raggy = 1
			Flags.list[FlagEnum.ROGAR_WARNING] = 1;
			doNext(camp.returnToCampUseOneHour);
		}
		//(high fem or breasts >=B-cup and Ro'roh Raggy =1)
		else if ((player.upperBody.chest.BreastRatingLargest[0].breastRating >= 2) && Flags.list[FlagEnum.ROGAR_WARNING] == 1) {
			MainScreen.text("Ro'gar the orc is here drinking again, but as you catch his eye, a pained expression flashes across his face as he looks over your form.  It's clear he doesn't relish the prospect of talking to you right now, but knowing him, he's too polite to say so.  The wind spills from your sails and your icebreaker slips from your mind - answering him with a simple glance of resignation is the most you can manage.  He gives you a weak smile and returns to his drink.", false);
			//return to bar menu
			doNext(telAdre.barTelAdre);
		}
		//(andro or masculine with tits <= A)
		else {
			MainScreen.text("Ro'gar is tipping his drink back when he catches sight of you, and waves you over.  \"<i>Ah, good ta see ya, " + player.short + "!", false);
			//[(Ro'roh Raggy = 1)
			if (Flags.list[FlagEnum.ROGAR_WARNING] == 1) {
				MainScreen.text("Yer lookin' much better today; ya been workin' out?</i>\"  You smile at the compliment, and ", false);
			}
			else MainScreen.text("</i>\"  You ", false);
			MainScreen.text("wave the bartender over for another round.  \"<i>So,</i>\" he begins once you've finished your drinks and she's out of earshot, \"<i>I was wonderin' if ya would like to hang out at my place later?  It ain't much, but it'd be a lot more... private... than here.</i>\"  He colors slightly and waggles an eyebrow at you, then slides a hand into your groin.", false);
			//[(if F or U)
			if (player.gender == 2 || player.gender == 0) {
				MainScreen.text("  It reaches the center without interruption, and Ro'gar colors deeper.  \"<i>Uh... ferget it,</i>\" he mumbles.  \"<i>Didn't mean ta be indecent with you or anythin', miss.</i>\"  He nods to you and quickly departs before you can recover from the surprise.", false);
				doNext(camp.returnToCampUseOneHour);
			}
			else {
				MainScreen.text("  " + CockDescriptor.describeMultiCockSimpleOne(player, true) + " trembles under his strong touch, as he increases the pressure and looks into your eyes meaningfully.  ", false);
				//[(if Dirt Mc Gurt flag = 1)
				if (Flags.list[FlagEnum.ROGAR_DIRT] == 1) MainScreen.text("</i>\"I know ya probably ain't ever imagined hangin' out with a feller like me, but... I could really use the company tonight.</i>\"  ", false);
				MainScreen.text("He's clearly in the mood for some fun; do you want to head back to his place and do something?", false);
	...
	private rogarFuckMenu(): void {
		spriteSelect(86);
		let getAnal: Function = null;
		let giveAnal: Function = null;
		let frot: Function = null;
		let brodown: Function = null;
		let getTied: Function = null;
		let rubdub: Function = null;

		if (player.inventory.items.has(consumables.BROBREW)) brodown = brobrobrobro;
		...
		menu();
		MainScreen.addButton(0, "GetAnal", getAnal);
		MainScreen.addButton(1, "GiveAnal", giveAnal);
		MainScreen.addButton(2, "Frot", frot);
		MainScreen.addButton(3, "BroDrink", brodown);
		MainScreen.addButton(4, "GetTiedAnal", getTied);
		MainScreen.addButton(5, "OrcRubDown", rubdub);
		MainScreen.addButton(6, "No Thanks", noTHanksRogarIAintGayDudeIjustLickedThatMudToBeNice);
	}
	...
	private noTHanksRogarIAintGayDudeIjustLickedThatMudToBeNice(): void {
		MainScreen.text("", true);
		spriteSelect(86);
		MainScreen.text("You smile at the orc, but tell him that you're not really in the mood to hang out right now.  He looks crestfallen, but nods at you.  \"<i>Well, I understan'.  I'll be seein' ya later, then.</i>\"", false);
		//Bar menu!
		doNext(telAdre.barTelAdre);
	}
	...
	private loseButtGinity(): void {
		...
		//(([Get Anal] Scenario 1b: Get fucked (normal)))
			...
			MainScreen.text("You can't help but feel hesitant as you draw near, but your lusts aren't willing to refuse the offer. You sit astride Ro'gar's leg, with your thighs clasping the mighty muscle that makes up his.  Ro'gar snakes an arm around your waist and tugs you closer, pressing you against his chest.  \"<i>That's a good boy.  Now how's about a kiss?</i>\"  He chuckles as he reaches a hand under your chin, tilting your face to meet his.", false);
			if (player.tallness >= 84) MainScreen.text("  You lean down as Ro'gar tilts up, your lips connecting with his, both mouths open to let tongues wrestle.", false);
			//(If player height is less than 7 feet)
			if (player.tallness < 84) MainScreen.text("  You lean up into Ro'gar's mouth, his hand caressing your cheek.", false);
			MainScreen.text("  You can feel his demanding tongue pressing into your mouth and coaxing moans from the wanton entrance.  His hand slides down your waist to cup your " + ButtDescriptor.describeButt(player) + " in his strong grip.  Ro'gar breaks the kiss with a devious grin.  \"<i>Let's get you out of these clothes.</i>\"  His voice rumbles deep in his chest, the resonations vibrating against your skin.  He takes the initiative and pulls off your garments, leaving you completely nude in his lap.  One of the orc's hands wanders over your body, playing with your nipples while the other slides down toward your " + CockDescriptor.describeMultiCockShort(player) + ".  Ro'gar's head nestles in the nape of your neck, gently nipping at your skin and reddening it with a slight sting.  Where he nibbles he quickly follows with a tender lap of warm tongue over the abused flesh, bringing slight shudders through your body as his smooth tusks rub over you.\n\n", false);

			MainScreen.text("You are left panting for breath from Ro'gar's continued teasing, your skin on fire from every touch as his thin oil smears over it.  You spread your legs lewdly on Ro'gar's lap, blood rushing south as you feel yourself stiffen and throb - though you aren't the only one sporting wood, as you soon feel Ro'gar's hot manhood pressed up to your side.  He groans into your shoulder, bucking his hips to hump your flesh.  Pre-cum dribbles from Ro'gar's swollen cockhead and smears you in his need.  \"<i>Come here,</i>\" he whispers directly into your ear.  His hands grip your bottom as he pulls you closer to face him.  Your chest presses to his as you straddle Ro'gar's hips.  Ro'gar's throbbing ten inches of man meat tucks between the cheeks of your " + ButtDescriptor.describeButt(player) + ". He gives you a playful wink, bucking his hips to bounce you in his lap.  The feeling of his hot, thick length rubbing over your " + ButtDescriptor.describeButthole(player) + "  and wetting it with copious pre makes you gasp like a bitch in heat.  The dripping orc spooge snakes down in between your cheeks, and you feel your body shudder with anticipation; Ro'gar lets the liquid pour over his own hard-on.  \"<i>My favorite boy ready for the ride of his life?</i>\"  He grins impishly as he grips the head of his thick, uncut orc cock and pushes it against your boy cunt.  A gasp of pleasure escapes your lips and your hands clasp onto Ro'gar's shoulders, wriggling your " + ButtDescriptor.describeButt(player) + " over the green mile.\n\n", false);

			MainScreen.text("With a buck of Ro'gar's hips his slick cockhead slips into your " + ButtDescriptor.describeButthole(player) + ".  Your lips part wide, letting out a sharp gasp as he nestles within you.  \"<i>Git ridin', boy!</i>\" he barks, with a hard smack against your " + ButtDescriptor.describeButt(player) + ".  You yelp at the rough treatment, easing yourself down slowly to slide Ro'gar's stiff flesh further into you, and feel yourself growing hard as the throbbing manhood stretches you open.  " + CockDescriptor.describeMultiCockSimpleOne(player, true) + " swells with blood as it brushes against Ro'gar's stomach, and the sensitive urethra picks up a thin layer of his slime from his skin, making you burn with sensitivity.  Your hips shift into Ro'gar's body more, rubbing your " + CockDescriptor.describeMultiCockShort(player) + " tightly against him.", false);
			if (player.lowerBody.cockSpot.count() > 1) {
				MainScreen.text("Lines of pre-cum are drawn with your erections, adulterating the sweat and oil on Ro'gar's body as you bob your hips along Ro'gar's mast.   ", false);
			}
			MainScreen.text("Your spunk dribbles over Ro'gar's green skin and collects in his navel as his mouth attacks your neck with an assault of nips and licks, each nibble rubbing his tusks over your sensitized skin.  Hands roughly grip your " + ButtDescriptor.describeButt(player) + ", spreading your cheeks apart manually and kneading the flesh like dough.  He coaxes you to move faster with demanding nudges of your hips, growling deeply with each thrust of his cock inside you.  Hot fluid sticks to your inner walls, arousal making you buck your hips helplessly as you become more and more sensitive with each thrust.  You're soon bouncing up and down on Ro'gar's prick, and to further your wild ride, Ro'gar begins bucking his hips up to meet your " + ButtDescriptor.describeButt(player) + ".\n\n", false);

			//[(If player is fat or has very defined muscles)
			if ((player.thickness >= 75 && player.tone < 33) || player.tone >= 75) {
				MainScreen.text("Riding Ro'gar's stiff manhood as fast as you can muster, you drive the orc man wild with need.  His thick girth stretches your " + ButtDescriptor.describeButthole(player) + " wide around it, making you a wonderful sleeve for his orc cock.  He hilts within you, and you cry out in pleasure as his cockhead rams your prostate.  Ro'gar wrests control from you as he hears you cry out like a bitch in heat.  His strong hands at your " + LowerBodyDescriptor.describeHips(player) + " hold you in place as he pounds your " + ButtDescriptor.describeButthole(player) + ", ramming against you with brutal force and making you moan loud enough that your voice grows a little hoarse.  " + CockDescriptor.describeMultiCockSimpleOne(player, true) + " twitches from the abuse to your trigger", false);
				if (player.lowerBody.balls > 0) MainScreen.text(" and your " + BallsDescriptor.describeBalls(true, true, player) + " clench tight as you feel your limit reached", false);
				MainScreen.text(".", false);
				//[(if player has toes)
				MainScreen.text("  You curl your fingers and " + LowerBodyDescriptor.describeFeet(player) + " in ecstasy as Ro'gar drives you over the edge.", false);
				MainScreen.text("  Your bucks become ragged, and the orc takes over as " + CockDescriptor.describeMultiCockSimpleOne(player) + " jerks and spasms, shooting out countless ropes of sticky spunk onto the glistening green skin, painting the orc white with your lust.  With a low, deep, tone, Ro'gar groans out as you feel his warmth overtake your lower body, flooding you full of his fertile man cream.  Ro'gar continues to fuck you with decreasing vigor, slowing to a stop as his spent cock pops from your drooling pucker.  His spunk floods out of your filled boycunt, the spooge running down Ro'gar's half-hard cock to drip onto the floor lewdly.\n\n", false);
			}
			//(else)
			else {
				MainScreen.text("\"<i>Enough horsin' around.</i>\"  Ro'gar snarls as his arms quickly yank back, sneaking under your legs and hoisting you up as he gets to his feet.  You grip Ro'gar's shoulders tight as he lifts you with a strained grunt.  You delight with sharp little moans as he begins to fuck you skyward, bouncing you off of his hips with each slam of his cock into you.  Slowly Ro'gar steps towards a wall, taking his time to be sure not to drop you, and you soon feel the cool surface pressed to your back.  Caught between a cock and a hard place, you stare into Ro'gar's predatory gaze as he holds you hoisted in the air and pinned, making you feel vulnerable.  The orc takes advantage of you and begins to abuse your " + ButtDescriptor.describeButthole(player) + ", making your head tilt back to moan out helplessly.", false);
				MainScreen.text("  " + CockDescriptor.describeMultiCockSimpleOne(player, true) + " lays out over your chest, dribbling pre-cum on your skin as you make a mess of your torso in lust.", false);
				//[(if player has tail) 
				if (player.hasLongTail() > 0 || player.lowerBody.isNaga()) MainScreen.text("  Your tail flicks helplessly below you, urgently wrapping around Ro'gar's thigh and trying to pull him deeper into you.", false);
				MainScreen.text("  You cry out as Ro'gar finds your sweet spot.  \"<i>Now I got yer button, boy,</i>\" he snickers, wearing his usual predatory grin, the sharp, jagged teeth on full display as you shudder from the relentless pounding against your " + ButtDescriptor.describeButt(player) + ".  The sound of flesh smacking flesh is loud in your ears as you squirm from Ro'gar's cock.  Each thrust drives you mad with pleasure, your mind in a lust-induced haze as your prostate is prodded and poked.", false);
				//[(If player has balls) 
				if (player.lowerBody.balls > 0) MainScreen.text("  You feel your " + BallsDescriptor.describeBalls(true, true, player) + " pull up tight in your sack as your labored breath comes out in pants.", false);
				MainScreen.text("  Ro'gar continues his savage thrusts, impaling you fully on his length; soon you cry out in ecstasy as his urgent pounding brings you to climax, spraying yourself with your own thick spunk.  Your chest is quickly coated in ropes of your own cum, glazing your torso like a delectable treat to be licked off.   Your orgasm spurs him onward, and Ro'gar crushes you between himself and the wall with each powerful thrust.  A maddened hiss sounds as he breathes through his clenched teeth, impaling you with a few sharp smacks of hips against ass, and snarls issue from the orc as you are suddenly flooded with cum.  He seems to ejaculate for an eternity, each urgent thrust pumping another bucket of jizz into your ass. Your stomach distends as cum begins to overflow and run from your ass to drip from the orc's bouncing, fat balls and make a puddle on the floor.  You moan in exhaustion as he plants his seed inside you.\n\n", false);
			}
			//((Paths combine here))
	...
	private fuckRogarsButtPussyBoyCuntManMoundSissySlitQueerQuim(): void {
		...
		if (player.stats.cor > 70 && player.lowerBody.vaginaSpot.hasVagina()) MainScreen.text("Ro'gar flicks his tongue toward your " + CockDescriptor.describeMultiCockShort(player) + ", but you have a better idea and nudge him lower to guide him to your " + VaginaDescriptor.describeVagina(player, player.lowerBody.vaginaSpot.get(0)) + ".  His eyes look up at you in confusion.  You can tell he'd rather not have his face buried there by the way he moves his mouth away, but you urge him on; telling him to get licking, you push your hips down over his face.  With his head caught between your legs and the bed his mouth presses to your " + vaginaDescript(0) + "without a choice.  His whimpers of displeasure bring a grin to your face as you rub over his mouth with your netherlips.  He reluctantly flicks his tongue out to lap over your mound.  You shiver at the attention, growing moist and slick as you drip over Ro'gar's mouth.  The orc gives a whine of disgust as you rudely force him to pleasure your pussy, and you let out a loud moan as his unwilling licks turn you on; excited, you stroke your " + CockDescriptor.describeCock(player, 0) + ".  Ro'gar focuses his attention on that instead, watching you grow stiff and swollen, his eyes following your pumping hand.  You generously rub the slick, drooling pre-cum over " + CockDescriptor.describeMultiCockSimpleOne(player) + ", your vaginal walls clenching around his tongue as you pleasure yourself, working the goo over your flesh with your hand.  You look down and grin devilishly at him.\n\n", false);
		//(If player doesn't have vagina but has 70+ corruption)
		else if (player.stats.cor > 70) MainScreen.text("Ro'gar flicks his tongue over your " + CockDescriptor.describeMultiCockShort(player) + ", but you have a better idea and nudge him lower to guide him to your " + ButtDescriptor.describeButthole(player) + " .  With a lusty growl Ro'gar attacks your pucker, tongue swirling over the surface and coaxing a pleased moan from your lips.  You grow stiff with arousal, bringing a hand down your shaft to answer your burning lust with a few teasing strokes.  You smear the pre-cum pouring out of your " + CockDescriptor.describeMultiCockShort(player) + " into an even coating of spunk as you work your hand.  Ro'gar looks over at the pumping hand and soon becomes distracted from his work, his tongue pressed lazily against your " + ButtDescriptor.describeButthole(player) + ".  You look down and grin devilishly at him.\n\n", false);

		MainScreen.text("Pulling back off of Ro'gar's face, you feel your entire body twitch in anticipation.  You press your " + LowerBodyDescriptor.describeHips(player) + " against his muscled ass, lining your aroused member up against his tight rear while your hands grope over the firm muscled cheeks, spreading them apart eagerly.\n\n", false);

		//[((If biggest cock is less than 4 inches))
		if (player.longestCockLength() < 4) {
			MainScreen.text("\"<i>Yer serious?</i>\" Ro'gar asks with a quirked eyebrow.  You blink as he suddenly gets up to stare you in the eyes.  \"<i>Not to be rude, " + player.short + ", but I ain't gonna feel nothin'.</i>\"  You can't help but feel a little offended, saying something about motions of large bodies of water.  Ro'gar doesn't seem convinced as he buries his forehead in a palm.  \"<i>Listen, this ain't a really good time for this.  I'm already losin' my mojo.  You come back another time, okay?</i>\"  With that, you are ushered out as politely as possible.  You can't help but feel a little embarrassed as you walk the city streets like this is some sort of walk of shame.", false);
			doNext(camp.returnToCampUseOneHour);
			return;		//end if too small
		}
		//((else If smallest cock is over 18 inches))
		else if (player.shortestCockLength() > 18) {
			MainScreen.text("\"<i>E-easy there...</i>\" Ro'gar actually stutters, looking at you with concern.  You are impossibly huge for him, and despite your titanic head rubbing pre-cum over Ro'gar's green hole it just won't fit.  You let out an annoyed grumble and begin to rub your length over Ro'gar's body and orc cock.  With lustful grunts Ro'gar bucks his hips into your " + CockDescriptor.describeMultiCockShort(player) + ", grinding the stiff masts together as they leak and drool over one another.\n\n", false);
			//[(If multiple cock)
			if (player.lowerBody.cockSpot.count() > 1) MainScreen.text(CockDescriptor.describeMultiCockSimpleOne(player, true) + " grinds over every inch of Ro'gar's front, and his dark olive skin soaks in your glistening fluids.  Ro'gar's length is lost in the forest of your meat.  With his green monster assaulted by multiple angles and dwarfed in size he whimpers softly.  \"<i>Ain't never felt nothin' like this.  Almost like fuckin' a dick.</i>\"", false);
			//(else If single cock)
			else MainScreen.text("Your " + CockDescriptor.describeMultiCockShort(player) + " bucks against Ro'gar's orcish pride.  The pair of hard cocks press tightly together as you dwarf Ro'gar in size.  You hump his orc sex with your " + CockDescriptor.describeMultiCockShort(player) + " and grunt in strain; your hands reach down to grip the pair of manhoods tightly, jerking them fast with squeezed pumps.", false);
			//(If player has balls) 
			if (player.lowerBody.balls > 0) MainScreen.text("  Ro'gar squirms under you, his chest heaving with labored breath while his musky scrotum presses against your own.", false);
			MainScreen.text("  He reaches down, sweaty palm wrapping around his meaty length and roughly choking it, then strokes along his orchood hastily as he groans out, spunk spilling over " + CockDescriptor.describeMultiCockSimpleOne(player) + " and leaving it sopping wet with hot seed.  Your own hands rub Ro'gar's strong smelling sperm over yourself, coating your " + CockDescriptor.describeMultiCockShort(player) + " in his lust.  The sight of the heaving orc beneath you drives you over the edge,and your pent-up load splatters over Ro'gar's sweaty body and covers the orc in your thick volleys of cum.", false);
			MainScreen.text("\n\n", false);
		}
		//((If cock is between 18 and 4 inches))
		else {
			MainScreen.text("\"<i>E-easy there.</i>\"  Ro'gar actually stutters, looking at you with concern. Your lips curl into a devious grin as you roughly press into Ro'gar's puckered hole.  You slide in with an abrupt grunt, ignoring Ro'gar's yelps of pain at the sudden entry and reasoning that it couldn't have hurt too much, judging by how your " + CockDescriptor.describeCock(player, 0) + " was literally coated in pre-cum.  But still, you find it amusing to push the orc's button and make him squirm for once.  Slipping in further, you bury yourself in Ro'gar's hole until he groans out and prematurely spurts more orc cum onto his stomach.", false);
			//[(If using feline cock)
			if (player.lowerBody.cockSpot.get(0).cockType == CockType.CAT) MainScreen.text("  You grind around in his green pucker, the barbs working over Ro'gar's inner walls.  \"<i>W-what in tarnation?</i>\" Ro'gar grunts as you watch him squirm under you.  You buck your hips, digging deeper into orcflesh with each thrust, his muscled ass tensing with each slam of your hips.", false);
			//(If horse cock)
			else if (player.lowerBody.cockSpot.get(0).cockType == CockType.HORSE) MainScreen.text("  The flared head of your " + CockDescriptor.describeCock(player, 0) + " nestles in Ro'gar's hole.  His breath quickens as you push in, the girthy, flared head stretching Ro'gar's insides impossibly.  You simply thrust and buck you way deeper within the green pucker to force more of your lengthy shaft past that olive rosebud each time.\n\n", false);
			//(If dog cock)
			else if (player.hasKnot(0)) MainScreen.text("  Your pointed tip slips in easily and you begin to plunge into Ro'gar's depths, and the burly orc gives satisfied grunts as his strong hand reaches down to touch himself.  You begin to fill his orc hole, the pre-slicked cock working as a lubing tool as you begin to build a nice rhythm within Ro'gar.  Your knot bulges as your climax approaches and begins to ram into Ro'gar's green pucker, the tight ring unable to allow entry as you swell bigger and bigger.", false);
			//(If other cock)
			else MainScreen.text("  Breaking Ro'gar's orc hole open, you thrust deep within his hot, tight depths.  The burly orc pants with heated breaths, humid air fluttering out of his tusked mouth.  His musclegut heaves, each breath punctuating the thrusts of your hips.  You plow his ass roughly, pulling out until only the head remains inside him before plunging back in further than before.  Ro'gar grunts low in his chest with each bit of progress made, his strong, calloused hand stroking his drooling cock.  \"<i>Mmmf, " + player.short + ",</i>\" he groans as you finally hilt yourself within him.", false);
			//end racialdicks, still inside right fit path

			MainScreen.text("\n\nYou grip his hips and begin a steady pace, slapping flesh loudly against his muscled ass.  His thick, powerful legs twitch in the air as you pound into his orcish hole, and the orc's toes curl visibly with each brutal thrust you make into him.  You groan as his musk makes your " + CockDescriptor.describeMultiCockShort(player) + " throb all the more within him.  To further his humiliation, you whisper in his pointed ear how good he feels wrapped around your length.  He blushes a lime green before you make him groan out your name with a rough smack over his ass.", false);
			if (player.lowerBody.cockSpot.count() > 2) MainScreen.text("  Your other cocks grind over that firm orc rump, drooling over his skin and making his rear glisten with your sex.", false);
			else if (player.lowerBody.cockSpot.count() > 1) MainScreen.text("  Your other cock grinds over that firm orc rump, drooling over his skin and making his rear glisten with your sex.", false);
			MainScreen.text("You decide to see how loud you can make him moan and begin ramming deep within him.  The thrusts slam hard enough to make Ro'gar's back arch, your bulbous cockhead prodding his buried prostate with each hilt.  His big hand beats furiously at his massive orc cock, strained groans bellowing out loudly as his heavy sack clenches tight against the base of his green rod.  Orc spunk flies out over his chest, hitting his chin and splattering over his heaving pecs.  His cum collects between his bulging muscles and splashes over his head.  Ro'gar's anal walls clench down tight around you as you pick up the pace of your brutal fuck; your " + CockDescriptor.describeCock(player, 0) + " is milked hard as you feel your climax rapidly approaching.  Sweat drips from your body onto Ro'gar's skin, and you finally feel yourself hit the edge.  With a burst of ecstasy you hilt completely within your orc fuck toy.", false);
			//[(If dog cock)
			if (player.hasKnot(0)) MainScreen.text("  Your knot forces past Ro'gar's tight, anal ring to pulse inside him, joining the pair of you together.", false);
			//[(if player has balls)
			if (player.lowerBody.balls > 0) MainScreen.text("  With short jerks of your hips, you begin to unload your pent up orbs into the orc's innards.", false);
			MainScreen.text("  Wave after wave of thick seed spills from your cock into Ro'gar as his head falls back at the blissful sensation.", false);
			//[(if multiple cock)
			if (player.lowerBody.cockSpot.count() > 1) MainScreen.text("  The other meat rubbing over his olive skin outside adds to the coating of spunk, making a giant mess of Ro'gar's body.  In seconds he resembles a well-paid whore beneath your " + CockDescriptor.describeMultiCockShort(player) + ".", false);
			MainScreen.text("\n\n", false);
		}
		//end right fit path
		//((Combine too big, and right size paths))
		MainScreen.text("Ro'gar's cum-coated body lies panting under you.  You slowly soften and lay limp against his olive skin, then pull away and clean yourself off.  Ro'gar stirs slowly, only rising to a seated position by the time you are dressed.  \"<i>That was really... something.  I don't really know what got inta ya, " + player.short + ", but ya really know how ta surprise a feller.</i>\"  With a sly smirk you intone that he had it coming and finish putting on your clothes, then walk over to smack Ro'gar's cum-covered ass with your hand.  The giant orc looks stunned a moment before giving a playful grin.  \"<i>Frisky, aren't'cha?</i>\"  He snickers low in his rumbling chest, then gets up to wave you off, but you're already out the door and heading back into the city with a spritely skip added to your step.", false);
		//<Lust sated>
		player.orgasm();
		player.stats.sens += -1;
		doNext(camp.returnToCampUseOneHour);
	...
	private rogarIsDumb(): void {
		MainScreen.text("", true);
		spriteSelect(86);
		MainScreen.text("You relinquish the can with a smile, slyly telling Ro'gar he can have it, then put your hands behind your back innocently.  He narrows his eyes, then shifts them to the can.  After a careful inspection, he thrusts the can toward you.  \"<i>Don't want it.  Ya probably put bimbo liqueur in it or somethin', ya sneaky devil.</i>\"\n\n", false);

		MainScreen.text("The playful mood broken, you hang out for a while and shoot the breeze, then head back.", false);
		//end
		doNext(camp.returnToCampUseOneHour);
	}
	...
	private takeDatBroBrewFromDaBigMeanOlOrc(): void {
		...
		if (!player.perks.has("BroBody")) {
			...
			if (player.lowerBody.cockSpot.hasCock()) {
				if (player.lowerBody.cockSpot.get(0).cockLength < 10) {
					if (player.lowerBody.cockSpot.get(0).cockThickness < 2.75) {
		...
		if (changed) {
			MainScreen.text("  You realize you look much stronger, bigger, and sexier", false);
			//(if dick grew)
			if (cocked) MainScreen.text(", and you smile to yourself as your now-larger endowment rubs against garments not suited to it", false);
			MainScreen.text(".  Who needs book smarts anyway?  Nerds.", false);
	...
	private frotWithRogar(): void {
		...
		MainScreen.text("", true);
		spriteSelect(86);
		MainScreen.text("You allow yourself to be led into Ro'gar's apartment and look around the modestly furnished lounge. Ro'gar seats himself in a cushioned chair.  \"<i>Thanks fer comin'.  I missed ya.</i>\"  He snickers, and you draw closer. His calloused hand reaches down to cup your " + ButtDescriptor.describeButt(player) + ".  He smirks at you, the frisky orc chuckling deeply and firmly squeezing.  You retaliate with a hard smack against Ro'gar's muscled rump.  He growls low, answering the challenge and crashing his lips into your own.  Muffled grunts and groans issue from both of you as you undress each other.  Soon you are standing in the nude and Ro'gar's hefty cock presses against your " + CockDescriptor.describeMultiCockShort(player) + ".\n\n", false);
		//(If multiple cocks)
		if (player.lowerBody.cockSpot.count() > 1) {
			MainScreen.text("Feeling your lengths stiffen against Ro'gar's hard green monster, you buck against Ro'gar's hard need, enveloping it in your cocks and coaxing a lewd groan from the orc.  Ro'gar growls as he feels his orc length surrounded, his green member being slathered with your pre-cum from multiple directions.  His arms wrap around you as he fucks your " + CockDescriptor.describeMultiCockShort(player) + ", grinding his orc cock between all your lengths; he presses his tusks against your neck and suckles, teeth grating the flesh while his tongue passes over the indentations they leave behind.  Ro'gar backs you up and you feel a hard wall behind you.  His oil-coated body rubs over your own, smearing onto your chest, arms, and hips.  Your hands grip tightly to Ro'gar's back as you grind into him with your " + CockDescriptor.describeMultiCockShort(player) + ".  Ro'gar reaches his hand down, wrapping his fingers around his length and the nearest cock to it, then strokes them slowly.  Hot breath washes over your face as he stares deep into your eyes, the deep blue pools hazed with lust as you fuck against each other's loins.  Your two bodies mingle with sweat and pre-cum, and soon your groins are sticky and glazed.  You fuck your cocks together, the strong scent of man musk filling your nose and sending a shudder down your spine and a thrill through your groin.  Ro'gar suddenly moans, his orc cock caught between your " + CockDescriptor.describeMultiCockShort(player) + " as he unloads over your chest.  His heavy sack clenches tight beneath his cock as he spills his thick seed onto you, coating you in his countless ropes.  The heat warms your skin as you reach your limit; each of your " + CockDescriptor.describeMultiCockShort(player) + " twitches, hot and sticky spunk splashing over Ro'gar's olive skin.\n\n", false);
		}
		//(If single cock)
		else {
			MainScreen.text("Your cock presses tight against Ro'gar's fat orc cock. He growls low as he grinds himself over you, his thick, globbing pre-cum drooling onto your " + CockDescriptor.describeMultiCockShort(player) + ".  Muffled groans escape Ro'gar's mouth as you kiss him roughly, tongues locked all the while in writhing combat.  ", false);
			//[(If player has balls)
			if (player.lowerBody.balls > 0) MainScreen.text("Your " + BallsDescriptor.describeBalls(true, true, player) + " slap audibly against Ro'gar's heavy green sack.  ", false);
			MainScreen.text("Each thrust is slicker and better than the last as your cockheads drip out copious amounts of pre-cum over each other's lengths, the two manhoods slick and bucking toward the other in hard, bestial rut.  Ro'gar backs you up and you feel a hard wall behind you.  His oily body rubs over your own, smearing onto your chest, arms, and hips, and your hands grip tightly to Ro'gar's back as you grind into the orc.  Ro'gar reaches his hand down, wrapping his fingers around his length and yours.  He strokes along them with his rough, calloused hand, and hot breath washes over your face as he stares deep into your eyes.  The deep blue pools are hazed with lust as you fuck against each other's loins.  Your two bodies mingle with sweat and pre-cum, and soon your groins are sticky and glazed.  You fuck your cocks together, the strong scent of man musk filling your nose.  Ro'gar suddenly moans, his orc cock caught against you as he unloads over your chest.  His heavy sack clenches tight beneath his cock as he spills his thick seed, coating you in his countless ropes of jizz.  The heat warms your skin as you reach your limit; your " + CockDescriptor.describeMultiCockShort(player) + " twitches and hot and sticky spunk splashes over Ro'gar's olive skin.\n\n", false);
		}
		//(( Paths combine here))
	...
	private kinkyWithDaOrc(): void {
		...
		MainScreen.text("over the threshold, and then look around the apartment.  He points out the small kitchen area and then, rather sheepishly, the bedroom.  You're examining it when something catches your eye...\n\n", false);
		MainScreen.text("You bend over the bed to grip a small bottle lying in the soft fabric of the sheets.  Turning it over, you tilt your head as you read the label.  It's... a bottle of lubricant.  Suddenly, there is a loud thud behind you and the bottle drops from your hand as your torso is pressed into the cushioned surface of the bed.  Something presses into your back.  \"<i>Gotcha...</i>\" the familiar voice snickers in your ear.  Ro'gar's head leans over your shoulder and a long, orcish tongue licks your cheek.  \"<i>Was waitin' for this...</i>\" he purrs; the resonance of his voice rumbles against your ear.  Ro'gar chuckles and grips around your wrists.  \"<i>Now that yer here, it's time ta break in this here new bed with sumthin' I've been cravin' since I washed ya down in that swamp, boy.</i>\"  Ro'gar's tone suddenly takes a demanding, hissing tone.  His tongue flicks over your ear as he speaks.  Your skin begins to grow goosebumps as shivers crawl down your spine.\n\n", false);
		MainScreen.text("He yanks your wrists behind your back, ignoring your faint gasps.  With a rustle of cloth, your wrists are bound together behind your back tightly; your fingers feel over the bonds but you struggle against them in vain.  Looking over your shoulder in ", false);
		if (player.stats.lib < 33) MainScreen.text("feigned confusion ", false);
		else if (player.stats.lib > 66) MainScreen.text("clear lust ", false);
		MainScreen.text("at Ro'gar, you only see his lust-ridden face dipping down to kiss at your lips.  His tusks press against your cheeks with a demanding snarl and his tongue into your mouth; your " + ButtDescriptor.describeButt(player) + " receives a smack, forcing you to yelp.  His tongue quickly invades, and his free hand unfastens your " + player.inventory.armor.displayName + " to strip you forcefully.  Rough, calloused fingers dance over your body and fasten onto your " + BreastDescriptor.describeNipple(0) + "s, coaxing moans from your throat with each pinch.  Your pleased noises are muffled by Ro'gar's mouth, his tongue and lips hushing each whimper and gasp you breathe.  A bare, firm chest presses against your exposed back, and you pant as the heat from his body burns against you, only intensified by the thin layer of oil on his skin.  Ro'gar's blue eyes watch you like a predator as your face flushes.  He breaks the kiss and cups his hands under your chin to hold your face in place.  \"<i>Such a perdy face yer makin', " + player.short + ".  Yer lookin' at me like a proper slut, an' it's makin' me hard seein' ya so needy to be bred.</i>\"  He growls in his throat as his mouth nips over your neck, leaving red marks along your skin where his tusks rub against you.  You can feel the oil and sweat smearing over your back, and your senses go wild.  The room is soon filled with your needy whimpers as " + CockDescriptor.describeMultiCockSimpleOne(player) + " oozes and throbs against the sheets, making the fabric damp with your lust.\n\n", false);
		...
		if (player.lowerBody.butt.analLooseness < 3) MainScreen.text("\"<i>Tarnation, " + player.short + ".  You're so tight...</i>\"\n\n", false);
		else if (player.lowerBody.butt.analLooseness < 5) MainScreen.text("\"<i>My favorite boy ready for the ride of his life?</i>\"\n\n", false);

		MainScreen.text("Ro'gar rolls you over by your " + LowerBodyDescriptor.describeHips(player) + ", forcing your body to lay out over your back.  The orc's face comes down close enough that you feel his breath washing over your skin.  With a rip you hear the shorts torn from Ro'gar's body.  You feel his hot, throbbing length grinding over your " + buttDescript() + " before you see it, the deep green head towering over your groin menacingly, each vein pulsing as the mammoth cock belches pre-cum to leak down the orcish shaft.  Your skin is soon slick with his spurting pre as he groans out. \"That's much better.\"  Ro'gar's breath becomes labored as he pants heavily and eagerly, his green length humping against your rosebud, making you moan out in an excess of sensation.  His hands hold your cheeks apart with a strong grip as you begin to leak your own pre-cum onto your stomach.", false);
		//(if player has balls) 
		if (player.lowerBody.balls > 0) MainScreen.text("  Ro'gar's dark green cockhead rubs over your " + BallsDescriptor.describeBalls(true, true, player) + " and coats the plump sack in his musky goo, like an alpha male marking his territory.", false);
		MainScreen.text("\n\n", false);

		MainScreen.text("Deep, guttural hisses echo out from the orc.  \"<i>Easy fella...</i>\" Ro'gar mutters, trying to restrain himself from ripping you apart with his fat cock.  He leans down and kisses you softly before continuing.  \"<i>I'll give ya a kinky fun ya won't forget.</i>\"  With a playful wink he gets down on his knees, squatting near the foot of the bed.  His hand hoists your " + LowerBodyDescriptor.describeHips(player) + " up to his mouth.  You can feel him kiss your tight ring, and soon a warm sensation shoots up your spine, causing you to moan.  His hot, slick tongue swirls over your puckered flesh, slathering your hole while his tusks rub along your cheeks.  You're left panting out hot, needy breaths as Ro'gar works over your anus, his tongue gently easing your tight ring of flesh open.  The pleasure makes your legs go limp over his shoulders and your eyes shut in a blissful daze.  Ro'gar's wet slurps and growls make your ears twitch, and you feel him slowly press in with his orcish tongue, beginning to tonguefuck your entrance forcefully.  With patience, your pucker gives in under Ro'gar's touch and his tongue slides into your untouched confines.  You give a sharp gasp, this strange feeling overwhelming you as you flick your eyes open.  Your " + ButtDescriptor.describeButt(player) + " wriggles in pleasure around his tongue, and the orc gives a pleased grunt as his tongue swirls around your inner walls, sliding out to pull your lime flavor into his mouth before roughly thrusting back in.  Your back arches as you cry out a surprised moan.", false);
		if (player.hasLongTail() || player.lowerBody.isNaga()) MainScreen.text("  Your tail wraps around Ro'gar's arm for some sort of stability, the tip flicking lazily as it coils and squeezes around a bicep.", false);
		MainScreen.text("\n\n", false);
		...
		if (player.lowerBody.butt.analLooseness < 3)
			MainScreen.text(" with some resistance, but the relentless finger rubs over your walls as he begins to pull your rim open, forcing another finger inside and making you bite your lip from the stinging sensation.  Working the pair of fingers together inside of you, he slowly moves them apart and stretches your hole wide.", false);
		else if (player.lowerBody.butt.analLooseness < 5)
			MainScreen.text(" and rubs over your walls as he pulls your rim open, forcing another finger inside and making you moan like a bitch in heat.  Working the pair of fingers together inside of you, he slowly moves them apart and stretches your hole wide.", false);

		MainScreen.text("  Fingers and " + LowerBodyDescriptor.describeFeet(player) + " curl in pleasure as your boycunt is forced open by Ro'gar's steady coaxing.", false);
		...
		if (player.lowerBody.butt.analLooseness < 3) MainScreen.text("the tight hole.  Your teeth clench as he stretches you wide around his length, though he continues without hesitation, and finally you cry out with the sting of the bulbous head squeezing into your tiny hole, though it falls on deaf ears as Ro'gar merely groans at your tightness.", false);
		else if (player.lowerBody.butt.analLooseness < 5) MainScreen.text("your well-used hole. You moan with need as he stretches you wide around his length, continuing without hesitation until he's inside.", false);
		player.buttChange(25, true, true, false);
		...
		MainScreen.text("You can't help but focus on the wonderful feeling of Ro'gar's cock throbbing within you.  Maybe this is where you belong?  With your ass impaled on Ro'gar's massive tool?  You moan loudly as Ro'gar picks up the pace, hips ramming into you with enough force to shift your body over the sheets.  He really starts to pound your hole with huffed grunts and groans as he hilts in you; his cockhead prods your prostate with each thrust, causing you to cry out as electric shocks shoot up your spine.  Every nerve in your body lights up like a Christmas tree and make your entire body squirm with pleasure.  You feel spurts of cum begin to leak from your " + CockDescriptor.describeMultiCockShort(player) + " and glaze your belly with pre-cum.", false);
		if (player.hasLongTail() > 0 || player.lowerBody.isNaga()) MainScreen.text("  Your tail, still gripping Ro'gar's arm, squeezes tight.", false);
		//(If player has balls) 
	...
	private rubdubWithDaOrcWithoutDucky(): void {
		...
		MainScreen.text("", true);
		spriteSelect(86);
		MainScreen.text("By the time you reach Ro'gar he has already reached his bedroom, his shorts on the floor. You eye over his olive green skin, all of it laid bare before you including his limp orc cock hanging over his hefty nutsack.\n\n", false);
		MainScreen.text("\"<i>I purchased these oils to relax my muscles after spending so much time in the gym.</i>\" Your orc lover motions to a few bottle of oils on his night stand. \"<i>How about you give me a hand... or two.</i>\" Ro'gar grins at you, his eyebrows twitching suggestively. You need no further provocation as you strip from your " + player.inventory.armor.displayName + ", you let it fall into a pile on the floor as you make for the bottle. Ro'gar grins and rolls onto his stomach.\n\n", false);
		MainScreen.text("The bottles pop open easily and you pour a generous amount over your hand, you spill even more over Ro'gar back. He gasps feeling the cool liquid crawl down the spine of his back. Though it's not long after you warm his skin with your hands. Your fingers spread and smear the oils over his damp skin. You crawl up and straddle Ro'gar's hips, sitting on his muscled ass as you begin to rub the oils in.\n\n", false);
		...
		MainScreen.text("\"<i>That's the spot.</i>\" Ro'gar grunts as you work your thumbs over a certain spot near his shoulders. You curve your fingers around his broad shoulder and gently pull the muscles to stretch away from the neck. Ro'gar's mouth bellows a moan as his head falls to the sheets. The oils mixing with the strange liquid secreted from the orc's skin making a curious concoction. You can feel your hands feeling so warm and soothed, the muscles in your hands relaxed and comforted. As you look along Ro'gar glistening back you wonder how it would feel to have such a large area affected by the slurry.\n\n", false);
		MainScreen.text("You ask Ro'gar to flip over as you get off of his hips to get more oils. By the time you turn around your orc lover has already laid out on his back. Your eyes take in the sight of your muscled lover laid out for you, his muscled limbs bulging in anticipation, his swollen cock growing larger before your eyes. He grins at you as you pour oils over his chest, the cool liquid making him shiver as it drips down along his center. The clear oil crawling in between his pectorals, down his treasure trail and dipping into his navel before filling the gaps in his abdominals.\n\n", false);
		MainScreen.text("Without any hesitation you straddle the orc's hips again, his engorged orc cock brushing against the bare skin of your " + buttDescript() + ". Your hands get to work smearing the relaxing oil over Ro'gar's body. The orc stares at you with a lurid gaze as you massage his bulging pectorals, teasing his darkened nipples with your fingers. You grin feeling Ro'gar's thick cock pressing more against your " + buttDescript() + " as his chest rumbles under your hands.\n\n", false);
		MainScreen.text("\"<i>You're good at this " + player.short + ", have you done this before?</i>\" Ro'gar purrs as you work over his abdominals, tracing over every gap with your fingertips, the oils glistening over your lover's body. Ro'gar's hips buck gently, bumping your " + buttDescript() + " with his throbbing cock with a chuckle, his mouth curls into a coy smile. You watch as Ro'gar reaches his arms back, resting his head on his hands as he bares his underarm and pits.\n\n", false);
