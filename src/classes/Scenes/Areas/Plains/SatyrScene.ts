...
private consensualSatyrFuck(loc: number = 0):void {
	...
	//(if High Int)
	if(player.stats.int > 60 && player.lust <= 99) {
...
internal function loseToSatyr():void {
	...
	spriteSelect(98);
	//[Lust loss
	if(player.lust > 99) MainScreen.text("You pant as you begin masturbating furiously, too horny to care about anything the grinning satyr before you has in mind.");
	...
	if(player.isNaga()) MainScreen.text("pins down your serpentine body");
...
private femaleTakesAdvantageOfSatyr():void {
	...
	if(player.lowerBody.cockSpot.hasCock()) {
		...
		else MainScreen.text("the base of your " + multiCockDescriptLight());
	}
...
private willinglyBoneSatyr():void {
	...
	if(!player.lowerBody.vaginaSpot.hasVagina() && flags[FlagEnum.SATYR_KIDS] == 0) {
