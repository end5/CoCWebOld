export default class Harpy extends Monster {
	...
	protected harpyUberCharge(): void {
		...
		if (findStatusAffect(StatusAffects.Uber) < 0) {
			...
			MainScreen.text("Flapping her wings frantically, she flies away from you and gains height, hanging in the light before you.  She lets out a shrill and terrifying cry, narrowing her eyes as she focuses in on you!", false);
		}
	...
	override protected outputPlayerDodged(dodge: number): void {
		MainScreen.text("With another deranged cry the harpy dives at you, swinging her razor-sharp talons through the air with the grace of a ballerina. Your quick reflexes allow you to dodge every vicious slash she makes at you.\n", false);
	}

	public outputAttack(damage: number): void {
		if (damage <= 0) {
			MainScreen.text("The harpy dives at you with her foot-talons, but you deflect the attack, grasp onto her leg, and swing her through the air, tossing her away from you before she has a chance to right herself.", false);
		} else {
			MainScreen.text("The harpy surges forward, bringing her razor-sharp claws down on you, tearing at all the exposed flesh she can reach! (" + damage + ")", false);
		}
	}
