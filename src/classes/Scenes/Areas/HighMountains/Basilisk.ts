package classes.Scenes.Areas.HighMountains
{
	...
	public class Basilisk extends Monster 
	{
		...
		private basiliskTailSwipe():void {
			...
			MainScreen.text("The basilisk suddenly whips its tail at you, swiping your " + player.feet() + " from under you!  You quickly stagger upright, being sure to hold the creature's feet in your vision. (" + damage + ")", false);
		...
		public Basilisk()
		{
			...
			this.hipRating = HIP_RATING.SLENDER+1;
			this.buttRating = BUTT_RATING.AVERAGE;
			this.lowerBody = LOWER_BODY.LIZARD;
			this.skinTone = "gray";
			this.skinType = SKIN.SCALES;
			//this.skinDesc = Appearance.Appearance.DEFAULT_SKIN.DESCS[SKIN.SCALES];
			this.hairColor = "none";
			this.hairLength = 0;
