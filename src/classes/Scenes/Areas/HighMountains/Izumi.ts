	...
	public class Izumi extends Monster
	{
		...
		public straightJab():void
		{
			...
			else
			{
				...
				if (player.isNaga()) MainScreen.text(" raise back up onto your [legs]");
		...
		{	
			...
			else
			{
				...
				if (player.str < 90) MainScreen.text(" immense");
		...
		public chokeSlamEscape():void
		{
			...
			else if (player.isNaga()) MainScreen.text(" raise your tail and slap her solidly");
			...
			else
			{
				...
				else
				{
					...
					if (player.lowerBody.cockSpot.hasCock())
					{
						...
						if (player.totalCocks() > 1) MainScreen.text(" they get");
						else MainScreen.text(" it gets");
						MainScreen.text(", the more insistently your");
						if (player.totalCocks() > 1) MainScreen.text(" erections throb");
