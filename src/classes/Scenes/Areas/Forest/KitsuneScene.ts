...
//[Enter the Trickster] (Coded)
		...
		{
			if (flags[FlagEnum.MET_KITSUNES] > 0) {
				willOWisp();
				return;
			}
			clearOutput();
			Render.text("\"<i>H-help!</i>\"\n\n");
			Render.text("You turn with a start as a woman bursts through the bushes, flinging herself into your arms.  It looks like she's been roughed up a bit - her simple peasant's robes are torn and frayed, and her forehead has a few smudges where it appears as though she was dragged through the dirt.\n\n");
			Render.text("\"<i>Th-thank goodness!  Please, you must help me!</i>\"  she cries, darting around to take shelter behind you.  \"<i>I was out picking wild berries, and, and...  the wretched, terrible little things attacked me!</i>\"\n\n");
			Render.text("You are about to question her, but are interrupted as an imp flies out of the thicket, growling and clawing at you menacingly.  At least...  clearly it's <i>trying</i> to be menacing.  The melodramatic display comes off as more hilarious than anything, but the woman cowering behind you obviously feels threatened, so you might as well deal with the pest.");
			// -> Standard Imp Battle
			startCombat(new Imp());
			monster.statusAffects.add(new StatusAffect("KitsuneFight", 0, 0, 0, 0)));
			doNext(playerMenu);
			flags[FlagEnum.MET_KITSUNES]++;
		}
...
//Lose:
		public function loseKitsuneImpFight():void
		{
			...
			kitsuneSprite();
			Render.text("As you fall to the ground in defeat, you look up to see the imp standing over you.  You prepare yourself for the worst, but are surprised to see the vile creature disappear in a puff of blue flames.\n\n");
			Render.text("\"<i>Well...  that was...  easier than I thought.  Kind of boring, actually.</i>\"\n\n");
			Render.text("The woman from earlier bends low over you, smiling bemusedly.  Before your eyes, her face, body, and clothing all begin to shift form.  Clad in a set of loose, revealing robes, she brushes her " + monster.hairColor + " hair out of her face, reaching up to straighten out her large triangular fox ears.  Six lustrous, bushy tails sway from side to side behind her, drawing your gaze hypnotically, and a generous layer of ornate tattoos follow the curves of her body.\n\n");
			Render.text("\"<i>My, my, you're kind of a pushover, aren't you?</i>\"  she remarks, grinning precociously.  \"<i>Well, hopefully you make for a better snack than you do a bodyguard.</i>\"");
...
//Win:
		public function winKitsuneImpFight():void
		{
			...
			kitsuneSprite();
			Render.text("\"<i>Oh, thank you, thank you!  I don't know </i>what<i> would have happened if you hadn't come along.</i>\"\n\n" + ((player.stats.cor < 50) ? "As the imp falls at your feet, you lower your [weapon] and turn to the grateful woman.  Beating down an imp is really nothing special, but you were glad to be of assistance, and tell her as much with a friendly smile." : "You scoff haughtily, lowering your [weapon] and turning to the woman.  Beating down an imp was hardly worth your time, you tell her, crossing your arms in irritation.") + "\n\n");
			Render.text("\"<i>My hero!</i>\"  she swoons, beaming.  \"<i>Oh, if there's </i>anything<i> I can do to repay you, please, tell me!</i>\"\n\n");
			Render.text("You find yourself gazing deep into her eyes, a dim haze entering your mind as you are drawn deeper and deeper into the glistening green pools.  The corners of her lips curl into a broad smile as she starts to step toward you, and for a moment you swear you can see a subtle change in her.  You rub your eyes, certain they are playing tricks on you, slowly following the gentle sway of her six tails as she strolls up to you." + ( ((player.lust > 70) || (player.stats.int < 40)) ? "  Nope, nothing wrong here...\n\n\"<i>Mm...  my hero...</i>\" she croons again, reaching up to caress your cheek." : "\n\nWait.") + "\n\n");
			//PC saw through glamour
			if ((player.lust < 70) || (player.stats.int >= 40)) {
				Render.text("You push her away, almost cracking your head open as you stumble over a stump.  Now that you have broken free of her sorcery, you can see her for what she is.  A pair of large triangular fox ears poke up from her ");
				if (monster.hairColor == "blonde") Render.text("back-length, flaxen");
				else if (monster.hairColor == "black") Render.text("ass-length, raven");
				else Render.text("shoulder-length, crimson");
				Render.text(" hair, six luxuriously furred tails fanning out behind her.\n\n");

				Render.text("\"<i>So, you saw through my glamour did you?  That's quite impressive...</i>\" she says, teasing you with her tails.  You back away from her, but give a start and wheel around when you feel yourself bump into something.");
			...
			//With Religious BG:
				...
				Render.text("The instant she touches you, she recoils with a yelp, a brilliant flash temporarily blinding you both.\n\n");
				Render.text("\"<i>Ow, ow, ow!</i>\"\n\n");
				Render.text("When the spots clear from your eyes, the kitsune's glamour has been dispelled, revealing her for what she truly is.  A pair of large triangular fox ears poke up from her ");
				if (monster.hairColor == "blonde") Render.text("back-length, flaxen");
				else if (monster.hairColor == "black") Render.text("ass-length, raven");
				else Render.text("shoulder-length, crimson");
				Render.text(" hair, six luxuriously furred tails fanning out behind her.  A layer of ornate tattoos covers patches of her exposed flesh, accentuating her feminine curves nicely.\n\n");
...
//[Will 'O Wisp](C)
		private function willOWisp():void
		{
			...
			Render.text("As you explore deeper into the dense wood, you are abruptly aware that your surroundings have grown darker without warning.  The back of your neck tingles lightly with a sense of foreboding, and you instinctively ready your [weapon], feeling uneasy.  Wracked with paranoia, you find yourself swiveling to face toward every random noise, and you could <i>swear</i> you just heard a voice through the trees.  There it was again!  As the ghostly, feminine laughter fills your ears, you are positive that it can't just be your imagination.  You turn left, then right, trying to pinpoint its source, but it truly sounds as though it is all around you now.\n\n");
			Render.text("Catching a glimpse of motion out of the corner of your eye, you whip around to face it, but are surprised to see that the only thing there is a small, pale blue flame, flitting about idly.  It dances around hypnotically, and as you stare into its ghostly light, you find your conscious mind growing hazy.  Your concerns suddenly seem trivial, and you find yourself relaxing gradually as the ethereal wisp glides along your arms, leaving behind a cool tingle where it touches you.\n\n");
			Render.text("It seems to be beckoning you to follow it.");
...
//[Turn Back] (C)
		...
		{
			clearOutput();
			Render.text("There's no way you're going to go gallivanting off into the woods after some flame.  You shake your head to clear your thoughts, and warily turn away to head back toward camp.  You could almost swear for a moment the flame looked disappointed, and you chuckle lightly at such a silly thought.");
...
//[Follow] (C)
		private function followTheWillOWisp(firstTime:boolean = false):void
		{
			clearOutput();
			if (!firstTime) {
				Render.text("The flame suddenly darts off into the darkness of the trees, and you find yourself unable to resist giving chase.  It feels as though you are being drawn to it by some otherworldly force, but every time your suspicions begin to grow, the flame pauses to float around you, tickling your erogenous zones and then pressing onward.");
				//+15 Lust
				dynStats("lus", 15);
			}
			if ((player.lust >= 100 || player.stats.int < 20) && !firstTime) {
				mansion(false, false);
			}
			//Else:
			else {
				kitsuneSprite();
				if (!firstTime) {
					Render.text("You are unsure of how long you have been stumbling after the flame, but in a brief moment of clarity, you stop dead in your tracks and look around cautiously.  Suddenly you deeply regret having followed the flame this far out of your way.  Your skin crawls as you hear that eerie, ghostly laughter once again, making you shudder involuntarily.  As you turn to head back the way you came, you practically jump out of your " + player.skinFurScales() + " in surprise.  Mere inches from you stands a strange woman with ");
					if (monster.hairColor == "blonde") Render.text("back-length, flaxen");
					else if (monster.hairColor == "black") Render.text("ass-length, raven");
					else Render.text("shoulder-length, crimson");
					Render.text(" hair, smirking precociously.\n\n");
					Render.text("\"<i>My, my, aren't we the clever one?</i>\"\n\n");
					Render.text("As she closes the gap even more, you now notice that she isn't any ordinary woman - a pair of large, vulpine ears parts her hair at the top of her head, and six luxuriously furred tails fan out around her.  A layer of ornate tattoos covers patches of her exposed flesh, accentuating her feminine curves nicely.  She's so close now that a few of the tails are drifting along your " + player.skinFurScales() + ", leaving a trail of crackling blue sparks that impart the same cool tingling that the flame did.\n\n");
					Render.text("\"<i>You resisted my illusions...  that's impressive,</i>\" she says, teasing you with her tails.  You back away from her, but give a start and wheel around when you feel yourself bump into something.\n\n");
				}
				Render.text("\"<i>Going somewhere?</i>\"\n\n");

				Render.text("How did she get behind you so quickly?  You were staring at her the entire time!  Glancing quickly over your shoulder, you confirm that this is not a case of twins, but when you turn to face her, she has disappeared once again!\n\n");
				Render.text("\"<i>Over here, silly~</i>\" she calls to you with a mischievous tone, beckoning to you as you whip around to face her voice.  \"<i>Don't be shy, I don't bite...  often...</i>\"\n\n");
				Render.text("Her tone is innocuous enough, but her mannerisms are a little disconcerting, somehow.  What are you going to do?");
...
//[Talk] (C)
		private function talkAfterResistingKitsunellusion():void
		{
			clearOutput();
			kitsuneSprite();
			Render.text("Odd as she is, she doesn't seem to be overtly threatening, so you decide to try to talk to her.  Searching for something to say, you end up simply asking her why she led you here.\n\n");

			//Blonde
			if (monster.hairColor == "blonde") {
				Render.text("\"<i>Oh, that's not important, dear,</i>\" she says with a sly grin.  \"<i>You're here now, that's what's important...</i>\"\n\n");
				Render.text("Since the conversation began, she has been watching you with a hungry look, strolling around you casually.  Every now and again she leans in, caressing you with her tails and giving you a decent angle down the front of her skimpy robes.\n\n");
			}
			//Black Hair
			else if (monster.hairColor == "black") {
				Render.text("You blink, and she is upon you, her index finger circling its way across your chest.  She is practically hanging off of you as she says, \"<i>You're the catch of the day, cutie!  Mm-mm, and such a tasty-looking morsel.</i>\"\n\n");
				Render.text("You're not sure whether to feel insulted or terrified at the prospect of her calling you food, so you settle on a mixture of the two.  Your eyes are drawn to her, though, as she strolls around, caressing you with her tails and leaning in to tease you with her ample bosom.\n\n");
			}
			//Redhead
			else {
				Render.text("\"<i>Ah!  You caught me,</i>\" she says, feigning embarrassment.  \"<i>It's just so deliciously adorable the way you mortals stumble around in the woods...  I can hardly resist!</i>\"\n\n");
			...
			//MERGE
			Render.text("You twist away, trying to shake off the tingling sensations that are crawling across your body, impairing your ability to think rationally.\n\n");
			Render.text("\"<i>Oh, you're no fun,</i>\" she says, smirking a bit as you pull away.  \"<i>Won't you come and play?  I promise that you won't be disappointed... my sisters and I will see to that.</i>\"\n\n");
			Render.text("Self-preservation battles with curiosity " + ((player.lust > 50) ? "and lust " : "" ) + "as you consider her offer, " + ((player.stats.lib < 50) ? "weighing your chances against the possible dangers." : "eying the voluptuous curves that fill out her robes."));
...
//[Leave] (C)
		private function leaveKitsune(talked:boolean = false):void
		{
			...
			if (talked) Render.text("Nervously, you thank her for her generous offer, but decline, turning to leave.");
			//if PC defeated her in combat
			else Render.text("You turn to leave, ready to put some distance between yourself and the fallen trickster.");
			//MERGE:
			...
			Render.text("\"<i>I have something for you...</i>\"\n\n");

			Render.text("She holds out a small white package tied with string, grinning eagerly.  You hesitate, wondering whether it would be wise to take a gift from this strange woman, but before you can protest, she shoves the package into your hands.  When you look up from the featureless wrapping, there is no sign of her save for the echo of a mischievous giggle through the trees.\n\n");
			Render.text("<b>You have received a Kitsune's Gift!</b>\n");
			if (getGame().inCombat) {
				flags[FlagEnum.BONUS_ITEM_AFTER_COMBAT_ID] = consumables.KITGIFT.id;
				cleanupAfterCombat();
			}
			else {
...
//Illusory Mansion (C)
		private function mansion(willing:boolean, firstTime:boolean = false):void
		{
			...
			kitsuneSprite();
			if (willing) {
				if (!firstTime) Render.text("Curiosity and lust get the better of you, and you decide to throw caution to the wind and take her up on her offer.  If her sisters are any bit as stunning as she is, then you know you're in for a real treat.  She seems pleased with your decision, teasing the underside of your chin with one of her tails and beckoning you to follow her.\n\n");
				//next
				Render.text("She leads you deeper and deeper into the woods, and before long night has fallen.  Thankfully your guide has summoned up a number of pale flames that light your way.  As you peer into the darkness beyond their range, you realize it is now too late to change your mind - even if you wanted to turn back, you would most certainly get lost.\n\n");
				Render.text("The kitsune stops for a moment, turning back to face you, and then disappears into the bushes with a girlish giggle.  You briefly fear that she has abandoned you in the wilderness, but as you break through the other side of the untamed hedge after her, you nearly smack face-first into a large stone wall.  Before you lies an imposing mansion, surrounded on all sides by the impressive wall.  You briefly wonder what sort of madman would build such an extravagant home in the middle of nowhere, but are broken out of your reverie when you spot the kitsune peering out from the gate, waving to you flirtatiously.\n\n");
			}
			else {
				Render.text("The hypnotic power of the flame compels you to follow it for hours, shambling through the woods in a daze.  The sky overhead has grown dark, and though every fiber of your being wills you to resist the wisp's temptation, your body simply refuses to listen.  You only vaguely register crossing the threshold of a large wooden gate, feeling like an observer outside your own body.  An imposing mansion lies before you, and what remains of your rational mind briefly wonders what sort of madman would build such an extravagant dwelling in the middle of nowhere.\n\n");
			}
			//MERGE:
			Render.text("\"<i>Welcome");
			if (flags[FlagEnum.MANSION_VISITED] > 0) Render.text(" back");
			Render.text(",</i>\" you hear as you enter the courtyard, startling you a little.  There to greet you at the mansion's door stands ");
			if (flags[FlagEnum.MANSION_VISITED] > 0) Render.text("the trio of familiar kitsune sisters.");
			else {
				Render.text("a trio of lovely maidens -");
				if (willing) Render.text(" including the one that led you here,");
				Render.text(" a blonde, a redhead, and one with silky black hair.  Their revealing robes are filled out in all the right places, hugging their enticing curves.  Each of them sports a pair of large fox ears and a cluster of luxuriously soft tails that wave hypnotically.");
			}
			if (willing) Render.text("\n\n\"<i>We've been expecting you,</i>\" the blonde one says, stepping forward with a flirtatious grin.");
			else {
				if (flags[FlagEnum.MANSION_VISITED] > 0) {
					if (player.fatigue < 70) Render.text("\n\n\"<i>We're all so thrilled you decided to come see us once again!</i>\"");
					else Render.text("\n\n\"<i>You know, if you keep coming back like this, we just might have to keep you...</i>\"");
				}
				else Render.text("\n\n\"<i>I'm so glad you decided to come with me...</i>\"");
			}
			flags[FlagEnum.MANSION_VISITED]++;
			Render.text("\n\n");

			Render.text("The three ladies close in around you, running their hands over your body and giggling lightly.  You find yourself practically floating among their many tails, drunk on the promise of pleasure as they lead you through the foyer.  They sit you down in front of a long table with a spectacularly opulent spread, and before long you are having your fill of delicacies the likes of which you never dared to dream about.\n\n");
			Render.text("Your cup never remains empty for long, as one of the sisters is always quick to arrive with a fresh decanter.  The strong alcohol burns your throat as it goes down, and it does not take much before your head is swimming.  You have grown so tipsy by now that you don't even register as the girls usher you out of the dining room, only noticing your change of scenery as you feel yourself being pulled down into a warm pool of water.\n\n");
			//next
...
//Formerly shoveHer()
		private function kitsuneShoveHerMansion(willing:boolean = true):void
		{
			...
			if (player.gender == 1 || ((player.gender == 3) && flags[FlagEnum.redheadIsFuta] == 0)) {
				...
				Render.text("She giggles immaturely at the obscene noise, looking back over her shoulder and flashing you a \"who, me?\"  smirk.  Her slippery cunt flexes, skillfully drawing you back inside with a slurp and spurring you back to your wild thrusting.  Pinned beneath the blonde, the redhead trembles with pleasure, grinding her hips upward into yours desperately, running her hands up and down her sister's back in pure ecstasy.\n\n");
				Render.text("You edge closer and closer to your climax, shivering with pleasure as pressure builds in your " + ((player.lowerBody.balls > 0) ? ballsDescriptLight() : "prostate" ) + ".  The " + ((player.lowerBody.cockSpot.hasSheath()) ? "sheath" : "base" ) + " of your " + cockDescript(player.biggestCockIndex()) + " bulges outwardly as the first thick glob of cum swells through it, forcing its way into the blonde's unprotected womb.  ");
				if (player.cumQ() <= 150) {
					Render.text("A few virile streams spurt into her, sloppily smearing her tunnel with your thick load.  Her inner muscles squeeze you involuntarily, a deep crimson blush spreading across her cheeks as a thick spray of girlcum erupts from her pussy.");
				}
				else if ((player.cumQ() > 150) && (player.cumQ() <= 350)) {
					Render.text("Numerous streams spurt into her, sloppily smearing her tunnel with your thick load.  Her inner muscles squeeze you greedily, massaging your shaft to draw your seed toward her convulsing womb, a thick spray of girlcum erupting from her pussy.");
				}
				else if (player.cumQ() <= 1000) {
					...
					Render.text("Hot ropes of cum splash into her womb, smearing her with your thick load.  Her inner muscles squeeze you greedily, massaging your shaft as it swells with virile seed over and over again, thick streams spurting out of her hole as her stomach begins to distend into a jiggling round belly from the pressure.  Her cunt clenches involuntarily as your cloying seed erupts into her and floods her womb, her stomach expanding with a jiggle and hanging low and heavy against the redhead's abdomen with the weight of your seed, while a thick spray of girlcum erupts from her pussy.");
				}
				else if (player.cumQ() > 2500) {
					Render.text("Hot waves of cum crest against her cervix, flooding her womb with your thick load.  Her inner muscles squeeze you greedily, massaging your shaft as it swells with virile seed over and over again, pressurized streams erupting from her snatch as her abdomen swells to an obscene size.  Her pussy squeezes you involuntarily as your cloying seed erupts into her quivering cunt, her stomach rapidly swelling into a heavy, gravid belly, sloshing audibly and pressing against the redhead's abdomen.");
				}
...
//fomerly shoveHer()
		private function kitsunesGenderlessShoverHer(willing:boolean):void
		{
			...
			if (flags[FlagEnum.redheadIsFuta] > 0) {
				...
				Render.text("The black-haired girl's slithering tongue coils around the base of the redhead's softening member, pulling it from your " + ((player.gender >= 2) ? vaginaDescript() : assholeDescript() ) + " with a 'plop!'  " + ((player.gender == 2) ? "A flood of seed begins to spill from your abused pussy, gushing over the redhead's groin and spreading into the water.  The flow is soon stemmed by the introduction of the black-haired girl's tongue, plush lips pressed against your cunt as she hungrily sucks down the outpouring of semen.  She gulps loudly and gluttonously, spreading your lips with her thumbs and swallowing every last delicious salty morsel, her stomach swelling and quivering as your own overfull abdomen begins to deflate in equal measure." : "As her cock slides out, a flood of seed begins to spill from your abused ass, gushing over the redhead's groin and spreading into the water and finally relieving the pressure in your abdomen.") + "\n\n");
				Render.text("With each twitch and spasm of your muscles, you feel your strength slipping away from you with each spasm, your eyelids growing heavy with an uncommon weariness.\n\n");
			}
			else {
				...
				Render.text("Each residual twitch and spasm of your muscles leaves you feeling more fatigued than ever, strength slipping away from you with each spasm and your eyelids growing heavy with an uncommon weariness.\n\n");
			}
			doNext(createCallBackFunction(genderlessKitsuneStillHungry, willing));
		} // end shoveHer()
...
//formerly stillHungry()
		private function genderlessKitsuneStillHungry(willing:boolean):void
		{
			...
			Render.text("A shock of pleasure jolts through you as six golden tails press against your body, azure embers sensually sizzling against your skin.  The blonde giggles lightly as she teases you, her eyes full of mischief, one finger lightly tracing the underside of your jaw.  It's a simple gesture, but the way she does it makes you practically melt into her arms, more a slave to pleasure now than ever.\n\n");
			if (flags[FlagEnum.redheadIsFuta] > 0) {
...
//3+ Tentacle cocks of 30" or longer
		...
		private function outro(tentacles:boolean = false):void
		{
			...
			if (player.fatigue >= 100) {
				...
				if (player.cumQ() < 10000 || (!player.lowerBody.cockSpot.hasCock() && player.lactationQ() < 10000)) {
					...
					Render.text("production has been enhanced.</b>");
				}
				model.time.hours = 6;
				model.time.days++;
				if (!getGame().inCombat)
		...
		private function mansionBadEnd():void
		{
			...
			Render.text("Your muscles are filled with fatigue and soreness from the night's activities, and it feels as though you are carrying a rucksack full of lead on your shoulders.  Just how long were the three of them at it after you passed out?  By the throbbing pain you feel in your hips, it feels like must have kept going all night long.\n\n");
			Render.text("You wander the meandering hallways of the manor for what feels like ages, searching for any sign of an exit.  At last, you find yourself in a familiar area, vaguely recalling passing through this room on the way to the banquet that the sisters had prepared for you.  Only now can you truly appreciate what a terribly foolish idea it was to accept food from the three mischief-makers.\n\n");
			Render.text("Escape is in sight, the front door coming into sight as you round the corner.  The hallway seems to stretch on for eternity as you make a beeline for the exit, the door never coming any closer.  A sinking feeling enters the pit of your stomach as your hope of escape is squashed with just four words.\n\n");
			Render.text("\"<i>Leaving so soon, dear?</i>\"\n\n");
			Render.text("You wheel around to face the manor's three mistresses, beckoning to you with offerings of food and drink in hand.  Though their expressions are innocently jovial, they carry an air of malevolence as they slowly close in on you.\n\n");
			Render.text("\"<i>Won't you stay just one more night?  You can rest your weary bones, and drink your fill...</i>\"\n\n");
			Render.text("You decline their offer, continually backing your way toward the door.  When they are no more than an arm's length away, you make a break for it, spinning in place and dashing madly toward the door - but alas, your ill-fated escape attempt meets with dismal failure.  No sooner have you turned away then you face them once again, and this time they block your escape.\n\n");
			Render.text("\"<i>Please, be our guest....  It gets so lonesome out here, just the three of us...</i>\"\n\n");
			Render.text("Throwing caution to the wind, you rush them, pushing past and barging through the door, filling your lungs with the fresh breath of freedom.  What meets you on the other side makes your heart sink, for you find not the open air of the courtyard, but another stretch of hallway, identical to the one you just left.  There to meet you beyond the threshold are the three kitsune, their lips pursed in identical smirks.\n\n");
			Render.text("As they crowd around, you can feel the lights in your mind flickering off one by one.  Azure flames swirl about the room, capturing you in their hypnotic thrall as you slowly drop to the floor, entranced by the kitsune's witchery.\n\n");
			Render.text("\"<i>You'll stay, won't you?</i>\"  the blonde says, placing her hand under your chin and delicately tipping your head back to look up into her eyes.  As you feel yourself being pulled into the depths of those green pools, you hear someone voicing their assent, only to realize that the voice was your own.\n\n");
			Render.text("You cling to the last vestiges of your mind with all your might, but to no avail.  Your mind, still muddied by the spirits you imbibed the night before, succumbs to the three enchantress' hypnotic power.  Eighteen bushy tails curl around you, pulling you up into a warm, calming embrace, and you have just enough time to register a cool tingling sensation spreading throughout your body before the last glimmer of free will you possess is snuffed out forever.");
...
//[Fight]
		...
		{
			clearOutput();
			Render.text("Something just doesn't sit right with you about this woman, and you cautiously raise your " + player.weaponName + ", watching her carefully.\n\n");
			startCombat(new Kitsune(monster.hairColor));// TODO refactor
			kitsuneSprite();
			//Blonde
			if (monster.hairColor == "blonde") Render.text("\"<i>Ah, so we're going to play like that, are we?</i>\"  she says with a grin, making a small clawing motion in the air.  \"<i>Very well my darling, if that's how you want it, but I won't be taking it easy on you just because you're cute~.</i>\"");
			//Black Hair
			else if (monster.hairColor == "black") Render.text("\"<i>Oh, dear...  are you sure you can't just spare the tiniest morsel?  I'm so hungry...</i>\"\n\nShe licks her lips to accentuate this, rubbing her stomach.  You however, have no intention of being made a meal, or whatever it is she intends to do with you.\n\n\"<i>Well, I guess it can't be helped,</i>\" she says, pursing her lips impishly.");
			//Redhead
			else {
				Render.text("\"<i>Oh, you're not going to make this easy for me, are you?</i>\"");
			...
			if (monster.hairColor == "blonde") Render.text("blonde");
			else if (monster.hairColor == "black") Render.text("black-haired");
			else Render.text("red-haired");
			Render.text(" kitsune!</b>");
			doNext(playerMenu);
		}
...
// For Males and Herms
		private function loseFightToHerms():void
		{
			...
			Render.text("The last thing you see before blacking out is a pair of delightfully plump, round cheeks jiggling happily as the kitsune gathers her robes.");
			player.orgasm();
...
// For Females and Genderless
		private function femalesAndNuetersLoseToKitsunes():void
		{
			clearOutput();
			kitsuneSprite();
			Render.text("\"<i>My, oh my, finished already?</i>\"  the kitsune says as she leans over your slumped form, grinning coyly.  \"<i>If you were going to give up that easily, you could have said so in the beginning and saved yourself the trouble!</i>\"\n\n");
			Render.text("Her tittering laughter rings in your ears, broken momentarily as she grunts with the effort of rolling you onto your back.\n\n");
			Render.text("\"<i>Hehe, time to claim my prize...</i>\"\n\n");
...
//Single cock < 9 inches long
		private function blondeKitsuneRapesSmallWangs():void
		{
			clearOutput();
			kitsuneSprite();
			Render.text("The precocious kitsune closes in on you with a predatory smirk as you fall to the ground, panting furiously.  You look up at her, fearing for whatever she has in store for you.  Mustering up every bit of willpower you have left, you scramble backward, but as you try to drag yourself up to your feet, you find your face pressing into something incredibly soft.  Six shimmering golden tails curl around your body, and you look up from between the kitsune's sizeable breasts to see her grinning down at you, her expression somewhere between doting and hungry.\n\n");
			Render.text("\"<i>Shh...  It'll be easier if you don't resist,</i>\" she whispers, her warm voice melting down your resistance almost instantly.\n\n");
			Render.text("Her fingers trail over your cheek, dazzling sparks bursting to life beneath her fingertips and licking across your skin in their wake, making you shiver comfortably.  Though a small part of your mind still urges you to break away from her tender caress, it is extinguished in short order when she slides her hands under your " + player.armorName + ", running her fingertips over your bare body.  You groan involuntarily, shuddering powerfully and feeling your muscles go slack.\n\n");
			Render.text("Without taking her hands off of you, she skillfully pulls your " + player.armorName + " off piece by piece using her tails, slowly easing you backward onto the ground.  Fully nude, you give yourself over to her tender touch, shivering as the cool flames zigzag down your [fullChest] toward your groin.  Your " + cockDescript(0) + " rises up to brush against the underside of her forearm, twitching lightly.  Smirking gleefully, she gives it a gentle squeeze, pushing it back against your stomach and giggling when she lets it go to watch it spring back, slinging a few thin strings of precum into the air.\n\n");
			Render.text("\"<i>Aww, it's so cuuute...</i>\" she says, running her index finger up and down the shaft, a little bead of azure flame following after it.\n\n");
			Render.text("Your member throbs and twitches involuntarily, her magical touch making you squirm and fidget in pleasure as she drags her fingertip across your sensitive prick.  Your hips buck upward all by themselves, a slick string of precum squeezing out of your cock and landing on the kitsune's face just above her nose.\n\n");
			Render.text("\"<i>No!  Bad!</i>\"  she says, flicking you across the nose with a playful scowl.  She takes your cock in her hand and presses down on your [hips], forcing you back down to the ground and pinning you with a surprising amount of strength.\n\n");
			Render.text("Her tails snake forward, curling around your limbs, and you find yourself pinned, struggling in vain against the uncommonly strong furred coils.  She nods, satisfied with your helplessness, and leans down to gently nuzzle your " + cockDescript(0) + ", cooing softly and sliding her soft, wet tongue along the underside from base to tip with a small giggle.  Her tongue swirls back and forth along the underside of your " + player.cockHead() + ", wrapping around it and slurping up your slick precum.\n\n");
			Render.text("\"<i>Mm...  that's more like it.</i>\"\n\n");
			Render.text("With a satisfied grin on her face, she sits upright again, pulling her robes down slowly.  You can only lie back and watch her disrobe, your member bobbing back and forth in the air freely now.  She teases and brushes your groin with her silken tails, smirking coyly as she begins a sensual striptease.  As the upper portion of her robes falls away, her voluptuous, perky breasts bounce freely, and she starts rubbing the sensitive pink nubs, making them pop out gently.  Her hands glide downward, drawing your eyes across her bare, creamy flesh.  You count a number of tattoos adorning her body, but your gaze is transfixed on the one you can see peeking out just over her waistband.  Swaying her hips back and forth, she tugs the sash that holds the lower part of her robes up and gently shimmies them down, turning just slightly to show off her well-toned but expansive ass.\n\n");
			Render.text("You get an even better look at it when she straddles your shoulders, lowering the quivering cheeks down onto your face.  Buried underneath the soft mounds, you moan in protest, which only serves to make the kitsune shiver with pleasure.  Before she can smother you, though, she lays herself across your front, giving you just enough room to tilt your head back and take a gulp of fresh air before the tremendous cheeks cover your face again.  Your tongue meets the sickly sweet taste of her pussy, sliding out to part the moist folds and lap up and down along her clitoris.\n\n");
			Render.text("Her entire body shudders a bit, and you can now feel her soft breasts squashing against your groin as she leans down to lightly kiss the end of your " + cockDescript(0) + ".  She starts to rock her wide, curvy hips back and forth across your face, grinding her crotch into your mouth and moaning.  The tails that aren't pinning your limbs down gently curl underneath your neck, lifting your head up.  You moan into her pussy as you feel her lips softly wrap around the tip of your shaft, her tongue playing along the " + player.cockHead() + " lightly.  Her lips make a soft smacking noise as she pulls away, and she starts to toy with your member gleefully, stroking it teasingly with her index finger just to feel your reactions trembling up through her loins.\n\n");
			Render.text("\"<i>Oh yeah, that's right, just like that!  Be a good " + player.mf("boy", "girl") + " and lick mama's pussy,</i>\" she groans, mashing her cunt into your face and riding your tongue with an animalistic passion.\n\n");
			Render.text("Her tails flex, pulling your arms up and laying your hands across her delicious derriere, and you begin to squeeze the soft, pliable cheeks of her ass before you can stop yourself.  Your fingers sink deep into the fleshy globes, their delightful jiggle filling your head with all manner of lewd fantasies.  You raise your hips in a vain attempt to garner some attention from your foxy assailant, only to have them shoved back down into the dirt.  " + ((player.stats.int > 50) ? "Weakened though you may be, you're certain she can't actually be that strong - it <i>must</i> be another one of her illusions." : "You don't remember her being that strong!") + "\n\n");
			Render.text("\"<i>No!  You behave, naughty " + player.mf("boy", "girl") + "!</i>\" she growls.  You can practically feel her scowling, despite the fact that your vision is almost entirely obscured by her colossal keister.  To punish you for your transgression, her tails pull your hands away from her ass, and she sits up, smothering you with it.\n\n");
			Render.text("Your tongue continues to plumb her depths while you slowly suffocate beneath her jiggling cheeks.  With every ounce of your will, you try to pull away from her sweet-tasting honeypot, but to no avail.  Her tails have wrapped around the back of your head, keeping you snugly crammed into her crotch, and she rides up and down, heedless of your thrashing protests.\n\n");
			Render.text("You are finally able to tear yourself away from her slavering cunt with a gasp, sputtering and coughing before taking a deep, desperate gulp of fresh air.  Your chest heaves as you fill your lungs with air, slick juices running down your chin and the smell of her feminine musk permeating your senses.  The respite is brief, however, and your head is mashed back into the dirt by the kitsune's heavy bottom seconds later.  This pattern repeats several more times, and by the end of it you are panting heavily, all thoughts of resistance purged from your mind.\n\n");
			Render.text("Satisfied with your submission, she slowly lowers her front to your groin again, wrapping her warm, soft breasts around your neglected member.\n\n");
			Render.text("\"<i>Mm, hey there lil' guy,</i>\" she says in a singsong voice, wrapping one arm around her breasts to squash them down and hold them in place while gently fiddling with the tip of your " + cockDescript(0) + " using her index finger.\n\n");

			Render.text("\"<i>Oooh, right there, lick right there!  If you're a good " + player.mf("boy", "girl") + ", I might just let you cum on my tits.</i>\"\n\n");
			...
			Render.text("Desperate for release, you force your tongue deeper into her sweet, sodden gash than you thought yourself capable, urging her in the only way you can think of to give you the climax you desire.  She bucks forward at the sudden deep intrusion, her lips wrapping around the tip of your cock as it is thrust up from between her pillowy jugs.  The warmth of her mouth and the softness of her tongue caressing your shaft sends a shock of pleasure up your spine, and it is all you can do to keep yourself from bucking your hips upward again, knowing full well that nothing good can come of it.\n\n");
			Render.text("Her lips rise and fall around your spasming prick, low moans vibrating through it each time she pulls back.  You can feel her cheeks pulling inward from the strength of her suction, loud smacks filling the air each time a gap forms in the almost airtight seal of her lips.  She squashes her breasts down as much as she can, lowering her lips to kiss your " + ((player.lowerBody.cockSpot.hasSheath()) ? "sheath" : "base" ) + ((player.lowerBody.balls > 0) ? " and reaching down to gently stroke your " + ballsDescriptLight() : "" ) + ((player.gender == 3) ? ", one of her long, dextrous fingers sliding into your " + vaginaDescript() : "" ) + "\n\n");
			Render.text("Your moan is muffled by her gushing twat, fingers digging into the malleable flesh of her ass as you stuff your face into her cunt, your lustful wail reverberating through her caverns like a symphony through a concert hall.  In unison, you bury your faces into each other's groins, sucking and licking with unabashed passion.\n\n");
			Render.text("Her pussy convulses around your tongue, practically sucking it out of your mouth, and you are abruptly met with the heavy taste of her orgasmic juices, a rush of femcum drenching your face and spurting onto your chest.  Cool air washes over your cock as she pulls her mouth away to belt out a moan, and the pressure in your loins reaches its peak, bubbling over.  ");
			if (player.cumQ() <= 150) {
				Render.text("Your cock twitches and spasms wildly, hot streams of cum spurting out to paint thin white streaks across the moaning fox-woman's breasts.  Glistening droplets of seed slowly roll off the curves of her chest, pooling in a small pocket of cleavage as your flagging cock slowly recedes into the warmth of her bosom.");
			}
			else if (player.cumQ() <= 350) {
				Render.text("You spurt hot strings of cum over her jiggling breasts, streaking her with white as a few errant streams manage to fling themselves across her chin.  A glistening bead of seed slides down the curves of her neck, joining the rest in a small pool between her breasts, your flagging cock gradually receding into her cleavage.");
			}
			else if (player.cumQ() <= 1000) {
				Render.text("Milky white ribbons of cum splatter from your cock, arcing high and crashing down on her face and chest.  Thick globs drip and dribble down her chin, falling to join the puddle of seed pooling between her breasts with a steady, pattering slap as your member slowly recedes into her cleavage.");
			}
			else if (player.cumQ() < 2500) {
				Render.text("Your shaft swells with pleasure, slinging thick jets of seed into the air.  In no time, her face, chest, and hair are plastered with a pearly gloss of semen, dribbling and rolling off her in thick, wet globs.  A puddle of seed overflows across her jiggling breasts, your shaft disappearing into the milky white pool as it recedes into her cleavage.");
			}
			else {
				Render.text("A thick load of semen swells through your cock, spurting high into the air.  A milky white downpour falls across her head and chest in thick streaks, plastering her with a heavy mask of glistening, pearly cum.  It cascades down the curves of her face and breasts, dribbling and sloughing off of her in globs and sheets.  Each breath she takes causes the lake of seed pooling in her cleavage to overflow onto the ground, your shaft long since disappearing into the depths of her cum-soaked cleavage.");
			}
			...
			Render.text("Your last sight before blacking out from the kitsune's spell is a span of creamy white flesh jiggling seductively, quivering gently beneath a cluster of tails.");
...
//Futa rape - chance increases as redhead's lust increases
		private function getRapedByRedHeadFutaKitsune():void
		{
			...
			Render.text("Wrapping her arms around your waist, she stuffs the remainder of her thick member inside you with one thrust, making you howl in ");
			if (player.lowerBody.vaginaSpot.hasVagina()) {
				if (player.vaginalCapacity() < 30) Render.text("a combination of pain and ");
				Render.text("pleasure.  Your muscles instinctively clench down on the intruder, milking her throbbing shaft in blatant disregard of your own desires, and the kitsune moans in pleasure, rolling her eyes back a little.\n\n");
			}
			else {
				if (player.analCapacity() < 30) Render.text("a combination of pain and ");
				Render.text("pleasure.  Your muscles instinctively clench down on the intruder, milking her throbbing shaft in blatant disregard of your own desires, and the kitsune moans in pleasure, rolling her eyes back a little.\n\n");
			}
			//Use same text for anal sex, but using analCapacity instead:
			if (player.gender >= 2) {
				Render.text(((player.vaginas[0].vaginalLooseness < VAGINA_LOOSENESS.GAPING) ? "\"<i>Ah!  Nice and tight, just how I like it!</i>\"  she groans, gripping your waist tightly and beginning to strongly pump her hips." : "\"<i>Hmm...  a little loose for my tastes, but I suppose it'll have to do.  You haven't been slutting it up on minotaurs and tentacle beasts, have you cutie?</i>\"  she says teasingly, giving you a patronizing pinch on the cheek."));
			}
			else {
				Render.text(((player.ass.analLooseness < 3) ? "\"<i>Ah!  Nice and tight, just how I like it!</i>\"  she groans, gripping your waist tightly and beginning to strongly pump her hips." : "\"<i>Hmm...  a little loose for my tastes, but I suppose it'll have to do.  You haven't been slutting it up on minotaurs and tentacle beasts, have you cutie?</i>\"  she says teasingly, giving you a patronizing pinch on the cheek."));
			}
...
//Damage victory
		public function defeatTheKitsunes(display:boolean = true):void
		{
			if (display) {
				...
				kitsuneSprite();
				if (monster.HP < 1) {
					Render.text("The kitsune hits the ground with an 'Oomph', landing roughly on her well-cushioned backside." + ((monster.hairColor == "red" && flags[FlagEnum.redheadIsFuta] == 0) ? "  The moment her rounded rump impacts the dirt, a swirling flame crackles to life between her legs, engulfing her exposed cock.  When it dies away, all that remains of her throbbing member is a pert cherry-colored bud between her dripping lips." : "") + "  She rubs her sore posterior, wincing in pain and pouting childishly.\n\n");

					Render.text("\"<i>I only wanted to play...</i>\" she says, looking crestfallen.\n\n" + ((player.lust >= 33) ? "<b>Well, you can certainly think of a few ways to 'play.'  What will you do to her?</b>" : "" ));
				}
				//Lust victory
				else {
					Render.text("The kitsune falls to the ground, one hand buried in her robes as she plays with herself shamelessly, too turned on to continue fighting." + ((monster.hairColor == "red" && flags[FlagEnum.redheadIsFuta] == 0) ? "  The moment her rounded rump impacts the dirt, a swirling flame crackles to life between her legs, engulfing her exposed cock.  When it dies away, all that remains of her throbbing member is a pert cherry-colored bud between her dripping lips." : "") + "\n\n" + ((player.lust >= 33) ? "<b>As you watch her lewd display, you realize your own lusts have not been sated yet. What will you do to her?</b>" : ""));
				}
			}
			menu();
			let button: number = 0;
			...
			if (monster.hairColor == "red") {
				...
				if (flags[FlagEnum.redheadIsFuta] == 0 && player.lowerBody.cockSpot.hasCock())
					button = kitsuneButton(button, "Lap HJ", nonFutaRedHeadIsWorstRedheadLapsittingHandjobThingIDontKnow);
				//[Helix] - requires herm
				if (flags[FlagEnum.redheadIsFuta] > 0 && player.gender == 3)
				...
				if (player.lowerBody.vaginaSpot.hasVagina() && flags[FlagEnum.redheadIsFuta] > 0)
					button = kitsuneButton(button, "RideHerCock", rideDatRedheadKitsuneCockIntoTheSkyDiamonds);
				if (flags[FlagEnum.redheadIsFuta] > 0 && player.lowerBody.vaginaSpot.hasVagina() && player.upperBody.chest.BreastRatingLargest[0].breastRating >= 4 && player.armorName == "lusty maiden's armor")
		...
		private function kitsuneButton(button: number, nam:string, func:Function): number
		{
...
//[Anal] - requires cock area 144 or less
		private function putItInAKitsunesAssWin():void
		{
			...
			Render.text("\"<i>Heh...  not bad for...  a mortal,</i>\" she says, resuming her previous teasing, though you can tell her heart isn't in it by the satisfied look on her face" + ((monster.hairColor == "red" && flags[FlagEnum.redheadIsFuta] > 0) ? " and the lazy droop of her spent, flaccid member" : "") + ".\n\n");

			Render.text("You take a moment to recuperate, and then begin to gather your things, but when you turn your attention back to the kitsune, there's no sign of her save for the sound of a feminine giggle drifting through the leaves.");
			//Advance time 1hr and return to camp. +Sensitivity, +Libido
			player.orgasm();
			dynStats("lib", 1, "sen", 1);
			cleanupAfterCombat();
...
//[Tail Job] - requires cock
		private function tailJobKitsuneWin():void
		{
			...
			Render.text("\"<i>Come look me up anytime, dear!</i>\"  she calls back when she is safely out of sight.  You briefly consider giving chase, but decide it is not worth the effort, gathering your " + player.armorName + " and turning back toward camp.");
...
//{all " + cockDescript(0) + " calls for this scene should prioritize dog cocks; if PC is in Rut, prioritize other animal dicks second, otherwise use the biggest cock.}
		private function fuckDraftBlond():void
		{
			...
			while (temp < player.lowerBody.cockSpot.count() && x < 0) {
				if (player.lowerBody.cockSpot.list[temp].cockType == CockType.DOG) x = temp;
				temp++;
			}
			if (x < 0) x = player.biggestCockIndex();

			Render.text("You smirk mischievously, getting a particularly evil idea.  If she likes tricks so much, well, you've got one hell of a trick for HER!  You reach into your pouch and pull out a vial of bubbling red potion, running your finger over the word \"Fuck\" inscribed on the side.\n\n");

			Render.text("\"<i>Hey...  wait, what are you do-</i>\"\n\n");

			Render.text("She cries out in protest as you wrestle her to the ground, uncorking the draft with your thumb and using your other hand to plug her nose.  You press the mouth of the vial up to her lips insistently, and it isn't long before she has to gasp for fresh air, allowing you to dump the contents down her throat.  She coughs and sputters a little, trying to spit it out, but you put a bit of pressure on her jaw to prevent exactly that, massaging her neck gently to help coerce her to swallow.  The moment the potent aphrodisiac begins to flow down her throat, you can feel the surface of her skin turn feverish with lust, a blush of deepest crimson spreading across her face.\n\n");

			Render.text("The powerful scent of feminine musk fills the air almost instantly, a viscous puddle spreading between her legs and soaking through the crotch of her robes." + ((player.dogCocks() > 0) || (player.inRut) ? "  As the potent smell fills your nostrils, your " + cockDescript(x) + " swells in anticipation, reacting instinctively to the scent of a female in heat.  Lurid fantasies of plugging her sloppy snatch with your " + ((player.dogCocks() > 0) ? "knot" : cockDescript(x)) + " and stuffing her belly full of kits rush into your mind unbidden" + ((player.stats.cor < 20) ? ", disturbing you slightly" : "") + "." : "") + "  Her body trembles and quakes with carnal need, pure animalistic desire burning in her eyes.  As the effects of her chemical-induced heat come into full swing, she struggles to maintain some semblance of rational thought, desperately willing herself to crawl away.\n\n");

			Render.text("You look on with mild amusement as she drags herself one, two, three feet away, and collapses in a shivering wreck, raising her ample rear into the air.  Her hips flex and pump in defiance of her will, all six of her golden tails raised high and fanned out as she claws out of her robes, exposing her drenched fuckhole and gorgeous tattooed ass.\n\n");

			Render.text("\"<i>Oooh gods, what did you DO to me?!</i>\"  she demands in between gasps of pleasure, plunging her hand into her soaked twat and pounding her fingers in and out furiously.  \"<i>S-sooo...  hot...  I feel...  Ah!  For the love of Marae, j-just fuck me!</i>\"\n\n");

			Render.text("You " + ((player.stats.cor < 33) ? "stifle a laugh, observing her somewhat humorous plight." : "laugh uproariously, relishing the proud kitsune's utter humiliation.") + "  Her face twists into a beautiful grimace of climactic pleasure, her tongue lolling out shamelessly as she rolls her eyes back and orgasms, abruptly and violently.  Clear feminine cum pours from her convulsing pussy, splattering on the ground in a thick puddle.\n\n");

			Render.text("With her cheek mashed into the ground, she squirms and bucks her hips, panting heavily.  Her hand dives into her snatch again and again, disappearing into the hungry folds of flesh over and over.\n\n");

			Render.text("\"<i>Hh...  Why isn't this working!?</i>\"  she cries desperately, tears forming at the corners of her eyes.  \"<i>I...  ah...  cum!  Please, I-I need cum inside me, NOW!</i>\"\n\n");

			Render.text("You grin a bit at her declaration, reaching forward and sliding your finger down her spine gently.  She practically collapses under your light touch, convulsing in pleasure as every one of her tails bristles in response, nearly orgasming again from that alone." + ((player.stats.cor < 33) ? "  You wonder if you've gone too far, and whether you should be somewhat concerned for the poor thing's sanity.  If you don't do something to satisfy her insatiable lust, though, that alone might be enough to break her." : "  You grin evilly, dragging your fingertips down your new pet's back and laughing as she spasms uncontrollably, spraying femcum unceasingly.  The little cocktease was so keen on making a fool of you before - where's her smug sense of superiority now?") + "\n\n");

			if (player.dogCocks() > 0 || player.inRut) Render.text("The sweet musk of her voluminous fem-jizz fills your mind with a lustful haze, higher-order thought processes gradually shutting down as animalistic mating instinct begins to take over.  ");
			Render.text("You slide your " + cockDescript(x) + " up between the supple mounds of her ass, groaning in pleasure as she begins to glide her hips back and forth along the shaft, cooing softly.  The warm, moist breath radiating off her sodden vagina caresses your ");
			if (player.lowerBody.balls > 0) Render.text(ballsDescriptLight());
			else Render.text(player.legs());
			if (silly()) Render.text(" with a heat you could roast marshmallows over.");
			else Render.text(" with a heat that sends blood rushing to your groin.");
			Render.text("  She raises her hips higher, whimpering a little as she desperately tries to line up your " + cockDescript(x) + " with her hungry fuckhole.\n\n");

			Render.text("\"<i>S-stop t-teasing...</i>\" she says breathlessly, whimpering as she fails to catch your " + player.cockHead(x) + " in her quivering snatch for the third time in a row.  Her hips clumsily rock back, a desperate whine escaping her throat as she tries to calm her shaking body enough to finally impale herself on your ever-hardening rod.");
			if (player.dogCocks() > 0 || player.inRut) {
				Render.text("  Your animalistic need to impregnate the fertile female in front of you battles with your desire to tease her, but impulse is quickly winning out over rationality.  You can only hold yourself back for a few moments longer before you give in to baser instincts and plunge your shaft into her needy pussy");
				if (player.cockArea(x) > 50) Render.text(" heedless of whether she can handle it or not.  Thankfully, you needn't worry - her cunt eagerly swallows your cock whole with room to spare, somehow");
			}
			else {
				Render.text("  Her needy thrusts do their part to endear you to her desperation, rapidly breaking through your desire to tease her.  You hold out for just a bit longer before finally succumbing to your lusts, driving your rod deep into her needy pussy");
				if (player.cockArea(x) > 50) Render.text(" heedless of whether she can handle it or not.  Thankfully, you needn't worry - her cunt eagerly swallows your cock whole with room to spare, somehow");
			}
			Render.text(".  Her insides feel like a furnace, the slick walls closing in around your cock, rippling along the length intensely.\n\n");

			Render.text("A jet of warm girlcum splashes out against your " + ((player.lowerBody.balls > 0) ? ballsDescriptLight() : player.legs() ) + " as the kitsune claws at the ground, launched into the throes of another orgasm.  Her walls convulse around your throbbing cock, gripping you like a vice.  They suck you deeper inside, prompting you to begin vigorously thrusting your hips, your loud moans joining her cries in a chorus of pleasure.  As her trembling orgasm begins to subside into the more manageable pleasure of mating, she begins to slam her ass back to meet you, each thrust forcing the air from her lungs and punctuating each moan with a loud grunt.\n\n");

			Render.text("\"<i>Nngah!  Fuck!  I-it feels s-so good!</i>\"\n\n");

			Render.text("You dig your fingertips into her massive, plush ass and begin to pound her wet snatch with all your might, grunting and groaning passionately.");
			if (player.dogCocks() > 0 || player.inRut) Render.text("  Vivid fantasies of stuffing her pussy full of your virile semen race through your mind, unable to think of anything else.  Come whatever may, you know you MUST impregnate her - there's simply no other option.");
			Render.text("  The force with which she mashes her voluptuous derriere back into your pelvis would surely leave you sore in the morning were it not for the expansive tattoo-adorned ass cushioning the blows.\n\n");

			//if (dogCocks > 0)
			if (player.dogCocks() > 0) {
				Render.text("The lips of her slippery pussy stretch over your canine knot a little more with every thrust, and with one last savage assault you force the bulge inside her, shaking from head to toe in pleasure.\n\n");

				Render.text("The kitsune rolls her eyes back and opens her mouth in a cacophonous scream of pleasure, stunned stiff by her hardest climax yet.  Her inner muscles contract around your knot powerfully, rooting you in place as steaming hot orgasmic juices gush out over your groin.\n\n");
			...
			Render.text("Gathering her tails into your arms, you pull them tight to your chest, eliciting a pleasured moan from the lust-maddened kitsune.  She lets out a pained squeal when you tug on them suddenly, using them for additional leverage as you redouble your powerful thrusting.  You can feel every pulse of her fluttering heartbeat through the walls of her vagina, liquid heat caressing and milking your cock as more juices squirt out around your " + ((player.dogCocks() > 0) ? "knot" : cockDescript(x) ) + ".\n\n");

			Render.text("Your pleasure begins to rise to a head, every passionate thrust bringing you closer and closer to your final, incredible release.  In preparation, you drop down over her, placing your hands on top of " + ((player.stats.cor < 33) ? "hers." : "her wrists to pin her down.") + ( ((player.dogCocks() > 0) || player.inRut) ? "  You are stricken with the urge to bite her neck, and indulge it, pinching the scruff of her shoulder between your teeth." : "") + "  With a roaring moan, you buck your hips one last time, slamming down against her well-cushioned rear with one final thrust, holding there as the pressure in your " + ((player.lowerBody.balls > 0) ? ballsDescriptLight() : "prostate" ) + " finally boils over.  ");

			if (player.cumQ() <= 150) {
				Render.text("Your cock spasms uncontrollably, spewing stream after stream of potent jizz into her hungry snatch.  The instant it begins to flow inside her, she locks down into another incredible orgasm, fingers digging into the dirt while tears flow from the corner of her eyes, moaning powerfully.  Her walls milk and massage you, drinking deeply of your virile cum.");
			}
			else if (player.cumQ() <= 350) {
				Render.text("Sticky ribbons of jizz fire into her hungry pussy one after another, coating her slick walls with your thick, salty cum.  The instant it begins to flow inside her, she locks down into another incredible orgasm, fingers digging into the dirt while tears flow from the corner of her eyes, moaning powerfully.  Her muscles contract and convulse, hungrily milking your cock of every drop it has to offer.");
			}
			else if (player.cumQ() <= 1000) {
				Render.text("Your urethra distends as load after load of sticky jizz flows up the shaft of your cock, frothing into the kitsune's belly.  The instant it begins to flow inside her, she locks down into another incredible orgasm, fingers digging into the dirt while tears flow from the corner of her eyes, moaning powerfully.  As her walls rhythmically milk and squeeze your cock, she begins to develop a slight belly, the swelling bulge jiggling a bit with the weight of your emissions.");
			}
			else if (player.cumQ() < 2500) {
				Render.text("The shaft of your cock swells as thick gobs of cum begin to erupt from the tip, rushing down her sopping fuckhole and pouring into her uterus.  The instant it begins to flow inside her, she locks down into another incredible orgasm, fingers digging into the dirt while tears flow from the corner of her eyes, moaning powerfully.  Her muscles continue to squeeze your shaft hungrily long after your abundant reserves have been depleted, her cum-bloated belly sloshing beneath her, jiggling with the weight of your cum.");
			}
			else {
				Render.text("You can actually hear the sound of your cum pouring into her, stuffing load after load of potent jizz into her fertile womb.  The instant it begins to flow inside her, she locks down into another incredible orgasm, fingers digging into the dirt while tears flow from the corner of her eyes, moaning powerfully.  ");
				if (player.hasKnot(x)) Render.text("Her belly balloons to a ludicrous size, swelling more by the second as you continue to pump her full.  Your knot blocks the only escape, forcing her to endure as her abdomen swells with your seed, sloshing and jiggling heavily.");
				else Render.text("The sheer volume is more than she can handle, and when her now heavily pregnant-looking belly begins to press against the ground, pressurized streams start to pour out of her tight hole, splattering against your [hips] and [fullChest].");
				Render.text("  Despite looking quite as though she has swallowed a beach ball, her sloppy cunt continues to milk your shaft of every drop it can squeeze, even long after your incredible reserves are depleted.");
			}
...
//[Ovi Elixir]
		private function doseAKitsuneWithOviElixirs():void
		{
			...
			Render.text(" about the size of ostrich eggs.  You pick one up and examine it, rolling it in your hand a bit.  A rustling in the bushes brings your focus back to the kitsune, but by the time you look up, all you see is a set of golden tails slipping into the underbrush.\n\n");
			player.consumeItem(consumables.OVIELIX);
			Render.text("\"<i>Take good care of my little eggies, darling!</i>\"");
			//{replace normal kitsune loot tables with randomly colored eggs}
			flags[FlagEnum.BONUS_ITEM_AFTER_COMBAT_ID] = itype.id;
			//Advance time 1hr and return to camp. +Sensitivity, +Libido
			player.orgasm();
			dynStats("lib", 1, "sen", 1);
			cleanupAfterCombat();
...
//[Lactaid]
		private function lactaidDoseAKitSune():void
		{
			clearOutput();
			kitsuneSprite();
			Render.text("You lick your lips hungrily, staring at her voluptuous tits, just barely contained in her robes.  Reaching into your pouch, you pull out a bottle of Lactaid and swirl it around in your hand, grinning darkly.  As you lean down over her, the kitsune eyes you suspiciously, her gaze moving back and forth between the bottle and you.  She makes a halfhearted attempt to crawl away, letting out a cry when you grab her by the " + ((player.stats.cor < 33) ? "hem of her robe" : "tail") + ", pulling her back.\n\n");

			Render.text("\"<i>Eheh...  you know all that other stuff before was just playing, right?  Eep!</i>\"\n\n");

			Render.text("Wrestling her to the ground, you tip the bottle of creamy liquid into her mouth, making it abundantly clear that she's to swallow every drop.  You keep the lip of the bottle pressed up to her mouth until she has obediently swallowed the entire contents, then dispose of the empty container.\n\n");

			Render.text("Almost immediately, her already sizeable breasts begin to expand, swelling up against the inside of her robes before spilling over with a bountiful jiggle.  She moves her hands up to support her rapidly expanding bust, her tits growing several cup sizes in the space of a minute.  Once the swelling in her breasts begins to slow, her nipples follow suit, the areolae puffing out and swallowing her pinkie-sized nubs.  Slowly at first, a creamy white substance begins to drip from her inverted nipples, the flow increasing gradually over time.\n\n");

			Render.text("\"<i>M-my chest!  F-feels so...  hot...</i>\" she moans, rolling her eyes back and beginning to play with her breasts, kneading the expansive flesh with both hands as milk trickles down the curves and over her fingers.  All told, you judge her tremendous mammaries to be about H-cups in size, far out of proportion for even her curvy frame.\n\n");

			Render.text("You grin and rub your palms together lecherously, then reach out to snatch them out of her hands, explaining that her fat milk-udders belong to you now.  With one of her obscenely huge tits in each hand, you press them together, squashing them up between your palms and shuddering at the way they feel.  The incredibly soft flesh spills over your fingertips with every squeeze, milk spurting from her puffy, puckered nipples and drenching her front.  Tentatively, you lift one of your milk-soaked fingers to your lips and lick it, savoring the sweet, almost minty aftertaste that sends an involuntary shudder down your spine.\n\n");

			Render.text("Pleased with the results of your little experiment, you release her gargantuan jugs, letting them bounce and quiver back into position before standing up.  Shedding your " + player.armorName + ", you run your hands down over your groin, lowering yourself down over her once again and scooting up to press against the underside of her breasts.  Laying [eachCock] in between the heaving mounds of titflesh, you gather up her breasts and squash them together again, moaning as the soft skin envelops your throbbing member" + ((player.lowerBody.cockSpot.count() > 1) ? "s" : "" ) + ".  Warm milk trickles down into her cavernous cleavage, flowing over your shaft" + ((player.lowerBody.cockSpot.count() > 1) ? "s" : "" ) + " and leaving behind an odd tingling sensation that makes you shudder.\n\n");

			Render.text("\"<i>Ooh...  that feels...</i>\" she groans, a soft pink blush spreading on her cheeks as she bites her knuckle.\n\n");

			Render.text("Your hands stray upward toward her puffy areolae, and you circle your thumbs across the sensitive flesh, eliciting a chorus of shameless moans from the kitsune.  She arches her back, thrusting her chest upward underneath you and spurting copious streams of milk into the air like a lewd fountain.  You press your fingertips down into her pliable jugs, watching the way the jiggling flesh ripples and squashes around your hands with an almost giddy delight.  Even the slightest amount of pressure causes a fresh trickle of milk to spill out of her inverted nipples, dribbling down and filling the expansive canyon in between.\n\n");

			Render.text("You slowly begin to thrust [eachCock] through the slippery passage, revelling in the way her tremendous tits squeeze around your throbbing shaft" + ((player.lowerBody.cockSpot.count() > 1) ? "s" : "" ) + ".  The warmth of her flesh contrasts wonderfully with the cool tingling of her milk coating your cock" + ((player.lowerBody.cockSpot.count() > 1) ? "s" : "" ) + ", heightening your pleasure to incredible levels and making you groan and shiver.  Her chest rises and falls beneath you with every heaving breath she takes, shuddering with her needy moans.\n\n");

			Render.text("\"<i>Oh Marae, it feels so good!</i>\"  she moans, rolling her eyes in pleasure as you continue to thrust [eachCock] in between her sensitive tits.  \"<i>Fuck my tits, k-keep going!</i>\"\n\n");

			Render.text("She moves her forearms up to press against the sides of her breasts, hooking her fingers over the top of her bust and squeezing inward with her elbows.  Freed to move your own hands elsewhere, you knead her nipples for a bit, running your thumbs in wide circles around the edges as you slowly spiral them inward.  Pressing your thumbs inward, you spread the puffy pucker of her areolae, inserting your fingers to get at the sensitive nubs inside.  She cries out in ecstasy when you pinch her engorged nipples, squeezing thick streams of milk out as you pull on them gently, forcing them to pop out.  It is only now that you can truly appreciate the effects of the Lactaid you fed her, her sensitive pink nubs having swollen up to the size of large cherries.\n\n");

			Render.text("Pinching around the base of her overgrown teats, you tilt them toward her face and squeeze, spurting milk into the kitsune's face.  She winces in surprise at first, but then opens her mouth, catching the streams on her tongue and lapping them up eagerly.  With a firm squeeze, you then aim her engorged nipples toward your own mouth, leaning down to drink deeply.  A good deal of it misses your tongue and begins to drip messily down your chin, but you savor the taste of what little you manage to get in your mouth, humming your satisfaction.\n\n");

			Render.text("Together with her, you squash her jiggling jugs against [eachCock] as tight as you can and begin to thrust with renewed vigor, sending ripples through her chest each time your hips impact her milk-swollen tits.  She moans shamelessly, craning her neck up to lap up her milk from the tops of her breasts and even running her tongue across [oneCock] whenever it is within reach.  Shuddering heavily, she begins to slide her arms up and down the sides of her chest, adding a little extra sensation to the wonderful titfuck.  Her breasts are constantly gushing milk now, her entire front soaked through and a puddle forming around her on the ground.\n\n");

			Render.text("Bearing down on her chest, you redouble your thrusting, the telltale quivering of an inevitable orgasm starting to build in your loins.  Loud liquid slapping noises fill the air each time you pass in between her immense udders, milk and precum coating every inch of her cleavage.  With a groan, you buck your hips forward one last time, [eachCock] twitching as your climax boils to the surface.\n\n");

			if (player.cumQ() <= 150) {
				Render.text("Spurts of thick semen bubble out in between her breasts, a few pressurized streams flying across the space from her chest to her face and landing wetly on her lips.  Thick globs dribble down to pool in the shallow depression above her sternum.");
			}
			else if (player.cumQ() <= 350) {
				Render.text("Her cavernous cleavage is filled with your bubbling seed, thick spurts of semen splattering out onto her neck and face.  Her chest is plastered with milk and cum, dribbling and flowing down around her shoulders and chin.");
			}
			else if (player.cumQ() <= 1000) {
				Render.text("Pressure builds in your groin, your shaft" + ((player.lowerBody.cockSpot.count() > 1) ? "s" : "" ) + " swelling up in the moments just before your orgasm.  Thick ribbons of cum spurt from between her tits, flying across her face and neck with a series of wet slaps.  Her chest and face are drenched with a creamy mask of milk and cum, a thick pearl necklace slowly dripping down around her shoulders.");
			}
			else {
				Render.text("Your cock");
				if (player.lowerBody.cockSpot.count() > 1) Render.text("s swell");
				else Render.text(" swells");
				Render.text(" up incredibly from the thick loads of seed rushing out all at once, a thick ribbon of cum splattering against the walls of her cleavage and spurting out onto her face.  Load after load of semen spurts from between her breasts, coating her face and chest with a sticky mask that mats down her golden hair.");
				if (player.cumQ() >= 2500) Render.text("  It seems as though your climax goes on forever, fresh streamers of cum flying everywhere until the milky white puddle surrounding her is equal parts milk and seed.");
			}
...
//[Hotdog Anal] - replaces regular Anal option only for the black-haired girl.
		private function hotdogAnalInKitsuneButtDontLetTailTickleYourNose():void
		{
			...
			if (player.cumQ() <= 150) {
				...
				Render.text("She lies spread eagle on her face, panting contentedly as her six ebony tails waft left and right in the air.  A continuous river of cum follows your cock shortly after you pull out, pooling on the ground between her thighs in a slippery puddle.");
			}
...
//[GetBJ] - requires cock 108 area or less
		private function getABJFromAFoxGirl():void
		{
			...
			Render.text("Standing over the beaten kitsune, you hear a barely audible groan.  Curiously, you lean down, and are surprised to find that the sound is coming from the girl's stomach.\n\n");

			Render.text("She gently rubs her somewhat pudgy tummy, sighing and whimpering, \"<i>So hungry...</i>\"\n\n");

			Render.text("So, she's hungry, is she?  With a smirk, you tell her you have just the thing to fix that.\n\n");

			Render.text("Stripping out of your " + player.armorName + ", you pull her into a kneeling position and press her back against a tree, presenting your " + cockDescript(x) + " with a grin.  She ogles it hungrily and licks her lips, eyes wide with desire.  As she reaches up to take it into her hands, you grab her wrists instead and pin them to the trunk of the tree.  You explain that she is to use only her mouth, and that if she does her job properly, <i>then</i> you will satiate her hunger.\n\n");

			Render.text("She pouts coyly, pursing her plush, kissable lips.  Your eyes are drawn to them, and it is only now that you notice just how juicy and full-looking they truly are.  As she leans forward to press them to your " + player.cockHead(x) + ", they seem to plump up even more, their warm wetness sending a shiver of pleasure through your groin.\n\n");

			Render.text("Grinning up at you, she dips underneath your shaft, lifting it up with her nose, flattening out her tongue around the underside of your " + ((player.lowerBody.cockSpot.hasSheath()) ? "sheath" : "base") + " and running it slowly upward.  Having her wrists restrained doesn't seem to be hampering her ability to pleasure you much at all - it even seems to be turning her on.  She pushes your " + cockDescript(x) + " up against your stomach using her nose, kissing along the underside longingly and making wet smacking sounds.\n\n");

			Render.text("\"<i>Mmn...  it'th tho delithiouth...  can'th waith thil 'oo fee' me lotth of tasthty cu'n,</i>\" she slurs around your hardening member, always staring up at you demurely with those big green eyes.\n\n");
...
//[Ride] - requires vagina
		private function rideDatRedheadKitsuneCockIntoTheSkyDiamonds():void
		{
			clearOutput();
			kitsuneSprite();
			Render.text("You watch the downed kitsune closely, strafing around her as you close in.  One never can be too careful, and you certainly have reason to suspect that this may just be another trick.  Thankfully, it appears the clever seductress' trickery has run its course.");
...
//REDHEAD KITSUNE
		private function helixZeKitsunes():void
		{
			...
			Render.text("As your cocks pass each other on the dismount, they are followed by thick, musky-smelling fountains of cum that pour from your uncorked vaginas, spilling onto the ground in a large, homogenous puddle.  The kitsune rolls onto her back in exhaustion, her spent cock hanging limply over one thigh" + ((player.cumQ() > 1000) ? " as her swollen abdomen slowly drains onto the forest floor" : "") + ".\n\n");

			Render.text("You turn to gather your " + player.armorName + ", cleaning up and dressing once more, then whip around to the sound of rustling leaves.  A set of sticky footprints leads your gaze to the edge of a bush, a flash of red tails and a pair of plump hind cheeks disappearing into the forest.");
			//Advance time 1hr and return to camp. +Sensitivity, +Libido
			player.orgasm();
			dynStats("lib", 1, "sen", 1);
			cleanupAfterCombat();
...
//AKA Lose the dick, schweethaat AKA put that thing away
		private function redheadsDontDeserveToHavePenisesBecauseTheyreTooGayForPenisOrSomethingIDontReallyKnowHowThisWorksOrWhyThisFunctionNameIsSoFuckingLong():void
		{
			clearOutput();
			kitsuneSprite();
			Render.text("You squint slightly, leering at the bulge between the kitsune's legs with a slight frown.  Your gaze travels up and down her voluptuous form, eying the girl's lovely curves carefully.  It's decided - if you're going to be having fun with her, that thing has got to go.\n\n");

			Render.text(((silly()) ? "\"<i>Not liking dicks, what are you, gay?</i>\"  the kitsune teases in a perfect deadpan." : "\"<i>Oh, how boring,</i>\" she mutters disappointedly, her lower lip quivering in a mocking pout.") + "\n\n");

			Render.text("You grumble in exasperation and jab your finger toward her groin, then thumb the air over your shoulder with an insistent whistle.\n\n");

			Render.text("Rolling her eyes, she hesitantly complies, a wreath of flame engulfing her mismatched genitals with the crackling snap of a flint being struck.  When the azure blaze dissipates, her foot long cock has regressed into a pert cherry-colored nub.\n\n");

			Render.text("\"<i>Fine, you beat me.  Fair's fair...");
			if (silly()) Render.text(" you monster.");
			Render.text("</i>\"\n\n");

			Render.text("<b>What will you do with her now?</b>");
			// Set flag (redheadIsFuta = false)
			flags[FlagEnum.redheadIsFuta] = 0;
...
//[Bring Back Dick] // AKA you don't know dick about dick AKA the dickening
		private function bringBackDick():void
		{
			clearOutput();
			kitsuneSprite();
			Render.text("You look her over contemplatively, rubbing your chin in thought as you stare at her crotch.  Somehow, it seems...  empty.  Something is missing.\n\n");
			...
			Render.text("As the last wisps of flame curl off into the air and disappear, her cock solidifies, standing proud and erect with a thin trickle of precum already dribbling down the shaft.\n\n");

			Render.text("\"<i>Mn...  About time you decided to walk on the wild side,</i>\" she teases, smirking at you coyly.");
			// Set flag (redheadIsFuta = true)
			flags[FlagEnum.redheadIsFuta] = 1;
...
//Non-Futa Redhead: [Some sort of lapsitting handjob thing, I don't know]
		private function nonFutaRedHeadIsWorstRedheadLapsittingHandjobThingIDontKnow():void
		{
			...
			Render.text("\"<i>I'm gonna...  g-gonna...</i>\"  she manages to stutter between panting and thrashing in your arms.  You cut her off before she can finish by gently biting down on her ear, and mutter through clenched teeth that she's forbidden to cum before you.\n\n");
...
//Non-futa Redhead: [Bondage] - requires a cock with area <= 144 due to some anal
		...
		/*Use whichever enhancement scene(s) you feel like.
		 ...
		 Render.text( "Lumi snatches the jewel from your hand, staring wide-eyed into the fathoms of its depths.  She remains like that for several moments before you clear her throat, and then hurries off to work.  Flitting back and forth between the various beakers and test tubes that litter the workshop, she mixes chemicals seemingly at random, many of which bubble or explode rather violently.\n\n
...
//Discovery
		...
		{
			clearOutput();
			if (flags[FlagEnum.KITSUNE_SHRINE_VISIT] == 0) {
				Render.text("Your travels take you down a winding path through the forest today, deep in the heart of the woods.  Each step you take makes it feel even more like the dense foliage is creeping in even closer, the rough-hewn dirt path dwindling down to almost nothing up ahead.  Whatever the trail was used for long ago, it is in the late stages of being reclaimed by the wilderness now.\n\n");

				Render.text("While you are mindful of this land's dangers, you are curious what secrets this part of the forest might hold.  You press on, trudging through the weed-choked trail, doing your best to keep your wits about you as you march onwards.\n\n");

				Render.text("You emerge from the dense foliage into a large clearing.  Your eye is immediately drawn to an absurdly large tree in the center, its weathered trunk covered in knots and gnarls.  Odd-looking paper talismans hang from some of the branches, swaying eerily in a nonexistent breeze.  Worn down flagstones wind around the ancient-looking tree to a small, run-down wooden building that looks like it could comfortably accommodate a single person if it wasn't in such a dilapidated state.\n\n");

				Render.text("You call out, but the place seems to be abandoned.  Shrugging, you decide to take a look around the building, hefting a rotten timber out of the way of the door and creeping inside carefully, just in case you aren't really alone.\n\n");

				Render.text("It takes a moment for your eyes to adjust to the dim light inside the musty shed, but you eventually start to piece together the makings of a simple dwelling.  An old bedroll lies in one corner, assorted cooking implements hung with care over a small fire pit.  In the rear of the one-room building is enshrined a small pedestal, atop of which stands a small gold statue of an androgynous figure with nine tails.  A short distance away stands a bookcase filled with musty tomes and scrolls of all shapes and sizes.\n\n");
...
//[Meditate]
		...
		{
			clearOutput();
			if (player.hasItem(consumables.FOXJEWL) && player.tailType == TAIL.FOX && player.lowerBody.tailVenom < 9 && player.lowerBody.tailVenom + 1 <= player.level && player.lowerBody.tailVenom + 1 <= player.stats.int / 10 && player.upperBody.head.earType == EARS.FOX && !player.perks.has("CorruptedNinetails") && !player.perks.has("EnlightenedNinetails")) {
				//20% chance if PC has fox ears, 1 or more fox tails, carries a Fox Jewel, and meets level & INT requirements for the next tail:
				Render.text("You sit down carefully on a small mat in front of the shrine and clear your mind.  Closing your eyes, you meditate on the things you've learned in your journey thus far, and resolve to continue fighting against the forces of corruption that permeate the land.\n\n");

				Render.text("Nearing the end of your meditation, you are inexplicably compelled to reach into your bag and pull out the small teardrop-shaped jewel you were carrying.  As you stare past the translucent surface of the bead and into the dancing fire within, the jewel begins to dissolve in your hand, the pale flames within spilling out and spreading over your body.\n\n");
				if (player.lowerBody.tailVenom < 8) {
					...
					Render.text("As the mystical flames wash over you, your mind is assaulted by a maelstrom of otherworldly knowledge and power.  For a moment it feels as though your mind will be torn asunder, but you are ready.  Your travels and meditations have prepared you well, and you open your mind to accept enlightenment.\n\n");
					Render.text("Your bushy tails begin to glow with an eerie, ghostly light, and with a crackle of electrical energy, split into nine tails.  <b>You are now a nine-tails!  Untold cosmic power radiates from your very being!  Use it wisely...</b>");
				...
				//Normal:
				Render.text("You sit down carefully on a small mat in front of the shrine and clear your mind.  Closing your eyes, you meditate on the things you've learned in your journey thus far, and resolve to continue fighting against the forces of corruption that permeate the land.  As you open your eyes again, you feel as if a great burden has been lifted from your shoulders.\n\nWith a renewed vigor for your quest, you stand up and set off for camp.");
...
//[Steal Statue]
		private function stealAStatue():void
		{
			clearOutput();
			menu();
			if (flags[FlagEnum.TOOK_KITSUNE_STATUE] == 0) {
				Render.text("Feeling the chance is just too great to pass up, you rub your hands together greedily and snatch the gold statue from the shrine.  As you stuff it into your pouch, you are overwhelmed with the sensation that what you are doing is very wrong.  You are starting to have second thoughts...");
				//[Take It] [Put it Back]
				addButton(0, "Take It", takeAKitsuneStatue);
			}
			else {
				Render.text("The empty alter stands there, obviously missing the statue you took from it.  You COULD put it back, if you wanted.");
...
//[Take it]
		...
		{
			clearOutput();
			Render.text("The thought of how many gems you'll be able to get for it is enough to quickly suppress those feelings, avarice winning out over guilt.");
			...
			flags[FlagEnum.TOOK_KITSUNE_STATUE] = 1;
		}
...
//[Put it Back]
		...
		{
			clearOutput();
			Render.text("Regretting your decision, you replace the statue on the pedestal, your guilty conscience winning out over greed today.");
			//Advance 1hr and return to camp.
			flags[FlagEnum.TOOK_KITSUNE_STATUE] = 0;
