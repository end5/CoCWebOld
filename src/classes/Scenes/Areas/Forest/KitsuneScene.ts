...
//[Talk] (C)
		private talkAfterResistingKitsunellusion():void
		{
			...
			MainScreen.text("Self-preservation battles with curiosity " + ((player.lust > 50) ? "and lust " : "" ) + "as you consider her offer, " + ((player.stats.lib < 50) ? "weighing your chances against the possible dangers." : "eying the voluptuous curves that fill out her robes."));
...
//Illusory Mansion (C)
		private mansion(willing:boolean, firstTime:boolean = false):void
		{
			...
			if (flags[FlagEnum.MANSION_VISITED] > 0) MainScreen.text(" back");
			...
			if (flags[FlagEnum.MANSION_VISITED] > 0) MainScreen.text("the trio of familiar kitsune sisters.");
			else {
...
//fomerly letHer()
		private kitSuneLetHerMansion(willing:boolean = true):void
		{
			...
			MainScreen.text(" around her shaft sends her over the edge, and she begins to groan loudly in your ear, digging her fingertips into your " + hipDescript() + ".  Her turgid rod trembles in your ");
			if (player.gender >= 2) MainScreen.text(vaginaDescript());
			else MainScreen.text(assholeDescript());
...
//Formerly shoveHer()
		private kitsuneShoveHerMansion(willing:boolean = true):void
		{
			...
			MainScreen.text("\"<i>F-fine...</i>\" she says quietly, rolling her eyes back in pleasure as you scratch behind her ears and run a finger coercively down her cheek." + ( flags[FlagEnum.redheadIsFuta] > 0 ? "" : "  Reaching down between her legs, you nod in satisfaction as you feel her cock slowly receding, shrinking down into a pert, solid pleasure bud between her puffy lips.") + "\n\n");
...
//formerly
		private kitsuneStillHungryMansion():void
		{
			...
			MainScreen.text("Still overly sensitive from the exhilarating romp you had just taken part in, your " + cockDescript(player.biggestCockIndex()) + " begins to throb and twitch excitedly within the black-haired girl's throat, already being pushed to the limits of your endurance.  ");
			if (flags[FlagEnum.redheadIsFuta] > 0) {
...
//Single cock < 9 inches long
		private blondeKitsuneRapesSmallWangs():void
		{
			...
			MainScreen.text("Her fingers trail over your cheek, dazzling sparks bursting to life beneath her fingertips and licking across your skin in their wake, making you shiver comfortably.  Though a small part of your mind still urges you to break away from her tender caress, it is extinguished in short order when she slides her hands under your " + player.armorName + ", running her fingertips over your bare body.  You groan involuntarily, shuddering powerfully and feeling your muscles go slack.\n\n");
			...
			MainScreen.text("Her entire body shudders a bit, and you can now feel her soft breasts squashing against your groin as she leans down to lightly kiss the end of your " + cockDescript(0) + ".  She starts to rock her wide, curvy hips back and forth across your face, grinding her crotch into your mouth and moaning.  The tails that aren't pinning your limbs down gently curl underneath your neck, lifting your head up.  You moan into her pussy as you feel her lips softly wrap around the tip of your shaft, her tongue playing along the " + player.cockHead() + " lightly.  Her lips make a soft smacking noise as she pulls away, and she starts to toy with your member gleefully, stroking it teasingly with her index finger just to feel your reactions trembling up through her loins.\n\n");
			...
			MainScreen.text("\"<i>Mm, hey there lil' guy,</i>\" she says in a singsong voice, wrapping one arm around her breasts to squash them down and hold them in place while gently fiddling with the tip of your " + cockDescript(0) + " using her index finger.\n\n");
			...
			MainScreen.text("Her lips rise and fall around your spasming prick, low moans vibrating through it each time she pulls back.  You can feel her cheeks pulling inward from the strength of her suction, loud smacks filling the air each time a gap forms in the almost airtight seal of her lips.  She squashes her breasts down as much as she can, lowering her lips to kiss your " + ((player.lowerBody.cockSpot.hasSheath()) ? "sheath" : "base" ) + ((player.lowerBody.balls > 0) ? " and reaching down to gently stroke your " + ballsDescriptLight() : "" ) + ((player.gender == 3) ? ", one of her long, dextrous fingers sliding into your " + vaginaDescript() : "" ) + "\n\n");
...
// lose, requires balls and cumQ() > 1000
		private loseToKitsunesWithBallsAndHighCumQ():void
		{
			...
			MainScreen.text("\"<i>Let's just see...</i>\"  she quietly muses to herself, slipping her hands under your " + player.armorName + ", <i>\"what we have here...\"</i>\n\n");
			MainScreen.text("Her coy grin turns to one of delighted surprise as her fingertips pass over your " + ballsDescriptLight() + ", giving them a firm but gentle squeeze.  She licks her lips and eagerly pulls your " + player.armorName + " off with a hungry glint in her eyes, lifting up your [cock biggest] and flexing it slightly as though examining it.  She leans down, her face close to your balls, and drinks in their scent with a long, drawn-out sigh.\n\n");
			...
			if (player.cumQ() <= 2500) {
				...
				MainScreen.text("She moans deeply the moment that your first thick streams of seed begin to flow into her throat, cupping your balls softly with both hands.  With her lips sealed tight around your shaft, her tongue swirls to and fro inside her mouth, gathering up your thick seed and funneling it into her gullet.  Overcome by gluttonous desire, she draws your shaft into the back of her throat, massaging your " + ballsDescriptLight() + " while she drinks them dry.  Even as her stomach begins to swell with the added weight of your seed, she never stops sucking down your thick load.  Your explosive climax continues to flow, and although she puts up a valiant effort to swallow it all, a few thick streams manage to escape from the corners of her mouth and nostrils.  As the lengthy orgasm finally begins to wind down, her tongue coils around your length one last time, and she sucks hard, slurping up the last drop with great embellishment.\n\n");
...
//Futa rape - chance increases as redhead's lust increases
		private getRapedByRedHeadFutaKitsune():void
		{
			...
			if (player.gender >= 2) {
				MainScreen.text(((player.vaginas[0].vaginalLooseness < VAGINA_LOOSENESS.GAPING) ? "\"<i>Ah!  Nice and tight, just how I like it!</i>\"  she groans, gripping your waist tightly and beginning to strongly pump her hips." : "\"<i>Hmm...  a little loose for my tastes, but I suppose it'll have to do.  You haven't been slutting it up on minotaurs and tentacle beasts, have you cutie?</i>\"  she says teasingly, giving you a patronizing pinch on the cheek."));
			}
			else {
				MainScreen.text(((player.ass.analLooseness < 3) ? "\"<i>Ah!  Nice and tight, just how I like it!</i>\"  she groans, gripping your waist tightly and beginning to strongly pump her hips." : "\"<i>Hmm...  a little loose for my tastes, but I suppose it'll have to do.  You haven't been slutting it up on minotaurs and tentacle beasts, have you cutie?</i>\"  she says teasingly, giving you a patronizing pinch on the cheek."));
			}
			...
			MainScreen.text("As she uses your " + ((player.gender >= 2) ? vaginaDescript() : assholeDescript() ) + " as her own personal fuckhole, her many tails begin to stroke and tease along your naked body, tickling you with their bristly tips and painting trails of fire across your flesh.  You are caught up in shivers each time one of them crosses one of your erogenous zones, the cool flames tickling and tingling across your most sensitive areas.  Thrashing and wriggling underneath her, you belt out a trembling moan, every muscle in your body resonating with pleasure from the odd contrast of the gentle caress of her tails with the rough pistonlike pounding of her cock.\n\n");
			...
			MainScreen.text("When she finally calms down and pulls out with a satisfied sigh, your " + ((player.gender >= 2) ? vaginaDescript() : assholeDescript() ) + " lies agape, a small river of seed slowly pouring out.  Your stomach has swollen to the size of a watermelon, jiggling heavily with the weight of her incredible load of futa-cum.  Her spent cock hangs limply between her thighs, a mixture of cum and feminine juices dripping from the tip.\n\n");
...
//Damage victory
		public defeatTheKitsunes(display:boolean = true):void
		{
			if (display) {
				...
				kitsuneSprite();
				if (monster.HP < 1) {
					MainScreen.text("The kitsune hits the ground with an 'Oomph', landing roughly on her well-cushioned backside." + ((monster.hairColor == "red" && flags[FlagEnum.redheadIsFuta] == 0) ? "  The moment her rounded rump impacts the dirt, a swirling flame crackles to life between her legs, engulfing her exposed cock.  When it dies away, all that remains of her throbbing member is a pert cherry-colored bud between her dripping lips." : "") + "  She rubs her sore posterior, wincing in pain and pouting childishly.\n\n");
...
//[Vaginal] - requires cock
		private fuckAKitsuneVaginally():void
		{
			...
			MainScreen.text("You only smirk, dragging your fingers across her side and leaning in to nibble the edge of her neck.  She practically melts in your arms, rolling her eyes back and moaning, her cheeks growing flushed with desire." + ((monster.hairColor == "red" && flags[FlagEnum.redheadIsFuta] > 0) ? "  You feel a light thump against your crotch and look down with a snicker, seeing a large tent in the lower half of her robes.  Teasingly, you run your hand down her front, wrapping your fingers around it through the fabric and pumping it slowly." : "" ) + "\n\n");
			...
			MainScreen.text("\"<i>Oooh, don't stop, please...  Fuck me harder...</i>\" she groans flashing you a coy smirk and sliding her hand up your neck, running her fingers " + ((player.hairLength > 0) ? "through your hair." : "across your scalp.") + "\n\n");
...
//[Anal] - requires cock area 144 or less
		private putItInAKitsunesAssWin():void
		{
			...
			MainScreen.text("Sensing your onrushing orgasm, she tightens the ring of her tail around your " + ((player.lowerBody.cockSpot.hasSheath()) ? "sheath" : "base" ) + ", blocking your orgasm from escaping and trapping blood in your swollen " + cockDescript(x) + ", making it that much more sensitive.\n\n");
			...
			MainScreen.text("\"<i>Heh...  not bad for...  a mortal,</i>\" she says, resuming her previous teasing, though you can tell her heart isn't in it by the satisfied look on her face" + ((monster.hairColor == "red" && flags[FlagEnum.redheadIsFuta] > 0) ? " and the lazy droop of her spent, flaccid member" : "") + ".\n\n");
...
//[Tail Job] - requires cock
		private tailJobKitsuneWin():void
		{
			...
			MainScreen.text("It is at the height of one such cycle of pleasure and denial that you feel something cool and tingly washing over you, looking down to see the kitsune's lips pursed at " + ((player.lowerBody.balls > 0) ? "the underside of your " + ballsDescriptLight() : "the " + ((player.lowerBody.cockSpot.hasSheath()) ? "sheath" : "base" ) + " of your " + cockDescript(0) ) + ", gently blowing pale flames across your groin.\n\n");
			...
			MainScreen.text("\"<i>Come look me up anytime, dear!</i>\"  she calls back when she is safely out of sight.  You briefly consider giving chase, but decide it is not worth the effort, gathering your " + player.armorName + " and turning back toward camp.");
...
//{all " + cockDescript(0) + " calls for this scene should prioritize dog cocks; if PC is in Rut, prioritize other animal dicks second, otherwise use the biggest cock.}
		private fuckDraftBlond():void
		{
			...
			if (player.dogCocks() > 0 || player.inRut) MainScreen.text("The sweet musk of her voluminous fem-jizz fills your mind with a lustful haze, higher-order thought processes gradually shutting down as animalistic mating instinct begins to take over.  ");
			MainScreen.text("You slide your " + cockDescript(x) + " up between the supple mounds of her ass, groaning in pleasure as she begins to glide her hips back and forth along the shaft, cooing softly.  The warm, moist breath radiating off her sodden vagina caresses your ");
			if (player.lowerBody.balls > 0) MainScreen.text(ballsDescriptLight());
			else MainScreen.text(player.legs());
			...
			MainScreen.text("  She raises her hips higher, whimpering a little as she desperately tries to line up your " + cockDescript(x) + " with her hungry fuckhole.\n\n");
			...
			if (player.dogCocks() > 0 || player.inRut) MainScreen.text("  Vivid fantasies of stuffing her pussy full of your virile semen race through your mind, unable to think of anything else.  Come whatever may, you know you MUST impregnate her - there's simply no other option.");
...
//[Hotdog Anal] - replaces regular Anal option only for the black-haired girl.
		private hotdogAnalInKitsuneButtDontLetTailTickleYourNose():void
		{
			...
			MainScreen.text("One last slap echoes through the clearing when you slam yourself into her ass for the final time, moaning in ecstasy as your " + cockDescript(x) + " twitches wildly in climax.  ");
...
//[Feeder]
		private feederTheKitsunes():void
		{
			...
			MainScreen.text("She becomes wetter with each passing moment, a new rush of fluid soaking your " + player.leg() + " with each gulp she takes.  Rewarding the girl for her admirable efforts in draining your milk-laden tits, you slide a finger in between her legs and grant her the pleasure she sought for herself earlier, rolling her cherry red clitoris back and forth under your fingertip slowly.  You slip your middle and ring fingers into her entrance, forcing a gasp from her throat that causes her to choke a bit, milk sputtering out and soaking her front.\n\n");
			...
			MainScreen.text("You carefully lay her on the ground, standing and donning your " + player.armorName + " once again.  The kitsune remains rooted in the spot, weighed down by her oversized tummy.  Something tells you she won't be moving from that spot for some time.");
			//Advance time 1hr and return to camp. +Sensitivity
...
//[GetBJ] - requires cock 108 area or less
		private getABJFromAFoxGirl():void
		{
			...
			else MainScreen.text("her lips squeezing sensually around the " + ((player.lowerBody.cockSpot.hasSheath()) ? "sheath" : "base") + " each time she goes down you.  Moaning intensely, she closes her eyes and rolls your " + cockDescript(x) + " back and forth in her mouth, swirling her tongue sensually along it.\n\n");
...
//[GetLicked] - requires a vagina
		private getLickedByKitsunes():void
		{
			...
			MainScreen.text("One hand caressing the back of her head, you lean into the kiss and slide your body passionately against hers, your " + nippleDescript(0) + " growing hard with arousal.  As your tongue dances around hers, you rub yourself against her thigh, spreading musky juices across it.  Your hands slide up and down her face and chest, fingertips cascading over every curve, and finally you break your kiss, a line of saliva connecting your bottom lip to hers.\n\n");

			MainScreen.text("As you stare at the shiny pink pillows, you gently brush your thumb along them, marvelling at how absolutely soft and plump they are.  It isn't long before you begin to wonder how they might feel kissing elsewhere on your body, and you decide to indulge your curiosity, pulling your " + player.armorName + " away to reveal your " + vaginaDescript() + ".  She licks her lips almost imperceptibly at the sight of your slick slit, her hungry gaze coming to rest between your legs.\n\n");
...
//[Ride] - requires vagina
		private rideDatRedheadKitsuneCockIntoTheSkyDiamonds():void
		{
			...
			MainScreen.text("You casually discard your " + player.armorName + ", tossing them aside in a pile.  By this point, she is putty in your hands, her whole body shaking from head to toe with each teasing stroke of your palms.\n\n");
...
//REDHEAD KITSUNE
		private helixZeKitsunes():void
		{
			...
			MainScreen.text("You turn to gather your " + player.armorName + ", cleaning up and dressing once more, then whip around to the sound of rustling leaves.  A set of sticky footprints leads your gaze to the edge of a bush, a flash of red tails and a pair of plump hind cheeks disappearing into the forest.");
			//Advance time 1hr and return to camp. +Sensitivity, +Libido
			player.orgasm();
			dynStats("lib", 1, "sen", 1);
			cleanupAfterCombat();
...
//Discovery
		public kitsuneShrine():void
		{
			...
			if (flags[FlagEnum.TOOK_KITSUNE_STATUE] == 0) MainScreen.addButton(1, "Meditate", meditateLikeAKitsuneEhQuestionMark);
			if (player.hasItem(useables.GLDSTAT) || flags[FlagEnum.TOOK_KITSUNE_STATUE] == 0) MainScreen.addButton(2, "Statue", stealAStatue);
