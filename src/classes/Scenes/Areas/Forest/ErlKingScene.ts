	...
	public class ErlKingScene extends BaseContent
	{
		...
		protected function firstWildHuntChase(waited:boolean = false):void
		{
			...
			else
			{
				...
				if (player.statusAffects.has("MetWhitney")) outputText(", and for a moment all you can think of are Whitney’s canine peppers");
				outputText(".\n\n");
		...
		public function repeatWildHuntEncounter():void
		{
			...
			if (player.upperBody.wingType != WING.NONE) outputText("You quickly glance from side to side, realizing that the trees here grow too close together for your to spread your [wings].\n\n");
		...
		public function repeatWildHuntGivenToTheHounds():void
		{
			...
			if (player.lowerBody.vaginaSpot.hasVagina()) outputText(" long tongue touching the bottom edge of your [vagina]");
			else if (player.lowerBody.balls > 0) outputText(" long tongue lapping at the base of your balls");
			else if (player.lowerBody.cockSpot.hasCock()) outputText(" long tongue lapping at the base of your cock");
		...
		protected function surrenderToTheHounds():void
		{
			...
			if (player.skinType == SKIN.FUR) outputText("Your fur turns jet black.");
			...
			if (player.lowerBody == LOWER_BODY.DOG) outputText("  Your doggie paws tingle as muscles build there, rebuilding them as stocky, athletic hound legs.");
			...
			else if (player.lowerBody.vaginaSpot.hasVagina() && player.lowerBody.cockSpot.hasCock())
			{
				...
				else
				{
					...
					if (player.lowerBody.cockSpot.list[0].cockType != CockType.DOG) outputText("  Your cock begins to shift and mold like clay, aching dull red, the veins darkening to purple, tip pulling out to form a throbbing, new dog cock.");
			...
			if (player.lowerBody.balls == 0) outputText(" new");
			outputText(" balls and runs halfway up your shiny red pecker, forming a sheath.");
			if (player.upperBody.wingType != 0) outputText("  You whine, rolling on your back and with a start, realize that your wings must have fallen off while you were distracted with your cock.");
...
//			doNext(5025); // Find out the gameover shits
		...
		protected function encounterPrincessGwynn():void
		{
			...
			if (player.lowerBody.cockSpot.hasCock()) outputText("“<i>I could suck your dick, or you could fuck my princess pussy, or ");
			else outputText("“<i>")
			if (player.lowerBody.vaginaSpot.hasVagina()) outputText("I could eat your pussy, ");
