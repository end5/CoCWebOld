package classes.Scenes.Areas.Forest
{
	...
	public class TamanisDaughters extends Goblin
	{
		...
		override protected function performCombatAction():void
		{
			...
			switch (rand(select)) {
				case 0:
					statusAffects.add(new StatusAffect("Attacks", int(flags[FlagEnum.TAMANI_NUMBER_OF_DAUGHTERS] / 20))), 0, 0, 0); //Tamani's Daughters get multiattacks!
					eAttack();
					break;
				case 1:
					special1();
		...
		public function TamanisDaughters()
		{
			...
			this.pronoun2 = "them";
			this.pronoun3 = "their";
			this.createVagina(false, VAGINA_WETNESS.DROOLING, VAGINA_LOOSENESS.TIGHT);
			...
			this.tallness = 40;
			this.hipRating = HIP_RATING.AMPLE+1;
			this.buttRating = BUTT_RATING.NOTICEABLE+1;
			...
			this.bonusHP = 50 + (int(flags[FlagEnum.TAMANI_NUMBER_OF_DAUGHTERS] / 2) * 15);
			this.lust = 30;
			this.lustVuln = .65;
			this.temperment = TEMPERMENT_RANDOM_GRAPPLES;
			this.level = 8 + (Math.floor(flags[FlagEnum.TAMANI_NUMBER_OF_DAUGHTERS] / 20));
			this.gems = rand(15) + 5;
