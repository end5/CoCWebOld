...
private function tentacleEntice():void {
	...
	if(player.gender == 1 || player.gender == 3) {
		if(rand(2) == 0) {
			Render.text("In an effort to distract the creature, you begin gyrating your hips and swinging your penis in a shameless imitation of MeatSpin. The Tentacled Horror briefly pauses to observe your actions and rears similar to a posturing spider, considering your next actions.\n\n", false);
			monster.lust += 10 + rand(5);
		}
		//Failure:
		else
		Render.text("You grab your penis and shake it feverishly at the creature in order to distract it.  It swats a tentacle at you, forcing you to adroitly dodge the reprisal.  Apparently, the beast found you unimpressive.\n\n", false);
	}
...
internal function tentacleVictoryRape():void {
	...
	//Male/Herm
	if(player.gender == 1 || player.gender == 3) {
		Render.text("Seizing the opportunity, you rush the monster while it is stopped. You grab the fattest hollow tentacle you can find and summarily shit-kick the beast onto the ground. Holding the creature down with one foot, you take the hollow tentacle and poise it in front of your raging erection.\n\n", false); 
		Render.text("\"<i>You want dick milk, you freak?!</i>\" you bellow in triumph. \"<i>HERE YOU GO!</i>\"\n\n", false);
		Render.text("You impale the tentacle on your penis and begin humping wildly, treating the creature's armature as your own personal onahole. The creature squirms wildly, trying to escape your lust-driven strength. Replying with a swift kick with your free foot, the creature's resolve to escape wavers.\n\n", false); 
		Render.text("\"<i>Quit fuckin' squirming and take your MEDICINE!</i>\" you thunder as you cheap-shot the beast for good measure.\n\n", false);
		Render.text("Feeling your peak approach, you allow your muscles into their rhythmic contractions as you unload your cum into the creature like a howitzer attacking a fort. Laughing like a maniac with each shot, you see your jizz leak out as the creature struggles to assimilate your 'donation'.\n\n", false);
		Render.text("Withdrawing your prick, you cast the beast aside and begin walking away both amused and satisfied. The beast stumbles weakly back into the wood it came from, clearly worse-off from the encounter.", false);
	}
	//Female:
	else {
		player.slimeFeed();
		...
		if(player.stats.cor >= 66) {
			Render.text("Seizing the opportunity, you rush the monster while it is stopped. You grab the fattest phallic tentacle you can find and summarily shit-kick the beast onto the ground. Holding the creature down with one foot, you take the tentacle-cock and poise it in front of your dripping cunt.\n\n", false);
			Render.text("Laughing like a true psychotic, you stuff the tentacle into your womb.", false);
			player.cuntChange(20, true, true, false);
			Render.text("  Your vaginal muscles quickly go to work stroking, squeezing and kneading the appendage. The creature, more intent with escape than hammering your box, begins struggling. You summarily slug the beast as well as any professional pugilist to stop its throes.\n\n", false);
			Render.text("\"<i>STOP STRUGGLING AND FUCK MY LITTLE PUSSY!</i>\", you screech.\n\n", false);
			Render.text("The sensation of the beast ejaculating immediately gets your attention. As your womb fills with its warm load, a brutal idea takes you. The beast responded after you hit it. Smirking like a devil, you turn the beast into a punching bag. With each strike, the beast sprays a batch of goo deep inside your body. The sheer force of the spray is working your hole into an ecstatic frenzy. As you orgasm, you slug the creature again, forcing another batch of semen to flush your womanhood. After an hour of this, you reach a multi-orgasmic peak and release. The creature twitches weakly as you pull the limp tentacle from your body. The excess spunk flows out like an overturned bucket, leaving one hell of a mess. You walk away satisfied. It is unclear whether the tentacled horror survived your lust... but who cares. Your satisfaction is all you cared about, anyway.", false);
		}
		//Rape Win Female-Low Corruption:: 
		else {
			Render.text("Seizing the opportunity, you rush the monster while it is stopped. You grab the fattest phallic tentacle you can find and summarily push the beast onto the ground. Holding the creature down with your body weight, you take the tentacle-cock and poise it in front of your dripping cunt.\n\n", false);
			Render.text("You sit on the creature and begin using the tentacle as a living dildo. With your mass atop it, the creature cannot move or struggle, despite its lack of any attempts to do so. You push the limb deeper and deeper until you feel it bottom out against your cervix.", false);
			player.cuntChange(20, true, true, false);
...
private function futaTentacleEpilogue():void {
	...
	if(kGAMECLASS.giacomo > 0) {
		Render.text("\"<i>Well, well, well. You aren't a total loss, I see.</i>\", says a sharp, masculine voice.\n\n", false);
		Render.text("While the fog of your brain has yet to lift completely, you recognize the voice to be the seedy merchant, Giacomo.\n\n", false);
		Render.text("\"<i>It is a good thing I happened to be out and about today.</i>\", Giacomo says. \"<i>I was testing out a new weapon to sell and I happened to see one of those nasty tentacle beasties. I had no idea they captured prey! Hell, you must have spent a few months inside that thing feeding it!</i>\"\n\n", false);
		Render.text("You attempt to say something, only to find yourself incapable of speaking. You feel the man's bony hands pick you up and set you down in what feels like his cart.\n\n", false);
		Render.text("\"<i>Well, I can't be a total bastard all the time.</i>\", Giacomo jingles. \"<i>I guess I can drop you off at the next village I come to so you can recover. Isn't that absolutely nice of me! Even better! I will do this for free!!!</i>\"\n\n", false);
		Render.text("Giacomo giggles to himself at his cheaply bought humanitarianism. A part of you dreads what is to happen next as nothing about the merchant ever struck you as trustworthy. However, a day or so later, true to his word, he leaves you at the clinic in the first town he comes to. Your recovery takes the better part of the year. The healers and apothecaries purge you of all of your corruptions, save your transgendered status. However, the sheer stress on your body has effectively ended your adventuring lifestyle and you resign yourself to settle down to a comparatively mundane existence, broken by the occasional tryst with a villager curious about your genitalia.", false);
	}
	//[Never met Giacomo]
	else {
		Render.text("\"<i>Will she live?</i>\", says a soft and feminine voice.\n\n", false);
		Render.text("\"<i>Yes, doctor. She will live.</i>\", replies a gruff and clearly masculine voice.\n\n", false);
		Render.text("\"<i>Is the beast dead</i>\", queries the doctor.\n\n", false);
		Render.text("\"<i>Dead several times over, madam.</i>\", answers the man.\n\n", false);
		Render.text("\"<i>We cannot leave this unfortunate woman out in the wild like this. Load her onto the wagon. We will take her back to the village. I am certain I can help this woman recover.</i>\", the doctor states flatly.\n\n", false);
		Render.text("Strong masculine hands easily lift your atrophied body and place you on a wooden slab. You feel the shaking of a cart as its movement assaults your stunted senses. After a while you notice the cart stops as it arrives at its destination. A cacophony of voices talk over one another as you feel a half a dozen people move you to what can only be a clinic. Many of the voices talk constantly as you are examined and various medicines are applied to you exhausted body. Your vision returns in a day or so, revealing that you are in a hospital and laborious effort from the staff allowed for your revival.\n\n", false);
		Render.text("Your recovery takes the better part of the year. The healers and apothecaries purge you of all of your corruptions, save your transgendered status. However, the sheer stress on your body has effectively ended your adventuring lifestyle and you resign yourself to settle down to a comparatively mundane existence, broken by the occasional tryst with a villager curious about your genitalia, which you are more than happy to display.", false);
	}
	getGame().gameOver();
}
...
internal function tentacleLossRape():void {
	...
	if(player.gender == 0) {
		...
		if(player.isTaur()) {
			...
			if(player.stats.cor < 75) Render.text("While you attempt to resist the abomination, its raw muscle mass is too much. ", false);
			...
			Render.text("\"<i>Where are your naughty bits, goddammit!</i>\" the creature bellows. \"<i>Us tentacle creatures need to FEED!</i>\"\n\n", false);
			Render.text("You sheepishly state that you are gender neutral and have no genitalia.\n\n\"<i>You gotta be shitting me!!</i>\" the monster bellows in contempt. \"<i>Of all the motherfuckers I ambush, it has to be the ONE bastard I can't feed from! What am I supposed to do now, asshole?! I gotta eat!</i>\"", false);
	...
	//Centaur madness!
		...
		Render.text("Tentacles wrap around your legs before you can stop them.  They continue to coil up your legs, spreading an uncomfortable warmth through your equine half.  Another tentacle wraps around your torso, spreading that same warmth and fuzzing your mind.  You grab one you can reach and attempt to tear it off of you, but two thinner, translucent feelers immobilize your arms, pulling them up behind your head.\n\n", false);
		player.slimeFeed();
		Render.text("They test your body, slipping about over your form.  A small tentacle finds its way into your mouth, coiling about your tongue and down your throat.  It's careful not to make you choke, seemingly as curious about your innards as it is about your shell.  You're given little time to think though, as a surge of fluid is deposited into your stomach, making your desire to cum grow even more.  The sharp spines coiled about you act similarly, spreading warmth about them wherever they touch your " + player.skin() + ".\n\n", false);
		// has at least 1 cock, engulfable:
		if(player.lowerBody.cockSpot.hasCock()) {
			if(player.cockArea(player.smallestCockIndex()) <= 50) {
				Render.text("More aphrodisiac-toxin pours into you, causing " + sMultiCockDesc() + " to expand.  ", false);
			...
			// has cock, not engulfable: 
				...
				//[With testicles: 
				if(player.lowerBody.balls > 0) Render.text("The sucking reaches all the way to your " + ballsDescriptLight() + ", a spectacularly strange sensation that nevertheless feels wonderful.", false);
				Render.text("\n\n", false);
			}
		}
		// has vagina: 
		if(player.lowerBody.vaginaSpot.hasVagina()) {
			Render.text("A squirming tentacle forces its way inside your " + vaginaDescript(0) + ", undulating and squirming as it works its way deeper and deeper.  Your body responds by pumping out more fluid, making the passage of the monstrous thing easier.", false);
			player.cuntChange(32,true,true,false);
			if(player.lowerBody.cockSpot.hasCock()) {
				if(player.cockArea(player.smallestCockIndex()) <= 50) Render.text("  Your humping appears to not affect the creatures continuing efforts, despite the force of your body.", false);
			}
			Render.text("  You feel the beast bottom out against your uterus and cry out in pleasure, gyrating yourself about as fluid sprays behind you.\n\n", false);
		}
		// Breasts > Manly, non-lactating: 
		if(player.upperBody.chest.BreastRatingLargest[0].breastRating >= 1 && player.lactationQ() <= 0) {
			Render.text("Roving tentacles latch onto your " + allBreastsDescript() + "; tiny spikes jabbing into each " + nippleDescript(0) + " and injecting some sort of hot fluid.", false);
			if(player.totalBreasts() == 2) Render.text("  The anus-like tips affix to them.", false);
			else Render.text("  The anus-like tips attach to one pair as more appear in order to take the others.", false);
			Render.text("  You feel a gush of liquid leave your body as the translucent lengths of the tentacles turn stark white.  The fluid they inject has caused you to lactate!  They suckle at you incessantly and before long your nipples ache from overuse and your breasts have run completely dry.\n\n", false);
			player.boostLactation(1.5);
		}
		// Anus == gaping: 
		if(player.ass.analLooseness >= 4) {
			Render.text("Your " + assholeDescript() + " makes an inviting target for the squirming mass and it's quick to capitalize.  A particularly bulbous appendage slides deep inside, roiling about in a way that not even your well-trained hole has been treated to.", false);
			if(player.lowerBody.cockSpot.hasCock()) Render.text("  A series of undulating lumps pass over your prostate, pushing out a splash of pre-cum.", false);
			Render.text("  You moan into the tentacle in your mouth appreciatevely at the beast's spectacular skill.\n\n", false);
		}
		...
		// Breasts > Manly, lactating, enough to overfill: 
			...
			Render.text("Roving tentacles latch onto your " + allBreastsDescript() + ", tiny spikes jabbing into your " + nippleDescript(0) + " and injecting some sort of hot fluid.  The pressure inside grows nearly unbearable as you feel your milk production increase.  To your relief, an anus-like tip attaches to each nipple.  They suckle at you incessantly and before long your nipples ache from overuse, but your breasts are still prepared to provide more milk!  The suction decreases as the beast before you becomes overfilled and eventually is forced to give up.\n\n", false);
			if(player.lowerBody.cockSpot.hasCock()) {
				Render.text("Your " + cockDescript(0) + " explodes inside the creature, ", false);
				if(player.cumQ() <= 500) Render.text("pushing the creature to the edge of its fluid-containing abilities.", false);
				else Render.text("quickly overfilling the tentacle attached to it; it explodes off of you, freeing your spunk to spray from both you and the retreating beast.  ", false);
			}
			Render.text("The tentacles holding you release, leaking fluids everywhere.  You delight in giving one of the larger ones a hard stomp, as a reminder not to trifle with you.", false);
			//end (victory)
			player.orgasm();
		...
		if(player.lowerBody.cockSpot.hasCock()) {
			...
			Render.text("The creature's desires are soon fulfilled as your " + cockDescript(0) + " starts to swell.  ", false);
			//[has testicles: 
			if(player.lowerBody.balls > 0) Render.text("Your " + ballsDescriptLight() + " tighten up against you in preparation for their inevitable release, ready to spray their boiling load into the beast.  ", false);
			Render.text("You rear up as a surge of euphoria races through you; your equine strength manages to overpower the tentacles holding your forelegs down for the briefest of moments needed to release your spunk into the suction of the tentacle, and you feel it get whisked out and down toward the writhing mass.\n\n", false);
		}
		// has vagina:
		if(player.lowerBody.vaginaSpot.hasVagina()) {
		...
		if(player.lowerBody.cockSpot.hasCock() && player.cumQ() < 1500 && player.ass.analLooseness < 4) {
			Render.text("Just as you think it's over, another tentacle rams into your " + assholeDescript() + " and begins roughly massaging your prostate as it swells massively, causing another surge of cum to leave you, and another, and another.", false);
			player.buttChange(40,true,true,false);
			Render.text("  It continues to violate your ass until you black out from exhaustion, the number of loads you've released no longer countable.", false);
			//end (loss)
			player.orgasm();
		...
		if(player.lowerBody.vaginaSpot.hasVagina()) {
			Render.text("Just as you think it's over, a tentacle rams into your " + assholeDescript() + " and begins to swell massively, causing another surge of girlcum to leave you, and another, and another.", false);
			player.buttChange(40,true,true,false);
			Render.text("  It continues to violate your ass until you black out from exhaustion, the number of times you've orgasmed no longer countable.", false);
			//end (loss)
			player.orgasm();
			dynStats("tou", 1, "int", -.5, "lib", 2, "sen", 1, "cor", .5);
			if (getGame().inCombat) cleanupAfterCombat();
		...
		if(player.lowerBody.cockSpot.hasCock()) {
			Render.text("You continue to pump more and more baby batter into the monster until, much to your surprise, it overwhelms the beast and comes surging back out to coat your ", false);
			...
			Render.text("Eventually you", false);
			if(player.lowerBody.balls > 0) Render.text("r " + ballsDescriptLight(), false);
			Render.text(" empty and you turn around to leave, giving the spunk covered mass a swift kick as a reminder of your superiority.", false);
			//end (victory)
			player.orgasm();
			dynStats("tou", .5, "spe", -.5, "int", -.5, "lib", 1, "sen", 1, "cor", 1);
			monster.HP = 0;
	...
	if(player.gender == 1) 
	{
		...
		if(player.stats.cor < 75) Render.text("It grabs you before you can get away!\n\nWhile you attempt to resist the abomination, its raw muscle mass is too much. ", false);
		Render.text("It pins you to the ground easily. You immediately feel a sharp, horrible pain ", false);
		if(player.lowerBody.cockSpot.count() > 1) Render.text("at the base of your " + multiCockDescriptLight() + ".", false);
		Render.text("  You look down to see the end of a thorny tendril impaled in your pelvic region. Fiery pain courses through your veins as you feel the creature inject you with some sort of liquid. As the pain sears through you, ", false);
		if(player.lowerBody.cockSpot.count() == 1) Render.text("your member immediately becomes fully erect and pre-cum leaks liberally from your tip.", false);
		else Render.text("your members immediately become fully erect, pre-cum drizzling from the tips.", false);
	...
	if(player.gender == 2)
	{
		...
		Render.text("Tentacles burst from the mass and bind your arms, legs, and midriff. ", false);
		if(player.stats.cor < 75) Render.text("You struggle to break free, but the creature only constricts you further, ensuring your immobility. ", false);
		Render.text("A quick flex of the tentacles securing your legs leaves you spreadeagled before the maw of the horror.  ", false);
		if(player.stats.cor < 75) Render.text("Fearing for your life, you scream and struggle for help, but only the apathetic sounds of nature respond.", false);
		...
		if(player.lowerBody.vaginaSpot.count() == 1) Render.text("clit ", false);
		else Render.text("clits ", false);
		Render.text("heat up and begin to swell. The pressure in your breasts is maddening and to your shock, you feel yourself leaking milk.", false);
	}
	if(player.gender == 3) 
	{
		player.slimeFeed();
		...
		if(player.stats.cor < 75) Render.text("While you attempt to resist the abomination, its raw muscle mass is too much. ", false);
		Render.text("It pins you to the ground easily. You immediately feel a sharp, horrible pain at the base of your ", false);
		if(player.lowerBody.cockSpot.count() > 1) Render.text("cocks", false);
		else Render.text(cockDescript(0), false);
		Render.text(".  You look down to see the end of a thorny tendril impaled in your pelvic region. Fiery pain courses through your veins as you feel the creature inject you with some sort of liquid. As the pain sears through you, your ", false);
		if(player.lowerBody.cockSpot.count() > 1) Render.text(multiCockDescriptLight() + " immediately become fully erect and leak pre-cum liberally from their tips.  ", false);
		else Render.text("member immediately becomes fully erect and pre-cum leaks liberally from your tip.  ", false);
		Render.text("  " + Num2Text((player.upperBody.chest.countNipples())) + " thorny tentacles pierce your nipples, and you feel as if someone shot acid into your tits, which immediately begin to swell.", false);
		...
		if(player.lowerBody.cockSpot.count() > 1) Render.text("furious cocks.  ", false);
		else Render.text("furious cock.  ", false);
		Render.text("You scream in shock and protest, but your cries fall upon deaf ears. The tentacle descends upon your ", false);
		if(player.lowerBody.cockSpot.count() > 1) Render.text(multiCockDescriptLight() + ", now begging for release, and clamps down around your pubic mound, fully encapsulating your members.  ", false);
		else Render.text(cockDescript(0) + ", now begging for release, and clamps down upon your pubic mound, fully encapsulating your member.", false);
	}
	//Call page 2!
...
private function tentacleRapeContinuation():void {
	...
	if (player.gender == 1) {
		...
		Render.text("The beast rears up to reveal a beak-like maw. It opens its massive jaws to reveal ");
...
private function tentacleRapeContinuationForFemales():void {
	...
	if (player.lowerBody.vaginaSpot.count() == 1) { //single coochie
		Render.text("Satisfied, the creature drops you smartly, withdraws its limbs from you, and lumbers away.  Covered completely in cum, you see that your clitoris has swollen up to ");
		...
		if ((player.perks.has("BigClit") && player.lowerBody.vaginaSpot.list[0].clitLength > 2) || player.lowerBody.vaginaSpot.list[0].clitLength > 3)
			Render.text("almost " + num2Text(Math.floor(player.lowerBody.vaginaSpot.list[0].clitLength * 1.75)) + " inches in length. ");
		//normal girls get big clits
		else
			Render.text("almost four inches in length.  Bruised and sore, you pass into unconsciousness ");
	}
	else {
		Render.text("Satisfied, the creature drops you smartly and withdraws its limbs from you and lumbers away.  Covered completely in cum, you see that your " + player.lowerBody.vaginaSpot.count() + " clits have swollen up to almost four inches in length.  Bruised and sore, you pass into unconsciousness, ");
	}
	//Not too corrupt
	if (player.stats.cor < 75)
		Render.text("too intoxicated with lust to fume over your violation. ");
	//Very corrupt
	else Render.text("too intoxicated with lust to continue the pleasure. ");
	...
	if (player.lowerBody.vaginaSpot.list[0].clitLength < 7 && player.lowerBody.vaginaSpot.list[0].clitLength >= 3.5 && player.perks.has("BigClit")) {
		...
		Render.text("Your massive clitty eventually diminishes, retaining a fair portion of its former glory.  It is now " + int(player.lowerBody.vaginaSpot.list[0].clitLength * 10) / 10 + " inches long when aroused, ");
		if (player.lowerBody.vaginaSpot.list[0].clitLength < 5)
			Render.text("like a tiny cock.");
		if (player.lowerBody.vaginaSpot.list[0].clitLength >= 5 && player.lowerBody.vaginaSpot.list[0].clitLength < 7)
			Render.text("like a slick throbbing cock.");
		if (player.lowerBody.vaginaSpot.list[0].clitLength >= 7)
			Render.text("like a big thick cock.");
	}
	//Grow clit if smaller than 3.5"
	else if (player.lowerBody.vaginaSpot.list[0].clitLength < 3.5) {
		Render.text("In time your clit returns to a more normal size, but retains a bit of extra volume.");
		player.lowerBody.vaginaSpot.list[0].clitLength += .2;
	}
	//Mention that clit doesn't grow if your big enough.
	else Render.text("In time it returns to its normal size, losing all the extra volume.");
...
private function centaurGenderlessRetardation():void {
	...
	if(flags[FlagEnum.UNKNOWN_FLAG_NUMBER_00247] == 0 || player.lowerBody.balls == 0) {
		...
		Render.text("Tentacles wrap around your legs before you can make a move to stop them, binding you tightly and coiling upwards.  One slides slowly along your underside, making you shiver in ", false);
		if(player.stats.cor < 50 && player.lust < 70) Render.text("dread", false);
		else Render.text("anticipation", false);
		Render.text(", but stops when it reaches your haunches.  Another starts testing the same area, briefly touching your " + assholeDescript() + " but clearly not finding what it's looking for.\n\n", false);
	
		Render.text("\"<i>WHAT THE FUCK IS WRONG WITH YOUR BODY?!</i>\" yells out an unnervingly human voice.\n\n", false);
	
		Render.text("Startled past horror, your mouth hangs wide open.\n\n", false);
	
		Render.text("\"<i>Why the FUCK can't I find your juicy bits?</i>\" the creature shrills.  \"<i>I'm so hungry I could risk stealing spoo from an army of goblins in heat!</i>\"\n\n", false);
	
		Render.text("You stammer out something about having no genitals, not thinking clearly enough to dissemble.\n\n", false);
	
		Render.text("\"<i>Oh, you think this shit is FUNNY, don't you?</i>\"  The voice has switched to a mocking tone.  \"<i>I know, let's wander into the forest and fuck with the hungry creatures who want some nice, nutritious cum!  Let's make them work for my amusement!  It'll be fucking HILARIOUS!</i>\"\n\n", false);
	
		Render.text("A tentacle smacks your " + buttDescript() + " hard, and the voice returns to normal.\n\n", false);
	
		Render.text("\"<i>I just caught a motherfucking HORSE, just to find out you haven't got anything for me to eat!  Do you have any idea how fucking hard it is to catch a horse!?</i>\"\n\n", false);
	
		Render.text("Feeling kind of ashamed now, you agree that horses are probably pretty hard to catch, but point out you're not <i>really</i> a horse, you're a centaur.  This is met by a stunned silence, which you, being unable to read the mood of the creature very well, decide to fill with your own voice.  You briefly explain the main differences between horses and centaurs, then mention that you weren't exactly <i>willing</i> prey; the monster certainly never asked you if it would be okay to feed from your genitalia, and that perhaps it should reconsider its strategy.\n\n", false);
		Render.text("More silence.\n\n", false);
	
		Render.text("Out of nowhere a tentacle slaps you in the face.\n\n", false);
	
		Render.text("\"<i>FUCK you, you stupid horse!  Why don't you grow a pair?  Literally!</i>\"\n\n", false);
	
		Render.text("It raises its tentacles and slams them into you as one, dropping you to the ground, unconscious.  With that, the tentacles retract and the monster shambles off into the forest, mumbling something about burning.", false);
	...
	//(Followup scene, if pc has seen above at least once, is unsexed centaur and has balls: -Z)
		...
		Render.text(", slipping forward to probe between your haunches.  It arrives at and discovers your " + sackDescript() + " with some little ceremony, stroking and fondling it.\n\n", false);

		Render.text("\"<i>Now THIS is what I'm talking about!</i>\" the creature's eerie voice sings out.  \"<i>Daddy needs his medicine!</i>\"\n\n", false);

		Render.text("The tentacle, now joined by a second, hunts around your " + ballsDescriptLight() + ", seeking any organs that might serve as a release valve for their contents.  You stare at it as it searches, quite certain you know what's coming next.\n\n", false);

		Render.text("\"<i>No, no, no. Where the FUCK is it?</i>\" the creature mumbles, frustration spiking the pitch of its voice.\n\n", false);

		Render.text("You glibly explain that though you do in fact have 'a pair', as requested, you're still very much genderless, without any sexual organs.\n\n", false);

		Render.text("The tentacles cease movement as their owner digests your words; it begins to shake visibly, shedding leaf-litter as it does.\n\n", false);

		Render.text("\"<i>You... literal-minded... PRICK!</i>\" it howls, rounding on you with furious venom and making you flinch.  \"<i>First of all, you're not GENDERLESS, you're UNSEXED!  Gender identity rolls up social and behavioral factors like masculine or feminine mannerisms, dress, and domestic roles; the only thing YOU are less is anything remotely USEFUL between your legs!  If you're going to be PEDANTIC, try at least to be right!</i>\"\n\n", false);

		Render.text("You quail, surprised at misguessing the character of its reaction.\n\n", false);

		Render.text("\"<i>SECOND of all,</i>\" it continues, \"<i>it occurs to me that, in your misguided zeal, you've forgotten that you, a: have BALLS, and b: have NO WAY to close your legs!  WHICH BRINGS ME TO C: TENTACLE TO THE GROIN!</i>\"\n\n", false);

		Render.text("Your eyes bulge out as one of the feelers which had been still during your argument pulls away from your " + sackDescript() + " and then returns with a sharp slap; as your vision pinks over under the wave of nausea, the creature releases your legs and you collapse into what can only be assumed is a centaur fetal position.\n\n", false);

		Render.text("\"<i>Q.E.D., MOTHERFUCKER!</i>\" it shouts, gesticulating in the air wildly with its tentacles as it turns and clumps back into the dense brush.", false);
	}
	player.takeDamage(5);
	if (getGame().inCombat) cleanupAfterCombat();
	else doNext(camp.returnToCampUseOneHour);
...
private function genderlessHilarityForNagaKenDolls():void {
	Render.text("", true);
	spriteSelect(100);
	Render.text("Out of nowhere tentacles bind your arms and tail, holding you firm in a matter of seconds.  You struggle to free yourself but can do nothing against the strength of the beast holding you in your current state.  More of the appendages start teasing around your body, as if looking for something.  A handful test the entrance to your " + assholeDescript() + " but evidently that's not what they're after.\n\n", false);

	Render.text("An oddly human voice comes from the undergrowth, catching you off-guard.  \"<i>Look, I'm really sorry about this, but I'm really not all that familiar with, uh, whatever it is you are.  Where do you keep the naughty bits?</i>\"\n\n", false);

	Render.text("A little stunned by the question, you tell the voice that you don't have any \"<i>naughty bits</i>\".\n\n", false);

	Render.text("\"<i>I'm sorry, maybe I just worded the question badly.  Um, where do you keep your penis... esss and or vagina... ssss.</i>\"  The words are followed up by prolonged hisses that may or may not represent the usual attempt to transmute one language to another by tacking new suffixes on.\n\n", false);

	Render.text("Sensing an opportunity to get out of this situation, you respond with your own series of hisses and hand gestures as if to say you have no idea what the beast wants.  It responds with a sigh and you're released from its grip, landing on the ground in a bit of a heap.\n\n", false);

	Render.text("\"<i>Fucking tourists.</i>\"  It slams its tentacles down in a brutal blow, knocking you out.", false);
...
private function tentacularGenderGooTimes():void {
	Render.text("", true);
	spriteSelect(100);
	Render.text("All of a sudden, tentacles come whipping out of the undergrowth to grab you.  Though, they're moving a little too fast, and manage to compress your body walls so far together that you're almost squeezed in half.\n\n", false);

	Render.text("\"<i>SHIT. SHIT. SHIT. SHIT.</i>\"  An oddly human voice is profaning loudly.  \"<i>Are you dead?</i>\"\n\n", false);

	Render.text("You respond that you are not, you're just mostly liquid and insubstantial.\n\n", false);

	Render.text("\"<i>Uh huh... that so?  Well, so long as you have some substantial naughty bits, I'll be happy.</i>\"\n\n", false);

	Render.text("There's an awkward silence.\n\n", false);

	Render.text("\"<i>You haven't got anything, have you?</i>\"\n\n", false);

	Render.text("You shake your head.\n\n", false);

	Render.text("\"<i>Well, fuck.</i>\"  A tentacle pokes you and you'd guess the beast is watching you jiggle as it chuckles.  \"<i>Maybe this isn't a total waste. I wonder, what do you taste like?</i>\"\n\n", false);
	
	Render.text("One of the larger tentacles extends and latches onto your base, its anus-like opening sucking gently at your gooey mass.  There follows a brief moment where you're not really afraid of the situation, but are instead mildly curious yourself what you taste like.\n\n", false);

	Render.text("\"<i>FUCK!</i>\" comes the voice again.  \"<i>You're sour apple!  I fucking HATE sour apple!</i>\"\n\n", false);

	Render.text("It slams its tentacles down in a brutal blow, knocking you out.", false);
	if (getGame().inCombat) cleanupAfterCombat();
	else doNext(camp.returnToCampUseOneHour);
}
}
