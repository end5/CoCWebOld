	...
	public class AkbalScene extends BaseContent
	{
		...
		private rapeAkbalForcedFemaleOral():void
		{
			...
			if (player.isNaga())
			{
				...
				MainScreen.text("With a sadistic laugh you ride out your orgasm until you're reduced to a shuddering heap on the floor.  After you've recovered you gather your " + player.armorName + ", leaving Akbal in a groaning mess behind you.  He howls as he claws the ground, his barbed cock still rock hard beneath him.  Just as you begin to leave you notice a group of imps watching you and the jaguar demon, their cocks out and leaking as their jagged teeth spread into feral grins.  You even spy a few goblins mixed in the crowd, each twirling a bottle of liquid and playing with her snatch.\n\n", false);
			...
			else if (player.isTaur())
			{
				...
				MainScreen.text("Akbal snarls as you shove him back first onto the forest ground.  You look down at him, fully prepared to have your way with his demon dick.  What you see causes your " + vaginaDescript(0) + " to flinch at the thought of what would have happened if you had lost and the demon had used that on you.\n\n", false);
				...
				MainScreen.text("Akbal gives a muffled scream at first but soon he gets the message. His tongue slithers into your " + vaginaDescript(0) + ".  You lift yourself a little; well... you lean forward a bit to let the demon actually breath.  This proves to be the right choice as Akbal is ravenous for your " + vaginaDescript(0) + ".\n\n", false);
				...
				MainScreen.text("After dropping a line about how he has to make you cum or get his head ripped off Akbal whines, obviously distressed at not being able to slip his aching member into your " + vaginaDescript(0) + ".\n\n", false);

				MainScreen.text("With a sadistic laugh you ride out your orgasm until you're reduced to a shuddering heap.  After you've recovered you stand and gather your " + player.armorName + ", leaving Akbal in a groaning mess behind you.  He howls as he claws the ground, his barbed cock still rock hard beneath him.  Just as you begin to leave you notice a group of imps watching you and the jaguar demon, their cocks out and leaking as their jagged teeth spread into feral grins.  You even spy a few goblins mixed in the crowd, each twirling a bottle of liquid and playing with her snatch.\n\n", false);
			...
			else
			{
				...
				MainScreen.text("With a sadistic laugh you ride out your orgasm until you're reduced to a shuddering heap on the floor.  After you've recovered, you stand and gather your " + player.armorName + ", leaving Akbal in a groaning mess behind you.  He howls as he claws the ground, his barbed cock still rock hard beneath him.  As you walk away, you notice a group of imps watching you and the jaguar demon with their cocks out and leaking, their jagged teeth spread into feral grins.  You even spy a few goblins mixed in the crowd, and each is twirling a bottle of liquid while playing with her snatches.\n\n", false);
		...
		private rapeAkbal():void
		{
			...
			if (player.lowerBody == LOWER_BODY.NAGA)
			{
				...
				if (player.totalCocks() > 0)
				{
					...
					if (player.lowerBody.cockSpot.list[primary].cockLength <= 7)
					{
					...
					else if (player.lowerBody.cockSpot.list[primary].cockLength <= 12)
					{
						...
						MainScreen.text("As you shove your " + cockDescript(primary) + " into his tight pucker you are not surprised to find your " + cockDescript(primary) + " barely able to breach the tightly sealed walls.  Grunting with effort you slowly inch forward, Akbal howling and squirming beneath you as he is taken without regard for his own pleasure.\n\n", false);

						MainScreen.text("After a dozen achingly slow thrusts Akbal's asshole begins to loosen and you begin to saw your " + cockDescript(primary) + " in and out of his pucker with force as the demon cat's howls range from pained to pleased.\n\n", false);
					}
					//(Lg Penis: 13 inches and up)
					else
					{
						MainScreen.text("As you uncoil you can't help but bump into the slimy leaking faucet Akbal calls his dick.  At your command he raises his hind quarters, giving you a perfect view of his tight pucker.  A short glance tells you your " + cockDescript(primary) + " won't fit... but since when has that stopped you from trying?\n\n", false);
					...
					//(transition)
					MainScreen.text("You rape the jaguar demon's tight hole with steadily mounting force, your " + hipDescript() + " smashing into his body with freight train force and causing him to cry out.  Despite this his 15 inch swollen sex organ pumps pre beneath him, letting you know that his pain is mixed with plenty of unwilling pleasure.\n\n", false);

					//(With Fertility/Lots of Jizz Perk)
					if (player.cumQ() > 1000)
					{
						MainScreen.text("The crushing tightness of Akbal's quivering hole pushes you over the edge and with a titanic howl you begin hosing down his insides.  The jaguar demon erupts as well, his body convulsing in time with your still thrusting " + cockDescript(0) + ".\n\n", false);
					...
					//(Ending)
					MainScreen.text("As you stand you gather your " + player.armorName + " and turn to leave the weakened demon behind you.  Just as you begin to walk away you notice a group of imps watching you and the jaguar demon, their cocks out and leaking.  Mixed in with the crowd are several goblins, each with a vial of liquid and a malicious grin.\n\n", false);
			...
			else if (player.lowerBody == LOWER_BODY.CENTAUR)
			{
				...
				if (player.totalCocks() > 0)
				{
					...
					if (player.lowerBody.cockSpot.list[primary].cockLength <= 7)
					{
						MainScreen.text("Akbal snarls pitifully as you shove him stomach down against a log.  Your " + cockDescript(primary) + " leaks at the thought of bringing this \"god\" down a notch .  At your command he arches his back and lifts his tail, giving you a perfect view of his tight pucker.  From the looks of it nothing has ever even touched the tightly sealed rim.  As you lightly tap it with your finger it flinches, becoming even tighter as Akbal's body jerks away in fear.\n\n", false);
					...
					else if (player.lowerBody.cockSpot.list[primary].cockLength <= 12)
					{
						...
						MainScreen.text("As you shove your " + cockDescript(primary) + " forward into his virginally-tight pucker you are not surprised to find your " + cockDescript(primary) + " barely able to breach the tightly sealed walls.  Grunting with effort you slowly inch forward, Akbal howling and squirming beneath you as he is taken without regard for his own pleasure.\n\n", false);

						MainScreen.text("After a dozen achingly slow thrusts Akbal's asshole begins to loosen and you begin to saw your " + cockDescript(primary) + " in and out of his pucker.  The demon cat's howls range from pained to pleased, obviously enjoying his butt rape more than he is willing to admit.\n\n", false);
					}
					//(Lg Penis: 13 inches and up)
					else
					{
			...
			if (player.totalCocks() > 0)
			{
				...
				{
					MainScreen.text("A light tap of your finger causes the tiny hole to constrict and Akbal's entire body flinches in fear.  You grab your " + cockDescript(0) + " with a cruel smile.  As you shove yourself into his tight pucker, you aren't surprised to find that your " + cockDescript(0) + " is barely able to breach the tightly sealed walls.  Grunting with effort you slowly inch forward, Akbal howling and squirming beneath you as he is taken without regard for his own pleasure.\n\n", false);
					MainScreen.text("After a dozen achingly slow thrusts, Akbal's asshole begins to loosen and you start sawing your " + cockDescript(0) + " in and out of his pucker with force. The demon cat's howls fluctuate between yelps of pain and moans of pleasure.\n\n", false);
				}
				//[Large penis (13 inches and up)]
				else
				{
					MainScreen.text("A single look tells you your " + cockDescript(0) + " won't fit... but since when has that stopped you from trying?  You slide a single finger against the virginally-tight hole and Akbal flinches. His already tight hole clamps shut in fear, as if doing so will somehow stop the inevitable intrusion.\n\n", false);
					MainScreen.text("You twist Akbal's tail into your fist and laugh as a scared whimper escapes from the jaguar demon's throat.  You begin to push your " + cockDescript(0) + " in with one hand as you pull Akbal's tail with the other.  The demon whines and howls as you invade his clenching sphincter, forcibly stretching the tight pink hole to a dangerous degree.  You are halted all too soon, barely able to fit more than a foot of your " + cockDescript(0) + " into Akbal's virginally-tight hole.  Deciding that's good enough, you pull out before pushing forward again, meeting the same resistance as before.\n\n", false);
					MainScreen.text("After what seems like hours of resistance and howling, Akbal's body shudders and his asshole relaxes from complete exhaustion.  Battling with your " + cockDescript(0) + " seems to have nearly made him pass out, and he no longer has the energy to resist you.  The jaguar demon's body flinches with your every thrust as you pound him raw – without lube, and without mercy.\n\n", false);
				}
				...
				if (player.cumQ() > 1000)
				{
					MainScreen.text("You continue to slide your still-swollen " + cockDescript(0) + " inside his quivering hole as you pump massive tons of liquid into the false god's stomach and bowels.  Beneath the two of you, his belly begins to bulge as he is filled to a dangerous degree.\n\n", false);
				...
				MainScreen.text("Standing up, you gather your " + player.armorName + " and turn to leave the weakened demon behind you.  As you walk away, you notice a group of imps watching you and the jaguar demon with their cocks out and leaking.  Mixed in with the crowd are several goblins, each with a vial of liquid and a malicious grin.\n\n", false);
			...
			else if (player.lowerBody.vaginaSpot.hasVagina())
			{
				...
				MainScreen.text("With a sadistic laugh you ride out your orgasm until you're reduced to a shuddering heap on the floor.  After you've recovered, you stand and gather your " + player.armorName + ", leaving Akbal in a groaning mess behind you.  He howls as he claws the ground, his barbed cock still rock hard beneath him.  As you walk away, you notice a group of imps watching you and the jaguar demon with their cocks out and leaking, their jagged teeth spread into feral grins.  You even spy a few goblins mixed in the crowd, and each is twirling a bottle of liquid while playing with their snatches.\n\n", false);
				MainScreen.text("Akbal snarls as you leave, the creatures that once feared him using his aroused state to get revenge on the 'god' of the terrestrial fire.  Even after you've reached the edge of the forest, the jaguar demon's pained howls can still be heard – though, just barely over the high-pitched laughter of the demon imps and the cackling of the goblin females.", false);
			}
			player.orgasm();
			dynStats("cor", 1);
		...
		private girlsRapeAkbal():void
		{
			flags[FlagEnum.AKBAL_BITCH_Q]++;
			MainScreen.text("", true);
			MainScreen.text("You smirk to yourself quietly as the so called \"God of Terrestrial Fire\" lays in a twitching heap on the ground, his flesh squirming as he shifts into his more humanoid form. Removing your " + player.armorName + ", your hand lowers to your feminine slit, pondering how to make use of him.\n\n", false);
			//{If Centaur}
			...
			if (player.isTaur())
			{
				...
				if (player.lowerBody.cockSpot.hasCock())
					MainScreen.text(" " + sMultiCockDesc() + " hanging beneath, twitching in anticipation", false);
			...
			else if (player.vaginalCapacity() < monster.cockArea(0))
			{
				...
				//{If Goo}
					...
					MainScreen.text("Lifting up your " + player.leg() + ", you firmly place the sole of your foot against his barbed flesh, pressing it against his stomach, forcing the jaguar to let out a low moan which you quickly take advantage of, ", false);
		...
		private girlsRapeAkbalPart2():void
		{
			...
			if (player.isTaur())
			{
				...
				if (player.lowerBody.cockSpot.hasCock())
					MainScreen.text(", " + sMultiCockDesc() + " swinging back and forth, occasionally bumping into his bound legs", false);
				...
				if (player.lowerBody.cockSpot.hasCock())
					MainScreen.text(" as " + sMultiCockDesc() + " twitch and let loose, spraying the ground with your seed", false);
				MainScreen.text(".\n\n", false);
			...
			else if (player.vaginalCapacity() < monster.cockArea(0))
			{
				...
				if (player.lowerBody.cockSpot.hasCock())
					MainScreen.text(" as " + sMultiCockDesc() + " offers up its bounty, spasming and adding to the mess", false);
				...
				MainScreen.text("Your " + chestDesc() + " chest heaves as you struggle to gulp air, " + player.legs() + " quivering from the sheer power of the orgasm the cat's tail gave you.  ", false);
				...
				MainScreen.text(" as he sags against the tree trunk, overwhelmed by the pleasure. With a satisfied grin of your own, you pick up your " + player.armorName + " and head out. Perhaps you should look out for the \"<i>God of Terrestrial fire</i>\" again sometime...", false);
			...
			else
			{
				...
				//({if Herm}
				if (player.lowerBody.cockSpot.hasCock())
					MainScreen.text(" as " + sMultiCockDesc() + "  twitches and strains, ready to blow", false);
		...
		private loseToAckballllllz():void
		{
			...
			{
				MainScreen.text("Akbal begins to push into you, the barbs on his massive cockhead causing you to howl as your " + assholeDescript() + " is forcibly stretched.  His jaguar claws grab your shoulders, and he uses your body as leverage to force his demonic erection into you.\n\n", false);
		...
		public supahAkabalEdition():void
		{
			...
			if (flags[FlagEnum.AKBAL_BITCH_Q] >= 2)
			{
				akbitchEncounter();
				return;
			}
			if (flags[FlagEnum.AKBAL_SUBMISSION_STATE] == 2)
			{
				repeatAkbalPostSubmission();
				return;
			}
			if (flags[FlagEnum.AKBAL_SUBMISSION_STATE] == 1)
			{
		...
		private akbalDeny():void
		{
			spriteSelect(2);
			MainScreen.text("", true);
			MainScreen.text("You shake your head and rub the lust-filled jaguar behind the ear as you tell him you're busy.  The demon's eyes roll, and he licks your " + player.leg() + " before his eyes find an imp in the trees above the two of you.\n\n", false);
		...
		private startuAkabalFightomon():void
		{
			...
			flags[FlagEnum.PLAYER_RESISTED_AKBAL]++;
		}
		...
		private akbalSubmit():void
		{
			spriteSelect(2);
			player.slimeFeed();
			flags[FlagEnum.AKBAL_SUBMISSION_COUNTER]++;
			flags[FlagEnum.AKBAL_SUBMISSION_STATE] = 2;
			flags[FlagEnum.AKBAL_BITCH_Q] = -1;
			//Big booty special
			if (flags[FlagEnum.AKBAL_SUBMISSION_COUNTER] > 5 && flags[FlagEnum.PLAYER_RESISTED_AKBAL] < 2 && player.lowerBody.butt.buttRating >= 13 && player.tone < 80)
			{
				akbalBigButtSubmit();
				return;
			}
			...
			if (player.lowerBody == LOWER_BODY.NAGA)
			{
				...
				MainScreen.text("After a few moments of thinking you nod to Akbal and the masculine voice in your head commands you to disrobe. You take off your " + player.armorName + ", setting it aside moments before the demon is upon you.\n\n", false);
				...
				if (player.ass.analLooseness < 3)
				{
					MainScreen.text("You feel him poking around your " + assholeDescript() + " and quickly realize his member is not only insanely large but its head is covered in a dozen tiny barbs. You grit your teeth, expecting pain and yet, thanks to the weird saliva he slathered your innards with, there is none as his gargantuan member forcibly widens your " + assholeDescript() + ".\n\n", false);
				...
				{
					MainScreen.text("You feel him poking around your " + assholeDescript() + " and quickly realize his member is not only quite large but covered in almost a dozen tiny barbs. Yet, thanks to the weird spit he slathered your innards with, there is none as his gargantuan member forcibly widens your " + assholeDescript() + ".\n\n", false);

					MainScreen.text("Akbal's titanic member stretches your " + assholeDescript() + " and makes you groan beneath him, reveling in the slick heat and fullness of your bowels. His saliva heats up, creating a steamy,pleasurable warmth inside your body. As he begins to pump his huge sex organ in and out of you the barbs covering his head begin to vibrate and hit your body with tidal waves of unbearable pleasure, feeling more like vibrating sex beads than punishing spikes. Your body begins to act of its own accord, your " + buttDescript() + " grinding against his thrusts as his large sex pump slides in with his trunk slamming into your " + buttDescript() + " in rhythmic, echoing claps.", false);
				}
				//(Gapping Pucker - Akbal's dick = 15 inches)
				else
				{
					MainScreen.text("You feel him poking around your " + assholeDescript() + " and quickly realize his member is not only quite large but covered in almost a dozen tiny barbs. When Akbal begins to penetrate you he is surprised when his trunk suddenly slams into your " + buttDescript() + ", the sudden invasion causing you to croon.\n\n", false);

					MainScreen.text("The weird spit he slathered your insides with begins to heat up instantly and the barbs covering his cock head start vibrating. The sensation of the vibrating barbs is like a dozen small slimy sex beads spinning and shaking as they are pushed inside you. Akbal wastes no time and begins forcibly fucking your " + assholeDescript() + " with reckless abandon, his every brutal thrust causing your body to slide forward through the dirt. You try to meet his deep thrusts but the jaguar fucks you with speed and force befitting a cheetah and the constantly vibrating barbs make your body shiver with each hammer blow to your insides.", false);
				}
				player.buttChange(monster.cockArea(0), true);
				MainScreen.text("\n\n", false);

				//(ending)
				MainScreen.text("Akbal works his hips fast, piston-pumping his long demon-cat dick in and out of your " + assholeDescript() + ". Your voice rises and falls with his frantic thrusts. Your body is racked by orgasm after orgasm and soon you're lying on your chest and knees in a pool of your own love juices.\n\n", false);
			...
			if (player.lowerBody == LOWER_BODY.CENTAUR)
			{
				...
				MainScreen.text("After a few moments of thinking you nod to Akbal.  The deep voice in your head commands you to disrobe.  You take off your " + player.armorName + ", setting it aside while mentally preparing yourself for whatever this demon has in mind.\n\n", false);
				...
				if (player.tailType > TAIL.NONE)
					MainScreen.text("  As he makes his way to your hind quarters he grabs you by the tail, pulling it up and out the way with a feral, jaguar grin.  His free hand slides a finger across your " + assholeDescript() + " making you paw the ground with your hooves.", false);

				//(No tail)
				else
					MainScreen.text("  As he makes his way to your hind quarters he grabs your " + buttDescript() + ", groping the mass of flesh with one hand and sliding a finger across your exposed " + assholeDescript() + ", making you paw the ground with your hooves.", false);
				MainScreen.text("\n\n", false);
				//(Transition)

				MainScreen.text("The jaguar demon begins pushing you forward with his powerful hips, his demon-cat-dick sliding up the crevice of your " + buttDescript() + ".  He steers you towards a tree, forcing you chest-first against the rough bark.\n\n", false);

				MainScreen.text("Looking back you watch Akbal bend low, losing sight of the jaguar demon as he disappears behind you.  For a moment you wonder what he's doing but soon you feel him shove his face into your " + buttDescript() + " with a snarl.  He begins working his slippery wet tongue into your " + assholeDescript() + ", greedily lapping at your exposed backside as if it were a quickly-melting ice cream cone.  The sensation causes you to groan and grind against the tongue, suddenly lost in ecstasy.  You are surprised at the strength in the demon's neck as he smashes your body against the tree with nothing but his mouth.  You feel his saliva, thick and warm like melted candy, sliding inside of you and coating your insides.", false);
				//(If Player has Vagina)
				if (player.lowerBody.vaginaSpot.hasVagina())
					MainScreen.text("  Akbal slurps his way down to your " + vaginaDescript(0) + " twisting his face and drilling his tongue into you, mercilessly attacking your " + clitDescript() + " as you scream, howl, and cringe in ecstasy.  He then uses his lips to gently suck your " + clitDescript() + " into his mouth and twirl his tongue on it, making your grind your swollen sex against his jaguar lips.", false);
				//(If Player has balls)
				if (player.lowerBody.balls > 0)
					MainScreen.text("  Akbal slurps his way down to your " + sackDescript() + " where he slathers his thick, heated saliva over your orbs, making you groan as your sensitive " + ballsDescriptLight() + " are teased and gently juggled by Akbal's masterful tongue.  He sucks both orbs into his mouth.  The sensation sends your eyes to the back of your skull and makes your entire body shiver.", false);
				//(transition)
				...
				else
				{
					...
					MainScreen.text("The weird spit he slathered your insides with begins to heat up instantly and the barbs covering his cock head start vibrating.  The sensation is like a dozen small slimy sex beads spinning and shaking as they are pushed inside you.  Akbal wastes no time and begins forcibly fucking your " + assholeDescript() + " with reckless abandon, his every brutal thrust causing the tree you're shoved up against to shake back and forth.  You try to meet his deep thrusts but the jaguar fucks you with speed and force befitting a cheetah and the constantly vibrating barbs make your body shiver with each hammer blow to your insides.", false);
				}
				player.buttChange(monster.cockArea(0), true);
				MainScreen.text("\n\n", false);

				//(ending)
				MainScreen.text("Akbal works his hips fast, piston-pumping his long demon-cat dick in and out of your " + assholeDescript() + ".  Your body is racked by orgasm after orgasm and soon the ground beneath your pawing hooves is covered in a thick layer of your own love juices.  Then Akbal releases a harsh growl and you feel the large feline member twitching and swelling inside you.  A growl sounds in your own chest as the hot, corrupted seed of the demon cat shoots into you.  The feeling of the hot, wet warmth being fucked deeper into you is so close to supreme bliss you can scarcely tell the difference.\n\n", false);

				MainScreen.text("After a few moments you realize Akbal isn't slowing down.  His piston pumping hips drive right through his orgasm and never stop slamming into your " + buttDescript() + ".  He continues until he's erupted no less than eight times, masterfully working your hole the entire time.\n\n", false);
			...
			MainScreen.text("After thinking for a minute, you nod to Akbal.  The deep voice in your head commands you to disrobe.  You obediently take off your " + player.armorName + " and set it aside just before the demon is upon you.\n\n", false);
			...
			MainScreen.text("He suddenly yanks your upturned bottom half toward himself and shoves his face into your " + buttDescript() + ".  His slippery wet tongue begins to work its way into your " + assholeDescript() + ", greedily lapping at your exposed backside as though it were a quickly-melting ice cream cone.  The sensation causes you to groan and grind against the tongue, quickly losing yourself into ecstasy.  You spread your " + player.legs() + " and arch your back, allowing his long and thick jaguar tongue to drill deeper into your " + assholeDescript() + ".  You feel his thick and warm saliva sliding into you and coating your insides.\n\n", false);
			...
			{
				MainScreen.text("Akbal slurps his way down to your " + sackDescript() + ", slathering his heated saliva over your orbs and making you groan as your sensitive " + ballsDescriptLight() + " are teased and gently juggled by Akbal's masterful tongue.  Your body continually twitches with pleasure from the sensations.  ", false);
			}
			...
			MainScreen.text("You feel him poking around your " + assholeDescript() + ", learning quickly that not only is his member insanely large, but its head is covered in dozens of tiny barbs.  ", false);
			//[Small/virgin pucker]
			if (player.ass.analLooseness < 3)
			{
				MainScreen.text("You grit your teeth, expecting pain. However, thanks to the weird saliva he slathered your innards with, you feel none as his gargantuan member forcibly widens your " + assholeDescript() + ".", false);
				player.buttChange(monster.cockArea(0), true);
				MainScreen.text("\n\n", false);
			...
			MainScreen.text("Akbal works his hips fast, piston-pumping his long demon cat-dick in and out of your " + assholeDescript() + ".  The rampant babbling coming from your mouth breaks with his every thrust, and your body is racked by orgasm after orgasm. You're soon on your chest and knees ", false);
			if (player.lowerBody.vaginaSpot.hasVagina() || player.totalCocks() > 0)
			...
			MainScreen.text("After the sensation begins to settle, you realize Akbal isn't slowing down.  His hips carry on with their pistoning right through his orgasm and continually slam into your " + buttDescript() + ".  He persists until he's erupted no less than eight times, masterfully working your hole the entire time.\n\n", false);

			MainScreen.text("After his final massive eruption, the jaguar demon pulls out. His copious load is released from your happy hole in an oddly satisfying cascade of thick white cream, rushing like a waterfall down your " + player.legs() + ".\n\n", false);
		...
		public akbalSubmissionFollowup():void
		{
			spriteSelect(2);
			MainScreen.text("", true);
			if (flags[FlagEnum.AKBAL_SUBMISSION_COUNTER] < 4)
			{
			...
			else if (flags[FlagEnum.PLAYER_RESISTED_AKBAL] == 0 && flags[FlagEnum.AKBAL_SUBMISSION_COUNTER] >= 8 && player.stats.cor > 80)
			{
		...
		private akbitchEncounter():void
		{
			...
			if (player.stats.cor < 40 || player.lust < 33)
				akbitchNoThnx(false);
			//{corruption > 40}
			else
			{
		...
		public takeAdvantageOfAkbitch():void
		{
			...
			flags[FlagEnum.AKBAL_TIMES_BITCHED]++;
			menu();
		...
		private basicAkbitchScene():void
		{
			...
			if (flags[FlagEnum.AKBAL_TIMES_BITCHED] == 1)
		...
		private buttFuckbuttFuckbuttFuckAkbal():void
		{
			...
			//{if penis < 7 inches}
			if (player.lowerBody.cockSpot.list[x].cockLength < 7)
		...
		private fuckAkbitchsButt():void
		{
			...
			else if (player.lowerBody.cockSpot.list[x].cockType == CockType.TENTACLE)
			...
			else if (player.lowerBody.cockSpot.list[x].cockType == CockType.CAT)
		...
		private topAkbitchFromBottomDuex():void
		{
			...
			if ((!player.lowerBody.vaginaSpot.hasVagina() && player.ass.analLooseness < 2) || (player.lowerBody.vaginaSpot.hasVagina() && player.looseness() <= 2))
			...
			//{medium vag/ass}
			else if ((!player.lowerBody.vaginaSpot.hasVagina() && player.ass.analLooseness < 4) || (player.lowerBody.vaginaSpot.hasVagina() && player.looseness() < 4))
		...
		private akbitchHighStrengthVariant():void
		{
			...
			if (player.lowerBody.cockSpot.hasCock())
			{
				...
				if (player.lowerBody.cockSpot.list[x].cockLength > 12)
				...
				else if (player.lowerBody.cockSpot.list[x].cockType == CockType.DRAGON)
				...
				else if (player.lowerBody.cockSpot.list[x].cockType == CockType.LIZARD)
			...
			else
			{
				...
				//{medium vagorAss}
				if ((!player.lowerBody.vaginaSpot.hasVagina() && player.ass.analLooseness < 4) || (player.lowerBody.vaginaSpot.hasVagina() && player.looseness() < 4))
