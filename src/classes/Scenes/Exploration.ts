...
export default class Exploration {
    ...
    public giacomo: public Giacomo = new Giacomo();
    ...
    public display(character: Character) {
        if (!Game.locations.get(LocationName.BeyondCamp).visited) {
            DisplayText().clear();
        ...
        else if (Game.locations.get(LocationName.BeyondCamp).visited) {
            DisplayText().clear();
            ...
            this.tryDiscover(character);
            Game.locations.get(LocationName.Forest).timesVisited++;
            Game.locations.get(LocationName.Forest).locationKnown = true;
            // character.exploredForest++;
            return;
        }
        else if (Game.locations.get(LocationName.BeyondCamp).locationKnown) {
            DisplayText().clear();
        ...
        buttonText.push(Game.locations.get(LocationName.Desert) ? "Desert" : "");
        buttonFunc.push(Game.locations.get(LocationName.Desert) ? kGAMECLASS.desert.exploreDesert : undefined);
        buttonText.push(Game.locations.get(LocationName.Forest) ? "Forest" : "");
        buttonFunc.push(Game.locations.get(LocationName.Forest) ? kGAMECLASS.forest.exploreForest : undefined);
        buttonText.push(Game.locations.get(LocationName.Lake) ? "Lake" : "");
        buttonFunc.push(Game.locations.get(LocationName.Lake) ? kGAMECLASS.lake.exploreLake : undefined);
        buttonText.push(Game.locations.get(LocationName.Plains) ? "Plains" : "");
        buttonFunc.push(Game.locations.get(LocationName.Plains) ? kGAMECLASS.plains.explorePlains : undefined);
        buttonText.push(Game.locations.get(LocationName.Swamp) ? "Swamp" : "");
        buttonFunc.push(Game.locations.get(LocationName.Swamp) ? kGAMECLASS.swamp.exploreSwamp : undefined);
        buttonText.push(Game.locations.get(LocationName.Deepwoods) ? "Deepwoods" : "");
        buttonFunc.push(Game.locations.get(LocationName.Deepwoods) ? kGAMECLASS.forest.exploreDeepwoods : undefined);
        buttonText.push(Game.locations.get(LocationName.Mountains) ? "Mountain" : "");
        buttonFunc.push(Game.locations.get(LocationName.Mountains) ? kGAMECLASS.mountain.exploreMountain : undefined);
        buttonText.push(Game.locations.get(LocationName.HighMountain) ? "High Mountain" : "");
        buttonFunc.push(Game.locations.get(LocationName.HighMountain) ? kGAMECLASS.highMountains.exploreHighMountain : undefined);
        buttonText.push(Game.locations.get(LocationName.Bog) ? "Bog" : "");
        buttonFunc.push(Game.locations.get(LocationName.Bog) ? kGAMECLASS.bog.exploreBog : undefined);
        ...
        if (character.statusAffects.has("ExploredDeepwoods")) MainScreen.getBottomButton(7).modify("Deepwoods", kGAMECLASS.forest.exploreDeepwoods);
    ...
    public tryDiscover(character: Character) {
        ...
        if (Game.locations.get(LocationName.BeyondCamp).timesVisited > 1) {
            if (!Game.locations.get(LocationName.Lake).visited) {
                DisplayText().clear();
                ...
                Game.locations.get(LocationName.Lake).timesVisited++;
                Game.locations.get(LocationName.Lake).locationKnown = true;
                Game.locations.get(LocationName.BeyondCamp).timesVisited++;
                MainScreen.doNext(camp.returnToCampUseOneHour);
                return;
            }
            if (Game.locations.get(LocationName.Lake).locationKnown && Utils.rand(3) === 0 && !Game.locations.get(LocationName.Desert).visited) {
                DisplayText().clear();
                ...
                Game.locations.get(LocationName.Desert).timesVisited++;
                Game.locations.get(LocationName.Desert).locationKnown = true;
                Game.locations.get(LocationName.BeyondCamp).timesVisited++;
                MainScreen.doNext(camp.returnToCampUseOneHour);
                return;
            }
            if (Game.locations.get(LocationName.Desert).locationKnown && Utils.rand(3) === 0 && !Game.locations.get(LocationName.Mountains).visited) {
                DisplayText().clear();
                ...
                Game.locations.get(LocationName.Mountains).timesVisited++;
                Game.locations.get(LocationName.Mountains).locationKnown = true;
                Game.locations.get(LocationName.BeyondCamp).timesVisited++;
                MainScreen.doNext(camp.returnToCampUseOneHour);
                return;
            }
            if (Game.locations.get(LocationName.Mountains).locationKnown && Utils.rand(3) === 0 && !Game.locations.get(LocationName.Plains).visited) {
                Game.locations.get(LocationName.Plains).timesVisited++;
                Game.locations.get(LocationName.Plains).locationKnown = true;
                Game.locations.get(LocationName.BeyondCamp).timesVisited++;
                DisplayText().clear();
            ...
            if (Game.locations.get(LocationName.Plains).locationKnown && Utils.rand(3) === 0 && !Game.locations.get(LocationName.Swamp).visited) {
                Game.locations.get(LocationName.Swamp).timesVisited++;
                Game.locations.get(LocationName.BeyondCamp).timesVisited++;
                DisplayText().clear();
    ...
    public bigJunkDesertScene(character: Character) {
        ...
        // FOR CENTAURS
            ...
            // IF CHARACTER HAS GIANT BREASTS ADD SENTENCE
            const largestBreasts = character.torso.chest.sort(BreastRow.BreastRatingLargest)[0];
            if (largestBreasts.rating >= 35) DisplayText("  Your " + kGAMECLASS.BreastDescriptor.describeAllBreasts(character) + " pull your human torso forward until it also is forced to rest facedown, just like your horse half.  Your tits rest, pinned on the desert sand to either side of you.  Their immense weight anchors you, further preventing any part of your equine body from lifting itself up.  The burning heat of the desert teases your " + BreastDescriptor.describeNipple(character, largestBreasts) + "s incessantly.");
            // IF CHARACTER HAS A BALLS ADD SENTENCE
