package classes.Scenes.Dungeons.D3 
{
	...
	public class HermCentaur extends Monster
	{
		...
		private function feminineMusk():void
		{
			...
			else 
			{
				...
				if (player.lowerBody.cockSpot.hasCock()) outputText(" [eachCock] with the desire to plunge inside that juicy-hot hole.");
				else if (player.lowerBody.vaginaSpot.hasVagina()) outputText(" your [vagina] with the desire to submit while juices pool between your [legs].");
	...
	else if (player.lust < 70) 
	{
		...
		if (player.lowerBody.cockSpot.hasCock()) outputText(" [eachCock] awakens, filling itself towards full erection.");
		else if (player.lowerBody.vaginaSpot.hasVagina()) outputText(" a wet heat answers in your loins, growing more insistent from moment to moment.");
	...
	else if (player.lust < 80) 
	{
		...
		if (player.lowerBody.cockSpot.hasCock()) outputText(" ignoring the stiffening pressure of [eachCock]");
	...
	else if (player.lust < 90)
	{
		...
		if (player.lowerBody.cockSpot.hasCock()) outputText("  Pre begins to dribble from your hot-and-ready cum-slit, eager to pour out in a deluge of sperm.");
		else if (player.lowerBody.vaginaSpot.hasVagina()) outputText("  A flood of sopping moisture dribbles down your [legs], the proof of your unholy desire to breed.");
		...
		private function arouseSpellCharge():void
		{
			...
			if (player.stats.int > 80) outputText("  A tease attack would likely be the most effective method of attack.");
