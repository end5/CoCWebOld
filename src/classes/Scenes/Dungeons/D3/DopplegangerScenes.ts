	...
	public class DopplegangerScenes extends BaseContent
	{
		...
		public function fuckYourself():void
		{
			...
			if (player.lowerBody.cockSpot.count() >= 1 && !player.lowerBody.vaginaSpot.hasVagina())
			{
				...
				else if (player.skinType == SKIN.FUR && player.tailType != TAIL.NONE) outputText("  You clamber on top of him, the rough mingling of your fur sparking deep urges within you, your animal half dreaming of frenzied, bestial mating in the wild. Your hardening dick presses against his [tail] and he groans raggedly in response.");
				...
				if (player.perks.has("Buttslut") || player.perks.has("MaraesGiftButtslut")) outputText("  You glory in your own decision to transform into an eager butt slut; the doppelganger’s back passage is tight, warm butter, accepting and clenching around your bulging prick like the perfect little boypussy you know it to be.");
			...
			else if (player.lowerBody.cockSpot.hasCock() && player.lowerBody.vaginaSpot.hasVagina())
			{
				...
				if (player.skinType == SKIN.FUR) outputText("  You clamber on top of her, the rough mingling of your fur sparking deep urges within you, your animal half dreaming of frenzied, bestial mating in the wild. Your dick presses into her digitigrade thigh and she groans raggedly in response.");
			...
			else if (player.lowerBody.vaginaSpot.hasVagina() && !player.lowerBody.cockSpot.hasCock())
			{
				...
				else if (player.skinType == SKIN.FUR) outputText("  You clamber on top of her, the rough mingling of your fur sparking deep urges within you, your animal half dreaming of frenzied, bestial mating in the wild. Your [vagina] presses into her digitigrade thigh and she groans raggedly in response.");
				else outputText("  You clamber on top of her, enjoying the give and take of her "+ (player.isGoo() ? "gooey" : "smooth") + " flesh as you lock your [hips] around their mirror counterparts, making her groan raggedly in response.");
		...
		public function inSovietCoCSelfFucksYou():void
		{
			...
			if (player.lowerBody.cockSpot.hasCock()) outputText(", the way your turgid [cock] feels when you grasp it at the base.");
			else if (player.lowerBody.vaginaSpot.hasVagina()) outputText(", the way your [vagina] feels when you slide your fingers along its lips.");
			else 
			{
			...
			if (player.lowerBody.cockSpot.hasCock() && !player.lowerBody.vaginaSpot.hasVagina())
			{
				...
				if (player.lowerBody.cockSpot.count() > 1) outputText("  Your other cocks deliriously tighten and spurt their own loads at the same time, an uncontrollable storm of a high.");
			}
			else if (player.lowerBody.cockSpot.hasCock() && player.lowerBody.vaginaSpot.hasVagina())
			{
