 ...
 * @author Gedan
 */
export default class JeanClaudeScenes {
	...
	public gogoFuckTheseBasilisks(): void {
		...
		if (player.lowerBody.isNaga()) MainScreen.text("  You’re probably imagining things but the passage of your sinuous form over the wire surface seems absurdly loud, an endless rubbing of sandpaper which seems to fill the hall.");
		else if (player.lowerBody.isGoo()) MainScreen.text("  Godsdamn this form... you try not to think as you slide across the wire surface, intensely aware of the slimy sound you make as you go, of the steady drip of your fluids through the mesh, trying not to think of it splashing down on curious, blunt heads.");
	...
	private regularBadEnd(): void {
		...
		if (player.statusAffects.has("RemovedArmor")) MainScreen.text("  You realize vaguely you already have taken your clothes off, undoubtedly your own subconscious preparing you for this moment.");
		...
		if (player.skinAdj != "smooth" || player.skinAdj != "latex" || player.skinAdj != "rubber") {
			...
			if (player.skinType == SkinType.FUR) MainScreen.text("  Your fur drops away in ragged clumps as you drink.");
