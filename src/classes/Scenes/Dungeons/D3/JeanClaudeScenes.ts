package classes.Scenes.Dungeons.D3 
{
	...
	public class JeanClaudeScenes extends BaseContent
	{
		...
		public function capturedByBasilisks():void
		{
			...
			if (player.lowerBody.cockSpot.hasCock()) outputText(" [eachCock] stiffening");
			if (player.lowerBody.cockSpot.hasCock() && player.lowerBody.vaginaSpot.hasVagina()) outputText(" and");
			if (player.lowerBody.vaginaSpot.hasVagina()) outputText(" your [vagina] beading with excitement");
			if (!player.lowerBody.cockSpot.hasCock() && !player.lowerBody.vaginaSpot.hasVagina()) outputText(" your loins aflame with excitement");
		...
		private function regularBadEnd():void
		{
			...
			if (player.lowerBody.vaginaSpot.hasVagina()) outputText(" your [vagina] beads with excitement");
			if (player.lowerBody.cockSpot.hasCock() && player.lowerBody.vaginaSpot.hasVagina()) outputText(" and");
			if (player.lowerBody.cockSpot.hasCock()) outputText(" [eachCock] hardens");
			if (player.lowerBody.cockSpot.hasCock() || player.lowerBody.vaginaSpot.hasVagina()) outputText(" as"); 
			...
			if (player.skinAdj != "smooth" || player.skinAdj != "latex" || player.skinAdj != "rubber")
			{
				...
				if (player.skinType == SKIN.FUR) outputText("  Your fur drops away in ragged clumps as you drink."); 
			...
			if (player.lowerBody.vaginaSpot.hasVagina()) outputText(" your [vagina] dribbling excitement");
			if (player.lowerBody.vaginaSpot.hasVagina() && player.lowerBody.cockSpot.hasCock()) outputText(" and");
			if (player.lowerBody.cockSpot.hasCock()) outputText(" your [cock] straining helplessly");
		...
		private function bwombBadEnd():void
		{
			...
			if (!player.lowerBody.cockSpot.hasCock()) outputText("  His other dick bats into your stomach, thrusting upwards towards your [chest] as he speaks, his eyes transfixing you, drawing you further into his savage, potent, golden dreams of lust and conquest as he speaks.");
