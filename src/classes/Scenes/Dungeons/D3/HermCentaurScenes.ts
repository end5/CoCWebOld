package classes.Scenes.Dungeons.D3 
{
	...
	public class HermCentaurScenes extends BaseContent
	{
		...
		private killHer():void
		{
			...
			flags[FlagEnum.D3_CENTAUR_DEFEATED] = CENTAUR_KILLED;
		...
		private letHerGo():void
		{
			...
			flags[FlagEnum.D3_CENTAUR_DEFEATED] = CENTAUR_RELEASED;
		...
		{
			flags[FlagEnum.D3_CENTAUR_DEFEATED] = CENTAUR_FUCKED;
		...
		private femFuckHerII(cockType: number):void
		{
			...
			if (cockType == TENTACOCK)
			{
				...
				if (player.lowerBody.vaginaSpot.list[0].clitLength >= 6) MainScreen.text(" A coil of cock loops around your gigantic buzzer, effectively frotting it like another cock and chance at protest from your lips.");
				...
				if (player.lowerBody.vaginaSpot.list[0].clitLength >= 6) MainScreen.text(" - you swear it spends as much time caressing your [clit] as squeezing it off");
			...
			else
			{
				...
				if (player.lowerBody.vaginaSpot.list[0].clitLength >= 6) MainScreen.text(" The hard, feminine pole twitches nicely at your touch, a far more sensitive rod than any cock.");
				...
				if (player.wetness() < 4) MainScreen.text(" practically");
		...
		private maleLoss(hpVictory:boolean):void
		{
			...
			if (player.tongueType != 0) MainScreen.text(" and uncoil your inhuman length to spear");
			...
			if (flags[FlagEnum.D1_OMNIBUS_KILLED] != 1) MainScreen.text(", and a familiar one at that");
			...
			if (flags[FlagEnum.D1_OMNIBUS_KILLED] != 1) MainScreen.text(" overseer asks, \"<i>Remember me?  I thought it only proper that I thank you for letting me live.  Now, be a good boy and suck my dick - show all everyone just what a horny, helplessly fuckable toy you are.</i>\"");
			...
			if (player.hornType != 0) MainScreen.text(" horns");
