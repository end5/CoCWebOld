	...
	public class SuccubusGardener extends Monster
	{
		...
		private function showerDotEffect():void
		{
			...
			else if (player.lust < 60) 
			{
				...
				if (player.stats.cor < 50) outputText(" You're ashamed to admit");
			...
			else if (player.lust < 100)
			{
				...
				{
					outputText(", even while your rigid cock" + ((player.lowerBody.cockSpot.count() > 1) ? "s are":" is") + " drizzling ropes of pre unimpeded.");
				}
