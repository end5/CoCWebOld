package classes.Scenes.Dungeons.D3 
{
	...
	public class Doppleganger extends Monster
	{
		...
		private function addTalkShit():void
		{
			...
			switch (_roundCount)
			{
				...
				case 2:
					...
					if (player.lowerBody.cockSpot.hasCock()) outputText(" strokes [his] [cock]");
					else if (player.lowerBody.vaginaSpot.hasVagina()) outputText(" slides two fingers into [his] [vagina] and gently frigs [himself]");
		...
		public function handleSpellResistance(spell:string):void
		{
			...
			{
				outputText(" (" + player.takeDamage(10 + (player.stats.int / 3 + rand(player.stats.int / 2))) + ")");
			}
