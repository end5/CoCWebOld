	...
	public class EncapsulationPod extends Monster
	{
		...
		public get long():string {
			...
			//[Round 2 Description]
				...
				if(player.skinType == SKIN.FUR) _long += "furry ";
				if(player.skinType == SKIN.SCALES) _long += "scaley ";
			...
			//[Round 4 Description]
				...
				if(player.upperBody.chest.BreastRatingLargest[0].breastRating >= 1) _long += "the underside of your " + game.allBreastsDescript();
