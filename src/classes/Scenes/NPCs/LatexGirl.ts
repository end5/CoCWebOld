...
public function meanGooGirlRecruitment():void {
	...
	if(player.stats.spe > 60) outputText("idly spin it on your finger, tossing it into the air and catching it on the next as you advance");
...
private function PCCarriedGooBackHome():void {
	...
	if(player.stats.cor < 33) outputText("that you'll be a nice [master].  She'll never be in want for the fluids she needs, and so long as she obeys you, you'll see to her other needs.");
	else if(player.stats.cor < 66) outputText("that you'll be a good [master] for her.  You'll keep her healthy and satisfied, so long as she's obedient.");
...
private function nameZeLatexGoo():void 
{
	...
	clearOutput();
	outputText("\"<i>");
	if(flags[FlagEnum.GOO_NAME] == "Cattleya") outputText("Cattleya, huh?  I don't know if my tits are big enough to live up to that name,");
	else if(flags[FlagEnum.GOO_NAME] == "Helia") outputText("Helia, huh?  I don't know if I like anal enough for that!");
	else if(flags[FlagEnum.GOO_NAME] == "Urta") outputText("Urta, huh?  What do you take me for, a furry?  I guess it will have to do,");
	else if(flags[FlagEnum.GOO_NAME] == "Tifa") outputText("Tifa, huh?  I like the sound of that one!");
	else if(flags[FlagEnum.GOO_NAME] == "Aeris") outputText("Aeris, huh?  That sounds like a name for a hoity-toity pain in the ass!");
	else if(flags[FlagEnum.GOO_NAME] == "Latexy") outputText("Latexy, huh? That's, uh... real original...");
	else if(flags[FlagEnum.GOO_NAME] == "Goo") outputText("Goo, huh?  Wow, not too bright, are you?  Still, I guess I can live with it.  Call me Goo, I guess,");
	else if(flags[FlagEnum.GOO_NAME] == "Blacky") outputText("Blacky, huh?  Do I look like a horse or something?  I guess it will have to do,");
	else if(flags[FlagEnum.GOO_NAME] == "Fetish") outputText("Fetish, huh?  You're pretty transparent about your motives, aren't you?");
	else if(flags[FlagEnum.GOO_NAME] == "Fenoxo") outputText("Fenoxo?</i>\"  Her hair slowly morphs into a fedora.  \"<i>I'm not sure this is quite my look, but it's a lovely name,");
	else if(flags[FlagEnum.GOO_NAME] == "Maria") outputText("Maria?  Fuck, this isn't Cursed!  You don't expect me to turn you into a woman, do you?");
	else if(flags[FlagEnum.GOO_NAME] == "Valeria") outputText("Valeria? Wait, I've heard that name before...");
	else if(flags[FlagEnum.GOO_NAME] == "Christmas") outputText("Christmas, huh?  How very festive.  The big difference is that I can come more than once a year.");
	else if(flags[FlagEnum.GOO_NAME] == "Symphonie") outputText("Symphonie, eh?  That seems very... fitting.  Snug and comfortable, somehow,");
	else if(flags[FlagEnum.GOO_NAME] == "Savin") outputText("Savin, huh? Why would you want to name me after the second worst person since Stalin?");
	else if(flags[FlagEnum.GOO_NAME] == "Galatea") outputText("Galatea?  By Oblimo, that's a beautiful name!");
	else if(flags[FlagEnum.GOO_NAME] == "Kara") outputText("Kara, huh? Like, that sounds like a name for a girl with big gropable boobs in a French maid outfit!  I, like, totally love it!");
	else if(flags[FlagEnum.GOO_NAME] == "Karazelle") outputText("Karazelle, huh? Like, that sounds like a name for a girl with big gropable boobs in a French maid outfit!  I, like, totally love it!");
	else if(flags[FlagEnum.GOO_NAME] == "Jacques") outputText("Jacques?  That's kind of a boy's name isn't it?  ...Did my boobs just get bigger?");
	else if(flags[FlagEnum.GOO_NAME] == "Whitney") outputText("Whitney?  The farm-girl?  Well, I suppose I can fill in for that frigid cunt.");
	else if(flags[FlagEnum.GOO_NAME] == "Hedrah") outputText("Hedrah?  A nice strong name.  I approve,");
	else if(flags[FlagEnum.GOO_NAME] == "Third") outputText("Third, huh?  Do I speak with a silly accent and miss headshots all day long?  Well, I suppose it will work,");
	else if(flags[FlagEnum.GOO_NAME] == "Luckster") outputText("Luckster, huh?  Strange, I don't feel that Lucky.  Are there any cow-girls about?");
	else outputText(flags[FlagEnum.GOO_NAME] + ", huh?  I can live with that, I suppose,");
	...
	if(player.stats.cor < 50) outputText("Patiently");
...
public function encounterLeftBehindGooSlave():void {
	...
	if(flags[FlagEnum.GOO_TFED_NICE] > 0) {
		...
		if(player.lowerBody.cockSpot.count() > 1) outputText("  You can't help but wonder what it would feel like to let her sheath your " + multiCockDescriptLight() + " with her juices.");
		...
		outputText("\n\n");
		if(player.stats.cor < 33) outputText("Sighing apologetically");
		else if(player.stats.cor < 66) outputText("Frowning");
...
public function approachLatexy():void {
	...
	//(Sub 10)
	if(gooHappiness() < 10) outputText(flags[FlagEnum.GOO_NAME] + " scowls up at your approach, her unhappiness clearly visible in her " + flags[FlagEnum.GOO_EYES] + " eyes.  You doubt her solid onyx face could be any more morose.");
	//(Sub 20)
	else if(gooHappiness() < 20) outputText(flags[FlagEnum.GOO_NAME] + " glares at you as you approach, clearly unhappy with the situation.  She looks like she's having a pretty terrible time.");
	//(Sub 30) 
	else if(gooHappiness() < 30) outputText(flags[FlagEnum.GOO_NAME] + " frowns at you as you approach, more than a little displeased to see you.  She doesn't seem to be having a very good time.");
	//(Sub 40) 
	else if(gooHappiness() < 40) outputText(flags[FlagEnum.GOO_NAME] + " knits her eyebrows in consternation at your approach, visibly less than happy.  It doesn't look like she's thrilled to be here.");
	//(Sub 50)
	else if(gooHappiness() < 50) outputText(flags[FlagEnum.GOO_NAME] + " glances up at you when you approach, visibly bored.  She looks like she needs some cheering up.");
	//(Sub 60)
	else if(gooHappiness() < 60) outputText(flags[FlagEnum.GOO_NAME] + " gives you a wan smile as you approach, looking a tad bored.  Still, the glitter in her eyes tells you that she's still a good ways from unhappy.");
	//(Sub 70)
	else if(gooHappiness() < 70) outputText(flags[FlagEnum.GOO_NAME] + " cracks a small grin at the sight of you, happy to see you.  It's good to see her having a positive outlook.");
	//(Sub 80) 
	else if(gooHappiness() < 80) outputText(flags[FlagEnum.GOO_NAME] + " openly smiles at you as you approach, in good spirits, it seems.  Her sensual, fetishy skin reflects the light as she smiles, looking truly beautiful.");
	//(Sub 90) 
	else if(gooHappiness() < 90) outputText(flags[FlagEnum.GOO_NAME] + " grins at you, revealing rows of glittering black teeth.  She playfully regards you with happy, " + flags[FlagEnum.GOO_EYES] + " eyes.");
	//(Sub 100)
	else if(gooHappiness() < 100) outputText(flags[FlagEnum.GOO_NAME] + " bounces up at your approach, mouth splitting into a wide smile.  Her glittering, " + flags[FlagEnum.GOO_EYES] + " eyes twinkle with genuine pleasure.");
	//(MAX) 
	else outputText(flags[FlagEnum.GOO_NAME] + " jumps up on her feet at your approach, gleefully clapping her hands as you close in on her.  Her " + flags[FlagEnum.GOO_EYES] + " eyes and ecstatic visage make it clear how unbelievably happy she is.");
	...
	//{Regardless} 
	outputText("  You estimate " + flags[FlagEnum.GOO_NAME] + "'s chest would fit a " + Appearance.breastCup(gooTitSize()) + " bra, were she to wear one.");
	//Dicknips:
	if(flags[FlagEnum.GOO_NIPPLE_TYPE] == 1) outputText("  Those proud nipples have odd bulges at the tips, bulges that can swell tremendously, turning into rigid dicknipples.");
	//Cuntnips:
	else if(flags[FlagEnum.GOO_NIPPLE_TYPE] == -1) outputText("  Those proud nipples have a visible slit down the middle, just waiting to be spread into hungry pussies.");
	...
	outputText("\n\n");
	//{Dick}
	if(flags[FlagEnum.GOO_DICK_LENGTH] > 0) outputText("Below her waist, a " + num2Text(Math.round(flags[FlagEnum.GOO_DICK_LENGTH]*10)/10) + "-inch, " + gooCock() + " hangs, soft and shiny.  ");
	...
	outputText("\n\n");
	//{sub 10}
	if(gooObedience() < 10) outputText(flags[FlagEnum.GOO_NAME] + " gives you a look of pure defiance, ready to disobey at the slightest notice.");
	//{sub 20}
	else if(gooObedience() < 20) outputText(flags[FlagEnum.GOO_NAME] + " idly twirls a raven lock of hair as she awaits your comment, a rebellious look glinting in her " + flags[FlagEnum.GOO_EYES] + " eyes.");
	//{sub 30}
	else if(gooObedience() < 30) outputText(flags[FlagEnum.GOO_NAME] + " smirks at you with a rebellious cast on her features.");
	//{sub 40}
	else if(gooObedience() < 40) outputText(flags[FlagEnum.GOO_NAME] + " bats charcoal eyelashes at you as she watches you with " + flags[FlagEnum.GOO_EYES] + ", fiery eyes, still far from obedient.");
	//{sub 50}
	else if(gooObedience() < 50) outputText(flags[FlagEnum.GOO_NAME] + " glances downwards for a moment, averting her eyes until she remembers to look up, defying her own submission.");
	//{sub 60}
	else if(gooObedience() < 60) outputText(flags[FlagEnum.GOO_NAME] + " casts her eyes down but peeks up through her charcoal eyelashes to regard you.");
	//{sub 70}
	else if(gooObedience() < 70) outputText(flags[FlagEnum.GOO_NAME] + " keeps her " + flags[FlagEnum.GOO_EYES] + " eyes cast down at the ground in deference to you, though she nervously draws in the dirt with a finger while she awaits a command.");
	//{sub 80}
	else if(gooObedience() < 80) outputText(flags[FlagEnum.GOO_NAME] + " fixes her gaze down obediently, her cheeks flushing purplish.  Is she enjoying submitting to you?");
	//{sub 90)
	else if(gooObedience() < 90) outputText(flags[FlagEnum.GOO_NAME] + " prostrates herself on the ground before you, tilting her head back so that she can fix her eyes on your waist, unfit to meet your gaze.");
	//{sub 100)
	else if(gooObedience() < 100) outputText(flags[FlagEnum.GOO_NAME] + " submissively prostrates herself before you, raising her onyx rump high as her forehead lowers.  Her cheeks and rump both manage to blush purple through her latex skin, clearly aroused by her own submissiveness.");
	//{MAX}
	else outputText(flags[FlagEnum.GOO_NAME] + " plants herself on all fours before you, kissing at your [feet].  Her smooth butt lightens along with her sides and cheeks, blushing violet with lust from the heat of her own submission.  Lewdly, she greets you, \"<i>[Master].</i>\"");
...
private function changeGooDick():void {
	...
	if(gooObedience() >= 60) {
		outputText("You ");
		if(flags[FlagEnum.GOO_DICK_LENGTH] == 0) outputText("ask " + flags[FlagEnum.GOO_NAME] + " if she's ever considered growing a dick for fun.");
		...
		if(flags[FlagEnum.GOO_DICK_LENGTH] == 0) outputText("I want to grow one for you.  ");
	...
	//High Happiness + Whatever Obedience(F)
		...
		outputText("You ask " + flags[FlagEnum.GOO_NAME] + " if ");
		if(flags[FlagEnum.GOO_DICK_LENGTH] == 0) outputText("she's ever considered growing a dick for fun.");
...
private function latexyEatsADickItem(item:ItemType):void {
	...
	clearOutput();
	outputText(flags[FlagEnum.GOO_NAME] + " uses your proffered item without a second though.  Surprisingly she doesn't seem to react in any way, aside from closing her eyes and taking on a look of incredible concentration.  ");
	if(flags[FlagEnum.GOO_DICK_LENGTH] == 0) {
		...
		if(item == consumables.GROPLUS) {
			...
			outputText("Her " + gooCock() + " trembles, and starts to shrink inward, disappearing into her polished abdomen.  The effect is so startling profound that you have to do a double-take.  " + flags[FlagEnum.GOO_NAME]+ "'s penis is barely two thirds its original size!\n\nShe giggles, \"<i>Not a fan of the big boys, huh?</i>\"");
...
private function setLatexysBustSize():void {
	clearOutput();
	outputText("You ask " + flags[FlagEnum.GOO_NAME] + " if she wouldn't mind keeping her tits around a certain size.");
	//Low Obedience
	if(gooObedience() < 60) {
...
private function feedLatexyCumIndirectly():void {
	...
	outputText("Glancing down at " + flags[FlagEnum.GOO_NAME] + ", you tell her that it's feeding time.  She turns her gaze upward, more than a little eagerly");
	...
	if(gooFluid() < 33) {
		...
		if(player.lowerBody.balls == 0) outputText("body");
	...
	if(player.lowerBody.cockSpot.count() > 1) outputText("all of ");
	outputText("your tip");
	if(player.lowerBody.cockSpot.count() > 1) outputText("s at once");
...
private function feedLatexyGirlCumIndirectly():void {
	...
	if(player.lowerBody.vaginaSpot.list[0].clitLength >= 3.5) outputText("  Soon, it stands out proud and erect, a column of glistening femme-flesh that tingles with every stray breeze.");
	...
	outputText(".  You instinctively rock your [hips] forward, slowly pumping them to an instinctive, animalistic beat.  " + flags[FlagEnum.GOO_NAME] + " watches raptly, still masturbating herself with relentless finger-fucks.  She watches expectantly, waiting for the first sign of your orgasm with spellbound attention.");
	outputText("\n\nRather than disappoint those eager eyes, you cum.  A bolt of electric intensity explodes in your [clit].");
	if(player.lowerBody.vaginaSpot.list[0].clitLength >= 3.5) outputText("  You wrap your hand around it without meaning to, caressing the slick, womanly shaft so fast that it floods your mind with white waves of unthinking pleasure.");
...
private function minotaurCumFeedingGoo(nice:boolean = false):void {
	...
	if(flags[FlagEnum.TIMES_FED_LATEXY_MINO_CUM] > 0) outputText("claps in excitement, her dark-as-night nipples perking up immediately.  She hasn't forgotten her last taste of the heady treat.");
	...
	outputText(".  Striking " + flags[FlagEnum.GOO_EYES] + " eyes imploringly beg at you, as if to say, \"<i>Can I have it now?</i>\"");
	//{HARD - skip if nice.}
	if(!nice) {
		...
		if(gooObedience() >= 70) outputText("  " + flags[FlagEnum.GOO_NAME] + " immediately drops to the ground on all fours, rubbing her head against your [foot] and begging, \"<i>Please [Master], may your latex fuckpet have some of that wonderful cum?</i>\"  It seems she can be obedient after all.");
		//[Semi obedient:]
		else if(gooObedience() >= 40) {
			outputText("  " + flags[FlagEnum.GOO_NAME] + " gives a trifling protest, \"<i>Do I have to?  That cum looks really delicious!  I promise, I'll be good!  I'll let you fuck me any way you want.  I'll even fuck you, if you want me to!</i>\"");
		...
		//[Not obedient:]
			...
			outputText("  " + flags[FlagEnum.GOO_NAME] + " protests, \"<i>But you captured me!  You ought to at least have the decency to give me some of that yummy food!</i>\"");
...
private function feedLatexyCumDirectly():void {
	clearOutput();
	outputText("Opening your [armor], you let [eachCock] flop free.  " + flags[FlagEnum.GOO_NAME] + " looks down immediately, " + flags[FlagEnum.GOO_EYES] + " eyes locking tightly to [oneCock], raptly watching it stiffen with rising lust.  You take it in hand to heft its weight.  Explaining that this is to be her meal, you give it an encouraging shake.  After all, what kind of master would you be if you didn't feed your goo-girl?");
	//HUNGRY: 
	if(gooFluid() < 33) {
		outputText("  A rumble makes " + flags[FlagEnum.GOO_NAME] + "'s tight belly tremble.  She brings a hand up to cover her featureless belly, giving you a nervous grin as she leans forward.  \"<i>How did you know I was so hungry");
		if(gooObedience() > 50) outputText(", [Master]");
		outputText("?</i>\"");
	}
	//INTERMEDIATE: 
	else if(gooFluid() < 66) {
		outputText("  A smirk spreads over " + flags[FlagEnum.GOO_NAME] + "'s visage.  She licks her lips and leans forward, saying, \"<i>Mmm...  I could go for a snack");
		if(gooObedience() > 50) outputText(", [Master]");
		outputText(".</i>\"");
	}
	//NOT HUNGRY:  
	else {
		outputText("  A lazy smile reveals itself on " + flags[FlagEnum.GOO_NAME] + "'s face.  She giggles, her lush body jiggling with liquid weight as she moves.  The latex woman comments, \"<i>Mmm...  I'm pretty full.</i>\"  She licks her lips and continues in a gluttonous purr, \"<i>You can always feed me more though");
		if(gooObedience() > 50) outputText(", [Master]");
		outputText(".</i>\"");
	}
	//{no new PG} 
	...
	if(player.lowerBody.cockSpot.biggestCocks[0].cockArea() > 80) outputText("  Her throat is stretched so tightly that it appears more like an inky condom than anything else.  Every vein, every variation in length is perfectly represented - until it disappears into her chest.");
	...
	if(player.lowerBody.cockSpot.count() > 1) {
		...
		if(player.lowerBody.cockSpot.count() == 2) outputText("dick fruitlessly paints");
	...
	if(gooObedience() >= 60) {
		...
		if(flags[FlagEnum.GOO_DICK_LENGTH] > 0) outputText(" and " + gooCock() + " spatter");
...
private function maleDirectFeedLatexGooGoneWrong():void {
	...
	if(player.lowerBody.cockSpot.count() > 1) {
		...
		if(player.lowerBody.cockSpot.count() > 2) outputText("your remaining erections");
		else outputText("your other erection");
		outputText(", stroking ");
		if(player.lowerBody.cockSpot.count() == 2) outputText("it");
	...
	if(player.lowerBody.cockSpot.count() > 1) outputText("each of ");
	outputText("your cum-slit");
	if(player.lowerBody.cockSpot.count() > 1) outputText("s");
	outputText(".  " + flags[FlagEnum.GOO_NAME] + " looks up at your seizing body, smiling wide around her ");
	if(player.lowerBody.cockSpot.biggestCocks[0].cockArea() > 80) outputText("impressive ");
	...
	if(player.lowerBody.cockSpot.count() == 1) outputText("Her hands fixate on your slick, black-coated length, beginning to stroke it with eager pumps");
...
private function feedLatexyGirlCumDirect():void {
	...
	if(player.lowerBody.cockSpot.hasCock()) {
		outputText("  When " + flags[FlagEnum.GOO_NAME] + " glances to your " + multiCockDescriptLight() + ", you tut and ");
		if(player.lowerBody.balls > 0) outputText("lift your [balls]");
		else outputText("shift position");
		outputText(" to show your [vagina].");
	}
	else outputText("  When " + flags[FlagEnum.GOO_NAME] + " glances down, you sashay to better show your [vagina].");
...
private function letLatexGooDrainCuntDry():void {
	...
	if(player.lowerBody.vaginaSpot.list[0].clitLength >= 3) outputText("  She happily fellates your female pole in time with the pumping of her arm.");
...
private function femalePCDomFucksLatexGoo():void {
	clearOutput();
	outputText("You start to undress, remarking to " + flags[FlagEnum.GOO_NAME] + " that you've got an itch she'd be great at scratching.  As if your language wasn't clear enough, you ");
	if(player.lowerBody.balls > 0) outputText("lift your [sack] out of the way to ");
	else if(player.lowerBody.cockSpot.hasCock()) outputText("lift your " + multiCockDescriptLight() + " out of the way to ");
	...
	if(gooObedience() < 60) {
		...
		outputText(", " + flags[FlagEnum.GOO_NAME] + " ");
		...
		if(flags[FlagEnum.GOO_DICK_LENGTH] > 0) outputText(" and the rigidity of her " + gooCock() + " have");
		else outputText(" has");
	...
	if(flags[FlagEnum.GOO_DICK_LENGTH] > 0) outputText("  Meanwhile, the " + gooCock() + " sways uselessly above the conjoined vaginas, leaking its own secretions as it's ignored.");
	...
	outputText(".  Arching your back, you grab hold of " + flags[FlagEnum.GOO_NAME] + " by the ankles and drag her against you.  She whimpers at the pressure on her nethers, too sensitive to endure what you're forcing her to experience.  A high-pitched trill of excitement splits the air.  " + flags[FlagEnum.GOO_NAME] + " is cumming, hard by the sounds of it.  Hot, inky discharge splatters across your [clit] and into your [vagina].");
	if(player.lowerBody.cockSpot.hasCock()) outputText("  Some of it even splats onto your " + multiCockDescriptLight() + ", leaving tight black spots on your maleness.");
	if(flags[FlagEnum.GOO_DICK_LENGTH] > 0) outputText("  Her " + gooCock() + " practically bursts from within, distending to accommodate its lurid latex discharge.  Most of it splatters against " + flags[FlagEnum.GOO_NAME] + "'s skin and rolls down her flesh in a march of onyx droplets.");
...
private function femalePCDomFucksLatexGooFuta():void {
	clearOutput();
	outputText("You begin to remove your [armor] under " + flags[FlagEnum.GOO_NAME] + "'s curious eye.  She asks, \"<i>[name], what are you doing?</i>\"");
	...
	if(flags[FlagEnum.GOO_DICK_LENGTH] * flags[FlagEnum.GOO_DICK_LENGTH]/6 > player.vaginalCapacity()) outputText("  Of course, as gigantic as it is, you can't take all of it, but you do your damnedest to try.");
	else outputText("  Soon, your [butt] comes to rest against " + flags[FlagEnum.GOO_NAME] + "'s oily skin, her erection nestled nicely inside you.");
	...
	if(flags[FlagEnum.GOO_DICK_LENGTH] * flags[FlagEnum.GOO_DICK_LENGTH]/6 <= player.vaginalCapacity()) outputText(", your [butt] clapping wetly against her onyx thighs");
	...
	if(flags[FlagEnum.GOO_DICK_TYPE] == CockType.DOG) outputText("stays trapped inside you thanks to your pet's thick knot");
	...
	if(!player.isTaur()) {
		...
		if(flags[FlagEnum.GOO_NIPPLE_TYPE] == -1) {
			...
			if(player.upperBody.chest.hasFuckableNipples()) outputText("kiss yours");
			else outputText("swallow your nipples");
			outputText(".");
		}
		else if(flags[FlagEnum.GOO_NIPPLE_TYPE] == 1) {
			outputText("  Her nipple-cocks ");
			if(!player.upperBody.chest.hasFuckableNipples()) outputText("smear over the tops of your tits");
			else outputText("disappear into your nipplecunts");
			outputText(".");
		}
		else {
			outputText("  Her nipples ");
			if(!player.upperBody.chest.hasFuckableNipples()) outputText("rub all over your own");
	...
	if(player.lowerBody.cockSpot.hasCock()) outputText("  White erupts from your " + multiCockDescriptLight() + " with abandon.  You don't even care that it stains " + flags[FlagEnum.GOO_NAME] + "'s " + gooTits() + ".  It feels so good and she looks so pretty with strands of icing spattering over top of her.");
	if(player.lowerBody.cockSpot.hasCock() && player.cumQ() >= 750) outputText("  Of course, you quickly bury those strands in a wave of alabaster.");
	...
	if(flags[FlagEnum.GOO_DICK_TYPE] == CockType.DOG) outputText(", ignoring the loud 'pop' of her knot slipping free,");
...
private function malePCDomFucksLatexGoo():void {
	clearOutput();
	outputText("You open your [armor] to expose your " + multiCockDescriptLight() + " to your latex-based lover.  She eyes it with unabashed affection and licks her lips unthinkingly, already tasting the flavor of semen on her tongue.  " + flags[FlagEnum.GOO_NAME] + " jolts out of her reverie to ask, \"<i>What are you doing");
	if(gooObedience() > 50) outputText(", [Master]");
	outputText("?</i>\"");
	...
	if(flags[FlagEnum.GOO_NIPPLE_TYPE] == 1) outputText("-cock");
	...
	if(player.stats.cor < 33) outputText("Smiling");
	else if(player.stats.cor < 66) outputText("Smiling knowingly");
	...
	if(player.lowerBody.cockSpot.biggestCocks[0].cockArea() < 80) outputText("easily encompassing your erection");
	...
	if(player.lowerBody.cockSpot.count() > 1) {
		...
		if(player.lowerBody.cockSpot.count() > 2) outputText("s");
	...
	if(player.lowerBody.cockSpot.biggestCocks[0].cockArea() >= 10 && player.lowerBody.cockSpot.biggestCocks[0].cockArea() < 50) outputText(" and throat");
	else if(player.lowerBody.cockSpot.biggestCocks[0].cockArea() >= 50) outputText(", throat, and body");
	outputText(" with quick strokes.  Faster and faster you bounce her on your loins");
	if(player.lowerBody.cockSpot.biggestCocks[0].cockArea() >= 80) outputText(", amazed that she can take so much so easily");
	...
	if(player.cumQ() >= 500) outputText("  Squirts of spooge run out of her nostrils after a particularly potent blast, but " + flags[FlagEnum.GOO_NAME] + " doesn't mind or even break her gaze.");
	...
	if(player.lowerBody.balls > 0) outputText("[sack]");
	...
	if(flags[FlagEnum.GOO_DICK_LENGTH] > 0) outputText("  The " + gooCock() + " below noisily fires inky loads into the dirt, where it's quickly absorbed.");
	...
	outputText("</i>\"  A hand that appears to be wearing a latex glove smears the juices that hang from " + flags[FlagEnum.GOO_NAME] + "'s mound up and through her crack, coating her asshole with your leftover sperm.");
...
private function feedLatexySomeMilk():void {
	clearOutput();
	outputText("You cup your hands under your milk-laden breasts and ask " + flags[FlagEnum.GOO_NAME] + " if she's hungry.");
	//{Not hungry}
	...
	else outputText("  Before you've even completed your offer, " + flags[FlagEnum.GOO_NAME] + " is on you like a moth to a flame, eagerly pulling at your clothes to try and free your teats.");
	...
	else if(player.lowerBody.cockSpot.hasCock()) outputText("cock");
	else if(player.lowerBody.vaginaSpot.hasVagina()) outputText("cunt");
	...
	outputText(".  Suddenly, your teat pops free of her mouth, a streak of milk still spraying until " + flags[FlagEnum.GOO_NAME] + " is liberally coated with your white orgasmic offering, laughing girlishly as she licks her fingers and brings her own breast to her mouth, trying to tongue off the milk splattered on her.");
