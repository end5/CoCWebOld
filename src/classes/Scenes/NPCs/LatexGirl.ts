...
private PCCarriedGooBackHome():void {
	...
	if(player.totalCocks() > 1) MainScreen.text("  You can't help but wonder what it would feel like to let her sheath your " + multiCockDescriptLight() + " with her juices.");
...
private nameZeLatexGoo():void 
{
	...
	MainScreen.clearText();
	MainScreen.text("\"<i>");
	if(flags[FlagEnum.GOO_NAME] == "Cattleya") MainScreen.text("Cattleya, huh?  I don't know if my tits are big enough to live up to that name,");
	else if(flags[FlagEnum.GOO_NAME] == "Helia") MainScreen.text("Helia, huh?  I don't know if I like anal enough for that!");
	else if(flags[FlagEnum.GOO_NAME] == "Urta") MainScreen.text("Urta, huh?  What do you take me for, a furry?  I guess it will have to do,");
	else if(flags[FlagEnum.GOO_NAME] == "Tifa") MainScreen.text("Tifa, huh?  I like the sound of that one!");
	else if(flags[FlagEnum.GOO_NAME] == "Aeris") MainScreen.text("Aeris, huh?  That sounds like a name for a hoity-toity pain in the ass!");
	else if(flags[FlagEnum.GOO_NAME] == "Latexy") MainScreen.text("Latexy, huh? That's, uh... real original...");
	else if(flags[FlagEnum.GOO_NAME] == "Goo") MainScreen.text("Goo, huh?  Wow, not too bright, are you?  Still, I guess I can live with it.  Call me Goo, I guess,");
	else if(flags[FlagEnum.GOO_NAME] == "Blacky") MainScreen.text("Blacky, huh?  Do I look like a horse or something?  I guess it will have to do,");
	else if(flags[FlagEnum.GOO_NAME] == "Fetish") MainScreen.text("Fetish, huh?  You're pretty transparent about your motives, aren't you?");
	else if(flags[FlagEnum.GOO_NAME] == "Fenoxo") MainScreen.text("Fenoxo?</i>\"  Her hair slowly morphs into a fedora.  \"<i>I'm not sure this is quite my look, but it's a lovely name,");
	else if(flags[FlagEnum.GOO_NAME] == "Maria") MainScreen.text("Maria?  Fuck, this isn't Cursed!  You don't expect me to turn you into a woman, do you?");
	else if(flags[FlagEnum.GOO_NAME] == "Valeria") MainScreen.text("Valeria? Wait, I've heard that name before...");
	else if(flags[FlagEnum.GOO_NAME] == "Christmas") MainScreen.text("Christmas, huh?  How very festive.  The big difference is that I can come more than once a year.");
	else if(flags[FlagEnum.GOO_NAME] == "Symphonie") MainScreen.text("Symphonie, eh?  That seems very... fitting.  Snug and comfortable, somehow,");
	else if(flags[FlagEnum.GOO_NAME] == "Savin") MainScreen.text("Savin, huh? Why would you want to name me after the second worst person since Stalin?");
	else if(flags[FlagEnum.GOO_NAME] == "Galatea") MainScreen.text("Galatea?  By Oblimo, that's a beautiful name!");
	else if(flags[FlagEnum.GOO_NAME] == "Kara") MainScreen.text("Kara, huh? Like, that sounds like a name for a girl with big gropable boobs in a French maid outfit!  I, like, totally love it!");
	else if(flags[FlagEnum.GOO_NAME] == "Karazelle") MainScreen.text("Karazelle, huh? Like, that sounds like a name for a girl with big gropable boobs in a French maid outfit!  I, like, totally love it!");
	else if(flags[FlagEnum.GOO_NAME] == "Jacques") MainScreen.text("Jacques?  That's kind of a boy's name isn't it?  ...Did my boobs just get bigger?");
	else if(flags[FlagEnum.GOO_NAME] == "Whitney") MainScreen.text("Whitney?  The farm-girl?  Well, I suppose I can fill in for that frigid cunt.");
	else if(flags[FlagEnum.GOO_NAME] == "Hedrah") MainScreen.text("Hedrah?  A nice strong name.  I approve,");
	else if(flags[FlagEnum.GOO_NAME] == "Third") MainScreen.text("Third, huh?  Do I speak with a silly accent and miss headshots all day long?  Well, I suppose it will work,");
	else if(flags[FlagEnum.GOO_NAME] == "Luckster") MainScreen.text("Luckster, huh?  Strange, I don't feel that Lucky.  Are there any cow-girls about?");
	else MainScreen.text(flags[FlagEnum.GOO_NAME] + ", huh?  I can live with that, I suppose,");
...
public encounterLeftBehindGooSlave():void {
	...
	if(flags[FlagEnum.GOO_TFED_NICE] > 0) {
		...
		if(player.lowerBody.cockSpot.count() > 1) MainScreen.text("  You can't help but wonder what it would feel like to let her sheath your " + multiCockDescriptLight() + " with her juices.");
...
public approachLatexy():void {
	...
	//(Sub 10)
	if(gooHappiness() < 10) MainScreen.text(flags[FlagEnum.GOO_NAME] + " scowls up at your approach, her unhappiness clearly visible in her " + flags[FlagEnum.GOO_EYES] + " eyes.  You doubt her solid onyx face could be any more morose.");
	//(Sub 20)
	else if(gooHappiness() < 20) MainScreen.text(flags[FlagEnum.GOO_NAME] + " glares at you as you approach, clearly unhappy with the situation.  She looks like she's having a pretty terrible time.");
	//(Sub 30) 
	else if(gooHappiness() < 30) MainScreen.text(flags[FlagEnum.GOO_NAME] + " frowns at you as you approach, more than a little displeased to see you.  She doesn't seem to be having a very good time.");
	//(Sub 40) 
	else if(gooHappiness() < 40) MainScreen.text(flags[FlagEnum.GOO_NAME] + " knits her eyebrows in consternation at your approach, visibly less than happy.  It doesn't look like she's thrilled to be here.");
	//(Sub 50)
	else if(gooHappiness() < 50) MainScreen.text(flags[FlagEnum.GOO_NAME] + " glances up at you when you approach, visibly bored.  She looks like she needs some cheering up.");
	//(Sub 60)
	else if(gooHappiness() < 60) MainScreen.text(flags[FlagEnum.GOO_NAME] + " gives you a wan smile as you approach, looking a tad bored.  Still, the glitter in her eyes tells you that she's still a good ways from unhappy.");
	//(Sub 70)
	else if(gooHappiness() < 70) MainScreen.text(flags[FlagEnum.GOO_NAME] + " cracks a small grin at the sight of you, happy to see you.  It's good to see her having a positive outlook.");
	//(Sub 80) 
	else if(gooHappiness() < 80) MainScreen.text(flags[FlagEnum.GOO_NAME] + " openly smiles at you as you approach, in good spirits, it seems.  Her sensual, fetishy skin reflects the light as she smiles, looking truly beautiful.");
	//(Sub 90) 
	else if(gooHappiness() < 90) MainScreen.text(flags[FlagEnum.GOO_NAME] + " grins at you, revealing rows of glittering black teeth.  She playfully regards you with happy, " + flags[FlagEnum.GOO_EYES] + " eyes.");
	//(Sub 100)
	else if(gooHappiness() < 100) MainScreen.text(flags[FlagEnum.GOO_NAME] + " bounces up at your approach, mouth splitting into a wide smile.  Her glittering, " + flags[FlagEnum.GOO_EYES] + " eyes twinkle with genuine pleasure.");
	//(MAX) 
	else MainScreen.text(flags[FlagEnum.GOO_NAME] + " jumps up on her feet at your approach, gleefully clapping her hands as you close in on her.  Her " + flags[FlagEnum.GOO_EYES] + " eyes and ecstatic visage make it clear how unbelievably happy she is.");
	...
	//{Regardless} 
	MainScreen.text("  You estimate " + flags[FlagEnum.GOO_NAME] + "'s chest would fit a " + Appearance.breastCup(gooTitSize()) + " bra, were she to wear one.");
	//Dicknips:
	if(flags[FlagEnum.GOO_NIPPLE_TYPE] == 1) MainScreen.text("  Those proud nipples have odd bulges at the tips, bulges that can swell tremendously, turning into rigid dicknipples.");
	//Cuntnips:
	else if(flags[FlagEnum.GOO_NIPPLE_TYPE] == -1) MainScreen.text("  Those proud nipples have a visible slit down the middle, just waiting to be spread into hungry pussies.");
	...
	MainScreen.text("\n\n");
	//{Dick}
	if(flags[FlagEnum.GOO_DICK_LENGTH] > 0) MainScreen.text("Below her waist, a " + num2Text(Math.round(flags[FlagEnum.GOO_DICK_LENGTH]*10)/10) + "-inch, " + gooCock() + " hangs, soft and shiny.  ");
	...
	MainScreen.text("\n\n");
	//{sub 10}
	if(gooObedience() < 10) MainScreen.text(flags[FlagEnum.GOO_NAME] + " gives you a look of pure defiance, ready to disobey at the slightest notice.");
	//{sub 20}
	else if(gooObedience() < 20) MainScreen.text(flags[FlagEnum.GOO_NAME] + " idly twirls a raven lock of hair as she awaits your comment, a rebellious look glinting in her " + flags[FlagEnum.GOO_EYES] + " eyes.");
	//{sub 30}
	else if(gooObedience() < 30) MainScreen.text(flags[FlagEnum.GOO_NAME] + " smirks at you with a rebellious cast on her features.");
	//{sub 40}
	else if(gooObedience() < 40) MainScreen.text(flags[FlagEnum.GOO_NAME] + " bats charcoal eyelashes at you as she watches you with " + flags[FlagEnum.GOO_EYES] + ", fiery eyes, still far from obedient.");
	//{sub 50}
	else if(gooObedience() < 50) MainScreen.text(flags[FlagEnum.GOO_NAME] + " glances downwards for a moment, averting her eyes until she remembers to look up, defying her own submission.");
	//{sub 60}
	else if(gooObedience() < 60) MainScreen.text(flags[FlagEnum.GOO_NAME] + " casts her eyes down but peeks up through her charcoal eyelashes to regard you.");
	//{sub 70}
	else if(gooObedience() < 70) MainScreen.text(flags[FlagEnum.GOO_NAME] + " keeps her " + flags[FlagEnum.GOO_EYES] + " eyes cast down at the ground in deference to you, though she nervously draws in the dirt with a finger while she awaits a command.");
	//{sub 80}
	else if(gooObedience() < 80) MainScreen.text(flags[FlagEnum.GOO_NAME] + " fixes her gaze down obediently, her cheeks flushing purplish.  Is she enjoying submitting to you?");
	//{sub 90)
	else if(gooObedience() < 90) MainScreen.text(flags[FlagEnum.GOO_NAME] + " prostrates herself on the ground before you, tilting her head back so that she can fix her eyes on your waist, unfit to meet your gaze.");
	//{sub 100)
	else if(gooObedience() < 100) MainScreen.text(flags[FlagEnum.GOO_NAME] + " submissively prostrates herself before you, raising her onyx rump high as her forehead lowers.  Her cheeks and rump both manage to blush purple through her latex skin, clearly aroused by her own submissiveness.");
	//{MAX}
	else MainScreen.text(flags[FlagEnum.GOO_NAME] + " plants herself on all fours before you, kissing at your [feet].  Her smooth butt lightens along with her sides and cheeks, blushing violet with lust from the heat of her own submission.  Lewdly, she greets you, \"<i>[Master].</i>\"");
	...
	if(player.gender > 0 && player.lust >= 33) MainScreen.addButton(1,"Use Her",useLatexy);
	MainScreen.addButton(3,"Breast Size",setLatexysBustSize);
	MainScreen.addButton(4, "Dick Options", changeGooDick);
	
	if (flags[FlagEnum.FOLLOWER_AT_FARM_LATEXY] == 1) MainScreen.addButton(9, "Back", kGAMECLASS.farm.farmCorruption.rootScene);
	
	if (flags[FlagEnum.FOLLOWER_AT_FARM_LATEXY] == 0 && flags[FlagEnum.FARM_CORRUPTION_STARTED] == 1) MainScreen.addButton(5, "Farm Work", sendToFarm);
	if (flags[FlagEnum.FOLLOWER_AT_FARM_LATEXY] == 1) MainScreen.addButton(5, "Go Camp", backToCamp);
}
...
private useLatexy():void {
	...
	if(player.lowerBody.vaginaSpot.hasVagina()) {
		...
		if(flags[FlagEnum.GOO_DICK_LENGTH] > 0) MainScreen.addButton(1,"RideGooCock",femalePCDomFucksLatexGooFuta);
	}
...
private changeGooDick():void {
	...
	if(gooObedience() >= 60) {
		MainScreen.text("You ");
		if(flags[FlagEnum.GOO_DICK_LENGTH] == 0) MainScreen.text("ask " + flags[FlagEnum.GOO_NAME] + " if she's ever considered growing a dick for fun.");
		...
		if(flags[FlagEnum.GOO_DICK_LENGTH] == 0) MainScreen.text("I want to grow one for you.  ");
	...
	//High Happiness + Whatever Obedience(F)
		...
		MainScreen.text("You ask " + flags[FlagEnum.GOO_NAME] + " if ");
		if(flags[FlagEnum.GOO_DICK_LENGTH] == 0) MainScreen.text("she's ever considered growing a dick for fun.");
	...
	if(flags[FlagEnum.GOO_DICK_LENGTH] > 0) {
		if(player.hasItem(consumables.CANINEP) && flags[FlagEnum.GOO_DICK_TYPE] != CockType.DOG) MainScreen.addButton(2,"Canine Pepper",latexyEatsADickItem,consumables.CANINEP);
		if(player.hasItem(consumables.EQUINUM) && flags[FlagEnum.GOO_DICK_TYPE] != CockType.HORSE) MainScreen.addButton(3,"Equinum",latexyEatsADickItem,consumables.EQUINUM);
		if(player.hasItem(consumables.P_DRAFT) && flags[FlagEnum.GOO_DICK_TYPE] != CockType.HUMAN) MainScreen.addButton(4,"Pure Draft",latexyEatsADickItem,consumables.P_DRAFT);
		if(player.hasItem(consumables.W_FRUIT) && flags[FlagEnum.GOO_DICK_TYPE] != CockType.CAT) MainScreen.addButton(5,"Whisker Fruit",latexyEatsADickItem,consumables.W_FRUIT);
		if(player.hasItem(consumables.INCUBID) && flags[FlagEnum.GOO_DICK_TYPE] != CockType.DEMON) MainScreen.addButton(0,"Incubi Draft",latexyEatsADickItem,consumables.INCUBID);
		if(player.hasItem(consumables.MINOBLO) && flags[FlagEnum.GOO_DICK_TYPE] != CockType.HORSE) MainScreen.addButton(1,"Mino Blood",latexyEatsADickItem,consumables.MINOBLO);
		if(player.hasItem(consumables.GROPLUS)) MainScreen.addButton(6,"Gro Plus",latexyEatsADickItem,consumables.GROPLUS);
		if(player.hasItem(consumables.REDUCTO) && flags[FlagEnum.GOO_DICK_LENGTH] >= 5) MainScreen.addButton(7,"Reducto",latexyEatsADickItem,consumables.REDUCTO);
	}	
	else {
		if(player.hasItem(consumables.INCUBID)) MainScreen.addButton(0,"Incubi Draft",latexyEatsADickItem,consumables.INCUBID);
		if(player.hasItem(consumables.MINOBLO)) MainScreen.addButton(1,"Mino Blood",latexyEatsADickItem,consumables.MINOBLO);
	}
...
private latexyEatsADickItem(item:ItemType):void {
	...
	MainScreen.clearText();
	MainScreen.text(flags[FlagEnum.GOO_NAME] + " uses your proffered item without a second though.  Surprisingly she doesn't seem to react in any way, aside from closing her eyes and taking on a look of incredible concentration.  ");
	if(flags[FlagEnum.GOO_DICK_LENGTH] == 0) {
		...
		if(item == consumables.GROPLUS) {
			...
			MainScreen.text("Her " + gooCock() + " trembles, and starts to shrink inward, disappearing into her polished abdomen.  The effect is so startling profound that you have to do a double-take.  " + flags[FlagEnum.GOO_NAME]+ "'s penis is barely two thirds its original size!\n\nShe giggles, \"<i>Not a fan of the big boys, huh?</i>\"");
...
private setLatexysBustSize():void {
	MainScreen.clearText();
	MainScreen.text("You ask " + flags[FlagEnum.GOO_NAME] + " if she wouldn't mind keeping her tits around a certain size.");
	//Low Obedience
	if(gooObedience() < 60) {
	...
	if(flags[FlagEnum.GOO_PREFERRED_TIT_SIZE] != 0) MainScreen.addButton(7,"Whatever",changeLatexyTits,0);
	MainScreen.addButton(9,"Back",approachLatexy);
}
...
private feedLatexy():void {
	...
	if(player.lust < 33 && player.gender > 0) MainScreen.text("  You aren't aroused enough to try and feed her any sexual fluids.");
	menu();
	...
	if(player.hasItem(consumables.MINOCUM)) MainScreen.addButton(5,"MinoCum Nic",minotaurCumFeedingGoo, true);
	if(player.hasItem(consumables.MINOCUM)) MainScreen.addButton(6,"MinoCum Ruf",minotaurCumFeedingGoo, false);
...
private feedLatexyCumIndirectly():void {
	...
	MainScreen.text("Glancing down at " + flags[FlagEnum.GOO_NAME] + ", you tell her that it's feeding time.  She turns her gaze upward, more than a little eagerly");
...
private feedLatexyGirlCumIndirectly():void {
	...
	if(player.lowerBody.vaginaSpot.list[0].clitLength >= 3.5) MainScreen.text("  Soon, it stands out proud and erect, a column of glistening femme-flesh that tingles with every stray breeze.");
	...
	MainScreen.text("\n\nYou groan, equally enraptured by the display she's putting on for you.  Soon, you're ");
	if(player.wetness() < 3) MainScreen.text("absolutely soaked with your girlish moisture");
	else if(player.wetness() < 4) MainScreen.text("dripping strings of girlish liquid with abandon");
	else MainScreen.text("practically gushing girlish moisture into the bowl");
	MainScreen.text(".  You instinctively rock your [hips] forward, slowly pumping them to an instinctive, animalistic beat.  " + flags[FlagEnum.GOO_NAME] + " watches raptly, still masturbating herself with relentless finger-fucks.  She watches expectantly, waiting for the first sign of your orgasm with spellbound attention.");
	MainScreen.text("\n\nRather than disappoint those eager eyes, you cum.  A bolt of electric intensity explodes in your [clit].");
	if(player.lowerBody.vaginaSpot.list[0].clitLength >= 3.5) MainScreen.text("  You wrap your hand around it without meaning to, caressing the slick, womanly shaft so fast that it floods your mind with white waves of unthinking pleasure.");
	...
	if(player.wetness() < 3) MainScreen.text("Your dribbling cunny paints a thin film of lady-spunk on the bowl, filling it slowly as you drip and squirm.");
	else if(player.wetness() < 4) MainScreen.text("Your ludicrously wet cunt oozes thick flows of lady-spunk into the bowl, rapidly filling it with the proof of your orgasm.");
	...
	MainScreen.text("\n\n" + flags[FlagEnum.GOO_NAME] + " dives into the bowl with gusto, greedily devouring every drop.  Her tongue hangs free, thrashing against the polished wood as more and more of her latex mouth-muscle spools free to help with the feeding.  In seconds, the bowl is emptied.");
	if(player.wetness() >= 4) MainScreen.text("  Sadly, the copious vaginal lube that muddied the ground is already absorbed.  It seems the dirt can eat faster than your pet.");
	//{Boost her fluid quantity, bonus for over 250mL.}
	temp = 10;
...
private minotaurCumFeedingGoo(nice:boolean = false):void {
	...
	if(flags[FlagEnum.TIMES_FED_LATEXY_MINO_CUM] > 0) MainScreen.text("claps in excitement, her dark-as-night nipples perking up immediately.  She hasn't forgotten her last taste of the heady treat.");
	...
	MainScreen.text(".  Striking " + flags[FlagEnum.GOO_EYES] + " eyes imploringly beg at you, as if to say, \"<i>Can I have it now?</i>\"");
	//{HARD - skip if nice.}
	if(!nice) {
		...
		if(gooObedience() >= 70) MainScreen.text("  " + flags[FlagEnum.GOO_NAME] + " immediately drops to the ground on all fours, rubbing her head against your [foot] and begging, \"<i>Please [Master], may your latex fuckpet have some of that wonderful cum?</i>\"  It seems she can be obedient after all.");
		//[Semi obedient:]
		else if(gooObedience() >= 40) {
			MainScreen.text("  " + flags[FlagEnum.GOO_NAME] + " gives a trifling protest, \"<i>Do I have to?  That cum looks really delicious!  I promise, I'll be good!  I'll let you fuck me any way you want.  I'll even fuck you, if you want me to!</i>\"");
		...
		//[Not obedient:]
			...
			MainScreen.text("  " + flags[FlagEnum.GOO_NAME] + " protests, \"<i>But you captured me!  You ought to at least have the decency to give me some of that yummy food!</i>\"");
...
private feedLatexyCumDirectly():void {
	MainScreen.clearText();
	MainScreen.text("Opening your [armor], you let [eachCock] flop free.  " + flags[FlagEnum.GOO_NAME] + " looks down immediately, " + flags[FlagEnum.GOO_EYES] + " eyes locking tightly to [oneCock], raptly watching it stiffen with rising lust.  You take it in hand to heft its weight.  Explaining that this is to be her meal, you give it an encouraging shake.  After all, what kind of master would you be if you didn't feed your goo-girl?");
	//HUNGRY: 
	if(gooFluid() < 33) {
		MainScreen.text("  A rumble makes " + flags[FlagEnum.GOO_NAME] + "'s tight belly tremble.  She brings a hand up to cover her featureless belly, giving you a nervous grin as she leans forward.  \"<i>How did you know I was so hungry");
		if(gooObedience() > 50) MainScreen.text(", [Master]");
		MainScreen.text("?</i>\"");
	}
	//INTERMEDIATE: 
	else if(gooFluid() < 66) {
		MainScreen.text("  A smirk spreads over " + flags[FlagEnum.GOO_NAME] + "'s visage.  She licks her lips and leans forward, saying, \"<i>Mmm...  I could go for a snack");
		if(gooObedience() > 50) MainScreen.text(", [Master]");
		MainScreen.text(".</i>\"");
	}
	//NOT HUNGRY:  
	else {
		MainScreen.text("  A lazy smile reveals itself on " + flags[FlagEnum.GOO_NAME] + "'s face.  She giggles, her lush body jiggling with liquid weight as she moves.  The latex woman comments, \"<i>Mmm...  I'm pretty full.</i>\"  She licks her lips and continues in a gluttonous purr, \"<i>You can always feed me more though");
		if(gooObedience() > 50) MainScreen.text(", [Master]");
		MainScreen.text(".</i>\"");
	}
	//{no new PG} 
	...
	if(gooObedience() >= 60) {
		...
		if(flags[FlagEnum.GOO_DICK_LENGTH] > 0) MainScreen.text(" and " + gooCock() + " spatter");
...
private maleDirectFeedLatexGooGoneWrong():void {
	...
	MainScreen.text(".  " + flags[FlagEnum.GOO_NAME] + " looks up at your seizing body, smiling wide around her ");
...
private feedLatexyGirlCumDirect():void {
	...
	if(player.lowerBody.cockSpot.hasCock()) {
		MainScreen.text("  When " + flags[FlagEnum.GOO_NAME] + " glances to your " + multiCockDescriptLight() + ", you tut and ");
	...
	else MainScreen.text("  When " + flags[FlagEnum.GOO_NAME] + " glances down, you sashay to better show your [vagina].");
	...
	if(player.wetness() >= 3) MainScreen.text("glistening ");
	MainScreen.text("outer lips with excitement, dilating slightly as she leans closer.  " + flags[FlagEnum.GOO_NAME] + "'s nostrils flare as she breathes deeply of your scent, inhaling thick lungfuls of your feminine odor, the heady musk of an aroused woman.  Her mouth hangs open slightly, as if in awe of what she sees, and undirected by her conscious mind, she lazily drifts closer.");
	...
	if(player.wetness() < 3) MainScreen.text("  Drizzling wetness pours down your pet's chin as she pleases you.  She swallows most of it with eager bobs of her throat, happy to have such a... moist [master].");
	else if(player.wetness() < 4) MainScreen.text("  Drops of wetness beat on your pet's chin as she pleases you.  She swallows most of it with eager bobs of her throat, pleased to have an appetizer before the main course.");
	...
	if(player.wetness() >= 4) MainScreen.text("  You squirt a small river of gushing juices directly into her mouth, her cheeks flooded by the copious outpouring of lubricant.");
...
private letLatexGooDrainCuntDry():void {
	...
	if(player.lowerBody.vaginaSpot.list[0].clitLength >= 3) MainScreen.text("  She happily fellates your female pole in time with the pumping of her arm.");
...
private femalePCDomFucksLatexGoo():void {
	MainScreen.clearText();
	MainScreen.text("You start to undress, remarking to " + flags[FlagEnum.GOO_NAME] + " that you've got an itch she'd be great at scratching.  As if your language wasn't clear enough, you ");
	if(player.lowerBody.balls > 0) MainScreen.text("lift your [sack] out of the way to ");
	else if(player.lowerBody.cockSpot.hasCock()) MainScreen.text("lift your " + multiCockDescriptLight() + " out of the way to ");
	...
	if(gooObedience() < 60) {
		...
		MainScreen.text(", " + flags[FlagEnum.GOO_NAME] + " ");
		...
		if(flags[FlagEnum.GOO_DICK_LENGTH] > 0) MainScreen.text(" and the rigidity of her " + gooCock() + " have");
	...
	if(flags[FlagEnum.GOO_DICK_LENGTH] > 0) MainScreen.text("  Meanwhile, the " + gooCock() + " sways uselessly above the conjoined vaginas, leaking its own secretions as it's ignored.");
	...
	MainScreen.text(".  Arching your back, you grab hold of " + flags[FlagEnum.GOO_NAME] + " by the ankles and drag her against you.  She whimpers at the pressure on her nethers, too sensitive to endure what you're forcing her to experience.  A high-pitched trill of excitement splits the air.  " + flags[FlagEnum.GOO_NAME] + " is cumming, hard by the sounds of it.  Hot, inky discharge splatters across your [clit] and into your [vagina].");
	if(player.lowerBody.cockSpot.hasCock()) MainScreen.text("  Some of it even splats onto your " + multiCockDescriptLight() + ", leaving tight black spots on your maleness.");
	if(flags[FlagEnum.GOO_DICK_LENGTH] > 0) MainScreen.text("  Her " + gooCock() + " practically bursts from within, distending to accommodate its lurid latex discharge.  Most of it splatters against " + flags[FlagEnum.GOO_NAME] + "'s skin and rolls down her flesh in a march of onyx droplets.");
...
private femalePCDomFucksLatexGooFuta():void {
	MainScreen.clearText();
	MainScreen.text("You begin to remove your [armor] under " + flags[FlagEnum.GOO_NAME] + "'s curious eye.  She asks, \"<i>[name], what are you doing?</i>\"");
	...
	if(flags[FlagEnum.GOO_DICK_LENGTH] * flags[FlagEnum.GOO_DICK_LENGTH]/6 > player.vaginalCapacity()) MainScreen.text("  Of course, as gigantic as it is, you can't take all of it, but you do your damnedest to try.");
	else MainScreen.text("  Soon, your [butt] comes to rest against " + flags[FlagEnum.GOO_NAME] + "'s oily skin, her erection nestled nicely inside you.");
	...
	if(player.isTaur()) MainScreen.text("into your haunches");
	...
	if(flags[FlagEnum.GOO_DICK_LENGTH] * flags[FlagEnum.GOO_DICK_LENGTH]/6 <= player.vaginalCapacity()) MainScreen.text(", your [butt] clapping wetly against her onyx thighs");
	...
	if(flags[FlagEnum.GOO_DICK_TYPE] == CockType.DOG) MainScreen.text("stays trapped inside you thanks to your pet's thick knot");
	...
	if(player.isTaur()) MainScreen.text("The latex woman wastes no time in bending double to kiss your equine ass, even darting forward to smooch your tender ring.");
	...
	if(!player.isTaur()) MainScreen.text(" along with your own");
	MainScreen.text(".  Together, the two of you give in to ecstasy and cum... and cum... and cum.");
	if(player.lowerBody.cockSpot.hasCock()) MainScreen.text("  White erupts from your " + multiCockDescriptLight() + " with abandon.  You don't even care that it stains " + flags[FlagEnum.GOO_NAME] + "'s " + gooTits() + ".  It feels so good and she looks so pretty with strands of icing spattering over top of her.");
	...
	if(flags[FlagEnum.GOO_DICK_TYPE] == CockType.DOG) MainScreen.text(", ignoring the loud 'pop' of her knot slipping free,");
...
private malePCDomFucksLatexGoo():void {
	MainScreen.clearText();
	MainScreen.text("You open your [armor] to expose your " + multiCockDescriptLight() + " to your latex-based lover.  She eyes it with unabashed affection and licks her lips unthinkingly, already tasting the flavor of semen on her tongue.  " + flags[FlagEnum.GOO_NAME] + " jolts out of her reverie to ask, \"<i>What are you doing");
	if(gooObedience() > 50) MainScreen.text(", [Master]");
	MainScreen.text("?</i>\"");
	...
	if(flags[FlagEnum.GOO_NIPPLE_TYPE] == 1) MainScreen.text("-cock");
	...
	MainScreen.text(".  Past her mouth, her insides become far less solid.  It feels like a mass of warm goo that deep inside her, and combined with the feel of her slippery tongue caressing the underside of your " + cockDescript(0) + ", you feel like you're in heaven.");
	if(player.lowerBody.cockSpot.count() > 1) {
	...
	if(player.cumQ() >= 500) MainScreen.text("  Squirts of spooge run out of her nostrils after a particularly potent blast, but " + flags[FlagEnum.GOO_NAME] + " doesn't mind or even break her gaze.");
	...
	if(flags[FlagEnum.GOO_DICK_LENGTH] > 0) MainScreen.text("  The " + gooCock() + " below noisily fires inky loads into the dirt, where it's quickly absorbed.");
	...
	MainScreen.text("</i>\"  A hand that appears to be wearing a latex glove smears the juices that hang from " + flags[FlagEnum.GOO_NAME] + "'s mound up and through her crack, coating her asshole with your leftover sperm.");
...
private feedLatexySomeMilk():void {
	MainScreen.clearText();
	MainScreen.text("You cup your hands under your milk-laden breasts and ask " + flags[FlagEnum.GOO_NAME] + " if she's hungry.");
	//{Not hungry}
	...
	else MainScreen.text("  Before you've even completed your offer, " + flags[FlagEnum.GOO_NAME] + " is on you like a moth to a flame, eagerly pulling at your clothes to try and free your teats.");
	...
	MainScreen.text(".  Suddenly, your teat pops free of her mouth, a streak of milk still spraying until " + flags[FlagEnum.GOO_NAME] + " is liberally coated with your white orgasmic offering, laughing girlishly as she licks her fingers and brings her own breast to her mouth, trying to tongue off the milk splattered on her.");
