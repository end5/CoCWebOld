	...
	public class AmilyScene extends NPCAwareContent implements TimeAwareInterface
	{
		...
		*/
		...
		public function exploreVillageRuin():void {
			...
			if(flags[FlagEnum.AMILY_PC_GENDER] == player.gender) {
				...
				//Herm Meetinz
					...
					if(flags[FlagEnum.AMILY_MET] == 0) {
						...
						if(player.upperBody.chest.BreastRatingLargest[0].breastRating < 1) outputText("sniffs the air intensely, her whiskers quivering. ", false);
			...
			switch (pregnancy.event) {
				...
				case 5: //Amily is slightly pregnant
						...
						//[Low Affection]
						if (flags[FlagEnum.AMILY_AFFECTION] < 15 || player.gender == 0) outputText("\"<i>Well, I guess despite whatever other faults you may have, you can get the job done.</i>\" She says, not looking directly at you.\n\n", false);
						//[Medium Affection]
						else if (flags[FlagEnum.AMILY_AFFECTION] < 40) outputText("\"<i>Thank you. With your help, my people will soon live again.</i>\" She strokes her belly, grinning happily. \"<i>Is there something you want to talk about?</i>\"\n\n", false);
						//[High Affection]
				...
				case 8: //Amily is heavily pregnant
						...
						//[Low Affection]
						if (flags[FlagEnum.AMILY_AFFECTION] < 15 || player.gender == 0) outputText("She seems to be paying more attention to her gravid midriff than to you, and it's several long moments before she finally speaks. \"<i>These children will be born soon. I guess I owe you my thanks for being willing to father them.</i>\"\n\n", false);
						//[Medium Affection]
						else if (flags[FlagEnum.AMILY_AFFECTION] < 40) outputText("She groans softly. \"<i>This isn't an easy task, you know. But I still want to thank you. Maybe, when these ones are born, you'll be willing to help me make some more?</i>\" She asks, her tail gently waving behind her.\n\n", false);
						//[High Affection]
				...
				default: //Amily is not pregnant
					...
					if (flags[FlagEnum.AMILY_AFFECTION] < 15 || player.gender == 0) {
						if (flags[FlagEnum.AMILY_MET_AS] == 2 && player.gender == 2) outputText("She crosses her arms and smiles at you. \"<i>So you came back huh?  Did you want to chat with little old me?</i>\" she asks.\n\n", false);
					...
					//[High Affection]
						...
						if (player.lowerBody.cockSpot.hasCock()) {
							...
							if (flags[FlagEnum.AMILY_WANG_LENGTH] > 0 && player.pregnancyIncubation == 0) outputText(" Or have you come to get knocked up?", false);
						}
						else if (player.lowerBody.vaginaSpot.hasVagina()) {
							if (flags[FlagEnum.AMILY_WANG_LENGTH] > 0 && player.pregnancyIncubation == 0) outputText("Have you come back so I could stuff another bun in your oven?", false);
		...
		private function talkToAmily():void {
			outputText("", true);
			amilySprite();
			if(flags[FlagEnum.AMILY_MET_AS] == 2 && player.gender == 2) outputText("You tell Amily that you came here because you wanted to talk with her.\n\n", false);
			...
			if (flags[FlagEnum.AMILY_AFFECTION] < 15) {
				switch (pregnancy.event) {
					...
					case 8: //Amily is heavily pregnant
							...
							break;
					default: //Amily is not pregnant
							if (flags[FlagEnum.AMILY_MET_AS] == 2 && player.gender == 2) outputText("\"<i>A chat would be lovely,</i>\" she says, clearly enjoying herself.  \"<i>I... I hardly ever get a chance to find someone to chat with.  Sometimes it seems like everyone in Mareth just wants to breed non-stop...</i>\" she murmers to herself.  \"<i>Well, what shall we talk about?</i>\" she asks, seemingly quite happy with your presence.\n\n", false);
		...
		private function sneakyUberAmilyRemeetingsAnnounce():void {
			...
			switch (pregnancy.event) {
				...
				case 5: //Amily is slightly pregnant
						//[Low Affection]
						if (flags[FlagEnum.AMILY_AFFECTION] < 15) outputText("\"<i>I guess maybe I'm starting to slow down with this hanging off of me,</i>\" she grumbles. \"<i>Something you wanted?</i>\"\n\n", false);
						//[Medium Affection]
						else if (flags[FlagEnum.AMILY_AFFECTION] < 40) outputText("\"<i>Be honest – did this make me easier to find?</i>\" she asks, pushing out her belly for emphasis. Then, seemingly uncaring about the answer, she changes the subject. \"<i>Is there a reason you wanted to see me?</i>\"\n\n", false);
						//High Affection
				...
				case 8: //Amily is heavily pregnant
						//[Low Affection]
						if (flags[FlagEnum.AMILY_AFFECTION] < 15) outputText("\"<i>The only reason you could possibly find me is because this huge belly makes me too slow to move quickly and too big to hide. You know that, don't you?</i>\" she proclaims defensively, before changing her tone and asking curiously, \"<i>...Why are you here, anyway?</i>\"\n\n", false);
						//[Medium Affection]
						else if (flags[FlagEnum.AMILY_AFFECTION] < 40) outputText("\"<i>I guess it's not as easy for me to hide as it once was. So, why are you here?</i>\"\n\n", false);
						//[High Affection]
				...
				default: //Amily is not pregnant
						//[Low Affection]
						if (flags[FlagEnum.AMILY_AFFECTION] < 15) outputText("\"<i>How on earth did you get here? Nobody's ever been able to track me!</i>\" she protests. Then she shakes her head. \"<i>Ah well, I guess if it's you, it's no matter. So, whaddya want?</i>\"\n\n", false);
						//[Medium Affection]
						else if (flags[FlagEnum.AMILY_AFFECTION] < 40) outputText("\"<i>Hmm... I'll have to work on that; I can't let just any bozo trail me,</i>\" she proclaims, smiling mischievously. \"<i>What's up?</i>\"\n\n", false);
						//[High Affection]
		...
		private function heyIGotTicketsToMicePoppingOut():void {
			...
			//([horsecock]
			if(flags[FlagEnum.AMILY_NOT_FURRY] == 0) outputText(", mousy figure – pink, hairless and ", false);
			...
			//([horsecock]
			if(flags[FlagEnum.AMILY_NOT_FURRY] == 0) outputText(" Though hairless like regular infant mice,", false);
			...
			//([horsecock]
			if(flags[FlagEnum.AMILY_NOT_FURRY] == 0) outputText(" and fur has already begun to cover their formerly-naked bodies.", false);
		...
		private function thisFunctionProbablySucksTooOhYeahAmilyFunction():void {
			...
			if(flags[FlagEnum.AMILY_MET_AS] == 1) outputText("When we first met, you were just sperm to me, a pure male to father the children I needed. ", false);
		...
		public function talkWithCuntIMeanAmily(sexAfter:boolean = false):void {
			...
			//Conversation: Minotaurs
				...
				if(flags[FlagEnum.AMILY_FUCK_COUNTER] == 0) outputText("\"<i>I am still a virgin, after all.</i>\"\n\n", false);
			...
			//Conversation: Imps
				...
				if(sexAfter) outputText("and regains her composure.\n\n", false);
					...
					if(flags[FlagEnum.AMILY_FOLLOWER] == 0) outputText("  As you set off back to camp,", false);
			...
			//Conversation: Goblins
				...
				if(!sexAfter) {
					if(flags[FlagEnum.AMILY_FOLLOWER] == 0) outputText("Thanking her for her time, and the warning, you head back to your own camp.\n\n", false);
			...
			//Conversation: How did she survive?
				...
				if(!sexAfter) {
					if(flags[FlagEnum.AMILY_FOLLOWER] == 0) outputText("\", politely excuse yourself, and head back to your own camp. It sounds like she's doing better at keeping a steady supply of food and water going than you are.  But if that's the case... why does she look so thin?\n\n", false);
			...
			//Conversation: How will she care for her children?
				...
				if(!sexAfter) {
					if(flags[FlagEnum.AMILY_FOLLOWER] == 0) outputText("  Then, as if realising you are still here, she waves at you to go, getting up and leaving herself.  Wondering what that was about, you return to camp.\n\n", false);
		...
		private function FirstTimeAmilyTakeCharge():void {
			...
			if(player.lowerBody.cockSpot.list[0].cockLength >= 14) outputText("failing to fit in more than a foot of your cock's length, ", false);
		...
		private function amilyHighAffectionSecks():void {
			...
			//(If Amily is herm:
			if(flags[FlagEnum.AMILY_WANG_LENGTH] > 0) outputText("  You can feel her erection, hot and solid, pressed between your two bodies.", false);
			outputText("\n\n", false);
			...
			if(flags[FlagEnum.AMILY_WANG_LENGTH] == 0) outputText("sucking on her sensitive clit", false);
			...
			//(if Amily is herm:
			if(flags[FlagEnum.AMILY_WANG_LENGTH] > 0) outputText(" and cum spurts into the air between you, splattering on you both", false);
			outputText(".\n\n", false);
			...
			/*OLD
			outputText("Amily really didn't waste any time getting to her hidden bedroom, sprinting as fast as she could with you in tow.", false);
			if(flags[FlagEnum.AMILY_INCUBATION] > 0) outputText("  Even in a slightly pregnant state she goes surprisingly fast, though she's also rather cautious of her small bump.", false);
			outputText("\n\n", false);
			...
			if(flags[FlagEnum.AMILY_INCUBATION] > 0) outputText("  Really it seems the only thing in-between you two now is Amily's small stomach bulge.", false);
			outputText("\n\n", false);
			...
			if(flags[FlagEnum.AMILY_INCUBATION] > 0) outputText("  As you move your head across her beautiful form, you stop at her growing baby bump and give it a small kiss.", false);
			outputText("  Your head hovers at her breasts ", false);
			if(flags[FlagEnum.AMILY_INCUBATION] > 0) outputText("which seem to have grown from the pregnancy ", false);
			outputText("and get to work licking and suckling her nipples, and rubbing the sensitive mounds.", false);
			if(flags[FlagEnum.AMILY_INCUBATION] > 0) outputText("  When you get a dribble of milk in your mouth it surprises you, but you certainly don't stop \"<i>Hah... You're going to have to teach the children how that's done,</i>\" Amily says in between fevered breaths.", false);
			outputText("\n\n", false);
			...
			if(flags[FlagEnum.AMILY_INCUBATION] > 0) outputText("  You are of course mindful of her baby bump, not going too fast and making sure you're in a position that's comfortable for the two of you.  You don't want to harm your future offspring with the lovely mouse maiden.", false);
			outputText("  It's not too long before you're going at a regular pace, stuffing Amily's fuckhole with your familiar manhood.\n\n", false);
			...
			//not preggo
			if(flags[FlagEnum.AMILY_INCUBATION] == 0) outputText("Fill me up with everything you have...I want to be a mother for your children, just as much as I want to be a mother of my own people...", false);
			else outputText("No need to hold back, pump as much cum into me as you can...", false);
			outputText("</i>\" she whispers in a sultry tone, and her words are enough to send you over the edge. You grunt loudly, feeling as if your cock is about to explode from the exertion, blasting Amily so full of your cum that it starts to ooze out. Amily gives a cute little cry, and her vaginal walls clamp down on your sensitive member with enough force to make you wince, as girlcum sprays out onto your thighs.\n\n", false);

			//no preggo
			if(flags[FlagEnum.AMILY_INCUBATION] == 0) outputText("\"<i>If that didn't knock me up...I don't care as much as you'd think. It was magnificent either way,", false);
			else outputText("\"<i>Hmm...My kids are pretty lucky that their father is such a virile specimen,", false);
			outputText("</i>\" Amily says as she catches her breath, reaching up to ruffle your hair. You give her a bashful smile, glad to see you've made her so happy.\n\n", false);
			...
			//no pregg
			if(flags[FlagEnum.AMILY_INCUBATION] == 0) outputText("Okay...Well, I'm sure you'll be back. I will need your help again if this doesn't set,", false);
		...
		private function fuckAmilyPreg():void {
			...
			if(flags[FlagEnum.AMILY_WANG_LENGTH] > 0) outputText("  The erection tenting her pants isn't helping.", false);
			outputText("\n\n", false);
			...
			if(player.tailType > TAIL.NONE) outputText("You even feel Amily wrap her mousy tail around your own, making you chuckle softly into your lovers mouth.  ", false);
			...
			outputText("Amily teases you for a little while, running her pussy-lips and tail along the tip of your erection a few times, earning a few moans and groans from you. Amily smirks slightly before sliding herself down your fully erect " + Appearance.cockNoun(CockType.HUMAN) + ", taking as much as she can. You're a little worried that this might be harmful for your offspring, or worse - that they'll know what's going on... but Amily really seems to know more about this than you do, so you're just going to go along with her suggestions on the matter.\n\n", false);
			...
			if(flags[FlagEnum.AMILY_WANG_LENGTH] > 0) outputText(", her own mouse-cock spewing futa-cum all over her belly", false);
			outputText(".\n\n", false);

			if(flags[FlagEnum.AMILY_WANG_LENGTH] > 0) outputText("\"<i>Remember when you said this cock was a bad thing?</i>\" you tease, causing Amily to blush and playfully punch you in the shoulder.  \"<i>Sh-shut up!  It's... it's pretty incredible, there, I said it.</i>\"\n\n", false);
		...
		public function amilyFollowerEncounter():void {
			...
			outputText("", true);
			//Non corrupt!
			if(flags[FlagEnum.AMILY_FOLLOWER] == 1) outputText("As you approach the mouse-woman, her big, hairless ears twitch and she turns to face you with a smile. \"<i>Hi, " + player.short + "! What's up?</i>\" She grins at you.\n\n", false);
			//Corrupt!
			else
			{
			...
			switch (pregnancy.event) {
				...
				case 7: if (flags[FlagEnum.AMILY_FOLLOWER] == 1) { //Pure
						...
						break;
				case 8: outputText("Amily's bulge frequently wriggles and squirms, though this doesn't seem to bother her. " + (flags[FlagEnum.AMILY_FOLLOWER] == 1 ? "T" : "She smiles with glee, t") + "he children mustn't have too much longer until they are born.\n\n", false);
				default:
			}
			amilyMenu(true);
		}
		...
		private function amilyAppearance():void {
			...
			if (flags[FlagEnum.AMILY_FOLLOWER] == 1) {
				//(Start [horsecock]
				outputText("Amily is a 5' 2\" tall "+what+", with a lean and wiry build. Her pink eyes normally twinkle merrily, but they can turn hard and cold if the circumstances warrant, just as the normally friendly grin "+onHerMuzzle+"can turn cruel and harsh when she is angry. "+furDesc+" a long, hairless mouse's tail that sways and twitches constantly from her behind. She is currently wearing " + flags[FlagEnum.AMILY_CLOTHING] + ". She has " + amilyHips() + " and a " + amilyButt() + ".\n\n", false);
				//(End [horsecock]
				outputText("She has a pair of " + amilyTits() + " on her chest. They have " + flags[FlagEnum.AMILY_NIPPLE_LENGTH] + "-inch nipples at their tips and must be at least " + Appearance.breastCup(flags[FlagEnum.AMILY_CUP_SIZE]) + "s.\n\n", false);
				...
				if (flags[FlagEnum.AMILY_WANG_LENGTH] > 0) {
					...
					outputText("She has a " + flags[FlagEnum.AMILY_WANG_LENGTH] + "-inch penis growing from her crotch, replacing the clitoris that would normally jut from her vulva. It is surprisingly human looking, "+dickDesc+" - it even has a foreskin, not a sheath.\n\n", false);
				}
				...
				// End [horsecock]
				outputText("She has a pair of " + amilyTits() + " on her chest. They have " + flags[FlagEnum.AMILY_NIPPLE_LENGTH] + "-inch nipples at their tips and must be at least DD-cups.\n\n", false);

				//(If Amily has a penis:
				if(flags[FlagEnum.AMILY_WANG_LENGTH] > 0) {
					outputText("She has a half-erect " + flags[FlagEnum.AMILY_WANG_LENGTH] + "-inch penis growing from her crotch. It is surprisingly human looking, "+((flags[FlagEnum.AMILY_NOT_FURRY]==0) ? "naked and hairless ":"")+"and pink and throbbing", false);
					if(flags[FlagEnum.AMILY_HAS_BALLS_AND_SIZE] == 0) outputText(" - it even has a foreskin, not a sheath.\n\n", false);
					else outputText(", though it does have a" + ((flags[FlagEnum.AMILY_NOT_FURRY]==1) ? " little sheath.":" fuzzy little sheath.") + "\n\n", false);
				}
				if(flags[FlagEnum.AMILY_HAS_BALLS_AND_SIZE] > 0) {
					outputText("She has " + amilyBalls() + " dangling ", false);
					if(flags[FlagEnum.AMILY_WANG_LENGTH] > 0) outputText("underneath her shaft", false);
				...
				if(flags[FlagEnum.AMILY_VAGINAL_WETNESS] == 2) outputText("moist, ", false);
				if(flags[FlagEnum.AMILY_VAGINAL_WETNESS] == 3) outputText("wet, ", false);
				if(flags[FlagEnum.AMILY_VAGINAL_WETNESS] == 4) outputText("dripping, ", false);
				if (flags[FlagEnum.AMILY_VAGINAL_WETNESS] >= 5) outputText("soaked, ", false);
				// [Horsecock]
				...
				if (kGAMECLASS.farm.farmCorruption.hasTattoo("amily"))
				{
					...
					else
					{
						...
						if (flags[FlagEnum.AMILY_TATTOO_COLLARBONE] != 0) outputText(flags[FlagEnum.AMILY_TATTOO_COLLARBONE] + "\n");
						if (flags[FlagEnum.AMILY_TATTOO_SHOULDERS] != 0) outputText(flags[FlagEnum.AMILY_TATTOO_SHOULDERS] + "\n");
						if (flags[FlagEnum.AMILY_TATTOO_LOWERBACK] != 0) outputText(flags[FlagEnum.AMILY_TATTOO_LOWERBACK] + "\n");
						if (flags[FlagEnum.AMILY_TATTOO_BUTT] != 0) outputText(flags[FlagEnum.AMILY_TATTOO_BUTT] + "\n");
					}
				}
			}
		...
		private function takeChargeAmilyFuck():void{
			...
			//(if Amily is herm:
			if(flags[FlagEnum.AMILY_WANG_LENGTH] > 0) outputText("  Her pants begin to tent as her male organ reacts, and you start to idly stroke it as well for emphasis.", false);
			outputText("\n\n", false);
			...
			//(if Amily is herm:
			if(flags[FlagEnum.AMILY_WANG_LENGTH] > 0) outputText(" and her " + amilyCock() + " standing erect", false);
			...
			if(flags[FlagEnum.AMILY_WANG_LENGTH] > 0) outputText(" her " + amilyCock() + " spasming and spraying futa-jism in between your bodies", false);
			outputText(".\n\n", false);
		...
		private function takeChargeAmilyEatOut():void {
			...
			//(if herm:
			if(flags[FlagEnum.AMILY_WANG_LENGTH] > 0) outputText(", and her " + amilyCock() + " is sticking up where her clitoris should be.  Y", false);
			...
			if(flags[FlagEnum.AMILY_WANG_LENGTH] == 0) outputText("her clitoris.", false);
			...
			//(if herm:
			if(flags[FlagEnum.AMILY_WANG_LENGTH] > 0) outputText(" as her penis erupts and sprays its own cum into the air to sprinkle the both of you", false);
			outputText(".\n\n", false);
		...
		private function takeChargeAmilyGetSucked():void {
			...
			if(player.lowerBody.cockSpot.count() > 1) outputText("largest ", false);
			// [Horsecocks]
			...
			if(player.lowerBody.balls > 0) outputText(ballsDescriptLight(), false);
			...
			//(If Amily is herm:
			if(flags[FlagEnum.AMILY_WANG_LENGTH] > 0) outputText("She turns halfway back to you as she goes. \"<i>I hope you'll remember this and return the favor someday,</i>\" she calls out to you. She then resumes walking off.", false);
			doNext(camp.returnToCampUseOneHour);
			player.orgasm();
			dynStats("sen", -1);
		}
		...
		private function takeChargeAmilyMountHer():void {
			...
			//(If player is herm:
			else if(player.lowerBody.cockSpot.hasCock()) outputText("She reaches out and grabs hold of " + oMultiCockDesc() + ", stroking, tugging, and teasing it to further excite you into increasing the speed and force with which you thrust.... Something that she succeeds admirably in doing.\n\n", false);
			...
			//(if herm:
			if(player.lowerBody.cockSpot.hasCock()) outputText(", spraying your own herm-cum onto Amily's face", false);
			outputText(", splattering mixed fluids below your " + player.legs() + " and Amily's ", false);
			if(flags[FlagEnum.AMILY_NOT_FURRY] == 0) outputText("furry ", false);
			outputText("thighs.\n\n", false);
		...
		private function letAmilyLead():void {
			...
			//B3: Eat Out
				...
				//(if Amily is herm:
				if(flags[FlagEnum.AMILY_WANG_LENGTH] > 0) outputText("  Her cock bobs merrily in your field of vision.", false);
				outputText("\n\n", false);
				...
				//(If Amily is herm:
				if(flags[FlagEnum.AMILY_WANG_LENGTH] > 0) outputText("\"<i>Could you... could you give it a lick, please?</i>\" she whispers, pointing at her male addition. Wanting to make her happy, you kiss the tip of her penis, eliciting a squeak of shock, before you start to lick from the base of her " + amilyCock() + " to the tip again. You then return your attention to her vagina itself.\n\n", false);
				...
				//(if Amily is herm:
				if(flags[FlagEnum.AMILY_WANG_LENGTH] > 0) outputText("  Her penis erupts and sprays its own cum into the air to sprinkle the both of you.", false);
				outputText("\n\n", false);
				...
				//(if Amily is herm:
				if(flags[FlagEnum.AMILY_WANG_LENGTH] > 0) outputText("and limp cock ", false);
			...
			//B5: Suck Off
				...
				if(player.lowerBody.cockSpot.hasCock()) outputText("When I do that for you?</i>\"\n\n", false);
			...
			//Let Amily Lead: Amily Mounts You
				...
				//(if player is herm:
				if(player.lowerBody.cockSpot.hasCock()) outputText("  She strokes your " + cockDescript(0) + " a few times, but in a prefunctory manner; it's obvious that she's focusing on her own penis, this time.", false);
				outputText("\n\n", false);
				...
				if(player.lowerBody.cockSpot.hasCock()) outputText(", " + sMultiCockDesc() + " spraying jism to fall upon you both like sex-scented rain", false);
				...
				if(flags[FlagEnum.AMILY_WANG_LENGTH] > 0) {
					...
					if(
						...
						if(player.stats.cor >= 50 || player.vaginalCapacity() >= 50) {
							...
							if(player.stats.cor >= 75) outputText("  Although the idea of raping yourself with your futa-mouse lover's helpless body is appealing, you realize this is one argument you simply won't win.", false);
							outputText("\n\n", false);
						}
						//otherwise]
		...
		public function giveAmilyPurifiedSuccubusMilk():void {
			...
			//CORRUPT UNZ
				...
				//[(If Amily has a dick)
				if(flags[FlagEnum.AMILY_WANG_LENGTH] > 0) outputText("  Her cock hardens with delight at your idea.", false);
				outputText("\n\n", false);
				...
				if(flags[FlagEnum.AMILY_VAGINAL_WETNESS] >= 5) outputText("  A jet of femcum flies straight out of her pussy, only to arch and hit her straight in the face.", false);
		...
		private function amilyDrinksSuccubusDelight():void {
			...
			if(flags[FlagEnum.AMILY_HAS_BALLS_AND_SIZE] == 0) {
				...
				if(flags[FlagEnum.AMILY_WANG_LENGTH] > 0) outputText("Her cock grows hard, but nothing else seems to happen...", false);
				outputText("\n\n", false);
				...
				outputText("You watch, smiling, as a couple of " + ((flags[FlagEnum.AMILY_NOT_FURRY]==0) ? "lumps begin forming" :"fuzzy lumps begin forming"), false);
				if(flags[FlagEnum.AMILY_WANG_LENGTH] > 0) outputText("right under her cock. Her skin grows and covers the base of her cock, pulling it in; giving her what looks like a sheath. It continues to expand and is finally complimented by a couple of orbs falling into her " + ((flags[FlagEnum.AMILY_NOT_FURRY]==0) ? "fuzzy " :"") + "sack, giving it the weight it needs to produce more cum. ", false);
				else outputText("between her legs. Her skin expands with the lumps, forming into a small sack. It continues to expand and is finally complimented by a couple of orbs falling into her " + ((flags[FlagEnum.AMILY_NOT_FURRY]==0) ? "fuzzy " :"") + " nutsack, giving it the weight it needs to produce cum, though how it will ever expel it is a mystery to you. ", false);
		...
		public function giveAmilyAWhiteEgg():void {
			...
			//Corrupt!
				...
				//(If Nipples are smaller than 4 inches:
				if(flags[FlagEnum.AMILY_NIPPLE_LENGTH] < maxSizeCorr) outputText("She looks at it and smiles knowingly. \"<i>Is " + player.mf("master","mistress") + " going to make this one's nipples into obscene toys?</i>\" she asks while accepting the egg.  She bites off the top and sucks down the contents in a practiced gulp.  Crushing the shell in her hand, she pulls at her top, allowing you to see her nipples swell and grow until they stop. She experimentally tweaks one, squeaking in shock at the sensation. \"<i>Thank you " + player.mf("master","mistress") + " for giving your slut such wonderful nipple-toys.  Would you like to abuse your slut's needy fuck-hole now?</i>\"\n\n", false);
		...
		*/
		...
		public function giveAmilySomePants():void {
			outputText("", true);
			amilySprite();
			outputText("You offer her a set of comfortable clothes, asking if she'd like to wear these instead of her " + flags[FlagEnum.AMILY_CLOTHING] + " she's wearing.\n\n", false);
		...
		*/
		...
		private function corruptAmilyOralSuckOff():void {
			...
			//[(if PC has a pussy)
			if(player.lowerBody.vaginaSpot.hasVagina()) {
				outputText("; getting some of your juices on her "+((flags[FlagEnum.AMILY_NOT_FURRY]==0)?"muzzle":"lips"), false);
				if(player.lowerBody.balls > 0) outputText(" and ", false);
			}
			else if(player.lowerBody.balls > 0) outputText("; ", false);
			if(player.lowerBody.balls > 0) outputText("tickling your balls with her "+((flags[FlagEnum.AMILY_NOT_FURRY]==0)?"fur":"skin"), false);
			...
			//[(if PC has balls)
			if(player.lowerBody.balls > 0) outputText(" balls churn and your", false);
		...
		private function corruptAmilyLickPussiesLikeAPro():void {
			...
			if(player.lowerBody.cockSpot.hasCock()) outputText("hardening " + Appearance.cockNoun(player.lowerBody.cockSpot.list[0].cockType) + " and ", false);
			...
			if(player.lowerBody.balls > 0) {
				if(!player.lowerBody.cockSpot.hasCock()) outputText(", ", false);
			...
			//[(if PC has balls)
			if(player.lowerBody.balls > 0) outputText("lifts your " + ballsDescriptLight() + " to set them gently atop her head, ", false);
			...
			if(player.lowerBody.balls > 0) outputText("balls", false);
			...
			//[(if PC has balls)
			if(player.lowerBody.balls > 0) outputText(" and her small horns gently massage your " + ballsDescriptLight(), false);
			//[(if PC has a cock)
			if(player.lowerBody.cockSpot.hasCock()) outputText("; " + sMultiCockDesc() + " throbs and begins leaking pre; it forms small rivulets that run down onto Amily's head", false);
			outputText(".  The "+((flags[FlagEnum.AMILY_NOT_FURRY]==0)?"mousette":"succubus")+" jumps slightly and you can almost imagine her grinning as she eats out her meal.\n\n", false);
			...
			// More [Horsecock]
			outputText("You move back and push Amily back into the ground, she hits the ground with a <b>THUD</b> and grins at you.  You move quickly, sitting on top of Amily's face and beginning using her mousy "+((flags[FlagEnum.AMILY_NOT_FURRY]==0)?"muzzle":"nose")+" like a dildo, rubbing it all over your pussy; her tongue darts out to give little licks and enhance your pleasure.\n\n", false);
			...
			if(player.vaginalCapacity() >= 45 && flags[FlagEnum.AMILY_NOT_FURRY]==0) {
				...
				outputText(vaginaDescript() + " , holding her " + ((flags[FlagEnum.AMILY_NOT_FURRY] == 0)?"nose":"mouth") + " closed; Amily's eyes bulge with surprise and you voice your pleasure with a long moan, \"<i>I'm not letting you breathe until you make me come slut. </i>\" With those words, you begin frigging yourself against Amily's ", false);
				outputText(((flags[FlagEnum.AMILY_NOT_FURRY] == 0)?"mousy muzzle":"face") + ", intent on driving yourself to orgasm as you feel her cheeks bulge with air and need.\n\n", false);
				// END [Horsecock]
			}
			...
			if(player.vaginalCapacity() >= 45) outputText("You pull yourself off Amily's "+((flags[FlagEnum.AMILY_NOT_FURRY]==0)?"muzzle":"face")+" and moan deeply.", false);
			else outputText("You let go of Amily's "+((flags[FlagEnum.AMILY_NOT_FURRY]==0)?"muzzle":"face")+" and moan deeply.", false);
		...
		private function corruptAmilyScissorsLikeAPro():void {
			...
			//[(if Amily has a cock)
			if(flags[FlagEnum.AMILY_WANG_LENGTH] > 0) outputText(" Amily's " + amilyCock() + " throbs,", false);
			...
			if(flags[FlagEnum.AMILY_WANG_LENGTH] > 0) {
				...
				//(if Amily has balls)
				if(flags[FlagEnum.AMILY_HAS_BALLS_AND_SIZE] > 0) outputText(" and " + amilyBalls() + ", which you shift to reveal her ", false);
			...
			//[(if Amily has a cock)
			if(flags[FlagEnum.AMILY_WANG_LENGTH] > 0) outputText(" almost as if trying to match its bigger brother above", false);
			...
			//[(ballsDescript)
			if(player.lowerBody.balls > 0) outputText(ballsDescriptLight(), false);
			else if(player.lowerBody.cockSpot.hasCock()) outputText(cockDescript(0), false);
			else outputText(clitDescript(), false);
			...
			//[(if Amily has a cock)
			if(flags[FlagEnum.AMILY_WANG_LENGTH] > 0) outputText("and her cock ", false);
			...
			// [Horsecock]
			outputText("\"<i>Thank you so much mistress! I love to fuck! I love to be fucked! I love to be used! I love being your sextoy! I love the way your pussy feels against mine! I love you, mistress!</i>\" Amily screams as an orgasm rocks her. She presses against you with all her strength, legs wrapping themselves around you, "+((flags[FlagEnum.AMILY_NOT_FURRY]==0)?"claws":"feet")+" curled in pleasure, eyes rolled back.", false);
			//[(if Amily's a squirter)
			if(flags[FlagEnum.AMILY_VAGINAL_WETNESS] >= 5) outputText("  A veritable jet of juices shoots up, splashing against your netherlips, some of it even making it inside.", false);
		...
		private function corruptAmilysPussyGetsMotherfuckingFucked():void {
			...
			//[(if PC has a vagina)
			if(player.lowerBody.vaginaSpot.hasVagina()) outputText("  Your other hand probes your moist fuck-hole for lube to help with your stroking.", false);
			outputText("\n\n", false);
			...
			//[(if Amily has balls)
			if(flags[FlagEnum.AMILY_HAS_BALLS_AND_SIZE] > 0) outputText("  Her balls do get in the way, but they form a nice cushion to rub your " + cockDescript(0) + " on, further stimulating you.", false);
			...
			//[(if Jojo's corrupt)
			if(monk >= 5 && flags[FlagEnum.JOJO_DEAD_OR_GONE] == 0) outputText("Jojo wants to play,", false);
			//(else)
			...
			if(player.cockArea(0) >= 61) {
				...
				if(flags[FlagEnum.AMILY_VAGINAL_WETNESS] >= 5) outputText("  Jets of fluid wash down whatever pre escapes your rigid tool.", false);
			...
			if(player.lowerBody.balls > 0) outputText("your balls slap against her butt and ");
			...
			//(If not squirter:
			if(flags[FlagEnum.AMILY_VAGINAL_WETNESS] < 5) outputText("  Her fluids slop wetly over your crotch, painting between your legs with her lubricant.", false);
			//(If squirter:
			...
			//(If Amily is herm:
			if(flags[FlagEnum.AMILY_WANG_LENGTH] > 0) outputText("  It doesn't take long - seconds, at most - before her pulsing, twitching cock finally explodes, spewing gush after gush of herm-spunk all over her tits and face, which Amily eagerly laps up.", false);
			outputText("\n\n", false);
			...
			//[(if PC has a pussy)
			if(player.lowerBody.vaginaSpot.hasVagina()) outputText("  Despite being neglected during the act, your " + vaginaDescript() + " leaks fluids to join Amily's on the floor.", false);
			...
			//[(if PC has a pussy)
			if(player.lowerBody.vaginaSpot.hasVagina()) outputText("  Once she's done with your cock she begins licking your thighs; ensuring none of your precious juices go to waste.", false);
		...
		private function corruptAmilyCampBonesPCWithHerCock():void {
			...
			//[(if Amily has balls)
			if(flags[FlagEnum.AMILY_HAS_BALLS_AND_SIZE] > 0) outputText("  A pair of balls hangs under Amily's shaft; as you look, you have the slightest impression that her balls became rounder, fuller...", false);
			outputText("  Amily's shaft is ", false);
			if(flags[FlagEnum.AMILY_WANG_LENGTH] < 6) outputText("small", false);
			else if(flags[FlagEnum.AMILY_WANG_LENGTH] < 9) outputText("average", false);
			...
			if(flags[FlagEnum.AMILY_HAS_BALLS_AND_SIZE] > 0) outputText(", and her balls seeingly inflate", false);
			...
			if(flags[FlagEnum.AMILY_WANG_LENGTH]*flags[FlagEnum.AMILY_WANG_GIRTH] > player.vaginalCapacity()) outputText("  You growl at her rough penetration, Amily stretches you out without regards for your pleasure; you'll definitely have to punish her for this later...", false);
			outputText("\n\n", false);
			...
			//(if Amily has balls:
			if(flags[FlagEnum.AMILY_HAS_BALLS_AND_SIZE] > 0) outputText(" and the meaty smack-smack-smack of her balls slapping against your " + assDescript(), false);
			outputText(".\n\n", false);
			...
			//[(if Amily has balls)
			if(flags[FlagEnum.AMILY_HAS_BALLS_AND_SIZE] > 0) outputText("The slapping of her balls on your ass reverberates around you.  ", false);
			...
			//[(if PC has a dick)
			if(player.lowerBody.cockSpot.hasCock()) outputText("  If she did, you might have to return the favor...", false);
			//(else)
		...
		private function corruptAmilyBuckFutter():void {
			...
			if(flags[FlagEnum.AMILY_WANG_LENGTH] > 0) outputText("; her " + amilyCock() + " stands erect, a tiny bead of pre forming on the tip as it throbs", false);
			outputText("\n\n", false);
			...
			//[(if PC has balls)
			if(player.lowerBody.balls > 0) outputText(" and her spilled juices from your balls", false);
		...
		public function girlyGirlMouseSex():void {
			...
			//(If first time:
			if(flags[FlagEnum.AMILY_TIMES_FUCKED_FEMPC] == 0) outputText("Amily stops and lets go of your hand, blushing faintly and looking embarrassed. \"<i>So, ah... how do we do this? I... I've never been attracted to another woman before, how does sex even work between us?</i>\"\n\n", false);
			...
			if(flags[FlagEnum.AMILY_TIMES_FUCKED_FEMPC] == 0) outputText("\"<i>...I'm supposed to lick you there, right?</i>\" Amily asks, hesitantly. You smirk and promptly give her own sex a long, sloppy lick of your own. She squeaks in shock and then clumsily licks you in return.\n\n", false);
			...
			if(flags[FlagEnum.AMILY_TIMES_FUCKED_FEMPC] == 0) outputText("\"<i>...I didn't know it could feel so good with another woman.... But I was never attracted to women before.</i>\" Amily murmurs to herself.\n\n", false);
		...
		public function hermilyOnFemalePC():void {
			...
			if(flags[FlagEnum.AMILY_HERM_TIMES_FUCKED_BY_FEMPC] == 0) outputText("\"<i>I can't believe this is actually happening... I've grown a cock and I'm about to use it on another woman.</i>\" Amily mutters to herself, though it's very evident that she likes what she sees, unable to resist staring at your " + chestDesc() + " or your " + vaginaDescript() + ".\n\n", false);
			...
			//(First time:
			if(flags[FlagEnum.AMILY_HERM_TIMES_FUCKED_BY_FEMPC] == 0) outputText("\"<i>...I had no idea it would feel like that,</i>\" she gasps softly.\n\n", false);
		...
		public function pcBirthsAmilysKidsQuestVersion():void {
			...
			if(flags[FlagEnum.PC_TIMES_BIRTHED_AMILYKIDS] + flags[FlagEnum.AMILY_BIRTH_TOTAL] >= 5) {
				...
				outputText(((flags[FlagEnum.AMILY_NOT_FURRY]==0)?", naked, pink, and totally hairless":"")+". Amily helps hold it to your " + breastDescript(0) + ", where it eagerly takes hold of your " + nippleDescript(0) + " and starts to suckle. As it drinks, it starts to grow larger, and "+((flags[FlagEnum.AMILY_NOT_FURRY]==0)?"fur the same color as your own hair starts to cover its body":"")+". It quickly drinks its fill and then detaches, its 'father' putting it aside, which is good, because by this time there's another baby waiting for its turn... and another... and another...\n\n", false);
			...
			outputText("Any reply you may have been inclined to make to that is swallowed by another cry of pain as yet another contraction wrings its way through you. Amily takes your hand in hers and you cling to the lifeline of comfort it offers, thankful to not be alone for this. You can feel the first child moving out of your womb, through your cervix, down and into your " + vaginaDescript() + ". Your lips part and, with a grunt, you expel the first child into Amily's waiting hand. She holds it up to you so that you can see your firstborn; it's a little mouselet", false);
			//(if player is female: 1 in 3 chance of it being boy, girl or herm, if player is herm, 100% chance of it being a herm)
			outputText(((flags[FlagEnum.AMILY_NOT_FURRY]==0)?", naked, pink, and totally hairless":"")+". Amily helps hold it to your " + chestDesc() + ", where it eagerly takes hold of your " + nippleDescript(0) + " and starts to suckle. As it drinks, it starts to grow larger, and "+((flags[FlagEnum.AMILY_NOT_FURRY]==0)?"fur the same color as your own hair starts to cover its body":"")+". It quickly drinks its fill and then detaches, its 'father' putting it aside, which is good, because by this time there's another baby waiting for its turn... and another... and another...\n\n", false);
			...
			//Genderless tooo
				...
				if(flags[FlagEnum.AMILY_AFFECTION] < 15) {
					...
					if(player.lowerBody.cockSpot.hasCock()) {
						...
						if(player.lowerBody.vaginaSpot.hasVagina()) outputText(" and ", false);
					}
					if(player.lowerBody.vaginaSpot.hasVagina()) outputText(vaginaDescript(), false);
				...
				//[High Affection]
					...
					if(player.lowerBody.cockSpot.hasCock()) outputText("bringing your " + cockDescript(0) + " to erection", false);
					if(player.lowerBody.vaginaSpot.hasVagina() && player.lowerBody.cockSpot.hasCock()) outputText(" and ", false);
					if(player.lowerBody.vaginaSpot.hasVagina()) outputText("earning a clench from your " + vaginaDescript(0), false);
		...
		private function beAmilysDadAsAHerm():void {
			...
			outputText("", true);
			flags[FlagEnum.AMILY_HERM_QUEST] = 2;
			outputText("You tell her that you'll forgive her, and you will help her breed the "+((flags[FlagEnum.AMILY_NOT_FURRY]==0)?"free mousemorphs that she wants so badly. She looks a bit confused by you using the term 'mouse-morphs', but otherwise seems happy.":"")+" \"<i>Wonderful! Come with me!</i>\" She says, grabbing your hand and pulling you down the street.\n\n", false);
		...
		private function playerBirthsWifAmilyMiceInCamp():void {
			...
			//Repeat brood
			if(flags[FlagEnum.PC_TIMES_BIRTHED_AMILYKIDS] > 0) outputText("this is hardly the first time you've given birth to her offspring before, after all", false);
			//First time!
		...
		public function amilyPopsOutKidsInCamp():void {
			...
			//CORRUPT!
				...
				//(If Amily is herm:
				if(flags[FlagEnum.AMILY_WANG_LENGTH] > 0) outputText("  She has hold of her cock with both hands and is furiously jacking herself off, spurts of cum spilling like a fountain; then spattering onto her heaving breasts, face and belly, even though her erection refuses to die away.", false);
				//[If Amily has balls:
				if(flags[FlagEnum.AMILY_HAS_BALLS_AND_SIZE] > 0) outputText("  Her testicles shake and quiver, swaying in the breeze as the pussy behind them readies itself to disgorge the life crammed into her swollen stomach above.", false);
				...
				//[(if Amily has a dick)
				if(flags[FlagEnum.AMILY_WANG_LENGTH] > 0) outputText(" followed by a spurt of cum", false);
				...
				//[(if Amily has balls)
				if(flags[FlagEnum.AMILY_HAS_BALLS_AND_SIZE] > 0) outputText(" it grabs Amily's balls and uses them to try and pull itself out;", false);
				...
				outputText("When the last "+((flags[FlagEnum.AMILY_NOT_FURRY]==0)?"mouse":"mouse-girl")+" is finally free of the confines of its slutty mother's cunt, they all crawl up towards their mother's breasts and each takes their turn drinking from their mother's corrupt milk. You just smile and observe; Amily's babies come in various flavors, some are girls, some are boys, and some are even both; they all share the same lewd purple "+((flags[FlagEnum.AMILY_NOT_FURRY]==0)?"fur":"skin tone")+" of their mother; you can't help but wonder if they'll be wonderful cum-sluts like their mother. As they drink, you see the little babies grow bigger; and that's not all, you see little cocks getting bigger, balls developing, breasts expanding, pussies juicing up.  The sight fills you with joy.\n\n", false);
				...
				if(player.lowerBody.cockSpot.hasCock() && (player.gender == 1 || rand(2) == 0)) {
					...
					if(player.lowerBody.vaginaSpot.hasVagina()) outputText(" and " + vaginaDescript(0), false);
				...
				//[=Pussy=]
					...
					outputText("; Amily licks her lips in anticipation. You squat above Amily, hovering over her "+((flags[FlagEnum.AMILY_NOT_FURRY]==0)?"muzzle":"face")+".", false);
					//[(if PC has balls)
					if(player.lowerBody.balls > 0) outputText("  She gives your balls a teasing lick, tickling you; impatient, you tell her to get on with it before you change your mind and go fuck something else.", false);
		...
		private function meetAmilyAsACorruptAsshat():void {
			...
			if(!player.perks.has("Evade") && !player.perks.has("Flexibility")) {
				...
				//-(if PC's int >= 40)
				if(player.stats.int >= 40) outputText("You begin to formulate a plan, but to put this plan into motion you'll require a Lust Draft and some Goblin Ale. That damn rat is going to rue the day she denied you.\n\n", false);
				//-(else)
		...
		private function cookAmilyASnack():void {
			...
			if(flags[FlagEnum.UNKNOWN_FLAG_NUMBER_00169] > 0) {
				...
				//(else)
					...
					if(player.lowerBody.vaginaSpot.hasVagina()) outputText("your " + vaginaDescript() + " moistens itself ", false);
					...
					if(player.lowerBody.cockSpot.hasCock()) {
						...
						//[(If PC is a herm.)
						if(player.lowerBody.vaginaSpot.hasVagina()) outputText("  Not yet fully sated, you decide that it couldn't hurt to add something 'girly' to the mixture...", false);
						outputText("\n\n", false);
					}
					//[Female]
					if(player.lowerBody.vaginaSpot.hasVagina()) {
			...
			//First Time
				...
				//(else)
					...
					if(player.lowerBody.cockSpot.hasCock()) outputText(cockDescript(0) + " jumps up to attention", false);
					if(player.lowerBody.cockSpot.hasCock() && player.lowerBody.vaginaSpot.hasVagina()) outputText(", and your ", false);
					if(player.lowerBody.vaginaSpot.hasVagina()) outputText(vaginaDescript() + " nearly juices itself", false);
					...
					if(player.lowerBody.cockSpot.hasCock()) outputText(cockDescript(0), false);
					if(player.lowerBody.cockSpot.hasCock() && player.lowerBody.vaginaSpot.hasVagina()) outputText(" and ", false);
					if(player.lowerBody.vaginaSpot.hasVagina()) outputText(vaginaDescript(), false);
		...
		private function talkWithCORRUPTCUNT(sexAfter:boolean = false):void {
			...
			//Conversation: Imps
				...
				if(player.cockArea(0) < 24 && player.lowerBody.cockSpot.hasCock()) outputText("\"<i>" + player.mf("Master","Mistress") + ", can you grow a bigger cock to fuck your loyal cumdumpster?</i>\"", false);
				//(else if PC has a dick >= 24 area)
				else if(player.lowerBody.cockSpot.hasCock()) outputText("\"<i>" + player.mf("Master","Mistress") + " I'm so horny, can you take your huge cock and jam it into your slutty mouse slave?</i>\"", false);
				//(else)
			...
			//Conversation: How did she survive?
				...
				//[(if Amily has a dick)
				if(flags[FlagEnum.AMILY_WANG_LENGTH] > 0) outputText(", and cock hardening", false);
		...
		private function rapeCorruptAmily1():void {
			...
			if(player.lowerBody.cockSpot.count() > 0) {
				if(player.lowerBody.cockSpot.count() > 1) outputText(multiCockDescriptLight() + " are", false);
			...
			if(player.lowerBody.vaginaSpot.hasVagina()) outputText(vaginaDescript() + " is already wet", false);
		...
		private function rapeCorruptAmily1Male():void {
			...
			if(player.lowerBody.balls > 0) outputText(ballsDescriptLight() + " churn", false);
		...
		private function rapeCorruptAmily2Male():void {
			...
			//[(if PC has balls)
			if(player.lowerBody.balls > 0) outputText("Amily grabs your balls and begins kneading them.  ", false);
			//(else if PC has a pussy)
			else if(player.lowerBody.vaginaSpot.hasVagina()) outputText("Amily shoves her fingers into your " + vaginaDescript() + ".  ", false);
			...
			//[(if PC has balls)
			if(player.lowerBody.balls > 0) outputText("  Just the thought of it is enough to make your balls churn.", false);
		...
		private function rapeCorruptAmily2Female():void {
			...
			//[(if PC is a squirter)
			if(player.wetness() >= 5) outputText("  Your juices rocket into her face, painting her "+((flags[FlagEnum.AMILY_NOT_FURRY]==0)?"muzzle":"face")+" in your femcum as she giggles with happiness and pleasure.", false);
		...
		private function rapeCorruptAmily3Male():void {
			...
			if(flags[FlagEnum.AMILY_NOT_FURRY] == 0) outputText("furry ");
			...
			if(player.lowerBody.balls > 0) outputText("your " + ballsDescriptLight(), false);
			else if(player.lowerBody.vaginaSpot.hasVagina()) outputText("your " + vaginaDescript(), false);
			...
			//[(if PC has balls)
			if(player.lowerBody.balls > 0) outputText("  Your " + ballsDescriptLight() + " churn with cum, growing heavier with every nasty detail that goes through your mind.", false);
		...
		private function rapeCorruptAmily3Female():void {
			...
			if(player.lowerBody.vaginaSpot.list[0].clitLength >= 4) outputText("Amily then crushes your sensitive clit between her breasts, working her mounds over it like it was a cock. You gasp and moan as Amily smiles up at you, happy to see your reaction to her stimulation.", false);
			//(else)
		...
		private function rapeCorruptAmily4Male():void {
			...
			//[(if pc has balls)
			if(player.lowerBody.balls > 0) outputText(" and " + ballsDescriptLight(), false);
			outputText(".\n\n", false);
			...
			if(player.lowerBody.balls > 0) outputText("your balls", false);
			else if(player.lowerBody.vaginaSpot.hasVagina()) outputText("your pussy", false);
			...
			//[(if PC has balls)
			if(player.lowerBody.balls > 0) outputText("  Sometimes you even feel her nipples brush your balls teasingly.", false);
			...
			//[(if PC has balls)
			if(player.lowerBody.balls > 0) outputText("  One of her hands even begins kneading your balls, attempting to coax even more out of you.", false);
			outputText("\n\n", false);
			...
			else if(player.lowerBody == LOWER_BODY.GOO) outputText("engulf her maw in slime.", false);
			...
			//[(if PC has balls)
			if(player.lowerBody.balls > 0) outputText(" and balls", false);
			outputText(".\n\n", false);
		...
		private function rapeCorruptAmily4Female():void {
			...
			//[(if PC has balls)
			if(player.lowerBody.balls > 0) outputText("  Pulling back enough to give your balls a teasing lick.", false);
			outputText("\n\n", false);
			...
			if(player.lowerBody.vaginaSpot.list[0].clitLength >= 4) outputText("  One of her hands begins stroking your erect clit as if it was a cock. The pleasure of the act nearly overloads your senses.", false);
			outputText("\n\n", false);
			...
			//[(if PC has balls)
			if(player.lowerBody.balls > 0) outputText("  She ignores your balls for the moment, so concentrated in her task, that she barely notices them resting on top of her head.", false);
		...
		private function rapeCorruptAmily4Epilogue():void {
			...
			outputText("Her " + ((flags[FlagEnum.AMILY_NOT_FURRY] == 0)?"fur turns to a lewd purple":"hair turns into a lewd purple, skin fading to a light lavender") + "; her small horns grow and become more defined; small bat-like wing sprout from her shoulders; the spade-like tip of her tail grows bigger and more defined; ", false);
			if (flags[FlagEnum.AMILY_NOT_FURRY] == 0)
		...
		private function stalkingZeAmiliez2():void {
			...
			//(else)
				...
				if(player.lowerBody.vaginaSpot.hasVagina()) outputText(vaginaDescript() + " growing wet", false);
				outputText(".\n\n", false);
				...
				if(player.lowerBody.vaginaSpot.hasVagina()) outputText(" dripping " + vaginaDescript(), false);
		...
		private function stalkingZeAmiliez3():void {
			...
			if(player.lowerBody.vaginaSpot.hasVagina()) outputText(" moistening your " + vaginaDescript(), false);
		...
		public function farewellNote():void {
			...
			//-(if PC's int >= 40)
			if(player.stats.int >= 40) outputText("You begin to formulate a plan, but to put this plan into motion you'll require a Lust Draft and some Goblin Ale.  That damn rat is going to rue the day she denied you...", false);
			//-(else)
			else outputText("You think about some of the more interesting potions you found while exploring; perhaps you could use some of them...", false);
		...
		public function dateNightFirstTime():void {
			...
			if(flags[FlagEnum.ENCOUNTERED_VALA_AT_BAR] == 0) outputText("a passing waitress", false);
		...
		private function liqueurUpTheWaifus():void {
			...
			if(player.lowerBody.cockSpot.hasCock()) outputText(", already feeling a strong stirring in your " + multiCockDescriptLight(), false);
			else if(player.lowerBody.vaginaSpot.hasVagina()) outputText(", already feeling a little moisture in your loins", false);
			outputText(".\n\n", false);
			...
			if(flags[FlagEnum.AMILY_NOT_FURRY] == 0) outputText("through the mouse's fur ", false);
		...
		public function threesomeAmilUrtaCAWKS():void {
			...
			//if Futamily:
			if(flags[FlagEnum.AMILY_WANG_LENGTH] > 0) outputText(" as her cock orgasms, too, spurting a nice, thick trail of mousecum all over Urta's face and tits", false);
			outputText(".\n\n", false);
		...
		public function pureAmilyPutsItInYourRectumDamnNearKilledEm():void {
			...
			if(player.tailType > TAIL.NONE) outputText(", moving your tail out of the way", false);
			outputText(".\n\n", false);

			outputText("Amily ", false);
			if(flags[FlagEnum.AMILY_TIMES_BUTTFUCKED_PC] == 0) outputText("looks a bit puzzled as she contemplates the mechanics of this for a moment, and then with a shrug, ", false);
			...
			if(flags[FlagEnum.AMILY_TIMES_BUTTFUCKED_PC] == 0) outputText("\"<i>Is this okay? Ah... it feels... really good...</i>\" she says with a low moan, to which you reply with a pleasure-filled groan of your own.\n\n", false);
			...
			if(player.lowerBody.cockSpot.hasCock()) {
				...
				if(player.lowerBody.cockSpot.count() > 1) outputText("She brushes along " + sMultiCockDesc() + " one at a time, stroking for a moment or two before switching off.", false);
			}
			outputText("\n\n", false);
			...
			if(player.lowerBody.vaginaSpot.hasVagina()) {
				...
				if(player.lowerBody.cockSpot.hasCock()) outputText(" and p", false);
			}
			if(player.lowerBody.cockSpot.hasCock()) {
				if(!player.lowerBody.vaginaSpot.hasVagina()) outputText("  P", false);
		...
		private function fuckPureAmilysHeiny():void {
			...
			if(flags[FlagEnum.AMILY_WANG_LENGTH] > 0) outputText("  Her pants tent from arousal as her male organ reacts to your sensual touching, and you start to teasingly stroke it as well.", false);
			outputText("\n\n", false);
			...
			outputText("She wipes her hand off on a discreet corner of her " + flags[FlagEnum.AMILY_CLOTHING] + " and begins to shimmy out of them.", false);
			if(flags[FlagEnum.TIMES_FUCKED_AMILYBUTT] == 0) outputText("  \"<i>I'm... not really sure how this goes... I guess... like this?</i>\"", false);
			...
			if(flags[FlagEnum.TIMES_FUCKED_AMILYBUTT] == 0) outputText("\"<i>Aah... ah... that feels really weird,</i>\" she pants, noticeably struggling against the instinct to clench up against the invader. \"<i>Ah... not... bad... just weird...</i>\"\n\n", false);
			...
			if(flags[FlagEnum.AMILY_WANG_LENGTH] > 0) outputText("her own member twitch and dribble a small puddle of clear pre-cum onto the ground below her, joining with ", false);
		...
		private function amilyIncest():void {
			...
			if(flags[FlagEnum.AMILY_NOT_FURRY] == 0) outputText("furred");
			...
			if(flags[FlagEnum.AMILY_NOT_FURRY] == 0) outputText("fur");
			...
			if(flags[FlagEnum.AMILY_NOT_FURRY] == 0) outputText("through her mother's fur");
		...
		private function fuckIncestCunts(all:boolean):void {
			...
			if(flags[FlagEnum.AMILY_NOT_FURRY] == 0) outputText("muzzles");
			...
			if(all) {
				...
				if(flags[FlagEnum.AMILY_NOT_FURRY] == 0) outputText("muzzle");
		...
		private function amilyEggStuff():void {
			...
			//if amily = herm
			if(flags[FlagEnum.AMILY_WANG_LENGTH] > 0) outputText("and you notice a growing bulge in her trousers");
		...
		private function layEggsInAmilysCorruptedHole():void {
			...
			if(flags[FlagEnum.AMILY_WANG_LENGTH] > 0) outputText(" and her erect shaft shuddering as it throbs in the air");
			...
			if(flags[FlagEnum.AMILY_WANG_LENGTH] > 0) outputText("and stiff cock ");
			...
			if(player.lowerBody.cockSpot.hasCock()) {
				...
				if(flags[FlagEnum.AMILY_WANG_LENGTH] > 0) outputText(", her shaft oozing thick globs of pre-cum that roll down her cock to smear against your own as she moves against you");
				outputText(".");
			}
			...
			//{(Genderless)
				...
				if(flags[FlagEnum.AMILY_WANG_LENGTH] > 0) outputText(", her shaft covering your stomach with thick strands of pre-cum");
			...
			//(Males/Herms)
			if(player.lowerBody.cockSpot.hasCock()) outputText("  Amily jolts forwards from the unexpected movement and you seize the opportunity, impaling her tight, wet entrance on your [cock].  You both cry out in bliss as she sinks down your shaft, her passage almost burning your oversensitive shaft as her arms wrap around your neck, pulling herself close to you.");
			//(Females + AmilyHerm)
			else if(player.lowerBody.vaginaSpot.hasVagina() && flags[FlagEnum.AMILY_WANG_LENGTH] > 0) {
			...
			//(Males/Herms)
			if(player.lowerBody.cockSpot.hasCock()) outputText("you feel her passage clamp down around your shaft, her body shaking as she whimpers softly above you.");
			//(Females + AmilyHerm)
			else if(player.lowerBody.vaginaSpot.hasVagina()) outputText("her thrusts falter slightly, her member twitching within you as your ovipositor fills her body up, shaking slightly with pleasure as her hot shaft brushes against your walls.");
			//(F/F or Genderless)
			...
			if(player.lowerBody.cockSpot.hasCock()) outputText("s quiver");
			...
			//(Males/Herms)
			if(player.lowerBody.cockSpot.hasCock()) outputText("another ");
		...
		public function amilyLaysEggsLikeABitch():void {
			...
			if(flags[FlagEnum.AMILY_WANG_LENGTH] == 0) outputText("teases her clit");
			...
			if(flags[FlagEnum.AMILY_WANG_LENGTH] == 0) outputText("pussy visibly quivering");
		...
		public function amilySwimFuckIntro():void {
			...
			if(flags[FlagEnum.AMILY_TIMES_SWIMFUCKED] == 0) {
				...
				if(player.stats.lib >= 60) outputText(", eagerly anticipating the opportunity to drink in her form while it's bound up in body-hugging black fabric.");
				else if(player.stats.cor < 50) outputText(", happy to share the fruits of your adventure with your mousy lover.");
				...
				if(flags[FlagEnum.AMILY_WANG_LENGTH] > 0) outputText("  D-don't laugh, okay?");
				outputText("</i>\"");
				outputText("\n\nAmily strides around the rocks nervously, hands on her hips.  Her soft ");
				if(flags[FlagEnum.AMILY_NOT_FURRY] > 0) outputText("skin");
				else outputText("fur");
				...
				if(flags[FlagEnum.AMILY_WANG_LENGTH] > 0) {
					...
					if(flags[FlagEnum.AMILY_HAS_BALLS_AND_SIZE] > 0) outputText("  It snaps back onto her " + amilyBalls() + " to snug them tightly.");
				}
			...
			//Repeat Swim Intro
				...
				if(flags[FlagEnum.AMILY_WANG_LENGTH] > 0) {
					...
					if(flags[FlagEnum.AMILY_HAS_BALLS_AND_SIZE] > 0) outputText("  Her balls are snugly secured in her bottoms, looking like a cute little sphere of virile fun.");
				}
		...
		private function amilySwimFuckPartII():void {
			...
			if(player.lowerBody.cockSpot.hasCock()) outputText("package");
			else if(player.lowerBody.vaginaSpot.hasVagina()) outputText("puffy lips");
			...
			if(flags[FlagEnum.AMILY_TIMES_SWIMFUCKED] > 1) outputText(", and wondering why you keep falling for it");
			...
			if(player.lowerBody.balls > 0) outputText("[balls]");
			else outputText("base");
			outputText(".");
			outputText("\n\nYou knead her supple cheeks, admiring ");
			if(flags[FlagEnum.AMILY_NOT_FURRY] == 0) outputText("her silky coat ");
			...
			if(flags[FlagEnum.AMILY_WANG_LENGTH] == 0) outputText("engorged bud that is her clit");
			...
			if(flags[FlagEnum.AMILY_NOT_FURRY] == 0) outputText("  Her whiskers tickle your cheeks as s");
			else outputText("  S");
			...
			if(player.lowerBody.cockSpot.count() > 1) {
				...
				if(player.lowerBody.cockSpot.count() > 2) outputText("s do");
				else outputText(" does");
				outputText(" a fine job of spraying ");
				if(player.lowerBody.cockSpot.count() == 2) outputText("its load ");
				else outputText("their loads ");
				outputText("over her middle.");
			}
			outputText("  The heat flowing inside her sets off a second orgasm");
			if(flags[FlagEnum.AMILY_WANG_LENGTH] > 0) outputText(", and she climaxes all over again, spraying the underside of her " + amilyTits() + " and your [chest] with milky mouse seed");
		...
		public function drinkThePotion():void {
			...
			if(flags[FlagEnum.AMILY_X_IZMA_POTION_3SOME] == 1) {
				...
				if(player.lowerBody.cockSpot.biggestCocks[0].cockArea() < 10) outputText("overtop of the petite, cock-holding digits");
			...
			//Appears in Amily's Sex Menu - Izma3Some
				...
				if(flags[FlagEnum.IZMA_NO_COCK] == 0) outputText(", barely concealing the half-swollen bulge beneath");
		...
		private function izmaAmilyDrugThreeWaySex():void {
			...
			if(player.lowerBody.cockSpot.count() == 1) outputText("it's");
			...
			if(player.lowerBody.balls > 0) outputText(", one that has your [sack] swelling slightly, the skin growing smooth and glossy as it fills with the heavy, comfortable weight of your sloshing seed");
			...
			if(flags[FlagEnum.IZMA_NO_COCK] > 0) outputText("former-");
			...
			if(flags[FlagEnum.IZMA_NO_COCK] == 0) outputText("The shark-girl's balls are pushed to the side, barely avoiding being smothered in the mouse-girl's weight, and her rigid dick is drooling up between Amily's tits, where it seems quite happy to rest.  ");
			...
			if(player.lowerBody.cockSpot.count() == 2) outputText("  You even cram your second member in alongside its big brother.  The two cunt-oiled shafts rub against each other as well as the sloppy holes on either side, leaving you grateful for the extra maleness.");
			else if(player.lowerBody.cockSpot.count() > 2) outputText("  You even cram an extra member in alongside its big brother.  The two cunt-oiled shafts rub against each other as well as the sloppy holes surrounding them, leaving you grateful for your extra maleness.  Of course, that isn't your entire package, but there isn't room to stuff any more dick into that stuffed cock-sauna.");
			if(flags[FlagEnum.IZMA_NO_COCK] == 0) outputText("  You even bump up against Izma's forgotten package, slathering it with mixed juices.  While it's rigid with arousal, Izma seems to have almost forgotten about it, instead choosing to focus exclusively on her more womanly parts.");
			...
			if(player.lowerBody.cockSpot.count() > 1) outputText("cocks");
			...
			if(flags[FlagEnum.AMILY_NOT_FURRY] == 0) outputText("actually blushing so hard that you can see it through her fur, a crimson tint that looks even better on her with the way her tongue is hanging out");
			...
			if(player.lowerBody.cockSpot.count() > 1) outputText("doubled dicks");
			else outputText("[cock biggest]");
			...
			if(player.lowerBody.balls > 0) outputText("straining balls slosh ");
			...
			if(player.lowerBody.cockSpot.biggestCocks[0].cockArea() > 61) outputText("as far into Amily's juicy slit as it will go");
		...
		private function izmaAmilyDrugThreeWaySex2():void {
			...
			if(flags[FlagEnum.IZMA_NO_COCK] == 0) outputText(", dick and balls flopping lamely on top of you");
			...
			if(player.lowerBody.balls == 0) outputText("the pressure is as omnipresent as ever");
			...
			if(player.lowerBody.cockSpot.biggestCocks[0].cockArea() <= 65) outputText("bottoms out");
			else outputText("takes as much as she can");
			outputText(", there's a squirt of lubricant that washes out onto your middle");

			if(flags[FlagEnum.IZMA_NO_COCK] == 0) outputText(" along with a matching jet of pre-cum from her tip");
			outputText(".");
			if(player.lowerBody.cockSpot.count() > 1) {
				outputText("  Strong hands wrap around ");
				if(player.lowerBody.cockSpot.count() > 2) outputText("two of ");
				outputText("your extra penis");
				if(player.lowerBody.cockSpot.count() > 2) outputText("es");
				outputText(", jacking ");
				if(player.lowerBody.cockSpot.count() == 1) outputText("it");
			...
			if(flags[FlagEnum.IZMA_NO_COCK] == 0) outputText(", ignoring the dribbly cock that's leaking on your chest");
			...
			outputText("\n\nIzma leans down");
			if(player.lowerBody.cockSpot.count() == 2) outputText(", taking a hand away from your extra dick to support herself,");
			if(player.lowerBody.cockSpot.count() > 2) outputText(", taking a hand away from one of your extra dicks to support herself,");
			...
			if(flags[FlagEnum.IZMA_NO_COCK] == 0) outputText("  Her four balls quake atop you, and you watch her urethra bulge, ready to splatter your [chest] with her own, lesser climax.");
			...
			if(flags[FlagEnum.IZMA_NO_COCK] == 0) outputText("  The smell of her hot, inferior seed hits your nostrils, exciting you even further as it rolls off of you in thick globs.");
			...
			if(player.lowerBody.balls > 0) outputText("[balls] are");
		...
		private function amilyNurseCheckupV2(repeat:boolean):void {
			...
			if(flags[FlagEnum.AMILY_WANG_LENGTH] > 0) outputText("  It bulges out lewdly in a sheer outline of her " + amilyCock() + ", which is curled over to remain inside the stretchy skirt.");
			if(flags[FlagEnum.AMILY_WANG_LENGTH] > 9) outputText("  The effort is a failure, as her immense cock is simply too big for such a slinky covering, and the fat tip curves down to dangle below the hem, pulsing dangerously.");
			...
			if(flags[FlagEnum.AMILY_NOT_FURRY] == 1) outputText("hand");
			else outputText("paw");
			...
			if(player.lowerBody.balls == 0) outputText(", testing to engorgement with soft squeezes that are almost painful with how aroused you've become.");
			else {
				outputText(", eventually coming to rest on your [sack].  She dutifully hefts your [balls], ");
				if(player.lowerBody.ballSize <= 4) outputText("rolling them in her fingers with a sly smile");
			...
			if(player.lowerBody.vaginaSpot.hasVagina()) outputText(", while a sneaky finger slides into your cleft, testing the wetness");
			outputText(".");

			outputText("\n\nAmily explains, \"<i>It's ");
			if(player.lowerBody.balls > 0) outputText("Blue Balls");
			...
			if(player.lowerBody.balls > 0) outputText("plump balls are");
			...
			if(player.lowerBody.cockSpot.count() > 1) {
				...
				if(player.lowerBody.cockSpot.count() > 2) outputText("one of your extra cocks");
				else if(player.lowerBody.cockSpot.count() == 2) outputText("your extra cock");
			...
			if(flags[FlagEnum.AMILY_WANG_LENGTH] > 0) outputText(" that flings sticky ropes across your [chest].  Her back arches as she continues to launch her own jism towards you");
