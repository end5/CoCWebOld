package classes.Scenes.NPCs
{
	...
	public class Clara extends Monster
	{
		...
		public claraGropesBlindPCs():void
		{
			...
			if(player.lowerBody.cockSpot.hasCock() && (!player.lowerBody.vaginaSpot.hasVagina() || rand(2) == 0)) MainScreen.text("Suddenly Clara wraps an arm around you, and sticks a hand into your " + player.armorName + "!  She is able to give your " + multiCockDescriptLight + " a good fondle before you can push her away.  \"<i>Admit it - I make you soo hard, don't I?</i>\" she taunts you behind your dazzled vision.");
			//Vagina: 
