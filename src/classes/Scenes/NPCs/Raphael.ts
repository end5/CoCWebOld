...
private RaphaelPicnicSkill():void {
	...
	//{Fencing practice variables: Speed 30-39 Must play out at least once}
		...
		MainScreen.text("You gasp.  For the first time, Raphael forbids you something with harsh tone.  It's quite the departure.  You hang limply from his grasp, your " + breastDescript(0) + " squashed against his chest like dough.\n\n", false);
...
private thieveryEnding():void {
	...
	if(flags[FlagEnum.RAPHAEL_RAPIER_TRANING] != 4) MainScreen.text("You try to reach for the magnificent ornament hanging off his hips, but as the fox continues to move, you lack the nimbleness to remove it.\n\n", false);
...
private QuiksilverFawkesPtII():void {
	...
	if(flags[FlagEnum.REJECTED_RAPHAEL] == 1) MainScreen.text("<i>\"I can smell traces of him,\"</i> Hati states, nearing the waterbarrel, <i>\"but it's hard to tell.  There're too many other scents here.\"</i>\n\n", false);
	...
	if(player.armorName == "red, high-society bodysuit") MainScreen.text("  Suddenly, his eyes and ears perk.  <i>\"Isn't that the stolen clothing of the widow Camembert that she's wearing? You know, before she mysteriously dropped the charges after a nightly visit from the fox? Should we confiscate it anyway?\"</i>", false);
	MainScreen.text("\n\n", false);
...
private cunnilingusWithRaphael():void {
	...
	if(player.wetness() < 3) MainScreen.text("your cunt fluttering");
	//({Medium wetness multiplier}
	else if(player.wetness() < 4) MainScreen.text("sending out a small spurt of femcum landing on your belly");
