export default class Anemone extends Monster {
	public eAttack(): void {
		MainScreen.text("Giggling playfully, the anemone launches several tentacles at you.  Most are aimed for your crotch, but a few attempt to caress your chest and face.\n", false);
		super.eAttack();
	}
	...
	public applyVenom(str: number = 1): void {
		//First application
		if (!player.statusAffects.has("AnemoneVenom")) player.statusAffects.add(new StatusAffect("AnemoneVenom", 0, 0, 0, 0)));
		//Gain some lust
	...
	public outputAttack(damage: number): void {
		MainScreen.text("You jink and dodge valiantly but the tentacles are too numerous and coming from too many directions.  A few get past your guard and caress your skin, leaving a tingling, warm sensation that arouses you further.", false);
	}
	...
	public constructor() {
		...
		this.upperBody.head.hairColor = "purplish-black";
