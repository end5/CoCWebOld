...
//fuckin' Jumanji flower darts -Z
		private function fuckinJamanjiFlowerDarts():void
		{
			...
			if (statusAffects.has("Blind")) outputText("  Though the demon herself is blinded, the fresh eye on the flower seems more than capable of aiming for her!");
			...
			//Hit
				...
				if (player.lowerBody.cockSpot.hasCock()) outputText("come inside me");
