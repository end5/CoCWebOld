...
internal function bimbotizeMeCaptainSophie():void {
	...
	Render.text("A wicked idea takes hold of you while you watch the harpy ", false);
	if(monster.lust > 99) Render.text("touch herself", false);
	else Render.text("squirm in the dirt around her nest", false);
	Render.text(".  Releasing the ties on one of your pouches, you reach inside to claim the contents.  You produce the bottle of bimbo liqueur with a flourish, swirling the potent fluid inside its prison as you approach the downed harpy matron; she looks up at you with dumb, ", false);
	if(monster.lust > 99) Render.text("lust", false);
	else Render.text("pain", false);
	Render.text("-glazed eyes, her beautiful but uncomprehending visage slack-jawed and empty.  It's a good look for her.\n\n", false);
	
	Render.text("The cork pops from the bottle's top with an easy tug, releasing a fine pink mist that reeks of alcohol, potent spices, and sweetness.  You hold Sophie's jaw in your hand and pull her mouth open, placing the bottle's lip upon the defeated slut's slack mouth.  Like this, she's almost perfect... almost.  You lift the back edge of the bottle higher, dribbling a flow of bimbolicious alcohol into Sophie's pliant, unresisting mouth.  She gulps as it hits her tongue, swaying back and forth dangerously while the magic starts to take effect.  You hold her fast and upend the rest of the liqueur directly into her throat.  The busty harpy shudders and shakes, sputtering a little bit with her eyes crossed.  Her convulsions grow so forceful that she wrenches out of your grip to flop about on the floor of her nest.\n\n", false);
	
	Render.text("Starting at her head, her flamingo-pink plumage brightens to an even more neon coloration.  It continually lightens until the blush utterly vanishes, a light, barely-blond hue fading into place in her feathery hair.  The same scene is repeated over her wings, legs, and feathery backside, girding her body in platinum pinions.  Fluffing softly, the changed feathers ruffle while Sophie's involuntary shudders slow to a stop.  She shakes her head and mutters, \"<i>OOooh, wha... what did you give me?  So... hard to... think.</i>\"\n\n", false);
	
	Render.text("You display the bottle's warning label to the harpy, waiting for her response.  She squints in confusion and pulls back, her heaving breasts jiggling and bouncing about.  \"<i>What's that?  Some like, weird language or something?  I can't read it.</i>\"  Sophie's brow knits in confusion - you can practically see the gears trying to turn behind her open, clueless eyes.  She taps at her chin, her arm brushing her suddenly-larger assets, once again setting her swelling bust to shaking.  \"<i>Omigosh!  Are my titties getting bigger?</i>\" she asks with a giggle.  \"<i>They're so... jiggly and shaky!</i>\"\n\n", false);
	
	Render.text("Looking down confirms her claims.  While the twin melons were definitely double-D's before, they've swollen up to an E-cup by now, and the blooming bosom shows no signs of stopping.  Before your eyes, Sophie's tits grow into a truly magnificent pair of breasts, shaking and rippling like bowls of jello.  Her nipples puff up and engorge, the nubs easily doubling in size and stretching out to nearly a full inch in their aroused state.  They redden as Sophie's creamy skin blushes pink, her flesh coloring from the pleasure of her chest's obscene growth.  Widening in panic and lust, Sophie's eyes glitter with half-formed tears as she wails, \"<i>I can't fly like thiiiis!</i>\"\n\n", false);
	
	Render.text("You chuckle and heft one of the harpy's weighty globes, marveling at the smooth softness of her heavy tit.\n\n", false);
	
	Render.text("Sophie squeals, \"<i>S-stop it!  It's s-s-sensitiiiive!</i>\"\n\n", false);
	
	Render.text("Sighing, you rub your thumb across her areola, circling around the huge nipple before you give the long protrusion a hard flick.  The avian matron shivers and moans at that, arching her back to press the mammoth mounds further into your hands, forcing you back against the mountainside with their weight.  Protruding even more, her unyielding nips slide between your fingers.  Thankfully, they don't seem to be getting any bigger; while you're no tailor, you appraise them as at least F-cups now.  You idly massage the more-than-motherly melons, setting off a chorus of moans from the harpy's gold-glossed lips.  Her wide hips wiggle with sensuous need, the scent of horny harpy filling the air.  You must be doing something right.\n\n", false);
	
	Render.text("Sophie gasps and pulls back, turning about to place her hefty rump in front of your face.  The long tail-feathers tickle at you, but you brush the blond fluff aside with an irritated snort.  \"<i>Y-you like, did this to me!  Whatever it is making me all... horny and slurpy and yummy and dumb and... mmmm... can we fuck?</i>\" she accuses, losing her train of thought part way through her diatribe as juices begin to drip from her inflamed cunt-lips.\n\n", false);
	
	Render.text("You run a finger from the top of Sophie's box to the bottom, even stopping to slide the lubricated digit across her taint to circle her sensitive asshole.  She moans and bounces in place, her hips nearly blocking the light from your view when she presses back.  Did they get bigger too?  You pause to watch her hand-devouring ass-cheeks and confirm that they are, in fact, growing larger - just like her tits.  The plush pillow-butt rounds out, swelling larger.  You look down and note that her legs are moving apart as well, shifted wider by Sophie's changing body and expanding hips.\n\n", false);
	
	Render.text("Sophie giggles, \"<i>Like, do you love my drippy pussy that much?  Gosh that's cute!  But why am I so horny and silly?</i>\"  She giggles.  \"<i>I don't get it.  My head's all light and floaty!  Not like before.</i>\"  Her voice drops slightly as she struggles with herself.  \"<i>So hard... hard to think.  Gotta... gotta... like, find someone to fuck!  Mmm, would you give me a lick?  Can't you feel how hot Momma Sophie's box is?  It like, needs a tongue to cool it down or something.</i>\"\n\n", false);
	
	Render.text("The harpy's frothing gash smears over your nose and lips, trailing a fragrant smear of girl-honey across your face.  For one glorious moment, you're utterly deprived of light and left with the newly-minted bimbo's twat on your lips.  Her thighs muffle the sounds of the high mountains to near nothing, and you find yourself licking without meaning to, lapping  experimentally to see which parts of her slutted-up anatomy will release the strongest gushes of fluids.  Once you prod her clit with your tongue, she cums, drenching your face with harpy-lube.  The blond's thighs lock around you, holding you tight in the bimbo-bitch's snatch to receive her musky baptism.\n\n", false);
	
	Render.text("After a few moments of torrential, slimy output, Sophie's quivering cunt spasms and her legs give out.  She slumps over, ass in the air and utterly exposed as she giggles, \"<i>Like, wow!  You made me cum so hard, " + player.mf("mister","miss") + "!  Can I, like, come home with you?  I don't really want to compete with these bitches and you're super " + player.mf("handsome","hot") + "!  We can have lots of like, sex and stuff!</i>\"\n\n", false);
	
	Render.text("You're a bit taken aback by her reaction, but it makes sense.  The dumb broad is too fucked up to survive without becoming someone's fuck-pet.  She may as well be yours.  She looks back with glossy, hopeful eyes and a pleading, pouty look on her thick lips.  Did they get bigger too?  (She probably gives great head...)\n\n", false);
	
	Render.text("Saying no seems silly... she's so fucking hot now, and you've no doubt she'll be like your personal masturbation toy.  Sophie titters, \"<i>Please please please!  Mmmm, I'll kiss and, like, lick you with my tongue all the time.  Don't say no... I totally need to fuck you!</i>\"\n\n", false);
	
	Render.text("You shake your head, feeling the compulsion picking at your mind.  Damn, she can still try to compel you with her words.  Do you take her home to be your live-in bimbo of choice?", false);
	dynStats("cor", 5);
...
private declineBimboSophie():void {
	...
	Render.text("", true);
	Render.text("You turn and flee the mountain, before she can compel you to take her to camp and fuck like bunnies.  Who knows when you'd have time to explore with a lust-crazed bird-woman like that around.  She'll find a mate soon enough, you're sure of that.\n\n", false);
	cleanupAfterCombat();
}
...
private acceptBimboSophie():void {
	...
	Render.text("You nod, and Sophie springs forward on her powerful legs, the strength undiminished by the effects of her bimbo transformation.  She tackles you in a bear-hug, kissing your " + chestDesc() + " over and over as her momentum carries you both off the side of the mountain.  You tumble in the air, screaming as you fall", false);
	if(player.canFly()) Render.text(" and unable to bring your wings to bear with arms pinning them to your back", false);
	Render.text(".\n\n", false);
	
	Render.text("Sophie looks up and gasps, \"<i>Oh no!</i>\"  Thankfully, the ditz remembers her own wings and spreads them, slowing the descent to a rapid, controlled glide.  You sigh with relief, supported by her arms and legs thousands of feet in the air.  Sophie titters, \"<i>Like, which way should we go, " + player.short + "?  Everything is all funny up here, and I dunno where you live.  We need a place to fuck!</i>\"\n\n", false);
	
	Render.text("You grudgingly direct her glide towards your campsite, and the two of you make good time.  Of course, Sophie's wet, drooling cunny makes an absolute mess of your " + player.armorName + " and " + player.legs() + " during the trip, soaking them with her copious pussy-cream.  She's exhausted and randy once you get to camp, and the landing is quite rough as a result.  You take a nasty tumble in the dirt, but it doesn't damage you significantly.  Sophie appears just as lucky - she's sitting on her plump rump with her legs spread wide, cluelessly scratching at her downy blond feathers.\n\n", false);
	
	Render.text("After a few seconds, the bimbo's dull eyes seem to light up with delight.  \"<i>Oh, is this where you live?  It's wonderful!  Oh, do you, like, sleep over there?  Can I share it with you?  Can we fuck every night?  Oh I've got, like, so many questions!  Umm... which ones did I ask already?  I forget!</i>\"\n\n", false);
	
	Render.text("You sigh and show the bimbo around.  She seems extremely pleased by the arrangements, and once the tour is complete, she prances off to touch up her make-up, though you see her masturbating the whole time.", false);
	
	if (player.statusAffects.has("CampRathazul"))
	{
		Render.text("  Afterwards, she offers to suck Rathazul's cock.  The old rat looked about ready to have a heart attack, but he managed to decline her offer with some amount of dignity, after a few moments of stammering.", false);
	}
	else if (flags[FlagEnum.UNKNOWN_FLAG_NUMBER_00238] == 1)
	{
		Render.text("  Afterwards, she offers to suck Izma's cock.  Izma looks at you for a moment before shaking her head, no.  Her skirt rises visibly in spite of her negative response.  Maybe she'll like having someone lower on the food chain to boss around?", false);
	}
	else if (flags[FlagEnum.AMILY_FOLLOWER] > 0 && flags[FlagEnum.AMILY_BLOCK_COUNTDOWN_BECAUSE_CORRUPTED_JOJO] == 0) 
	{
		Render.text("  Afterwards, she offers to lick Amily's twat, if Amily will do the same to her.  Amily ", false);
		if(flags[FlagEnum.AMILY_FOLLOWER] == 1) Render.text("flushes hotly and denies the bimbo's request with a terse 'no'.", false);
		else Render.text("flushes hotly and wiggles her hips Sophie's way.  The slutty, corrupted mouse and Sophie will clearly be helping to sate each other's needs in your absence.", false);
	}
	else if (monk >= 5 && player.findStatusAffect(StatusAffects.NoJojo) < 0 && flags[FlagEnum.JOJO_DEAD_OR_GONE] == 0)
	{
		Render.text("  Afterwards, she offers to suck Jojo's cock.  The corrupted slut-mouse nods and stiffens in delight, though he keeps glancing back your way.  Those two will probably spend a lot of time together...", false);
	}
	else if (player.statusAffects.has("PureCampJojo"))
	{
		Render.text("  Afterwards, she offers to suck Jojo's cock.  The chaste mouse's jaw drops, but when he picks it up, he answers, \"<i>Never.  My body is as pure as my soul!</i>\"", false);
	}
	else if (kGAMECLASS.isabellaFollowerScene.isabellaFollower())
	{
		Render.text("  Afterwards, she offers to lick Isabella's cunt.  Isabella answers sternly, ");
		if (isabellaAccent()) Render.text("\"<i> Nein!  But you can drink mein milk from time to time.</i>\"");
		else Render.text("“<i>No! But you can still drink my milk from time to time.</i>”");
		Render.text("  The cow-girl is blushing hotly.  You've no doubt after a few nipple-licks she'll be spreading her thick thighs for the bimbo harpy.", false);
	}
	Render.text("\n\n", false);
	Render.text("Well, you know where to find her any time you want to fuck the motherly bimbo.\n<b>(Bimbo Sophie has been added to your slaves!)</b>", false);
	cleanupAfterCombat();
}
//Follower In Camp Text:
public sophieCampLines():void {
	let choice:number = rand(4);
	if(choice == 0)  Render.text("Sophie is sitting by herself, applying yet another layer of glittering lip gloss to her puffy bimbo lips.", false);
	else if(choice == 1) Render.text("Sophie is sitting by herself, idly diddling her twat and noisily moaning.  She keeps looking your way, hoping you'll approach.", false);
	else if(choice == 2) Render.text("The beach-blond harpy is preening herself with a vapid, brainless look plastered on her face.  Her puffy, bee-stung lips are slightly parted and lacquered with a heavy layer of golden gloss.", false);
	else Render.text("Your personal bimbo, Sophie, is playing with her breasts, touching and caressing the heavy orbs in between sighs of pleasure.  She keeps glancing your way, hoping you'll join her.  She's insatiable!", false);
	Render.text("\n\n", false);
}
//Approach Texts
public approachBimboSophieInCamp(output:boolean = true):void {
	...
	else
	{
		if (output)
		{
			...
			Render.text("Sophie emerges from the hen coop and wiggles her way over to you when you call her name.");
	...
	if(flags[FlagEnum.SOPHIE_CAMP_EGG_COUNTDOWN] > 0 && output) Render.text("\n\n<b>Sophie's egg is sitting nearby.</b>");
	...
	if (flags[FlagEnum.FOLLOWER_AT_FARM_SOPHIE] == 0 && !pregnancy.isPregnant && flags[FlagEnum.FARM_CORRUPTION_STARTED] == 1) addButton(1, "Farm Work", sendToFarm);
	if (flags[FlagEnum.FOLLOWER_AT_FARM_SOPHIE] != 0) addButton(1, "Go Camp", backToCamp);
	
	if (flags[FlagEnum.FOLLOWER_AT_FARM_SOPHIE] != 0 && flags[FlagEnum.FOLLOWER_PRODUCTION_SOPHIE] == 0) addButton(2, "Harvest Eggs", harvestEggs);
	if (flags[FlagEnum.FOLLOWER_AT_FARM_SOPHIE] != 0 && flags[FlagEnum.FOLLOWER_PRODUCTION_SOPHIE] == 1) addButton(2, "Change Eggs", changeEggs);
	
	if (flags[FlagEnum.FOLLOWER_AT_FARM_SOPHIE] != 0 && flags[FlagEnum.FOLLOWER_PRODUCTION_SOPHIE] == 1) addButton(3, "Stop Harvest", stopHarvest);
	
	addButton(7, "Appearance", sophieBimboAppearance);

	if (flags[FlagEnum.FOLLOWER_AT_FARM_SOPHIE] == 0) addButton(9, "Leave", camp.campSlavesMenu);
	if (flags[FlagEnum.FOLLOWER_AT_FARM_SOPHIE] != 0) addButton(9, "Back", kGAMECLASS.farm.farmCorruption.rootScene);
}
...
private sophieBimboAppearance():void {
	...
	Render.text("long ");
	if(flags[FlagEnum.UNKNOWN_FLAG_NUMBER_00282] > 0) Render.text("platinum-blond");
	else Render.text("pink");
	Render.text(" 'hair' that dangles off her shoulders, like a bird's plumage.  She wears a thick layer of golden lipstick over her plump");
	if(flags[FlagEnum.UNKNOWN_FLAG_NUMBER_00282] > 0) Render.text(", super-sized");
	Render.text(" lips at all times, like most of her kind, the gloss capable of giving her voice a compelling quality or inducing arousal on contact with males or herms.  Her face lacks the youthful quality found among many of her sisters, though you don't see any of the lines that would indicate age.");
	
	Render.text("\n\nSophie's breasts are ");
	if(flags[FlagEnum.UNKNOWN_FLAG_NUMBER_00282] > 0) Render.text("so immense they would drag her to the ground if she tried to fly, a sexy, lingering aftereffect of the draft you gave her.  The wobbly bimbo-tits look to be about F-cups.");
	else Render.text("unusually large.  The buxom harpy does seem slightly encumbered by them, but still capable of flight.  Her breasts look to be about DD-cups, nice and big enough for a soft squeeze or rough tit-fuck.");
	...
	if (kGAMECLASS.farm.farmCorruption.hasTattoo("sophie"))
	{
		...
		{
			if (kGAMECLASS.farm.farmCorruption.numTattoos("sophie") > 1) Render.text("She has the following tattoos emblazoned across her body:\n");
			else Render.text("She has ");

			if (flags[FlagEnum.SOPHIE_TATTOO_COLLARBONE] != 0) Render.text(flags[FlagEnum.SOPHIE_TATTOO_COLLARBONE] + "\n");
			if (flags[FlagEnum.SOPHIE_TATTOO_SHOULDERS] != 0) Render.text(flags[FlagEnum.SOPHIE_TATTOO_SHOULDERS] + "\n");
			if (flags[FlagEnum.SOPHIE_TATTOO_LOWERBACK] != 0) Render.text(flags[FlagEnum.SOPHIE_TATTOO_LOWERBACK] + "\n");
			if (flags[FlagEnum.SOPHIE_TATTOO_BUTT] != 0) Render.text(flags[FlagEnum.SOPHIE_TATTOO_BUTT] + "\n");
		}
	}
...
private harvestEggs():void
{
	...
	Render.text("You ask Sophie if it’s possible for her to produce eggs of a certain color whilst she’s here.");
...
private changeEggs():void
{
	...
	Render.text("You ask Sophie to change the type of eggs that she is producing for you.");
...
private postEggSelector(selected:string):void
{
	...
	Render.text("“<i>I’ll make some nice " + selected.toLowerCase() + " eggs just for you then, good looking,</i>” she says. “<i>I can only make, like, one once a week, though. All the rest gotta be sold. I’ll put it with the weekly earnings, ok?</i>”");
...
private stopHarvest():void
{
	...
	Render.text("You tell Sophie to stop giving you eggs; you’d rather she’d put them towards making the farm money.");

	if (silly()) Render.text("\n\n“<i>I only wish I had your keenly developed financial acumen and, like, grasp of small scale agricultural supply and demand, babe. Whatever you say!</i>”");
	else Render.text("“<i>I only wish I was good with numbers and things,</i>” Sophie sighs wistfully, picking at her bellybutton. “<i>Then I’d know when to give you my eggs and, and when to give them to the doggie. Whatever you say anyways, babe!</i>”");
...
private sendToFarm():void
{
	...
	Render.text("“<i>I want you to head towards the lake,</i>” you say to your pet bimbo, “<i>and find a farm. You’re to present yourself to th...</i>“ you stop. Sophie is staring at you in complete incomprehension, fingering herself impulsively.");
...
private backToCamp():void
{
	...
	Render.text("You tell her to head back to camp; there are things you need to do to her you can’t do whilst she’s here. Repeatedly. Sophie’s face falls a bit.");
...
private bimboSophieSexMenu():void {
	clearOutput();
	Render.text("How will you have sex with your feather-brained slut?");
	menu();
	...
	if(player.lowerBody.vaginaSpot.hasVagina()) addButton(3,"Get Licked",bimboSophieLicksRugs);
...
private tellSophieToVisitIzma():void {
	clearOutput();
	Render.text("You suggest she visit Izma again.  Maybe this time she won't get tied up again?");
...
public bimboSophieLustStickSurprise():void {
	...
	if(select == 0) {
		sophieSprite();
		Render.text("Sophie flounces into your arms and kisses you on the lips before you can react.  ", false);
		if(!player.lowerBody.cockSpot.hasCock()) {
			Render.text("You smirk and pry the enthusiastic bimbo out of your arms, for now.", false);
			dynStats("lus", 1);
		}
		else {
			Render.text("You shiver, " + sMultiCockDesc() + " growing hard and ready to submit to the feathery blond's love.  Perhaps you'll take care of that soon...", false);
			dynStats("lus", 15);
		}
		...
		sophieSprite();
		Render.text("During an idle moment, you feel heavy breasts squeezing against your back.  Sophie caresses your " + chestDesc() + " and nibbles at your ear.  She asks, \"<i>Can we like, fuck soon, babe?  I've been so wet here all by myself, just stroking my pussy and dreaming of you.</i>\"  You can't help but turn and smile at her, but as soon as you do, she plants a kiss full on your lips.  ", false);
		if(!player.lowerBody.cockSpot.hasCock()) {
			Render.text("Pushing her back, you give her ass a slap and mouth, 'Soon'.", false);
			dynStats("lus", 1);
		}
		else {
			Render.text("Pushing her back, you try not to make contact against her with " + oMultiCockDesc() + ".  Your lips tingle dangerously, and you know you'll be lusting after harpies for at least a few hours.", false);
			dynStats("lus", 15);
		}
		sophieScene.luststickApplication(5);
	}
		...
		sophieSprite();
		if(player.lowerBody.cockSpot.hasCock()) {
			Render.text("While standing there, drinking a sip of water, strong hands pull down your " + player.armorName + ".  Plump lips wrap around " + oMultiCockDesc() + " and smother it in plush, warm slipperiness.  You look down at your bimbo harpy and sigh while " + oMultiCockDesc() + " grows harder in her lips.  She pops off and asks, \"<i>Like, wanna fuck?</i>\"  You sigh and try to resist the images of yourself mounting the harpy that flood your mind.  It might be time to fuck her soon...", false);
			dynStats("lus", 15);
		}
		else {
			dynStats("lus", 10);
			Render.text("While standing there, drinking a sip of water, strong hands pull down your " + player.armorName + ".  Plump lips slide over your ");
			if(player.lowerBody.vaginaSpot.hasVagina()) Render.text("vulva, sucking at your clitoral hood.  Those gold, slobbery pussy-lickers look good on your groin, and you find yourself releasing your wetness from her oral attentions.  It might be time to fuck her soon...", false);
			else Render.text("smooth groin, eventually licking at your [asshole].  Those gold, slobbery lickers look good pressed against you.  It might be time to fuck her soon...", false);
		}
		sophieScene.luststickApplication(5);
	}
	else {
		sophieSprite();
		Render.text("Sophie glides down from atop a rock, landing roughly atop you.  She plants a wet, smacking kiss on you and asks, \"<i>Didja miss me?  I totally missed you!</i>\"  ", false);
		if(player.lowerBody.cockSpot.hasCock()) {
			dynStats("lus", 15);
			Render.text(SMultiCockDesc() + " seems to wiggle inside your " + player.armorName + ".  Damn, she feels really good on you!  Maybe you should screw the slutty bimbo soon?  ", false);
		}
		Render.text("You nod and Sophie gets up, beaming a radiant smile as she prances away, her booty swaying enticingly behind her.", false);
		dynStats("lus", 2);
		sophieScene.luststickApplication(5);
	}
	Render.text("\n", false);
...
internal function daughterCheckup():void {
	...
	if(flags[FlagEnum.SOPHIE_DAUGHTER_MATURITY_COUNTER] > 200) {
		Render.text("Back in the nest, your cute little harpy is still just a little chick.  Her body is small and childlike, and her feathers are fluffy and poofy, making your little girl look like she has puffballs for arms and legs.  Already looking to be four or five years old, the baby harpy is just as energetic as a human child of that age.  She flutters around and scrambles from one thing to another.  Thankfully, the rambunctious little darling runs out of explosive energy quickly, suddenly falling to the ground into a fluffy heap for a quick nap.");
	}
	else if(flags[FlagEnum.SOPHIE_DAUGHTER_MATURITY_COUNTER] > 100) {
		Render.text("Back in the nest, your sweet little harpy is starting to grow up!  Her body is much bigger than it was before, though her baby fat has spread out over her larger form and looks more lean and lanky then the big-butted harpies you're used to seeing.  Her feathers have even started to smooth out, though she is still quite the fluffball.  You're sure that it won't be too long before the curves harpies are known for start to appear.  The energy she exuded as a little chick still drives her to 'terrorize' your camp, scampering around, fluttering from place to place and getting into all kinds of things.  Your fluffy daughter seems to be able to stay active for longer than before, though you still see her curl up for a nap every so often.\n");
	}
	else if(flags[FlagEnum.SOPHIE_DAUGHTER_MATURITY_COUNTER] > 0) {
		Render.text("Looking around for your developing daughter, you find that she and your ");
		if(bimboSophie()) Render.text("boisterous bimbo ");
		else Render.text("matronly harpy ");
		Render.text("are spending some quality mother-daughter time together.  Sophie is helping the young girl with her make up, showing her how to use that golden luststick that her people are so fond of.  You're not too sure how appropriate that is for your daughter, but then again, this is what harpies do, right? Aside from the lusty lipstick, your ");
		if(bimboSophie()) Render.text("live-in bimbo ");
		else Render.text("favorite bird-woman ");
		Render.text("moves on to her hair and nails, all the while gabbing on and on about you, and about all the daughters she plans to have.");
...
public unlockResistance():void {
	...
	Render.text("<b>(Perk Unlocked: Luststick Adapted - your minimum lust is permanently raised, but you are 20% more lust resistant.  In combat, you're immune to it, though it still gives you a rush during sex.  You're also comfortable enough with it to use it like a harpy if you find any.)</b>\n", false);
...
private bimboSophieLicksRugs():void {
	...
	//(ginormous clitties)
		...
		Render.text("\"<i>It's... like, well... big!  Gosh, you're a big girl!  Mmm, you'll cum hard for Momma Sophie while I, like, suck on this fat pole, won't you?</i>\" teases the thick-bootied bird-bitch.\n\n", false);
		Render.text("You shudder as the harpy resumes her oral onslaught, slurping your " + clitDescript() + " deep into her throat in one smooth plunge.  She hums in delight, licking over the feminine fuck-stick's lower portions while she tries to get her fat, soft puss-pillows closer to your juicy snatch.  You rock your hips forward to thrust your " + clitDescript() + " further inside your bimbo's neckhole.  She gurgles happily and lashes at your " + vaginaDescript() + ", her tongue tracing trails of hot, sexual pleasure through your depths as her molten-hot throat milks you like no tomorrow.\n\n", false);
	}
	Render.text("Sophie purrs with desire, and when you hear a distinctive wet squelching coming from something other than your pussy, you realize she's vigorously masturbating.  You crane your head over to get a view of the harpy's frenzied, pumping fingers, watching them disappear into her puffy, lust-reddened lips, as if by magic.  Sophie ", false);
	if(player.lowerBody.vaginaSpot.list[0].clitLength < 3) Render.text("hums on your clit and doubles the speed of her licking while you watch her finger-fucking her sloppy cunt.", false);
	else Render.text("pumps on your clit with her hand and doubles the speed of her lashing tongue while you watch her finger-fucking her sloppy cunt.", false);
	Render.text("  The sight pushes you over the edge in a climax of body-shaking, muscle-locking proportions.  You seize up and ", false);
	if(player.wetness() >= 5) Render.text("squirt", false);
	else if(player.wetness() >= 4) Render.text("gush", false);
	else if(player.wetness() >= 3) Render.text("leak", false);
	else if(player.wetness() >= 2) Render.text("dribble", false);
	else Render.text("drool", false);
	Render.text(" fem-spunk all over Sophie's face, marking the bimbo with your love.  The horny harpy seems to be getting off on it as well, as she's moaning luridly into your labia, letting the fluid bubble up and muffle her outbursts.\n\n", false);
	
	Render.text("You both fall back, winded, gasping, and a little delirious from the encounter.  The entirely of your groin is covered in a gold coating, shining with the harpy's lipstick and your own feminine moisture.  In a way, the sight is oddly entrancing.  Your " + vaginaDescript() + " glitters in the light while the harpy's overly-thick lipstick sinks into your skin, filling your body with drugs designed to stimulate males.  ", false);
	if(!player.lowerBody.cockSpot.hasCock()) Render.text("  It's a good thing you don't have a penis!", false);
	else Render.text("You groan as your groin burns with desire, filling your " + multiCockDescriptLight() + " with blood.  Images of yourself relentlessly fucking your bimbo bride pregnant over and over again fill your mind.  You shudder and blush, trying to resist the artificial needs pounding through your body, but you realize your body is ready.", false);
	Render.text("\n\n", false);
	
	Render.text("The ditzy blond giggles and tweaks her hefty nipples, cooing, \"<i>That was absolutely yummy!  Your puss is like, totally tasty.  Let's go again!</i>\"  You feel a little fucked out after the fantastic oral, and you decline.\n\n", false);
	
	Render.text("Sophie retorts, \"<i>But I wanna fuck nooooooowwww!</i>\"  She pouts, sticking out her lower lip and saying, \"<i>Come on... look at my pussy... just look at it.  Can't you, like, see how fucking wet you've gotten me?  You know you wanna lick me... your tongue TOOOTALLY wants to taste my sweet honey-pot!</i>\"  The harpy spreads her legs so wide she's nearly doing a split, pulling her pussy-lips apart to show you just how wet you've made the puffy, pink entrance.  You've got to admit... it does look really nice.  Her words seem... heavy somehow, like they have an extra weight behind them.  You have a hard time finding fault with her logic - she sure would taste good right about now...\n\n", false);
	
	Render.text("\"<i>Please?  I'll make you feel just as good as last time, maybe more.  Look at me, at my lips, would they lie to you?  I bet they'd feel soooo good back on your hot, wet cunny", false);
	if(player.lowerBody.cockSpot.hasCock()) Render.text(", or thick, juicy dick", false);
	Render.text(".  Come over here and sixty-nine me, baby!</i>\" cheers Sophie with a wiggle of her considerable hips.  Damn, her lips are sooo plump and sexy, and that ass - gods she's getting you wet ", false);
	if(player.lowerBody.cockSpot.hasCock()) Render.text("and hard ", false);
	Render.text("again!  You want to tackle her onto the ground and smash your crotch into her face!  Fuck, is she trying to use her compulsion on you? It's working!\n\n", false);
	player.orgasm();
	dynStats("sen", -1);
	sophieScene.luststickApplication(4);
	if(player.stats.int * 2 < player.stats.cor + player.stats.lib) {
		Render.text("There's no way you could ever turn her down at this point... just look at her lips... they'd never lie to you.  It'll feel so good...", false);
...
private bimboSophieSixtyNineAfterCunnilingus():void {
	...
	if(!player.lowerBody.cockSpot.hasCock() || player.cockThatFits(sophieCapacity()) == -1) {
		Render.text("You throw yourself at Sophie, compelled by thoughts of pleasure and her delicious-looking pussy, wanting nothing more than to place your lips on her cunt and slurp with reckless abandon.  She takes the hit like a champ, tumbling with you through the dirt and dust until you land on your " + buttDescript() + ", bouncing to a stop with the harpy's feathery thighs clenching around your head.  ");
		if (pregnancy.event >= 2) Render.text("Her pregnant belly rests against your middle, untouched by the rough fall.  ");
		Render.text("How did she do that?  Your questions fade away as you look up and spot your target - the cum-slicked delta of Sophie's cunt, so moist it seems to fog the air, beckoning you to plunge your tongue inside and taste it.\n\n", false);
		
		Render.text("With rapacious desire, you grab the harpy's down-coated ass-cheeks and squeeze her plump rump, pulling her dripping cooch straight onto your face.  You shiver at the potent, womanly smell as it oozes over your " + player.face() + ", and dribbles down your chin.  Without a moment's hesitation, you take the first long lick of Sophie's tasty juices.  They have a tangy flavor that seems to sizzle on your tongue before fading into a soft, sweet, peach-like taste.  You hum in pleasure - the harpy was right; your tongue REALLY wants to taste her.\n\n", false);
	
		Render.text("\"<i>Wow! You're so good at pussy-licking, babe,</i>\" declares Sophie, pursing her lips slowly and deliberately as she enunciates the rest of her statement, \"<i>Your tongue just can't get enough harpy pussy!  Ooooh yeah, you're totally the best cunny-licker I've like, ever had munch on my box!  Mmm, you love Momma Sophie's girl-cum, dontcha?  Yea-ah... lick lick lick!</i>\"  She giggles inarticulately after that, swiveling her hips to smear her leaking vagina all over your face.  You cram your " + player.face() + " further up Sophie's creamy quim and lick over and over, curling your tongue into every delicious nook and fold.\n\n", false);
	
		Render.text("Sophie drops down onto her elbows, her ass-length blond plumage tickling at your " + player.legs() + " as she examines your groin.  The slutty harpy leans over your gold-smeared crotch and gives your " + clitDescript() + " a kiss, her plush lips smothering the ", false);
		if(player.lowerBody.vaginaSpot.list[0].clitLength < 1) Render.text("tiny ", false);
		Render.text("organ in warm, oral bliss.  You moan into her sumptuous pussy and giggle when the vibrations set off a cascade of harpy cum.  Inspired, you begin to hum with every lick, the sound carrying up from your voice-box to turn your tongue into the bimbo's new vibrator.\n\n", false);
		
		Render.text("The two of you attack each other's pussies in a frenzy of wanton need, slurping and moaning so loudly that the noise is likely carried a hundred yards away.  Sophie's pussy seems to grow even more delectable with every touch to your taste buds, if such a thing is possible.  Your moronic mate seems equally infatuated with your pussy, and she sucks your clit", false);
		if(player.lowerBody.vaginaSpot.list[0].clitLength >= 3) Render.text(", even pausing to jack it off like a penis", false);
		Render.text(" with hasty, need-filled strokes.  Eyes crossing, you suck and lick, swallowing great mouthfuls of bimbo-jizz in your haste to bring off the harpy.\n\n", false);
		
		Render.text("Sophie parts her silken lips from your gold-glazed groin with a moist *pop*.  \"<i>You're totally great at licking pussy, babe!  Mmmmhmmm, just, like, keep doing it like that.  You'll mmm-make Momma Sophie cum in no time!  Make me cum, baby!  Oooh, does trying to make cum make you hot for my pussy?  You're gonna cum... I know it... you'll cum with me,</i>\" utters the bimbo bitch while she stirs your pussy with a finger, stroking around it and dragging her long nails over the sensitive flesh of your loins.  Her words hit you like a wave, and with renewed vigor, you thrust your entire tongue deep inside the harpy and rub your lower lip back and forth across her pleasure-bud.  Pulling hard on her hips, you orally ravage her cunt with no regard for anything around yourself, your body burning hot from how good it feels to get your pet off.\n\n", false);
	
		Render.text("At long last, the bimbo's bald cunt climaxes from your work, splattering you with a flood of musky girl-spunk.  You still need her pussy so bad that you can't stop.  You lick, lap, and swallow with inhuman eagerness until the box atop you is emptied of everything save your saliva.  Then, and only then, do you finally feel release.  Your " + vaginaDescript() + " climaxes for Sophie, soaking her fingers and wringing them as if your life depended on it.  She giggles, coming down from her own orgasm and feeling quite pleased with the effects her words have had on you.\n\n", false);
		
		Render.text("The harpy gets up, but only long enough to turn around and lay atop you, face to face");
		if (pregnancy.event >= 2) Render.text(", egg-swollen belly smushing between you");
		Render.text(".  \"<i>That was sooo fun!  Like, we'll totally do this sometime soon, but I need a drink, and you smell like pussy.  Mmmm, I like that smell.  It means fun stuff!</i>\"  Sophie kisses you full on the mouth, her puffy, quim-stained lips coloring your own with her amber lipstick.  \"<i>You're like, the best pussy-licker ever, ya know?</i>\"\n\n", false);
		
		Render.text("Sophie struts off, touching a finger to her cunt before licking it, tasting the remnants of your saliva.", false);
		sophieScene.luststickApplication(5);
		player.orgasm();
		dynStats("sen", -1);
	}
	//SixtyNine Continuation - DUDES
		...
		if (pregnancy.event >= 2) Render.text("Her gravid belly bumps up against your own, somehow untouched by the rough-and-tumble fall.  ");
		Render.text("How did she do that?  Your questions fade away as you look up and spot your target - the cum-slicked delta of Sophie's cunt, so moist it seems to fog the air, beckoning you to plunge your tongue inside and taste it.\n\n", false);
...
private buttFuckBimboSophie():void {
	...
	let x:number = player.cockThatFits(sophieCapacity());
	if(x < 0) x = player.smallestCockIndex();
	Render.text("You instruct your bimbo bitch to bend over and show you that rounded rump that you keep her around for.  She leans away from you, her ass high in the air with tail feathers fluffing, and she cluelessly asks, \"<i>Ummm, like this, babe? Or this?</i>\"\n\n", false);
	
	Render.text("The bimbo bounces her backside back and forth, making her heavy cheeks jiggle a few inches away from you.  Winking between them, Sophie's puckered anal star and juicy, dripping pussy seem to beckon for your " + multiCockDescriptLight() + ", but you just watch for now, enjoying the sight of such a gorgeous ass jiggling and shaking for you.  After a moment she asks, \"<i>Or did you mean like this?</i>\"  The harpie flexes her thighs and begins to bounce her ass up and down to a vigorous, butt-shaking rhythm no one but your slut can seem to hear.  Your eyes sway up and down, following the glorious, heart-shaped mass on its ballistic trajectory while " + sMultiCockDesc() + " becomes hard and completely ready to claim that bouncy butt.\n\n", false);
	
	Render.text("Stepping closer, you toss off your " + player.armorName + " and reply, \"<i>Yes, just like that.</i>\"\n\n", false);
	
	Render.text("Sophie claps her hands and gives a girlish squeal of happiness. \"<i>Really?  C-can I like, do this a little closer?  ", false);
	if(player.lowerBody.cockSpot.count() > 1) Render.text("Those cocks look", false);
	else Render.text("That cock looks", false);
	Render.text(" delic... de... yummy!</i>\"  You slap her ass, grab her tail feathers, and pull the harpy's winking asshole down onto your " + cockDescript(x) + ". Her voices rises, not in anger, but in delight, and your " + player.cockHead(x) + " pulses pleasantly in the first few inches of the harpy's rectum.  The bimbo relaxes and sinks down, giggling and asking, \"<i>Is-ooh-is my butt, like, good for you?  It's soooo tight, and it's making my cunny all wet and stuff!</i>\"\n\n", false);
	
	Render.text("You squeeze her shuddering rump hard enough to feel her flesh bulging out around your fingers, the soft cheeks nearly subsuming your hands, and then you pull her hard, dragging your " + cockDescript(x) + " the rest of the way inside her, all the way to the ", false);
	if(!player.lowerBody.cockSpot.hasSheath()) Render.text("hilt", false);
	else Render.text("sheath", false);
	Render.text(".  Sophie's breasts sway underneath her, the pendulous globes occasionally dipping low enough to drag her thumb-sized nipples through the rough dirt.");
	if (pregnancy.event >= 2) Render.text("  Just like her breasts, her gravid tummy sways a little as well, plush with the weight of the egg you've given her.");
	Render.text("  The bimbo moans harder every time it happens and sounds more whorish and lurid with each passing second - a true anal slut.  She looks back at you with lust in her eyes and a gleeful grin on her face.  Suddenly, one of the ditz's fingernails is dragging ", false);
	if(player.lowerBody.balls > 0) Render.text("over your " + ballsDescriptLight(), false);
	else Render.text("across your taint", false);
	Render.text(".  It works its way down, crosses the joining of your bodies, and reaches its owner's pussy, circling the puffy lips until a long strand of girl-goo is dangling down towards the ground.\n\n", false);
	
	Render.text("\"<i>So... good.  Why didn't anyone tell me that butt-sex is like, super-duper fun?</i>\"  The breathless bimbo rocks her ass back and forth, and you let her have her 'fun'.  She's wiggling and squirming, impaled on a cock and loving it.  You simply relax and let her go to town, the bimbo's fingers running through her sodden box in time with the butt-jiggling contortions of her body.  Her anus milks your " + cockDescript(x) + " like a machine, drawing out thick streamers of pre-cum to make her ass almost as sloppy as her pussy.  It's hard to stand still with her working you so efficiently, and after a few moments of allowing your bimbo to pleasure you with her plump rump, you tire of waiting.\n\n", false);
	
	Render.text("Pushing her away, you unsheath most of your " + num2Text(Math.round(player.lowerBody.cockSpot.list[x].cockLength)) + " inches from Sophie's stretched asshole, leaving just your " + player.cockHead(x) + " to hold the rectal portal open.  She whines in disappointment until you lunge forward and stuff her full of dick so suddenly that she squirts dribbles of lube.  You grab her hair with one hand and ride her ass hard and fast, each thrust punctuated by happy squeals of submissive pleasure from your airheaded anal toy.  Sophie cheers, \"<i>Fuck me " + player.mf("stud","babe") + ", fuck my ass!  Unh, y-yeah like that.  Mmmm, yeah, pull my hair and tell me what a bad girl I've been!</i>\"\n\n", false);
	
	Render.text("Gods, she's such a naughty little bird bitch!  You yank her hair back and lean over her shoulder, whispering, \"<i>You like that, you brain-dead bimbo?  Look down at all the juices raining from your cunt.  Would anyone but a horny slut get off so hard from having her ass reamed?  I don't think so.</i>\"\n\n", false);
	
	Render.text("You keep butt-fucking her hard and fast, ignoring the sprinkles of sticky, maternal harpy-juice that splatter on your " + player.legs() + " as you fuck her.  In between throaty moans and screams, she bellows out \"<i>YES!</i>\" as loudly as possible, then lapses into quiet, exhausted grunts.  Yet, her vagina does not stop its prodigious leaking; if anything it's dripping and squirting out even heavier flows of submissive girl-spooge.  The harpie's anal ring is convulsing around you, reduced to pointless trembling from the hard fucking you're giving her.  Looking back with lidded eyes, she begs, \"<i>C-cum... cum in my ass... it'll... it'll feel soo good, babe.  Please?  Like, gimme your spooge!</i>\"\n\n", false);
	
	if(player.lowerBody.balls > 0) Render.text("Your balls seize up at Sophie's request, and you swear you can actually hear the fluid churning and sloshing of your cum before it burns a path of warmth through your body.", false);
	else Render.text("Your insides seem to seize up at Sophie's request, and you swear you can actually feel the fluid churning a path of warmth through your body.", false);
	Render.text("  Seed spews from your " + cockDescript(x) + " into your bimbo's blubbery bottom with an audible gurgle that brings a blush to her cheek.  You pull her hair harder and bounce your " + hipDescript() + " off her bottom a few times, injecting the rest of your cum inside her while you rut at her now-sloppy anus.", false);
	if(player.cumQ() >= 500) {
		Render.text("  Even though your semen is frothing and spurting from between her cheeks with each push, you keep at it", false);
		if(player.cumQ() >= 1000) Render.text(", filling her belly with spooge", false);
		Render.text(".", false);
	}
	Render.text("  With a few final clenches of pleasure, your dick's flow of cum trickles down to a dribble.  You sigh and muse that you must've completely emptied your " + ballsDescriptLight() + " by now, and you slump back against a rock to watch your jizz flood out of Sophie's ass.  She pushes some inside her pink nether-lips with a triumphant smile, clearly pleased with herself.\n\n", false);
	
	Render.text("Still full of energy, the big-tittied ditz bounces around and catches the cum as it drains from her gaped ass, shoving more and more into her soaked quim.  She even licks her fingers once she bores of that and says, \"<i>Thanks for making my asshole so creamy!  You even left me enough to like, stuff up my twat so I can have an egg!  Yay!</i>\"\n\n", false);
	if (pregnancy.event >= 2) {
		Render.text("Sophie giggles again, rubbing her already well-filled belly and winking at you, like you're sharing in some absurd joke.  You roll your eyes - bimbos!");
	}
...
private fuckBimboSophiesTits():void {
	...
	let x:number = player.cockThatFits(sophieCapacity());
	if(x < 0) x = player.smallestCockIndex();
	Render.text("You grab Sophie's tits in a squeezing grip and pull her towards you, flicking your thumbs across the bimbo's nipples.  She stumbles toward you and purrs, \"<i>Who's being forward now, huh?  If you wanted to play with Momma Sophie's tits, all you had to do was, like, ask!</i>\"\n\n", false);
	
	Render.text("The harpy grabs at your " + player.armorName + " and removes it, leaving your hands free to continue the fondling of her breasts.  Once you're as a nude as your salacious slut, you finally release the huge, watermelon-like breasts and admire your handiwork.  Sophie's ditzy, empty eyes are dilated, her mouth is open and drooling, and her nipples are easily as big as your thumbs.  She's panting softly and just staring at you with her eyes glazed.  You can only assume that her simple mind has slipped into some kind of erotic trance, but if anything it only makes the idea of releasing yourself with her big, soft mammaries that much more appealing.\n\n", false);
	
	Render.text("You grab hold of her nipples and sit down on a nearby rock; the dazed harpy is pulled onto her knees.  ");
	if (pregnancy.event >= 2) Render.text("Her swollen tummy pushes against your [legs] as she assumes the position, the weighty egg-distorted lump pressing against you.  ");
	Render.text("She wobbles forward and her massive mounds easily slide to either side of " + oMultiCockDesc() + ", completely engulfing it.  Still holding on to her nipples, you pull them together and ", false);
	if(player.lowerBody.cockSpot.list[x].cockThickness < 8) Render.text("completely surround yourself", false);
	else Render.text("surround as much of yourself as possible", false);
	Render.text(" in warm, smooth skin.  The smell of your " + cockDescript(x) + " mere inches from her nose seems to startle Sophie from her trance, and she breaks into a smile so big you'll worry it'll break her face.\n\n", false);
	
	Render.text("\"<i>Wh-what's going o-mmmmmm, that looks nice!  Oooh, and it's already in Momma Sophie's big ol' titties!  Yay!  Like, do you mind if I give it a kiss?</i>\" asks the bimbo with a cross-eyed, dick-addicted look on her face.  You nod your assent and lean back, feeling quite pleased with how this is working out.\n\n", false);
	
	Render.text("Suddenly, Sophie's puckered lips are on your " + player.cockHead(x) + ", sucking it softly while her tongue tickles the sensitive slit of your urethra.  She pops off for a breath with a lusty look in her eyes and spit drooling from the corner of her puffy lips to lubricate her tits.  A golden lip print sits around the circumference of your " + cockDescript(x) + ", marking just how much she's managed to smother in oral pleasure.  Pulling her hands up, she presses her palms into the heavy weight of her breasts, nearly vanishing from view as she drags them up your " + num2Text(Math.round(player.lowerBody.cockSpot.list[x].cockLength)) + "-inch length.  Her drugged lipstick makes your " + player.cockHead(x) + " tingle deliciously, and you sigh, happy to have such glorious udders growing from your bleach-blonde bitch.\n\n", false);

	Render.text("Full, slippery lips slide back around you again, further staining your " + cockDescript(x) + " in their amber gloss.  It's enough to make you swoon and flare, growing thicker inside her smothering mounds while she pumps at you with her tits.  Sophie croons in between sucking on your dick-tip, saying, \"<i>Mmm, such a yummy cock!  Let my tits like, milk out all that yummy cum from your cock, okay babe?</i>\"\n\n", false);
	
	Render.text("You demur and start pumping your hips.  The bimbo shakes her platinum-blonde feathers in irritation, but she doesn't dare stop you now.  You grab her tits as well, lifting them out of her grip as you begin to fuck them in earnest, your cock cresting through the massive cleavage with each stroke.  Sophie smiles dopily, rapidly forgetting her unhappiness at being so thoroughly manhandled, and she returns to worshipping your " + player.cockHead(x) + " each time it comes anywhere near her mouth.  Spit and golden lipstick drool down her cleavage, and soon your rod looks like a golden spear of lust, trembling in the pale valleys of your bimbo slut's mountainous peaks.\n\n", false);
	
	Render.text("Closing your eyes, you revel in bliss, utterly satisfied by the surging pleasure of having your cock smothered in fertility-enhancing drugs while it's tit-fucking a motherly harpy's giant breasts.  A simple, breathy voice begs, \"<i>Please cum for me... let out all of that fun stuff on my titties and slutty, cock-slurping lips.  Like, paint me with your seed, I wanna be your fat-bottomed harpy slut!</i>\"\n\n", false);
	
	Render.text("One of the dumb blonde's hands circles under her bouncing, jiggling chest to stroke your " + cockDescript(x) + ", jacking you off with the spit, sweat, and drugged gloss as lubricants.  She jerks you hard and fast, smearing it ", false);
	if(player.lowerBody.balls > 0) Render.text("all over your balls whenever she needs a break, and you feel your " + ballsDescriptLight() + " growing heavier by the moment.", false);
	else Render.text("all over your taint and asshole, and you feel your body churning, building up more seed for your moronic mate.", false);
	Render.text("  " + SMultiCockDesc() + " thickens and bloats, a rush of warmth rushing up the base as your internal muscles clench tight, squeezing out a globby rope of jism.  It explodes from your cum-slit, taking Sophie full on the face.\n\n", false);
	
	Render.text("You're just getting started.  Sophie smirks and opens her mouth, letting her tongue slide out to taste your jizm as you launch the next rope, so long it trails from her hair to her chin and so thick it rolls in drops from the side of her face.  She hums in delight and squeezes her breasts tight around your " + cockDescript(x) + ", the next blast backing up inside you from the pressure.  A moment of buildup later, and your seed germinates and blooms over the harpy's tits, soaking them with spunk.  Droplets of the stuff splatter onto the ground around the both of you, but you just keep coming.  In your mind you have visions of yourself knocking up harpy after harpy, the slutty bird-girls mounting your fountaining fuck-stick long enough for their bellies to bloat with seed before moving on.  Like this, you could inseminate a whole tribe...\n\n", false);
	
	Render.text("Once the thought passes, you sag back, utterly spent and more than a little parched.  Blinking the haze from your eyes, you look over at Sophie.  She's on her back, frigging herself non-stop and utterly lost to the world.  Her pretty blonde hair is plastered against her, her boobs are covered in a thick layer of white, ");
	if (pregnancy.event >= 2) Render.text("her swollen midriff is glazed, ");
	Render.text("and her eyes are closed, held shut by a thick layer of your sperm.  She's been well and truly bukkaked, drenched in ejaculate, and judging by how furiously she's schlicking away at her pussy, she couldn't be happier.  As for you, " + sMultiCockDesc() + " is still erect, even though you feel like you don't have a drop left in you.  Of course, the drugs soaking into your gold-tinted cock will probably keep you hard and ready to breed for hours.\n\n", false);
	sophieScene.luststickApplication(5);
	player.orgasm();
	dynStats("sen", -1);
	doNext(camp.returnToCampUseOneHour);
...
private rideDatSophieVag(nice:boolean = false):void {
	...
	if(nice) {
		Render.text("Before you can decide what, exactly, you're going to do with your harpy slut, Sophie jiggles her way over to you, the insides of her thighs dripping with every step.  You watch as the plump bird wobbles, too aroused and too damn big to walk straight, but eventually she does manage to make it to you.");
		if (pregnancy.event >= 2) Render.text("  Her pregnancy-imbued middle doesn't really help, either.");
		...
		Render.text(" in your [armor] - and starts to finger herself as she watches to see what you'll do, her wet folds easily parting for her randy, exploring fingers.");
		...
		if(player.lowerBody.balls > 0) Render.text("your [balls] bouncing and slapping against what parts of Sophie's bubble butt they can reach, ");
		Render.text("and you start to grunt and moan with each movement of your hips as you get close.  Sophie picks up on it as well, her eyes lighting up as she drools, and her back-rubbing arms pull you against her.");
	...
	if(player.lowerBody.cockSpot.count() == 1) {
		...
		//{if (cocks >= 2) and (cumHigh = true)} 
			...
			if(player.lowerBody.cockSpot.count() == 3) Render.text(", along with your third length, spittling and spraying onto her belly.");
			else if(player.lowerBody.cockSpot.count() > 3) Render.text(", along with the rest of your cocks, your entire mass of lengths getting your seed all over her.");
			if(player.lowerBody.cockSpot.count() == 2) Render.text(".");
			Render.text("  Sophie shudders and sighs, rubbing your [hair] with her hand, and you hear her breathe a \"<i>Thank you...</i>\"");
		}		
	...
	if(player.lowerBody.vaginaSpot.hasVagina()) {
		...
		else Render.text("dripping and drooling ");
		Render.text("with its own juices; you barely notice it over the orgasm from your male half, but, as you readjust your position, the slickness dripping down your thighs is unmistakable.");
	}
	...
	if (pregnancy.event >= 2) Render.text("resting your head on her gravid tummy and smiling to yourself.");
	else Render.text("hugging her tight as she tries her best to show her appreciation.");
	if(sophieIsInSeason()) sophiePregChance();
	player.orgasm();
...
private sophieImpregnationSex():void {
	...
	clearOutput();
	sophieSprite();
	Render.text("Hurriedly undressing, you realize she's right- you really do want to slide [oneCock] through that gilded entrance and cum until she's completely and utterly impregnated.  Deliciously, your [armor] tugs [eachCock] down, then in a moment of pure, unadulterated release, your tip");
	if(player.lowerBody.cockSpot.count() > 1) Render.text("s come");
	else Render.text(" comes");
	Render.text(" free of the offending garment's edge and snap");
	if(player.lowerBody.cockSpot.count() == 1) Render.text("s");
	Render.text(" up, proud and erect.  ");
	if(player.lowerBody.cockSpot.count() == 1) Render.text("It wobbles");
	else Render.text("They wobble");
	Render.text(", ");
	if(player.lowerBody.cockSpot.count() > 1) Render.text("each ");
	Render.text("bouncing up and down.  Sophie's eyes never leave the bobbing erection");
	if(player.lowerBody.cockSpot.count() > 1) Render.text("s");
	Render.text(".  She seems in a complete cock-trance, licking her glossy make-up soaked lips without meaning to.  You grab hold of ");
	if(player.lowerBody.cockSpot.count() > 1) Render.text("one of your lengths");
	else Render.text("your length");
	Render.text(" and shake ");
	if(player.lowerBody.cockSpot.count() == 1) Render.text("it");
	else Render.text("them");
	Render.text(", startling the dazed bimbo from her vacuous stare.");
	...
	if(player.lowerBody.cockSpot.count() > 1) {
		Render.text(", and the extra");
		if(player.lowerBody.cockSpot.count() > 2) Render.text("s between her thighs are");
		else Render.text(" between her thighs is");
		Render.text(" likewise in heaven, slowly gathering more of the drug as some of it drips down with the tide of her vaginal juices");
	}
	Render.text(".  Sophie cums repeatedly around you, wiggling her butt in circular motions in between each orgasm to spur you on.  It works.  Her cunt is like a cock-vacuum - no matter how you move, it sucks you back inside, to a heaven of pleasure that you can no longer resist, or care to.");
	...
	Render.text(" with the onset of your release");
	if(player.lowerBody.balls > 0) Render.text(", and your [balls] begin to rhythmically pulse in your [sack]");
	else Render.text(", something inside you begins to clench rhythmically");
	Render.text(".  Sophie's pussy stretches around your increasing thickness, dripping its amber honey");
	if(player.lowerBody.cockSpot.count() > 1) Render.text(" over your extra, thigh slapping cock");
	if(player.lowerBody.cockSpot.count() > 2) Render.text("s");
	Render.text(".  Responding, the warm ecstasy inside you rushes out in a tremendous spurt, squirting globs of thick white cum into the harpy's receptive cunt again and again.");
	if(player.lowerBody.cockSpot.count() > 1) Render.text("  Ropes of creamy spunk drizzle over the ground and the underside of Sophie's tits, but the lust-drunk harpy doesn't seem to mind any more than you do.");
	Render.text("  Her hungry twat drinks down the seed with gusto, drawing it out of you even as it milks you for more.");
	if(player.cumQ() >= 500) Render.text("  You give her exactly what she wants, drowning her pussy with jism.");
	if(player.cumQ() >= 1000) Render.text("  Alabaster spooge oozes out of her lips after you stuff her womb full, dripping down your [legs] and her own feathery thighs.");
	if(player.cumQ() >= 2000) Render.text("  The ground quickly becomes a salty quagmire that Sophie's hands are sinking into.");
	if(player.cumQ() >= 5000) Render.text("  Soon, those droplets become thick gouts, as your immense virility asserts itself.  You hold her there, letting her belly balloon underneath you as you forcefully inseminate her, flooding her with hot seed.");
	...
	if(player.lowerBody.cockSpot.count() > 1) {
		Render.text("  Her thighs seem almost sad to let your extra manhood");
		if(player.lowerBody.cockSpot.count() > 2) Render.text("s");
		Render.text(" escape as well.");
	}
	if(player.hasKnot(x)) Render.text("  The thickness of your swollen, canine knot makes pulling out harder than you thought, and you wind up rocking back and forth while you keep drizzling into her, letting the engorged mass deflate slowly as you fill her womb further with canine seed.  Eventually, with a wet 'POP', you're freed, leaving Sophie nice and gaped, like a good, well-bred bitch.");
	else Render.text("  You slip out with a lurid 'schluuuuck', leaving Sophie a nice messy, well-fucked wreck of a harpy.");
	Render.text("  Sophie shudders, confused eyes looking back at you.  She whimpers, \"<i>Noooo, fuck me again!</i>\"");
	...
	if(y >= 0) Render.text("  A sinful tightness clenches your " + cockDescript(y) + " at the same time.  You accidently started double penetrating her!  The sloppy vaginal heat around your second member is enough to make you forget that it was even an accident.");
	Render.text("  You push on, reveling in the tight clenching of her anal ring as it passes over every inch of cock, squeezing you like a slippery cock-ring as you nestle deeper into the harpy's plump bottom");
	if(player.cumQ() >= 1000) Render.text(" and sperm-oozing pussy");
	Render.text(".");
	...
	if(y >= 0) Render.text(" and pussy");
	Render.text(" with confident, sure strokes.  Your answer, never spoken aloud, becomes evident by your actions: she got you this horny, and you're going to impregnate every hole, no matter how long it takes.  Her asshole is tight, almost <i>too tight</i> after having experienced her pussy, and you can feel the next batch of cum already beginning to churn in your [balls], a heavy, warm weight growing larger and larger.");
	...
	Render.text(" revealed briefly to the cold air before ");
	if(y < 0) Render.text("it's ");
	else Render.text("they're ");
	Render.text("devoured by the hot, enveloping anal entrance ");
	if(y >= 0) Render.text("and squeezing pussy ");
	Render.text("all over again.");
	...
	if(player.tallness >= 74) Render.text("nipping her ear");
	else if(player.tallness >= 60) Render.text("nipping at her shoulder");
	else Render.text("nipping at her side");
	Render.text(" as you answer, \"<i>Yes.</i>\"  Her breasts feel softer than her pillowy buttcheeks, which even now are squishingly running over your hips and [legs], smothering you in soft warmth while her innards milk your member");
	if(y >= 0) Render.text("s");
	Render.text(".  You roughly squeeze her breasts, too focused on the climax slowly building within your compressed crotches to be gentle.  Her breasts bounce and jiggle around your ministrations.  Her nipples, hard as lead bullets, are like magnets for your exploratory fingertips, and soon you lock onto them, squeezing and tugging, kneading them with each bounce for encouragement.  Sophie screeches as she bottoms out, pushing herself back against you, noisily cumming, her juices ");
	if(y < 0) Render.text("spraying across your [legs]");
	else Render.text("running down your " + cockDescript(y) + " in miniature rivers");
	Render.text(" messily.  The explosion of sloppy lady-spunk accompanies convulsive anal clenching, and with a hard pinch on her nipples, you give yourself over to the unnatural lusts coursing through your bloodstream again.");
	...
	if(y >= 0) Render.text("s");
	Render.text(".  She wraps her arms behind herself to hold onto you affectionately.  Again and again, you blast rope after rope of spunk into her plush heiny.  ");
	if(y >= 0) {
		Render.text("At the same time, you make her cunt even creamier");
		if(player.cumQ() >= 1000) Render.text(" and her belly even more distended");
		Render.text(".  ");
	}
	Render.text("There's no stopping your orgasm - it may even be more potent, more virile than the one before!  Sophie simply rides it out, gushing her girlspunk out all over you.");
	if(player.cumQ() >= 500) {
		Render.text("  Her gut rumbles as you fill more and more of her intestines, eventually ");
		if(player.cumQ() < 1000) Render.text("giving her a");
		else Render.text("adding to her visible");
		Render.text(" cum-paunch.");
		if(player.cumQ() >= 1500) {
			Render.text("  Soon, the cum is squirting out around you");
			if(player.hasKnot(x)) Render.text("r knot");
			Render.text(".  You've filled every inch of her intestines with cum, and there's simply nowhere for your fresh, virile squirts to go but out!");
		}
	}
	Render.text("  The harpy goes limp in your arms, still dribbling from her cunt as you continue to sate yourself on her rump and nipples.");
...
private giantCocksImpregnateSophie():void {
	...
	if(player.lowerBody.balls > 0) Render.text("in those plump balls of yours");
	else Render.text("inside you");
	Render.text(", just waiting to squirt out!</i>\"  She says it as more a statement of fact than anything else, using that oddly hypnotic, sing-songish voice that seems to reach right inside you.  The cum really <b>does</b> seem to be sloshing around inside you, and as your heart beats faster in your chest, your ardor for the well-endowed harpy grows.  Sophie rubs her soft palm along the underside, right on the meatus your urethra makes as she continues in that strange tone, \"<i>You're <b>soooo</b> hard, and full.  It's making your cock more...</i>\" She plants another wet kiss on you, this time on your " + player.cockHead(x) + ".  \"<i>...and more sensitive.  <b>So</b> sensitive, like just me rubbing my finger on you is as good as fucking a cunt, right?</i>\"");
	...
	if(player.cumQ() >= 500) Render.text("  In no time, Sophie's belly begins to form into a bump, and the pressure leaves more and more of your seed to be wasted on the bimbo's thighs.");
	if(player.cumQ() >= 1000) Render.text("  Your intense ejaculations quickly balloon that petite bump into a rounded dome.  Torrents of spunk run out of her around your tip, fountaining slightly with each fresh dose.  You simply can't pack any more cum into her, and the excess puddles around her plush bottom.");
...
public sophieMoveInAttempt():void {
	...
	Render.text("Sophie approaches you with a particularly somber expression on her normally vapid face, pressing her index fingers together nervously.  Her walk, normally exaggerated and sexual, is meek and diminished as she makes her way forward.  You cock your head to the side, looking at her curiously.");
...
private yesSophieSleepWith():void {
	clearOutput();
	sophieSprite();
	Render.text("Sophie claps her hands excitedly when you give your assent, immediately launching into a hug that presses her ");
	switch (pregnancy.event) {
		case 1: Render.text("burgeoning"); break;
		case 2: Render.text("swollen"); break;
		case 3:
		case 4: Render.text("huge, gravid"); break;
		default: Render.text("taut");
		
	}
	Render.text(" midriff and cushiony tits against you.  \"<i>You're awesome, [name], you know that?  You're totally " + player.mf("hunky","cute") + " AND awesome!</i>\"  She spins about, dancing happily and shaking her voluptuous backside in your direction as she goes.");
...
private moveSophieInRepeat():void {
	clearOutput();
	sophieSprite();
	Render.text("You go up to the feathery bimbo and idly question if she still wants to share your bed with you");
	if (!pregnancy.isPregnant) Render.text(" even though she's not pregnant any more");
	Render.text(".  Sophie's voluminous, painted lips curl into a radiant smile, an effect enhanced even more by the gold gloss she coats them with.");
...
public sophieFenCraftedSex(morning:boolean = false):void {
	...
	//{Regular Sex}
		...
		clearOutput();
		sophieSprite();
		Render.text("You hastily remove your armor and lie back on your blankets, beckoning Sophie forward with your hand.  The slutty, sex-hungry bimbo prances up on her tiptoes, supporting herself with flapping wings as her flared hips roll hypnotically, ever closer.  In no time, she's straddling your supine form; dripping sex positioned a foot above.  The moisture her puffy, aroused cleft exudes patters off your ");
		if(player.pregnancyIncubation > 0 && player.pregnancyIncubation < 150) Render.text("pregnant ");
		Render.text("midsection from time to time, hot droplets that shimmer with the proof of Sophie's ever-burning arousal for dick.  Above, her titanic cleavage casts a gloriously large shadow across you.  Each of the heaving globes is capped with a jutting nipple.  Her areolae look nearly as hard as your " + multiCockDescriptLight() + ", and you lick your lips at the sight of them.");
	...
	if(player.lowerBody.balls > 0) Render.text("  Sophie's immense backside slides over your [balls] each time she bottoms out, her tail feathers tickling at the bottom of your [sack].");
	Render.text("  You pull on her nipple, earning yourself a squawk of surprised excitement from Sophie.  She writhes in your grip, twisting this way and that, pulling harder on her poor abused nipple as her pussy goes wild around you.");
	...
	if(player.upperBody.chest.BreastRatingLargest[0].breastRating >= 1) Render.text("own");
	else Render.text("chest");
	Render.text(", as she kisses you passionately, moaning into your mouth.  The effects of her potent lip-gloss hit you immediately, fortifying your pleasure into a tsunami wave of excitement, one that's cresting whether you want it to or not.  You cry out into Sophie's tongue, hips lifting her off the ground, as you cum, hard.  Your ejaculate fires out in long, thick ropes of white, painting the harpy's sodden innards white.  With her folds coated in spunk, your spasming " + cockDescript(x) + " pours the rest of your lusts into her, emptying your [balls] completely.");
	if (pregnancy.isPregnant) {
		Render.text("  The thorough seeding fills her up completely - her womb is too full of egg for there to be any room for spunk, and it all drips out with each fresh injection.");
		if(player.cumQ() >= 500) Render.text("  You cum so hard that torrents of spooge wash out of her slit, her womb obstructed by the egg you made with her.");
	}
	if(player.cumQ() >= 2000) Render.text("  The oozing spunk soaks you thoroughly, and Sophie's thighs become matted with the gallons of gunk that squirts out of her lips.");
...
public fuckYoPregnantHarpyWaifu(morning:boolean = false):void {
	...
	if(morning) {
		...
		if(morning) Render.text(", morning");
		Render.text(" fuck.  Her skin is silky smooth, and if you push a little, you can actually feel the solid curve of the growth inside her.  That egg sure is getting big!");
	}
	//REGULAR FUCK
	else {
		clearOutput();
		sophieSprite();
		Render.text("You go ahead and take off your [armor], letting Sophie take in the view of [eachCock].  She immediately flounces over and drops to her knees in front of you.  Her hands wraps around " + cockDescript(x) + ", ");
		if(player.lust > 50) Render.text("feeling its firmness.  \"<i>Wow, you're so hard already, [name]!</i>\" she comments.");
		else Render.text("slowly stroking it until it begins to pulse to life, thickening in her hand.");
		Render.text("  Your rigid tool is soon tingling pleasantly from her handjob, the pregnant bimbo licking her lips hungrily.  She asks \"<i>Could you lie back and let me be on top?  It'll be easier on me, since I'm all big and stuff.</i>\"  She runs a hand over her gravid midriff, obviously enjoying herself as she waits.");
	...
	if(player.lowerBody.balls > 0) Render.text("[balls], where they hang in thick drops before falling to the ground,");
	else Render.text("taint and [legs]");
	Render.text(" proving the veracity of her statements many times over.  You can't SEE the wetness, but your " + cockDescript(x) + " certainly feels it, twitching inside Sophie's silky slit when the waves of wetness roll over it.");
	...
	if(player.lowerBody.cockSpot.count() > 1) {
		Render.text("  The underside of her tremendous, pregnant belly suddenly slides along you slickly, lubricated by the wasted spooge that's spurting from your unused member");
		if(player.lowerBody.cockSpot.count() > 1) Render.text("s");
		Render.text(".  The inadvertent tummyfuck redoubles the pleasure, forcing you to deal with a true, multi-cocked orgasm.");
	}
	Render.text("  Immediately, the cum you're squirting into her begins to be squeezed right back out.  Her womb is blocked thanks to the massive egg inside, and your lower body turns into a fruity, salty mess from all the cum and girl-jizz Sophie forces out.");
	if(player.cumQ() >= 500) {
		Render.text("  There's enough there to ");
		if(player.cumQ() < 1000) Render.text("soak your blankets");
		else if(player.cumQ() < 2000) Render.text("soak your blankets and the ground below");
		else if(player.cumQ() < 5000) Render.text("soak your blankets and form a giant puddle below, leaving you feeling like you're on a waterbed made of spunk.");
		else Render.text("soak your blankets and create a lake the two of you sink partway into, surrounded by muddy, cum-flavored mud.");
	}
	Render.text("\n\nYou sag back as the last few drops leak out around you.  Sophie rolls off to the side, panting heavily.  She titters, \"<i>");
	if(morning) Render.text("What... a... way to... start a... morning!");
	else Render.text("Ooohh... you're... gonna be... a great... daddy...");
	Render.text("</i>\" in between panting gasps for breath.");
	
	Render.text("\n\nSophie leaves you there");
	if(player.cumQ() >= 1000) Render.text(" in the hardening mud");
	Render.text(", swaying her hips sensually as seed runs from her cunt in thick little rivers.  You're wet, sticky, and sated");
	if(morning) Render.text(" when you go wash up to get dressed.  It's going to be a good day.");
	else Render.text(" when you go to get dressed.  You'll have to make sure to wash clean at some point, but for now you enjoy the sweet scent of your pet bimbo's cum.");
	player.orgasm();
	dynStats("sen", -2);
	if(morning) doNext(playerMenu);
	else doNext(camp.returnToCampUseOneHour);
...
private sophiePreggoTitJobs():void {
	...
	if(player.lowerBody.cockSpot.count() > 1) {
		Render.text("  Then, she fishes the ");
		if(player.lowerBody.cockSpot.count() == 2) Render.text("other one");
		else Render.text("rest");
		Render.text(" out of your [armor], giving ");
		if(player.lowerBody.cockSpot.count() == 2) Render.text("it");
		else Render.text("each");
		Render.text(" a slow, affectionate stroke before she returns to her target.");
	}
	Render.text("  The sensitive tip swells in her mouth, responding to the combination of sloppy, plump lip-kisses and the drugs now coursing through you.");
	...
	if(player.lowerBody.cockSpot.list[x].cockLength > 30) Render.text("the underside of your immense erection");
	else Render.text("your " + player.cockHead(x) + "");
	Render.text(" with her lips, already pursed into a plump, cock-sucking doughnut hole of pleasure.  The noise she makes when your " + cockDescript(x) + " ");
	if(player.lowerBody.cockSpot.list[x].cockLength > 30) Render.text("presses against");
	else Render.text("slips into");
	Render.text(" her puffy, puckered orifice is indescribably moist, a sloppy sucking sound that would make you dribble pre-cum if her tits and mouth weren't already milking a steady flow out.");
	if(player.lowerBody.cockSpot.list[x].cockLength > 30) Render.text("  Sophie pulls back long enough to gasp, \"<i>You're so long, I can't even take the tip!</i>\"");
...
private goHogWildOnSophieBewbs():void {
	...
	if(player.lowerBody.cockSpot.count() > 1) {
		...
		if(player.lowerBody.cockSpot.count() > 2) Render.text("s splay");
		else Render.text(" splays");
		Render.text(" out to the side, lamely brushing against the outsides of her tit.");
	}
	Render.text("  Sophie blubbers in surprise, stopping only when your ");
	if(player.lowerBody.cockSpot.list[x].cockLength <= 30) Render.text(player.cockHead(x) + " pushes into through her startled cock-pillows, muffling her more effectively than any gag.  She immediately sucks on it, a happy look in her eyes.  The bimbo seems to want nothing more than to lie there and polish your rod.");
	else Render.text(" immense rod smacks across her face, too long to try to jam down her throat.  It completely covers her face, smothering her features with rigid, veiny dickflesh.  She immediately begins to lavish the underside with licks and long wet kisses, aided by her plus-sized bimbo lips.  When her eyes peek out from under your " + cockDescript(x) + ", they seem placid and happy.  It seems the slut wants nothing more than to lie there and service your cock.");
	...
	if(player.lowerBody.cockSpot.list[x].cockLength <= 30) Render.text(" right into Sophie's mouth");
	else Render.text(" above Sophie's head");
	Render.text(".  The bird slut stops her frenzied fellatio to beg, \"<i>Please cum on me, [name]!  Cum all over Momma's Sophie's face and tits!  I fucking love, like, being covered in jizz!</i>\"");
	...
	if(player.lowerBody.balls > 0) Render.text(", cupping your [balls] with a hand and massaging them to aid your ejaculation");
	Render.text(".  Your [butt] is squished up against her belly, both of you sweating and slipping all over each other.  Bulging in her breasty embrace, your " + cockDescript(x) + " flexes, and your " + player.cockHead(x) + " thickens.");
	if(player.hasKnot(x)) Render.text("  Your knot inflates to a ludicrous degree, squeezed down on from all sides by slick, gold-painted tits, happy to be engulfed by warm flesh.");
	Render.text("  Cum fountains from you, splattering over Sophie's face, some of it catching on her tits along the way.  A ribbon of the white goo dangles between her mountainous chest and her chin, breaking only when you spurt another set of alabaster cream all over her breasts, most trapped inside the snug cleavage with you.  You slip yourself forwards and continue to cum, lacing hot, sticky jets onto her face.");
	if(player.cumQ() > 1000) Render.text("  Again and again, you continue to paint her white.  Your orgasm seems almost without end as you ejaculate.  Sophie's face is soaked with it, and her breasts have become glazed mountain-peaks.");
	if(player.cumQ() > 2500) Render.text("  By the time you finish, the stuff is puddled under her.  The best your harpy pet can manage is a spermy smile as she languishes in your seed.");
	Render.text("  You push your " + player.cockHead(x) + " and get a kiss from her as you finish cumming, oozing one last dollop onto her fat lips.  She whimpers in the most exciting way as you withdraw, wiping your cock off on her swollen belly, marking her as yours once more.");
...
private letSophieMilkYoDick():void {
	...
	sophieSprite();
	let x: number = player.biggestCockIndex();
	Render.text("You nod at Sophie and hold yourself still.  She rewards you by wrapping her breasts back around you, enveloping you in tight pleasure again.  ");
	if(player.lowerBody.balls > 0) Render.text("Your [balls] drag across her pregnant belly as she goes to work, but you don't mind in the slightest.  There's something erotic about having them bumping up against the fruit of your union.  ");
	Render.text("Her breasts begin to bounce without warning, up and down in perfect sync.  The tight titty-embrace is almost too much.  You can feel your dick flexing in that smothering, lube-soaked chest.  Sophie extends her tongue to lick at you, and her tongue sends shockwaves of excitement through your already raging boner.");
	...
	if(player.lowerBody.cockSpot.list[x].cockLength <= 30) Render.text(", ready to catch the cum");
	else Render.text(", assisting the cum");
	...
	if(player.lowerBody.cockSpot.list[x].cockLength <= 30) {
		Render.text("  Sophie");
		if(player.cumQ() < 250) Render.text(" swallows it without complaint, her eyes twinkling mirthfully as she suckles down your small load.  Surprisingly, you dump a few more pulses into her, each weaker than the last.  The bird-woman drinks it with ease, never looking away from you.");
		else if(player.cumQ() < 500) Render.text("'s cheeks bulge from the size of your load, but she manages to get it down with a big gulp.  Surprisingly, you dump a few more jets of thick cream into her waiting gullet, each weaker than the last but big enough to make it hard for her to swallow.  She never looks away from you as she takes it.");
		else if(player.cumQ() < 1000) Render.text("'s cheeks bulge cartoonishly at your immense deposit, cream escaping from the corners of her mouth as her poor mouth floods.  Her throat bobs ludicrously, trying to keep up with the flow, but when you follow up that virile blast with several smaller, still potent deposits, she gives up and lets the jizz run down her lip and face, dripping onto her tits.  Through it all, her eyes never leaves yours.");
		else {
			Render.text("'s cheeks bulge ridiculously for a split second before the pleasure sends cum fountaining out her nose and jetting out the corners of her mouth.  She <b>tries</b> to swallow it, but her meager throat simply can't ");
			if(silly()) Render.text("repel cum of that magnitude");
			else Render.text("handle that much cum");
			Render.text(".  Again and again, you spunk the hell out of her face, until Sophie pulls back gagging.  She gets a mask of jizz for her efforts, even after she's swallowed a bellyful of cum.  She WAS watching your face, until your cum obscured her eyes, and even then, she keeps her head facing you, letting you watch your jism dripping down her gorgeous features.");
		}
		Render.text("  The bird-girl withdraws ");
		if(player.cumQ() < 1000) Render.text("with a happy smile");
		else Render.text("coughing and sputtering");
		Render.text(" once you're dumped out every drop.  She touches your " + cockDescript(x) + " affectionately, tickling at its underside, and her flushed face seems extraordinairily pleased to have made you cum so hard.  Sophie's hands stroke her belly slowly as she looks up at you, whispering, \"<i>You're like, so good to Momma Sophie.  Just be sure and cum for my twat again soon, okay?  It misses you.</i>\"");
	}
	//On top of her.
	else {
		Render.text("  Sophie");
		if(player.cumQ() < 250) Render.text(" giggles happily when the cum jets into the air and down atop her head, moaning against your dick while it seeps through her platinum feathers.  Throughout it all, she licks and sucks on your shaft, milking out every drop and never looking away.");
		else if(player.cumQ() < 800) Render.text(" moans when your heavy deposits splatter into her hair, dripping through the downy blond feathers in a messy web.  Throughout it all, she sucks and licks at you, polishing your " + cockDescript(x) + " until she's sure every single drop of jizz has been expelled onto her curvy frame.");
		else {
			Render.text(" moans whorishly as your gigantic cum-wad splatters over her, running down her hair in thick waves, soaking her shoulders and even dropping over her face in a slippery mask.  She keeps kissing and sucking to make sure you give up every drop, not stopping until she feels your urethra stop its orgasmic pulsating.  Even then, her face stays angled up at you, allowing you to watch as your jizz runs unimpeded across her voluptuous body, dripping from every curve.");
			if(player.cumQ() >= 2000) {
				Render.text("  She's completely soaked, head to toe");
				if(player.cumQ() >= 3000) {
					Render.text(" and a ");
					if(player.cumQ() < 4000) Render.text("puddle");
					else if(player.cumQ() < 6000) Render.text("big puddle");
					else if(player.cumQ() < 10000) Render.text("small lake");
					else Render.text("obscene lake");
					Render.text(" has formed around the pair of you");
				}
				Render.text(".");
			}
		}
		Render.text("  She gathers up some of your spunk and rubs it over her breasts and belly as you slump back, reveling in the feel on her skin and how wonderful her big, pregnant boobs are feeling.");
...
public sophieBirthsEgg():void {
	...
	if(bimboSophie()) Render.text("Come here, [name]!  I... whooooaaaa... I wanna like, hold your hand when the egg comes out!");
	else Render.text("Come here, [name]!  I... whoooaaaa...  I need something to hold on to while this comes out!");
	Render.text("</i>\"");
	
	if(player.stats.cor < 33) Render.text("  You sit down next to her, and figuring this must be normal for her, you hold her hand with one arm and grope at her free breast with the other.");
	else if(player.stats.cor < 66) Render.text("  You sit down next to her with a sigh.  Well, at least you can grope her tit with your other hand!");
	else Render.text("  You plop down next to her, but ignore her proffered hand for one of those juicy melons on her chest.  Grinning, you can't help but think that this is a far more tender thing to hold anyway.");
	...
	if(player.isBiped()) Render.text("rs");
	Render.text(".  A rounded white rim peeks out through her spasming pussy-lips, glistening with lubricants that drop from its bottom so fast it's almost a steady stream.");
	...
	if(flags[FlagEnum.SOPHIE_ADULT_KID_COUNT] == 0) Render.text("  Can you handle having another harpy living in your camp?\n");
	else Render.text("  Just how many harpies can your camp hold?\n");
...
public sophiesEggHatches():void {
	...
	if(flags[FlagEnum.SOPHIE_ADULT_KID_COUNT] < 4) {	
		...
		if(flags[FlagEnum.SOPHIE_ADULT_KID_COUNT] == 0) {
			...
			if(flags[FlagEnum.UNKNOWN_FLAG_NUMBER_00282] > 0) Render.text(", though her lips are a little larger than you'd think was normal - maybe she inherited it from her mom?");
			else Render.text(".");
			Render.text("  The harpy chick is actually about as big as a four or five year old, and she looks up at Sophie curiously.");
		...
		//-Curvy like Sophie, but with well-developed wings and extra-soft feathers (WINGJOBS).  Pink plumage.  (blue eyes)
			...
			if(flags[FlagEnum.UNKNOWN_FLAG_NUMBER_00282] > 0) Render.text(" like her mother used to have before her bimbofication");
			Render.text(", and a shape that seems to indicate that maturity will be VERY generous to her.  She looks around in wonder, already flapping wings that seem a touch more developed than her sisters were at that age.  You've got to wonder just how big they'll get with age.");
			if(flags[FlagEnum.UNKNOWN_FLAG_NUMBER_00282] > 0) flags[FlagEnum.DAUGHTER_FOUR_BIMBO] = 1;
		}
		
		//ALL FIRST FOUR END WITH THIS: 
		if(bimboSophie()) Render.text("  Before the girl can try to stand she is swept up off her feet by her ecstatic mother.  \"<i>Oohhhhh, just look at you!  My baby girl is sooo cute!  Soooo totally fluffy and like, suuuuper soft!</i>\"");
		else Render.text("  Before the girl can try to stand she is swept up off her feet by her ecstatic mother.  \"<i>Oohhhhh, you're so cute!  My baby girl is sooo cute!  Oh, the boys will be all over you when you grow up, I just know it!</i>\"");
	}
	...
	else
	{
		...
		if(rand(2) == 0) Render.text("pink");
		else {
			if(flags[FlagEnum.UNKNOWN_FLAG_NUMBER_00282] > 0) Render.text("blonde");
			else Render.text("white");
		}
		Render.text(" girl coos as she shields her ");
		if(rand(2) == 0) Render.text("violet");
		else Render.text("blue");
		Render.text(" eyes from the sun.  The little bird-girl is soon out of her egg, but already looks to be four or five years old.  As always, the sweet little thing is as fluffy as a newborn chick, feathers sticking out every which way and making her look more like a puffball with skin showing than a little baby harpy.  Before the girl can try to stand she is swept up off her feet by her ecstatic mother.  ");
		if(bimboSophie()) Render.text("\"<i>Oohhhhh, just look at you!  My baby girl is sooo cute!  Soooo totally fluffy and like, suuuuper soft!</i>\"");
		else Render.text("\"<i>Oohhhhh, you're so cute!  My baby girl is sooo cute! Oh, the boys will be all over you when you grow up, I just know it!</i>\"");
	}
	...
	if(bimboSophie()) Render.text("\"<i>Oh dearie, there there, like, calm down, sweetie.  Don't worry, Momma Sophie's here.</i>\"  The matronly harpy gently hugs the squirming fluff-ball into her big, soft breasts, her hands gently stroking her fussy daughter's feathery hair.");
	else Render.text("\"<i>There there, calm down, baby.  Momma Sophie's here...  I'm here.</i>\"  The matronly harpy gently hugs the squirming fluff-ball into her big, soft breasts, her hands gently stroking her fussy daughter's feathery hair.");
...
public sophieKidMaturation():void {
	...
	//Fifth+ daughter
		...
		if(flags[FlagEnum.UNKNOWN_FLAG_NUMBER_00282] > 0) Render.text("bimbo ");
		Render.text("breasts - just as high, round and perky, yet big and yielding to the touch, like the softest pillow.");
	}
	//ALL CONTINUE HERE
	Render.text("  The newly embodied harpy lets out a sigh of relief now that the changes have stopped, clearly surprised by what happened and glad it's over. Moving to get a better view of your daughter, you take in the sight of her new body. Your once petite harpy girl looks more like a stacked ");
	if(flags[FlagEnum.UNKNOWN_FLAG_NUMBER_00282] > 0) Render.text("bimbo");
	else Render.text("bombshell");
	Render.text(", just like her mother.");
	if(bimboSophie()) Render.text("  From the inquisitive look on her face and spark of intelligence in her eyes, it seems that she hasn't lost her mind to her inner bimbo.");
	...
	if(flags[FlagEnum.SOPHIE_ADULT_KID_COUNT] > 0) {
		...
		if(flags[FlagEnum.SOPHIE_FAMILY_INCEST] == 1) {
			...
			if(flags[FlagEnum.SOPHIE_ADULT_KID_COUNT] > 1) Render.text("s");
			Render.text(".  She beams a radiant smile at you and turns around, shaking her rump at you enticingly, \"<i>So, when do you want to try me out, " + player.mf("Daddy","'Mom'") + "?</i>\"");
...
public sophieAndIzmaPlay():void {
	...
	Render.text("<b>Something odd happens that ");
	if(model.time.hours < 6 || model.time.hours > 20) Render.text("night");
	else if(model.time.hours < 12) Render.text("morning");
	else if(model.time.hours == 12) Render.text("noon");
	else if(model.time.hours < 5) Render.text("afternoon");
	else Render.text("evening");
	Render.text("...</b>");
...
private watchIzmaSophie():void {
	...
	if(player.lowerBody.cockSpot.hasCock()) Render.text(", from me OR my Alpha");
	Render.text(".  If I had MY way, you'd be tied up on the lake-side so my sisters could play with these ridiculous jugs while they pound your fat ass full of spunk and your belly full of shark-babies.</i>\"");
	...
	if(player.lowerBody.cockSpot.hasCock()) Render.text("stroke yourself through bliss");
	else Render.text("finger yourself through bliss");
	Render.text(".  Izma's quartette of sperm-filled balls abruptly rise in her suddenly taut prison and begin to pulsate in time with her cock.  At first, there's no visible change, but before long, semen begins to bubble out around the twitching shark-shaft, spattering onto the ground below.  Your own climax winds down as well");
	if(player.lowerBody.cockSpot.hasCock()) {
		if(player.cumQ() >= 1000) Render.text(", leaving you in a puddle of your own slimy mess");
	}
	Render.text(".  Izma keeps futilely pumping a bit longer, and you see Sophie's belly curve slightly with the hefty seed-deposit.");
