export default class SophieBimbo extends NPCAwareContent {
	...
	*/
	internal function sophieSprite(): void {
		if (Flags.list[FlagEnum.UNKNOWN_FLAG_NUMBER_00282] > 0 && Flags.list[FlagEnum.UNKNOWN_FLAG_NUMBER_00283] == 0) spriteSelect(83);
		else spriteSelect(53);
	}

	public bimboSophie(): boolean {
		return (Flags.list[FlagEnum.UNKNOWN_FLAG_NUMBER_00282] > 0 && Flags.list[FlagEnum.UNKNOWN_FLAG_NUMBER_00283] == 0 && Flags.list[FlagEnum.SOPHIE_DEBIMBOED] == 0);
	}

	public sophieIsInSeason(): boolean {
		return (Flags.list[FlagEnum.SOPHIE_HEAT_COUNTER] > 551 && !pregnancy.isPregnant);
	}

	internal function sophiePregChance(): void {
		if (Flags.list[FlagEnum.FOLLOWER_AT_FARM_SOPHIE] != 0) return;

		//25% + gradually increasing cumQ bonus
		if (rand(4) == 0 || player.cumQ() > rand(1000)) {
			pregnancy.knockUpForce(PregnancyType.PLAYER, PregnancyType.INCUBATION_HARPY);
		}
	}
	...
	internal function bimbotizeMeCaptainSophie(): void {
		...
		MainScreen.text("A wicked idea takes hold of you while you watch the harpy ", false);
		if (monster.lust > 99) MainScreen.text("touch herself", false);
		else MainScreen.text("squirm in the dirt around her nest", false);
		MainScreen.text(".  Releasing the ties on one of your pouches, you reach inside to claim the contents.  You produce the bottle of bimbo liqueur with a flourish, swirling the potent fluid inside its prison as you approach the downed harpy matron; she looks up at you with dumb, ", false);
		if (monster.lust > 99) MainScreen.text("lust", false);
		else MainScreen.text("pain", false);
		MainScreen.text("-glazed eyes, her beautiful but uncomprehending visage slack-jawed and empty.  It's a good look for her.\n\n", false);

		MainScreen.text("The cork pops from the bottle's top with an easy tug, releasing a fine pink mist that reeks of alcohol, potent spices, and sweetness.  You hold Sophie's jaw in your hand and pull her mouth open, placing the bottle's lip upon the defeated slut's slack mouth.  Like this, she's almost perfect... almost.  You lift the back edge of the bottle higher, dribbling a flow of bimbolicious alcohol into Sophie's pliant, unresisting mouth.  She gulps as it hits her tongue, swaying back and forth dangerously while the magic starts to take effect.  You hold her fast and upend the rest of the liqueur directly into her throat.  The busty harpy shudders and shakes, sputtering a little bit with her eyes crossed.  Her convulsions grow so forceful that she wrenches out of your grip to flop about on the floor of her nest.\n\n", false);

		MainScreen.text("Starting at her head, her flamingo-pink plumage brightens to an even more neon coloration.  It continually lightens until the blush utterly vanishes, a light, barely-blond hue fading into place in her feathery hair.  The same scene is repeated over her wings, legs, and feathery backside, girding her body in platinum pinions.  Fluffing softly, the changed feathers ruffle while Sophie's involuntary shudders slow to a stop.  She shakes her head and mutters, \"<i>OOooh, wha... what did you give me?  So... hard to... think.</i>\"\n\n", false);

		MainScreen.text("You display the bottle's warning label to the harpy, waiting for her response.  She squints in confusion and pulls back, her heaving breasts jiggling and bouncing about.  \"<i>What's that?  Some like, weird language or something?  I can't read it.</i>\"  Sophie's brow knits in confusion - you can practically see the gears trying to turn behind her open, clueless eyes.  She taps at her chin, her arm brushing her suddenly-larger assets, once again setting her swelling bust to shaking.  \"<i>Omigosh!  Are my titties getting bigger?</i>\" she asks with a giggle.  \"<i>They're so... jiggly and shaky!</i>\"\n\n", false);

		MainScreen.text("Looking down confirms her claims.  While the twin melons were definitely double-D's before, they've swollen up to an E-cup by now, and the blooming bosom shows no signs of stopping.  Before your eyes, Sophie's tits grow into a truly magnificent pair of breasts, shaking and rippling like bowls of jello.  Her nipples puff up and engorge, the nubs easily doubling in size and stretching out to nearly a full inch in their aroused state.  They redden as Sophie's creamy skin blushes pink, her flesh coloring from the pleasure of her chest's obscene growth.  Widening in panic and lust, Sophie's eyes glitter with half-formed tears as she wails, \"<i>I can't fly like thiiiis!</i>\"\n\n", false);

		MainScreen.text("You chuckle and heft one of the harpy's weighty globes, marveling at the smooth softness of her heavy tit.\n\n", false);

		MainScreen.text("Sophie squeals, \"<i>S-stop it!  It's s-s-sensitiiiive!</i>\"\n\n", false);

		MainScreen.text("Sighing, you rub your thumb across her areola, circling around the huge nipple before you give the long protrusion a hard flick.  The avian matron shivers and moans at that, arching her back to press the mammoth mounds further into your hands, forcing you back against the mountainside with their weight.  Protruding even more, her unyielding nips slide between your fingers.  Thankfully, they don't seem to be getting any bigger; while you're no tailor, you appraise them as at least F-cups now.  You idly massage the more-than-motherly melons, setting off a chorus of moans from the harpy's gold-glossed lips.  Her wide hips wiggle with sensuous need, the scent of horny harpy filling the air.  You must be doing something right.\n\n", false);

		MainScreen.text("Sophie gasps and pulls back, turning about to place her hefty rump in front of your face.  The long tail-feathers tickle at you, but you brush the blond fluff aside with an irritated snort.  \"<i>Y-you like, did this to me!  Whatever it is making me all... horny and slurpy and yummy and dumb and... mmmm... can we fuck?</i>\" she accuses, losing her train of thought part way through her diatribe as juices begin to drip from her inflamed cunt-lips.\n\n", false);

		MainScreen.text("You run a finger from the top of Sophie's box to the bottom, even stopping to slide the lubricated digit across her taint to circle her sensitive asshole.  She moans and bounces in place, her hips nearly blocking the light from your view when she presses back.  Did they get bigger too?  You pause to watch her hand-devouring ass-cheeks and confirm that they are, in fact, growing larger - just like her tits.  The plush pillow-butt rounds out, swelling larger.  You look down and note that her legs are moving apart as well, shifted wider by Sophie's changing body and expanding hips.\n\n", false);

		MainScreen.text("Sophie giggles, \"<i>Like, do you love my drippy pussy that much?  Gosh that's cute!  But why am I so horny and silly?</i>\"  She giggles.  \"<i>I don't get it.  My head's all light and floaty!  Not like before.</i>\"  Her voice drops slightly as she struggles with herself.  \"<i>So hard... hard to think.  Gotta... gotta... like, find someone to fuck!  Mmm, would you give me a lick?  Can't you feel how hot Momma Sophie's box is?  It like, needs a tongue to cool it down or something.</i>\"\n\n", false);

		MainScreen.text("The harpy's frothing gash smears over your nose and lips, trailing a fragrant smear of girl-honey across your face.  For one glorious moment, you're utterly deprived of light and left with the newly-minted bimbo's twat on your lips.  Her thighs muffle the sounds of the high mountains to near nothing, and you find yourself licking without meaning to, lapping  experimentally to see which parts of her slutted-up anatomy will release the strongest gushes of fluids.  Once you prod her clit with your tongue, she cums, drenching your face with harpy-lube.  The blond's thighs lock around you, holding you tight in the bimbo-bitch's snatch to receive her musky baptism.\n\n", false);

		MainScreen.text("After a few moments of torrential, slimy output, Sophie's quivering cunt spasms and her legs give out.  She slumps over, ass in the air and utterly exposed as she giggles, \"<i>Like, wow!  You made me cum so hard, " + player.mf("mister", "miss") + "!  Can I, like, come home with you?  I don't really want to compete with these bitches and you're super " + player.mf("handsome", "hot") + "!  We can have lots of like, sex and stuff!</i>\"\n\n", false);

		MainScreen.text("You're a bit taken aback by her reaction, but it makes sense.  The dumb broad is too fucked up to survive without becoming someone's fuck-pet.  She may as well be yours.  She looks back with glossy, hopeful eyes and a pleading, pouty look on her thick lips.  Did they get bigger too?  (She probably gives great head...)\n\n", false);

		MainScreen.text("Saying no seems silly... she's so fucking hot now, and you've no doubt she'll be like your personal masturbation toy.  Sophie titters, \"<i>Please please please!  Mmmm, I'll kiss and, like, lick you with my tongue all the time.  Don't say no... I totally need to fuck you!</i>\"\n\n", false);

		MainScreen.text("You shake your head, feeling the compulsion picking at your mind.  Damn, she can still try to compel you with her words.  Do you take her home to be your live-in bimbo of choice?", false);
		player.stats.cor += 5;
	...
	private declineBimboSophie(): void {
		...
		MainScreen.text("", true);
		MainScreen.text("You turn and flee the mountain, before she can compel you to take her to camp and fuck like bunnies.  Who knows when you'd have time to explore with a lust-crazed bird-woman like that around.  She'll find a mate soon enough, you're sure of that.\n\n", false);
		cleanupAfterCombat();
	}
	...
	private acceptBimboSophie(): void {
		...
		MainScreen.text("You nod, and Sophie springs forward on her powerful legs, the strength undiminished by the effects of her bimbo transformation.  She tackles you in a bear-hug, kissing your " + chestDesc() + " over and over as her momentum carries you both off the side of the mountain.  You tumble in the air, screaming as you fall", false);
		if (player.canFly()) MainScreen.text(" and unable to bring your wings to bear with arms pinning them to your back", false);
		MainScreen.text(".\n\n", false);

		MainScreen.text("Sophie looks up and gasps, \"<i>Oh no!</i>\"  Thankfully, the ditz remembers her own wings and spreads them, slowing the descent to a rapid, controlled glide.  You sigh with relief, supported by her arms and legs thousands of feet in the air.  Sophie titters, \"<i>Like, which way should we go, " + player.short + "?  Everything is all funny up here, and I dunno where you live.  We need a place to fuck!</i>\"\n\n", false);

		MainScreen.text("You grudgingly direct her glide towards your campsite, and the two of you make good time.  Of course, Sophie's wet, drooling cunny makes an absolute mess of your " + player.inventory.armor.displayName + " and " + LowerBodyDescriptor.describeLegs(player) + " during the trip, soaking them with her copious pussy-cream.  She's exhausted and randy once you get to camp, and the landing is quite rough as a result.  You take a nasty tumble in the dirt, but it doesn't damage you significantly.  Sophie appears just as lucky - she's sitting on her plump rump with her legs spread wide, cluelessly scratching at her downy blond feathers.\n\n", false);

		MainScreen.text("After a few seconds, the bimbo's dull eyes seem to light up with delight.  \"<i>Oh, is this where you live?  It's wonderful!  Oh, do you, like, sleep over there?  Can I share it with you?  Can we fuck every night?  Oh I've got, like, so many questions!  Umm... which ones did I ask already?  I forget!</i>\"\n\n", false);

		MainScreen.text("You sigh and show the bimbo around.  She seems extremely pleased by the arrangements, and once the tour is complete, she prances off to touch up her make-up, though you see her masturbating the whole time.", false);

		if (player.statusAffects.has("CampRathazul")) {
			MainScreen.text("  Afterwards, she offers to suck Rathazul's cock.  The old rat looked about ready to have a heart attack, but he managed to decline her offer with some amount of dignity, after a few moments of stammering.", false);
		}
		else if (Flags.list[FlagEnum.UNKNOWN_FLAG_NUMBER_00238] == 1) {
			MainScreen.text("  Afterwards, she offers to suck Izma's cock.  Izma looks at you for a moment before shaking her head, no.  Her skirt rises visibly in spite of her negative response.  Maybe she'll like having someone lower on the food chain to boss around?", false);
		}
		else if (Flags.list[FlagEnum.AMILY_FOLLOWER] > 0 && Flags.list[FlagEnum.AMILY_BLOCK_COUNTDOWN_BECAUSE_CORRUPTED_JOJO] == 0) {
			MainScreen.text("  Afterwards, she offers to lick Amily's twat, if Amily will do the same to her.  Amily ", false);
			if (Flags.list[FlagEnum.AMILY_FOLLOWER] == 1) MainScreen.text("flushes hotly and denies the bimbo's request with a terse 'no'.", false);
			else MainScreen.text("flushes hotly and wiggles her hips Sophie's way.  The slutty, corrupted mouse and Sophie will clearly be helping to sate each other's needs in your absence.", false);
		}
		else if (monk >= 5 && !player.statusAffects.has("NoJojo") && Flags.list[FlagEnum.JOJO_DEAD_OR_GONE] == 0) {
			MainScreen.text("  Afterwards, she offers to suck Jojo's cock.  The corrupted slut-mouse nods and stiffens in delight, though he keeps glancing back your way.  Those two will probably spend a lot of time together...", false);
		}
		else if (player.statusAffects.has("PureCampJojo")) {
			MainScreen.text("  Afterwards, she offers to suck Jojo's cock.  The chaste mouse's jaw drops, but when he picks it up, he answers, \"<i>Never.  My body is as pure as my soul!</i>\"", false);
		}
		else if (kGAMECLASS.isabellaFollowerScene.isabellaFollower()) {
			MainScreen.text("  Afterwards, she offers to lick Isabella's cunt.  Isabella answers sternly, ");
			if (isabellaAccent()) MainScreen.text("\"<i> Nein!  But you can drink mein milk from time to time.</i>\"");
			else MainScreen.text("“<i>No! But you can still drink my milk from time to time.</i>”");
			MainScreen.text("  The cow-girl is blushing hotly.  You've no doubt after a few nipple-licks she'll be spreading her thick thighs for the bimbo harpy.", false);
		}
		MainScreen.text("\n\n", false);
		MainScreen.text("Well, you know where to find her any time you want to fuck the motherly bimbo.\n<b>(Bimbo Sophie has been added to your slaves!)</b>", false);
		cleanupAfterCombat();
	}
	//Follower In Camp Text:
	public sophieCampLines(): void {
		let choice: number = rand(4);
		if (choice == 0) MainScreen.text("Sophie is sitting by herself, applying yet another layer of glittering lip gloss to her puffy bimbo lips.", false);
		else if (choice == 1) MainScreen.text("Sophie is sitting by herself, idly diddling her twat and noisily moaning.  She keeps looking your way, hoping you'll approach.", false);
		else if (choice == 2) MainScreen.text("The beach-blond harpy is preening herself with a vapid, brainless look plastered on her face.  Her puffy, bee-stung lips are slightly parted and lacquered with a heavy layer of golden gloss.", false);
		else MainScreen.text("Your personal bimbo, Sophie, is playing with her breasts, touching and caressing the heavy orbs in between sighs of pleasure.  She keeps glancing your way, hoping you'll join her.  She's insatiable!", false);
		MainScreen.text("\n\n", false);
	}
	//Approach Texts
	public approachBimboSophieInCamp(output: boolean = true): void {
		sophieSprite();
		if (Flags.list[FlagEnum.FOLLOWER_AT_FARM_SOPHIE] == 0) {
			if (output) {
				MainScreen.text("", true);
				if (sophieIsInSeason() && player.lowerBody.cockSpot.hasCock()) {
					//New Sophie Greeting*
					MainScreen.text("As soon as you call for Sophie, the blond bimbo trots over to you, her arms hugging around her chest, barely containing the enormous, bouncing mammaries within.  She's completely nude, like usual.  Her fluttering eyelashes lower coquettishly as she comes to a stop, rolling her immense hips back and forth hypnotically.  Her tail feathers twitch up and back, fanning a breeze in your direction that reeks of pheremonal sex.  The tangy, peach-like scent of her lust practically assaults your nostrils as the harpy attaches herself to your arm.  She presses her breasts against you as she clings tight, the prominent nipples so hard that they dig painfully in your " + player.skinFurScales() + ".");
			...
			if (output) {
				...
				MainScreen.text("Sophie emerges from the hen coop and wiggles her way over to you when you call her name.");
		...
		menu();
		if (player.stats.lust < 33 && output) MainScreen.text("\n\n<b>You aren't turned on enough right now to make use of Sophie's 'services'.</b>", false);
		else if (player.stats.lust >= 33) {
			MainScreen.addButton(0, "Sex", bimboSophieSexMenu);
		}
		if (player.inventory.items.has(consumables.DEBIMBO)) {
			MainScreen.addButton(4, "Debimbo", sophieFollowerScene.unbimboSophie);
			if (output) MainScreen.text("\n\n<b>You could use the bottle of debimbo to return Sophie's intellect...</b>");
		}
		if (Flags.list[FlagEnum.SOPHIE_CAMP_EGG_COUNTDOWN] > 0 && output) MainScreen.text("\n\n<b>Sophie's egg is sitting nearby.</b>");
		if (Flags.list[FlagEnum.SOPHIE_DAUGHTER_MATURITY_COUNTER] > 0) {
			MainScreen.addButton(5, "Daughter", daughterCheckup);
		}
		if (Flags.list[FlagEnum.SOPHIE_BROACHED_SLEEP_WITH] == 1 && Flags.list[FlagEnum.FOLLOWER_AT_FARM_SOPHIE] == 0) {
			if (Flags.list[FlagEnum.SLEEP_WITH] != "Sophie") {
				if (output) MainScreen.text("\n\nYou could invite her to share the bed with you at night.");
				MainScreen.addButton(6, "SleepWith", moveSophieInRepeat);
			}
			else {
				if (output) MainScreen.text("\n\nYou're currently sharing your bed with Sophie at night.  You could kick her out.");
				MainScreen.addButton(6, "NoSnuggles", noSophieSleepWith);
			}
		}
		...
		if (Flags.list[FlagEnum.FOLLOWER_AT_FARM_SOPHIE] == 0 && !pregnancy.isPregnant && Flags.list[FlagEnum.FARM_CORRUPTION_STARTED] == 1) MainScreen.addButton(1, "Farm Work", sendToFarm);
		if (Flags.list[FlagEnum.FOLLOWER_AT_FARM_SOPHIE] != 0) MainScreen.addButton(1, "Go Camp", backToCamp);

		if (Flags.list[FlagEnum.FOLLOWER_AT_FARM_SOPHIE] != 0 && Flags.list[FlagEnum.FOLLOWER_PRODUCTION_SOPHIE] == 0) MainScreen.addButton(2, "Harvest Eggs", harvestEggs);
		if (Flags.list[FlagEnum.FOLLOWER_AT_FARM_SOPHIE] != 0 && Flags.list[FlagEnum.FOLLOWER_PRODUCTION_SOPHIE] == 1) MainScreen.addButton(2, "Change Eggs", changeEggs);

		if (Flags.list[FlagEnum.FOLLOWER_AT_FARM_SOPHIE] != 0 && Flags.list[FlagEnum.FOLLOWER_PRODUCTION_SOPHIE] == 1) MainScreen.addButton(3, "Stop Harvest", stopHarvest);

		MainScreen.addButton(7, "Appearance", sophieBimboAppearance);

		if (Flags.list[FlagEnum.FOLLOWER_AT_FARM_SOPHIE] == 0) MainScreen.addButton(9, "Leave", camp.campSlavesMenu);
		if (Flags.list[FlagEnum.FOLLOWER_AT_FARM_SOPHIE] != 0) MainScreen.addButton(9, "Back", kGAMECLASS.farm.farmCorruption.rootScene);
	}

	//Appearance:
	private sophieBimboAppearance(): void {
		MainScreen.clearText();
		MainScreen.text("Sophie is a big, buxom harpy, no two ways about her.  She has ");
		if (Flags.list[FlagEnum.UNKNOWN_FLAG_NUMBER_00282] > 0) MainScreen.text("very ");
		MainScreen.text("long ");
		if (Flags.list[FlagEnum.UNKNOWN_FLAG_NUMBER_00282] > 0) MainScreen.text("platinum-blond");
		else MainScreen.text("pink");
		MainScreen.text(" 'hair' that dangles off her shoulders, like a bird's plumage.  She wears a thick layer of golden lipstick over her plump");
		if (Flags.list[FlagEnum.UNKNOWN_FLAG_NUMBER_00282] > 0) MainScreen.text(", super-sized");
		MainScreen.text(" lips at all times, like most of her kind, the gloss capable of giving her voice a compelling quality or inducing arousal on contact with males or herms.  Her face lacks the youthful quality found among many of her sisters, though you don't see any of the lines that would indicate age.");

		MainScreen.text("\n\nSophie's breasts are ");
		if (Flags.list[FlagEnum.UNKNOWN_FLAG_NUMBER_00282] > 0) MainScreen.text("so immense they would drag her to the ground if she tried to fly, a sexy, lingering aftereffect of the draft you gave her.  The wobbly bimbo-tits look to be about F-cups.");
		else MainScreen.text("unusually large.  The buxom harpy does seem slightly encumbered by them, but still capable of flight.  Her breasts look to be about DD-cups, nice and big enough for a soft squeeze or rough tit-fuck.");
		...
		if (kGAMECLASS.farm.farmCorruption.hasTattoo("sophie")) {
			...
			if (kGAMECLASS.farm.farmCorruption.sophieFullTribalTats()) {
				...
				if (kGAMECLASS.farm.farmCorruption.numTattoos("sophie") > 1) MainScreen.text("She has the following tattoos emblazoned across her body:\n");
				else MainScreen.text("She has ");

				if (Flags.list[FlagEnum.SOPHIE_TATTOO_COLLARBONE] != 0) MainScreen.text(Flags.list[FlagEnum.SOPHIE_TATTOO_COLLARBONE] + "\n");
				if (Flags.list[FlagEnum.SOPHIE_TATTOO_SHOULDERS] != 0) MainScreen.text(Flags.list[FlagEnum.SOPHIE_TATTOO_SHOULDERS] + "\n");
				if (Flags.list[FlagEnum.SOPHIE_TATTOO_LOWERBACK] != 0) MainScreen.text(Flags.list[FlagEnum.SOPHIE_TATTOO_LOWERBACK] + "\n");
				if (Flags.list[FlagEnum.SOPHIE_TATTOO_BUTT] != 0) MainScreen.text(Flags.list[FlagEnum.SOPHIE_TATTOO_BUTT] + "\n");
			}
		}

		menu();
		MainScreen.addButton(0, "Back", approachBimboSophieInCamp, false);
	}
	...
	private harvestEggs(): void {
		...
		MainScreen.text("You ask Sophie if it’s possible for her to produce eggs of a certain color whilst she’s here.");
	...
	private changeEggs(): void {
		...
		MainScreen.text("You ask Sophie to change the type of eggs that she is producing for you.");
	...
	private postEggSelector(selected: string): void {
		...
		MainScreen.text("“<i>I’ll make some nice " + selected.toLowerCase() + " eggs just for you then, good looking,</i>” she says. “<i>I can only make, like, one once a week, though. All the rest gotta be sold. I’ll put it with the weekly earnings, ok?</i>”");
	...
	private stopHarvest(): void {
		...
		MainScreen.text("You tell Sophie to stop giving you eggs; you’d rather she’d put them towards making the farm money.");
		...
		else MainScreen.text("“<i>I only wish I was good with numbers and things,</i>” Sophie sighs wistfully, picking at her bellybutton. “<i>Then I’d know when to give you my eggs and, and when to give them to the doggie. Whatever you say anyways, babe!</i>”");
	...
	private sendToFarm(): void {
		...
		MainScreen.text("“<i>I want you to head towards the lake,</i>” you say to your pet bimbo, “<i>and find a farm. You’re to present yourself to th...</i>“ you stop. Sophie is staring at you in complete incomprehension, fingering herself impulsively.");
	...
	private backToCamp(): void {
		...
		MainScreen.text("You tell her to head back to camp; there are things you need to do to her you can’t do whilst she’s here. Repeatedly. Sophie’s face falls a bit.");
	...
	private bimboSophieSexMenu(): void {
		MainScreen.clearText();
		MainScreen.text("How will you have sex with your feather-brained slut?");
		menu();
		if (player.lowerBody.cockSpot.hasCock()) {
			//BUTT FUCKS
			if (player.cockThatFits(sophieCapacity()) >= 0 && player.stats.lust >= 33) MainScreen.addButton(2, "Anal", buttFuckBimboSophie);
			else MainScreen.text("\n\n<b>You're too big to butt-fuck her.</b>", false);
			//TIT FUCKS!
			if (pregnancy.event >= 2) MainScreen.addButton(5, "Titty-Fuck", sophiePreggoTitJobs);
			else MainScreen.addButton(5, "Titty-Fuck", fuckBimboSophiesTits);

			//VAG FUCKS!
			if (player.cockThatFits(sophieCapacity()) >= 0) {
				if (sophieIsInSeason()) {
					MainScreen.addButton(0, "Impregnate", sophieImpregnationSex);
				}
				else {
					MainScreen.addButton(0, "Nice Fuck", sophieFenCraftedSex);
				}
				MainScreen.addButton(1, "Rough Fuck", rideDatSophieVag);
			}
			else {
				MainScreen.text("\n\n<b>You're too big to give her cunt a working over.</b>");
			}
			if (player.lowerBody.cockSpot.biggestCocks[0].cockArea() > sophieCapacity() && sophieIsInSeason()) {
				MainScreen.text("\n\nYou can always try to impregnate her with your biggest member...");
				MainScreen.addButton(6, "Big Impreg", giantCocksImpregnateSophie);
			}
		}
		if (player.lowerBody.vaginaSpot.hasVagina()) MainScreen.addButton(3, "Get Licked", bimboSophieLicksRugs);
		if (Flags.list[FlagEnum.TIMES_SOPHIE_HAS_DRUNK_OVI_ELIXIR] > 0 && (player.gender > 0) && !pregnancy.isPregnant) {
			if (player.inventory.items.has(consumables.OVIELIX) || inventory.hasItemInStorage(consumables.OVIELIX)) {
				MainScreen.addButton(4, "Ovi Elixir", sophieEggApocalypse);
			}
			else MainScreen.text("\n\n<b>If you had an Oviposition Elixir in your inventory or camp storage, Sophie could have some fun with it...</b>", false);
		}
		if (Flags.list[FlagEnum.TOLD_SOPHIE_TO_IZMA] == 0 && Flags.list[FlagEnum.TIMES_SOPHIE_AND_IZMA_FUCKED] > 0 && Flags.list[FlagEnum.IZMA_NO_COCK] == 0) {
			MainScreen.text("\n\nYou could tell Sophie to visit Izma again.  She'd probably wind up tied AGAIN.");
			MainScreen.addButton(7, "Visit Izma", tellSophieToVisitIzma);
		}
		if (Flags.list[FlagEnum.SOPHIE_ADULT_KID_COUNT] > 0 && Flags.list[FlagEnum.SOPHIE_FAMILY_INCEST] > 0 && player.cockThatFits(sophieCapacity()) >= 0 && player.lowerBody.cockSpot.hasCock())
			MainScreen.addButton(8, "DaughterFuck", sophieFollowerScene.sophieIncestInHerCooterOrSomethingIDunno);
		MainScreen.addButton(9, "Leave", approachBimboSophieInCamp);
	}

	private tellSophieToVisitIzma(): void {
		MainScreen.clearText();
		MainScreen.text("You suggest she visit Izma again.  Maybe this time she won't get tied up again?");
		MainScreen.text("\n\nSophie squeals, \"<i>REAAALLY?</i>\" before taking off towards the other side of camp.  This should be good.");
		Flags.list[FlagEnum.TOLD_SOPHIE_TO_IZMA] = 1;
		doNext(camp.returnToCampUseOneHour);
	}
	...
	public bimboSophieLustStickSurprise(): void {
		...
		let select: number = rand(4);
		if (select == 0) {
			sophieSprite();
			MainScreen.text("Sophie flounces into your arms and kisses you on the lips before you can react.  ", false);
			if (!player.lowerBody.cockSpot.hasCock()) {
				MainScreen.text("You smirk and pry the enthusiastic bimbo out of your arms, for now.", false);
				player.stats.lust += 1;
			}
			else {
				MainScreen.text("You shiver, " + CockDescriptor.describeMultiCockSimpleOne(player) + " growing hard and ready to submit to the feathery blond's love.  Perhaps you'll take care of that soon...", false);
				player.stats.lust += 15;
			}
			...
			sophieSprite();
			MainScreen.text("During an idle moment, you feel heavy breasts squeezing against your back.  Sophie caresses your " + chestDesc() + " and nibbles at your ear.  She asks, \"<i>Can we like, fuck soon, babe?  I've been so wet here all by myself, just stroking my pussy and dreaming of you.</i>\"  You can't help but turn and smile at her, but as soon as you do, she plants a kiss full on your lips.  ", false);
			if (!player.lowerBody.cockSpot.hasCock()) {
				MainScreen.text("Pushing her back, you give her ass a slap and mouth, 'Soon'.", false);
				player.stats.lust += 1;
			}
			else {
				MainScreen.text("Pushing her back, you try not to make contact against her with " + oMultiCockDesc() + ".  Your lips tingle dangerously, and you know you'll be lusting after harpies for at least a few hours.", false);
				player.stats.lust += 15;
			}
			sophieScene.luststickApplication(5);
		}
			...
			sophieSprite();
			if (player.lowerBody.cockSpot.hasCock()) {
				MainScreen.text("While standing there, drinking a sip of water, strong hands pull down your " + player.inventory.armor.displayName + ".  Plump lips wrap around " + oMultiCockDesc() + " and smother it in plush, warm slipperiness.  You look down at your bimbo harpy and sigh while " + oMultiCockDesc() + " grows harder in her lips.  She pops off and asks, \"<i>Like, wanna fuck?</i>\"  You sigh and try to resist the images of yourself mounting the harpy that flood your mind.  It might be time to fuck her soon...", false);
				player.stats.lust += 15;
			}
			else {
				player.stats.lust += 10;
				MainScreen.text("While standing there, drinking a sip of water, strong hands pull down your " + player.inventory.armor.displayName + ".  Plump lips slide over your ");
				if (player.lowerBody.vaginaSpot.hasVagina()) MainScreen.text("vulva, sucking at your clitoral hood.  Those gold, slobbery pussy-lickers look good on your groin, and you find yourself releasing your wetness from her oral attentions.  It might be time to fuck her soon...", false);
				else MainScreen.text("smooth groin, eventually licking at your [asshole].  Those gold, slobbery lickers look good pressed against you.  It might be time to fuck her soon...", false);
			}
			sophieScene.luststickApplication(5);
		}
		else {
			sophieSprite();
			MainScreen.text("Sophie glides down from atop a rock, landing roughly atop you.  She plants a wet, smacking kiss on you and asks, \"<i>Didja miss me?  I totally missed you!</i>\"  ", false);
			if (player.lowerBody.cockSpot.hasCock()) {
				player.stats.lust += 15;
				MainScreen.text(CockDescriptor.describeMultiCockSimpleOne(player, true) + " seems to wiggle inside your " + player.inventory.armor.displayName + ".  Damn, she feels really good on you!  Maybe you should screw the slutty bimbo soon?  ", false);
			}
			MainScreen.text("You nod and Sophie gets up, beaming a radiant smile as she prances away, her booty swaying enticingly behind her.", false);
			player.stats.lust += 2;
			sophieScene.luststickApplication(5);
		}
		MainScreen.text("\n", false);
	...
	internal function daughterCheckup(): void {
		MainScreen.clearText();
		if (Flags.list[FlagEnum.SOPHIE_DAUGHTER_MATURITY_COUNTER] > 200) {
			MainScreen.text("Back in the nest, your cute little harpy is still just a little chick.  Her body is small and childlike, and her feathers are fluffy and poofy, making your little girl look like she has puffballs for arms and legs.  Already looking to be four or five years old, the baby harpy is just as energetic as a human child of that age.  She flutters around and scrambles from one thing to another.  Thankfully, the rambunctious little darling runs out of explosive energy quickly, suddenly falling to the ground into a fluffy heap for a quick nap.");
		}
		else if (Flags.list[FlagEnum.SOPHIE_DAUGHTER_MATURITY_COUNTER] > 100) {
			MainScreen.text("Back in the nest, your sweet little harpy is starting to grow up!  Her body is much bigger than it was before, though her baby fat has spread out over her larger form and looks more lean and lanky then the big-butted harpies you're used to seeing.  Her feathers have even started to smooth out, though she is still quite the fluffball.  You're sure that it won't be too long before the curves harpies are known for start to appear.  The energy she exuded as a little chick still drives her to 'terrorize' your camp, scampering around, fluttering from place to place and getting into all kinds of things.  Your fluffy daughter seems to be able to stay active for longer than before, though you still see her curl up for a nap every so often.\n");
		}
		else if (Flags.list[FlagEnum.SOPHIE_DAUGHTER_MATURITY_COUNTER] > 0) {
			MainScreen.text("Looking around for your developing daughter, you find that she and your ");
			if (bimboSophie()) MainScreen.text("boisterous bimbo ");
			else MainScreen.text("matronly harpy ");
			MainScreen.text("are spending some quality mother-daughter time together.  Sophie is helping the young girl with her make up, showing her how to use that golden luststick that her people are so fond of.  You're not too sure how appropriate that is for your daughter, but then again, this is what harpies do, right? Aside from the lusty lipstick, your ");
			if (bimboSophie()) MainScreen.text("live-in bimbo ");
			else MainScreen.text("favorite bird-woman ");
			MainScreen.text("moves on to her hair and nails, all the while gabbing on and on about you, and about all the daughters she plans to have.");
		...
		menu();
		if (bimboSophie()) MainScreen.addButton(4, "Back", approachBimboSophieInCamp);
		else MainScreen.addButton(4, "Back", sophieFollowerScene.followerSophieMainScreen);
	}
	...
	public unlockResistance(): void {
		...
		MainScreen.text("<b>(Perk Unlocked: Luststick Adapted - your minimum lust is permanently raised, but you are 20% more lust resistant.  In combat, you're immune to it, though it still gives you a rush during sex.  You're also comfortable enough with it to use it like a harpy if you find any.)</b>\n", false);
	...
	private bimboSophieLicksRugs(): void {
		...
		MainScreen.text("You sit back on a nearby rock and spread your " + LowerBodyDescriptor.describeLegs(player), false);
		if (player.lowerBody.balls > 0) MainScreen.text(", lifting your heavy sack out of the way", false);
		MainScreen.text(" to give Sophie a perfect view of your " + VaginaDescriptor.describeVagina(player, player.lowerBody.vaginaSpot.get(0)) + ".  Sophie's dull, somewhat glazed eyes brighten at the sight of your box, and she leans forward intently, dipping a digit into herself as she asks, \"<i>Ooh, can I, like, lick it for you?  It looks soooo yummy!</i>\"\n\n", false);

		if (player.stats.cor < 33) MainScreen.text("You nod nervously, blushing hotly at the thought of your bimbo-slut's fat lips kissing and lapping at your slit.", false);
		else if (player.stats.cor < 66) MainScreen.text("You nod and smile, blushing a bit in anticipation of feeling your bimbo-slut's fat, pussy-licking lips against your slit.", false);
		else MainScreen.text("You confidently smile and scoot your " + LowerBodyDescriptor.describeHips(player) + " forward, anticipating the feeling of your bimbo-bitch's fat, pussy-licking lips on your slit.", false);
		MainScreen.text("  Sophie just looks at you, her wide-eyed gaze never leaving your engorged labia.  After what feels like a full minute of her watching you, she finally remembers that a nod means 'yes', and she bounces up and down in excitement, clapping and cheering while her tits jiggle ludicrously.  She leans in close, nearly brushing her nose into your ", false);
		...
		//(ginormous clitties)
			...
			MainScreen.text("\"<i>It's... like, well... big!  Gosh, you're a big girl!  Mmm, you'll cum hard for Momma Sophie while I, like, suck on this fat pole, won't you?</i>\" teases the thick-bootied bird-bitch.\n\n", false);
			MainScreen.text("You shudder as the harpy resumes her oral onslaught, slurping your " + VaginaDescriptor.describeClit(player, player.lowerBody.vaginaSpot.get(0)) + " deep into her throat in one smooth plunge.  She hums in delight, licking over the feminine fuck-stick's lower portions while she tries to get her fat, soft puss-pillows closer to your juicy snatch.  You rock your hips forward to thrust your " + VaginaDescriptor.describeClit(player, player.lowerBody.vaginaSpot.get(0)) + " further inside your bimbo's neckhole.  She gurgles happily and lashes at your " + VaginaDescriptor.describeVagina(player, player.lowerBody.vaginaSpot.get(0)) + ", her tongue tracing trails of hot, sexual pleasure through your depths as her molten-hot throat milks you like no tomorrow.\n\n", false);
		}
		MainScreen.text("Sophie purrs with desire, and when you hear a distinctive wet squelching coming from something other than your pussy, you realize she's vigorously masturbating.  You crane your head over to get a view of the harpy's frenzied, pumping fingers, watching them disappear into her puffy, lust-reddened lips, as if by magic.  Sophie ", false);
		if (player.lowerBody.vaginaSpot.get(0).clitLength < 3) MainScreen.text("hums on your clit and doubles the speed of her licking while you watch her finger-fucking her sloppy cunt.", false);
		else MainScreen.text("pumps on your clit with her hand and doubles the speed of her lashing tongue while you watch her finger-fucking her sloppy cunt.", false);
		MainScreen.text("  The sight pushes you over the edge in a climax of body-shaking, muscle-locking proportions.  You seize up and ", false);
		if (player.lowerBody.vaginaSpot.get(0).vaginalWetness >= 5) MainScreen.text("squirt", false);
		else if (player.lowerBody.vaginaSpot.get(0).vaginalWetness >= 4) MainScreen.text("gush", false);
		else if (player.lowerBody.vaginaSpot.get(0).vaginalWetness >= 3) MainScreen.text("leak", false);
		else if (player.lowerBody.vaginaSpot.get(0).vaginalWetness >= 2) MainScreen.text("dribble", false);
		else MainScreen.text("drool", false);
		MainScreen.text(" fem-spunk all over Sophie's face, marking the bimbo with your love.  The horny harpy seems to be getting off on it as well, as she's moaning luridly into your labia, letting the fluid bubble up and muffle her outbursts.\n\n", false);

		MainScreen.text("You both fall back, winded, gasping, and a little delirious from the encounter.  The entirely of your groin is covered in a gold coating, shining with the harpy's lipstick and your own feminine moisture.  In a way, the sight is oddly entrancing.  Your " + VaginaDescriptor.describeVagina(player, player.lowerBody.vaginaSpot.get(0)) + " glitters in the light while the harpy's overly-thick lipstick sinks into your skin, filling your body with drugs designed to stimulate males.  ", false);
		if (!player.lowerBody.cockSpot.hasCock()) MainScreen.text("  It's a good thing you don't have a penis!", false);
		else MainScreen.text("You groan as your groin burns with desire, filling your " + CockDescriptor.describeMultiCockShort(player) + " with blood.  Images of yourself relentlessly fucking your bimbo bride pregnant over and over again fill your mind.  You shudder and blush, trying to resist the artificial needs pounding through your body, but you realize your body is ready.", false);
		MainScreen.text("\n\n", false);

		MainScreen.text("The ditzy blond giggles and tweaks her hefty nipples, cooing, \"<i>That was absolutely yummy!  Your puss is like, totally tasty.  Let's go again!</i>\"  You feel a little fucked out after the fantastic oral, and you decline.\n\n", false);

		MainScreen.text("Sophie retorts, \"<i>But I wanna fuck nooooooowwww!</i>\"  She pouts, sticking out her lower lip and saying, \"<i>Come on... look at my pussy... just look at it.  Can't you, like, see how fucking wet you've gotten me?  You know you wanna lick me... your tongue TOOOTALLY wants to taste my sweet honey-pot!</i>\"  The harpy spreads her legs so wide she's nearly doing a split, pulling her pussy-lips apart to show you just how wet you've made the puffy, pink entrance.  You've got to admit... it does look really nice.  Her words seem... heavy somehow, like they have an extra weight behind them.  You have a hard time finding fault with her logic - she sure would taste good right about now...\n\n", false);

		MainScreen.text("\"<i>Please?  I'll make you feel just as good as last time, maybe more.  Look at me, at my lips, would they lie to you?  I bet they'd feel soooo good back on your hot, wet cunny", false);
		if (player.lowerBody.cockSpot.hasCock()) MainScreen.text(", or thick, juicy dick", false);
		MainScreen.text(".  Come over here and sixty-nine me, baby!</i>\" cheers Sophie with a wiggle of her considerable hips.  Damn, her lips are sooo plump and sexy, and that ass - gods she's getting you wet ", false);
		if (player.lowerBody.cockSpot.hasCock()) MainScreen.text("and hard ", false);
		MainScreen.text("again!  You want to tackle her onto the ground and smash your crotch into her face!  Fuck, is she trying to use her compulsion on you? It's working!\n\n", false);
		player.orgasm();
		player.stats.sens += -1;
		sophieScene.luststickApplication(4);
		if (player.stats.int * 2 < player.stats.cor + player.stats.lib) {
			MainScreen.text("There's no way you could ever turn her down at this point... just look at her lips... they'd never lie to you.  It'll feel so good...", false);
	...
	private bimboSophieSixtyNineAfterCunnilingus(): void {
		...
		MainScreen.text("", true);
		//NON WANG
		if (!player.lowerBody.cockSpot.hasCock() || player.cockThatFits(sophieCapacity()) == -1) {
			MainScreen.text("You throw yourself at Sophie, compelled by thoughts of pleasure and her delicious-looking pussy, wanting nothing more than to place your lips on her cunt and slurp with reckless abandon.  She takes the hit like a champ, tumbling with you through the dirt and dust until you land on your " + ButtDescriptor.describeButt(player) + ", bouncing to a stop with the harpy's feathery thighs clenching around your head.  ");
			if (pregnancy.event >= 2) MainScreen.text("Her pregnant belly rests against your middle, untouched by the rough fall.  ");
			MainScreen.text("How did she do that?  Your questions fade away as you look up and spot your target - the cum-slicked delta of Sophie's cunt, so moist it seems to fog the air, beckoning you to plunge your tongue inside and taste it.\n\n", false);

			MainScreen.text("With rapacious desire, you grab the harpy's down-coated ass-cheeks and squeeze her plump rump, pulling her dripping cooch straight onto your face.  You shiver at the potent, womanly smell as it oozes over your " + HeadDescriptor.describeFace(player) + ", and dribbles down your chin.  Without a moment's hesitation, you take the first long lick of Sophie's tasty juices.  They have a tangy flavor that seems to sizzle on your tongue before fading into a soft, sweet, peach-like taste.  You hum in pleasure - the harpy was right; your tongue REALLY wants to taste her.\n\n", false);

			MainScreen.text("\"<i>Wow! You're so good at pussy-licking, babe,</i>\" declares Sophie, pursing her lips slowly and deliberately as she enunciates the rest of her statement, \"<i>Your tongue just can't get enough harpy pussy!  Ooooh yeah, you're totally the best cunny-licker I've like, ever had munch on my box!  Mmm, you love Momma Sophie's girl-cum, dontcha?  Yea-ah... lick lick lick!</i>\"  She giggles inarticulately after that, swiveling her hips to smear her leaking vagina all over your face.  You cram your " + HeadDescriptor.describeFace(player) + " further up Sophie's creamy quim and lick over and over, curling your tongue into every delicious nook and fold.\n\n", false);

			MainScreen.text("Sophie drops down onto her elbows, her ass-length blond plumage tickling at your " + LowerBodyDescriptor.describeLegs(player) + " as she examines your groin.  The slutty harpy leans over your gold-smeared crotch and gives your " + VaginaDescriptor.describeClit(player, player.lowerBody.vaginaSpot.get(0)) + " a kiss, her plush lips smothering the ", false);
			if (player.lowerBody.vaginaSpot.get(0).clitLength < 1) MainScreen.text("tiny ", false);
			MainScreen.text("organ in warm, oral bliss.  You moan into her sumptuous pussy and giggle when the vibrations set off a cascade of harpy cum.  Inspired, you begin to hum with every lick, the sound carrying up from your voice-box to turn your tongue into the bimbo's new vibrator.\n\n", false);

			MainScreen.text("The two of you attack each other's pussies in a frenzy of wanton need, slurping and moaning so loudly that the noise is likely carried a hundred yards away.  Sophie's pussy seems to grow even more delectable with every touch to your taste buds, if such a thing is possible.  Your moronic mate seems equally infatuated with your pussy, and she sucks your clit", false);
			if (player.lowerBody.vaginaSpot.get(0).clitLength >= 3) MainScreen.text(", even pausing to jack it off like a penis", false);
			MainScreen.text(" with hasty, need-filled strokes.  Eyes crossing, you suck and lick, swallowing great mouthfuls of bimbo-jizz in your haste to bring off the harpy.\n\n", false);

			MainScreen.text("Sophie parts her silken lips from your gold-glazed groin with a moist *pop*.  \"<i>You're totally great at licking pussy, babe!  Mmmmhmmm, just, like, keep doing it like that.  You'll mmm-make Momma Sophie cum in no time!  Make me cum, baby!  Oooh, does trying to make cum make you hot for my pussy?  You're gonna cum... I know it... you'll cum with me,</i>\" utters the bimbo bitch while she stirs your pussy with a finger, stroking around it and dragging her long nails over the sensitive flesh of your loins.  Her words hit you like a wave, and with renewed vigor, you thrust your entire tongue deep inside the harpy and rub your lower lip back and forth across her pleasure-bud.  Pulling hard on her hips, you orally ravage her cunt with no regard for anything around yourself, your body burning hot from how good it feels to get your pet off.\n\n", false);

			MainScreen.text("At long last, the bimbo's bald cunt climaxes from your work, splattering you with a flood of musky girl-spunk.  You still need her pussy so bad that you can't stop.  You lick, lap, and swallow with inhuman eagerness until the box atop you is emptied of everything save your saliva.  Then, and only then, do you finally feel release.  Your " + VaginaDescriptor.describeVagina(player, player.lowerBody.vaginaSpot.get(0)) + " climaxes for Sophie, soaking her fingers and wringing them as if your life depended on it.  She giggles, coming down from her own orgasm and feeling quite pleased with the effects her words have had on you.\n\n", false);

			MainScreen.text("The harpy gets up, but only long enough to turn around and lay atop you, face to face");
			if (pregnancy.event >= 2) MainScreen.text(", egg-swollen belly smushing between you");
			MainScreen.text(".  \"<i>That was sooo fun!  Like, we'll totally do this sometime soon, but I need a drink, and you smell like pussy.  Mmmm, I like that smell.  It means fun stuff!</i>\"  Sophie kisses you full on the mouth, her puffy, quim-stained lips coloring your own with her amber lipstick.  \"<i>You're like, the best pussy-licker ever, ya know?</i>\"\n\n", false);

			MainScreen.text("Sophie struts off, touching a finger to her cunt before licking it, tasting the remnants of your saliva.", false);
			sophieScene.luststickApplication(5);
			player.orgasm();
			player.stats.sens += -1;
		}
		//SixtyNine Continuation - DUDES
			...
			MainScreen.text("You throw yourself at Sophie, compelled by thoughts of pleasure and her delicious-looking pussy.  Imagining yourself placing your lips on her cunt and slurping with reckless abandon, you tackle her, hard.  She takes the hit like a champ, tumbling with you through the dirt and dust until you land on your " + ButtDescriptor.describeButt(player) + ", bouncing to a stop with the harpy's feathery thighs clenching around your head.  ");
			if (pregnancy.event >= 2) MainScreen.text("Her gravid belly bumps up against your own, somehow untouched by the rough-and-tumble fall.  ");
			MainScreen.text("How did she do that?  Your questions fade away as you look up and spot your target - the cum-slicked delta of Sophie's cunt, so moist it seems to fog the air, beckoning you to plunge your tongue inside and taste it.\n\n", false);
			...
			MainScreen.text("Sophie drops down onto her elbows, her ass-length blond plumage tickling at your " + LowerBodyDescriptor.describeLegs(player) + " as she examines your groin.  The slutty harpy leans down over " + oMultiCockDesc() + " and gives it a gentle squeeze, staring down at the pulsating penis with a rapt, attentive gaze.  \"<i>Mmmm, such a yummy dick!  Did it, like, get this super-hard for lil' ol me?  Oh, that's so cute babe!  Just lie back and lick while Momma Sophie gets all the sticky, stinky ol' cum out of you!</i>\"\n\n", false);

			MainScreen.text("The air-headed harpy rubs one of her long, manicured-looking nails over your urethra, teasing your poor " + CockDescriptor.describeCock(player, x) + " with persistent touches.  You cry out in bliss, your straining voice muffled by the heavenly coochie oozing over your face, though the cries of passion lend your tongue a vibrating quality that seems to please her compelling cunt greatly.  It releases a wash of juice onto your tongue and mouth, giving you more of the peaches-and-tang taste that you've come to crave.  Sophie's cunt tastes so good, you've got to get more!\n\n", false);

			MainScreen.text("You squeeze her jiggly, bimbo-sized ass-cheeks and cram her cunt harder against your lips.  MORE!  You've got to taste her more!  You lash at her pink pussy wildly, throwing your tongue around in a frenzy of whip-like licks.  Meanwhile, Sophie moans and bends down to curl her thick lips around your pre-cum-pulsing prick.  She's so warm that it feels like your cock is melting between those plush, painted pillows.  The bimbo circles her tongue over your slick dick-tip, firing constant bolts of hellish pleasure up your shaft.  Slurping noisily, she begins to suck as well, and her cheeks hollow from the effort of trying to vacuum the cum straight from your " + CockDescriptor.describeCock(player, x) + ".\n\n", false);

			MainScreen.text("The bimbo's mouth is like your own personal heaven.  As she continues to fellate you, you can feel your " + player.skin() + " blushing and your heart hammering from the influx of chemicals.  Sophie's smothering your " + CockDescriptor.describeCock(player, x) + " in caramel-hued drugs, but you're already too far gone to care.  Her mouth feels so good, her pussy tastes even better, and you couldn't stop licking even if you wanted to.  Your tongue... it just can't get enough of that wonderful duff.  It's so good... so tasty.  You keep licking as hard you as can, your oral organ aching to stay buried in the sloppy wet box, even though it's already pushed as far inside as you can manage.\n\n", false);

			MainScreen.text("Sophie pops your " + CockDescriptor.describeCock(player, x) + " out with a lurid moan, ignoring the strands of gold saliva connecting her to your crotch.  \"<i>So yummy!  Did I ever tell you that your dick is, like, the best tasting thing?  It dripped some of your icing all over my tongue and it was soooo good.  Hurry up and give me more - squirt it all over my lips and tongue!  Cover me in your love babe, and like, don't stop licking!</i>\" she commands.\n\n", false);

			MainScreen.text("As her imperatives roll through you, you shudder and shake.  " + OMultiCockDesc() + " immediately releases a dollop of pre-cum, and Sophie dives down on it like an addict seeking her fix.  The return of her drugged suction is nearly too much for you, and you feel your " + CockDescriptor.describeCock(player, x) + " swelling in her mouth, the " + player.cockHead(x) + " thickening against her hungry tongue.  She shakes on top of you and releases another wave of syrupy fluids.  You swallow a mouthful, compulsively drinking her prodigious pussy's copious lady-spunk.  Your back arches, your " + LowerBodyDescriptor.describeLegs(player) + " clench, and you erupt inside your bimbo's puckered, sucking mouth-hole, giving her tonsils a bath of your creamy semen.  Rivulets of semen run over her juicy lips as you cum too fast for her to keep up with.", false);
			if (player.cumQ() >= 500) {
				MainScreen.text("  She gulps and swallows as fast as possible, but cum starts oozing from her nose, dripping from the corners of her mouth, and spurting back out around your " + CockDescriptor.describeCock(player, x) + " to spatter your groin.", false);
				if (player.cumQ() >= 1000) MainScreen.text("  After a moment of this, the full-bellied harpy pulls back and lets you paint the remainder over her face, hair, and mountainous breasts.", false);
			}
			MainScreen.text("\n\n", false);

			MainScreen.text("Sophie gives an airheaded giggle and jumps up, ignoring the slosh of your sexual fluids in her belly");
			if (pregnancy.event >= 2) MainScreen.text(" and the way her egg-stuffed womb jiggles");
			MainScreen.text(".  Shining in the light, a web of harpy-lube stretches between her groin and your soaked face.  You try to sit up and get your tongue back where it belongs, inside her, but she steps one of her clawed feet down on your chest to playfully pin you to the ground.\n\n", false);

			MainScreen.text("The blond bombshell titters, \"<i>Like, you don't need to lick my cunny any more, babe. You were totally awesome and got me off super hard.  And you did such a good job cumming for me too!  Just relax there a moment, I'm gonna get a drink or something.  Let's do this again soon!</i>\"\n\n", false);

			MainScreen.text("Sophie leans down to kiss you on the lips, smearing more of her lust-enhancing lipstick over your mouth.  " + CockDescriptor.describeMultiCockSimpleOne(player, true) + " stays hard as a rock, but the need to service her pussy with your tongue slowly fades.  You feel oddly sated in spite of your erection, yet you know that a peek at your vapid harpy mistress will likely throw you into a rutting frenzy all over again thanks to the properties of her lipstick.", false);
			player.orgasm();
			player.stats.lib += 1;
			player.stats.sens += -1;
			sophieScene.luststickApplication(5);
	...
	private buttFuckBimboSophie(): void {
		...
		let x: number = player.cockThatFits(sophieCapacity());
		if (x < 0) x = player.smallestCockIndex();
		MainScreen.text("You instruct your bimbo bitch to bend over and show you that rounded rump that you keep her around for.  She leans away from you, her ass high in the air with tail feathers fluffing, and she cluelessly asks, \"<i>Ummm, like this, babe? Or this?</i>\"\n\n", false);

		MainScreen.text("The bimbo bounces her backside back and forth, making her heavy cheeks jiggle a few inches away from you.  Winking between them, Sophie's puckered anal star and juicy, dripping pussy seem to beckon for your " + CockDescriptor.describeMultiCockShort(player) + ", but you just watch for now, enjoying the sight of such a gorgeous ass jiggling and shaking for you.  After a moment she asks, \"<i>Or did you mean like this?</i>\"  The harpie flexes her thighs and begins to bounce her ass up and down to a vigorous, butt-shaking rhythm no one but your slut can seem to hear.  Your eyes sway up and down, following the glorious, heart-shaped mass on its ballistic trajectory while " + CockDescriptor.describeMultiCockSimpleOne(player) + " becomes hard and completely ready to claim that bouncy butt.\n\n", false);

		MainScreen.text("Stepping closer, you toss off your " + player.inventory.armor.displayName + " and reply, \"<i>Yes, just like that.</i>\"\n\n", false);

		MainScreen.text("Sophie claps her hands and gives a girlish squeal of happiness. \"<i>Really?  C-can I like, do this a little closer?  ", false);
		if (player.lowerBody.cockSpot.count() > 1) MainScreen.text("Those cocks look", false);
		else MainScreen.text("That cock looks", false);
		MainScreen.text(" delic... de... yummy!</i>\"  You slap her ass, grab her tail feathers, and pull the harpy's winking asshole down onto your " + CockDescriptor.describeCock(player, x) + ". Her voices rises, not in anger, but in delight, and your " + player.cockHead(x) + " pulses pleasantly in the first few inches of the harpy's rectum.  The bimbo relaxes and sinks down, giggling and asking, \"<i>Is-ooh-is my butt, like, good for you?  It's soooo tight, and it's making my cunny all wet and stuff!</i>\"\n\n", false);

		MainScreen.text("You squeeze her shuddering rump hard enough to feel her flesh bulging out around your fingers, the soft cheeks nearly subsuming your hands, and then you pull her hard, dragging your " + CockDescriptor.describeCock(player, x) + " the rest of the way inside her, all the way to the ", false);
		if (!player.lowerBody.cockSpot.hasSheath()) MainScreen.text("hilt", false);
		else MainScreen.text("sheath", false);
		MainScreen.text(".  Sophie's breasts sway underneath her, the pendulous globes occasionally dipping low enough to drag her thumb-sized nipples through the rough dirt.");
		if (pregnancy.event >= 2) MainScreen.text("  Just like her breasts, her gravid tummy sways a little as well, plush with the weight of the egg you've given her.");
		MainScreen.text("  The bimbo moans harder every time it happens and sounds more whorish and lurid with each passing second - a true anal slut.  She looks back at you with lust in her eyes and a gleeful grin on her face.  Suddenly, one of the ditz's fingernails is dragging ", false);
		if (player.lowerBody.balls > 0) MainScreen.text("over your " + BallsDescriptor.describeBalls(true, true, player), false);
		else MainScreen.text("across your taint", false);
		MainScreen.text(".  It works its way down, crosses the joining of your bodies, and reaches its owner's pussy, circling the puffy lips until a long strand of girl-goo is dangling down towards the ground.\n\n", false);

		MainScreen.text("\"<i>So... good.  Why didn't anyone tell me that butt-sex is like, super-duper fun?</i>\"  The breathless bimbo rocks her ass back and forth, and you let her have her 'fun'.  She's wiggling and squirming, impaled on a cock and loving it.  You simply relax and let her go to town, the bimbo's fingers running through her sodden box in time with the butt-jiggling contortions of her body.  Her anus milks your " + CockDescriptor.describeCock(player, x) + " like a machine, drawing out thick streamers of pre-cum to make her ass almost as sloppy as her pussy.  It's hard to stand still with her working you so efficiently, and after a few moments of allowing your bimbo to pleasure you with her plump rump, you tire of waiting.\n\n", false);

		MainScreen.text("Pushing her away, you unsheath most of your " + num2Text(Math.round(player.lowerBody.cockSpot.get(x).cockLength)) + " inches from Sophie's stretched asshole, leaving just your " + player.cockHead(x) + " to hold the rectal portal open.  She whines in disappointment until you lunge forward and stuff her full of dick so suddenly that she squirts dribbles of lube.  You grab her hair with one hand and ride her ass hard and fast, each thrust punctuated by happy squeals of submissive pleasure from your airheaded anal toy.  Sophie cheers, \"<i>Fuck me " + player.mf("stud", "babe") + ", fuck my ass!  Unh, y-yeah like that.  Mmmm, yeah, pull my hair and tell me what a bad girl I've been!</i>\"\n\n", false);

		MainScreen.text("Gods, she's such a naughty little bird bitch!  You yank her hair back and lean over her shoulder, whispering, \"<i>You like that, you brain-dead bimbo?  Look down at all the juices raining from your cunt.  Would anyone but a horny slut get off so hard from having her ass reamed?  I don't think so.</i>\"\n\n", false);

		MainScreen.text("You keep butt-fucking her hard and fast, ignoring the sprinkles of sticky, maternal harpy-juice that splatter on your " + LowerBodyDescriptor.describeLegs(player) + " as you fuck her.  In between throaty moans and screams, she bellows out \"<i>YES!</i>\" as loudly as possible, then lapses into quiet, exhausted grunts.  Yet, her vagina does not stop its prodigious leaking; if anything it's dripping and squirting out even heavier flows of submissive girl-spooge.  The harpie's anal ring is convulsing around you, reduced to pointless trembling from the hard fucking you're giving her.  Looking back with lidded eyes, she begs, \"<i>C-cum... cum in my ass... it'll... it'll feel soo good, babe.  Please?  Like, gimme your spooge!</i>\"\n\n", false);

		if (player.lowerBody.balls > 0) MainScreen.text("Your balls seize up at Sophie's request, and you swear you can actually hear the fluid churning and sloshing of your cum before it burns a path of warmth through your body.", false);
		else MainScreen.text("Your insides seem to seize up at Sophie's request, and you swear you can actually feel the fluid churning a path of warmth through your body.", false);
		MainScreen.text("  Seed spews from your " + CockDescriptor.describeCock(player, x) + " into your bimbo's blubbery bottom with an audible gurgle that brings a blush to her cheek.  You pull her hair harder and bounce your " + LowerBodyDescriptor.describeHips(player) + " off her bottom a few times, injecting the rest of your cum inside her while you rut at her now-sloppy anus.", false);
		if (player.cumQ() >= 500) {
			MainScreen.text("  Even though your semen is frothing and spurting from between her cheeks with each push, you keep at it", false);
			if (player.cumQ() >= 1000) MainScreen.text(", filling her belly with spooge", false);
			MainScreen.text(".", false);
		}
		MainScreen.text("  With a few final clenches of pleasure, your dick's flow of cum trickles down to a dribble.  You sigh and muse that you must've completely emptied your " + BallsDescriptor.describeBalls(true, true, player) + " by now, and you slump back against a rock to watch your jizz flood out of Sophie's ass.  She pushes some inside her pink nether-lips with a triumphant smile, clearly pleased with herself.\n\n", false);

		MainScreen.text("Still full of energy, the big-tittied ditz bounces around and catches the cum as it drains from her gaped ass, shoving more and more into her soaked quim.  She even licks her fingers once she bores of that and says, \"<i>Thanks for making my asshole so creamy!  You even left me enough to like, stuff up my twat so I can have an egg!  Yay!</i>\"\n\n", false);
		if (pregnancy.event >= 2) {
			MainScreen.text("Sophie giggles again, rubbing her already well-filled belly and winking at you, like you're sharing in some absurd joke.  You roll your eyes - bimbos!");
		}
	...
	private fuckBimboSophiesTits(): void {
		...
		let x: number = player.cockThatFits(sophieCapacity());
		if (x < 0) x = player.smallestCockIndex();
		MainScreen.text("You grab Sophie's tits in a squeezing grip and pull her towards you, flicking your thumbs across the bimbo's nipples.  She stumbles toward you and purrs, \"<i>Who's being forward now, huh?  If you wanted to play with Momma Sophie's tits, all you had to do was, like, ask!</i>\"\n\n", false);

		MainScreen.text("The harpy grabs at your " + player.inventory.armor.displayName + " and removes it, leaving your hands free to continue the fondling of her breasts.  Once you're as a nude as your salacious slut, you finally release the huge, watermelon-like breasts and admire your handiwork.  Sophie's ditzy, empty eyes are dilated, her mouth is open and drooling, and her nipples are easily as big as your thumbs.  She's panting softly and just staring at you with her eyes glazed.  You can only assume that her simple mind has slipped into some kind of erotic trance, but if anything it only makes the idea of releasing yourself with her big, soft mammaries that much more appealing.\n\n", false);

		MainScreen.text("You grab hold of her nipples and sit down on a nearby rock; the dazed harpy is pulled onto her knees.  ");
		if (pregnancy.event >= 2) MainScreen.text("Her swollen tummy pushes against your [legs] as she assumes the position, the weighty egg-distorted lump pressing against you.  ");
		MainScreen.text("She wobbles forward and her massive mounds easily slide to either side of " + oMultiCockDesc() + ", completely engulfing it.  Still holding on to her nipples, you pull them together and ", false);
		if (player.lowerBody.cockSpot.get(x).cockThickness < 8) MainScreen.text("completely surround yourself", false);
		else MainScreen.text("surround as much of yourself as possible", false);
		MainScreen.text(" in warm, smooth skin.  The smell of your " + CockDescriptor.describeCock(player, x) + " mere inches from her nose seems to startle Sophie from her trance, and she breaks into a smile so big you'll worry it'll break her face.\n\n", false);

		MainScreen.text("\"<i>Wh-what's going o-mmmmmm, that looks nice!  Oooh, and it's already in Momma Sophie's big ol' titties!  Yay!  Like, do you mind if I give it a kiss?</i>\" asks the bimbo with a cross-eyed, dick-addicted look on her face.  You nod your assent and lean back, feeling quite pleased with how this is working out.\n\n", false);

		MainScreen.text("Suddenly, Sophie's puckered lips are on your " + player.cockHead(x) + ", sucking it softly while her tongue tickles the sensitive slit of your urethra.  She pops off for a breath with a lusty look in her eyes and spit drooling from the corner of her puffy lips to lubricate her tits.  A golden lip print sits around the circumference of your " + CockDescriptor.describeCock(player, x) + ", marking just how much she's managed to smother in oral pleasure.  Pulling her hands up, she presses her palms into the heavy weight of her breasts, nearly vanishing from view as she drags them up your " + num2Text(Math.round(player.lowerBody.cockSpot.get(x).cockLength)) + "-inch length.  Her drugged lipstick makes your " + player.cockHead(x) + " tingle deliciously, and you sigh, happy to have such glorious udders growing from your bleach-blonde bitch.\n\n", false);

		MainScreen.text("Full, slippery lips slide back around you again, further staining your " + CockDescriptor.describeCock(player, x) + " in their amber gloss.  It's enough to make you swoon and flare, growing thicker inside her smothering mounds while she pumps at you with her tits.  Sophie croons in between sucking on your dick-tip, saying, \"<i>Mmm, such a yummy cock!  Let my tits like, milk out all that yummy cum from your cock, okay babe?</i>\"\n\n", false);

		MainScreen.text("You demur and start pumping your hips.  The bimbo shakes her platinum-blonde feathers in irritation, but she doesn't dare stop you now.  You grab her tits as well, lifting them out of her grip as you begin to fuck them in earnest, your cock cresting through the massive cleavage with each stroke.  Sophie smiles dopily, rapidly forgetting her unhappiness at being so thoroughly manhandled, and she returns to worshipping your " + player.cockHead(x) + " each time it comes anywhere near her mouth.  Spit and golden lipstick drool down her cleavage, and soon your rod looks like a golden spear of lust, trembling in the pale valleys of your bimbo slut's mountainous peaks.\n\n", false);

		MainScreen.text("Closing your eyes, you revel in bliss, utterly satisfied by the surging pleasure of having your cock smothered in fertility-enhancing drugs while it's tit-fucking a motherly harpy's giant breasts.  A simple, breathy voice begs, \"<i>Please cum for me... let out all of that fun stuff on my titties and slutty, cock-slurping lips.  Like, paint me with your seed, I wanna be your fat-bottomed harpy slut!</i>\"\n\n", false);

		MainScreen.text("One of the dumb blonde's hands circles under her bouncing, jiggling chest to stroke your " + CockDescriptor.describeCock(player, x) + ", jacking you off with the spit, sweat, and drugged gloss as lubricants.  She jerks you hard and fast, smearing it ", false);
		if (player.lowerBody.balls > 0) MainScreen.text("all over your balls whenever she needs a break, and you feel your " + BallsDescriptor.describeBalls(true, true, player) + " growing heavier by the moment.", false);
		else MainScreen.text("all over your taint and asshole, and you feel your body churning, building up more seed for your moronic mate.", false);
		MainScreen.text("  " + CockDescriptor.describeMultiCockSimpleOne(player, true) + " thickens and bloats, a rush of warmth rushing up the base as your internal muscles clench tight, squeezing out a globby rope of jism.  It explodes from your cum-slit, taking Sophie full on the face.\n\n", false);

		MainScreen.text("You're just getting started.  Sophie smirks and opens her mouth, letting her tongue slide out to taste your jizm as you launch the next rope, so long it trails from her hair to her chin and so thick it rolls in drops from the side of her face.  She hums in delight and squeezes her breasts tight around your " + CockDescriptor.describeCock(player, x) + ", the next blast backing up inside you from the pressure.  A moment of buildup later, and your seed germinates and blooms over the harpy's tits, soaking them with spunk.  Droplets of the stuff splatter onto the ground around the both of you, but you just keep coming.  In your mind you have visions of yourself knocking up harpy after harpy, the slutty bird-girls mounting your fountaining fuck-stick long enough for their bellies to bloat with seed before moving on.  Like this, you could inseminate a whole tribe...\n\n", false);

		MainScreen.text("Once the thought passes, you sag back, utterly spent and more than a little parched.  Blinking the haze from your eyes, you look over at Sophie.  She's on her back, frigging herself non-stop and utterly lost to the world.  Her pretty blonde hair is plastered against her, her boobs are covered in a thick layer of white, ");
		if (pregnancy.event >= 2) MainScreen.text("her swollen midriff is glazed, ");
		MainScreen.text("and her eyes are closed, held shut by a thick layer of your sperm.  She's been well and truly bukkaked, drenched in ejaculate, and judging by how furiously she's schlicking away at her pussy, she couldn't be happier.  As for you, " + CockDescriptor.describeMultiCockSimpleOne(player) + " is still erect, even though you feel like you don't have a drop left in you.  Of course, the drugs soaking into your gold-tinted cock will probably keep you hard and ready to breed for hours.\n\n", false);
		sophieScene.luststickApplication(5);
		player.orgasm();
		player.stats.sens += -1;
		doNext(camp.returnToCampUseOneHour);
	...
	private rideDatSophieVag(nice: boolean = false): void {
		...
		if (player.stats.cor <= 50) nice = true;
		if (nice) {
			MainScreen.text("Before you can decide what, exactly, you're going to do with your harpy slut, Sophie jiggles her way over to you, the insides of her thighs dripping with every step.  You watch as the plump bird wobbles, too aroused and too damn big to walk straight, but eventually she does manage to make it to you.");
			if (pregnancy.event >= 2) MainScreen.text("  Her pregnancy-imbued middle doesn't really help, either.");
			...
			MainScreen.text(" in your [armor] - and starts to finger herself as she watches to see what you'll do, her wet folds easily parting for her randy, exploring fingers.");
			...
			MainScreen.text("\n\n\"<i>So then,</i>\" you coo, reaching down and grabbing your " + CockDescriptor.describeCock(player, x) + ".  You give it a few strokes, enjoying the feeling of your cock between your fingers, and then angle it so the tip is rubbing directly against Sophie's gushing cunt, the bird herself begging you with her eyes.  You let go of her other breast to rub a downy-feathered thigh, and she bites her lip as you chuckle.");

			MainScreen.text("\n\n\"<i>Ready?</i>\" you ask her, prodding your tip against her entrance.  She opens her mouth to answer - and you shove in all at once, enjoying the way her voice hikes up a couple of octaves as she moans in sheer pleasure.  Her soppy cunt squeezes down on your " + CockDescriptor.describeCock(player, x) + ", the internal muscles desperately trying to work you, but you give them little room to do so; you instead pull right back out, watching as Sophie's arms - freed from your grip - reach out to try and tug you back in.");
			...
			MainScreen.text("\n\nYour hips turn into a staccato of smacks and slaps as you help Sophie thrust against your constant pounding, her walls trying their very damnedest to milk your " + CockDescriptor.describeCock(player, x) + " of its seed, and her feathery arms run across your back as she lets out another squawky moan - and then her body seizes up.");
			...
			if (player.lowerBody.balls > 0) MainScreen.text("your [balls] bouncing and slapping against what parts of Sophie's bubble butt they can reach, ");
			MainScreen.text("and you start to grunt and moan with each movement of your hips as you get close.  Sophie picks up on it as well, her eyes lighting up as she drools, and her back-rubbing arms pull you against her.");
		...
		if (player.lowerBody.cockSpot.count() == 1) {
			...
			//{if (cocks >= 2) and (cumHigh = true)} 
				...
				if (player.lowerBody.cockSpot.count() == 3) MainScreen.text(", along with your third length, spittling and spraying onto her belly.");
				else if (player.lowerBody.cockSpot.count() > 3) MainScreen.text(", along with the rest of your cocks, your entire mass of lengths getting your seed all over her.");
				if (player.lowerBody.cockSpot.count() == 2) MainScreen.text(".");
				MainScreen.text("  Sophie shudders and sighs, rubbing your [hair] with her hand, and you hear her breathe a \"<i>Thank you...</i>\"");
			}
		...
		if (player.lowerBody.vaginaSpot.hasVagina()) {
			...
			else MainScreen.text("dripping and drooling ");
			MainScreen.text("with its own juices; you barely notice it over the orgasm from your male half, but, as you readjust your position, the slickness dripping down your thighs is unmistakable.");
		}
		...
		if (pregnancy.event >= 2) MainScreen.text("resting your head on her gravid tummy and smiling to yourself.");
		else MainScreen.text("hugging her tight as she tries her best to show her appreciation.");
		if (sophieIsInSeason()) sophiePregChance();
		player.orgasm();
		player.stats.lib += .5;
		player.stats.sens += -4;
		if (!nice && player.stats.cor < 50) player.stats.cor += 1;
		sophieScene.luststickApplication(5);
		doNext(camp.returnToCampUseOneHour);
	}
	...
	private sophieImpregnationSex(): void {
		let x: number = player.cockThatFits(sophieCapacity());
		let y: number = player.cockThatFits2(sophieCapacity());
		if (x < 0) x = player.smallestCockIndex();
		MainScreen.clearText();
		sophieSprite();
		MainScreen.text("Hurriedly undressing, you realize she's right- you really do want to slide [oneCock] through that gilded entrance and cum until she's completely and utterly impregnated.  Deliciously, your [armor] tugs [eachCock] down, then in a moment of pure, unadulterated release, your tip");
		if (player.lowerBody.cockSpot.count() > 1) MainScreen.text("s come");
		else MainScreen.text(" comes");
		MainScreen.text(" free of the offending garment's edge and snap");
		if (player.lowerBody.cockSpot.count() == 1) MainScreen.text("s");
		MainScreen.text(" up, proud and erect.  ");
		if (player.lowerBody.cockSpot.count() == 1) MainScreen.text("It wobbles");
		else MainScreen.text("They wobble");
		MainScreen.text(", ");
		if (player.lowerBody.cockSpot.count() > 1) MainScreen.text("each ");
		MainScreen.text("bouncing up and down.  Sophie's eyes never leave the bobbing erection");
		if (player.lowerBody.cockSpot.count() > 1) MainScreen.text("s");
		MainScreen.text(".  She seems in a complete cock-trance, licking her glossy make-up soaked lips without meaning to.  You grab hold of ");
		if (player.lowerBody.cockSpot.count() > 1) MainScreen.text("one of your lengths");
		else MainScreen.text("your length");
		MainScreen.text(" and shake ");
		if (player.lowerBody.cockSpot.count() == 1) MainScreen.text("it");
		else MainScreen.text("them");
		MainScreen.text(", startling the dazed bimbo from her vacuous stare.");
		...
		MainScreen.text("\n\nYour hands find their way to just above the flare of the bird-brained girl's waist and begin to pull her down with each piston forward you make, forcing her to meet you halfway.  You pound Sophie's twat like a jackhammer, fluids squirting out with each booty-shaking cunt-stuffing thrust you dish out.  Your " + CockDescriptor.describeCock(player, x) + " feels so sensitive, so hard that her slit feels like a molten pleasure-sleeve");
		if (player.lowerBody.cockSpot.count() > 1) {
			MainScreen.text(", and the extra");
			if (player.lowerBody.cockSpot.count() > 2) MainScreen.text("s between her thighs are");
			else MainScreen.text(" between her thighs is");
			MainScreen.text(" likewise in heaven, slowly gathering more of the drug as some of it drips down with the tide of her vaginal juices");
		}
		MainScreen.text(".  Sophie cums repeatedly around you, wiggling her butt in circular motions in between each orgasm to spur you on.  It works.  Her cunt is like a cock-vacuum - no matter how you move, it sucks you back inside, to a heaven of pleasure that you can no longer resist, or care to.");

		MainScreen.text("\n\nEvery ounce of strength in your body diverts to stuffing your " + CockDescriptor.describeCock(player, x) + " as far into Sophie's sodden, drug-inducing pussy as possible, ramming so hard into her that she gives a chirp of half-pleasure, half-pain.  Your dick");
		if (player.lowerBody.cockSpot.count() > 1) MainScreen.text("s swell");
		else MainScreen.text(" swells");
		MainScreen.text(" with the onset of your release");
		if (player.lowerBody.balls > 0) MainScreen.text(", and your [balls] begin to rhythmically pulse in your [sack]");
		else MainScreen.text(", something inside you begins to clench rhythmically");
		MainScreen.text(".  Sophie's pussy stretches around your increasing thickness, dripping its amber honey");
		if (player.lowerBody.cockSpot.count() > 1) MainScreen.text(" over your extra, thigh slapping cock");
		if (player.lowerBody.cockSpot.count() > 2) MainScreen.text("s");
		MainScreen.text(".  Responding, the warm ecstasy inside you rushes out in a tremendous spurt, squirting globs of thick white cum into the harpy's receptive cunt again and again.");
		if (player.lowerBody.cockSpot.count() > 1) MainScreen.text("  Ropes of creamy spunk drizzle over the ground and the underside of Sophie's tits, but the lust-drunk harpy doesn't seem to mind any more than you do.");
		MainScreen.text("  Her hungry twat drinks down the seed with gusto, drawing it out of you even as it milks you for more.");
		if (player.cumQ() >= 500) MainScreen.text("  You give her exactly what she wants, drowning her pussy with jism.");
		if (player.cumQ() >= 1000) MainScreen.text("  Alabaster spooge oozes out of her lips after you stuff her womb full, dripping down your [legs] and her own feathery thighs.");
		if (player.cumQ() >= 2000) MainScreen.text("  The ground quickly becomes a salty quagmire that Sophie's hands are sinking into.");
		if (player.cumQ() >= 5000) MainScreen.text("  Soon, those droplets become thick gouts, as your immense virility asserts itself.  You hold her there, letting her belly balloon underneath you as you forcefully inseminate her, flooding her with hot seed.");
		...
		if (player.lowerBody.cockSpot.count() > 1) {
			MainScreen.text("  Her thighs seem almost sad to let your extra manhood");
			if (player.lowerBody.cockSpot.count() > 2) MainScreen.text("s");
			MainScreen.text(" escape as well.");
		}
		if (player.hasKnot(x)) MainScreen.text("  The thickness of your swollen, canine knot makes pulling out harder than you thought, and you wind up rocking back and forth while you keep drizzling into her, letting the engorged mass deflate slowly as you fill her womb further with canine seed.  Eventually, with a wet 'POP', you're freed, leaving Sophie nice and gaped, like a good, well-bred bitch.");
		else MainScreen.text("  You slip out with a lurid 'schluuuuck', leaving Sophie a nice messy, well-fucked wreck of a harpy.");
		MainScreen.text("  Sophie shudders, confused eyes looking back at you.  She whimpers, \"<i>Noooo, fuck me again!</i>\"");

		MainScreen.text("\n\nYou shift position slightly, grabbing a fistful of her expansive ass for leverage, that bouncy bimbo-butt allowing your fingers to sink into its supple flesh, giving in to your fingers perfectly as you pull them apart - giving your cum-slick dick a perfect path to her unadulterated pucker!  You push your " + CockDescriptor.describeCock(player, x) + " against her backdoor immediately.  There's a moment of resistance, then Sophie relaxes, and all the spunk, girl-lube, and slippery aphrodisiac covering your cock helps you to slide into her yielding ass chasm with ease.");
		if (y >= 0) MainScreen.text("  A sinful tightness clenches your " + CockDescriptor.describeCock(player, y) + " at the same time.  You accidently started double penetrating her!  The sloppy vaginal heat around your second member is enough to make you forget that it was even an accident.");
		MainScreen.text("  You push on, reveling in the tight clenching of her anal ring as it passes over every inch of cock, squeezing you like a slippery cock-ring as you nestle deeper into the harpy's plump bottom");
		if (player.cumQ() >= 1000) MainScreen.text(" and sperm-oozing pussy");
		MainScreen.text(".");

		//NO DP:
		if (y < 0) MainScreen.text("\n\nSophie moans, \"<i>Hey...you can't - ungh - get me pre... preggers like that!</i>\"");
		...
		if (y >= 0) MainScreen.text(" and pussy");
		MainScreen.text(" with confident, sure strokes.  Your answer, never spoken aloud, becomes evident by your actions: she got you this horny, and you're going to impregnate every hole, no matter how long it takes.  Her asshole is tight, almost <i>too tight</i> after having experienced her pussy, and you can feel the next batch of cum already beginning to churn in your [balls], a heavy, warm weight growing larger and larger.");
		...
		MainScreen.text(" revealed briefly to the cold air before ");
		if (y < 0) MainScreen.text("it's ");
		else MainScreen.text("they're ");
		MainScreen.text("devoured by the hot, enveloping anal entrance ");
		if (y >= 0) MainScreen.text("and squeezing pussy ");
		MainScreen.text("all over again.");
		...
		if (player.tallness >= 74) MainScreen.text("nipping her ear");
		else if (player.tallness >= 60) MainScreen.text("nipping at her shoulder");
		else MainScreen.text("nipping at her side");
		MainScreen.text(" as you answer, \"<i>Yes.</i>\"  Her breasts feel softer than her pillowy buttcheeks, which even now are squishingly running over your hips and [legs], smothering you in soft warmth while her innards milk your member");
		if (y >= 0) MainScreen.text("s");
		MainScreen.text(".  You roughly squeeze her breasts, too focused on the climax slowly building within your compressed crotches to be gentle.  Her breasts bounce and jiggle around your ministrations.  Her nipples, hard as lead bullets, are like magnets for your exploratory fingertips, and soon you lock onto them, squeezing and tugging, kneading them with each bounce for encouragement.  Sophie screeches as she bottoms out, pushing herself back against you, noisily cumming, her juices ");
		if (y < 0) MainScreen.text("spraying across your [legs]");
		else MainScreen.text("running down your " + CockDescriptor.describeCock(player, y) + " in miniature rivers");
		MainScreen.text(" messily.  The explosion of sloppy lady-spunk accompanies convulsive anal clenching, and with a hard pinch on her nipples, you give yourself over to the unnatural lusts coursing through your bloodstream again.");
		...
		if (y >= 0) MainScreen.text("s");
		MainScreen.text(".  She wraps her arms behind herself to hold onto you affectionately.  Again and again, you blast rope after rope of spunk into her plush heiny.  ");
		if (y >= 0) {
			MainScreen.text("At the same time, you make her cunt even creamier");
			if (player.cumQ() >= 1000) MainScreen.text(" and her belly even more distended");
			MainScreen.text(".  ");
		}
		MainScreen.text("There's no stopping your orgasm - it may even be more potent, more virile than the one before!  Sophie simply rides it out, gushing her girlspunk out all over you.");
		if (player.cumQ() >= 500) {
			MainScreen.text("  Her gut rumbles as you fill more and more of her intestines, eventually ");
			if (player.cumQ() < 1000) MainScreen.text("giving her a");
			else MainScreen.text("adding to her visible");
			MainScreen.text(" cum-paunch.");
			if (player.cumQ() >= 1500) {
				MainScreen.text("  Soon, the cum is squirting out around you");
				if (player.hasKnot(x)) MainScreen.text("r knot");
				MainScreen.text(".  You've filled every inch of her intestines with cum, and there's simply nowhere for your fresh, virile squirts to go but out!");
			}
		}
		MainScreen.text("  The harpy goes limp in your arms, still dribbling from her cunt as you continue to sate yourself on her rump and nipples.");
		...
		MainScreen.text("\n\nLicking her lips, Sophie chants, \"<i>Just one more, in my pussy, please?  Please, cum in my pussy again!</i>\"  She goes on like this, asking, begging, and even pleading as she pivots to place her plump, cum-soaked mound back on your " + CockDescriptor.describeCock(player, x) + ".  The silken vice fits you as snugly as a tailor-made glove.  She immediately begins to bounce it up and down, looking over her shoulder to watch your face as the waves of sensation overpower your resistance, breaking down your conscious thoughts.  You cum promptly, squirting a long rope of pleasure in on top of all the sperm you've already deposited.  She bounces, forcing more of that ecstasy through your " + CockDescriptor.describeCock(player, x) + ", laboring messily atop you in a display lascivious enough to make a whore blush.  Every upstroke of her velvet walls along your shaft earns her all the cum your accelerated reproductive system can offer up since the last downstroke, weak spurts of little bearing, but still an extra dose of cream for her twat.");

		MainScreen.text("\n\nYou fall back, eyes rolling wildly, moaning uncontrollably.  Consciousness for you becomes little more than the feelings tingling through your " + CockDescriptor.describeCock(player, x) + " and the ensuing orgasms.  At some point, you lose track of time and pass out.");
		sophiePregChance();
		player.orgasm();
		player.stats.lib += 1;
	...
	private giantCocksImpregnateSophie(): void {
		...
		if (player.lowerBody.balls > 0) MainScreen.text("in those plump balls of yours");
		else MainScreen.text("inside you");
		MainScreen.text(", just waiting to squirt out!</i>\"  She says it as more a statement of fact than anything else, using that oddly hypnotic, sing-songish voice that seems to reach right inside you.  The cum really <b>does</b> seem to be sloshing around inside you, and as your heart beats faster in your chest, your ardor for the well-endowed harpy grows.  Sophie rubs her soft palm along the underside, right on the meatus your urethra makes as she continues in that strange tone, \"<i>You're <b>soooo</b> hard, and full.  It's making your cock more...</i>\" She plants another wet kiss on you, this time on your " + player.cockHead(x) + ".  \"<i>...and more sensitive.  <b>So</b> sensitive, like just me rubbing my finger on you is as good as fucking a cunt, right?</i>\"");
		...
		if (player.cumQ() >= 500) MainScreen.text("  In no time, Sophie's belly begins to form into a bump, and the pressure leaves more and more of your seed to be wasted on the bimbo's thighs.");
		if (player.cumQ() >= 1000) MainScreen.text("  Your intense ejaculations quickly balloon that petite bump into a rounded dome.  Torrents of spunk run out of her around your tip, fountaining slightly with each fresh dose.  You simply can't pack any more cum into her, and the excess puddles around her plush bottom.");
	...
	public sophieMoveInAttempt(): void {
		MainScreen.clearText();
		sophieSprite();
		Flags.list[FlagEnum.SOPHIE_BROACHED_SLEEP_WITH] = 1;
		MainScreen.text("Sophie approaches you with a particularly somber expression on her normally vapid face, pressing her index fingers together nervously.  Her walk, normally exaggerated and sexual, is meek and diminished as she makes her way forward.  You cock your head to the side, looking at her curiously.");
		...
		menu();
		MainScreen.addButton(0, "Yes", yesSophieSleepWith);
		MainScreen.addButton(1, "Nah", noSophieSleepWith);
	}
	...
	private yesSophieSleepWith(): void {
		MainScreen.clearText();
		sophieSprite();
		MainScreen.text("Sophie claps her hands excitedly when you give your assent, immediately launching into a hug that presses her ");
		switch (pregnancy.event) {
			case 1: MainScreen.text("burgeoning"); break;
			case 2: MainScreen.text("swollen"); break;
			case 3:
			case 4: MainScreen.text("huge, gravid"); break;
			default: MainScreen.text("taut");

		}
		MainScreen.text(" midriff and cushiony tits against you.  \"<i>You're awesome, [name], you know that?  You're totally " + player.mf("hunky", "cute") + " AND awesome!</i>\"  She spins about, dancing happily and shaking her voluptuous backside in your direction as she goes.");
	...
	private noSophieSleepWith(): void {
		...
		if (Flags.list[FlagEnum.SLEEP_WITH] == "Sophie") Flags.list[FlagEnum.SLEEP_WITH] = "";
		doNext(camp.returnToCampUseOneHour);
	}
	...
	private moveSophieInRepeat(): void {
		MainScreen.clearText();
		sophieSprite();
		MainScreen.text("You go up to the feathery bimbo and idly question if she still wants to share your bed with you");
		if (!pregnancy.isPregnant) MainScreen.text(" even though she's not pregnant any more");
		MainScreen.text(".  Sophie's voluminous, painted lips curl into a radiant smile, an effect enhanced even more by the gold gloss she coats them with.");
	...
	public sophieFenCraftedSex(morning: boolean = false): void {
		...
		if (player.lowerBody.balls > 0) MainScreen.text("  Sophie's immense backside slides over your [balls] each time she bottoms out, her tail feathers tickling at the bottom of your [sack].");
		MainScreen.text("  You pull on her nipple, earning yourself a squawk of surprised excitement from Sophie.  She writhes in your grip, twisting this way and that, pulling harder on her poor abused nipple as her pussy goes wild around you.");

		MainScreen.text("\n\nYou feel her juices drip out over your length and across your middle as she hits climax, one hand holding on to your shoulder for support.  Her velvety interior spasms wonderfully, convulsing around your " + CockDescriptor.describeCock(player, x) + " in what can only be the throes of orgasm.  Sophie folds double, dropping her tits onto your ");
		if (player.upperBody.chest.BreastRatingLargest[0].breastRating >= 1) MainScreen.text("own");
		else MainScreen.text("chest");
		MainScreen.text(", as she kisses you passionately, moaning into your mouth.  The effects of her potent lip-gloss hit you immediately, fortifying your pleasure into a tsunami wave of excitement, one that's cresting whether you want it to or not.  You cry out into Sophie's tongue, hips lifting her off the ground, as you cum, hard.  Your ejaculate fires out in long, thick ropes of white, painting the harpy's sodden innards white.  With her folds coated in spunk, your spasming " + CockDescriptor.describeCock(player, x) + " pours the rest of your lusts into her, emptying your [balls] completely.");
		if (pregnancy.isPregnant) {
			MainScreen.text("  The thorough seeding fills her up completely - her womb is too full of egg for there to be any room for spunk, and it all drips out with each fresh injection.");
			if (player.cumQ() >= 500) MainScreen.text("  You cum so hard that torrents of spooge wash out of her slit, her womb obstructed by the egg you made with her.");
		}
		if (player.cumQ() >= 2000) MainScreen.text("  The oozing spunk soaks you thoroughly, and Sophie's thighs become matted with the gallons of gunk that squirts out of her lips.");
	...
	public fuckYoPregnantHarpyWaifu(morning: boolean = false): void {
		...
		if (morning) {
			...
			if (morning) MainScreen.text(", morning");
			MainScreen.text(" fuck.  Her skin is silky smooth, and if you push a little, you can actually feel the solid curve of the growth inside her.  That egg sure is getting big!");
		}
		//REGULAR FUCK
		else {
			MainScreen.clearText();
			sophieSprite();
			MainScreen.text("You go ahead and take off your [armor], letting Sophie take in the view of [eachCock].  She immediately flounces over and drops to her knees in front of you.  Her hands wraps around " + CockDescriptor.describeCock(player, x) + ", ");
			if (player.stats.lust > 50) MainScreen.text("feeling its firmness.  \"<i>Wow, you're so hard already, [name]!</i>\" she comments.");
			else MainScreen.text("slowly stroking it until it begins to pulse to life, thickening in her hand.");
			MainScreen.text("  Your rigid tool is soon tingling pleasantly from her handjob, the pregnant bimbo licking her lips hungrily.  She asks \"<i>Could you lie back and let me be on top?  It'll be easier on me, since I'm all big and stuff.</i>\"  She runs a hand over her gravid midriff, obviously enjoying herself as she waits.");
			MainScreen.text("\n\nLeaning back on your blankets, you do as she asks, since sex with a pregnant woman does require a little bit of give and take.  Sophie waddles up, her curvy hips still managing to wiggle seductively as she climbs on to you.  Her heavy breasts, normally perky enough to support themselves, rest on top of her swollen gut as she settles into place, jiggling slightly.  You take your " + CockDescriptor.describeCock(player, x) + " in your hand and lift it up against her pussy lips, just in time for her to lower herself, absorbing you into the cock-squeezing haven that is her pussy.  She moans as she takes you.  \"<i>Ooohh, you remind me why I got this egg in the first place!</i>\" You rub her belly alongside her, simply admiring her smooth, super-curvy, pregnant frame.  That egg sure is big!");
		}
		//BOTH FUCKS
		MainScreen.text("\n\nSophie swivels her hips around in slow, circular strokes, riding your " + CockDescriptor.describeCock(player, x) + " confidently.");
		...
		if (player.lowerBody.balls > 0) MainScreen.text("[balls], where they hang in thick drops before falling to the ground,");
		else MainScreen.text("taint and [legs]");
		MainScreen.text(" proving the veracity of her statements many times over.  You can't SEE the wetness, but your " + CockDescriptor.describeCock(player, x) + " certainly feels it, twitching inside Sophie's silky slit when the waves of wetness roll over it.");
		...
		MainScreen.text("\n\nYou release your pressure, and her pussy relaxes.  Then, you inhale around her tight bud again.  Her sodden snatch obliges your ploy with another supple squeeze.  In no time flat you're using the bimbo's big nipple like a control-rod for her pussy, suckling and releasing it again and again to make her milk your " + CockDescriptor.describeCock(player, x) + " for all she's worth.  Sophie doesn't offer any complaints - just blissful exhalations of pleasure intermingled with lurid moans.  Even as a pregnant harpy matron, her body is absolutely, ridiculously designed for sex.  The air is virtually saturated with her fruity scent - a smell that only gets stronger each time you make her squeeze your dick and release a fresh drizzle of lady-cum.");

		MainScreen.text("\n\nSophie shudders and shakes, her nipple getting puffier in your mouth.  After a while, you note the other seems equally engorged and yet untaken, so you pop the well-used tit-tip out of your mouth and hungrily latch on to the other, starting the cycle anew.  Sophie's gash explodes at that first suckle, undulating around you and clenching you wildly.  Her eyes roll up, half-hidden under her fluttering lashes as she releases a long, low moan, her whole body shaking with the excitement of it all.  Your " + CockDescriptor.describeCock(player, x) + " is tingling all over, smothered in lubricant, sensuous pleasure, and a mountain of plump, harpy ass.  You shift your hands down there to squeeze the bouncing buttcheeks, holding on for dear life as the harpy's pussy assaults you with ecstasy.");

		MainScreen.text("\n\nSophie pleads, \"<i>Oooooh, cum in me baby, I wanna feel it agaaaiiiin!</i>\"  Before you can even think to answer, [eachCock] is complying with the expectant mother's wishes.  All the pent-up pressure, excitement, and lust bubbles out of you in a rush, the liquid wave draining out of your well-milked " + CockDescriptor.describeCock(player, x) + " and directly into the harpy's channel.");
		if (player.lowerBody.cockSpot.count() > 1) {
			MainScreen.text("  The underside of her tremendous, pregnant belly suddenly slides along you slickly, lubricated by the wasted spooge that's spurting from your unused member");
			if (player.lowerBody.cockSpot.count() > 1) MainScreen.text("s");
			MainScreen.text(".  The inadvertent tummyfuck redoubles the pleasure, forcing you to deal with a true, multi-cocked orgasm.");
		}
		MainScreen.text("  Immediately, the cum you're squirting into her begins to be squeezed right back out.  Her womb is blocked thanks to the massive egg inside, and your lower body turns into a fruity, salty mess from all the cum and girl-jizz Sophie forces out.");
		if (player.cumQ() >= 500) {
			MainScreen.text("  There's enough there to ");
			if (player.cumQ() < 1000) MainScreen.text("soak your blankets");
			else if (player.cumQ() < 2000) MainScreen.text("soak your blankets and the ground below");
			else if (player.cumQ() < 5000) MainScreen.text("soak your blankets and form a giant puddle below, leaving you feeling like you're on a waterbed made of spunk.");
			else MainScreen.text("soak your blankets and create a lake the two of you sink partway into, surrounded by muddy, cum-flavored mud.");
		}
		MainScreen.text("\n\nYou sag back as the last few drops leak out around you.  Sophie rolls off to the side, panting heavily.  She titters, \"<i>");
		if (morning) MainScreen.text("What... a... way to... start a... morning!");
		else MainScreen.text("Ooohh... you're... gonna be... a great... daddy...");
		MainScreen.text("</i>\" in between panting gasps for breath.");

		MainScreen.text("\n\nSophie leaves you there");
		if (player.cumQ() >= 1000) MainScreen.text(" in the hardening mud");
		MainScreen.text(", swaying her hips sensually as seed runs from her cunt in thick little rivers.  You're wet, sticky, and sated");
		if (morning) MainScreen.text(" when you go wash up to get dressed.  It's going to be a good day.");
		else MainScreen.text(" when you go to get dressed.  You'll have to make sure to wash clean at some point, but for now you enjoy the sweet scent of your pet bimbo's cum.");
		player.orgasm();
		player.stats.sens += -2;
		if (morning) doNext(playerMenu);
		else doNext(camp.returnToCampUseOneHour);
	...
	private sophiePreggoTitJobs(): void {
		...
		if (player.lowerBody.cockSpot.count() > 1) {
			MainScreen.text("  Then, she fishes the ");
			if (player.lowerBody.cockSpot.count() == 2) MainScreen.text("other one");
			else MainScreen.text("rest");
			MainScreen.text(" out of your [armor], giving ");
			if (player.lowerBody.cockSpot.count() == 2) MainScreen.text("it");
			else MainScreen.text("each");
			MainScreen.text(" a slow, affectionate stroke before she returns to her target.");
		}
		MainScreen.text("  The sensitive tip swells in her mouth, responding to the combination of sloppy, plump lip-kisses and the drugs now coursing through you.");

		MainScreen.text("\n\nYour curvy cock-craving queen leans back, letting you slip free, connected to her by a golden strand of saliva as she arches her back and brings her immense melons into play.  She spreads them wide as your unrestrained erection lurches forward, dipping into the glossy valley she's made for you.  Her lipstick is extremely slick and the entire underside of your " + CockDescriptor.describeCock(player, x) + " is immediately gilt with reflective aphrodisiac.  The buxom harpy presses her breasts in from each side, the change in tightness immediately noticeable to your sensitive cockflesh.  A delicious, warm friction envelops your maleness from all sides.  Smooth, gloss-lubed skin seems to caress you from every angle, compressing tightly about your girth as Sophie's hands finish bringing the pleasant power of her breasts to full erotic effect.  Your [legs] tremble, and your head is pounding from just how badly you desire a fuck, a cum- anything to bring you to orgasm.");
		...
		if (player.lowerBody.cockSpot.get(x).cockLength > 30) MainScreen.text("the underside of your immense erection");
		else MainScreen.text("your " + player.cockHead(x) + "");
		MainScreen.text(" with her lips, already pursed into a plump, cock-sucking doughnut hole of pleasure.  The noise she makes when your " + CockDescriptor.describeCock(player, x) + " ");
		if (player.lowerBody.cockSpot.get(x).cockLength > 30) MainScreen.text("presses against");
		else MainScreen.text("slips into");
		MainScreen.text(" her puffy, puckered orifice is indescribably moist, a sloppy sucking sound that would make you dribble pre-cum if her tits and mouth weren't already milking a steady flow out.");
		if (player.lowerBody.cockSpot.get(x).cockLength > 30) MainScreen.text("  Sophie pulls back long enough to gasp, \"<i>You're so long, I can't even take the tip!</i>\"");
		...
		//[Let Her] [Hog Wild]
		menu();
		MainScreen.addButton(0, "Let Her", letSophieMilkYoDick);
		MainScreen.addButton(1, "Hog Wild", goHogWildOnSophieBewbs);
	}
	...
	private goHogWildOnSophieBewbs(): void {
		...
		sophieSprite();
		let x: number = player.biggestCockIndex();
		MainScreen.text("You don't care about her promises- there's a pair of soft tits right there just waiting for a dick to fuck them, and nothing is going to stop you from spooging all over them however you want!  Sophie barely has a chance to react before you're tossing her on her back and mounting her chest.  Your [butt] rubs on the top of her pregnant belly as you settle your " + CockDescriptor.describeCock(player, x) + " into the perfect position.");
		if (player.lowerBody.cockSpot.count() > 1) {
			MainScreen.text("  Your other cock");
			if (player.lowerBody.cockSpot.count() > 2) MainScreen.text("s splay");
			else MainScreen.text(" splays");
			MainScreen.text(" out to the side, lamely brushing against the outsides of her tit.");
		}
		MainScreen.text("  Sophie blubbers in surprise, stopping only when your ");
		if (player.lowerBody.cockSpot.get(x).cockLength <= 30) MainScreen.text(player.cockHead(x) + " pushes into through her startled cock-pillows, muffling her more effectively than any gag.  She immediately sucks on it, a happy look in her eyes.  The bimbo seems to want nothing more than to lie there and polish your rod.");
		else MainScreen.text(" immense rod smacks across her face, too long to try to jam down her throat.  It completely covers her face, smothering her features with rigid, veiny dickflesh.  She immediately begins to lavish the underside with licks and long wet kisses, aided by her plus-sized bimbo lips.  When her eyes peek out from under your " + CockDescriptor.describeCock(player, x) + ", they seem placid and happy.  It seems the slut wants nothing more than to lie there and service your cock.");
		MainScreen.text("\n\nGrabbing hold of Sophie's plump nipples, you immediately use them for leverage, tugging them together above your dick.  The tiny, pebbly joysticks are almost rock-hard already!  With your yanks merging her tits together around your " + CockDescriptor.describeCock(player, x) + " and shooting explosions of sensation through her brain, Sophie struggles to stay coherent enough to keep orally attending to your maleness.  Her tongue's licks quickly begin to devolve into spastic, instinctive strokes, lashing around your underside with lusty fury.  They still feel good, so you don't really mind.  The space under Sophie's ass sloshes around muddily, proof of just how much the harpy is enjoying this tryst, even if you've turned the tables on her.");

		MainScreen.text("\n\nSophie's tits bounce off your crotch, hard.  Your [hips] have begun their march back and forth, bouncing off your pregnant tart's immense belly and back into her voluptuous tits.  The jiggling udders feel so good pressed around your " + CockDescriptor.describeCock(player, x) + " that you can't even comprehend why anyone would want to wait for such pleasure.  You fuck her tits hard, so violently that Sophie begins to give up short gasps of pain, stopping her fellatio as the pain and pleasure mix confusingly in her head.  She grabs her jugs from the side, pressing them into you to take some of the tension from her abused nipples.");

		MainScreen.text("\n\nThe effects of her honeyed lipgloss are becoming more and more apparent to you, visible to the extreme in the thick, exceedingly quick pulsations that are running through your " + CockDescriptor.describeCock(player, x) + ".  It's twitching happily, bouncing in the harpy's fat tits.  Her soft breasts have the perfect amount of give, and the golden fluid that slicks them makes them easily as slippery as a wet pussy, perhaps even more so.  Pre-cum is dribbling from your tip");
		if (player.lowerBody.cockSpot.get(x).cockLength <= 30) MainScreen.text(" right into Sophie's mouth");
		else MainScreen.text(" above Sophie's head");
		MainScreen.text(".  The bird slut stops her frenzied fellatio to beg, \"<i>Please cum on me, [name]!  Cum all over Momma's Sophie's face and tits!  I fucking love, like, being covered in jizz!</i>\"");
		...
		if (player.lowerBody.balls > 0) MainScreen.text(", cupping your [balls] with a hand and massaging them to aid your ejaculation");
		MainScreen.text(".  Your [butt] is squished up against her belly, both of you sweating and slipping all over each other.  Bulging in her breasty embrace, your " + CockDescriptor.describeCock(player, x) + " flexes, and your " + player.cockHead(x) + " thickens.");
		if (player.hasKnot(x)) MainScreen.text("  Your knot inflates to a ludicrous degree, squeezed down on from all sides by slick, gold-painted tits, happy to be engulfed by warm flesh.");
		MainScreen.text("  Cum fountains from you, splattering over Sophie's face, some of it catching on her tits along the way.  A ribbon of the white goo dangles between her mountainous chest and her chin, breaking only when you spurt another set of alabaster cream all over her breasts, most trapped inside the snug cleavage with you.  You slip yourself forwards and continue to cum, lacing hot, sticky jets onto her face.");
		if (player.cumQ() > 1000) MainScreen.text("  Again and again, you continue to paint her white.  Your orgasm seems almost without end as you ejaculate.  Sophie's face is soaked with it, and her breasts have become glazed mountain-peaks.");
		if (player.cumQ() > 2500) MainScreen.text("  By the time you finish, the stuff is puddled under her.  The best your harpy pet can manage is a spermy smile as she languishes in your seed.");
		MainScreen.text("  You push your " + player.cockHead(x) + " and get a kiss from her as you finish cumming, oozing one last dollop onto her fat lips.  She whimpers in the most exciting way as you withdraw, wiping your cock off on her swollen belly, marking her as yours once more.");
	...
	private letSophieMilkYoDick(): void {
		...
		sophieSprite();
		let x: number = player.biggestCockIndex();
		MainScreen.text("You nod at Sophie and hold yourself still.  She rewards you by wrapping her breasts back around you, enveloping you in tight pleasure again.  ");
		if (player.lowerBody.balls > 0) MainScreen.text("Your [balls] drag across her pregnant belly as she goes to work, but you don't mind in the slightest.  There's something erotic about having them bumping up against the fruit of your union.  ");
		MainScreen.text("Her breasts begin to bounce without warning, up and down in perfect sync.  The tight titty-embrace is almost too much.  You can feel your dick flexing in that smothering, lube-soaked chest.  Sophie extends her tongue to lick at you, and her tongue sends shockwaves of excitement through your already raging boner.");
		...
		MainScreen.text("\n\nSophie rolls her eyes exaggeratedly and pops her mouth back off your dick.  \"<i>Why didn't you just, like, say that, sexy?</i>\"  She giggles cutely and returns to polishing your gold-gilt rod.  Her eyes flick back up at you, the corners of her mouth curling up as she begins to hum on your " + CockDescriptor.describeCock(player, x) + ".  Sophie suddenly switches tempo, bouncing her left tit down while she takes her right titty up.  With the creamy tits on either side to moving to different tempos, sliding their slick druggy payload across you with delicious, alternating friction your " + CockDescriptor.describeCock(player, x) + " immediately begins to twitch and pulse fitfully.  It's like you have your cock fucking two different pussies at once, all while getting a blowjob from a pair of puffy, bee-stung bimbo-lips.");

		MainScreen.text("\n\nSophie breaks away from fellatio long enough to mouth, \"<i>Cum.  Now,</i>\" and immediately pops her mouth back in place");
		if (player.lowerBody.cockSpot.get(x).cockLength <= 30) MainScreen.text(", ready to catch the cum");
		else MainScreen.text(", assisting the cum");
		MainScreen.text(" that's already bubbling out of your [balls] with searing heat.  She presses harder on each side, crushing your " + CockDescriptor.describeCock(player, x) + " with her slippery tits as your urethra bulges with the heavy load. With an audible squishing noise, you unload what feels like every drop of cum your body contains in one huge lance.");
		//{Fork between mouth and bukkake}
		//Mouth
		if (player.lowerBody.cockSpot.get(x).cockLength <= 30) {
			MainScreen.text("  Sophie");
			if (player.cumQ() < 250) MainScreen.text(" swallows it without complaint, her eyes twinkling mirthfully as she suckles down your small load.  Surprisingly, you dump a few more pulses into her, each weaker than the last.  The bird-woman drinks it with ease, never looking away from you.");
			else if (player.cumQ() < 500) MainScreen.text("'s cheeks bulge from the size of your load, but she manages to get it down with a big gulp.  Surprisingly, you dump a few more jets of thick cream into her waiting gullet, each weaker than the last but big enough to make it hard for her to swallow.  She never looks away from you as she takes it.");
			else if (player.cumQ() < 1000) MainScreen.text("'s cheeks bulge cartoonishly at your immense deposit, cream escaping from the corners of her mouth as her poor mouth floods.  Her throat bobs ludicrously, trying to keep up with the flow, but when you follow up that virile blast with several smaller, still potent deposits, she gives up and lets the jizz run down her lip and face, dripping onto her tits.  Through it all, her eyes never leaves yours.");
			else {
				MainScreen.text("'s cheeks bulge ridiculously for a split second before the pleasure sends cum fountaining out her nose and jetting out the corners of her mouth.  She <b>tries</b> to swallow it, but her meager throat simply can't ");
				if (silly()) MainScreen.text("repel cum of that magnitude");
				else MainScreen.text("handle that much cum");
				MainScreen.text(".  Again and again, you spunk the hell out of her face, until Sophie pulls back gagging.  She gets a mask of jizz for her efforts, even after she's swallowed a bellyful of cum.  She WAS watching your face, until your cum obscured her eyes, and even then, she keeps her head facing you, letting you watch your jism dripping down her gorgeous features.");
			}
			MainScreen.text("  The bird-girl withdraws ");
			if (player.cumQ() < 1000) MainScreen.text("with a happy smile");
			else MainScreen.text("coughing and sputtering");
			MainScreen.text(" once you're dumped out every drop.  She touches your " + CockDescriptor.describeCock(player, x) + " affectionately, tickling at its underside, and her flushed face seems extraordinairily pleased to have made you cum so hard.  Sophie's hands stroke her belly slowly as she looks up at you, whispering, \"<i>You're like, so good to Momma Sophie.  Just be sure and cum for my twat again soon, okay?  It misses you.</i>\"");
		}
		//On top of her.
		else {
			MainScreen.text("  Sophie");
			if (player.cumQ() < 250) MainScreen.text(" giggles happily when the cum jets into the air and down atop her head, moaning against your dick while it seeps through her platinum feathers.  Throughout it all, she licks and sucks on your shaft, milking out every drop and never looking away.");
			else if (player.cumQ() < 800) MainScreen.text(" moans when your heavy deposits splatter into her hair, dripping through the downy blond feathers in a messy web.  Throughout it all, she sucks and licks at you, polishing your " + CockDescriptor.describeCock(player, x) + " until she's sure every single drop of jizz has been expelled onto her curvy frame.");
			else {
				MainScreen.text(" moans whorishly as your gigantic cum-wad splatters over her, running down her hair in thick waves, soaking her shoulders and even dropping over her face in a slippery mask.  She keeps kissing and sucking to make sure you give up every drop, not stopping until she feels your urethra stop its orgasmic pulsating.  Even then, her face stays angled up at you, allowing you to watch as your jizz runs unimpeded across her voluptuous body, dripping from every curve.");
				if (player.cumQ() >= 2000) {
					MainScreen.text("  She's completely soaked, head to toe");
					if (player.cumQ() >= 3000) {
						MainScreen.text(" and a ");
						if (player.cumQ() < 4000) MainScreen.text("puddle");
						else if (player.cumQ() < 6000) MainScreen.text("big puddle");
						else if (player.cumQ() < 10000) MainScreen.text("small lake");
						else MainScreen.text("obscene lake");
						MainScreen.text(" has formed around the pair of you");
					}
					MainScreen.text(".");
				}
			}
			MainScreen.text("  She gathers up some of your spunk and rubs it over her breasts and belly as you slump back, reveling in the feel on her skin and how wonderful her big, pregnant boobs are feeling.");
	...
	public sophieBirthsEgg(): void {
		...
		if (bimboSophie()) MainScreen.text("Come here, [name]!  I... whooooaaaa... I wanna like, hold your hand when the egg comes out!");
		else MainScreen.text("Come here, [name]!  I... whoooaaaa...  I need something to hold on to while this comes out!");
		MainScreen.text("</i>\"");

		if (player.stats.cor < 33) MainScreen.text("  You sit down next to her, and figuring this must be normal for her, you hold her hand with one arm and grope at her free breast with the other.");
		else if (player.stats.cor < 66) MainScreen.text("  You sit down next to her with a sigh.  Well, at least you can grope her tit with your other hand!");
		else MainScreen.text("  You plop down next to her, but ignore her proffered hand for one of those juicy melons on her chest.  Grinning, you can't help but think that this is a far more tender thing to hold anyway.");
		...
		if (player.isBiped()) MainScreen.text("rs");
		MainScreen.text(".  A rounded white rim peeks out through her spasming pussy-lips, glistening with lubricants that drop from its bottom so fast it's almost a steady stream.");
		...
		if (Flags.list[FlagEnum.SOPHIE_ADULT_KID_COUNT] == 0) MainScreen.text("  Can you handle having another harpy living in your camp?\n");
		else MainScreen.text("  Just how many harpies can your camp hold?\n");
		dynStats("lus", (10 + player.stats.lib / 10));
	}

	//Egg Hatched Notification
	public sophiesEggHatches(): void {
		Flags.list[FlagEnum.SOPHIE_CAMP_EGG_COUNTDOWN] = 0;
		sophieSprite();
		...
		if (bimboSophie()) MainScreen.text("bimbo ");
		else MainScreen.text("woman ");
		MainScreen.text("is raising such a fuss.  Upon spotting Sophie, you can't help but notice the flapping of wings and a number of feathers strewn about.  The ");
		if (bimboSophie()) MainScreen.text("silly ");
		MainScreen.text("harpy is once again fussing over her newly birthed egg, though this time she seems even more flustered about it.  Catching sight of you, her face instantly lights up, a bright");
		if (bimboSophie()) MainScreen.text(", happy");
		MainScreen.text(" smile spreading across her plump, golden lips as she bounds over to you and grabs your hand.");

		if (bimboSophie()) MainScreen.text("\n\n\"<i>It's time!  It's time!  It's like, totally time for our egg to hatch!  Come on, babe!  Come see your new, fluffy little cutie!</i>\" she says as she pulls you over to her nest.  As soon as you get there, you can already see what the excited bimbo means.  The egg wiggles and shakes, cracks forming across its hard shell as if something inside is trying to break out.  Now that you're here and watching, Sophie lets go of you, bounding over to her precious egg.  She rubs it softly and coos to it, cheering her little baby harpy on.  Sophie may be a dumb horny bimbo, but she still seems to care for her offspring immensely.");
		...
		if (Flags.list[FlagEnum.SOPHIE_ADULT_KID_COUNT] < 4) {
			//First Harpy:
			//-Pink plumage, big tits and (sensitive) lips, normal harpy hips. (blue eyes)
			if (Flags.list[FlagEnum.SOPHIE_ADULT_KID_COUNT] == 0) {
				...
				if (Flags.list[FlagEnum.UNKNOWN_FLAG_NUMBER_00282] > 0) MainScreen.text(", though her lips are a little larger than you'd think was normal - maybe she inherited it from her mom?");
				else MainScreen.text(".");
				MainScreen.text("  The harpy chick is actually about as big as a four or five year old, and she looks up at Sophie curiously.");
				if (Flags.list[FlagEnum.UNKNOWN_FLAG_NUMBER_00282] > 0) {
					Flags.list[FlagEnum.DAUGHTER_ONE_BIMBO] = 1;
				}
			}
			//Second daughter
			//Second Harpy:
			//-Badonkadonk to 9000.  Blond feathers that grow very long. (violet eyes)
			else if (Flags.list[FlagEnum.SOPHIE_ADULT_KID_COUNT] == 1) {
				...
				if (player.stats.cor > 66) MainScreen.text(" a little bit");
				MainScreen.text(".  The newly hatched chick looks about as old as the other - four or five years old.  Unlike the first one, her face is fairly normal, though you think with her features she's sure to be a beauty when she matures.  She's a bit bigger in the butt and hips than her elder sister, and her eyes are violet while her plumage matches her mothers - ");
				if (Flags.list[FlagEnum.UNKNOWN_FLAG_NUMBER_00282] > 0) {
					MainScreen.text("platinum blonde");
					Flags.list[FlagEnum.DAUGHTER_TWO_BIMBO] = 1;
				}
				else MainScreen.text("pure pink");
				MainScreen.text(".  Her feathers definitely seems longer as well, even though it's still just fuzzy down.");
			}
			//Third Harpy:
			//-Not that curvy, but has human feet and purple feathers. (violet eyes)
				...
				if (Flags.list[FlagEnum.UNKNOWN_FLAG_NUMBER_00282] > 0) Flags.list[FlagEnum.DAUGHTER_THREE_BIMBO] = 1;
			}
			//Fourth Harpy:
			//-Curvy like Sophie, but with well-developed wings and extra-soft feathers (WINGJOBS).  Pink plumage.  (blue eyes)
				...
				if (Flags.list[FlagEnum.UNKNOWN_FLAG_NUMBER_00282] > 0) MainScreen.text(" like her mother used to have before her bimbofication");
				MainScreen.text(", and a shape that seems to indicate that maturity will be VERY generous to her.  She looks around in wonder, already flapping wings that seem a touch more developed than her sisters were at that age.  You've got to wonder just how big they'll get with age.");
				if (Flags.list[FlagEnum.UNKNOWN_FLAG_NUMBER_00282] > 0) Flags.list[FlagEnum.DAUGHTER_FOUR_BIMBO] = 1;
			}

			//ALL FIRST FOUR END WITH THIS: 
			if (bimboSophie()) MainScreen.text("  Before the girl can try to stand she is swept up off her feet by her ecstatic mother.  \"<i>Oohhhhh, just look at you!  My baby girl is sooo cute!  Soooo totally fluffy and like, suuuuper soft!</i>\"");
			else MainScreen.text("  Before the girl can try to stand she is swept up off her feet by her ecstatic mother.  \"<i>Oohhhhh, you're so cute!  My baby girl is sooo cute!  Oh, the boys will be all over you when you grow up, I just know it!</i>\"");
		}
		//Every Other daughter*
			...
			if (rand(2) == 0) MainScreen.text("pink");
			else {
				if (Flags.list[FlagEnum.UNKNOWN_FLAG_NUMBER_00282] > 0) MainScreen.text("blonde");
				else MainScreen.text("white");
			}
			MainScreen.text(" girl coos as she shields her ");
			if (rand(2) == 0) MainScreen.text("violet");
			else MainScreen.text("blue");
			MainScreen.text(" eyes from the sun.  The little bird-girl is soon out of her egg, but already looks to be four or five years old.  As always, the sweet little thing is as fluffy as a newborn chick, feathers sticking out every which way and making her look more like a puffball with skin showing than a little baby harpy.  Before the girl can try to stand she is swept up off her feet by her ecstatic mother.  ");
			if (bimboSophie()) MainScreen.text("\"<i>Oohhhhh, just look at you!  My baby girl is sooo cute!  Soooo totally fluffy and like, suuuuper soft!</i>\"");
			else MainScreen.text("\"<i>Oohhhhh, you're so cute!  My baby girl is sooo cute! Oh, the boys will be all over you when you grow up, I just know it!</i>\"");
		}
		...
		if (bimboSophie()) MainScreen.text("\"<i>Oh dearie, there there, like, calm down, sweetie.  Don't worry, Momma Sophie's here.</i>\"  The matronly harpy gently hugs the squirming fluff-ball into her big, soft breasts, her hands gently stroking her fussy daughter's feathery hair.");
		else MainScreen.text("\"<i>There there, calm down, baby.  Momma Sophie's here...  I'm here.</i>\"  The matronly harpy gently hugs the squirming fluff-ball into her big, soft breasts, her hands gently stroking her fussy daughter's feathery hair.");
	...
	public sophieKidMaturation(): void {
		...
		//Fifth+ daughter
			...
			if (Flags.list[FlagEnum.UNKNOWN_FLAG_NUMBER_00282] > 0) MainScreen.text("bimbo ");
			MainScreen.text("breasts - just as high, round and perky, yet big and yielding to the touch, like the softest pillow.");
		}
		//ALL CONTINUE HERE
		MainScreen.text("  The newly embodied harpy lets out a sigh of relief now that the changes have stopped, clearly surprised by what happened and glad it's over. Moving to get a better view of your daughter, you take in the sight of her new body. Your once petite harpy girl looks more like a stacked ");
		if (Flags.list[FlagEnum.UNKNOWN_FLAG_NUMBER_00282] > 0) MainScreen.text("bimbo");
		else MainScreen.text("bombshell");
		MainScreen.text(", just like her mother.");
		if (bimboSophie()) MainScreen.text("  From the inquisitive look on her face and spark of intelligence in her eyes, it seems that she hasn't lost her mind to her inner bimbo.");
		...
		if (Flags.list[FlagEnum.SOPHIE_ADULT_KID_COUNT] > 0) {
			//If Yes Incest
			if (Flags.list[FlagEnum.SOPHIE_FAMILY_INCEST] == 1) {
				MainScreen.text("\n\nYou nod your head and tell her that she's very beautiful, just like her mom and sister");
				if (Flags.list[FlagEnum.SOPHIE_ADULT_KID_COUNT] > 1) MainScreen.text("s");
				MainScreen.text(".  She beams a radiant smile at you and turns around, shaking her rump at you enticingly, \"<i>So, when do you want to try me out, " + player.mf("Daddy", "'Mom'") + "?</i>\"");
	...
	private yesToSophieIncest(): void {
		...
		if (bimboSophie()) MainScreen.text("personal bimbo ");
		else MainScreen.text("lusty matron ");
		MainScreen.text("is more than happy to return the sudden affection, her hands running over your body as she grinds against you teasingly.  With a firm open-palm spank to her rump, you release her, telling both harpies that you will play with them again very soon.  The two horny girls giggle together before talking about all the fun they will have.");
		player.stats.lust += 5;
		Flags.list[FlagEnum.SOPHIE_FAMILY_INCEST] = 1;
		doNext(camp.returnToCampUseOneHour);
	}
	//[nono]
	...
	public sophieAndIzmaPlay(): void {
		MainScreen.text("\n");
		Flags.list[FlagEnum.TIMES_SOPHIE_AND_IZMA_FUCKED]++;
		MainScreen.text("<b>Something odd happens that ");
		if (model.time.hours < 6 || model.time.hours > 20) MainScreen.text("night");
		else if (model.time.hours < 12) MainScreen.text("morning");
		else if (model.time.hours == 12) MainScreen.text("noon");
		else if (model.time.hours < 5) MainScreen.text("afternoon");
		else MainScreen.text("evening");
		MainScreen.text("...</b>");
		...
		if (Flags.list[FlagEnum.TIMES_SOPHIE_AND_IZMA_FUCKED] == 1) {
			MainScreen.text("\n\n(Regardless, you could probably suggest that Sophie try this again in the future...)");
		}
		dynStats("lus", 10 + player.stats.lib / 10);
		//[Interrupt] [Watch]
		menu();
		MainScreen.addButton(0, "Interrupt", interruptSophieIzma);
		MainScreen.addButton(1, "Watch", watchIzmaSophie);
	}
	...
	private watchIzmaSophie(): void {
		...
		if (player.lowerBody.cockSpot.hasCock()) MainScreen.text(", from me OR my Alpha");
		MainScreen.text(".  If I had MY way, you'd be tied up on the lake-side so my sisters could play with these ridiculous jugs while they pound your fat ass full of spunk and your belly full of shark-babies.</i>\"");
		...
		if (player.lowerBody.cockSpot.hasCock()) MainScreen.text("stroke yourself through bliss");
		else MainScreen.text("finger yourself through bliss");
		MainScreen.text(".  Izma's quartette of sperm-filled balls abruptly rise in her suddenly taut prison and begin to pulsate in time with her cock.  At first, there's no visible change, but before long, semen begins to bubble out around the twitching shark-shaft, spattering onto the ground below.  Your own climax winds down as well");
		if (player.lowerBody.cockSpot.hasCock()) {
			if (player.cumQ() >= 1000) MainScreen.text(", leaving you in a puddle of your own slimy mess");
		}
		MainScreen.text(".  Izma keeps futilely pumping a bit longer, and you see Sophie's belly curve slightly with the hefty seed-deposit.");
