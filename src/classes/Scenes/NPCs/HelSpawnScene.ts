export default class HelSpawnScene extends NPCAwareContent {
	...
	internal function heliasAppearanceScreen(): void {
		...
		if (Flags.list[FlagEnum.HEL_BONUS_POINTS] < 150) MainScreen.text("bright orange glow");
		...
		//if Isabella is cool: 
		if (Flags.list[FlagEnum.HEL_ISABELLA_THREESOME_ENABLED] >= 1) MainScreen.text("; she’s got her blue bandanna wrapped around her head, mostly obscured by her fiery hair");
		...
		if (Flags.list[FlagEnum.HELSPAWN_NAME] != 0) {
			MainScreen.text("  A dark trio of scars run down Hel’s thighs, left by " + Flags.list[FlagEnum.HELSPAWN_NAME] + "’s youthful claws.");
		}
		else {
			switch (kGAMECLASS.helScene.pregnancy.event) {
				...
				default: //She's not pregnant, check if she's ready for it
					if (Flags.list[FlagEnum.HEL_BONUS_POINTS] >= 150) MainScreen.text("  Hel’s long, reptilian tail is currently burning white-hot, signaling her body’s ready for motherhood.");
			}
		}
	...
	private helSpawnsAppearanceScreen(): void {
		MainScreen.clearText();
		if (Flags.list[FlagEnum.HELSPAWN_DADDY] == 0) MainScreen.text("Your ");
		else MainScreen.text("Hel’s ");
		MainScreen.text("salamander daughter, " + Flags.list[FlagEnum.HELSPAWN_NAME] + ", stands about six-foot-six tall, with pale skin and thick, ");
		if (Flags.list[FlagEnum.HELSPAWN_DADDY] == 1) MainScreen.text("chitin-black");
		...
		if (Flags.list[FlagEnum.HELSPAWN_PERSONALITY] >= 50) MainScreen.text("a scale bikini, just like her mother’s");
		...
		if (Flags.list[FlagEnum.HEL_ISABELLA_THREESOME_ENABLED] >= 1) MainScreen.text(", with a brightly-colored scarf wrapped around her neck");
		MainScreen.text(". She has a human face, with ");
		if (Flags.list[FlagEnum.HELSPAWN_DADDY] == 0) MainScreen.text("golden");
		else if (Flags.list[FlagEnum.HELSPAWN_DADDY] == 2) MainScreen.text("bright green");
		...
		if (Flags.list[FlagEnum.HELSPAWN_DADDY] == 2) MainScreen.text("puppy-dog");
	...
	private heliaLoveFollowup(): void {
		...
		//If HelLove = No:
		if (Flags.list[FlagEnum.HEL_LOVE] == -1) MainScreen.text("Even if you don't love me, you'd love our child, right?  You can fuck me full of kids, or even... even get someone else to, I don't care.  I just </i>need<i> it, [name].  More than anything else in the whole wide world.");
		else {
	...
	internal function haveAKid(): void {
		...
		MainScreen.text("You tell Hel that you're in this with her, that you want to give her that child she seems so desperate for.  She beams at you, smiling from eye to eye before leaping into your arms, pressing her lips hard to yours.  You kiss her back, wrapping your arms around her hips to support her as her powerful legs wrap around your waist; you push her up against the ruined wall, hands searching across her taut, hot flesh until you toss her bikini top aside, letting her hefty tits free.  \"<i>Oh god yes,</i>\" she moans as you trail kisses from her lips, down her neck to her stiffening nipple.  \"<i>I want this so much, more than anything.  Give it to me, [name].  Don't hold back!</i>\"  Your fingers sink into her pliant flesh as you suckle on her exposed teat, groping her other tit and soft ass as she moans and squirms in your arms.  Clumsily, Hel's claws brush down your body, peeling off your [armor] until your " + CockDescriptor.describeCock(player, 0) + " flops into her lap.  She locks her scaled fingers around your manhood, roughly stroking you until you're stiff as diamonds in her grasp.");

		MainScreen.text("\n\nYou shudder as her fingers work your " + CockDescriptor.describeCock(player, 0) + ", but don't let up on your end for a second.  You brush and knead Hel's nipple between your teeth, letting your hands drift down to her wide hips and gropable ass, slowly stripping her of her scale bottom and pulling it off her legs.  With your lover bare and naked, you slip down between her legs, letting her hook them over your shoulder to give you a good view of her dripping cunt.  Your tongue laps across her labia, drawing a long, lewd moan from Hel.  She runs her fingers through your [hair], urging you onward; at her lusty moans, you dig in, sucking on her prominent clit and drilling your tongue between her inner folds.  You gasp into her when Hel's lengthy tail wraps around your shoulders, the pale flame soothingly warm on your " + player.skinFurScales() + " as her leathery appendage works its way down to the " + CockDescriptor.describeCock(player, 0) + " dangling between your [legs].  You groan with sudden need as the tip of her tail brushes your most sensitive flesh, tickling ");
		if (player.lowerBody.balls > 0) MainScreen.text("your [balls]");
		else MainScreen.text("the base of your prick");
		MainScreen.text(" before coiling around the shaft with serpentine dexterity.  Her tail contracts and squeezes, undulating across your " + CockDescriptor.describeCock(player, 0) + " until it finally massages a thick blob of pre from your " + player.cockHead() + ", dribbling out to stain the wasteland ground.");

		MainScreen.text("\n\nSuddenly, Helia grabs your shoulders and shoves you down.  You flop onto your back, tail-encased prick standing straight up like a flagpole as Hel straddles your [hips], vigorously fingering herself as her tail lines your cock up with her drooling womanhood.  Your breath catches as your " + player.cockHead() + " brushes her boiling juices, slickening your entry as she slides down your pole.  You grab Hel's flared hips, guiding her in as she envelopes your " + CockDescriptor.describeCock(player, 0) + " in the roiling inferno inside her.  Her tail unravels from around your throbbing shaft as she descends, tantalizingly slowly; she takes the better part of a minute before her groin is cozily joined to yours, her hungry maw kissing the very base of your lusty prick.");
	...
	private HaveAHellKidPartII(): void {
		...
		if (Flags.list[FlagEnum.HEL_LOVE] == 1) MainScreen.text(", and I'm so very, very glad you love me back.");
	...
	public helGotKnockedUp(): void {
		...
		if (Flags.list[FlagEnum.HELSPAWN_DADDY] == 2) MainScreen.text("warm ");
	...
	internal function heliaTalkSeven(): void {
		...
		//if PC isn't daddy:
		if (Flags.list[FlagEnum.HELSPAWN_DADDY] != 0) MainScreen.text(", even if he's not your get, I can hope, you know?  If he spends enough time around you, maybe he'll take more after you than me");
		MainScreen.text(".</i>\"");
		menu();
	...
	private encouragePregalia(): void {
		...
		if (Flags.list[FlagEnum.HEL_LOVE] == 1) MainScreen.text("You love Hel");
	...
	private helsLifestyle(): void {
		...
		if (Flags.list[FlagEnum.HEL_LOVE] == 1) MainScreen.text("and I hope that's part of why you love me");
	...
	public heliaBirthtime(): void {
		...
		if (Flags.list[FlagEnum.HELSPAWN_DADDY] == 1) MainScreen.text("your ");
	...
	private applyHelspawnName(): void {
		...
		//Easter Egg Names:
		MainScreen.clearText();
		if (Flags.list[FlagEnum.HELSPAWN_NAME] == "Helspawn") MainScreen.text("\"<i>That's what I was gonna call her!  Except not at all.  God dammit, seriously, [name]?</i>\"\n\n");
		if (Flags.list[FlagEnum.HELSPAWN_NAME] == "Jayne") MainScreen.text("\"<i>That sounds like a hero's name... I like it.  A name that demands respect!</i>\"\n\n");
		if (Flags.list[FlagEnum.HELSPAWN_NAME] == "Hesper") MainScreen.text("\"<i>Ah, the Evening Star.  She'll be the star of my life, alright...</i>\"\n\n");
		if (Flags.list[FlagEnum.HELSPAWN_NAME] == "Kiri") MainScreen.text("\"<i>Aw, that's great, lover.  Sis'll shit her pants when she hears her niece is named after her!  Gonna get confusing, though...</i>\"\n\n");
		if (Flags.list[FlagEnum.HELSPAWN_NAME] == "Mai") MainScreen.text("\"<i>Aw, that's great, lover.  Mai'll be honored, I know it.  And it is a great name...</i>\"\n\n");
		if (Flags.list[FlagEnum.HELSPAWN_NAME] == "Tanis") MainScreen.text("\<i>I don't... I don't know if I want her to have that name, lover.  It's got a lot of baggage, but... but it does my mother an honor.  More than I could ever give her.</i>\"\n\n");
		//Syn: 
		if (Flags.list[FlagEnum.HELSPAWN_NAME] == "Syn") MainScreen.text("\"Awesome.  I was hoping you'd choose that one, lover mine.</i>\"\n\n");
		if (Flags.list[FlagEnum.HELSPAWN_NAME] == "Chara") MainScreen.text("\"<i>Awesome.  You liked my ideas, after all!</i>\"\n\n");

		MainScreen.text("\"<i>So... " + Flags.list[FlagEnum.HELSPAWN_NAME] + " it is.  That's a good name, my love.  A strong name.  ");
		if (Flags.list[FlagEnum.HELSPAWN_DADDY] == 0) MainScreen.text("Our");
	...
	internal function heliaTalkEight(): void {
		...
		if (Flags.list[FlagEnum.HELSPAWN_DADDY] == 0) MainScreen.text("parental ");
	...
	internal function playWithYourKid(): void {
		MainScreen.clearText();
		spriteSelect(68);
		MainScreen.text("Picking " + Flags.list[FlagEnum.HELSPAWN_NAME] + " up off the ground, you spin the giggling little girl around, laughing as your ");
		if (Flags.list[FlagEnum.HELSPAWN_DADDY] != 0) MainScreen.text("ward ");
		else MainScreen.text("daughter ");
		MainScreen.text("cries out in surprise and glee.  Soon, you're bouncing her, then down on the ground crawling around with her, playing peek-a-boo and a dozen other games as you and " + Flags.list[FlagEnum.HELSPAWN_NAME] + " laugh and hug.  Helia herself slips down with you before you know it, holding her daughter close as she tries to communicate, teaching the ever-growing girl a few words at a time.");
	...
	public helSpawnGraduation(): void {
		...
		MainScreen.text("You wake up to a scream, high-pitched and terrified.  You bolt up out of bed, tangling up in your bedroll for a minute before stumbling over to Hel and... " + Flags.list[FlagEnum.HELSPAWN_NAME] + "?");
		MainScreen.text("\n\nYou do a double take as you lay eyes on the ");
		if (Flags.list[FlagEnum.HELSPAWN_DADDY] == 1) MainScreen.text("black");
		...
		if (Flags.list[FlagEnum.HELSPAWN_DADDY] == 2) MainScreen.text("And the puppy ears, now more wolf-like, are a dead giveaway.  Utterly unique to her.  ");
	...
	private encourageHelspawn(): void {
		...
		if (Flags.list[FlagEnum.HELSPAWN_DADDY] != 1) MainScreen.text("red ");
	...
	public helSpawnChoosesAFightingStyle(): void {
		MainScreen.clearText();
		spriteSelect(68);
		MainScreen.text("As you make your way back to camp, you begin to hear the sounds of fighting from ahead.  Readying your [weapon], you pick up the pace until your campsite comes into view.  You relax, seeing that it's only " + Flags.list[FlagEnum.HELSPAWN_NAME] + " and her mother.  Helia's standing near the center of camp, ");
		if (camp.companionsCount() > 3) MainScreen.text("apparently having cleared out most of your other followers for the moment, ");
		MainScreen.text("her sword held at a guard pose between herself and a training dummy. " + Flags.list[FlagEnum.HELSPAWN_NAME] + " stands a few feet behind her mother, watching intently as Hel paces around the dummy, breathing hard.");
	...
	private snipermanders(): void {
		...
		else if (latexGooFollower()) MainScreen.text("  You hear a sudden yelp of pain from across camp.  " + Flags.list[FlagEnum.GOO_NAME] + " slithers up to you with an irritated look on her gooey face, pointing an accusing finger at an arrow sticking out of her tit.  \"<i>Dammit, [name], I'm a googirl, not a pin cushion!</i>\"  You wave her off, and tell " + Flags.list[FlagEnum.HELSPAWN_NAME] + " to try again.");
		...
		if (Flags.list[FlagEnum.HELSPAWN_DADDY] == 0) MainScreen.text("s");
		MainScreen.text(".");
		doNext(camp.returnToCampUseOneHour);
	}
	...
	private swordAndBoardmander(): void {
		...
		if (Flags.list[FlagEnum.HELSPAWN_DADDY] == 0) MainScreen.text("\n\nYour");
		...
		if (Flags.list[FlagEnum.HELSPAWN_DADDY] != 0) MainScreen.text("her");
	...
	private dasBarbarimander(): void {
		...
		if (player.stats.gems >= 200) {
			MainScreen.text("You sigh and dig out a handful of gems.  Helia beams at you, planting a quick kiss on your cheek before grabbing " + Flags.list[FlagEnum.HELSPAWN_NAME] + " and the loot.  \"<i>Thanks for the loan, lover mine.  C'mon, sweetie, we're going for a trip to town.</i>\"");
	...
	public helspawnIsASlut(): void {
		...
		if (player.stats.cor >= 50) MainScreen.text("  And by mistake you clearly mean old enough to get her ass fucked in by a cute little spider trap... you contemplate jumping in on it, but with a sigh figure it's " + Flags.list[FlagEnum.HELSPAWN_NAME] + "'s catch.  Let her enjoy it.");
		menu();
	...
	private helSpawnStopFucking(): void {
		MainScreen.clearText();
		spriteSelect(68);
		MainScreen.text("You sigh and step out of the shadows, grabbing the feminine little spider boy by the shoulder and yanking him away from " + Flags.list[FlagEnum.HELSPAWN_NAME] + ".  \"<i>And just what the hell do you two think you're doing?</i>\" you yell, scowling ");
		if (player.tallness >= 90) MainScreen.text("up ");
		else if (player.tallness <= 72) MainScreen.text("down ");
		...
		if (Flags.list[FlagEnum.HELSPAWN_DADDY] == 0) MainScreen.text("my dad");
		...
		//If No Hel Love:
		if (Flags.list[FlagEnum.HEL_LOVE] != 0) MainScreen.text("  You don't want to be a whore like your mother, do you?  The girl that everyone's had a ride with.");
		//if HelLove:
		if (Flags.list[FlagEnum.HEL_LOVE] == 1) MainScreen.text("  I'm not going to a raise a whore, " + Flags.list[FlagEnum.HELSPAWN_NAME] + ".  Your mother's made mistakes, sure, but...</i>\" you sigh.  \"<i>");
		MainScreen.text("  You don't have to be that person, " + Flags.list[FlagEnum.HELSPAWN_NAME] + ".  Don't just give yourself out to the first person that asks, you know?  Save it for someone you really care about.  Trust me, it'll be worth it.</i>\"");
	...
	public helspawnsMainMenu(): void {
		MainScreen.clearText();
		MainScreen.text("You call " + Flags.list[FlagEnum.HELSPAWN_NAME] + " over to you and she comes running, ");
	...
	private talkToHelspawn(): void {
		...
		if (Flags.list[FlagEnum.HAD_FIRST_HELSPAWN_TALK] == 0) {
			...
			//{if Sluttymander:
			if (Flags.list[FlagEnum.HELSPAWN_PERSONALITY] >= 50) MainScreen.text("  Even if she wants to be just like mom, she shouldn't be bringing monsters home.  Some of them may be dangerous, and she's not a warrior quite like you and Helia yet.");
			...
			if (Flags.list[FlagEnum.HELSPAWN_DADDY] == 0) MainScreen.text("Of course, as her father, you could always say it's your duty to keep her happy...");
		...
		//{Needs Rath at camp]
			...
			MainScreen.text("\"<i>" + Flags.list[FlagEnum.HELSPAWN_NAME] + "!</i>\" you hear a ragged old voice call, \"<i>Get back here this instant!  I'm not done with you yet!</i>\"");
		...
		//{Bath Slut w/ DD or HHH must be at camp}
			...
			MainScreen.text("\"<i>Hey, have you seen " + Flags.list[FlagEnum.MILK_NAME] + " around anywhere, " + championRef() + "?</i>\" " + Flags.list[FlagEnum.HELSPAWN_NAME] + " asks, looking around the camp.  \"<i>Mom asked me to milk her, but I haven't seen her around.  She wouldn't have run off, would she?</i>\"");
			if (Flags.list[FlagEnum.MILK_SIZE] == 1) MainScreen.text("\n\nYou tell her it'd be more of a wobble, but");
		...
		//{Isabella must be at camp}
			...
			MainScreen.text("\"<i>Oh hey, " + championRef() + "!</i>\" " + Flags.list[FlagEnum.HELSPAWN_NAME] + " says, suddenly grinning, \"<i>Mom bought me a new guitar in town.  Wanna come listen?</i>\"");
	...
	private dontFuckAlex(): void {
		MainScreen.clearText();
		MainScreen.text("Stroking " + Flags.list[FlagEnum.HELSPAWN_NAME] + "'s hair, you try to tell her that there's a better way, that she doesn't have to just fuck everything she comes across.  Her mother's that way, sure, but she could do so much better, so much more with herself than giving in to constant lust.");
		//{If Sluttymander:}
	...
	private sparHelspawn(): void {
		MainScreen.clearText();
		MainScreen.text("You ask " + Flags.list[FlagEnum.HELSPAWN_NAME] + " if she's up for some battle practice, and she answers with an eager nod as she grabs her weapon.");
		//If Sluttymander: 
	...
	internal function loseSparringToDaughter(): void {
		...
		if (Flags.list[FlagEnum.HELSPAWN_PERSONALITY] >= 50) {
			...
			if (player.stats.lust > 99) MainScreen.text("succumbing to your own lusts");
			else MainScreen.text("unable to withstand her unending hail of attacks");
			MainScreen.text(", " + Flags.list[FlagEnum.HELSPAWN_NAME] + " quickly sweeps your [legs] out from under you, dropping you right on your ass.  You collapse with a grunt, ");
			...
			MainScreen.text(", and a moment later " + Flags.list[FlagEnum.HELSPAWN_NAME] + "'s on you, straddling you with her powerful legs, pushing you down into the dirt.");
		...
		//Else If Chastemander:
			...
			MainScreen.text(", " + Flags.list[FlagEnum.HELSPAWN_NAME] + " grabs your arm, catching you before you can fall.  \"<i>Easy there, " + championRef() + ", I got you,</i>\" she says, pulling you into a quick hug.");
	...
	internal function beatUpYourDaughter(): void {
		...
		if (Flags.list[FlagEnum.HELSPAWN_PERSONALITY] >= 50 && monster.lust > 99) {
			...
			//If No Incest: 
			if (Flags.list[FlagEnum.HELSPAWN_INCEST] == 0) MainScreen.text("  You wash your hands of the defeated slut and head back to camp, leaving her to work through her tension herself.");
			else {
			...
			MainScreen.text(Flags.list[FlagEnum.HELSPAWN_NAME] + " stumbles back, dropping her weapon and waving her arms, \"<i>I give, I give.</i>\"");
	...
	public maiVisitsHerKids(): void {
		MainScreen.clearText();
		spriteSelect(68);
		MainScreen.text("As you head back into camp, you notice Hel and " + Flags.list[FlagEnum.HELSPAWN_NAME] + " are sitting around the cook fire in the center of camp, with your foster daughter balanced precariously on the lap of her own father, Mai the fox-girl.");
	...
	public spiderBrosGift(): void {
		...
		MainScreen.text("As you're getting ready to head out for the day, you notice " + Flags.list[FlagEnum.HELSPAWN_NAME] + " prancing around camp with a long, brightly-colored scarf wrapped around her neck, standing painfully in contrast with her midnight-black scales and pale flesh.");
	...
	public hakonAndKiriComeVisit(): void {
		...
		MainScreen.text("\n\n\"<i>Sure!  ");
		if (Flags.list[FlagEnum.HELSPAWN_WEAPON] == "scimitar and shield") MainScreen.text(championRef() + "'s been teaching me how to fight.");
		...
		if (Flags.list[FlagEnum.HELSPAWN_DADDY] == 0) MainScreen.text("your old man");
		else MainScreen.text("[name]");
