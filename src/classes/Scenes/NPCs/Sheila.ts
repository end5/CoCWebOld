	...
	public class Sheila extends Monster
	{
		...
		private function suspiciousGlint():void {
			...
			//Hit:
				...
				if(!player.lowerBody.cockSpot.hasCock()) outputText("burying her drooling tail inside you until it squirts");
		...
		private function lickEmAndStickEm():void {
			...
			if(player.lowerBody.cockSpot.hasCock()) outputText("[oneCock] fucks Sheila to the base while her tail snakes around and penetrates your [vagOrAss]");
