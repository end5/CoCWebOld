...
export default class Sheila extends Monster {
	...
	private sheilaFlyingKick(): void {
		...
		//Hit:
			...
			damage = int((str + 50 + weaponAttack) - rand(player.stats.tou) - player.armorDef);
			if (damage < 1) damage = 2;
			damage = player.takeDamage(damage);
			MainScreen.text(" (" + damage + ")");
	...
	public Sheila() {
		...
		this.skinTone = "tan";
		this.upperBody.head.hairColor = "auburn";
		this.upperBody.head.hairLength = 11;
