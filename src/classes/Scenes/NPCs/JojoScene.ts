...
public corruptCampJojo():void {
	...
	if (flags[FlagEnum.FOLLOWER_AT_FARM_JOJO] == 0)
	{
		...
		Render.text("Before you call for your corrupted pet, how do you want to use him?", true);
	}
	else
	{
		Render.text("Jojo slinks out of a barn when you call his name, hating and loving every step he takes towards you. He looks dusty and worn out but his dick still strains at the sight of you.");
		...
		if (tentacleJojo()) Render.text(" A number of tentacles vaugley resembling cocks have sprouted from his back and groin. They sway restlessly around him, oozing thick, fragrant pre from their tips.");
		...
		if (kGAMECLASS.farm.farmCorruption.hasTattoo("jojo"))
		{
			...
			{
				Render.text("He is covered from head to tail in tribal tattoos, erotic lines snaking all over his naked frame, giving him the look of a barely tamed savage.")
			}
			else
			{
				if (kGAMECLASS.farm.farmCorruption.numTattoos("jojo") > 1) Render.text("He has the following tattoos emblazoned across his body:\n");
				else Render.text("He has ");

				if (flags[FlagEnum.JOJO_TATTOO_COLLARBONE] != 0) Render.text(flags[FlagEnum.JOJO_TATTOO_COLLARBONE] + "\n");
				if (flags[FlagEnum.JOJO_TATTOO_SHOULDERS] != 0) Render.text(flags[FlagEnum.JOJO_TATTOO_SHOULDERS] + "\n");
				if (flags[FlagEnum.JOJO_TATTOO_LOWERBACK] != 0) Render.text(flags[FlagEnum.JOJO_TATTOO_LOWERBACK] + "\n");
				if (flags[FlagEnum.JOJO_TATTOO_BUTT] != 0) Render.text(flags[FlagEnum.JOJO_TATTOO_BUTT] + "\n");
				Render.text("\n");
			}
		}
	...
	if (flags[FlagEnum.FARM_CORRUPTION_STARTED] == 1 && flags[FlagEnum.FOLLOWER_AT_FARM_JOJO] == 0) addButton(6, "Farm Work", sendToFarm);
	if (flags[FlagEnum.FARM_CORRUPTION_STARTED] == 1 && flags[FlagEnum.FOLLOWER_AT_FARM_JOJO] == 1) addButton(6, "Go Camp", backToCamp);
	
	if (flags[FlagEnum.FOLLOWER_AT_FARM_JOJO] == 1 && flags[FlagEnum.FOLLOWER_PRODUCTION_JOJO] == 0) addButton(7, "Harvest Draft", harvestJojoDraft);
	if (flags[FlagEnum.FOLLOWER_AT_FARM_JOJO] == 1 && flags[FlagEnum.FOLLOWER_PRODUCTION_JOJO] == 1) addButton(7, "Stop Harvest", stopHarvestJojoDraft);
...
private harvestJojoDraft():void
{
	...
	Render.text("You tell Jojo that you want him hooked up to a cock milker whenever possible; you need his fluids.");
...
private stopHarvestJojoDraft():void
{
	...
	Render.text("You tell Jojo to stop producing incubus draft; you’re practically drowning in the stuff. Jojo closes his eyes, and you grin as you envisage the image you’ve just planted in his mind.");
...
private sendToFarm():void
{
	...
	Render.text("You tell your pet mouse");
	if (tentacleJojo()) Render.text("-come-tentacle-beast");
	Render.text( " that he is to head towards the lake, find a farm, present himself to the lady who works there and do as she says.");
...
private backToCamp():void
{
	...
	Render.text("You tell him to head back to camp; there are things you need to do to him you can’t do whilst he’s here. Repeatedly. Jojo trembles, manages a bow, and then slowly trails off towards camp.");
...
private jojoMutationOfferYes():void {
	...
	Render.text("Whether by luck or some unconscious demonic magic, the smaller piece of lethicite is rather phallic. If it weren't for the sharp corners and hard edges, it would look like a large dildo with a pair of balls at the base.  You put away the larger piece, focusing this tool and your plans for your pet.\n\n", false);
	Render.text("You lick the sharp crystalline dildo, slathering it with spit.  You aren't sure, but you seem unable to stop.  It's as if some demonic force guides you.  It's difficult to focus on much beyond your own arousal and the tingling feeling that spreads through your body as you taste this piece of a goddess' essence.  Your mind drifts off into a perverted fantasy, unable to cope with total loss of control and oral debauchery.\n==========================================\n<i>", false);
	//[Male]
	if(player.gender <= 1) {
		Render.text("In your fantasy you're fucking Jojo again, bottoming out against his cute girlish ass over and over.  His dick spurts mouse-milk with each thrust, feeding a dozen growing puddles underneath him as they slowly merge together.  He writhes and squirms, a pair of crystalline balls against his chin while he deep-throats a massive dildo.  You blast another wave into his overloaded spunk-dumpster, forcing a thick jet out of him and into the cum-puddles underneath you.\n\n", false);
		Render.text("Tired of the foreplay, you pull out of him, watching a river of your cum escape from the uncorked opening.  You pull him up, watching the crystal cock slide out of his mouth, the bulge along his throat slowly disappearing as each inch escapes.  He staggers, completely exhausted, but still hard and horny judging by the look in his eye.\n\n", false);
		Render.text("You shove him over a log and grab his spit-slick toy, dragging it through the puddled cum until it's white and dripping.  Jojo whimpers, his disproportional member stuck between his legs and twitching with anticipation.  The dildo slides into his well-stretched hole with ease, sealing the rest of your tainted seed deep inside his bowels as your magic begins to change him...</i>\n==========================================\n", false);
		Render.text("You snap out of the fantasy with a start.  The crystal shard is sitting on the ground in front of you, but it is no longer a shard – it's the dildo from your fantasy, complete with a thick covering of your cum.  You manage to pry your hand away from your softening member");
		if (player.lowerBody.cockSpot.count() > 1) Render.text("s");
		Render.text(" and take the tainted artifact, now ready to be used.</i>\n", false);
	}
	//[Female] 
	else {
		Render.text("In your fantasy, you're riding Jojo hard, milking his swollen dick with your pussy", false);
		if(player.biggestLactation() < 2) Render.text(" while your tits cover his head, nearly suffocating him", false);
		else Render.text(" while he suckles one of your breasts hungrily, sucking down your milk", false);
		Render.text(". A crystalline dildo is buried hilt-deep in his ass, held in place by a harness of your own design that twists it around every time he moves.  You cum again, relishing the desperate and needy look the poor mouse is giving.  Your spasming pussy is immediately filled with even more warmth, and you feel the thick spunk forcing its way into your core until you feel bloated.\n\n", false);
		Render.text("You calm your trembling body and stand up off of him, soaking him with his own escaping fluids.  Jojo moans and starts pumping his dick, wriggling his hips while his orgasm is dragged on by the dildo squeezing his prostate.  You curl up alongside his ear and begin whispering into his mind, watching as your words soak in and begin to change him with the aid of the crystalline cock's magic.</i>\n==========================================\n", false);
		Render.text("You snap out of your fantasy with a start.  The crystal shard is sitting on the ground in front of you, but it's no longer a shard – it's the dildo from your fantasy, now slick with pussy juices.  You touch your sore cunt and gasp when you realize where it went.  ", false);
		if(player.vaginas[0].virgin) Render.text("(Yet somehow your virginity remains intact).  ", false);
		Render.text("The dildo disappears back into your inventory, and you smile in wicked anticipation of your next meeting with Jojo.\n", false);
	}
...
private mutateJojo():void {
	...
	Render.text("Jojo shivers and takes your offering with his free hand, slowly hefting it and dragging it lower.  He looks up at you questioningly, and you gesture impatiently at him to quit wasting your time.  The dildo's crown presses against his sphincter, stopping for a second as the bitch-boy relaxes, and then begins its long journey inward.  Jojo's eyes roll up a bit and his prick starts pumping out a clear stream of his pre-cum, wetting most of his belly.  Finally the pinkish-hued balls press against his bum.  He's taken the whole thing.\n\n", false);
	Render.text("While you still have one of the mouse's hands pinned under your " + player.foot() + ", his other has already released the tainted sex-toy, and journeyed up to his pre-cum spurting cock.  You waste no time and push his hand away as you jump on top of him, being sure to grind your " + vaginaOrDicksOrCrotch() + " against his slick boner.  He keeps whining plaintively and wriggling his hips against you, but you deny him any further stimulation, instead focusing on keeping him horny while the tainted dildo settles in.\n\n", false);
	Render.text("Jojo's moans reach a fevered pitch as a soft buzzing begins to fill the air behind you.  You turn around and see that the lethicite-crafted dildo has begun to vibrate inside of him!  Somehow you can feel that this is the time to change him – that his form is malleable and ready.  Your hand finds itself wrapped around the base of his cock, bottling him up until you're ready, while you lean up to his cute mouse-ears and start to whisper, \"<i>Aww, does my little rodent-bitch want to cum?</i>\"\n\n", false);
	Render.text("He shakes his head and whines again, trembling underneath you.\n\n", false); 
	Render.text("\"<i>Too bad slut,</i>\" you say while you give his balls a squeeze, \"<i>you can't cum until I've changed you into the perfect fuck-toy.  A toy that can just keep cumming, more than once.  A toy who can fill more than one hole at a time.  A toy I could share with my friends, who could keep up with a succubus and an incubus simultaneously.  You'll be that toy for me.  My delicious fuck-puppet that cums on command with tentacle-dicks and pussy-vines aplenty.</i>\"\n\n", false);
	Render.text("Jojo's eyes roll back until all you can see is the whites.  His mouth lolls open from pleasure and lets loose a constant stream of pants and moans.  Already you can feel his cock squirming in your hand, thrashing to get free.  The dildo starts vibrating louder, and his pre-cum manages to start spurting free again, despite your tight grip on his member.  You see his shoulders bulge as something starts wriggling under his skin, thrashing back and forth until they sprout free as a pair of tentacles.\n\n", false); 
	Render.text("Uncontrolled, the tentacles curl down to Jojo's vine-like member, wrapping it in coils until your hand is forced off and wriggling around it.  You note each of his new appendages is developing a flare at their tips, and the puddle of pre seems to be growing faster than it ever did before.\n\n", false);
	Render.text("You whisper, \"<i>Good bitch, you'll be able to fuck every hole around you, won't you?  But all I see is an ass and a mouth for cocks.  You need some nice tight cock-sleeves don't you?</i>\"\n\n", false);
	Render.text("On cue, you feel his tail curl up your back, already longer than it ever was before.  To your surprise the fur is vanishing, leaving you feeling smooth rubbery skin.  It splits three ways in an instant, but each grows thicker than his tail ever was before.  One curls over your shoulder as if looking for something, and reveals a strange sucking opening, sticky with some kind of fluid and filled with undulating fleshy ridges.\n\n", false);
	Render.text("You smile and give the opening a lick – it's sweet – and turn back to his ear, \"<i>Now you're where I want you bitch.  Feel that dildo squeezing your prostate?  You'll cum just from that won't you?  Take those new tentacles off your dick and aim them at your face, I want to watch you give yourself a facial and cum all over yourself just from my other toy.</i>\"\n\n", false);
	...
	if(player.upperBody.chest.BreastRatingLargest[0].breastRating < 1) Render.text("bodies", false);
	else Render.text(allBreastsDescript(), false);
	Render.text(", until it pops out just under his chin, looking like a fatter version of the twins on his shoulders.  All three start flaring wider in preparation, and you know he is about to erupt.\n\n", false);
	Render.text("\"<i>Good toy,</i>\" you whisper, \"<i>cum for your ", false);
	if(player.gender <= 1) Render.text("master", false);
	else Render.text("mistress", false);
	Render.text(".</i>\"\n\n", false);
	Render.text("He submits happily, a smile overtaking his face in spite of his eyes rolled back and his tongue drooling all over his muzzle.  His entire body quakes, and you feel bulges beginning to pass under your ", false);
...
public useTentacleJojo():void {
	...
	if(player.totalCocks() > 0) {
		...
		if(player.lowerBody.cockSpot.count() == 1) {
			...
			//(1 dick no balls = 
				...
				Render.text(" your " + cockDescript(0) + " in a tight vise of pleasure.  The other two tentacles slide under, ", false);
				if(!player.lowerBody.vaginaSpot.hasVagina()) Render.text("rubbing back and forth along your taint and smearing you with their slime.", false);
				else {
					Render.text("rubbing against your thighs and smearing them with lubricant while one of them easily sucks your " + clitDescript() + " inside.", false);
					//(If big clit – 
					if(player.lowerBody.vaginaSpot.list[0].clitLength >= 4) Render.text("  You nearly cum on the spot from the clitoral stimulation; it's like you have a super-sensitive cock being licked by a thousand tongues.", false);
				}
				Render.text("\n\n", false);
			}
		}
		...
		if(player.lowerBody.cockSpot.count() == 2) {
			//balls)
			if(player.lowerBody.balls > 0) {
				Render.text("Two of them lash forward, ", false);
				if(player.cockArea(0) > 60) Render.text("laboriously stretching around", false);
				else if(player.cockArea(0) >= 20) Render.text("engulfing", false);
				else Render.text("easily swallowing", false);
				Render.text(" your " + multiCockDescriptLight() + " in tight vises of pleasure.  The remaining tentacle slides underneath, alternatively taking each of your " + ballsDescript() + " partway into its 'mouth' and massaging them with its thousands of wriggling stimulators.\n\n", false);
			}
			//(2 dicks no balls) 
			else {
				Render.text("Two of them lash forward, ", false);
				...
				Render.text(" your " + multiCockDescriptLight() + " in tight vises of pleasure.  The remaining tentacle slides underneath, seeking ", false);
				if(player.lowerBody.vaginaSpot.hasVagina()) {
					Render.text("out your " + clitDescript() + " and sucking it inside.", false);
					//(If big clit – 
					if(player.lowerBody.vaginaSpot.list[0].clitLength >= 4) Render.text("  You nearly cum on the spot from the clitoral stimulation; it's like you have a super-sensitive cock being licked by a thousand tongues.", false);
				}
				else Render.text("to rub itself along your taint, massaging the sensitive skin with its slimy lubricants.", false);
				Render.text("\n\n", false);
			}
		}
		//(3 dicks) 
		if(player.lowerBody.cockSpot.count() >= 3) {
			Render.text("All three of them lash forward, ", false);
			if(player.cockArea(0) > 60) Render.text("laboriously working to swallow", false);
			else if(player.cockArea(0) >= 20) Render.text("engulfing", false);
			else Render.text("easily swallowing", false);
			Render.text(" your " + multiCockDescriptLight() + " in tight vises of pleasure.  The sensation is overwhelmingly pleasurable, like having three cocks being licked and sucked by a thousand tongues.", false);
			//(if extra: 
	...
	if(player.totalCocks() == 0 && player.lowerBody.vaginaSpot.hasVagina()) {
		Render.text("One of Jojo's tail-tentacles slides underneath his body, shooting forwards to seek out your " + clitDescript() + ".  It pauses an inch or two away and opens up a horrific orifice full of wriggling tentacles and slick fluids.  The next moment it lunges forwards and sucks it inside.", false);
		//(If big clit – 
		if(player.lowerBody.vaginaSpot.list[0].clitLength >= 4) Render.text("  You nearly cum on the spot from the clitoral stimulation; it's like you have a super-sensitive cock being licked by a thousand tongues.", false);
		else Render.text("  The sensation was unreal, and you find yourself wishing your clit was bigger so you could feel even more of the tendrils pleasure-hole.", false);
		Render.text("\n\n", false);
	}
	//GET BUTT/VAGOO PENETRATED
	Render.text("The ", false);
	if(player.lowerBody.vaginaSpot.hasVagina()) Render.text("pair of tentacles ", false);
	else Render.text("tentacle ", false);
	Render.text("hanging over your bottom decide", false);
	if(!player.lowerBody.vaginaSpot.hasVagina()) Render.text("s", false);
	Render.text(" that now is a good time to penetrate your undefended opening", false);
	if(player.lowerBody.vaginaSpot.hasVagina()) Render.text("s", false);
	Render.text(", and press against you, ", false);
	//Virgin taking
	if(player.hasVirginVagina() || player.ass.analLooseness == 0) {
		Render.text("barely slipping inside your virginal opening", false);
		if(player.hasVirginVagina() && player.ass.analLooseness == 0) Render.text("s", false);
	}
	//not virgin taking
	else {
		//With cunt
		if(player.lowerBody.vaginaSpot.hasVagina()) {
			if(player.vaginas[0].vaginalLooseness >= VAGINA_LOOSENESS.GAPING_WIDE) Render.text(" practically falling into your oversized cum-receptacles", false);
			else {
				if(player.vaginas[0].vaginalWetness >= VAGINA_WETNESS.SLICK) Render.text(" sliding inside easily thanks to your copious lubrication", false);
				else Render.text("forcing their way inside your " + vaginaDescript(0) + " and " + assholeDescript(), false);
			}
		}
		//Just butt
		else {
			if(player.ass.analLooseness >= 4) Render.text(" practically falling into your oversized cum-receptacle", false);
			else {
				if(player.ass.analWetness >= 3) Render.text(" sliding inside easily thanks to your copious lubrication", false);
				else Render.text("forcing its way inside your " + assholeDescript(), false);
			}
		}
	}
	//ON WITH THE PENETRATION
	Render.text(".  Your " + mouthMuzzle() + " opens with a wordless cry of surprise ", false);
	if(player.lowerBody.vaginaSpot.hasVagina()) Render.text("and pleasure ", false);
	Render.text("as Jojo's tentacle", false);
	if(player.lowerBody.vaginaSpot.hasVagina()) Render.text("s begin", false);
	else Render.text(" begins", false);
	Render.text(" thoroughly violating you, pistoning in and out relentlessly.", false);
	if(player.totalCocks() > 0) {
		Render.text("  You feel a strange pleasure every time it plunges deep into your ass, smacking into your prostate.  ", false);
		if(player.lowerBody.cockSpot.count() == 1) Render.text("  The tentacle on your " + multiCockDescriptLight() + " seems appreciative, and begins sucking to swallow down all your pre.", false);
		if(player.lowerBody.cockSpot.count() > 1) Render.text("  The tentacles on your " + multiCockDescriptLight() + " seem appreciative, and begin sucking to swallow down all your pre.", false);
	}
	if(player.lowerBody.vaginaSpot.hasVagina()) Render.text("  Your " + vaginaDescript(0) + " spasms around the invader, clenching uncontrollably as it's plowed by the thick vine-prick.", false);
	Render.text("\n\n", false);
	Render.text("You feel the bindings around your waist sliding and twisting to free up some of their length.  The pair of tentacle-cocks rear up before your " + allBreastsDescript() + " like hungry snakes eyeing a mouse.\n\n", false);
	...
	if((player.upperBody.chest.BreastRatingLargest[0].breastRating >= 4 || (player.upperBody.chest.BreastRatingLargest[0].breastRating >= 4 && player.upperBody.chest.count() > 1)) && player.biggestLactation() < 2) {
		titFucking = true;
		Render.text("The twin tentacles erupt like kinked up garden-hoses that have suddenly become free, splattering your chest with thick white goop.  They spurt until all of your " + breastDescript(0) + " are painted white with warm dripping goop.  One of the purple-headed monsters slides into the mess, while the other ties itself around your " + breastDescript(0) + ", squeezing its brother tightly between the walls of cum-slickened titflesh.  The swollen purple head bumps your chin, smearing you with its cum as it begins to fuck your tits.  Glob after glob of mouse-cum spatters up from your chest into your chin and mouth, eventually soaking your " + faceMuzzle() + " and neck.\n\n", false);
	}
	//(Lactating highly)
	if(player.biggestLactation() >= 2) {
		nippleSucking = true;
		Render.text("The heads split apart, dividing into quarters as they reveal wet openings with pink, tongue-like appendages.  Milk begins to leak from your nipples as their intent becomes clear, and you inwardly scold yourself for ", false);
		if(player.stats.cor < 80) Render.text("being such a wanton slut", false);
		else Render.text("giving it up too easily", false);
		Render.text(".  Jojo's dick-mouths latch on and suck hard, pulling your " + nippleDescript(0) + "s deep into their internal reservoir and stimulating your breasts to release a torrent of milk.  ", false);
		if(player.cowScore() >= 5) Render.text("You find yourself mooing in contentment as your fuck-slave works to milk you.  ", false);
		Render.text("You watch with a happy smile, enjoying the sensations as the tentacles bulge and move milk-distended knots down their lengths towards Jojo.  They are so full that the sloshing whiteness actually becomes visible through the 'skin' of his tendrils.", false);
	...
	//(NEITHER - JUST NIPS) 
		...
		nippleSucking = true;
		Render.text("The heads split apart, dividing into quarters and revealing a wet pink opening with a writhing tongue in the center.  They latch on and suck hard, each pulling your entire " + nippleDescript(0) + " into their interior.  Gasping at the sensations, you can only moan as the tentacular tongue twists itself around your nipple.  ", false);
		if(player.biggestLactation() >= 1) Render.text("A squirt of milk escapes and is quickly sucked down by the hungry tentacles.  ", false);
		Render.text("The sucking and teasing is relentless, keeping your nipples hard and incredibly sensative as Jojo has his way with you.\n\n", false);
	}
	//mouthfuck – if shoulder-tentacles are unoccupied – random
		...
		mouthFucking = true;
		Render.text("You feel the bindings around your waist sliding and twisting to free up some of their length.  The pair of tentacle-cocks rear up in front of your face, dripping cum from their tainted purple heads.  One curls around the other, twirling around it until the two tentacles look more like some obscene double-headed dildo.  They smear against your lips, coating them with spunk and begging to be let inside.  Pushing harder and harder, they eventally work your jaw open and cram themselves inside.  An immediate jet of cum paints the back of your throat, nearly gagging you for a moment.  The sensation passes quickly, as if your gag reflex was somehow numbed.\n\n", false);
		Render.text("Twinned dicks force themselves further into your throat, until you are sure they must be outlined and clearly visible to Jojo on your neck.  The mouse-dicks push further in, working their way down to the bottom of your esophagus before pulling back, dripping cum all the while.  Every now and then you get a feeling of fullness in your belly, and realize one of them must have shot off a load of spunk directly into you.  The brutal mouthfuck shows no sign of slowing down, forcing you to gasp in a breath through your nose every time the tentacles pull back.\n\n", false);
	}
	//Cumsplosion
	Render.text("Jojo unleashes a howl of bestial pleasure, and you feel the ", false);
	if(player.lowerBody.vaginaSpot.hasVagina()) {
		Render.text("tentacles in your " + assholeOrDP() + " thicken perceptibly.  Bulges of cum work their way down the tentacles, spreading your " + assholeOrDP() + " wide before stuffing you full of mouse cream.  You can feel your bowels and uterus filling, expanding you until you look ", false);
		if(player.pregnancyIncubation == 0) Render.text("mildly pregnant", false);
		else Render.text("even more pregnant", false);
		Render.text(".  Your body spasms around them, locked in the throes of orgasm", false);
		if(player.vaginas[0].vaginalWetness == VAGINA_WETNESS.SLAVERING) Render.text(", and soaks him with a wave of puss juice.  ", false);
		else if(player.vaginas[0].vaginalWetness >= VAGINA_WETNESS.SLICK) Render.text(", as your drooling cunt forms a slick puddle.  ", false);
		else Render.text(".  ", false);
		//(If big clit being sucked – 
		if(player.lowerBody.cockSpot.count() <= 2 && player.lowerBody.balls == 0) {
			Render.text("The tentacle locked around your " + clitDescript() + " bulges out a bit as your clit throbs from the orgasm, before it sucks harder, making your clitty even larger.  You squeal from the raw sensation until the tentacle pops off, satisfied, leaving your clit looking like an angry red cock.  ", false);
			player.lowerBody.vaginaSpot.list[0].clitLength += .25;
		}
		Render.text("Both tentacles pull out, still dripping whiteness that puddles in your holes.", false);
	}
	else {
		Render.text("tentacle in your " + assholeDescript() + " thickens perceptibly.  Bulges of cum work their way down the main tentacle, spreading your " + assholeDescript() + " wide before stuffing you full of mouse cream.  You can feel your bowels filling, expanding you until you look mildly pregnant.  Your body spasms around them, locked in the throes of orgasm.  The tentacle pulls out, still dripping whiteness that puddles in your well-used hole.", false);
	}
	//Dick milkings ahoy!
	if(player.lowerBody.cockSpot.count() > 0) {
		if(player.lowerBody.cockSpot.count() == 1) {
			Render.text("The tentacle working over your " + multiCockDescript() + " clamps down and wriggles deliciously around you.  You can't help but cum from the assault, feeding the tentacle your hot spoogy load.  It drinks it down eagerly", false);
			if(player.cumQ() >= 100) {
				Render.text(", but after a few moments it begins to struggle with the sheer output.", false);
				if(player.cumQ() >= 300) {
					Render.text("  When you finally finish, it's bloated and dripping your cum all over your crotch.", false);
					if(player.cumQ() >= 600) {
						Render.text("  You pump the tentacle so full it turns pinkish-white and bloats obscenely, before suddenly releasing a backflow that soaks you in spunk from the waist down. It drops to the ground limp and spent", false);
						if(player.cumQ() >= 800) Render.text(" but you don't stop cumming until it lies in a deep puddle of jizz", false);
						Render.text(".", false);
						cumPuddle = true;
					}
				}
		...
		if(player.lowerBody.cockSpot.count() > 1) {
			Render.text("The tentacles working over your " + multiCockDescript() + " clamp down and wriggle deliciously around you.  You can't help but cum from the assault, feeding the tentacles your hot spoogy load.  They drink it down eagerly", false);
			if(player.cumQ() >= 100) {
				Render.text(", but after a few moments they begin to struggle with the sheer output.", false);
				if(player.cumQ() >= 300) {
					Render.text("  When you finally finish, they're bloated and dripping your cum all over your crotch.", false);
					if(player.cumQ() >= 600) {
						Render.text("  You pump the tentacles so full they turn pinkish-white and bloat obscenely, before suddenly releasing a backflow that soaks you in spunk from the waist down. They drop to the ground limp and spent", false);
						if(player.cumQ() >= 800) Render.text(" but you don't stop cumming until they lie in a deep puddle of jizz", false);
						Render.text(".", false);
						cumPuddle = true;
					}
				}
	...
	if(player.biggestLactation() >= 2 && nippleSucking) {
		Render.text("Your " + breastDescript(0) + " squirt milk even harder, pushing the tentacles clear off you with the force of your lactation.  Your " + nippleDescript(0) + "s look like ", false);
		if(player.upperBody.chest.BreastRatingLargest[0].nippleLength >= 2) Render.text("even larger", false);
		else Render.text("obscene", false);
		Render.text(" cow-teats from all the suction, fountaining milk everywhere as it puddles on the ground.  The milk flow tapers off after a few seconds, leaving you stretched and sore.", false);
		if(player.upperBody.chest.BreastRatingLargest[0].nippleLength < 4 && player.upperBody.chest.list[0].breastRating >= 1) {
			Render.text("  Somehow you know they won't shrink the whole way back down to normal.", false);
			player.upperBody.chest.BreastRatingLargest[0].nippleLength += .25;
		}
		else Render.text("  Somehow you know they won't get any bigger from his rough treatment.", false);
		Render.text("  Your " + allBreastsDescript() + " finally feel emptied; it's a relief.\n\n", false);
		milkPuddle = true;
	}
	//Titfucking breastgasm
	if(titFucking) {
		Render.text("The titfucking tentacles squeeze tighter against your " + allBreastsDescript() + " before they cum again, much harder than before.  Each time it pops free of your flesh, a wave of spunk flows out with it, rolling off your chest to drip into your already soaked face and mouth.  ", false);
		if(player.stats.cor >= 80 && player.stats.lib >= 70) Render.text("You lick your lips and swallow as much of it as possible, wallowing in the mouse-cream.  ", false);
		if(player.hairLength > 0) Render.text("He keeps unloading it until you feel it in your " + hairDescript(), false);
		else Render.text("He keeps unloading it until you feel it on your head", false);
		Render.text(", then both tentacles abruptly release, going flaccid.\n\n", false);
	}
	if(mouthFucking) {
		Render.text("A wide bulge forces your jaw apart, distends your throat, and finally empties into your gut, filling you with warmth.  The action repeats until you feel bloated and full, far worse than before as you're now filled from BOTH ends.  You look more like ", false);
		if(player.pregnancyIncubation == 0 && player.buttPregnancyIncubation == 0) Render.text("an eight month pregnant woman", false);
		else Render.text("a brood-mother immobilized by her growing offspring", false);
		Render.text(" than your old self at this point, and Jojo wastes no time in pulling out to paint your " + faceMuzzle() + " with his baby batter.\n\n", false);
		cumPuddle = true;
		dynStats("cor", .5);
	}
	Render.text("All of Jojo's tentacles seem to lose their strength, and he gently sets your violated body down ", false);
	if(cumPuddle) {
		if(milkPuddle) Render.text("in the puddle of cum and milk", false);
		else Render.text("in the puddle of spunk", false);
	}
	else {
		if(milkPuddle) Render.text("in the puddle of milk", false);
		else Render.text("on the ground", false);
	}
	Render.text(".  You moan in frustration, feeling the fluid soak into your skin, secretly wishing he could've fucked you into unconsciousness.  ", false);
	Render.text("The mouse kneels over you and begins licking your body, cleaning you with his tongue.  The tentacles join in, noisily slurping up every ounce of fluid from your form until you're clean and sated.  Sighing dreamily from the attention, you close your eyes and murmer, \"<i>Good boy.</i>\" When you open them, he's trotting away towards the forest, his tentacles well-hidden again...\n\n", false);
...
private jojoMilkPay(tentacle:boolean = false):void {
	...
	Render.text(cumQ/1000 + " Ls.  ", false);
	...
	if(flags[FlagEnum.WHITNEY_GEMS_PAID_THIS_WEEK] + payout >= cap) {
		...
		Render.text("It also shows a warning: <b>Not enough gems for full payment.  GEMS NOW EXHAUSTED.</b>  ", false);
	}
	//If over cap!
	else if(flags[FlagEnum.WHITNEY_GEMS_PAID_THIS_WEEK] >= cap) {
		payout = 0;
		Render.text("It also shows a warning: <b>FUNDS EXHAUSTED.</b>  ", false);
	}
	if(payout > 0) {
		...
		if(payout == 1) Render.text(Num2Text(payout) + " gem rolls out into a collection plate.  Whitney really put a lot of work into this!  You pocket the gem and g", false);
		else Render.text(Num2Text(payout) + " gems roll out into a collection plate.  Whitney really put a lot of work into this!  You pocket the gems and g", false);
	}
...
private milkJojoFirst():void {
	...
	//(NEITHER!)
		...
		Render.text(", and while you're getting quite turned on from the show, you lack the equipment to take care of your lusts in a satisfactory way.  Meanwhile, Jojo is just moaning, squirming, and twitching each time he's brought close to orgasm.  You sit down and watch the machinery take your mouse-toy to task, wishing you had similar endowments you could be taking care of right now.\n\n", false);
		dynStats("lus", 50);
	}
	
	Render.text("At long last, the appointed time has come, and Jojo lets out the most lewd-sounding squeak you've ever heard come from his mouth.  His ass-cheeks and legs clench and flex against their restraints", false);
	if(player.lowerBody.cockSpot.hasCock()) Render.text(", squeezing your " + cockDescript(x) + " with agonizingly pleasurable pressure", false);
	Render.text(".  His back arches in ecstasy.  Most noticeably, the tube slurping on his cock is suddenly distorting as thick, round globules of mousey seed are sucked towards the wall.  The bulges are quickly smoothed out into one long, hose-dilating river of rodent-spooge.", false);
	if(!player.lowerBody.cockSpot.hasCock() && player.lowerBody.vaginaSpot.hasVagina()) Render.text("  His balls tremble and shrink in your mouth, pumping his prodigious semen out, wasting it in exchange for a pittance of gems.", false);
	Render.text("\n\n", false);
	
	if(player.lowerBody.cockSpot.hasCock()) {
		//(Too big dick: 
		if(player.cockThatFits(40) < 0) Render.text("You release your cum all over Jojo's back, matting his white fur with cum.  Each successive splatter of spunk makes the mouse look even more like a semen-drenched whore.  It's a good look for him.", false);
		else Render.text("You pull out and release your cum all over Jojo's back, matting his white fur with cum.  Each successive splatter of spunk makes the mouse look even more like a semen-drenched whore.  It's a good look for him.", false);
	}
	else if(player.lowerBody.vaginaSpot.hasVagina()) Render.text("You climax and clamp down on your fingers, squeezing your hand as your own cries of pleasure mix with your cock-toy's milked-out moans.", false);
	else Render.text("You sigh wistfully as Jojo ejaculates his load, wishing you could feel such exquisite sensations.  Maybe you can find something to give you some proper sexual organs soon?", false);
	Render.text("  Though he cums for minutes on end, the machinery doesn't seem to have much problem keeping up.  Eventually the hose pops off and drags back towards the wall, leaking a small trail of mouse-spunk on the floor.\n\n", false);
	
	Render.text("Jojo is lowered to the ground and released.  He immediately nuzzles against you, still trembling from the force of his orgasm and clearly thankful for the treat.  ", false);
	...
	Render.text("o on your way, dragging an exhausted mouse behind you as you head back towards camp.", false);
	doNext(camp.returnToCampUseOneHour);
}
...
private repeatMilkJojo(tentacle:boolean = false):void {
	...
	if(!tentacle || !tentacleJojo()) {
		Render.text("You call for your corruption-filled mouse-pet, and Jojo immediately bounds out of the woods on all fours, his bloated dick practically dragging the ground as it dribbles behind him. He looks up at you with eyes full of hope, still remembering the pleasure of his last trip to the farm.  You sigh and say, \"<i>Yes, I'm going to take you for another milking.  Are your balls nice and full?  I expect you to earn me a few gems, my little cum-cow.</i>\"\n\n", false);
		
		Render.text("Jojo nods his head eagerly and sits up on his haunches, his hand darting down to fondle his dick for you and show you just how much it dribbles now.  He seems to be more than ready for another session.  You start leading him to the farm, listening to him moan and pant behind you.  Drops of pre-cum splatter into the ground with every movement, and you realize he seems to be leaking a little more heavily than the last time the two of you embarked on this journey.  Somehow either the milkers or what you did originally must be slowly increasing his 'productivity' the more he empties out.  Perfect!\n\n", false);
		
		Render.text("In no time, the two of you are back inside the barn.  Jojo practically leaps into the stall, helping you strap him into the harness in record time.  His dick ", false);
		
		if(jojoCumQ() < 1000) Render.text("has already dripped everywhere, making a mess of the floor.", false);
		else if(jojoCumQ() < 4000) Render.text("is drizzling a steady flow of man-slime, puddling on the floor.", false);
		else Render.text("is already pouring out a river of pre-cum, turning the floor into a slippery morass.", false);
		Render.text("  The mouse is quickly immobilized and left to hang there, waiting on you to finish strapping him into his place.  You tune out his frantic whines and admire your handiwork.  Jojo is utterly restrained and hanging in the air.  His dick is throbbing and dripping in anticipation.  Even his balls are twitching and shuddering, aching to release their heavy cream.  You give his weighty orbs a squeeze and pull the last strap into place, activating the machinery.\n\n", false);
		
		Render.text("Your white-furred slut is hauled up into the air, kept up high enough that he can't get any kind of traction.  He can barely move at all!  Well, most of him can barely move - the way his dick is bobbing around makes it clear that no matter how you tie him down, Jojo will find a way to squirm like a bitch.  Once again, the wall pops open and releases a thick tube.  Just looking at the pulsating purple opening, you can tell it will be a near-perfect fit for your fuckpet's throbbing erection.  The faint sounds of suction mix with wet squishes as the hose rises up, homing in on Jojo's bouncing shaft.\n\n", false);
		
		Render.text("Lunging forward, the tube's opening slips around your mouse's cock-head, slurping it up as the sound of mechanized suction whines higher.  Jojo's own voice rises as well, matching the machine pitch for pitch as he moans in bliss.  Lurid slurps fill the barn as the tube greedily devours the mouse's boner, eventually coming to rest snugly against his groin and bouncing, squirming gonads.  Now that his member has been completely encapsulated by the machinery, Jojo sighs blissfully.  His hips are rocking gently against the restraints, as if it would somehow increase the pleasure coursing through his penis.  You know better - he gets to hang there on the edge for most of the next hour.\n\n", false);
		
		Render.text("Giving your furry slut's clenching ass a smack, you walk around in front of him, nearly tripping over the bouncing tube as you change position.  Jojo's panting with his eyes nearly rolled back into his head.  Every fifteen seconds or so his body will clench, only to have the cock-sucker's motions slow torturously.  He squeals and squeaks each time as if it was the first time.  You scratch him behind his large, dish-shaped ears as words bubble up from within you.  \"<i>Good pet.  You love being milked.  Your balls get so full and heavy... so full of spunk.  They ache, don't they?  Yes... they hurt you so bad.  You get so much cum pent up in there, and you can't let it out, not without being sucked like this.  Shhh... shhh... it's okay.  Just enjoy how perfectly swollen your balls are getting.  You can let it out eventually.</i>\"\n\n", false);
		
		Render.text("Jojo's eyes roll the whole way back for a moment, and his mouth begins to froth as he utterly caves in to his animal, pleasure-seeking instincts.  You lean back against a smooth part of the wall and shed your clothes, beginning to masturbate directly in front of your stall.  In time, your own pleasured moans draw your pet from his pleasure-induced stupor, and he watches with wide, bloodshot eyes as you bring yourself off to climax after climax", false);
		if(!player.lowerBody.cockSpot.hasCock() && !player.lowerBody.vaginaSpot.hasVagina()) Render.text(", even though to do so you're forced to stimulate your " + assholeDescript(), false);
		Render.text(".  His twitching rodent-nose sniffs at the air wildly as he pants, inhaling your scent between long, forlorn sounding moans.\n\n", false);
		
		Render.text("Jojo's muscles seize, and you can tell his orgasm has arrived.  You smirk and lean closer, tugging an ear close to your mouth for another dose of 'encouragement'.  \"<i>Cum for me, pet.  Let all that spunk clogging up your balls boil out into the milker.  Give it all up for me.  Just let out every... thick... pent-up... liter of your seed.  Empty it all!  Cum and squirt until your balls are as empty as your virtue!</i>\"\n\n", false);
		
		//(\"<i>Normal</i>\" Jojo cum) 
		if(jojoCumQ() < 1000) {
			Render.text("Your poor semen-slave does not disappoint.  His balls, looking far more swollen than when you arrived, tremble beneath him in time with his bouncing cock, convulsing as they begin to obey your commands.  Big spheres of cum suddenly distend the hose, stretching it with their liquid weight as they're pumped away toward the wall.  Jojo happily squeaks with each fresh burst he releases, though he rapidly devolves into just constantly screeching and moaning as his dick begins to continually twitch, unloading the rest of his spermy cargo in one thick deluge.  He hangs over the slightly dilated, whirring hose as it slurps down all of his cum.  Eventually, the mouse is totally drained, and his body goes limp in the harness.\n\n", false);
			Render.text("The hose slides off Jojo's softening member and heads back to the wall, trailing mouse-slime as it goes.  At the same time, Jojo is lowered down to the floor.  He stands up on wobbling feet and stumbles down to kneel beneath you.  Looking up, he pants, \"<i>Did I cum enough?</i>\"\n\n", false);
			Render.text("You pat his head and answer, \"<i>Yes, for now.  I expect your swollen balls can do better next time though, can't they?</i>\"\n\n", false);
		}
		//(\"<i>Big</i>\" Jojo Cum)
			...
			Render.text("Finished, the hose slides off Jojo's hard, cum-drooling cock and retracts towards the wall, leaving a messy trail of mouse-spunk in its wake.  At the same time, Jojo is lowered down to the floor.  He finds his bearings, waking up to stumble over to kneel before you.  Looking up, he pants, \"<i>Was... was that enough?</i>\"\n\n", false);
			
			Render.text("You pet him affectionately and answer, \"<i>Not too bad, pet.  I still think those balls of yours can do more.  Maybe someday you'll put out so much that the machine can't take it.  Only then will you be cumming enough for me.</i>\"\n\n", false);
		}
		//(\"<i>Victory</i>\" Jojo Cum)
			...
			Render.text("Finally finished, you release the tube and let it slither towards its home in the wall.  It burps out a wave of cum that stains the floor as it goes.  Meanwhile, Jojo's dick is still rock-hard and dumping his alabaster slime.  Once lowered to the ground, he rouses from his state and drops to his knees, right in the middle of his spunk-puddle.  With heavy-lidded eyes, he asks, \"<i>Did I cum enough?</i>\"\n\n", false);
			
			Render.text("You pet him affectionately and reply, \"<i>Yes you did.  You're such a good cum-slave.</i>\"\n\n", false);
		}
...
private jojoPaysForPerms():void {
	...
	Render.text("You answer that your pet mouse, Jojo will be taking care of payment for you today.  Lynnette looks doubtful, but she quickly drops to her knees in front of the mouse, determined to get her payment one way or another.  Jojo's forearm-length erection immediately makes itself apparent.  The goblin matron coos at the sight, humming happily once she sees the rivulets of pre-cum streaming down your slut's cock.  In one smooth motion, she devours the heavy mouse-shaft, sliding her lips down all the way to the base.\n\n", false);
	Render.text("Jojo moans and reaches for Lynnette's hair, but you stop him with a sharp command.  He's paying for your services today, not getting a reward.  Big, lusty eyes look up at him from his loins, and he shudders, his heavy balls clenching and relaxing from the goblin's perfect throat-fuck.  She reaches up to caress them, ", false);
	if(jojoCumQ() >= 4000) 
		Render.text("and releases a surprised gurgle when she feels just how heavy and full they've gotten.  All that time at the milker has clearly done Jojo's body good, and Lynette is likely to leave with a mouse-milk mustache.", false);
	else if(jojoCumQ() >= 1000) 
		Render.text("and releases a surprised gurgle when she discovers their size.  Clearly all the trips to the milker have given Jojo an impressive set of testes.", false);
	else Render.text("and rolls them back and forth in her fingers, expertly pleasuring Jojo.", false);
	Render.text("  In no time flat he's reached the edge of his endurance.\n\n", false);
	
	Render.text("Lynnette, for her part, has two wet stains on her blouse, but she ignores them as she gives the mouse's nuts a gentle squeeze.  He cums easily and hard from that little bit of extra stimulation.  The goblin's throat works to devour it all", false);
	if(jojoCumQ() < 1000) 
		Render.text(", readily swallowing most of it.  After a short time, she pulls back and lets him finish by filling her mouth.  In turn, she spits the sticky mess into a funnel that leads to who-knows-where.", false);
	else if(jojoCumQ() < 4000) 
		Render.text(", swallowing as much as she can.  Still, Jojo is pumping out enough that Lynette's belly quickly grows even more gravid, and the semen froths at the edges of her lips.  Eventually she just gives up and pulls off, aiming him at a funnel.  She keeps stroking his spit-slicked shaft as he's drained off that way, the goblin's grin growing a touch manic at the sight of that much seed being collected.", false);
	else 
		Render.text(", but there's no way she can keep up with Jojo's ridiculous cum-production.  Two jets of seed leave her belly stretched to its limit, and the goblin matron quickly pulls back with a panicked look in her eyes, barely aiming Jojo's spunk-sprayer at the funnel in time for it to be filled by the next blast.  Watching with rapt attention, the green-skinned girl smiles wider and wider when she realizes just how much your pet can produce.  It's quite some time before his flow tapers off, but Lynnette doesn't seem to mind at all.", false);
	Render.text("  Perhaps one of her daughters has the other end of that pipe jammed into her pussy?\n\n", false);
	Render.text("Lynnete pants", false);
	if(jojoCumQ() >= 1000 && jojoCumQ() < 4000) 
		Render.text(" with a smile", false);
	else if(jojoCumQ() >= 4000) 
		Render.text(" with a dazed, crazy-looking smile", false);
	Render.text(", \"<i>What'll it be today?</i>\"\n\n", false);
...
private amilyTeachingJojoBJ():void {
	...
	if(flags[FlagEnum.TIMES_AMILY_AND_JOJO_PLAYED_TIMES] == 0) {
		Render.text("Your pet mice make an appearance as you're plotting your next move, Amily practically dragging Jojo behind her, ignoring the thick ropes of spunk he drizzles on the ground in his path.  He pants and whines, \"<i>-don't wanna suck cocks!  Fucking is totally better.</i>\"");
	...
	//Universal Outro
	Render.text("  She seems visibly distracted by the mouse's boner, and will likely wind up fucking him soon.");
	if (player.lowerBody.cockSpot.hasCock()) Render.text(" Do you surprise them both by allowing Amily to demonstrate on you?");
	else Render.text(" Do you want to watch them fuck?");
	
	menu();
	if (player.lowerBody.cockSpot.hasCock()) addButton(0, "Demonstrate", BJRidesGETYOUONE);
...
private BJRidesGETYOUONE():void {
	...
	if(player.lowerBody.cockSpot.biggestCocks[0].cockArea() > 50) 
		Render.text("as much of your [cock biggest] as possible");
	else 
		Render.text("your entire [cock biggest]");
	Render.text(" into her mouth and throat.  The tight warmth of your pet's puffy, corruption-engorged cock-sucker shoots tingling thrills of delight through your maleness, and as she's careful to guide the sensitive underside along her tongue as she swallows, [eachCock] soon stiffens to a full, throbbing erection.  You cannot help but groan at the skillful sucking, and when Amily pops off a moment later, she looks quite pleased with herself.");
	...
	if(flags[FlagEnum.AMILY_NOT_FURRY] == 1) 
		...
		Render.text("muzzles ");
	Render.text("almost too great to resist.  Amily seems to sense this, obediently offering their bodies for your release. \"<i>[Master], would you like to fill your cum-slut's pussy or mouth?  Or maybe you want to give your bitch-boy a taste?</i>\"");
...
private fillAmilysMouth():void {
	...
	if (player.lowerBody.balls > 0) Render.text(" leans down to desperately suckle at your [sack], subserviently worshipping your bloated testes and their liquid bliss one after another; tonguing, sucking, and moaning into the spunk - bloated mass of your ambrosial scrotum.");
	else Render.text(" leans down to slurp needily at the bottom of your cock, licking it with languid tongue-strokes each time Amily gives him an opening.");
	Render.text(" Amily looks up at you, her cute, succubi - like horns glinting in the light as she purrs, \"<i>Please, [master], give slut a throat-thick load to swallow.  Fill your nympho's mouth-pussy with sticky baby batter and splatter her whorish face with oozing leftovers.</i>\"");
...
private stuffAmilysMouthWithPostBJCUM():void {
	...
	Render.text("on your rigid fuck-tool");
	Render.text(".  She squeaks in surprise, her yelp turning into a high-pitched moan as your [cockHead biggest] widens in preparation for your looming orgasm.  Spunk forces your cum-slit open and sprays into Amily's clenching uterus, gorging her lascivious cunt with the virile seed it craves.  You hold her, impaled and squirming, as you continue to spray, inseminating her moist twat with squirt after squirt of oozing cock-nectar.[if (cumQuantity > 500)   Her belly rounds out delightfully from the extra stuffing.  You run a palm across it and smile when you feel your sperm churning under her stretched skin.][if (cumQuantity >= 1000) \"  Rivulets of spooge run from her overflowing pussy in thick cascades of pearl goo.  Jojo does his best to keep up, but even his growing lust for swallowing your cum can't match the volume of the salty surf foaming from the spasming girl's flush pussy.\"][if (cumQuantity >= 2000) \"  Amily's eyes roll back in complete pleasure as the pressure of your cum begins to cause the ejaculate to spout from her spunk-laden twat.  Jojo gives up on swallowing it all and leans back, opening wide to catch as much as possible as your second-hand seed showers the fallen monk, an ivory rain of hot slime splattering from your freshly stuffed slut's cream-sated cunny.\"]");
...
private amilyAndJojoFuck():void {
	...
	if (player.lowerBody.vaginaSpot.hasVagina()) Render.text(" It isn't until you notice how wet your crotch is that you come to the realization that you've masturbated yourself through a few orgasms as well.");
	else Render.text(" It isn't until you notice how clearheaded you are that you come to the relaization that you've masturbated while watching the pair.");
	Render.text(" Maybe you'll get to catch them in the act again?");
	player.orgasm();
	//{DONT FORGET PREGNANCY CHECK}
	//amilyPreggoChance();
	doNext(camp.returnToCampUseOneHour);
	...
	doNext(camp.returnToCampUseOneHour);
		...
		public jojoDefenseToggle():void {
			...
			if (player.statusAffects.has("JojoNightWatch")) {
				...
				Render.text("You tell Jojo that you no longer need him to watch the camp at night.  He nods, then speaks.  \"<i>Alright.  Please let me know if you require my help again.</i>\"");
			}
			else {
				player.statusAffects.add(new StatusAffect("JojoNightWatch", 0, 0, 0, 0)));
				Render.text("You ask the monk if he could guard the camp for you at night.  He smiles politely.  \"<i>Certainly, [name].</i>\"");
			}
			doNext(jojoCamp);
		}
...
//this.semiglobalReferencer.jojoRape = jojoRape;
		...
		public jojoAtCampRape():void {
			...
			clearOutput();
			Render.text("You ask Jojo if he'd like to go on a hunt through the woods to clear out some of the corrupted creatures, and the mouse readily agrees.  He asks if you've been getting a bit stir-crazy from having your camp in one place as the two of you walk into the woods...");
			menu();
		...
		public defeatedJojo(hpVictory:boolean):void {
			...
			if (player.lust > 33 && player.gender > 0) {
				clearOutput();
				Render.text("You smile in satisfaction as Jojo" + (hpVictory ? " collapses, unable to continue fighting" :" collapses and begins masturbating feverishly") + ".  Sadly you realize your own needs have not been met.  Of course, you could always rape the poor thing...\n\nDo you rape him?");
		...
		private postCombatRape():void {
			...
			if (monk == 5)
				Render.text("fuck your violent little slut senseless.  ");
			else Render.text("teach the uppity monk a lesson...\n\n");
			menu();
		...
		private jojosSecondRape():void {
			...
			dynStats("lib", -10, "cor", 4);
			if(player.gender == 1) {
				Render.text("You force Jojo over a log, running your hands through his fur and slapping his ass.  He grunts, but it's impossible to tell if it's in frustration, anger, or arousal.  You quickly force yourself back into his ass, finding it noticably stretched from your last incursion.  ");
				if(player.averageCockThickness() >= 3) Render.text("It makes little difference to your " + cockDescript(0) + ", he still feels tight as a virgin's cunt to you.  ");
				Render.text("You grab him by the waist and fuck him powerfully, slamming your " + cockDescript(0) + " in brutally hard and fast.  You notice his hands are in his crotch, feverishly masturbating his disproportionately large cock like a slut.  You start leaking pre-cum like a sieve, realizing you're doing it, really doing it - making this virtuous mouse into a wanton slut!  You squeeze him tightly as you cum into his bowels, his belly distending slightly as your orgasm goes on and on.  Trails of cum run down his fur as it becomes more than his ass can handle.");
				if(player.lowerBody.cockSpot.count() > 1) Render.text("  Your remaining equipment showers him with jizz, more than you ever thought you could produce.");
				Render.text("  The mouse moans and cums himself, with loud moans and messy splurts coating the ground every time your hips meet.\n\n");
				Render.text("Eventually it ends, and you drop him into the puddled spooge like a used condom.  He lays there, idly stroking himself in a daze, his prick still swollen with need and dripping fluids.  You can't wait to corrupt him some more.");
			}
			if(player.gender == 2 || player.gender == 3) {
				Render.text("You throw him on the soft soil of the forest and mount him, skillfully guiding his member towards your now dripping wet hole.  As you slide down you marvel at how he feels larger and thicker than before, deliciously so.  Your " + vaginaDescript(0) + " throbs in the most pleasant way as you rape his small form.  You play with your clit, watching Jojo's face flit between rapture and disgust.  You lick your lips and smile as the disgust vanishes, his hot jets of cum painting your cunt-walls.  You giggle and keep fucking him, hoping that somehow your corruption and lust are influencing him, turning him into your personal fucktoy.  The thought brings you over the edge.  You clamp down, your " + vaginaDescript(0) + " milking, squeezing every last drop from him as his prick erupts inside you.  ");
				player.cuntChange(1.5, true);
				if(player.biggestLactation() >= 1 && player.biggestLactation() < 2) Render.text("Milk squirts from  your nipples, spraying him down with small droplets of your creamy tit-treat.  ");
				if(player.biggestLactation() >= 2 && player.biggestLactation() < 3) Render.text("Streams of milk spray from your nipples in time with your pussy contractions, hosing the poor mouse down and puddling on his fur.  ");
				if(player.biggestLactation() >= 3) Render.text("Gouts of milk erupt from your nipples, spraying continually as you cum.  The poor mouse is soaked from head to toe, your cream utterly drenching the monk.  ");
				if(player.averageVaginalWetness() == 5) Render.text("Your " + vaginaDescript(0) + " drenches him with your squirting girl-cum, mixed with his own seed.");
				if(player.lowerBody.cockSpot.count() == 1) Render.text("Jizz sprays onto his chest from your " + cockDescript(0) + ".  ");
				if(player.lowerBody.cockSpot.count() == 2) Render.text("A hail of jizz splatters over Jojo from your " + multiCockDescriptLight() + ".  ");
				if(player.lowerBody.cockSpot.count() == 3) Render.text("A multitude of thick cum-streams splatter over Jojo from head to waist as your " + multiCockDescriptLight() + " hose him down.  ");
		...
		private jojosThirdRape():void {
			...
			if(player.gender == 1) {
				Render.text("You yank Jojo up from the ground and onto his knees, ");
				if(player.lowerBody.cockSpot.count() == 1) {
					Render.text("presenting your " + cockDescript(0) + " to him.  ");
				}
				else Render.text("presenting your " + multiCockDescriptLight() + " to him.  ");
				Render.text("The monk betrays his violated state of mind, licking his lips demurely and opening wide.  The invitation is all you need ");
				if(player.lowerBody.cockSpot.count() == 1) Render.text("to ram your " + cockDescript(0) + " deep into his maw.  You roughly grab his ears, facefucking him hard, his tongue working hard to please.  ");
				if(player.lowerBody.cockSpot.count() > 1) Render.text("to cram two cocks deep into his maw, making his jaw stretch obscenely.  You roughly grab his ears, facefucking him hard, his tongue working hard to please you.  ");
				Render.text("One of Jojo's paws is buried in his groin, stroking his " + monster.cockDescriptShort(0) + " with feverish intensity.  The hornier he gets, the more his throat seems to relax, allowing you to push deeper.  The glazed, lust-addled look on his face is so hot, you can't hold back any longer.  ");
				if(player.lowerBody.cockSpot.count() == 1) Render.text("Your " + cockDescript(0) + " clenches tightly, erupting ");
				if(player.lowerBody.cockSpot.count() > 1) Render.text("Your twin dicks clench tightly, erupting ");
				Render.text("hot seed into the now meek and subdued bitch-boy.  His throat squeezes around you as he presses his nose tightly against your crotch, pulling as much of you in as he can.  Mouse-spunk spatters your legs as he cums with you.\n\n");
				if(player.stats.lib > 60 && player.stats.cor > 40) {
					Render.text("You flip him onto his back, both of you still hard and ready for more.  He gets up on all fours and wiggles his bum tantalizingly.  You press on, ");
					if(player.lowerBody.cockSpot.count() == 1) Render.text("violating his loosened sphincter, and begin to fuck him hard.  He whimpers with a mixture of pain and pleasure, your spit-lubed " + cockDescript(0) + " pounding his prostate mercilessly.  Thick ropes of mousey-cum drool with each anus-stretching thrust of your cock, pooling below you.  You wickedly smile, slapping his ass, imagining him stretched further, his ass gaping, his cock huge and dripping with cum.  The strange thoughts filling your mind seem to travel straight to your balls and distill into pools of cum.  Like a long dormant volcano, you erupt, hot liquid spraying into Jojo, pumping his ass full and leaking down his legs.  He cums again, harder than before, his pulsing prick seeming to grow larger throughout his orgasm.\n\n");
					else Render.text("violating his loosened sphincter, and begin to fuck him hard.  He whimpers with a mixture of pain and pleasure, a spit-lubed cock pounding his prostate mercilessly.  Thick ropes of mousey-cum drool with each anus-stretching thrust of your cock, pooling below you.  You wickedly smile, slapping his ass, imagining him stretched further, his ass gaping, his cock huge and dripping with cum.  The strange thoughts filling your mind seem to travel straight to your balls and distill into pools of cum.  Like a long dormant volcano, you erupt, hot liquid spraying into Jojo, pumping his ass full and leaking down his legs.  He cums again, harder than before, his pulsing prick seeming to grow larger throughout his orgasm.\n\n");
				}
				Render.text("You leave the exhausted mousey behind you, wondering how you'll take him next time.  ");
				player.orgasm();
				if(player.stats.lib > 60 && player.stats.cor > 40) {
					Render.text("You smile as you hear him begin masturbating in the background.  There can be no doubt, you are tainting him more and more...");
					monk+=1;
					dynStats("lib", -10, "cor", 4);
				}
				else
			...
			if (player.gender == 2) {
				if (player.isBiped()) Render.text("You spread your legs and crook your finger");
				else Render.text("You crook your finger");
				Render.text(", beckoning him towards your " + vaginaDescript(0) + ".  He looks disheartened, but obediently kneels before you, his whiskers tickling your " + vaginaDescript(0) + ", his wet nose bumping your clit, his tongue taking long licks between your lips.  ");
				if(player.upperBody.chest.BreastRatingLargest[0].breastRating >= 2) {
					Render.text("You sigh and knead your breasts in pleasure.  ");
				}
				if(player.biggestLactation() >= 1.5 && player.upperBody.chest.BreastRatingLargest[0].breastRating > 2 && player.mostBreastsPerRow() >= 2 && player.upperBody.chest.count() >= 1) Render.text("Every sensual peak within you is mirrored with small spurts of milk from your nipples.  It eventually trickles down to Jojo's tongue, spurring his efforts on.  ");
				Render.text("The mousey gets more and more in to eating your box, making it harder and harder to stave off an orgasm.  You wrap ");
				if(player.lowerBody == LOWER_BODY.NAGA) Render.text("your coils ");
				else if(player.lowerBody == LOWER_BODY.GOO) Render.text("your jiggling goo ");
				else Render.text("your thighs ");
				Render.text("around his head and quiver with passion, ");
				if(player.averageVaginalWetness() <= 1) Render.text("squeezing him tightly into your " + vaginaDescript(0) + ".");
				if(player.averageVaginalWetness() > 1 && player.averageVaginalWetness() <= 3) Render.text("creaming his tongue liberally with girlcum.");
				if(player.averageVaginalWetness() == 4) Render.text("creaming all over him with your slobbering pussy.");
				if(player.averageVaginalWetness() == 5) Render.text("splattering him with girlcum from your " + vaginaDescript(0) + ".");
				Render.text("\n\nYou pull the cunt-dazed mouse away reluctantly, and bend over,");
				if (player.isBiped()) Render.text(" spreading your legs and");
				Render.text(" shaking your rump.  ");
				if(player.hasLongTail() > 0) Render.text("Your tail swishes back and forth teasingly.  ");
				Render.text("Your tantalizing backside is too much for him.  He pounces your ass in a second, penetrating your " + vaginaDescript(0) + " forcefully.  The knowledge that your demonic influence is responsible for his state nearly makes you cream all over his cock.  You fantasize about your cunt making his cock grow longer and fatter as it corrupts him further, transforming his morals and values into cock and cum.  Jojo thrashes against you, brutally pounding your " + vaginaDescript(0) + " as he orgasms.  His " + monster.cockDescriptShort(0) + " erupts inside you, the feeling of being filled with mouse-spunk drives you over the edge with him.  More and more of his cum sprays inside you, unnatural amounts for a creature his size.  Thick streams of the stuff escape down your thighs as your belly distends.  ");
				player.cuntChange(2, true);
				Render.text("\n\n");
				Render.text("You let the drained mouse pop free, reveling in the sensation of cum pouring from");
				if (player.isBiped()) Render.text(" between your thighs"); 
				else Render.text(" your cunt");
				Render.text(".  Jojo has already passed out behind you.  ");
				player.orgasm();
				if(player.stats.lib > 60 && player.stats.cor > 50) {
					Render.text("You lean down and whisper strange un-words as you stroke his cock.  It spasms and grows, cum pumping from it slowly but constantly.  You walk away, leaving him in a growing puddle of what was once his morals.  You don't know where the words came from, but you do know you're getting better at tempting and corrupting.");
					monk+=1;
					dynStats("lib", -10, "cor", 4);
				}
				else
			...
			if(player.gender == 3) {
				...
				Render.text(", beckoning him towards your " + vaginaDescript(0) + ".  He looks disheartened, but obediently kneels before you, his whiskers tickling, his wet nose bumping your clit, his tongue taking long licks between your lips.  ");
				if(player.lowerBody.cockSpot.count() == 1) Render.text("You sigh as your " + cockDescript(0) + " droops over his head.  ");
				if(player.lowerBody.cockSpot.count() > 1) Render.text("You sigh as your " + multiCockDescriptLight() + " pile atop his head.  ");
				if(player.upperBody.chest.BreastRatingLargest[0].breastRating >= 2) {
					Render.text("You kneed your breasts, excited and filled with pleasure.  ");
				}
				if(player.biggestLactation() >= 1.5 && player.upperBody.chest.BreastRatingLargest[0].breastRating > 2 && player.mostBreastsPerRow() >= 2 && player.upperBody.chest.count() >= 1) Render.text("Every sensual peak within you is mirrored with small spurts of milk from your nipples.  It eventually trickles down to Jojo's tongue, spurring his efforts on.  ");
				Render.text("The mousey gets more and more into eating your box, making it harder and harder to stave off an orgasm.  You wrap your thighs around his head and quiver with passion, ");
				if(player.averageVaginalWetness() <= 1) Render.text("squeezing him tightly into your " + vaginaDescript(0) + ".");
				if(player.averageVaginalWetness() > 1 && player.averageVaginalWetness() < 4) Render.text("creaming his tongue liberally with girlcum.");
				if(player.averageVaginalWetness() == 4) Render.text("creaming all over him with your slobbering pussy.");
				if(player.averageVaginalWetness() >= 5) Render.text("splattering him with you girlcum from your " + vaginaDescript(0) + ".");
				if(player.lowerBody.cockSpot.count() > 0) Render.text("  Thick runners of your pre dribble down his neck, sticking to his fur.  ");
				Render.text("\n\nYou pull the cunt-dazed mouse away reluctantly, and bend over,");
				if (player.isBiped()) Render.text(" spreading your legs and");
				Render.text(" shaking your rump.  ");
				if(player.hasLongTail() > 0) Render.text("Your tail swishes back and forth teasingly.  ");
				Render.text("Your tantalizing backside is too much for him.  He pounces your ass in a second, penetrating your " + vaginaDescript(0) + " forcefully.  The knowledge that your demonic influence is responsible for his state nearly makes you cream all over his cock.  You fantasize about your cunt making his cock grow longer and fatter as it corrupts him further, transforming his morals and values into cock and cum.  Jojo thrashes against you, brutally pounding your " + vaginaDescript(0) + " as he orgasms.  His " + monster.cockDescriptShort(0) + " erupts inside you, the feeling of being filled with mouse-spunk drives you over the edge with him.  More and more of his cum sprays inside you, unnatural amounts for a creature his size.  Thick streams of the stuff escape down your thighs as your belly distends.  ");
				player.cuntChange(2, true);
				if(player.lowerBody.cockSpot.count() == 1) Render.text("Your " + cockDescript(0) + " trembles in orgasm, squirting your load into the thick forest loam.  ");
				if(player.lowerBody.cockSpot.count() > 1) Render.text("Your " + multiCockDescriptLight() + " tremble in orgasm, squirting their hot loads all over the thick forest loam.  ");
				Render.text("\n\n");
				Render.text("You let the drained mouse pop free, reveling in the sensation of cum pouring from ");
				if (player.isBiped()) Render.text("between your thighs");
				else Render.text("your cunt");
		...
		private jojosFourthRape():void {
			...
			//Male Version
			if(player.gender == 1) {
				Render.text("The mousy former-monk kneels as you disrobe, his will nearly broken by desire.  ");
				if(player.lowerBody.cockSpot.count() == 1) Render.text("You touch his head softly and guide him to your " + cockDescript(0) + ", smiling as he licks his lips with anticipation.  You gasp at the feeling of his soft lips and wet tongue as he pleasures you, your knees going weak from his efforts.  Jojo cups your balls and slips a fuzzy finger into your ass.  He labors to take as much of you as possible into his mouth, panting warmly and wetly around your " + cockDescript(0) + ".  You twitch in pleasure as he alternates pressure on your prostate with smooth strokes of his slick tongue.  ");
				else Render.text("You touch his head softly and guide him to your " + multiCockDescriptLight() + ", smiling as he licks his lips in anticipation.  You gasp at the feelings of his soft lips and wet tongue on your heads as he pleasures you, your knees going weak from his efforts.  Jojo cups your balls and slips a fuzzy finger into your ass.  He labors to take in two shafts, struggling to swallow them as deep as possible, panting wetly around you.  You twitch with pleasure as he alternates pressure on your prostate with smooth strokes of his slick tongue.  ");
				//Too thick for him
				if(player.averageCockThickness() > 3 || (player.dogCocks() > 0 && player.averageCockThickness() > 3)) Render.text("Jojo is forced to back off of your " + cockDescript(0) + " from time to time to come up for air, barely opening his jaw wide enough to take your girth back inside his mouth.  ");
				//Too long for him
				if(player.averageCockLength() > 10 || (player.horseCocks() > 0 && player.averageCockLength() > 10)) Render.text("He struggles not to gag on your " + cockDescript(0) + "'s length, opening his throat as far as he can.  ");
				Render.text("You rock back and forth on his face as he expertly keeps you on the edge of orgasm.  ");
				if(player.cumQ() > 25) Render.text("Your constant stream of heavy pre practically chokes the poor mouse as he edges you mercilessly, his own equipment drizzling in sympathetic lust.  ");
				Render.text("Jojo presses his paw hard into your ass, squeezing your prostate tightly as his hot muzzle dives deeply over your cock.  You feel the building tightness of your orgasm and pull him tightly against you as the pressure builds.  ");
				if(player.cumQ() < 25) Render.text("You buck against him as you orgasm, your small squirts of cum eagerly devoured by the slutty mouse.");
				if(player.cumQ() >= 25 && player.cumQ() < 250) Render.text("You buck against him as you orgasm, the slutty mouse's throat squeezing against you as he works to swallow your seed.");
				if(player.cumQ() >= 250 && player.cumQ() < 500) Render.text("You spasm against him as you orgasm, the pleasure erupting into the slut-mouse's throat as he tries to swallow it all.  Excess cum dribbles from the corners of his mouth as you fully spend yourself.");
				if(player.cumQ() >= 500) Render.text("You buck against him as you orgasm, the slutty mouse's cheeks bulging in surprise as your cum explodes into his mouth.  Thick streams escape from the corners of his muzzle, your seed pouring into him faster than he can swallow.  Eventually you finish, and see the mouse dripping with your spunk nearly to the waist, a small bulge in his belly.");
				Render.text("  Jojo leans back, panting for breath, a dull smile on his face.  He spits a load of your cum into his paw and begins jerking himself off with it, lewdly putting on a show for you.\n\n");
				if(player.stats.lib > 50 && player.stats.cor > 80) {
					Render.text("<b>You feel a familiar power growing within you and decide to unleash it.</b>  You grab the prayer beads from his outfit and spit on them, making them slick and wet.  Holding them below your flagging cock, you focus on the demonic visions in your mind, slowly but constantly milking larger and larger dollops of cum onto the once holy beads.  Jojo moans as he comes to understand your intent, and turns around, shaking his lithe mouse-bum at you.  You lean over him, whispering into his ear, \"<i>Each defiled bead I push into you is going to make you more of a willing slut.  More of a willing receptacle for demon cum.  More of a fountain of desire waiting to be tapped by Succubi.  More my toy.</i>\"\n\n");
					Render.text("He whimpers as you slide the first bead in, his eyes growing foggy and his bum wiggling more eagerly.  You push the second bead inside him, and feel his asshole stretch and loosen, welcoming the corruption.  The third bead slips right in, and he moans, \"<i>sluuuut</i>,\" His cock grows longer and thicker throughout the moan, stopping at over a foot long and 3 inches thick, dribbling cum.  You whisper, \"<i>Cum, my Toy,</i>\" and push the remaining beads inside him.  His eyes roll back as his paws frantically milk his " + monster.cockDescriptShort(0) + ", cum spraying from him like a fountain.  Jojo trembles, losing complete control and falling away from you.  You still hold the end of his beads, and smile as they pop out, stained almost as dark as the poor mouse's soul.\n\n");
					Render.text("You walk away, leaving your new pet to explore his outlook on life, and to test your awakened powers.  ");
					monk+=1;
					player.orgasm();
					dynStats("lib", -10, "cor", 10);
				}
				else {
					Render.text("Jojo eventually cums violently, collapsing into a puddle of spent jizz.  You smile and walk away, hoping to encounter him again.  ");
					player.orgasm();
					dynStats("lib", 2, "cor", 1);
				}
			}
			...
			if(player.gender == 2 || player.gender == 3) {
				//Oral
				Render.text("The mousy once-monk kneels as you disrobe, his will nearly broken by desire.  ");
				Render.text("You touch his head softly, guiding him to your " + vaginaDescript(0) + ", lips breaking into a grin as he licks his mouth with desire.  You gasp at the feeling of his wet nose as it bumps against your groin, shooting thunderbolts of pleasure from your " + clitDescript() + ".  He attacks with his tongue, thrusting strikes practically attacking your " + vaginaDescript(0) + " with his long, practically serpentine, tongue.  You shudder, knowing a visible sign of corruption when you see it, moisture slicking the mouse's face.\n\n");
				Render.text("Jojo moans into your folds as his " + monster.cockDescriptShort(0));
				if (player.isBiped()) Render.text(" brushes against your calf");
				else Render.text(" brushes against your [leg]");
				Render.text(".  You get a devilish idea, ");
				if(player.lowerBody == LOWER_BODY.GOO) Render.text("and push his " + monster.cockDescriptShort(0) + " in between folds of slime, sandwiching it in a mass of slippery, gooey tightness.  Holding his shoulder for balance, you slowly squeeze him, gently milking out small dribbles of pre.  He redoubles his efforts, burying his nose into your " + vaginaDescript(0) + ", tongue swirling over your folds and around your " + clitDescript() + ".  For every effort on his part you step up your own, squeezing and stroking him with your goo, doing your best to impart a fetish for being masturbated with someone's lower body on his slowly warping mind.  You feel a hot wetness in your slime, and it grows slicker and wetter every second. Jojo's cum drips out of you, glazing your jello-like form white.  ");
				else Render.text("and push his " + monster.cockDescriptShort(0) + " with your " + player.foot() + ", sandwiching it under one " + player.foot() + " and on top of the other.  Holding his shoulder for balance, you slowly squeeze him, gently milking out small dribbles of pre.  He redoubles his efforts, burying his nose into your " + vaginaDescript(0) + ", tongue swirling over your folds and around your " + clitDescript() + ".  For every effort on his part you step up your own, squeezing and stroking him with your " + player.feet() + ", doing your best to impart a " + player.foot() + " fetish on his slowly warping mind.  You feel a hot wetness on your " + player.feet() + ", and they grow slicker and wetter every second. Jojo's cum drips out from between them, glazing them white.  ");
				if(player.averageVaginalWetness() <= 1) Render.text("You clamp down on his muzzle as you writhe in orgasm.  ");
				if(player.averageVaginalWetness() > 1 && player.averageVaginalWetness() <= 3) Render.text("Your legs trap his muzzle in your " + vaginaDescript(0) + " as orgasm wracks your body.  ");
				if(player.averageVaginalWetness() == 4) Render.text("Your legs trap his muzzle in your " + vaginaDescript(0) + ", slicking his muzzle with girlcum as you spasm with bliss.  ");
				if(player.averageVaginalWetness() == 5)Render.text("Your legs squeeze him against your " + vaginaDescript(0) + ", girlcum erupting over his face and soaking him as you bliss out with orgasm  ");
				if(player.lowerBody.cockSpot.count() == 1) Render.text("Your " + cockDescript(0) + " drizzles cum in his hair, some dripping off by his ear.  ");
				if(player.lowerBody.cockSpot.count() > 1) Render.text("Your " + cockDescript(0) + "s drizzle him with cum, covering his head with thick white streams of your jizz.  ");
				Render.text("Twitching weakly with pleasure, you fall back.\n\n");
				//Fux!
				Render.text("The pleasure was magnificent... but you want MORE.  You push yourself up, feeling pleased as you spy Jojo stroking his cum-slick " + monster.cockDescriptShort(0) + ", thick streams of cum leaking from the tip.  You pounce on him, pushing him down on the ground, and position your " + vaginaDescript(0) + " over him, allowing him to scent your sex.  With a triumphant smile, you sink down onto him, impaling yourself on his " + monster.cockDescriptShort(0) + ".  ");
				if(player.averageVaginalLooseness() == 0) Render.text("He is painfully large, so much so that you feel more pain than pleasure.  ");
				if(player.averageVaginalLooseness() == 1) Render.text("He stretches you around him like a latex glove, pulling your " + vaginaDescript(0) + " taught with his " + monster.cockDescriptShort(0) + ", the sensation riding a razor's edge between pleasure and pain.  ");
				if(player.averageVaginalLooseness() == 2) Render.text("His " + monster.cockDescriptShort(0) + " stuffs you completely, filling your " + vaginaDescript(0) + " to capacity.  ");
				if(player.averageVaginalLooseness() == 3) Render.text("His " + monster.cockDescriptShort(0) + " fits you perfectly, burying deep inside your folds.  ");
				if(player.averageVaginalLooseness() == 4) Render.text("You easily accomadate his member into your " + vaginaDescript(0) + ".  ");
				if(player.averageVaginalLooseness() == 5) Render.text("His " + monster.cockDescriptShort(0) + " slips inside your " + vaginaDescript(0) + " with little resistance, easily sinking in to the hilt.  You muse to yourself, \"<i>If only he were thicker...</i>\"  ");
				Render.text("You ride him slowly, gyrating your hips in tiny grinding circles while you run your hands through his fur.  His hips bounce you gently with tiny twitching thrusts, cum pooling out of your " + vaginaDescript(0) + " as it continues to drip from him.  ");
				Render.text("He gradually ups the tempo, and you are forced to go along for the ride as you begin to bounce on his " + monster.cockDescriptShort(0) + ".  You grab fistfuls of his fur and hang on as he begins pounding your " + vaginaDescript(0) + ", his huge balls slapping against you.  Cum squirts from your pussy with each of his violent thrusts, more pouring deep inside you continually.  Jojo squeals with glee and slams his hips into yours a final time, triggering an eruption of seed in your channel.  You feel it pouring into your womb, slowly distending your belly with every shuddering pump of cum.  You orgasm helplessly, fingering your " + clitDescript() + " the whole time.  ");
				//Futacawk here
				if(player.lowerBody.cockSpot.count() > 0) {
					//Single Cock
					if(player.lowerBody.cockSpot.count() == 1) {
						//Horsefun!
						if(player.horseCocks() == 1) Render.text("Your " + cockDescript(0) + " feels a building pressure, the whole thing pulsating wildly with each of your heartbeats, most noticably the tip, which flares out wildly.  Powerful contractions wrack your sheath and " + cockDescript(0) + " as pre practically fountains from it.  ");
						//DogFun!
						if(player.dogCocks() == 1) Render.text("Your " + cockDescript(0) + " feels an intense pressure, and begins bulging out obscenely above your sheath.  The knot thickens gratuitiously, filling as it pulses with need.  Cum drips from your pointed tip as it continues to bulge wider, filling you with unbearable pressure.  ");
						//Else
						if(player.normalCocks() == 1) Render.text("Your " + cockDescript(0) + " twitches, muscle contractions slowly working their way up from the base.  ");
						//CUMSPLOISION
						if(player.cumQ() < 25) Render.text("Your body tenses and cums, spraying spurts of jizz over the mouse.  ");
						if(player.cumQ() >= 25 && player.cumQ() < 250) {
							if(player.horseCocks() == 1) Render.text(" Your " + cockDescript(0) + " flares wildly as musky horse-cum erupts from it, splattering over Jojo.  ");
							if(player.dogCocks() == 1) Render.text("The terrible pressure in your " + cockDescript(0) + " finally relents, in the form of a fountain of doggie-cum, spraying out from your " + cockDescript(0) + " in a steady stream that seems to last and last.  ");
							if(player.lowerBody.cockSpot.list[0].cockType == CockType.HUMAN || player.lowerBody.cockSpot.list[0].cockType.Index > 2) Render.text("Your body tenses and cums a thick eruption far beyond what a normal human could produce.  Jojo is splattered with the stuff.  ");
						}
						if(player.cumQ() >= 250) {
							if(player.horseCocks() == 1) Render.text("Your " + cockDescript(0) + " ripples and bulges with animalistic vigor, horse-cum splattering everywhere with each contraction.  The musky animal-jizz never seems to stop pouring from your equine organ, soaking the mouse from the waist up.  ");
							if(player.dogCocks() == 1) Render.text("Your " + cockDescript(0) + " suddenly releases the pressure, a constant stream of doggie-cum spouting from your " + cockDescript(0) + " like some kind of cum-hose.  It seems to go on endlessly, covering the mouse from the waist up with thick ribbons of doggie-spooge as your knot slowly shrinks to normal.  ");
							if(player.lowerBody.cockSpot.list[0].cockType == CockType.HUMAN || player.lowerBody.cockSpot.list[0].cockType.Index > 2) Render.text("Your body tenses and cums a thick eruption far beyond what a normal human could produce.  Jojo is splattered with the stuff.  ");
						}
					}
					//Sorry multicocks, I'm donE!
					if(player.lowerBody.cockSpot.count() > 1) {
						Render.text("Your cocks feel a building pressure at their base. It only seems to get stronger and stronger, until at last it explodes out from you, jizz covering the poor mouse from the waist up.  ");
					}
				}
				
				//Milk here
				if(player.biggestLactation() >= 1 && player.upperBody.chest.BreastRatingLargest[0].breastRating > 3) {
					if(player.upperBody.chest.BreastRatingLargest[0].breastRating * player.biggestLactation() * player.upperBody.chest.count() < 8) Render.text("Milk sprays from your " + breastDescript(0) + " in tiny streams, triggered by your orgasms.");
					if(player.upperBody.chest.BreastRatingLargest[0].breastRating * player.biggestLactation() * player.upperBody.chest.count() < 20 &&
					player.upperBody.chest.BreastRatingLargest[0].breastRating * player.biggestLactation() * player.upperBody.chest.count() >= 8) Render.text("Milk erupts from your " + breastDescript(0) + ", spraying out over the mouse, squirting out the contractions of each shuddering orgasm.");
					if(player.upperBody.chest.BreastRatingLargest[0].breastRating * player.biggestLactation() * player.upperBody.chest.count() < 35 &&
					player.upperBody.chest.BreastRatingLargest[0].breastRating * player.biggestLactation() * player.upperBody.chest.count() >= 20) Render.text("Milk erupts from your " + breastDescript(0) + ", spraying in pulsing blasts, soaking the mouse.  Each nerve-wracking orgasm seems to wring more and more milk from you, until it puddles around.");
					if(player.upperBody.chest.BreastRatingLargest[0].breastRating * player.biggestLactation() * player.upperBody.chest.count() >= 35) Render.text("Milk fountains from your " + breastDescript(0) + ", soaking the mouse with a continuous river of cream.  For every blob of cum you feel pushing into your over-filled uterus, another torrent of milk sprays out.  As your mind-bending orgasms drag on, a small lake of milk forms around you.");
				}
		...
		private jojosFifthRape():void {
			...
			Render.text("You fuck your mousey slut for what feels like hours, orgasming until both of you are tired and worn out.  ");
			player.orgasm();
			fatigue(-20);
			if (player.stats.lib > 40) {
				Render.text("When you're done you feel more clear-headed, but Jojo looks hornier than ever.");
				dynStats("lib", -4);
			}
		}
		...
		public loseToJojo():void {
			...
			if (monk == 2 || monk == 3) {
				...
				Render.text("Jojo grins wickedly as he senses your defeat, " + monster.cockDescriptShort(0) + " throbbing hard.  ");
				if (player.lust >= 100) {
					if (player.gender == 1) {
						Render.text("Too aroused to think, you just bend over, displaying your bum and letting your " + player.multiCockDescriptLight() + " dangle freely.  The mouse doesn't hesitate, and he thrusts his " + monster.cockDescriptShort(0) + " with painful force.  You stagger from the size and struggle to stay conscious as he fucks you like a mad beast, hammering your ass with incredible force.  ");
						if (player.lowerBody.cockSpot.count() == 1) Render.text("Pre and cum drip from your " + player.cockDescript(0) + ", forced out of your prostate by the rough beating it's taking.  You feel a flash of warm wetness inside you, and realize Jojo is cumming.  A sense of relief washes over you as the last burst of cum squirts out from your cheeks, only to be replaced with a dawning sense of horror as he continues fucking you harder than ever.\n\nYou black out after a few dozen of his orgasms and one or two of your own, your gut painfully distended with semen.");
						if (player.lowerBody.cockSpot.count() > 1) Render.text("Pre and cum drip from your " + player.cockDescript(0) + "s, forced out of your prostate by the rough beating it's taking.  You feel a flash of warm wetness inside you, and realize Jojo is cumming.  A sense of relief washes over you as the last burst of cum squirts out from your cheeks, only to be replaced with a dawning sense of horror as he continues fucking you harder than ever.\n\nYou black out after a few dozen of his orgasms and one or two of your own, your gut painfully distended with semen.");
						player.buttChange(monster.cockArea(0), true);
					}
					if (player.gender >= 2) {
						Render.text("Too aroused to think, you bend over, displaying your bum and " + vaginaDescript(0) + " to Jojo as open targets.  The mouse obliges, plunging himself into you, hard.  He fucks you with abandon, pounding your wanton little pussy with no regard for your pleasure.  Despite yourself, you enjoy the rough treatment.  A spasm of warmth erupts inside you as Jojo cums.  You worry he might stop, but as the mouse's orgasm ends he resumes fucking with even greater energy. You cum powerfully, his jizz seeping down your thighs as you begin lose track of yourself.  ");
						if (player.lowerBody.cockSpot.count() > 1) Render.text("Your " + player.cockDescript(0) + " splatters the ground with cum repeatedly, until both your genders are raw and sore.  ");
						else Render.text("Your " + vaginaDescript(0) + " cums on him many more times it until it is sore and tender, dripping with spunk.  ");
						Render.text("You black out as Jojo cums AGAIN, forcing a river of spunk from your already over-filled uterus.");
					...
					if (player.gender == 0) {
						Render.text("Too aroused to think, you just bend over, displaying your bum and wiggling enticingly.  The mouse doesn't hesitate, and he thrusts his " + monster.cockDescriptShort(0) + " with painful force.  You stagger from the size and struggle to stay conscious as he fucks you like a mad beast, hammering your ass with incredible force.  ");
						Render.text("You feel a flash of warm wetness inside you, and realize Jojo is cumming.  A sense of relief washes over you as the last burst of cum squirts out from your cheeks, only to be replaced with a dawning sense of horror as he continues fucking you harder than ever.\n\nYou black out after a few dozen of his orgasms and one or two of your own, your gut painfully distended with semen.");
					}
					player.slimeFeed();
					hideUpDown();
					player.orgasm();
				...
				//HP Defeat
					...
					Render.text("You black out from the pain of your injuries.\n\n");
					statScreenRefresh();
				}
			}
			cleanupAfterCombat();
		...
		private corruptJojoSexMenu():void {
			...
			if (player.upperBody.chest.BreastRatingLargest[0].breastRating >= 2) addButton(6, (player.biggestLactation() > 1 ? "Suckle" : "Breasts"), corruptJojoBreasts); //All ya need is bewbs
		...
		private corruptJojoBJCruel():void {
			...
			Render.text("You yell out into the jungle, \"<i>Slut!</i>\" Minutes later Jojo slips into your camp from the jungle's shadows, dropping to his knees with a timid look of fear in his eyes. You step forward and grip the fur between his shell-like ears firmly, hissing angrily, \"<i>When I call for you, you need to be here. Do I need to teach you your place again?</i>\"  ");
			Render.text("He shakes his head as you say this, trying to marshal up the strength to resist you. You draw your teeth back in a snarl of anger at this resistance and punch the mouse in the gut, dropping him to his knees gasping for breath.  ");  
			if (player.lowerBody.cockSpot.list[x].cArea() < 10)
				Render.text("You grip the fur on his head tightly in one hand and pull his mouth over your " + player.cockDescript(x) + ", thrusting into his muzzle with little concern for letting him catch his breath. You shove your length down his throat and start sawing away, making the mouse's eyes roll back from breathlessness. You can feel the muscles of his throat grip and spasm around your cock flesh as he chokes on the length, his thin lips trembling around your.  ");
			else if (player.lowerBody.cockSpot.list[x].cArea() < 36)
				Render.text("You grip the fur on his head tightly in one hand and pull his mouth over your " + cockDescript(x) + ", thrusting into his muzzle with little concern for letting him catch his breath. The girth of your " + player.cockDescript(x) + " nearly dislocates his jaw. You can feel his throat stretching around you, like a hot, wet, tight sleeve, trembling with the pulse of his racing heart as you grind in and out of his mouth.  ");
			else Render.text("You grip the fur on his head tightly in one hand and pull his mouth over your " + player.cockDescript(x) + ", thrusting against his muzzle with your " + player.cockDescript(x) + ". You can feel his buck teeth scratching against the top and bottom of your " + player.cockDescript(x) + "'s crown, but it does nothing to prevent what is to come. He lifts his hands to try to push your huge erection away, and since you can't fit your girth in his mouth, you decide to use that; grabbing hold of his hands and using them to stroke your length.  ");
			Render.text("His eyes turn to you in fear and his body shudders for lack of breath, but it does nothing more than stoke the fires of your lust. You groan in pleasure as your balls draw up tight, churning with your corrupted seed, and in a rush you feed it to him, your orgasm overtaking you as surge after hot surge of cum flares through your flesh and into his throat.  " + (player.lowerBody.vaginaSpot.hasVagina() ? "A sympathetic orgasm hits your pussy, causing a surge of feminine juices to splash against his chest and dribble down your thighs lewdly.  " : ""));
			Render.text("Your orgasm seems to last forever, filling his belly with your corrupted essence, causing his stomach to bulge slightly with the sheer volume of it. You pull away at last, letting him gasp for breath and fall to the ground, curling around his bloated belly.  ");
			Render.text("You sneer at him and shake your head, hissing out, \"<i>It would be so much better for you if you didn't try to resist, my slut.</i>\"  ");
			player.orgasm();
			dynStats("cor", 0.5);
			doNext(camp.returnToCampUseOneHour);
		}
		...
		private corruptJojoBJGentle():void {
			...
			else Render.text("He opens his mouth to protest, only to have your " + player.cockDescript(x) + " mute him. You can feel his buck teeth scratching against the top and bottom of your " + player.cockDescript(x) + "'s crown, but it does nothing to prevent what is to come. He lifts his hands to try to push your huge erection away, and since you can't fit your girth in his mouth, you decide to use that; grabbing hold of his hands and using them to stroke your length.  " + (player.upperBody.chest.BreastRatingLargest[0].breastRating >= 2 ? "His eyes move from your massive member to your bouncing breasts above with a look of wanton desire that makes you laugh softly.  " : ""));
			Render.text("His eyes turn to you in fear and awe, pleading for release, and a slip of your foot to his own straining erection lets you know how in need of an orgasm he is, but this time is yours. You groan in pleasure as your balls draw up tight, churning with your corrupted seed, and in a rush you feed it to him, your orgasm overtaking you as surge after hot surge of cum flares through your flesh and into his throat.  " + (player.lowerBody.vaginaSpot.hasVagina() ? "A sympathetic orgasm hits your pussy, causing a surge of feminine juices to splash against his chest and dribble down your thighs lewdly.  " : ""));
			Render.text("Your orgasm seems to last forever, filling his belly with your corrupted essence, causing his stomach to bulge slightly with the sheer volume of it. You pull away at last, letting him gasp for breath and fall to the ground, curling around his bloated belly.  ");
			if (player.upperBody.chest.BreastRatingLargest[0].breastRating >= 2)
				Render.text("You draw him to your bosom and kiss his forehead and then stand and go about your duties, leaving him to recover from the intense encounter and then retreat back into the jungle.  ");
			else Render.text("You give him one last fond caress, running your fingers through his fur in an almost patronizing petting motion, then turn without another word and leave him to retreat back into the jungle.  ");
			player.orgasm();
			dynStats("cor", 0.5);
			doNext(camp.returnToCampUseOneHour);
		}
		...
		private corruptJojoCunnilingus():void {
			...
			Render.text("He looks at you in confusion that turns to bliss as you start to lick and caress his sheath and balls, urging the male to a full erection.  ");
			switch (rand(3)) {
				case 0:
					Render.text("You take the tip of his member into your mouth, suckling at it as your tongue curls at the crown and teases at the tiny slit at the tip. You take your time with him, letting your hands rub up and down his length, masturbating him slowly and giving his needy balls the occasional caress.  ");
					break;
				case 1: Render.text("You take the tip of his member into your mouth and slowly start to bob your head, one hand squeezing at his balls tenderly as your other hand strokes the length of his cock that your lips don't reach. You let your pace quicken over time, mimicking a vigorous fucking.  ");
					break;
				default:
					Render.text("You take the tip of his member into your mouth, and then take a deep breath through your nose, before dropping your head down, listening to him gasp as his cock slides all the way into your mouth and down your throat, until your nose presses against his musky sheath.  Your hands tease and squeeze at his balls, urging him to cum as your throat rhythmically swallows at his length in a milking motion.  ");
			}
			Render.text("You work until your slut explodes, and then, keeping all his seed in your mouth, you lift your head and press your lips to his in a firm kiss, feeding him the load of cum that he just released. He blushes as you do so, but obediently takes it all in, swallowing it down as you feed it to him.  ");
			Render.text("Once the vulgar kiss is finished, you stand and smile, dismissing him with a casual wave of your hand.  ");
			dynStats("cor", 0.5);
			doNext(camp.returnToCampUseOneHour);
		}
		...
		private corruptJojoVaginalGentle():void {
			...
			if (player.vaginalCapacity() < 10) {
				...
				Render.text("You lower your hand to take hold of his cock, lining it up with your entrance, and then with a moan of pleasure, you lower your weight atop him. His cock slides into your pussy like a hand into a glove, fitting perfectly, as though he were made for you.\n");
				player.cuntChange(36.4, true);
				...
				Render.text("You shift forward, and then tilt your hips and drive back, taking his length into your wide stretched body.\n");
				player.cuntChange(36.4, true);
		...
		private corruptJojoVaginalSmother():void {
			...
			Render.text("You crawl further up his body and grin down at him as you press your already dripping pussy to his mouth and command sharply, \"<i>Start licking if you want to breathe.</i>\" His eyes go wide, but you can feel his tongue already starting to work at your lusty slit.  ");
			if (player.vaginas.wetness > 4)
				Render.text("You moan as he works, your juices flowing liberally across his muzzle and into his mouth and nose, making him struggle not to drown in your pleasure as he focuses on giving you even more so.  ");
			else if (rand(2) == 0)
				Render.text("You grind your slit against him as he eats you out, moaning with pleasure and writhing above him. You lift off of his face every so often, giving him just enough of a break to catch his breath before cutting it off with your pussy once again.  ");
			else Render.text("You settle the full of your weight against his face and laugh as you feel him struggling to pleasure you, his nose and mouth trapped tight against your slit so that every attempt to breathe is halted, making him tremble breathlessly beneath you.  ");
			Render.text("His tongue digs deep into your body, finally bringing you to an explosive climax that leaves you shuddering thoughtlessly above him. You actually forget you are sitting on his face for a moment, feeling him go still as he nearly passes out from lack of breath before you stand up.  ");
			Render.text("He gasps for breath and coughs a few times, and once you are sure that he is safe, you laugh softly and walk back to your camp.  ");
			player.orgasm();
			dynStats("cor", 0.5);
			doNext(camp.returnToCampUseOneHour);
		}
		...
		private corruptJojoAnalGentle():void {
			...
			clearOutput();
			let x: number = player.biggestCockIndex();
			Render.text("You watch as Jojo slinks into your camp from the dense jungle, moving timidly with his eyes focused on your feet. The sight of such a once pious monk reduced to your submissive fuck toy stirs your loins and brings a smile to your lips.  ");
			Render.text("You pull him against your body in a firm and possessive hug, and press your lips to his in a forceful kiss, laughing as you break the kiss to the sight of his discomfort. You pay it little mind as you gently force him back onto the ground and spread his legs. You can see in his eyes that he knows what is coming, and you can see that he is as eager for it as he is humiliated by that eagerness.  ");
			if (player.lowerBody.cockSpot.list[x].cArea() < 10)
				Render.text("You lift the mouse's balls out of the way and spit down onto the crinkled star of his anus, then lever your tip to the well used hole. There is little ceremony or foreplay, but his cock is already straining erect, and a blush colors his cheeks as you push into his ass, inch by inch. You set a slow and tender pace at first, but as your orgasm nears, your thrusts become more animal and needy.  ");
			else if (player.lowerBody.cockSpot.biggestCocks[0].cockArea() < 36)
				Render.text("You slide your thick and drooling cockhead beneath the mouse's balls, working the musky drool of your pre-cum against the well used crinkle of his ass before forcing the thick vein-lined length of your " + player.cockDescript(x) + " into him. You watch as inch after thick, vulgar inch disappears into his body, grinning as his face contorts in a mix of pain and pleasure from it, and then start to fuck him in earnest, watching as his belly bulges with each thrust of your massive prick.  ");
			else Render.text("You force your " + player.cockDescript(x) + " against the mouse's ass and watch as he shakes his head, silently begging you not to do it. You smile and grip his hips, then press forward hard, forcing his body to adapt to your girth, stretching his ass and belly dangerously. You can barely get more than a foot of your " + player.cockDescript(x) + " into him before bottoming out against his diaphragm, so you just fuck him with what you can, churning his insides with each thrust.  ");
			Render.text("You pound away at the mouse's tight body for as long as you can, then feel your orgasm hit you hard, your balls drawing up tight as your seed churns and pulses through you and into the mouse's ass, filling his belly with your lust and corruption. You watch his belly swell with the seed in a beautifully vulgar display.  ");
			Render.text("His eyes glaze over from the intensity of the act, his teeth tightly grit, and then you can hear a keening groan from him as he falls over the edge into his own orgasm, his untouched mouse cock bouncing and jerking on his belly as his thick seed is sprayed across his chest and face lewdly. He blushes deep at the visible proof that he enjoyed what you did to him and trembles beneath you.  ");
			Render.text("You can't help but laugh at the scene, and draw out of his ass with a groan of pleasure. You watch as he crawls back into the jungle in shame, leaving a trail of your cum the whole way.  ");
			player.orgasm();
			dynStats("cor", 0.5);
			doNext(camp.returnToCampUseOneHour);
		}
		...
		private corruptJojoAnalSmother():void {
			...
			clearOutput();
			Render.text("You feel the need to gain a little sexual relief and a mischievous idea comes to your mind, making you grin wickedly. You slip off into the jungle to seek out your monk mouse fuck toy, and when you find him, you practically pounce atop him, pinning him to his back. He struggles in surprise until he realizes that it is you, at which point he blushes and tries to look away, unable to help the erection that you are sitting against as you straddle him.  ");
			Render.text("You crawl further up his body and grin down at him as he stares at your exposed pussy. You suddenly spin, sitting down the other way, so that your ass cheeks envelope his muzzle, trapping his nose and mouth against your tight pucker. \"<i>Get that tongue up in there slut.</i>\"  ");
			switch (rand(3)) {
				case 0:
					Render.text("You grind your ass against him as he eats you out, moaning with pleasure and writhing above him. You lift off of his face every so often, giving him just enough of a break to catch his breath before cutting it off with your ass once again.  ");
					break;
				case 1:
					Render.text("You settle the full of your weight against his face and laugh as you feel him struggling to pleasure you, his nose and mouth trapped tight against your ass so that every attempt to breathe is halted, making him tremble breathlessly beneath you.  ");
					break;
				default:
					Render.text("You moan as he takes you at your word, spearing his tongue deep into your anus and thrusting it in and out as though it were a sleek muscled shaft, making your body tremble in pleasure. It makes you wonder where he learned such a trick in his life as a pious monk.  ");
			}
			Render.text("His tongue continues to work at your ass, finally bringing you to an explosive climax that leaves you shuddering thoughtlessly above him. You actually forget you are sitting on his face for a moment, feeling him go still as he nearly passes out from lack of breath before you stand up.  ");
			Render.text("He gasps for breath and coughs a few times, and once you are sure that he is safe, you laugh softly and walk back to your camp.");
			player.orgasm();
			dynStats("cor", 0.5);
			doNext(camp.returnToCampUseOneHour);
		...
		private corruptJojoBreasts():void { //Should only be available to players with biggestBreastSize > 2
			...
			Render.text("Your mouse slut obediently slips from the darkness and into your camp, approaching you and kneeling at your side. You can see the lust in his eyes as he looks at your breasts, longing and love reflecting wonderfully. You nod your approval and let him worship your bosom.  ");
			if (player.biggestLactation() > 1) { //For suckling the scene is the same regardless of player's gender
				Render.text("He leans in and starts to kiss along your nipples before taking one into his mouth. He gives a firm suckle at the engorged teat, and you can see his eyes open wider in surprise at the sudden surge of milk that fills his muzzle. He shivers and starts to suckle in earnest, drinking from first one breast, then the other, ");
				if (player.upperBody.chest.count() > 1) Render.text("and then all the others, "); //Extra boob coverage
				Render.text("partaking of your blessing until his belly is full.  ");
				player.milked();
			}
			else if (player.upperBody.chest.BreastRatingLargest[0].breastRating <= 5) {
				Render.text("He leans in to nuzzle and kiss at your breasts, his hands moving to caress the soft and full orbs in gentle worship. His kissing and licking slowly circles in on your nipples, bringing them to firm points that send jolts of warm pleasure through your body when he at last takes them into his mouth. You reach down between your legs, " + (player.lowerBody.cockSpot.hasCock() ? "taking hold of your shaft and masturbating it lazily as he works.  " : "slipping your fingers into your slit as you lazily masturbate with the pleasure he brings.  "));
			}
			else {
				Render.text("He leans in close and presses a kiss to first one nipple, then the other, starting to worship your breasts lovingly. You have other plans, however, and one hand grabs the fur at the back of his neck as the other slips beneath your breasts to pull them together to either side of his face as you press him in tight against the curves of your cleavage, forcing the mouse to fight for every breath.  ");
			}
			Render.text("You can hear Jojo's breath quickening, then his body shudders as he climaxes spontaneously, splashing his seed across your hip and belly. You can't help the laugh that rises from within you at his submissive gesture, watching as shame washes across his face and his ears lay back.  ");
			Render.text("He slinks back into the woods, chased by your amused laughter.");
			player.orgasm();
			dynStats("cor", 0.5);
			doNext(camp.returnToCampUseOneHour);
		}
		...
		private masturbateJojo():void {
			...
			if (player.gender == 1 && player.upperBody.chest.BreastRatingLargest[0].breastRating < 2) {
				...
				if (selection == 0) {
					...
					Render.text("His eyes turn to you in fear and awe, pleading for release, and in the end you give him just that. You groan in pleasure as your balls draw up tight, churning with your corrupted seed, and in a rush you feed it to him, your orgasm overtaking you as surge after hot surge of cum flares through your flesh and into his throat.  ");
					Render.text("Your orgasm seems to last forever, filling his belly with your corrupted essence, causing his stomach to bulge slightly with the sheer volume of it. You pull away at last, letting him gasp for breath and fall to the ground, curling around his bloated belly.  ");
					Render.text("You give him one last fond caress, running your fingers through his fur in an almost patronizing petting motion, then turn without another word and leave him to retreat back into the jungle.  ");
				}
				//MALE HARD BJ	
				if (selection == 1) {
					Render.text("You yell out into the jungle, \"<i>Slut!</i>\" Minutes later Jojo slips into your camp from the jungle's shadows, dropping to his knees with a timid look of fear in his eyes. You step forward and grip the fur between his shell-like ears firmly, hissing angrily, \"<i>When I call for you, you need to be here. Do I need to teach you your place again?</i>\"  ");
					Render.text("He shakes his head as you say this, trying to marshal up the strength to resist you. You draw your teeth back in a snarl of anger at this resistance and punch the mouse in the gut, dropping him to his knees gasping for breath.  ");  
					if (player.lowerBody.cockSpot.list[storage].cArea() < 10)
						Render.text("You grip the fur on his head tightly in one hand and pull his mouth over your " + player.cockDescript(storage) + ", thrusting into his muzzle with little concern for letting him catch his breath. You shove your length down his throat and start sawing away, making the mouse's eyes roll back from breathlessness. You can feel the muscles of his throat grip and spasm around your cock flesh as he chokes on the length, his thin lips trembling around your.  ");
					else if (player.lowerBody.cockSpot.list[storage].cArea() < 36)
						Render.text("You grip the fur on his head tightly in one hand and pull his mouth over your " + cockDescript(storage) + ", thrusting into his muzzle with little concern for letting him catch his breath. The girth of your " + player.cockDescript(storage) + " nearly dislocates his jaw. You can feel his throat stretching around you, like a hot, wet, tight sleeve, trembling with the pulse of his racing heart as you grind in and out of his mouth.  ");
					else Render.text("You grip the fur on his head tightly in one hand and pull his mouth over your " + player.cockDescript(storage) + ", thrusting against his muzzle with your " + player.cockDescript(storage) + ". You can feel his buck teeth scratching against the top and bottom of your " + player.cockDescript(storage) + "'s crown, but it does nothing to prevent what is to come. He lifts his hands to try to push your huge erection away, and since you can't fit your girth in his mouth, you decide to use that; grabbing hold of his hands and using them to stroke your length.  ");
					Render.text("His eyes turn to you in fear and his body shudders for lack of breath, but it does nothing more than stoke the fires of your lust. You groan in pleasure as your balls draw up tight, churning with your corrupted seed, and in a rush you feed it to him, your orgasm overtaking you as surge after hot surge of cum flares through your flesh and into his throat.  ");
					Render.text("Your orgasm seems to last forever, filling his belly with your corrupted essence, causing his stomach to bulge slightly with the sheer volume of it. You pull away at last, letting him gasp for breath and fall to the ground, curling around his bloated belly.  ");
					Render.text("You sneer at him and shake your head, hissing out, \"<i>It would be so much better for you if you didn't try to resist, my slut.</i>\"  ");
				}
				//MALE ANAL GENTLE
				...
				if (selection == 3) {
					Render.text("You decided that it is time to seek out your pet monk slut, and stalk into the jungle after the mouse. It doesn't take long to find him, so you move silently to avoid his notice. You move with a predator's grace as you sneak up behind him, your hand reaching down to grab hold of his tail firmly as you shove him against a nearby tree.  ");
					Render.text("You press your body up behind him and hiss into his ear, \"<i>Hello slut...</i>\" You keep hold of the base of his tail, hiking it up to lift his ass enough that he has to go to his toes to stay standing. You listen to him whimper softly as he feels your stirring loins press against the cleft of his oh-so-fuckable ass.  ");
					if (player.lowerBody.cockSpot.list[storage].cArea() < 10)
						...
						Render.text("You press the mouse hard against the tree, inhaling his scent and sliding your " + cockDescript(storage) + " between his firm cheeks.  There is little in the way of tenderness as you thrust deep into his body. You can hear him groan as your " + player.cockDescript(storage) + " forces his intestines to shift to accommodate you.  ");
					else Render.text("You grin as your mouse slut cries out with your " + player.cockDescript(storage) + " spearing into his bowels. You can feel the weight of the tree against your " + player.cockDescript(storage) + " as you force his belly to bulge out vulgarly to accommodate the enormous girth.  ");
					Render.text("You thrust away at your squirming and mewling mouse, taking out your pleasure on him with little concern for his own enjoyment, not that this is really a problem, as before you manage to cum, you feel him tense as he 'fertilizes' the tree you have him pressed against. The feel of his orgasm milks you to your own explosion within his belly, emptying your balls with a low groan of relief.  ");
					Render.text("You pull out of Jojo's ass once your orgasm has subsided and wipe your cock off on the fur of his back, then walk away to leave him to his own devices.  ");
				}
			}
			//Shemale
			if (player.gender == 1 && player.upperBody.chest.BreastRatingLargest[0].breastRating >= 2) {
				...
				if (selection == 0) {
					...
					Render.text("His eyes beg for release and a slip of your foot to his own straining erection lets you know how in need of an orgasm he is, but this time is yours. You groan in pleasure as your balls draw up tight, churning with your corrupted seed, and in a rush you feed it to him, your orgasm overtaking you as surge after hot surge of cum flares through your flesh and into his throat.  ");
					Render.text("Your orgasm seems to last forever, filling his belly with your corrupted essence, causing his stomach to bulge slightly with the sheer volume of it. You pull away at last, letting him gasp for breath and fall to the ground, curling around his bloated belly.  ");
					Render.text("You draw him to your bosom and kiss his forehead and then stand and go about your duties, leaving him to recover from the intense encounter and then retreat back into the jungle.  ");
				}
				...
				if (selection == 1) {
					...
					else Render.text("He leans in close and presses a kiss to first one nipple, then the other, starting to worship your breasts lovingly. You have other plans, however, and one hand grabs the fur at the back of his neck as the other slips beneath your breasts to pull them together to either side of his face as you press him in tight against the curves of your cleavage, forcing the mouse to fight for every breath.  ");
					Render.text("You can hear Jojo's breath quickening, then his body shudders as he climaxes spontaneously, splashing his seed across your hip and belly. You can't help the laugh that rises from within you at his submissive gesture, watching as shame washes across his face and his ears lay back.  ");
					Render.text("He slinks back into the woods, chased by your amused laughter.  ");
				}
				...
				if (selection == 3) {
					Render.text("You decided that it is time to seek out your pet monk slut, and stalk into the jungle after the mouse. It doesn't take long to find him, so you move silently to avoid his notice. You move with a predator's grace as you sneak up behind him, your hand reaching down to grab hold of his tail firmly as you shove him against a nearby tree.  ");
					Render.text("You press your body up behind him, mashing your breasts against his back, and hiss into his ear, \"<i>Hello slut...</i>\" You keep hold of the base of his tail, hiking it up to lift his ass enough that he has to go to his toes to stay standing. You listen to him whimper softly as he feels your stirring loins press against the cleft of his oh-so-fuckable ass.  ");
					if (player.lowerBody.cockSpot.list[storage].cArea() < 10)
						...
						Render.text("You press the mouse hard against the tree, inhaling his scent and sliding your " + player.cockDescript(storage) + " between his firm cheeks.  There is little in the way of tenderness as you thrust deep into his body. You can hear him groan as your " + player.cockDescript(storage) + " forces his intestines to shift to accommodate you.  ");
					else Render.text("You grin as your mouse slut cries out with your " + player.cockDescript(storage) + " spearing into his bowels. You can feel the weight of the tree against your member as you force his belly to bulge out vulgarly to accommodate the enormous girth.  ");
					Render.text("You thrust away at your squirming and mewling mouse, taking out your pleasure on him with little concern for his own enjoyment, not that this is really a problem, as before you manage to cum, you feel him tense as he 'fertilizes' the tree you have him pressed against. The feel of his orgasm milks you to your own explosion within his belly, emptying your balls with a low groan of relief.  ");
					Render.text("You pull out of Jojo's ass once your orgasm has subsided and wipe your " + player.cockDescript(storage) + " off on the fur of his back, then walk away to leave him to his own devices.  ");
				}
			}
			//CuntBOOOOOI
			...
			if (player.gender == 2 && player.upperBody.chest.BreastRatingLargest[0].breastRating >= 2) {
				...
				if (selection == 0) {
					...
					if (player.biggestLactation() > 1) {
						Render.text("He leans in and starts to kiss along your nipples before taking one into his mouth. He gives a firm suckle at the engorged teat, and you can see his eyes open wider in surprise at the sudden surge of milk that fills his muzzle. He shivers and starts to suckle in earnest, drinking from first one breast, then the other, ");
						//Extra boob coverage
						if (player.upperBody.chest.count() > 1) Render.text("and then all the others, ");
						Render.text("partaking of your blessing until his belly is full.  ");
					}
					else if (player.upperBody.chest.BreastRatingLargest[0].breastRating <= 5)
				...
				if (selection == 2) {
					...
					Render.text("You cry out in pleasure as your orgasm floods through your body, causing your juices to splash out around your mouse slut's cock. You stay seated on his hips until your orgasm fades, then with a sigh of pleasure you stand off of him and dismiss him with a wave of your hand.  ");
					//Preggers chance!
					player.knockUp(PregnancyType.JOJO, PregnancyType.INCUBATION_MOUSE + 82); //Jojo's kids take longer for some reason
					player.cuntChange(36.4, true);
				}
				...
				if (selection == 3) {
					...
					switch (rand(3)) {
						case 0:
							Render.text("You grind your slit against him as he eats you out, moaning with pleasure and writhing above him. You lift off of his face every so often, giving him just enough of a break to catch his breath before cutting it off with your pussy once again.  ");
							break;
						case 1: Render.text("You settle the full of your weight against his face and laugh as you feel him struggling to pleasure you, his nose and mouth trapped tight against your slit so that every attempt to breathe is halted, making him tremble breathlessly beneath you.  ");
							break;
						default:
							Render.text("You moan as he works, your juices flowing liberally across his muzzle and into his mouth and nose, making him struggle not to drown in your pleasure as he focuses on giving you even more so.  ");
					}
			...
			if (player.gender == 3) {
				...
				if (selection == 0) {
					...
					Render.text("His eyes beg for release and a slip of your foot to his own straining erection lets you know how in need of an orgasm he is, but this time is yours. You groan in pleasure as your balls draw up tight, churning with your corrupted seed, and in a rush you feed it to him, your orgasm overtaking you as surge after hot surge of cum flares through your flesh and into his throat. A sympathetic orgasm hits your pussy, causing a surge of feminine juices to splash against his chest and dribble down your thighs lewdly.  ");
					Render.text("Your orgasm seems to last forever, filling his belly with your corrupted essence, causing his stomach to bulge slightly with the sheer volume of it. You pull away at last, letting him gasp for breath and fall to the ground, curling around his bloated belly.  ");
					Render.text("You draw him to your bosom and kiss his forehead and then stand and go about your duties, leaving him to recover from the intense encounter and then retreat back into the jungle.  ");
				}
				...
				if (selection == 1) {
					if (player.upperBody.chest.BreastRatingLargest[0].breastRating < 2) 
						...
						if (player.biggestLactation() > 1)
							...
							Render.text("He leans in to nuzzle and kiss at your breasts, his hands moving to caress the soft and full orbs in gentle worship. His kissing and licking slowly circles in on your nipples, bringing them to firm points that send jolts of warm pleasure through your body when he at last takes them into his mouth. You reach down between your legs, taking hold of your shaft and masturbating it lazily as he works.  ");
						else Render.text("He leans in close and presses a kiss first to one nipple, then the other, worshiping your breasts lovingly. You have other plans, however, and one hand grabs the fur at the back of his neck as the other slips beneath your breasts to pull them together to either side of his face as you press him in tight against the curves of your cleavage, forcing the mouse to have to fight for every breath.  ");
						Render.text("You can hear Jojo's breath quickening, then his body shudders as he climaxes spontaneously, splashing his seed across your hip and belly. You can't help the laugh that rises from within you at his submissive gesture, watching as shame washes across his face and his ears lay back.  ");
						Render.text("He slinks back into the woods, chased by your amused laughter.  ");
					}
				}
				...
				if (selection == 3) {
					...
					Render.text("You cry out in pleasure as your orgasm floods through your body, causing your juices to splash out around your mouse slut's cock, and your own " + player.multiCockDescriptLight() + " to explode with thick splashes of your hot cum across his chest and belly.  ");
					Render.text("You stay seated on his hips until your orgasm fades, then with a sigh of pleasure you stand off of him and dismiss him with a wave of your hand.");
					//Preggers chance!
					player.knockUp(PregnancyType.JOJO, PregnancyType.INCUBATION_MOUSE + 82); //Jojo's kids take longer for some reason
					player.cuntChange(36.4, true);
				}
...
private beeEggsInCorruptJojo():void {
	...
	if(!player.lowerBody.cockSpot.hasCock()) {
		if(flags[FlagEnum.TIMES_EGGED_JOJO] == 0) Render.text("Jojo looks confused at this; he knows you don't have a cock!  ");
		else Render.text("Jojo looks confused at first, and then nods in understanding, remembering the last time you laid in him.  ");
	}
	Render.text("He bends over, obedient slut that he is, lifting his ");
	if(tentacleJojo()) Render.text("tentacle-");
	Render.text("tail for you in an inviting motion.  His butt looks nice and cushy, a soft heart-shape just beckoning to be impaled on your rigid egg-tool.  You give the mouse-tush a hearty swat and smile at his squeak of surprise and winking anus.");
	
	Render.text("\n\nMoving forward, you ");
	if(player.isNaga()) Render.text("slither around him");
	else if(player.isGoo()) Render.text("ooze over him");
	else if(player.isTaur()) Render.text("straddle him");
	else Render.text("climb atop him");
	Render.text(".  Jojo looks up over his shoulder trustingly, swaying a bit from trying to hold up your body weight.  He starts to reach for his corruption-fueled boner, but of course, he has to drop his arm to hold himself upright.  The rodent whines plaintively, begging you to take him, stroke him... ANYTHING!  You gently shush him and sink your stinger into his backside, rewarding his obedience with a flash of pain and injection of fresh, unnatural lust.  His arms begin to shake, his butt begins to wiggle, and he starts to drool all over the ground, panting in a way that reminds you more of a canine than a mouse.");
	...
	if(player.gender > 0) {
		...
		if(player.gender == 3) Render.text(" and [eachCock] ");
		if(player.gender == 1) Render.text(multiCockDescriptLight() + " ");
		if(player.gender == 3 || player.lowerBody.cockSpot.count() > 1) Render.text("are");
		else Render.text("is");
		Render.text(" gushing all over Jojo's back, but you don't feel particularly inclined to deal with your regular genitals.  ");
	}
	Render.text("You're utterly focused on the silky feel of those smooth spheres rolling out of you, being implanted into a host, willing or not.  Thankfully, Jojo is willing, creaming the ground, sputtering strings of spunk with each new egg that you force inside his once-tight anus.  Orb after orb slides inside him, drawing shivers of ecstasy from your alien-looking egg-cock.  With an explosive clench, you cum and force the remainder of your eggs into the mouse-bitch's butt-cunt.");
	if(player.eggs() > 30) Render.text("  His belly is slightly rounded by the time you finish, with small, egg-shaped bumps visible through his fur.");
...
public lowCorruptionJojoEncounter():void
{
	...
	Render.text("Tired of exploring the forest for the moment, you decide to head back to camp.  Not feeling like taking the scenic route, you move to step through some bushes, but immediately your mind registers a yelp.  The instant you move to look at the source of the noise, a white blur smacks you right on your head.");

	if (player.tou >= 50 && player.isBiped() == true)
	{
		Render.text("  You take a few steps back, momentarily dazed.  Shaking it off, you ready your [weapon] and assume a fighting stance.\n\n");
	}
	else if (player.tou < 50 && player.isBiped() == false)
	{
		Render.text("The force of the blow knocks you flat on your [ass].  Shaking it off, you immediately climb to your feet and take on a fighting stance.\n\n");
	}
	else if (player.isTaur())
	{
		Render.text("The blow does little more than leave you momentarily dazed but isn’t enough to knock you over.  You shake it off and ready your [weapon] as you assume a fighting stance.\n\n");
	}
	else // Was originally isNaga() only, but this will also cover Drider just as well
	{
		Render.text("You recoil as you are struck, but the force of the blow does little more than leave you momentarily dazed. You assume a fighting stance, ready to defend yourself.\n\n");
	}

	Render.text("To your surprise you are greeted with the visage of a rather surprised mouse.\n\n");

	Render.text("“<i>Oh... erm... I’m sorry.  You spooked me,</i>” he says apologetically, rubbing the back of his neck in embarrassment.\n\n");

	Render.text("Do you accept his apology?\n\n");
...
public acceptJojosApology():void
{
	...
	Render.text("You forgive him for hitting you and apologize for spooking him yourself, prompting a relieved sigh.\n\n");

	Render.text("“<i>Thanks, it’s a relief to meet a friendly face,</i>” he says, his mouth breaking into a smile. “<i>Oh, where are my manners!</i>”\n\n");
...
public refuseJojosApology():void
{
	...
	Render.text("With a smile you curl up a fist and knock the unsuspecting mouse morph upside the head, causing him drop his staff and rub the spot where you slugged him.  As he looks up at you you give his angry expression a shrug, telling him that now the two of you are even.\n\n");

	Render.text("“<i>O-Kay</i>” The mouse says slowly, suddenly watching your movements very closely with those quick little eyes of his, “<i>But I guess it’s fair, no harm done right?</i>”\n\n");
	Render.text("It’s all water under the bridge to you now; after all you did slug him real good. The two of you agree to start over.\n\n");
...
public lowCorruptionIntro():void
{
	...
	Render.text("Now that you have the opportunity to take a good look at him, you notice that he is dressed in simple garbs reminiscent of a monk. A light-blue robe covers his flat chest, tied with a simple sash around his waist. His pants, similar to his robes, fit him snugly as well.\n\n");

	Render.text("His build is lithe, though you detect he isn’t weak by any means. His handshake is firm and transmits confidence; it’s clear that this mouse has trained well, though you can’t see any hint of muscles with his robes covering him. His hair is short and as white as his fur, you’d guess he’s an albino if not for his brown eyes. Surprisingly, he doesn’t seem to be carrying anything on his person, save for a necklace made of beads.\n\n"); // Can't really presume that they're holy without knowing much more about him, rite?

	Render.text("He smiles knowingly, “<i>Yes I am a monk, and yes this is a strange place for one such as I... this world was not always this way.  Long ago this world was home to many villages, including my own.  But then the demons came.  I'm not sure if they were summoned, created, or simply a perversion of magic or breeding, but they came swarming out of the mountains to destroy everything in their path.</i>”\n\n");

	Render.text("Jojo sighs sadly, “<i>Enough of my woes.  Though I ");
	if (player.stats.cor <= 5) Render.text("don't ");
	else Render.text("barely ");
	Render.text("feel any corruption within you, it’s always best to be prepared.  Would you care to join me in meditation?</i>”\n\n");
	...
	if (player.statusAffects.get("JojoMeditationCount").value1 >= 5) {
		...
		if (flags[FlagEnum.FUCK_FLOWER_LEVEL] >= 4 && flags[FlagEnum.FUCK_FLOWER_KILLED] == 0 && player.statusAffects.get("JojoMeditationCount").value1 % 5 == 0) {
			...
			if (player.hasKeyItem("Jojo's Talisman") >= 0) { //[(if PC has Small Talisman)
				Render.text("Jojo smiles at you.  \"<i>[name], well done.  Your talent at focusing is undiminished.  Regarding the other issue... you still have the item I gave you?</i>\"");
				...
				Render.text("Jojo nods at you respectfully.  \"<i>Well done today; your dedication is impressive.  We could meditate together more often.</i>\"");
			...
			Render.text("\"<i>It seems you have quite a talent for this.  We should meditate together more often.</i>\"", false);
	}
...
public acceptOfferOfHelp():void
{
	...
	Render.text("<i>“Thank Marae.  You’re much stronger than I, my friend... to hold so much corruption and still retain your will.  But let us not tempt fate,”</i> he says before the two of you get to it.\n\n");
...
public jojoCamp():void {
	...
	if (player.statusAffects.has("Infested")) { // Worms overrides everything else
		Render.text("As you approach the serene monk, you see his nose twitch.\n\n");
	...
	if (player.stats.cor > 10) { //New "offer of help" menu
		if (player.stats.cor >= 40) {
			Render.text("You walk toward the boulder where Jojo usually sits, and as soon as you're close Jojo approaches you with urgency.  \"<i>By Marae! [name], we must do something! I feel the corruption surrounding you like a dense fog.  We need to meditate or I’m going to lose you!</i>\" Jojo pleads.\n\n");
		}
		else {
			Render.text("You walk up to the boulder where Jojo usually sits, and see him sitting cross legged with his eyes closed.  He seems to be deep in meditation, but when you approach his eyes open suddenly and he gets up appearing slightly distressed, “<i>Uh... [name], I can feel a bit of corruption within you.  It is not much, but I think you should be concerned about it before it gets out of hand and you do something you might regret.  If you want to I'd be happy to meditate with you as you rid yourself of it.</i>” he offers with a concerned look on his face.\n\n");
		}
		Render.text("Do you accept Jojo's help?\n\n");
		...
		switch (rand(3)) {
			case 0: Render.text("You walk toward the boulder where Jojo usually sits, and see him cross legged with his eyes closed.  At first he seems to be deep in meditation, but when you approach his mouth curls into a smile; he gets up and opens his eyes regarding you with a welcoming expression.  “<i>Greetings [name], is there anything I can assist you with?</i>”\n\n");
					break;
			case 1: Render.text("You walk up to the boulder where Jojo usually sits and find him a few paces behind it. He is standing and practicing his form, gracefully moving from one pose to the next. As you approach him you see his ears visibly perk and he turns his head towards you without breaking his stance, saying, “<i>Greetings [name], is there anything I can assist you with?</i>”\n\n");
					break;
			default: Render.text("You find Jojo sitting cross-legged on a flat rock with his staff leaning against his shoulder, thinking.  He looks to you and nods, \"<i>Greetings, " + player.short + ".  Is there something I could do to assist you?</i>\"\n\n");
		}
		jojoCampMenu();
	}
}
...
//[Appearance] [Talk] [Train] [Meditate] [Night Watch toggle]
	...
	if (player.statusAffects.has("JojoNightWatch")) {
		Render.text("(Jojo is currently watching for enemies at night.)\n\n");
		jojoDefense += "On";
	}
	...
	if (flags[FlagEnum.UNLOCKED_JOJO_TRAINING] == 1) addButton(2, "Train", apparantlyJojoDOESlift);
	addButton(3, "Meditate", jojoFollowerMeditate);
	addButton(4, jojoDefense, jojoDefenseToggle);
	if (player.statusAffects.has("Infested")) addButton(5, "Purge", wormRemoval);
	addButton(8, "Rape", (player.stats.cor > 10 && player.lust >= 33 && player.gender > 0 ? jojoAtCampRape : null));
...
public jojoAppearance():void
{
	clearOutput();
	jojoSprite();
	Render.text("Jojo is a white furred mouse-morph with dish-like ears and a small muzzle below a sometimes twitchy nose. He watches you with striking blue eyes.\n\n");

	Render.text("He's wearing pale blue monk robes that are form fitting yet loose enough to allow him to move freely if the need arises. He also wears prayer beads, a cloth sash that holds his robe close and baggy pants cover his legs all the way to his mouse-like footpaws; on the back of his pants a small hole is cut to allow his ropy pink tail freedom.\n\n");

	Render.text("It's hard to estimate due to his clothing, but you can tell he is pretty lean and doesn't have much in the way of muscle; which makes sense since his martials arts rely more on speed than strength anyways.\n\n");

	Render.text("His weapons of choice are his fists and a polished wooden staff he wields with practiced hands, right now it is tucked away in his bed roll.\n\n");
	menu();
	doNext(jojoCamp);
}
...
public talkMenu():void
{
	...
	if (flags[FlagEnum.TIMES_TALKED_WITH_JOJO] >= 4) addButton(4, "You", jojoTalkYourOrigin);
	if (player.statusAffects.has("DungeonShutDown")) addButton(5, "Factory", jojoTalkFactory);
	if (flags[FlagEnum.SAND_WITCHES_COWED] == 1 || flags[FlagEnum.SAND_WITCHES_FRIENDLY] == 1 || flags[FlagEnum.SAND_MOTHER_DEFEATED] == 1) addButton(6, "SandCave", jojoTalkSandCave);
	if (flags[FlagEnum.UNLOCKED_JOJO_TRAINING] == 0 && flags[FlagEnum.TIMES_TALKED_WITH_JOJO] >= 4) addButton(7, "Training", apparantlyJojoDOESlift);
...
public jojoTalkVillage():void
{
	...
	Render.text("You decide to ask Jojo about his village.\n\n");
	Render.text("He speaks softly with a smile on his face and in his voice, “<i>It was a small village near a large beautiful lake. We were peaceful people who laughed and trusted one another, just good simple folk you know?”\n\n");
	Render.text("“Most of the people of Belridge were either fishers or farmers with huge families that stayed near the village. There were a few hunters and a few craftsmen. We made enemies of no one and sought to do no harm to others,</i>” Jojo says, his smile fading.\n\n");
	Render.text("Before you can muster a reaction to his sadness, his fuzzy cheeks spread again as he looks up at you with bright eyes.\n\n"); 
	Render.text("“<i>My father was a fisherman.  He was this calm, strong man with a lot of silver whiskers that always smelled like fish.  I remember I used to go out on the boat with him and a few of my brothers and he’d always make sure to pick me up and put me on his shoulders... that is until I got too big. He always made everything look so easy, like the world was just there to shake his hand and make him smile. No one could cook seafood like he did, no one.</i>”\n\n");
	Render.text("“<i>Then there was my mother who was a little high strung, but no one could hug you more fiercely or love you more dearly.  She was a small woman with a big soul who loved her family more than anything.  She was a seamstress before she met my dad and was always the brightest one in the room, which is hard when you have seventeen loud children clamoring for your attention.</i>”\n\n");
	Render.text("“<i>Even with 19 people living under one roof my family wasn’t the biggest family in town, but there was always plenty work and plenty food.  It was a nice simple existence and I am thankful for the time I had with everyone in that village,</i>” he finishes with a serene smile.\n\n");

	if (player.stats.cor < 40)
	{
		Render.text("Looks like Jojo's childhood wasn't so bad... you thank the mouse morph monk for sharing his treasured memories with you now that the conversation is over.\n\n");
	}
	else
	{
		Render.text("Looks like Jojo’s childhood wasn’t so bad. A little sickly sweet and void of wet pussies and drooling dicks but not bad. You tell him you’re happy to have him near you and he smiles for ear to ear, ignorant of your thoughts.\n\n");
	}
...
public jojoTalkYourOrigin():void // Prob tack on some interaction count or something to unlock this
{
	...
	Render.text("As you start up a conversation with Jojo, the two of you speak at length about nothing really important or noteworthy, just small talk.  That is until the monk brings up the subject of your background.  You tell him about Ingnam and your family there, and the tradition of sending a champion through the portal.  When he asks why anyone would choose to come here, you tell him how legends say that in years a champion wasn’t sent through the portal, terrible things happened to the village.\n\n");
	Render.text("“<i>That portal?</i>” Jojo asks, pointing to the very portal you stumbled through. You nod and he asks, “<i>So... what were you like in Ingnam?</i>”\n\n");

	if (player.perks.has("HistoryAlchemist"))
	{
		Render.text("You tell Jojo that you were the assistant to Riku, an alchemist residing in your village.  He asks questions about your time with the alchemist and how you family felt about you taking up alchemy.  You tell him that you were just about to go into advanced studies when it was announced that you were the next champion and all you really learned was how to increase the potency of certain types of items.\n\n");
	}
	else if (player.perks.has("HistoryFighter"))
	{
		Render.text("You tell Jojo about how, growing up, you got into fights a lot.  You name names and tell him why and how each of those little brats had got what was coming to them. You tell him how you had planned to join the village guard, but that became a pipe dream when it was announced that you were the next champion.\n\n");
	}
	else if (player.perks.has("HistoryHealer"))
	{
		Render.text("You tell Jojo about how you spent a lot of your time at the side of Dende, the village healer. You talk about why you wanted to spend time with the older man as he looked after the sick and infirm and the skills you learned there. You let him know how you had just decided to train to become an official healer when you were announced to be the next champion.\n\n");
	}
	else if (player.perks.has("HistoryReligious"))
	{
		Render.text("You tell Jojo about how you spent most of your time in the temple. He seems to really like hearing about the differences in religious practices between the Celestial Lotus and your village. You tell him about the various clergy of your hometown and how Sister Esther took time to teach you about meditation.\n\n");
	}
	else if (player.perks.has("HistoryScholar"))
	{
		Render.text("You tell Jojo about your insatiable thirst for knowledge and how you spent a lot of time in school. You tell him the story about how you ‘convinced’ Mr. ");
		if (kGAMECLASS.silly()) Render.text("Savin");
		else Render.text("Sellet");
		Render.text(" to let you read some of the rare books in his collection, skipping over how much begging and pleading was actually involved.\n\n");
	}
	else if (player.perks.has("HistorySlut"))
	{
		Render.text("You tell Jojo about how you spent time... making friends.  Jojo looks at you weirdly and when you tell him you had a lot of friends....\n\n");
		Render.text("“<i>That’s nice I guess [name] but didn’t you have aspirations beyond being, erm... popular?</i>” he questions.\n\n");
		Render.text("You laugh and tell him that you were just really good and making friends, instead of the truth about how much of a slut you actually were.\n\n");
	}
	else if (player.perks.has("HistorySlacker"))
	{
		Render.text("You tell Jojo about how you spent your time basically relaxing with your fiends.  You gloss over how big of a lazy bum you were with stories of the times you generally made a nuisance of yourself.  You don’t tell him that you’re pretty sure you were chosen as the next champion in order to be gotten rid of.\n\n");
	}
	else if (player.perks.has("HistorySmith"))
	{
		Render.text("You tell Jojo about how you spent your time training to become a blacksmith.  Not knowing much about smithing he asks questions about the things you learned and you answer them to the best of your ability.  To finish you describe the process of fitting armor in great detail and how you were going to start learning advanced techniques but were announced to be the next champion.\n\n");
	}
	else if (player.perks.has("HistoryWhore"))
	{
		Render.text("You tell Jojo about how you spent a lot of your time... making money.  When the naive little monk asks how, you just smile as you fondly remember the older whore, Poison, showing you the ropes and teaching the tricks of the trade.  Regardless of how it made people think of you, it was certainly good money.  In an attempt to hide some of the messier details of your past from the monk, you explain how you accepted... odd jobs for people, important work that not many others in the village would be willing to accept.  He seems confused but shrugs it off.\n\n");
	}
	else
	{
		Render.text("Somehow, you don’t seem to have a defined history perk... <b>Please report a bug!</b>\n\n");
	}

	Render.text("Jojo smiles now that he has gotten to know you a little better. After a little bit more small talk, the two of you decide the conversation is over and part ways.\n\n");
...
public jojoTalkFactory():void
{
	...
	Render.text("You tell Jojo about your having successfully found and stopped the demonic factory.  You tell him how you found out the factory was there and how you defeated the demons inside. He seems impressed.\n\n");

	if (player.statusAffects.has("FactoryOverload"))
	{
		Render.text("His ears perk at the news as you continue, telling him that you destroyed the factory controls, which permanently shut down the factory - but released an enormous quantity of corrupted fluids into the environment.\n\n");

		Render.text("Jojo cocks his head to the side as he considers his words carefully before speaking, “<i>I guess it seems like the right move.  Permanently disabling the factory would not only deal a heavy blow to the demons, but also give the rest of us time to reclaim the forest... but I don’t know.  If the release of fluids was as much as you say it was then there’s a chance that it’ll do more harm than good.  I’ve seen what corruption does to this world and that much corrupted fluid flooding out all at once could really hurt our cause. I’m not saying it was the wrong thing to do, or lessening your accomplishment, but you have to be careful.  The demons aren’t just powerful, they’re deceptive.</i>”\n\n");

		Render.text("You listen to the monk’s council and despite his concerns he seems genuinely happy to hear you’ve struck a blow against the demonic regime.\n\n");
	}
	else
	{
		Render.text("His ears perk at the news as you continue, telling him that you shut down the factory and destroyed the controls, for the sake of the surrounding environment.\n\n");
		Render.text("Jojo’s chest swells with pride as he looks at you with new eyes before saying, “<i>Wow [name], I don’t know what to say.  I know it uprooted your life and took you away from the ones you love but I sincerely believe that the day you came through that portal was a good day for all of Mareth.  I am proud of you and humbled by the fact that I can call you my friend.</i>”  He rises and gives you a hug of fierce devotion and friendly affection before pulling away and saying, “<i>We’ll have to watch the factory though... the demons can’t be allowed to reopen that evil place.</i>”\n\n");
	}

	Render.text("Once the two of you are done discussing the demonic factory Jojo excuses himself to think on what you’ve told him.\n\n");
...
public jojoTalkSandCave():void
{
	...
	{
		 Render.text("You describe your battle with the Sand Mother in an animated blow by blow. When you get to the end you tell him about how reasonable the Sand Mother actually was after you beat her.\n\n");
		 Render.text("Jojo’s head tils to the side as he says, “<i>Maybe the whole thing didn’t need to come to an altercation in the first place, a little diplomacy on both sides....</i>”  He gives you a pointed look, “<i>Might have gone a long way.</i>”\n\n");
	}
	//if PC just spoke to the Sand Mother
	else if (flags[FlagEnum.SAND_WITCHES_FRIENDLY] == 1 && flags[FlagEnum.SAND_MOTHER_DEFEATED] == 0)
	{
		Render.text("You tell Jojo about how the Sand Mother spoke with you once you had battled your way to her.  You tell him she was reasonable and how the whole thing was, in the end, a simple misunderstanding.\n\n"); 
		Render.text("He marvels at the way you handled the situation, “<i>Many would have expected her trying to talk to them to be a trap [name] and hurried to attack her but not you... that is... wow [name], you are truly a great individual.</i>”\n\n");
	}
	
	//[if {PC met bath slut} 
	if (flags[FlagEnum.MET_MILK_SLAVE] == 1)
	{
		Render.text("You tell Jojo about the poor mind addled thing you found sitting in a tub of milk acting as a slave to the sand witch coven.\n\n");
		Render.text("He shudders like a child being told a scary story and asks, “<i>What did you do?</i>”\n\n");
		...
		{
			Render.text("You tell Jojo about how the Sand Mother told you the bath girl was unfit to be free and how they care for her because she can’t care for herself.\n\n");
			Render.text("Jojo reacts by putting his chin in his hands and thinking, “<i>Well... I guess that’s the human thing to do, especially since she doesn’t seem to be corrupted.  Maybe these sand witch covens aren’t all bad, still hard to believe that they’re on our side though....</i>”  He looks up and shrugs, “<i>Any act of charity though is a good thing.  I do hope the poor girl will be alright.</i>”\n\n");
		}
		// [if {PC has bath slut in camp}
		else if (flags[FlagEnum.MILK_NAME] is String)
		{
			Render.text("As the question leaves his lips you give Jojo a confused look and, with a glance, direct his gaze toward " + flags[FlagEnum.MILK_NAME] + ".\n\n");
			Render.text("He slaps his own forehead and says, “<i>Oh... yeah... right.</i>” Obviously embarrassed by not putting two and two together. He smiles good naturedly though, “<i>I don’t know I guess I just assumed you found some poor mind addled soul and decided to save her.</i>” Jojo says as he looks over at " + flags[FlagEnum.MILK_NAME] + ".\n\n");

			//[if (bathSlutStage1 - unaltered)
			if (flags[FlagEnum.MILK_SIZE] == 0)
			{ 
				Render.text("“<i>She’ll fare much better in our care than in the coven’s,</i>” he states with conviction.\n\n");
			}
			//[if (bathSlutStage2 - HHH) 
			else if (flags[FlagEnum.MILK_SIZE] == 1)
			{
				Render.text("“<i>She’s already much better than she was when she got here,</i>” he says with a grin.\n\n");
			}
			//[if (bathSlutStage3 - DD) 
			else
			{
				Render.text("“<i>The coven wouldn’t have done what you’ve done for her.  You’ve given her a much, much better life and even aided in fixing her condition, you truly are a champion, [name],</i>” he says, giving you a fond smile and a pat on the back.\n\n");
			}
		}	
	}
	...
	{
		Render.text("You tell Jojo about the cum witch, the herm witch responsible for inseminating the witches there, acting as a father to the others.  When you do he scratches his ear, “<i>Like I said, I don’t get why sex is so overly important to these creatures but whatever, continue.</i>”\n\n");

		//[if {PC allowed Cum Witches to increase their numbers}
		if (flags[FlagEnum.MORE_CUM_WITCHES] == 1)
		{
			Render.text("You tell him how you tried to remedy the current cum witch’s situation by asking the Sand Mother to make more cum witches.\n\n");
			Render.text("He whistles low, “<i>That’s a bold move [name].  It seems like they would want that though, it’d allow them to, er, you know... more often, and make more sand witches in the long run wouldn’t it?</i>” As the question sound rhetorical you plow on ahead.\n\n");
		}
		//[if {PC allowed Cum Witches to rome}
		else if (flags[FlagEnum.CUM_WITCHES_FIGHTABLE] == 1)
		{
			Render.text("You describe to him how you convinced the Sand Mother to allow her cum witches to rome the desert along with the sand witches and he looks at you with astonishment, “<i>You are a generous spirit [name] and this Sand Mother doesn’t seem entirely unreasonable.</i>”\n\n");
		}
		//[if {PC did nothing to help Cum Witch} 
		else
		{
			Render.text("“You tell Jojo that you’re actually done. He says, “<i>Oh... well that’s weird.</i>” and after an awkward silence, the two of you burst out laughing.\n\n");
		}
	}

	Render.text("Having concluded the conversation the two of you stand and Jojo gives you an appreciative pat on the shoulder, seeming more fond of you.\n\n");
...
public apparantlyJojoDOESlift():void
{
	...
	if (flags[FlagEnum.UNLOCKED_JOJO_TRAINING] == 0)
	{
		...
		{
			Render.text("Jojo smiles, “<i>I am not a master, therefore I am unworthy of taking you on as a disciple... but as a friend I can teach you all I know.  Whenever you are ready, just ask.</i>.”\n\n");
	...
	else
	{
		...
		{
			Render.text("You ask the monk to continue your training; but he shakes his head.\n\n");
			Render.text("“<i>Not yet [name]. Your body must be fit and rested before our training sessions. Rest first, and come back to me later.</i>”\n\n");
		...
		{
			Render.text("You ask the monk to continue your training; but he shakes his head.\n\n");
			Render.text("“<i>I fear that your time would be better spend meditating before we continue your training. Would you like to do so now?</i>”\n\n");
	...
	{
		Render.text("Jojo gives you a bright cheerful smile, “<i>Alright [name]... let’s begin.</i>”\n\n");
		Render.text("Jojo’s teaching style periodically switches between lecture and sparring.  When he explains a concept or a strike, he guides you through it before asking you to try it on him. He is patient but firm.  He doesn’t punish you when you make a mistake, instead, corrects you and asks you to try again.  He doesn’t allow you to give up, and his teaching style stops you from feeling frustrated.\n\n");
		Render.text("The entire session is intense, and each brief lecture or demonstration serves as a quick break to stop your body from giving out, and help you build endurance.\n\n");
		Render.text("By the end of the training session you are covered in sweat, your lungs heaving for breath.\n\n");
		Render.text("As you bow to Jojo he bows back and says, “<i>Go get some rest [name], you’ve earned it.</i>”\n\n");
		...
		if (flags[FlagEnum.TIMES_TRAINED_WITH_JOJO] == 5)
		{
			...
			Render.text("“<i>Breathing is key.</i>”\n\n");
			Render.text("Jojo’s constantly repeated words resonate within you as you realize you’ve learned to control your breathing. It takes you less time to rest than normal and you feel as though you are bursting with energy because of it.  Your [fullChest]");
			if (player.upperBody.chest.BreastRatingLargest[0].breastRating == 0) Render.text(" rises and falls");
			else Render.text(" rise and fall");
			Render.text(" smoothly even in the heat of battle.  From now on you know you’ll recover more quickly.\n\n");

			Render.text("<b>(Perk Gained: Controlled Breath -</b> Increases rate of fatigue regeneration by 10%<b>)</b>");
	...
	{
		Render.text("Jojo gives you a big toothy grin, “<i>Alright [name]... let’s begin.</i>”\n\n");
		Render.text("Jojo switches up the way he is instructing you.  Largely due to your increased endurance, the two of you spend more time moving through forms together and practicing strikes and maneuvers.  When it comes time for a brief lecture, he breaks out one of the few scrolls he has from his order and tells you what he knows about the contents.\n\n");
		Render.text("Before too long, the two of you are up again and practicing forms and mock strikes, even sparring briefly from time to time.  By the end of the intense training session you are covered in sweat... but so is Jojo, and neither of you are out of breath. As you bow to Jojo he returns the gesture and says, “<i>Go get some rest [name], you’ve earned it.</i>”\n\n");
		...
		if (flags[FlagEnum.TIMES_TRAINED_WITH_JOJO] == 10)
		{
			...
			Render.text("The repeated movements are slowly starting to sink in, your muscles becoming accustomed to Jojo’s training.\n\n");
			Render.text("By the end of the training session with the mouse, you think that you may have picked up something that might help against the denizens of this world.\n\n");

			Render.text("<b>(Ability Gained: Cleansing Palm -</b> A ranged fighting technique of Jojo’s order, allows you to blast your enemies with waves of pure spiritual energy, weakening them and hurting the corrupt.<b>)</b>")
	...
	{
		Render.text("Jojo gives you a big smile brimming with pride, “<i>Alright [Name]... let’s begin.</i>”\n\n");
		Render.text("Largely due to your increased endurance and improved technique the two of you spend more time sparring and dancing through the forms Jojo knows.  When it comes time for a brief lecture, Jojo pants as he sits with you, taking a minute to regain his breath.  Jojo’s lectures, instead of dealing with how to strike and defend oneself, deal with the nature of the soul.  You learn much about individuality, willpower and determination and after the lecture the two of you meditate on what you’ve learned for a few silent moments.\n\n");
		Render.text("Then the two of you are back up, sweeping gracefully through forms and striking invisible enemies with fierce blows.  By the end of the intense training session both you and Jojo are tired, having trained to both of your limits.\n\n");
		Render.text("As the two of you give each other decidedly shaky bows, Jojo says, “<i>Great effort [name], you are... wow... I need a rest. I’ve earned it.</i>”  The two of you share a laugh and end you training.\n\n");
		...
		if (flags[FlagEnum.TIMES_TRAINED_WITH_JOJO] >= 16 && player.stats.int >= 70)
		{
			...
			Render.text("As you finish training you decide to meditate alone; returning to your bedroll, you close your eyes and begin to breathe.  Then the world around you begins to sing.\n\n");
			Render.text("The camp is alive with the sounds of voices on the wind, of the ominous sizzling of the great scar between worlds that is the portal that brought you here.  You feel open to the universe as if it were a lady in a dress sitting next to you, that you could easily reach out and touch.  You feel liberated and free despite the fact that you are not moving a muscle.  You are ready for anything but expecting nothing.  You are neither thinking nor dreaming, you simply are.\n\n");

			Render.text("<b>(Perk Gained: Enlightened -</b> White magic threshold reduced. Meditation restores health. Grants the ability to meditate alone.<b>)</b>");
	...
	else
	{
		...
		Render.text(enlightenedBlurbs[rand(enlightenedBlurbs.length)] + "\n\n");
	}
