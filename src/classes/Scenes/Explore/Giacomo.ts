	...
	public class Giacomo extends BaseContent implements TimeAwareInterface {
		...
		public timeChange():boolean
		{
			...
			if (model.time.hours > 23) {
				if (flags[FlagEnum.CERULEAN_POTION_BAD_END_FUTA_COUNTER] > 0) flags[FlagEnum.CERULEAN_POTION_BAD_END_FUTA_COUNTER] -= 0.5; //Reduce bad-end for cerulean herms number
			}
			return false;
		}
		...
		public giacomoEncounter():void {
			...
			else if (player.findStatusAffect(StatusAffects.WormOffer) < 0 && player.statusAffects.has("Infested")) { //If infested && no worm offer yet
		...
		private bookMenu():void {
			...
			simpleChoices("Dangerous Plants", pitchDangerousPlantsBook, "Traveler's Guide", pitchTravellersGuide, "Hentai Comic", pitchHentaiComic,
				"Yoga Guide", (flags[FlagEnum.COTTON_UNUSUAL_YOGA_BOOK_TRACKER] > 0 ? pitchYogaGuide : null), "Back", giacomoEncounter);
			statScreenRefresh();
		}
		...
		private nightSuccubiRepeat():void {
			...
			if(player.gender == 1) {
				if(player.stats.cor < 66) {
					...
					if(player.isTaur()) MainScreen.text(" crouch between your legs and impale herself on your " + cockDescript(0) + " with a wet sound caused by her well-lubricated vulva. Y", false);
					else MainScreen.text(" open her womb and quickly consume your " + cockDescript(0) + ". She embraces you, entrapping your head in her cleavage as y", false);
					MainScreen.text("ou quickly feel her superhuman vaginal muscles work and stroke your " + cockDescript(0) + " better than any human woman or pair of hands could ever hope to accomplish. You are helpless as your unholy embrace milks the both of you in an infernal symphony of debauchery. The familiar cramp of an impending ejaculation grips you and your twitching signals the succubus of your approaching climax.\n\n", false);
					if(player.isTaur()) MainScreen.text("Pushing on your forelegs, she engulfs even more of your " + cockDescript(0), false);
					...
					if(player.isTaur()) MainScreen.text("arches under your belly as you feel your " + cockDescript(0) + " bending pleasurably inside her, and", false);
					...
					MainScreen.text(" her contractions milking your " + cockDescript(0) + " as fiercely as a maid milks a cow! Another torrent of cum pushes its way out of your body and you let out a moan of pleasure and exhaustion.\n\n", false);
					...
					if(player.isTaur()) MainScreen.text("flanks", false);
					...
					if(player.isTaur()) MainScreen.text("pushes on your forelegs, impaling herself even deeper on your " + cockDescript(0), false);
					...
					if(player.isTaur()) MainScreen.text("She moans inhumanly, and reflexively digs her claws into your forelegs. Searing with lust, the pain means little to you as you only feel the sensation of your body forcing your fluids out of your body and into hers. You press your " + cockDescript(0) + " into her", false);
				...
				if(flags[FlagEnum.CERULEAN_POTION_BAD_END_FUTA_COUNTER] > 10 && player.stats.cor > 50) {
					...
					if(player.horseScore() + player.dogScore() + player.nagaScore() + player.goblinScore() + player.sharkScore() + player.minoScore() + player.cowScore() > 5) MainScreen.text("  All of the other corruptions and changes to your body have faded away as your new form has taken shape.", false);
					...
					flags[FlagEnum.UNKNOWN_FLAG_NUMBER_00111]++;
					flags[FlagEnum.CERULEAN_POTION_BAD_END_FUTA_COUNTER]++;
					...
					if(flags[FlagEnum.CERULEAN_POTION_BAD_END_FUTA_COUNTER] > 10) {
