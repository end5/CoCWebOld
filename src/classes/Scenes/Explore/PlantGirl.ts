...
export default class PlantGirl {
    ...
    public encounterPlantWoman(): void {
        ...
        if (flags[FlagEnum.TIMES_MET_PLANTGIRL] == 0) {
    ...
    public escapeFromPlantWomanAndDeclineSex(): void {
        ...
        //Failure to persuade/intimidate (SD 1.1f)
            ...
            if (!player.isTaur()) MainScreen.text("leap");
    ...
    public fuckMyAssPlantLadyWhileImTrapped(): void {
        ...
        else if (player.lowerBody.vaginaSpot.hasVagina()) MainScreen.text("your " + clitDescript());
...
shudder from the sensation of your [asshole]'s tightness.  Once the floral creature regains her composure, she begins to pump in and out of your ass at a gradually faster pace.");
	//PC asshole is loose:  
        ...
        if (player.shortestCockLength() < 48) {
            ...
            MainScreen.text(cockDescript(player.shortestCockIndex()) + " flap");
            ...
            MainScreen.text(".  The creature twists and jerks at the head of your cock and works diligently to stimulate your rock hard " + multiCockDescriptLight() + ", intent on making you moan out for her.");
        }
        //PC has a vagina: 
        ...
        if (player.lowerBody.balls == 0) MainScreen.text(nippleDescript(0));
        ...
        if (player.hairLength > 0) MainScreen.text("grabs you by the hair");
    ...
    public trappedFlowerSexBlowjobAhoy(): void {
        ...
        //(If PC has a cock(s): 
        else if (player.lowerBody.cockSpot.hasCock()) MainScreen.text("wrap themselves around your " + multiCockDescriptLight() + " and begin to squeeze");
        //(If PC has a pussy: 
        else if (player.lowerBody.vaginaSpot.hasVagina()) MainScreen.text("take hold of you clitDescript() and tug hard");
        //(If PC is genderless: 
    ...
    public trappedPlantSexPussy(): void {
        MainScreen.clearText();
        MainScreen.text("Staring down at your " + multiCockDescriptLight() + ", the plant woman's eyes become fixated and betray a sense of longing, of curiosity, and eagerness.  Approaching your well restrained body, she takes [oneCock] into her soft hand and brushes it's sensitive head against her smooth pelvis, fairly close to the creature's moist and sweet smelling pussy.  Proceeding to wrap its arms around you, the plant woman takes [oneCock] in-between her legs and against her clit, signaling the creature's intent to plunge its hungry cunt down on your dick.");
    ...
    public trappedPlantSexPussyGOOO(): void {
        ...
        if (player.lowerBody.cockSpot.list[x].cockLength < 4) {
            ...
            player.lowerBody.cockSpot.list[x].cockLength += 7;
        }
        //(if > 4 inches) 
	...
	//(If height is 36 inches to 72 inches: 
        ...
        MainScreen.text(" as she slowly begins to work her hips, grinding the innards of her hot and moist sex against your " + cockDescript(x) + ".");
        //(if one cock:
        ...
        //Vagina: 
        if (player.lowerBody.vaginaSpot.hasVagina()) MainScreen.text("  Cumming hard, your " + clitDescript() + " releases a liberal stream of juices down the vine that fucks you, dissolving into the appendage as you moan in furious release.");
    ...
    public trappedPlantSexBlowMe(): void {
        ...
        if (player.longestCockLength() < 24) {
            ...
            MainScreen.text(multiCockDescriptLight() + " stare");
            if (player.lowerBody.cockSpot.count() == 1) MainScreen.text("s");
            ...
            MainScreen.text(" that will be tending to them today.  Eager to rise to said challenge, the plant woman attempts to take your " + multiCockDescriptLight() + " into her mouth and ");
            ...
            if (player.lowerBody.cockSpot.count() == 1) MainScreen.text(".");
                ...
                MainScreen.text(", while she cheek fucks the remainder of your " + multiCockDescriptLight() + ".");
            }
    ...
    public plantAnalGivingTheDick(): void {
        MainScreen.clearText();
        MainScreen.text("The sight of this nice, ample ass and the thought of fucking a supple  little pucker piques your " + multiCockDescriptLight() + ", causing ");
        if (player.lowerBody.cockSpot.count() == 1) MainScreen.text("it");
        else MainScreen.text("them");
        ...
        MainScreen.text(" will hopefully penetrate is a winner in the tightness department, your " + multiCockDescriptLight() + " surge");
        if (player.lowerBody.cockSpot.count() > 1) MainScreen.text("s");
    ...
    public failStruggle69(): void {
        ...
        else MainScreen.text(assholeDescript() + " as she dives nose first into the under crevice of your " + buttDescript() + ", rubbing the bridge of it between your cheeks as she giggles");
        MainScreen.text(".");
    ...
    public struggle69Plant(pt: number = 1): void {
        ...
        if (pt == 2) {
            ...
            //PC pussy chosen:
            if (target == 2) MainScreen.text(", allowing her soft lips to surround your " + clitDescript() + ", 'trapping' it for her much anticipated assault.");
            //PC cock chosen: 
            else MainScreen.text(".  Wasting no time with 'formalities,' she stuffs your " + cockDescript(0) + " into her mouth, firmly sealing her lips around your shaft and suckling along the sensitive flesh of your glans.");
        }
        //[69!, TsI: 1.6a, give her oral] 
            ...
            //PC cock chosen: 
            else MainScreen.text(" as she wastes no time with 'formalities,' stuffing your " + cockDescript(0) + " into her mouth, firmly sealing her lips around your shaft and suckling along the sensitive flesh of your glans.");
        }
    ...
    public struggleFailPlantPussyFuckNoWay(): void {
        ...
        //PC is virgin: 
        if (player.vaginas[0].virgin) MainScreen.text("want to protect your chastity, or you ");
    ...
    public defeatOrDomPlantAndCuntFuck(): void {
        ...
        if (player.lowerBody.balls == 0) MainScreen.text(multiCockDescriptLight());
        ...
        if (player.lowerBody.vaginaSpot.hasVagina()) MainScreen.text("; your vaginaDescript(0) quivers with the need for release, letting loose with its own torrent of lady fluids as you moan in orgasm");
    ...
    public victoryDefeatPlantGirlGetBJDARKVADER(): void {
        MainScreen.clearText();
        MainScreen.text("Your " + multiCockDescriptLight() + " become");
        if (player.lowerBody.cockSpot.count() == 1) MainScreen.text("s");
    ...
    public victoryDefeatPlantGirlGetBJMainSCREENON(): void {
        ...
        //______________________________________________________________________________
        //(if Non-goo: 
        if (!player.isGoo()) MainScreen.text(".  She pulls your dick out of her mouth and closes her eyes as she gets ready to catch the rest of your load with her mouth.  Thick globs of semen erupt from your multiCockDescriptLight() and strike her in the face.  She herself orgasms as your torrent of semen washes over her head and chest, covering both liberally.");
        //(If goo: 
    ...
    public plantGirlPCWinGetTentacleBJ(): void {
        ...
        if (player.lowerBody.cockSpot.list[x].cockLength < 48) {
		...
		else MainScreen.text(nippleDescript(0));
            MainScreen.text(" and begins to squeeze tighter and tighter.  “Owww! Owww! Okay, Okay! I get it!” you cry out as you once again ram your " + cockDescript(x) + " down her throat.  The plant woman responds by massaging your ");
            if (player.lowerBody.balls > 0) MainScreen.text("balls");
        ...
        //[If tentacle cock is longer than 48 inches]
            ...
            if (player.lowerBody.balls > 0 || player.lowerBody.vaginaSpot.hasVagina()) {
                ...
                else MainScreen.text(vaginaDescript(0) + " slithers");
    ...
    public beatPlantGirlDomLetsFuckAnal(): void {
        ...
        //(Dominant Let's Fuck! (giving anal) D 1.3
            ...
            //First time: 
            if (flags[FlagEnum.TIMES_FUCKED_PLANTGIRLS_ASS] == 0) {
        ...
        flags[FlagEnum.TIMES_FUCKED_PLANTGIRLS_ASS]++;
    }
    ...
    public defeatPlantgirlBlowAndButtfuckCorrupt(): void {
        MainScreen.clearText();
        if (flags[FlagEnum.TIMES_GOT_CORRUPT_BJ_ANAL_PLANTGIRL_SCENE] >= 2) {
        ...
        flags[FlagEnum.TIMES_GOT_CORRUPT_BJ_ANAL_PLANTGIRL_SCENE]++;
    ...
    public defeatPlantgirlBlowAndButtfuckPure(): void {
        ...
        if (player.isNaga()) MainScreen.text("now exposed ");
        MainScreen.text(clitDescript() + ".  The plant woman yelps in surprise as the vine makes contact with your labia, causing you to jump a little.  You turn to face the plant woman, who is blushing profusely and resting her hand on her pussy.  Looking at the vegetation, you deduce that she must be able to feel you along her vines and that these creepers may also function as penile appendages.  A grin spreads across your face as the realization hits you, and you bring the vine back to your sex and tease your vulva.  Soft moans escape the plant girl as the head of the perverted vegetation brushes past your clit, and you ");
        //(pure: 
        if (player.stats.cor < 50) MainScreen.text("giggle");
        //Corrupted: 
        else MainScreen.text("smirk");
        MainScreen.text(" at the woman's predicament.  Deciding to stop teasing the poor girl, you take the head of the creeper and push it into your pussy, edging it upwards at a gradual pace so that your partner can feel the contours of your " + vaginaDescript(0) + ".");
