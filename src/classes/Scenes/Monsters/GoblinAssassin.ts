export default class GoblinAssassin extends Monster {
	protected goblinDrugAttack(): void {
		...
		if (color != "blue") {
			MainScreen.text(capitalA + short + " uncorks a glass bottle full of " + color + " fluid and swings her arm, flinging a wave of fluid at you.", false);
		}
		//Drink blue pots
		else {
	...
	protected lustNeedle(): void {
		MainScreen.text("With a swift step, the assassin vanishes, her movements too quick for you to follow. You take a sharp breath as you feel her ample thighs clench your head in between them, her slick cunt in full view as you take in her scent.");
		//Miss
	...
	protected dualShot(): void {
		...
		//Hit: 
			...
			let damage: number = int((str + weaponAttack + 40) - rand(player.stats.tou) - player.armorDef);
	...
	protected goblinExplosion(): void {
		MainScreen.text("Without a second thought, the assassin pulls a thin needle from the belt wrapped around her chest and strikes it against the ground, causing a flame to erupt on the tip. She twirls forward, launching the needle in your direction which subsequently bursts apart and showers you with heat.");
	...
	public won(hpVictory: boolean, pcCameWorms: boolean): void {
		if (player.gender == 0) {
			MainScreen.text("You collapse in front of the goblin, too wounded to fight.  She growls and kicks you in the head, making your vision swim. As your sight fades, you hear her murmur, \"<i>Fucking dicks can't even bother to grow a dick or cunt.</i>\"", false);
	...
	public GoblinAssassin(noInit: boolean = false) {
		...
		this.statusAffects.add(new StatusAffect("BonusVCapacity", 90, 0, 0, 0)));
		...
		this.upperBody.head.hairColor = "blue";
		this.upperBody.head.hairLength = 7;
