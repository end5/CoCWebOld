package classes.Scenes.Places.Farm
{
	...
	public class FarmCorruption extends AbstractFarmContent
	{
		...
		protected takeoverPromptKelly():void
		{
			...
			{
				MainScreen.text(" and the rodent slut");
				if (kGAMECLASS.amilyScene.amilyCorrupt() && kGAMECLASS.jojoScene.campCorruptJojo())
				{
					MainScreen.text("s");
				}
				MainScreen.text(" before him");
			}
			MainScreen.text("?");
		}
		...
		protected takeoverPromptMerge(firstTime:boolean = false):void
		{
			...
			else
			{
				...
				MainScreen.text("Again, you find yourself standing on the bluff overlooking the farm, and you feel yourself filled with unholy rage at the woman below who stands against you and your plans for this piece of property. Do you put your plan into motion now or later?");
			}
		...
		public takeoverPromptNow():void
		{
			...
			MainScreen.text("You stride down to the farm and leap over a gate. You move casually, swaggering towards the pepper field with no obvious intent. When Whitney spots you and slowly stands up from her weeding, you raise your hand in friendly greeting"); 
			if (player.weaponName != "fists") MainScreen.text(", and to demonstrate your peacefulness, you theatrically hold up your [weapon] and then discard it with a careless swing of your arm.");
		...
		protected takeoverPromptLater():void
		{
			...
			MainScreen.text("You stare for a moment longer, then turn and head back to camp. You will show mercy she does not deserve... for now.");
		...
		public rootScene():void
		{
			...
			{
				MainScreen.text("You stand on your rise and take in your slave farm. ");
				if (silly())
				{
		...
		private keltAChangeInManagement():void
		{
			...
			MainScreen.text("“<i>Hear there’s been a change in management,</i>” says Kelt, clopping to a halt in front of you. You confirm that that is the case. The big centaur looks at you thoughtfully. There’s something different in his dark eyes and rugged scowl than his usual wearied contempt. Grudging admiration?");

			MainScreen.text("“<i>Find it difficult to believe someone like you could put a bitch in her place,</i>” he says eventually. “<i>Perhaps you’ve got bigger balls than I thought you had."); 
			if (player.lowerBody.balls == 0) MainScreen.text(" So to speak, anyway.");
			MainScreen.text("</i>” He snorts, and trots towards the butts. “<i>Just don’t expect me to treat you any different. As long as you’re getting free instruction from me, I’m the master and you’re the whelp. Got that?</i>”");
			...
			MainScreen.text("“<i>Do I look like I want or need your sloppy seconds? Godsdamn, I can only imagine what kind of pathetic creatures would have </i>you<i> lording it over them. What a joke! Now, are we going to go watch you fail miserably to hit a target from five yards or what?</i>”");
		...
		private dogeNotCorruptYet():void
		{
			...
			if (whitneyCorruption() >= 31 && whitneyCorruption() <= 60)
			{
				...
				{
					// Subsequent 31-60: 
					MainScreen.text("Whitney puts down her work as you stride towards her, resigned unhappiness in her expression.");
			...
			if (whitneyCorruption() >= 61 && whitneyCorruption() <= 90)
			{
				...
				{
					// 61-90 Subsequent: 
					MainScreen.text("Whitney puts down her work and smiles at you vaguely as you approach her. You again sense that queasy mixture of anxiety, unhappiness and excitement in her jerky, cramped movements and expression.");
			...
			if (whitneyCorruption() >= 91 && whitneyCorruption() <= 119)
			{
				...
				{
					// Subsequent 91-119: 
					MainScreen.text("Whitney lays down her work eagerly as you approach. ");
		...
		private whitneyAppearanceCorrupt():void
		{
			...
			MainScreen.text("Whitney is a 5’8” dog");
			if (whitneyDefurred()) MainScreen.text("-girl. Her human transformation has rendered her pretty in a delicate, diffident kind of way.");
			else MainScreen.text("-morph. Her muzzle is suggestive of a golden retriever but really she could be any breed.");
			if (whitneyMaxedOralTraining()) MainScreen.text(" In sharp contrast to her otherwise fairly thin features, her lips are plump and a depthless black, shining like wet tar. She constantly moves her tongue over them unconsciously.");
			MainScreen.text(" Although she continues to dress in the same modest cotton blouses and long skirts she always has, complete with holes cut in to allow her short, perky tail to poke through, the cut of it and the way she moves and swings herself about, livid with arousal and near-constant sexual frustration, makes the demure outfit more perverse than anything a demon could dream up.\n");
		...
		private prosperityGoNotCorrupt():void
		{
			...
			MainScreen.text("You ask her how the help is coming on.");
		...
		private investmentBreastMilker():void
		{
			...
			if (!whitneyCorrupt())
			{
				MainScreen.text("You say you’d like a breast milker installed, one that you could make use of. Whitney frowns, but doesn’t seem as thrown by this idea as you expected.");
			...
			{
				MainScreen.text("You say you’d like a breast milker installed, one that you could make use of. Whitney lets her gaze sink down to your [chest].");
		...
		private doBreastMilkerInvestment():void
		{
			...
			MainScreen.text("You silently hand over a hefty bag of gems. Whitney stows it away.");
		...
		private investmentCockMilker():void
		{
			...
			if (!whitneyCorrupt())
			{
				MainScreen.text("You say you’d like a semen extractor built, one that you could make use of. Whitney frowns, but doesn’t seem as thrown by this idea as you expected.");
			...
			{
				MainScreen.text("You say you’d like a semen extractor built, one that you could make use of. Whitney bites her lip at the implication.");
		...
		private investmentRefinery():void
		{
			...
			if (!whitneyCorrupt())
			{
				MainScreen.text("You say you want a machine built that could concentrate the fluids your followers produce into actual transformatives. Whitney shudders, but is in no position to argue.");
			...
			{
				MainScreen.text("You say you want a machine built that could concentrate the fluids your followers produce into actual transformatives.");
		...
		private investmentContraceptive():void
		{
			...
			if (!whitneyCorrupt())
			{
				MainScreen.text("You ask Whitney if she knows of any natural contraceptive that grows in Mareth.");
		...
		private doContraceptiveInvestment():void
		{
			...
			if (!whitneyCorrupt())
			{
				MainScreen.text("You hand over the dough. Whitney stows it away.");
		...
		private investmentMilktank():void
		{
			...
			if (!whitneyCorrupt())
			{
				...
				{
					MainScreen.text("You tell Whitney you want her to build a swimming tank at the farm, then come to your camp, take away your expensively acquired milk slave and install her in it. The dog woman slowly absorbs this.");
		...
		private doMilktankInvestment():void
		{
			...
			if (!whitneyCorrupt()) MainScreen.text("You press the gems into your taskmaster’s hand, turn and leave without another word. Your thoughts turn to huge, delightfully plush brown boobs and luxurious milky baths; it will be well worth it. ");
		...
		private turnDownInvestment(money:boolean = false):void
		{
			...
			{
				// Any “No” option:
				MainScreen.text("Whitney shrugs, nonplussed.");

				if (money) MainScreen.text("\n\n“<i>Come back with the money.</i>”");
				else MainScreen.text("\n\n“<i>Come back if you change your mind. With the money.</i>”");
			}
			else
			{
				MainScreen.text("Whitney shrugs with a simper. ");
		...
		private deFurDoge():void
		{
			...
			MainScreen.text("You put away the gem and move into Whitney, holding her gaze as you gently place your finger and thumb along her jaw line. She doesn’t pull away and lets out a shuddering sigh as you touch her.");
		...
		private dontDeFurDoge():void
		{
			...
			if (player.lowerBody.cockSpot.hasCock()) MainScreen.text(" crotch into");
			else MainScreen.text(" hips against");
			MainScreen.text(" her firm ass and she moans, her breath starting to come in shallow gulps, her heart beating furiously against your skin. Although you keep hold of her you don’t have to do anything to make the hatchet rise again.");
		...
		private makeDogeSubby():void
		{
			...
			MainScreen.text("You again retrieve your gem, and once more begin to rhythmically turn it; this time, however, you walk steadily towards Whitney, your voice getting louder in her ears and the shining light in her unfocused eyes getting brighter as you go on.");
		...
		private makeDogeDommy():void
		{
			...
			MainScreen.text("You again retrieve your gem, and once more begin to rhythmically turn it. This time, however, you walk steadily towards Whitney, your voice getting louder in her ears, the shining light in her unfocused eyes getting brighter as you go on.");
		...
		private dogeCorruptedMissionComplete(output:boolean = true):void
		{
			...
			{
				MainScreen.text("Whitney is in front of you before you’ve finished calling her name.");
			...
			{
				MainScreen.text("Whitney is knelt in front of you before you’ve finished calling her name. Her tail wags as her soulful brown eyes look up at you, lit up with depthless lust.");
		...
		private firstOralTraining():void
		{
			...
			MainScreen.text(". You tell her huskily it’s time she learned how to service you.");
			...
			if (player.lowerBody.cockSpot.hasCock()) MainScreen.text(" cocksucker");
			else MainScreen.text(" pussy eater");
			...
			if (silly()) MainScreen.text(" “<i>Do. Or do not. There is no try.</i>”");
			else MainScreen.text(" “<i>You will.</i>”");
			MainScreen.text(" Determination lines the dog woman’s mouth.");
		...
		private cockOralTrainingStageOne():void
		{
			...
			if (player.biggestCockLength() > 12) MainScreen.text(" She still struggles a bit with her gag reflex but it only takes her a few tries to swallow your thick prick, allowing you to pump into the delightful tightness of her throat without issue.");
		...
		private firstCockOralTrainingStageTwo():void
		{
			...
			else if (!player.lowerBody.vaginaSpot.hasVagina() && player.lowerBody.balls > 0)
			{
				...
				if (player.cumQ() >= 1500) MainScreen.text(" which is no mean feat, given it feels like you’ve fucked what feels like a gallon of it down her gullet. Once you’re almost done, as ever you spurt the last few creamy ropes across her face and clothes");
				MainScreen.text(".");
				if (player.lowerBody.cockSpot.count() > 1) MainScreen.text(" The second cock trapped in her grasp flexes out cum just as eagerly as the first, sweat standing out on your forehead as you are clenched by your twin high; it paints her skirt with its generous discharge.");
			}
			//Male without balls:
			else if (!player.lowerBody.vaginaSpot.hasVagina() && player.lowerBody.balls == 0)
			{
			...
			if (!player.lowerBody.vaginaSpot.hasVagina())
			{
				...
				if (player.lowerBody.cockSpot.count() > 1) MainScreen.text(" and [cock biggest2]");
				MainScreen.text(". There’s an eagerness on display here which you don’t think was there before as she laps at your cock [headplural], and you think she even stifles a disappointed whine when she’s finished. Smiling softly, you get up, dress and send her on her way.");
			}
		...
		private cockOralTrainingStageTwo():void
		{
			...
			if (!player.lowerBody.vaginaSpot.hasVagina())
			{
				...
				if (player.lowerBody.cockSpot.count() > 1) MainScreen.text("She wraps her hand around your [cock biggest2] when she’s ready, giving it an experimental pump before beginning to softly and slowly work it, remembering exactly how to grip and bend its girth as she prepares for the main course.");
				...
				if (player.lowerBody.cockSpot.count() > 1) MainScreen.text("she occasionally forgets the length bulging in her hand so eager is she to push her lips further down your [cock biggest] and work at her own clit, and you need to murmur to get her to concentrate.");
				else MainScreen.text("she still occasionally forgets the length buried in her mouth, so eager is she to work keenly at her own clit, and you need to murmur to get her to concentrate.");
				MainScreen.text(" Nonetheless, the worshipful pleasure inundating your groin is close to masterful and you find yourself drifting away on it, closing your eyes and forgetting about instruction, lost entirely in the waves of your bitch’s soft, exact, ecstatic movements, her sighs and slurps filling your ears.");
				...
				if (player.lowerBody.cockSpot.count() == 1) MainScreen.text("Whitney cleans your [cock biggest] with her flat tongue, humming as she laps your oozing head clean, deliciously soothing your aching cock.");
				else MainScreen.text("Whitney cleans first your [cock biggest2] and then your [cock biggest] with her flat tongue, humming as she laps each of your oozing heads clean, deliciously soothing your aching cock.");
		...
		private firstCockOralTrainingStageThree():void
		{
			...
			if (!player.lowerBody.vaginaSpot.hasVagina())
			{
				...
				else
				{
					MainScreen.text("\n\n“<i>Put your hand here.</i>” Slowly she withdraws her fingers from her panties and wraps them around the base of your [cock biggest]. You sigh at the hot, damp pressure now ringing the very bottom of your saliva-glossed member. “<i>Work it right there... that’s it...</i>” You sigh as she swiftly picks up a steady beat");
						if (player.lowerBody.cockSpot.count() > 1) MainScreen.text(" jerking both your cocks with her smooth, exacting grasp in tandem");
						MainScreen.text(".");
				}
				...
				if (player.lowerBody.cockSpot.count() > 1)
				{
					MainScreen.text(" all the while your [cock biggest2]");
					if (player.lowerBody.cockSpot.count() > 2) MainScreen.text(" and [cock biggest3]");
					MainScreen.text(" bulge and vibrate with pleasure in her pumping hand");
					if (player.lowerBody.cockSpot.count() > 2) MainScreen.text("s");
				}
				MainScreen.text(". Though it would be so easy to lose yourself entirely to her expert movements you keep abreast it for now, holding a close eye on the dog woman kneeling in front of you, now entirely devoted to pleasuring you.");
				...
				if (player.lowerBody.cockSpot.count() > 1 || player.cumQ() >= 1500) MainScreen.text("\n\n");
				if (player.lowerBody.cockSpot.count() > 1)
				{
					MainScreen.text("She doesn’t forget the cock");
					if (player.lowerBody.cockSpot.count() > 2) MainScreen.text("s");
					MainScreen.text(" trapped in her grasp for a moment; she milks");
					if (player.lowerBody.cockSpot.count() > 2) MainScreen.text(" them");
					else MainScreen.text(" it");
					MainScreen.text(" as hard as you’re fucking her mouth, and");
					if (player.lowerBody.cockSpot.count() > 2) MainScreen.text(" they flex");
					else MainScreen.text(" it flexes");
					MainScreen.text(" out cum just as eagerly as the first, delirium seizing you as you are clenched by your");
					if (player.lowerBody.cockSpot.count() == 2) MainScreen.text(" twin");
					else if (player.lowerBody.cockSpot.count() == 3) MainScreen.text(" triple");
					else MainScreen.text(" transcendent");
					MainScreen.text(" high;")
					if (player.lowerBody.cockSpot.count() > 2) MainScreen.text(" they paint");
					else MainScreen.text(" it paints");
					MainScreen.text(" her skirt with")
					if (player.lowerBody.cockSpot.count() > 2) MainScreen.text(" their");
					else MainScreen.text(" its");
					MainScreen.text(" generous discharge. ");
				}
				if (player.cumQ() >= 1500)
				{
					MainScreen.text("Once you’re almost done, as ever you pull out and spurt the last few creamy ropes across her face and clothes. Red with her own huge high, the dog woman does her level best to catch them in her mouth.");
				}
			...
			if (player.biggestCockLength() < 8) MainScreen.text("the back of her mouth");
			else MainScreen.text("her gullet");
			MainScreen.text(" as you spear decisively inwards.");
			...
			MainScreen.text("\n\nOnce you have tensed your last you sigh beatifically and float high and formless on your post-blowjob haze. You close your eyes as, without any bidding, ");
			if (player.lowerBody.cockSpot.count() == 1) MainScreen.text("Whitney first cleans your [vagina] and then your [cock biggest] with her flat tongue, polishing your dripping pussy and thighs to a shine before lapping your oozing head clean, deliciously soothing your aching cock.");
			else MainScreen.text("Whitney uses her flat tongue to clean first your [vagina], polishing your dripping pussy and thighs to a shine, and then each of your pricks, lapping the oozing heads clean, deliciously soothing your aching cocks.");
			MainScreen.text(" She moans the low, blissed-out moan of an addict as she cleans you up, actually gently pumping your spent [prickplural] to make the last of it drool out. Gods... just these sounds and sensations, the gentle licking at your [cock biggest]’s tip and the little gasping exhale as she manages to coax a final drop onto her thirsty tongue, make you want to do it all over again... if only she hadn’t so adroitly drained you utterly. You pull her up before she makes your cock ache even more, pressing her firm, petite body into your [chest] and gaze proudly and complacently at your champion cocksucker.");
		...
		private cockOralTrainingStageThree():void
		{
			...
			if (player.lowerBody.cockSpot.count() >= 2) MainScreen.text(", allowing your other cock");
			if (player.lowerBody.cockSpot.count() > 2) MainScreen.text("s");
			if (player.lowerBody.cockSpot.count() >= 2) MainScreen.text(" to unfurl and bob behind it");
			if (player.lowerBody.vaginaSpot.hasVagina() && player.lowerBody.cockSpot.count() >= 2) MainScreen.text(" and");
			if (player.lowerBody.vaginaSpot.hasVagina()) MainScreen.text(", leisurely exposing your moist [vagina]");
			if (player.lowerBody.cockSpot.count() >= 2 && player.lowerBody.vaginaSpot.hasVagina()) MainScreen.text(" at the same time");
			MainScreen.text(", perfuming the air around her with your heavy musk.");
			...
			if (!player.lowerBody.vaginaSpot.hasVagina())
			{
				...
				if (player.lowerBody.cockSpot.count() > 2) MainScreen.text("Finally, she snakes her other hand around your [cock biggest3], rolling her wrist as she gently wrings it with the same sliding thoroughness.} You open your mouth to the shifting delectation inundating your overgrowth of cocks.");
				...
				if (player.lowerBody.balls > 0) MainScreen.text(", your saliva-glossed [balls] beating against her chin");
				MainScreen.text(". If there is one deficiency to her right now it is her fairly thin, pale lips. No cocksucking champion has lips like that - they need to be big, bee-stung, constantly wet with the movements of a needy tongue. Luscious whore pillows worthy of having your cock slide between them. You push these succulent, evil thoughts deep into your groin, deep into the heat building inexorably there. ");
				...
				if (player.lowerBody.cockSpot.count() > 1)
				{
					...
					MainScreen.text(" as hard as you’re fucking her mouth, and");
					if (player.lowerBody.cockSpot.count() == 2) MainScreen.text(" it flexes");
					else MainScreen.text(" they flex");
					MainScreen.text(" out cum just as eagerly as the first, delirium seizing you as you are clenched by your");
					if (player.lowerBody.cockSpot.count() == 2) MainScreen.text(" twin");
					else if (player.lowerBody.cockSpot.count() == 3) MainScreen.text(" triple");
					else MainScreen.text(" transcendent");
					MainScreen.text(" high;");
					if (player.lowerBody.cockSpot.count() == 2) MainScreen.text(" it paints");
					else MainScreen.text(" they paint");
					MainScreen.text(" her skirt with ");
					if (player.lowerBody.cockSpot.count() == 2) MainScreen.text(" its");
					else MainScreen.text(" their");
					MainScreen.text(" generous discharge. ");
				}
				MainScreen.text("She suddenly gasps in shock, and you quickly look down. Her lips look swollen, and they seem to be darkening.");
				...
				MainScreen.text(", first kissing your head deep and then lapping you close; she moans like a whore. She thrusts her ass in the air, sending her tongue pushing all around her new cock pillows with the taste of your cum, gently pumping your spent prick");
				if (player.lowerBody.cockSpot.count() > 1) MainScreen.text("s");
				MainScreen.text(" to make the last of it drool out.");
			...
			else if (player.lowerBody.vaginaSpot.hasVagina())
			{
				...
				if (player.lowerBody.cockSpot.count() > 1) MainScreen.text("As she bathes your [cock biggest] in delicious sensation she wraps her hand around your [cock biggest2], softening and then tightening her grip, sliding up and down its stem until it is every bit as rock-hard as the one she is lapping at. ");
				MainScreen.text(" You close your eyes as the pleasure inundating both your male and female sex twist around each other, a slow but brilliant chemical reaction consuming you from within.");
				...
				if (player.biggestCockLength() < 8) MainScreen.text("mouth");
				else MainScreen.text("throat");
				MainScreen.text(". With some effort you stay afloat and consider the dog woman as she whimpers in delight to you hammering into her juicy mouth");
				if (player.lowerBody.balls > 0) MainScreen.text(", your saliva-glossed [balls] beating against her chin");
				MainScreen.text(". If there is one deficiency to her right now it is her fairly thin, pale lips. No cocksucking champion has lips like that - they need to be big, bee-stung, constantly wet with the movements of a needy tongue. Luscious whore pillows worthy of having your cock slide between them. You push these succulent, evil thoughts deep into your groin, deep into the heat building inexorably there. ");
				...
				if (player.lowerBody.cockSpot.count() > 1)
				{
					MainScreen.text(" She doesn’t forget the cock trapped in her grasp for a moment; she milks it as hard as you’re fucking her mouth, and it flexes out cum just as eagerly as the first, delirium seizing you as you are clenched by your ");
					if (player.lowerBody.cockSpot.count() == 2) MainScreen.text("triple");
					else MainScreen.text("transcendent");
					MainScreen.text(" high; it paints her skirt with its generous discharge.");
				}
		...
		private cockOralTrainingMaxed():void
		{
			...
			if (!player.lowerBody.vaginaSpot.hasVagina())
			{
				...
				if (player.lowerBody.balls > 0) MainScreen.text("You sigh blissfully as her plump lips push into your [balls] before the flat, warm flannel-like tongue spreads itself across them, covering every inch, each sensitive orb first sensuously kissed and then taken into your slave’s mouth to be suckled gently until they are thrumming and bulging with packed heat. The loving attention laved on them is made all the better by the soft, lustful moans turning into outright panting sobs of pleasure drifting up from between your legs as she obsequiously polishes them.");

				MainScreen.text("\n\nShe rises until her head is level with your semi-erect prick and with long, careful, exquisite licks makes it fiercely erect, running her tongue along its full length and then swirling it around your head, pressing into the sensitive spots she knows will make you dense and tight with need. She grips it steadily at the base as she does so, every so often giving it a tight squeeze to contrast with a particularly soft lap at your bulging head.");
				if (player.lowerBody.cockSpot.count() > 1) MainScreen.text(" As she bathes your [cock biggest] in delicious sensation she wraps her hand around your [cock biggest2], softening and then tightening her grip, sliding up and down its stem until it is every bit as rock-hard as the one she is lapping at.");
				if (player.lowerBody.cockSpot.count() > 2) MainScreen.text(" Finally, she snakes her other hand around your [cock biggest3], rolling her wrist as she gently wrings it with the same sliding thoroughness.");
				MainScreen.text(" You open your mouth to the shifting delectation inundating [eachCock].");
				...
				if (player.lowerBody.cockSpot.count() > 1) MainScreen.text("In the long, delicious daze that follows you move her around");
				if (player.lowerBody.cockSpot.count() == 2) MainScreen.text(", switching her attention to your [cock biggest2] for a while");
				else if (player.lowerBody.cockSpot.count() >= 3) MainScreen.text(" switching her attention first to one cock and then the other");
				if (player.lowerBody.cockSpot.count() > 1) MainScreen.text(" so that each of your fiercely erect pricks has time to enjoy the tight, sucking embrace of her mouth.");
				...
				if (player.lowerBody.balls > 0) MainScreen.text(" and her tongue once again sliding across your [balls], ");
				MainScreen.text("before wrapping your hand through her silky hair and lifting her carefully but firmly all the way up, above your gleaming cock, at a height where she is just able to reach it with her tongue, telling her to cup her peachy breasts as you do. You enjoy the soft lapping at your beading head and the frustrated moans filling your ears at leisure, reveling in the sight of her, attempting to reconcile the memory of the calm, independent dog woman you once knew with the whimpering bitch dangling from your fist and creaming herself from worshiping your cock now.");

				MainScreen.text("\n\nYou let her go and she immediately impales herself back onto your length");
				if (player.lowerBody.cockSpot.count() > 1) MainScreen.text(", her hands wrapping back around your other cock");
				if (player.lowerBody.cockSpot.count() > 2) MainScreen.text("s");
				if (player.lowerBody.cockSpot.count() > 1) MainScreen.text(" as if they never left them");
				MainScreen.text(" pulling and kneading you now with real need. The drowning intensity of the pleasure inundating your maleness increases and you begin to pump upwards to an irresistible high, grasping her head and beginning to thrust deep into the tight suction of her "+ ((player.biggestCockLength() < 8) ? "mouth" : "throat") +".");
				...
				MainScreen.text(" Eventually you can give her no more and withdrawing you stumble back, stars swimming in your eyes from the force of it.");
			...
			else if (player.lowerBody.vaginaSpot.hasVagina())
			{
				...
				MainScreen.text("\n\nShe rises until her head is level with your semi-erect prick and with long, careful, exquisite licks makes it fiercely erect, running her tongue along its full length and then swirling it around your head, pressing into the sensitive spots she knows will make you dense and tight with need. She grips it steadily at the base as she does so, every so often giving it a tight squeeze to contrast with a particularly soft lap at your bulging head.");
				if (player.lowerBody.cockSpot.count() > 1) MainScreen.text(" As she bathes your [cock biggest] in delicious sensation she wraps her hand around your [cock biggest2], softening and then tightening her grip, sliding up and down its stem until it is every bit as rock-hard as the one she is lapping at.");
				MainScreen.text(" You open your mouth to the shifting delectation inundating both your male and female sex, her teasing digits moving with innate expertise to send twin pleasure twisting through you, a slow but brilliant chemical reaction consuming you from within.");
				...
				if (player.lowerBody.cockSpot.count() > 1) MainScreen.text(" In the long, delicious daze that follows you move her around");
				if (player.lowerBody.cockSpot.count() == 2) MainScreen.text(", switching her attention to your [cock biggest2] for a while");
				if (player.lowerBody.cockSpot.count() >= 3) MainScreen.text(", switching her first to one cock then another");
				if (player.lowerBody.cockSpot.count() > 1) MainScreen.text(" so that each of your fiercely erect pricks has time to enjoy the tight, sucking embrace of her mouth.");

				MainScreen.text("\n\nPushing her all the way down to the base of your [cock biggest] so that the heavy breath through her nose warms your crotch and holding her there for a time, you enjoy the glorious closeness of the back of her "+ ((player.biggestCockLength() < 8) ? "mouth" : "throat"));
				if (player.lowerBody.balls > 0) MainScreen.text(", and her tongue once again sliding across your [balls]");
				MainScreen.text(" before wrapping your hand through her silky hair and lifting her carefully but firmly all the way up, above your [cock biggest] at a height where she is just able to reach it with her tongue, telling her to cup her peachy breasts as you do. You enjoy the soft lapping at your beading head and the frustrated moans filling your ears at leisure, reveling in the sight of her, attempting to reconcile the memory of the calm, independent dog woman you once knew with the whimpering bitch dangling from your fist and creaming herself from worshiping your cock now.");
		...
		private firstVaginaOralTrainingStageTwo():void
		{
			...
			if (player.lactationQ() > 0) MainScreen.text(" dripping slightly");
			else MainScreen.text(" semi-erect"); 
			MainScreen.text(" from the arousal you already feel. “<i>A good slut knows her mistress’s breasts need to be attended to, her nipples and skin shining with a slave’s worship for all the world to see, before she’s deserving of drinking from her pussy. Let’s see how you do.</i>” ");
			...
			if (player.upperBody.chest.hasFuckableNipples()) MainScreen.text(" obscene folds");
			else MainScreen.text(" sensitive points");
			MainScreen.text(", kneading them gently and bathing them in saliva. Given her initial awkwardness at cunnilingus it’s remarkable how good she is at this. “<i>Lick every inch... that’s good. Suckle on them a bit... very good!</i>” You gasp a bit as she envelopes one of your nipples and");
			if (player.upperBody.chest.hasFuckableNipples()) MainScreen.text(" sends her tongue questing into its sensitive inside.");
			else MainScreen.text("bites it ever so gently.");
			if (player.lactationQ() > 0)
			{
				MainScreen.text(" The gentle kneading is easily enough to make your fecund teats dribble milk into her mouth, and after being slightly startled by it Whitney evidently enjoys the taste of it, because she begins to pull at your plump breast for more. You allow her another mouthful before gently pulling her away.");
		...
		private vaginaOralTrainingStageTwo():void
		{
			...
			MainScreen.text("Not saying a word, you undo your [armor], exposing your whole body with a soft smile. Without any need for instruction Whitney gets to work, her hand delving into her underwear with a contented sigh, her eyes focused on the task in front of her as she steadily stokes the heat in her crotch with tight, urgent jerks of her slim body.");
			...
			if (player.lactationQ() > 0) MainScreen.text(" and it quickly makes the liquid warmth in your breasts rise to a point, beading milk freely from your teats. Whitney laps and sucks it down eagerly, but gratifyingly she remembers your order and stops reluctantly after only taking a single pull");
			MainScreen.text(", leaving your nipples");
			if (!player.upperBody.chest.hasFuckableNipples()) MainScreen.text(" rock-hard and");
			MainScreen.text(" shining and your [vagina] beading eagerly.");
		...
		private firstVaginaOralTrainingStageThree():void
		{
			...
			if (!player.upperBody.chest.hasFuckableNipples()) MainScreen.text(" she takes each of your [nipples] into her mouth to bathe them in close, sucking attention");
			else MainScreen.text(" she sends her tongue lapping into each of your cunt nipples, curling at their sensitive pink until they are wet with need");
			MainScreen.text(". It’s a process which is beautifully sensuous, made all the more gratifying by the soft, lustful moans she makes as she polishes your softness.");
			if (player.lactationQ() > 0) MainScreen.text(" It quickly makes the liquid warmth in your breasts rise to a point, beading milk freely from your teats. Whitney laps and sucks it down eagerly, but gratifyingly she remembers your order and stops reluctantly after only taking a single pull.");
			MainScreen.text(" She sinks downwards leaving your nipples");
			if (!player.upperBody.chest.hasFuckableNipples()) MainScreen.text(" rock-hard and");
			MainScreen.text(" shining, your [vagina] beading eagerly.");
		...
		private vaginaOralTrainingStageThree():void
		{
			...
			MainScreen.text(". It’s a process which is beautifully sensuous.");
			if (player.lactationQ() > 0) MainScreen.text(" It quickly makes the liquid warmth in your breasts rise to a point, beading milk freely from your teats. Whitney laps and sucks it down eagerly, whimpering as she withdraws after taking a single pull. You smile softly, knowing that the small, teasing taste of your sweetness only serves to make her thirstier.");
			MainScreen.text(" She sinks downwards leaving your nipples");
			if (player.upperBody.chest.hasFuckableNipples()) MainScreen.text(" rock-hard and");
			MainScreen.text(" shining, your [vagina] beading eagerly.");
		...
		private vaginaOralTrainingMaxed():void
		{
			...
			if (!player.upperBody.chest.hasFuckableNipples()) MainScreen.text(" she envelopes each of your [nipples] with her lips, kissing them with their sumptuous sponginess before bathing them in close, sucking attention");
			else MainScreen.text(" she pushes her lips against your cunt nipples before sending her tongue gently into each of them, curling at their sensitive pink until they are oozing wetness in delight");
			MainScreen.text(". It’s a process which is beautifully sensuous, made all the better by the soft, lustful moans she makes as she polishes your bust.");
			...
			MainScreen.text(" Having left your [chest] gleaming with warm, oily saliva and your nipples");
			if (!player.upperBody.chest.hasFuckableNipples()) MainScreen.text(" rock-hard and");
			MainScreen.text(" shining, she sinks down to the next stage.");
			...
			if (player.lowerBody.butt.buttRating < 4) MainScreen.text("firm butt");
			if (player.lowerBody.butt.buttRating < 8) MainScreen.text("supple rump");
			else MainScreen.text("soft ass");
			MainScreen.text(", oiling it to a sheen. She makes little gasping, stifled breaths as she goes about it, and a grin comes to your lips.");
		...
		{
			MainScreen.text("You are slightly apprehensive about this, but you’ve gone to the trouble of crafting Whitney into a fairly unique slave, and it seems churlish not to test just how deep the dominating streak you’ve brought out in her goes. You tell her you could do with a bit of relaxation.");
		...
		{
			MainScreen.text("You say you could do with some relaxation.");
		...
		private whitneyDomBondageOral():void
		{
			...
			MainScreen.text("Whitney climbs on top of your supine form, her hands pressing into your [chest], firm hips clenching around your abdomen as she considers you.");
			...
			else MainScreen.text("femcum");
			MainScreen.text(", and only after relaxing for a long, heavy moment on your face does she finally slide off you. You heave and pant for breath, still cuffed to the bed, rivulets of femcum trickling down your face, your tongue and ");
			if (player.lowerBody.cockSpot.hasCock()) MainScreen.text("[cock biggest]"); 
			if (player.lowerBody.cockSpot.hasCock() && player.lowerBody.vaginaSpot.hasVagina()) MainScreen.text(" and ");
			if (player.lowerBody.vaginaSpot.hasVagina()) MainScreen.text("[vagina]");
			MainScreen.text(" aching, oozing. In a deep, post-coital haze you feel someone take a towel to your body before curling into you, throwing a dense thigh over you, holding and running her hands over you possessively as you recover. ");
		...
		private whitneyDomStraponDoggy():void
		{
			...
			if (capacity >= 36)
			{
				...
				if (player.lowerBody.vaginaSpot.hasVagina()) MainScreen.text("deep, eager vagina");
				else MainScreen.text("oily, well-used passage");
				MainScreen.text(" eagerly swallowing it up until her hard hips are pressed against your [butt].");
				...
				if (player.lowerBody.vaginaSpot.hasVagina()) MainScreen.text("sit and spread ‘em for anything going, don’t you?");
				else MainScreen.text("I bet you get on your knees for anything with a nice, juicy cock, right?");
				MainScreen.text(" What would your other slaves think of that? My secret little slut.</i>” ");
			...
			else
			{
				...
				if (player.lowerBody.vaginaSpot.hasVagina()) MainScreen.text("take of your tight cunt");
				else MainScreen.text("give of your tight ass");
				MainScreen.text(", pushing the other end of the dildo into her. An even louder moan is forced out of your throat by the intensity of your tunnel being packed full of cock, albeit an imitation.");
				...
				if (player.lowerBody.vaginaSpot.hasVagina()) MainScreen.text("servants, you tight, bossy little bitch");
				else MainScreen.text("cattle, you tight, bossy little boy-bitch");
				MainScreen.text(".</i>” ");
			...
			if (player.lowerBody.vaginaSpot.hasVagina() && !player.lowerBody.cockSpot.hasCock() && kGAMECLASS.vapula.vapulaSlave()) MainScreen.text(" You feel the end of the dildo tense deep within you before releasing, filling you full of warm demon spunk until it pools out onto the bed. The feeling is horribly, disgustingly satisfying, and for a moment you can see exactly how Vapula views the world.");
		...
		private brandingMenu():void
		{
			...
			else
			{
				...
				MainScreen.text("Your thoughts turn to the ingenious magic of your tattooing gear, stashed away in the barn. Grinning, you consider who you will summon to brand.");

				if (player.stats.gems < 50) MainScreen.text("\n\n<b>You don't have enough gems to afford a new brand for any of your slaves.</b>");
		...
		private brandWhitney():void
		{
			...
			MainScreen.text("Whitney knows exactly what it means when you head off to the barn where she stashed your “branding” equipment; the dog girl is already eagerly stripped down by the time you’ve returned. You hold the pots of ink and consider where, and what, to put on her.");
		...
		public brandAmily():void
		{
			...
			MainScreen.text("You retrieve the pots of ink and paper from the barn and, smiling, tell your pet mouse you’re going to give her a treat.");

			MainScreen.text("\n\n“<i>How exciting!</i>” she squeaks. “<i>Is it your");
			if (player.lowerBody.cockSpot.hasCock()) MainScreen.text(" dick");
			else if (player.lowerBody.vaginaSpot.hasVagina()) MainScreen.text(" pussy");
			else MainScreen.text(" body");
			MainScreen.text(", [master]? That’s my favorite type of treat.</i>” You consider where, and what, to put on her.");
		...
		private brandJojo():void
		{
			...
			MainScreen.text("You retrieve the pots of ink and paper from the barn and, smiling brightly, tell your pet mouse you’re going to give him a special treat. Jojo knows all too well the nature of your treats. He closes his eyes and waits for the worst as you consider where and what to put on him.");
		...
		private brandBimboSophie():void
		{
			...
			MainScreen.text("You retrieve the pots of ink and paper from the barn and, smiling, tell your pet harpy you’re going to give her a treat.");
		...
		{
			MainScreen.text("You retrieve the pots of ink and paper from the barn and, smiling, tell your succubus you’re going to give her a treat.");
		...
		{
			MainScreen.text("You retrieve the pots of ink and paper from the barn and smilingly tell your centaur cumslut you’re going to give her a treat.");
		...
		{
			MainScreen.text("You retrieve the pots of ink and paper from the barn and, smiling kindly, tell your ex Sand Witch slave you’re going to give her a treat. ");
		...
		private dontGetBrandingStuff():void
		{
			...
			MainScreen.text("You stroke at her tiny bulging button until you adjudge she’s on the edge, before withdrawing your hand completely. Maybe some other time, you say airily.");

			MainScreen.text("\n\n“<i>Oh [master],</i>” groans Whitney, in a tone of deepest exasperation, her hands between her thighs.");
			if (whitneyDom()) MainScreen.text(" “<i>You’ll pay for that later, I swear!</i>”");
			MainScreen.text(" Grinning, you turn and leave.");
		...
		private brandingAvailableTalk():void
		{
			...
			MainScreen.text("“<i>[Master]! [Master], I’ve done as you asked,</i>” says Whitney, her tail wagging frantically as you approach. Her eyes are lit with glee and she’s got a cow with her on tether. You settle down and watch as she produces unassuming pots of black and red ink, and a sheaf of what looks like blotting paper.");
			...
			if (whitneyDefurred()) MainScreen.text(" fingernail");
			else MainScreen.text(" claw");
			MainScreen.text(" into the pot, withdraws it and then, dripping black fluid, presses it against the cow’s ample backside. The animal moos and swishes its tail in mild protest, but it doesn’t seem in any grievous amount of pain as Whitney’s digit moves, artfully tracing a large number 12 with the ink.");
		...
		private testBranding():void
		{
			...
			MainScreen.text("You return her devilish grin with interest.");
		...
		public brandSelect(slot: number):void
		{
			...
			MainScreen.text("What will you draw on her " + slotNames[slot] + "?");
			...
			if (player.lowerBody.cockSpot.hasCock() && whitneyMaxedOralTraining()) MainScreen.addButton(4, "Cocksucker", champCocksuckerTattoo, slot);
			if (player.lowerBody.vaginaSpot.hasVagina() && whitneyMaxedOralTraining()) MainScreen.addButton(5, "Pussylicker", champPussylickerTattoo, slot);
		...
		public amilyBrandSelect(slot: number):void
		{
			...
			if (player.lowerBody.cockSpot.hasCock() && slot == 2) MainScreen.addButton(4, "Cock Here", amilyCockGoesHereTattoo, slot);
			if (player.lowerBody.vaginaSpot.hasVagina()) MainScreen.addButton(5, "Mommy's Girl", amilyMommysGirlTattoo, slot);
		...
		public jojoBrandSelect(slot: number):void
		{
			...
			MainScreen.text("What will you draw on his " + slotNames[slot] + "?");
			...
			if (player.lowerBody.cockSpot.hasCock() && slot == 2) MainScreen.addButton(4, "Cock Here", jojoCockGoesHereTattoo, slot);
			if (player.lowerBody.vaginaSpot.hasVagina()) MainScreen.addButton(5, "Mommy's Boy", jojoMommysBoyTattoo, slot);
		...
		public bimboSophieBrandSelect(slot: number):void
		{
			...
			if (player.lowerBody.cockSpot.hasCock() && slot == 2) MainScreen.addButton(6, "Cock Goes Here", bimboSophieCockGoesHereTattoo, slot);
		...
		public vapulaBrandSelect(slot: number):void
		{
			...
			if (!player.lowerBody.cockSpot.hasCock()) MainScreen.addButton(5, "Dildo Polisher", vapulaDildoPolisherTattoo, slot);
		...
		public smallMilkyBrandSelect(slot: number):void
		{
			...
			if (slot == 0 && player.lowerBody.cockSpot.hasCock()) MainScreen.addButton(6, "Cock Cozy", smallMilkyCockCozyTattoo, slot);
		...
		public bigMilkyBrandSelect(slot: number):void
		{
			...
			if (slot == 0 && player.lowerBody.cockSpot.hasCock()) MainScreen.addButton(5, "Cock Cozy", bigMilkyCockCozyTattoo, slot);
		...
		{
			MainScreen.text("You command her to kneel in front of you and be still. Your lithe, naked dog girl does so, staying perfectly still as you dip your finger into the ink, carefully draw your design on her, and then seal it on with the paper.");
		}

		private amilyCollarboneIntro():void
		{
			MainScreen.text("You command her to kneel in front of you and be still. The succubus mouse does so, staying perfectly still as you dip your finger into the ink, carefully draw your design on her, and then seal it on with the paper. ");
		}

		private jojoCollarboneIntro():void
		{
			MainScreen.text("You command him to kneel in front of you and be still. The mouse-demon does so, staying perfectly still as you dip your finger into the ink, carefully draw your design on him, and then seal it on with the paper. ");
		...
		{
			MainScreen.text("You command her to kneel in front of you and be still. It’s difficult to get her to stay still, but she goes into a trance-like state when you finally lay your ink-soaked finger on her, mesmerized by its movement until you lay the paper over the design you’ve drawn and seal the ink.");
		}

		private vapulaCollarboneIntro():void
		{
			MainScreen.text("You command her to kneel in front of you and be still. The succubus does so, staying perfectly still as you dip your finger into the ink, carefully draw your design on her, and then seal it on with the paper. ");
		}

		private kellyCollarboneIntro():void
		{
			MainScreen.text("You command her to kneel in front of you and be still. The centaur does so, staying perfectly still as you dip your finger into the ink, carefully draw your design on her, and then seal it on with the paper. ");
		}

		private smallMilkyCollarboneIntro():void
		{
			MainScreen.text("You command her to take her clothes off, kneel in front of you and be still. The dusky girl does so, staying perfectly still as you dip your finger into the ink, carefully draw your design on her and then seal it on with the paper.");
		}
		...
		{
			MainScreen.text("You command her to kneel facing away from you and be still. Your lithe, naked dog girl does so, staying perfectly still as you dip your finger into the ink, carefully draw your design on her, and then seal it on with the paper. “<i>What did you draw, [master]?</i>” she says eagerly.");
		...
		{
			MainScreen.text("You command him to kneel facing away from you and be still. The mouse-demon does so, staying perfectly still as you dip your finger into the ink, carefully draw your design on him, and then seal it on with the paper. ");
		...
		{
			MainScreen.text("You command her to kneel facing away from you and be still. Your succubus mouse does so, staying perfectly still as you dip your finger into the ink, carefully draw your design on her and then seal it on with the paper. ");
		...
		{
			MainScreen.text("You command her to kneel facing away from you and be still. It’s difficult to get her to stay still, but she goes into a trance-like state when you finally lay your ink-soaked finger between her blonde wings, mesmerized by its movement until you lay the paper over the design you’ve drawn and seal the ink.");
		...
		{
			MainScreen.text("You command her to kneel facing away from you and be still. Your succubus does so, staying perfectly still as you dip your finger into the ink, carefully draw your design on her, and then seal it on with the paper. ");
		...
		{
			MainScreen.text("You command her to kneel facing away from you and be still. The centaur does so, staying perfectly still as you dip your finger into the ink, carefully draw your design on her shoulder blades, and then seal it on with the paper. ");
		...
		{
			MainScreen.text("You command her to kneel facing away from you and be still. The dusky girl does so, keeping her back straight and still as you dip your finger into the ink, carefully draw your design on her, and then seal it on with the paper. ");
		}

		private bigMilkyShouldersIntro():void
		{
			MainScreen.text("You set yourself down behind [bathgirlName] before dipping your finger into the ink, carefully draw your design on her, and then seal it on with the paper. She barely seems to notice.");
		...
		{
			MainScreen.text("You command her to set herself down on your [legs], as if she were about to receive a spanking. Your lithe, naked dog girl does so, her laughter at her own compromising permission turning to a sharp coo as you dip your finger into the ink and carefully draw your design on her, before sealing it on with the paper. “<i>What did you draw, [master]?</i>” she says eagerly.");
		...
		{
			MainScreen.text("You command him to set himself face down across your [legs], as if he were about to receive a spanking. The mouse-demon does so, staying perfectly still as you dip your finger into the ink, carefully draw your design on him and then seal it on with the paper. ");
		...
		{
			MainScreen.text("You command her to set herself face down across your [legs], as if she were about to receive a spanking. Your succubus mouse does so, her giggles at her own compromising position turning to a sharp coo as you dip your finger into the ink and carefully draw your design on her, before sealing it on with the paper. ");
		...
		{
			MainScreen.text("You command her to set herself face down across your [legs], as if she were about to receive a spanking. Your succubus does so, her put-upon sigh turning to a sharp coo as you dip your finger into the ink and carefully draw your design on her, before sealing it on with the paper. ");
		...
		{
			MainScreen.text("You command her to stand perfectly still.  She can’t quite stop clopping her hooves fretfully as you dip your finger into the ink and carefully draw your design on her human lower back before sealing it on with the paper. ");
		...
		{
			MainScreen.text("You command her to set herself down across your [legs]. The dusky girl does so, staying perfectly still as you dip your finger into the ink, carefully draw your design on her, and then seal it on with the paper.");
		}
		...
		{
			MainScreen.text("You command her to set herself down on your [legs], as if she were about to receive a spanking. Your lithe, naked dog girl does so, her laughter at her own compromising permission turning to a sharp coo as you dip your finger into the ink and carefully draw your design on the softest part of her anatomy, before sealing it on with the paper.");
		...
		{
			MainScreen.text("You command her to set herself face down across your [legs], as if she were about to receive a spanking. Your succubus mouse does so, her laughter at her own compromising position turning to a sharp coo as you dip your finger into the ink and carefully draw your design on the softest part of her anatomy, before sealing it on with the paper. ");
		...
		{
			MainScreen.text("You command him to set himself face down across your [legs], as if he were about to receive a spanking. The mouse-demon does so, staying perfectly still as you dip your finger into the ink, carefully draw your design onto the softest part of his body and then seal it on with the paper. ");
		...
		{
			MainScreen.text("You command her to set herself down across your [legs], as if she were about to receive a spanking. Your succubus does so, her put-upon sigh turning to a sharp coo as you dip your finger into the ink and carefully draw your design on the softest part of her anatomy, before sealing it on with the paper. ");
		...
		{
			MainScreen.text("You command her to stand perfectly still.  She can’t quite stop clopping her hooves fretfully as you dip your finger into the ink and carefully draw your design on her smooth, brawny horse ass before sealing it on with the paper. ");
		...
		{
			MainScreen.text("You command her to set herself down across your [legs]. The dusky girl does so, staying perfectly still as you dip your finger into the ink, carefully draw your design on her fine, round ass, and then seal it on with the paper.");
		}

		private bigMilkyButtIntro():void
		{
			MainScreen.text("You set yourself down behind [bathgirlName] before dipping your finger into the ink, carefully draw your design on her fine, round ass, and then seal it on with the paper. She barely seems to notice.");
		...
		private dontTestBranding():void
		{
			...
			MainScreen.text("Maybe later, you say. Whitney looks disappointed.");
		...
		private getOrgyRoom():void
		{
			...
			MainScreen.text("It’s a heavy investment, but her description of what she intends has definitely piqued your interest. Slowly you turn and, with a flick of the head, indicate the rock where she leaves the farm’s profit each week. Whitney breaks out onto a wide grin, her hands scrunching up on her skirt.");
		...
		private noOrgyRoomPlz():void
		{
			...
			MainScreen.text("You tell her it’s a fine idea, but it will have to wait for now.");
		...
		private orgyRoomTalk():void
		{
			...
			MainScreen.text("You can hear Whitney humming to herself happily as you approach her outside the milking shed, and when she sees you she rushes over to clutch at your arm excitedly.");
			...
			if (whitneyDom()) MainScreen.text("The sight sends a shuddering thrill down your spine. “<i>You didn’t think I’d forget those, did you [master]? We both know how important they are for properly relaxing you,</i>” Whitney murmurs, pushing her hot suppleness into your side. ");
			else MainScreen.text("You raise an eyebrow at these and Whitney giggles and blushes. “<i>Just in case you’re feeling adventurous, [master]. Or, um, want help.</i>”");
			MainScreen.text("You might be able to recognize those but you have no idea what the final object you can make out in the room’s dusky gloom is, stood against the far wall. It’s at least four foot tall and looks like an ornate stone urn, with a round bottom, a thin body, some sort of square contraption at the top, and a series of long tubes emerging from its stem. There’s a very small brazier next to it, with a few pebbles of charcoal huffing feebly at the bottom.");
			...
			if (!whitneyDom()) MainScreen.text("“<i>It’s exactly what a harem owner needs, [master] - with this you could take care of me and your other sluts all night, every night!</i>”");
			else MainScreen.text("“<i>I could do so many things to you [master], if you were on this stuff. And for so long. Just imagine it!</i>”");
			MainScreen.text(" You don’t feel woozy or spaced out at all - if anything, you feel slightly more aware and in control of your surroundings, it’s just that your skin feels like it’s coated with something vaguely fuzzy. ");
		...
		private orgyRoomSubMassage():void
		{
			...
			MainScreen.text("You say in a grand, wearied tone that you’ve arrived from another hard day of bringing Mareth to its knees, and that you require the services of your pet masseuse. ");
			...
			if (player.lowerBody.butt.buttRating >= 6) MainScreen.text("soft");
			else MainScreen.text("brawny");
			MainScreen.text(" rear. After she’s finished making your butt feel red and smooth she dips a heated, greasy hand between your [hips] and");
			if (player.lowerBody.cockSpot.hasCock()) MainScreen.text(" grips your [cock]");
			else if (player.lowerBody.vaginaSpot.hasVagina()) MainScreen.text(" traces the entrance of your [vagina]");
			MainScreen.text(" for a moment... before sliding out with a throaty giggle, moving on down to your hips.");
			...
			if (player.isBiped())
			{
				...
				if (!(player.lowerBody == LowerBodyType.HOOFED || player.lowerBody == LowerBodyType.NAGA || player.lowerBody == LowerBodyType.GOO || player.lowerBody == LowerBodyType.PONY))
				{
					...
					if (player.lowerBody.cockSpot.hasCock() && player.lowerBody.vaginaSpot.hasVagina()) MainScreen.text(" and your");
					if (player.lowerBody.vaginaSpot.hasVagina()) MainScreen.text(" pussy moisten");
					MainScreen.text(".");
		...
		private orgyRoomSubMassageHappyEnding():void
		{
			...
			MainScreen.text("You silently rise from the slab and put your arm around your masseuse’s tight body. It radiates heat into you as you send a hand sliding down the curve of her back to squeeze at her tight, supple butt.");
			...
			{
				MainScreen.text(" With a single movement you swing her hot, compact weight over your shoulder. You growl into her ear that she’s still got plenty to do if she’s to finish her job of thoroughly relaxing every part of you.");
			...
			{
				MainScreen.text(" You tighten your grip on her pert behind and growl that she’s still got plenty to do if she’s to finish her job of thoroughly relaxing every part of you.");
			...
			{
				MainScreen.text(" You take a long moment to consider which of your sexes you will satisfy yourself with.");
			}

			//[Male][Female]/[Next]
			menu();
			if (player.cockThatFits(whitneyVagCapacity() * 1.33) != -1) MainScreen.addButton(0, "Male", subHappyEndingMale);
			if (player.lowerBody.vaginaSpot.hasVagina()) MainScreen.addButton(1, "Female", subHappyEndingFemale);
		}
		...
		private subHappyEndingMale():void
		{
			...
			if (hasBiggerCock) MainScreen.text(" [cock biggest]");
			else if (player.isBiped()) MainScreen.text(" against your [hips]");
			else MainScreen.text(" around your back");
			MainScreen.text(" momentarily. You grin, and begin to pump into her a little harder, using the full breadth of movement afforded to you by your oiled, [hips] to do so. It has the effect you anticipated. After a few more moments gamely keeping time with your own heavy exhalations the dog girl you’re buried into gasps, unable to contain herself. You winch her legs up by the knees and go at her faster again, still using the full movement of your pelvis to withdraw and sink every inch of your [cock " + cockThatFits + "], pushing into her pink tightness vigorously enough for the water around to splash briskly, buried into her even deeper. ");
			...
			if (player.cumQ() >= 1500) MainScreen.text(" Her small capacity is almost immediately filled and jizz spurts out with every rich thrust you make, polluting the water around you with your massive load.");
			if (hasBiggerCock) MainScreen.text(" Whitney has stroked and tantalized your [cock biggest] with her hot hands and smooth belly intermittently this whole time, and as your orgasm builds and overwhelms you she gets her just reward for it; you jet cum from [eachCock], pasting first her face and then her tight breasts with your thick cream as you ride her hard.");
