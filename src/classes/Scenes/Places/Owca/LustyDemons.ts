 ...
 */
export default class LustyDemons extends Monster {
	...
	public LustyDemons() {
		...
		this.horns = 2;
		this.drop = NO_DROP;
		statusAffects.add(new StatusAffect("Vapula", 0, 0, 0, 0)));
		checkMonster();
	}
}
