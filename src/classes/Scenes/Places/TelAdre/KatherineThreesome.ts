	...
	public class KatherineThreesome extends TelAdreAbstractContent
	{
		...
		*/
		...
		public function circlejerk():void { //Not available if Kath has no cock
			...
			if (player.lowerBody.cockSpot.hasCock()) outputText("; [eachCock] erects, nice and ready for what’s to come");
			else if (player.lowerBody.vaginaSpot.hasVagina()) outputText("; your pussy is drenched with your juices, some of it dripping on Urta’s tail");
			outputText(".");
			...
			if (player.lowerBody.cockSpot.hasCock())
				outputText("wrapping around your cock" + (player.lowerBody.vaginaSpot.hasVagina() ? " and " : ""));
			if (player.lowerBody.vaginaSpot.hasVagina()) outputText("gently teasing around your cunt");
			...
			if (player.lowerBody.cockSpot.hasCock()) outputText("   Her hand teases your [cock] with the soft pads on the tips of her fingers; every once in awhile, she reaches up to collect a dollop of pre and smear it along your shaft, making it easier for her to tease you into defeat.");
			if (player.lowerBody.vaginaSpot.hasVagina()) outputText("   Her " + (player.lowerBody.cockSpot.hasCock() ? "other " : "") + "hand teases your labia by gently circling it, the fur tickling your entrance so deliciously, you can’t help but buck against her wandering finger, trying to capture it within your moist walls.");
			...
			if (player.lowerBody.cockSpot.hasCock() && player.lowerBody.vaginaSpot.hasVagina()) { //Herm
				outputText("you're overcome.  Your pussy and hips lock up and you dribble femcum as Urta and Kath's efforts pay off.  You feel hot liquid rushing up from your " + (player.lowerBody.balls > 0 ? "balls" : "prostate") + ", then an explosion...\n\n");
			}
			...
			if (player.lowerBody.cockSpot.hasCock()) outputText(" and especially against your " + player.cockDescript());
		...
		public function threeSixtyNine():void {
			...
			else outputText("Your overpowered " + (player.lowerBody.balls > 0 ? "balls produce" : "prostate produces") + " jet after boiling jet of cum.  ");
		...
		public function roastYou():void { //Not available if Kath has no cock
			...
			if (katherine.cockNumber > 1) 
				outputText("s of her cocks press firmly against " + (player.lowerBody.vaginaSpot.hasVagina() ? "both your holes" : "your ass"));
			else outputText(" of her cock presses firmly against your " + (player.lowerBody.vaginaSpot.hasVagina() ? "cunt" : "ass"));
			outputText(".\n\nKath pushes your legs apart with her knees and starts to force ");
			if (katherine.cockNumber == 1)
				outputText("her " + katherine.cockLength + " inch " + katherine.cockType("doggy dick", "cat cock") + " into your " + (player.lowerBody.vaginaSpot.hasVagina() ? "pussy" : "rectum"));
			else if (player.lowerBody.vaginaSpot.hasVagina())
			...
			outputText(" for her coming deposit" + (player.lowerBody.vaginaSpot.hasVagina() && !player.isPregnant() ? " and ensuring your uterus will be awash with her seed" : "") + ".\n\n");
			if (player.lowerBody.vaginaSpot.hasVagina()) if (player.cuntChange(katherine.cockArea(), true)) outputText("\n\n");
			if (wasButtStretched) {
		...
		public function spitroastKath():void { //Works for all except genderless characters
			...
			if (player.isTaur())
				...
				outputText("her mouth is lined up with your " + (player.lowerBody.cockSpot.hasCock() ? "cock" : "pussy") + ".  Your submissive pussy cat doesn’t need any instruction to " + (player.lowerBody.cockSpot.hasCock() ? "swallow the tip of your cock" : "slam her tongue into the depths of your pussy"));
			...
			outputText(" Kath takes it without complaint and her rough tongue does wonders for your mood and " + (player.lowerBody.cockSpot.hasCock() ? "member" : "your moist cunt") + ".\n\n");
		...
		public function pinAndFuck():void { //Kath is sober, Urta is drunk //Not available if Kath has no cock
			...
			if (urta.pregnancy.isPregnant && urta.pregnancy.type != PregnancyType.BEE_EGGS && urta.pregnancy.type != PregnancyType.DRIDER_EGGS)
				...
				outputText(" - she needs a womb full of seed.  Urta laughs and says “<i>" + (flags[FlagEnum.URTA_FERTILE] > 0 ? "Yeah, fill me up, maybe you’ll get to be a daddy" : "Oh please fill me up.  It’s so good"));
		...
		private function pinAndFuckMountUrta():void { //Plays for anyone without a cock and for herms who select this option
			...
			outputText("Kath laughs and continues to gently fuck Urta.  You pull off Urta’s cock and wait for her massive load to finish gushing from your " + (player.lowerBody.vaginaSpot.hasVagina() ? "pussy" : "ass") + " before putting on your clothes.  Before you leave you give Urta a kiss and squeeze her belly a little.  Her only reply is to moan.  You tell Kath to take good care of Urta and then leave.  You know that if you stay much longer their display will get you excited enough that you’d stay around all afternoon and unfortunately you’ve got things you need to do.\n\n");
			player.orgasm();
			flags[FlagEnum.URTA_COMFORTABLE_WITH_OWN_BODY]++;
		...
		private function pinAndFuckStuffKath():void { //Plays for any males and for herms who select this option
			clearOutput();
			outputText("When Kath flopped on top of Urta her legs spread apart and gave you a great view of " + (player.lowerBody.cockSpot.count() > 1 ? "three" : "two") + " things.  Her" + katherine.cockMultiple("", " lower") + " knot, hot and hard, buried in Urta’s pussy" + katherine.cockMultiple(" and her dripping slit", ", her dripping slit and her supple sphincter, both") + " waiting for your cock.  " + (player.lowerBody.cockSpot.count() > 1 ? "They look" : "It looks") + " so wet, so empty.  Neither Katherine nor Urta notice as you " + (player.isNaga() ? "slither" : "step") + " around them, position yourself behind Kath, line up your dick" + (player.lowerBody.cockSpot.count() > 1 ? "s and feed them" : " and feed it") + " into Kath's body.\n\n");
			outputText("Kath may be tired but she’s still in the mood.  She clenches her pussy " + (player.lowerBody.cockSpot.count() > 1 ? "and ass around your cocks" : "around your cock") + " and lets out a low moan.  You ");
			if (player.stats.cor < 25)
				outputText("hold your cock" + (player.lowerBody.cockSpot.count() > 1 ? "s" : "") + " still for a moment, letting Kath adjust her hips so she’s in a more comfortable position.  You massage the base of her tail which draws even more moans of pleasure from Kath.  When you finally start to thrust again Kath weakly tries to push her hips back toward you and her pussy " + (player.lowerBody.cockSpot.count() > 1 ? "and ass do their" : "does its") + " best to pull you in deeper.");
			else if (player.stats.cor < 75)
				outputText("start to fuck her slowly and gently but quickly build to thrusting hard and fast as your base instincts take over.  It doesn’t seem to matter to Kath, she moans and purrs happily as long as your cock" + (player.lowerBody.cockSpot.count() > 1 ? "s are filling her holes." : " is filling her pussy."));
			else
			...
			outputText("Your cock" + (player.lowerBody.cockSpot.count() > 1 ? "s erupt inside Kath" : " erupts inside Kath"));
			if (player.cumQ() < 500)
				outputText(", your load soaking into her " + (player.lowerBody.cockSpot.count() > 1 ? "pussy and ass" : "waiting pussy") + ".  Katherine just purrs and rolls slightly so she can kiss you.");
			else if (player.cumQ() < 1500)
				outputText("and you feel " + (player.lowerBody.cockSpot.count() > 1 ? "little lakes of cum forming around the tips of your cocks" : "a little lake of cum forming around the tip of your cock") + ".  Her belly swells just a bit and Kath puts her hand on it, a smile on her lips.");
			else if (player.cumQ() < 3000) {
				...
				if (katherine.pregSize() > 0)
					...
					outputText("She starts to look a little pregnant as her womb " + (player.lowerBody.cockSpot.count() > 1 ? " and colon" : "") + " fill with your seed.");
			}
			else {
				...
				if (katherine.pregSize() > 0) {
					...
					if (player.lowerBody.cockSpot.count() > 1)
						outputText("your lower shaft Kath’s vagina quickly reaches its limit and you feel all your cum running down your other cock" + (player.lowerBody.cockSpot.count() > 2 ? "s, blasting all over the room." : " stuffing her colon with cum."));
					else 
						outputText("your supercharged " + (player.lowerBody.balls > 0 ? "balls" : "prostate") + " you quickly fill her cunt to its limit, the rest of your seed blasting back against your groin.");
				}
			...
			outputText("You lock the door on the way out, " + (flags[FlagEnum.KATHERINE_URTA_AFFECTION] >= 31 ? "knowing that with those two the sex option will eventually win out." : "hoping your sated girlfriends will bond over this."));
			flags[FlagEnum.URTA_TIME_SINCE_LAST_CAME] = 2 + rand(2);
			if (model.time.hours >= 13) flags[FlagEnum.KATHERINE_LOCATION] = Katherine.KLOC_URTAS_APT; //Katherine.timeChange will sort out whether Kath actually stays with Urta
			doNext(camp.returnToCampUseOneHour);
		}
		...
		public function knothole():void { //Kath is drunk, Urta is sober //Not available if Kath has no cock
			...
			if (player.lowerBody.cockSpot.count() > 0)
				outputText((player.lowerBody.cockSpot.count() > 1 ? "one of your cocks" : "your cock") + ".  Kath sucks on the tip eagerly,");
			else outputText("your pussy. Kath presses her face to your crotch,");
			outputText(" her rough tongue caressing you.\n\n");
			outputText("You start to scratch Kath’s sensitive ears and she goes wild.  She grabs your hips and pulls herself closer, " + (player.lowerBody.cockSpot.count() > 0 ? "her teeth locked around the base of your cock" : "like her tongue is trying to reach your cervix") + ".\n\n");
		...
		private function sandwichGetLicked():void {
			...
			outputText(".  Every time she thrusts her rack jiggles delightfully.  At the same time Urta’s expert tongue is " + (player.lowerBody.cockSpot.hasCock() ? "sliding around your cockhead" : "busy teasing your folds") + ", nudging you towards an orgasm.\n\n");
			...
			outputText("It’s the pleading look Urta gives you that sends you over the edge.  That and " + (player.lowerBody.cockSpot.hasCock() ? "the feeling of her whole throat clamping down on your member" : "her nose tickling your clit while her tongue probes your depths.  You cum hard, soaking her face with fem-cum") + ".\n\n");
			if (player.lowerBody.cockSpot.hasCock()) {
				if (player.cumQ() < 500) {
					...
					outputText("You pump shot after shot down Urta’s throat.  With each blast you fire you feel her innards stretch more and more.  By the time your " + (player.lowerBody.balls > 0 ? "balls are" : "prostate is") + " empty there’s a distinct warmth and wetness in her throat.  Thank goodness she has no gag reflex.\n\n");
					outputText("Urta doesn’t have a chance to recover");
				}
				else if (player.cumQ() < 3000) {
		...
		private function sandwichCommonEnd():void {
			...
			outputText("Urta clutches her belly and moans, “<i>Oh no,</i>” but you think she’s starting to get into it.  Before you get too turned on you leave your lovers to it." + (flags[FlagEnum.KATHERINE_URTA_AFFECTION] >= 31 ? "  They really need some more time together and you’re sure this qualifies as a ‘bonding experience’." : ""));
			player.orgasm();
			katherine.orgasm();
			katherine.katherineAndUrtaHadSex(true);
			flags[FlagEnum.URTA_COMFORTABLE_WITH_OWN_BODY]++;
		...
		public function orgy():void { //Both Kath and Urta are drunk
			...
			else outputText(player.lowerBody.vaginaSpot.hasVagina() ? "licked you out" : "fisted your ass");
		...
		public function doubleStuffKath():void { //Both Kath and Urta are drunk
			...
			outputText("Your two lovers trade you" + (player.lowerBody.cockSpot.hasCock() ? "r cock" : "") + " back and forth a few times until you feel that you’re about to cum.  ");
			if (!player.lowerBody.cockSpot.hasCock()) {
				...
				if (player.cumQ() < 500) {
					...
					if (player.lowerBody.cockSpot.count() > 2) outputText("  Your other cock" + (player.lowerBody.cockSpot.count() > 3 ? "s" : "") + " produce a few squirts which coat both Kath and Urta’s bodies.");
					...
					if (player.lowerBody.cockSpot.count() > 2) outputText("  You realize that your free cock" + (player.lowerBody.cockSpot.count() > 3 ? "s" : "") + " fired their streams all over the room, adding to the mess Urta will have to clean up later.");
					...
					if (player.lowerBody.cockSpot.count() > 2) outputText("  Your other cock" + (player.lowerBody.cockSpot.count() > 3 ? "s" : "") + " release a torrent of cum, coating Kath, Urta, the floor and a few of the walls.  Though it’s messy you’re sure both your lovers are happy that at least some of your sperm didn’t wind up inside them.");
				...
				if (rand(2) == 0) { //Urta takes it
					outputText("Urta had just swallowed you again, the ride down her throat setting you off.  You grip the back of her head and your " + (player.lowerBody.balls > 0 ? "balls start" : "prostate starts") + " pumping.  Her eyes go wide but she accepts her fate, trying to swallow your load as fast as you can produce it.\n\n");
					outputText("Kath realizes what’s happened" + (player.lowerBody.balls > 0 ? " and rubs your balls" : ", quicky inserts her finger into your ass and starts milking your prostate") + ", trying to coax an even bigger load out of " + (player.lowerBody.balls > 0 ? "them" : "it") + ".  ");
					if (player.cumQ() < 500)
					...
					outputText("Kath’s licking and humming set you off, so you grip the back of her head.  Your " + (player.lowerBody.balls > 0 ? "balls start" : "prostate starts") + " pumping.  Her eyes go wide but she accepts her fate, trying to swallow your load as fast as you can produce it.\n\n");
					outputText("Urta realizes what’s happened" + (player.lowerBody.balls > 0 ? " and rubs your balls" : ", quicky inserts her finger into your ass and starts milking your prostate") + ", trying to coax an even bigger load out of " + (player.lowerBody.balls > 0 ? "them" : "it") + ".  ");
					if (player.cumQ() < 500)
			...
			if (katherine.hasCock()) {
				...
				else outputText(player.stats.cor < 66 ? ".  Despite having just cum you feel a little twitch from your cock." : ".  It's sickly sweet, but who cares as long as they keep fucking like that.");
			}
			player.orgasm();
			katherine.orgasm();
			katherine.katherineAndUrtaHadSex(true);
		...
		public function doublePenetrateKath():void { //Both Kath and Urta are drunk
			...
			outputText("You watch the show, your cock beginning to strain against the confines of your clothes" + (player.lowerBody.vaginaSpot.hasVagina() ? " as your pussy begins to wet them" : "") + ".  Katherine starts to tug at Urta’s clothes and despite her drunkenness she does a good job of removing them.\n\n");
			...
			outputText("Now it’s your turn.  You tighten your grip on Kath’s hips and jam your prick all the way in.  You hear a whimpered “<i>Yes</i>” from Kath before your " + (player.lowerBody.balls > 0 ? "balls start to empty their" : "prostate starts to empty its") + " contents.  ");
			if (player.cumQ() < 500)
				...
				outputText("You pump several streams of cum into Kath’s rectum.  With each shot you fire you feel her innards stretch more and more.  By the time your " + (player.lowerBody.balls > 0 ? "balls are" : "prostate is") + " empty you can’t feel the insides of her colon anymore, just an inner sea of your cum.");
			...
			if (flags[FlagEnum.KATHERINE_URTA_AFFECTION] == 1) { //First time they’ve ever had sex together
				...
				outputText("Urta gives you a big wet kiss and says, “<i>You must really like seeing me fill your friend." + (flags[FlagEnum.URTA_FERTILE] == 1 ? "  Better be careful, I might just knock her up." : "") + "</i>”\n\n");
		...
		public function doubleStuffVala():void { //Not available if Kath has no cock
			...
			if (player.cumQ() < 1500) {
				outputText("Your " + (player.lowerBody.balls > 0 ? "balls have" : "prostate has") + " to work much harder than usual to force your cum past Katherine’s engorged knot" + katherine.cockMultiple("", "s") + ".  It’s somewhat painful, but after a while you can feel a small pool of your seed forming in Vala’s colon.\n\n");
		...
		private function valaCommonStart():void {
			...
			outputText("You turn, expecting " + (flags[FlagEnum.KATHERINE_VALA_AFFECTION] > 5 ? "Kath to have readied herself.  Sure enough" : "to have to convince Kath of what you want.  Instead") + " you find her part way through stripping her clothes off.");
