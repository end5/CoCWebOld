...
//    && (KATHERINE_TRAINING & KBIT_TRAINING_TALK_KATH) == 0)
		...
		public function katherineTrainingStage1(clearOut:boolean = true):void
		{
			...
			outputText((flags[FlagEnum.KATHERINE_TRAINING] == 0 ? "  You" : "Kath readies herself quickly and you") + " lead her on a long, winding trek through the desert sands.  You always keep Tel’Adre in sight so that if the two of you are somehow separated Kath will be able to find her way home.\n\n");
...
//    (KATHERINE_UNLOCKED == 2) && (KATHERINE_TRAINING >= 100)
			...
			outputText("Urta knocks back her mug and says, “<i>Oh yes, we’ve been sleeping together for a while.  I’m guessing from the look on your face, you two have been sleeping together for a while too, hmmm?  Where have you been hiding her, " + player.short + "?  And why haven’t you introduced us?</i>”");
					...
					if (urta.urtaLove() && (flags[FlagEnum.AMILY_VISITING_URTA] == 4 || flags[FlagEnum.URTA_KNOWS_PC_HAS_MARBLE_FOLLOWER] > 0)) {
						...
						if (flags[FlagEnum.URTA_OPEN_ABOUT_EDRYN] > 0) outputText(" and " + player.mf("he", "she") + " doesn’t get " + player.mf("his", "her") + " back up when I sleep around");
		...
		{	//This scene plays automatically the first time that the player goes to Tel’Adre after Kath’s training is done
			...
			outputText("“<i>Hi, " + player.short + " - what, didn’t you recognize me?</i>” she jokes.  “<i>I finally did it!  I’m in the Watch now - I have a job and a home and everything, and I owe it all to you" + (flags[FlagEnum.KATHERINE_TRAINING] == 200 ? " and Captain Urta" : "") + "!</i>”\n\n");
