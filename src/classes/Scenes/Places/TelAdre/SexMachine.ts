...
private useTheSexMachine():void {
	...
	if(player.gender == 1) {
		if(flags[FlagEnum.TIMES_USED_SEX_MACHINE_AS_MALE] == 0) {
			Render.text("You sit on the padded bench, looping your legs behind the machine's soft foam leg lift bars. There's even straps to prevent you from slipping. The machine's monitor blinks to life, instructing you to strap in your legs, your waist, and then place your arms in the cuffs on the lowered bars to either side of your head.\n\n", false);

			Render.text("You do as you're told, and as soon as you're all strapped in, and your arms are in place, the cuffs tighten, quickly securing you to the machine! It lifts you off the padded bench, slipping it behind you for you to lean against at an angle on your back. It takes no time at all for the shifting mechanical parts to begin working your already sore arms and legs, leaving you helpless to fight against them as you're already strapped in. You grunt in effort, attempting to get free from the crazed weight machine, only to have it increase the pace. The screen flashes once more, stating that it is beginning \"phase two\". Quickly your pants are removed, revealing " + sMultiCockDesc() + " and your " + assholeDescript() + " to the cool air. Almost instantly a firm, phallic-shaped metallic object is pressed against your anus, but it goes no further.  Another device slips around your ", false);
			if(player.lowerBody.cockSpot.count() > 1) Render.text("primary ", false);
			Render.text("cock, tightening around your member while beginning to hum softly.\n\n", false);

			Render.text("It takes little time for " + sMultiCockDesc() + " to grow hard, your lust betraying you as another phallic shaped metallic length is presented in front of your face. A small shock is delivered to your " + assholeDescript() + ", causing you to gasp, and allowing the phallic length to slip deep into your mouth, giving you little choice but to suck on the device. The tube-like length on your " + cockDescript(0) + " continues its assault, humming and stroking your firm cock, starting to suck softly to pleasure your mighty rod; so much that you nearly don't notice as a small tube slips into the tip of your penis, beginning to slowly devour your leaking pre-cum.\n\n", false);

			Render.text("Shaking your head as the machine forcibly pleasures you, you quickly realize that with each drop of cum your cock has drained from it, the phallus against your anus gets a little more moist. It's using your own pre-cum to lube your asshole!\n\n", false);

			Render.text("It doesn't take long for the phallus to slip past your anal ring, filling your anus with firm strokes while you let out muffled moans.", false);
			player.buttChange(30,true,true,false);
			Render.text("  The machine's screen states that it is now entering \"Harvest phase\", and goes into high gear. The phallus in your ass bucks you forward, forcing your hips to buck and grind against the tight mechanical cunt as it quickly grinds against your cock.  Even the device forced inside your mouth begins to vibrate and hum, and you swear you taste your own cum leaking from it.\n\n", false);

			Render.text("The phallus in your anus begins to rub firmly against your prostate, as if it was locating it and locking onto it. Within moments you cry out in orgasmic pleasure, ", false);
			if(player.lowerBody.balls > 0) Render.text("your " + ballsDescriptLight() + " pulling up tightly ", false);
			else Render.text("prostate pulsing madly ", false);
			Render.text("as you pump your thick seed into the machine's waiting tube.\n\n", false);

			Render.text("You are surprised when the machine doesn't pump your own seed into your mouth and anus, instead slowly letting you back down. A platform lifts up in front of the machine, with a small metallic mini-keg. Once you're released and the keg is presented, the machine \"dings\", as if it had finished, leaving you exhausted and utterly violated.\n\n", false);

			Render.text("Within moments, the goblin comes out of the back room - the small redheaded woman looks surprised to see you. Covered head to toe in thick grease and dirty clothes, she fits every last stereotype of an engineer.\n\n", false);

			Render.text("\"<i>What are you doing to my baby?!</i>\" she cries out, until she notices the keg sitting in front of her.  \"<i>Wait, it works? It works!</i>\" she cheers with glee, quickly rushing over and snatching up the keg of your seed. Within moments she's gone back through her locked door, leaving you alone with the machine, whose screen goes blank after noting that it had \"saved your measurements\". Probably to rape you more efficiently next time...\n\n", false);
		}
		//[Male repeat scene]
		else {
			Render.text("You get a sly smirk on your face. If you're going to get a full body workout, you need to work out -every- muscle in your body, and there's only one machine that can do that.\n\n", false);
	...
	//[If you decide to mess with the machine, female:]
		...
		if(flags[FlagEnum.TIMES_USED_SEX_MACHINE_AS_FEMALE] == 0) {
			...
			Render.text("It isn't long until the goblin comes into the room gasping. \"<i>You used my baby? You... wait, it worked? It worked! Tell me, how was it?  Wait no, don't tell me, it was wonderful of course!</i>\" the red-headed goblin beams.  She's covered from head to toe in grease, wearing dirty clothing that has various tools sticking out of every pocket; a stereotypical engineer. \"<i>The machine is made to milk studly men dry and use their cum to impregnate goblin females.  It automates the process!  But if you want to use it too, feel free, sexy.</i>\"  She winks at you lewdly. \"<i>But who knows what kind of cum will knock you up!</i>\"\n\n", false);
	
			Render.text("She turns, walking back into the locked backroom, leaving you stunned and speechless.", false);
		}
		//[Female repeat scene]
		else {
			Render.text("You grin as you walk down the halls, wiping sweat from your forehead from your recent workout. Tired, but not exhausted, you decide to have a wind down session with your favorite machine in the building. Walking down the back halls, it doesn't take you long to find the quiet back room with the mysterious goblin machine in it. You quickly slip inside, letting the steel door close behind you with a soft metallic click.\n\n", false);

			Render.text("As you sit on the bench, the screen once more flares to life, quickly scrolling various body information about you past, not limited to vaginal depth, optimal ovulation periods, bust size... attempting to read it all is dizzying! You rub your forehead, sighing softly as you buckle yourself in.  Then you slip your arms and legs into the restraints of the machine, and once again it lifts you up in the air and strips your " + player.armorName + " off.\n\n", false);

			Render.text("The cool air makes your nipples stand out, and you notice a pleasant surprise: the cocks slipping between your ass-cheeks and thighs are made of a soft, but firm, latex.  They warm as they leak cum on your " + assholeDescript() + " and labia. You blush, willingly opening your mouth for the cock in front of you.  Sucking it in to taste the heady seed, you close your eyes, enjoying the ride as your labia softly part, wet and ready for the intruding member.\n\n", false);

			Render.text("You moan lustfully as the members slip into your " + vaginaDescript() + " and " + assholeDescript() + ", filling you deeply.", false);
			player.cuntChange(30,true,true,false);
			player.buttChange(30,true,true,false);
			Render.text("  They begin to stroke slowly", false);
			if(player.upperBody.chest.BreastRatingLargest[0].breastRating >= 2) Render.text(", and it doesn't take long for the machine to slip a cock between your breasts as well, starting to tit fuck you as it rotates you in your restraints to optimize your position", false);
			else Render.text(" while the machine rotates you in place to optimized your positioning.", false);
			Render.text(".\n\n", false);
																														   
			Render.text("You moan with your legs lifted high above your head, leaving you surprised as to how flexible you truly are; the positioning of your legs forces your ass and vagina to clamp down on the members, making you feel every ridge and nub as they piston in and out of your wet fuck holes. Once more, the cock in your mouth cums first, pumping globs of hot semen down your throat, filling your stomach while you begin to climax, panting and gasping for air even as you swallow all you can. The latex pricks fucking your other holes bounce you as your girlcum runs down your thighs, and shortly after they cum deep inside you, pumping you full of their mysterious seed.\n\n", false);

			Render.text("You pant as you are let down onto the padded bench, rubbing your swollen stomach while cum leaks out of both of your holes. You smile from the afterglow of your climax, truly exhausted, and <b>really</b> needing that shower now.\n\n", false);
		}
	...
	//[Sexless]
		...
		if(flags[FlagEnum.TIMES_USED_SEX_MACHINE_AS_EUNUCH] == 0) {
			Render.text("You sit down on the padded bench and look around at the odd weight-lifting machine nearby. Various parts look less than pleasant, and less than exercise orientated on further inspection.  It makes you question the uses of this machine. The screen before you flashes to life, politely asking you to place your arms and legs in the cuffs and buckle yourself in.\n\n", false);

			Render.text("You raise an eyebrow, wondering what you're getting yourself into as you buckle yourself to the machine, hoping this isn't a mistake. It doesn't take long for you to realize it is. The machine lifts you up, stripping your " + player.armorName + " off of you and spreading your arms and legs. First, a round device that appears to be made to hold a penis slips up, rubbing against your flat pelvis. It tries for a few moments, lifting up two other smaller devices made for smaller dicks before it gives up, the screen reading \"error\". Shortly afterward, a cock-like metallic device is lifted up to your groin, rubbing around as it leaks lubrication, searching for an entrance until once again the screen reads \"error\".\n\n", false);

			Render.text("It whirs for a moment, confused. It seems to ponder matters for a second before simply lifting you up into a sitting position. It doesn't take but a moment for you to feel a firm steel tip press against your anus, the machine bouncing you slowly in your restraints on the mechanical cock, each bounce smearing more and more cum on your " + assholeDescript() + ", lubing you up for your eventual penetration.\n\n", false);

			Render.text("You gasp with each bounce, your ass finally lubed enough that each gentle jostle forces you to sink another half-inch down on the thick phallic member. With a groan you finally bottom out, your anus stretched around the thick member.  ", false);
			player.buttChange(30,true,false,true);
			Render.text("The machine forces you forwards, onto your hands and knees, the thick cock beginning to slip in and out of your ass, pounding away with fervor to the sound of your exhausted moans. Each thrust seems to get closer and closer to a pleasurable spot, as if homing in on it slowly.\n\n", false);

			Render.text("It doesn't take long for every thrust of the thick metal cock to ram that pleasant spot, pushing you closer and closer to your climax. You close your eyes as they roll back in your head, moaning loudly as you orgasm, the cock erupting inside of you, filling your rectum with thick spurts of cum.\n\n", false);

			Render.text("Slowly, the machine pulls out of your asshole, releasing the straps and leaving you unceremoniously on the padded bench, facedown with your gaped anus hanging the air, leaking cum.\n\n", false);

			Render.text("After you collect yourself and your gear, you quietly slip out of the room, the machine quiet and inactive now. However, you can't help but feel like you were being watched...", false);
		}
		//[Sexless Repeat]
		else {
			Render.text("You walk down the halls after your brisk workout, once more headed for that quiet back room with that wonderful piece of exercise equipment. You smile as you slip in the door, looking around a moment to make sure you're alone in the room.\n\n", false);

			Render.text("You casually strip yourself naked, saving the machine the effort, and sit on the padded bench. It whirrs to life, blinking a few statistics on the screen, including what seems to be measurements of your rectum and anus. Why would it need those?\n\n", false);

			Render.text("You shrug it off, slipping, as directed, into the various straps and buckles to secure yourself to the machine, and once more it lifts you into the air. You feel a firm pressure against your " + assholeDescript() + " once again, teasing you with a surprise: you feel a flexible latex head probing your asscheeks, leaking cum all over them!\n\n", false);

			Render.text("You turn your head, look back, and gasp. You expected to see a latex cock molesting your backdoor, but instead see a latex tentacle brushing cum against your anus. What is this machine planning to do?!\n\n", false);

			Render.text("It doesn't take long for your " + assholeDescript() + " to be slathered in cum, the machine pressing on your muscular ring with the tip of its tentacle cock, starting to fill your ass with its prehensile member. Inch after inch slips inside of you, each humming ring of the cock stroking your anus as it fills your ass, vibrating deep inside of you.", false);
			player.buttChange(30,true,false,true);
			Render.text("  You moan, closing your eyes and enjoying the pleasure, only to have a second tentacled cock thrust into your mouth, and down your throat. It doesn't take long for them both to begin thrusting, vibrating in both your holes.\n\n", false);
