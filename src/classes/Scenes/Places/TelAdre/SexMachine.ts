...
private useTheSexMachine():void {
	...
	if(player.gender == 1) {
		if(flags[FlagEnum.TIMES_USED_SEX_MACHINE_AS_MALE] == 0) {
			...
			MainScreen.text("It takes little time for " + sMultiCockDesc() + " to grow hard, your lust betraying you as another phallic shaped metallic length is presented in front of your face. A small shock is delivered to your " + assholeDescript() + ", causing you to gasp, and allowing the phallic length to slip deep into your mouth, giving you little choice but to suck on the device. The tube-like length on your " + cockDescript(0) + " continues its assault, humming and stroking your firm cock, starting to suck softly to pleasure your mighty rod; so much that you nearly don't notice as a small tube slips into the tip of your penis, beginning to slowly devour your leaking pre-cum.\n\n", false);
			...
			if(player.lowerBody.balls > 0) MainScreen.text("your " + ballsDescriptLight() + " pulling up tightly ", false);
	...
	//[If you decide to mess with the machine, female:]
		...
		//[Female repeat scene]
			...
			MainScreen.text("The cool air makes your nipples stand out, and you notice a pleasant surprise: the cocks slipping between your ass-cheeks and thighs are made of a soft, but firm, latex.  They warm as they leak cum on your " + assholeDescript() + " and labia. You blush, willingly opening your mouth for the cock in front of you.  Sucking it in to taste the heady seed, you close your eyes, enjoying the ride as your labia softly part, wet and ready for the intruding member.\n\n", false);

			MainScreen.text("You moan lustfully as the members slip into your " + vaginaDescript() + " and " + assholeDescript() + ", filling you deeply.", false);
			player.cuntChange(30,true,true,false);
			player.buttChange(30,true,true,false);
	...
	//[Hermaphrodite]
		...
		if(flags[FlagEnum.TIMES_USED_SEX_MACHINE_AS_HERM] == 0) {
			...
			player.cuntChange(30,true,true,false);
			player.buttChange(30,true,true,false);
			MainScreen.text("  You moan lustfully, your girly juices beginning to flow down your thighs as the cock begins to thrust deep inside of you.  The metallic sleeve on your member thrusts down around you, even as the machine penetrates your " + vaginaDescript() + ". It's almost as if you were fucking your own cunt!\n\n", false);
