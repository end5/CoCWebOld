...
private function heckelLovesDaAnal(loss:boolean = false):void {
	...
	if(player.lowerBody.cockSpot.hasCock() && player.lowerBody.vaginaSpot.hasVagina()) outputText(SMultiCockDesc() + " is trapped between you and the wooden bench, and you know Heckel won't let you shift position to free it. Your " + vaginaDescript(0) + " is also being ignored, and having so much pleasure with so little stimulation is driving you crazy. You hump weakly up and down, trying to draw some pleasure out of the bench beneath you while simultaneously pushing her rolling and massaging tongue closer to your aching slit, but she ignores you and only licks deeper. She buries her face in your ass entirely, her cold nose and teeth rubbing up against your sensitive skin as her tongue pushes as far inside of you as she can get it.\n\n", false);
	
	//[<IF PC HAS PENIS>
	else if(player.lowerBody.cockSpot.hasCock()) outputText(SMultiCockDesc() + " is trapped between you and the wooden bench, and you know Heckel won't let you shift position to free it. You hump weakly at the bench in a desperate attempt to get some stimulation, and you can feel the vibrations of Heckel's laugh as she buries her snout in your ass. She doesn't stop you, but the polished wood barely gives any pleasure anyway.\n\n", false);

	//[<IF PC HAS VAGOO>
	else if(player.lowerBody.vaginaSpot.hasVagina()) outputText("Your snatch starts to ache while moisture runs down your groin, and you groan at the lack of attention it's receiving. If Heckel notices, she doesn't react and keeps swirling her tongue around your hole. You push weakly backwards, hoping to make her drop her tongue down a few inches, but she instead takes this as an opportunity to bury her snout fully between your ass cheecks, her tongue slipping inside you deeper than before.\n\n", false);
...
private function heckelLovesAnal2():void {
	...
	//[<IF PC HAS PENIS AND VAGOO>
	if(player.lowerBody.cockSpot.hasCock() && player.lowerBody.vaginaSpot.hasVagina()) outputText("Although " + sMultiCockDesc() + " is trapped beneath you, Heckel's balls slap into your cunt with every one of her quickening thrusts.  Although neither your " + multiCockDescriptLight() + " or " + vaginaDescript(0) + " are getting much stimulation, your prostate is being milked better than it ever has. One thrust in particular makes you cry out, and Heckel laughs above you as she slams her furry thighs into yours again. \"<i>You moan like a whore, " + player.short + ", a perfect bitch for me to ride.</i>\"\n\n", false);

	//[<IF PC HAS PENIS AND BALLS> 
	else if(player.lowerBody.cockSpot.hasCock() && player.lowerBody.balls > 0) outputText(SMultiCockDesc() + " pulses beneath you with every thrust, her duo of fist-sized balls slapping into your " + ballsDescriptLight() + ". You gasp in surprise as one of her thrusts rubs against your prostate, and she barks out a single laugh above you. \"<i>You moan like a whore, " + player.short + ", a perfect bitch for me to ride.</i>\"\n\n", false);

	//[<IF PC HAS VAGOO>
	else if(player.lowerBody.vaginaSpot.hasVagina()) outputText("Heckel's fist-sized balls slap against your ass and grind your snatch with every thrust, driving you crazy with the desperate need to be filled. You moan in anguish, pushing yourself towards her with every thrust, desperate to milk as much stimulation out of her as possible. She laughs above you, but rewards you with harder and faster thrusts. \"<i>You moan like a whore, " + player.short + ", a perfect bitch for me to ride.</i>\"\n\n", false);
	...
	//[<MALE PC>
	else if(player.lowerBody.cockSpot.hasCock()) outputText("Heckel wastes no time before going back to her brutal fucking, though her thrusts are limited to short bursts now. She makes up for this in speed as you lie helplessly below her, the pain of taking her knot slowly turning into intense pleasure. The heat and pleasure spreads from your ass to your " + ballsDescriptLight() + " and cock, making it twitch at your impending orgasm. Heckel cries out above you and slams her hips into you as much as she can, and you immediately feel a burning heat shooting up your gut. She pumps again as she seeds your insides with another spurt, and this time you orgasm along with her.  Your " + ballsDescriptLight() + " get tight as your trapped " + Appearance.cockNoun(CockType.HUMAN) + " twitches, shooting your cum up between your stomach and chest. Your legs quiver beneath hers as the warmth spread further up your gut, leading you into a warm and hazy afterglow.\n\n", false);
	//[<FEMALE PC>
	else if(player.lowerBody.vaginaSpot.hasVagina()) outputText("Heckel wastes no time before going back to her brutal fucking, though her thrusts are limited to short bursts now. She makes up for this in speed as you lie helplessly below her, the pain of taking her knot slowly turning into intense pleasure. The heat and pleasure spreads from your ass to your entire groin, and the knot pushes against the walls of your " + vaginaDescript() + " hard enough to make them rub against each other. Heckel cries out above you and slams her hips into you as much as she can, and you immediately feel a burning heat shooting up your gut. She pumps again as she seeds your insides with another spurt, and this time you orgasm along with her. Your " + vaginaDescript(0) + " spasms and gushes over your soaked thighs, your asshole spasming around her cock just as much. Your legs quiver beneath hers as the warmth spread further up your gut, leading you into a warm and hazy afterglow.\n\n", false);
...
public function dominateHeckel():void {
	...
	if(flags[FlagEnum.TIMES_DOMMED_HECKEL] == 0) outputText("there's a new top dog just waiting to claim the town bitch");
	else outputText("you're back for a taste of your favorite bitch");
	outputText(".  Heckel snorts, \"<i>Nice try, fuck-meat, but ");
	if(flags[FlagEnum.TIMES_DOMMED_HECKEL] > 0) outputText("last time was a fluke");
	...
	if(flags[FlagEnum.TIMES_LOST_HECKEL_DOM_CHALLENGE] > 0) outputText(" again");
	...
	//{Win}
		...
		if(flags[FlagEnum.TIMES_DOMMED_HECKEL] > 0) outputText(" AGAIN");
		outputText("...</i>\"");
...
private function dominateHeckelConclusion():void {
	...
	if(flags[FlagEnum.PC_FETISH] > 0) outputText("You grin and blush hotly, imagining the whole of the gym watching you fuck this hyena, their watchful eyes exciting you further.");
	else if(player.stats.cor < 33) outputText("You blush a bit at that, uncomfortable at your sex being so public but unwilling to stop.");
	else if(player.stats.cor < 66) outputText("You smirk a little at that while barely acknowledge the worry of being caught nagging at your consciousness.");
	...
	if(player.lowerBody.cockSpot.count() > 2) outputText(", fanning the others across her neck and forehead, burying her in penis.");
	else if(player.lowerBody.cockSpot.count() == 2) outputText(", dropping your [cock smallest] alongside it over her eyes, burying her in penis.");
	...
	if(player.lowerBody.cockSpot.count() > 1) outputText("s throb and thicken");
	...
	if(player.lowerBody.cockSpot.biggestCocks[0].cockArea() > 40) outputText("as much of it as possible");
	else outputText("it");
	...
	if(player.lowerBody.balls > 0) outputText(", basting your [balls] with her steaming warmth");
	else if(player.lowerBody.vaginaSpot.hasVagina()) outputText(", basting your [vagina] with her steaming warmth");
	...
	if(player.lowerBody.cockSpot.count() > 1) {
		...
		if(player.lowerBody.cockSpot.count() > 2) outputText("s contribute");
	...
	if(silly()) {
		...
		if(flags[FlagEnum.UNKNOWN_FLAG_NUMBER_00281] > 0) outputText(", then give Lottie a high five");
