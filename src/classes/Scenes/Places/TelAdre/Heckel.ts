...
public function greetHeckel():void {
	...
	if(flags[FlagEnum.MET_HECKEL] == 0) {
		...
		Render.text("When she draws up to you, she slows down long enough to have a conversation.  She smiles at you with a grin that manages to show every single fang, and you realize she caught you staring.  \"<i>Fresh meat, huh? I'm Heckel, the alpha dog around here.</i>\"  She extends a large paw toward you as she wipes her face.  You ignore the sweat as you shake hands and introduce yourself.\n\n", false);
	
		Render.text("\"<i>So, " + player.short + ", what can I do for you?  The person working the desk can give you a tour if that's what you need... or maybe you were looking for a training partner?  If you can keep up with me, of course.</i>\"\n\n", false);
...
private function heckelTraining():void {
	...
	//FOLLOWUP SECKZ
		...
		Render.text("You know the drill as you follow Heckel into the locker room. You watch her undress before she walks into the shower room, admiring the way her toned ass moves in counterpoint to her tail. She shoots you a fang-filled grin as she disappears around the corner, and you use the opportunity to shed your own clothes.\n\n", false);

		Render.text("By the time she comes back into the locker room, you're completely naked. She doesn't bother to cover herself as she towels her fur off, making the coarse hair stand on end in more than a few places. She tosses the towel aside as she passes you, her black cock already bobbing between her legs. She sits down on one of the simple wooden benches and pats the spot next to her, beckoning you over.\n\n", false);

		Render.text("\"<i>I'm not gonna mince words,</i>\" she says with a snicker. \"<i>I need a good fuck and I need it right now. I promise, this is going to be as much of a workout as hitting the track.</i>\" As you sit down next to her, she runs a paw up your back and along your neck, eventually draping it over your shoulders. \"<i>Now then partner, how are you gonna take this?</i>\"\n\n", false);
		if(player.str > 50 && player.lowerBody.cockSpot.hasCock()) {
			Render.text("You feel pretty strong yourself, and you realize you could probably arm wrestle this hyena-bitch down to size.");
			dom = dominateHeckel;
		}
		//ORAL or LEAVE
...
private function heckelLovesDaAnal(loss:boolean = false):void {
	...
	if(player.analCapacity() <= 20 && !loss) {
		Render.text("Heckel lets out a barking laugh when you suggest using your " + assDescript() + ", ruffling your hair playfully. \"<i>Know your limits, " + player.short + ", I'd tear you apart down there. I'm sure there are plenty of others in this realm who can help you out with that.</i>\"\n\n", false);
		doNext(camp.returnToCampUseOneHour);
		return;
	}
	//success - requires ass to be 'a little loose'
	Render.text("Heckel's eyes flash as her grin splits her face, and for just a moment you wonder if this might have been a bad idea. Before you can object, however, she's pushing you down onto your stomach, your arms and " + player.legs() + " draped over either side of the wooden bench.\n\n", false);

	Render.text("You half expect her to just shove herself in right there, but she thankfully holds off. Instead, you feel her rough paws grab and knead either side of your " + buttDescript() + " as she lets out a low growl.", false);
	//[<IF TONE OVER 80>
	if(player.tone >= 80) Render.text("  \"<i>Damn " + player.short + ", you've got one hell of an ass. I bet it's gonna feel even better than it looks.</i>\"", false);
	//[<IF TONE BETWEEN 60-79>
	else if(player.tone >= 60) Render.text("  \"<i>Mmm, not bad " + player.short + ", not perfect, but not bad.</i>\"", false);
	Render.text("\n\n", false);
	
	Render.text("One hand releases your " + buttDescript() + " and you can hear the sound of her stroking herself. You start to turn your head around to watch, but she firmly presses you back down against the bench. \"<i>Now now partner, I told you to stay there. When you're the alpha dog around here, then you can make the rules.</i>\" Deciding this treatment isn't so bad anyway, you relax and let her hand continue to knead your " + buttDescript() + ".\n\n", false);

	Render.text("The sound of her stroking stops, and you bite your lower lip. You feel the bench shift beneath you as she changes position, and a moment later she pulls both of your asscheeks apart to expose your " + assholeDescript() + ". You tense for the inevitable penetration, but instead of a hard cockhead poking at your backdoor you feel something warm and wet. Heckel is licking you!\n\n", false);

	Render.text("Her large tongue feels like sandpaper as it licks up and down your anus, your spread cheeks exposing you to the world. You can feel her wet nose on your sensitive skin, and the contrast with her warm tongue makes you shiver. Her tongue pokes and prods at your " + assholeDescript() + " before slipping painlessly in, swirling expertly around before pulling out and licking some more.\n\n", false);

	//[<IF PC HAS PENIS AND VAGOO> 
	if(player.lowerBody.cockSpot.hasCock() && player.lowerBody.vaginaSpot.hasVagina()) Render.text(SMultiCockDesc() + " is trapped between you and the wooden bench, and you know Heckel won't let you shift position to free it. Your " + vaginaDescript(0) + " is also being ignored, and having so much pleasure with so little stimulation is driving you crazy. You hump weakly up and down, trying to draw some pleasure out of the bench beneath you while simultaneously pushing her rolling and massaging tongue closer to your aching slit, but she ignores you and only licks deeper. She buries her face in your ass entirely, her cold nose and teeth rubbing up against your sensitive skin as her tongue pushes as far inside of you as she can get it.\n\n", false);
	
	//[<IF PC HAS PENIS>
	else if(player.lowerBody.cockSpot.hasCock()) Render.text(SMultiCockDesc() + " is trapped between you and the wooden bench, and you know Heckel won't let you shift position to free it. You hump weakly at the bench in a desperate attempt to get some stimulation, and you can feel the vibrations of Heckel's laugh as she buries her snout in your ass. She doesn't stop you, but the polished wood barely gives any pleasure anyway.\n\n", false);

	//[<IF PC HAS VAGOO>
	else if(player.lowerBody.vaginaSpot.hasVagina()) Render.text("Your snatch starts to ache while moisture runs down your groin, and you groan at the lack of attention it's receiving. If Heckel notices, she doesn't react and keeps swirling her tongue around your hole. You push weakly backwards, hoping to make her drop her tongue down a few inches, but she instead takes this as an opportunity to bury her snout fully between your ass cheecks, her tongue slipping inside you deeper than before.\n\n", false);

	Render.text("Even with only a few inches inside your ass, her tongue makes you moan almost immediately. She rolls in back and forth, then side to side, then pushes it in and out before starting the cycle over. The teasing becomes more and more unbearable until you're ready to abandon caution and begin masturbating, but just as you tense to change position she stops and pulls her tongue out suddenly.\n\n", false);
	//NEXT
...
private function heckelLovesAnal2():void {
	...
	Render.text("You open your mouth to gasp as she slides into you, but no sounds come out. You can feel inch after inch penetrate you, your asshole slowly stretching to accommodate her increasing thickness. She pushes as much as she can into you before pulling back slightly, then humping lightly as she works the rest in little by little.", false);
	player.buttChange(28,true,true,false);
	Render.text("\n\n", false);

	Render.text("As more and more doggie dick is pushed into your ass, you find your estimations of her size more and more ridiculous. There has to be an entire foot of cock in you already, but she's still going! When she does finally bottom out, your mind reels at the impossibility. Her dick must grow the longer she stays aroused, because she's at least 15 inches right now! The base of her dick stretches your ass painfully open, and she gives you a moment to adjust to it.", false);
	player.buttChange(35,true,true,false);
	Render.text("\n\n", false);
	
	Render.text("Just as the sting begins to fade, she draws herself out to the tip in one motion. You bite your lip in anticipation, but you still moan like a whore when she slams all 15 inches back into you. She draws back before pounding your " + assholeDescript() + " again, making your " + buttDescript() + " shake with the impact.\n\n", false);

	//[<IF PC HAS PENIS AND VAGOO>
	if(player.lowerBody.cockSpot.hasCock() && player.lowerBody.vaginaSpot.hasVagina()) Render.text("Although " + sMultiCockDesc() + " is trapped beneath you, Heckel's balls slap into your cunt with every one of her quickening thrusts.  Although neither your " + multiCockDescriptLight() + " or " + vaginaDescript(0) + " are getting much stimulation, your prostate is being milked better than it ever has. One thrust in particular makes you cry out, and Heckel laughs above you as she slams her furry thighs into yours again. \"<i>You moan like a whore, " + player.short + ", a perfect bitch for me to ride.</i>\"\n\n", false);

	//[<IF PC HAS PENIS AND BALLS> 
	else if(player.lowerBody.cockSpot.hasCock() && player.lowerBody.balls > 0) Render.text(SMultiCockDesc() + " pulses beneath you with every thrust, her duo of fist-sized balls slapping into your " + ballsDescriptLight() + ". You gasp in surprise as one of her thrusts rubs against your prostate, and she barks out a single laugh above you. \"<i>You moan like a whore, " + player.short + ", a perfect bitch for me to ride.</i>\"\n\n", false);

	//[<IF PC HAS VAGOO>
	else if(player.lowerBody.vaginaSpot.hasVagina()) Render.text("Heckel's fist-sized balls slap against your ass and grind your snatch with every thrust, driving you crazy with the desperate need to be filled. You moan in anguish, pushing yourself towards her with every thrust, desperate to milk as much stimulation out of her as possible. She laughs above you, but rewards you with harder and faster thrusts. \"<i>You moan like a whore, " + player.short + ", a perfect bitch for me to ride.</i>\"\n\n", false);
	...
	Render.text("You lay on the bench for a few moments as Heckel ruffles your hair again. \"<i>Not bad, partner. You're the best fuck I've had in years, you know that? Not to mention the best workout!</i>\"\n\n", false);
	
	Render.text("She laughs as she stands and heads for the shower, letting you clean yourself up and head back to camp.", false);
	player.orgasm();
	dynStats("sen", 4);
...
public function dominateHeckel():void {
	...
	else Render.text("you're back for a taste of your favorite bitch");
	Render.text(".  Heckel snorts, \"<i>Nice try, fuck-meat, but ");
	if(flags[FlagEnum.TIMES_DOMMED_HECKEL] > 0) Render.text("last time was a fluke");
	else Render.text("I'm always on top");
	Render.text(".  If you want a squealing submissive to ride, the Wet Bitch is that way,</i>\" pointing towards the exit.  Her flaccid dog-dong twitches a little but remains defiantly soft.");
	...
	if(flags[FlagEnum.TIMES_LOST_HECKEL_DOM_CHALLENGE] > 0) Render.text(" again");
	Render.text("?</i>\"  Her tough finger-tip slams into your solar plexus for emphasis");
	if(player.tou < 60) Render.text(", pushing you back a bit");
	Render.text(".");
	...
	//{Lose}
	if(player.str < 75) {
		Render.text("Even with your mighty struggling, you cannot overcome the relentless hyena, and your shaking hand is forced down, eventually pressed flat into the wood.");
...
private function dominateHeckelConclusion():void {
	...
	if(flags[FlagEnum.PC_FETISH] > 0) Render.text("You grin and blush hotly, imagining the whole of the gym watching you fuck this hyena, their watchful eyes exciting you further.");
	else if(player.stats.cor < 33) Render.text("You blush a bit at that, uncomfortable at your sex being so public but unwilling to stop.");
	else if(player.stats.cor < 66) Render.text("You smirk a little at that while barely acknowledge the worry of being caught nagging at your consciousness.");
	else Render.text("You grin widely at that and secretly hope that the whole gym will come in to see their 'alpha' laid low.");
	Render.text("  Never stopping their probing motions, your fingertips dance through the hyena's sopping passageway, caressing the underswell of her virile nutsack, and occasionally brush the sensitive fur along her inner thighs.  Heckel is squirming and writhing atop the table, dominated by the mere twitches of your digits, a panting bitch in heat just begging for rough impalement on [oneCock].");
	Render.text("\n\nStepping to the side but never leaving the hyena's arousal-engorged box empty, you flop your [cock biggest] across her nose");
	if(player.lowerBody.cockSpot.count() > 2) Render.text(", fanning the others across her neck and forehead, burying her in penis.");
	else if(player.lowerBody.cockSpot.count() == 2) Render.text(", dropping your [cock smallest] alongside it over her eyes, burying her in penis.");
	else Render.text(", draping her in hard penis.");
	Render.text("  She whimpers as you rub your sensitive underside across her nose and pouting lips, looking up at you with what you imagine was supposed to be hatred.  It looks like lust instead.  Slowly stroking yourself while you diddle her, your manhood");
	if(player.lowerBody.cockSpot.count() > 1) Render.text("s throb and thicken");
	else Render.text(" throbs and thickens");
	Render.text(" further, too turned on to stop even if you wanted to.  You command her to open with a terse word.  She does, and you slide inside.");
	...
	if(player.cumQ() < 250) Render.text("single drop");
	else if(player.cumQ() < 1000) Render.text("steady drip");
	else Render.text("never-ending flow");
	Render.text(" of pre-cum onto the muscle-girl's tongue.  Her body wriggles happily in acceptance, twitching around your knuckles.  A nice, sticky puddle of her own pre has formed on her well-defined abdominals, still connected to its spigot by a web of glittering, translucent love-juice.  Whimpering, Heckel fairly hums with need, the vibrations of her hungry protests bouncing through your [cock biggest] pleasantly.");
	...
	if(player.lowerBody.cockSpot.biggestCocks[0].cockArea() > 40) Render.text("as much of it as possible");
	else Render.text("it");
	Render.text(" down her throat.  Heckel's eyes bulge in disbelief, wildly looking left and right.  Her teeth come down, just barely pricking the skin of your [cock biggest] in warning.  You twist her nipple in a retaliatory strike, opening her throat up with a moaning shriek.");
	...
	if(player.lowerBody.balls > 0) Render.text(", basting your [balls] with her steaming warmth");
	else if(player.lowerBody.vaginaSpot.hasVagina()) Render.text(", basting your [vagina] with her steaming warmth");
	else Render.text(", basting your " + player.skin() + " with her steaming warmth");
	Render.text(".  You give her a knowing smile, " + player.mf("man","'woman'") + " to woman, and rock forward, sliding through her puffy labia and into her silky canal.  Those wet hyena-lips cling to every vein and rigid nook of your " + cockDescript(x) + ", slurping your penis down the slick tunnel with hungry undulations.");
	...
	if(player.cumQ() > 500) {
		Render.text("  Your potent virility does a superb job of seeding Heckel's womb, stuffing it nice and full while streamers of white escape around your girth.");
		if(player.cumQ() >= 1000) Render.text("  Still, you keep blasting wad after wad of spunk inside her, and her belly rounds nicely, puffed up with virile sperm.");
		if(player.cumQ() >= 2000) Render.text("  Your spooge is seemingly without end, pouring out endlessly long after she's spunk-gravid and nearly immobile.  The rivers that run from her abused cunt-lips quickly turn the table into a puddle.");
		if(player.cumQ() >= 3000) {
			Render.text("  That puddle then drips to the floor to make an alabaster lake");
			if(player.cumQ() >= 4000) {
				Render.text(" at least ");
				if(player.cumQ() < 10000) Render.text("a foot deep");
				else if(player.cumQ() < 15000) Render.text("knee high by most measurements");
				else if(player.cumQ() < 20000) Render.text("waist high");
				else Render.text("as high as the table");
			}
			Render.text(".  Thank the gods for drains.");
		}
	}
	if(player.lowerBody.cockSpot.count() > 1) {
		Render.text("  Your other member");
		if(player.lowerBody.cockSpot.count() > 2) Render.text("s contribute");
		else Render.text(" contributes");
		Render.text(" as well, turning her hips and thighs into a wonderland of ivory-soaked fur.");
	}
	...
	if(silly()) {
		Render.text("  You grab a bacon shake from the shake-cart on your way out");
		if(flags[FlagEnum.UNKNOWN_FLAG_NUMBER_00281] > 0) Render.text(", then give Lottie a high five");
		Render.text(".  You really love bacon.");
	}
	player.orgasm();
	dynStats("sen", -2);
	doNext(camp.returnToCampUseOneHour);
