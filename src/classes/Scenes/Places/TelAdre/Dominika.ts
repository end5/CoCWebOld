...
private function acceptDominikasKnowledge():void {
	...
	if(flags[FlagEnum.UNKNOWN_FLAG_NUMBER_00150] == 2) {
		...
		if(player.stats.int >= 80) outputText("Not due to lack of intellect, but due to lack of time.  You're all too aware of your mental skill.  ", false);
...
private function fellatrixSexWarmup():void {
	...
	//(If breasts)
	if(player.upperBody.chest.BreastRatingLargest[0].breastRating >= 1) outputText("They briefly run down to the top of your " + breastDescript(0) + " before returning to your collar.  ", false);
	//First time
	if(flags[FlagEnum.UNKNOWN_FLAG_NUMBER_00150] == 2)	outputText("\"<i>I have not been unaffected by this land. I have certain... dietary needs.</i>\" She coughs slightly, glancing aside and looking as though she's doing her very best not to blush.\n\n", false);
	//Repeat
	...
	//[If \"<i>Yes</i>\" and penis small enough to suck]
		...
		//Human/fallback wang
			...
			if(flags[FlagEnum.UNKNOWN_FLAG_NUMBER_00151] == 0) {
				...
				//(if player has balls)
				if(player.lowerBody.balls > 0) outputText("Meanwhile her mouth slips down your dick, planting a few kisses along the way before reaching your " + sackDescript() + ". Her dark lips press against each of your " + ballsDescriptLight() + " in turn, granting each her moist smooch. She exhales warmly over them, teasing the cumfactories with a grin. Her mouth slips partially over one, her tongue slipping around the soft flesh. She is gentle and delicate in her administrations, and you feel comfortable about your " + sackDescript() + " sitting in her warm mouth – though you would prefer she wrap those plump lips around something else. Your head continues to be stimulated by her soft palm, and now adds pre-cum to the saliva she slowly spreads. A grunt makes her smirk, lifting from your " + sackDescript() + " and sliding her lips slowly up your dick.\n\n", false);
...
private function dominikaBlowjobs():void {
	...
	if(player.stats.cor < 50) outputText("Though you still feel ill at ease restrained like this you have to admit that Dominika has never done you wrong, and you should be safe in her home.", false);
	...
	//(if penis)
	if(player.lowerBody.cockSpot.hasCock()) outputText("caressed your dick.", false);
...
private function dominikaBlowjobs2():void {
	...
	if(flags[FlagEnum.UNKNOWN_FLAG_NUMBER_00157] == 1 || flags[FlagEnum.UNKNOWN_FLAG_NUMBER_00157] == 4) outputText("At the same time, you get the sense that perhaps it's for the best you did so.", false);
