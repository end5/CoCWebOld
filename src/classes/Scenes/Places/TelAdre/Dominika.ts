...
public fellatrixBarApproach():void {
	...
	MainScreen.text(images.showImage("dominika-first-meeting-at-bar"));
	...
	if(player.minoScore() >= 3 && player.faceType == FACE.COW_MINOTAUR && player.gender == 1) {
		MainScreen.text("You approach the woman, delivering what you consider a polite greeting. Icily she turns to you, raises an eyebrow, and in a low husky voice snarls \"<i>Don't bother. I'm not interested in being your bimbo.</i>\" She turns away from you, and ignores any further attempts to start a conversation.\n\n", false);

		MainScreen.text("A tavern maid with shaggy dreadlocks and a long tongue she can barely fit in her mouth waves you over. \"<i>Don't wowwy 'bout Dominika,</i>\" she says through her lisp, \"<i>The's a liddle wacist against, you know, your type. Thays you're only interethted in wape. Motht of uth aren't like dat.</i>\"\n\n", false);

		MainScreen.text("You nod slightly, glancing back at Dominika, then shrug.", false);
		//TO THE BAR
		cheatTime(1);
	...
	//Second encounter]
		...
		MainScreen.text("\"<i>Although...</i>\" she seems to think about something, glancing over at you for a few seconds. After a pause, she adds \"<i>If you'd like, my place is just a few blocks down, I could... impart some knowledge on you there.</i>\"\n\n", false);
	...
	//[Follow-up Introduction]
		...
		MainScreen.text("You make your way over to Dominika's table and strike up conversation with the modestly dressed woman. Her eyes give away her smile and the two of you discuss your exploits. She doesn't attempt to hide the casual way she ogles you during the conversation, and after a brief while, she invites you back to her place.", false);
		simpleChoices("Sure", acceptDominikasKnowledge, "No Thanks", turnDownDominikasKnowledge, "", null, "", null, "", null);
		return;
	}
	MainScreen.text("ERROR, ERROR, ALERT THE FENFEN!", true);
	doNext(camp.returnToCampUseOneHour);
}
//[\"<i>No thanks</i>\"]
private turnDownDominikasKnowledge():void {
	spriteSelect(10);
	MainScreen.text("", true);
	MainScreen.text("\"<i>Fair enough,</i>\" Dominika nods. \"<i>Let me know if you change your mind.</i>\" The two of you make small talk for a while longer, before you decide to get back to work and excuse yourself.\n\n", false);
	cheatTime(1);
	doNext(telAdre.barTelAdre);
}
//[\"<i>Sure</i>\"]
private acceptDominikasKnowledge():void {
	...
	if(flags[FlagEnum.UNKNOWN_FLAG_NUMBER_00150] == 2) {
		...
		MainScreen.text("Dominika smiles with her eyes again. She leaves some payment on the table, then escorts you out into the desert city. The familiar sights along the journey to her abode rush by, nearly forgotten as you ply her with questions and eagerly anticipate ", false);
		if(!fellatrixSucked()) MainScreen.text("learning more arcane lore.", false);
		else MainScreen.text("getting to feel those black lips on your skin once again.", false);
		MainScreen.text("  You let her lead the way inside, and oogle her pale bare legs as she climbs up before you follow.\n\n", false);

		MainScreen.text("The inside of her place is unchanged; it's full of books, tomes, and parchments scattered over numerous desks and shelves.  With her tutelage you're able to recognize some of them, but you doubt you'll ever have her encyclopedic knowledge.  ", false);
		if(player.stats.int >= 80) MainScreen.text("Not due to lack of intellect, but due to lack of time.  You're all too aware of your mental skill.  ", false);
		MainScreen.text("Dominika unwinds her turban and lets her hair fall free.  She even undoes her top, revealing the curves of her breasts and her strange tattoos.  Despite the revelation of her multiple intricate tattoos, your eyes find themselves drawn elsewhere once again. Nearly pitch black, her lips shine with moisture and sit plump and full on her face. It says a great deal about their prominence that between them and the fact that she stands topless before you, you stare at her face!\n\n", false);
	}

	//If no dominika cooldown up
	if(flags[FlagEnum.UNKNOWN_FLAG_NUMBER_00155] == 0) {
		flags[FlagEnum.UNKNOWN_FLAG_NUMBER_00155] = 7 + rand(3);
		MainScreen.text("\"<i>Now then,</i>\" she says. Her hands glow with a brief sense of power, and many of the tattoos shine with equal illumination. She gestures with her hand and the lamps all acquire an unearthly light, as green glowing circles appear interlinked on the floor. \"<i>How much do you know about magic?</i>\"\n\n", false);
		...
		if(player.stats.spellCount() == 6) {
			if(flags[FlagEnum.UNKNOWN_FLAG_NUMBER_00154] == 0) {
				...
				MainScreen.text("You blink, then casually mention that you actually know quite a bit about magic. Dominika listens to you explain your skill in white and black magic, then coughs awkwardly and glances to the side. \"<i>O-oh,</i>\" she says, \"<i>Well. Uhm. I guess we can talk about magical theory, maybe?</i>\"\n\n", false);
			}
			else MainScreen.text("You blink, then casually mention that you actually know quite a bit about magic. Dominika smiles, curling those glistening black lips into an even more erotic shape as she replies, \"<i>Oh I know sweety.  Why don't we discuss the theory behind it all?</i>\"\n\n", false);
			MainScreen.text("Magical theory is not very interesting, but you do feel smarter for discussing it.", false);
				//(Player receives Intelligence.)
			dynStats("int", 1+rand(4));
		}
		//[If player knows some spells]
		else if(player.stats.spellCount() > 0) {
			MainScreen.text("You take a step backwards in surprise, but your experience with magic makes you realize that she's not doing anything dangerous. You explain that you've learned a bit of sorcery from books, and she nods thoughtfully. \"<i>I see,</i>\" she muses, stroking her chin. \"<i>I think I may be able to show you a thing or two. Let's see here...</i>\"\n\n", false);

			MainScreen.text("Dominika seems to be quite good at magic, and you find yourself picking up the spell she demonstrates fairly quickly.", false);
			...
			else MainScreen.text("==SOMETHING FUCKED UP.  TELL FEN VIA EMAIL (fenoxo@gmail.com) OR POST ON THE BUG FORUMS==", false);
			dynStats("int", 2);
		}
		//[If player knows no spells]
		else {
			MainScreen.text("You nearly fall on your " + buttDescript() + " in surprise, fumbling to defend yourself from an attack, but Dominika laughs helplessly and tries to collect herself. \"<i>Oh goodness, oh I'm sorry, I'm sorry, this isn't anything. This is just flashy lights and constellation circles. This isn't going to hurt you, I'm sorry.</i>\" She walks over to you and extends a hand, helping you get to your feet and hugging you.\n\n", false);

			MainScreen.text("\"<i>So sorry, again,</i>\" she says, those black lips curving into a big smile. \"<i>I guess I'll take that to mean 'not much', so, here. Let me show you some things.</i>\"\n\n", false);

			MainScreen.text("Even with your inexperience, you find Dominika to be a good teacher. She helps you focus and train your mind, and you quickly find your first spell to be easy to perform.", false);
			//(Player receives random unlearned spell.)
			if(player.findStatusAffect(StatusAffects.KnowsMight) < 0) {
				player.statusAffects.add(new StatusAffect("KnowsMight",0,0,0,0)));
				MainScreen.text("\n\n<b>New Black Magic Spell Learned: Might</b>", false);
...
private fellatrixSexWarmup():void {
	...
	//Cooldown ongoing!
	if(flags[FlagEnum.UNKNOWN_FLAG_NUMBER_00155] > 0) {
		MainScreen.text("Dominika glances out the window nervously and says, \"<i>I don't think you're ready to learn more yet – your mind still needs time to absorb the knowledge from our last meeting.</i>\"  Her tongue slowly slides over the glistening black surface of her lower lip and her voice becomes a little more husky as she offers, \"<i>Why don't we talk about something else?</i>\"\n\n", false);
	}
	//No cooldown, knowledge get epilogue
	else {
		MainScreen.text("Dominika glances out the window. \"<i>That, I think, is more than enough for now.</i>\" She rubs her hands together, letting the room return to more normal lighting. Looking back at you she pauses, thinking to herself, then speaks again. \"<i>Now, there is something that you could do for me.</i>\"\n\n", false);
	}

	MainScreen.text("She walks towards you, resting her hands on your collarbone.  ", false);
	//(If breasts)
	if(player.upperBody.chest.BreastRatingLargest[0].breastRating >= 1) MainScreen.text("They briefly run down to the top of your " + breastDescript(0) + " before returning to your collar.  ", false);
	//First time
	if(flags[FlagEnum.UNKNOWN_FLAG_NUMBER_00150] == 2)	MainScreen.text("\"<i>I have not been unaffected by this land. I have certain... dietary needs.</i>\" She coughs slightly, glancing aside and looking as though she's doing her very best not to blush.\n\n", false);
	//Repeat
	else MainScreen.text("\"<i>You know what I need,</i>\" She coughs slightly, glancing aside and looking as though she's doing her very best not to blush.\n\n", false);

	MainScreen.text("Breathing in, she turns back to you and smiles. \"<i>Would it be all right with you if I put my mouth on your genitals", false);
	if(fellatrixSucked()) MainScreen.text(" again", false);
	MainScreen.text("?</i>\"\n\n", false);

	//[If genderless]
	if(player.gender == 0) {
		MainScreen.text("You politely explain that you don't actually have any genitals. Dominika blinks, looks at you, then grabs your crotch. \"<i>Oh. Oh. My uh, my apologies.</i>\" She coughs awkwardly and backs up, rubbing the back of her neck. \"<i>That... that is unfortunate.</i>\" She lowers her skirt slightly, letting you see the top of a chastity belt. \"<i>I can understand to a certain degree but uh... Yikes. At least I can get this taken off if I want.</i>\"\n\n", false);

		MainScreen.text("She walks up to you and kisses your cheek. Her full dark lips are devilishly soft and perfectly moist, and you think of the sensation for longer than you expected.  Patting your shoulder, she gives you a half-smile. \"<i>If you solve that, come back some time, eh?</i>\" She helps you out the door and waves goodbye, but you can't help but feel particularly awkward.\n\n", false);
		doNext(camp.returnToCampUseOneHour);
		return;
	}
...
private declineFellatrixOralHARDCORE():void {
	spriteSelect(58);
	MainScreen.text("", true);
	MainScreen.text("\"<i>Really?</i>\" she asks again. \"<i>But, I mean... fucking look at these!</i>\" She purses her dark lips, running her tongue over them to emphasize how they glisten in the light. \"<i>Don't tell me you don't think these would feel fucking rad on you.</i>\"\n\nIt's VERY tempting.  Maybe one little round of fellatio?", false);
...
private declineFellatrixOralSUPERHARDCORE():void {
	spriteSelect(58);
	MainScreen.text("", true);
	MainScreen.text("Dominika stares at you incredulously, then turns away. \"<i>Fine. Just go then. You know where the door is.</i>\" She walks away into another room, closing the door behind her.\n\n", false);

	MainScreen.text("You let yourself out.", false);
...
private acceptFellatrixOral():void {
	spriteSelect(58);
	MainScreen.text("", true);
	MainScreen.text(images.showImage("dominika-oral-sex"));
	...
	//[If \"<i>Yes</i>\" and penis small enough to suck]
		...
		//Human/fallback wang
			...
			if(flags[FlagEnum.UNKNOWN_FLAG_NUMBER_00151] == 0) {
				MainScreen.text("Dominika smiles, taking your hand and leading you to another room. Within is a surprisingly rich-looking bed, and she encourages you to sit down. \"<i>Thank you,</i>\" she says, and immediately follows it up with a truly wicked grin. \"<i>Now to make you realize you should be thanking me.</i>\"\n\n", false);
				...
				MainScreen.text("After a bit of small talk, she glances out the window, and suggests you get back to your adventuring. She kisses you once more as you go, and you taste those dark curves on your lips as you return to camp.", false);
			}
	...
	//[If \"<i>Yes</i>\" and penis too big to suck]
		...
		if(flags[FlagEnum.UNKNOWN_FLAG_NUMBER_00152] == 0) {
			MainScreen.text("A surprisingly big grin spreads across Dominika's face and she takes your hand, leading you to a side room. Within is a very comfortable looking bed, and she encourages you to sit down upon the covers. \"<i>Excellent,</i>\" she says, before grinning just a little wickedly, \"<i>Now to break you upon my knee and leave you gasping for more.</i>\" You don't have words for that one. At least she's confident.\n\n", false);
...
private agreeWithDominika():void {
	...
	dynStats("cor", 2);
	if(flags[FlagEnum.NUMBER_OF_TIMES_MET_SCYLLA] > 0) {
		MainScreen.text("You pause for a moment, then nod. Dominika's lips curl in a grin that manages to be both sinister and playful at the same time, running a hand over your shoulder before suddenly and aggressively straddling your lap. She bends down to you, biting your lip just barely lightly enough to not draw blood. Her hand caresses down the side of your head and your neck almost possessively.  The action turns into a kiss of some small passion, the smell of your crotch still fresh on her breath as those slippery ebon pillows graze over your own inferior display. She breathes heavily over you, looking in your eyes and filling your vision with her own blue eyes.\n\n", false);

		MainScreen.text("\"<i>I knew you were strong when I saw you,</i>\" she purrs softly. Though the folds of her skirt cover the belt you can feel its steel firmness pressing into your lap. \"<i>And through you, I can recover the strength stolen from me.</i>\" Her hand runs along your " + hairDescript() + " before she climbs off you, glancing out the window. \"<i>You should go though,</i>\" she says, \"<i>It's late.</i>\" There's a pause, before she says something she's never said before. \"<i>I look forward to seeing you again.</i>\"\n\n", false);

		MainScreen.text("You think about her lips on the streets of Tel'Adre.", false);
	}
	else {
		MainScreen.text("You look at her for a moment, then nod.  Dominika's lips curl in a grin that manages to be both sinister and playful at the same time, running a hand over your shoulder before suddenly and aggressively stepping forward.  She presses you against the wall and ", false);
		if(player.tallness < 64) MainScreen.text("leans down", false);
		else MainScreen.text("pushes herself up", false);
		MainScreen.text(", biting your lip just barely lightly enough to not draw blood.  Her hand caresses down the side of your head and your neck almost possessively.  You can feel her knee pressing in between your legs, grinding into your ", false);
		...
		MainScreen.text(".  The action turns into a kiss of some small passion, the smell of your crotch still fresh on her breath as those slippery ebon pillows graze over your own inferior display.  She breathes heavily against you, looking in your eyes and filling your vision with her own blue eyes.\n\n", false);

		MainScreen.text("\"<i>I knew you were strong when I saw you,</i>\" she purrs softly.  Though the folds of her skirt cover the belt she is close enough that you can feel the firmness of its steel pressing against you.  \"<i>And through you, I can recover the strength stolen from me.</i>\"  Her hand runs along your " + hairDescript() + " before she relaxes off you, glancing out the window.  \"<i>You should go though,</i>\" she says, \"<i>It's late.</i>\"  There's a pause, before she says something she's never said before.  \"<i>I look forward to seeing you again.</i>\"\n\n", false);
...
private ehhhhDominika():void {
	spriteSelect(58);
	MainScreen.text("", true);
	MainScreen.text("You make a small grunt, not even sitting up. Dominika's eyebrows lower after a time, and a bored but amused expression comes to her features. \"<i>I suppose I shouldn't bother asking you anything after we're done, mm?</i>\" She seems content to amuse herself with this telling of events, and you don't question it. \"<i>Well, you should get going soon,</i>\" she says, turning back to her mirror and adjusting her hair. \"<i>You don't want to walk through the desert too late at night. Do visit again.</i>\"\n\n", false);
	...
	MainScreen.text("Still, that was some magnificent oral. You idly recall the sensations of those dark lips as you walk through Tel'Adre.\n\n", false);
...
private disagreeDominika():void {
	...
	if(flags[FlagEnum.NUMBER_OF_TIMES_MET_SCYLLA] > 0) {
		...
		MainScreen.text("Conflicted, you find yourself walking away from Dominika's apartment without ever thinking about her lips for the first time.", false);
	}
	else {
...
private dominidramaYes():void {
	...
	MainScreen.text("Weary, you continue on your way out of Tel'Adre.", false);
...
private dominidramaNo():void {
	MainScreen.text("", true);
	MainScreen.text("You think about the woman you have laid with, about her soft form, her laughter, and most of all those deep, curving lips. There's only one action you feel you could take, and you calmly say that no, you have not heard of anything or anyone fitting the description given. \"<i>I see,</i>\" the plant woman says, though her glowing eyes seem to linger on you with an uncertain meaning. She shouldn't have any reason to disbelieve you, should she?\n\n", false);
	...
	MainScreen.text("She turns to leave down the street, then pauses and turns back to you. \"<i>Where are you from, anyway?</i>\" she asks, \"<i>I don't recognize your accent.</i>\" You mention your home. \"<i>Ingnam? Hmm. Never heard of it.</i>\" She shrugs lightly, then leaves.\n\n", false);

	MainScreen.text("You feel warm inside, filled with a confidence that seemed to come out of nowhere. You can imagine Dominika's dark lips in your mind smiling, opening and curving as if to say \"<i>Good work.</i>\" The thought empowers you. It feels good to protect her, you think to yourself. You stride confidently out of the city.", false);
...
private dominikaBlowjobs():void {
	...
	if(player.lowerBody.cockSpot.hasCock()) {
		if(player.cockArea(x) <= 36) {
			...
			MainScreen.text("You cum. You didn't realize  how strong, how good it could feel when she sucked – you couldn't, until now.  The eruption splatters into her throat, and you imagine the strands of your cum clinging and dripping down the delicious throat-cunt you're so hungry to fill.  You have to cum for her, you're so fucking horny, so eager to dump everything your balls have into her.  As she pulls off of your softening prick (the very sensation of her lips gliding off of your head fills you with a certain disappointment) and your entire body heaves with your panting, you hear her chuckle.  \"<i>Good " + player.mf("boy","girl") + ",</i>\" Dominika says. \"<i><b>Again.</b></i>\"\n\n", false);
			...
			MainScreen.text("\"<i><b>Again.</b></i>\"", false);
		}
	}
	else {
...
private dominikaBlowjobs2():void {
	spriteSelect(58);
	MainScreen.text("", true);
	MainScreen.text("Groaning, you roll over, sitting up in your bedroll.  The rays of the sun hitting your face feel particularly unwelcome.  You're not sure what you drank last night, but given your hangover you must have done so.\n\n", false);
	MainScreen.text("After a lot of water, you feel a little better.  Something nags at the back of your mind, an itch you can't quite scratch but persistently remains.  You feel as though you've forgotten something important, and perhaps even essential, but cannot think of any clues as to what.  ", false);
	//[Agreed with Dominika]
	if(flags[FlagEnum.UNKNOWN_FLAG_NUMBER_00157] == 1 || flags[FlagEnum.UNKNOWN_FLAG_NUMBER_00157] == 4) MainScreen.text("At the same time, you get the sense that perhaps it's for the best you did so.", false);
	//[Disagreed/Neutral with Dominika]
	else MainScreen.text("It deeply bothers you, leaving a sense of anxiety behind that you don't know how to deal with. You'll have to just hope something comes along that reminds you.", false);
