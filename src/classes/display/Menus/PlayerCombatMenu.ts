...
export default class CharacterCombatMenu implements Menu {
    ...
    private showAction(button: number, character: Character, action: CombatAction, flag: CombatAbilityFlag) {
