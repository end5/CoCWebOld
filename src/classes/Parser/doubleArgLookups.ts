		...
		public let cockLookups:Object = // For subject: "cock"
		{
		...
		public let cockHeadLookups:Object = // For subject: "cockHead"
		{
		...
		public let twoWordNumericTagsLookup:Object =
		{
				"cockfit":
					function(thisPtr:*, aspect:*):*
					{
						if(!kGAMECLASS.player.lowerBody.cockSpot.hasCock()) return "<b>(Attempt to parse cock when none present.)</b>";
						else
						{
				...
				"cockheadfit":
					function(thisPtr:*, aspect:*):*
					{
						if (!kGAMECLASS.player.lowerBody.cockSpot.hasCock())
						{
				...
				"cockheadfit2":
					function(thisPtr:*, aspect:*):*
					{
						if(!kGAMECLASS.player.lowerBody.cockSpot.hasCock()) return "<b>(Attempt to parse cockhead when none present.)</b>";
						else {
				...
				"cock":
					function(thisPtr:*, aspect:*):*
					{
						...
						{
							if(aspect-1 >= 0 && aspect-1 < kGAMECLASS.player.lowerBody.cockSpot.count()) return kGAMECLASS.player.cockDescript(aspect - 1);
				...
				"cockhead":
					function(thisPtr:*, aspect:*):*
					{
						...
						{
							let intAspect: number = int(aspect - 1);
							if (intAspect >= 0 && intAspect < kGAMECLASS.player.lowerBody.cockSpot.count()) return kGAMECLASS.player.cockHead(intAspect);
		...
		public let twoWordTagsLookup:Object =
		{
			// NPCs:
			"rubi"		: rubiLookups,
			"arian"		: arianLookups,
