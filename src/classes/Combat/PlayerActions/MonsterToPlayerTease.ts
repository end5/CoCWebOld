...
export default class MonsterToPlayerTease {
    public use(player: Player, monster: Character): void {
        if (player.stats.lust < 35) {
            MainScreen.text("The " + monster.desc.short + " press in close against you and although they fail to hit you with an attack, the sensation of their skin rubbing against yours feels highly erotic.");
        }
        else if (player.stats.lust < 65) {
            MainScreen.text("The push of the " + monster.desc.short + "' sweaty, seductive bodies sliding over yours is deliciously arousing and you feel your ");
            ...
            MainScreen.text("As the " + monster.desc.short + " mill around you, their bodies rub constantly over yours, and it becomes harder and harder to keep your thoughts on the fight or resist reaching out to touch a well lubricated cock or pussy as it slips past.  You keep subconsciously moving your ");
