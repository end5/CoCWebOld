    ...
    public use(player: Player, monster: Character) {
        ...
        if (hitChance >= Utils.rand(100)) {
            ...
            if (Utils.rand(4) > 0) {
                ...
                damage = Math.floor(player.stats.str + horns.amount * 2 - Utils.rand(monster.stats.tou) - monster.combat.stats.defense());
            }
            // CRIT
            else {
                // doubles horn bonus damage
                damage = Math.floor(player.stats.str + horns.amount * 4 - Utils.rand(monster.stats.tou) - monster.combat.stats.defense());
            ...
            if (player.inRut && monster.torso.cocks.count > 0) {
