...
export default class Fantasize implements CombatAction {
    ...
    public use(character: Character, monster: Character) {
        ...
        else if (character.torso.balls.quantity > 0 && character.torso.balls.size >= 10 && Utils.rand(2) === 0) {
        ...
        else if (character.torso.chest.sort(BreastRow.BreastRatingLargest)[0].rating >= 6 && Utils.rand(2) === 0) {
        ...
        else if (character.torso.chest.sort(BreastRow.LactationMultipierLargest)[0].lactationMultiplier >= 6 && Utils.rand(2) === 0) {
