...
export default class Wait implements CombatAction {
    ...
    public use(character: Character, monster: Character) {
        ...
        if (monster.combat.effects.has(CombatEffectType.MinotaurEntangled)) {
            ...
            DisplayText().clear();
            const damageTaken = character.combat.stats.loseHP(80 + Utils.rand(40), monster);
            ...
            if (character.torso.cocks.count > 0)
                ...
                DisplayText("The creature continues probing at your asshole and has now latched " + Utils.numToCardinalText(character.torso.chest.countNipples()) + " more suckers onto your nipples, amplifying your growing lust.  You must escape or you will become a mere toy to this thing!");
