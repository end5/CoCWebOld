...
export default class Struggle implements CombatAction {
    ...
    public use(character: Character, monster: Character) {
        if (monster.statusAffects.has(StatusAffectType.MinotaurEntangled)) {
            ...
            monster.kitsuneStruggle() as Kitsune;
        }
            ...
            // Fail to break free
                ...
                else DisplayText("The creature continues probing at your asshole and has now latched " + Utils.numToCardinalText(character.torso.chest.countNipples()) + " more suckers onto your nipples, amplifying your growing lust.  You must escape or you will become a mere toy to this thing!");
