...
export default class PlayerFantasize {
    public use(player: Player, monster: Character) {
        ...
        if (player.inventory.armorSlot.equipment.displayName == "goo armor") {
            ...
            if (player.gender > 0) DisplayText.text(" and genitals");
            ...
            DisplayText.text("You aren't sure if it's just the fantasy, but your " + BallsDescriptor.describeBalls(true, true, player) + " do feel fuller than before...\n");
