    ...
    public update(character: Character): string {
        if (enemyChar.stats.lustVuln > 0 && character.stats.cor >= 70) {
            if (enemyChar.stats.lust < 50) return "Your aura seeps into " + enemyChar.desc.a + enemyChar.desc.short + " but does not have any visible effects just yet.\n\n";
                ...
                if (!enemyChar.desc.plural) DisplayText.text(enemyChar.desc.capitalA + enemyChar.desc.short + " starts to squirm a little from your unholy presence.\n\n");
                else DisplayText.text(enemyChar.desc.capitalA + enemyChar.desc.short + " start to squirm a little from your unholy presence.\n\n");
            }
                ...
                if (!enemyChar.desc.plural) DisplayText.text(enemyChar.desc.capitalA + enemyChar.desc.short + "'s skin colors red as " + enemyChar.desc.subjectivePronoun + " inadvertantly basks in your presence.\n\n");
                else DisplayText.text(enemyChar.desc.capitalA + enemyChar.desc.short + "' skin colors red as " + enemyChar.desc.subjectivePronoun + " inadvertantly bask in your presence.\n\n");
            }
            else {
