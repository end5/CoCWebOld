...
export class DriderKiss extends CombatEffect {
    public update(character: Character) {
        ...
        if (character.combat.effects.get(CombatEffectType.DriderKiss).value1 == 0) {
            ...
            DisplayText.text("Your heart hammers a little faster as a vision of the drider's nude, exotic body on top of you assails you.  It'll only get worse if she kisses you again...");
        }
        //(VENOM OVER TIME: MEDIUM)
            ...
            DisplayText.text(out + "  Gods, her venom is getting you so hot.  You've got to end this quickly!");
        }
        //(VENOM OVER TIME: MAX)
        else {
