...
export class WebSilence extends StatusAffect {
    ...
    public combatUpdate(character: Character): string {
        if (character.statusAffects.get(StatusAffectType.WebSilence).value1 >= 2 || Utils.rand(20) + 1 + character.stats.str / 10 >= 15) {
            ...
            character.statusAffects.get(StatusAffectType.WebSilence).value1++;
