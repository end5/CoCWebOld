		...
		//Scylla + dom + dong
			...
			if(player.gender <= 1) {
				...
				//Male Trap Dream #2: 
					...
					if(player.lowerBody.cockSpot.hasCock()) outputText("  [EachCock] is fully erect and throbbing.");
					else if(player.lowerBody.vaginaSpot.hasVagina()) outputText("  Your [vagina] dripping wet with need.");
