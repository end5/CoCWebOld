...
public function updatePregnancy():boolean {
	...
	if (player.pregnancyIncubation > 1) {
		...
		if (player.pregnancyType == PregnancyType.IMP) {			
			...
			if(player.pregnancyIncubation == 216) {
				...
				if(player.stats.cor < 40) outputText("You are distressed by your unwanted pregnancy, and your inability to force this thing out of you.</b>", false);
				if(player.stats.cor >= 40 && player.stats.cor < 75) outputText("Considering the size of the creatures you've fucked, you hope it doesn't hurt when it comes out.</b>", false);
				if(player.stats.cor >= 75) outputText("You think dreamily about the monstrous cocks that have recently been fucking you, and hope that your offspring inherit such a pleasure tool.</b>", false);
			...
			if(player.pregnancyIncubation == 72) {
				...
				if(player.stats.cor < 40) outputText("making it difficult to function.</b>", false);
				if(player.stats.cor >= 40 && player.stats.cor < 75) outputText("and you wonder how much longer you have to wait.</b>", false);
				if(player.stats.cor >= 75) outputText("and you're eager to give birth, so you can get impregnated again by corrupted or monstrous cum filling out your eager womb.</b>", false);
				outputText("\n", false);
			...
			if(player.pregnancyIncubation == 48) {
				...
				if(player.stats.cor < 40) outputText("Afterwards you feel somewhat disgusted with yourself.</b>\n", false);
				if(player.stats.cor >= 40 && player.stats.cor < 75) outputText("You estimate you'll give birth in the next few days.</b>\n", false);
				if(player.stats.cor >= 75) outputText("You find yourself daydreaming about birthing demons repeatedly, each time being re-impregnated by your hordes of lusty adolescent children.</b>\n", false);
				displayedUpdate = true;
			}
		}
		//Minotaur Pregnancy!
		if (player.pregnancyType == PregnancyType.MINOTAUR) {			
			...
			if(player.pregnancyIncubation == 72) {
				...
				if(player.stats.cor < 40) outputText("making it difficult to function.</b>", false);
				if(player.stats.cor >= 40 && player.stats.cor < 75) outputText("and you wonder how much longer you have to wait.</b>", false);
				if(player.stats.cor >= 75) outputText("and you're eager to give birth, so you can get impregnated again by monstrous cocks unloading their corrupted seed directly into your eager womb.</b>", false);
				outputText("\n", false);
				dynStats("spe", -3, "lib", 1, "sen", 1, "lus", 4);
				displayedUpdate = true;
			}
			if(player.pregnancyIncubation == 48) {
				...
				if(player.stats.cor < 40) outputText("Afterwards you feel somewhat disgusted with yourself.</b>\n", false);
				if(player.stats.cor >= 40 && player.stats.cor < 75) outputText("You estimate you'll give birth in the next few days.</b>\n", false);
				if(player.stats.cor >= 75) outputText("You find yourself daydreaming about birthing some huge monstrous beast, and raising it to fuck your wet pussy over and over.</b>\n", false);
			}
			if(player.pregnancyIncubation == 32 || player.pregnancyIncubation == 64 || player.pregnancyIncubation == 85 || player.pregnancyIncubation == 150) {
				displayedUpdate = true;
				//Increase lactation!
		...
		if (player.pregnancyType == PregnancyType.BUNNY) {
			...
			if(player.pregnancyIncubation == 156) {
				outputText("\n<b>The unmistakable bulge of pregnancy is visible in your tummy.  ", false);
				if(player.stats.cor < 40) outputText("You are distressed by your unwanted pregnancy, and your inability to force this thing out of you.</b>", false);
				if(player.stats.cor >= 40 && player.stats.cor < 75) outputText("You find yourself wondering what giving birth to bunny-girls is like.</b>", false);
				if(player.stats.cor >= 75) outputText("You dreamily wonder if you could find a bunny willing to put more than two eggs inside you at once.</b>", false);
				dynStats("spe", -1, "lib", 1, "sen", 1, "lus", 2);
				outputText("\n", false);
				displayedUpdate = true;				
			}
			...
			if(player.pregnancyIncubation == 72) {
				...
				if(player.stats.cor < 40) outputText("making it difficult to function.</b>", false);
				if(player.stats.cor >= 40 && player.stats.cor < 75) outputText("and you wonder how much longer you have to wait.</b>", false);
				if(player.stats.cor >= 75) outputText("and you're eager to give birth so you'll be able to get pregnant again.</b>", false);
				outputText("\n", false);
				dynStats("spe", -3, "lib", 1, "sen", 1, "lus", 4);
				displayedUpdate = true;
			}
			if(player.pregnancyIncubation == 48) {
				...
				if(player.stats.cor < 40) outputText("Afterwards you feel somewhat disgusted with yourself.</b>\n", false);
				if(player.stats.cor >= 40 && player.stats.cor < 75) outputText("You estimate you'll give birth in the next few days.</b>\n", false);
				if(player.stats.cor >= 75) outputText("You find yourself daydreaming about birthing bunnies repeatedly, each time being re-impregnated with dozens of eggs from your lusty adolescent children.</b>\n", false);
				displayedUpdate = true;
			}
		}
		//Marblz Pregnancy!
		if (player.pregnancyType == PregnancyType.MARBLE) {			
			...
			if(player.pregnancyIncubation == 72) {
				...
				if(player.stats.cor < 40) outputText("making it difficult to function.</b>", false);
				if(player.stats.cor >= 40 && player.stats.cor < 75) outputText("and you wonder how much longer you have to wait.</b>", false);
				if(player.stats.cor >= 75) outputText("and you're eager to give birth, so you can get fill your womb with a new charge.</b>", false);
				outputText("\n", false);
				dynStats("spe", -3, "lib", 1, "sen", 1, "lus", 4);
				displayedUpdate = true;
			}
		...
		if (player.pregnancyType == PregnancyType.MOUSE || player.pregnancyType == PregnancyType.JOJO) {
			...
			if(player.pregnancyIncubation == 48) {
				...
				if(player.stats.cor < 40) outputText("Afterwards you feel somewhat disgusted with yourself.</b>\n", false);
				if(player.stats.cor >= 40 && player.stats.cor < 75) outputText("You estimate you'll give birth in the next few days.</b>\n", false);
				if(player.stats.cor >= 75) outputText("You find yourself daydreaming about birthing hundreds of little babies, and lounging around while they nurse non-stop on your increasingly sensitive breasts.</b>\n", false);				
			}
			if(player.pregnancyIncubation == 32 || player.pregnancyIncubation == 64 || player.pregnancyIncubation == 85 || player.pregnancyIncubation == 150) {
				//Increase lactation!
				if(player.upperBody.chest.BreastRatingLargest[0].breastRating >= 3 && player.mostBreastsPerRow() > 1 && player.biggestLactation() >= 1 && player.biggestLactation() < 2) {
		...
		if (player.pregnancyType == PregnancyType.AMILY) {
			...
			if(player.pregnancyIncubation == 216) {
				...
				if(flags[FlagEnum.AMILY_FOLLOWER] == 1) outputText("  Amily smiles at you reassuringly. \"<i>We do have litters, dear, this is normal.</i>\"", false);
				outputText("</b>", false);
				outputText("\n", false);
				dynStats("spe", -1, "lib", 1, "sen", 1, "lus", 2);
				displayedUpdate = true;				
		...
		if (player.pregnancyType == PregnancyType.SPIDER || player.pregnancyType == PregnancyType.DRIDER_EGGS) {	
			...
			if(player.pregnancyIncubation == 180) {
				...
				if (player.pregnancyType == PregnancyType.SPIDER) outputText("spider-morphs ", false);
			...
			if(player.pregnancyIncubation == 72) {
				...
				if(player.stats.cor < 50) outputText("  You shudder and shake your head, wondering why you're thinking such unusual things.", false);
				outputText("</b>\n", false);
				displayedUpdate = true;
			}
			if(player.pregnancyIncubation == 32 || player.pregnancyIncubation == 64 || player.pregnancyIncubation == 85 || player.pregnancyIncubation == 150) {
		...
		if (player.pregnancyType == PregnancyType.ANEMONE) {			
			...
			if(player.pregnancyIncubation == 185) {
				outputText("\n<b>The unmistakable bulge of pregnancy is visible in your tummy.  ", false);
				if(player.stats.cor < 40) outputText("You are distressed by your unwanted pregnancy, and your inability to force this thing out of you.</b>", false);
				if(player.stats.cor >= 40 && player.stats.cor < 75) outputText("Considering the possible fathers, you hope it isn't that big.</b>", false);
				if(player.stats.cor >= 75) outputText("You think dreamily about the cocks that have recently been fucking you, and hope that your offspring inherit such a divine pleasure tool.</b>", false);
				dynStats("spe", -1, "lib", 1, "sen", 1, "lus", 2);
				outputText("\n", false);
				displayedUpdate = true;				
			}
			...
			if(player.pregnancyIncubation == 120) {
				...
				if(player.lowerBody.vaginaSpot.hasVagina()) outputText(" and keeps your " + vaginaDescript(0) + " aroused from the constant tingling in your womb", false);
				outputText(".</b>\n", false);
			...
			if(player.pregnancyIncubation == 72) {
				...
				if(player.stats.cor < 40) outputText("and constantly shifts and wriggles.  What manner of beast are you bringing into the world?</b>", false);
				if(player.stats.cor >= 40 && player.stats.cor < 75) outputText("and you wonder how much longer you have to wait.</b>", false);
				if(player.stats.cor >= 75) outputText("and you're eager to give birth, so you can get impregnated again by corrupted or monstrous cum filling out your eager womb.</b>", false);
				outputText("\n", false);
			...
			if(player.pregnancyIncubation == 48) {
				outputText("\n<b>You rub your hands over your bulging belly, lost in the sensations of motherhood.  ", false);
				if(player.stats.cor < 40) outputText("Afterwards you feel somewhat disgusted with yourself, but horny.</b>\n", false);
				if(player.stats.cor >= 40 && player.stats.cor < 75) outputText("You estimate you'll give birth in the next few days.  You hope the birth is as erotically charged as the pregnancy has been.</b>\n", false);
				if(player.stats.cor >= 75) outputText("You find yourself daydreaming  about birthing cilia-covered worms, orgasming each time their thousands of stingers brush by your clit and fill it full of sensation-enhancing drugs.</b>\n", false);
		...
		//Frog Eggs
			...
			if(player.pregnancyIncubation == 8) {
				...
				if(player.lowerBody.vaginaSpot.hasVagina()) {
					...
					//pussy:
					if(player.lowerBody.vaginaSpot.hasVagina()) outputText("  Against your [vagina], the slime feels warm and cold at the same time, coaxing delightful tremors from your [clit].");
					//[balls:
					else if(player.lowerBody.balls > 0) outputText("  Slathered in hallucinogenic frog slime, your balls tingle, sending warm pulses of pleasure all the way up into your brain.");
					//genderless: 
	...
	if(player.buttPregnancyIncubation > 1) {
		if (player.buttPregnancyType == PregnancyType.FROG_GIRL) {
			if(player.buttPregnancyIncubation == 8) {
				...
				//[cock:
				else if(player.lowerBody.cockSpot.hasCock()) outputText("  Splashing against the underside of your " + player.multiCockDescriptLight() + ", the slime leaves a warm, oozy sensation that makes you just want to rub [eachCock] over and over and over again.");
				//genderless: 
		...
		if (player.buttPregnancyType == PregnancyType.BEE_EGGS) {
			...
			if(player.buttPregnancyIncubation == 20) {
				...
				if(player.lowerBody.cockSpot.count() > 0) outputText("The aroma seems to permeate your very being, slowly congregating in your ", false);
				...
				if(player.lowerBody.cockSpot.count() > 1) outputText("groin.  Your " + player.multiCockDescriptLight() + " fill and grow with every lungful of the stuff you breathe in.  You suck in great lungfuls of the tainted air, desperate for more, your cocks twitching and dripping with need.  ", false);
		...
		if (player.buttPregnancyType == PregnancyType.SANDTRAP || player.buttPregnancyType == PregnancyType.SANDTRAP_FERTILE) {
			if(player.buttPregnancyIncubation == 36) {
				...
				if(player.buttPregnancyType == PregnancyType.SANDTRAP_FERTILE) outputText(" bloated and full; the sensation isn't entirely unpleasant.");
				else {
	...
	if (player.buttPregnancyIncubation == 1 && player.buttPregnancyType == PregnancyType.BEE_EGGS) {
		...
		if(player.lowerBody.cockSpot.count() > 0) outputText("The muzzy feeling that fills your head seems to seep downwards, making your equipment hard and tight.  ", false);
		if(player.lowerBody.vaginaSpot.count() > 0) outputText("Your " + vaginaDescript(0) + " becomes engorged and sensitive.  ", false);
		...
		if(player.averageLactation() >= 1 && player.upperBody.chest.BreastRatingLargest[0].breastRating > 2) outputText("Seeking even greater sensation, your hands gather the honey and massage it into your " + breastDescript(0) + ", slowly working up to your nipples.  Milk immediately begins pouring out from the attention, flooding your chest with warmth.  ", false);
		...
		if(player.stats.cor < 35) outputText("You are disgusted, but glad you were not stung during the ordeal.  You stagger away and find a brook to wash out your mouth with.", false);
		if(player.stats.cor >= 35 && player.stats.cor < 65) outputText("You are amazed you could lay so many eggs, and while the act was strange there was something definitely arousing about it.", false);
		if(player.stats.cor >= 65 && player.stats.cor < 90) outputText("You stretch languidly, noting that most of the drugged honey is gone.  Maybe you can find the Bee again and remember to bottle it next time.", false);
		if(player.stats.cor >= 90) outputText("You lick your lips, savoring the honeyed residue on them as you admire your thousands of children.  If only every night could be like this...\n", false);
		player.buttKnockUpForce(); //Clear Butt Pregnancy
		player.orgasm();
	...
	if (player.pregnancyType == PregnancyType.ANEMONE && player.pregnancyIncubation == 1) {
		...
		//[(if pc has 0-9 existing cocks)
			...
			//[(if cocks)
			if(player.lowerBody.cockSpot.count() > 0) outputText(" below your " + player.multiCockDescriptLight(), false);
			...
			//[(dick slot 1 exists)
			if(player.lowerBody.cockSpot.count() > 0) outputText("  The tentacles writhe around, rubbing against your " + player.multiCockDescriptLight(), false);
			//(doesn't exist)
			...
			if(player.totalCocks() == 1 && player.lowerBody.balls == 0) outputText("; you feel a pressure build below the shaft, near your asshole", false);
			...
			//[(if boobs)
			if(player.upperBody.chest.BreastRatingLargest[0].breastRating >= 1) outputText(allBreastsDescript() + " and ", false);
			outputText("stomach", false);
			//[(dick1 exists)
			if(player.lowerBody.cockSpot.count() > 1) outputText(", followed in short order by white squirts from " + player.sMultiCockDesc() + " remaining", false);
			outputText(".  Your " + vaginaDescript(0) + " quivers and pulses as well, adding ", false);
			if(player.vaginas[0].vaginalWetness < VAGINA_WETNESS.SLICK) outputText("a trickle", false);
			else if(player.vaginas[0].vaginalWetness < VAGINA_WETNESS.SLAVERING) outputText("a squirt", false);
	...
	if (player.pregnancyIncubation == 1 && player.pregnancyType == PregnancyType.IMP) {
		...
		if(player.stats.cor < 50) outputText("You rue the day you encountered that hateful imp.  ", false);
		...
		if(player.pregnancyIncubation == 1) {
			...
			if(player.statusAffects.get("Eggs").value2 == 0) {
				...
				//High quantity
					...
					if(player.lowerBody.vaginaSpot.list[0].clitLength > 5) outputText("jerking on your huge clitty as if it were a cock, moaning and panting as each egg slides free of your diminishing belly.  You lubricate it with a mix of your juices and the slime until ", false);
					if(player.lowerBody.vaginaSpot.list[0].clitLength > 2 && player.lowerBody.vaginaSpot.list[0].clitLength <= 5) outputText("playing with your over-large clit as if it were a small cock, moaning and panting as the eggs slide free of your diminishing belly.  You spread the slime and cunt juice over it as you tease and stroke until ", false);
					if(player.lowerBody.vaginaSpot.list[0].clitLength <= 2) outputText("pulling your folds wide and playing with your clit as another egg pops free from your diminishing belly.  You make wet 'schlick'ing sounds as you spread the slime around, vigorously frigging yourself until ", false); 
			...
			//Large egg scene
				...
				if(player.vaginas[0].vaginalLooseness < VAGINA_LOOSENESS.LOOSE) outputText("stretching your tight cunt painfully, the lips opening wide ", false);
				if(player.vaginas[0].vaginalLooseness >= VAGINA_LOOSENESS.LOOSE && player.vaginas[0].vaginalLooseness <= VAGINA_LOOSENESS.GAPING_WIDE) outputText("temporarily stretching your cunt-lips wide-open ", false);
				if(player.vaginas[0].vaginalLooseness > VAGINA_LOOSENESS.GAPING_WIDE) outputText("parting your already gaping lips wide ", false);
				...
				if(player.lowerBody.vaginaSpot.list[0].clitLength > 5) outputText("your massive cock-like clit, jacking it off with the slimy birthing fluids as lube.   It pulses and twitches in time with your heartbeats, its sensitive surface overloading your fragile mind with pleasure.  ", false);
				if(player.lowerBody.vaginaSpot.list[0].clitLength > 2 && player.lowerBody.vaginaSpot.list[0].clitLength <= 5) outputText("your large clit like a tiny cock, stroking it up and down between your slime-lubed thumb and fore-finger.  It twitches and pulses with your heartbeats, the incredible sensitivity of it overloading your fragile mind with waves of pleasure.  ", false);
				if(player.lowerBody.vaginaSpot.list[0].clitLength <= 2) outputText("your " + vaginaDescript(0) + " by pulling your folds wide and playing with your clit.  Another egg pops free from your diminishing belly, accompanied by an audible burst of relief.  You make wet 'schlick'ing sounds as you spread the slime around, vigorously frigging yourself.  ", false);
