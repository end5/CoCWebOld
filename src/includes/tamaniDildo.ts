...
public function sharkGirlGetsDildoed():void {
	...
	if(player.stats.cor > 50) outputText("latest ", false);
...
public function sandwitchGetsDildoed():void {
	...
	if(player.stats.cor > 50) outputText("lick it clean, ", false);
...
public function succubusGetsDildoed():void {
	...
	if(player.stats.cor < 50) outputText("in shame", false);
	...
	if(player.stats.cor > 75) outputText("giving it a long lick to taste the succubi's delicious flavor ", false);
