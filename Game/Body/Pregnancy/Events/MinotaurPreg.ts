...
export class MinotaurPregEvent implements IPregnancyEvent {
    ...
    public birthScene(player: Character, womb: Womb): void {
        ...
        MinotaurFlags.UNKNOWN_FLAG_NUMBER_00327++;
        if (MinotaurFlags.UNKNOWN_FLAG_NUMBER_00328 === 0) MinotaurFlags.UNKNOWN_FLAG_NUMBER_00328 = 150;
    }
}
