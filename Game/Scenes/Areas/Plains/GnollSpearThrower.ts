...
export class GnollSpearThrower extends Character {
    public constructor() {
        ...
        this.inventory.equipment.defaultWeaponSlot.equip(new Weapon("teeth" as WeaponName, undefined, "teeth", "bite", 0, 25));
