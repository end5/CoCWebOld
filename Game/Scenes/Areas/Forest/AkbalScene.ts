...
import { returnToCampUseOneHour, returnToCampUseEightHours } from "../../Camp";
...
export function akbalDefeated(player: Character, monster: Character, hpVictory: boolean): NextScreenChoices {
    AkbalFlags.AKBAL_SUBMISSION_STATE = 1;
    if (hpVictory) // [General Victory]
    {
        /*if(randInt(10) == 0) {
           CView.text("Akbal falls to the ground, but as you raise your " + player.inventory.equipment.weapon.displayName + " to deliver the final blow, a harsh ripping sound rends the air.  A dark form covered in burning violet light flies out of the jaguar's body; the demon has fled, leaving a corpse behind.  You have no doubt that the demon can gain another body, but it's best to take the old one with you to make sure it doesn't regain its form easily.");
    ...
    else // [Victory via Lust]
    {
        ...
        if (player.stats.lust >= 33 && player.gender > 0) {
            ...
            if (player.body.vaginas.length > 0) {
                vagoo = partial(girlsRapeAkbal, player, monster);
                vagooLick = rapeAkbalForcedFemaleOral;
            }
            if (player.body.vaginas.length > 0 && player.body.chest.sort(BreastRow.Largest)[0].rating >= 4 && player.inventory.equipment.armor.name === ArmorName.LustyMaidensArmor)
                bikiniTits = partial(lustyMaidenPaizuri, player, monster);
...
function rapeAkbalForcedFemaleOral(player: Character): NextScreenChoices {
    ...
    if (player.body.legs.isNaga()) {
        CView.text("akbal-deepwoods-naga-forcedfemaleoral");
        ...
        CView.text("With a sadistic laugh you ride out your orgasm until you're reduced to a shuddering heap on the floor.  After you've recovered you gather your " + player.inventory.equipment.armor.displayName + ", leaving Akbal in a groaning mess behind you.  He howls as he claws the ground, his barbed cock still rock hard beneath him.  Just as you begin to leave you notice a group of imps watching you and the jaguar demon, their cocks out and leaking as their jagged teeth spread into feral grins.  You even spy a few goblins mixed in the crowd, each twirling a bottle of liquid and playing with her snatch.\n\n");
    ...
    // Centaur RAPPUUUUU
        ...
        CView.text("akbal-deepwoods-taur-forcedfemaleoral");
        ...
        CView.text("With a sadistic laugh you ride out your orgasm until you're reduced to a shuddering heap.  After you've recovered you stand and gather your " + player.inventory.equipment.armor.displayName + ", leaving Akbal in a groaning mess behind you.  He howls as he claws the ground, his barbed cock still rock hard beneath him.  Just as you begin to leave you notice a group of imps watching you and the jaguar demon, their cocks out and leaking as their jagged teeth spread into feral grins.  You even spy a few goblins mixed in the crowd, each twirling a bottle of liquid and playing with her snatch.\n\n");

        CView.text("As you leave Akbal snarls as the creatures that once feared him use his overtly aroused state to get revenge on the \"god\" of the terrestrial fire.  Even after you've reached the edge of the forest the wails of the jaguar demon can still be heard but just barely over the high pitched laughter of the demon imps and goblin females.");
    }
    // Everybody else
    else {
        CView.text("akbal-deepwoods-forcedfemaleoral");
        ...
        CView.text("With a sadistic laugh you ride out your orgasm until you're reduced to a shuddering heap on the floor.  After you've recovered, you stand and gather your " + player.inventory.equipment.armor.displayName + ", leaving Akbal in a groaning mess behind you.  He howls as he claws the ground, his barbed cock still rock hard beneath him.  As you walk away, you notice a group of imps watching you and the jaguar demon with their cocks out and leaking, their jagged teeth spread into feral grins.  You even spy a few goblins mixed in the crowd, and each is twirling a bottle of liquid while playing with her snatches.\n\n");
...
function rapeAkbal(player: Character): NextScreenChoices {
    AkbalFlags.AKBAL_BITCH_Q++;
    let primary = player.body.cocks.find(Cock.CockThatFits(50));
    if (!primary)
        primary = player.body.cocks.get(0);
    CView.clear();
    // Naga RAPPUUUUUU
    if (player.body.legs.type === LegType.NAGA) {
        ...
        if (player.body.cocks.length > 0) {
            ...
            // (Md Penis: 8-12 inches)
                ...
                CView.text("After a dozen achingly slow thrusts Akbal's asshole begins to loosen and you begin to saw your " + describeCock(player, primary) + " in and out of his pucker with force as the demon cat's howls range from pained to pleased.\n\n");
            }
            ...
            // (Ending)
            CView.text("As you stand you gather your " + player.inventory.equipment.armor.displayName + " and turn to leave the weakened demon behind you.  Just as you begin to walk away you notice a group of imps watching you and the jaguar demon, their cocks out and leaking.  Mixed in with the crowd are several goblins, each with a vial of liquid and a malicious grin.\n\n");
        ...
        // (If the player has a vagina)
            ...
            CView.text("akbal-deepwoods-female-naga-rapeakbal");
            CView.text("As you uncoil you can't help but bump into the slimy leaking faucet Akbal calls his dick.  At your command he raises his hind quarters, allowing you a perfect view of his low hanging balls and sheath.  You reach around his fuzzy orbs and pull his swollen cock back until the jaguar demon's 15 inch pecker is visible.\n\n");
    ...
    // Centaur RAPPUUUUU
        ...
        // (If player has a dick)
        if (player.body.cocks.length > 0) {
            CView.text("akbal-deepwoods-male-taur-rapeakbal");
            // (Sm Penis: 7 inches or less)
            if (primary.length <= 7) {
            ...
            // (Md Penis: 8-12 inches)
                ...
                CView.text("After a dozen achingly slow thrusts Akbal's asshole begins to loosen and you begin to saw your " + describeCock(player, primary) + " in and out of his pucker.  The demon cat's howls range from pained to pleased, obviously enjoying his butt rape more than he is willing to admit.\n\n");
            }
            // (Lg Penis: 13 inches and up)
            else {
        ...
        // (If the player has a vagina)
            ...
            CView.text("akbal-deepwoods-female-taur-rapeakbal");
            CView.text("Akbal snarls as you shove him back first onto the forest ground.  You look down at him, fully prepared to have your way with his demon dick.  What you see causes your " + describeVagina(player, player.body.vaginas.get(0)) + " to flinch at the thought of what would have happened if you had lost and the demon had used that on you.\n\n");
    ...
    // [Player has a dick]
    if (player.body.cocks.length > 0) {
        CView.text("akbal-deepwoods-male-rapeakbal");
        ...
        if (player.body.cocks.get(0).area < 13) {
            CView.text("You first poke it with your finger, causing Akbal to flinch at the sensation.  Taking your " + describeCock(player, player.body.cocks.get(0)) + " in hand, you shove it in without hesitation or mercy.  The virgin-like hole clamps shut and Akbal hisses in pain as you force him open.  In no time at all you're sawing your " + describeCock(player, player.body.cocks.get(0)) + " in and out of the demon's tight hole, relishing in the way it quivers and squirms around your embedded " + describeCock(player, player.body.cocks.get(0)) + ".\n\n");
        }
        // [Medium penis (8-12 inches)]
        else if (player.body.cocks.get(0).area < 25) {
            CView.text("A light tap of your finger causes the tiny hole to constrict and Akbal's entire body flinches in fear.  You grab your " + describeCock(player, player.body.cocks.get(0)) + " with a cruel smile.  As you shove yourself into his tight pucker, you aren't surprised to find that your " + describeCock(player, player.body.cocks.get(0)) + " is barely able to breach the tightly sealed walls.  Grunting with effort you slowly inch forward, Akbal howling and squirming beneath you as he is taken without regard for his own pleasure.\n\n");
            CView.text("After a dozen achingly slow thrusts, Akbal's asshole begins to loosen and you start sawing your " + describeCock(player, player.body.cocks.get(0)) + " in and out of his pucker with force. The demon cat's howls fluctuate between yelps of pain and moans of pleasure.\n\n");
        }
        // [Large penis (13 inches and up)]
        else {
            CView.text("A single look tells you your " + describeCock(player, player.body.cocks.get(0)) + " won't fit... but since when has that stopped you from trying?  You slide a single finger against the virginally-tight hole and Akbal flinches. His already tight hole clamps shut in fear, as if doing so will somehow stop the inevitable intrusion.\n\n");
            CView.text("You twist Akbal's tail into your fist and laugh as a scared whimper escapes from the jaguar demon's throat.  You begin to push your " + describeCock(player, player.body.cocks.get(0)) + " in with one hand as you pull Akbal's tail with the other.  The demon whines and howls as you invade his clenching sphincter, forcibly stretching the tight pink hole to a dangerous degree.  You are halted all too soon, barely able to fit more than a foot of your " + describeCock(player, player.body.cocks.get(0)) + " into Akbal's virginally-tight hole.  Deciding that's good enough, you pull out before pushing forward again, meeting the same resistance as before.\n\n");
            CView.text("After what seems like hours of resistance and howling, Akbal's body shudders and his asshole relaxes from complete exhaustion.  Battling with your " + describeCock(player, player.body.cocks.get(0)) + " seems to have nearly made him pass out, and he no longer has the energy to resist you.  The jaguar demon's body flinches with your every thrust as you pound him raw – without lube, and without mercy.\n\n");
        }
        ...
        // [With Fertility/Lots of Jizz Perk]
        if (player.cumQ() > 1000) {
            CView.text("You continue to slide your still-swollen " + describeCock(player, player.body.cocks.get(0)) + " inside his quivering hole as you pump massive tons of liquid into the false god's stomach and bowels.  Beneath the two of you, his belly begins to bulge as he is filled to a dangerous degree.\n\n");
        ...
        CView.text("Standing up, you gather your " + player.inventory.equipment.armor.displayName + " and turn to leave the weakened demon behind you.  As you walk away, you notice a group of imps watching you and the jaguar demon with their cocks out and leaking.  Mixed in with the crowd are several goblins, each with a vial of liquid and a malicious grin.\n\n");
    ...
    // [Player has a vagina]
        ...
        CView.text("akbal-deepwoods-female-rapeakbal");
        CView.text("Akbal grunts as you smash his face into the ground.  At your command he raises his hind quarters, allowing you a perfect view of his low-hanging balls and sheath.  You reach around his fuzzy orbs and pull his swollen cock back until the jaguar demon's 15-inch pecker is visible.\n\n");
        CView.text("Your eyes widen when you see several wicked-looking barbs around his pre-pumping cockhead.  Instead of trying to deal with this massive phallus that looks like it was made to punish sinners, you walk around to the front of the creature.\n\n");
        CView.text("Your scent causes Akbal's growling to quiver.  You lay down before him, grabbing his head and smashing his furry lips into your " + describeVagina(player, player.body.vaginas.get(0)) + ".  The demon, unable to escape his debilitating arousal, begins to lap at your " + describeVagina(player, player.body.vaginas.get(0)) + ".  He twists his lips and drills his tongue into you, mercilessly attacking your " + describeClit(player) + ", and you scream, howl and cringe in ecstasy.  He begins to lift up, probably to get into position above you, but you force his face back down into your " + describeVagina(player, player.body.vaginas.get(0)) + ".  After dropping a line about how he has to make your cum or get his head ripped off, Akbal whines, obviously distressed at not being able to slip his aching member into your " + describeVagina(player, player.body.vaginas.get(0)) + ".\n\n");

        CView.text("With a sadistic laugh you ride out your orgasm until you're reduced to a shuddering heap on the floor.  After you've recovered, you stand and gather your " + player.inventory.equipment.armor.displayName + ", leaving Akbal in a groaning mess behind you.  He howls as he claws the ground, his barbed cock still rock hard beneath him.  As you walk away, you notice a group of imps watching you and the jaguar demon with their cocks out and leaking, their jagged teeth spread into feral grins.  You even spy a few goblins mixed in the crowd, and each is twirling a bottle of liquid while playing with their snatches.\n\n");
        CView.text("Akbal snarls as you leave, the creatures that once feared him using his aroused state to get revenge on the 'god' of the terrestrial fire.  Even after you've reached the edge of the forest, the jaguar demon's pained howls can still be heard – though, just barely over the high-pitched laughter of the demon imps and the cackling of the goblin females.");
    }
    player.orgasm();
    player.stats.cor += 1;
...
function girlsRapeAkbal(player: Character, monster: Character): NextScreenChoices {
    AkbalFlags.AKBAL_BITCH_Q++;
    CView.clear();
    ...
    // {If Centaur}
    CView.text("akbal-deepwoods-female-bindakbal");
    ...
    // {If Pussy is <loose}
    else if (player.vaginalCapacity() < monster.body.cocks.get(0).area) {
    ...
    // -Page Turn-
    return { next: partial(girlsRapeAkbalPart2, player, monster) };
}

function girlsRapeAkbalPart2(player: Character, monster: Character): NextScreenChoices {
    CView.clear();

    // Centaur
    CView.text("akbal-deepwoods-female-taur-bindakbal");
    if (player.body.legs.isTaur()) {
    ...
    // TOIGHT
        ...
        CView.text(" as he sags against the tree trunk, overwhelmed by the pleasure. With a satisfied grin of your own, you pick up your " + player.inventory.equipment.armor.displayName + " and head out. Perhaps you should look out for the \"<i>God of Terrestrial fire</i>\" again sometime...");
...
function loseToAckballllllz(player: Character) {
    // [Defeat via Lust]
    if (player.body.legs.type !== LegType.CENTAUR) {
        CView.text("akbal-deepwoods-losslust-analed");
    ...
    // Centaurs R SPECIALZ
        ...
        CView.text("akbal-deepwoods-losslust-taur-analed");
        ...
        displayStretchButt(player, (new Akbal()).body.cocks.get(0).area, true);
        CView.text("\n\n");
    ...
    if (player.body.butt.looseness < 3) // [Small/virgin pucker]
    {
    ...
    } else if (player.body.butt.looseness < 5) // [Medium pucker]
    {
...
// [First Encounter]
export function supahAkabalEdition(player: Character, monster: Character): NextScreenChoices {
    CView.sprite(SpriteName.Akbal); // 2
    // Make sure that the buttchange is set correctly
    // when submitting.  Gotta stretch em all!
    monster.body.cocks.add(new Cock());
    monster.body.cocks.get(0).length = 15;
    monster.body.cocks.get(0).thickness = 2.5;
    monster.body.cocks.get(0).type = CockType.HUMAN;
    if (AkbalFlags.AKBAL_BITCH_Q >= 2) {
        return akbitchEncounter(player);
    }
    if (AkbalFlags.AKBAL_SUBMISSION_STATE === 2) {
        return repeatAkbalPostSubmission(player, monster);
    }
    if (AkbalFlags.AKBAL_SUBMISSION_STATE === 1) {
        return ackbalRepeatAfterWin(player);
    }
    if (AkbalFlags.AKBAL_SUBMISSION_STATE === -1) {
        return ackbalRepeatAfterLoss(player, monster);
    }
    CView.clear();
    ...
    return {
        choices: [
            ["Talk", partial(superAkbalioTalk, player, monster)],
            ["Fight", startuAkabalFightomon],
            ["", undefined],
            ["", undefined],
            ["Leave", returnToCampUseOneHour],
        ]
...
// [Talk]
function superAkbalioTalk(player: Character, monster: Character): NextScreenChoices {
    CView.sprite(SpriteName.Akbal); // 2
    CView.clear();
    ...
    return {
        choices: [
            ["Fight", startuAkabalFightomon],
            ["Submit", partial(akbalSubmit, player, monster)],
        ]
    };
}

// [Encounter if previously submitted]
function repeatAkbalPostSubmission(player: Character, monster: Character): NextScreenChoices {
    CView.sprite(SpriteName.Akbal); // 2
    CView.clear();
...
function ackbalRepeatAfterLoss(player: Character, monster: Character): NextScreenChoices {
    CView.sprite(SpriteName.Akbal); // 2
    CView.clear();
...
function startuAkabalFightomon(player: Character): NextScreenChoices {
    CView.sprite(SpriteName.Akbal); // 2
    CView.clear();
    CView.text("You ready your " + player.inventory.equipment.weapon.displayName + " and prepare to battle the demon jaguar.");
    // [battle ensues]
...
// [Submit]
function akbalSubmit(player: Character, monster: Character): NextScreenChoices {
    CView.sprite(SpriteName.Akbal); // 2
    player.slimeFeed();
    ...
    if (player.body.legs.type === LegType.NAGA) {
        CView.text("akbal-deepwoods-naga-sumbitanal");
        CView.text("After a few moments of thinking you nod to Akbal and the masculine voice in your head commands you to disrobe. You take off your " + player.inventory.equipment.armor.displayName + ", setting it aside moments before the demon is upon you.\n\n");
        ...
        player.effects.add(StatusEffectType.PostAkbalSubmission, 0, 0, 0, 0);
        return { next: returnToCampUseEightHours };
    }
    // Taur variant goez here
    if (player.body.legs.type === LegType.CENTAUR) {
        CView.text("akbal-deepwoods-taur-sumbitanal");
        CView.text("After a few moments of thinking you nod to Akbal.  The deep voice in your head commands you to disrobe.  You take off your " + player.inventory.equipment.armor.displayName + ", setting it aside while mentally preparing yourself for whatever this demon has in mind.\n\n");
    ...
    CView.text("akbal-deepwoods-sumbitanal");
    CView.text("After thinking for a minute, you nod to Akbal.  The deep voice in your head commands you to disrobe.  You obediently take off your " + player.inventory.equipment.armor.displayName + " and set it aside just before the demon is upon you.\n\n");
...
function akbalBigButtSubmit(player: Character): NextScreenChoices {
    CView.clear();
    CView.text("akbal-deepwoods-bigbuttanaled");
...
function akbitchEncounter(player: Character): NextScreenChoices {
    ...
    // {corruption > 40}
        ...
        return { yes: takeAdvantageOfAkbitch, no: partial(akbitchNoThnx) };
    }
}
...
export function takeAdvantageOfAkbitch(player: Character): NextScreenChoices {
    ...
    if (player.stats.str < 50) {
        ...
        CombatManager.beginBattle(player, akbal);
        akbal.akbalSpecial();
        return;
    }
    // {strength > 50}
    ...
    if (player.stats.int < 60) {
        ...
        CombatManager.beginBattle(player, new Akbal());
        monster.eAttack();
        return;
    }
    // {intelligence > 60}
...
function buttFuckbuttFuckbuttFuckAkbal(player: Character): NextScreenChoices {
    CView.clear();
    CView.text("akbal-deepwoods-male-buttfuck");
    // [if (hasCock = true)]
    if (player.body.cocks.length > 0)
...
function fuckAkbitchsButt(player: Character): NextScreenChoices {
    CView.clear();
    const largestCock = player.body.cocks.sort(Cock.Largest)[0];
    CView.text("akbal-deepwoods-male-buttfuck2");
...
function topAkbitchFromDaBottom(player: Character): NextScreenChoices {
    CView.clear();
    CView.text("akbal-deepwoods-male-akbalonback");
    // [{if goo legs}]
...
function topAkbitchFromBottomDuex(player: Character): NextScreenChoices {
    CView.clear();
    CView.text("akbal-deepwoods-male-akbalonback2");
    // -page turn-
...
function akbitchHighStrengthVariant(player: Character): NextScreenChoices {
    ...
    if (player.body.cocks.length > 0) {
        CView.text("akbal-deepwoods-male-highstrength");
        // if (hasCock = true)
        ...
        CView.text("akbal-deepwoods-female-highstrength");
...
function akbalBitchSpeed(player: Character): NextScreenChoices {
    ...
    // [if (hasCock = true)]
    if (player.body.cocks.length > 0) {
        CView.text("akbal-deepwoods-male-highspeed");
    ...
    // [if (hasVagina = true)
        ...
        CView.text("akbal-deepwoods-female-highspeed");
...
function akbitchToughness(player: Character): NextScreenChoices {
    ...
    // [if (hasCock = true)]
    if (player.body.cocks.length > 0) {
        CView.text("akbal-deepwoods-male-hightoughness");
