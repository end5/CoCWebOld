...
class KatherineEmployment {
    ...
    public employmentTalk() {
        ...
        DisplayText("You ask if she’d like you to look around for her.  You don’t know why, but folks in this world seem to take a liking to you on sight; maybe you’ll have better luck persuading somebody in town to take her on as an apprentice of some kind?\n\n");
        DisplayText("Kath visibly thinks it over, then gives you a loving smile.  “<i>I’d really appreciate that,</i>” she beams.  “<i>It’d be nice to have somewhere other than an empty alley to spend time with you.</i>”  She pokes sadly at the meager nest she’s made from rubbish, ashamed that this is all she has.\n\n");
        DisplayText("You tell her that you’ll go and take a look right now, and promise to be back as quickly as you can.");
    ...
    private tryShops() {
        ...
        DisplayText("You tell him that you understand, and you’ll try elsewhere.  “<i>Good luck,</i>” he says as you exit his shop.\n\n");
        DisplayText("Weighing the options a little more carefully, of the shops around town, it seems like the Bakery would be the easiest place for Kath to get situated in.  It seems like there are a variety of jobs and learning how to prepare food would be a good skill for the vagrant to pick up.  You enter the Bakery.\n\n");
        ...
        DisplayText("You reply that you do know somebody, but you can’t really say they know anything about being a blacksmith.  Yvonne sighs heavily and shakes her head.  “<i>Sorry, but I don’t really have the time to train fresh meat.  If this friend of yours wants a job, they need to look elsewhere.</i>”\n\n");
        DisplayText("Sighing, you thank Yvonne for her time and wish her a good day.  Once outside you consider your other options... hmm... how about the Gym?  That doesn’t look like it’d be too much work for the cat-girl, especially if she gets a desk job.  You head over, a bit hopeful.\n\n");
        ...
        DisplayText("You admit that she’s probably not really qualified to train anyone in how to exercise or help people get fit.  The centauress sighs.  “<i>Then I’m afraid I cannot help you...</i>”");
        if (player.tone >= 75) {
            DisplayText("  She takes a second look at you and notices your well defined muscles.  “<i>Hey... maybe you’d be willing to come work here?  With a body like that, you must really know how to work out, huh?</i>”\n\n");
            DisplayText("You tell her that you appreciate the offer, and keep it in mind, but you currently have other engagements that demand the bulk of your time.");
        }
        ...
        DisplayText("You consider your remaining options... what about Yara?  Sure her business might not exactly be booming, but you never know until you ask, right?  With that in mind you decide to enter the Piercing Studio.\n\n");
        DisplayText("Stepping inside, you greet Yara with a friendly nod.  Drumming her fingernails on the counter, she returns the gesture with a half-smile.  “<i>Welcome, can I help you with anything?</i>”\n\n");
        DisplayText("You tell her that you have a friend who is looking for a job, and you were hoping the studio might be able to take her on in some fashion.\n\n");
        DisplayText("Yara thinks it over.  “<i>I don’t really need anyone else at the moment, but I understand it must be rough... does she know anything about piercings?  You need to have a special touch for this kind of work, especially considering some of the sensitive parts my clients might request to be pierced.</i>”\n\n");
        DisplayText("You know for a fact Kath’s never been pierced, so you have to admit she probably doesn’t know anything; but surely Yara can teach her on the job?\n\n");
        ...
        DisplayText("You sigh and admit that you’re not certain you can spare the time to help train her in such a fashion.  You’d certainly be willing to drop by and help out, but you aren’t able to get into Tel’Adre on any kind of regular schedule, what with all the things you have to do in the wastelands.\n\n");
        DisplayText("“<i>Then I’m afraid I can’t help you...</i>” Yara says, sadly.  You thank her just the same and take your leave.\n\n");
        DisplayText("By now, the pattern seems pretty clear and you’re running out of options... only the Tailor shop and the Weaponsmith remain.  Considering the Weaponsmith doesn’t look like the most charitable of people, you decide to try your luck with Victoria.\n\n");
        DisplayText("Once inside, you immediately ask the little corgi-girl if she’d be willing to take on a hired hand to help out around the place.\n\n");
        ...
        DisplayText("You smile and thank her for time, letting her know that you will try; then leave the shop.\n\n");
        DisplayText("Your only remaining option is the Weaponsmith... dreading the task ahead, you steel yourself and approach the old dog-morph.\n\n");
        ...
        DisplayText("...Cranky old coot.\n\n");
        DisplayText("It looks like no one is willing to take Kath in... you’ll have to think of something else...");
    ...
    private tryTheWatch() {
        ...
        if (pissedOffUrta && pissedOffEdryn) { //Well aren't you a giant dick
            ...
            DisplayText("After some further explaining you learn that the watch needs officers who can survive outside the city, handle themselves in fights and who will behave properly when dealing with the public.\n\n");
            DisplayText("You leave the watch station hopeful that some time training with you will make Kath a decent watch candidate.");
            Flags.list[FlagEnum.KATHERINE_TRAINING] = 3; //Player can now talk to Kath about getting a job in the watch
        }
        else {
            DisplayText("  You should try talking to Urta or Edryn; they might be able to help you see if there’s a way to get Katherine into the watch.");
    ...
    public talkToEdryn() {
        ...
        if (edryn.pregnancy.isPregnant) DisplayText(" gorging");
        DisplayText(" centauress and make yourself comfortable in the seat across from her, which makes Edryn");
        ...
        if (edrynKidsPlus > 0) {
            ...
            if (edryn.pregnancy.isPregnant) DisplayText(", one hand brushing against her swollen equine belly as best it can");
            DisplayText(".  “<i>Don’t tell me this has to do with the " + (edrynKidsPlus > 1 ? "kids" : "baby") + ".  I mean, it’s not that I don’t appreciate the sentiment and all, but you don’t have to do this because of me!</i>” she protests.");
        }
        ...
        DisplayText("Of course, you reply, before admitting you’re not certain if Katherine - the person you’re asking for - has those skills.\n\n");
        ...
        DisplayText("You smile and thank the centauress for her help.  “<i>It was nothing,</i>” she replies, looking quite pleased at your thanks all the same.\n\n");
        ...
        if ((cockFitIndex >= 0 && player.cockArea(cockFitIndex) >= 24) && (player.hips.legs.type === LegType.CENTAUR || player.torso.cocks.filter(Cock.FilterType(CockType.HORSE) > 0 || player.stats.cor > 50 || player.statusAffects.get(StatusAffectType.Edryn).value1 > 0))).length {
            DisplayText("“<i>So... I don’t suppose there’s anything else you might have on your mind...?</i>”  She gives you a coy look and fiddles with a nipple through her shirt.");
            MainScreen.doYesNo((edryn.pregnancy.isPregnant ? pregnantEdrynSexSelector : edryn.edrynSexSelecter), telAdre.barTelAdre);
        }
        else {
            DisplayText("Your business done, you leave the bar; now, how to tell Katherine that if she wants a job, she’ll need to join the Watch...?");
    ...
    public talkToUrta() {
        ...
        DisplayText().clear();
        DisplayText("You tell Urta that you actually need to talk to her about something business related.  The gray-furred vixen gives you a quizzical expression.  “<i>Oh?  What do you mean?</i>”\n\n");
        DisplayText("You explain Katherine’s situation; how you met the cat, her life as an unemployed, homeless vagrant, her desire to find an honest living, and your hopes that Urta can help you get her a place in the Watch.\n\n");
        DisplayText("The vulpine herm sighs and taps a finger on the table.  “<i>Just because I’m letting you into my pants doesn’t mean you can just walk all over the rules, you know? ...But, well, we do always need recruits... still, she’ll have to pass the tests to get in, just like anyone else.</i>”\n\n");
        ...
        if (urta.urtaLove()) { //Lover Urta
            ...
            DisplayText("You figure it’s the least you can do to thank her; you can go and tell Katherine about it when you’re done here, and besides, it’s best to keep her in a good mood, right?");
    ...
    public talkToKath() {
        ...
        DisplayText("You frown at her attitude and tell her that there is no need to get aggressive, after all you’re trying to help her.  Besides that, it’s not like she has much choice.\n\n");
        DisplayText("“<i>What do you mean I have no choice?!</i>” Kath protests.  “<i>You’re just not looking hard enough for a job!</i>”\n\n");
        ...
        DisplayText("Kath glowers at you, but then wilts, ears and tail falling limp.  “<i>No.  I survive mainly by running away, and I’ve never been a leader, always a follower - if that.  More often, a hanger-on,</i>” she admits, glumly.\n\n");
        ...
        DisplayText("Kath’s lip trembles and her ears and tail droop so low they look like they want to fall off.  “<i>How... how can you say these things to me?  Don’t you know what the Watch does to us homeless?  They’re nothing but bullies and thugs - always chasing us away from empty houses because of some dumb law!</i>”\n\n");
        ...
        DisplayText("“<i>Of course!</i>” she spits, managing to muster enough spirit to bristle her tail with rage.  “<i>But... why are they so unfair to us?  We didn’t ask to be homeless, you know...</i>”\n\n");
        ...
        DisplayText("“<i>But that wasn’t-!  I didn’t-!</i>”  She tries to defend the actions of her colleagues, unable to find any arguments that sound even the least bit convincing.\n\n");
        ...
        DisplayText("“<i>I... all right.  You win.  I’ll take the job,</i>” Kath says, sniffling in shame and wiping a humiliated tear from her right eye.\n\n");
        DisplayText("You pat the sniffling cat-girl on her head, inviting her into a friendly hug.  It’s okay, you tell her, taking a chance can be frightening, but life is about reaching through fear and risk for something more.  Besides, no matter how unlikely it might seem, she might actually end up liking her job at the Watch.\n\n");
        ...
        DisplayText("Well it’s true that when you asked, you were told Kath would need some basic knowledge before passing the test and joining... but you should be able to help her.  There is plenty you’ve learned adventuring, surely you can pass some of that knowledge to her?  ");
        if (urta.urtaLove()) {
            DisplayText("Besides that, you also know someone who might just be able to help whip her up into shape.\n\n");
            DisplayText("“<i>And how do you know they’ll be good enough to meet Watch standards?</i>”  Kath asks, curiously.\n\n");
            DisplayText("Oh I don’t know... maybe because she’s the captain?  You smile wryly at Kath.  The cat’s jaw drops and she stares to you.  “<i>Wha... how?</i>” she blurts aimlessly.\n\n");
            ...
            DisplayText("The cat-herm nods her head in understanding.  “<i>I promise I’ll do what you tell me,</i>” she swears, blushing a bit.\n\n");
        }
        else {
            DisplayText("“<i>I guess... I mean, you survive on your own out in the wilderness, right?  You gotta know something about defending yourself, don’t you?</i>” Kath asks, shrugging her shoulders helplessly.\n\n");
            DisplayText("You can’t help but give her a look of mild hurt.  You were hoping she’d have some more confidence in you...  “<i>What?  What’s with that look?  It was a compliment!</i>” She protests.\n\n");
            ...
            DisplayText("Katherine nods, doe-eyed, trying to look serious but coming off a bit desperate.  “<i>I don’t know how you plan on cleaning up a mess like me, but I’ll try to follow your lead.</i>”\n\n");
        }
        DisplayText("Having made your point, you say your goodbye and return to camp.");
    ...
    public initiateTraining(): boolean { //Only appears if you’ve talked to Kath about joining the watch
        ...
        MainScreen.simpleChoices(["Postpone", "Train", "With Urta", "", ""], [postpone, trainKath, withUrta, null, null]);
        return true;
    }
    ...
    private trainKath() {
        ...
        DisplayText("Then there are the more martial skills.  Kath has probably never fought alone and every fight she’s been in alone has probably been a fight to escape.  At least with all your skills you can really give her a leg up in combat training.\n\n");
        ...
        DisplayText("Stepping into the alleyway you put down the sack of spare equipment you gathered at camp and tell Kath that it’s time.  She nervously get up from the old packing crate she was sitting on.  Her tail twitches as she approaches and she asks you what the sack is for.\n\n");
        DisplayText("You tell her it’s all supplies for her to train with.  Until she finishes training she’s going to have to carry this bundle with her at all times.  Kath picks it up and just manages to heft the sack onto her shoulder.  Hopefully the weight will help build her strength and her endurance.\n\n");
        DisplayText("You lead Kath through the streets of Tel’Adre and despite having lived here her whole life she doesn’t realize where you’re going until you reach the gates.  “<i>We’re going into the desert?  What if some monster eats me?  I heard there are these man eating nagas out here that love cat flesh.</i>”\n\n");
        if (player.statusAffects.get(StatusAffectType.Naga).value2 != 0)
            DisplayText("You almost laugh.  Of all the dangers of the desert she picks the naga.  There’s only one way the naga would eat Kath and they would both enjoy it.  ");
        DisplayText("You tell Kath that this is the best way for her to learn survival skills.  Besides you’re always going to be with her out in the desert and you’ve crossed it uncounted times and you’re still here.\n\n");
        DisplayText("Kath nods, adjusts the sack, steels herself and follows you out into the wastes for some very practical survival training.");
    ...
    public katherineTrainingStage1(clearOut: boolean = true) {
        ...
        DisplayText("When you aren’t instructing her Kath complains about the sand, the heat and the weight of the sack.  You can tell when she really gets tired because she starts to concentrate more on walking than talking.  You can’t blame her.  The desert is difficult terrain to walk on, that’s why you chose it.\n\n");
        ...
        DisplayText("Kath pants a few more times before taking a drink from her canteen and pulling open the sack.");
        switch (randInt(3)) {
            case 0: return { next: katherineTrainingStage1Success }; break;
            case 1: return { next: katherineTrainingStage1Failure }; break;
            case 2: return { next: katherineTrainingStage1Horny };
        }
    }
    ...
    private katherineTrainingStage1Success() {
        ...
        DisplayText("Lashing down the canvas takes a lot more effort, but Kath is soon sitting inside a completed tent.  It’s not perfect, the wind can still blow through a few seams and gaps, but it’s not bad either.\n\n");
        DisplayText("Now shielded from the sun Kath begins to recover some of her usual energy and smiles at you from inside the tent.  “<i>Wanna test this thing out " + player.short + "?</i>”\n\n");
        DisplayText("It’s not the best idea to get distracted out here so you decline.  Besides, part of Kath’s training is to boost her endurance.  If you laze about all afternoon it won’t help her very much.\n\n");
        DisplayText("You give Kath some more survival instruction while she breaks the tent back down.  Another long march back to the city and Kath is panting by the time you reach the gates.\n\n");
        DisplayText("She squeezes your hand and thanks you again for doing this, even if she’s not exactly enjoying it she’s going to keep trying until she can pass that test.");
    ...
    private katherineTrainingStage1Failure() {
        ...
        DisplayText("The wind nearly blows the canvas away from her and she ends up sifting some of the sand trying to locate a missing strut.  When she finds it hidden under the canvas she plops down on her butt, exhausted.\n\n");
        DisplayText("“<i>I know, I screwed up.  They probably wouldn’t give me so much time on the test.</i>”  She sighs and adds, “<i>I’ll do better tomorrow.</i>”\n\n");
        DisplayText("Before returning to Tel’Adre you go over all the mistakes Kath made so that she understands what she did wrong and will be less likely to screw up next time.\n\n");
        DisplayText("You almost have to carry her back to the alley behind Oswald’s shop.  Kath flops down onto some softer refuse and curls up for what promises to be a long nap.");
    ...
    private katherineTrainingStage1Horny() {
        ...
        DisplayText("She sits up, embarrassed despite the fact there’s no one else within a mile.  “<i>Come on " + player.short + " - You had me walking all over the place.  My cock" + katherine.cockMultiple("", "s") + " kept rubbing against my pants.  I need to do this to even think straight.</i>”\n\n");
        DisplayText("You realize there is no way you’re going to get Kath to do anything useful out here.  On the other hand it’s a nice day and your girlfriend is very, very horny.  Might as well make the most of this trip.");
    ...
    public katherineTrainingStage2() {
        ...
        switch (randInt(3)) {
            case 0: return { next: katherineTrainingStage2Success }; break;
            case 1: return { next: katherineTrainingStage2Failure }; break;
            case 2: return { next: katherineTrainingStage2Horny };
        }
    }
    ...
    private katherineTrainingStage2Success() {
        ...
        DisplayText("When Kath starts to tire you tell her she did well today and pack up the training aids.  If she keeps showing this kind of improvement it won’t take long before she’s a match for any criminal in Tel’Adre and many monsters outside it.\n\n");
        DisplayText("She beams at the compliment and the two of you walk back to Tel'Adre arm in arm.");
        Flags.list[FlagEnum.KATHERINE_TRAINING] += 10;
    ...
    private katherineTrainingStage2Failure() {
        ...
        DisplayText("Time and again you try a manoeuvre you showed her only to see her put up the wrong block.  It’s a bit discouraging so you switch to some hand to hand combat for a while.  Here again Kath’s fighting just seems to be off, though she starts to improve her grappling slowly.\n\n");
        DisplayText("When you switch back to the training swords Kath does a bit better.  At least she’s not messing up her blocks as often.  She would still lose in most fair fights but you think she’s learning.\n\n");
        DisplayText("When Katherine is tired enough that you can’t continue you pack up and head back for Tel’Adre.  It hasn’t been the best training session, but you know you managed to get some things across.");
        Flags.list[FlagEnum.KATHERINE_TRAINING] += 5;
        return { next: Scenes.camp.returnToCampUseTwoHours }; //Use up two hours, go back to camp
    }
    ...
    private katherineTrainingStage2Horny() {
        ...
        if (player.torso.vaginas.count > 0 && player.vaginalCapacity() >= 100) { //Don't want to get knotted together out here at the lake
    ...
    public katherineTrainingStage3() {
        ...
        if (Flags.list[FlagEnum.KATHERINE_TRAINING] >= 99) {
            return { next: katherineTrainingStage3Success };
        }
        else {
            switch (randInt(3)) {
                case 0: return { next: katherineTrainingStage3Success }; break;
                case 1: return { next: katherineTrainingStage3Failure }; break;
                case 2: return { next: katherineTrainingStage3Horny };
            }
        }
    }
    ...
    private katherineTrainingStage3Success() {
        ...
        DisplayText("You try to talk your way out of it, but to no avail.  Kath isn’t prepared to let you get away.  She offers to let your friends accompany you as witnesses, but that’s all.  When you still refuse she takes a step forward and pulls out her club.\n\n");
        DisplayText("Before Kath decides to carry out some more combat training you tell her she did well.  Her stern demeanor cracks in an instant and she gives you a big smile and a hug.\n\n");
        DisplayText("You go through a number of other scenarios with her, all based on the rules and cases you researched at the library.  Kath makes mistakes but rarely makes them twice and through it all she maintains the bearing expected of a watch officer.\n\n");
        DisplayText("You leave Katherine to practice by herself for a while, thinking that teaching her how to behave might not take as long as you imagined.");
        Flags.list[FlagEnum.KATHERINE_TRAINING] += 10;
        return { next: Scenes.camp.returnToCampUseOneHour };
    }
    ...
    private katherineTrainingStage3Failure() {
        ...
        DisplayText("You press on and tell her that she just found some miscreants trying to pickpocket an older lady and she’s chased one down an alley.  The thief has stopped next to two other people and all three are now claiming he’s been there all afternoon.  Now how is she going to deal with the situation?\n\n");
        DisplayText("Katherine marches toward you, hand on the grip of her club.  She levels a stare at you and says, “<i>I’m placing you under arrest.  Come with me to the watch house quietly or I will be forced to subdue you.</i>”\n\n");
        DisplayText("You manage to throw her off kilter by interrupting her whenever she tries to explain why she wants to arrest you.  You question how she has the right to do that, since there’s no witness here to identify you and you have two other people who swear you’ve been here with them.\n\n");
        DisplayText("Kath keeps trying so you start insulting her, calling her a police pussy among other things.  You give her a fake address and tell her that if the watch want you they can come find you later - you have things to do now.\n\n");
        ...
        DisplayText("As you walk towards the city gates you feel you’ve made little progress today, but what progress you did make was hard won.  Katherine will make it, she just needs more time and training.");
        Flags.list[FlagEnum.KATHERINE_TRAINING] += 5;
    ...
    private katherineTrainingStage3Horny() {
        ...
        DisplayText("Kath looks down at her treacherous cock and back up at you.  She straightens up again, assuming the correct posture for a watch officer and puffing her chest out.  In a stern, commanding voice she says, “<i>I arrest officer Katherine for indecent exposure.</i>”\n\n");
        ...
        DisplayText("You sigh, but the feel of Katherine’s fuzzy face against your cheek weakens your resolve.  It’s not as though she has to take the test tomorrow, so why not take a break?  Kath whispers in your ear, “<i>So how would you like me, lover?</i>”");
        alleywaySexOptions();
    }
    ...
    private alleywaySexOptions() {
        ...
        if (player.torso.cocks.count > 0 && Flags.list[FlagEnum.KATHERINE_TIMES_SEXED] > 0) suckNFucked = katherine.suckedNFuckedByKat;
    ...
    public katherineTrainingComplete() {
        ...
        if (urta.urtaDrunk() || model.time.hours >= 15) {
            if (model.time.hours >= 15)
                DisplayText("Although Kath is ready for testing you think it would be best to catch Urta while she’s filling out paperwork at the Wet Bitch.  That way you won’t risk interrupting her while she’s doing something important or on patrol.");
            else DisplayText("Although Kath is ready for testing you don’t think the captain of Tel’Adre’s guard is going to be in any condition to test her.  You’re better off waiting until she’s sober.");
        ...
        DisplayText("You tell Kath that you feel she’s ready for testing.  She beams and nervously tries to smooth out her clothes.  The two of you walk to the Wet Bitch where, as expected, you find captain Urta sitting alone at her table reading reports and sipping something from a mug.\n\n");
        if (Flags.list[FlagEnum.URTA_COMFORTABLE_WITH_OWN_BODY] > -1) {
            if (Flags.list[FlagEnum.TIMES_FUCKED_URTA] > 0) { //Urta is either your lover or a fuckbuddy
                DisplayText("Urta gives you a big smile as you lead Katherine over to her table.  “<i>How’s it going, " + player.short + "?</i>”  When Kath sits down, she adds, “<i>And who’s this?</i>” in a friendly tone.\n\n");
                DisplayText("You explain to Urta how you’ve been training Kath in the hopes of getting her a job in the watch.  Urta sips from her mug and listens closely as you go over the training.  When you finish Urta says, “<i>" + (urta.urtaLove() ? "You know, I could have given you a hand with that, love" : "Well love, the watch can always use new recruits if they’re well trained") + ".</i>”  Kath’s jaw hits the floor and she asks, “<i>You’re sleeping with the captain of the guard?</i>”\n\n");
                DisplayText("Urta knocks back her mug and says, “<i>Oh yes, we’ve been sleeping together for a while.  I’m guessing from the look on your face, you two have been sleeping together for a while too, hmmm?  Where have you been hiding her, " + player.short + "?  And why haven’t you introduced us?</i>”");
                ...
                return { next: katherineTrainingCompleteUrtaLover };
            }
            else { //You've never spoken to her
                DisplayText("You haven’t spoken to the captain of Tel’Adre’s guard since that first day when you arrived in the city.  Urta is nursing some kind of hard liquor and working her way through piles of reports and other paperwork.  She notices your approach and puts aside her quill.\n\n");
                DisplayText("“<i>What can I do for you two?</i>” she asks, waving her hand towards the empty seats at the table.\n\n");
                DisplayText("You both sit down and explain that Katherine wants to join the watch.\n\n");
                DisplayText("“<i>You’ve heard there are some tests she will have to pass to qualify, right?</i>” Urta asks.\n\n");
                DisplayText("You tell her you’ve heard about the tests and in fact you’ve been training Kath for some time based on what you’ve learned surviving outside Tel’Adre.\n\n");
                DisplayText("Urta seems impressed and tosses back the rest of her drink.  In moments she’s packed up all her papers and turns to Kath.  “<i>Alright recruit, follow me.  Let’s see if you’ve got what it takes.</i>”");
                return { next: katherineTrainingCompleteNeverSpokenOrPermanentlyPissed };
            }
        }
        else {
            if (Flags.list[FlagEnum.TIMES_FUCKED_URTA] === 0) { //You ran away that first time, she assumed you hate her cock
                DisplayText("Urta’s expressions wavers between curiosity, anger and fear when you bring Kath to her table and ask if you and Katherine can talk about the watch.  She does let you both sit down and then says little as you explain how Kath wants to join the watch and how you’ve been training her.\n\n");
                ...
                return { next: katherineTrainingCompleteUrtaThoughtYouDidntLikeHer };
            }
    ...
    private katherineTrainingCompleteUrtaLover() {
        ...
        DisplayText("“<i>We just call it housing approval,</i>” says a voice from the door.  Urta is standing there, looking quite pleased.  “<i>Well Kath, you’ve spread the good news, now you’ve got some equipment to pick up at the watch house.</i>”\n\n");
        ...
        DisplayText("You run an hand through Urta’s fur and thank her for being so understanding.  Unfortunately you have stayed in town quite a while so you decide that you have to head back to camp to check up on the portal.");
    ...
    private katherineTrainingCompleteUrtaThoughtYouDidntLikeHer() {
        ...
        DisplayText("“<i>We just call it housing approval,</i>” says a voice from the door.  Urta is standing there, looking quite pleased.  “<i>Well Kath, you’ve spread the good news, now you’ve got some equipment to pick up at the watch house.</i>”\n\n");
        DisplayText("Kath nods and says to you, “<i>Yes, there’s so much to do.  I’ve got to get going.</i>”  She gives you another kiss and you can feel a certain bulge pressing against your hip.  “<i>I don’t know where my house will be yet, but Captain Urta is going to be making sure I settle in, so I’ll be here at the bar filling out reports from time to time.</i>”\n\n");
        DisplayText("She says, “<i>Thank you,</i>” again, kisses you again and then races off down the street.  Then Urta surprises you by saying, “<i>I want to buy you a drink.</i>”");
    ...
    private urtaForgivesYou() {
        ...
        DisplayText("After a long pause she adds “<i>So... I think I misjudged you.  That time you saw me, just out back of this place.  A lot of people hate herms and I thought you must be like that.</i>”  She looks down again and adds, “<i>I guess I never gave you the chance to set the record straight.</i>”");
    ...
    private trainKathWithUrta() {
        ...
        DisplayText("You nod in confirmation, telling Urta that you are here to give her more information on Kath, so the two of you can come up with a good training schedule for her.\n\n");
        DisplayText("The fox steeples her clawed fingers in front of her face.  “<i>I’m listening,</i>” she tells you.\n\n");
        DisplayText("Looking around, you suggest that perhaps it would be better to do this in a more private setting, it can’t be good for the people to know that the watch captain is going to be doing a personal favor for someone; this could impact her image.\n\n");
        ...
        DisplayText("You lay a hand on her thigh and start sharing all you know about Kath; how she is currently homeless; how she lacks any combat experience beyond basic survival; how she tends to get pretty pent up sexually and how that frustration boils over... even giving the details of how you met in the first place...\n\n");
        DisplayText("Urta nods her head and keeps quiet throughout, quietly digesting what you have to say.  Glancing at you with eyes half-lidded in thought, she quietly asks, “<i>So... do you just have a thing for herms with mismatched dicks?</i>”\n\n");
        ...
        DisplayText("Urta blushes and looks at her feet, idly fiddling with the hem of her dress.  She’s silent for a long time, but finally asks, “<i>So... how do you want me to help you train this... Kath, was it?</i>”\n\n");
        DisplayText("To be honest, you were hoping she would have a plan... she is the guard captain, and if anyone knows the job, it’d be her.  You ask Urta if she doesn’t have any ideas?\n\n");
        ...
        DisplayText("You tell her you understand... but considering the current state of affairs in Mareth perhaps it would be good to train Kath in the matter of... restraint... as well.  You fear that some demon or perhaps a corrupt individual might be able to take advantage of her that way...\n\n");
        ...
        DisplayText("“<i>From what you tell me, my libido’s a lot worse than your little kitty-cat’s.  She wouldn’t have it anywhere near as bad as I did,</i>” Urta points out.  She then shrugs.  “<i>Besides, it failed to help me master my libido in the long term, but for short-term motivation, it’s quite effective.</i>”\n\n");
        DisplayText("That’s true, you admit.  As a final note, you ask if Urta has a place where she could properly train Kath.\n\n");
        DisplayText("“<i>Well... we use a number of safehouses around the city for new recruits, and lust-resistance training is part of their regime too.  I could commandeer one when you need, justify it as me brushing up on some training of my own?</i>” Urta offers after some deep thought on the subject.\n\n");
        DisplayText("You tell her that if she could do that, it would be perfect.  You give the matter some thought and conclude that this pretty much settles all that needs to be settled about Kath’s training.\n\n");
        DisplayText("“<i>Alright, so, is there... anything else that’s on your mind?</i>” Urta asks, hopefully.  You look Urta over... she’s given you such a nice mental image... her being tied up into a chastity belt, unable to cum... perhaps you should see if she’s up for a little practice of her own?  Right here, right now?");
    ...
    private chastityBeltFun() {
        ...
        DisplayText("You grin at her as she finally caves to your unspoken request and hand the belt over to her.");
    ...
    private initiateTrainingWithUrta() {	//Happens next time you visit Kath after the visit to Urta
        ...
        DisplayText("You find Urta standing at the door of the Wet Bitch; she has chosen to wear her Watch uniform for this task it seems... smiling, you wave to her, trying to draw her attention.\n\n");
        DisplayText("The Watch-vixen looks at you, smiles and walks over to meet up with you.  “<i>So, you and the puffball kitten ready to start, are you?</i>” she asks, her tone light and fairly friendly despite her words.  Still, you think she’s maybe a little jealous, and you can’t really blame her.\n\n");
        DisplayText("You decide to ease the tension by drawing her into a quick kiss, then telling her that yes... you’re both ready.  You also warn her that Kath doesn’t seem too enthusiastic about joining the watch... maybe Urta could give her some motivation or something?\n\n");
        DisplayText("“<i>Motivation?  Like how?  I’m not going to threaten to shove my cock up her ass if she doesn’t perform to my expectations.  I got more pride than that, I’ll have you know,</i>” she warns you.\n\n");
        DisplayText("You shake your head.  You didn’t mean anything like that... you were hoping Urta would maybe give a pep talk or something along the lines of that.  Threats are not likely to get the reluctant cat going...\n\n");
        DisplayText("Urta stops and flushes with embarrassment.  “<i>Okay, yeah, pep talk, I think I can pull that off.  Can’t guarantee she’ll listen, but hey, isn’t that always a problem with trying to talk people into doing something, even for their own good?</i>” she rambles.\n\n");
        ...
        DisplayText("You nod in understanding, but tell Urta that Kath has it pretty rough.  You were hoping she would be sympathetic, considering her past.  Urta was strong enough to get a better life on her own, but Kath isn’t... besides that, you tell her you’re not trying to replace her or anything like that.\n\n");
        DisplayText("Urta heaves a sigh.  “<i>Okay, okay, no need for the lectures.  Let’s just go see this cat of yours.</i>”  Despite her gruff tone, her expression makes it obvious she appreciates your words.  She indicates you should lead the way.\n\n");
        DisplayText("Nodding, you do so.\n\n");
        DisplayText("You lead Urta to the alleyway behind the pawn shop, and instantly spot Kath sitting on an empty box, a small pouch with what you presume to be her belonging sit nearby.  You approach her and introduce Urta and Kath to one another.\n\n");
        DisplayText("The two herms awkwardly say hello to each other, and then fall silent, staring, neither willing - able? - to make the first move herself.  You’ll have to break the ice between your mismatched dickgirls.\n\n");
        DisplayText("Sighing at their social ineptitude... you tell Kath that Urta is actually the captain of the guard, she’s also pretty well-known and respected in Tel’Adre, so she couldn’t be in better hands if she’s hoping to join.\n\n");
        DisplayText("The cat looks at you dully.  “<i>I know who she is, " + player.short + ".  You sure this booze-hound can stay sober long enough to help?</i>” she jerks a thumb at Urta, who is fuming already.\n\n");
        DisplayText("“<i>Listen here, pussy cat, I’m doing this as a favor, so knock off the insults,</i>” Urta snaps back.\n\n");
        DisplayText("“<i>As if you know anything about doing a hard day’s work, anyway; you spend all morning in that cushy bar drinking your ass off, then stagger back home, everyone knows it,</i>” Katherine jeers.  “<i>How’d you even get into the Watch in the first place?</i>”\n\n");
        ...
        DisplayText("Kath looks at the fox with what is obviously trying to be a guarded expression, but hints of both awe and fear are blatantly visible.  “<i>...I’m sorry.  I was in the wrong,</i>” she admits.\n\n");
        ...
        DisplayText("“<i>Deal,</i>” the cat replies, shaking the fox’s hand.  “<i>So... uh... what do you two have in mind, anyway?</i>” she asks, looking from Urta to you and back again.\n\n");
        ...
        DisplayText("Kath’s eyes widen and she turns to Urta.  “<i>Isn’t that expensive?</i>” she asks, dumbstruck.\n\n");
        DisplayText("“<i>I’m the captain of the Watch.  Besides, its official purpose is for training Watch members; there’s no price on it.  We got others to use, anyway,</i>” Urta replies.\n\n");
        DisplayText("“<i>I see.... well,</i>” Kath draws herself up straight, “<i>I swear I’ll do my best to train - I won’t let either of you down.</i>”\n\n");
        DisplayText("“<i>You say that now.  You mightn’t be so chipper when you see what the training entails,</i>” Urta smirks.\n\n");
        ...
        DisplayText("Urta nods.  “<i>It’s waiting at the safe house, ready to be put to use.</i>”\n\n");
        DisplayText("“<i>Package?  What package?</i>” Katherine asks, bringing to mind the curious kittens back in Ingnam.\n\n");
        DisplayText("Neither you nor Urta reply, though; instead, you indicate Urta should start leading the way and she sets off, with you close behind and Kath tagging along at the end, muttering nervously to herself as you go.\n\n");
        ...
        DisplayText("“<i>Of course it’s safe!</i>” Urta protests, wounded.\n\n");
        ...
        if (User.settings.silly()) {
            ...
            if (kGAMECLASS.shouldraFollower.followerShouldra()) {
                DisplayText("You would beg to differ, you happen to not only know one... but is also carrying one right at this instant...\n\n");
                DisplayText("“<i>Oh? So why doesn’t he come out and say hello, huh?</i>” Urta snarks, clearly feeling very put out.\n\n");
                DisplayText("“<i>Don’t mind if I do!</i>” an ethereal voice replies out of your chest.  A familiar face emerges, grinning widely.  “<i>Boo,</i>” Shouldra states, simply.\n\n");
                ...
                DisplayText("“<i>Wow, jackpot!  Come here my swollen-dicked morsels, let’s have some fun!</i>”  Shouldra lunges after both Kath and Urta, who promptly scamper, not happy with the idea of becoming a ghost’s plaything.  You just watch the spectacle unfold and both the herms and Shouldra vanish from your sight...\n\n");
                DisplayText("A few minutes later, both Urta and Kath return... panting and with their respective tents visibly absent...\n\n");
                DisplayText("“<i>Oh, dear sweet Marae’s mercy, we finally lost that freaky ghoulie,</i>” Urta pants, tongue lolling out in a very canine fashion.\n\n");
                DisplayText("“<i>That’s not funny, " + player.short + "! Kath shouts at you, tail jutting out like someone stuck a broom up her ass and swollen twice its usual girth with bristling hair.\n\n");
                DisplayText("You just shrug and tell them that - unfortunately - that one is out of your control.  “<i>So why do you put up with her?</i>” they promptly ask, even as they recompose themselves.  You shrug once more, replying that even you don’t know that...");
            }
            else if (Flags.list[FlagEnum.TIMES_MET_SHOULDRA] > 0) {
                DisplayText("You would beg to differ... you happen to know one actually...\n\n");
                DisplayText("“<i>...Have you been spending too much time out in the sun, " + player.short + "?</i>”  Urta's the one who said it, but Katherine nods her head in agreement, looking just as concerned that you’ve lost it.\n\n");
                DisplayText("You just shrug... telling them that if they don’t believe you, maybe you should take them to meet her someday?\n\n");
                DisplayText("“<i>...Yeah, maybe.</i>”  Is the again-mutual sentiment of both herms.");
            }
            else {
                DisplayText("You just snicker.");
            }
        }
        DisplayText("You suggest that Urta just open the gate so the three of you can get in and get started... if Urta says the building won’t collapse, then you trust her... and Kath should too.\n\n");
        DisplayText("Urta huffs and, trying to salve her wounded dignity, removes a key from a belt pouch, opening the padlock and then pulling the doors open before heading inside, leaving you and Kath to follow.\n\n");
        ...
        DisplayText("“<i>Alright, Katherine.  You can park your gear over in the corner, but, first, you’re probably wondering why you’re here, right?</i>” Urta declares.\n\n");
        DisplayText("“<i>To learn the skills I need to be in the Watch?</i>” Kath replies, sarcastically.\n\n");
        ...
        DisplayText("Urta pouts, clearly not too happy at having her thunder stolen, while Kath rolls her eyes.  “<i>Corny much, " + player.short + "?</i>”  Still, there’s a twinkle in her eyes that makes you feel you really have bolstered her spirits.  “<i>So, what does this training consist of, anyway?</i>”\n\n");
        DisplayText("Upon hearing that, you grin evilly at Urta and ask her if you should get the package?\n\n");
        DisplayText("Urta shakes her head and passes you the key, indicating silently that you should lock the front door instead.  Nodding in agreement, you concur that this is probably a good idea, there’s no telling how Kath will react.\n\n");
        DisplayText("The cat-morph watches nervously as you and Urta head your seperate ways.  As the fox rummages amongst the junk on the side, she audibly professes, “<i>Why do I think I’m not going to like this?</i>”\n\n");
        DisplayText("You tell Kath to relax, this will all be over soon...\n\n");
        DisplayText("“<i>Okay, now I’m really worried,</i>” she retorts, eyes flicking nervously between you and Urta.\n\n");
        DisplayText("“<i>Before we begin, you should put this on,</i>” Urta says, holding the chastity belt towards Kath.\n\n");
        DisplayText("Kath stares at it for several long moments, saying nothing.  You wonder if Urta broke her by showing it to her like that.  “<i>What?</i>” she asks, her tone flat, clearly not comprehending - or wanting to believe - what Urta is telling her.\n\n");
        DisplayText("“<i>You heard me, put it on,</i>” Urta states impatiently.\n\n");
        DisplayText("Kath just stares at you, then flattens her ears, bristles her tail, and hisses at you both, holding up one hand with fingers splayed before claws the size of gutting knives suddenly sprout from the tips.  “<i>No way!  I didn’t come here for no kinky sex, bitch!</i>” she spits.\n\n");
        DisplayText("Urta rolls her eyes.  “<i>It’s not for kinky sex... it’s part of your training.  Demons attack you with lust as well, so we need to make sure you can handle the pressure.</i>”  She takes a few steps towards Kath.  You just watch the show unfold before you...\n\n");
        ...
        if (User.settings.silly()) {
            ...
            DisplayText("“<i>Oh? Does it really work?</i>” Urta asks, sounding intrigued.\n\n");
            DisplayText("You stop to think about it... and finally conclude that, no.  Usually it doesn’t...\n\n");
            DisplayText("“<i>Figures...</i>” Urta huffs in disappointment, even as Kath hisses at you from where she’s accidentally cornered herself.\n\n");
        }
        DisplayText("“<i>Okay, kitten.  Last chance to get over here and step into the belt,</i>” Urta threatens.\n\n");
        DisplayText("“<i>Come and make me, voop.</i>” Kath spits, claws extended on all fingers now.\n\n");
        ...
        DisplayText("“<i>Insulting?</i>” you can’t resist asking.  You’ve never heard the word that Katherine used before.  “<i>It’s not really that bad, but rude all the same - it’s kind of like calling a dog or a wolf a bitch,</i>” Urta replies, gracefully dodging yet another swipe from the thrashing cat underneath.\n\n");
        ...
        DisplayText("You clarify that you thought the original plan was Kath would wear the belt for a training session and then take it off; is she going to make her keep it on until the entire course of training is over, given how much of a fuss Kath just kicked up over putting it on?\n\n");
        DisplayText("“<i>Definitely.  If we have to go through that every time we come here to train, we’ll never get any actual training done,</i>” Urta huffs.\n\n");
        DisplayText("“<i>I’ll be good,</i>” Katherine meekly promises.  “<i>Just don’t make me keep this on - days with no sex? I couldn’t take it!</i>” she pleads.  Urta shakes her head.  “<i>Sorry kitty, I gave you a chance, but you didn’t take it.  So if you want any relief from that belt, you’d better do as we say and train diligently.</i>”\n\n");
        DisplayText("“<i>I will!  I swear it!  Please, just, please, don’t make me stay in this thing all the time!</i>” the cat whimpers.  Urta pays no heed to Kath’s pleas though.  “<i>If you perform well during the training, I’ll let you off the belt to blow some steam, but until then - get used to it.</i>”\n\n");
        DisplayText("Kath mewls sadly, but nods her head in dismayed agreement.  For her sake, you hope she’ll try to get back into Urta’s good books.\n\n");
        DisplayText("Urta turns to you.  “<i>I got things here, lover.  If you want to you can see yourself out, I’ll make sure miss paws here understands fully what she’s gotten herself into.  Don’t forget to visit every once in awhile, I may need your help with one thing or another.</i>”\n\n");
        ...
        DisplayText("You promptly leave, hoping that the two will be able to come to terms somehow while you’re not there.");
    ...
    private katherineTrainingWithUrtaStage1() {
        ...
        DisplayText("“<i>When are you going to start taking this seriously, kitty?  These skills are essential if you ever get sent outside the walls!</i>”\n\n");
        DisplayText("“<i>Since when do you send people out into the desert anyway?  Besides, it’s hard to concentrate when you’re stuck in this stupid thing,</i>” the cat replies, tapping a claw-like fingernail meaningfully on the chastity belt she’s wearing.\n\n");
        DisplayText("“<i>You can’t seriously be aroused already - I’m the only one here, and it’s not like I’m in heat.  It should only be bothering you if you’re too much of a slut to control yourself!</i>” Urta snaps back.\n\n");
        DisplayText("Before things can escalate into a fight, you interject, yelling both of them to stay quiet!  This is not helping either of them!  You step between the two girls, crossing your arms and glaring at both of them.  You tell them to apologize to each other so the three of you can carry on.\n\n");
        ...
        DisplayText("You turn to smile at Kath and then ask.  If Kath did as well as Urta’s saying, what seems to be the problem?\n\n");
        ...
        DisplayText("You nod in agreement.  Even if there is no rain, there are other elements that she would need protection from; for instance, if she ever has to camp in the desert, where there is no cover, and a sandstorm kicks in, she’d be in deep trouble without a tent.\n\n");
        DisplayText("“<i>That’s exactly right - I’ve been in one of those sandstorms without shelter, and I was terrified I was going to die.  And that was just a gentle one,</i>” the fox agrees.\n\n");
        DisplayText("Turning to Kath you ask her what is the problem?\n\n");
        DisplayText("The cat grimaces at you.  “<i>Despite the fact that even if I’m not horny, this belt feels all wrong on me?  I’ve never done anything like this before, and prickvixen’s instructions on how to make a house out of sticks and cloth aren’t exactly easy to understand, you know?</i>”\n\n");
        DisplayText("“<i>In case you haven’t noticed, you’re a herm too, so lay off the gender insults,</i>” Urta snaps.\n\n");
        DisplayText("“<i>...It’s supposed to be a nickname, not an insult.  What’s wrong with having a girlcock?</i>” Kath asks, looking puzzled, even as Urta looks angrily sheepish before carefully schooling her features into neutral blankness.\n\n");
        DisplayText("You step closer to Kath and ask if she’d like you to try and explain how to build a tent for her?  You’ve already erected your own, after all.\n\n");
        DisplayText("“<i>Please?</i>” Kath begs.  “<i>I could really use some advice from someone who does this for a living.</i>”  She casts a teasing look at Urta, who simply huffs, either too tired or too honest to get upset over it.\n\n");
        DisplayText("You instruct her carefully, making sure she understands how each piece comes together; you tell her how to tie the tent down, so the wind won’t carry it, how to properly hold the structure together and even how to quickly pack everything up, should she need to move quickly.\n\n");
        DisplayText("Kath sits there quietly, intently following your every move, listening to everything you say - at least, you hope so.  Finally, she nods and starts to pick up the pieces of her tent...");
        switch (randInt(3)) {
            case 0: return { next: katherineTrainingWithUrtaStage1Success }; break;
            case 1: return { next: katherineTrainingWithUrtaStage1Failure }; break;
            case 2: return { next: katherineTrainingWithUrtaStage1Horny };
        }
    }
    ...
    private katherineTrainingWithUrtaStage1Success() {
        ...
        DisplayText("You laugh at her reaction, clapping in order to congratulate her.  Urta smiles slightly, then schools her face to look stern.  “<i>Alright, kitty, you passed the test - now let’s see you do it again!</i>”\n\n");
        DisplayText("“<i>What!?  But! ...aw...alright,</i>” Kath sighs, and promptly starts dismantling her tent.  “<i>Hey, seeing as how I did this once already, can I get this stupid belt taken off now?</i>”\n\n");
        DisplayText("“<i>No,</i>” is all Urta will say on that.\n\n");
        DisplayText("“<i>That’s not fair!</i>” Kath protests.\n\n");
        DisplayText("“<i>Do it successfully five times, and I’ll let you take it off.  Heck, do it ten times successfully with it on and without complaining, I’ll even give you a handjob - not that I think you’ve got the balls to take up a challenge like that,</i>” the vulpine herm smirks.\n\n");
        DisplayText("“<i>You’re on, pricky-vixxy!  I’m gonna enjoy being able to boast that the captain of the guard was sucking on my cock!</i>” Kath crows.\n\n");
        DisplayText("“<i>Uh, you gotta work your way up to stakes like that, all I’m offering is a handjob, kitty,</i>” Urta points out.  “<i>And stop with the prick-vixen stuff!</i>”\n\n");
        DisplayText("“<i>You’re just scared because you know I’d win,</i>” Kath replies.\n\n");
        DisplayText("“<i>Confident, huh?  Fine, let's up the ante then!  Do it ten times in a row and I will blow you... for a whole day... but if you lose... YOU are going to blow me instead!</i>”\n\n");
        ...
        DisplayText("You bid farewell to Urta and wish Kath luck, then twist the knob and see yourself out...");
    ...
    private katherineTrainingWithUrtaStage1Failure() {
        ...
        DisplayText("“<i>You better; I can’t move on to the next phase until you’ve passed this test,</i>” Urta points out.\n\n");
        DisplayText("You sigh and tell Kath you also made many mistakes before finally managing to build one.  But what’s important is her determination; as long as she keeps trying, she is bound to make it, and you’ll be cheering for her.\n\n");
        DisplayText("“<i>You really think so, " + player.short + "?</i>” she asks, looking to you with a hopeful expression.\n\n");
        DisplayText("“<i>Of course!</i>” you say, smiling.\n\n");
        DisplayText("She promptly throws her arms around you in a tight squeezing hug.  “<i>Then I’m going to try and try until I get it right.  I want to make you happy,</i>” she insists.\n\n");
        DisplayText("You return her hug, gently caressing the back of her head.\n\n");
        ...
        DisplayText("Feeling like there’s nothing else to be done here at the moment, you bid the girls farewell and return to camp.");
    ...
    private katherineTrainingWithUrtaStage1Horny() {
        ...
        DisplayText("“<i>Then what about at breakfast, when you were washing up?  Tail wagging all over the place - I could look right at your pussy every time it wasn’t hanging between your legs,</i>” Kath drawls.\n\n");
        DisplayText("Looking at Urta you tell her that does seem like something she would do when drunk...\n\n");
        DisplayText("“<i>I don’t drink that much in the morning, and certainly not while I’m working here!</i>” the vulpine herm retorts indignantly.\n\n");
        DisplayText("Okay... you apologize.  Still you oughta do something about Kath, she really looks in pain...\n\n");
        DisplayText("Kath promptly clasps her hands in front of you and stares at you and Urta alike with her eyes as wide and pleading as possible... how is it that she can look so much like an adorable little kitten when she wants to?\n\n");
        DisplayText("“<i>...Ugh, fine, I guess we can do something for her.  What do you have in mind? ...Besides taking the belt off, of course?</i>” Urta asks.\n\n");
        ...
        DisplayText("Both of them look at you as if you just sprouted another head.  “<i>What!  No way!  I don’t want her hands on my dick - besides, what would she know about giving a handjob anyway?</i>”  Kath protests.\n\n");
        DisplayText("“<i>I’ll have you know I’m an expert when it comes to using my hands on a dick - I’ve got years of practice on my own,</i>” the fox proclaims with wounded dignity.\n\n");
        DisplayText("“<i>Of course you would, you had nobody else to practice with,</i>” Kath retorts.  Urta flinches at that, looking genuinely wounded.\n\n");
        DisplayText("“<i>Hey!</i>” you interject.  “<i>That is not something you say to someone who is using her off-time to help you out!  Maybe you should stay in your belt after all... you’ll cool off sometime later...</i>”\n\n");
        DisplayText("“<i>You wouldn’t!</i>” Kath protests in horror.\n\n");
        ...
        DisplayText("The feline herm has the decency to look genuinely ashamed of herself as she turns to Urta, “<i>I’m sorry, Ms. Urta,</i>” she says.\n\n");
        DisplayText("“<i>...Just Urta, is fine,</i>” Urta grumbles, then heaves a sigh.\n\n");
        DisplayText("You nod your head, that’s much better now...\n\n");
        DisplayText("Kath then turns to you.  “<i>Can you let me out of this belt now?  Please?</i>” she begs.  You sigh and tell her that if she wants release, she’d better talk to Urta.  After what she’s done, you don’t really feel like granting her release.\n\n");
        DisplayText("“<i>Oh, come on!</i>” Kath protests, but you just ignore her.  “<i>Fiiine!</i>” she concedes, the fur on the back of her neck bristling.  She turns to Urta and takes a deep breath.  “<i>Can you grant me release?  Please?</i>”\n\n");
    ...
    private circlejerkTrainingEnding() {
        ...
        DisplayText("“<i>Well, maybe we’ll need to get together like this a little more often; we’re a trio now, aren’t we?</i>” Urta asks, smiling - and not a playful smile, a genuine one.\n\n");
        DisplayText("“<i>That’s right,</i>” Kath agrees, nodding her head, wearing the same smile.  You chuckle, it seems your little bonding session did work out after all... you tell Urta and Kath that you didn't think they’d grow so fond of each other so quickly.\n\n");
        ...
        DisplayText("“<i>Both of us at the same time?</i>” Urta slowly states, “<i>...You’re kinkier than I thought, pussycat.</i>”\n\n");
        DisplayText("“<i>Then why are you getting hard at the idea, prickvixen?</i>”\n\n");
        DisplayText("Uuuh... looks like you’d better be going.  Looking around you quickly spot your " + player.inventory.equipment.armor.displayName + " and get dressed, then bid the girls farewell, hurrying away back to camp before they get any more ideas.");
        return { next: Scenes.camp.returnToCampUseOneHour };
    }
    ...
    private katherineTrainingWithUrtaStage2() {
        ...
        DisplayText("“<i>Calling this a cat-fight would imply that this cat is actually fighting,</i>”  Urta drawls, even as she suddenly lunges forward in a straight-armed punch at her sparring partner.\n\n");
        DisplayText("To your surprise, Kath actually manages to intercept the blow with her forearm, deflecting it harmlessly but leaving herself wide-open for a palm-thrust from the fox that shoves her onto her ass.\n\n");
        DisplayText("“<i>Oof!</i>” Kath groans as she hits the floor, but doesn’t complain.\n\n");
        ...
        DisplayText("Before they can begin anew, you interrupt, telling both girls you’d like to give Kath some instructions of your own.\n\n");
        DisplayText("“<i>Sure couldn’t hurt - she needs all the help she can get.  Go on, kitty, have yourself a private lesson,</i>”  Urta drawls, then surprises you by giving you a wink.\n\n");
        DisplayText("“<i>I thought you were supposed to be my private tutor,</i>” Kath deadpans, but she eagerly approaches you.  “<i>So, " + player.short + ", what did you want to tell me?</i>” she asks, curious.\n\n");
        DisplayText("You ask if she’d like a few pointers?  You’re no expert at hand-to-hand combat, but you did come to this realm without any weapons on you, so you can handle yourself... plus you’ve been travelling all over, facing the dangers of this realm, surely you can impart some of the knowledge you’ve gained to her?\n\n");
        DisplayText("“<i>Please, " + player.short + ", I’d love to hear some pointers from an expert,</i>”  Kath replies, giving a teasing grin at her vulpine tutor, who simply huffs noisily.\n\n");
        ...
        DisplayText("The cat promptly wriggles out of your grip.  “<i>Alright, foxy, I’m coming for you now!</i>” she taunts Urta gleefully.\n\n");
        DisplayText("The vulpine officer merely yawns loudly.  “<i>About time, I was starting to fall asleep.  Come at me whenever you’re ready.</i>”\n\n");
        DisplayText("Before Kath can go, you pull her close once more to give her a light kiss on the lips, wishing her good luck.\n\n");
        DisplayText("The cat meows softly and breaks away, blushing softly.  “<i>T-thank you, " + player.short + ",</i>” she says, even as she walks away from you.  A certain awkwardness in her step suggests that maybe that wasn’t such a good idea; it looks like you’ve turned her on...\n\n");
        DisplayText("As the two herms adopt a fighting stance, Urta leers.  “<i>Just be lucky that this isn’t the wasteland, kitty, or I’d be sticking this cock of mine into you and filling you up like an old condom when I win.</i>”\n\n");
        DisplayText("“<i>Don’t be too confident, my pretty prickvixen,</i>” Kath laughs back.  “<i>Maybe you’d like to make a bet?  Loser has to cook dinner for and hand-feed the winner tonight?</i>”  She suggests.\n\n");
        DisplayText("“<i>Fine by me - but I hate fish,</i>” Urta warns her.\n\n");
        DisplayText("You take a seat on a chair nearby, this will be interesting...");
        switch (randInt(3)) {
            case 0: return { next: katherineTrainingWithUrtaStage2Success }; break;
            case 1: return { next: katherineTrainingWithUrtaStage2Failure }; break;
            case 2: return { next: katherineTrainingWithUrtaStage2Horny };
        }
    }
    ...
    private katherineTrainingWithUrtaStage2Success() {
        ...
        DisplayText("You applaud the cat-herm, clearly the plan worked flawlessly.");
        Flags.list[FlagEnum.KATHERINE_TRAINING] += 16;
        return { next: Scenes.camp.returnToCampUseOneHour };
    }
    ...
    private katherineTrainingWithUrtaStage2Failure() {
        ...
        DisplayText("“<i>No way!  I’m not a coward - I won't give up that easily!</i>” Kath protests indignantly.\n\n");
        ...
        DisplayText("Urta just shakes her head.  “<i>Anyway, not a bad move, kitty; if I hadn’t noticed what you were trying, you would have beaten me with that move for sure.  Need to work on your speed,</i>” she concludes.\n\n");
    ...
    private katherineTrainingWithUrtaStage2Horny() {
        ...
        DisplayText("Kath manages to roll on top and wraps her legs around Urta’s waist.  Urta bucks and tries to pry Kath off but she’s locked on like a vice.  You think Kath might just have the upper hand this time - and then she lets out a deep purr and tries to kiss Urta.\n\n");
        DisplayText("Urta rolls back on top of Kath and pins her firmly to the floor.  “<i>Well puss, that’s what happens when you think with your cock,</i>” Urta says, smiling. “<i>Expect to wake up in some alleyway missing some of your gems and all of your dignity.</i>”\n\n");
        DisplayText("Urta tries to get up but Kath’s legs are still locked around her waist.  Kath grins and asks “<i>What happened to filling me up like a big condom if you win?</i>”\n\n");
        ...
        if (player.gender === Gender.NONE) spitroast = null;
    ...
    private katherineTrainingWithUrtaStage2HornyLeave() {
        ...
        DisplayText("  Urta tries to fight her off, calling out, “<i>" + player.short + "!  I need some backup here.  This is <b>your</b> cock hungry kitty.</i>”  Urta tries to bat Kath’s arms away but she’s clearly turned on and you slip out before you get too horny to leave.  You’re sure they’re getting along just fine without you.");
        katherine.katherineAndUrtaHadSex(false);
        return { next: Scenes.camp.returnToCampUseOneHour };
    }
    ...
    private katherineTrainingWithUrtaStage3() {
        ...
        DisplayText("Katherine mumbles something half-hearted, but then steps aside to let you in.\n\n");
        DisplayText("You come inside and comment that from what you’ve seen, things aren’t going along as planned, huh?\n\n");
        DisplayText("“<i>No, they’re not.  I don’t know, I used to think I was a bit of a shrinking violet, but Kath here puts me to shame,</i>” Urta says, heaving a melodramatic sigh.\n\n");
        DisplayText("“<i>You’ve had lots of practice at it, Urta.  I haven’t,</i>” Kath grumbles in return.\n\n");
        DisplayText("Well, this kind of training is really important.  If Kath can’t sound authoritative when out on patrol how can she expect to be respected?  Or feared, if it comes to that.\n\n");
        DisplayText("Urta nods her head sagely.  “<i>" + player.short + ", perhaps you’d be willing to help us?  Having somebody else to act as the civilian would probably work better than just the two of us going back and forth,</i>” she suggests.  Kath nods her head, making it clear that she agrees to Urta’s suggestion.\n\n");
        DisplayText("Considering Urta’s demeanor, it’s more likely that she’s the one doing the intimidating in their exchange, you joke.\n\n");
        DisplayText("“<i>Well that may be true, but she’s actually pretty good at standing up to me... most of the time,</i>” Urta concedes.  “<i>It’s getting her to be more assertive herself that’s the tricky part.</i>”\n\n");
        DisplayText("Hmm... well Urta is the specialist, so you’ll leave things in her hands.  Adjusting your " + player.inventory.equipment.armor.displayName + " you ask what you should do?\n\n");
        DisplayText("The fox shrugs.  “<i>Just act like a defiant, disrespectful citizen - refuse to listen to her, try to make her back down, just generally encourage her to make you respect her.</i>”\n\n");
        DisplayText("You nod in understanding, telling her you’ll try.\n\n");
        DisplayText("“<i>Here, let’s have a demonstration; give you both an idea of what needs to be done.</i>”  The fox declares, then clears her throat.  “<i>Citizen, you are in a restricted area; please leave now.</i>”\n\n");
        ...
        if (Flags.list[FlagEnum.KATHERINE_TRAINING] >= 99) {
            return { next: katherineTrainingWithUrtaStage3Success };
        }
        else {
            switch (randInt(3)) {
                case 0: return { next: katherineTrainingWithUrtaStage3Success }; break;
                case 1: return { next: katherineTrainingWithUrtaStage3Failure }; break;
                case 2: return { next: katherineTrainingWithUrtaStage3Horny };
            }
        }
    }
    ...
    private katherineTrainingWithUrtaStage3Success() {
        ...
        DisplayText("You congratulate her as well, at first you really thought she was going to give up trying, but she really pulled through.  However if she truly intends to catch you she’ll have to work a LOT more on her holds, you wink at her.\n\n");
        ...
        DisplayText("“<i>Well, maybe I am, but I’m so happy - I finally did it!  Doesn’t this mean I’m in the Watch, now?</i>” Kath asks, looking Urta right in the eyes.\n\n");
        DisplayText("“<i>Now hold on there, kitten; there’s still a couple of tests you’ll need to take to prove you’ve got the skills,</i>” Urta warns, before she grins and declares, “<i>but personally, I’m sure you’ll pass the tests with flying colors.</i>”\n\n");
        DisplayText("Kath hugs Urta even harder at that, and starts to purr - much to Urta’s surprise, from the look on the vulpine herm’s face.  You repress a smile and tell Kath and Urta that, if they don’t need you anymore, you’ll head back to camp for now.\n\n");
        DisplayText("“<i>Ah, sure, " + player.short + ", go ahead,</i>” Urta replies in a distracted tone, still cuddling the purring cat-herm and looking kind of spooked at the fact.  You wish Kath luck in her upcoming tests, and then head back to camp.");
        Flags.list[FlagEnum.KATHERINE_TRAINING] += 16;
        return { next: Scenes.camp.returnToCampUseOneHour };
    }
    ...
    private katherineTrainingWithUrtaStage3Failure() {
        ...
        DisplayText("Kath sniffles, visibly weeping in front of you.  “<i>H-how could you be so cruel to me, " + player.short + "?  I-I thought you cared about me!</i>” she wails.\n\n");
        ...
        if (User.settings.silly()) {
            ...
            DisplayText("“<i>...What ARE you two doing?</i>” Urta says, completely baffled.\n\n");
            DisplayText("“<i>...Haven’t you ever played games before?</i>” Kath finally asks, looking at Urta with a shocked expression on her face.\n\n");
            DisplayText("Urta blushes.  “<i>I...er... well... oh, you two are just being ridiculous!</i>” she complains, throwing her arms up in exasperation.\n\n");
            ...
            DisplayText("Still smiling, you tell Kath that you’ll stop by later to check up on her, encouraging her to keep trying until she’s able to properly get into the mindset.  “<i>I will, name, don’t you worry - I’m so close now, I won’t let you down!</i>” she vows.\n\n");
            DisplayText("Then you turn to Urta and wink at her, telling her there’s no need to be such a killjoy... you’ll be happy to help her get over her grumpiness later, in bed.  “<i>I bet you will, " + player.short + ",</i>” Kath jokes.  “<i>But, you know, Urta, if if " + player.short + "’s not giving you enough love, I’ve got a pole you could use to loosen up with.</i>”\n\n");
            ...
            DisplayText("“<i>You know, I am not some piece of meat you two can fight over!</i>” Urta interjects, blushing fiercely and with her forearm-length prick jutting before her.  “<i>Maybe I ought to shove the two of you full of this here, if you’re so eager for sex!</i>” she blusters.\n\n");
    ...
    private katherineTrainingWithUrtaStage3Horny() {
        ...
        DisplayText("Urta moves in next to Kath and says “<i>We’re going to have to work on that.  It’s a sure bet that perps will <b>whoa!</b></i>”  Kath has got her hands on Urta’s breasts and is purring much more loudly now.  Urta swats her away and back up.  “<i>No Kath, fight it.  This is exactly what some perps will do.</i>”\n\n");
        DisplayText("Kath starts to rub her own breasts as her torso and tail sway from side to side in a hypnotic dance.  Only her overly flexible spine allows her to move that way.\n\n");
        DisplayText("Urta shakes her head and says “<i>Well she’s no good to anyone now.  It was your idea to tease her so now you’re going help me calm this kitty.</i>”");
        let spitroast: Function = threesome.spitroastKath;
        let three69: Function = threesome.threeSixtyNine;
        if (player.gender === Gender.NONE) spitroast = null;
        if (player.torso.cocks.count <= 0) three69 = null;
    ...
    private katherineTrainingWithUrtaComplete() {
        ...
        DisplayText("“<i>It’s alright, Kath, it’s alright.  I knew you had it in you,</i>” Urta says, stroking the cat’s ears.  “<i>Now, if you’d kindly get off of me and help me up...?</i>” she suggests with an embarrassed blush.  Kath promptly blushes as well and stands up, helping her new superior officer to her feet.\n\n");
        DisplayText("You can’t help but laugh at the little display of affection from Kath.  Still... you’re curious... how was the test?\n\n");
        DisplayText("Kath grins and points her thumb at herself.  “<i>I aced every last one of the written tests and the practical tests, thanks to the training you guys put me through,</i>” she proudly proclaims.\n\n");
        ...
        DisplayText("All right... the bar it is then.  You motion extend an arm for each of the herms.  They loop their arms around yours and you lead them away.\n\n");
    ...
    private katherineTrainingWithUrtaCompleteContinued() {
        ...
        if (player.gender === Gender.NONE)
            return { next: katherineTrainingWithUrtaCompleteLeave };
        else {
            DisplayText("That’s an enticing sight... you should really get back to your duties... but on the other hand another hour with the two herm beauties wouldn’t be so bad, would it?  What to do...");
            MainScreen.simpleChoices(["Stay", "Leave", "", "", ""], [katherineTrainingWithUrtaCompleteStay, katherineTrainingWithUrtaCompleteLeave, null, null, null]);
        }
    }
    ...
    private katherineTrainingWithUrtaCompleteLeave() {
        ...
        DisplayText("On the way out, you pay your tab and wave to the two girls, who seem too busy with each other to notice... well... you’ll just find out how this ends via gossip later...");
    ...
    private katherineTrainingWithUrtaCompleteStay() {
        ...
        DisplayText("“<i>Right, ah, of course, " + player.short + ".  So, what do you want me to do to you?</i>” Kath purrs, tail languidly waving in delight.\n\n");
        DisplayText("“<i>Get back in line, kitty-Kath, I want [him] first!</i>” Urta interjects.\n\n");
        DisplayText("“<i>You?  But I called [him] first!</i>” Kath protests.\n\n");
        DisplayText("“<i>As your superior officer, I command you to stand down,</i>” Urta says an authoritative manner, puffing out her chest.\n\n");
        DisplayText("“<i>Cut it back, prickvixen!  I won’t be bullied, even if you are my commanding officer,</i>” Kath shoots back.\n\n");
        DisplayText("“<i>Why you little... want me to remind you who taught you to stand up for-</i>”\n\n");
        DisplayText("“<i>Alright, that’s enough,</i>” you interject, physically separating the girls.  There’ll be enough time to discuss what to do in the back-rooms... you’re already drawing enough attention as is, and a bar brawl within the watch is not the kind of news either of them need right now...\n\n");
        DisplayText("The two herms look at each other, and nod silently, then hug each other and say, “<i>I’m sorry,</i>” in unison.  Then, with a wicked grin, they spring up and hug you, letting you feel the prominent bulges of their erect cocks against your belly.\n\n");
        DisplayText("Okay, okay, you say, laughing at the two amorous herms.  You don’t know about them, but you really don’t feel like being charged with public indecency... so let’s go to the back-rooms? you suggest once more.\n\n");
        DisplayText("“<i>Sounds good to me!</i>” they cheer at once.  You lead the girls away, arm in arm, followed by the envious stares of more than a few patrons...");
        let dpKath: Function = (player.torso.cocks.count > 0 ? threesome.doublePenetrateKath : null);
    ...
    public katherineGetsEmployed() {	//This scene plays automatically the first time that the player goes to Tel’Adre after Kath’s training is done
        ...
        DisplayText("You smile proudly and congratulate her, asking how she’s handling the changes?\n\n");
        DisplayText("“<i>It’s a bit tough,</i>” she admits, “<i>but I’m going to work hard - it’s so nice to have money in my pockets and a roof to sleep under, now.  No more hiding in alleyways and scavenging through refuse for me!</i>” she grins.\n\n");
    ...
    public postTrainingAlleyDescription() {
        ...
        if (!katherine.isAt(Katherine.KLOC_KATHS_APT)) { //Only possible if she's already been seen on guard duty at the gate and you've slept once since
            DisplayText("You see a note tucked into the side of the crate Kath used to sleep on.  It says, 'Hi " + player.short + ", everything is going great!  Come and see me at the Wet Bitch.  I'll try to be there from mid-morning to mid-afternoon.  Can't wait to see you again, love you, bye'.  It's signed with a kiss.");
        }
        else if (Flags.list[FlagEnum.KATHERINE_TRAINING] >= 100) {
            DisplayText("You guess that Urta and other members of the watch will be keeping her busy for the rest of the day.  Wherever she is you know she's being well taken care of.");
        }
        else {
            DisplayText("You're guessing that her guard detail at the gate will last all day.");
        }
        telAdre.telAdreMenuShow();
    }
