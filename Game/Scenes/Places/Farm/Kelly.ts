...
class Kelly implements TimeAwareInterface {
    ...
    private breakKeltGo() {
        ...
        DisplayText("\n\nWHAM!  ");
        if (player.tallness < 70) DisplayText("You jump up, and y");
        else DisplayText("Y");
        DisplayText("our [weapon] hits Kelt's forehead, knocking him back.  He didn't even dodge or defend himself; the hit brought him down immediately.");
        ...
        if (hasPinkEgg()) {
            DisplayText(", as well as the egg");
        }
        DisplayText(".  You grab a nearby keg and pour down vial after vial until it's half-full.  The creamy substance exudes strong female scents that arouse both of you.");

        if (hasPinkEgg()) {
            DisplayText("  You then throw the egg into the keg before stirring the whole mixture, grinning as you prepare Kelt a whole new meal.");
        }
        ...
        if (!player.torso.hips.legs.isTaur()) DisplayText("pulling [eachCock] out of your [armor] and stroking yourself with your free hand");
        else {
            DisplayText("slapping your hardening dick");
            if (player.torso.cocks.count > 1) DisplayText("s");
            DisplayText(" against your belly in anticipation");
        }
        DisplayText(".  You might as well add some flavor to the meal.");
        ...
        DisplayText(" to use later.  You lift the keg and walk up to Kelt.");
        ...
        if (!player.torso.hips.legs.isTaur()) DisplayText("fully whip out your [cock biggest] and shove it between her busty tits and slowly start grinding");
        else DisplayText("step over her, shoving your [cock biggest] between her busty tits, grinding it through that smooth valley");
        DisplayText(".");
        ...
        DisplayText("down ");
        if (player.torso.hips.legs.isTaur()) DisplayText("under you ");
        ...
        if (player.torso.hips.legs.isTaur()) DisplayText("dance your hindlegs about in order to ");
        DisplayText("cockslap her.");
        ...
        if (player.torso.hips.legs.isTaur()) DisplayText("step over her, moving your hips back and forth to thrust through her more-than-ample cleavage.");
        else DisplayText("grab her nipples and begin to thrust your pecker against her boob valley.");
        DisplayText("  She occasionally gives your tip a wet kiss, trying to make up for her mistakes.  You ignore her and thrust harder, her round melons squeezing your shaft rhythmically.");
    ...
    internal function defeatKellyNDBREAKHIM() {
        ...
        //lust/HP: 
        if (monster.lust > 99) DisplayText("Kelt moans, mauling at his mantits in his lust before he realizes what's going on");
        else DisplayText("Kelt groans, slumping slightly from all the damage you've done to him");
        DisplayText(".  You close in, saying, \"<i>Easy now, okay?  You know what I can do with my [weapon].  Now if you just calm down, I promise I'll be much nicer this time.</i>\"");
        ...
        //(Silly:)
        if (silly() && kGAMECLASS.amilyScene.amilyFollower() && kGAMECLASS.amilyScene.amilyCorrupt()) DisplayText("\n\nSomewhere, Amily perks up, \"<i>[Master]?</i>\"  How many cumbuckets do you need anyway?");
        ...
        if (player.torso.balls.quantity > 0) DisplayText(" and fondling your [balls] with great care");
        DisplayText(".  Her lips regularly wrap around your [cock biggest] in near-perfect sucking motions.  She's getting better at this.");
        ...
        if (!player.torso.hips.legs.isTaur()) DisplayText("cock-");
        ...
        if (player.torso.hips.legs.isTaur()) DisplayText("your genitals and equine body back ");
        ...
        DisplayText("\n\nA ");
        if (player.torso.hips.legs.isTaur()) DisplayText("quick step and ");
        DisplayText("heavy thrust");
        if (player.torso.hips.legs.isTaur()) DisplayText(" later");
    ...
    internal function breakingKeltNumeroThree() {
        ...
        DisplayText("he doesn't attempt to escape or attack you.  Before he can do anything, you're already on him. His reactions appear to be a lot slower since he began discovering his new craving for your dick.  He just stares at you nervously, waiting for your next move.");
        ...
        if (!player.torso.hips.legs.isTaur()) DisplayText(", sometimes with your [cock] -");
        DisplayText(" and yell: \"<i>What's your name?</i>\"");
        ...
        if (player.torso.hips.legs.isTaur()) DisplayText("push from behind");
        ...
        DisplayText("\n\nYou briskly reach ");
        if (player.torso.hips.legs.isTaur()) DisplayText("down, pushing her");
        else DisplayText("forward to grab one of her tits and grope it");
        ...
        DisplayText("as you feel your climax coming.  ");
        if (!player.torso.hips.legs.isTaur()) DisplayText("You squeeze Kelly's boobs so harshly she screams in pain, and y");
        else DisplayText("Y");
        DisplayText("ou release a loud groan yourself.  You cum hard, your quivering [cock biggest] spraying spooge in steady jets directly into the keg.  You maintain your grip on the centauress");
        if (!player.torso.hips.legs.isTaur()) DisplayText("' breasts");
    ...
    private finalKeltBreaking() {
        ...
        if (player.torso.hips.legs.isTaur()) DisplayText("kneels down");
        else DisplayText("bends over");
        DisplayText(" to reach for your [cock biggest].  She sucks with eagerness and passion; you don't even need to pull her head as it moves on its own around your length.  ");
        if (player.torso.balls.quantity > 0) DisplayText("Her free hands moves down on your groin and caresses your [balls] with expert care and precision; obviously her previous experience in groping has had an effect on her current skills.  ");
        DisplayText("Her hunger for your meaty junk seems to be insatiable, for after moments of dick kissing and licking, she decides to take the entirety of your length.  Her eyes are voracious as her fat lips swallow inch after inch of dick-flesh.");
        ...
        if (player.torso.hips.legs.isTaur()) DisplayText("hindleg haunches");
        ...
        if (player.torso.hips.legs.isTaur()) DisplayText("back away");
        else DisplayText("push the centaur girl away");
        DisplayText(" and pull out of her mouth. Wailing with displeasure, the cock-slut decides to give your meat a couple of sad licks, disappointed to see her phallic prize withdrawing from her.  She quickly regains her enthusiasm, however.");
        ...
        if (!player.torso.hips.legs.isTaur()) DisplayText("You grope her bountiful tits and pull them closer to you as you fuck them.  ");
    ...
    private kellyAppearance() {
        ...
        DisplayText(" braid hangs between her shoulders, giving you easy leverage when you have your way with her.  Her torso is likewise human-looking, only stopping below her navel where her equine part starts growing.  She stands on four horse hooves, her lower body looking almost like a horse's- aside from the pointed " + flags[FlagEnum.KELLY_HAIR.COLOR] + " demon's tail which sprouts where her horse tail should, and her cute, pink, human-like asshole.");
        //[chestnut brown/sable black/garish purple/bright pink/slutty blonde]

        DisplayText("\n\nShe sports a pair of soft DD-cup breasts.  Each one is ornate with a 0.5 inch nipple, often rock-hard in arousal.");
        if (Flags.list[FlagEnum.KELLY_BONUS_BOOB_ROWS] > 0) DisplayText("  Beneath those, she has a second row of jiggly tits, just aching to be squeezed.");
        if (pregnancy.isPregnant) DisplayText("  Drops of milk often dribble from her tits, betraying her potent lactation.");
        //[enter vagina text] 
        DisplayText("\n\nKelly has a ");
        //[virgin]
        if (Flags.list[FlagEnum.KELLY_VAGINALLY_FUCKED_COUNT] === 0) DisplayText("virgin, ");
        if (Flags.list[FlagEnum.KELLY_CUNT_TYPE] === 0) DisplayText("pink pussy");
        else DisplayText("puffy, black mare-cunt");
        DisplayText(" placed below her hindquarters.  It is almost constantly dripping rivulets of moisture when you're around.  Its shining openness seems to welcome you in her warmth.");
        if (Flags.list[FlagEnum.KELLY_HEAT_TIME] > 0 && !pregnancy.isPregnant) DisplayText("<b>  There is so much leaking from her that you think she might be in heat, rendering her more receptive to impregnation.</b>");
        ...
        if (farm.farmCorruption.hasTattoo("kelly")) {
            ...
            if (farm.farmCorruption.kellyFullTribalTats()) {
                ...
                if (farm.farmCorruption.numTattoos("kelly") > 1) DisplayText("She has the following tattoos emblazoned across her body:\n");
                else DisplayText("She has ");

                if (Flags.list[FlagEnum.KELLY_TATTOO_COLLARBONE] != 0) DisplayText(Flags.list[FlagEnum.KELLY_TATTOO_COLLARBONE] + "\n");
                if (Flags.list[FlagEnum.KELLY_TATTOO_SHOULDERS] != 0) DisplayText(Flags.list[FlagEnum.KELLY_TATTOO_SHOULDERS] + "\n");
                if (Flags.list[FlagEnum.KELLY_TATTOO_LOWERBACK] != 0) DisplayText(Flags.list[FlagEnum.KELLY_TATTOO_LOWERBACK] + "\n");
                if (Flags.list[FlagEnum.KELLY_TATTOO_BUTT] != 0) DisplayText(Flags.list[FlagEnum.KELLY_TATTOO_BUTT] + "\n");
                DisplayText("\n");
            }
        }
        ...
        if (Flags.list[FlagEnum.KELLY_KIDS] > 0) {
            if (Flags.list[FlagEnum.KELLY_KIDS] === 1) {
                DisplayText("\nKelly's ");
                if (Flags.list[FlagEnum.KELLY_FIRST_KID_GENDER] === 1) DisplayText("son");
                else DisplayText("daughter");
                DisplayText(" is off in a separate field; still very young, you can see ");
    ...
    private approachKelly() {
        ...
        if (Flags.list[FlagEnum.KELLY_VAGINALLY_FUCKED_COUNT] > 0 && Flags.list[FlagEnum.TIMES_PUNISHED_KELLY] === 0 && randInt(3) === 0 && player.torso.cocks.count > 0) {
        ...
        if (Flags.list[FlagEnum.FARM_CORRUPTION_STARTED] === 0) DisplayText("You aren't welcome on the farm proper, but you can go visit Kelly's field.");
        ...
        if (model.time.hours >= 9 && model.time.hours <= 11 && Flags.list[FlagEnum.KELLY_KIDS] >= 2) {
            ...
            if (Flags.list[FlagEnum.KELLY_KIDS] > 2) DisplayText("two youngest ");
            DisplayText("children with ");
            if (Flags.list[FlagEnum.KELLY_BONUS_BOOB_ROWS] > 0) DisplayText("the top row of ");
            DisplayText("her milk-laden tits.  When she dreamily opens her eyes and sees you standing there, she nudges them off gently.");
        ...
        if (player.inventory.items.has(consumables.CANINEP)) {
            ...
            if (Flags.list[FlagEnum.KELLY_BONUS_BOOB_ROWS] === 0) DisplayText(", but who knows how it will change her");
            DisplayText(".");
            MainScreen.addButton(6, "Give CanineP", giveKellyAPepper);
        }
        if (Flags.list[FlagEnum.KELLY_VAGINALLY_FUCKED_COUNT] > 0 && Flags.list[FlagEnum.KELLY_DISOBEYING_COUNTER] >= 3 && player.torso.cocks.count > 0) {
        ...
        if (Flags.list[FlagEnum.TIMES_PUNISHED_KELLY] > 0 && Flags.list[FlagEnum.KELLY_REWARD_COOLDOWN] === 0 && randInt(3) === 0) {
        ...
        if (Flags.list[FlagEnum.FARM_CORRUPTION_STARTED] === 0) MainScreen.addButton(9, "Leave", Scenes.camp.returnToCampUseOneHour);
    ...
    private kellySexMenu() {
        ...
        if (player.torso.cocks.count > 0 && player.stats.lust >= 33) {
            if (player.cockThatFits(300) >= 0 || Flags.list[FlagEnum.KELLY_CUNT_TYPE] === 1) {
                ...
                else if (!player.torso.hips.legs.isTaur()) MainScreen.addButton(0, "Fuck Cunt", fuckKellysCunt);
                ...
                if (player.torso.cocks.filter(Cock.FilterType(CockType.TENTACLE) >= 2) MainScreen.addButton(1, "TentaFuck", tentaFuckKelly)).length;
            }
            else DisplayText("\n<b>You're too big to fuck her vagina.</b>");
            if (Flags.list[FlagEnum.KELLY_BONUS_BOOB_ROWS] === 0 && player.cockThatFits(18, "length") < 0 && !player.torso.hips.legs.isTaur()) {
                DisplayText("\n<b>You're too big to fuck her tits.  Maybe if you gave her something to make her grow more...</b>");
            }
            else if (!player.torso.hips.legs.isTaur()) MainScreen.addButton(2, "Titfuck", kellyTitJob);
    ...
    private fuckKellysCunt() {
        ...
        DisplayText("You strip out of your [armor] in a hurry, intent on claiming your equine slut from behind.  As soon as [eachCock] flops free, Kelly takes notice, her hand coming in front of her mouth in surprise.");
        ...
        if (player.tallness < 72) {
            DisplayText("You turn around to get a stool, since your ");
        ...
        if (player.cumQ() >= 1200) {
            DisplayText("  The sheer amount of spunk exploding into her womb actually rounds her belly a little");
            if (player.cumQ() >= 4000) DisplayText(", until she's so pregnant with spooge that she can barely stand");
            DisplayText(".  ");
        }
        DisplayText("You lay immobile on her back, panting while her wonderful cunt drains you of every drop.");
        ...
        if (!pregnancy.isPregnant) DisplayText(" so the cum can turn you into a proper broodmare");
        else DisplayText(", maybe knit some for the kids you're going to be pumping out for me non-stop");
        DisplayText(".</i>\"");
    ...
    private taurOnTaurSexKelly() {
        ...
        if (player.torso.balls.quantity > 0) DisplayText("  Your [balls] tingle pleasantly from the attention, and you groan when she sucks one into her mouth, worshipping it with her lips.");
        ...
        if (Flags.list[FlagEnum.KELLY_CUNT_TYPE] === 0) DisplayText("pink pussy");
        else DisplayText("black horse-cunt");
        ...
        if (player.torso.balls.quantity > 0) DisplayText("[sack]");
        else DisplayText("hindlegs");
        DisplayText(", splattering out in fresh waves from Kelly's ");
        ...
        DisplayText("Thoroughly creamed, the centaur cum-dump sighs in satisfaction while you dismount her.");

        DisplayText("\n\nKelly starts to move, then immediately slips in the lubed mud below, legs flailing wildly.");
        if (player.stats.cor < 50) DisplayText("  You feel a little bad for her and help her up - she did just milk your dick in the way that only a centaur can.");
        else DisplayText("  You snicker and walk away - she's already served her purpose.");
        kellyPreggers();
        player.orgasm();
        return { next: Scenes.camp.returnToCampUseOneHour };
    }
    ...
    private tentaFuckKelly() {
        ...
        if (player.stats.cor < 33) DisplayText("but also a bit disgusted to watch such shameless, wanton behavior, ");
        DisplayText("you walk away, letting the slut enjoy herself.");
        kellyPreggers();
        player.orgasm();
        player.stats.sens += -3;
        return { next: Scenes.camp.returnToCampUseOneHour };
    ...
    private getARimjobFromKelly() {
        ...
        DisplayText("\"<i>You aren't worthy of my dick,</i>\" you say, as you slowly peel off your [armor]; you do it facing away from Kelly so that she can take in your [butt] as you slowly wriggle free of your underclothing.  \"<i>But I still need servicing.  So...</i>\"");
        ...
        if (player.torso.hips.legs.isNaga()) DisplayText("With reptilian litheness, you slowly lean backwards and press your hands onto the back of her head, pushing her face further between your cheeks.  ");
        else if (!player.torso.hips.legs.isTaur()) DisplayText("You lean backwards and press your hands onto the back of her head, pushing her face further between your cheeks.  ");
        DisplayText("You laugh at the sensation of her tongue as it pushes into your anal passage, slathering it with worshipful attention, perhaps hoping the sooner she gets you off the sooner this can end.");
        //[Not Centaur: 
        if (!player.torso.hips.legs.isTaur()) DisplayText("  You smirk and grip her hair, moving her head in rhythm with your own movements.");
        else DisplayText("  You gyrate your [butt] this way and that, moving her head in rhythm with your own movements.");
        ...
        if (player.torso.hips.legs.isNaga()) DisplayText("  You clench her almost bone crushingly tight in your coils as rut overtakes you.");
        ...
        if (player.torso.vaginas.count > 0) DisplayText(" and pussy");
        DisplayText("?  I can't say it's something you don't deserve for being such a shameless slut, and I don't doubt you'd enjoy every minute of it.</i>\"");
        ...
        if (Flags.list[FlagEnum.TIMES_RIM_JOBBED_BY_KELLY] === 1) {
            ...
            if (player.cumQ() >= 700) DisplayText("You, as ever, have produced a veritable oozing lake of the stuff.  ");
    ...
    private rideKellyForPunishment() {
        ...
        if (Flags.list[FlagEnum.TIMES_RIDDEN_KELLY_FOR_PUNISHMENT] === 1) {
            DisplayText("You stroke Kelly's side thoughtfully.  What would be a good punishment for a centaur? Several ideas immediately occur, but all require... equipment.  You tap your chin as a plan of action falls into place.");
            ...
            if (player.tallness < 78 && !player.torso.hips.legs.isTaur()) {
                ...
                //[Naga:]
                if (player.torso.hips.legs.isNaga()) DisplayText("  Your reptilian half is hardly ideal for riding a horse but eventually you reach a happy compromise; you perch upon her with your long tail wrapped around her barrel-like lower body.");
                //[Drider:]
                else if (player.torso.hips.legs.isDrider()) DisplayText("  Your spider half is hardly ideal for riding a horse but eventually you reach a happy compromise; you perch upon her with your long, chitinous legs wrapped carefully around her barrel-like lower body.  You must look utterly bizarre but feel reasonably comfortable.");
                DisplayText("  You lean in close to her human half and wrap your arms around her waist, drinking in the sweet scent of her pale skin; you know your own smell and power is pressing upon her senses and she whimpers softly as you slide your hands up her stomach until they are clutching her ");
                if (Flags.list[FlagEnum.KELLY_BONUS_TIT_ROWS] > 0) DisplayText("top row of ");
                DisplayText("breasts.");
                ...
                if (Flags.list[FlagEnum.KELLY_LACTATING] > 0) DisplayText(" hard enough to produce thin arcs of milk");
                DisplayText(".  The centauress gasps, her breath already ragged. \"<i>...I've got to hold onto something.  Now, giddy up!</i>\" Kelly jolts into action, stumbles slightly at the extra weight, before righting and trotting in the direction of the farm; you keep yourself steady by maintaining a firm grip upon her breasts.");
                //[PC is riding: 
            ...
            //[PC is 6'6</i>\" or more/centaur:
                ...
                if (Flags.list[FlagEnum.KELLY_LACTATING] > 0) {
                    if (Flags.list[FlagEnum.KELLY_BONUS_TIT_ROWS] > 0) DisplayText("All four of h");
                    else DisplayText("H");
                    DisplayText("er swollen teats immediately begin to dribble milk, and she moans.  ");
                }
                DisplayText("\"<i>So we will have to find some other way you can serve me.  We're going to go across to the farm.  You remember where that is, don't you?  It's where I taught you who you really are.  We're going to learn some more lessons there.  Won't that be fun?</i>\" You let go and set off at a ");
                if (!player.torso.hips.legs.isTaur()) DisplayText("march");
                else DisplayText("canter");
                DisplayText(" and after a pause she follows; deliberately led towards your destination.");
        ...
        //First repeat: 
            ...
            DisplayText("Without another word, you stride over to the stones underneath which you secreted the riding gear.  Kelly watches you with deep apprehension, and then bursts into protests as you return, carrying the heap of clinking leather and metal.");
            ...
            if (Flags.list[FlagEnum.KELLY_BONUS_TIT_ROWS] > 0) DisplayText("  Just as well there were four of them, eh?");
            DisplayText("</i>\" You step back to admire the effect.  Kelly stares back at you behind her leather straps and ball gag, her tasselled boobs forced outwards by her arms bound behind her back.  You laugh and stroke her face; she closes her eyes and bends into it, enjoying the simple motion of her [Master]'s hand.");
    ...
    private takeKellysVirginity() {
        ...
        DisplayText("You tell Kelly that you intend to come claim the prize you broke her for - her virgin ");
        if (Flags.list[FlagEnum.KELLY_CUNT_TYPE] === 1) DisplayText("horse-");
        DisplayText("cunt.");
        ...
        if (Flags.list[FlagEnum.KELLY_CUNT_TYPE] === 1) DisplayText("lust-swollen, black-lipped fuck-hole");
        else DisplayText("blooming, pink-tinged pussy");
        DisplayText(" to your roving eyes.  She asks, \"<i>Is th-th-this good, [Master]?</i>\"");
        ...
        if (Flags.list[FlagEnum.KELLY_CUNT_TYPE] === 1) DisplayText(", equine");
        DisplayText(" cunt until her hymen is easily visible.  You rub every sensitive fold that you can get to");

        if (Flags.list[FlagEnum.KELLY_CUNT_TYPE] === 1) DisplayText(", taking time to squeeze her plush, onyx vulva teasingly.  Kelly whinnies in response, overtaken by her potent equine instincts.");
        else DisplayText(", taking time to fondle her slick labia.  Kelly moans in response, overtaken by the sensations you're forcing through her.");
        ...
        if (player.cumQ() >= 500) {
            DisplayText("  You even have enough jism to make sure that some is squirting into her womb and drizzling out of her entrance, mixing with her clear fluids to make a runny, off-wet mess down her rump.");
            if (player.cumQ() >= 1500) DisplayText("  In no time flat, her belly has begun to round slightly, puffed up with spunk.");
            if (player.cumQ() >= 3500) DisplayText("  That doesn't stop you from seeding it even further, pumping her poor horse-gut until it jiggles and jostles with your spermy cargo.  There's no way she'll forget this.");
        }

        DisplayText("\n\nYou pull out with a self-satisfied sigh, admiring ");
        if (Flags.list[FlagEnum.KELLY_CUNT_TYPE] === 0) DisplayText("the redness of her well-used cunt.");
        else DisplayText("the shining juices that drip from her oh-so-equine entrance, gilding the smooth onyx lips with a slimey sheen.");
        DisplayText("  Kelly has passed out in a puddle of her own making, and you leave her like that, getting dressed without a backwards glance.");
        kellyPreggers();
        player.orgasm();
        player.stats.sens += -3;
        player.stats.cor += .5;
    ...
    private giveKellyAPepper() {
        ...
        //Repeat:
            ...
            DisplayText("You grin and dangle the pepper in front of Kelly's face wordlessly.  The centauress knows what's coming and color spreads across her cheeks; however, she still opens wide and accepts the \"<i>gift</i>\", chewing slowly and swallowing.");
            //If no second row:
    ...
    private kellyTitJob() {
        ...
        else x = player.torso.cocks.sort(Cock.LargestCockArea)[0];
    ...
    private kellyPregSex() {
        ...
        if (player.torso.cocks.get(x).type != CockType.HORSE) DisplayText("\n\nToo bad she gets yours instead.");
    ...
    private talkNHandToKelly() {
        ...
        if (Flags.list[FlagEnum.KELLY_TALK_N_HAND_TIMES] === 0) {
            DisplayText("\"<i>Talk?  Oh, that's the least interesting thing I can do with my mouth, [Master],</i>\" Kelly purrs.  That may be, you say, but she can amuse you with her hands whilst she amuses you with her voice.  The centaur gets the picture and grins.  ");
            //Not Centaur: 
            if (!player.torso.hips.legs.isTaur()) {
                DisplayText("She helps you take off the lower half of your [armor] as you set yourself down and then wraps her warm hand around ");
                if (player.torso.cocks.count === 1) DisplayText("[oneCock], gently tugging it.  It quickly hardens with the pleasing friction she coils around it.");
                else DisplayText("first your [cock], then your [cock 2], gently tugging until they are both hard from the pleasing friction she coils around them.");
            }
            //Centaur:
            else {
                DisplayText("You leisurely clop yourself around so your back end is facing her and sigh as ");
                if (player.torso.cocks.count === 1) DisplayText("a warm hands wraps itself around your [cock] and then begins to gently tug, quickly hardening it with pleasing coils of friction.");
                else DisplayText("a warm hand wraps around first your [cock] and then your [cock 2] before beginning to gently tug, both quickly hardening from the pleasing coils of friction.");
            }
        }
        //Repeat: 
        else {
            DisplayText("You tell her you'd like to... talk.");
            DisplayText("\n\nGrinning, your centaur slave ");
            if (!player.torso.hips.legs.isTaur()) {
                DisplayText("slides off the lower half of your [armor] as you set yourself down and then grasps your cock");
                if (player.torso.cocks.count > 1) DisplayText("s");
                DisplayText(" with her soft hands.  You sigh as she begins to gently pump, making ");
                if (player.torso.cocks.count > 1) DisplayText("them");
                else DisplayText("it");
                DisplayText(" harden quickly.");
            }
            else {
                DisplayText("trots around behind you.  You sigh as ");
                if (player.torso.cocks.count === 1) DisplayText("a warm hands wraps itself around your [cock] and then begins to gently tug, quickly hardening it with pleasing coils of friction.");
                else DisplayText("a warm hand wraps around first your [cock] and then your [cock 2] before beginning to gently tug, both quickly hardening from the pleasing coils of friction.");
            }
        }
        ...
        if (temp === 0) {
            ...
            if (player.torso.vaginas.count <= 0) {
                //Male: 
                DisplayText("  Now I </i>do<i> work for a man, and I spend most days polishing his [cock biggest]!");
            }
            //Futa:
            else DisplayText("  Now I am a woman, I work for another woman, and I spend most days polishing her [cock biggest]!");
            ...
            DisplayText("  You tell Kelly you appreciate the thought as you pick yourself up and leave, but you think you need to save your energy and cum for the really special case that she is.  The centaur shivers with glee.");
        ...
        //2. 
            ...
            if (player.torso.cocks.count > 1) DisplayText(" and [cock 2]");
            DisplayText(".  \"<i>Of course I can never repay you for what you've done for me.  I wasn't thinking.</i>\"");
        ...
        //3.
            ...
            if (!player.torso.hips.legs.isTaur()) DisplayText("into the air");
            else DisplayText("onto the ground");
            DisplayText(".  Kelly nuzzles your [cocks] when you're done, slurping obscenely as she polishes your nobhead");
            if (player.torso.cocks.count > 1) DisplayText("s");
            DisplayText(" to a shine.  You thank her with a slap on the ass and leave.");
        }
        //4.
        else if (temp === 3) {
            ...
            if (player.torso.balls.quantity === 0) DisplayText("suckles and laps at the very base of your [cock] for a time");
            else DisplayText("suckles and laps at your [balls] for a time");
            DisplayText(".  It's a beautiful tactic - the sound and sensation is wonderful but it also cools your cock down just a bit.");
            ...
            if (Flags.list[FlagEnum.KELLY_KIDS] > 0) DisplayText(" and bearing and raising your children");
            DisplayText(", I'm a hundred times happier.  I just used a demon's curse to get my way - you did it all on your own.  You showed me what true strength and dominance is, [Master]!</i>\"");
    ...
    private rewardKelly() {
        ...
        if (Flags.list[FlagEnum.KELLY_TIMES_REWARDED] === 0) {
            DisplayText("There seems to be an added bounce to Kelly's canter today.  She prances a bit playfully in front of you, grinning, whipping her demonic tail so that the high, sweet smell of her gushing pussy is in the air.  You realize she is calling your attention to her backside, which is unmarked.");
        ...
        //Repeat:
            ...
            DisplayText("Kelly holds her head up proudly as you inspect her, running your hand slowly over her backside.   It's nice and smooth.  You smile at her benevolently and tell her that since she's been such a good cumslut, you're going to reward her.  She claps excitedly.");
            DisplayText("  \"<i>Hurray!</i>\"");
        }
    ...
    private giveKellyAppleSauce() {
        ...
        if (Flags.list[FlagEnum.KELLY_TIMES_APPLESAUCED] === 0) {
            DisplayText("You tap your chin idly and ask Kelly what she likes eating.  Aside from dick, you add, rolling your eyes as she opens her mouth eagerly.");
            ...
            if (!farm.farmCorruption.whitneyCorrupt()) DisplayText(" \"<i>I'd like to go and check on it, but... I don't think Whitney likes me much anymore.  I'd hate to cause more trouble than I already have.</i>\"");
            else DisplayText("“<i>I'd like to go and check on it, but... I’d hate to get into Mistress Whitney’s bad books.  I’ve caused enough trouble already.</i>”");
            DisplayText(" You 'pfft' and wave your hand airily to show what YOU think of Whitney.  You tell her to stay put - as her treat, you'll go check on the orchard and bring back some apples for her, if there are any.");
            ...
            if (!player.torso.hips.legs.isTaur()) {
                ...
                //[High cum:]
                if (player.cumQ() >= 750) DisplayText("  The bowl quickly begins to brim as your [cock] torrents out cum, and eventually you have to turn away, grunting out the last jets of filth into the undergrowth.");
            }
            //[Centaur:]
            else {
                ...
                if (player.torso.vaginas.count > 0) DisplayText("\n\nYour [vagina] quivers and clenches, and gasping with the dual orgasm which is clutching your body you stand over the bowl and let some of your femcum drip into it.  Taste my summer flavor Kelly, you think wildly, and laugh with a slightly manic edge.");
                //[High cum:
                if (player.cumQ() >= 750) DisplayText("  Your [cock] torrents out cum, and eventually you have to clop away, grunting out the last jets of filth onto the ground to avoid overflowing the bowl.");
            }
        ...
        //Repeat:
            ...
            if (Flags.list[FlagEnum.KELLY_KIDS] > 1) DisplayText("  Somebody has even cleared an oblong patch of earth alongside the trees- a piece of card stuck into it is scrawled with a childish hand which declares it to be “CAROTS”.  You marvel at it all.  Who would have imagined your lust for horse pussy would have turned a pointless asshole into a loving mother who gardens with her children?  Really, you deserve a medal for your efforts.");
            ...
            if (!player.torso.hips.legs.isTaur()) {
                ...
                if (player.torso.vaginas.count > 0) DisplayText("  Your [vagina] quivers and clenches, and once again, gasping with the dual orgasm which is clutching your body, you stand over the bowl and let some of your femcum drip into it.");
                //[High cum:
                if (player.cumQ() >= 750) DisplayText("  The bowl quickly begins to brim as your [cock] torrents out cum, and eventually you have to turn away, grunting out the last jets of filth into the undergrowth.");
            }
            //[Centaur:
        ...
        if (player.torso.hips.legs.isBiped()) DisplayText("giving at the knees, ");
        ...
        if (player.stats.cor < 60) DisplayText("The taste of cum glazing her apple breath is off-putting but what did you really expect?");
        else DisplayText("You don't like to admit it but you do taste pretty good, even to yourself.  You push your tongue further into Kelly's mouth hungrily, working your jaw as you savage her mouth with your lips and tongue in search of that fruity, horny flavour, making her 'mmm' with delight and respond in kind.");
    ...
    private kellyBJsAhoy() {
        ...
        if (!player.torso.hips.legs.isTaur()) {
            ...
            if (player.torso.vaginas.count > 0) DisplayText("  You're in no hurry, and with a slight roll of your [hips] you direct her to start at the back and work her way up.");
            ...
            //Balls:
                ...
                //[Normal balls:]
                if (player.torso.balls.size <= 8) {
                    DisplayText("After curling her tongue here and there over each sensitive orb, bathing them in saliva, she envelops each one in her mouth, sucking gently first one, then the second");
            ...
            if (player.torso.balls.quantity > 0) DisplayText(", as you feel your [balls] clench");
            ...
            if (Flags.list[FlagEnum.KELLY_BONUS_BOOB_ROWS] > 0) DisplayText(" onto all four of her tits");
            DisplayText(".  The sensation of deep release is ecstatic, the sight of your cock cream pasting your slave's softness delicious.");
            if (player.cumQ() >= 750) DisplayText("\n\nAs ever you can barely control yourself once you get going, and it feels like you cum for minutes on end, painting not just her chest but her face and stomach, not stopping until she is absolutely caked and dripping with your potent sex.");
            ...
            DisplayText("  Finally you are spent.");
        }
        //Centaur:
        else {
            ...
            if (player.torso.cocks.count > 1 || player.torso.vaginas.count > 0) DisplayText("  You're in no hurry, and with a slight roll of your [hips] you direct her to start at the front and work her way down.");
            ...
            if (player.torso.vaginas.count > 0 && player.torso.balls.quantity > 0) {
                ...
                if (player.torso.balls.size <= 8) {
                    ...
                    DisplayText(", then back to the first one, a slow and sensual repetition.  She moans intermittently as she does it, and you're not sure if it's intentionally to send delightful shivers of sensation through your scrotum and up the spine of [eachCock], or it's simply because the sheer degradation of the act fills her with deep, shameful lust- supporting her soft");
                    if (pregnancy.isPregnant) DisplayText(", milk-laden");
                    DisplayText(" breasts whilst slavishly polishing the [balls] of the centaur who made her into, well, a ball-licking bitch.  Whatever the cause the result is the same.  Pleasure thrums through your groin and up your [cock biggest] and you close your eyes, lost to the sensations of her skillful tongue.");
                }
                //[Huge balls:
                else {
                    DisplayText("\n\nAfter curling her tongue here and there over each sensitive orb, bathing them in saliva, she attempts to envelop one in her mouth.  She can't though - your testicles, bulging and tight with arousal, are simply too big.  After a short pause she goes back to licking them, lapping at their surface tenderly, licking all around each one for every trace of salt and musk, wetly caressing first one, then the second");
                    ...
                    DisplayText(", then back to the first one, a slow and sensual repetition.  The warm air is punctuated with desperate 'ahh, ahn, ahh's as she surrenders herself to the deep, shameful lust of the act, supporting her soft");
                    if (pregnancy.isPregnant) DisplayText(", milk laden");
                    DisplayText(" breasts whilst slavishly polishing the [balls] of the centaur who made her into, well, a ball-licking bitch.");
                    if (Flags.list[FlagEnum.NUMBER_OF_TIMES_MET_SCYLLA] > 0 && Flags.list[FlagEnum.UNKNOWN_FLAG_NUMBER_00150] > 0) DisplayText("  You are gripped by a sudden but thrilling, velvet-edged sense of déjà vu.  Has this scene not repeated somewhere else?");
                }
            }
            //Vagina: 
            ...
            if (player.torso.balls.quantity > 0) DisplayText(", as you feel your [balls] clench");
            DisplayText(", you pull out and point your [cock biggest] downwards.  She 'aww's in deep disappointment as the dick is torn away from her, but you shush her.");
            ...
            if (player.torso.vaginas.count > 0) DisplayText("pussy-licking, ");
            if (player.torso.balls.quantity > 0) DisplayText("ball-sucking ");
            DisplayText("cock addict, you will have to do a good job of catching it on those whore pillows of yours.</i>\"  With that, you thrust your hindquarters forward.  Her breathy groan is what you hear as orgasm clenches you.");
            DisplayText("\n\nYour cock slit dilates and you spurt out rope after rope of jizz");
            if (Flags.list[FlagEnum.KELLY_BONUS_BOOB_ROWS] > 0) DisplayText(" onto all four of her tits");
            DisplayText(".  The sensation of deep release is ecstatic, the sound of your cock cream spattering onto your slave's softness delicious.");
            //[Vagina:
            if (player.torso.vaginas.count > 0) DisplayText("  Your female sex clenches and orgasms in sympathy, and you feel fluid dribble down your [hips] as you continue to paint Kelly.  Your only dim regret is that there's no way of soaking her with that, too.");
            DisplayText("\n\nFinally you are spent.  You clop around to admire your handiwork.");
            //Low cum:
            if (player.cumQ() < 750) DisplayText("  Kelly has done a sterling job of catching your load; you've frosted her boobs with long strokes quite convincingly.");
            else {
                DisplayText("  As ever, your virility has gotten the better of you.  Kelly looks like she's in an ecstatic trance.  You've completely pasted not just ");
                if (Flags.list[FlagEnum.KELLY_BONUS_BOOB_ROWS] > 0) DisplayText("all four of ");
                DisplayText("her boobs with alabaster ooze, but her stomach, face and hair.  She's holding a reservoir of the stuff in her cleavage.");
            }
        }
        //[merge]
        ...
        if (!player.torso.hips.legs.isTaur()) DisplayText(", still clutching your pleasantly aching prick");
        DisplayText(", saying you know she is, but it's a lot more pleasing to you to see her get her fix this way.  Quickly cottoning on, the centaur stares at you with her lustful green eyes as she lifts a cum-spattered boob to her mouth.");
        ...
        if (Flags.list[FlagEnum.KELLY_BONUS_BOOB_ROWS] > 0) DisplayText("\n\nShe can't reach her lower row of tits with her tongue, so she simply runs her hands over them, sighing as she rubs your musk into her horny skin and hard nipples before running her tongue across her palms.");
        DisplayText("  She leaves a trail of cum leaking down a nipple until at last, closing her eyes, she tenses and orgasms with a muffled sigh as her wet tongue pushes over her erect nub and guides the last of your fix into her mouth.");
        ...
        //Libido >50:
            ...
            if (player.torso.vaginas.count > 0) DisplayText(", letting her sensually lick you out again until your [vagina] is gleaming with arousal");
            if (player.torso.balls.quantity > 0) DisplayText(", letting her needily suckle on your [balls] again until they are inflamed with renewed pressure");
