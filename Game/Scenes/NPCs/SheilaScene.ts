export class SheilaScene extends NPCAwareContent implements TimeAwareInterface {
	...
	private sheilaPreg(reducedChance: boolean = false) {
	...
	internal function sheilaCup(): string {
		...
		else if (Flags.list[FlagEnum.SHEILA_CORRUPTION] < 310 && player.torso.cocks.count > 0) return "'would feel great around your' PP-cup";
		else if (Flags.list[FlagEnum.SHEILA_CORRUPTION] < 310 && player.torso.cocks.count === 0) return "PP-cup";
	...
	public sheilaEncounterRouter() {
		...
		if (Flags.list[FlagEnum.SHEILA_DEMON] === 0) {
			...
			//XP4: Fancy meeting you here (sheila xp >= 4 and demon sheila = 0):
				...
				DisplayText("A BUG HAPPENED.  YOUR SHEILA_XP: " + Flags.list[FlagEnum.SHEILA_XP] + ". <b>Value should be between -3 to 4.</b>");
	...
	private sheilaCorruptionUpdate() {
	...
	//[XP0 - Stay Hidden]
	private sheila1stEncStayHidden() {
		DisplayText().clear();
		DisplayText("You regulate your breathing and hold yourself still to avoid rustling anything softly, waiting for the creature to finish its business and leave.");
		//no change in sheila xp
		return { next: Scenes.camp.returnToCampUseOneHour };
	}

	//[XP0 - Look Closer]
	private sheila1ndEncLookCloser() {
		DisplayText().clear();
	...
	private sheila1ndEncLookCloserPtII() {
		DisplayText().clear();
		DisplayText("You subject yourself to her examination; she seems to take professional interest in the way you hold your [weapon].  ");
		//[(PC weapon = Scarred Blade)]
		if (player.weaponName === "Scarred Blade") DisplayText("As the blade feels her gaze, it vibrates eagerly toward her, sliding partway out of the oiled scabbard; she stares into the exposed metal transfixed, as if looking into the diary of a past life.  Abruptly, she shakes her head and turns away, and the saber calms down.  ");
		...
		//[(libido>=50)
		if (player.stats.lib >= 50) DisplayText("  Noting you still checking out her body, she smirks and says, \"<i>Enjoying your lookie, then?  Up here, cobber,</i>\" causing you to snap your head up sheepishly.");
		DisplayText("  You nod at the strange woman and introduce yourself.");
		if (player.short != "Sheila") DisplayText("  \"<i>" + player.short + ", eh?  My mates just call me Sheila.  Bunch of jokers, the bastards.</i>\"");
		else DisplayText("  \"<i>You too, eh?  Sheila's what my mates call me for a nickname.  Don't suppose you got yours from a bunch of adolescent-minded wankers, though.</i>\"");
		...
		//[(high demon score)
		if (player.demonScore() >= 4) DisplayText("  I mean, take a squizz at yourself.  It's like you're not even trying to hide it; I've seen imps that look more like normal people.");
		DisplayText("  Forget it.</i>\"  You deny the accusation, but she continues to glare at you.");
	...
	private sheila1ndEncLookCloserPtIILeave() {
		DisplayText().clear();
		DisplayText("\"<i>Good onya.  Maybe I'll see you around.</i>\"  With that, you take your leave of the strange woman.");
		//set sheila xp = 1
	...
	//set sheila xp = -1
	private sheila1ndEncLookCloserPtIITalk() {
		DisplayText().clear();
		Flags.list[FlagEnum.SHEILA_XP] = -1;
	...
	private sheila1ndEncLookCloserPtIITalkLeave() {
		DisplayText().clear();
		DisplayText("Wordlessly, you get up and back away from the woman... though not without a dirty glance.  She follows you with her eyes until you judge yourself far enough away to turn your back to her.");
		//go to camp
		return { next: Scenes.camp.returnToCampUseOneHour };
	}
	...
	// go to fight
	private sheila1ndEncLookCloserPtIITalkFight() {
		DisplayText().clear();
	...
	private sheilaApology() {
		DisplayText().clear();
		DisplayText("As you search the plains for god-knows-what, you catch your [leg] on something; a rustling in the brush below you is the only warning you get before a cleverly hidden snare closes on it!");
	...
	//[XP-1 - Avoid Her]
	private apologyAvoidSheila() {
		DisplayText().clear();
		DisplayText("You shake your head at the leery girl, and tell her you'd be just as happy as she would if you never saw each other again.");
	...
	//[XP-1 - Apologize]
	private apologySheilaApology() {
		DisplayText().clear();
		DisplayText("You scratch your " + Desc.Skin.skinFurScales(player) + " absently behind an ear, not sure how to broach the topic of reconciliation when you feel like she was the aggressor, but mumble something about being sorry things started off on the wrong foot.");
	...
	//[XP-1 - Slap'n'sult]
	private apologySheilaSlapSult() {
		DisplayText().clear();
		DisplayText("You say nothing as she finishes with the snare and stands back up.");
		...
		DisplayText("\n\n\"<i>Fuck you, arsehole!</i>\" she counters, breaking in.  \"<i>I'm not about to stand here and take a bollocking from some mullet who rolls up and expects everyone " + Desc.Gender.mf(player, "he", "she") + " meets to fall over " + Desc.Gender.mf(player, "his", "her") + " charming self like " + Desc.Gender.mf(player, "he", "she") + "'s the storybook hero" + Desc.Gender.mf(player, "", "ine") + "!  If you want a girl who'll be your soulmate at the word 'hello' you can go look for sloppy seconds from one of those goblin slags!</i>\"");
	...
	//[XP-1 - Nothing]
	private apologySheilaSayNothing() {
		DisplayText().clear();
		DisplayText("You decide to keep your own counsel for now, folding your arms defensively and frowning.");
	...
	private sheilaIsSorrySheRapedYou() {
		DisplayText().clear();
		...
		if (player.statusAffects.has(StatusAffectType.KnowsArouse)) MainScreen.addButton(2, "CastArouse", sheilaPologyCastArouse);
	...
	//[XP-2 - Leave Me Alone]
	private sheilaIsSorryButLeaveMeAlone() {
		DisplayText().clear();
		DisplayText("You shake your head and turn away, dismissing Sheila with a pointed gesture.  \"<i>H-hey!</i>\" the girl calls angrily from behind you.  \"<i>Dammit, I said I was sorry, you bastard!  Screw you!  See if I talk to you again!</i>\"");
		//set sheilapreg = -1
		Flags.list[FlagEnum.SHEILA_DISABLED] = 1;
		return { next: Scenes.camp.returnToCampUseOneHour };
	}
	//[XP-2 - Forgive]
	private sheilaIsSorryAndYouForgive() {
		DisplayText().clear();
		DisplayText("\"<i>Okay.</i>\"");
	...
	//[XP-2 - Fight]
	private sheilaPologyFight() {
		DisplayText().clear();
		DisplayText("Saying nothing, you raise your [weapon] and take a swing!  Sheila starts a bit and dodges just in time, then with a look of resignation, raises her fists as well.  \"<i>That'll be right, I guess.  For what it's worth, I really am sorry.</i>\"");
	...
	private castArouseAndLeaveSheila() {
		DisplayText().clear();
		DisplayText("You shake your head sadly.  \"<i>I'm sorry, I haven't the time right now.</i>\"");
	...
	private castArouseAndLetHer() {
		DisplayText().clear();
		DisplayText("As soon as you nod, the girl bounds to her feet and jumps you, driving you slightly downward in her ardor.");
	...
	//XP-3 or XP-4 She-mad (Sheila XP <= -3 and demon sheila = 0):
	private sheilaReallyMad() {
		DisplayText().clear();
		DisplayText("A rustle in the bush claims your attention, and you turn your head to see Sheila, standing up suddenly.  Her eyes narrow when she recognizes you, and she takes off running!");
		...
		if (Flags.list[FlagEnum.SHEILA_CORRUPTION] >= 90) DisplayText("It's so hard to remember myself anymore, and the taint you've put in my body goes crazy when you touch me.  Do you want me to get on my hands and knees?</i>\"  The woman lowers herself to the ground.  \"<i>I beg you.  ");
		DisplayText("Please, please leave me alone.");
		if (Flags.list[FlagEnum.SHEILA_XP] === -3) DisplayText("  I know you... you're not as bad as the rest of the monsters out here, so... please.");
		DisplayText("</i>\"");
		//[Stand][Leave]
	...
	//[XP-3 - Leave]
	private sheilaReallyMadLeave() {
		DisplayText().clear();
		DisplayText("Huffing, you throw the animals down and turn away.  What a display.");
		//go to camp, reincarnate as something slightly better next life
		return { next: Scenes.camp.returnToCampUseOneHour };
	}

	//[XP-3 - Stand]
	private sheilaReallyMadStandGround() {
		DisplayText().clear();
		//[(normal mode)]
		if (!silly()) {
			DisplayText("You throw the animals behind you and fold your arms.");
			DisplayText("\n\nSheila shivers, then speaks.  \"<i>Alright, mate.  If that's the way it has to be.</i>\"  She raises her fists half-heartedly.");
		}
		//(silly mode)
		else {
			DisplayText("Throwing the bundle to the side dramatically, you call the name of your stand!  Sheila's eyes widen as your body surges with renewed energy, and she jumps back as a ghostly other self materializes next to you.");
	...
	private sheilaReconcile() {
		DisplayText().clear();
		DisplayText("\"<i>Oy, it's you,</i>\" sings out a voice behind you.  \"<i>Back again?</i>\"");
	...
	//[XP1 - Don't Wanna]
	private sheilaReconcileDunWanna() {
		DisplayText().clear();
		DisplayText("Raising your hands in a palms-out gesture, you decline.  Sheila colors a bit, misinterpreting your reluctance.  \"<i>Hey, it's not like I'm cracking onto you or anything.  I was just looking for a reason to eat half a rabbit myself, is all.</i>\"");
	...
	//[XP1 - Kay]
	private sheilaReconcileKay() {
		DisplayText().clear();
		DisplayText("Some fresh meat does sound pretty tempting.  You nod at the woman and she climbs to her feet.  \"<i>Beaut!  Do me the favor and fossick about for some tinder.</i>\"");
		//--Next--
		
		MainScreen.addButton(0, "Next", sheilaReconcileKay2);
	}

	private sheilaReconcileKay2() {
		DisplayText().clear();
		...
		if (player.stats.lib < 50) DisplayText("the beckoning hunks of meat");
		else DisplayText("her rising and falling breasts under the pretext of watching her work");
		DisplayText(", until she happens to look up and catch your eye.  \"<i>Sorry, no parsley,</i>\" she says, breaking into an obliviously happy smile.  Seems like her temperament preternaturally suits this lifestyle.");
		...
		//[(pc is kangaroo)
		if (player.race() === "kangaroo-morph") DisplayText(" - except you, I suppose");
		DisplayText(".  We trade our goods in prearranged op shops and dead drops but avoid bringing outsiders into our own settlements, even when they're right corkers.</i>\"");
		...
		//[(lib >50)]
		if (player.stats.lib >= 50) DisplayText(" like yourself - I saw you perving -");
	...
	//XP2: Familiarizing (Sheila XP = 2; or Sheila XP = 3 AND time =/= 20:00 and demon sheila = 0):
	private sheilaGettingFamiliar() {
		DisplayText().clear();
		DisplayText("\"<i>Hey, it's [name].</i>\"");
	...
	//[XP2 - No Questions]
	private sheilaFriendlyNoQuestions() {
		DisplayText().clear();
		...
		DisplayText("\n\n\"<i>Didn't take ya for a quiet " + Desc.Gender.mf(player, "bloke", "sheila") + " when we met, [name]... but I find you peaceful company.</i>\"");
	...
	//[XP2 - Come Here Often?]
	private sheilaFriendlyComeHereOften() {
		DisplayText().clear();
		DisplayText("You ask her why she enjoys being on the plains so much.");
	...
	//[XP2 - Her People]
	private sheilaFriendlyHerPeoples() {
		DisplayText().clear();
		DisplayText("You lie down on the grass yourself, balance the parcel on your stomach, and ask about her people.");
		...
		if (player.femininity < 35) DisplayText("  She looks absently at your crotch.");
		...
		//(lib >=50)
			...
			if (player.torso.cocks.count > 0) DisplayText(", and you raise the kids at home?  Or put them with a nanny");
			DisplayText("?</i>\"");

			DisplayText("\n\n\"<i>Yeah, I suppose that'll work");
			if (player.torso.cocks.count > 0) DisplayText(", and I'll turn the kids over to");
			DisplayText(" - no, I mean, ");
			if (player.torso.cocks.count <= 0) DisplayText("if I decide");
			else DisplayText("I'm not ready for");
			DisplayText(" - er... fuck <b>you!</b></i>\"  This last exclamation comes in response to your pealing laughter.  \"<i>Wanker!</i>\"");
	...
	//[XP2 - Curfew?]
	private sheilaFriendlyCurfew() {
		DisplayText().clear();
		DisplayText("\"<i>Curfew?</i>\"");
	...
	//[XP3 - Ditch Her]
	private sheilaXPThreeSexyTimeDitchHer() {
		DisplayText().clear();
		DisplayText("You shake your head, pulling away from the woman and telling her she'll be fine.  \"<i>No!</i>\" she shrieks.  \"<i>You gotta help me!</i>\"");
	...
	//[XP3 - Sex]
	private sheilaXPThreeSexyTimeSex() {
		DisplayText().clear();
		DisplayText("Sheila's eyes widen with your smile, and she pulls back from you.  \"<i>That's, um...</i>\"");
	...
	private sheilaXPThreeSexyTimePostSexLetHerBe() {
		DisplayText().clear();
		DisplayText("Pulling away from you, Sheila gathers her clothing and departs, looking satisfied.  The glance she gives you over her shoulder is even a little warmer than before.");
		//i had snoo-snoo!
		Flags.list[FlagEnum.SHEILA_XP] = 4;
		return { next: Scenes.camp.returnToCampUseOneHour };
	}
	...
	private shielaXPThreeSexyTimePostSexStay() {
		DisplayText().clear();
		Flags.list[FlagEnum.SHEILA_XP] = 4;
		DisplayText("You grab her tail, provoking a curious, but not discouraging, look from the woman who was planning to spend the night alone.  \"<i>What is it, [name]?</i>\"");
	...
	//fork
	private shielaXPThreeSexyTimePostSexStayII() {
		DisplayText().clear();
		//(has cockfit 32)
		if (player.torso.cocks.count > 0 && player.cockThatFits(32) >= 0) {
			DisplayText("Her hand slips down to your groin and, overcoming its trepidation, grabs your [cockFit 32] and begins to pump languidly, slowly stimulating blood back into it.  \"<i>I don't know what's come over me,</i>\" she says, giggling.  \"<i>Maybe I'm just greedy, but... I want you again.</i>\"  She pushes you");
			//[(horse)]
			if (player.torso.hips.legs.isTaur()) DisplayText(" and you playfully roll");
			DisplayText(" onto your back; Sheila slips her leg over you");
			if (player.torso.hips.legs.isTaur()) DisplayText("r own");
			DisplayText(", positioning herself atop your crotch and guiding your tip to her pussy.  It pokes through the labia slightly, welcomed with warm wetness.  \"<i>Is... this ok, [name]?  Can I?</i>\"");
			...
			//[(not horse)]
			if (!player.torso.hips.legs.isTaur()) DisplayText(" just above one " + Desc.Breast.describeNipple(character, character.torso.chest.get(0)));
			else DisplayText(" on the thigh");
			DisplayText(".  \"<i>I'm gonna have to punish you for it, you dag.</i>\"  Excusing herself thusly, she sits up and begins to slide up and down your [cockFit 32].  ");
			//[(not horse)]
			if (!player.torso.hips.legs.isTaur()) DisplayText("Your hands squeeze her hips almost of their own volition, helping her slam down with force, and her head rolls back on her neck.  ");
			DisplayText("Her ");
			//[(sheila corruption < 30)]
			if (Flags.list[FlagEnum.SHEILA_CORRUPTION] < 30) DisplayText("little breasts rise and fall with increasing frequency atop her ribcage as her pace picks up and her breaths come short and shallow.");
			else if (Flags.list[FlagEnum.SHEILA_CORRUPTION] > 60) DisplayText("huge tits jiggle magnificently as she rocks, nearly slapping her in the face as she plunges down and then falling back into place with waves of rippling flesh.");
			else DisplayText("breasts quiver invitingly as she pumps your cock, but before you can think of grabbing one yourself, both of her hands are squeezing and caressing them, drawing sighs from the woman as she toys with her erect nipples.");
			...
			//(horse)
			if (player.torso.hips.legs.isTaur()) DisplayText("barrel");
			else DisplayText("chest");
			DisplayText(" in her soft hair - but her hips keep pumping, incredibly.  ");
			//(pc corr >= 90 or > sheila corruption)
			if (player.stats.cor >= 90 || player.stats.cor > Flags.list[FlagEnum.SHEILA_CORRUPTION]) {
				DisplayText("  The tight, rippling muscles of her pussy clamp down on you, nearly holding your cock in place as she tries to ride you still but only manages to jerk your dick up and down and squeeze pre-cum from it.  \"<i>S-so full,</i>\" Sheila groans, \"<i>did you just get bigger in me?</i>\"  Her lungs inflate as she sucks in her breath, and her hard nipples push into your " + Desc.Skin.skinFurScales(player) + ".");
			}
			else if (player.stats.cor < Flags.list[FlagEnum.SHEILA_CORRUPTION]) DisplayText("  Her pussy clamps down around you, the rippling muscles so tight that she wouldn't even be able to pump if it weren't for the hot river of juice you feel around your tool.  \"<i>A-ah,</i>\" Sheila groans, \"<i>you thrust too!  Rail me silly!</i>\"  She tries to push against you with her hands, to return herself to an upright position, but can barely pull her chest apart from you - her nipples just narrowly recede from the surface of your " + Desc.Skin.skinFurScales(player) + " as her efforts peak.");
			//(else if magically equal but < 90)
			else DisplayText("  Her pussy squirts and sucks alternately, trying to find purchase on your cock even as her pumping hips deny it; the sensation drives you wild.  \"<i>[name], your old fella is amazing...</i>\"");
			DisplayText("  Your dick twitches and swells, as if to fulfill her words, and your pelvis rocks into Sheila's as you begin to ejaculate.  \"<i>No... pull out, or you'll get me pregnant,</i>\" she cries, when ");
			//[(single cox)
			if (player.torso.cocks.count === 1) DisplayText("your dick twitches inside her");
			//(multicox)
			else DisplayText("she spies the first bead of pearly semen exiting");
			if (player.torso.cocks.count === 2) DisplayText(" your lonely, unused prick");
			if (player.torso.cocks.count > 2) DisplayText(" each of your lonely, unused pricks");
			DisplayText(".");
			...
			//[(multi)]
			if (player.torso.cocks.count > 1) DisplayText(", to be joined shortly by a messy external eruption that covers her thighs and belly in blotches of gooey white");
			DisplayText(".");
			//[(big skeet)
			if (player.cumQ() >= 1000) DisplayText("  It rolls out of you in waves, packing Sheila's cunt until she fills to capacity and the excess is forced out, sliming your own crotch.");
		...
		//(if no cockFit 32 and yes vag)
			...
			//[(horse)]
			if (player.torso.hips.legs.isTaur()) DisplayText("You turn around and straddle a leg, squatting to bring your [vagina] atop her crotch.  \"<i>Push up,</i>\" you order, and Sheila obeys eagerly, twisting her body to connect her excited pussy with yours.");
			//(else if naga)
			else if (player.torso.hips.legs.isNaga()) DisplayText("You slide it under her and lift gently; Sheila plays along with a disquieted expression, rolling over and raising her pussy into the air, and you press your own against her butt as your tail slides between her legs.  \"<i>See, you just need to be more... flexible,</i>\" you quip.");
			//(else if not horse and not naga)
			else DisplayText("You straddle her legs with your own, pressing her pussy into yours; Sheila gasps as the hot flesh connects and you tentatively rock your hips, dragging your lower lips across.");
			...
			//(sheila corruption > 30)
			if (sheilaCorruption() < 30) DisplayText(" even though they're small and humble");
			//(else sheila corruption > 60)
			else if (sheilaCorruption() > 60) DisplayText("; I worry that they're getting too mountainous");
			DisplayText(".</i>\"  A hand drifts up to her nipple, pinching it as her mouth hangs open.  She rolls it in her palm, then presses the breast against her ribcage, and her shiver of arousal transmits to you through");
			if (player.torso.hips.legs.isNaga()) {
				DisplayText(" her taut buttcheek");
				DisplayText(".");
				...
				DisplayText(" her heated, slippery vagina.");
			...
			//[(naga) 
			if (player.torso.hips.legs.isNaga()) DisplayText(" tail, drawing it up the hot opening and coiling it so you can return the warm, lube-slicked length for another pass even as you hump her butt.");
			else DisplayText(" cunt, grinding her like a sex toy in search of your own climax.");
			DisplayText("  \"<i>Do it!</i>\" you order, anxious to feel her pussy convulsing against you, anxious to feel your own squeezing her.  \"<i>Come with your lesbian lover!</i>\"");
			...
			if (player.stats.cor >= 90 || player.stats.cor > sheilaCorruption()) {
				DisplayText("  Her vagina doesn't wait for romance, spasming and opening wide to try to suck you in, pulling at your ");
				if (player.torso.hips.legs.isNaga()) DisplayText("scales");
				else DisplayText("pussy");
				DisplayText(" until you can take no more of the heat and come as well.");
				//[(naga)]
				if (player.torso.hips.legs.isNaga()) DisplayText("  Her breasts swell in your hands as she sucks in her breath sharply, feeling your pussy drool its juice onto her ass.");
			}
			//(else if PC corr < sheila corruption)
			else if (player.stats.cor < sheilaCorruption()) {
				DisplayText("  Her vagina doesn't wait for symbolism, dumping a wave of orgasm that splashes almost audibly against you.  Your pussy answers with your own climax, and begins wetting the woman underneath");
				if (player.torso.hips.legs.isNaga()) DisplayText("; it feels like her breasts are pulling away from you as she tries to push her ass further into your quivering quim");
				DisplayText(".");
			}
			else {
				DisplayText("  Her vagina drools and spasms, not interested in gestures so much as release, and coats ");
				if (player.torso.hips.legs.isNaga()) DisplayText("your tail");
				else DisplayText("your own");
				DisplayText(" with a fresh coat of her hot fluids which trigger the expected response from you.");
			}
			//(if cock)
			if (player.torso.cocks.count > 0) {
				DisplayText("  Your neglected ");
				if (player.torso.cocks.count === 1) DisplayText("prick quakes and spurts");
				else DisplayText("pricks quake and spurt");
				DisplayText(" weakly, drooling semen that pools on her skin.");
			}
			//[(not horse)
		...
		//(else if no cockFit 32 and no vag)
			...
			DisplayText("Her hand lowers to her crotch and slides her middle finger into her pussy.  \"<i>I don't know what's wrong with me,</i>\" Sheila says, nervously.  \"<i>I'm not even sure why I get hot when I think of you... you don't have anything I can use.</i>\"");

			DisplayText("\n\nYou smile at the admission");
			if (player.torso.cocks.count > 0) DisplayText(", stroking your oversized tool despite her dismissal");
			DisplayText(".  \"<i>But you do?</i>\"");
			...
			if (player.torso.cocks.count > 0) {
				...
				//(mans)
				if (!player.torso.hips.legs.isTaur()) DisplayText("falls into your lap");
				//(horse)
				else DisplayText("drifts between your legs");
				DisplayText(", then crawls its way to your [cock].  She begins stroking it, torpidly at first, but with increasing excitement as a drop of pre-cum slides down and wets her palm.  \"<i>What's wrong, goblin girl?</i>\" you ask.  \"<i>Gotta get some sperm no matter what?</i>\"");

				DisplayText("Sheila winces as your probing fingers send a shudder through her.  \"<i>Shut up, you tosser,</i>\" she retorts, yanking on your dick slightly harder in her irritation.");
			}
			//(new PG)
			...
			//[(pc corr >= 90 or > sheila corruption)]
			if (player.stats.cor >= 90 || player.stats.cor > sheilaCorruption()) DisplayText("  Her vagina heats up, squeezing your fingers so hard that you nearly can't pull out to rub her again, and you have a clear view of her breasts swelling up - arguable proof of your prowess, considering what she told you earlier.  Her people must be terrible at faking orgasm.");
			//(pc corr < sheila corruption)
			else if (player.stats.cor < sheilaCorruption()) DisplayText("  Her vagina gushes with clear fluid, filling the bowl made by your hand with warmth, and you think you can see her breasts tightening up slightly as her back arches, though it's hard to be sure with how she's shaking.");
			else DisplayText("  Her pussy quivers around you, and you draw the fingers out and pop them into Sheila's mouth.  The woman sucks on them greedily, and you raise an eyebrow at her.  She blushes again, but it's evidently not the first time she's done the same thing!");
			...
			if (player.torso.cocks.count > 0) {
				...
				//[(big skeet)
				if (player.cumQ() > 1000) DisplayText("  Her mouth fills quickly, and she writhes in your grip, managing to turn her head.  \"<i>Oh god, no way!</i>\" she coughs, spitting up enough semen to coat her chin as your ongoing orgasm spatters against her cheek.");
				//[(mega skeet)
				if (player.cumQ() >= 2000) DisplayText("  Not satisfied with that alone, you turn her head the other way for your finish, ejaculating on the rest of her face and completing her gooey, white beard as she squirms.");
				//[(multicock)
				if (player.torso.cocks.count > 1) DisplayText("  The other strokes not coming from this cock do their part to decorate your lover as well, turning her hair into a slimy mess.");
				DisplayText("  She escapes from your hand as you spend yourself, leaning away and gagging up seed onto the dry grass.");
			}
			DisplayText("\n\nThe woman falls weakly backward");
			//(cock.length > 0)
			if (player.torso.cocks.count > 0) DisplayText(", her face still covered in globby white smears");
			DisplayText(".  \"<i>Fuck...</i>\" she groans.  \"<i>You're a jerk, [name].");
			//[(cock.length > 0)
			if (player.torso.cocks.count > 0) DisplayText("  I can't believe you called me a goblin, you arsehole.");
			DisplayText("</i>\"");

			DisplayText("\n\nYou ");
			//[(cock.length > 0)
			if (player.torso.cocks.count > 0) DisplayText("can't believe how much she acts like one sometimes... but you ");
			DisplayText("just laugh and tug her ear; she flicks it and pulls away from you, backhanding you softly in the gut.  \"<i>Knock it off!</i>\"");

			DisplayText("\n\n\"<i>Are you really so worried about it?</i>\" you ask.  No answer comes");
			//[(cock.length > 0)
			if (player.torso.cocks.count > 0) DisplayText(", even after Sheila finishes wiping her face clean and stares at you");
			DisplayText(", so you just content yourself with lying next to the woman for a while.");
	...
	//[XP3 - Guard Duty]
	private sheilaXPThreeSexyTimeGuardDuty() {
		DisplayText().clear();
		DisplayText("You fold your arms and frown at Sheila, but consent to help.  She brightens, then looks confused when you make no further motion.  \"<i>So...</i>\" she begins, \"<i>what should I do?</i>\"");
		...
		//[(PC level >=8)
		if (player.level >= 8) DisplayText(" - which, you suppose, must include imps even though they're so far beneath you they might as well be underground");
		...
		//(else lib >= 40)
			...
			//[(cock.length > 0)
			if (player.torso.cocks.count > 0) DisplayText("shift your pelvis forward");
			//(cock.length === 0)
			else DisplayText("stick out your tongue playfully");
			DisplayText(".  The girl giggles at that, relaxing and finally letting herself get into the masturbation.");
	...
	//XP4: Fancy meeting you here (sheila xp >= 4 and demon sheila = 0):
	private fuckBuddySheilaMeeting() {
		DisplayText().clear();
		DisplayText("\"<i>Hey...</i>\"");
	...
	private fuckBuddySheilaMeetingMaybeLater() {
		DisplayText().clear();
		DisplayText("You tell her you haven't the time right now, but squeeze her knee as you get up again.");
	...
	//[XP4 - Just Hang]
	private fuckBuddySheilaMeetingJustHangOut() {
		DisplayText().clear();
		DisplayText("In answer, you reach down to pinch her butt and then ");
		//[(not horse or drider)
		if (!player.torso.hips.legs.isTaur() && !player.torso.hips.legs.isDrider()) DisplayText("scoot your own forward");
		else DisplayText("fold your legs under you");
		DisplayText(" to lay in the bush's shade.");
	...
	//[XP4 - Chat]
	private fuckBuddySheilaMeetingChat() {
		DisplayText().clear();
		DisplayText("\"<i>Feeling talkative?</i>\" Sheila asks.  \"<i>Have at yer.</i>\"");
	...
	private fuckBuddySheilaMeetingChatFamilyAndFriends() {
		DisplayText().clear();
		DisplayText("\"<i>Them?  They're doing fine.</i>\"  Sheila stares at you obtusely, trying to will you into changing the subject; you stare right back.  She sighs.  \"<i>No go, huh?</i>\"");
	...
	//[XP4 - Chat - Old Loves]
	private fuckBuddySheilaMeetingChatOldLoves() {
		DisplayText().clear();
		DisplayText("\"<i>[name], I don't want to talk about that,</i>\" Sheila says, \"<i>it leaves a bad taste in my mouth.</i>\"");

		DisplayText("\n\nYou offer to tell her about your own history, as an enticement, but she shakes her head.  \"<i>I don't want to talk about that either!  Look, no matter how cosmopolitan, nobody really wants to hear about the dicks " + Desc.Gender.mf(player, "his", "her") + " girl's had growing out of her face.  I mean, how many is the right answer?</i>\"");
		...
		if (player.stats.lib < 50) {
			...
			DisplayText("\n\nThe woman colors a bit and looks down.  \"<i>Er...</i>\" she mumbles, \"<i>it means you're great, [name].  Top shelf.  My favorite " + Desc.Gender.mf(player, "bloke", "sheila") + ".</i>\"");
		...
		//(else lib >=50)
			...
			if (player.stats.cor >= 60) DisplayText(" - though it's probably meant to be a defensive gesture, all it does is push her tits together under her white shirt and frame them in light-brown skin");
			DisplayText(".  \"<i>[name], you horny whacker, I'm not gonna marry you.  Having to bull my way through a horde of monsters to see you and stand watch in shifts just to sleep together at night may be romantic once, but it's no kind of thing to do every day for the rest of my life.</i>\"");
			...
			//[(corr < 30)
			if (player.stats.cor < 30) DisplayText("; you lay a hand on her shoulder reassuringly");
			DisplayText(".  Eventually she pulls away again, nose slightly red.  \"<i>Sorry, mate; didn't mean to have a tantrum on you.</i>\"");
	...
	//[XP4 - Chat - Why Hide?]
	private fuckBuddySheilaMeetingChatWhyHide() {
		DisplayText().clear();
		...
		//(if T'A)
		if (player.statusAffects.get(StatusAffectType.TelAdre).value1 >= 1) {
			DisplayText("  After all, the city in the desert seems to be bustling and bristling with weapons to resist the demons, whatever her feelings may be about it.");
	...
	private fuckBuddySheilaMeetingChatLiveWithMe() {
		DisplayText().clear();
		DisplayText("You ask Sheila to move in with you at your camp, and she turns bright red.");
	...
	private fuckBuddySheilaMeetingChatKids() {
		DisplayText().clear();
		//if joeycount = 1
		if (Flags.list[FlagEnum.SHEILA_JOEYS] === 1) {
			DisplayText("\"<i>Ah?</i>\" Sheila says, turning toward you sheepishly.");
			...
			if (player.femininity > 50) {
				DisplayText("I don't know how he'll react when he sees a pretty face like yours, though; he doesn't know that I'm-");
				//[(PC is herm, fem)
				if (player.gender >= 2) {
				...
				DisplayText(" you guess, teasing her as her blush deepens.");
				DisplayText("\n\n\"<i>[name], stop it.</i>\"");
			}
			//else if PC masculine or andro, no new PG)
			else {
				DisplayText("I'm not sure if he intends to shake your hand or punch you, though.</i>\"");
				//[(PC is male or neuter)]
				if (player.gender <= 1) DisplayText("\n\n\"<i>Sounds... protective.</i>\"");
		...
		//if 1 < joeycount < 10
			...
			DisplayText("\"<i>So how are the kids?</i>\"");
			...
			if (player.stats.lib > 50) DisplayText(" and tight, hot cunt");
			DisplayText(" so well...  \"<i>How long does it take them to grow up?</i>\"");
			...
			DisplayText("\n\nSheila laughs.  \"<i>No, mate; much older than that.  I'm not going to tell you how much, though.</i>\"  Her eyes narrow in mock suspicion, and she smiles broadly.  \"<i>A " + Desc.Gender.mf(player, "gentleman", "lady") + " doesn't ask a");
			if (player.gender >= 3) DisplayText("nother");
			DisplayText(" lady's age, after all.</i>\"");

			//[(lib >=50)
			if (player.stats.lib >= 50) {
				DisplayText("\n\n\"<i>But I'm no " + Desc.Gender.mf(player, "gentleman", "lady") + ",</i>\" you retort, leaning in to tickle her ear with your words.  \"<i>Though, I was only asking because your skin is so smooth and your nipples so perky...</i>\"  You nip at her lobe.  \"<i>And your pussy still squeezes like it's your first time.</i>\"");
		...
		//if joeycount >= 10
			...
			DisplayText("\"<i>Kids doing all right?</i>\"");
			...
			if (player.stats.lib < 50) {
				...
				//[(silly)]
				if (User.settings.silly()) {
					DisplayText(" and clutching the life-sized [name] bodypillow I made");
					DisplayText(".  But it's not going to happen right now.</i>\"");
	...
	private fuckBuddySheilaMeetingChatKidsRest4Now() {
		DisplayText().clear();
		DisplayText("\"<i>Always,</i>\" you answer, \"<i>but if you need to relax and sleep for a bit, I'm here for that too.</i>\"  You draw your hand back out, patting her on the cheek.");

		DisplayText("\n\nSheila kisses you on the forehead and then lays her head against your ");
		if (player.torso.hips.legs.isTaur()) DisplayText("back");
		else DisplayText("lap");
		DisplayText(".  \"<i>You're sweet... thank you.  I will take you up on both of those offers - but maybe just the nap this arvo.  Would you wake me up in about an hour?</i>\"");
	...
	//[XP4 - Sex]
	private sheilaXP4Sex(display: boolean = false) {
		if (display) {
			DisplayText().clear();
			DisplayText("You slip an arm around the bushranger and lean in.  \"<i>I was thinking we could have some sex... feel up to it?</i>\"");
		...
		if (player.gender > 0) {
			if (player.torso.cocks.count > 0) MainScreen.addButton(0, "69WithWang", consensualSheila69, true);
			if (player.torso.vaginas.count > 0) MainScreen.addButton(1, "69WithCooch", consensualSheila69, false);
		}
		//[Consensual - Vaginal Sex] (req. cock <= 32 area):
		if (player.torso.cocks.count > 0 && player.cockThatFits(32) >= 0) MainScreen.addButton(2, "Fuck Her", consentacleVagSexForKangarooSlutBitches);
		//da scene
	...
	private consensualSheila69(cock: boolean = true) {
		...
		if (cock) {
			if (player.cockThatFits(32) >= 0) {
				DisplayText("  Though, she smiles openly when you produce your [cockFit 32].");
				...
				//(all big cox > 32)
				DisplayText("\n\nIncreasingly wide eyes offset her thin, pressed lips as you reveal " + Desc.Cock.describeMultiCockSimpleOne(player) + ", the voluminous flesh swaying softly to the breeze.");
				...
				DisplayText(" as she rubs her small, smooth labia vigorously.  \"<i>What do you expect me to do with one of those?</i>\"");
			}
		}
		//(vag)
		else {
			DisplayText("  When you finally drop your bottoms, revealing your wet " + Desc.Vagina.describeVagina(player, player.torso.vaginas.get(0)) + ", she smiles softly.");
			...
			if (player.torso.clit.length > 8) DisplayText(" and bring your " + Desc.Vagina.describeClit(player) + " to its erect state.  \"<i>... And quite a stem,</i>\" your lover concludes.  \"<i>You sure that's not a dick?</i>\"");
			else DisplayText(", producing a slight sigh and a wet finger.  \"<i>And I'm the eager one, right?</i>\" your lover asks, wryly - though her finger is just as wet.");
		}
		...
		if (cock && player.cockThatFits(32) < 0) DisplayText("  \"<i>[name], I'm telling you it won't fit!</i>\"");
		else DisplayText("  \"<i>Not talking, then?  Please yourself.</i>\"");
		DisplayText("  Her commentary cuts off as you ");
		if (!player.torso.hips.legs.isTaur()) DisplayText("turn around and hang your ");
		else DisplayText("straddle her and squat down to dangle your ");
		if (cock) DisplayText("pre-seeping shaft");
		else DisplayText("wet pussy");
		DisplayText(" over her head, waggling it provocatively as you slip your fingers into her.");

		DisplayText("\n\n\"<i>Ah... ah... you could have just told me,</i>\" Sheila gasps, ");
		//[(cox)
		if (cock) {
			DisplayText("wrapping a hand around your shaft");
			//(big) 
			if (player.cockThatFits(32) < 0) DisplayText(" and guiding it to bend comfortably against her chest, drooling a trail of pre-cum as she slides it into position");
			DisplayText(".");
		}
		//(vag)
		else DisplayText("returning the favor and plunging into your " + Desc.Vagina.describeVagina(player, player.torso.vaginas.get(0)) + " with her hand.");
		DisplayText("  She pumps you once, eliciting a trickle of fluid, and then speaks once more.  \"<i>Bring it lower...</i>\"");

		DisplayText("\n\nYou oblige, ");
		if (!player.torso.hips.legs.isTaur()) DisplayText("flattening your back");
		else DisplayText("squatting lower");
		DisplayText(" so your ");
		if (cock) {
			DisplayText("cock sinks down");
			//[(small cock) 
			if (player.cockThatFits(32) >= 0) DisplayText(" into her warm, waiting mouth");
			else DisplayText("; she lets go of it to grab her breasts instead, trying to push them around the sensitive shaft as she runs her tongue up the underside");
			DisplayText(".");
		}
		else {
			DisplayText("pussy dangles just over her face; she ");
			if (player.torso.clit.length > 8) DisplayText("nips and sucks at the tip of your clit, rolling it with her tongue");
			else DisplayText("parts your labia with her tongue, stroking them gently and tickling your little clitoris");
			DisplayText(".");
		}
		DisplayText("  Not to be outdone in creativity, technique, or audacity, you ");
		if (!player.torso.hips.legs.isTaur()) DisplayText("lean down and bury your own tongue all the way inside Sheila, forcing her labia open with your mouth");
		else DisplayText("reach as far as you can to bring both hands into play, stroking and pulling Sheila's labia apart with one as you tease her exposed clitoris or slip inside her vagina with the other");
		DisplayText("; your lover stops licking and you can feel her mouth slip away from your sensitive skin as her head rolls back.");
		...
		//[(ladyparts)
		if (!cock) {
			DisplayText("slipping her tongue back into you");
			//[(bigclit)
			if (player.torso.clit.length > 8) DisplayText(" and stroking your " + Desc.Vagina.describeClit(player) + " rapidly with one hand");
			DisplayText(".");
		}
		//(smallcox)
		else if (player.cockThatFits(32) >= 0) DisplayText("taking you into her mouth once again and licking away a neglected drop of pre-cum.");
		else DisplayText("stroking your cock with one hand as she pushes an erect nipple against its side to trace a line.");
		...
		if (!player.torso.hips.legs.isTaur()) {
			...
			if (cock && player.cockThatFits(32) < 0) DisplayText("shaking, teasing nipples and heaving chest");
			else DisplayText("mouth, humming in delight");
			DisplayText(".");
		}
		//(horse)
		else {
			...
			if (cock && player.cockThatFits(32) < 0) DisplayText("hard nipples");
			else DisplayText("throat");
			DisplayText(".");
		}
		//merge horse with rider
		//[(big cox)
		if (cock && player.cockThatFits(32) < 0) DisplayText("\n\n\"<i>[name]!  I'm coming!</i>\" Sheila cries.");
		else DisplayText("\n\n\"<i>Mmmh!  Mm mmnnn!</i>\" Sheila moans, muffled by your body.  The import doesn't hit you until a second later.");
		DisplayText("  Her vagina convulses, ");
		//(pc corr >= 90 or > sheila corruption
		if (player.stats.cor >= 90 || player.stats.cor > Flags.list[FlagEnum.SHEILA_CORRUPTION]) {
			DisplayText("trying to pull your ");
			if (!player.torso.hips.legs.isTaur()) DisplayText("tongue");
			else DisplayText("fingers");
			DisplayText(" in ravenously.  You can literally feel her internal muscles rippling and undulating, stroking you as if they could coax out an ejaculation.  Sheila sucks in her breath as she climaxes, filling her chest; you can feel her tits pushing harder and harder against you.");
		}
		//(PC corr < sheila corruption)
		else if (player.stats.cor < Flags.list[FlagEnum.SHEILA_CORRUPTION]) {
			DisplayText("pushing out a gush of fluid.  For what seems like several minutes, her pussy deluges your ");
			if (!player.torso.hips.legs.isTaur()) DisplayText("mouth, filling you with her taste.");
			else DisplayText("hands, completely soaking them in her orgasm.");
			DisplayText("   Her thighs tense, forcing her pelvis into the air and her cunt toward you as her chest slumps; slowly, you feel the perky nipples pressing into your stomach pull away.");
		}
		//(else if equal but below 90)
		else if (player.stats.cor === Flags.list[FlagEnum.SHEILA_CORRUPTION] && player.stats.cor < 90) {
			DisplayText("drooling a trickle of fluid and licking at you as she screams her ecstasy into your crotch.");
		}
		DisplayText("  Sheila jams her face upward, ");
		//[(big cox)
		if (cock && player.cockThatFits(32) < 0) DisplayText("pressing her lips and tongue to the base of your shaft as she masturbates it vigorously.");
		///(small cox)
		else if (cock) DisplayText("sinking your [cockHeadFit 32] into the warm recesses of her throat where her muscles caress and coax it.");
		else DisplayText("penetrating you deeply with her tongue as her hands reach up to stroke your clit furiously.");
		DisplayText("  Your body gives up under her frenzied assault, laying your crotch onto the woman's face as muscle control abandons you.");

		//[(if cock-focus)]
		if (cock) {
			DisplayText("\n\nStroke after stroke of semen passes down " + Desc.Cock.describeMultiCockSimpleOne(player) + ", ");
			//[(cock fits)
			if (player.cockThatFits(32) >= 0) {
				DisplayText("pouring out into your lover's waiting throat.  She gags and you can feel the gooey seed oozing back against your [cockHeadFit 32]");
				//[(small cum)
				if (player.cumQ() < 250) DisplayText("; you withdraw from her, allowing her throat to force your ejaculate back up and over her lips and cheeks with a splutter.");
				//(big cum)
				else if (player.cumQ() < 2000) DisplayText(", but your relentless orgasm forces it down again, dumping more jism into her throat.  You can feel her hands clawing at your [butt] as you relieve your buildup.");
				//[(mega cum)
				else DisplayText(".  Soon, her visibly-rounding stomach fills and the tip of your dick is once again washed in backflow; the next spurts force the cum all the way up, and she begins drooling the slimy semen-saliva blend from her mouth and nose, hands all the more frantic in her alarm.");
			}
			//(else doesn't fit)
			else {
				DisplayText(" squirting onto and between your intertwined bodies to soak your [chest] and neck, and Sheila's softly pumping crotch.");
				//(big skeet)
				if (player.cumQ() > 1000) DisplayText("  A wellspring of seed, your body continues producing until the fuzz on her thighs and tail is completely matted down with the whiteness drooling between you.");
				//(multicocks)
				if (player.torso.cocks.count > 1) {
					DisplayText("  Your other cock");
					if (player.torso.cocks.count === 2) DisplayText(" spasms");
					else DisplayText("s spasm");
					DisplayText(" as well, adding their own issue to the unholy mess covering the poor woman.");
				}
			}
		}
		//(else if vag-focus)
			...
			if (player.torso.vaginas.get(0).wetness <= 2) DisplayText("trickle out, and are quickly sucked up by her greedy mouth");
			else if (player.torso.vaginas.get(0).wetness <= 4) DisplayText("gush freely, leaving her face slick");
			else DisplayText("overflow, soaking her hair even as she shuts her eyes tight against the cataract");
			DisplayText(".  As you climax, you wrap around her head, squeezing so hard that you flatten her ears against her skull.  Her hands latch onto your butt, trying to pull you off, but having already spent herself on her throes of passion, she's no match for yours, still ongoing, and you hold tight until your body relaxes.");
		}
		...
		//(else not smallcox)
		else DisplayText(".  She sits up, wiping sweat and stray fluids away from her eyes.");
		...
		if (cock && player.torso.balls.quantity > 0) {
			DisplayText("What you see manages to pull an explosive laugh from you, tired as you are.  Sheila gives you the stink-eye until you've recovered enough to explain the source of your mirth: on her forehead, making a perfect ");
			if (player.torso.balls.quantity === 2) DisplayText("infinity");
			else DisplayText("double infinity");
			DisplayText(" shape against the rest of her skin, is an imprint of your " + Desc.Balls.describeBalls(true, true, player) + ".  The kangaroo girl rolls her eyes at the juvenile display and resumes her harangue.  ");
		}
		DisplayText("\"<i>You could give a girl a bloody warning before that sort of behavior.  I thought you were going to kill me!</i>\"");
		...
		if (Flags.list[FlagEnum.SHEILA_XP] === 3) {
			DisplayText("\"<i>[name]... thanks.  Even being covered in your mess is better than being stuck outside all night, too scared to touch myself and too horny to run.</i>\"  Sheila kisses you on the cheek.  \"<i>My sloppy hero, eh?  I'm okay now; I can make it 'til morning when the gate reopens.</i>\"");
		...
		//(else if sheila xp =/= 3)
			...
			DisplayText("\"<i>Forget it.  With the way you worked me, I forgive you.  Just be careful, you wanker.</i>\"  Sheila closes her eyes and pulls your arm around her shoulder");
			if (cock && player.cockThatFits(32) >= 0) DisplayText(", smearing your dangling hand into the mess on her tits");
			DisplayText(".  The two of you lie like that for a while, until she gets up.  \"<i>I should really go... need to cure my catch.  Not to mention I'll have to clean up before I can even put my damn clothes back on.</i>\"  Sheila picks up her stuff.  \"<i>Hehe... see you soon.</i>\"");
		}
		return { next: Scenes.camp.returnToCampUseOneHour };
	}

	//[Consensual - Vaginal Sex] (req. cock <= 32 area):
	private consentacleVagSexForKangarooSlutBitches() {
		DisplayText().clear();
		...
		if (sheilaCorruption() <= 30) DisplayText("pert");
		else DisplayText("jiggly");
		DisplayText(" breasts as she fiddles with your own clothing.  She manages to remove the top of your [armor], exposing your [chest]; she then returns your favor by ");
		if (!player.torso.chest.find(BreastRow.FuckableNipples)) DisplayText("squeezing and fondling");
		else DisplayText("plunging two fingers into");
		DisplayText(" your own " + Desc.Breast.describeNipple(character, character.torso.chest.get(0)) + "s.  You shiver as she paws at the sensitive nubs on your chest, but don't let up your assault, moving your mouth down to tickle one of hers with your teeth and tongue.  Soon she's quaking and twitching beneath your ministrations; rubbing at her crotch with one hand as she half-heartedly tries to tease you back with the other.");

		DisplayText("\n\n\"<i>Please... I can't take any more,</i>\" she whines.  \"<i>Stop pashing on my nips and put it in, mate.</i>\"  The hand at her crotch begins trying to unfasten her belt while the other grabs and fondles her breast; you smirk and complete your own undressing quickly with both hands.  As " + Desc.Cock.describeMultiCockSimpleOne(player) + " emerges, engorged with blood, from your clothing, she switches from undressing back to rubbing, breathing heavily and stroking herself through the fabric as she stares at your ");
		//[(if wangaroo)
		if (player.torso.cocks.list[player.cockThatFits(32)].cockType === CockType.KANGAROO) DisplayText("tapered, fleshy penis.  \"<i>Wow... you never see those.</i>\"");
		...
		DisplayText("\n\nYou grin.  ");
		//[(no centaur)
		if (!player.torso.hips.legs.isTaur()) DisplayText("Taking hold of your " + Desc.Cock.describeCock(player, x));
		//(centard)
		else DisplayText("Attempting to maneuver your " + Desc.Cock.describeCock(player, x) + " into position");
		DisplayText(", you rub the head along her dripping snatch, smearing her fluid over it.  ");
		//[(non-cent)
		if (!player.torso.hips.legs.isTaur()) DisplayText("Gripping her fuzzy thighs next, you lift her bottom and line");
		//(hoers)
		else DisplayText("She lifts her bottom and lines");
		DisplayText(" her slippery passage up with your cock.  \"<i>Here it comes!</i>\" you cry.  With that announcement, you thrust into her, parting her lips with your swollen " + Desc.Cock.describeCockHead(x) + ".  She moans in relief as you finally enter her, but said relief is short-lived as you begin pumping at her slick vagina.  Gasping weakly, she lies back on the ground; ");
		if (sheilaCorruption() <= 30) DisplayText("her perky breasts rock back and forth");
		else DisplayText("her jiggling breasts flatten into perfect domes and undulate on her chest");
		DisplayText(" as you draw in and out of her warm, moist pussy.");
		...
		//[(non-cent)]
		if (!player.torso.hips.legs.isTaur()) {
			DisplayText("You pause briefly, adjusting your angle and leaning down to kiss her deeply once again and help caress her ");
			if (sheilaCorruption() <= 30) DisplayText("firm");
			else DisplayText("pillowy");
			DisplayText(" tits, then resume thrusting from your new position; her nipples now brush against your [chest] as you pump.  ");
		}
		//(if balls/vag)
		if (player.torso.balls.quantity > 0 || player.torso.vaginas.count > 0) {
			DisplayText("Her stubby tail curls inward toward you, rubbing up against your ");
			...
			DisplayText(" and tickling you as she writhes in pleasure.  ");
			//(if vag)
			if (player.torso.balls.quantity === 0 && player.torso.vaginas.count > 0) DisplayText("Your cunt twitches and drools a bit of fluid on the furry intruder.  ");
		}
		DisplayText("You fuck harder, stuffing Sheila with such force that her ");
		if (sheilaCorruption() < 30) DisplayText("perky, erect nipples trace long arcs against your skin");
		else DisplayText("jiggly tits nearly slap into her face");
		DisplayText(".  \"<i>Ohhh,</i>\" she moans, \"<i>YES!</i>\"  At that moment you feel her vagina clamp around your [cockFit 32], wringing it frantically as she reaches her climax.  You continue pumping as best you're able, but you can't stand up to the siege of her spasming pussy for long; ");
		...
		if (player.stats.cor >= 90 || player.stats.cor > Flags.list[FlagEnum.SHEILA_CORRUPTION]) {
			...
			//[(multi)
			if (player.torso.cocks.count > 1) {
				DisplayText("  Your other ");
				if (player.torso.cocks.count === 2) DisplayText("dick erupts");
				else DisplayText("dicks erupt");
				DisplayText(" as well, festooning her crotch with sticky strings.");
			}
		...
		//(PC corruption < sheila corruption)
			...
			if (sheilaCorruption() < 30) DisplayText("perky");
			else DisplayText("pillowy");
			DisplayText(" breasts seem to be held taut, compressed and motionless.  Suddenly she rams her hips into yours violently and throws her head back, and before you can issue a word of protest, her cunt wrings your " + Desc.Cock.describeCock(player, x) + " one last time with almost supernatural heat; your mind clouds over and a wracking orgasm shoots to the base of your spine, echoing back with the first wave of your ejaculation.");
		}
		//(else if equal but below 90)
		else {
			DisplayText("your orgasm quickly supersedes your control as she wrings you and rubs her nipples against your [chest].  " + Desc.Cock.describeMultiCockSimpleOne(player, true) + " begins to twitch as it unloads its first squirt of semen into her spasming pussy");
			if (player.torso.cocks.count > 1) DisplayText(" or onto her thighs and belly");
			DisplayText(".");
		}
		...
		//[(non-dog cock)
		if (!player.hasKnot(x)) {
			DisplayText("You oblige shakingly, pulling your " + Desc.Cock.nounCock(player.torso.cocks.get(x).type) + " out of her clenching pussy with a wet, sucking noise.  A trickle of semen drools from between her lips as you unburden yourself of the rest of your load, squirting it onto her groin");
			//[(big skeet)
			if (player.cumQ() > 500) DisplayText(", breasts, and face");
			DisplayText(".");
			//[(Huge skeet)
			if (player.cumQ() >= 1500) DisplayText("  More and more globs of semen shoot from the end of " + Desc.Cock.describeMultiCockSimpleOne(player) + ", pasting Sheila to the dry grass as you paint her body white.");
		}
		//(dog cock)
		else {
			DisplayText("You attempt to oblige her, but your swollen knot sticks firmly in her squeezing pussy, locking you into place.  After a few fruitless tugs, you give yourself up to your orgasm with an apology, slumping against her heaving chest and helplessly dumping the rest of your load into the twitching woman. ");
			//[(big skeet)
			if (player.cumQ() >= 1000) {
				DisplayText("Her belly begins to round as your overproductive gonads push out your massive store of semen");
				//[(huge skeet)
				if (player.cumQ() >= 3000) DisplayText(", until it's stretched as far as possible and each successive jet forces out squirts of frothy jism from the tight seal her pussy makes around the knot");
				DisplayText(". ");
			}
			//[(multi)
			if (player.torso.cocks.count > 2) DisplayText("Your other cocks erupt as well, soaking her crotch and matting down the fur on her thighs with whiteness. ");
		}
		DisplayText("Both of your orgasms finish up");
		//(dog-c) 
		if (player.hasKnot(x)) DisplayText(" and you finally manage to pull out of her");
		DisplayText("; the two of you lie there breathing raggedly for several minutes.  Sheila breaks the silence first.");
		...
		//[(sheila xp = 3)
		if (Flags.list[FlagEnum.SHEILA_XP] === 3) {
			DisplayText("  Sheila looks over, thankfulness written on every inch of her brow.  \"<i>[name]... I really appreciate what you did.  I'd rather be knocked up than caught by some nightmare because I was too horny to hide properly until the colony opened - er, not that I want to be knocked up by you, sweet as you are.</i>\"");
		...
		//(else sheila xp =/= 3)
			...
			//[(norm skeet)
			if (player.cumQ() < 500) DisplayText("as she strokes the " + Desc.Skin.skinFurScales(player) + " of your chest");
			else DisplayText("as she wipes off as much jizz as she can");
			DisplayText(", then get up and collect your gear.  \"<i>Um... see you later, ok?</i>\" she says.");
			return { next: Scenes.camp.returnToCampUseOneHour };
		}
	...
	//da scene
	private sheilaMutualMasturbation() {
		DisplayText().clear();
		let target: string = "";
		let choices: Array = new Array();
		if (player.torso.cocks.count > 0) {
			if ((player.torso.hips.legs.isTaur() && player.tallness * (5 / 6) < player.torso.cocks.sort(Cock.LongestCocks)[0].length) || player.torso.cocks.count > 0) choices[choices.length] = "cock";
		}
		if (player.torso.vaginas.count > 0 && !player.torso.hips.legs.isTaur()) choices[choices.length] = "vagina";
		if (player.torso.chest.find(BreastRow.FuckableNipples)) choices[choices.length] = "nipplecunt";
		if (player.gender === Gender.NONE || choices.length === 0) choices[choices.length] = "ass";

		if (choices.length === 0) {
			CoC_Settings.error("");
			DisplayText("ERROR - SHEILA MASTURBATE BROKE, SON");
			return { next: Scenes.camp.returnToCampUseOneHour };
		}
		...
		if (User.settings.silly()) DisplayText("-chan");
		DisplayText("?</i>\"");
		...
		//[(horse)
		if (player.torso.hips.legs.isTaur()) DisplayText(", folding your legs under you,");
		DisplayText(" and begin ");
		//[(adequate-length cock)
		if (target === "cock") {
			DisplayText("stroking your [cock], pointing it at her as you smear pre-cum onto your fingers");
		}
		//(non-horse vag)
		else if (target === "cunt") DisplayText(" sliding your hand to your [vagina], parting your lips with two fingers");
		//(gross-ass nipcunts)
		else if (target === "nipplecunt") DisplayText("plunging your fingers into one of your awkward, distended nipples");
		//(Unsexed non-centaur only)
		else if (target === "ass" && !player.torso.hips.legs.isTaur()) DisplayText("licking a finger and teasing your asshole with shallow strokes, gently circling the ring");
		//(centaur who hasn't got shit)
		else DisplayText("sucking a single digit salaciously, fingerfucking your mouth and coating it with saliva");
		DisplayText(".  \"<i>Oh... are you going to touch me, or just play with that?</i>\" Sheila asks, grinning.");
		...
		if (target === "cock") DisplayText("begin stroking your shaft, drooling pre-cum onto her skin and ");
		//(non-horse vag)
		else if (target === "cunt") DisplayText("demonstrate by slipping your fingers into your own [vagina] and ");
		...
		if (target === "cock") DisplayText("You return your hand to your [cock], pumping vigorously to catch up to your lover, spurred onward by the smooth skin she presses into your lips.");
		//(else if nonhorse vag)
		else if (target === "cunt") DisplayText("You slide your hand between your [legs] again, intent on recovering the march Sheila's stolen on you, and begin rubbing your [clit] vigorously while sighing into her breast.");
		//(else if RNG disgusting nipplecunts)
		else if (target === "nipplecunt") DisplayText("Your hand returns to your chest, slipping inside the sensitive flesh of your nipple, and you groan into Sheila's as a trickle of moisture falls from your chest.");
		//(else if non-centaur asshole)
		else if (!player.torso.hips.legs.isTaur()) DisplayText("Your hand reaches back to your [asshole], neglected for too long, and a finger spears your pucker, stroking the nerves inside as you hurry to bring your arousal in line with Sheila's.");
		///(else if fucking nothing)
		else {
			DisplayText("You wish you had something to play with as you watch your lover writhe under you");
			//[(silly), even just a paperclip].]
			if (User.settings.silly()) DisplayText(", even just a paperclip");
			DisplayText(".");
		}
		...
		//[(if fucking nothing)
		if (target != "cock" && target != "cunt" && target != "nipplecunt") DisplayText(", and yours joins her, slipping into her entrance alongside");
		DisplayText(".  \"<i>Just... say I'm always yours!</i>\"  She turns you toward her face again, locking you in a kiss, and your ");
		//[(if cock)
		if (target === "cock") {
			if (player.torso.cocks.count === 1) DisplayText("prick begins");
			else DisplayText("pricks begin");
			DisplayText(" to twitch, ejaculating a stroke onto Sheila's midriff and wrist.  The girl groans in your mouth at the new heat, and her body shakes in orgasm.");
		}
		//(vag)
		else if (target === "cunt") {
			DisplayText("pussy convulses, ");
			if (player.torso.vaginas.get(0).wetness < 4) DisplayText("drooling");
			else DisplayText("squirting");
			DisplayText(" around your hand.  As your body shakes and your lips rattle against Sheila's, she shivers and her own orgasm begins.");
		}
		//(nipcunts)
		else if (target === "nipplecunt") {
			DisplayText("nipple constricts around your fingers in climax, oozing lubrication onto your partner.  As the drops from your " + Desc.Breast.describeBreastRow(player.torso.chest.get(0)) + " hit her own, Sheila's back arches again and her own orgasm begins.");
		}
		//(jack shit)
		else DisplayText("fingers are pulled into her vagina by her muscles as her orgasm begins.");
		//[( pc corr >= 90 or > sheila corruption) 
		if (player.stats.cor >= 90 || player.stats.cor > Flags.list[FlagEnum.SHEILA_CORRUPTION]) {
		...
		//(else if equal corr but under 90)
			...
			DisplayText("She breaks the kiss, drawing her hand from her pussy, and holds your head in front of her; her eyes soften with affection as she shudders.");
			//[(not jack shit)
			if (target === "cunt" || target === "cock" || target === "nipplecunt") DisplayText("  Emptying your reserves, you allow yourself to fall into her arms, resting your head on her chest.");
		}
		...
		//(else no corruption warning triggered)
			...
			DisplayText("\n\nSheila strokes your " + Desc.Head.describeHair(player) + " as you lie ");
			if (target === "cock") DisplayText("there, staring at the load you left in her bellybutton");
			else DisplayText("together");
			DisplayText(".  \"<i>Oh, I had so much fun, mate.");
			//[(if sex =U and sillymode)
			if (player.gender === Gender.NONE && silly()) DisplayText("  I love you, my Ken doll.");
			DisplayText("</i>\"");
			//[(if sheila xp = 3)
			if (Flags.list[FlagEnum.SHEILA_XP] === 3) {
	...
	private sheilaCorruptionWarningsChooseFondle() {
		DisplayText().clear();
		...
		if (player.torso.cocks.count > 0) DisplayText("erect");
		else if (player.torso.vaginas.count > 0) DisplayText("wet");
		else DisplayText("aching");
		DisplayText(".  Even as she goes, you can still see the edges of her amazing, swaying rack around the sides of her torso.");
	...
	private sheilaCorruptionWarningListenToHer() {
		DisplayText().clear();
		DisplayText("\"<i>So...</i>\" you answer, your feel frozen in mid-cop, \"<i>what?</i>\"");
	...
	internal function sheilaGotWhomped() {
		DisplayText().clear();
		DisplayText("Sheila collapses, ");
		//[(HP)
		if (monster.stats.HP < 1) DisplayText("completely spread-eagled from her injuries");
		///(lust)
		else DisplayText("rubbing her thighs together and smearing around the moisture from her pussy");
		DisplayText(".  As you stand over her, she forces herself to her elbows and tries to scoot away from you, fear written on her face.  \"<i>I'm sorry... please, no...");
		//[(sheila xp > -4)
		if (Flags.list[FlagEnum.SHEILA_XP] > -4) DisplayText("  I'll forgive you for everything else, but please, not this!");
		DisplayText("</i>\" she implores.");
		//[(sheila corruption >= 90)
		if (sheilaCorruption() >= 90) DisplayText("  \"<i>I-if you touch me again... god, I can't even think straight anymore!  Don't do this!</i>\"");
		//(lust >= 30)
		...
		if (player.stats.lust >= 33) {
			if (player.torso.cocks.count > 0 && player.cockThatFits(48) >= 0) MainScreen.addButton(0, "Fuck Pussy", rapeSheilasCooter);
			if (player.torso.cocks.count > 0) {
				if ((!player.torso.hips.legs.isTaur() && player.shortestCockLength() <= player.tallness * .35) || (player.torso.hips.legs.isTaur() && player.tallness * 1.2 <= player.shortestCockLength() && player.shortestCockLength() <= player.tallness * 1.55)) {
					MainScreen.addButton(1, "Forced BJ", forcedSheilaOral, true);
				}
			}
			if (player.torso.vaginas.count > 0) MainScreen.addButton(2, "Forced Lick", forcedSheilaOral, false);
		}
	...
	private rapeSheilasCooter() {
		DisplayText().clear();
		//set sheila xp = -4
		Flags.list[FlagEnum.SHEILA_XP] = -4;
		let x: number = player.cockThatFits(48);

		DisplayText("You grab the girl by her fuzzy leg; she tries to kick away from you, but you pull her back, pinning her");
		//[(horse)
		if (player.torso.hips.legs.isTaur()) DisplayText(" by planting your forehooves just above her hips");
		DisplayText(".  Reaching down, you take the neck of her shirt in your hand, then rip it open, exposing her ");
		//[(sheila corruption < 30)
		if (sheilaCorruption() < 30) DisplayText("tiny ");
		//sheila corruption > 60)
		else if (sheilaCorruption() > 60) DisplayText("huge, soft ");
		...
		//[(monster HP < 1)
		if (monster.stats.HP < 1) DisplayText("sliding it between her labia and producing a damp spot, then ");
		DisplayText("dragging the wet fabric around her vulva.");

		DisplayText("\n\nSatisfying yourself as to her readiness, you unfasten your [armor] to extract your [cockFit 48]; the " + Desc.Cock.describeCockHead(x) + " drips with pre-cum as you pull it loose, and you lay it on her crotch, letting the goo soak the white fabric until you can see her light-brown skin through it.  She squirms under it, bringing up another droplet with her motion, and you place the tip at the entrance to her pussy, pressing eagerly against the fabric.  \"<i>Please...</i>\" she whimpers, \"<i>I'm begging you; don't.</i>\"");

		//fuck-fork
		//[(corruption < 50)
		if (player.stats.cor < 50) {
			DisplayText("\n\nYou frown at the girl.  She still wants to escape, even though her body is eager for this?  You can feel her wet pussy twitching at your " + Desc.Cock.describeCockHead(x) + ".  Dragging the oozing tip along her soaked panties provokes a shiver and another bloom of fluid from the girl, but she bites her lip and refuses to meet your eye.");
			...
			DisplayText("\n\nMan, whatever.  Experimentally, you push in again, testing how far her panties will let you go, and her labia accept you smoothly, rubbing the fabric against your " + Desc.Cock.describeCockHead(x) + ".  With lips spread open, even her small clitoris can be felt through the cloth, and you take the opportunity to rub at it");
			if (player.torso.hips.legs.isTaur()) DisplayText(" with your belly");
			...
			//[(big skeet)
			if (player.cumQ() >= 500) DisplayText("  Soon you've filled her as fully as the shallow penetration will allow, and the panties begin to press back against your cock, oozing onto you whatever semen the porous dam can't contain.");
			//(mega skeet)
			else if (player.cumQ() >= 1500) DisplayText("  It sags and bows around the tip of your spear, pulsing with each new stroke as the hemlines leak jizz onto her legs and butt.");
			...
			//[(big skeet)
			if (player.cumQ() >= 500) DisplayText("So much cum fills her pussy that it slips out, once again restoring the opacity, though not the dryness, of her panties.  ");
			DisplayText("You return her gaze, turning your nose up dismissively.  Conscious of her nudity, she pulls up her shorts and buttons her vest to conceal herself as you leave her behind.");
			...
			if (x.area > 32) DisplayText(" and the pain of taking a cock slightly too large for her");
			DisplayText(", and she actually rears back to scratch at you with her fingernails.  You catch her hand and hold it, and she responds by spitting at you!  \"<i>Fuck you, arsehole!</i>\" Sheila shrieks.  \"<i>Take it out!</i>\"  Reaching down, you slap her in the face.");
			...
			if (sheilaCorruption() > 10) DisplayText(" jiggles her breasts and");
			...
			//[(not centaur)
			if (!player.torso.hips.legs.isTaur()) DisplayText(", leaning down to kiss her long neck and collarbone");
			...
			//[(nothors)
			if (!player.torso.hips.legs.isTaur()) DisplayText(", transferring yours to her breast while brushing her torn shirt to the side");
			DisplayText("; without struggling further, she slowly lowers it");
			//[(nothors)
			if (!player.torso.hips.legs.isTaur()) DisplayText(" to rest atop your own");
			DisplayText(", confirming your suspicion.  Her eyes close and her chin raises resignedly");
			//[(nothors)
			if (!player.torso.hips.legs.isTaur()) DisplayText(" as you triumphantly squeeze the flesh in your hand and kiss her under the jaw");
			DisplayText(".");
			...
			//[(mans)
			if (!player.torso.hips.legs.isTaur()) DisplayText("place a hand along her face, tuning it toward you, and kiss her on the lips.");
			else DisplayText("bend down, lowering your torso until you can caress her cheek.");
			DisplayText("  \"<i>Of course I won't,</i>\" you answer sweetly.  \"<i>What would be the point?</i>\"  Sheila winces as you hilt yourself, sinking your [cockFit 48] so far into her that your crotch meets hers.  You shudder");
			//[(nonhors)
			if (!player.torso.hips.legs.isTaur()) DisplayText(" and squeeze her breast");
			DisplayText(" as your climax arrives and the first of your seed pours into her grasping pussy.  While you fill her, her back arches");
			//[(nonhors) 
			if (!player.torso.hips.legs.isTaur()) DisplayText(" and she presses your hand uncomfortably");
			DisplayText(", gasping as her own orgasm begins.  Her knees wrap around your sides, satisfying your predicition, and her vagina");
			//[(pc corr >= 90 or > sheila corruption)
			if (player.stats.cor >= 90 || sheilaCorruption() < player.stats.cor) {
				DisplayText(" pulls greedily at your [cockFit 48], drinking up your semen as fast as you can squirt it.  She sucks in breath as she climaxes, finally opening her eyes as her head tilts back");
				//[(nonhors)
				if (!player.torso.hips.legs.isTaur()) DisplayText("; you can almost feel her breast heating up and swelling with blood under your hand, as the nipple pokes into your palm");
				DisplayText(".");
			}
			//(PC corr < sheila corruption)
			else if (player.stats.cor < sheilaCorruption()) {
				DisplayText(" floods you with juices, dumping so much around your twitching cock that you feel like you're lowering it into a hot spring.");
				//[(nonhors)
				if (!player.torso.hips.legs.isTaur()) DisplayText("  She squeezes your hand so hard that you swear you can feel her breast compressing under it as she screams her pleasure.");
			}
			//(else equal but < 90)
			else {
				DisplayText(" drools eagerly as you mingle your juices with hers, until the fluid begins to thicken with white seed.");
			}
			//[(big skeet)
			if (player.cumQ() >= 500) DisplayText("  Overabundant as always, your semen quickly fills her to capacity and begins to squirt out around your shaft, staining her thighs.");
			//[(multicock)
			if (player.torso.cocks.count > 1) {
				DisplayText("  Your other ");
				if (player.torso.cocks.count === 2) DisplayText("dick spits");
				else DisplayText("dicks spit");
				DisplayText(" as well, leaving trails all over her light-brown skin.");
			}
	...
	private forcedSheilaOral(dick: boolean = true) {
		DisplayText().clear();
		//set sheila xp = -4
		Flags.list[FlagEnum.SHEILA_XP] = -4;
		DisplayText("You lean down and grab the girl by her shirt-front, raising her to her knees; her hands automatically go to yours.");
		...
		if (sheilaCorruption() >= 50) DisplayText("soft, pillowy");
		else DisplayText("small, perky");
		DisplayText(" breast.  \"<i>You don't want to rip your clothes, do you?  It must be difficult to get nice fabric like this out here in the middle of nowhere.</i>\"");
		...
		if (sheilaCorruption() < 20) DisplayText("little round things that trace gentle curves under her loose shirt.");
		//(else sheila corruption < 50)
		else if (sheilaCorruption() < 50) DisplayText("healthy mounds that fill out her shirt.");
		else DisplayText("swollen globes that bulge over her v-neck and strain at the seams of her shirt.");
		DisplayText("  Smiling at the sight, you grab the garment's hem and pull it up roughly.  Sheila blinks dumbly as you expose her erect nipples to the air, then blushes and covers them with her hands.");

		DisplayText("\n\nStill smiling, you unfasten your [armor] and reveal your crotch.  ");
		//[(cock.length > 0)
		if (dick) DisplayText(Desc.Cock.describeMultiCockSimpleOne(player, true) + " flops free, half-erect and swelling steadily with blood as you appraise the woman's body.");
		//(vag present)
		else DisplayText("Your [vagina] drools slightly, labia parting and [clit] poking up; you imagine what you want to do with it.");
		DisplayText("  Sheila watches your face as you slip into a fantasy, half-playing with her nipples - but just when you start to get into your daydream, she turns and tries to scramble to her feet!");
		...
		if (dick) {
			...
			//[(cock width <= 6")
			if (player.torso.cocks.list[player.shortestCockIndex()].cockThickness <= 6) {
				DisplayText("parting her lips to pop neatly between them.  It feels good, but one-sided, and you order Sheila to get to work.");
			}
			else {
				DisplayText("jabbing at her undersized mouth with your enormous [cockHead shortest].  \"<i>It's too thick!</i>\" she complains, trying to turn away.");
			...
			DisplayText("  The reticent woman brings her lips into play, sucking gingerly, ");
			//start length fork, no new PG
			//[(dick length <= 8)
			if (player.torso.cocks.list[player.shortestCockIndex()].cockLength <= 8) {
				DisplayText("and the warm embrace of her mouth is welcome stimulation.");
				...
				DisplayText(", and the other hesitantly makes its way to her breasts as she gets into the sex.  The woman tweaks her nipple, softly at first but with mounting passion as her attentions on your dick become more lavish.  Catching this from the corner of your eye, you move ");
				if (!player.torso.hips.legs.isNaga()) DisplayText("a [foot]");
				else DisplayText("the tip of your tail");
				...
				if (player.torso.balls.quantity > 0) DisplayText(" and your [balls] tighten up");
				DisplayText(".  She pushes against you with her hands, trying to get free, but you just hold her against your crotch as you lean over her head.");
			}
			//(else dick length > 8)
			else {
				DisplayText("but this sort of half-assed attention won't get you off any time before sundown.");
				...
				if (player.torso.cocks.list[player.shortestCockIndex()].cockThickness <= 6) {
					...
					if (player.torso.balls.quantity > 0) DisplayText(" and your [balls] begin to rise");
					DisplayText(", the woman starts to panic, re-upping her struggle to push away from you.");
				}
				///(else width > 6)
				else {
					...
					if (player.torso.balls.quantity > 0) DisplayText(" and your [balls] draw closer to your body");
					DisplayText("; still intent on calling this oral sex, you squeeze Sheila's jaw, forcing her mouth open, then push your drooling slit right up to it as the first squirt of white peeks out.");
				}
			}
			//end width fork and length fork
			//begin corruption worms fork
			//(if corr >= 70 and Infest command is unlocked)
			if (player.stats.cor >= 70 && player.statusAffects.get(StatusAffectType.Infested).value1 === 5) {
				DisplayText("\n\nA wicked idea flits through your head, brought on by the squirming annoyances ");
				if (player.torso.balls.quantity > 0) DisplayText("packing your [balls] and driving up your lust in their zeal to multiply");
				else DisplayText("deep inside your body, trailing sensation along the nerves in your most intimate places and ramping up your production");
				DisplayText(", and you decide to indulge it.  \"<i>Don't worry about rations for the day,</i>\" you cry out, \"<i>I've got more than enough to feed you!</i>\"  Sheila's resigned expression registers this as little more than masculine braggadocio - all the better for your surprise.  Pulling deep inside yourself, you force out a thick load of wormy jism, depositing it directly into the woman's throat; her body tenses at the texture and she tries again to pull away.  As the writhing mass is pushed down her gullet by yet more arriving after it, she begins to struggle violently, hitting you with tired fists and trying to wrench her head free of your grip, even at the cost of her ears.  Luckily, she lacks the energy to do permanent damage to either you or herself after the fight and the cruel face-fucking, and you pour your infested load into her with abandon.");
				//[(big skeet)
				if (player.cumQ() >= 2500) DisplayText("  The volume of semen and slimy worms you pack her with is so great that it strains her stomach; you can actually see dozens of the annelids slithering around in a tight ball under the taut skin of her swollen midriff.");
				DisplayText("  Eventually you finish and pull out, after pushing up every worm you can.  Your ");
				if (player.torso.balls.quantity > 0) DisplayText("[sack]");
				else DisplayText("body");
				DisplayText(" actually feels lighter by a noticeable amount - though you can still feel some deep inside you, reminding you that you'll be full again soon.  On that note...");
			...
			//(else if corr < 70 or PC cannot use Infest at will)
				...
				//[(big skeet)
				if (player.cumQ() >= 1000) DisplayText(", and soon you can feel it lapping at the end of your shaft");
				DisplayText(".");
				//[(mega skeet)
				if (player.cumQ() >= 3000) DisplayText("  Your body's not done with that, though, and keeps pushing out cum until it spurts around your prick and out Sheila's nose in little squirts.");
				DisplayText("  Emptying yourself, you pull Sheila's mouth away from your [cock shortest] and drag the slimy member on her chest, smearing her tits with spit and semen and wiping away the last of the mess on her shirt.");

				DisplayText("\n\nYou pull the soiled garment down over Sheila's breasts");
				//[(big+ skeet)
				if (player.cumQ() >= 1000) DisplayText(", though it's so wet with seed now that you can see them almost as well through it");
				DisplayText(".  \"<i>This really is a nice fabric.  You should take better care of it.</i>\"  With that parting shot, you leave the queasy-looking woman to digest your load and the humiliation.");
			}
			//end worm fork
			...
			//[(sheila corruption >= 30)
			if (sheilaCorruption() >= 30) DisplayText("; her breasts jiggle pleasingly as they settle on her chest, filling you with the urge to play with them");
			DisplayText(".  Straddling her, you lower your [vagOrAss] to her face.  \"<i>Lick,</i>\" you order, rubbing your [butt] on Sheila's nose");
			//[(not horse)
			if (!player.torso.hips.legs.isTaur()) DisplayText(" as you fondle her tits");
			DisplayText(".");
			...
			if ((player.torso.vaginas.count > 0 && player.vaginalCapacity() >= 100) || (player.torso.vaginas.count <= 0 && player.analCapacity() >= 100)) DisplayText("  She keeps hitting the same spot again, too - she's not even bothering to adjust her angle and touch the rest of your stretched opening.");
			...
			if (Flags.list[FlagEnum.UNKNOWN_FLAG_NUMBER_00141] > 0) DisplayText("  I know a nice boy in the mountains who keeps dogs, and I'm sure he'd love to have a womb like yours for their seed.  By this time tomorrow, you could have a cock in both holes, filling you with hellhound babies since you can't please a person.");
			DisplayText("</i>\"");

			DisplayText("\n\nYou can feel her face heating up under your [butt] as she flushes with shame; seems like you struck a nerve.  You ");
			//[(no horse)
			if (!player.torso.hips.legs.isTaur()) DisplayText("pinch her nipple for emphasis, then grind your hips across her face, mauling her nose with your ass.  \"<i>I could fuck a tree and it wouldn't be as wooden as you in the sack");
			//[(PC has found corrupt glade)
			if (player.exploredForest >= 40) DisplayText(" - in fact, there are quite a few I've seen who look like better lovers than you.  Maybe I should carry you to the forest and tie you to a nice pussy-shaped giant flower to give you lessons");
			DisplayText(".  ");
			//[(minotaur addiction score =/= 0%)
			if (Flags.list[FlagEnum.MINOTAUR_CUM_ADDICTION_TRACKER] > 0 || player.perks.has(PerkType.MinotaurCumAddict)) {
			...
			DisplayText("Or I could take you home and give you personal training myself, whenever I feel like it, and invite travelers to do the same");
			//[(PC has Izma with cock)
			if (izmaFollower() && Flags.list[FlagEnum.IZMA_NO_COCK] === 0) DisplayText("; I personally know fifteen inches of fat, orange dick and four heavy balls that'd love to get in at your other end while I ride your face");
			DisplayText(".</i>\"");
			...
			if (player.statusAffects.has(StatusAffectType.HairdresserMeeting) || Flags.list[FlagEnum.LUMI_MET] > 0) {
				DisplayText(" while imagining her turned over to the goblins for experiments, forced to drink potion after potion - most would be dedicated to growing cocks on her or increasing semen production, of course");
			}
			DisplayText(".  Your hole clenches and drools on her, and the woman's rude tongue retreats from the pressure, leaving you painfully empty.");
			//[(no horse)
			if (!player.torso.hips.legs.isTaur()) DisplayText("  Even squeezing her breasts viciously can't compel her to reinsert it, though you amuse yourself trying.");
	...
	//set sheila xp = -4
	private sheilaGetsRapedWithADildont() {
		DisplayText().clear();
		Flags.list[FlagEnum.SHEILA_XP] = -4;
		...
		DisplayText("\n\n\"<i>Nnnnn,</i>\" she moans, humming into your " + Desc.Skin.skinFurScales(player) + ".  ");
		//[(PC corr >= 90 and sheila corr >= 90)
		if (player.stats.cor >= 90 || player.stats.cor > sheilaCorruption()) {
			DisplayText("Your face heats as she kisses you sloppily, and not all of the temperature is from her mouth.  It feels like she's pulling energy right out of you, and you can swear that her breasts are growing.");
		}
		//(else PC corr < sheila corruption)
		else if (player.stats.cor < sheilaCorruption()) {
			DisplayText("Her lips heat up and your body tingles; you can see her breasts shrinking as she shivers and slobbers on your face - or so it seems from the angle.");
		}
		//(else if magically equal but < 90)
		else DisplayText("The kiss is wet and indecent as she shudders through her anal orgasm; her lips don't stay in one place, instead tracking drool all over your face.");
		...
		//(cock)
		if (player.torso.cocks.count > 0) DisplayText("  \"<i>Perhaps next time you'd like to try a real cock in there?</i>\"  Even exhausted and messed up on goblin drugs, she has the presence of mind to shake her head at that.  You laugh.");
	...
	internal function getBeatUpBySheila() {
		DisplayText().clear();
		DisplayText("You slump down before Sheila, breathing heavily; the woman ");
		if (monster.lust < 75) {
			DisplayText("takes the opportunity to grab her catch and take off running!  Even if you wanted to, you couldn't catch her now... you collapse, head swimming in ");
			if (player.stats.HP < 1) DisplayText("colorful spots");
			else DisplayText("fantasies of her, stark naked but for her hat and waiting with her legs open");
			DisplayText(".");
		...
		//(else monster lust >= 75)
			...
			DisplayText("stares at you, desire and nerve at war in her face.  Her thighs rub together involuntarily as she tries and fails to will herself away... slowly, she takes a step toward you.");
	...
	private sheilaLossRapeRouter() {
		...
		if ((player.torso.cocks.count <= 0 || randInt(3) === 0)) sheilaForcedOralGeneric();
	...
	//loss scene - cowgirl (for M,H)
	//if sheila xp >= -3, set sheila xp = -2
	private sheilaCowgirlRapesYou() {
		DisplayText().clear();
		DisplayText("Sheila pushes insistently, and you allow her to force you to the ground and then onto your back");
		if (player.torso.hips.legs.isTaur()) DisplayText("; your hooves stick awkwardly out to one side");
		DisplayText(".  She blushes furiously and won't meet your eyes, but it doesn't stop her from stripping off her vest and shirt in one smooth motion, revealing her " + sheilaCup() + " chest.  \"<i>T-touch me,</i>\" she demands, \"<i>rub me.</i>\"  Almost as an afterthought, she adds \"<i>... please.</i>\"");

		DisplayText("\n\nYou move your hands to her smooth skin, cupping a ");
		if (sheilaCorruption() < 30) DisplayText("petit ");
		else if (sheilaCorruption() > 70) DisplayText("massive ");
		...
		if (player.torso.hips.legs.isTaur()) DisplayText("pulls your legs apart");
		else DisplayText("unfastens and strips off your [armor]");
		DisplayText(", revealing your " + Desc.Cock.describeMultiCockShort(player) + "; ");
		//[(if no cock fit 32)
		if (player.cockThatFits(32) < 0) {
			DisplayText("her eyes widen as " + Desc.Cock.describeMultiCockSimpleOne(player) + " bobs free, half-erect monster meat that fills her with frustration.");
			...
			//[(horse)
			if (player.torso.hips.legs.isTaur()) DisplayText(", or at least as flat as you can get it");
			DisplayText(", then sits on your stomach");
			if (player.torso.hips.legs.isTaur()) DisplayText(", sliding her long legs between yours");
			DisplayText(".  She scoots forward slowly, and gasps as her pussy comes to rest against your hot, blood-engorged shaft.");
			...
			if (player.torso.hips.legs.isTaur()) DisplayText("forelegs fold over her torso affectionately");
			else DisplayText("hands search out her breasts, caressing and squeezing");
			DisplayText(" as her gasps and the picture in your head both intensify.  Sheila grabs one with her own hand, pulling it up to her mouth to smother it in kisses");
			if (!player.torso.hips.legs.isTaur()) DisplayText("and suck on your fingers");
			DisplayText(".  \"<i>Oh... [name]...</i>\"");
			...
			DisplayText("Sheila shivers and leans back, hair dangling, as her hips buck and her thighs squeeze your shaft.  ");
			//(PC corr >=90 or > sheila corruption)
			if (player.stats.cor >= 90 || sheilaCorruption() < player.stats.cor) {
			...
			else if (player.stats.cor < sheilaCorruption()) DisplayText("Her orgasm wets your prick, coating it with fluid as she comes.  Sheila wraps herself tighter in your limbs, squeezing her breasts against her chest, and you think you can feel them get a little smaller as your head fuzzes over with her excess emotion.");
			else DisplayText("Her hips lock up when she comes, leaving you to try and finish yourself as she heats up around your shaft.");

			//[(sens >=50)
			if (player.stats.sens >= 50) {
				DisplayText("\n\nThe warm, smooth, wetness of her thighs is enough to bring out your own climax, and " + Desc.Cock.describeMultiCockSimpleOne(player) + " unburdens itself, forcing globs of semen into the air to rain down on your entwined bodies.  Sheila laughs as you coat her midriff with your mess, and playfully strokes your sensitized [cock] with one hand, sending shivers through you as she helps force your cum up your shaft.");
				//[(mega skeet)
				if (player.cumQ() >= 2000) DisplayText("  The giggles and the strokes stop long before your orgasm, though; eventually Sheila just lies there, dumbfounded, as you deposit layer after layer of white lattice on her skin.  \"<i>Bloody hell,</i>\" she mumbles vaguely, either stone-sober or drunk from the sight of it.");
				DisplayText("  Once the rain of semen peters out, she pulls apart from you, slimy and dripping.");
		...
		//(else if cock fit 32)
			...
			DisplayText("as you lean over to catch her expression, you can see her eyes glimmer with desire.  Sheila notices you from her peripheral vision, and her face reddens again.  She turns her back to you.");
			...
			//[(multicock)]
			if (player.torso.cocks.count > 1) DisplayText("separating out and ");
			...
			//(else lib >= 25)
				...
				if (!player.torso.hips.legs.isTaur()) DisplayText(", and your hands go to her waist, fairly pushing her up and slamming her back down in your eagerness");
				DisplayText(".  She rolls her head as the fuck gets wetter and faster, dangling her hair over her shoulders as her back muscles shift and flex with her strokes; her ears flick whenever she descends and rubs your neck against one of the sweet spots on her vulva.");
				...
				//(PC corr >= 90 or > sheila corruption)
				if (player.stats.cor >= 90 || player.stats.cor > sheilaCorruption()) DisplayText("You can feel her cum-slick inner walls pulling at you as she begins to orgasm, and your mind clears as you blow your load inside her, wondering when she'll likewise return to sense.");
				//(else PC corr < sheila corruption)
				else if (player.stats.cor < sheilaCorruption()) DisplayText("Her pussy gushes with her orgasm, pushing out your semen and soaking her inner lips even as she continues riding your cock, and your mind clouds as you think of little except sneaking as much of your cum inside her as possible.");
				//else equal but < 90)
				else DisplayText("Even as she comes mindlessly something makes you hold in your own moans, wondering how long it will take her to notice her pussy being filled with your egg-hunting sperm.");
				//[(small cum)]
				if (player.cumQ() <= 250) {
					DisplayText("  Sheila continues moving her hips even as she comes, lost in bliss; on one particularly lofty ascent, your cock flops out, squirting a line of jizz along ");
					if (player.torso.tailType > TailType.NONE) DisplayText("your tail");
					else DisplayText("the grass");
					DisplayText(", and her eyes go wide.");
				}
				//(big cum)
				else {
					DisplayText("  With how much Sheila is still moving her hips, it's only a matter of time before she notices the mounting pressure in her cunt... on one particularly deep push, she forces out a squirt of white, and her eyes go wide as she pulls off and lets you finish on the grass.");
				}
				...
				DisplayText(" you groan.  \"<i>Can't believe you didn't notice...</i>\"");
	...
	//boilerplate face-in-cunt shit
	//if sheila xp >= -3, set sheila xp = -2
	private sheilaForcedOralGeneric() {
		DisplayText().clear();
		DisplayText("Sheila kisses you once more, forcing her tongue into your mouth, and slides a hand into your [armor]; you stare wonderingly into her affectionate, hungry eyes at the sudden change.  It isn't until ");
		if (player.torso.cocks.count > 0) DisplayText("her hand slips around your [cock]");
		else if (player.torso.vaginas.count > 0) DisplayText("her fingers slip between your labia");
		else DisplayText("she rubs your bare crotch for a few seconds");
		DisplayText(" that her reverie breaks; her face colors and she looks away, averting her gaze in shame.  She draws her hand back out guiltily, then begins to doff her shorts and panties.  \"<i>S-sorry... didn't mean to get familiar.  I'll have this over with quickly.</i>\"");

		DisplayText("\n\n\"<i>That's-</i>\"  Your words are cut off as she suddenly climbs atop you, bringing her pussy to eye level");
		if (player.stats.str < 61) DisplayText("; her weight bears you slowly to the ground");
		DisplayText(".  Sheila rubs the smooth slit on your [face], trying to part her labia on you, and shivers a bit when your lips brush hers.");
		...
		if (player.torso.head.hairType === 4) DisplayText(" and flushing as your stingers release their payloads into her palm");
		DisplayText(".  You obediently stick out your tongue");
		if (player.stats.cor > 60) DisplayText(", motivated more by whimsy than the meager, almost playful pain,");
		DisplayText(" and shallowly penetrate Sheila's vagina with it.");
		...
		if (player.torso.head.face.tongue.type > TongueType.HUMAN) {
			DisplayText("  A sly look crosses your face at her request; she notices it but has no time to dismount before your long tongue shoots into her, stroking the nerves around her entrance as you unspool.  \"<i>Ah-ahhh!</i>\" she moans, \"<i>What the hell... is with your mouth?</i>\"");
		...
		//[(PC corr >= 90 or > sheila corruption)]
		if (player.stats.cor >= 90 || player.stats.cor > sheilaCorruption()) {
			DisplayText("strangling your tongue with muscles attempting to lock onto it, trying to pull it in.");
			//[(demon/dragon tongue)
			if (player.torso.head.face.tongue.type > TongueType.HUMAN) DisplayText("  As tired as you are, you simply go along with it, allowing her rippling walls to slowly draw your tip deeper inside until it bumps against her cervix; she shivers and kisses the top of your head as you groggily run your tongue over the entrance to her womb.");
			else DisplayText("  However, it doesn't get very far; you lazily flop it around inside her as she works through her arousal.");
			DisplayText("  Sheila groans loudly and your vision fades; through the fog, you can swear you feel her breasts growing larger against your forehead.");
		}
		//(else PC corr < sheila corruption)
		else if (player.stats.cor < sheilaCorruption()) {
			DisplayText("filling your mouth with her liquid love.  Your lips and throat heat up as you're forced to drink it from the nearness of her pussy; as she bucks her hips weakly into your face, trying to draw out her climax, you increasingly wish that you could return the favor, ");
			if (player.torso.cocks.count > 0) DisplayText("face-fucking her and blowing a load into her mouth, then holding her jaw shut until she swallows it unhappily.");
			else if (player.torso.vaginas.count > 0) DisplayText("smearing your gash on her face until you come and drown her in your squirting girl-jizz.");
			else DisplayText("forcing her to tongue your asshole until you come, writhing and pressing her head into the grass with your [butt].");
		}
		else DisplayText("and she pets your head affectionately as her walls squeeze your tongue.  \"<i>Oh, mate...</i>\" she whispers lovingly, completely forgetting the struggle that led to your tryst.");
		...
		//[(str < 61)
		if (player.stats.str < 61) DisplayText("climbing off and kneeling next to you.");
		else DisplayText("letting herself down your body until she can put her long legs on the ground once more.");
		DisplayText("  She looks into your eyes contentedly, rubbing your cheek... but then starts and looks away, guilty once more.  \"<i>Shit...</i>\" she mumbles.  \"<i>I did it again.  Even after I promised myself I wouldn't...</i>\"");
		...
		if (player.torso.head.face.tongue.type > TongueType.HUMAN) fatigue(15);
	...
	//set sheilapreg = 0
	private normalSheilaPregNotifNumberOne() {
		pregnancy.knockUpForce(); //Clear Pregnancy
		DisplayText().clear();
		DisplayText("Traipsing through the grass, you can see Sheila sitting under the shade of a low tree from a long way off.  The reverse is also true, as she waves to you from her seat, beckoning you over.  You make your way to her curiously.");
		...
		if (player.stats.cor < 50) DisplayText("  A hand placed around her shoulder seems to steady her a bit.");
	...
	private normalSheilaPregNotifNumberOneYepIssue() {
		DisplayText().clear();
		DisplayText("\"<i>I see,</i>\" Sheila says, nonplussed.  \"<i>I'm sorry you feel that way...  Truth be told, I'm not keen myself on the idea of having a kid, but what's out is out.</i>\"");
	...
	private normalSheilaPregNotifNumberOneCoolDeal() {
		DisplayText().clear();
	...
	private normalSheilaPregNotifREPEATEDED() {
		DisplayText().clear();
		DisplayText("Sheila is here as you step into the plains, with a grass-wrapped parcel of food open on her lap and her hat sitting upturned next to her, and waves you over.");
		...
		if (randInt(10) < 7) DisplayText("healthy.  It's eating a lot... frankly, it's a little hellraiser with a strong grip, and it cries well, too.</i>\"");
		else DisplayText("weak... we thought we were going to lose it for a bit.  It wouldn't drink from the nurse unless I was there, so I had to stay up with it all night myself.  Feeling a bit stuffed.</i>\"");
		DisplayText("  She looks over at you, giving you the benefit of her fatigue-lined eyes.");

		DisplayText("\n\nSheila slips her hand into yours");
		if (player.stats.cor < 40) DisplayText(", and you give it a squeeze");
		DisplayText(".  \"<i>I just wanted to tell you about your baby.  Can't stay... have to catch up to quota still.</i>\"  She drags to her feet and turns to go, tail listlessly hanging.  Even her ears are drooping; this girl is tired.");
		...
		if ((player.stats.spe > 80 && player.perks.has(PerkType.Runner)) || (player.torso.hips.legs.isTaur()) || player.torso.hips.legs.isNaga() || (player.canFly && player.hasKeyItem("Bow") >= 0))
	...
	private normalSheilaPregNotifREPEATEDEDLetHerGo() {
		DisplayText().clear();
		DisplayText("Nothing you can do about that - even if you wanted to watch your baby for her, she's keeping it hidden in a hole in the ground.  You hand her the parcel back");
		if (player.stats.cor < 40) DisplayText(", imploring her to eat the rest and keep up her strength");
		DisplayText(".  Sheila smiles weakly and takes it, folding the grass around again.  \"<i>Thanks, [name].  I'll see you soon... ish.</i>\"");
	...
	private normalSheilaPregNotifREPEATEDEDWalkWithHer() {
		DisplayText().clear();
		DisplayText("You pick up her forgotten hat and rise as well, carefully refolding the grass around Sheila's uneaten lunch and tucking it back into her pack for her.  She takes her hat back from you distantly.");

		DisplayText("\n\n\"<i>Thanks, mate... forget my own head next.</i>\"  She doesn't even put it on, simply holds it in her hand as she plods on.  You ");
		if (!player.torso.hips.legs.isNaga()) DisplayText("walk");
		else DisplayText("slither");
		DisplayText(" next to her, easily keeping pace with the tired woman, and she raises her face to you inquiringly.  \"<i>What's up, [name]?</i>\"");
	...
	private normalSheilaPregNotifREPEATEDEDHelpABitchOut() {
		DisplayText().clear();
		DisplayText("You pick up her forgotten hat and set it on her head, then fold her lunch back into its grass wrapper and tuck it into her pack.");
		...
		//(else spd >= 80 and Runner perk)
			...
			if (player.stats.lib < 50) DisplayText("you pinch her ear, provoking an annoyed flick from it.");
			else DisplayText("you slap her on the ass, grabbing a handful and taking her mind off her own misery.");
			DisplayText("  \"<i>Dammit, [name]... not now,</i>\" she frowns, pulling away from you.");
			...
			if (!player.torso.hips.legs.isGoo()) DisplayText("run");
			else DisplayText("glide");
			DisplayText(", making a long loop around to the rear of the wary animal, then begin to systematically drive it closer to your partner, who has strung a line to the base of a shrub and is gesturing at you to force the hare into it.");
		...
		player.stats.cor += -2;
		if (model.time.hours + 4 < 21) return { next: Scenes.camp.returnToCampUseFourHours };
		else {
	...
	private normalSheilaPregNotifREPEATEDEDHelpABitchOutANDWELP() {
		DisplayText().clear();
		DisplayText("\"<i>Welp,</i>\" you say softly.");
		//[(corr <50)
		if (player.stats.cor < 50) DisplayText("  You set a hand on Sheila's shoulder to steady her a bit as the tears start to fall.");
		DisplayText("  \"<i>It'll be alright.</i>\"");
	...
	private normalSheilaPregNotifREPEATEDEDHelpABitchOutANDSTAYDERE() {
		DisplayText().clear();
		DisplayText("With a wan smile, you pull the woman to her feet.  She doesn't resist, but continues looking into your face disconsolately.  \"<i>I'm so stonkered I can't even think what to do first...</i>\"");
		...
		if (player.torso.hips.legs.isNaga()) DisplayText("coil");
		else DisplayText("seat");
		DisplayText(" yourself, then grabs your arms and pulls them around her waist.");

		//forks in order of priority, no new pg at start
		//[(full gooey body)
		if (player.torso.hips.legs.isGoo()) {
			DisplayText("  She considers for a moment, rubbing away some of the slime you've deposited on her shorts, and pulls free from your slimy skin again.  \"<i>Um... do you... would you be offended if I took my kit off, so it doesn't get ruined?</i>\"");
			if (player.stats.lib >= 40) DisplayText("  The leer you display is so prurient that she seems on the verge of reconsidering, but you compose yourself and");
			else DisplayText("  You");
			DisplayText(" give assent with little more than a broad smile.  Sheila pulls her shirt over her head, revealing her " + sheilaCup() + " breasts, but raises her face to you hesitantly when her hands get to her belt.");
		...
		//(naga)
			...
			if (player.stats.lib >= 40) DisplayText(" - but tighten the one sliding across her breasts just slightly.  Sheila's neck turns red and her ears twitch as you rub her nipples, and you plant a kiss on her nape");
			DisplayText(".  \"<i>Ahh,</i>\" she sighs, shifting in your coils.  \"<i>Hold it right there...</i>\"");
			//(apply libido-based lust damage if lib >= 40)
			if (player.stats.lib >= 40) dynStats("lus", player.stats.lib / 4, "resisted", false);
		}
		//(horse and >=5ft)
		else if (player.torso.hips.legs.isTaur() && player.tallness >= 60) {
			...
			if (player.stats.sens >= 40) DisplayText("... or would be, if you weren't distracted by the nipples poking into you and the thighs squeezing your flank");
			DisplayText(".");
		...
		else if (player.hips.legs.type === LegType.HARPY && player.torso.tailType === TailType.HARPY) {
		...
		//(bees with boots)
		else if (player.hips.legs.type === LegType.BEE) {
		...
		//(eight-legged freaks)
			...
			player.torso.tailVenom -= 10;
			if (player.torso.tailVenom < 0) player.torso.tailVenom = 1;
		}
		//(else)
		...
		if (!player.torso.hips.legs.isGoo()) DisplayText("blood");
		...
		if (!player.torso.hips.legs.isTaur()) DisplayText("  She grudgingly repositions, allowing you to rest against her.");
		model.time.days++;
		model.time.hours = 2;
		statScreenRefresh();
		//--Next--
	...
	private normalSheilaPregNotifREPEATEDEDHelpABitchOutANDSTAYDERE2() {
		DisplayText().clear();
		model.time.hours = 5;
		statScreenRefresh();
		DisplayText("Your sleep is fitful, but not totally useless, and you yawn and stir a few hours later when Sheila wakes you");
		if (player.torso.hips.legs.isGoo()) DisplayText("; she's already dressed and appears to have just been outside");
		DisplayText(".");
		...
		if (player.stats.lust < 30) DisplayText("  You give her a hand, then help her load up.  She gives you a peck on the cheek before she departs.  \"<i>Thanks, love.</i>\"");
		if (player.stats.lust >= 30) {
			DisplayText("  Part of you is actually sad to see your cozy hovel being disassembled if it means her warm body won't be pressed up against yours anymore, and your hands begin to rove over her as she works.");
	...
	private normalSheilaPregNotifREPEATEDEDHelpABitchOutANDSTAYDEREBUTLEAVEHERBE() {
		DisplayText().clear();
		DisplayText("You relent, allowing the woman to free herself with a peck on your cheek.  She loads up her catch, and then turns to you.  \"<i>Thanks, [name].  Owe you one.</i>\"");
		//This is your Protoshield! I can't take this!
		return { next: Scenes.camp.returnToCampUseOneHour };
	}

	//[Normal Preg Subsequent - Help - 21:00 hours - To Camp]
	private normalSheilaPregNotifREPEATEDEDHelpABitchOutTOCAMP() {
		DisplayText().clear();
		DisplayText("Wordlessly, you lift the bundle of game animals off of Sheila's shoulders and sling it over your own.  She looks up at you, confused enough to forget about her tears.  \"<i>What're you doing?</i>\"");
		...
		//[(int >=60)]
		if (player.stats.int >= 60) DisplayText("\"<i>The baby will be fine,</i>\" you venture, hazarding a guess.  \"<i>It's what the nurses are there for.</i>\"");
		else DisplayText("You slip an arm around her, and ask if she's okay.");
		DisplayText("  She nods mutely and pulls the food out of the fire.");
		//[(if Jojo present)
		if (player.statusAffects.has(StatusAffectType.JojoNightWatch) || player.statusAffects.has(StatusAffectType.PureCampJojo)) DisplayText("  She extends one bird to you and another to Jojo.  He raises his hand and shakes his head, but politely.");
		else if (Flags.list[FlagEnum.ANEMONE_WATCH] > 0) DisplayText("  Sheila offers you one of the birds, then extends another to your odd tenant.  The anemone's mouth tightens and she shakes her head vigorously, blushing a deep blue.");
		DisplayText("  You eat in silence until the food is gone, and Sheila clears her throat.");
		...
		//[(if no watch)
		if (!player.statusAffects.has(StatusAffectType.JojoNightWatch) || !player.statusAffects.has(StatusAffectType.PureCampJojo) || Flags.list[FlagEnum.ANEMONE_WATCH] === 0) DisplayText("\n\nShe gets to her feet as you grin, then makes her way over to your bedroll.  It doesn't take her long to fall asleep; you amuse yourself watching her toss and turn... and drool on your pillow.");
		//(if watch)
		else {
			DisplayText("\n\nYou grin and get up, and Sheila tails you to your bed.  ");
			if (Flags.list[FlagEnum.SLEEP_WITH] != 0 && Flags.list[FlagEnum.SLEEP_WITH] != "") DisplayText("She looks with some distaste at the nearby sleeper, and steps past.  You pick up the bedroll and follow her, reasoning that if she keeps her promise to be gone before dawn, it shouldn't raise any questions.  \"<i>Making friends, I see,</i>\" Sheila mutters... but as you unroll the bed again, her eyes zero in on it like a drowning man's on a raft, and she says nothing else.  ");
			DisplayText("She lies down first, allowing you to cozy up to her as far as you dare.  Just as you're about to drift off, you feel Sheila take your hand and pull your arm over her body.");
		}
	...
	private sheilaGoesDemon() {
		...
		if (Flags.list[FlagEnum.SHEILA_XP] < -2) DisplayText("always so bloody eager to fuck me!");
		else DisplayText("me best mate!");
		DisplayText("  Help out!</i>\"");
		...
		if (player.torso.head.face.tongue.type > TongueType.HUMAN) DisplayText("extending your oral muscle until it's all the way to the back of her pussy.  ");
		else DisplayText("but only manage to scrape her entrance; she shudders and seems satisfied with that, judging by what she says next.  ");
	...
	//Demon Sheila encounter (demon sheila = 1 and sheilapreg < 4)
	private demonSheilaEncounter() {
		DisplayText().clear();
		DisplayText("A shadow drops out of a low tree behind you with a rustle.  \"<i>Hey, lover; been a while... how about spending some time with me?</i>\"");
		...
		MainScreen.addButton(4, "Run", Scenes.camp.returnToCampUseOneHour);
	}

	//[Demon Sheila - Resist]
	private demonSheilaResist() {
		DisplayText().clear();
		DisplayText("You back away from the demon and raise your [weapon] with a dour glower.  Sheila purses her lips at you, then says, \"<i>Not in the mood, eh mate?  I'm so horny though... I bet I could get you into it.  Let me show you how much I love you...</i>\"  Her ears twitch furiously, belying her intentions as she");
		//[(sheila corruption < 30)
		if (sheilaCorruption() < 30) DisplayText(" thrusts her black spade forward and smears some of the constantly-oozing fluid from its tip down the length with her hand");
		else DisplayText(" kneads her breasts seductively, pinching her nipples");
		DisplayText(".  Your posture softens a bit as she reaches out to you");
		if (sheilaCorruption() < 30) DisplayText(", tilting her palm to dribble a handful of strong-scented dark oils");
		DisplayText(", but as she giggles sadistically and starts to approach, you tense up again.  It's pretty clear by the way she swaggers dismissively that she isn't taking the rejection well!");
		//go to fight
		startCombat(new Sheila());
	}

	//[Demon Sheila - Talk]
	private demonSheilaTalk() {
		DisplayText().clear();
		DisplayText("Questions nag at you, and you ask Sheila if she wouldn't mind answering a few of them.  She struts over and ");
		//[(not horse)
		if (!player.torso.hips.legs.isTaur()) DisplayText("takes your arm in hers, then slips the other hand into your armor");
		//[(horse)
		else DisplayText("between your legs");
		DisplayText(" to touch your ");
		if (player.torso.cocks.count > 0) DisplayText("[cock]");
		else if (player.torso.vaginas.count > 0) DisplayText("[vagina]");
		else DisplayText("smooth skin");
		//[(lib <20)
		if (player.stats.lib < 20) DisplayText(", giggling as your expression petrifies");
		DisplayText(".  \"<i>Anything for you; I'll just find something to occupy my attention.  What's on your mind, love?</i>\"");
	...
	private tellSheilaDemonToFuckOff() {
		DisplayText().clear();
		DisplayText("\"<i>Oh,</i>\" she says.  \"<i>Don't be like that.  You're my best mate, you know.  My beloved.  I'll never let you go, ever.</i>\"  Her eyes gloss over a bit, ");
		//[(RNG decides if dis bitch crazy, bias toward sane)
		if (randInt(10) < 3) {
			DisplayText("and she blurts, \"<i>I know I can make you understand.  You can't go until you say it back!</i>\"  You pull her hand free and back away from her, but she advances again, trying to grab you!");
			startCombat(new Sheila());
			return;
		}
		else {
	...
	private askDemonSheilaAboutDahChange() {
		DisplayText().clear();
		//[(if sheilacite >= 1)]
		if (Flags.list[FlagEnum.SHEILA_CITE] >= 1) {
			DisplayText("Sheila blushes deeply.  \"<i>Silly.  You were there.</i>\"  She looks at you, pupils dancing as she remembers the lovemaking session that led to her current form.  \"<i>I suppose that's not what you're asking, though.</i>\"");
			...
			if (player.torso.cocks.count > 0) DisplayText(", and you feel a monument of your own being erected");
			DisplayText(".  \"<i>Every squeeze of my pussy compressed my focus, too, until my mind was clearer than the juice you made me flow with.  I realized my purpose there, with you.</i>\"");
	...
	private askDemonSheilaAboutHerColony() {
		DisplayText().clear();
		DisplayText("\"<i>That place?  Do you wanna go there?</i>\"  Sheila smiles duplicitously, then lifts your chin and steals a kiss before you can pull away.  \"<i>Got no qualms about showing you the way to that nest of prudes, but...</i>\"  Her eyes darken.  \"<i>There's nothing left now.  A shame you didn't insist earlier, they could have stood to learn what a ripper " + Desc.Gender.mf(player, "man", "woman") + " is.</i>\"");
		...
		//(corr >=75)
		if (player.stats.cor >= 75) DisplayText("harvested that day, you sigh wistfully");
		else DisplayText("stolen that day, you wince");
		...
		//[(cock)
		if (player.torso.cocks.count > 0) DisplayText("she ties you down and rides you until she's so full of your spunk that she can push it back out just by pressing on her stomach");
		else DisplayText("she binds your hands and sits on you, teasing your helpless body with her oozing, throbbing spade until she comes all over you, spraying dark slimy fluid from it");
		DisplayText(".  You ");
		if (player.stats.cor < 50) DisplayText("break eye contact, blushing");
		else DisplayText("stare into her shining eyes, getting hotter and hotter as the vision plays out to the very end");
		DisplayText(".");
	...
	private talkToDemonSheilaAboutWhatNow() {
		DisplayText().clear();
		//fucking daddy issues
		DisplayText("\"<i>What will I do now?  What else, my silly love?</i>\"  Sheila looks out over the plains.  \"<i>I'm always hot for you.  We could have a bit of a naughty, and make each other feel good.</i>\"");
		...
		//(lib>=30)
		if (player.stats.lib >= 30) DisplayText("\n\nYour eyebrows rise.  \"<i>Got your attention, did I?  But,</i>\"");
		else DisplayText("\n\nYour mouth hardens.  \"<i>You're right,</i>\"");
		DisplayText(" Sheila says, \"<i>I'm going to save that one for our honeymoon, instead.</i>\"  Her eyes twinkle with infatuation.  \"<i>I could even pull the taint of this land out of your body and use it to make mine more lewd for you, my " + Desc.Gender.mf(player, "knight-champion", "great lady") + "...</i>\"");
		...
		//(corr<50)
		if (player.stats.cor < 50) {
			DisplayText("\"<i>I don't think I will, though, my sooky mate... I'd rather stain you in my colors, even if it costs my body to do it.  Or, would you like me more if my proportions were modest?  You, my confident, courtly " + Desc.Gender.mf(player, "lord", "dame") + ", and I, your worshipful, tomboyish " + Desc.Gender.mf(player, "squire", "lady-in-waiting") + ", secretly in love with you and game to follow you anywhere and do anything for you to make you acknowledge me and accept ");
			if (player.torso.cocks.count > 0) DisplayText("my pussy");
			else DisplayText("the dick I grow for you");
			DisplayText("?  </i>Anything?<i>");
		}
		else {
		...
		if (player.torso.cocks.count > 0) DisplayText("give them to me");
		else DisplayText("have them for me");
		DisplayText(".  I dunno what could be simpler.</i>\"");

		DisplayText("\n\nShe's so fixated on having children now, more so than anyone you've met");
		//[(PC has been propositioned by Amily)]
		if (Flags.list[FlagEnum.AMILY_OFFER_ACCEPTED] > 0) DisplayText(" save one.  Actually, the two are a bit reminiscent of each other..");
		DisplayText(".  Yet, any offspring a demon makes will be imps, right?");
		...
		if (player.stats.cor < 50) DisplayText("; even though you hide it, I've seen it lurking");
		DisplayText(".  Feel like flying your colors for a while?</i>\"");
	...
	private demonSheilaTalkAnotherQuestion() {
		DisplayText().clear();
		//(if lust <=99)
		if (player.stats.lust <= 99) {
			DisplayText("Sheila reaches farther down, ");
			//(cock)
			if (player.torso.cocks.count > 0) DisplayText("slipping more of her finger and thumb around your penis");
			else if (player.torso.vaginas.count > 0) DisplayText("parting your lips more");
			else DisplayText("rubbing your bare groin");
			DisplayText(" even as she smiles encouragingly.  \"<i>Sure, mate.  Amuse yourself.  I certainly intend to.</i>\"");
	...
	private sheilaLetHerFuckYou() {
		...
		if (sheilaCorruption() >= 40) DisplayText("pillowy ");
		else DisplayText("pert ");
		DisplayText("breasts against you.");
	...
	//Post-demon pregnancy notif (demon sheila = 1 and sheilapreg = 4)
	//increment imp children counter?
	private demonImpChildren() {
		DisplayText().clear();
		DisplayText("\"<i>[name]!</i>\"  A swishing in the grass behind you is the only prelude you get to a nude Sheila pressing herself against you in a hug, ");
		//(sheila corruption < 40)
		if (sheilaCorruption() < 40) DisplayText("her perky nipples rubbing into your arm as she snuggles up");
		else DisplayText("her enormous, pendulous breasts practically parting around you to wrap you up alongside her arms");
		DisplayText(".");

		DisplayText("\n\n\"<i>Guess what?  I had your baby!  He was the most darling little thing.</i>\"");

		DisplayText("\n\nShe takes your look of surprise as permission to elaborate.  \"<i>Mmm, why the wide eyes, mate?  Our people always pushed them out fast.  Except instead of tucking him into a snuggly against my tits, I tucked him into somewhere a bit... lower.</i>\"  She hugs your arm closer, fairly rubbing her pussy on the back of your hand and leaving a trail of her lube as she slides her own fingers into your [armor].  \"<i>He has his " + Desc.Gender.mf(player, "daddy", "other mommy") + "'s cock.");
		//(if no cock)
		if (player.torso.cocks.count <= 0) DisplayText("  Or, had...</i>\" she finishes with a frown as she reaches your bare groin.  \"<i>Where'd you leave that magnificent old fella?  I was lookin' forward to another go.</i>\"  She pulls her hand out, then leans toward you with a pout.  \"<i>I'm so horny, too...</i>\"");
		//(if cock)
		else {
			...
			if (sheilaCorruption() <= 80) DisplayText("with her fingers to make sure the invitation is all the way open");
			//(else)
			else DisplayText("with her split tail while she cradles her massive tits to make sure you see the open invitation");
			DisplayText(".  Impatiently, she rubs her stubby, drooling, phallic spade against the hole, accentuating the imagery.  You can feel the blood rushing to your groin as she gives herself shallow, teasing strokes.");
		}
		pregnancy.knockUpForce(); //Clear Pregnancy
		Flags.list[FlagEnum.SHEILA_IMPS]++;
		//plus lust if PC has cock
		if (player.torso.cocks.count > 0) dynStats("lus", 10 + player.stats.lib / 10, "resisted", false);
		//[Other Sex][Knock Up(cock only)][Leave]
		
		MainScreen.addButton(0, "Other Sex", pregDemonSheilaOtherSex);
		if (player.torso.cocks.count > 0) MainScreen.addButton(1, "Knock Up", pregDemonSheilaKnockUp);
		//leave should be default spacebar option
		MainScreen.addButton(4, "Leave", leavePregDemonSheila);
	}

	//[Preg Demon Sheila - Leave]
	private leavePregDemonSheila() {
		DisplayText().clear();
		DisplayText("You shake your head at her, backing away.  She sulks a bit, then speaks.  \"<i>I guess I'll let you off, since you sexed me up so well before.  Next time, though, you're gonna give me some... satisfaction.</i>\"  She runs a finger teasingly down her chest, giving you half a smile.");
		//(if cock)
		...
		if (player.torso.cocks.count > 0) player.stats.lust += 10;
		return { next: Scenes.camp.returnToCampUseOneHour };
	}

	//[Preg Demon Sheila - Other Sex]
	private pregDemonSheilaOtherSex() {
		DisplayText().clear();
		DisplayText("Her eyebrows knit as you propose an alternative.  ");
		//[(if cock)
		if (player.torso.cocks.count > 0) {
			DisplayText("\"<i>Well now, I think I get a say, don't I?  I was really hoping to have your seed inside me... it's practically worth bottling.</i>\"  She ");
			if (sheilaCorruption() >= 80) DisplayText("heaves onto her feet, heavy breasts swaying");
			else DisplayText("nimbly hops to her clawed feet");
			DisplayText(", and runs her hands distractingly along the curves of her hips.  \"<i>You can do what you like with my body, love... if you can convince me.  Of course, I'll claim the same privilege!</i>\"  Sheila jumps at you, leaving no doubt what kind of 'convincing' she expects to do!");
			startCombat(new Sheila());
		}
		//(if no cock)
		else if (player.torso.vaginas.count > 0) {
	...
	private pregDemonSheilaKnockUp() {
		DisplayText().clear();
	...
	internal function loseToSheila(consensual: boolean = false) {
		DisplayText().clear();
		//Loss - if PC manages to lose by HP somehow (overrides all other losses)
		if (player.stats.HP < 1 && !consensual) {
			DisplayText("Your erstwhile opponent's eyes glimmer with excitement as you collapse from your injuries, and she runs over to you.  The demon strips off your [armor] eagerly, but you can't stay awake for the fun.  Consciousness slips away and you pass out.");
			//--Next--
			model.time.hours += 8;
			if (model.time.hours > 23) {
				model.time.hours -= 24;
			...
			if (player.torso.cocks.count > 0 && player.cockThatFits(56) >= 0)
				choices[choices.length] = loseToNormalSheilaAndGetRidden;
			//Loss - tail-spade sounding for fuckhueg cock (for cockarea > 56)
			if (player.torso.cocks.count > 0 && player.torso.cocks.sort(Cock.LargestCockArea)[0].area > 56)
	...
	private loseToDemonSheila() {
		...
		DisplayText("\n\nStill shaken, you stand and let Sheila do the same.  She narrows her eyes at you before speaking again.  \"<i>Be more careful, mate.  The idea of my " + Desc.Gender.mf(player, "boy", "girl") + " being fucked by trash makes me ill.</i>\"  Saying nothing more, the woman turns and leaves you to walk back to your camp.");
	...
	//Loss - normal cocks get rode (for cockarea <= 56)
	private loseToNormalSheilaAndGetRidden() {
		DisplayText().clear();
		let x: number = player.cockThatFits(56);
		DisplayText("Sheila pushes you onto the ground");
		if (player.torso.hips.legs.isTaur()) DisplayText(" and you're forced to put your forelegs down for support as you come to rest on your haunches");
		else DisplayText(", spreading your legs.  The demon unfastens your [armor] and strips it from your bottoms easily");
		DisplayText(", exposing your " + Desc.Cock.describeMultiCockShort(player) + ".");

		DisplayText("\n\n");
		//[(multi)
		if (player.torso.cocks.count > 1) DisplayText("\"<i>All of these look ripper, but... I want this one today,</i>\" she says, selecting your [cockFit 56].  ");
		DisplayText("She wraps her hand around it and begins pumping up and down, squeezing out a drop of precum that she smears onto her palm.  \"<i>You're so eager,</i>\" Sheila giggles.  \"<i>Are you already about to burst?  That's no good... I wanted to play a bit more.</i>\"");

		DisplayText("\n\nThe demon releases your dick, watching raptly as it bobs and twitches, then scoots up to you and");
		if (player.torso.hips.legs.isTaur()) DisplayText(", draping your forelegs over her shoulders,");
		DisplayText(" presses her " + sheilaCup() + " breasts");
		if (sheilaCorruption() < 100) DisplayText(" against you, dragging her nipples against yours.  ");
		else DisplayText(" against you so forcefully that they part around your chest.  ");
		DisplayText("\"<i>Such a " + Desc.Gender.mf(player, "handsome bloke", "pretty sheila") + ", with such a nice dong,</i>\" she whispers, \"<i>I'm going to have to take you for a ride.  Try not to come as soon as you get in!</i>\"");

		DisplayText("\n\nSheila grins viciously and sinks down on your [cockFit 56], sliding it into her pussy at a painstaking pace");
		//[(multi)
		if (player.torso.cocks.count > 0) DisplayText(" and slipping the unused remainder of your manhood between her thighs");
		DisplayText("; you can feel every new inch of heat as she lowers her body.  The woman moans, gyrating her hips, and " + Desc.Cock.describeMultiCockSimpleOne(player) + " twitches in painful erectness.");
		...
		if (player.torso.balls.quantity > 0) {
			...
			//(not horse)
			if (!player.torso.hips.legs.isTaur()) DisplayText("  Sheila takes your face in her hands and presses it into her breasts as she reassures you.");
			...
			DisplayText("\n\nSheila's pussy spasms around you and she looks into your eyes; you feel a wave of compulsion from them, and arousal flows into you from each place your " + Desc.Skin.skin(character) + " touches her body.  Unable to withstand her orgasm-fueled power, your [balls] pull close to your shaft and you let go of your climax, grabbing her hips and dumping semen into her cunt");
			if (player.torso.cocks.count > 1) DisplayText(" and lap");
			DisplayText(" just like she's dumping feelings into your head.  \"<i>Lover!</i>\" she screams.  \"<i>Pack me with your babies!</i>\"");
			...
			if (player.torso.hips.legs.isTaur()) DisplayText("forelegs");
			else DisplayText("hands");
			DisplayText(", displacing a glob of cum from her pussy that's soon followed by others as you ejaculate once more.  The jizz is so dense with sperm that it's thick, almost colloidal; it jiggles on her skin, barely sliding downward as your hips ram against hers.  It takes nearly ");
			//(normal skeet)
			if (player.cumQ() < 250) DisplayText("ten minutes and two");
			//(big skeet)
			else if (player.cumQ() < 1000) DisplayText("thirty minutes and four");
			else DisplayText("fifty minutes and eight");
			DisplayText(" more orgasms, but finally your balls empty of their demonically-induced load and your lover pulls away and stands up.");
		...
		//(else if no balls)
			...
			if (player.torso.hips.legs.isTaur()) DisplayText("You force her downward with your forelegs to");
			else DisplayText("You grab her hips and");
			DisplayText(" help her impale herself on your tool.");
			...
			if (player.stats.cor < 70) {
				DisplayText("\n\nYou stiffen in embarrassment.  Sheila smiles and plants a kiss on your " + Desc.Skin.skinFurScales(player) + ", then looks at you innocently.  \"<i>Don't be mad, mate.  I just wanted our time together to last.</i>\"");
			...
			if (player.torso.cocks.count > 1) DisplayText(" and lap");
			//[(big skeet)
			if (player.cumQ() >= 1000) DisplayText("; she quickly reaches capacity and pulls off, jerking your messy, slimy [cockFit 56] and letting you squirt the last of your strokes all over her face and chest");
			if (player.cumQ() >= 6000) DisplayText(".  So much is left that she's practically underwater by the time you're finished; she giggles and bubbles form in the oozing liquid covering her lips");
			DisplayText(".");
	...
	//Loss - tail-spade sounding for fuckhueg cock (for cockarea > 56)
	private tailSpadeSoundingForFuckHugeDongsWithDemonSheila() {
		DisplayText().clear();
		...
		if (player.torso.cocks.count > 1) DisplayText("; unguided, the ");
		if (player.torso.cocks.count === 2) DisplayText("other twitches and sprays");
		else if (player.torso.cocks.count > 2) DisplayText("others twitch and spray");
		if (player.torso.cocks.count > 1) DisplayText(" all over, coating her back, you, the grass, and anything ");
		if (player.torso.cocks.count > 2) DisplayText("else they happen to point at");
		if (player.torso.cocks.count === 2) DisplayText("else it happens to point at");
		DisplayText(".  Your hips automatically try to push your dick further into her warm hole but only succeed in unbalancing her, forcing the demon onto her hands.  As your climax winds down, your head leans back and your cock slips from her vulva, squirting the last stroke onto her ass.");
	...
	//Loss - clit-swelling and clit-sounding or clit-anal
	private clitSwellingDemonSheilaClitSoundingAnal() {
		DisplayText().clear();
		//(no horse)
		if (!player.torso.hips.legs.isTaur()) DisplayText("Sheila places her hand in the small of your back and leans in, drawing closer to your face even as she pulls your waist inward.");
		else DisplayText("Sheila sets her hand atop your withers, pressing down gently as she looks into your eyes.");
		DisplayText("  \"<i>Why don't you relax, [name]?  Lie down and let me take care of you...</i>\"  Her eyelids lower and her mouth spreads in a sly smile, and for just a moment you lose your nerve, looking into her devilish expression.  \"<i>Don't worry, love,</i>\" she says, straightening her face.  \"<i>I promise you'll enjoy this.</i>\"");

		DisplayText("\n\nBefogged but still reserved, you nonetheless allow Sheila to lower you to the grass and remove your [armor].  She ");
		//[(not horse)
		if (!player.torso.hips.legs.isTaur()) DisplayText("turns around, then straddles your groin and looks over her shoulder.");
		//(Equus ferus caballus)
		else DisplayText("circles you until she reaches your rump, then turns around and kneels down herself, looking at you over her shoulder.");
		DisplayText("  Her black, spaded tail lifts from between her thighs and snakes toward your pussy,");
		//[(if manparts)
		if (player.torso.cocks.count > 0) {
			DisplayText(" caressing ");
			if (player.torso.balls.quantity > 0) DisplayText("your [balls]");
			else DisplayText("the underside of your [cock biggest], before");
		}
		DisplayText(" forcing your lips apart and lingering on your rapidly-swelling " + Desc.Vagina.describeClit(player) + ".  \"<i>Oh, my.  What's with this ");
		if (player.torso.clit.length <= 6) DisplayText("lewd little");
		else DisplayText("grotesque");
		DisplayText(" thing doing growing from a pretty girl like you?  It's just the perfect size for some fun.</i>\"");

		DisplayText("\n\nYour eyes open in alarm at the same time as her mouth does in pleasure; she jams the slit of her spade onto your button");
		if (player.torso.clit.length > 6) DisplayText(", taking it several inches deep");
		...
		if (player.torso.clit.length <= 6) {
			...
			if (!player.torso.hips.legs.isTaur()) DisplayText("Taking your face into her hand, she closes your jaw and then leans in to plant a kiss on your chin.");
			else DisplayText("Her eyes glitter with mirth.");
			DisplayText("  \"<i>Why the look, mate?  Seems like you're saturated for now, and just in time.  This... is...</i>\"  She pulls her tail up from the end of your clitoris, then slides it back down, slowly.  \"<i>... perfect!</i>\"  As her tight hole swallows your sensitive distaff staff once again, your eyes roll and her head drops, dragging her hair");
			//[(horse)
			if (player.torso.hips.legs.isTaur()) DisplayText(" through the grass");
			else if (player.torso.chest.sort(BreastRow.BreastRatingLargest)[0].rating >= 1) DisplayText(" between your " + Desc.Breast.describeAllBreasts(player));
			else DisplayText(" along your flat chest");
			DisplayText(".  \"<i>Ffuck, even your girl parts are amazing.</i>\"  Sheila plants kiss after kiss on your ");
			if (!player.torso.hips.legs.isTaur()) DisplayText("[chest]");
			else DisplayText(Desc.Butt.describeButt(player));
			DisplayText(" as she shallowly pumps your " + Desc.Vagina.describeClit(player) + " in and out of her spade.  Your pelvis twitches uselessly; with her tail waving in the air instead of braced against her, controlling the pace of the fuck is beyond you.  \"<i>Naughty sheila,</i>\" she says, squeezing your wiggling hip with a hand.  You think privately that she could just as easily be talking about herself.  \"<i>Am I not going fast enough for you?  Let me speed up.</i>\"");
			...
			if (player.stats.cor < 50) {
				...
				DisplayText("\n\n\"<i>N-no... no!  So close!</i>\"  The black stalk thrashes weakly as her body loses muscle control everywhere except the parts responsible for forcing her cum out of it.  She moans piteously and babbles as her tail swells around your clit and engulfs you in her liquid climax, doubling in thickness behind the spade from the mounting fluids.  It's too much for you to watch, this arrogant woman trying to use you to get off but only managing to tease herself while suffusing your clit with her hot fluid, and combined with the temperature, pushes you over the edge you'd been flirting with.  Your " + Desc.Vagina.describeVagina(player, player.torso.vaginas.get(0)) + " squeezes and squirts, depositing your own orgasm onto the ");
				if (player.torso.vaginas.get(0).wetness >= 4) DisplayText("demon's legs");
				else DisplayText("grass");
				DisplayText(", and your clit swells even further inside your tormented partner.  Sheila groans, \"<i>Fuck you, [name]...</i>\"");

				DisplayText("\n\nIrritated, she wraps her other frantic tail around the still-straining black one and squeezes, finally managing to get some of her climax past the ring of tight skin at the end; with the fluid forming a bridge, you feel the tension release as a wave of her black, slippery tail-cum forces her slit wide open and gushes out to soak your clit and then your pussy underneath.  \"<i>Ah!  Ah!  Finally!</i>\" she cries, great gouts of agitated slime sliding down your " + Desc.Vagina.describeClit(player) + " to bubble and lick at your pussy, as if trying to get inside.");
			}
			//(else PC corr>=50)
			else {
				DisplayText("her tail quakes, then pushes her pussy into yours.  \"<i>God, yes!</i>\"  A spatter of hot fluid hits your " + Desc.Vagina.describeVagina(player, player.torso.vaginas.get(0)) + " as your demon lover climaxes, and another begins to drool around the tip of your clit, still suspended inside her writhing tail.  The sudden labial heat is too much for you, and you answer her with a climax of your own, ");
				if (player.torso.vaginas.get(0).wetness >= 4) DisplayText("drizzling");
				else DisplayText("copiously soaking");
		...
		//(else if clit >6" initially)
			...
			//[(horse)
			if (player.torso.hips.legs.isTaur()) DisplayText(" and rolls onto her back");
			DisplayText(", then wraps her tails around your thickened clit.  They twist and pull, sending spirals of pleasure along the numerous nerves, and begin gently but insistently tugging you toward her tan butt.  Sheila directs the tip right between her cheeks, and you can feel her using it to rub the ring around her hole.  \"<i>I think this should be about the right size for you, love,</i>\" she teases, spearing herself on your " + Desc.Vagina.describeClit(player) + ".  Inch after inch slides into her slowly, maddening you with warmth, until ");
			if (player.torso.clit.length <= 12) DisplayText("all of it is in her bowels and her hot cunt rests against yours");
			else DisplayText("she's taken as much as she can");
			DisplayText(".  She half-smiles and half-winces at you.  \"<i>Don't usually take it in this hole, but I wanted to feel your pussy going crazy for me.</i>\"  ");
			if (player.torso.clit.length <= 12) DisplayText("Her hips shift, dragging her lips across yours and stirring your clit through her asshole even as it squeezes you; your pussy twitches at the stimulation.");
			else {
				DisplayText("Her tails, one still swollen from being stretched and tormented by your growing clit, slip into you abruptly, bringing their mild burning sensation with them; if you hadn't been saturated with it already, you'd probably pass out.");
				//[(if virgin vagina)
				if (player.hasVirginVagina()) DisplayText("  \"<i>What's this?</i>\" Sheila teases.  \"<i>Why, your virtue is still intact, little girl!  I wouldn't want anything to happen to it!</i>\"  She pulls her tails out a bit, contenting herself with simply teasing your lips and driving you mad for penetration.");
				DisplayText("  The demon shifts around your clit, sending a wave through you that makes your lips wrap around the invaders.");
			}

			DisplayText("\n\nSheila places her long-taloned feet against ");
			//(not naga)
			if (!player.torso.hips.legs.isNaga()) DisplayText("your thighs, spreading your [legs] wide and then hooking them over top to touch ");
			DisplayText("the ground next to your ass, and uses the leverage to begin pumping your clit out of and into her asshole, caressing your " + Desc.Vagina.describeVagina(player, player.torso.vaginas.get(0)) + " every time she slides home.  \"<i>I could get used to this, love.  What say I keep you dosed up like this and you become my dildo?  I'll ride you with a different hole every time!</i>\"  Your eyes roll back in your head, at least partially from the irregular pace at which she's stroking your clit.  Sheila grabs her breasts as she slows down drastically once again, mashing them with her hands and sinking onto you an inch at a time.  \"<i>Fuck... I love your junk, [name].  Maybe I should catch a goblin, too, and make her tease my pussy while you fill my ass.</i>\"  She raises back up and ");
			//[(clit>12")
			if (player.torso.clit.length > 12) DisplayText("pulls her black tail free, dripping with your juice, then ");
			DisplayText("begins to work her drooling spade along your clit again, smearing her goo along your chunky chick-stick.  You can feel the edges of the stretched hole in her tip working on your skin, opening and closing ever so slightly as her copious tainted lube oozes out.  Your " + Desc.Vagina.describeClit(player) + " must be completely saturated already, because the slippery goo lingers on the surface instead of wicking into it.  \"<i>Gonna g-get you nice and wet, love...  Ohh,</i>\" Sheila says, affected to distraction by the pleasure of tracing the slick end of her stubby tail along you.");

			DisplayText("\n\nFinally coating you to satisfaction with the oily secretions, Sheila begins pumping again.  The heated friction from before evaporates, replaced with a dull, distributed warmth as she slides her asshole along your clit.  With less resistance, she's able to up the tempo to frantic, scraping along the ground so fast that she begins to tear up the grass.  You bear up as much as you can under the onslaught of pumping and gyrating hips, but eventually the sensation is too much, and your nerves take over as your climax begins.  Your " + Desc.Vagina.describeVagina(player, player.torso.vaginas.get(0)) + " spasms, drooling onto her ");
			if (player.torso.clit.length <= 12) DisplayText("pussy; her smooth, small labia greedily lap at the fluid when they touch, brushing against yours and drawing further twitches and squirts.");
			else DisplayText("teasing tails; they shift from stroking your labia to holding them open, allowing your pussy to squirt as it pleases.");
			DisplayText("  Suddenly she stops mid-stroke as her asshole quivers, sending shivers up your orgasm-sensitized clitoris.  \"<i>Fffuck!  So soon!  I'm coming too, [name]!</i>\"  Sheila sinks down, burying your " + Desc.Vagina.describeClit(player) + " into her asshole.");
			//(clit>12")
			if (player.torso.clit.length <= 12) {
				DisplayText("  Her tails sink into you as she squirms, parting your lips and pushing their way inside.");
				//[output hymen check, but don't remove virgin flag yet]  
				if (player.hasVirginVagina()) DisplayText("  <b>You've lost your virginity!</b>");
				DisplayText("  Buried in your pussy, the spade begins drooling its black fluids in greater and greater volume as Sheila is wracked by her orgasm.");
			}
			...
			if (player.torso.clit.length > 12 && player.hasVirginVagina()) {
				DisplayText("  \"<i>Sorry about your hymen, love, but I just couldn't resist making a sweet little slut like you into my girl.  I hope you'll remember me - I only wish I had a proper donger so I could give you my baby, too.</i>\"");
			}
			DisplayText("  Even as tired as you are, what you see on the demon girl makes you laugh.  She starts at this, then follows the direction of your gaze; ");
			if (!player.torso.hips.legs.isTaur()) DisplayText("her tits are covered by grass stains from her frenetic pumping.");
			else DisplayText("craning around shows her that her asscheeks are completely green and wet with torn grass from slamming into you so violently and repeatedly.");
		...
		if (player.torso.clit.length > 12 || player.stats.cor < 50) {
			Mod.Vagina.displayStretchVagina(player, 12, false, false, false);
			player.slimeFeed();
		}
		player.torso.clit.length++;
		if (player.perks.has(PerkType.BigClit)) player.torso.clit.length += .5;
		if (player.stats.cor < 50) {
			player.stats.cor += 10;
			sheilaCorruption(-10);
		}
	...
	//Loss - unsexed joke scene
	private aintGotNoGenderAndKangarooRaped() {
		DisplayText().clear();
		DisplayText("Sheila sashays over to you and brazenly sticks her hand in your featureless crotch.  \"<i>It's too bad you've mutilated yourself like this, love... or did you do it just to tease me?  You know, it doesn't bug me that much.</i>\"");
	...
	internal function beatUpDemonSheila(output: boolean = true) {
		if (output) {
			DisplayText().clear();
			DisplayText("\"<i>Ahh, you win, mate.  I give up.</i>\"  Sheila slumps to the ground, ");
			if (monster.stats.HP < 1) DisplayText("and her wounds begin to close with a soft lilac glow.  \"<i>So fuckin' strong.  I don't suppose you've got any sperm for me, do you?  I'd love to have some of your kids...</i>\"  She looks at you beseechingly, gently fingering herself.");
			//(lust)
			else DisplayText("frigging herself vigorously.  \"<i>Do with me what you will, lover; those were the terms.  Won't you take my body to satisfy yourself, you brute?</i>\"  The audacious woman sticks her tongue out, as if to goad you into treating her roughly.");
		}
		//[(lust < 30)]
		...
		if (player.torso.cocks.count > 0 && player.cockThatFits(56) >= 0) MainScreen.addButton(0, "Missionary", missionaryForThePurposesOfCreatingImpsWithSheila);
		...
		if (player.torso.cocks.count > 0 && player.cockThatFits(56) >= 0) MainScreen.addButton(1, "AnalHateFuck", analHateFuck);
		//Win - [Big Dick+Thighs] (usable for dicks with cockarea > 56) (all 10 of them)
		//penis envy, go!
		if (player.torso.cocks.count > 0 && player.torso.cocks.sort(Cock.LargestCockArea)[0].area > 56) MainScreen.addButton(2, "UseHerThighs", bigDickAndThighs);
		//Win - [Penetration, in Spades] - for self-loathing vaginas
		if (player.torso.vaginas.count > 0) MainScreen.addButton(3, "Clit-Fuck", winAgainstDemoNSheilaForVaginas);
	}

	//Win - [Missionary] - for the purpose of procreation
	//requires a cockarea <= 56
	private missionaryForThePurposesOfCreatingImpsWithSheila() {
		DisplayText().clear();
		DisplayText("You unfasten your [armor] and strip down completely, as Sheila's eyes drink up your bare flesh.  Denuded, you caress your cock with several strokes, producing a drop of precum.");
		...
		if (player.stats.cor < 40) DisplayText("Your ardor subsides a bit at her performance, but seeing your look of contrition, ");
		else DisplayText("Your scowl hardens at her shameless playacting, and ");
		DisplayText("she breaks into laughter.  \"<i>I'm just having you on, love.  You know my body's yours for the using.</i>\"");
		...
		if (!player.torso.hips.legs.isTaur()) DisplayText("shoulders");
		else DisplayText("flanks");
		DisplayText(" and her pupils dance in excitement; for a moment you even lose yourself in her enthusiasm, forgetting her demonhood and seeing only an earnest, adoring girl under you.  \"<i>Now, push!</i>\"");
		...
		//(sheila corruption >=40)
		if (sheilaCorruption() >= 40) DisplayText("and her soft breasts jiggle ");
		DisplayText("as a twinge of sensation from your thrust provokes a gasp and forces her to reposition herself, to better find it again.  \"<i>That's the spot!  Your dick is the <b>best!</b>  Pound me, you fucking cum-hose!</i>\"");

		DisplayText("\n\nRestraint evaporates as she reaches up and kisses your chest, dancing her lips across your " + Desc.Skin.skinFurScales(player) + " and leaving a trail of tingling nerves behind.  Your ");
		if (!player.torso.hips.legs.isTaur()) DisplayText("arms");
		else DisplayText("forelegs");
		...
		if (player.torso.hips.legs.isTaur()) {
			DisplayText(", practically lifting herself off of the ground] as she impales her cunt on your [cockFit 56] to prevent you from pulling out.");
		}
		//[(silly)
		if (User.settings.silly()) DisplayText("  \"<i>Make me feel like I'm fifteen years old again and playin' with the dog-morphs in the field!</i>\"  Heavens to Betsy!");
		else DisplayText("  \"<i>This is what you're here for!  Don't spill a single drop!</i>\"");
		...
		if (sheilaCorruption() < 40) DisplayText("tight");
		else DisplayText("soft");
		DisplayText(" chest against you");
		if (player.torso.hips.legs.isTaur()) DisplayText(" as you slump forward");
		DisplayText(".  Your cock ");
		if (player.torso.cocks.count > 1) {
			DisplayText(" and its ");
			if (player.torso.cocks.count === 2) DisplayText("brother");
			else DisplayText("brethren");
			DisplayText(" swell and squirt");
		}
		else DisplayText("swells and squirts");
		DisplayText(", pouring your semen into Sheila's ravenous pussy");
		if (player.torso.cocks.count > 1) DisplayText(" and coating her crotch with a glaze of white");
		DisplayText("; her eyes glow and it briefly feels as though her body is sucking the ejaculate right out of you");
		if (player.cumQ() >= 500) DisplayText(", until she fills up and the rest of your orgasm is drooled out at its own lazy pace");
		DisplayText(".  She kisses you");
		if (player.torso.hips.legs.isTaur()) DisplayText("r forelegs");
		DisplayText(" lovingly and deeply");
		if (player.torso.cocks.count > 1 || player.cumQ() >= 500) DisplayText(" as the spare seed dribbles from her crotch");
		DisplayText(", then breaks away and looks up into your face.");

		DisplayText("\n\n\"<i>[name], you ");
		if (player.cumQ() >= 500 || player.torso.cocks.count > 1) DisplayText("spilled some.  I can't have your baby if you're fucking the grass.  And you ");
		DisplayText("came too soon; I wasn't done.</i>\"");
		...
		//(else if RNG doesn't end scene)
			...
			//(if vag)
			if (player.torso.vaginas.count > 0) DisplayText(" as her imp spawn take turns doing the same to you from behind");
			else DisplayText(" as her imp spawn gather around, stroking themselves and occasionally squirting their hot, tainted cum on her body or yours as orgasm takes them");
			DisplayText(".  ");
			if (player.stats.lib < 40) DisplayText("Shocked");
			else DisplayText("Flushing hotly");
			DisplayText(", you look away and break the connection, but Sheila's smile only widens.");

			DisplayText("\n\n\"<i>Did you see it?  Our future together?</i>\"  The demon reaches up and plays with your hair.  \"<i>Our wonderful family... our children... so full of seed to give, just like their " + Desc.Gender.mf(player, "father", "mother") + ".  I can feel you getting hard again inside me - am I exciting you?</i>\"  Her hand drifts down to your mouth, and she brushes your lips gently with her thumb.  \"<i>Why don't you go ahead and do me again?  Show me how you feel, mate; I won't do anything except touch you, so you can take your time.  I'm your obedient, loving wife, here to make you happy.</i>\"  She caresses your cheek one last time and lowers her hand to your chest, tracing a meaningless pattern as she turns expectant eyes on you.");

			DisplayText("\n\nIt's too much.  ");
			if (!player.torso.hips.legs.isTaur()) DisplayText("You kiss Sheila on the lips, pushing your tongue through to play with hers, as your arms push your spent body into position to thrust again.");
			else DisplayText("You reach down with a hand and place it alongside Sheila's face; her ear twitches as she looks at you brightly, and for a moment you recapture your earlier impression of her as a sweet, devoted lover.  Your legs struggle to push your equine bulk upwards as you return to a thrusting position, dragging her groin into the air by your erect cock.");
			...
			//[(PC corr <50)
			if (player.stats.cor < 50) DisplayText("Her pussy convulses as she orgasms, and you feel a wave of heat overtaking your [cock biggest], starting at the tip and moving down the shaft.  As it reaches the base, a gush of her fluids breaches the seal her pussy makes around you, forcing your jizz out along with it in a mixed white and clear squirt.  The demon's vagina squeezes and drools for half a minute, pouring her tainted liquid love out against your tightly-held body until your crotch is soaked with her sticky heat and responds with its own.");
			else DisplayText("Her pussy sucks you in as she climaxes, and you can feel larger and larger waves of precum being pulled from your shaft; it almost feels like she's tugging at your entire being.  It's not long before your cock twitches and begins giving her greedy sex a second helping of your semen.");
			DisplayText("  She goes limp as her twitching cunt takes over and begins drinking every drop it can get from your dick to replace the goo you pushed out");
			if (player.cumQ() >= 500) DisplayText("; you nearly manage to fit it all into her this time, with your production still flagging from the last session");
			DisplayText(".  Muscles weakening again, you lower yourself onto her once more and allow her to stroke your ");
			if (!player.torso.hips.legs.isTaur()) DisplayText("back");
			else DisplayText("sides");
			DisplayText(" as she cools down.");
	...
	private sheilaAnalHateFuckAGoGo() {
		DisplayText().clear();
		DisplayText("Your [cockFit 56] gets hard in your [armor] as you watch her diddle her pussy, but you set your jaw to resist giving her what she wants - a better idea is taking shape in your head.  \"<i>Turn around,</i>\" you demand.");

		DisplayText("\n\nSheila bites her lip and blushes, then turns her back to you, pressing her chest into the ground and waving her ass in the air, twin tails bobbing over her round cheeks and drooling, eager cunt.  \"<i>Heehee, I'm ready for you, mate... look how wet I am!</i>\"  You strip, releasing your " + Desc.Cock.describeMultiCockShort(player) + ", and approach.  She hums in anticipation as you rub against her smooth labia, smearing her moisture onto your [cockHeadFit 56].  \"<i>Come on; time to put it in already!  Don't tease me!</i>\"");

		DisplayText("\n\nYour smile widens, unseen, as you silently agree.  ");
		if (!player.torso.hips.legs.isTaur()) DisplayText("Slipping one hand around your [cockFit 32]");
		else DisplayText("Straddling her");
		DisplayText(", you pull your hips back and line the [cockHeadFit 32] up, then thrust - right into her asshole.  Her head raises and her teeth grit as you force the slick tip past her ring.  \"<i>[name], what the fuck?!  That hurts!  Go easy if you're going to use that hole; I'm not good at stretching my body yet!</i>\"");

		DisplayText("\n\n\"<i>No.</i>\"  You ");
		//(not centaur)
		if (!player.torso.hips.legs.isTaur()) DisplayText("grab her thrashing legs, using them for leverage as you ");
		DisplayText("force your dick into the angry woman.  \"<i>You talk a good game about how you love being full of cock, but when I shove one in you, you get all bitchy and act like you're not ready; why don't you just shut up and get fucked, slut?</i>\"");
		...
		if (sheilaCorruption() >= 90) DisplayText("; her enormous, cushiony breasts spread under her as your prick forces her weight heavily onto them");
		DisplayText(".  She pulls up tufts and pounds the earth impotently with her fists while you sink in as far as you can.  \"<i>Fuck you!  What the fuck is wrong with you, arsehole?!  Let me go, I don't want anything to do with you anymore!</i>\"");
		...
		if (player.stats.cor >= 80 && player.statusAffects.has(StatusAffectType.Infested)) {
	...
	private sheilaAnalHateFuckAGoGoNO() {
		DisplayText().clear();
		DisplayText("\"<i>Go to hell.</i>\"  You bury yourself in the demon's ass as your dick begins to spasm.  Her tails writhe as the first trickle sinks into her.  \"<i>What?  Say something, I dare you.</i>\"");
		...
		if (player.cumQ() >= 500) DisplayText("  Your overproduction floods her insides, and Sheila groans as it begins to leak back out, drooling over her pussy.  \"<i>Hey, you got your wish,</i>\" you tease.  The wanton woman tries to tilt her ass higher, to tip more of your overflow into her cunt, but you laugh and slap her hard on the hip, sending her to one knee again.");
		...
		if (player.cumQ() < 250) DisplayText("trickle");
		else if (player.cumQ() < 1000) DisplayText("stream");
		else DisplayText("waterfall");
		DisplayText(" of semen made when her body pushes out some of the foreign substance.");
	...
	private sheilaAnalHateFuckAGoGoGETYOUSOMEWORMS() {
		DisplayText().clear();
		DisplayText("\"<i>Mmm...</i>\" you answer, noncommittally.  Your ");
		if (player.torso.balls.quantity > 0) DisplayText("[balls]");
		else DisplayText("insides");
		DisplayText(" squirm, giving you pause, and you pop your [cockFit 56] out.  \"<i>Actually... I don't think I suit you at all.</i>\"");
		...
		DisplayText("\n\n\"<i>Mmm...</i>\" she hums, reaching eagerly for your [cockHeadFit 56] with her finger as if getting it inside were the only thing that mattered.  You back up again, and she crawls over and onto you, rubbing her slimy cunt against your [legs].  Her strokes trigger a small orgasm in her, and as her pussy sprays a load of worms onto your " + Desc.Skin.skinFurScales(player) + " she kisses you affectionately, looking right into your eyes; you're flooded with nebulous mental images of fucking a slender, sickly pale Sheila as both of you are covered and hidden from the sunlight by a massive colony, of her riding you with her slithering, wormy pussy until the semen spitting from your [cockFit 56] leads the parasites within right to your slit, and, most disturbingly, of Sheila stretching your slick urethra wide open and climbing into your penis herself!  Shaking it off, you quickly break contact, pick up your stuff, and depart, leaving the infested woman behind... but the visions don't go away.");
	...
	private analHateFucksWithJojo() {
		DisplayText().clear();
		DisplayText("Watching her sit there and play with herself like nothing's the matter and you didn't just demonstrate her weakness for all the world to see touches a nerve deep inside you.  You scowl and focus your thoughts to call your mousey ex-monk, bent on showing this demon how a proper mendicant should behave.");
		...
		if (sheilaCorruption() < 40) DisplayText("\"<i>What's with these tiny titties?  Could any man possibly be aroused by your bug bites?  I've seen bigger breasts on incubi!</i>\"");
		else DisplayText("\"<i>These disgusting sacks of fat on your chest... are you under the impression that men like giant stretch marks and nipples that hang to your knees?  Why don't you get in shape, you messy bitch?</i>\"");
	...
	private analHateFucksWithJojoNo(clear: boolean) {
	...
	private jojoRuinsTheAnalHateFuck(clear: boolean = true) {
		if (clear) DisplayText().clear();
		else DisplayText("\n\n");
		DisplayText("Your mouth spreads in a sickly smile as you contemplate granting her request anyway.  \"<i>Jojo...</i>\"");
		...
		if (sheilaCorruption() >= 90) DisplayText(", mashing her tits together as they thicken");
		DisplayText(".  The mouse himself seems to be growing, in fact.  His feet kick and thrash, sprouting dangerous-looking nails as his legs stretch prodigiously.  As his body mass increases, his white-furred skin begins to burst and peel like old rags, revealing new, dark flesh underneath.");
		...
		if (sheilaCorruption() >= 40) DisplayText("Her breasts tighten up, shedding cup sizes rapidly; t");
		else DisplayText("T");
	...
	//Win - [Big Dick+Thighs] (usable for dicks with cockarea > 56) (all 10 of them)
	//penis envy, go!
	private bigDickAndThighs() {
		DisplayText().clear();
		DisplayText("As Sheila diddles herself, you ");
		//[(not horse)
		if (!player.torso.hips.legs.isTaur()) {
			DisplayText("doff your [armor]; the demon's eyebrows climb as you haul out " + Desc.Cock.describeMultiCockSimpleOne(player));
			if (player.torso.cocks.count > 2) DisplayText(" one at a time, practically stacking them atop each other");
			DisplayText(".");
		}
		//(horse)
		else {
			DisplayText("slowly draw nearer to her, your " + Desc.Cock.describeMultiCockShort(player) + " bobbing with each step.");
		}
		...
		if (player.stats.cor < 40) {
			...
			DisplayText(" toward her and aim underneath her cunt to rub your [cockHead biggest] against her palm, smearing a glob of precum on it.  You can see her shivering wordlessly, sliding her fingers together to play with the hot, clingy fluid, making translucent webbing between them.");
			//[(multi)
			if (player.torso.cocks.count > 1) {
				if (player.torso.cocks.count === 2) DisplayText("  Both");
				else DisplayText("  All");
				DisplayText(" of them... slide them here, love,</i>\" the demon insists.  You line the remainder of your manhood up and force it between her thighs as well.");
			}
			DisplayText("  She takes the tip of your [cock biggest] in her hand and pulls gently, coaxing your forward; you close the distance until " + Desc.Cock.describeMultiCockSimpleOne(player) + " is peeking through her legs and your crotch is pressed against hers.");

			DisplayText("\n\n\"<i>I'm going to borrow a bit of your sensation...</i>\" Sheila announces quietly.  ");
			//[(not horse and not < 5"0)
			if (!player.torso.hips.legs.isTaur() && player.tallness >= 60) DisplayText("She unbends and kisses you on the cheek, and your face feels a bit fuzzy where her lips touch.  ");
			...
			DisplayText("\n\n\"<i>We'll see who finishes first.</i>\"  Resting herself against your " + Desc.Cock.describeMultiCockShort(player) + " for support, she brings her other hand up and touches you; almost the full sensation is there this time, and you sign in happiness.  Sheila begins stroking with the new hand as well as the old, grabbing ");
			if (player.torso.cocks.count === 1) DisplayText("your dick with both");
			else DisplayText("a prick in each");
			DisplayText(" and angling upward so the precum drools downward and lubes her fingers.");
		}
		//(else corr >= 40)
			...
			if (player.torso.cocks.count > 1) {
				...
				if (player.torso.cocks.count === 2) DisplayText(", you slide it through her legs between your first cock and her cunt, plowing through her entrance like a furrow; she quakes and you can feel it contracting against your skin.  ");
				else DisplayText("s, you push them through the woman's legs one by one, smearing warm precum on her thighs as you do; her pussy squeezes against the top of your [cock biggest] as you coat her skin with your fluids.  ");
			}
			else DisplayText("\n\n");
			DisplayText("Sheila scoots backward, choking up on monster cock until her ass is pressed against your crotch, and then wraps her hands around and begins to masturbate you, using your drooling fluid and her own wetness for lubrication.");

			DisplayText("\n\nShe seems to get off on it as much as you do; as she strokes, her tongue hangs out slightly and she begins rubbing your " + Desc.Cock.describeMultiCockShort(player) + " between her " + sheilaCup() + " breasts, smearing your secretions down her entire torso.  Her skin is hot and feels good, but not as vivid as you'd expect.  The demon's pussy contracts wildly again, despite being at rest against your shaft, and you come to a realization: she's actually siphoning the pleasure from you!");
		}
		//end corr split
		DisplayText("\n\nThe woman quickly becomes lost in her own little world, searching out the nerves on your prick");
		if (player.torso.cocks.count > 1) DisplayText("s");
		DisplayText(" and teasing each one; you thrust weakly into her hand, helping guide her hands, but your lonely tip wants for stimulation.  As the feeling becomes so acute that you prepare to say something, Sheila uncannily anticipates you and scoots her pussy along your shaft, popping your [cockHead biggest] into her mouth.  Her tongue dabs at your slit, tasting your fluid, and her hands ");
		if (player.torso.cocks.count > 2) DisplayText("relinquish your other pricks and ");
		if (player.torso.cocks.count === 2) DisplayText("relinquish your other prick and ");
		DisplayText("focus on squeezing more drops out of you.  She fairly coats her lips with it, rubbing your hole against them before popping the whole [cockHead biggest] back into her mouth.  A moan escapes you just as another one returns from Sheila's throat, transmitted through your [cock biggest].");

		DisplayText("\n\nAs her attentions refocus on your [cockHead biggest], a pang of loss arises from the middle of your " + Desc.Cock.describeMultiCockShort(player) + " - and is quickly smothered with her chest.");
		//[(sheila corruption < 50)
		if (sheilaCorruption() < 50) DisplayText("  Though her modest breasts can't even begin to encompass your girth, Sheila rubs her cleavage along your skin with gusto while she works your tip with her tongue.");
		else if (sheilaCorruption() < 150) DisplayText("  Her large " + sheilaCup() + " breasts encompass your girth easily, and she pushes the soft, flushed skin together as she slides it up and down your cock.");
		else {
			DisplayText("  The demon's ridiculously enormous breasts easily cover the entire length of your cock");
			if (player.torso.cocks.count > 1) DisplayText("s");
			DisplayText(" falling between her crotch and her mouth, making her whole body feel like a huge, wet fuckhole");
			if (player.torso.cocks.count > 1) DisplayText(" built for " + numToCardinalText(player.torso.cocks.count) + " pricks");
			DisplayText(".");
		}
		...
		if (sheilaCorruption() >= 150) {
			DisplayText("Her enormous breasts dangle all the way to the ground, forming a second, softer hole to push into with your swollen prick");
			if (player.torso.cocks.count > 1) DisplayText("s");
			DisplayText(".  ");
		}
		DisplayText("\"<i>Y-yes,</i>\" she mumbles, \"<i>gonna fuck her... harder...</i>\"");

		DisplayText("\n\nThe apparent answer to your question passes you by as you obliviously force your tool");
		if (player.torso.cocks.count > 1) DisplayText("s");
		DisplayText(" through the vise of her legs; losing yourself further and further to pleasure, you don't even notice when Sheila's hips begin to buck in time with your own, pressing her mons down against your ");
		if (player.torso.cocks.count > 1) DisplayText("topmost ");
		DisplayText("dick.  With an enormous, final thrust, you mash your crotch up against hers and begin to ejaculate.  ");
		if (player.stats.cor < 50) DisplayText("The sensation seems to reawaken Sheila; she angles her body up to press her pussy close and your embezzled sensation floods back into you - along with an unexpected gift.  You can feel your... no, <i>her</i> demonic pussy convulsing repeatedly, trying to suck up sperm in vain as her own orgasm comes off, and she looks at you with sly eyes.  \"<i>A little reciprocity for my love,</i>\" the woman coos, \"<i>to show you how much I care.</i>\"");
		else DisplayText("\"<i>Oh god!</i>\" Sheila shrieks.  \"<i>I'm coming!  Jizz is going everywhere!</i>\"  Indeed, as your body releases streams of cum, Sheila directs them by aiming " + Desc.Cock.describeMultiCockSimpleOne(player) + ", covering herself and moaning as her hands press out as much as possible.");

		DisplayText("\n\nFinished, you pull your sensitive, soaked shaft");
		if (player.torso.cocks.count > 1) DisplayText("s");
		DisplayText(" from between her still-squeezing thighs with a shudder; Sheila shudders with you until you finally draw free and break skin contact, then lowers herself carefully to the ground.  The demon turns toward you, exposing a face and chest splattered with your semen.  She stares at your deflating prick");
		if (player.torso.cocks.count > 1) DisplayText("s");
		DisplayText(", looking almost wistful to see ");
		...
		if (player.torso.vaginas.count <= 0) DisplayText("to grow a nice pussy for me so that ");
		DisplayText("I can put it in you any time I want.</i>\"  She sticks her tongue out at you, and the seed dripping from her lips oozes onto it.");
	...
	//Win - [Penetration, in Spades] - for self-loathing vaginas
	private winAgainstDemoNSheilaForVaginas() {
		DisplayText().clear();
		DisplayText("You drop onto the woman's lap without hesitation, ");
		if (!player.torso.hips.legs.isTaur()) DisplayText("mauling her tits roughly with your hands, ");
		DisplayText("and grind your pussy desperately against her midriff.  She slips two fingers into you obligingly, but you ");
		if (!player.torso.hips.legs.isTaur()) DisplayText("grab her face, plunging one thumb into the corner of her mouth in your haste, and");
		else DisplayText("turn your head and");
		DisplayText(" stare right into her eyes.  Focusing as hard as you can on your fantasy, you try to transmit your desire for something more to the demon by sheer force of will.  A sly smile parts her lips as she stares back - could this actually work?");
		...
		if (!player.torso.hips.legs.isTaur()) {
			DisplayText("crawl away on your hands");
			//[(tail or naga)
			if (player.torso.tailType > TailType.NONE && player.torso.hips.legs.isNaga()) DisplayText(" and raise your tail");
		}
		else DisplayText("clamber to your hooves and bend your forelegs");
		DisplayText(" to present your eager [vagina].  Sheila sits up and places her hands on your [hips], then slides her pelvis up, teasing your lower lips with something bulbous and warm.  They sting slightly as it smears its slime along them, a not-entirely-pleasant sensation.");
		...
		DisplayText("  Oh, god, it burns!  You shake violently as your pussy is assaulted by the fluid from Sheila's black tail, waves of pain twisting through it and forcing its walls to clamp down on the invader.  The demon gasps as you squeeze and leans forward onto your back");
		if (sheilaCorruption() > 0) DisplayText(", squashing her tits into you");
		DisplayText(".  \"<i>Calm down!</i>\" she barks, grabbing your arms and pulling them toward her.  With hands held behind you like this, you can do little to check her enthusiasm... but Sheila doesn't begin thrusting yet.  \"<i>It'll fade soon, love, and you'll start feeling it,</i>\" she promises, kissing your ");
		if (!player.torso.hips.legs.isTaur()) DisplayText("neck");
		else DisplayText("withers");
		...
		//[(lib <20)
		if (player.stats.lib < 20) DisplayText("even as proud as you are, ");
		...
		if (player.stats.cor < 50) {
			DisplayText("  She pumps and pumps again, forcing more of the muck into your [vagina] even as she calls you the most filthy things she can think of");
			if (sheilaCorruption() > 0) DisplayText("; her tits wobble violently as she thrusts, and then still as she arches her back and jams her spade all the way in");
			DisplayText(".  Sheila howls to the sky as she pours her demonic slime into you in one final, solid stream.  You can feel it pushing eagerly through even your copious fluids until it's at the entrance to your womb... and then inside.");
			...
			if (player.fertility < 50) {
				DisplayText("  There is a tingle deep inside you, making you more fertile.");
				player.fertility++;
			}
		}
		else {
			DisplayText("  She stops pumping, falling against your back and panting as the last of her goo seeps out and is ejected around her shaft by your fountainhead of girl-cum.  You are clearer-headed than before as your orgasm dwindles, though, illogically, you could swear you felt her tits growing against you.");
		}
		...
		if (player.torso.vaginas.get(0).wetness < 5) {
