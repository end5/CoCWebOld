...
export class Shouldra extends Character {
    public constructor() {
        ...
        this.baseStats.str.value = 45;
        this.baseStats.tou.value = 30;
        this.baseStats.spe.value = 5;
        this.baseStats.int.value = 110;
        this.baseStats.lib.value = 100;
        this.baseStats.sens.value = 0;
        this.baseStats.cor.value = 33;
