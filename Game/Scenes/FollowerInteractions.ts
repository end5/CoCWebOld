...
export class FollowerInteractions {
    ...
    public amilyMeetsPureJojo(): NextScreenChoices {
        ...
        DisplayText("Jojo colors, turning redder than you've ever seen him.  He tries to explain himself, \"<i>I'm sorry... there were so many, and I dared not return.  If they had caught me-</i>\" but stops and shudders with barely expressed fear.\n\n");

        DisplayText("Amily sighs and hugs him again, \"<i>You're a pansy. You know that Jojo?  But I'm glad " + player.short + " reunited us so that we could meet again.</i>\"\n\n");

        DisplayText("Jojo replies, \"<i>Me too,</i>\" before he notices you and coughs.  Amily pulls back and beams a brilliant, buck-toothed smile at you.  She rushes into your arms and gives you a kiss before she runs off.  Jojo looks a little embarrassed and scratches his ear as he centers himself.\n\n");
        player.stats.lust += 5;

        // [To jojo camp interaction]
        return { next: jojoScene.jojoCamp };
    }

    // [Amily and Pure Jojo spar – occurs when going to amily, requires 'amily meets jojo']
    public pureJojoAndAmilySpar(): NextScreenChoices {
        DisplayText().clear();
        ...
        // [To amily screen]
        return { next: amilyScene.amilyFollowerEncounter };
    }
    ...
    public amilyIsPissedAtYouForRuiningJojo(): NextScreenChoices {
        DisplayText().clear();
        ...
        DisplayText("\"<i>What did you DO TO HIM!?</i>\" her voice shrieks.  She's behind you!  You pivot, praying the enraged mouse doesn't hit you with the same dart, and you see Amily half-hidden behind a rock.  Her blowgun is clutched in a trembling hand as she sobs with grief.  So she figured it out...\n\n");

        DisplayText("Amily screams, \"<i>Don't even try to lie!  I met him before you did this to him, and HE TOLD ME IT WAS YOU before he passed out!  We... we have to fix him.  I don't know why you would do something like this, but he- he's broken.  Utterly.  Please.  Find some pure honey and we can fix him!</i>\"\n\n");

        DisplayText("(You're at a crossroads. You can help Amily purify Jojo, but the mouse will likely never give you a chance to corrupt him again.  Alternatively, you could tell the bitch off and keep your favorite fuck-pet.)");

        // [Fix him] [Fuck off]
        MainScreen.simpleChoices(["Fix Him", "Fuck Off", "", "", ""], [agreeToHelpAmilyFixJojo, tellAmilyToFuckOffRuinedJojo, null, null, null]);
    }

    // [Tell Amily to fuck off]
    private tellAmilyToFuckOffRuinedJojo(): NextScreenChoices {
        jojoScene.jojoSprite();
        DisplayText().clear();
        DisplayText("You chuckle, \"<i>He's a better fuck like this than you ever were.  Why don't you piss off and leave us alone?</i>\"\n\n");

        DisplayText("The sadness she exudes is palpable, but her eyes harden into ice as she replies, \"<i>Fine. I don't want anything to do with a demon anyway.</i>\"  She turns around and jogs off, glancing back over her shoulder with tears in her eyes before she disappears.\n\n");

        DisplayText("No doubt she ran back to the ruins.  Perhaps you could gather some appropriate drugs to teach her a lesson?");
        if (player.stats.int >= 45) DisplayText("  Goblin ale and lust drafts might do the trick.");
    ...
    // [Fix Him]
    private agreeToHelpAmilyFixJojo() {
        jojoScene.jojoSprite();
        DisplayText().clear();
        DisplayText("You nod, ");
        if (player.stats.cor < 33) DisplayText("feeling genuinely sorry for what you've done.");
        else if (player.stats.cor < 66) DisplayText("unsure if you're making the right choice.");
        else DisplayText("wondering if this will wind up as an empty promise to placate the angry mouse-cunt.");
        DisplayText("  You say, \"<i>All right, when I find some pure-honey I'll bring it to you so we can fix him, okay?  I don't know what came over me; the corruption of this place just... got to me.  Let's fix him together.</i>\"\n\n");

        DisplayText("She tearfully nods and promises, \"<i>Just don't expect anything from me until this is taken care of.</i>\"\n\n");
    ...
    public fixJojoOOOOHYEEEEAHSNAPINTOASLIMJIM() {
        DisplayText().clear();
        ...
        DisplayText("You nod and leave, ");
        if (player.stats.cor > 66) DisplayText("already regretting your choice");
        else if (player.stats.cor > 33) DisplayText("a little confused by the whole situation");
        else DisplayText("glad the damage you did to Jojo wasn't permanent");
        DisplayText(".");
    ...
    private findJojosNote() {
        Flags.list[FlagEnum.JOJO_FIXED_STATUS] = 2;
        DisplayText().clear();
        DisplayText("There is a note left on your bedroll. You pick it up and unseal it – it's from Jojo!\n\n");
    ...
    public amilyDiscoversJojoWithTentaclesAndShitOhBoy() {
        DisplayText().clear();
        ...
        // Else:
            ...
            // [Corrupt/Choose Jojo]
            MainScreen.simpleChoices(["Explain", "Flip Bird", "", "", ""], [aerisDies, AmilyLeavesBirdJojoTentacles, null, null, null]);
        }
    }

    private AmilyLeavesBirdJojoTentacles() {
        DisplayText().clear();
        DisplayText("You flip her the bird.  She was a shitty fuck anyways.  Amily's eyes flood with tears, but her expression hardens with rage.  The mouse yells, \"<i>Like I'd want to stay with a demon like you anyway!</i>\"  She turns and jogs off into the distance.  Amily stops just before you lose sight of her and looks over her shoulder with tears in her eyes.  You've utterly crushed her heart.  She starts jogging again and disappears from your life forever.  Meanwhile, Jojo begins to stir.  It appears he'll be ready to serve soon...\n\n");
    ...
    private aerisDies() {
        ...
        DisplayText("(Amily is going to kill Jojo.  What do you do?)");
    ...
    private stopJojoDeathInTheNameOfLove() {
        jojoScene.jojoSprite();
        DisplayText().clear();
        DisplayText("You grab her by the shoulders and say, \"");
        ...
        // (SMART)
            ...
            DisplayText("Amily, this is wrong.  He may be corrupted, but we don't need to kill helpless innocents, no matter how horny they may be.  Yes he's corrupted beyond redemption, but his body and mind aren't geared towards spreading that corruption.  The mouse isn't a threat to anyone.</i>\"\n\n");

            DisplayText("She slowly nods and pulls her hand away from her dagger.  Amily answers, \"<i>You're right, as usual.  I'll leave him be, but if you ever do something like this again, I'm gone.</i>\"\n\n");
            // (+1 int)
            player.stats.int += 1;
    ...
    // [Let Her Kill Jojo]
    private whyWouldDoThis() {
        jojoScene.jojoSprite();
        DisplayText().clear();
        DisplayText("You can't watch the grisly deed and avert your eyes.  She slits the once-pious monk's throat and it's done.  The two of you build a cairn of rocks over the mouse's body, as fitting a burial as you're able to provide for him.");
    ...
    public AmilyIntroducesSelfToRathazul() {
        DisplayText().clear();
        ...
        DisplayText("The wise rat strokes his frazzled whiskers as he listens, clearly pleased with the younger rodent's words.  \"<i>The pleasure is mine.  It's not often I find such a rapt and attentive listener,</i>\" he replies.\n\n");

        DisplayText("Amily gives him a friendly hug and turns to leave.  She squeaks in surprise when she sees you and stamps over to demand, \"<i>How long have you been there?</i>\"\n\n");

        DisplayText("You stutter for a second until she kisses you on the lips and laughs, \"<i>It's ok, we were just wrapping up the lesson.  Go on, I'm sure you have something important to see to with Rathazul!</i>\"\n\n");

        DisplayText("Amily takes off, leaving you alone with the alchemist.");

        // (+5 lust!)/
        player.stats.lust += 5;
        return { next: kGAMECLASS.rathazul.returnToRathazulMenu };
    }
    // [Amily delivers ingredients to Rathazul – happens at Rathazul]
    public amilyIngredientDelivery() {
        DisplayText().clear();
        DisplayText("As you make your way to Rathazul's lab, a ");

        if (Flags.list[FlagEnum.AMILY_NOT_FURRY] === 1) DisplayText("big-eared blur whizzes past you");
        else DisplayText("blur of fur whizzes past you");

        DisplayText(".  Amily sprints into the rat's lab with an armful of flowers, plants, and other ingredients.  Rathazul says, \"<i>Thank you, child - these will be a huge help.  It is fortunate you knew where to find some of these.  Purchasing them is difficult and expensive.</i>\"\n\n");
        DisplayText("Amily bobs her head happily as Rathazul reaches into his robes and says, \"<i>Here is the payment, as promised,</i>\" and hands her an old alchemical text.  She squeals happily and runs past you, her tail curling about your waist for the briefest moment before she's gone.\n\n");
        // [To rathazul, +4 lust]
        player.stats.lust += 4;
    ...
    public amilyAsksAboutRathazulsVillage() {
        DisplayText().clear();
        Flags.list[FlagEnum.AMILY_MET_RATHAZUL]++;
        ...
        DisplayText("Rathazul sighs and shuffles around uncomfortably as he wraps it up, \"<i>'What-ifs' will get us nowhere.  Our villages are gone, and we must look to the future, child.</i>\"\n\n");

        DisplayText("Amily nods solemnly and says her farewells.  She looks a little bleary-eyed as you pass her, and you give her a comforting squeeze on the shoulder.   The mouse gives you a tight smile and continues away, leaving you alone with the rat.");
        return { next: kGAMECLASS.rathazul.returnToRathazulMenu };
    }

    // [Rathazul and Corrupt/Tentacle Jojo] – Occurs instead of camp
    private rathazulFreaksOverJojo() {
        DisplayText().clear();
        Flags.list[FlagEnum.RATHAZUL_CORRUPT_JOJO_FREAKOUT]++;
        DisplayText("Rathazul comes up to you with a serious, worried expression.  You ask him what's wrong, and he explains, \"<i>There is a creature in the woods.  I've seen glimpses of it numerous times, and I believe it to be some kind of demon-tainted mouse.  We must deal with it, lest it strike while we are unawares!</i>\"\n\n");

        DisplayText("You work hard to keep a straight face.  The 'creature' is clearly your fuck-pet, Jojo.  What do you tell the old mouse?  ");

        DisplayText("(He is mine, I can handle it, or he's harmless?)");
        // [Jojo is yours] [I can handle it] [It's harmless]
        MainScreen.simpleChoices(["Mine", "Handle It", "Harmless", "", ""], [tellRathazulYouOwnJojo, tellRathazulYouCanHandleIt, TellRathazulJojoIsHarmless, null, null]);
    }
    // 	[Jojo is yours]
    private tellRathazulYouOwnJojo() {
        jojoScene.jojoSprite();
        DisplayText().clear();
        DisplayText("You tell Rathazul, \"<i>Oh that's just Jojo.  He's been corrupted, but he isn't evil and he hangs around because he knows I like to sleep with him.</i>\"\n\n");

        DisplayText("Rathazul scratches his head in confusion and stutters, \"<i>You, uh, f-fuck the creature?  Well, umm... okay.  I guess I don't have to worry about it then...</i>\"\n\n");

        DisplayText("He blushes red and lurches back towards his laboratory, muttering under his breath about crazy kids.");
        return { next: Scenes.camp.returnToCampUseOneHour };
    }
    // [I can handle it]
    private tellRathazulYouCanHandleIt() {
        jojoScene.jojoSprite();
        DisplayText().clear();
        DisplayText("You tell Rathazul, \"<i>Don't worry about it.  I've been all over the woods and fought that mouse before.  He's a pushover, and if he tries to sneak up on either of us I'll take care of it.</i>\"\n\n");

        DisplayText("Rathazul looks you over and asks, \"<i>Why didn't you kill it?  With all the corruption in this world, we would be better off nipping these things in the bud.</i>\"\n\n");

        DisplayText("You answer, \"<i>Do I look like a demon to you?  I don't kill my enemies if I can help it.  Trust me, we're safe.</i>\"\n\n");

        DisplayText("The rat seems satisfied by your response and nods respectfully.  He lurches back towards his laboratory, wringing his clawed hands with worry.");
        return { next: Scenes.camp.returnToCampUseOneHour };
    }
    // [Its harmless]
    private TellRathazulJojoIsHarmless() {
        jojoScene.jojoSprite();
        DisplayText().clear();
        DisplayText("You explain to Rathazul, \"<i>That's just Jojo.  He got pretty fucked up and is hoping I'll let him fuck me.  The little mouse is a push-over, and nothing to worry about.</i>\"\n\n");

        DisplayText("Rathazul looks a little incredulous at the declaration and he asks, \"<i>Can we do something about him?  He's very creepy.</i>\"\n\n");

        DisplayText("You snort disdainfully and answer, \"<i>It's fine.  He's not interested in you – it's me he wants, and he won't be getting any of me unless I decide to let him.</i>\"\n\n");

        DisplayText("With the conversation concluded, Rathazul wanders off, murmuring, \"<i>Oh my, no...</i>\"");
        return { next: Scenes.camp.returnToCampUseOneHour };
    }

    // [Rathazul and non-corrupt Jojo]
    public jojoOffersRathazulMeditation() {
        DisplayText().clear();
        ...
        DisplayText("Jojo turns to you, gives a quick bow, and departs.");
        // [To rathazul]
        return { next: kGAMECLASS.rathazul.returnToRathazulMenu };
    }
    // [Rathazul Napping]
    public catchRathazulNapping() {
        DisplayText().clear();
        ...
        DisplayText("The mouse quietly rises and walks a fair distance away from the sleeping rat, letting his elder rest.  He motions for you to follow and leave Rathazul in peace.");
        // [NEXT – to normal jojo]
        return { next: jojoScene.jojoCamp };
    }

    private marbleVsAmilyFreakout() {
        DisplayText().clear();
        Flags.list[FlagEnum.AMILY_NOT_FREAKED_OUT]++;
        // Marble is in camp first
        if (Flags.list[FlagEnum.MARBLE_OR_AMILY_FIRST_FOR_FREAKOUT] <= 1) DisplayText("As you bring Amily into your camp, you see Marble look towards you with a smile for a moment, before that smile turns into a frown.  You realize that this might not have been such a good idea...\n\n");
        //// Amily is in camp first
        else DisplayText("As you bring Marble back to your camp, you see Amily sitting there as Marble asks while frowning, \"<i>Sweetie, who is that?</i>\"  Uh-oh, this could get bad.\n\n");

        // After either
        DisplayText("Within moments, Marble has walked up to Amily and, with a forced smile on her face, asks, \"<i>May I ask who you are?</i>\"\n\nWithout realizing what is happening yet, Amily cheerfully responds. \"<i>I'm Amily, " + player.short + "'s lover.  Who're you?</i>\" She extends her hand towards Marble.  At this moment you hear something like a low growl coming from Marble as she turns to face you, absolutely livid.  \"<i>YOU!  Why didn't you tell me about this girl?!  I trusted you!</i>\"\n\nHow do you respond?");

        // Player choices how they want to respond.
        // Stay silent (A1), pimp (B1), or explain (C1).
        MainScreen.simpleChoices(["StaySilent", "Pimp", "Explain", "", ""], [marbleIsPissyAndYourTooDumbToTalk, beAPimpMarbleLovesIt, LucyYouGotSomeSplainingToDo, null, null]);
    }

    // Stay silent like a douche
    private marbleIsPissyAndYourTooDumbToTalk() {
        DisplayText().clear();
        // Stay silent (A1)
        DisplayText("You can't think of anything to say to her at this point, and can do nothing but stare.  Marble then turns to Amily and yells, \"<i>I'm " + Desc.Gender.mf(player, "his", "her") + " lover too.  " + Desc.Gender.mf(player, "He", "She") + " didn't tell you about me, did " + Desc.Gender.mf(player, "he", "she") + "?</i>\"  Amily looks at Marble for a few moments before looking back at you with tears in her eyes.  She says, \"<i>I know what kind of world this is, but I'd think you'd at least tell me about someone like her.  Did our kids together mean nothing to you?</i>\"  At this point, Marble's hammer flies to the ready in her hands.  She practically screams, \"<i>YOU HAD KIDS TOGETHER?!?!</i>\" her hammer flying to the ready in her hands.\n\n");
    ...
    private beAPimpMarbleLovesIt() {
        DisplayText().clear();
        // Pimp (B1)
        DisplayText("You look at both of them in the eyes in turn before replying, \"<i>Come on girls, there is plenty of me to go around!</i>\"  ");
        // Can go to B2 if the PC is addicted to Marble, otherwise B3

        // Pimp -> PC is addicted (B2)
        if (player.perks.has(PerkType.MarblesMilk)) {
            DisplayText("Marble blinks before saying \"<i>" + player.short + ", try again, I know you're better than that.</i>\"  You blink in response and wonder yourself what possessed you to say that.\n\n");
            // Player chooses stay silent (A1) or explain (C1)
            MainScreen.simpleChoices(["StaySilent", "Explain", "", "", ""], [marbleIsPissyAndYourTooDumbToTalk, LucyYouGotSomeSplainingToDo, null, null, null]);
        }
        // Pimp -> PC is not addicted (B3)
            ...
            MainScreen.simpleChoices(["Serious", "Joking", "", "", ""], [srslyPimpinGuyz, jokeAboutPimpularness, null, null, null]);
        }
    }
    // Pimp -> PC is not addicted -> serious (B4)
    private srslyPimpinGuyz() {
        DisplayText().clear();
    ...
    private jokeAboutPimpularness() {
        DisplayText().clear();
        DisplayText("You assure them that you thought a joke might help them calm down.  The two of them seem to disagree with you on that sentiment, but wait for you to say something else.");
        // Player chooses stay silent (A1) or explain (C1)
        MainScreen.simpleChoices(["StaySilent", "Explain", "", "", ""], [marbleIsPissyAndYourTooDumbToTalk, LucyYouGotSomeSplainingToDo, null, null, null]);
    }

    private LucyYouGotSomeSplainingToDo() {
        DisplayText().clear();
        // Explain (C1)
        DisplayText("You spend some time trying to explain to the two of them why you never told either of them about each other.  ");
        ...
        // Explain -> fail (C3)
            ...
            if (player.perks.has(PerkType.MarblesMilk)) {
                DisplayText("Since you need Marble's milk to live, there's no way you can blame her.  It would be tantamount to suicide.");
                blameMarble = null;
            }
            // Player chooses stay silent (A1), blame Marble (C4), blame Amily (C5)
            MainScreen.simpleChoices(["StaySilent", "BlameMarble", "BlameAmily", "", ""], [marbleIsPissyAndYourTooDumbToTalk, blameMarble, blameAmilysDumbMouseCunt, null, null]);
            return;
        }
    }
    // Explain -> blame Marble
    public BlameMarblezSweetVagoozle() {
        DisplayText().clear();
        ...
        if (Flags.list[FlagEnum.MARBLE_KIDS] === 1) DisplayText("and child");
        else if (Flags.list[FlagEnum.MARBLE_KIDS] > 1) DisplayText("and her children");
        DisplayText(" before slowly walking away from the camp without looking back.  \"<i>I'm going back to the farm, I guess I'll see you around.</i>\"\n\n");
    ...
    // Explain -> blame Amily
    private blameAmilysDumbMouseCunt() {
    ...
    private amilyUrtaReaction() {
        ...
        DisplayText("Amily bounds out of camp before you can react, sniffling as she disappears into the distance. She's lost to sight almost immediately thanks to the properties of this accursed landscape.");
    ...
    public askAboutAmily() {
        ...
        if (model.time.hours > 14) {
            ...
            return { next: kGAMECLASS.telAdre.barTelAdre };
            return;
        }
        // before Urta goes on duty at 1400:
        else {
            DisplayText("You ask the assembled bar patrons if anybody has seen either a strange mouse-woman or Urta around. The sparse morning crowd points, virtually as one, toward the back rooms. As you aproach, you hear a thumping, banging commotion coming from one of the rooms...\n\n");

            DisplayText("To a mixture of confusion and relief, you realize they aren't the sounds of violence.\n\n");

            DisplayText("\"<i>Mmm... yeah, you're *burp* great at this!</i>\" you hear Urta groan, laboriously.\n\n");

            DisplayText("This is met with a chittering squeal you distinctly recognize as Amily's.  \"<i>Oooohhh... I see why " + player.short + " - yeah, gimme all you got! - fell for you!</i>\"\n\n");

            DisplayText("Curious, you ease open the door.  Inside, you see Urta and Amily, both naked, sitting on one of the cushioned couches along the wall.  Well, Urta is sitting there; Amily is perched in her lap, Urta's girthy prick visibly stuffed into her folds, with");
            if (Flags.list[FlagEnum.AMILY_WANG_LENGTH] > 0) DisplayText(" her " + amilyScene.amilyCock() + " half-erect and drooling pre and");
            DisplayText(" her stomach swollen from the fox-morph's prodigious cum output to the point she looks ");
            if (amilyScene.pregnancy.event >= 3) DisplayText("almost twice as ");
            ...
            DisplayText("Do you leave them to get acquainted (and possibly be up for threesomes in the future), or do you barge in and stop these cheating sluts?");
            // [Leave Them (finishes as normal] [Interrupt]
            MainScreen.simpleChoices(["Leave Them", "Interrupt", "", "", ""], [askAboutAmilyPt2, cheatingSloots, null, null, null]);
        }
    }

    private askAboutAmilyPt2() {
        DisplayText().clear();
        ...
        DisplayText("With a soft sigh, you shut the door and leave them to sleep it off.  While you can't predict that they will be quite so magnanimous about all this when they wake up, right now, it looks like neither of them is inclined to declare war over you.");
    ...
    private cheatingSloots() {
        ...
        DisplayText("You growl and turn to Amily, who quietly squeaks, \"<i>I thought... I thought if I knew her better *hic* I could find a way to save what we had... *burp* I am REALLLY out of it, but I thought... ya know, if I was willing to sleep with her too that we could all be happy together.</i>\"\n\n");

        DisplayText("Well, the mouse may have a point.  You could let them get to know each other and perhaps turn this into a threesome down the road, or you could put a firm end to it right now.  There's a pretty good chance putting your boot down on this might piss off one of them.");
        // [Let Them Be] [End It]
        MainScreen.simpleChoices(["Let It Be", "End It", "", "", ""], [letTheSlootsFuck, endThisMadness, null, null, null]);
    }
    private letTheSlootsFuck() {
        DisplayText().clear();
        DisplayText("You chuckle and tell them you understand, though they had better include you in the future.  Drunken relief spreads across their faces when you give them a wink and step out.  Soon you hear the sloppy sounds of sex and giggles about how great their lover is.");
        player.stats.lust += 75;
        return { next: Scenes.camp.returnToCampUseOneHour };
        Flags.list[FlagEnum.AMILY_VISITING_URTA] = 4;
    }
    private endThisMadness() {
        DisplayText().clear();
        ...
        if (randInt(2) === 0) {
            DisplayText("\"<i>" + player.short + ", I did this for you!  I loved you so much I worked to see what you liked in Urta!</i>\" cries Amily.  Her face blushes, not in shame, but in anger as her temper flares.  She actually says, \"<i>Everything, all of this, it was me wanting things to be perfect for YOU!  FOR US!  You... you... asshole!</i>\"\n\n");
            DisplayText("The mouse scurries past you and disappears into the night.  Somehow you know you won't see her again.\n\n");
        ...
        // (Chance of Urta rage)
            ...
            DisplayText("The angry vixen snatches her clothes from a peg on the wall and slides out the door, too pissed to care that she's standing naked.  \"<i>I won't be a problem for you any more.  Just stay away from me.</i>\"\n\n");
            urtaLove(-100);
        ...
        DisplayText("You shrug.  Well, that puts an end to that.");
        return { next: Scenes.camp.returnToCampUseOneHour };
    }

    // Next Morning
    public amilyUrtaMorningAfter() {
        ...
        DisplayText("\"<i>Ughhh... I'll live,</i>\" she groans, letting the last of the water run out over herself.  \"<i>Whaa...  Oh... right.  About Urta.  I'd still rather you'd told me about it, but... it's okay.</i>\"\n\n");
        ...
        MainScreen.simpleChoices(["Be Nice", "Be A Dick", "", "", ""], [smileAndNodToAmilyXUrta, beADickToAmily, null, null, null]);
    }

    // [Be totally a dick]
    private beADickToAmily() {
        DisplayText().clear();
        DisplayText("With a wicked, shit-eating grin, you tease Amily about falling into the trap she set for you.  Her expression hardens, winces breaking her frown as her hangover thrums every time you laugh.\n\n");

        DisplayText("\"<i>F-fuck you, " + player.short + ",</i>\" she finally rejoins.  \"<i>You did the same damn thing.</i>\"\n\n");

        DisplayText("You tell her that's <b>exactly</b> why you're laughing; she may act pure and monogamous, a perfect little wife, but her legs spread open just the same as every other whore's when confronted with a hard and ready cock like Urta's.\n\n");
        ...
        DisplayText("With that, Amily grabs her gear closest to hand and pushes past you with the best flounce she can manage, heading toward the desert.");
    ...
    // [Smile and nod]
    private smileAndNodToAmilyXUrta() {
        DisplayText().clear();
        ...
        DisplayText("Amily is blushing with embarrassment at that last remark.  \"<i>O-Okay... I'll remember that.  But, can I go back to sleep, please?  My head is killing me.</i>\"\n\n");

        DisplayText("You nod and leave her to sleep.");
    ...
    public amilyUrtaSex() {
        ...
        if (player.stats.cor > 50 && Flags.list[FlagEnum.AMILY_WANG_LENGTH] > 0) DisplayText("  Privately, you note that it's bullshit; she's nothing <b>but</b> self-pity.");
        DisplayText("\n\n");

        DisplayText("With a gesture, the two of you set off.  As soon as you pass through the gates, you head towards the Wet Bitch.  Sure enough, Urta is at her usual table, and she smiles in delight to see you.  \"<i>" + player.short + ", Amily, hello!</i>\"  You take seats at the same table, as she ");
        if (!urtaLove()) DisplayText("blushes softly at the clunk of her erection against the table");
        else DisplayText("turns sideways to let her dress tent without banging into the table");
        DisplayText(".\n\n");
        ...
        DisplayText("Urta's face lights up in hungry delight and she promptly gets up and hurries off to one of the backrooms.  Amily also arises, face red with shame, and quickly follows her, with you bringing up the rear.\n\n");

        DisplayText("Once the three of you are in a empty room, you lock the door behind you as Urta and Amily both strip down, eyeing each other and you with equal attention.  \"<i>So... are you going to partake?  Or just watch?</i>\" Amily asks, hesitantly.");

        // Watch (only game in town for now, so suppress the choice buttons and route right to this)
        let dick;
        let vag;
        if (player.torso.vaginas.count > 0) vag = amilyScene.urtaXAmilyCuntPussyVagSQUICK;
        if (player.torso.cocks.count > 0) dick = amilyScene.threesomeAmilUrtaCAWKS;
        MainScreen.simpleChoices(["Use Dick", "Use Vag", "", "", "Watch"], [dick, vag, null, null, amilyUrtaSexWatch]);
    }
    private amilyUrtaSexWatch() {
        DisplayText().clear();

        DisplayText("You tell the two that, this time, you're content to just watch.  You head over to one end of the couch and sit down, leaning back and waiting for them to begin.\n\n");

        DisplayText("Urta takes a deep breath, and then exhales it slowly.  \"<i>I'm not really used to doing this with an audience... but it might be fun to give it a try,</i>\" she declares.  You can see her erection isn't shrinking at the prospect.\n\n");

        DisplayText("\"<i>I'm... not sure of how we'll do this,</i>\" Amily says, hesitant despite the gathering moisture in her nether lips.\n\n");

        DisplayText("You just smile and assure them that they'll be just fine; just pretend you aren't in the room, you tell them, and do what comes naturally.\n\n");

        DisplayText("Urta rolls her eyes at the cliche advice, but turns to face Amily.  \"<i>Well, all right... come on, squeaky... I'm sure you know what fits where.</i>\"  She smiles as she says this, and gives the mouse a friendly wink.\n\n");

        DisplayText("Amily smiles back and approaches Urta, giving her a small peck on the lips and gently stroking her cock.\n\n");

        DisplayText("Urta groans, unable to resist groping Amily's " + amilyScene.amilyTits() + ".  \"<i>Let me sit down, first, squeaky; I've never been one for sex while standing up</i>\".  She slowly lowers herself to the ground and then pulls Amily down into her lap, idly grinding her mare-cock against Amily's torso");
        if (Flags.list[FlagEnum.AMILY_WANG_LENGTH] > 0) DisplayText(", up the underside of her penis,");
        DisplayText(" and between her " + amilyScene.amilyTits() + ".\n\n");

        DisplayText("Amily slides her cleavage down Urta's length to gently give her flared tip a small lick, before rising");
        if (Flags.list[FlagEnum.AMILY_WANG_LENGTH] > 0) DisplayText(", a bead of pre-cum stretching into a line connecting their two members");
        DisplayText(".  Straddling Urta and aligning the heavy horse-cock with her moist snatch, Amily teases, \"<i>Ready for this, foxy?</i>\"  Her eyes dart towards you for a split second.\n\n");

        DisplayText("You just smile gently and watch Urta, who swallows hard, tongue lolling out with anticipation before she remembers herself.  \"<i>Anytime, little mouse; if you can handle all of this.</i>\"  She's obviously trying to be bold about this - maybe your presence is unnerving her more than you thought.\n\n");
        ...
        DisplayText("Urta huffs and growls, easily getting into the spirit of things as she thrusts her long, girthy shaft into the rodent's surprisingly stretchable cunny.  Well, now you have a good idea why the demons would want to enslave her people, if she's typical of their ability to handle large insertions...\n\n");
        ...
        DisplayText("Amily squeaks and moans, her stretched pussy clamping down as she impales herself fully on  Urta's invading shaft.  Urta can't take it any more; she actually barks with joy as her apple-sized nuts visibly clench, unleashing a cumsplosion into your rodent lover's waiting womb.\n\n");
        ...
        DisplayText("With a sigh and a smile, Amily collapses on top of Urta, sated and full.  Her eyes dart towards you one more time before she cuddles the panting vixen to rest and enjoy the afterglow.\n\n");

        DisplayText("By this point, you are feeling very turned on indeed, but you can't bring yourself to disturb them.  Instead, you simply grin again and leave them to recover.");
