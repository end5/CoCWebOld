...
const conditionalOptions =
    {
        ...
        cocks: (char: Character) => char.body.cocks.count,
        breastrows: (char: Character) => char.body.chest.count,
        ...
        hasvagina: (char: Character) => char.body.vaginas.count > 0,
        ...
        hascock: (char: Character) => char.body.cocks.count > 0,
