...
export class GooArmorSilence extends CombatEffect {
    public update(character: Character) {
        const gooSilenceEffect = character.combat.effects.get(CombatEffectType.GooArmorSilence)!;
        if (gooSilenceEffect.value1 >= 2 || randInt(20) + 1 + character.stats.str / 10 >= 15) {
