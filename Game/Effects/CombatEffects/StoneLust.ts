    ...
    public update(character: Character) {
        ...
        if (selVagina) {
            ...
            if (character.stats.lust >= 70 && character.stats.lust < 85)
                CView.text("You stagger in surprise as a particularly pleasant burst of vibrations erupt from the smooth stone sphere in your " + describeVagina(character, selVagina) + ".");
