...
export class WeaponLib extends Dictionary<Weapon> {
    public constructor() {
        ...
        this.set(WeaponName.BeautifulSword, new BeautifulSword());
        this.set(WeaponName.LargeClaymore, new LargeClaymore());
        this.set(WeaponName.DragonShellShield, new DragonShellShield());
        this.set(WeaponName.EldritchStaff, new EldritchStaff());
        ...
        this.set(WeaponName.JeweledRapier, new JeweledRapier());
        this.set(WeaponName.Katana, new Katana());
        ...
        this.set(WeaponName.LargeHammer, new LargeHammer());
        ...
        this.set(WeaponName.RaphaelsRapier, new RaphaelsRapier());
        this.set(WeaponName.Spellblade, new Spellblade());
        ...
        this.set(WeaponName.WizardsStaff, new WizardsStaff());
        this.set(WeaponName.HugeWarhammer, new HugeWarhammer());
