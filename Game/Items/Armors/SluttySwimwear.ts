        ...
        if (character.body.cocks.length <= 0) {
            ...
            if (character.body.balls.count > 0) {
                if (character.body.balls.size > 5)
                    DisplayText("You do your best to put the thong on, and while the material is very stretchy, it simply can't even begin to cover everything, and your " + describeBalls(true, true, character) + " hang on the sides, exposed.  Maybe if you shrunk your male parts down a little...");
                else
