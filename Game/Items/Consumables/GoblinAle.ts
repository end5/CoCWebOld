    ...
    public use(character: Character) {
        ...
        // Shrink primary dick to no longer than 12 inches
            ...
            if (character.body.cocks.get(0).length > 12) {
                ...
                temp3 += Mod.Cock.growCock(character, character.body.cocks.get(0), (randInt(3) + 1) * -1);
        ...
        if (character.body.skin.tone !== "green" && character.body.skin.tone !== "grayish-blue" && character.body.skin.tone !== "dark green" && character.body.skin.tone !== "pale yellow" && changes < changeLimit && randInt(2) === 0) {
            ...
            if (character.body.skin.type === SkinType.FUR) DisplayText("skin");
            else DisplayText(character.body.skin.desc);
            DisplayText(" turned " + character.body.skin.tone + ".  No way!  It's staying, it really changed color!");
        }
        // Face!
