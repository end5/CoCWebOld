...
export class MinotaurCum extends Consumable {
    ...
    public use(character: Character) {
        ...
        if (MinotaurCumFlags.MINOTAUR_CUM_ADDICTION_STATE === 0) DisplayText("potent musk washes over you.");
        else DisplayText("heavenly scent fills your nostrils.");
        if (MinotaurCumFlags.MINOTAUR_CUM_ADDICTION_TRACKER < 50) DisplayText("  It makes you feel dizzy, ditzy, and placid.");
        ...
        if (character.body.vaginas.length > 0) {
            ...
            if (vagina.wetness <= VaginaWetness.NORMAL) DisplayText("  Wetness builds inside you as your " + describeVagina(character, vagina) + " tingles and aches to be filled.");
            else if (vagina.wetness <= VaginaWetness.SLICK) DisplayText("  A trickle of wetness escapes your " + describeVagina(character, vagina) + " as your body reacts to the desire burning inside you.");
