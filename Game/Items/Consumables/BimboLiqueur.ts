    ...
    public use(character: Character) {
        if (character.perks.has(PerkType.BroBody)) {
            ...
            if (character.body.hair.color !== "platinum blonde") {
                DisplayText("The first change that you notice is to your " + describeHair(character) + ".  It starts with a tingling in your scalp and intensifies ");
                ...
                DisplayText("  You grab a lock of the silken strands and watch open-mouthed while streaks so blonde they're almost white flow down the " + character.body.hair.color + " hair.  It goes faster and faster until your hair has changed into perfectly bimbo-blonde, flowing locks.\n\n");
            ...
            if (character.body.vaginas.count <= 0) {
                ...
                if (character.body.legs.isTaur()) DisplayText("Wait!? Wet? You wish you could touch yourself between the " + describeLegs(character) + ", but you can tell from the fluid running down your hind-legs just how soaked your new vagina is.");
                else DisplayText("Wait!?  Wet?  You touch yourself between the " + describeLegs(character) + " and groan when your fingers sink into a sloppy, wet cunt.");
            }
            else {
            ...
            DisplayText("You sigh and run one hand over your " + describeNipple(character, character.body.chest.get(0)) + "s");
            ...
            if (character.body.clit.length >= 3) DisplayText("jerk ");
            else DisplayText("caress ");
            DisplayText("that makes your " + describeLegs(character) + " give out as you cum, splattering female fluids as you convulse nervelessly on the ground.\n\n");
