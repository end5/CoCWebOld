        ...
        if (monster.body.vaginas.count > 0) {
            ...
            if (monster.desc.plural) {
                if (monster.stats.lust >= 60 && firstVagina.wetness === VaginaWetness.NORMAL)
                    DisplayText(monster.desc.capitalA + monster.desc.short + "'s " + describeVagina(character, character.body.vaginas.get(0)) + "s dampen perceptibly.  ");
                ...
                if (monster.stats.lust >= 60 && firstVagina.wetness === VaginaWetness.SLICK)
                    DisplayText(monster.desc.capitalA + monster.desc.short + "'s " + describeVagina(character, character.body.vaginas.get(0)) + "s become sloppy and wet.  ");
                ...
                if (monster.stats.lust >= 60 && firstVagina.wetness === VaginaWetness.SLAVERING)
                    DisplayText(monster.desc.capitalA + monster.desc.short + "'s " + describeVagina(character, character.body.vaginas.get(0)) + "s instantly soak " + monster.desc.objectivePronoun + " groin.  ");
            }
            else {
                if (monster.stats.lust >= 60 && firstVagina.wetness === VaginaWetness.NORMAL)
                    DisplayText(monster.desc.capitalA + monster.desc.short + "'s " + describeVagina(character, character.body.vaginas.get(0)) + " dampens perceptibly.  ");
                if (monster.stats.lust >= 60 && firstVagina.wetness === VaginaWetness.WET)
                    DisplayText(monster.desc.capitalA + monster.desc.short + "'s crotch becomes sticky with girl-lust.  ");
                if (monster.stats.lust >= 60 && firstVagina.wetness === VaginaWetness.SLICK)
                    DisplayText(monster.desc.capitalA + monster.desc.short + "'s " + describeVagina(character, character.body.vaginas.get(0)) + " becomes sloppy and wet.  ");
                if (monster.stats.lust >= 60 && firstVagina.wetness === VaginaWetness.DROOLING)
                    DisplayText("Thick runners of girl-lube stream down the insides of " + monster.desc.a + monster.desc.short + "'s thighs.  ");
                if (monster.stats.lust >= 60 && firstVagina.wetness === VaginaWetness.SLAVERING)
                    DisplayText(monster.desc.capitalA + monster.desc.short + "'s " + describeVagina(character, character.body.vaginas.get(0)) + " instantly soaks her groin.  ");
            }
        }
        DisplayText("\n\n");
    }
