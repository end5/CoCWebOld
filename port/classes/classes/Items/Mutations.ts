    ...
    /* Now handled by OvipositionElixir.as
            public ovipositionElixer(player:Player):void
            {
                ...
                if (changes == 0 && player.pregnancyIncubation > 20 && player.pregnancyType != PregnancyStore.PREGNANCY_BUNNY) {
                    ...
                    var newIncubation: number = player.pregnancyIncubation - Math.floor(player.pregnancyIncubation * .3 + 10);
    ...
    /*
            ...
            private reductoButt():void {
                ...
                if (player.buttRating >= 15) {
                    player.buttRating -= (3 + Math.floor(player.buttRating / 3));
            ...
            private reductoClit():void {
                ...
                player.clitLength = Math.floor(player.clitLength * 100) / 100;
            ...
            private reductoHips():void {
                ...
                if (player.hipRating >= 15) {
                    player.hipRating -= (3 + Math.floor(player.hipRating / 3));
