...
//Naga on Bee Scene
		...
		private nagaRapesPt2TheExtremeContinuationOfAwesome():void
		{
			...
			if (player.gender == 1 || (player.gender == 3 && rand(3) == 0)) {
				...
				outputText("even when she takes your " + cockDescript(0) + " to the hilt, her eyes straining up in their sockets. You watch " + Math.floor(player.cocks[0].cockLength) + " inches of " + cockDescript(0) + " disappear inside her mouth, and the vibrations in her throat tell you that you'd hear her cooing if it wasn't packed tight.\n\n", false);
