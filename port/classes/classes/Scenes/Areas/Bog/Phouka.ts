 ...
 */
	export class Phouka extends Monster
	{
		...
		override public handleAwardItemText(itype:ItemType):void
		{
		...
		override public handleAwardText():void
		{
			//Talk about gems and XP when the player looks in the hollow of the tree instead of here
		}
		
		override public handleCombatLossText(inDungeon: boolean, gemsLost: number): number
		{
			if (player.gems > 1)
