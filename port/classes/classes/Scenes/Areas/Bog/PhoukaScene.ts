 ...
 */
	export class PhoukaScene extends BaseContent implements TimeAwareInterface {
		...
		internal static phoukaForm: number = 0; //This keeps track of the form of the phouka across different scenes and through combat
		internal static PHOUKA_FORM_FAERIE: number = 0;
		internal static PHOUKA_FORM_BUNNY: number = 1;
		internal static PHOUKA_FORM_GOAT: number = 2;
		internal static PHOUKA_FORM_HORSE: number = 3;
		...
		protected function phoukaSexFaerieFemale(postCombat: boolean):void
		{
			...
			if (player.biggestCockLength() < 8)
				outputText("You push the last inch of your " + Math.floor(player.biggestCockLength()) + " prick into the moaning slut.");
			else if (player.biggestCockLength() < 15)
				outputText("You feed the last inch of your " + Math.floor(player.biggestCockLength()) + " cock into her.  Your cockhead bumps against her cervix and the slut beneath you begs for more.");
			else {
