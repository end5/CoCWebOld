	...
	export class LivingStatue extends Monster
	{
		...
		private overhandSmash():void
		{
			...
			var damage: number = 175 + Math.floor((str + weaponAttack) - rand(player.tou) - player.armorDef);
...
//				player.weapon.unequip(player,false,true);
		...
		private cycloneStrike():void
		{
			...
			var damage: number = (175 + Math.floor((str + weaponAttack) - rand(player.tou) - player.armorDef)) / (rand(3) + 2);
			//Avoid
