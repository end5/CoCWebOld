...
override public bimboSophie(): boolean {
...
private acceptBimboSophie():void {
	...
	if (pregnancy.isPregnant) pregnancy.knockUpForce(pregnancy.type, Math.floor(pregnancy.incubation * 1.75));
