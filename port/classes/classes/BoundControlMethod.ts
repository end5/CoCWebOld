...
export class BoundControlMethod {
     ...
     */
    public constructor(func: Function, name: string, desc: string, index: number, primaryKey: number = -1, secondaryKey: number = -1) {
    ...
    public ExecFunc(...args): void {
        this._funcToCall.apply(null, args);
    }
