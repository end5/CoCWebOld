    ...
    public useText(): void { //Produces any text seen when equipping the armor normally
        ...
        if (this.game.player.totalCocks() == 0) {
            ...
            if (this.game.player.balls > 0) {
                if (this.game.player.ballSize > 5) outputText("You do your best to put the thong on, and while the material is very stretchy, it simply can't even begin to cover everything, and your " + this.game.player.ballsDescriptLight() + " hang on the sides, exposed.  Maybe if you shrunk your male parts down a little...");
            ...
            if (this.game.player.totalCocks() == 1) {
                outputText("You grunt in discomfort, your " + this.game.player.cockDescript(0) + " flopping free from the thong's confines. The tight material rubbing against your dick does manage to turn you on slightly.  ");
            }
            else {
                outputText("You grunt in discomfort, your " + this.game.player.multiCockDescriptLight() + " flopping free from the thong's confines. The tight material rubbing against your dicks does manage to turn you on slightly.  ");
            }
            this.game.dynStats("lus", 5);
            if (this.game.player.biggestCockArea() >= 20) outputText("You do your best to put the thong on, and while the material is very stretchy, it simply can't even begin to cover everything, and your " + this.game.player.cockDescript(this.game.player.biggestCockIndex()) + " has popped out of the top, completely exposed.  Maybe if you shrunk your male parts down a little...");
            //[If dick is 7+ inches OR balls are apple-sized]
            else if (this.game.player.ballSize > 5) outputText("You do your best to put the thong on, and while the material is very stretchy, it simply can't even begin to cover everything, and your " + this.game.player.ballsDescriptLight() + " hang on the sides, exposed.  Maybe if you shrunk your male parts down a little...");
        }
        outputText("\n\n");
    }
