...
//Tamani's Daughters – Tracked every birthing.  High cum production characters will produce more //Tamani babies and thus grow the mob (and achieve bad-end) faster.  
	...
	//Tamani's Daughters gets nigh-impossible @ #60
		...
		internal static tamaniPresent: boolean = false; //Used to communicate between this class and TamanisDaughters.as
...
public encounterTamanisDaughters():void {
	...
	if(flags[kFLAGS.TIMES_ENCOUNTED_TAMANIS_DAUGHTERS] > 0 && rand(10) == 0) {
		tamaniPresent = true;
		outputText("While roaming along, you find your path ahead blocked by " + num2Text(Math.floor(flags[kFLAGS.TAMANI_NUMBER_OF_DAUGHTERS] / 4)) + " goblins.  At the forefront of the mob is Tamani", false);
	...
	outputText(num2Text(Math.floor(flags[kFLAGS.TAMANI_NUMBER_OF_DAUGHTERS] / 4)) + " goblins.  You ", false);
...
private fuckYoDaughtersHomie():void {
	...
	var daughters: number = Math.floor(flags[kFLAGS.TAMANI_NUMBER_OF_DAUGHTERS] / 2);
