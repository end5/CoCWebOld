 ...
 */
	export class Inventory extends BaseContent {
		private static inventorySlotName:Array = ["first", "second", "third", "fourth", "fifth"];
		
		private itemStorage:Array;
		private gearStorage:Array;
		private callNext:Function;		//These are used so that we know what has to happen once the player finishes with an item
		private callOnAbandon:Function;	//They simplify dealing with items that have a sub menu. Set in inventoryMenu and in takeItem
