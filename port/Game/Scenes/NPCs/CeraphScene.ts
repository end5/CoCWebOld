...
//(REQ's – HUGE WANG, Exgartuan or Jojo corruption, and !centaur)
		private hugeCorruptionForceFuckCeraph():void
		{
			...
			if (player.cocks[x].cockLength < 68) outputText(num2Text(Math.floor(player.cocks[x].cockLength / 12)), false);
