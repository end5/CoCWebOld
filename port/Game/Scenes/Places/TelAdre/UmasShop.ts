	...
	public static MAX_MASSAGE_BONUS_DURATION: number = 24;			// Duration of the bonus
		 ...
		 * ie. it makes future balancing of the perks more of a chore. Rather, other code can just reference the statics we have here using UmasShop.NEEDLEWORK_MAGIC_blah. It's still bad, but its an shader of bad lighter so fuck it!
