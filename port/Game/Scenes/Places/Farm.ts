...
public getMilked():void {
	...
	if(player.findStatusAffect(StatusAffects.BreastsMilked) < 0 || application == 0) {
		...
		outputText("There is a mechanical lurching noise as the suction builds rapidly.  Your nipple swells out to " + Math.floor(player.nippleLength*1.5*10)/10 + " inches of length, turning purplish from the strain.   You can feel something welling up inside your " + allBreastsDescript() + ", building as it moves towards your " + nippleDescript(0) + "s.\n\n", false);
	}
	...
	liters = Math.floor(player.lactationQ()* (rand(10) + 90) / 100)/1000;
