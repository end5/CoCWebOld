...
export class Parser {
    ...
    */
    ...
    public parserState: Object = new Object();
    ...
    private convertDoubleArg(inputArg: string): string {
        ...
        var argTemp: Array<any> = inputArg.split(" ");
        if (argTemp.length != 2) {
    ...
    private parseConditional(textCtnt: string, depth: number): string {
        ...
        var ret: Array<any> = new Array("", "", "");	// first string is conditional, second string is the output
    ...
    private parseButtonTag(textCtnt: string): void {
        ...
        var arr: Array<any> = textCtnt.split("|")
        if (arr.len > 2) {
