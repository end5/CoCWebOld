...
export class PregnancyStore {
    ...
    //Old Value, replaced in Saves.unFuckSave()		public static PREGNANCY_BUTT_BEE: number              =   2;
    //Old Value, replaced in Saves.unFuckSave()		public static PREGNANCY_BUTT_DRIDER: number           =   3;
    //Old Value, replaced in Saves.unFuckSave()		public static PREGNANCY_BUTT_SANDTRAP_FERTILE: number =   4;
    //Old Value, replaced in Saves.unFuckSave()		public static PREGNANCY_BUTT_SANDTRAP: number         =   5; //Sandtrap did not have fertilized eggs
    ...
    private _pregnancyEventValue: Array<Array<number>>; //Using a vector of vectors so that each different pregnancy type can have its own set of events
    private _buttPregnancyEventValue: Array<Array<number>>;
    ...
    public constructor(pregType: number, pregInc: number, buttPregType: number, buttPregInc: number) {
        ...
        this._pregnancyEventValue = new Array<Array<number>>();
        this._buttPregnancyEventValue = new Array<Array<number>>();
    ...
    public addPregnancyEventSet(pregType: number, ...pregStage): void {
        var pregVector: Array<number> = new Array<number>(pregStage.length + 2);
    ...
    public addButtPregnancyEventSet(buttPregType: number, ...buttPregStage): void {
        var pregVector: Array<number> = new Array<number>(buttPregStage.length + 1);
    ...
    public get event(): number {
        ...
        var pregEventVector: Array<number> = null;
