...
import { dynStats } from '../../includes/engineCore';
...
export class PlayerEvents extends BaseContent implements TimeAwareInterface {
    ...
    public timeChange(): boolean {
        ...
        if (this.player.findStatusAffect(StatusAffects.Luststick) >= 0) { //Luststic countdown
            ...
            if (rand(2) == 0 && this.player.hasCock()) { //50% chance to lust spike
        ...
        if (this.player.findPerk(PerkLib.Oviposition) >= 0 || this.player.findPerk(PerkLib.BunnyEggs) >= 0) { //Oviposition perk for lizard and bunny folks
            if ((this.player.nagaScore() + this.player.lizardScore() < 3) && this.player.findPerk(PerkLib.Oviposition) >= 0 && this.player.findPerk(PerkLib.BasiliskWomb) < 0) { //--Lose Oviposition perk if lizard score gets below 3.
                ...
                if ((this.player.totalFertility() > 50 && this.getGame().model.time.days % 15 == 0) || this.getGame().model.time.days % 30 == 0) { //every 15 days if high fertility get egg preg
                    ...
                    this.player.createStatusAffect(StatusAffects.Eggs, rand(6), rand(2), (5 + rand(3)), 0); //v1 is type, v2 is size (1 == large) and v3 is quantity
        ...
        if (this.player.findStatusAffect(StatusAffects.LustyTongue) >= 0) { //Lusty Tongue Check!
            if (rand(5) == 0) {
                ...
                this.getGame().dynStats("lus", 2 + rand(15));
        ...
        if (this.getGame().model.time.hours == 6 && this.player.armorName == "bimbo skirt" && rand(10) == 0) {
        ...
        if (this.getGame().model.time.hours > 23) { //Once per day
            ...
            if (this.flags[kFLAGS.RUBI_PROSTITUTION] > 0) this.flags[kFLAGS.RUBI_PROFIT] += 2 + rand(4);
    ...
    public timeChangeLarge(): boolean {
        if (rand(4) == 0 && this.getGame().isHolidays() && this.player.gender > 0 && this.getGame().model.time.hours == 6 && this.flags[kFLAGS.XMAS_CHICKEN_YEAR] < this.getGame().date.fullYear) {
        ...
        if (this.checkedTurkey++ == 0 && (rand(5) == 0 && (this.getGame().model.time.hours == 18 || this.getGame().model.time.hours == 19)) && (this.getGame().date.fullYear > this.flags[kFLAGS.TURKEY_FUCK_YEAR_DONE] || this.flags[kFLAGS.MORE_TURKEY] > 0) && this.getGame().isThanksgiving() && this.player.gender > 0) {
        ...
        if (this.checkedDream++ == 0 && this.getGame().model.time.hours == 3) { //You can only have one dream each night
            ...
            if (this.player.hasCock() && this.player.findPerk(PerkLib.BeeOvipositor) >= 0 && (this.player.eggs() >= 20 && rand(6) == 0)) { //Bee dreams proc
            ...
            if (this.player.hasCock() && this.player.findPerk(PerkLib.SpiderOvipositor) >= 0 && (this.player.eggs() >= 20 && rand(6) == 0)) { //Drider dreams proc
