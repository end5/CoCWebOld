...
export class Kiss implements CombatAction {
    ...
    public use(player: Player, monster: Character) {
        ...
        switch (randInt(6)) {
            case 1:
                // Attack text 1:
                DisplayText("You hop up to " + monster.desc.a + monster.desc.short + " and attempt to plant a kiss on " + monster.desc.possessivePronoun + ".");
                break;
            // Attack text 2:
            case 2:
                DisplayText("You saunter up and dart forward, puckering your golden lips into a perfect kiss.");
                break;
            // Attack text 3:
            case 3:
                DisplayText("Swaying sensually, you wiggle up to " + monster.desc.a + monster.desc.short + " and attempt to plant a nice wet kiss on " + monster.desc.objectivePronoun + ".");
                break;
            // Attack text 4:
            case 4:
                DisplayText("Lunging forward, you fly through the air at " + monster.desc.a + monster.desc.short + " with your lips puckered and ready to smear drugs all over " + monster.desc.objectivePronoun + ".");
                break;
            // Attack text 5:
            case 5:
                DisplayText("You lean over, your lips swollen with lust, wet with your wanting slobber as you close in on " + monster.desc.a + monster.desc.short + ".");
                break;
            // Attack text 6:
            default:
                DisplayText("Pursing your drug-laced lips, you close on " + monster.desc.a + monster.desc.short + " and try to plant a nice, wet kiss on " + monster.desc.objectivePronoun + ".");
                break;
        }
        // Dodged!
            ...
            switch (randInt(3)) {
                ...
                case 1:
                    if (monster.desc.plural)
                        DisplayText("  " + monster.desc.capitalA + monster.desc.short + " sees it coming and moves out of the way in the nick of time!\n\n");
                    break;
                // Dodge 2:
                case 2:
                    if (monster.desc.plural) DisplayText("  Unfortunately, you're too slow, and " + monster.desc.a + monster.desc.short + " slips out of the way before you can lay a wet one on one of them.\n\n");
                    else DisplayText("  Unfortunately, you're too slow, and " + monster.desc.a + monster.desc.short + " slips out of the way before you can lay a wet one on " + monster.desc.objectivePronoun + ".\n\n");
                    break;
                // Dodge 3:
                default:
                    if (monster.desc.plural) DisplayText("  Sadly, " + monster.desc.a + monster.desc.short + " moves aside, denying you the chance to give one of them a smooch.\n\n");
                    else DisplayText("  Sadly, " + monster.desc.a + monster.desc.short + " moves aside, denying you the chance to give " + monster.desc.objectivePronoun + " a smooch.\n\n");
                    break;
            }
            return;
        }
        ...
        switch (randInt(4)) {
            ...
            // Success 2:
            case 2:
                if (monster.desc.plural) DisplayText("  Gold-gilt lips press into one of their mouths, the victim's lips melding with yours.  You take your time with your suddenly cooperative captive and make sure to cover every bit of their mouth with your lipstick before you let them go.\n\n");
                else DisplayText("  Gold-gilt lips press into " + monster.desc.a + monster.desc.short + ", " + monster.desc.possessivePronoun + " mouth melding with yours.  You take your time with your suddenly cooperative captive and make sure to cover every inch of " + monster.desc.possessivePronoun + " with your lipstick before you let " + monster.desc.objectivePronoun + " go.\n\n");
                damage = 20;
                break;
            // CRITICAL SUCCESS (3)
            case 3:
            ...
            // Success 4:
            default:
                DisplayText("  With great effort, you slip through an opening and compress their lips against your own, lust seeping through the oral embrace along with a heavy dose of drugs.\n\n");
                damage = 12;
                break;
        }
