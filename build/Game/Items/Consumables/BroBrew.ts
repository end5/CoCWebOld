    ...
    public use(character: Character) {
        ...
        if (character.torso.chest.count > 0) {
            ...
            if (topBreastRow.rating >= 1) {
                DisplayText("A tingle starts in your " + Desc.Breast.describeNipple(character, topBreastRow) + "s before the tight buds grow warm, hot even.  ");
                ...
                DisplayText("They pinch in towards your core, shrinking along with your flattening " + Desc.Breast.describeAllBreasts(character) + ".  You shudder and flex in response.  Your chest isn't just shrinking, it's reforming, sculping itself into a massive pair of chiseled pecs.  ");
        ...
        DisplayText(".  The strange, muscle-building changes flow down your " + Desc.Leg.describeLegs(character) + ", making them just as fit and strong as the rest of you.  You curl your arm and kiss your massive, flexing bicep.  You're awesome!\n\n");
        ...
        if (character.torso.cocks.count > 0) {
            ...
            if (cock.length < 10) {
                DisplayText("As if on cue, the familiar tingling gathers in your groin, and you dimly remember you have one muscle left to enlarge.  If only you had the intelligence left to realize that your penis is not a muscle.  In any event, your " + Desc.Cock.describeCock(character, cock) + " swells in size, ");
            ...
            if (character.torso.balls.quantity > 0) {
                DisplayText("Churning audibly, your " + Desc.Balls.describeSack(character) + " sways, but doesn't show any outward sign of change.  Oh well, it's probably just like, getting more endurance or something.");
            }
            else {
                DisplayText("Two rounded orbs drop down below, filling out a new, fleshy sac above your " + Desc.Leg.describeLegs(character) + ".  Sweet!  You can probably cum buckets with balls like these.");
                character.torso.balls.quantity = 2;
                character.torso.balls.size = 3;
            }
            DisplayText("\n\n");
