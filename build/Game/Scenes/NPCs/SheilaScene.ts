export class SheilaScene extends NPCAwareContent implements TimeAwareInterface {
	...
	private sheilaForcedOralGeneric() {
		...
		if (player.torso.head.face.tongueType > TongueType.HUMAN) fatigue(15);
	...
	private sheilaGoesDemon() {
		...
		if (player.torso.head.face.tongueType > TongueType.HUMAN) DisplayText("extending your oral muscle until it's all the way to the back of her pussy.  ");
