export class LatexGirl extends NPCAwareContent {
	...
	*/
	...
	public meanGooGirlRecruitment(): void {
		...
		Flags.list[FlagEnum.GOO_EYES] = monster.skin.tone;
		...
		DisplayText("You approach the horny gel-girl, admiring the marvelous, refractive hue of her soluble body for the last time.  Pulling the black egg from your pouches, you ");
		if (player.stats.spe > 60) DisplayText("idly spin it on your finger, tossing it into the air and catching it on the next as you advance");
		else DisplayText("firmly grasp it in your hand as you approach");
		...
		//{Strong:}
			...
			if (player.stats.tou < 40) {
				DisplayText("Halfway there, you get too tired to continue.  You may be strong, but you don't have the endurance to heft a burden like this long term.  You'll have to leave her for now and try to recapture her once she's conscious.");
				return { next: Scenes.camp.returnToCampUseOneHour };
				fatigue(30);
				return;
			}
			DisplayText("You're out of breath when you get to camp, but you made it!  It'll take awhile for you to catch your wind after all that work...  Your arms and legs are still burning from the exertion!");
	...
	private PCCarriedGooBackHome(): void {
		...
		if (player.stats.cor < 33) DisplayText("that you'll be a nice [master].  She'll never be in want for the fluids she needs, and so long as she obeys you, you'll see to her other needs.");
		else if (player.stats.cor < 66) DisplayText("that you'll be a good [master] for her.  You'll keep her healthy and satisfied, so long as she's obedient.");
		else DisplayText("that so long as she obeys you, she has nothing to fear.  She had better obey.");
	...
	private nameZeLatexGoo(): void {
		...
		DisplayText().clear();
		DisplayText("\"<i>");
		if (Flags.list[FlagEnum.GOO_NAME] === "Cattleya") DisplayText("Cattleya, huh?  I don't know if my tits are big enough to live up to that name,");
		else if (Flags.list[FlagEnum.GOO_NAME] === "Helia") DisplayText("Helia, huh?  I don't know if I like anal enough for that!");
		else if (Flags.list[FlagEnum.GOO_NAME] === "Urta") DisplayText("Urta, huh?  What do you take me for, a furry?  I guess it will have to do,");
		else if (Flags.list[FlagEnum.GOO_NAME] === "Tifa") DisplayText("Tifa, huh?  I like the sound of that one!");
		else if (Flags.list[FlagEnum.GOO_NAME] === "Aeris") DisplayText("Aeris, huh?  That sounds like a name for a hoity-toity pain in the ass!");
		else if (Flags.list[FlagEnum.GOO_NAME] === "Latexy") DisplayText("Latexy, huh? That's, uh... real original...");
		else if (Flags.list[FlagEnum.GOO_NAME] === "Goo") DisplayText("Goo, huh?  Wow, not too bright, are you?  Still, I guess I can live with it.  Call me Goo, I guess,");
		else if (Flags.list[FlagEnum.GOO_NAME] === "Blacky") DisplayText("Blacky, huh?  Do I look like a horse or something?  I guess it will have to do,");
		else if (Flags.list[FlagEnum.GOO_NAME] === "Fetish") DisplayText("Fetish, huh?  You're pretty transparent about your motives, aren't you?");
		else if (Flags.list[FlagEnum.GOO_NAME] === "Fenoxo") DisplayText("Fenoxo?</i>\"  Her hair slowly morphs into a fedora.  \"<i>I'm not sure this is quite my look, but it's a lovely name,");
		else if (Flags.list[FlagEnum.GOO_NAME] === "Maria") DisplayText("Maria?  Fuck, this isn't Cursed!  You don't expect me to turn you into a woman, do you?");
		else if (Flags.list[FlagEnum.GOO_NAME] === "Valeria") DisplayText("Valeria? Wait, I've heard that name before...");
		else if (Flags.list[FlagEnum.GOO_NAME] === "Christmas") DisplayText("Christmas, huh?  How very festive.  The big difference is that I can come more than once a year.");
		else if (Flags.list[FlagEnum.GOO_NAME] === "Symphonie") DisplayText("Symphonie, eh?  That seems very... fitting.  Snug and comfortable, somehow,");
		else if (Flags.list[FlagEnum.GOO_NAME] === "Savin") DisplayText("Savin, huh? Why would you want to name me after the second worst person since Stalin?");
		else if (Flags.list[FlagEnum.GOO_NAME] === "Galatea") DisplayText("Galatea?  By Oblimo, that's a beautiful name!");
		else if (Flags.list[FlagEnum.GOO_NAME] === "Kara") DisplayText("Kara, huh? Like, that sounds like a name for a girl with big gropable boobs in a French maid outfit!  I, like, totally love it!");
		else if (Flags.list[FlagEnum.GOO_NAME] === "Karazelle") DisplayText("Karazelle, huh? Like, that sounds like a name for a girl with big gropable boobs in a French maid outfit!  I, like, totally love it!");
		else if (Flags.list[FlagEnum.GOO_NAME] === "Jacques") DisplayText("Jacques?  That's kind of a boy's name isn't it?  ...Did my boobs just get bigger?");
		else if (Flags.list[FlagEnum.GOO_NAME] === "Whitney") DisplayText("Whitney?  The farm-girl?  Well, I suppose I can fill in for that frigid cunt.");
		else if (Flags.list[FlagEnum.GOO_NAME] === "Hedrah") DisplayText("Hedrah?  A nice strong name.  I approve,");
		else if (Flags.list[FlagEnum.GOO_NAME] === "Third") DisplayText("Third, huh?  Do I speak with a silly accent and miss headshots all day long?  Well, I suppose it will work,");
		else if (Flags.list[FlagEnum.GOO_NAME] === "Luckster") DisplayText("Luckster, huh?  Strange, I don't feel that Lucky.  Are there any cow-girls about?");
		else DisplayText(Flags.list[FlagEnum.GOO_NAME] + ", huh?  I can live with that, I suppose,");
		DisplayText("</i>\" she muses, her mood brightening.  A storm cloud blows across her brow, darkening her gaze.  Petulantly, she asks, \"<i>Well, what now, [Master]?  What are the rules?</i>\"  Her voice carries an unhappy undercurrent that makes it clear she already resents her situation a little bit.");
		DisplayText("\n\nYou take her by the chin, tilting her head up to look at you.  ");
		if (player.stats.cor < 50) DisplayText("Patiently");
		else DisplayText("Impatiently");
		DisplayText(", you explain that she is not to leave the camp.  The furthest she should go is to the stream, if she needs moisture.");
		...
		if (player.gender === Gender.NONE) DisplayText(", so please grow some genitals");
		DisplayText("!  Just every now and again...  It'll be pretty apparent when I'm hurting for food...  Take care of me, please?</i>\"");
	...
	private niceGuysTakeLatexHome(): void {
		...
		//{Strong:}
			...
			DisplayText("You heave her up over your shoulder, straining your capable muscles to hold up those giant mammaries and remain upright.  The task is arduous, but you're strong enough for anything!  ");
			if (player.stats.tou < 40) {
				DisplayText("Halfway there, you get too tired to continue.  You may be strong, but you don't have the endurance to heft a burden like this long term.  You'll have to leave her for now and try to find her once she's conscious.");
				fatigue(30);
				return { next: Scenes.camp.returnToCampUseOneHour };
				return;
			}
		...
		//{Too weak and dumb:}
			...
			DisplayText("You try to lift her, but she's too heavy!  Drat!  There's no way you'll get her back to camp like this, and you can't leave the portal undefended long enough to wait for her to wake.  You'll have to leave her for now and try finding her again once she's awake.");
			return { next: Scenes.camp.returnToCampUseOneHour };
			return;
		}
	...
	private niceGuysKeepTheirGooGals(): void {
		...
		if (player.gender === Gender.NONE) DisplayText(", so you had better grow some genitals");
		DisplayText(".  Just every now and again, though - and I promise I'll make it feel good for you, too!  I'll try and let you know when I get... hungry... but keep an eye out for me, all right?  I'm not entirely used to this new metabolism yet..</i>\"");
		DisplayText("\n\nYou nod and tell her to get settled, you'll be back to check up on her shortly.");
		DisplayText("\n\n<b>(" + Flags.list[FlagEnum.GOO_NAME] + " has been added to the slaves tab!)</b>");
		Flags.list[FlagEnum.GOO_SLAVE_RECRUITED] = 1;
	...
	public approachLatexy(): void {
		...
		//(Sub 10)
		if (gooHappiness() < 10) DisplayText(Flags.list[FlagEnum.GOO_NAME] + " scowls up at your approach, her unhappiness clearly visible in her " + Flags.list[FlagEnum.GOO_EYES] + " eyes.  You doubt her solid onyx face could be any more morose.");
		//(Sub 20)
		else if (gooHappiness() < 20) DisplayText(Flags.list[FlagEnum.GOO_NAME] + " glares at you as you approach, clearly unhappy with the situation.  She looks like she's having a pretty terrible time.");
		//(Sub 30) 
		else if (gooHappiness() < 30) DisplayText(Flags.list[FlagEnum.GOO_NAME] + " frowns at you as you approach, more than a little displeased to see you.  She doesn't seem to be having a very good time.");
		//(Sub 40) 
		else if (gooHappiness() < 40) DisplayText(Flags.list[FlagEnum.GOO_NAME] + " knits her eyebrows in consternation at your approach, visibly less than happy.  It doesn't look like she's thrilled to be here.");
		//(Sub 50)
		else if (gooHappiness() < 50) DisplayText(Flags.list[FlagEnum.GOO_NAME] + " glances up at you when you approach, visibly bored.  She looks like she needs some cheering up.");
		//(Sub 60)
		else if (gooHappiness() < 60) DisplayText(Flags.list[FlagEnum.GOO_NAME] + " gives you a wan smile as you approach, looking a tad bored.  Still, the glitter in her eyes tells you that she's still a good ways from unhappy.");
		//(Sub 70)
		else if (gooHappiness() < 70) DisplayText(Flags.list[FlagEnum.GOO_NAME] + " cracks a small grin at the sight of you, happy to see you.  It's good to see her having a positive outlook.");
		//(Sub 80) 
		else if (gooHappiness() < 80) DisplayText(Flags.list[FlagEnum.GOO_NAME] + " openly smiles at you as you approach, in good spirits, it seems.  Her sensual, fetishy skin reflects the light as she smiles, looking truly beautiful.");
		//(Sub 90) 
		else if (gooHappiness() < 90) DisplayText(Flags.list[FlagEnum.GOO_NAME] + " grins at you, revealing rows of glittering black teeth.  She playfully regards you with happy, " + Flags.list[FlagEnum.GOO_EYES] + " eyes.");
		//(Sub 100)
		else if (gooHappiness() < 100) DisplayText(Flags.list[FlagEnum.GOO_NAME] + " bounces up at your approach, mouth splitting into a wide smile.  Her glittering, " + Flags.list[FlagEnum.GOO_EYES] + " eyes twinkle with genuine pleasure.");
		//(MAX) 
		else DisplayText(Flags.list[FlagEnum.GOO_NAME] + " jumps up on her feet at your approach, gleefully clapping her hands as you close in on her.  Her " + Flags.list[FlagEnum.GOO_EYES] + " eyes and ecstatic visage make it clear how unbelievably happy she is.");
		//Second Line - Tit Size
		DisplayText("  ");
		//{Giant-Sized Titties}
		if (gooTitSize() >= 35) DisplayText("Utterly filled with moisture, her " + gooTits() + " are so big her arms can barely encompass them, her hands pressing fruitlessly against the sloshing sides.  The bubbly black surface bulges obscenely, barely containing the liquid weight within.");
		//{Very Big-Sized Titties}
		else if (gooTitSize() >= 24) DisplayText("Wobbling like crazy, her incredible chest barely stays bound up in her hands.  It completely obscures her torso from view.  Eventually, she gives up on restraining them and lets them slosh free.  You can't help but admire the flawless curves as you ponder how she can possibly remain upright.");
		//{Pretty nice sized} 
		else if (gooTitSize() >= 15) DisplayText("Big enough to hide most of her torso, the " + gooTits() + " sway and bounce ponderously.  Light reflects off the shiny, hypnotizing surface of her chest as she supports it with her hands.");
		//{Big SizedVolley}
		else if (gooTitSize() > 4) DisplayText("Well-rounded and jiggly, her " + gooTits() + " ripples slightly as she moves.  Those well-rounded spheres seem soft and firm at the same time.");
		//{LargeDD} 
		else if (gooTitSize() > 3) DisplayText("Sitting high on her chest, a proud pair of " + gooTits() + " jiggle slightly with her every movement.  They're still nice and round, but nowhere near the mammoths she had before.");
		//{MediumC} 
		else if (gooTitSize() > 2) DisplayText("High and curvy, her " + gooTits() + " looks pert and perky, topped with dark chocolate nipples.  The reflective surface makes them appear larger than they truly are, a feast of midnight darkness for your eyes.");
		//{LightA}  
		else DisplayText("Sitting high on her chest, her " + gooTits() + " seems almost disproportionately tiny for her frame.  The perky onyx nipples protrude invitingly, tiny caps of inviting midnight.");
		//{Regardless} 
		DisplayText("  You estimate " + Flags.list[FlagEnum.GOO_NAME] + "'s chest would fit a " + Appearance.breastCup(gooTitSize()) + " bra, were she to wear one.");
		//Dicknips:
		if (Flags.list[FlagEnum.GOO_NIPPLE_TYPE] === 1) DisplayText("  Those proud nipples have odd bulges at the tips, bulges that can swell tremendously, turning into rigid dicknipples.");
		//Cuntnips:
		else if (Flags.list[FlagEnum.GOO_NIPPLE_TYPE] === -1) DisplayText("  Those proud nipples have a visible slit down the middle, just waiting to be spread into hungry pussies.");
		//Third Line - Fluid content
		//{Above 75}
		if (gooFluid() >= 75) DisplayText("  Her onyx lips are plush and inviting, full of liquid.  Likewise, her body seems flush and full of life, certainly not suffering for fluid nutrients.");
		//{Above 50}
		else if (gooFluid() >= 50) DisplayText("  Her onyx lips are full and pouty.  Likewise, her body is smooth and curvy, filled with plenty of fluid nutrients.");
		//{Above 25}
		else if (gooFluid() >= 25) DisplayText("  Her onyx lips look a little on the small side.  Likewise, her body is slim and narrow, not very filled out or curvy.  She could probably use more liquid nutrients.");
		//{Low} 
		else {
			DisplayText("  Her onyx lips are tiny, drawn into a thin line.  Likewise, her body is narrow and feeble, perhaps lacking in fluid sustenance.");
			if (gooFluid() <= 5) DisplayText("  She looks very unhealthy - she might be able to survive like this, but you can tell it will weigh heavily on her.");
		}
		...
		DisplayText("\n\n");
		//{sub 10}
		if (gooObedience() < 10) DisplayText(Flags.list[FlagEnum.GOO_NAME] + " gives you a look of pure defiance, ready to disobey at the slightest notice.");
		//{sub 20}
		else if (gooObedience() < 20) DisplayText(Flags.list[FlagEnum.GOO_NAME] + " idly twirls a raven lock of hair as she awaits your comment, a rebellious look glinting in her " + Flags.list[FlagEnum.GOO_EYES] + " eyes.");
		//{sub 30}
		else if (gooObedience() < 30) DisplayText(Flags.list[FlagEnum.GOO_NAME] + " smirks at you with a rebellious cast on her features.");
		//{sub 40}
		else if (gooObedience() < 40) DisplayText(Flags.list[FlagEnum.GOO_NAME] + " bats charcoal eyelashes at you as she watches you with " + Flags.list[FlagEnum.GOO_EYES] + ", fiery eyes, still far from obedient.");
		//{sub 50}
		else if (gooObedience() < 50) DisplayText(Flags.list[FlagEnum.GOO_NAME] + " glances downwards for a moment, averting her eyes until she remembers to look up, defying her own submission.");
		//{sub 60}
		else if (gooObedience() < 60) DisplayText(Flags.list[FlagEnum.GOO_NAME] + " casts her eyes down but peeks up through her charcoal eyelashes to regard you.");
		//{sub 70}
		else if (gooObedience() < 70) DisplayText(Flags.list[FlagEnum.GOO_NAME] + " keeps her " + Flags.list[FlagEnum.GOO_EYES] + " eyes cast down at the ground in deference to you, though she nervously draws in the dirt with a finger while she awaits a command.");
		//{sub 80}
		else if (gooObedience() < 80) DisplayText(Flags.list[FlagEnum.GOO_NAME] + " fixes her gaze down obediently, her cheeks flushing purplish.  Is she enjoying submitting to you?");
		//{sub 90)
		else if (gooObedience() < 90) DisplayText(Flags.list[FlagEnum.GOO_NAME] + " prostrates herself on the ground before you, tilting her head back so that she can fix her eyes on your waist, unfit to meet your gaze.");
		//{sub 100)
		else if (gooObedience() < 100) DisplayText(Flags.list[FlagEnum.GOO_NAME] + " submissively prostrates herself before you, raising her onyx rump high as her forehead lowers.  Her cheeks and rump both manage to blush purple through her latex skin, clearly aroused by her own submissiveness.");
		//{MAX}
		else DisplayText(Flags.list[FlagEnum.GOO_NAME] + " plants herself on all fours before you, kissing at your [feet].  Her smooth butt lightens along with her sides and cheeks, blushing violet with lust from the heat of her own submission.  Lewdly, she greets you, \"<i>[Master].</i>\"");
	...
	private useLatexy(): void {
		...
		if (player.torso.cocks.count > 0) MainScreen.addButton(2, "DickFuckHer", malePCDomFucksLatexGoo);
	...
	private changeGooDick(): void {
		...
		if (gooObedience() >= 60) {
			DisplayText("You ");
			if (Flags.list[FlagEnum.GOO_DICK_LENGTH] === 0) DisplayText("ask " + Flags.list[FlagEnum.GOO_NAME] + " if she's ever considered growing a dick for fun.");
			else DisplayText("ask her if she'd like to change what kind of dick she has.");
			DisplayText("  She whimpers and moans, \"<i>[Master], I loved growing penises back before I changed.  More than that, ");
			if (Flags.list[FlagEnum.GOO_DICK_LENGTH] === 0) DisplayText("I want to grow one for you.  ");
			else DisplayText("I want you to order me to shift it often.  ");
			DisplayText("Changing myself further, twisting my body into a sexual playground for you... that would be the ultimate thrill!</i>\"");
			if (Flags.list[FlagEnum.GOO_DICK_LENGTH] === 0) DisplayText("\n\n" + Flags.list[FlagEnum.GOO_NAME] + " pulls a hand away from her pussy and says, \"<i>I'll need something masculine if you want me to grow a cock, [Master].  An incubi draft would work, or some minotaur blood, though the blood might make it a horsecock...</i>\"  She shudders and closes her eyes, imagining herself with a rigid equine pole.  Your goo must have a bit of a fetish.");
		...
		//High Happiness + Whatever Obedience(F)
			...
			DisplayText("You ask " + Flags.list[FlagEnum.GOO_NAME] + " if ");
			if (Flags.list[FlagEnum.GOO_DICK_LENGTH] === 0) DisplayText("she's ever considered growing a dick for fun.");
			else DisplayText("she'd like to change what kind of dick she has.");
			DisplayText("  She beams and titters, \"<i>Omigod, I loved growing penises back before I changed!  It was so much fun to see how surprised it would make people and to make new shapes to see how they'd feel.  Let's do it!</i>\"");
	...
	private latexyEatsADickItem(item: ItemType): void {
		...
		if (Flags.list[FlagEnum.GOO_DICK_LENGTH] === 0) {
			DisplayText("Her onyx mound bulges, the luscious lips spreading around something internal.  Gradually, they part like a silken veil to reveal a ");
			if (item === consumables.MINOBLO) DisplayText("flattened head");
			else DisplayText("bulbous crown");
			DisplayText(".  The newborn cock-tip thickens, spreading her wider as it gradually droops out of the female flesh surrounding it.  ");
			Flags.list[FlagEnum.GOO_DICK_LENGTH] = 8;
			if (item === consumables.MINOBLO) {
				DisplayText("On and on it comes.  She's truly going to be hung like a stallion at this rate!   ");
			...
			if (item === consumables.GROPLUS) {
				DisplayText("Her " + gooCock() + " shivers, and starts to sprout outward from the base, lengthening before your very eyes.  One... two... three... new inches of gleaming prick reveal themselves to you!\n\n" + Flags.list[FlagEnum.GOO_NAME] + " giggles, \"<i>You sure do like them big!</i>\"");
				Flags.list[FlagEnum.GOO_DICK_LENGTH] += 3;
			}
			else if (item === consumables.REDUCTO) {
				DisplayText("Her " + gooCock() + " trembles, and starts to shrink inward, disappearing into her polished abdomen.  The effect is so startling profound that you have to do a double-take.  " + Flags.list[FlagEnum.GOO_NAME] + "'s penis is barely two thirds its original size!\n\nShe giggles, \"<i>Not a fan of the big boys, huh?</i>\"");
				Flags.list[FlagEnum.GOO_DICK_LENGTH] = Math.round(Flags.list[FlagEnum.GOO_DICK_LENGTH] * .66);
			}
			else {
				DisplayText("Her " + gooCock() + " rapidly erects, rising to full tumescence in seconds.  The veins begin to shift, crawling around under her onyx skin like little worms as her penis reshapes it.  A muffled moan escapes from " + Flags.list[FlagEnum.GOO_NAME] + "'s lips along with a discharge of black pre-cum from her tip and slit.  Then, with a powerful flex, the latex woman's penis solidifies into a new shape.  <b>" + Flags.list[FlagEnum.GOO_NAME] + "'s maleness is now a ");
	...
	private changeLatexyTits(arg: number = 0): void {
		...
		if (gooTitClass(arg) > gooTitClass(Flags.list[FlagEnum.GOO_PREFERRED_TIT_SIZE]) && gooTitClass(Flags.list[FlagEnum.GOO_FLUID_AMOUNT] / 2) < gooTitClass(arg)) {
			...
			if (gooTitClass(Flags.list[FlagEnum.GOO_FLUID_AMOUNT] / 2) === gooTitClass(gooTitSize()))
				DisplayText(Flags.list[FlagEnum.GOO_NAME] + " nods, but her body doesn't change.  \"<i>There's not enough of me to make them any bigger right now.  You'll have to feed me if you want to see what they'll look at... full size.</i>\"");
		...
		//To C {medium} sized:
			...
			//Bigger: 
			if (gooTitClass(gooTitSize()) < 2) DisplayText(Flags.list[FlagEnum.GOO_NAME] + " says, \"<i>Well, that's a start I suppose.</i>\"  She cups her tiny teats and massages them with gentle gropes.  Each time, they jiggle a little bit more.  Almost as soon as she starts, she stops, leaving them as curvy C-cups.  \"<i>Could we go bigger?</i>\"");
			//Smaller: 
	...
	private feedLatexy(): void {
		...
		if (gooHappiness() >= 50 && player.lactationQ() >= 100 && player.torso.chest.sort(BreastRow.BreastRatingLargest)[0].rating >= 3) MainScreen.addButton(4, "Milk", feedLatexySomeMilk);
	...
	private feedLatexyCumIndirectly(): void {
		...
		if (Flags.list[FlagEnum.GOO_INDIRECT_FED] === 0) {
			DisplayText("You toss a wooden bowl on the ground in your latex pet's area.  She looks more than a little confused by this development, poking it and asking, \"<i>What's this for?</i>\"\n\n");
			Flags.list[FlagEnum.GOO_INDIRECT_FED] = 1;
		}
		DisplayText("Glancing down at " + Flags.list[FlagEnum.GOO_NAME] + ", you tell her that it's feeding time.  She turns her gaze upward, more than a little eagerly");
		if (gooObedience() < 70) DisplayText(" and unashamedly reaching for your [armor].  You bat her hands away, forcing her greedy little latex digits to wait along with the rest of her");
		else DisplayText(", obediently waiting with her tongue wagging.");
		if (gooFluid() < 33) {
			DisplayText("  The hunger in her eyes is so relentless you fear her gaze could drill directly into your ");
			if (player.torso.balls.quantity === 0) DisplayText("body");
			else DisplayText("ballsack");
			DisplayText(".");
		}
		else if (gooFluid() < 66) DisplayText("  The hunger in her eyes is a palpable thing, one you fear could prod her into rash action.");
		else if (gooFluid() < 90) DisplayText("  The hunger in her eyes is a lazy thing.  It doesn't seem that strong, but she's always willing to drink more.");
		else DisplayText("  The hunger in her eyes is a decadent, gluttonous thing that's barely roused by the prospect of fresh seed.  It still causes her to smear a lick across her shiny lips.");
		DisplayText("\n\n[EachCock] easily hardens as it's removed from your restraining gear, already fairly turgid.  You experimentally pump ");
		if (player.torso.cocks.count > 1) DisplayText("one");
		else DisplayText("it");
		DisplayText(", plumping it to full rigidity with a few quick strokes.  " + Flags.list[FlagEnum.GOO_NAME] + " can only watch the salacious display with rapt attention, one hand nervously stroking her thigh while the other fiddles with her hair.  Willingly waiting, she seems to understand that you're just here to provide her with sustenance.  It doesn't make it any easier for her to restrain her lusts.");
		...
		if (player.cumQ() < 250) DisplayText("oozing a thicker river of pre-cum than normal");
		else if (player.cumQ() < 500) DisplayText("dripping even more pre-cum than usual");
		...
		DisplayText(", raining down into the bowl in thick white ropes.");
		if (player.cumQ() >= 500) DisplayText("  In a short time, you have overfilled it, so you settle for spraying the remainder over your rubbery prize.  Long strands of sticky, slick breeding fluid rain over her charcoal mane, painting into a gray mop.");
		if (player.cumQ() >= 1000) DisplayText("  Still, you relentlessly pump yourself through more and more ejaculations, until the ground can bear no more and a puddle forms below.");
		if (player.cumQ() >= 4000) DisplayText("  That puddle swiftly fills into a foot deep lake of spunk, a muddy morass of your own virile semen.");
		...
		if (player.cumQ() >= 500) DisplayText(", and she turns to cleaning herself");
		DisplayText(".");
		if (player.cumQ() >= 1000) DisplayText("  Sadly, the copious jizz that puddled up has already been devoured by the dry ground.  It seems the dirt can drink faster than your latex slave.");
	...
	private feedLatexyGirlCumIndirectly(): void {
		...
		if (gooFluid() < 33) DisplayText("  The hunger in her eyes is so relentless you fear her gaze could drill directly into your [vagina].");
		else if (gooFluid() < 66) DisplayText("  The hunger in her eyes is a palpable thing, one you fear could prod her into rash action.");
		else if (gooFluid() < 90) DisplayText("  The hunger in her eyes is a lazy thing.  It doesn't seem that strong, but she's always willing to drink more.");
		else DisplayText("  The hunger in her eyes is a decadent, gluttonous thing that's barely roused by the prospect of fresh seed.  It still causes her to smear a lick across her shiny lips.");
		...
		if (player.torso.clit.length >= 3.5) DisplayText("  Soon, it stands out proud and erect, a column of glistening femme-flesh that tingles with every stray breeze.");
		...
		DisplayText("\n\nYou groan, equally enraptured by the display she's putting on for you.  Soon, you're ");
		if (player.torso.vaginas.get(0).wetness < 3) DisplayText("absolutely soaked with your girlish moisture");
		else if (player.torso.vaginas.get(0).wetness < 4) DisplayText("dripping strings of girlish liquid with abandon");
		else DisplayText("practically gushing girlish moisture into the bowl");
		DisplayText(".  You instinctively rock your [hips] forward, slowly pumping them to an instinctive, animalistic beat.  " + Flags.list[FlagEnum.GOO_NAME] + " watches raptly, still masturbating herself with relentless finger-fucks.  She watches expectantly, waiting for the first sign of your orgasm with spellbound attention.");
		DisplayText("\n\nRather than disappoint those eager eyes, you cum.  A bolt of electric intensity explodes in your [clit].");
		if (player.torso.clit.length >= 3.5) DisplayText("  You wrap your hand around it without meaning to, caressing the slick, womanly shaft so fast that it floods your mind with white waves of unthinking pleasure.");
		...
		if (player.torso.vaginas.get(0).wetness < 3) DisplayText("Your dribbling cunny paints a thin film of lady-spunk on the bowl, filling it slowly as you drip and squirm.");
		else if (player.torso.vaginas.get(0).wetness < 4) DisplayText("Your ludicrously wet cunt oozes thick flows of lady-spunk into the bowl, rapidly filling it with the proof of your orgasm.");
		else DisplayText("Your gushing cunny sprays a lurid flow of lady-spunk into the bowl, immediately filling it beyond its rim.  It does a fine job of muddying the ground with the proof of your orgasm as your bliss drags on.");
		DisplayText("\n\n" + Flags.list[FlagEnum.GOO_NAME] + " dives into the bowl with gusto, greedily devouring every drop.  Her tongue hangs free, thrashing against the polished wood as more and more of her latex mouth-muscle spools free to help with the feeding.  In seconds, the bowl is emptied.");
		if (player.torso.vaginas.get(0).wetness >= 4) DisplayText("  Sadly, the copious vaginal lube that muddied the ground is already absorbed.  It seems the dirt can eat faster than your pet.");
		//{Boost her fluid quantity, bonus for over 250mL.}
		temp = 10;
		if (player.torso.vaginas.get(0).wetness >= 3) temp += 5;
		if (player.torso.vaginas.get(0).wetness >= 4) temp += 5;
		if (player.torso.vaginas.get(0).wetness >= 5) temp += 5;
		player.orgasm();
		gooFluid(temp);
		//{Boost her happiness a tiny amount.}
		gooHappiness(4);
	...
	private minotaurCumFeedingGoo(nice: boolean = false): void {
		...
		if (player.minotaurNeed() || player.minotaurAddicted()) DisplayText(" and hungrily lick at your lips, always eager to take such a treat yourself");
		DisplayText(".  The latex woman ");
		if (Flags.list[FlagEnum.TIMES_FED_LATEXY_MINO_CUM] > 0) DisplayText("claps in excitement, her dark-as-night nipples perking up immediately.  She hasn't forgotten her last taste of the heady treat.");
		else DisplayText(" tilts her head in confusion, though when she realizes that it's cum you carry, her dark-as-night nipples perk up.");
		DisplayText("  You swish the bottle back and forth, commenting on how you've brought your pet a treat.");
		...
		else if (player.tallness >= 60) DisplayText("neck");
		else if (player.tallness >= 52) DisplayText("own");
		else DisplayText("hair");
		DisplayText(".  Striking " + Flags.list[FlagEnum.GOO_EYES] + " eyes imploringly beg at you, as if to say, \"<i>Can I have it now?</i>\"");
		//{HARD - skip if nice.}
		if (!nice) {
			...
			if (gooObedience() >= 70) DisplayText("  " + Flags.list[FlagEnum.GOO_NAME] + " immediately drops to the ground on all fours, rubbing her head against your [foot] and begging, \"<i>Please [Master], may your latex fuckpet have some of that wonderful cum?</i>\"  It seems she can be obedient after all.");
			//[Semi obedient:]
			else if (gooObedience() >= 40) {
				DisplayText("  " + Flags.list[FlagEnum.GOO_NAME] + " gives a trifling protest, \"<i>Do I have to?  That cum looks really delicious!  I promise, I'll be good!  I'll let you fuck me any way you want.  I'll even fuck you, if you want me to!</i>\"");
			...
			//[Not obedient:]
				...
				DisplayText("  " + Flags.list[FlagEnum.GOO_NAME] + " protests, \"<i>But you captured me!  You ought to at least have the decency to give me some of that yummy food!</i>\"");
				...
				DisplayText("That's more like it.");
			}
		...
		if (player.minotaurNeed()) {
			DisplayText(" that makes you flush with an echoing need of your own.  Without meaning to, you pounce her, licking every trace of the heavenly minotaur spunk from her lips and licking the smallest of leftovers from inside her.  Your slave");
			if (gooHappiness() < 33) DisplayText(" reluctantly returns the kiss, seeming to tolerate it more than anything else.  You barely notice, lust drunk as you are.");
			else if (gooHappiness() < 66) DisplayText(" seems surprised at first but quickly comes to enjoy it, swapping cummy spit with passion.");
			else DisplayText(" eagerly returns the kiss, frenching you with abandon.  Her tongue happily pushes the leftover jizz into your mouth.");
			DisplayText("  You pull back, panting and unsated, wishing you had drank it yourself");
	...
	private feedLatexyCumDirectly(): void {
		...
		//HUNGRY: 
		if (gooFluid() < 33) {
			DisplayText("  A rumble makes " + Flags.list[FlagEnum.GOO_NAME] + "'s tight belly tremble.  She brings a hand up to cover her featureless belly, giving you a nervous grin as she leans forward.  \"<i>How did you know I was so hungry");
			if (gooObedience() > 50) DisplayText(", [Master]");
			DisplayText("?</i>\"");
		}
		//INTERMEDIATE: 
		else if (gooFluid() < 66) {
			DisplayText("  A smirk spreads over " + Flags.list[FlagEnum.GOO_NAME] + "'s visage.  She licks her lips and leans forward, saying, \"<i>Mmm...  I could go for a snack");
			if (gooObedience() > 50) DisplayText(", [Master]");
			DisplayText(".</i>\"");
		}
		//NOT HUNGRY:  
		else {
			DisplayText("  A lazy smile reveals itself on " + Flags.list[FlagEnum.GOO_NAME] + "'s face.  She giggles, her lush body jiggling with liquid weight as she moves.  The latex woman comments, \"<i>Mmm...  I'm pretty full.</i>\"  She licks her lips and continues in a gluttonous purr, \"<i>You can always feed me more though");
			if (gooObedience() > 50) DisplayText(", [Master]");
			DisplayText(".</i>\"");
		}
		//{no new PG} 
		if (gooFluid() > 50) DisplayText("  Plump o");
		else DisplayText("  O");
		...
		if (player.torso.cocks.count > 1) {
			DisplayText("  Your remaining ");
			if (player.torso.cocks.count === 2) DisplayText("dick fruitlessly paints");
			else DisplayText("dicks fruitlessly paint");
			DisplayText(" her " + gooTits() + " with a sheen of white, wasting their moisture in a decadent display of virility.");
		}
		if (player.cumQ() >= 500) DisplayText("  You cream her internals so full that her belly distends and jiggles with each fresh pump of spunk.");
		if (player.cumQ() >= 1500) DisplayText("  Rounder and rounder she swells, until her middle is almost balloonish, stretched so taut it appears grayish-white thanks to all the white beneath.");
		if (player.cumQ() >= 500) DisplayText("  However, by the time your orgasm is winding down, she's already metabolizing it, converting her spunk-plumped belly into supple, denser curves for the rest of her form.");
		...
		if (gooObedience() >= 60) {
			...
			if (Flags.list[FlagEnum.GOO_DICK_LENGTH] > 0) DisplayText(" and " + gooCock() + " spatter");
			else DisplayText(" spatters");
			DisplayText(" oily wetness onto the ground below at your affirmation, and she shudders with a submissive thrill.  You pat her on the head for a job well done and depart, secure in her obedience.");
			//{Boost her fluid quantity, bonus for over 250mL.}
			temp = 20;
	...
	private maleDirectFeedLatexGooGoneWrong(): void {
		...
		if (player.torso.cocks.count > 1) {
			...
			if (player.torso.cocks.count > 2) DisplayText("your remaining erections");
			else DisplayText("your other erection");
			DisplayText(", stroking ");
			if (player.torso.cocks.count === 2) DisplayText("it");
			else DisplayText("them");
			DisplayText(" with slow caresses.  Using the extra ejaculate as lubricant, she ensures that they're nearly as engulfed in slippery latex as your main member.  ");
		}
		DisplayText("Without warning, an explosion of ecstasy rises up, forcing decadent, pleasurable squeezes through your abdominal muscles, culminating in a release of white pressure from ");
		...
		else DisplayText("Her eager pumps never slow, and she moves one of her busy mitts to stroke your black-coated length");
		DisplayText(".  The latex waif tickles your ");
		...
		if (player.torso.cocks.count > 1) DisplayText("s");
		DisplayText(".  Worse, the slimy handjob");
		if (player.torso.cocks.count > 1) DisplayText("s");
		DisplayText(" you've been getting morph");
		if (player.torso.cocks.count === 1) DisplayText("s");
	...
	private feedLatexyGirlCumDirect(): void {
		...
		else DisplayText("  When " + Flags.list[FlagEnum.GOO_NAME] + " glances down, you sashay to better show your [vagina].");
		...
		if (player.torso.vaginas.get(0).wetness < 3) DisplayText("  Drizzling wetness pours down your pet's chin as she pleases you.  She swallows most of it with eager bobs of her throat, happy to have such a... moist [master].");
		else if (player.torso.vaginas.get(0).wetness < 4) DisplayText("  Drops of wetness beat on your pet's chin as she pleases you.  She swallows most of it with eager bobs of her throat, pleased to have an appetizer before the main course.");
		else DisplayText("  Lubricant shines on your pet's glossy chin as she pleases you.  She swallows every now and again with eager bobs of her throat, sampling your flavor.");
		...
		if (player.torso.vaginas.get(0).wetness >= 4) DisplayText("  You squirt a small river of gushing juices directly into her mouth, her cheeks flooded by the copious outpouring of lubricant.");
		else DisplayText("  You gradually fill her mouth with your free-flowing orgasmic lubricants.");
		DisplayText("  Her tongue is squished tight when your [vagina] clamps closed, convulsing around the mouth muscle as if it was a dick it could somehow milk.  Your [legs] lock as you endure the tidal wave of release.");
	...
	private letLatexGooDrainCuntDry(): void {
		...
		if (player.torso.clit.length >= 3) DisplayText("  She happily fellates your female pole in time with the pumping of her arm.");
	...
	private assertControlOverCuntDrainingLatexGoo(): void {
		...
		if (gooObedience() <= 50) DisplayText("[name]");
		...
		player.orgasm();
		player.stats.sens += -2;
		gooFluid(30 + player.torso.vaginas.get(0).wetness * 5);
		//{Boost her happiness a tiny amount.}
		gooHappiness(5);
		gooObedience(5);
		return { next: Scenes.camp.returnToCampUseOneHour };
	...
	private femalePCDomFucksLatexGoo(): void {
		...
		//{NOT OBEDIENT ENOUGH}
		if (gooObedience() < 60) {
			if (gooFluid() < 33) DisplayText("\n\nLicking her lips with unrepentant hunger");
			else if (gooFluid() < 66) DisplayText("\n\nSticking her tongue against her cheek in consternation");
			else DisplayText("\n\nRolling her eyes");
			DisplayText(", " + Flags.list[FlagEnum.GOO_NAME] + " ");
			if (gooObedience() < 20) DisplayText("boldly retorts");
			else if (gooObedience() < 40) DisplayText("answers snarkily");
			else DisplayText("timidly protests");
			DisplayText(", \"<i>No.  You can't make me.  I may be stuck in this camp and separated from my people, but I will not let myself be some sexual toy.</i>\"  A trickle of inky lubricant between her legs");
			if (Flags.list[FlagEnum.GOO_DICK_LENGTH] > 0) DisplayText(" and the rigidity of her " + gooCock() + " have");
			else DisplayText(" has");
			DisplayText(" you doubting that claim, but she seems resolute in her desire to avoid direct sex, for now.");
			if (gooFluid() < 15) DisplayText("  Her hunger is palpable, perhaps it would be best if you simply 'fed' her soon?");
			return { next: Scenes.camp.returnToCampUseOneHour };
			gooObedience(-3);
			return;
		}
		...
		if (Flags.list[FlagEnum.GOO_DICK_LENGTH] > 0) DisplayText("  Meanwhile, the " + gooCock() + " sways uselessly above the conjoined vaginas, leaking its own secretions as it's ignored.");
		DisplayText("  Lost to the pleasure, you rock your [hips] back and forth, up and down, mindlessly rubbing yourself to new heights of ecstasy on your pet's super-slick snatch.");
		...
		if (player.torso.chest.sort(BreastRow.BreastRatingLargest)[0].rating >= 1) {
			DisplayText(", kneading your chest");
			if (player.lactationQ() > 50) {
				DisplayText(" as milk ");
				if (player.lactationQ() < 200) DisplayText("dribbles over your fingers");
				else if (player.lactationQ() < 500) DisplayText("squirts out unhindered");
				else DisplayText("sprays out in a fountain");
			}
		}
		...
		if (player.perks.has(PerkType.Masochist)) DisplayText(", so you do, gleefully stripping the material from your skin.  Juices gush from your [vagina] as you torture your mons with masochistic pleasure, peeling the adhesive substance away to reveal pain-reddened skin.  " + Flags.list[FlagEnum.GOO_NAME] + " looks up at you in awe, and with a shudder, you pat her on the head.  \"<i>Good pet.</i>\"");
		//{ALT:
		else {
			DisplayText(".  Of course, you've got a pet right here that's already an obedient little cunt-cleaner.  You plant your [vagina] right on her face and command, \"<i>Lick it clean.</i>\"");
		...
		player.orgasm();
		player.stats.sens += -2;
		gooFluid(5 + player.torso.vaginas.get(0).wetness * 2);
		gooObedience(5);
		gooHappiness(2);
		return { next: Scenes.camp.returnToCampUseOneHour };
	}
	...
	private femalePCDomFucksLatexGooFuta(): void {
		...
		//{NOT OBEDIENT ENOUGH}
		if (gooObedience() < 60) {
			if (gooFluid() < 33) DisplayText("Licking her lips with unrepentant hunger");
			else if (gooFluid() < 66) DisplayText("Sticking her tongue against her cheek in consternation");
			else DisplayText("Rolling her eyes");
			DisplayText(", " + Flags.list[FlagEnum.GOO_NAME] + " ");
			if (gooObedience() < 20) DisplayText("boldly retorts");
			else if (gooObedience() < 40) DisplayText("answers snarkily");
			else DisplayText("timidly protests");
			DisplayText(", \"<i>No.  You can't make me.  I may be stuck in this camp and separated from my people, but I will not let myself be some sexual toy.</i>\"  A trickle of inky lubricant between her legs and the rigidity of her " + gooCock() + " have you doubting that claim, but she seems resolute in her desire to avoid direct sex, for now.");
			if (gooFluid() < 10) DisplayText("  Her hunger is palpable, perhaps it would be best if you simply 'fed' her soon?");
			gooObedience(-3);
			return { next: Scenes.camp.returnToCampUseOneHour };
			return;
		}
		//{OBEDIENT ENOUGH}
		DisplayText("At first, she reaches down to touch herself, so aroused by the idea she wants to get started right away, but she remembers her place and stops.  The ebony slave-girl asks, \"<i>Shall I sit down for you to ride me, [Master]?  Or would you rather I mount you?</i>\"");
		...
		if (Flags.list[FlagEnum.GOO_DICK_LENGTH] * Flags.list[FlagEnum.GOO_DICK_LENGTH] / 6 > player.vaginalCapacity()) DisplayText("  Of course, as gigantic as it is, you can't take all of it, but you do your damnedest to try.");
		else DisplayText("  Soon, your [butt] comes to rest against " + Flags.list[FlagEnum.GOO_NAME] + "'s oily skin, her erection nestled nicely inside you.");
		DisplayText("  You take a few experimental bounces, enjoying the feeling of that " + gooCock() + " pressing on your folds and stirring against your insides.  Your pet reaches up to grab onto your [hips] for support.  She pants ");
		if (player.torso.hips.legs.isTaur()) DisplayText("into your haunches");
		else if (player.tallness >= 84) DisplayText("against your side");
		else if (player.tallness >= 70) DisplayText("into your shoulder");
		...
		if (Flags.list[FlagEnum.GOO_DICK_TYPE] === CockType.DOG) DisplayText("stays trapped inside you thanks to your pet's thick knot");
		else DisplayText("sprays out of your [vagina]");
		DisplayText(".  You look over your shoulder and scold, \"<i>I didn't give you permission to cum!</i>\"");
		...
		else DisplayText(", you begin to fondle your [nipples] and bounce haunches on her lap.");
		...
		if (player.torso.hips.legs.isTaur()) DisplayText("The latex woman wastes no time in bending double to kiss your equine ass, even darting forward to smooch your tender ring.");
		else DisplayText("The latex woman wastes no time in placing her glossy lips against yours, even plunging her slick tongue into your mouth.");
		DisplayText("  Her passionate kisses and twitching boner overwhelm your senses, and before you can warn her, you cum.");
		...
		DisplayText("  You get dressed and leave with a swagger in your step.  A smiling, solid goo-girl sits in your wake.");
		player.orgasm();
		player.stats.sens += -2;
		player.slimeFeed();
		Flags.list[FlagEnum.LATEX_GOO_TIMES_FEMDOMMED_BY_PC]++;
	...
	private malePCDomFucksLatexGoo(): void {
		...
		if (Flags.list[FlagEnum.GOO_NIPPLE_TYPE] === 1) DisplayText("-cock");
		DisplayText("s harden on her chest, jutting out and just begging to be sucked.");
		//{NOT OBEDIENT ENOUGH}
		if (gooObedience() < 60) {
			if (gooFluid() < 33) DisplayText("\n\nLicking her lips with unrepentant hunger");
			else if (gooFluid() < 66) DisplayText("\n\nSticking her tongue against her cheek in consternation");
			...
			DisplayText(", \"<i>No.  You can't make me.  I may be stuck in this camp and separated from my people, but I will not let myself be some sexual toy.</i>\"  The trickle of inky lubricant between her legs");
			if (Flags.list[FlagEnum.GOO_DICK_LENGTH] > 0) DisplayText(" and the rigidity of her " + gooCock() + " have");
			else DisplayText(" has");
			DisplayText(" you doubting that claim, but she seems resolute in her desire to avoid direct sex, at least until you train her a bit better.");
			if (gooFluid() < 10) DisplayText("  Her hunger is palpable, perhaps it would be best if you simply 'fed' her soon?");
			gooObedience(-3);
			return { next: Scenes.camp.returnToCampUseOneHour };
			return;
		...
		if (player.stats.cor < 33) DisplayText("Smiling");
		...
		DisplayText("  Once finished, you pull her off and leave her to pant for breath.");
	...
	private feedLatexySomeMilk(): void {
		...
		//{Not hungry}
		if (gooFluid() >= 66) DisplayText("  She shrugs, but gives you a little smile as she sidles closer to you. \"<i>No, but if you need to lighten your load... I'm your girl!</i>\"");
		//{Middling hungry}
		else if (gooFluid() >= 33) DisplayText("  She licks her lips in response to your offer, obviously ready for a taste of your delicious milk.");
		//{Really fucking hungry}
		else DisplayText("  Before you've even completed your offer, " + Flags.list[FlagEnum.GOO_NAME] + " is on you like a moth to a flame, eagerly pulling at your clothes to try and free your teats.");
		...
		if (player.gender === Gender.HERM) DisplayText("double genitals");
		else if (player.torso.cocks.count > 0) DisplayText("cock");
		else if (player.torso.vaginas.count > 0) DisplayText("cunt");
		else DisplayText("asshole");
		DisplayText(".  You don't last long, and soon throw your head back and cum, ");
		if (player.gender > 0) DisplayText("smearing her fingers with a liberal spattering of your cum");
		else DisplayText("your [ass] clamping down hard as her finger milks you from behind");
