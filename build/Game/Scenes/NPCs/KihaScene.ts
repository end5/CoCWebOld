export class KihaScene extends NPCAwareContent {
	...
	internal function kihaVictoryIntroduction(): void {
		...
		if (silly()) DisplayText("(like Urta's cock!) ");
	...
	private kihaMilkTitHumiliation(): void {
		...
		DisplayText("Kiha recoils at the drops of white beading atop your " + BreastDescriptor.describeNipple(character, character.torso.chest.get(0)) + " and asks, \"<i>Do you really think that's hot?  It's disgusting.  A perversion of the body only a sick... MAMMAL would enjoy.</i>\"\n\n");

		DisplayText("The scaly woman leans down to tug on your " + BreastDescriptor.describeNipple(character, character.torso.chest.get(0)) + "s in turn, laughing every time a spurt of milk erupts from one of your tits.  Each rough squeeze sends shivers of erotic sensation through your body, and you quickly grow aroused from the rough treatment.  Kiha keeps going, ");
	...
	private kihaRapesMen(): void {
		...
		if (x < 0) x = 0;
		DisplayText("You try to rise, but the dragon girl whips around, her long, thick tail delivering a subduing crack against the side of your head, dropping you back onto your " + ButtDescriptor.describeButt(player) + ".  Triumphantly standing over you, the scaled woman eyes you with a panting breathlessness that betrays the coldness in her gaze.  She squints, arcing an imperious eyebrow as she looks you up and down, drawing her hands back to shoulder level and barely brushing against her breasts.  Her tail lashes back and forth between her legs, wrapping around her calves as she lifts a clawed foot and rests it lightly upon your stiffening groin.  Apparently, your fight left her wanting more than just your gems.  Her flexible toes squeeze your " + CockDescriptor.describeMultiCockShort(player) + " through your " + player.inventory.equipment.armor.displayName + ", and she snorts in derision.  \"<i>This is it, huh?  Pathetic.  I'm going to have to do all the work if I have any hope of you satisfying me.</i>\"\n\n");

		DisplayText("With a swift kick to your collarbone, Kiha knocks you on your back and stands over you, her vulva swollen with excitement despite her frosty insults.  She opens your " + player.inventory.equipment.armor.displayName + " with her long, clenching talons just enough to expose " + CockDescriptor.describeMultiCockSimpleOne(player) + ".  The dragoness curls her tail between her legs, the warm, scaled surface of the dexterous limb rubbing your tender flesh impatiently, tip flicking " + Desc.Cock.describeMultiCockSimpleEach(character) + " before coiling around the crest of your cockhead.  The narrow point of her backside pokes at your urethra, parting the narrow slit and tickling the sensitive, silken interior to draw a weak gasp from you.  \"<i>Yeah, I bet you'd love to get penetrated,</i>\" she scoffs, wrapping her hands around the thick girth of tail poking between her thighs like a massive, scale-textured cock.  She strokes the fat plates and thumbs the ridge-like nobs lining its underside with a hip-swaying motion that sends her chest wobbling.  \"<i>But,</i>\" she continues, her tail lifting off of your " + CockDescriptor.describeMultiCockShort(player) + " and curling upwards, \"<i>this isn't about what you want.</i>\"\n\n");
		...
		DisplayText("Before long, her cunny practically drools, but you're not sure what she's getting off on more, the tail teasing her clit or your dick stiffening uncontrollably at her feet.  She grins, more to show her teeth than in pleasure, and begins to feed her tail into her snatch, the girl's folds parting eagerly to the rough limb, her honeypot polishing her scales to a liquid gleam almost immediately.  As she pumps long, slow thrusts inside herself, Kiha shifts to one leg, bringing her adept foot to your " + CockDescriptor.describeCock(player, x) + " once more");
		if (player.torso.balls.quantity > 0) DisplayText(", resting the heel of her foot against the swell of your " + BallsDescriptor.describeBalls(true, true, player) + " and applying just enough pressure to feel the cum churning within");
		...
		DisplayText("With a rumbling growl, the dragoness impales herself on your " + CockDescriptor.describeCock(player, x) + " hard enough to knock the wind from your lungs. She clamps down and begins rolling her ass back and forth over your groin, stroking you off with only the rippling contractions from the toned walls of her rectum.  Your orgasm moments away, you helplessly clench your fingers in the earth");
		//[Lizard/naga tail: 
		...
		if (player.torso.balls.quantity > 0) DisplayText(", your " + BallsDescriptor.describeBalls(true, true, player) + " practically leaping in over-burdened joy as their heavy load rushes through your flesh");
		DisplayText(".  A geyser of hot spunk sprays from your " + CockDescriptor.describeCock(player, x) + ", flooding her innards with the excruciatingly hefty torrent of seed all her teasing and abuse built within you.");
	...
	private kihaRapesHerms(): void {
		...
		DisplayText("The heat of her closeness and probing tail begin to excite you, " + CockDescriptor.describeMultiCockShort(player) + " slowly stiffening against your abdomen.  Noticing your arousal, the dragoness pulls her tail from your mouth and curls it back behind her again.  \"<i>You'd love to stuff my tight box with every inch you've got, wouldn't you?</i>\" she taunts, pressing her hands to the ground behind her. Leaning back, she derisively stares down the bridge of her nose and curls her upper lip to display her jagged fangs.  ");
		//NAGA OR SLIME: 
	...
	private tsundereMasturbationChristmasCarol(): void {
		...
		if (player.torso.cocks.count > 0) {
			DisplayText(CockDescriptor.describeMultiCockShort(player) + " against her soft flesh, ");
		...
		else DisplayText(BreastDescriptor.describeNipple(character, character.torso.chest.get(0)) + "s against the hard ridges of her back, your tongue softly licking her smooth skin.");
	...
	private kihaVictoryPomfTail(): void {
		...
		if (silly()) DisplayText(" with a pomf =3");
		else DisplayText(".");
		DisplayText("  Now nude, you sway your " + LowerBodyDescriptor.describeHips(player) + " back and forth sensually, forcing Kiha to watch your body before you use her.  ");
		...
		DisplayText("Satisfied that it is sufficiently lubricated, you squeeze the now-slippery tail and point its nubby tip at your entrance.  It bumps your " + VaginaDescriptor.describeClit(player) + " as you wrangle with the struggling hind-limb, only turning you on all the more.  Feeling the tip circling your tunnel's opening, you push it up and seat the tentacle-like tail deep inside yourself.  ");
		player.displayStretchVagina(1, true, false, true);
		DisplayText("Gods she's so... warm, and the ridges, they're stroking every inch of your interior, even your g-spot!  Your " + LegDescriptor.describeLegs(player) + " wobble unsteadily, but spurred by lust, you keep an iron grip on your new-found toy.  Kiha doesn't stop resisting either.\n\n");

		DisplayText("Leaning back against the tree the dragon previously occupied, you slide down, letting your " + LegDescriptor.describeLegs(player) + " go completely nerveless.  Kiha's struggles unintentionally add to your pleasure, turning her tail into the world's warmest, most powerful vibrator.  Your hands begin to push more of her girthy thickness inside, stretching your poor puss further and further.  ");
		player.displayStretchVagina(35, true, false, true);
		...
		DisplayText(" girl-cum, your " + VaginaDescriptor.describeVagina(player, player.torso.vaginas.get(0)) + " cums hard.  It squeezes down with clenching, rippling action that finally stop the tail's frantic struggles, immobilizing it in your womanhood.\n\n");
	...
	private victoryDickKiha(): void {
		...
		if (player.stats.lust > 60) DisplayText("only makes " + CockDescriptor.describeMultiCockSimpleOne(player) + " harder.");
		else DisplayText("quickly makes " + CockDescriptor.describeMultiCockSimpleOne(player) + " hard");
		DisplayText(".  Her rear-most extremity yanks out of your grip to cover her femininity once more and you let it, for now.\n\n");

		DisplayText("Pausing for a moment, you set to removing your " + player.inventory.equipment.armor.displayName + " and unleashing " + CockDescriptor.describeMultiCockSimpleOne(player) + " ");
		...
		DisplayText("You advance on her helpless form and repeat your actions, raising her leg and shoving her tail aside.  She resists, but not as fiercely as before.  Her tail is easily kept at bay while you lower yourself to align your " + LowerBodyDescriptor.describeHips(player) + " with the Kiha's moist cunt.  The heat rolling out of her loins is unreal.  Her pussy seems to fog the air with its combination of warmth and wetness, and as you press your " + CockDescriptor.describeCock(player, x) + " closer, it feels almost like a woman is about to give you head, with her hot breath washing over your genitals.\n\n");

		//(DOUBLE DICKING VARIANT)
		if (y != -1 && player.torso.cocks.count > 1) {
			DisplayText("That perfect, dripping entrance beckons for your " + CockDescriptor.describeCock(player, x) + ", but your other penis");
		...
		//(SINGLE DICKING VARIANT)
			...
			DisplayText("That perfect, dripping entrance beckons for your " + CockDescriptor.describeCock(player, x) + ", and without hesitation, you slide inside.  Kiha growls, \"<i>That's it?  How artless.</i>\"  In spite of her disappointed tone, her slippery passage squeezes down on your member with miraculous tightness, embracing your " + CockDescriptor.describeCock(player, x) + " in its firm, velvet grip.  You sigh happily and enjoy the dragon-pussy's pressure for a few moments, tuning out Kiha's griping to focus on the heavenly feelings her body is giving you.\n\n");

			DisplayText("Eventually, you become accustomed to the feel of the reptilian tunnel's simmering juices, and eager for more stimulation, you begin to saw your " + CockDescriptor.describeCock(player, x) + " in and out of sodden box.  The draconic woman beneath you lets out whimpers and moans of pleasure mixed with discontent, unable to resist you and unable to allow herself to enjoy it.  She squirms and wriggles beneath your forced affections, growing ");
	...
	*/
	...
	private analRapuzulaKiha(): void {
		...
		if (player.cockArea(x) <= 20) DisplayText("You quickly shed your " + player.inventory.equipment.armor.displayName + ", letting your " + CockDescriptor.describeMultiCockShort(player) + " out to breathe in the warm, swampy air.  Her red eyes widen slightly, but she quickly regains her composure, suddenly all confidence despite her obvious loss.  \"<i>Oh? What do you think you're gonna do with THAT, huh?  Just ravish me like some kind of sex-crazed demon? Is that your genius plan?</i>\"\n\n");
		else DisplayText("You quickly shed your " + player.inventory.equipment.armor.displayName + ", letting your " + CockDescriptor.describeMultiCockShort(player) + " out to breathe in the warm, swampy air. Her red eyes widen slightly, but she quickly regains her composure, suddenly all confidence despite her obvious loss.  \"<i>Hah, look at that pathetic thing.  You might have gotten me a little hot, but I really doubt you could please anyone with that puny piece of equipment.</i>\"\n\n");
		...
		DisplayText("As soon as your fingers touch her skin, her tail whips around your " + CockDescriptor.describeMultiCockShort(player) + ", wrapping up your groin");
		if (player.torso.balls.quantity > 0) DisplayText(" and threatening to crush your " + BallsDescriptor.describeBalls(true, true, player));
		...
		DisplayText("The heat that now encircles your " + CockDescriptor.nounCock(player.torso.cocks.get(x).type) + " is tremendous; her tightness, incredible.  You're nearly overwhelmed by the urge to slam your whole length home and just cum your brains out.  But you want her to enjoy this, too.  You slowly slide back out of her rectum, stopping when just the tip of the head is barely inside. You lean forward, resting your chest against the warm skin of her back, and thrust your " + CockDescriptor.describeCock(player, x) + " back into the crushing heat of her asshole.\n\n");
		...
		if (y >= 0) {
			...
			DisplayText("Kiha shudders in her own climax, soaking her thighs as you finally release your seed into her ravaged ass.  Your other " + CockDescriptor.nounCock(player.torso.cocks.get(y).type) + " follows its brother, painting her leather-colored skin with alabaster cream");
			...
			else if (player.torso.vaginas.count > 0) DisplayText("; your " + VaginaDescriptor.describeVagina(player, player.torso.vaginas.get(0)) + " pulses with pleasure, soaking your thighs with girl-cum as your cocks unload");
			DisplayText(".\n\n");
			...
			if (player.cockArea(x) <= 20) DisplayText("You move your hands to her breasts, feeling the lightly scaled flesh and begin tweaking her nipples in time to your continued thrusting.  She breaks her self-imposed silence with a long, pleasured sigh, but cuts it short when you laugh at her body's betrayal of her emotions.  \"<i>H-how can anyone even l-like this anyway?</i>\" she pants with barely contained pleasure.  \"<i>All you're doing is sticking your pathetic dick inside something that it isn-isn't designed for.  I-I can barely feel your ti-tiny little cock... uhh... stretching my ass, filling it with s-such force.  Its head tickling my walls with your... ohhh... pathetic attempts to get yourself o-off...</i>\"\n\n");
