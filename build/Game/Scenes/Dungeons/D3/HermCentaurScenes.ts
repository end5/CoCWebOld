...
export class HermCentaurScenes {
	...
	private femFuckHerII(cockType: number): void {
		...
		if (cockType === TENTACOCK) {
			...
			player.displayStretchButt(player.analCapacity(), true, true, false);
	...
	private femLoss(hpVictory: boolean): void {
		...
		player.displayStretchVagina(monster.biggestCockArea(), true, true, false);
	...
	private maleLoss(hpVictory: boolean): void {
		...
		DisplayText(" She smirks as she trots up, commenting, \"<i>That's more like it, slut.  I don't know how you got so far thinking you were some kind of " + player.mf("stud", "queen bitch") + ".</i>\"  She casually reaches down and grabs you by the scruff of the neck, hauling you bodily up until your head nestles between her tits");
		if (player.tallness >= 7 * 12) DisplayText(", even though your [feet] still touch the ground");
