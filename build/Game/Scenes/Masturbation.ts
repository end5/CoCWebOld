...
//     if(player.stats.lib < 45) DisplayText("You grip your " + Desc.Cock.describeCock(player, player.torso.cocks.get(0)) + " and begin cautiously guiding it towards ");
//     if(player.stats.lib >= 45 && player.stats.lib < 70) DisplayText("Shivering with anticipation, you place the tip of your " + Desc.Cock.describeCock(player, player.torso.cocks.get(0)) + " against the opening of ");
//     if(player.stats.lib >= 70) DisplayText("Without hesitation, you shove the tip of your " + Desc.Cock.describeCock(player, player.torso.cocks.get(0)) + " into ");
//     //More than one row?
...
//     if (player.stats.lib < 45)
//         DisplayText("You grip your " + Desc.Cock.describeCock(player, ) + " and begin cautiously guiding it towards ");
//     else if (player.stats.lib < 70) {
...
//             default:
//         }
//         DisplayText("tip of your " + Desc.Cock.describeCock(player, ) + " against the opening of ");
//         /* Old method
...
//                 else if(player.torso.cocks.filter(Cock.FilterType(CockType.HUMAN) > 0) DisplayText("Shivering with anticipation, you place the tip of your " + Desc.Cock.describeCock(player, player.torso.cocks.get(0)) + " against the opening of ")).length;
...
//                 else if(player.torso.cocks.filter(Cock.FilterType(CockType.TENTACLE) > 0) DisplayText("Shivering with anticipation, you place the bulbous tip of your " + Desc.Cock.describeCock(player, player.torso.cocks.get(0)) + " against the opening of ")).length;
//                 else if(player.torso.cocks.filter(Cock.FilterType(CockType.DEMON) > 0) DisplayText("Shivering with anticipation, you place the bump-encircled tip of your " + Desc.Cock.describeCock(player, player.torso.cocks.get(0)) + " against the opening of ")).length;
//                 else if(player.torso.cocks.filter(Cock.FilterType(CockType.CAT) > 0) DisplayText("Shivering with anticipation, you place the tip of your " + Desc.Cock.describeCock(player, player.torso.cocks.get(0)) + " against the opening of ")).length;
//                 else if(player.torso.cocks.filter(Cock.FilterType(CockType.ANEMONE) > 0 || player.displacerCocks() > 0) DisplayText("Shivering with anticipation, you place the wriggling tip of your " + Desc.Cock.describeCock(player, player.torso.cocks.get(0)) + " against the opening of ")).length;
//                 else DisplayText("Shivering with anticipation, you place the tip of your " + Desc.Cock.describeCock(player, player.torso.cocks.get(0)) + " against the opening of ");
//         */
//     }
//     else {
...
//         }
//         DisplayText("your " + Desc.Cock.describeCock(player, ) + " into ");
//         /* Old method
//                 if(player.torso.cocks.filter(Cock.FilterType(CockType.HUMAN) > 0) DisplayText("Without hesitation, you shove the tip of your " + Desc.Cock.describeCock(player, player.torso.cocks.get(0)) + " into ")).length;
//                 else if(player.torso.cocks.filter(Cock.FilterType(CockType.HORSE) > 0) DisplayText("Without hesitation, you shove the engorged flare of your " + Desc.Cock.describeCock(player, player.torso.cocks.get(0)) + " into ")).length;
...
//                 else if(player.torso.cocks.filter(Cock.FilterType(CockType.TENTACLE) > 0) DisplayText("Without hesitation, you shove the over-sized mushroom that is your " + Desc.Cock.describeCock(player, player.torso.cocks.get(0)) + " into ")).length;
//                 else if(player.torso.cocks.filter(Cock.FilterType(CockType.DEMON) > 0) DisplayText("Without hesitation, you shove the bump-ringed monstrosity that is your " + Desc.Cock.describeCock(player, player.torso.cocks.get(0)) + " into ")).length;
//                 else if(player.torso.cocks.filter(Cock.FilterType(CockType.ANEMONE) > 0) DisplayText("Without hesitation, you shove the tentacle-laden mushroom that is your " + Desc.Cock.describeCock(player, player.torso.cocks.get(0)) + " into ")).length;
//                 else if(player.displacerCocks() > 0) DisplayText("Without hesitation, you shove the opened top of your " + Desc.Cock.describeCock(player, x) + " into ");
//                 else DisplayText("Without hesitation, you shove the " + cockHead(0) + " of your " + Desc.Cock.describeCock(player, player.torso.cocks.get(0)) + " into ");
//         */
//     }
//     // More than one row?
...
//             }
//             DisplayText("your " + Desc.Cock.describeCock(player, ) + " and y");
//             /* Old method
//                         if(player.torso.cocks.filter(Cock.FilterType(CockType.HUMAN) > 0) DisplayText("Slick juices dribble down the skin of your " + Desc.Cock.describeCock(player, player.torso.cocks.get(0)) + " and y")).length;
...
//                         else if(player.torso.cocks.filter(Cock.FilterType(CockType.TENTACLE) > 0) DisplayText("Slick juices dribble down the rubbery skin of your " + Desc.Cock.describeCock(player, player.torso.cocks.get(0)) + " and y")).length;
//                         else if(player.torso.cocks.filter(Cock.FilterType(CockType.DEMON) > 0) DisplayText("Slick juices dribble down the shiny purplish skin and nodules of your " + Desc.Cock.describeCock(player, player.torso.cocks.get(0)) + " and y")).length;
//                         else if(player.torso.cocks.filter(Cock.FilterType(CockType.LIZARD) > 0) DisplayText("Slick juices dribble down the bumpy purple skin of your " + Desc.Cock.describeCock(player, player.torso.cocks.get(0)) + " and y")).length;
//                         else if(player.torso.cocks.filter(Cock.FilterType(CockType.CAT) > 0) DisplayText("Slick juices dribble over the pink, spiny protrusions that cover your " + Desc.Cock.describeCock(player, player.torso.cocks.get(0)) + " and y")).length;
//                         else if(player.torso.cocks.filter(Cock.FilterType(CockType.ANEMONE) > 0) DisplayText("Slick juices dribble over the nearly transparent skin of your " + Desc.Cock.describeCock(player, player.torso.cocks.get(0)) + " and y")).length;
//                         else if(player.displacerCocks() > 0) DisplayText("Slick juices dribble over the dusky purple of your " + Desc.Cock.describeCock(player, player.torso.cocks.get(0)) + " and y");
//                         else DisplayText("Slick juices dribble down the skin of your " + Desc.Cock.describeCock(player, player.torso.cocks.get(0)) + " and y");
//             */
//         }
//         else DisplayText("Slick juices squirt out from around your " + Desc.Cock.describeCock(player, ) + " and y");
//     }
//     else {
...
//             DisplayText("your " + Desc.Cock.describeCock(player, ) + " and y");
//             /* Old method
//                         if(player.torso.cocks.filter(Cock.FilterType(CockType.HUMAN) > 0) DisplayText("Rivulets of milky girlcum drizzle down the skin of your " + Desc.Cock.describeCock(player, player.torso.cocks.get(0)) + " and y")).length;
...
//                         else if(player.torso.cocks.filter(Cock.FilterType(CockType.TENTACLE) > 0) DisplayText("Rivulets of milky girlcum drizzle down the rubbery skin of your " + Desc.Cock.describeCock(player, player.torso.cocks.get(0)) + " and y")).length;
//                         else if(player.torso.cocks.filter(Cock.FilterType(CockType.DEMON) > 0) DisplayText("Rivulets of milky girlcum drizzle down the shiny purplish skin and nodules of your " + Desc.Cock.describeCock(player, player.torso.cocks.get(0)) + " and y")).length;
//                         else if(player.torso.cocks.filter(Cock.FilterType(CockType.CAT) > 0) DisplayText("Rivulets of milky girlcum drizzle down the spiny, pink flesh of your " + Desc.Cock.describeCock(player, player.torso.cocks.get(0)) + " and y")).length;
//                         else if(player.torso.cocks.filter(Cock.FilterType(CockType.LIZARD) > 0 || player.displacerCocks()) DisplayText("Rivulets of milky girlcum drizzle over the purplish, knotted flesh of your " + Desc.Cock.describeCock(player, player.torso.cocks.get(0)) + " and y")).length;
//                         else if(player.torso.cocks.filter(Cock.FilterType(CockType.ANEMONE) > 0) DisplayText("Rivulets of milky girlcum drizzle and drip from the many tiny tentacles of your " + Desc.Cock.describeCock(player, player.torso.cocks.get(0)) + " and y")).length;
//                         else DisplayText("Rivulets of milky girlcum drizzle over the sensitive skin of your " + Desc.Cock.describeCock(player, player.torso.cocks.get(0)) + " and y");
//             */
//         }
//         else {
//             DisplayText("Milky girlcum squirts out from around your " + Desc.Cock.describeCock(player, ) + ", staining ");
//             switch (player.torso.cocks.get(0).type) { // Different way of choosing cock to use, results in consistent description of cock[0]
//                 case CockType.ANEMONE:
...
//             }
//             /* Old method
//                         if(player.torso.cocks.filter(Cock.FilterType(CockType.HUMAN) > 0) DisplayText("Milky girlcum squirts out from around your " + Desc.Cock.describeCock(player, player.torso.cocks.get(0)) + ", staining it white.  Y")).length;
...
//                         else if(player.torso.cocks.filter(Cock.FilterType(CockType.TENTACLE) > 0) DisplayText("Milky girlcum squirts out from around your " + Desc.Cock.describeCock(player, player.torso.cocks.get(0)) + ", staining its rubbery skin white.  Y")).length;
//                         else if(player.torso.cocks.filter(Cock.FilterType(CockType.DEMON) > 0) DisplayText("Milky girlcum squirts out from around your " + Desc.Cock.describeCock(player, player.torso.cocks.get(0)) + ", staining its purplish-skin white.  Y")).length;
//                         else if(player.torso.cocks.filter(Cock.FilterType(CockType.CAT) > 0) DisplayText("Milky girlcum squirts out from around your " + Desc.Cock.describeCock(player, player.torso.cocks.get(0)) + ", staining the pink kitty-skin white.  Y")).length;
//                         else if(player.torso.cocks.filter(Cock.FilterType(CockType.LIZARD) > 0 || player.displacerCocks() > 0) DisplayText("Milky girlcum squirts out from around your " + Desc.Cock.describeCock(player, player.torso.cocks.get(0)) + ", staining the purple, knotty flesh white.  Y")).length;
//                         else if(player.torso.cocks.filter(Cock.FilterType(CockType.ANEMONE) > 0) DisplayText("Milky girlcum squirts out from around your " + Desc.Cock.describeCock(player, player.torso.cocks.get(0)) + ", staining the odd aquatic shaft wide.  Y")).length;
//                         else DisplayText("Milky girlcum squirts out from around your " + Desc.Cock.describeCock(player, player.torso.cocks.get(0)) + ", staining its length white.  Y");
//             */
//         }
//     }
...
//         else if (player.stats.sens < 70)
//             DisplayText("ou blink back tears as you attempt to stuff your " + Desc.Cock.describeCock(player, ) + " into ");
//         else DisplayText("ou scream with a combination of pain and pleasure as you attempt to stuff your " + Desc.Cock.describeCock(player, ) + " into ");
...
//             else if (player.averageVaginalLooseness() < 4)
//                 DisplayText("The engorged opening at the end of your swollen nipple is stretched to its limit as you shove your " + Desc.Cock.describeCock(player, ) + " home. ");
//             else {
//                 switch (player.torso.cocks.get(0).type) { // Different way of choosing cock to use, results in consistent description of cock[0]
//                     case CockType.ANEMONE:
//                         DisplayText("The swollen tips of your bloated nipple wrap around the stinging tentacles that surround your " + Desc.Cock.describeCock(player, ) + "'s tip, convulsing with wet squishing sounds as they become red and enflamed with artificial lust.  ");
//                         break;
//                     case CockType.CAT:
//                         DisplayText("The swollen tips of your bloated nipples stretch around the barbed tip of your " + Desc.Cock.describeCock(player, ) + ", swallowing it like an enormous mouth.  ");
//                         break;
//                     case CockType.DEMON:
//                         DisplayText("The swollen lips of your bloated nipple stretch around the nodule-ringed tip of your " + Desc.Cock.describeCock(player, ) + ", swallowing it like an enormous mouth.  ");
//                         break;
//                     case CockType.DISPLACER:
//                         DisplayText("The swollen tips of your bloated nipple wrap around the outstretched head of your " + Desc.Cock.describeCock(player, ) + ", convulsing with wet, squishing sounds as it wriggles inside you.  ");
//                         break;
//                     case CockType.DOG:
//                     case CockType.FOX:
//                         DisplayText("The swollen lips of your bloated nipple stretch around the pointed tip of your " + Desc.Cock.describeCock(player, ) + " swallowing it like an enormous mouth.  ");
//                         break;
//                     case CockType.HORSE:
//                         DisplayText("The swollen lips of your bloated nipple stretch around the flared tip of your " + Desc.Cock.describeCock(player, ) + " swallowing it like an enormous mouth.  ");
//                         break;
//                     case CockType.HUMAN:
//                         DisplayText("The swollen lips of your bloated nipple stretch around the tip of your " + Desc.Cock.describeCock(player, ) + " swallowing it like an enormous mouth.  ");
//                         break;
//                     case CockType.LIZARD:
//                         DisplayText("The swollen tips of your bloated nipple wrap around the pointed tip of your " + Desc.Cock.describeCock(player, ) + ", stretching oddly as it swallows the knot-covered appendage.  ");
//                         break;
//                     case CockType.TENTACLE:
//                         DisplayText("The swollen lips of your bloated nipple stretch around the rounded tip of your " + Desc.Cock.describeCock(player, ) + ", swallowing it like an enormous mouth.  ");
//                         break;
//                     default:
//                         DisplayText("tips of your bloated nipples wrap around the " + player.cockHead() + " of your " + Desc.Cock.describeCock(player, ) + ", swallowing it like an enormous mouth.  ");
//                 }
//                 /* Old method
//                                 if(player.torso.cocks.filter(Cock.FilterType(CockType.HUMAN) > 0) DisplayText("The swollen lips of your bloated nipple stretch around the tip of your " + Desc.Cock.describeCock(player, player.torso.cocks.get(0)) + " swallowing it like an enormous mouth. ")).length;
...
//                                 else if(player.torso.cocks.filter(Cock.FilterType(CockType.TENTACLE) > 0) DisplayText("The swollen lips of your bloated nipple stretch around the rounded tip of your " + Desc.Cock.describeCock(player, player.torso.cocks.get(0)) + ", swallowing it like an enormous mouth. ")).length;
//                                 else if(player.torso.cocks.filter(Cock.FilterType(CockType.DEMON) > 0) DisplayText("The swollen lips of your bloated nipple stretch around the nodule-ringed tip of your " + Desc.Cock.describeCock(player, player.torso.cocks.get(0)) + ", swallowing it like an enormous mouth. ")).length;
//                                 else if(player.torso.cocks.filter(Cock.FilterType(CockType.CAT) > 0) DisplayText("The swollen tips of your bloated nipples stretch around the barbed tip of your " + Desc.Cock.describeCock(player, player.torso.cocks.get(0)) + ", swallowing it like an enormous mouth. ")).length;
//                                 else if(player.torso.cocks.filter(Cock.FilterType(CockType.LIZARD) > 0) DisplayText("The swollen tips of your bloated nipple wrap around the pointed tip of your " + Desc.Cock.describeCock(player, player.torso.cocks.get(0)) + ", stretching oddly as it swallows the knot-covered appendage. ")).length;
//                                 else if(player.torso.cocks.filter(Cock.FilterType(CockType.ANEMONE) > 0) DisplayText("The swollen tips of your bloated nipple wrap around the stinging tentacles that surround your " + Desc.Cock.describeCock(player, player.torso.cocks.get(0)) + "'s tip, convulsing with wet squishing sounds as they become red and enflamed with artificial lust.  ")).length;
//                                 else if(player.displacerCocks() > 0) DisplayText("The swollen tips of your bloated nipple wrap around the outstretched head of your " + Desc.Cock.describeCock(player, player.torso.cocks.get(0)) + ", convulsing with wet, squishing sounds as it wriggles inside you.");
//                                 else DisplayText("The swollen tips of your bloated nipples wrap around the " + cockHead(0) + " of your " + Desc.Cock.describeCock(player, player.torso.cocks.get(0)) + ", swallowing it like an enormous mouth. ");
//                 */
//             }
...
//             else if (player.averageVaginalLooseness() < 4)
//                 DisplayText("The engorged opening at the end of your swollen nipple is stretched to its limits and beyond as you shove your " + Desc.Cock.describeCock(player, ) + " home. ");
//             else {
//                 switch (player.torso.cocks.get(0).type) { // Different way of choosing cock to use, results in consistent description of cock[0]
//                     case CockType.ANEMONE:
//                         DisplayText("The swollen lips of your bloated nipple gape wide, but the stinging tip of your " + Desc.Cock.describeCock(player, ) + " spreads them wider and fills them with artificial lust.  ");
//                         break;
//                     case CockType.CAT:
//                         DisplayText("The swollen lips of your bloated nipple gape wide, but the barbed tip of your " + Desc.Cock.describeCock(player, ) + " spreads them even wider.  ");
//                         break;
//                     case CockType.DEMON:
//                         DisplayText("The swollen lips of your bloated nipple gape wide, but the tip of your " + Desc.Cock.describeCock(player, ) + " spreads them even wider.  ");
//                         break;
//                     case CockType.DISPLACER:
//                         DisplayText("The swollen lips of your bloated nipple gape wide, but the wide head of your " + Desc.Cock.describeCock(player, ) + " spreads them even wider.  ");
//                         break;
//                     case CockType.DOG:
//                     case CockType.FOX:
//                         DisplayText("The swollen lips of your bloated nipple gape wide, but the massive girth of your " + Desc.Cock.describeCock(player, ) + " spreads them even wider.  ");
//                         break;
//                     case CockType.HORSE:
//                         DisplayText("The swollen lips of your bloated nipple gape wide, but the flared tip of your " + Desc.Cock.describeCock(player, ) + " spreads them even wider.  ");
//                         break;
//                     case CockType.HUMAN:
//                         DisplayText("The swollen lips of your bloated nipple gape wide, but the tip of your " + Desc.Cock.describeCock(player, ) + " spreads them even wider.  ");
//                         break;
//                     case CockType.LIZARD:
//                         DisplayText("The swollen lips of your bloated nipple gape wide, but the pointed tip of your " + Desc.Cock.describeCock(player, ) + " slowly spreads them even wider.  ");
//                         break;
//                     case CockType.TENTACLE:
//                         DisplayText("The swollen lips of your bloated nipple gape wide, but the tip of your " + Desc.Cock.describeCock(player, ) + " spreads them even wider.  ");
//                         break;
//                     default:
//                         DisplayText("The swollen lips of your bloated nipple gape wide, but the " + player.cockHead() + " of your " + Desc.Cock.describeCock(player, ) + " spreads them even wider.  ");
//                 }
//                 /* Old method
//                                 if(player.torso.cocks.filter(Cock.FilterType(CockType.HUMAN) > 0) DisplayText("The swollen lips of your bloated nipple gape wide, but the tip of your " + Desc.Cock.describeCock(player, player.torso.cocks.get(0)) + " spreads them even wider. ")).length;
...
//                                 else if(player.torso.cocks.filter(Cock.FilterType(CockType.TENTACLE) > 0) DisplayText("The swollen lips of your bloated nipple gape wide, but the tip of your " + Desc.Cock.describeCock(player, player.torso.cocks.get(0)) + " spreads them even wider. ")).length;
//                                 else if(player.torso.cocks.filter(Cock.FilterType(CockType.DEMON) > 0) DisplayText("The swollen lips of your bloated nipple gape wide, but the tip of your " + Desc.Cock.describeCock(player, player.torso.cocks.get(0)) + " spreads them even wider. ")).length;
//                                 else if(player.torso.cocks.filter(Cock.FilterType(CockType.CAT) > 0) DisplayText("The swollen lips of your bloated nipple gape wide, but the barbed tip of your " + Desc.Cock.describeCock(player, player.torso.cocks.get(0)) + " spreads them even wider. ")).length;
//                                 else if(player.torso.cocks.filter(Cock.FilterType(CockType.LIZARD) > 0) DisplayText("The swollen lips of your bloated nipple gape wide, but the pointed tip of your " + Desc.Cock.describeCock(player, player.torso.cocks.get(0)) + " slowly spreads them even wider. ")).length;
//                                 else if(player.torso.cocks.filter(Cock.FilterType(CockType.ANEMONE) > 0)  DisplayText("The swollen lips of your bloated nipple gape wide, but the stinging tip of your " + Desc.Cock.describeCock(player, player.torso.cocks.get(0)) + " spreads them wider and fills them with artificial lust. ")).length;
//                                 else if(player.displacerCocks() > 0)  DisplayText("The swollen lips of your bloated nipple gape wide, but the wide head of your " + Desc.Cock.describeCock(player, player.torso.cocks.get(0)) + " spreads them even wider. ");
//                                 else DisplayText("The swollen lips of your bloated nipple gape wide, but the " + cockHead(0) + " of your " + Desc.Cock.describeCock(player, player.torso.cocks.get(0)) + " spreads them even wider. ");
//                 */
//             }
//             DisplayText("Grunting and sweating with effort, you stuff as much of your " + Desc.Cock.describeCock(player, ) + " into your overstretched nipple as you can fit. The feeling of incredible tightness around your " + Desc.Cock.describeCock(player, ) + " combines with the pain of your distended nipple to form a mindbending sensation that makes your head spin. ");
//         }
//         if (player.torso.chest.averageLactation() > 0)
//             DisplayText("Milky ");
//         else DisplayText("Slick ");
//         if (player.averageVaginalWetness() < 2) DisplayText("girl-lube quickly coats the whole length of your " + Desc.Cock.describeCock(player, ) + " in a glistening layer of fuck juice. ");
//         else if (player.averageVaginalWetness() < 4) {
//             DisplayText("girl-lube drizzles down the length of your " + Desc.Cock.describeCock(player, ) + " in thick streams, ");
//             switch (player.torso.cocks.get(0).type) { // Different way of choosing cock to use, results in consistent description of cock[0]
//                 case CockType.ANEMONE:
...
//             }
//             /* Old method
//                         if(player.torso.cocks.filter(Cock.FilterType(CockType.HUMAN) > 0) DisplayText("girl-lube drizzles down the length of your " + Desc.Cock.describeCock(player, player.torso.cocks.get(0)) + " in thick streams, pooling at your crotch. ")).length;
//                         else if(player.torso.cocks.filter(Cock.FilterType(CockType.HORSE) > 0) DisplayText("girl-lube drizzles down the length of your " + Desc.Cock.describeCock(player, player.torso.cocks.get(0)) + " in thick streams, pooling in and around your sheath. ")).length;
//                         else if(player.torso.cocks.filter(Cock.FilterType(CockType.TENTACLE) > 0) DisplayText("girl-lube drizzles down the length of your " + Desc.Cock.describeCock(player, player.torso.cocks.get(0)) + " in thick streams, mixing with the tentacles own lubricants. ")).length;
//                         else if(player.torso.cocks.filter(Cock.FilterType(CockType.DEMON) > 0) DisplayText("girl-lube drizzles down the length of your " + Desc.Cock.describeCock(player, player.torso.cocks.get(0)) + " in thick streams, pooling around the base of your member. ")).length;
//                         else if(player.torso.cocks.filter(Cock.FilterType(CockType.CAT) > 0) DisplayText("girl-lube drizzles down the length of your " + Desc.Cock.describeCock(player, player.torso.cocks.get(0)) + " in thick streams, pooling around the spines near your base. ")).length;
//                         else if(player.torso.cocks.filter(Cock.FilterType(CockType.LIZARD) > 0) DisplayText("girl-lube drizzles down the length of your " + Desc.Cock.describeCock(player, player.torso.cocks.get(0)) + " in thick streams, pooling around the bulbs near your base. ")).length;
//                         else if(player.torso.cocks.filter(Cock.FilterType(CockType.ANEMONE) > 0)  DisplayText("girl-lube drizzles down the length of your " + Desc.Cock.describeCock(player, player.torso.cocks.get(0)) + " in thick streams, pooling around the wriggling tentacles near your base. ")).length;
//                         else if(player.hasKnot()) DisplayText("girl-lube drizzles down the length of your " + Desc.Cock.describeCock(player, player.torso.cocks.get(0)) + " in thick streams, pooling around the bulb near your base. ");
//                         else  DisplayText("girl-lube drizzles down the length of your " + Desc.Cock.describeCock(player, player.torso.cocks.get(0)) + " in thick streams, pooling around the spines near your base. ");
//             */
//         }
...
//         DisplayText(" as your " + Desc.Cock.describeCock(player, ) + " slides into ");
//         // Different based on looseness
//         if (player.averageVaginalLooseness() < 2)
//             DisplayText("the small, over-stretched opening of your swollen nipple. Your " + Desc.Cock.describeCock(player, ) + " penetrates your swollen nipple easily, sliding halfway in on your first thrust. ");
//         else if (player.averageVaginalLooseness() < 4)
//             DisplayText("the engorged and distended opening of your fat, swollen nipple. Your " + Desc.Cock.describeCock(player, ) + " plunges deeply into your freakishly engorged nipple, penetrating it easily. ");
//         else {
...
//             DisplayText("tip of your " + Desc.Cock.describeCock(player, ) + " and begin to slide down its length, ");
//             switch (player.torso.cocks.get(0).type) { // Different way of choosing cock to use, results in consistent description of cock[0]
//                 case CockType.ANEMONE:
...
//             }
//             /* Old method
//                         if(player.torso.cocks.filter(Cock.FilterType(CockType.HUMAN) > 0) DisplayText("the gaping fuck-mouth of your inhuman nipple-cunt. The swollen lips of your bloated nipple engulf the tip of your " + Desc.Cock.describeCock(player, player.torso.cocks.get(0)) + " and begin to slide down its length, swallowing it completely. ")).length;
...
//                         else DisplayText("the gaping fuck-mouth of your inhuman nipple-cunt. The swollen lips of your bloated nipple engulf the tip of your " + Desc.Cock.describeCock(player, player.torso.cocks.get(0)) + " and begin to slide down its length, swallowing it completely. ");
//             */
//         }
//         DisplayText("You revel in the sensation as you slowly stroke your " + Desc.Cock.describeCock(player, ) + " in and out of your distended nipple. Your shaft is enveloped in the warm, wet embrace of your freakish tit, and ");
//         if (player.torso.chest.averageLactation() > 0)
//             DisplayText("milky ");
//         else DisplayText("slippery ");
//         if (player.averageVaginalWetness() < 2)
//             DisplayText("girl-lube quickly coats the whole length of your " + Desc.Cock.describeCock(player, ) + " in a glistening layer of fuck juice. ");
//         else if (player.averageVaginalWetness() < 4)
//             DisplayText("girl-lube drizzles down the length of your " + Desc.Cock.describeCock(player, ) + " in thick streams, pooling at your crotch. ");
//         else {
//             if (player.torso.cocks.filter(Cock.FilterType(CockType.HUMAN)).length > 0)
//                 DisplayText("girl-lube pours out of your swollen nipple over your " + Desc.Cock.describeCock(player, ) + " and hands, pooling on the ground below you. ");
//             else if (player.torso.cocks.hasSheath() > 0)
//                 DisplayText("girl-lube drizzles down the length of your " + Desc.Cock.describeCock(player, ) + " in thick streams, pooling in and around your sheath. ");
...
//                 DisplayText("girl-lube pours out of your swollen nipple over your " + Desc.Cock.describeCock(player, ) + " and hands, pooling on the ground below you. ");
//             else DisplayText("girl-lube pours out of your swollen nipple over your " + Desc.Cock.describeCock(player, ) + " and hands, pooling on the ground below you. ");
//         }
//     }
// }
...
//             DisplayText("one of your " + num2Text(player.torso.cocks.filter(Cock.FilterType(CockType.HUMAN)).length) + " " + Desc.Cock.describeCock(player, randomCock) + "s ");
...
//             DisplayText("one of your " + num2Text(player.torso.cocks.filter(Cock.FilterType(CockType.HORSE)).length) + " " + Desc.Cock.describeCock(player, randomCock) + "s ");
//         else DisplayText("your " + Desc.Cock.describeCock(player, randomCock) + " ");
//     }
...
//             DisplayText("one of your " + num2Text(player.torso.cocks.filter(Cock.FilterType(CockType.DOG)).length) + " " + Desc.Cock.describeCock(player, randomCock) + "s ");
//         else DisplayText("your " + Desc.Cock.describeCock(player, randomCock) + " ");
//     }
...
//                 DisplayText("swelling, bulbous knot.  You feel it growing tighter and tighter until it's nearly twice the width of your " + Desc.Cock.describeCock(player, ) + ".  The pressure is an agonizing pleasure that only builds higher and higher as you come closer and closer to orgasm.  ");
//             else if (player.torso.cocks.filter(Cock.FilterType(CockType.HORSE)).length === 1)
//                 DisplayText("swollen equine sheath, slowly beginning to work its way up your shaft.  Pre-cum begins pouring from your " + Desc.Cock.describeCock(player, ) + ", slicking your " + Desc.Cock.describeCock(player, ) + " as you get ready to blow.  ");
//             else if (player.torso.cocks.filter(Cock.FilterType(CockType.TENTACLE)).length === 1)
//                 DisplayText("wiggling vine-like cock, growing rapidly.  You feel the rubbery surface of your tentacle prick contracting as it nears release.  Thick bulges of fluids collect and travel along the length of your " + Desc.Cock.describeCock(player, ) + ", the first of which is almost to your oversized tip.  ");
//             else if (player.torso.cocks.filter(Cock.FilterType(CockType.DEMON)).length === 1)
//                 DisplayText("tainted man-meat, growing rapidly.  You feel the nodules close to the base swell and pulse, starting a rippling wave of pleasure that migrates upwards.  The ring of bumps around your crown double in size, flaring out as your " + Desc.Cock.describeCock(player, ) + " prepares to unload.  ");
//             else if (player.torso.cocks.filter(Cock.FilterType(CockType.CAT)).length === 1)
//                 DisplayText("full, cat-like sheath.  You feel it tingling and throbbing as the spines pulsate with arousal.  You feel the barbs at the bottom thickening as bulges of fluid migrate through your " + Desc.Cock.describeCock(player, ) + " towards the tip.  ");
//             else if (player.torso.cocks.filter(Cock.FilterType(CockType.LIZARD)).length === 1)
//                 DisplayText("swollen member.  You can feel it tingling and bulging strangly as it begins to contract and pulse.  Pre-cum leaks from your " + Desc.Cock.describeCock(player, ) + " in a steady stream as each 'bulb' nearly doubles in size, and then one at a time, they deflate while your urethra dilates wide.  ");
//             else if (player.torso.cocks.filter(Cock.FilterType(CockType.ANEMONE)).length === 1)
//                 DisplayText("base.  The tentacles surrounding your " + Desc.Cock.describeCock(player, ) + " go nuts, constricting around it, inadvertently firing aphrodisiacs into the orgasmic flesh as they wring a potent, hip-jerking climax from you.  ");
...
//             DisplayText("Pleasurable spasms overwhelm you as cum erupts from your " + Desc.Cock.describeCock(player, ));
...
//                     DisplayText("Pulse after pulse of cum erupts from your " + Desc.Cock.describeCock(player, ) + " into your mouth.  You swallow what you can but it's too much for you.  Cum runs down your cock to pool on you as your orgasm drags on.  ");
//                 else DisplayText("Your orgasm never seems to end, and your world dissolves into the feelings from your " + Desc.Cock.describeCock(player, ) + " as it erupts jet after jet of cum into your mouth.  You nearly gag, cum overflowing to spray out in a river, pooling around you.  ");
//             }
//             else if (nippleFuck) {
//                 if (player.cumQ() < 25)
...
//                 else DisplayText("Your orgasm never seems to end, and your world dissolves into the feelings from your " + Desc.Cock.describeCock(player, ) + " as it erupts jet after jet of cum into your abused tit.  With a *pop*, your cock is forced free by the pressure. It continues to squirt semen everywhere, while a river of cum pours out of your dialated nipple, pooling around you.  ");
//             }
//             else {
//                 if (player.cumQ() < 25)
...
//                 }
//                 DisplayText("Your feel your knots bulging and swelling, growing tighter and tighter until they're nearly double the width of a " + Desc.Cock.describeCock(player, dogIndex) + ".  The agonizing pressure builds higher and tighter with every passing second as you get closer and closer to orgasm.  ");
//             }
...
//                 }
//                 DisplayText("You feel a pulsing in your sheath, slowly working its way up your " + Desc.Cock.describeCock(player, horseIndex) + "s.  Pre-cum pours from your " + Desc.Cock.describeCock(player, horseIndex) + "s, slicking the wobbly equine shafts as they get ready to blow.  ");
//             }
//             else { // Primary Normal
...
//                 else if (player.cumQ() < 500)
//                     DisplayText("Pulse after pulse of cum erupts from your " + Desc.Cock.describeCock(player, ) + " into your mouth.  You swallow what you can but it's too much for you.  Cum runs down your " + Desc.Cock.describeCock(player, ) + " to pool on you as your orgasm drags on.  Jizz rains over you the entire time from the rest of your \"equipment\".");
//                 else DisplayText("Your orgasm never seems to end, and your world dissolves into the feelings from your " + Desc.Cock.describeCock(player, ) + " as it erupts jet after jet of cum into your mouth.  You nearly gag, cum overflowing to spray out in a river, pooling around you.  Your other 'equipment' rains jizz upon you the whole while, soaking you in a cum-puddle.");
//             }
...
//             DisplayText(Desc.Breast.breastCup(player.torso.chest.get(0)));
...
//         // [Male]
//         DisplayText("You undress from your " + player.inventory.equipment.armor.displayName + " and take a seat down on the ground, your " + Desc.Cock.describeCock(player, ) + " pointing straight at your face. You stroke the erect member a few times, but then remember the cats back at the village. You stare at your " + Desc.Cock.describeCock(player, ) + "; the more you look at the cock, the more your mouth craves to suck on it. You open your mouth as wide as you can and lean towards your cock, only to be stopped halfway to the tip. You stick your tongue out and try to lick the head. You pretend you're rolling your tongue around the head, but this only makes your cock harder in eagerness. You throw your head forward in an attempt to flick your tongue against it, but the " + Desc.Cock.describeCock(player, ) + " is pulled back as you go forward. You slump your back onto the ground and let out a frustrated groan. The only thing you've managed to do is make yourself more aroused than when you started.");
//         player.stats.lust += 15;
//         return { next: Scenes.camp.returnToCampUseOneHour };
//         return;
//     }
...
//             DisplayText("You once again feel a slight chill as you reach the point-of-no-return and you let your " + Desc.Cock.describeCock(player, ) + " pop free of your mouth. You watch in glee as your seed slit parts to begin the sparkling shower you know is coming. Your cum, caught in the light of the golden cocksock, beads and twists in the light, crystallizing into a glittering shower. A ");
//             if (player.cumQ() < 25)
//                 DisplayText("sprinkle of");
//             else if (player.cumQ() < 250)
//                 DisplayText("rain of");
...
//                 DisplayText("\n\nWhile gasping for air, you scowl at your " + Desc.Cock.describeCock(player, ) + " in disapproval. That's when your " + player.Desc.Balls.describeSack(player) + " catches your attention. It's gleaming with your sex sheen and you watch one of your balls slowly slide off to one side.");

//                 DisplayText("\n\nYou think you can make it! You throw your other leg over your head and both feet come to rest on your back. You push your mouth towards your " + player.Desc.Balls.describeSack(player) + ", slowly walking your toes down your back. You are only an inch from your " + player.Desc.Balls.describeBalls(true, true, player) + " now and your own aroma fills your nostrils, spurring your on. Then, finally, you are there! And it nearly knocks you out! The sensation of your own balls in your mouth is incredible--you can feel them churning in your mouth--and your [feet] start kneeding your back. You bring your hands up to massage your " + player.Desc.Balls.describeBalls(true, true, player) + " as well, making them take turns in your mouth. Completely intoxicated by your own scent you loose all track of time--there is only the bliss of sucking, licking, and massaging your own balls...");

//                 DisplayText("\n\nAbrubtly you realize that your " + Desc.Cock.describeMultiCockSimpleOne(player) + " have soaked your torso in precum--apparently you've been on the edge for some time. In one swift motion, you pick your head up and slam your mouth down over your " + Desc.Cock.describeCock(player, ) + " leaving your hands to continue their ball massage.");

//                 // add cum quantity conditional text...
//                 DisplayText("\n\nThe release is immediate. You feel the contractions of your climax against your [face], your [feet] involuntarly start massaging your back, and you feel your " + Desc.Cock.describeCock(player, ) + " expand and contract in your mouth as seed pumps through it into your stomach. It's more relaxing than anything else--each contraction makes you feel like you might be melting a little, like you might remain in this position forever.");

//                 DisplayText("\n\nYour [feet] and hands are still masagging their respective charges when you realize you are starting to go flaccid! You make an attempt to massage every last drop of cum from your " + player.Desc.Balls.describeBalls(true, true, player) + ", sucking on your " + Desc.Cock.describeCock(player, ) + " continuously as it goes down. It slowly slips from your mouth once it's completely deflated, causing you to frown slightly. Still feeling great in this position, you go down on your " + player.Desc.Balls.describeSack(player) + " again--alternating between licking and sucking them with your mouth and massaging them with your hands.");
...
//     DisplayText().clear();
//     DisplayText("You look at the thing in front of you and sigh, your " + Desc.Cock.describeMultiCockShort(player) + " and " + Desc.Vagina.describeVagina(player, player.torso.vaginas.get(0)) + " dripping with fluids. With a nervous sigh you step into the underwear looking device and slip it up your legs, the cold metal feeling so good on your " + player.skinDesc + ", sending a rush of feelings up your body. You slip your " + Desc.Cock.describeCock(player, ) + " down and into a hole on the front of the belt, the extra length sticking out on the other side of it. Underneath the hole and right above your pussy is another metal square with what feels like a small nub on the inside rubbing against your clit. Shivering from the feeling of it, you stay there for a moment, waiting in anticipation. Finally, you reach down to the side of the belt and flick the switch to the on position.\n\n");
...
//         DisplayText("panting lustily as you envision being caught masturbating your " + Desc.Breast.describeNipple(character, character.torso.chest.get(0)) + "s.");
//     else if (player.stats.cor < 33)
//         DisplayText("blushing a bit as you look down at your " + Desc.Breast.describeNipple(character, character.torso.chest.get(0)) + "s.");
//     else if (player.stats.cor < 66)
//         DisplayText("shivering as the air hits your exposed " + Desc.Breast.describeNipple(character, character.torso.chest.get(0)) + "s.");
//     else DisplayText("smiling to yourself as you blatantly oogle your " + Desc.Breast.describeNipple(character, character.torso.chest.get(0)) + "s.");
...
//     DisplayText("  Your free fingers slowly stroke around the outer edges of your " + Desc.Breast.describeNipple(character, character.torso.chest.get(0)) + "s' lips, pausing when you feel a tiny sensitive clit-like nub just inside the top of the opening.\n\n");

//     DisplayText("Shivering with pleasure, you kneel down to prevent your legs from going out from underneath you.   Your " + Desc.Head.describeFace(player) + " flushes hotter as you toy with the slippery nipple-cunts, feeling them growing hard and puffy as you turn yourself on more and more.  ");
...
//             else DisplayText(Desc.Cock.describeCock(player, ));
...
//         if (player.torso.balls.quantity > 0) DisplayText("  Rocking slightly inside your sack, your " + player.Desc.Balls.describeBalls(true, true, player) + " repeatedly clench up against your body, ready to release.");
//         DisplayText("\n\n");
//     }
//     // (ORGAZMO)
//     DisplayText("A slow wave of contractions starts deep inside each of your " + Desc.Breast.describeNipple(character, character.torso.chest.get(0)) + "s.  It intensifies as it rises towards the surface of your " + Desc.Breast.describeBreastRow(player.torso.chest.get(0)) + ", reaching a crescendo that brings you to the peak of pleasure.  Your eyes roll back as you slump down in orgasmic bliss, fingers pumping relentlessly at you slippery nipple-holes.  Noisy wet squelches and incessant moaning rouse you from your pleasure-induced coma, eventually waking you back to reality.\n\n");
...
//     // Real aftermath
//     DisplayText("Judging by the sky, at least an hour has passed.  You sigh and pry your cramped fingers from your aching " + Desc.Breast.describeNipple(character, character.torso.chest.get(0)) + "s, rubbing the sore entrances with your palm before you climb back up onto your " + LowerDesc.Body.describeFeet(player) + ".  As you get dressed, you're very conscious of how much better you feel from the wonderful finger-fuck.  ");
//     if (player.stats.cor > 66)
...
//         DisplayText(Desc.Cock.describeCock(player, primary) + " and lift up, pressing it tightly against your belly as you begin to stroke along the sensitive underside.  ");
//         if (player.cumQ() > 500)
...
//             DisplayText("a ");
//         else DisplayText("your ");
//         DisplayText(Desc.Cock.describeCock(player, primary) + " and lift it up, curving it slightly as you begin to stroke the underside with long, fluid caresses.  You even manage to bend down and give it a lick, forcing you into a pleasurable shudder.");
//         if (player.cumQ() > 500)
//             DisplayText("  Thick streams of pre-cum start to drizzle from your tip, forced out due to your prodigious production of sexual fluid.");
//         else if (player.cumQ() > 100)
//             DisplayText("  A dribble of pre-cum starts to leak from the tip as you get more into the act.");
...
//         // STROKE (long)
//         DisplayText("You smear your pre-cum over the tip, rolling your palm across the sensitive tip in a way that makes it hard to stand.  Meanwhile your other hand is making great use of your incredible length, jacking you off with long fluid strokes.  In no time flat, you can feel your " + Desc.Cock.describeCock(player, ) + " pulsing in your grip, growing harder in time with your fevered stroking.");
//         if (player.torso.cocks.count === 2)
//             DisplayText("  Your other dick mimics its lucky brother's pleasure, even though it's been ignored in order for you to focus on your current 'toy'.");
//         else if (player.torso.cocks.count > 2)
//             DisplayText("  Your other " + Desc.Cock.describeMultiCockShort(player) + " mimic their lucky brother's pleasure, even though they've been ignored in order for you to focus on your current 'toy'.");
...
//     if (player.torso.balls.quantity > 0)
//         DisplayText("your " + player.Desc.Balls.describeBalls(true, true, player));
...
//             DisplayText(" of your " + num2Text(player.torso.chest.countNipples()) + " " + Desc.Breast.describeNipple(character, character.torso.chest.get(0)) + "s quiver, ");
...
//     DisplayText("Finally able to get the release you weren't able to give yourself, you feel an orgasm mounting deep within you.  You let out a loud, equine whinny as you hump the toy faster and faster, pounding her with your " + Desc.Cock.describeCock(player, x) + " until the pleasure overwhelms you.  You cry out as you cum, squirting your centaur-cum as far into the toy as you can shoot it");
...
//         DisplayText(".\n\nSated, you spend a few blissful minutes enjoying the warmth and tightness of the mare-like onahole until your " + Desc.Cock.describeCock(player, x) + " is soft inside it.  You scamper off of her, dropping back to your four equine feet.  <b>You are startled to see glittering gems pouring from her ");
//         if (player.cockArea(x) >= 30)
//             DisplayText("horsecunt");
//         else DisplayText("asshole");
...
//         DisplayText("Sated, you spend a few blissful minutes enjoying the warmth and tightness of the mare-like onahole until your " + Desc.Cock.describeCock(player, x) + " is soft inside it.  You scamper off of her, dropping back to your four equine feet.  With a contented yawn, you disassemble the toy and haul it off back to your stash, leaking your cum the entire way.");
//     }
...
//     DisplayText("Almost immediately, your " + Desc.Cock.describeCock(player, x) + " perks up like a pet expecting to be fed, and you have to admit that you plan to give that squirming tentacle exactly what it desires - a hot, slippery slit to nestle inside of.  Already, your [vagina] has grown ");
//     if (player.torso.vaginas.get(0).wetness <= 2)
//         DisplayText("moist");
//     else if (player.torso.vaginas.get(0).wetness <= 3)
//         DisplayText("wet");
...
//     if (y >= 0) DisplayText("  It loops around your " + Desc.Cock.describeCock(player, y) + " while you fight with it, strangling the other phallus in tight coils of squeezing, floral friction.");
...
//     if (y >= 0) {
//         DisplayText("  Your " + Desc.Cock.describeCock(player, y) + " is getting jacked off by the engorged cock-coil's motions and slowly leaks creamy pre over the jerking length.");
...
//     DisplayText(".");
//     if (player.torso.cocks.filter(Cock.FilterType(CockType.TENTACLE)).length === 2) {
//         DisplayText("  Your untended " + Desc.Cock.describeCock(player, y) + " blows spunk over you ");
//         if (player.cumQ() < 50)
...
//                 DisplayText("  You quickly fall asleep, spent. ");
//             else if (player.stats.lib < 55)
//                 DisplayText("  You roll and begin to doze, your semi-erect " + Desc.Cock.describeCock(player, ) + " flopping against you. ");
//             else if (player.stats.lib <= 80) {
//                 DisplayText("  As you close your eyes and relax, your " + Desc.Cock.describeCock(player, ) + " surges back to erectness, ensuring ");
//                 if (player.stats.cor < 50)
//                     DisplayText("your dreams will be filled with sex.");
//                 else DisplayText("you dream in a depraved kinky fantasia.");
//             }
//             else DisplayText("  You groan and drift to sleep, your rigid " + Desc.Cock.describeCock(player, ) + " pulsing and throbbing with continual lust.");
//         }
//         // Multi Cock
//         if (player.torso.cocks.count > 1) {
//             if (player.stats.lib < 30)
...
//     }
//     else {
//         DisplayText("Much to your annoyance and embarrassment, you feel the need to relieve yourself of your tension. Sighing in reservation, you remove the used onahole from your sack. Operating with a mind of its own, your " + Desc.Cock.describeCock(player, ) + " springs to attention, anticipating the coming stimulation and release. Your member easily pushes past the opening in the toy and you begin working your penis with some vigor. Pleasure begins to pulse through your " + Desc.Cock.describeCock(player, ) + " as you build yourself up. The force of the building fluids pushes against your inner organs, creating the paradoxical sensation of pain and pleasure. Pure instict takes over, and your hips begin to buck reflexively. With a sudden, sharp pinch at the base of your member, the need to cum takes over your body");
