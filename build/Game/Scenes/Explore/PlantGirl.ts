...
import Desc.Breast from '../../Descriptors/Desc.Breast';
import Desc.Cock from '../../Descriptors/Desc.Cock';
import Desc.Vagina from '../../Descriptors/Desc.Vagina';
...
export class PlantGirl {
    ...
    public fuckMyAssPlantLadyWhileImTrapped(character: Character) {
        ...
        if (character.torso.cocks.count > 0) DisplayText(Desc.Cock.describeMultiCockShort(character));
        if (character.gender === Gender.HERM) DisplayText(" and ");
        if (character.torso.vaginas.count > 0) DisplayText(Desc.Vagina.describeClit(character));
        ...
        else if (character.torso.vaginas.count > 0) DisplayText("your " + Desc.Vagina.describeClit(character));
        ...
        if (character.torso.cocks.count > 0) {
            ...
            if (shortestCock.length < 48) {
                ...
                DisplayText(Desc.Cock.describeCock(character, shortestCock) + " flap");
                ...
                DisplayText(".  The creature twists and jerks at the head of your cock and works diligently to stimulate your rock hard " + Desc.Cock.describeMultiCockShort(character) + ", intent on making you moan out for her.");
            }
        }
        // PC has a vagina:
        ...
        DisplayText(" to your ");
        if (character.torso.balls.quantity === 0) DisplayText(Desc.Breast.describeNipple(character, character.torso.chest.get(0)));
    ...
    public trappedFlowerSexBlowjobAhoy(character: Character) {
        ...
        // (If PC has a cock(s):
        else if (character.torso.cocks.count > 0) DisplayText("wrap themselves around your " + Desc.Cock.describeMultiCockShort(character) + " and begin to squeeze");
        // (If PC has a pussy:
        else if (character.torso.vaginas.count > 0) DisplayText("take hold of you Desc.Vagina.describeClit(character) and tug hard");
        // (If PC is genderless:
    ...
    public trappedPlantSexPussy(character: Character) {
        DisplayText().clear();
        DisplayText("Staring down at your " + Desc.Cock.describeMultiCockShort(character) + ", the plant woman's eyes become fixated and betray a sense of longing, of curiosity, and eagerness.  Approaching your well restrained body, she takes [oneCock] into her soft hand and brushes it's sensitive head against her smooth pelvis, fairly close to the creature's moist and sweet smelling pussy.  Proceeding to wrap its arms around you, the plant woman takes [oneCock] in-between her legs and against her clit, signaling the creature's intent to plunge its hungry cunt down on your dick.");
    ...
    public trappedPlantSexPussyGOOO(character: Character) {
        ...
        // (if > 4 inches)
        else DisplayText("\n\nShe presses her body against yours, causing your rock hard Desc.Cock.describeMultiCockShort(character) to jut upward against her leafy stomach.");
        DisplayText("\n\nRaising herself ever so slightly, the plant woman wraps her legs around and straddles you as she lowers her pussy onto the tip of " + Desc.Cock.describeCock(character, x) + ".  The female perversion of nature slowly takes the entirety of your cock in her, causing your prick to sensually ease through her tight cunt like a mole crawling through the fertile earth.  The sensation is too much, causing you to shudder and twitch uncontrollably.  Your dominant partner rests her ");
// (If height is 36 inches to 72 inches:
        ...
        else if (character.tallness < 96) DisplayText("forehead against your chest, sniffing you intensely as she takes in your musk.  The creature of flora and warped flesh moans and shivers as she acquires your " + Desc.Gender.mf(character, "manly", "feminine") + " scent, and ");
        ...
        DisplayText(" as she slowly begins to work her hips, grinding the innards of her hot and moist sex against your " + Desc.Cock.describeCock(character, x) + ".");
        // (if one cock:
        ...
        // Vagina:
        if (character.torso.vaginas.count > 0) DisplayText("  Cumming hard, your " + Desc.Vagina.describeClit(character) + " releases a liberal stream of juices down the vine that fucks you, dissolving into the appendage as you moan in furious release.");
    ...
    public trappedPlantSexWantsToBlowYa() {
        DisplayText().clear();
        DisplayText("The plant woman looks your body up and down, seemingly torn between what tickles her fancy and how she can take your body.  Her almost childlike darting of her eyes stops when she lays her sight on your Desc.Cock.describeMultiCockShort(character), sending an aroused shiver through her body as she appears to finalize her decision.  Like a child walking to the local stream for a swim, she proceeds towards you in an almost skipping like fashion.  Reaching your naked body, she promptly sinks to her knees and takes your " + Desc.Cock.describeMultiCockShort(character) + " into her hand");
    ...
    public trappedPlantSexDontBlowMe() {
        DisplayText().clear();
        DisplayText("It may seem she wants to take your [oneCock] and suck on it like a sugar cane, but you aren't keen on her choice of how to pleasure you.  Remaining flaccid, you stare down at the plant woman and tell her you aren't interest in a little oral love for your " + Desc.Cock.describeMultiCockShort(character) + ", aware of the fact that she can't understand you.  Despite your words likely sounding like jibberish, the plant woman understands your intent and motions for you to make up your mind; given the slightly annoyed expression on her face, you had better make it quick.");
    ...
    public trappedPlantSexBlowMe() {
        ...
        if (character.longestCockLength() < 24) {
            ...
            DisplayText(" that will be tending to them today.  Eager to rise to said challenge, the plant woman attempts to take your " + Desc.Cock.describeMultiCockShort(character) + " into her mouth and ");
            ...
            if (character.torso.cocks.count === 1) DisplayText(".");
                ...
                DisplayText(", while she cheek fucks the remainder of your " + Desc.Cock.describeMultiCockShort(character) + ".");
            }
            ...
            DisplayText("\n\nHaving to scoot back a fair bit to enjoy her catch, the plant woman kneels against the dirty ground and attempts to take your " + Desc.Cock.describeCock(character, character.torso.cocks.get(0)) + " into her mouth.  You feel her attempt to fit your rod into her little mouth; teeth accidentally scraping along your head, the buckling of jaws, and soft lips that are rebutted are all the signs you need to understand that your " + Desc.Cock.describeMultiCockShort(character));
    ...
    public plantAnalGivingTheDick() {
        DisplayText().clear();
        DisplayText("The sight of this nice, ample ass and the thought of fucking a supple  little pucker piques your " + Desc.Cock.describeMultiCockShort(character) + ", causing ");
        if (character.torso.cocks.count === 1) DisplayText("it");
        else DisplayText("them");
        ...
        DisplayText(" will hopefully penetrate is a winner in the tightness department, your " + Desc.Cock.describeMultiCockShort(character) + " surge");
        if (character.torso.cocks.count > 1) DisplayText("s");
        ...
        if (character.torso.cocks.count > 1) DisplayText("\n\nThe rest of your " + Desc.Cock.describeMultiCockShort(character) + " erupt as well, coating her butt and thighs in sticky jizz.  Like a true slut, the plant woman grabs your ejaculating prick and crams it into her fuck-hole, her pussy milking you of all the cum you can muster up.");
    ...
    public failStruggle69() {
        ...
        else DisplayText(Desc.Butt.describeButthole(character.torso.butt) + " as she dives nose first into the under crevice of your " + Desc.Butt.describeButt(character) + ", rubbing the bridge of it between your cheeks as she giggles");
        DisplayText(".");
    ...
    public struggle69Plant(pt: number = 1) {
        ...
        if (pt === 2) {
            ...
            // PC pussy chosen:
            if (target === 2) DisplayText(", allowing her soft lips to surround your " + Desc.Vagina.describeClit(character) + ", 'trapping' it for her much anticipated assault.");
            // PC cock chosen:
            else DisplayText(".  Wasting no time with 'formalities,' she stuffs your " + Desc.Cock.describeCock(character, character.torso.cocks.get(0)) + " into her mouth, firmly sealing her lips around your shaft and suckling along the sensitive flesh of your glans.");
        }
        // [69!, TsI: 1.6a, give her oral]
            ...
            // PC cock chosen:
            else DisplayText(" as she wastes no time with 'formalities,' stuffing your " + Desc.Cock.describeCock(character, character.torso.cocks.get(0)) + " into her mouth, firmly sealing her lips around your shaft and suckling along the sensitive flesh of your glans.");
        }
        ...
        if (target === 2) {
            ...
            // (Herm support:
            if (character.torso.cocks.count > 0) {
                DisplayText("\n\nIf that wasn't bad enough, the unsporting woman also takes to your " + Desc.Cock.describeMultiCockShort(character) + " and strokes ");
                if (character.torso.cocks.count === 1) DisplayText("it");
                else DisplayText("them");
    ...
    public defeatOrDomPlantAndCuntFuck() {
        ...
        if (character.torso.balls.quantity === 0) DisplayText(Desc.Cock.describeMultiCockShort(character));
        else DisplayText(Desc.Balls.describeBalls(true, true, character));
        ...
        if (character.torso.vaginas.count > 0) DisplayText("; your Desc.Vagina.describeVagina(character, character.torso.vaginas.get(0)) quivers with the need for release, letting loose with its own torrent of lady fluids as you moan in orgasm");
    ...
    public victoryOverPlantGalWithPCCockCorrupted(newl: boolean = false) {
        ...
        DisplayText("After an eternity of ravaging her pussy, you feel your load building up pressure and getting ready to explode.  You tighten your grip on the plant woman's hair and with one last thrust fill her womb with your corrupted semen.  You jerk her hair back, forcing her head back towards your mouth as you begin to neck her.  \"<i>AuuughhhAHHHHHHHHHHHHHHH!</i>\" she screams out as you pull on her hair, with her pussy clamping down on your " + Desc.Cock.describeCock(character, x) + ".  Her fuck hole ever so eager to receive your seed, her body convulses violently as you continue to fire more semen into the floral vixen's cervix.  The excretion is too much, and with a groan, you pass out on top of her.");
    ...
    public victoryDefeatPlantGirlGetBJDARKVADER() {
        DisplayText().clear();
        DisplayText("Your " + Desc.Cock.describeMultiCockShort(character) + " become");
        if (character.torso.cocks.count === 1) DisplayText("s");
    ...
    public victoryDefeatPlantGirlGetBJMainSCREENON() {
        ...
        // ______________________________________________________________________________
        // (if Non-goo:
        if (!character.torso.hips.legs.isGoo()) DisplayText(".  She pulls your dick out of her mouth and closes her eyes as she gets ready to catch the rest of your load with her mouth.  Thick globs of semen erupt from your Desc.Cock.describeMultiCockShort(character) and strike her in the face.  She herself orgasms as your torrent of semen washes over her head and chest, covering both liberally.");
        // (If goo:
    ...
    public plantGirlPCWinGetTentacleBJ() {
        ...
        if (character.torso.cocks.get(x).length < 48) {
            ...
            DisplayText(" and begins to squeeze tighter and tighter.  “Owww! Owww! Okay, Okay! I get it!” you cry out as you once again ram your " + Desc.Cock.describeCock(character, x) + " down her throat.  The plant woman responds by massaging your ");
            if (character.torso.balls.quantity > 0) DisplayText("balls");
        ...
        // [If tentacle cock is longer than 48 inches]
            ...
            if (character.torso.balls.quantity > 0 || character.torso.vaginas.count > 0) {
                ...
                else DisplayText(Desc.Vagina.describeVagina(character, character.torso.vaginas.get(0)) + " slithers");
    ...
    public beatPlantGirlDomLetsFuckAnal() {
        ...
        if (inCombat) {
            ...
            DisplayText("\n\nYou grunt and moan as your " + Desc.Cock.describeCock(character, x) + " shoots its anal payload ");
    ...
    public defeatPlantgirlBlowAndButtfuckPure() {
        // V 1.6 and D 1.6
        DisplayText().clear();
        DisplayText("With your hands on your hips you " + Desc.Gender.mf(character, "walk", "sway"));
    ...
    public defeatPlantgirlBlowAndButtfuckPure() {
        ...
        DisplayText(Desc.Vagina.describeClit(character) + ".  The plant woman yelps in surprise as the vine makes contact with your labia, causing you to jump a little.  You turn to face the plant woman, who is blushing profusely and resting her hand on her pussy.  Looking at the vegetation, you deduce that she must be able to feel you along her vines and that these creepers may also function as penile appendages.  A grin spreads across your face as the realization hits you, and you bring the vine back to your sex and tease your vulva.  Soft moans escape the plant girl as the head of the perverted vegetation brushes past your clit, and you ");
        // (pure:
        if (character.stats.cor < 50) DisplayText("giggle");
        // Corrupted:
        else DisplayText("smirk");
        DisplayText(" at the woman's predicament.  Deciding to stop teasing the poor girl, you take the head of the creeper and push it into your pussy, edging it upwards at a gradual pace so that your partner can feel the contours of your " + Desc.Vagina.describeVagina(character, character.torso.vaginas.get(0)) + ".");
...
[If you chose just the vine, V and D 1.6vp] You slip a hand to your
 	...
 	(if female) Desc.Breast.describeBreastRow(character.torso.chest.get(0)) and start to massage your hardening nippleDescriptAll().

	(if herm)) member and begin to (fondle your Desc.Cock.describeCock(character, character.torso.cocks.get(0))).
...
(if herm: slips her hand down to your Desc.Cock.describeMultiCockShort(character), taking (it/one at a time) into her hands, stroking (it/them) furiously as you pound her moist love canal.  You let up on the rough fucking for a brief moment as she tends to your dick(s), taking in the euphoria of her soft, leaf like texture on your naughty bit(s). )
...
Eventually all good things must come to an end;  Your inevitable orgasm approaches, body trembling in anticipation at the thought of covering this creature in cum.  Sexual fluids rush out of you as you concentrate on pushing, forcing them out. Instinct takes hold as you mash your pelvis against the plant woman's lap. (Your Desc.Cock.describeMultiCockShort(character)) explode(s),
...
(Victory and Dominant scenes converge here, V and D 1.7): Catching the scent of her lubricating fluids on her delicate clitty, you breathe heavily, shoulders rising and falling in tandem with your respiration. (If dominant: Looking downward, the plant woman sights) Your Desc.Cock.describeMultiCockShort(character) [and]/ (clitdescript()/
If genderless: Desc.Breast.describeBreastRow()
...
(if vagina and/or cock: (Desc.Vagina.describeVagina(character, character.torso.vaginas.get(0))/   /and/ Desc.Cock.describeMultiCockShort(character)/
...
(Desc.Vagina.describeVagina(character, character.torso.vaginas.get(0))/ Desc.Cock.describeMultiCockShort(character)/ assholeDescript(0) ).
...
(Desc.Cock.describeMultiCockShort(character)/ Desc.Vagina.describeVagina(character, character.torso.vaginas.get(0))/assholeDescript( ) )
against her face, slathering (it/them) down her forehead and past her nose as
PC has cock(s): (gravity takes your Desc.Cock.describeMultiCockShort(character) and prods (it/them) against her lips)
