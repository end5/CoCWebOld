...
export default class Gargoyle {
    ...
    public constructor() {
        User.flags.set(CharacterType.Gargoyle, this.data);
    }
    ...
    private breakZeChains(character: Character) {
        ...
        textElement.text = "";
        MainScreen.doNext((char: Character) => { this.nameZeGargoyle(char, textElement); });
    }

    private nameZeGargoyle(character: Character, textElement: InputTextElement) {
        ...
        this.data.name = textElement.text;
        DisplayText().clear();
    ...
    public returnToCathedral(character: Character, woken: boolean = false) {
        ...
        if (Time.hour <= 9 || Time.hour >= 18 || woken) {
            if (!woken) {
                DisplayText("\n\nIn the dim ");
                if (Time.hour <= 9) DisplayText("early morning");
        ...
        MainScreen.getBottomButton(9).modify("Leave", Scenes.camp.returnToCampUseOneHour);
    }
    ...
    private gargoylesAreGirlfriends(character: Character) {
        ...
        MainScreen.getBottomButton(4).modify("Leave", Scenes.camp.returnToCampUseOneHour);
    }
