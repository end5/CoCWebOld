...
For further information and license requests, Dxasmodeus may be contacted through function message at the Futanari Palace. http://www.futanaripalace.com/forum.php. */
export interface GiacomoFlags {
    met: number;
}

const giacomoFlags: GiacomoFlags = {
    met: 0,
};
...
function nightSuccubiRepeat(character: Character): NextScreenChoices {
    ...
    if (character.gender === 0) {
        ...
        // REPEAT
            ...
            DisplayText("\"<i>Ahem.</i>\", the woman says meekly, \"<i>I hate to bother you, but I was sent by the CoC writers and staff to hand you </i>\"\n\n");
