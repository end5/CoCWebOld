export class Xmas {
    ...
    public openXmasPresent(): void {
        ...
        if (player.stats.cor >= 90 || monk >= 5 || player.statusAffects.has(StatusAffectType.Exgartuan) || amilyScene.amilyCorrupt() || Flags.list[FlagEnum.UNKNOWN_FLAG_NUMBER_00283] > 0 || Flags.list[FlagEnum.UNKNOWN_FLAG_NUMBER_00282] > 0 || Flags.list[FlagEnum.NIAMH_STATUS] > 0) {
            ...
            DisplayText("Before you can utter a single word of confusion or protest, the elf moans and the cock erupts, spurting a rope of cum into your hair.  The next blast takes you across the nose, then on your lips, then your chin, and finally onto your " + BreastDescriptor.describeAllBreasts(player) + ".  Shocked and dripping, you stand dumbfounded as the elf plants a kiss on your lips, tears off the box, and runs away with her cock flopping and buzzing in time with each step.  There's no way to catch her in this darkness.\n\n");
    ...
    public dickXmasElfGo(): void {
        ...
        if (player.torso.cocks.get(0).area < 80) {
            ...
            if (player.cumQ() >= 250) DisplayText("  The spunk quickly fills her womb and flows back out her entrance, frothing and bubbling as it drips over your " + LowerBodyDescriptor.describeHips(player) + ".  ");
            ...
            DisplayText("Aside from your " + CockDescriptor.describeCock(player, player.torso.cocks.get(0)) + ", your body has gone completely numb from the waist down.  You glance down and see your " + LegDescriptor.describeLegs(player) + " twitching and convulsing under the elf's assault.   She's so hot inside, it's like her pussy's candy-coated in liquid pleasure.   You fuck her harder and harder, squeezing her hips tightly and roughly fucking her magical pussy.   Somehow you're on the edge again, about to unload.  You start counting in your head, trying to resist another orgasm.  You know if you do you'll never be able stop.  You doubt you'll even be able to think.\n\n");

            DisplayText("Your effort at holding out totally fails – you start counting in time with each thrust, tying the numbers into the feel of the velvet cock-sleeve as it massages your " + CockDescriptor.describeCock(player, player.torso.cocks.get(0)) + ".   The elf smiles condescendingly and taunts, \"<i>I can see you've already lost the ability to resist the pleasure.  Just give in, and enjoy the night.  I'll be riding you 'til morning.</i>\"\n\n");
            ...
            DisplayText("You snap out of it and the elf is smirking down at you, stationary.  You feel totally numb – your " + CockDescriptor.describeCock(player, player.torso.cocks.get(0)) + " has all of your sensation, all of your sense of touch.   On their own, your " + LowerBodyDescriptor.describeHips(player) + " continually rise and fall, pumping into her with noisy explosions of pleasure that leave you gasping and writhing.  Every time you start to think something, the vise-like tunnel slides down you and squeezes your " + CockDescriptor.describeCock(player, player.torso.cocks.get(0)) + ", interrupting any attempt at thought.  You give up on thinking and start drooling all over yourself, your world fading into a heaven of constant pleasure and repeated orgasms.\n\n");
            ...
            //(TOO BIG)
            DisplayText("She pushes you down onto your bedroll and whispers, \"<i>Time to enjoy your present.</i>\"\n\n");
            DisplayText("The elf grabs ahold of your " + CockDescriptor.describeCock(player, player.torso.cocks.get(0)) + " with both hands and cuddles against it as if it were a person, planting kisses along the edge of its " + player.cockHead() + ".  She laughs, \"<i>Oh my, you're so big!  I almost wish I was big enough to take this bad boy.  Believe me, you haven't lived until you've been milked by an elf's cunt.</i>\"\n\n");

            DisplayText("She wraps her arms around it and begins licking it, squatting down and standing up, jerking you off with her whole body.  Each time her cute bottom bumps your " + BreastDescriptor.describeAllBreasts(player) + " ");
            ...
            DisplayText("Before you can puzzle out her meaning, she takes a big gulp of air, grabs your " + player.cockHead() + " with both hands, and presses her lips into your urethra.  She blows into it with a look of intense concentration.  You can feel your urethra filling, expanding with something, but it feels more like liquid than air, tingling as it slides deep into your shaft towards your ");
            ...
            if (player.torso.balls.quantity > 0) DisplayText("r " + BallsDescriptor.describeBalls(true, true, player));
            ...
            DisplayText("Thick ropes of your orgasmic goop splatter into her hair, and each successive blast comes out with less and less force, until you're leaking a steady stream of cum that rolls down your " + CockDescriptor.describeCock(player, player.torso.cocks.get(0)) + " and soaks the pointy-eared woman completely.   As you release your prodigious load the scent of cinnamon fills the air, and you dumbly wonder if it's some side effect of the magic she used on you.  Regardless, cum keeps leaking out over the elf and onto you, and you eventually lose consciousness from perpetual orgasm.");
        }
