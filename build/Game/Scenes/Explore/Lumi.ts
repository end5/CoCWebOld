...
export default class Lumi {
    public data: LumiFlags = {
        met: false
    };
    public constructor() {
        User.flags.set(CharacterType.Lumi, this.data);
    }
    ...
    public lumiEncounter() {
        ...
        if (!this.data.met) {
            ...
            MainScreen.doYesNo(this.lumiLabChoices, Scenes.camp.returnToCampUseOneHour);
        }
        else {
            // placeholder text for outside the cathedral
    ...
    public lumiLabChoices(character: Character) {
        ...
        MainScreen.displayChoices(["Shop", "Enhance", "", "", "Leave"], [this.lumiShop, enhance, undefined, undefined, Scenes.camp.returnToCampUseOneHour]);
    }
    ...
    private lumiPurchase(character: Character, itype: string) {
        ...
        if (character.inventory.gems >= cost) {
            ...
            character.inventory.items.createAdd(character, ItemType.Consumable, itype, this.lumiLabChoices);
        }
        else {
    ...
    private lumiEnhanceGo(character: Character, itype: string) {
        ...
        character.inventory.items.createAdd(character, ItemType.Consumable, nextItem, this.lumiLabChoices);
    }
}
