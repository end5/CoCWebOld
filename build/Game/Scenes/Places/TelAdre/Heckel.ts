    ...
    */
    ...
    private heckelOrallyFixated() {
        ...
        //Repeat
            ...
            //[<PC IS MALE OR HERM> 
            if (player.torso.cocks.count > 0) DisplayText("You use one hand to fondle her balls, letting them roll over your fingers and pinching the skin lightly. Your other hand finds its way to your crotch, where you begin stroking your " + Desc.Cock.describeCock(player, player.torso.cocks.get(0)) + " in time with her weak thrusts. Within moments you've brought yourself to a stiffening arousal, the cold air making your exposed " + Desc.Cock.describeCock(player, player.torso.cocks.get(0)) + " twitch slightly.\n\n");
            //[<PC IS FEMALE>
            else if (player.torso.vaginas.count > 0) DisplayText("You use one hand to fondle her balls, letting them roll over your fingers and pinching the skin lightly. Your other hand finds its way to your crotch, where you roll your " + Desc.Vagina.describeClit(player) + " between your first two fingers. You let two fingers sink into your " + Desc.Vagina.describeVagina(player, player.torso.vaginas.get(0)) + ", curling them upwards and moaning around the giant dog dick in your mouth.  Your fingers bring you to the edge of orgasm, but you lack the stimulation to send yourself over just yet.\n\n");
            ...
            //<PC IS MALE OR HERM> 
            else DisplayText("A growl rises in Heckel's throat, and you recognize the sign of her impending orgasm. It's all you can do to keep your balance as her thrusts into your throat come more frequently. Although you are barely able to breath between thrusts, your free hand feverishly strokes your " + Desc.Cock.describeCock(player, player.torso.cocks.get(0)) + ", your hand becoming slippery with pre as your own orgasm builds. Heckel's paws grab your head and pull you deeply on to her dick as you feel it spasm, and you begin to moan as you feel her load travelling through her cock and finally spilling directly into your stomach. The warmth of her seed spreads throughout your body until it meets the warmth of your groin, and your cock erupts in your hand as it sets your over the edge.\n\n");
    ...
    //anal
    private heckelLovesDaAnal(loss: boolean = false) {
        DisplayText().clear();
        //rejection - ass not loose enough
        if (player.analCapacity() <= 20 && !loss) {
            DisplayText("Heckel lets out a barking laugh when you suggest using your " + Desc.Butt.describeButt(player) + ", ruffling your hair playfully. \"<i>Know your limits, " + player.short + ", I'd tear you apart down there. I'm sure there are plenty of others in this realm who can help you out with that.</i>\"\n\n");
            return { next: Scenes.camp.returnToCampUseOneHour };
            return;
        }
        //success - requires ass to be 'a little loose'
        DisplayText("Heckel's eyes flash as her grin splits her face, and for just a moment you wonder if this might have been a bad idea. Before you can object, however, she's pushing you down onto your stomach, your arms and " + Desc.Leg.describeLegs(player) + " draped over either side of the wooden bench.\n\n");

        DisplayText("You half expect her to just shove herself in right there, but she thankfully holds off. Instead, you feel her rough paws grab and knead either side of your " + Desc.Butt.describeButt(player) + " as she lets out a low growl.");
        //[<IF TONE OVER 80>
        ...
        DisplayText("One hand releases your " + Desc.Butt.describeButt(player) + " and you can hear the sound of her stroking herself. You start to turn your head around to watch, but she firmly presses you back down against the bench. \"<i>Now now partner, I told you to stay there. When you're the alpha dog around here, then you can make the rules.</i>\" Deciding this treatment isn't so bad anyway, you relax and let her hand continue to knead your " + Desc.Butt.describeButt(player) + ".\n\n");

        DisplayText("The sound of her stroking stops, and you bite your lower lip. You feel the bench shift beneath you as she changes position, and a moment later she pulls both of your asscheeks apart to expose your " + Desc.Butt.describeButthole(character.torso.butt) + ". You tense for the inevitable penetration, but instead of a hard cockhead poking at your backdoor you feel something warm and wet. Heckel is licking you!\n\n");

        DisplayText("Her large tongue feels like sandpaper as it licks up and down your anus, your spread cheeks exposing you to the world. You can feel her wet nose on your sensitive skin, and the contrast with her warm tongue makes you shiver. Her tongue pokes and prods at your " + Desc.Butt.describeButthole(character.torso.butt) + " before slipping painlessly in, swirling expertly around before pulling out and licking some more.\n\n");

        //[<IF PC HAS PENIS AND VAGOO> 
        if (player.torso.cocks.count > 0 && player.torso.vaginas.count > 0) DisplayText(Desc.Cock.describeMultiCockSimpleOne(player, true) + " is trapped between you and the wooden bench, and you know Heckel won't let you shift position to free it. Your " + Desc.Vagina.describeVagina(player, player.torso.vaginas.get(0)) + " is also being ignored, and having so much pleasure with so little stimulation is driving you crazy. You hump weakly up and down, trying to draw some pleasure out of the bench beneath you while simultaneously pushing her rolling and massaging tongue closer to your aching slit, but she ignores you and only licks deeper. She buries her face in your ass entirely, her cold nose and teeth rubbing up against your sensitive skin as her tongue pushes as far inside of you as she can get it.\n\n");

        //[<IF PC HAS PENIS>
        else if (player.torso.cocks.count > 0) DisplayText(Desc.Cock.describeMultiCockSimpleOne(player, true) + " is trapped between you and the wooden bench, and you know Heckel won't let you shift position to free it. You hump weakly at the bench in a desperate attempt to get some stimulation, and you can feel the vibrations of Heckel's laugh as she buries her snout in your ass. She doesn't stop you, but the polished wood barely gives any pleasure anyway.\n\n");
    ...
    private heckelLovesAnal2() {
        DisplayText().clear();
        DisplayText("Her legs bump against yours as she pulls herself up, the contact sending shivers through your sensitive body. \"<i>Even better than I thought,</i>\" she mumbles as you hear the sound of her stroking herself. Before the wetness around your ass can dry up, you feel something hard and slightly pointed poking the entrance of your " + Desc.Butt.describeButthole(character.torso.butt) + ".\n\n");
        ...
        Mod.Butt.displayStretchButt(player, 28, true, true, false);
        DisplayText("\n\n");
        ...
        //[<HERM PC>
        if (player.gender === Gender.HERM) DisplayText("Heckel wastes no time before going back to her brutal fucking, though her thrusts are limited to short bursts now. She makes up for this in speed as you lie helplessly below her, the pain of taking her knot slowly turning into intense pleasure. The heat and pleasure spreads from your ass to your entire groin, and the knot pushes against the walls of your vagina hard enough to make them rub against each other. Heckel cries out above you and slams her hips into you as much as she can, and you immediately feel a burning heat shooting up your gut. She pumps again as she seeds your insides with another spurt, and this time you orgasm along with her. Your " + Desc.Vagina.describeVagina(player, player.torso.vaginas.get(0)) + " spasms and gushes over your soaked " + Desc.Leg.describeLegs(player) + ", your asshole spasming around her cock just as much. Your " + Desc.Cock.describeMultiCockShort(player) + " soon follows, shooting your own seed up between your " + Desc.Breast.describeChest(character) + " and coating your stomach. Even as your orgasm begins to taper off, you can do little more than lie panting in a pool of your own spunk. Your legs quiver beneath hers as the warmth spreads further up your gut, leading you into a warm and hazy afterglow.\n\n");
        //[<MALE PC>
        else if (player.torso.cocks.count > 0) DisplayText("Heckel wastes no time before going back to her brutal fucking, though her thrusts are limited to short bursts now. She makes up for this in speed as you lie helplessly below her, the pain of taking her knot slowly turning into intense pleasure. The heat and pleasure spreads from your ass to your " + Desc.Balls.describeBalls(true, true, player) + " and cock, making it twitch at your impending orgasm. Heckel cries out above you and slams her hips into you as much as she can, and you immediately feel a burning heat shooting up your gut. She pumps again as she seeds your insides with another spurt, and this time you orgasm along with her.  Your " + Desc.Balls.describeBalls(true, true, player) + " get tight as your trapped " + Desc.Cock.nounCock(CockType.HUMAN) + " twitches, shooting your cum up between your stomach and chest. Your legs quiver beneath hers as the warmth spread further up your gut, leading you into a warm and hazy afterglow.\n\n");
        //[<FEMALE PC>
        else if (player.torso.vaginas.count > 0) DisplayText("Heckel wastes no time before going back to her brutal fucking, though her thrusts are limited to short bursts now. She makes up for this in speed as you lie helplessly below her, the pain of taking her knot slowly turning into intense pleasure. The heat and pleasure spreads from your ass to your entire groin, and the knot pushes against the walls of your " + Desc.Vagina.describeVagina(player, player.torso.vaginas.get(0)) + " hard enough to make them rub against each other. Heckel cries out above you and slams her hips into you as much as she can, and you immediately feel a burning heat shooting up your gut. She pumps again as she seeds your insides with another spurt, and this time you orgasm along with her. Your " + Desc.Vagina.describeVagina(player, player.torso.vaginas.get(0)) + " spasms and gushes over your soaked thighs, your asshole spasming around her cock just as much. Your legs quiver beneath hers as the warmth spread further up your gut, leading you into a warm and hazy afterglow.\n\n");
    ...
    //[Fuck Heckel]
    private dominateHeckelConclusion() {
        DisplayText().clear();
        ...
        if (player.torso.cocks.sort(Cock.LargestCockArea)[0].area > 40) DisplayText("as much of it as possible");
        else DisplayText("it");
        ...
        else DisplayText(", basting your " + Desc.Skin.skin(character) + " with her steaming warmth");
        DisplayText(".  You give her a knowing smile, " + Desc.Gender.mf(player, "man", "'woman'") + " to woman, and rock forward, sliding through her puffy labia and into her silky canal.  Those wet hyena-lips cling to every vein and rigid nook of your " + Desc.Cock.describeCock(player, x) + ", slurping your penis down the slick tunnel with hungry undulations.");
        DisplayText("\n\nAs soon as you finish your slow glide into that wondrous passage, you drop forward over your prize to look her in the eyes, admiring the smears of cock-cream you dripped and wiped over her muzzle.  Her pouty black lips are trembling, and inspired by the exquisite sensations migrating through your " + Desc.Cock.describeCock(player, x) + ", you kiss her, not as her lover but as her owner.  You ply her mouth with brutal, forceful kisses, raping her lips with your tongue, twining it around her own as you pillage her confused visage with a bruisingly rough french.  Her animal-like ears quickly begin to twitch, and her back arches, pressing her nipples into your [chest] as she sensually writhes beneath you.");
        ...
        DisplayText("\n\nOnly once you have fully sated yourself upon the still-climaxing herm's vagina do you pull out.  Her gash gapes in the shape of your maleness as you exit, dribbling sperm and continuing to convulse anew, milking the phantom member she wishes were still inside her.  You plop your " + Desc.Cock.describeCock(player, x) + " into her mouth, and she licks it without thought or question, cleaning the mixed love-juices from you until you shine with her glossy spit.");
