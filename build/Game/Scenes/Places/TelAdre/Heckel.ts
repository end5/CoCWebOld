    ...
    */
    ...
    public greetHeckel(): void {
        ...
        if (Flags.list[FlagEnum.MET_HECKEL] === 0) {
            ...
            DisplayText("\"<i>So, " + player.short + ", what can I do for you?  The person working the desk can give you a tour if that's what you need... or maybe you were looking for a training partner?  If you can keep up with me, of course.</i>\"\n\n");
        ...
        else if (telAdre.brooke.brookeAffection() >= 70 && Flags.list[FlagEnum.BROOKE_MEDIUM_SCENE] > 0 && Flags.list[FlagEnum.MET_HECKEL] > 0 && model.time.hours >= 13 && model.time.hours <= 15 && (player.torso.vaginas.count > 0 || player.cockThatFits(telAdre.brooke.brookeCapacity()) >= 0)) {
    ...
    private heckelTraining(): void {
        ...
        if (player.tone < 60) {
            ...
            DisplayText("You open your mouth to reply, but the hyena has already started another lap.  Deciding it isn't worth it, you turn away indignantly.");
            return { next: telAdre.gymDesc };
            return;
        }
        //Centaur or Genderless
        else if (player.gender === Gender.NONE || player.torso.hips.legs.isTaur()) {
            DisplayText("You tell Heckel that you're looking for a training partner, but she suddenly looks off balance. She shifts from foot to foot as she looks you up and down, head cocked to the side.\n\n");

            DisplayText("\"<i>Err, look " + player.short + ", people around here come in all shapes and sizes and use all sorts of... equipment. Maybe you should go find someone more your type to ask, because I honestly don't know what to do with yours.</i>\"\n\n");
            return { next: telAdre.gymDesc };
            return;
        }
        if (Flags.list[FlagEnum.TIMES_FUCKED_HECKEL_BLOWJOB] + Flags.list[FlagEnum.TIMES_FUCKED_HECKEL_ANAL] === 0) {
            DisplayText("You tell Heckel that you're looking for a training partner, and she makes no attempt to hide her gaze as she looks you up and down.  When she's finished, her unsettling grin returns.  \"<i>Excellent!  Let me just get cleaned up and we'll start with some stretches.</i>\"\n\n");
            ...
            if (player.stats.str > 50 && player.torso.cocks.count > 0) {
                DisplayText("\n\nYou feel pretty strong yourself, and you realize you could probably arm wrestle this hyena-bitch down to size.");
                dom = dominateHeckel;
            }
            //ORAL or LEAVE
            simpleChoices("Oral", heckelOrallyFixated, "Anal", null, "Be Top Dog", dom, "", null, "Leave", Scenes.camp.returnToCampUseOneHour);
        }
        //FOLLOWUP SECKZ
        else {
            if (Flags.list[FlagEnum.LIFETIME_GYM_MEMBER] === 0) {
            ...
            if (player.stats.str > 50 && player.torso.cocks.count > 0) {
                DisplayText("You feel pretty strong yourself, and you realize you could probably arm wrestle this hyena-bitch down to size.");
                dom = dominateHeckel;
            }
            //ORAL or LEAVE
            simpleChoices("Oral", heckelOrallyFixated, "Anal", heckelLovesDaAnal, "Be Top Dog", dom, "", null, "Leave", Scenes.camp.returnToCampUseOneHour);
        }
    }
    ...
    private heckelOrallyFixated(): void {
        ...
        if (Flags.list[FlagEnum.TIMES_FUCKED_HECKEL_BLOWJOB] === 0) {
            DisplayText("You walk over to Heckel and fall to your knees, already licking your lips. Heckel throws her head back in a barking laugh as she scoots forward, one paw coming around the back of your head. Without needing further encouragement, you grab the flaccid dog cock and give it an experimental pump.\n\n");
            ...
            return { next: heckelOralFixationII };
        }
        //Repeat
        else {
            ...
            //[<PC IS MALE OR HERM> 
            if (player.torso.cocks.count > 0) DisplayText("You use one hand to fondle her balls, letting them roll over your fingers and pinching the skin lightly. Your other hand finds its way to your crotch, where you begin stroking your " + CockDescriptor.describeCock(player, player.torso.cocks.get(0)) + " in time with her weak thrusts. Within moments you've brought yourself to a stiffening arousal, the cold air making your exposed " + CockDescriptor.describeCock(player, player.torso.cocks.get(0)) + " twitch slightly.\n\n");
            //[<PC IS FEMALE>
            else if (player.torso.vaginas.count > 0) DisplayText("You use one hand to fondle her balls, letting them roll over your fingers and pinching the skin lightly. Your other hand finds its way to your crotch, where you roll your " + VaginaDescriptor.describeClit(player) + " between your first two fingers. You let two fingers sink into your " + VaginaDescriptor.describeVagina(player, player.torso.vaginas.get(0)) + ", curling them upwards and moaning around the giant dog dick in your mouth.  Your fingers bring you to the edge of orgasm, but you lack the stimulation to send yourself over just yet.\n\n");
            ...
            //[<PC IS FEMALE>
            if (player.gender === Gender.FEMALE) DisplayText("A growl rises in Heckel's throat, and you recognize the sign of her impending orgasm. It's all you can do to keep your balance as her thrusts into your throat come more frequently. Although you are barely able to breath between thrusts, your free hand feverishly works at your wet slit, plumbing your depths as your own orgasm builds. Heckel's paws grab your head and pull you deeply on to her dick as you feel it spasm, and you begin to moan as you feel her load travelling through her cock and finally spilling directly into your stomach. The warmth of her seed spreads throughout your body until it meets the warmth of your groin, and your cunt begins to spasm around your fingers as it sets you over the edge.\n\n");
            //<PC IS MALE OR HERM> 
            else DisplayText("A growl rises in Heckel's throat, and you recognize the sign of her impending orgasm. It's all you can do to keep your balance as her thrusts into your throat come more frequently. Although you are barely able to breath between thrusts, your free hand feverishly strokes your " + CockDescriptor.describeCock(player, player.torso.cocks.get(0)) + ", your hand becoming slippery with pre as your own orgasm builds. Heckel's paws grab your head and pull you deeply on to her dick as you feel it spasm, and you begin to moan as you feel her load travelling through her cock and finally spilling directly into your stomach. The warmth of her seed spreads throughout your body until it meets the warmth of your groin, and your cock erupts in your hand as it sets your over the edge.\n\n");
    ...
    private heckelLovesDaAnal(loss: boolean = false): void {
        ...
        if (player.analCapacity() <= 20 && !loss) {
            DisplayText("Heckel lets out a barking laugh when you suggest using your " + ButtDescriptor.describeButt(player) + ", ruffling your hair playfully. \"<i>Know your limits, " + player.short + ", I'd tear you apart down there. I'm sure there are plenty of others in this realm who can help you out with that.</i>\"\n\n");
            return { next: Scenes.camp.returnToCampUseOneHour };
            return;
        }
        //success - requires ass to be 'a little loose'
        DisplayText("Heckel's eyes flash as her grin splits her face, and for just a moment you wonder if this might have been a bad idea. Before you can object, however, she's pushing you down onto your stomach, your arms and " + LegDescriptor.describeLegs(player) + " draped over either side of the wooden bench.\n\n");

        DisplayText("You half expect her to just shove herself in right there, but she thankfully holds off. Instead, you feel her rough paws grab and knead either side of your " + ButtDescriptor.describeButt(player) + " as she lets out a low growl.");
        //[<IF TONE OVER 80>
        if (player.tone >= 80) DisplayText("  \"<i>Damn " + player.short + ", you've got one hell of an ass. I bet it's gonna feel even better than it looks.</i>\"");
        //[<IF TONE BETWEEN 60-79>
        else if (player.tone >= 60) DisplayText("  \"<i>Mmm, not bad " + player.short + ", not perfect, but not bad.</i>\"");
        DisplayText("\n\n");

        DisplayText("One hand releases your " + ButtDescriptor.describeButt(player) + " and you can hear the sound of her stroking herself. You start to turn your head around to watch, but she firmly presses you back down against the bench. \"<i>Now now partner, I told you to stay there. When you're the alpha dog around here, then you can make the rules.</i>\" Deciding this treatment isn't so bad anyway, you relax and let her hand continue to knead your " + ButtDescriptor.describeButt(player) + ".\n\n");

        DisplayText("The sound of her stroking stops, and you bite your lower lip. You feel the bench shift beneath you as she changes position, and a moment later she pulls both of your asscheeks apart to expose your " + ButtDescriptor.describeButthole(character.torso.butt) + ". You tense for the inevitable penetration, but instead of a hard cockhead poking at your backdoor you feel something warm and wet. Heckel is licking you!\n\n");

        DisplayText("Her large tongue feels like sandpaper as it licks up and down your anus, your spread cheeks exposing you to the world. You can feel her wet nose on your sensitive skin, and the contrast with her warm tongue makes you shiver. Her tongue pokes and prods at your " + ButtDescriptor.describeButthole(character.torso.butt) + " before slipping painlessly in, swirling expertly around before pulling out and licking some more.\n\n");

        //[<IF PC HAS PENIS AND VAGOO> 
        if (player.torso.cocks.count > 0 && player.torso.vaginas.count > 0) DisplayText(CockDescriptor.describeMultiCockSimpleOne(player, true) + " is trapped between you and the wooden bench, and you know Heckel won't let you shift position to free it. Your " + VaginaDescriptor.describeVagina(player, player.torso.vaginas.get(0)) + " is also being ignored, and having so much pleasure with so little stimulation is driving you crazy. You hump weakly up and down, trying to draw some pleasure out of the bench beneath you while simultaneously pushing her rolling and massaging tongue closer to your aching slit, but she ignores you and only licks deeper. She buries her face in your ass entirely, her cold nose and teeth rubbing up against your sensitive skin as her tongue pushes as far inside of you as she can get it.\n\n");

        //[<IF PC HAS PENIS>
        else if (player.torso.cocks.count > 0) DisplayText(CockDescriptor.describeMultiCockSimpleOne(player, true) + " is trapped between you and the wooden bench, and you know Heckel won't let you shift position to free it. You hump weakly at the bench in a desperate attempt to get some stimulation, and you can feel the vibrations of Heckel's laugh as she buries her snout in your ass. She doesn't stop you, but the polished wood barely gives any pleasure anyway.\n\n");
    ...
    private heckelLovesAnal2(): void {
        DisplayText().clear();
        DisplayText("Her legs bump against yours as she pulls herself up, the contact sending shivers through your sensitive body. \"<i>Even better than I thought,</i>\" she mumbles as you hear the sound of her stroking herself. Before the wetness around your ass can dry up, you feel something hard and slightly pointed poking the entrance of your " + ButtDescriptor.describeButthole(character.torso.butt) + ".\n\n");
        ...
        player.displayStretchButt(28, true, true, false);
        DisplayText("\n\n");
        ...
        DisplayText("Just as the sting begins to fade, she draws herself out to the tip in one motion. You bite your lip in anticipation, but you still moan like a whore when she slams all 15 inches back into you. She draws back before pounding your " + ButtDescriptor.describeButthole(character.torso.butt) + " again, making your " + ButtDescriptor.describeButt(player) + " shake with the impact.\n\n");

        //[<IF PC HAS PENIS AND VAGOO>
        if (player.torso.cocks.count > 0 && player.torso.vaginas.count > 0) DisplayText("Although " + CockDescriptor.describeMultiCockSimpleOne(player) + " is trapped beneath you, Heckel's balls slap into your cunt with every one of her quickening thrusts.  Although neither your " + CockDescriptor.describeMultiCockShort(player) + " or " + VaginaDescriptor.describeVagina(player, player.torso.vaginas.get(0)) + " are getting much stimulation, your prostate is being milked better than it ever has. One thrust in particular makes you cry out, and Heckel laughs above you as she slams her furry thighs into yours again. \"<i>You moan like a whore, " + player.short + ", a perfect bitch for me to ride.</i>\"\n\n");

        //[<IF PC HAS PENIS AND BALLS> 
        else if (player.torso.cocks.count > 0 && player.torso.balls.quantity > 0) DisplayText(CockDescriptor.describeMultiCockSimpleOne(player, true) + " pulses beneath you with every thrust, her duo of fist-sized balls slapping into your " + BallsDescriptor.describeBalls(true, true, player) + ". You gasp in surprise as one of her thrusts rubs against your prostate, and she barks out a single laugh above you. \"<i>You moan like a whore, " + player.short + ", a perfect bitch for me to ride.</i>\"\n\n");
        ...
        //[<IF PC IS FEMALE>
        if (player.gender === Gender.FEMALE) DisplayText("  \"<i>I'm going to fuck your ass like you wish I'd fuck your cunt,</i>\"");
        //[<IF PC IS MALE OR HERM >
        else DisplayText("  \"<i>I'm going to ride your ass like you wish you could ride me,</i>\"");
        DisplayText(" she whispers into your ear. You can't help but shiver as she adjusts herself before resuming her pounding, drawing small gasps from you with every thrust.\n\n");

        DisplayText("Her thrusts become faster and shorter as she leaves more of her cock buried inside of you, jackhammering your hole with her last few inches. Something even bigger begins to press against your " + ButtDescriptor.describeButthole(character.torso.butt) + " as you hear her breathing become faster, her tongue lolling out of her mouth. You forgot about her knot! She doesn't let up her speed as she pushes it a little further with every thrust, and you don't want to think of how big it must be by now if it grew along with her dick size. She doesn't seem deterred however, and all you can do is grunt in pain as it pushes itself further and further.\n\n");
        ...
        //[<HERM PC>
        if (player.gender === Gender.HERM) DisplayText("Heckel wastes no time before going back to her brutal fucking, though her thrusts are limited to short bursts now. She makes up for this in speed as you lie helplessly below her, the pain of taking her knot slowly turning into intense pleasure. The heat and pleasure spreads from your ass to your entire groin, and the knot pushes against the walls of your vagina hard enough to make them rub against each other. Heckel cries out above you and slams her hips into you as much as she can, and you immediately feel a burning heat shooting up your gut. She pumps again as she seeds your insides with another spurt, and this time you orgasm along with her. Your " + VaginaDescriptor.describeVagina(player, player.torso.vaginas.get(0)) + " spasms and gushes over your soaked " + LegDescriptor.describeLegs(player) + ", your asshole spasming around her cock just as much. Your " + CockDescriptor.describeMultiCockShort(player) + " soon follows, shooting your own seed up between your " + Desc.Breast.describeChest(character) + " and coating your stomach. Even as your orgasm begins to taper off, you can do little more than lie panting in a pool of your own spunk. Your legs quiver beneath hers as the warmth spreads further up your gut, leading you into a warm and hazy afterglow.\n\n");
        //[<MALE PC>
        else if (player.torso.cocks.count > 0) DisplayText("Heckel wastes no time before going back to her brutal fucking, though her thrusts are limited to short bursts now. She makes up for this in speed as you lie helplessly below her, the pain of taking her knot slowly turning into intense pleasure. The heat and pleasure spreads from your ass to your " + BallsDescriptor.describeBalls(true, true, player) + " and cock, making it twitch at your impending orgasm. Heckel cries out above you and slams her hips into you as much as she can, and you immediately feel a burning heat shooting up your gut. She pumps again as she seeds your insides with another spurt, and this time you orgasm along with her.  Your " + BallsDescriptor.describeBalls(true, true, player) + " get tight as your trapped " + CockDescriptor.nounCock(CockType.HUMAN) + " twitches, shooting your cum up between your stomach and chest. Your legs quiver beneath hers as the warmth spread further up your gut, leading you into a warm and hazy afterglow.\n\n");
        //[<FEMALE PC>
        else if (player.torso.vaginas.count > 0) DisplayText("Heckel wastes no time before going back to her brutal fucking, though her thrusts are limited to short bursts now. She makes up for this in speed as you lie helplessly below her, the pain of taking her knot slowly turning into intense pleasure. The heat and pleasure spreads from your ass to your entire groin, and the knot pushes against the walls of your " + VaginaDescriptor.describeVagina(player, player.torso.vaginas.get(0)) + " hard enough to make them rub against each other. Heckel cries out above you and slams her hips into you as much as she can, and you immediately feel a burning heat shooting up your gut. She pumps again as she seeds your insides with another spurt, and this time you orgasm along with her. Your " + VaginaDescriptor.describeVagina(player, player.torso.vaginas.get(0)) + " spasms and gushes over your soaked thighs, your asshole spasming around her cock just as much. Your legs quiver beneath hers as the warmth spread further up your gut, leading you into a warm and hazy afterglow.\n\n");
        ...
        DisplayText("You lay on the bench for a few moments as Heckel ruffles your hair again. \"<i>Not bad, partner. You're the best fuck I've had in years, you know that? Not to mention the best workout!</i>\"\n\n");

        DisplayText("She laughs as she stands and heads for the shower, letting you clean yourself up and head back to camp.");
        player.orgasm();
        player.stats.sens += 4;
    ...
    public dominateHeckel(): void {
        DisplayText().clear();
        DisplayText("Smirking, you fold your arms and tell her to bend over - ");
        if (Flags.list[FlagEnum.TIMES_DOMMED_HECKEL] === 0) DisplayText("there's a new top dog just waiting to claim the town bitch");
        else DisplayText("you're back for a taste of your favorite bitch");
        DisplayText(".  Heckel snorts, \"<i>Nice try, fuck-meat, but ");
        if (Flags.list[FlagEnum.TIMES_DOMMED_HECKEL] > 0) DisplayText("last time was a fluke");
        else DisplayText("I'm always on top");
        DisplayText(".  If you want a squealing submissive to ride, the Wet Bitch is that way,</i>\" pointing towards the exit.  Her flaccid dog-dong twitches a little but remains defiantly soft.");
        ...
        if (Flags.list[FlagEnum.TIMES_LOST_HECKEL_DOM_CHALLENGE] > 0) DisplayText(" again");
        DisplayText("?</i>\"  Her tough finger-tip slams into your solar plexus for emphasis");
        if (player.stats.tou < 60) DisplayText(", pushing you back a bit");
        DisplayText(".");
        ...
        if (player.stats.str < 75) {
            DisplayText("Even with your mighty struggling, you cannot overcome the relentless hyena, and your shaking hand is forced down, eventually pressed flat into the wood.");
        ...
        //{Win}
            ...
            if (Flags.list[FlagEnum.TIMES_DOMMED_HECKEL] > 0) DisplayText(" AGAIN");
            DisplayText("...</i>\"");
    ...
    private dominateHeckelConclusion(): void {
        ...
        if (Flags.list[FlagEnum.PC_FETISH] > 0) DisplayText("You grin and blush hotly, imagining the whole of the gym watching you fuck this hyena, their watchful eyes exciting you further.");
        else if (player.stats.cor < 33) DisplayText("You blush a bit at that, uncomfortable at your sex being so public but unwilling to stop.");
        else if (player.stats.cor < 66) DisplayText("You smirk a little at that while barely acknowledge the worry of being caught nagging at your consciousness.");
        else DisplayText("You grin widely at that and secretly hope that the whole gym will come in to see their 'alpha' laid low.");
        ...
        if (player.torso.cocks.count > 2) DisplayText(", fanning the others across her neck and forehead, burying her in penis.");
        else if (player.torso.cocks.count === 2) DisplayText(", dropping your [cock smallest] alongside it over her eyes, burying her in penis.");
        else DisplayText(", draping her in hard penis.");
        DisplayText("  She whimpers as you rub your sensitive underside across her nose and pouting lips, looking up at you with what you imagine was supposed to be hatred.  It looks like lust instead.  Slowly stroking yourself while you diddle her, your manhood");
        if (player.torso.cocks.count > 1) DisplayText("s throb and thicken");
        else DisplayText(" throbs and thickens");
        DisplayText(" further, too turned on to stop even if you wanted to.  You command her to open with a terse word.  She does, and you slide inside.");
        ...
        if (player.cumQ() < 250) DisplayText("single drop");
        else if (player.cumQ() < 1000) DisplayText("steady drip");
        else DisplayText("never-ending flow");
        ...
        if (player.torso.cocks.biggestCocks[0].area > 40) DisplayText("as much of it as possible");
        else DisplayText("it");
        DisplayText(" down her throat.  Heckel's eyes bulge in disbelief, wildly looking left and right.  Her teeth come down, just barely pricking the skin of your [cock biggest] in warning.  You twist her nipple in a retaliatory strike, opening her throat up with a moaning shriek.");
        ...
        if (player.torso.balls.quantity > 0) DisplayText(", basting your [balls] with her steaming warmth");
        else if (player.torso.vaginas.count > 0) DisplayText(", basting your [vagina] with her steaming warmth");
        else DisplayText(", basting your " + SkinDescriptor.skin(character) + " with her steaming warmth");
        DisplayText(".  You give her a knowing smile, " + player.mf("man", "'woman'") + " to woman, and rock forward, sliding through her puffy labia and into her silky canal.  Those wet hyena-lips cling to every vein and rigid nook of your " + CockDescriptor.describeCock(player, x) + ", slurping your penis down the slick tunnel with hungry undulations.");
        ...
        if (player.cumQ() > 500) {
            DisplayText("  Your potent virility does a superb job of seeding Heckel's womb, stuffing it nice and full while streamers of white escape around your girth.");
            if (player.cumQ() >= 1000) DisplayText("  Still, you keep blasting wad after wad of spunk inside her, and her belly rounds nicely, puffed up with virile sperm.");
            if (player.cumQ() >= 2000) DisplayText("  Your spooge is seemingly without end, pouring out endlessly long after she's spunk-gravid and nearly immobile.  The rivers that run from her abused cunt-lips quickly turn the table into a puddle.");
            if (player.cumQ() >= 3000) {
                DisplayText("  That puddle then drips to the floor to make an alabaster lake");
                if (player.cumQ() >= 4000) {
                    DisplayText(" at least ");
                    if (player.cumQ() < 10000) DisplayText("a foot deep");
                    else if (player.cumQ() < 15000) DisplayText("knee high by most measurements");
                    else if (player.cumQ() < 20000) DisplayText("waist high");
                    else DisplayText("as high as the table");
                }
                DisplayText(".  Thank the gods for drains.");
            }
        }
        if (player.torso.cocks.count > 1) {
            DisplayText("  Your other member");
            if (player.torso.cocks.count > 2) DisplayText("s contribute");
            else DisplayText(" contributes");
            DisplayText(" as well, turning her hips and thighs into a wonderland of ivory-soaked fur.");
        }
        ...
        if (silly()) {
            DisplayText("  You grab a bacon shake from the shake-cart on your way out");
            if (Flags.list[FlagEnum.UNKNOWN_FLAG_NUMBER_00281] > 0) DisplayText(", then give Lottie a high five");
            DisplayText(".  You really love bacon.");
        }
        player.orgasm();
        player.stats.sens += -2;
        return { next: Scenes.camp.returnToCampUseOneHour };
