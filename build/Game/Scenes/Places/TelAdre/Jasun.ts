...
class Jasun {
    ...
    private meetJasun() {
        ...
        if (Flags.list[FlagEnum.UNKNOWN_FLAG_NUMBER_00179] === 0) {
            ...
            // IF MALE
            if (player.gender <= 1) {
                DisplayText("\"<i>Eyes to yourself, boy. Try to play any games and I'll tear you apart limb from limb. Now get out of here before I do it anyway.</i>\" The shark-morph snarls threateningly before turning back to the mirror.\n\n");
                DisplayText("You doubt he'd have the nerve to murder someone here, but you feel like you've wasted your time.");
            ...
            // IF FEMALE
                ...
                DisplayText("\"<i>You're no better than the women I used to deal with, I see!  Before you assail me anymore with those daring eyes of yours, care to at least tell me your name?</i>\"\n\n");
                ...
                DisplayText("\"<i>Excuse me, my lady, but you're staring again.</i>\"  You see that same old smirk play over his features again, clearly proud of himself being so desirable despite his attempts to play it off smoothly.\n\n");
                ...
                if (player.tone < 75) {
                    ...
                    DisplayText("You book it out of there.  What a waste.");
                    return { next: Scenes.camp.returnToCampUseOneHour };
                    return;
                }
                ...
                if (player.inventory.equipment.armor.displayName !== "slutty swimwear") {
        ...
        // Met Jasun but not boned!
            ...
            if (Flags.list[FlagEnum.UNKNOWN_FLAG_NUMBER_00181] === 0) {
                DisplayText("While you look around the changing room, one of the gym's other patron asks you if you're looking for Jasun.  Seeing your confusion, they describe the hunky shark guy you met before.  You nod and smile, happy to have learned his name.\n\n");
                Flags.list[FlagEnum.UNKNOWN_FLAG_NUMBER_00181]++;
            }
            // If you're a dude.
            if (player.gender <= 1) {
                DisplayText("Jasun walks out of a stall, his thick and muscular figure still as glorious as the last time you set eyes upon it.  He glances your way and smirks.\n\n");
                DisplayText("\"<i>Eyes to yourself, boy. Try to play any games and I'll tear you apart limb from limb. Now get out of here before I do it anyway.</i>\" The shark-morph snarls threateningly before turning to walk away.\n\n");
                DisplayText("You doubt he'd have the nerve to murder someone here, but you feel like you've wasted your time.");
                return { next: Scenes.camp.returnToCampUseOneHour };
                return;
            }
            // IF YOU FAIL TO MEET ANY OF HIS CRITERIA NOW
            if (player.tone < 75 || player.inventory.equipment.armor.displayName !== "slutty swimwear") {
                ...
                DisplayText("\"<i>" + player.short + ", you know, I still don't think you're quite ready to swim with me. That's fine, and it's entirely up to you, but I think today I should probably swim alone. You can come and visit me anytime, of course, maybe when you're ");
                if (player.tone < 75) DisplayText("fit enough");
                else if (player.inventory.equipment.armor.displayName !== "slutty swimwear") DisplayText("properly attired");
                else DisplayText("a little more compatible with me");
            ...
            DisplayText("Jasun comes out of his stall and smiles when he sees you, already beginning to strain against the skimpy fabric of his bottom.  He asks, \"<i>Would you like to come swimming with me?</i>\" though his tone indicates that swimming may involve more than a few laps.");
            MainScreen.doYesNo(meetJasun2, turnAwayFromAdj);
            return;
        }
        // Repeat
        else {
            ...
            if (player.gender <= 1) {
                DisplayText("Jasun walks out of a stall, his thick and muscular figure still as glorious as the last time you set eyes upon it.  He glances your way and smirks.\n\n");
                DisplayText("\"<i>Eyes to yourself, boy. Try to play any games and I'll tear you apart limb from limb. Now get out of here before I do it anyway.</i>\" The shark-morph snarls threateningly before turning to walk away.\n\n");
                DisplayText("You doubt he'd have the nerve to murder someone here, but it's clear that so long as you lack a vagina Jasun will have no interest in you.  What a waste.");
                return { next: Scenes.camp.returnToCampUseOneHour };
                return;
            }
            // IF YOU FAIL TO MEET ANY OF HIS CRITERIA NOW
    ...
    private jasunSecks() {
        ...
        if (Flags.list[FlagEnum.UNKNOWN_FLAG_NUMBER_00180] === 0) {
            ...
            DisplayText("When you come to, you find that your bikini is still on and that everything seems to be in order. Collecting your things, you leave the gym and think fondly of your encounter with Jasun... And what the next encounter might entail.");
        }
        // Repeat
        else {
            // REPEAT SEX
            ...
            DisplayText("When you wake back up, you find that your bikini is next to you and that everything else seems to be fine. You put your bikini back on and look around, unable to see Jasun anywhere. You walk toward the gym's exit and reminisce of your experience today, ready for whatever your next escapade will bring.");
        }
