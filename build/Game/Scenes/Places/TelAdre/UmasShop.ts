...
class UmasShop {
    ...
    public firstVisitPart1(): void {
        ...
        if (flags[FlagEnum.LOPPE_TIMES_SEXED] <= 3) {
            DisplayText(" but you've never noticed the quaint storefront before.  ");
        }
        else if (flags[FlagEnum.LOPPE_TIMES_SEXED] <= 8) {
            DisplayText(" and the homely building has caught your eye once or twice in the past.  ");
        }
        else {
            DisplayText(" and from there you've seen the humble exterior many times.  ");
        }

        DisplayText("\"Kemono's Oriental Clinic\" is written on a wooden board above the entryway.  \"<i>Sugar, you coming?</i>\" Loppe asks, breaking you out of your reverie.  \"<i>Come on in!</i>\"\n\n");
        ...
        DisplayText("\"<i>Mom, are you busy?!</i>\" Loppe yells.  \"<i>Just a second, dear!</i>\" replies a melodic, feminine voice.\n\n");
        ...
        DisplayText("Loppe giggles and gives you an \"I told you so\" look.\n\n");
        ...
        if (player.tallness < 78) {
            DisplayText("down at you ");
        }
        else if (player.tallness < 90) {
            DisplayText("straight at you ");
        }
        else {
            DisplayText("up at you ");
        }
    ...
    public firstVisitPart2(): void {
        ...
        DisplayText("You politely offer Loppe's mother your name, telling her that you're a... friend of Loppe's.\n\n");
        DisplayText("Loppe looks at you with disdain, then adds, \"<i>Yes, [he]'s a friend alright.</i>\"  Loppe clears her throat.  \"<i>Mom, I would like to introduce you to [name], my [boyfriend].</i>\"\n\n");
        ...
        DisplayText("Uma looks between the two of you with interest.  \"<i>[Boyfriend] huh?  So it's you whom I have to thank for the broken springs in Loppe's bed?</i>\" Uma says with a smile, offering you a hand.\n\n");
        DisplayText("You give her a winning smile back and accept it, wondering if you should prepare yourself for a macho-type squeezing match.  Even as you shake her hand, you apologize, telling her it wasn't your intention to make Loppe's bed need replacement springs.\n\n");
        ...
        DisplayText("You give them your best confused expression, realising that Uma and her daughter must have similar tastes in humor; she was evidently joking with you.\n\n");
    ...
    public firstVisitPart3(): void {
        ...
        DisplayText("Your conversation is interrupted when a cat man enters the clinic.  \"<i>Umm... hello?</i>\" he says, shyly as he enters.  Uma turns to you.  \"<i>You'll have to excuse me, but I must get back to work.</i>\"  Understanding that Uma is currently working, you politely step back and watch as Uma walks to attend to her client.\n\n");
        DisplayText("\"<i>We should go, sugar,</i>\" Loppe whispers in your ear.  You nod to her, tell Uma that it was nice meeting her, and indicate Loppe should lead you out.  You follow the Laquine out of the building, and tell her that her mother is a nice woman.\n\n");
        DisplayText("\"<i>Yeah, she is nice, she's just a little... quirky sometimes,</i>\" Loppe agrees.  \"<i>And I think she likes you too, sugar; nice work.</i>\"  She grins, patting you on the shoulder.\n\n");
        DisplayText("You tell her that you're glad, but you have other things to do, so you'll catch her some other time. \"<i>Alright sugar, see you around,</i>\" Loppe announces as she turns and walks away, back in the direction of her home, leaving you to start heading back to what passes for yours in this world.\n\n");

        DisplayText("<b>Uma's Clinic is now available from the Tel'Adre shops menu!</b>");
    ...
    public enterClinic(returnedTo: boolean = false): void {
        ...
        if (!returnedTo) {
            DisplayText("You decide to pay Uma a visit at the clinic, so you follow the way through the streets to the apparently humble clinic.  Once there, you open the door and enter.\n\n");
            DisplayText("The interior of Uma's clinic is as calm and quiet as usual.  There don't seem to be any customers present at this moment, and you announce your presence by knocking gently on a counter.  The tall horse-woman walks softly out through the beaded curtain, giving you a friendly smile.\n\n");
            ...
            if (player.femininity >= UMA_CONSIDER_PC_FEM) {
                DisplayText("You notice her appraising your form as you stand before her, Uma's approval of your appearance clear.");
            }
        }
        else {
            if (player.femininity >= UMA_CONSIDER_PC_FEM) {
                DisplayText("\"<i>So then, [name], what can I do you for?</i>\"  She flashes you a knowing grin, the innuendo clearly intended.");
            }
            else {
                DisplayText("\"<i>So then, [name], what can I do for you?</i>\"  She flashes you a friendly smile, her professionalism ever present.");
            }
        }
    ...
    public massageMenu(): void {
        ...
        DisplayText("\"<i>Of course, dear.  I have a selection of a few types of special massages I can give you, but you're only able to keep the effects of one of them, we can't risk disturbing your flow of chi, right?</i>\" she says smiling happily, \"<i>Here's the list.</i>\"  She hands you a small catalogue with her available massages.\n\n");
        DisplayText("You study the catalogue, noting the description of each one as you do so...\n\n");
        DisplayText("\"Your libido getting you down?  Find that it's just too easy for you to get turned on?  This special massage will help make you too relaxed to get horny for a few hours,\" reads the first one.\n\n");
        DisplayText("The second one, on the other hand, states, \"Want to get into the mood for some special fun, but finding it a challenge?  This special massage will get you primed and ready for some sweet, sweet loving.\"\n\n");
        DisplayText("\"Feel good and look better with this special modelling massage; the boys, girls and herms will be drooling over you while it lasts,\" reads the third; you're not surprised that most of treatments seem to have some sexual benefit.\n\n");
        DisplayText("\"Muscles sore and aching?  Weary down to your bones?  A nice relaxing massage can alleviate your pain and fatigue, and help you unwind more effectively,\" is how the fourth option describes itself.\n\n");
    ...
    public massageRelief(): void {
        ...
        DisplayText("\"<i>Are sure about that honey?  Wouldn't that make it hard to keep up with my little Loppe?</i>\"\n\n");
        DisplayText("You admit that it may, but you feel you could use it.  Besides, you do spend most of your time out in the wilderness; the people, to use the term loosely, out there aren't quite as understanding about sex as Uma's daughter is.\n\n");
        DisplayText("\"<i>I see... come along then,</i>\" Uma replies, motioning for you to follow.  You nod and promptly do as she asks.");
    ...
    public massageLust(): void {
        ...
        DisplayText("\"<i>Oh... feel like getting some help handling my little Loppe, perhaps?</i>\"\n\n");
        DisplayText("You give her a playful smile and a wink, telling her that's not really any of her business; it's not good form for a [boyfriend] to kiss and tell.  Can she help you?\n\n");
        DisplayText("Uma gasps in mock hurt.  \"<i>Are you doubting my skills, dear?  Of course I can help you!  Follow me.</i>\" Uma replies, motioning for you to follow her, and you trail along behind the mare masseur.\n\n");
    ...
    public massageModelling(): void {
        ...
        if (player.femininity <= 60) {
            DisplayText("\"<i>I can see why you want this one, you could use a few touches to make you cuter, dear.</i>\"\n\n");
        }
        else {
            DisplayText("\"<i>Personally I think you're pretty enough as you are, but a few extra touches can't hurt, right dear?</i>\"\n\n");
        }

        DisplayText("You thank her for the professional opinion, and indicate she should lead the way.\n\n");
    ...
    public massageRelaxation(): void {
        ...
        DisplayText("\"<i>I wonder if Loppe is the reason you're asking for this kind of massage... either way, sure, let's do this.</i>\"");
        DisplayText("You tell her that you won't deny or admit to Loppe being a cause.  However, it's also pretty rough out in the wilderness, so you could really use the relief.\n\n");
        DisplayText("\"<i>Very well... don't want you too burned out to deal my little Loppe afterwards.  Follow me.</i>\"  Uma motions for you to follow her, and you trail after her, looking forward to your treatment.\n\n");
    ...
    public massagePower(): void {
        ...
        DisplayText("\"<i>Feel like getting involved in a fight, do you?  Okay, let Uma give you a little help!</i>\"  She grins happily.\n\n");
        DisplayText("You thank her; her massage could mean the difference between life and death for you.\n\n");
        ...
        DisplayText("You tell her that you appreciate your sentiment, and you have no intention of hurting Loppe, but you have a mission and you are sworn to complete it; the demons must fall, and you won't stop until they have been defeated.");
        DisplayText("\"<i>I understand.  In that case, follow me,</i>\" Uma replies, motioning for you to follow her.  You let her lead the way and follow close behind.\n\n");
    ...
    public massageMain(selectedMassage: number): void {
        ...
        DisplayText("\"<i>Before we get started, I'll have to ask you to hand over a few gems for my services, dear.  Even if you are my little Loppe's [boyfriend], this is still a business.</i>\"\n\n");
        DisplayText("You tell her that's alright, fishing in your belongings for the gems that the mare masseur needs for this particular service... which you remember she hasn't told you yet?\n\n");
        ...
        if (flags[FlagEnum.PC_FETISH] >= 1) {
            DisplayText(" flushing with arousal at the idea of being naked before the mare, ");
        }
    ...
    public massageCommence(selectedMassage: number): void {
        ...
        DisplayText("You swallow audibly and brace yourself for what's to come.\n\n");
        DisplayText("Uma presses her elbow against your chest ");

        if (player.torso.chest.sort(BreastRow.BreastRatingLargest)[0].rating >= 1) {
            DisplayText("between your [chest] ");
        }

        DisplayText("and pushes hard.  You can't help but scream at the initial bout of pain.  \"<i>Relax dear.  It will only hurt for a little while.</i>\"  You squirm at the pain but slowly it begins to dissipate... you're pretty sure Uma is pressing against your chest even harder than before, yet the pain is quickly ebbing away...\n\n");
        ...
        DisplayText("The treatment on your front is painful, but at the same time it gets easier and easier to relax as it goes on... and it hurts less and less, until by the time Uma is finished it just doesn't hurt anymore...\n\n");
        DisplayText("\"<i>Very good, dear.  Now flip yourself over, it's time to take care of your back,</i>\" she informs you");

        if (player.femininity >= UMA_CONSIDER_PC_FEM) {
            DisplayText(", her hand gently caressing your [hips] absent-mindedly");
        }
        else if (player.femininity >= UMA_CONSIDER_PC_AND) {
            DisplayText(", her hand lightly touching your [hips] absend-mindedly");
        }

        DisplayText(".\n\n");

        // Refactor to say something about nipples against the table?
        DisplayText("You move to do as she asks; it's a little awkward adjusting to having your face in the - thankfully cushioned - hole.  You wriggle about to settle yourself comfortably on the table, [nipples] squashing into the surface, but you manage to make yourself relaxed and tell Uma that you're ready once more.\n\n");
        DisplayText("You yelp as Uma presses the metal rod " + ((player.torso.tailType > 0) ? "to the base of your tail" : "to your lower back") + ".  \"<i>I'm going to have to trace a few spots on your back dear, to ensure your flow of chi is not obstructed.  It might hurt again, but be brave, ok?</i>\"  You nod as best as you can and prepare yourself.\n\n");
        DisplayText("By the time Uma is finished you feel sore all over, the pain on your back seemingly bringing back the pain on your front.\n\n");
        DisplayText("\"<i>It will be a little while before the flow of chi inside your body stabilizes, dear.  But by the time you're out of this clinic, you should feel much better,</i>\" Uma explains.\n\n");
        DisplayText("You thank the mare and get dressed, bidding her farewell before you exit the clinic. Once outside, true to her words, you start to feel better... in fact you feel amazing!  It's no wonder her treatment is expensive, you feel just... amazing!\n\n");
    ...
    public applyMassageBonus(selectedMassage: number): void {
        if (selectedMassage < 0 || selectedMassage > 4) {
            ...
            if (selectedMassage === MASSAGE_RELIEF) {
                DisplayText("<b>You feel so relaxed and mellow... you don't think you'll be able to get in the mood for sex while you feel this blissed out.</b> " + MASSAGE_RELIEF_BONUS_TEXT);
                bonusValue = MASSAGE_RELIEF_BONUS;
            }
            else if (selectedMassage === MASSAGE_LUST) {
                DisplayText("<b>You feel so... wired! Your skin tingles with the slightest breeze, your heart races in your chest, and you lick your lips with eager nervousness.  You wanna fuck something so badly!</b> " + MASSAGE_LUST_BONUS_TEXT);
                bonusValue = MASSAGE_LUST_BONUS;
            }
            else if (selectedMassage === MASSAGE_MODELLING) {
                DisplayText("<b>You feel sexier; you don't know if the massage has actually affected your looks, but you definitely have the confidence to strut your stuff!</b> " + MASSAGE_MODELLING_BONUS_TEXT);
                bonusValue = MASSAGE_MODELLING_BONUS;
            }
            else if (selectedMassage === MASSAGE_RELAXATION) {
                DisplayText("<b>Your aches and pains have vanished, and you feel so relaxed and rested.  That really did the trick in curing what ails you.</b> " + MASSAGE_RELAXATION_BONUS_TEXT);
                bonusValue = MASSAGE_RELAXATION_BONUS;
            }
            else if (selectedMassage === MASSAGE_POWER) {
                DisplayText("<b>Your muscles tingle and burn with energy; you feel like you could knock out a minotaur in one punch!</b> " + MASSAGE_POWER_BONUS_TEXT);
                bonusValue = MASSAGE_POWER_BONUS;
            }

            if (bonusValue != 0) {
                player.statusAffects.set(new StatusAffect("UmasMassage", selectedMassage, bonusValue, MAX_MASSAGE_BONUS_DURATION, 0)));
    ...
    public applyNeedlework(selectedSession: number): void {
        if (selectedSession === NEEDLEWORK_UNDO) {
            ...
            player.perks.set(new Perk("ChiReflowSpeed", 0, 0, 0, 0));
            DisplayText("<b>" + NEEDLEWORK_SPEED_PERK_DESC + "</b>");
        }
        else if (selectedSession === NEEDLEWORK_LUST) {
            player.perks.set(new Perk("ChiReflowLust", 0, 0, 0, 0));
            DisplayText("<b>" + NEEDLEWORK_LUST_PERK_DESC + "</b>");
        }
        else if (selectedSession === NEEDLEWORK_DEFENSE) {
            player.perks.set(new Perk("ChiReflowDefense", 0, 0, 0, 0));
            DisplayText("<b>" + NEEDLEWORK_DEFENSE_PERK_DESC + "</b>");
        }
        else if (selectedSession === NEEDLEWORK_MAGIC) {
            player.perks.set(new Perk("ChiReflowMagic", 0, 0, 0, 0));
            DisplayText("<b>" + NEEDLEWORK_MAGIC_PERK_DESC + "</b>");
        }
        else if (selectedSession === NEEDLEWORK_ATTACK) {
            player.perks.set(new Perk("ChiReflowAttack", 0, 0, 0, 0));
            DisplayText("<b>" + NEEDLEWORK_ATTACK_PERK_DESC + "</b>");
        }
    }
    ...
    public acupunctureMenu(): void {
        ...
        if (hasNeedleworkPerk()) {
            ...
            DisplayText("\"<i>Are you sure, dear?  While the effects of a Do-in massage will fade eventually, acupuncture is fairly... permanent.  Though I can only give you the effects of one type of needlework at a time...</i>\"\n\n");
            DisplayText("You tell her that you understand what she's saying, and thank her for warning you. You ask her what kinds of effects you can expect from her needlework and how much it's going to cost you.\n\n");
            DisplayText("\"<i>Well, fine.  So long as you're sure.  Normally, I would just show you a catalog, but I suppose you'd prefer needlework that can be used for combat, yes?</i>\"\n\n");
            DisplayText("You tell her that would probably be most useful to you, yes.\n\n");
            ...
            DisplayText("\"<i>One of my special needleworks favored by mages will redirect chi from your muscles to your mind; your blows will be weaker, but your spells will be far more potent.</i>\"\n\n");
        ...
        DisplayText("You nod in understanding... now you stop and consider your options, ");

        if (hasNeedleworkPerk()) {
            DisplayText("considering Uma's information.\n\n");
        }
        else {
            DisplayText("wondering what you should choose...\n\n");
        }
    ...
    public doNeedleworkSession(selectedSession: number): void {
        ...
        DisplayText("The room is light, but not overwhelmingly bright, with cool breezes gently wafting through, tingling deliciously on your exposed [skin] and setting the chimes hanging from the rafters gently a-tinkle. A number of large potted plants occupy the corners of the room, and there's even a tiny fountain with stones in it, the tumble of water over rocks creating a strangely soothing melody.  A small brazier produces a sweet, calming smell from incense burning in it.  The pride of the room is a sizable table, made from bamboo; it's covered in a white cloth, and has an upraised headboard with a hole in it that looks like it's big enough to fit your head through.\n\n");
        DisplayText("\"<i>I want you to strip and lay face down on my table, while I go fetch my needles and some numbing cream.  Unless you'd like me to stick needles in your body without anything to dull the pain?\"</i>  Uma asks jokingly.\n\n");
        ...
        if (flags[FlagEnum.PC_FETISH] >= 1) {
            DisplayText(", although there's a certain thrill running through your body, the thought of being naked in front of Uma.  Your [nipples] respond in kind, squashed into the table beneath your [chest]");
        }
        ...
        DisplayText("\"<i>Are you comfortable, dear?  May I start?</i>\" she asks.\n\n");
        ...
        DisplayText("You promise you will, and wait patiently.  Slowly the sensation of her fingers fades away, until at last you aren't sure if she's even touching you any more, and you report this to the mare currently planning on sticking you full of needles.\n\n");
        DisplayText("\"<i>Very good.  I'll start the treatment now, you might feel a slight pricking sensation, though it shouldn't hurt... if at any point it starts hurting, tell me and I'll do something to ease your pain, alright?</i>\"\n\n");
        ...
        DisplayText("You ask if you can get up now, or do you need to stay where you are so that it has time to settle?\n\n");
        ...
        DisplayText("You thank her for her work, get yourself up and proceed to dress.  You politely excuse yourself and start the long journey back to your camp.\n\n");
    ...
    public talkJob(): void {
        ...
        DisplayText("\"<i>My work?</i>\" Uma repeats in a thoughtful tone.  \"<i>Well, I'm something of a healer - my specific skills lie in acupuncture and do-in, a form of deep muscle massage.  As for what they can do... In short, my skills allow me to modify a person's flows of chi - I presume you've heard of that?</i>\"\n\n");
        ...
        DisplayText("So, Uma manipulates the energy inside of people for a living?  But why would anyone want her to do that?  You ask this to the mare, hoping for clarification.\n\n");
        DisplayText("\"<i>Manipulating the chi inside someone can have various beneficial effects, such as improving strength, altering sexual drive, getting rid of pains, alleviating mood swings... basically anything you can imagine has a relationship, no matter how detached, to chi.</i>\"\n\n");
        DisplayText("You nod your head in understanding; that makes sense.  So, what's the difference between the massages - do-in, she called them? - and acupuncture?  Don't they both do the same thing?\n\n");
        ...
        DisplayText("You tell her that's correct, and you understand the analogy. So, how does acupuncture differ in its effects?\n\n");
        ...
        DisplayText("You nod your head thoughtfully, digesting what you have been told.\n\n");
        ...
        DisplayText("You tell her that you appreciate her taking the time to explain her job to you; maybe at some point in the future you'll have a need for her special skills, but, right now, you think you've taken enough of her time.\n\n");
    ...
    public talkSexuality(): void {
        ...
        DisplayText("\"<i>Oh, I'm okay with talking about that.  You're not the first person to ask me about that...</i>\"  She looks distant for a short while, but then looks at you and smiles.  \"<i>So, what do you want to know, exactly?</i>\"\n\n");
        DisplayText("You think for a while, and finally ask why she considers herself a lesbian?  Won't she have sex with herms too?  Wouldn't that make her bisexual?  In fact... what made her think of herself as a lesbian in the first place?\n\n");
        ...
        DisplayText("So, it's not so much that she's unattracted to dicks as that she needs a fairly feminine face, and preferably physique as well, to get turned on by someone? You ask, interested.  Uma nods.  \"<i>That is correct, I like my partners pretty...</i>\"  She laughs lightly.\n\n");
        DisplayText("You ask if that makes it at all challenging to find partners, when she's feeling in the mood?\n\n");
        ...
        DisplayText("You ask casually if that implies the few men who do visit tend to be especially likely to be her type?\n\n");
        DisplayText("Uma thinks for a while.  \"<i>To be honest it's a fifty-fifty chance... usually the men that do show up happen to have been sent here by their wives and girlfriends.  Finding girly men is just very rare... though I do get the occasional client.</i>\"\n\n");
        DisplayText("That makes you think, and you ask how much effort Uma has to put into keeping her little tete-a-tetes discrete? After all, you don't think too many boyfriends, husbands or fathers would be happy to hear about her seducing their girlfriends, wives or daughters.\n\n");
        ...
        DisplayText("You can't resist the wry grin as you comment that it must do wonders for the reputation of her business.\n\n");
    ...
    public talkLoppe(): void {
        ...
        DisplayText("Uma taps her chin, thinking of something to tell you about...\n\n");

        // random call to one of the loppeTalks functors
        _loppeTalks[randInt(_loppeTalks.length)]();
    }
    ...
    public talkLoppeAttitudes(): void {
        ...
        DisplayText("You think it over and note that makes sense; when she was that age, well, she'd hardly have been able to really tell the difference between the genders, and it's not like she would have had any problems convincing the boys she was one of them, right?\n\n");
        DisplayText("\"<i>Yes, especially since she was flat-chested back then... but she was quite a handful. The eldar would call for me regularly to discuss my little hoppers behaviour. I guess she was kind of a bully, so I had to discipline her many times.</i>\"\n\n");
        DisplayText("You note that's more of a surprise to you than Loppe being a tomboy; she's always so sweet and kindly when you're around her.  You can't deny that she's a little on the horny side, but still, she's a nice person.\n\n");
        ...
        DisplayText("Slips up?\n\n");
        DisplayText("\"<i>Sometimes she'll let loose the foulest belches in public, or... </i>readjust<i> herself in public</i>\" replies Uma, her hand cupping an imaginary bulge at her crotch.  \"<i>She does things that a lady wouldn't let herself get caught dead doing when she forgets about her desire to appear lady-like.</i>\"\n\n"); // Changed this line pretty significantly, might wanna compare it etc
        ...
        DisplayText("\"<i>Oh, but she of course you wouldn't catch her doing any of that, she's extra careful around you... believe me, I've seen her when she gets home after a date with you.  She's at least twice as tired as she usually is, no doubt due to keeping her boyish tendencies in check.</i>\"\n\n");
        DisplayText("You wonder if maybe you should tell her that she doesn't have to try so hard to impress you; you want to be able to say you like her for who she is, the real her, not some act she forces herself to go through.  You don't realize you've been musing aloud until Uma responds.\n\n");
        DisplayText("\"<i>Dear, that wouldn't help at all.  She wouldn't be with you if she thought you would leave her if she was rude, but she owes it to herself to act like a proper lady around you.  So the best you can do is pretend to buy into her act.</i>\"\n\n");
        DisplayText("You sigh quietly and tell Uma you understand, but ask if maybe she could drop a hint to her daughter about trying too hard, hmm?\n\n");
        DisplayText("\"<i>I can do that, but I don't think it's going to help.  When she was young I told her she didn't have push herself so hard, but she insists on doing so anyway.  She can be quite stubborn, you know?</i>\"\n\n");
        DisplayText("You confess that you've had that impression from her, yes.  You thank Uma for giving you an insight into her daughter's history, but tell her it's time you were on your way.\n\n");
        DisplayText("\"<i>You're welcome, see you around.</i>\"  Uma waves you goodbye as you excuse yourself and return to camp.");
    ...
    public talkLoppeCarrotIncident(): void {
        ...
        DisplayText("You nod, proclaiming that it's a little cliché.  So, why is Uma talking about vegetables?\n\n");
        DisplayText("Uma grins mischievously at you.  \"<i>Did you know my little Loppe loves carrots so, so much... that she tried to have sex with one?</i>\"\n\n");
        DisplayText("...Okay, that's a story that you feel you need to hear, and you tell this to the dirty old mare who calls herself Loppe's mother.\n\n");
        ...
        DisplayText("You can't resist the wry grin; did she really...?\n\n");
        ...
        DisplayText("You ask in disbelief if Uma actually made her daughter eat her own carrot dildo?\n\n");
        DisplayText("Uma shakes her head.  \"<i>No no, of course not.  But back then Loppe wasn't so open about her sexuality either, and she had to make me buy into her argument.  Of course... I let her get away with it, but I laughed once I was sure she was out of earshot.</i>\"  Uma smiles, recalling the event.\n\n");
        DisplayText("You chuckle and suggest that Loppe probably never used carrots in that fashion again?\n\n");
        DisplayText("Uma smirks.  \"<i>Well, on certain lonely nights I did see a few carrots going missing from our stash...</i>\"\n\n");
        DisplayText("You can't resist a laugh, and tell Uma that you're grateful for her sharing such an intimate story about her daughter with you.  Isn't she a little worried you might tease Loppe about it, though?\n\n");
        DisplayText("Uma grins mischievously.  \"<i>Dear... I'm counting on it.  Maybe she'll learn to leave my carrots alone so I can actually have a midnight snack for once.  Make sure you tell me how she reacted afterwards, okay?</i>\"\n\n");
        DisplayText("You tell her that you make no promises and then excuse yourself; the chat was lovely, but you have to be moving on now.\n\n");
        DisplayText("\"<i>Okay, see you around [name].</i>\" Uma waves you goodbye.");
    ...
    public talkLoppePuberty(): void {
        ...
        DisplayText("You blink in surprise; you could have sworn Loppe told you that her \"stamina\" was the result of that demon's curse, and you pass this on to Uma.\n\n");
        DisplayText("\"<i>Make no mistake, dear.  It was one of the effects of the curse... but little Loppe's always been a bundle of insatiable energy.</i>\"  Uma smiles.\n\n");
        DisplayText("Be that as it may, surely her massive \"discharges\" owe more to magic than nature, you protest?\n\n");
        DisplayText("\"<i>I'm afraid not... or at least not entirely.  When she was younger Loppe often would suffer... accidents, due to her cum production.</i>\"\n\n");
        DisplayText("Accidents, you ask?  Then the mental image hits you, and you muse aloud on a sort of combination of accidental erections and the ejaculate-equivalent of poor bladder control.\n\n");
        DisplayText("\"<i>Yes, she would spontaneously cum all over her lower garments.  Mind you, it wasn't an orgasm per se... more like a slowish unstoppable leak.  Other kids used to call her Furutama due to her problems.  But I took care of that.</i>\"  Uma chuckles to herself.\n\n");
        DisplayText("You note that it must have something of a trial for both Loppe and her mother.  Morbidly curious, you ask how Uma took care of Loppe's little leaking problem.\n\n");
        DisplayText("\"<i>Morning drainings, dear.</i>\"\n\n");
        DisplayText("Drainings? You repeat in a puzzled tone of voice.\n\n");
        DisplayText("\"<i>Yes.  Before Loppe went out for the day, I would help her relieve the tension in her undeveloped balls.  Nowadays she can handle her heightened production just fine, but back then her balls weren't that big, so she couldn't stand her own body's metabolism.</i>\"\n\n");
        DisplayText("You can't resist chuckling and declaring Loppe must have enjoyed that.\n\n");
        ...
        DisplayText("You cluck your tongue; how did the two of them manage to put up with Loppe's puberty?\n\n");
        DisplayText("\"<i>With lots of patience, love and a helping hand.</i>\"  Uma giggles, making a small pumping motion with her hand, as if stroking an invisible cock.\n\n");
        DisplayText("You chuckle at Uma's sense of humor; she's so proud to be a dirty old mare now, isn't she?\n\n");
        ...
        DisplayText("So, she's not denying she's a pervert and proud of it?\n\n");
        ...
        DisplayText("You tell her that, yes, she's definitely a real silver fox - or silver mare, or whatever the term is for an attractive older woman.  Why, you can only hope Loppe takes after her mother when it comes to keeping her looks as she ages.\n\n");
        DisplayText("\"<i>Good answer.</i>\"  Uma snorts.\n\n");
        ...
        DisplayText("You apologize for sticking your foot in your mouth, and tell Uma you've clearly kept her talking long enough.\n\n");
        DisplayText("\"<i>Oh, it's always a pleasure to talk to my little Loppe's [boyfriend].</i>\"  Uma smiles at you happily.  \"<i>Though call me old again and I'll make your life a living hell.</i>\"  She adds, still smiling happily.\n\n");
        DisplayText("You get your things and get ready to leave - before you can bring yourself to go, however, you can't resist asking; Uma said the other kids in the village where Loppe grew called her \"<i>Furutama</i>\". What does that mean?\n\n");
        DisplayText("\"<i>It means full balls, dear.</i>\"  Uma states matter of factly.\n\n");
        DisplayText("You blink in shock, then stifle a laugh.  Yeah, that sounds like Loppe, alright.  You shake your head with a smile, thank Uma for talking to you, and then head off again.\n\n");
        talkLoppeJoiner();
    }
    ...
    public talkLoppesFirstGirl(): void {
        ...
        DisplayText("You follow her instructions, wondering just what kind of doozy the mare has to share with you this time.\n\n");
        DisplayText("\"<i>Back in our old village, there was a prostitute that went by name of Puffy Lips... but we just called her Puff.  Loppe had just blossomed into a beautiful young lady, so it's no surprise she drew plenty of stares when she walked around the streets-</i>\"");
        DisplayText("Wait, her mother actually named her Puffy Lips?  Seriously?  You interject.\n\n");
        DisplayText("Uma chuckles.  \"<i>Of course not, dear.  This was just her street name... though her last name was Kuchibiru, which means lips...</i>\"\n\n");
    ...
    public talkLoppesFirstGirlPart2(): void {
        ...
        DisplayText("Bored.  She was utterly, totally bored. There are good days, and there are slow days... but today wasn't just a slow day, it was completely dead.  Not even her regulars came to see her.\n\n");
        ...
        DisplayText("\"<i>Can I help you, dear?</i>\"  The cat behind the counter asked.\n\n");
        DisplayText("\"<i>Oh, umm, no thanks miss, just browsing, that's all.</i>\"  Loppe smiled.\n\n");
        DisplayText("The elderly cat smiled and replied, \"<i>Aren't you a cute little thing?  If you see anything you'd like, don't hesitate to call.</i>\"\n\n");
        ...
        DisplayText("With that in mind, Loppe made her way towards the carpenter...\n\n");
    ...
    public talkLoppesFirstGirlPart3(): void {
        ...
        DisplayText("\"<i>Hey, are you okay?</i>\"  Puff asked, as the girl seemed to be having some trouble with her breathing.\n\n");
        DisplayText("\"<i>I-I'm fine.</i>\"  Loppe squeaked, unable to look the wolfess in the eye and, indeed, trying to avoid looking at her at all, lest she be drawn to the she-wolf's gorgeous, big, beautiful, soft, wondrous breasts...\n\n");
        DisplayText("\"<i>Aww... don't be like that.  You can tell Puff all about your problems, dear.  Unless your problems have something to do with this?</i>\"  She opened her own robes, displaying the pair of orbs sitting upon her chest, nipples erect and pointing accusingly at Loppe.\n\n");
        DisplayText("\"<i>I-I-I...</i>\"  Loppe stammered, the laquine trailing off as her eyes glued to the massive orbs that transfixed her, like a mouse caught under the eyes of an owl.  One of her more recent dreams came to mind, and unthinkingly her fingers flexed, itching to squeeze and caress those beautiful boobs.\n\n");
        DisplayText("\"<i>You know... I was looking at you browsing the bakery earlier and I couldn't help but notice what a pretty friend you have...</i>\"  The wolfess teased with a smile.\n\n");
        DisplayText("Loppe blinks her eyes in confusion.  \"<i>Friend?</i>\"  She repeated softly.\n\n");
        ...
        DisplayText("Forcefully, Loppe leaped away, blushing like mad.  \"<i>I'm sorry, Ms Puff, but I've got to deliver an erection - I mean, a request from my mom and then get back home, right away!</i>\"\n\n");
        DisplayText("Puff clicks her tongue.  \"<i>Oh, surely you can spare a few minutes with little me?  I promise I don't bite... much.  Plus your friend down there looks like he really needs it.  How about it?  Just pay me a few coins and I'll give you the time of the day.</i>\"  She winks.\n\n");
        DisplayText("\"<i>P-pay you? I don't even have the money to pay for a piece of carrot cake!</i>\"  Loppe stammered, taking several steps back, powerful lapine legs already flexing in anticipation of making a dash for the carpentry before things got really embarrassing.\n\n");
        DisplayText("Shit!  If she didn't do something quickly, Puff was going to lose that nice horse-cock of a girl and have to resort to ol' thrusty!  \"<i>W-Wait!</i>\"  She yelled before the laquine could bolt away.\n\n");
        ...
        DisplayText("Loppe just stood there, poleaxed... She had the nagging worry that, if she did this, her mother would be so mad with her.  But, at the same time, this was Puffy Lips, the she-wolf who haunted her most erotic dreams.  What to do...\n\n");
        DisplayText("Realizing that Loppe still wasn't convinced she hurriedly added, \"<i>Okay... let's sweeten the deal... come with me and I'll even buy you a slice of carrot cake. What do you say?</i>\"  Puff looked at her expectantly,  tail wagging worriedly behind her.\n\n");
    ...
    public talkLoppesFirstGirlPart4(): void {
        ...
        DisplayText("Loppe, swallowing nervously, mustered her courage and managed to knock loudly on the she-wolf's door.  She could hardly believe she was about to do what she was going to do... \n\n");
        DisplayText("\"<i>It's open.</i>\" Loppe hears through the door. Well, here goes...\n\n");
        ...
        DisplayText("Mindlessly, Loppe shrugs off her dress, letting it fall abandoned to the floor.  Cock thrusting before her like a spear, the rabbit-horse herm strides towards the wolfess with an incongruously predatory air.  Her only thought in mind was to bury her shaft into Puff's waiting hole.\n\n");
        DisplayText("\"<i>Oh, is that for me?  Lovely!  I love it!  I want to take it for a test drive right now!</i>\"  The wolfess giggles, falling back onto her bed and spreading her legs wide to allow the laquine's throbbing member easy access to her own plump, well-used vagina.\n\n");
        DisplayText("With a mighty spring of her powerful rabbit legs, Loppe pounces bodily upon the wolfess, kissing her so fiercely she might as well be biting her in spirit.  With the clumsiness of an eager virgin, she grinds her cock into Puff's muff, too impatient and unsure of herself to properly slot herself into place.\n\n");
        DisplayText("Puff, being an experienced lover, takes hold of Loppe's rock-hard horse-prick and gives it a squeeze, drawing an excited gasp from the eager laquine.  \"<i>This looks painful... better do something about it!</i>\" Puff teases, aligning the shaft with her own throbbing pussy.\n\n");
        ...
        DisplayText("With a groan, Loppe immediately thrusts herself home, sinking herself to the hilt in one brutal thrust.  \"<i>Ow!  Not so rough!</i>\"  Puff protests.\n\n");
        DisplayText("\"<i>Sorry...</i>\"  Loppe moans, shuddering at the strange, new, absolutely wonderful experience of being surrounded by the she-wolf's warm, wet cunt.\n\n");
        DisplayText("\"<i>It's okay... I'm fine... feeling good?</i>\"\n\n");
        DisplayText("\"<i>Yesss.</i>\" Loppe hisses.\n\n");
        DisplayText("\"<i>Good.</i>\"  Reaching behind Loppe to gently brush at her equine tail and grab her hips, Puff continues to instruct Loppe on the finer points the female anatomy.  \"<i>Now thrust your hips like this... right there,</i>\"  She says, gently pulling the young laquine towards her.\n\n");
        DisplayText("The laquine gives herself over to the ministrations of her more experienced lover, anxious to learn how to make this feel even better than it already is, tongue lolling out in bliss.  \"<i>This... this is incredible, Puff!</i>\" She gasps.\n\n");
        DisplayText("The wolfess giggles.  \"<i>Careful Loppe, don't want to shoot too soon, do you?</i>\"\n\n");
        ...
        DisplayText("\"<i>Still hard?  Well, I guess that can be expected since you're young, no problem.  Puff knows how to deal with your kind.</i>\"  She gives Loppe a grin that can only be described as... wolfish.\n\n");
        DisplayText("Loppe grins back at her, just as wolfishly, eyes burning with lust.  \"<i>You mean it?  I can go again?</i>\" \n\n");
        DisplayText("\"<i>Of course you can girl.  You're not satisfied yet, are you?  I sure ain't... we can keep going until you're completely sated.  Now start fucking me!</i>\"  Puff begins bucking against Loppe, eager to get her started once more.\n\n");
        ...
        DisplayText("At this Puff's ears suddenly perk up as she looks at Loppe, startled.  \"<i>Oh!  Wait - Ah - Did I hear you right? - Oh, yes - An hour and a half?</i>\"\n\n");
        DisplayText("\"<i>Yeah, that's about normal for me to use up all the cum in my balls.  My horse half gives me balls with lots of room in them, rabbit half lets them fill up faster.</i>\" Loppe grunts, continuing to thrust into the she-wolf even as she talks. \n\n");
        DisplayText("Puff starts having second thoughts about this arrangement.  \"<i>Err, maybe we shouldn't go at it that long - Ahh - it might not be healthy.</i>\"\n\n");
    ...
    public talkLoppesFirstGirlPart5(): void {
        ...
        DisplayText("\"<i>You... That was incredible, Puff.  Thanks.</i>\"  The laquine give a peck on the comatose she-wolf's cheek.  \"<i>Sorry, but I really have to get back now.</i>\"  She says, redressing herself and making her way home.\n\n");
    ...
    public talkLoppesFirstGirlPart6(): void {
        ...
        DisplayText("...That, you finally manage to say, was quite a story.  So, was Uma really that mad Loppe was out late?\n\n");
        DisplayText("\"<i>Not that much, no.  I grounded her of course, but when I learned what she had done... then I was really mad.  I taught my little girl better than to hang out with Puffy Lips and her kind.  Though I suppose some good came of it, since she stopped having wet dreams about that vulgar wolf bitch.</i>\"\n\n");
        DisplayText("Having done it with her for real meant the dreams were no longer as interesting? You suggest.\n\n");
        DisplayText("\"<i>I don't really know... perhaps that is what happened, or maybe finding out what happened to Puff is what put her off.  I can't tell.</i>\"\n\n");
        DisplayText("What happened to Puff? You repeat, warily.  So, something happened between them?\n\n");
        ...
        DisplayText("You can only blink at that and flatly ask why; as startling as it probably was the first time around, you would have thought someone like Puff would, after she had recovered, jump at the chance to keep Loppe as her permanent personal fuck-toy.\n\n");
        ...
        DisplayText("You can only shake your head and tell her that you find that hard to believe.  After all, you and Loppe are still going out, and you've had sex more than once, haven't you?  But, regardless, you can't help but feel sorry for Loppe; that must have been a real kick to the ego.\n\n");
        ...
        DisplayText("You admit that Loppe is a handful and a half.  Still, not enough to make you go celibate, certainly.  You ask why Uma is asking.\n\n");
        DisplayText("Uma smiles.  \"<i>And that, my dear, is why you're special.  You're the first person who can actually handle Loppe.  Usually she wears out her partners so much that they need a few days to recover, but she tells me that all you need is a little rest and you're already good to go.</i>\"\n\n");
        DisplayText("You admit it can't be that hard, surely?  You're not even from this world, you should be worse at it than the natives like Loppe herself are.\n\n");
        DisplayText("Uma shakes her head lightly.  \"<i>I don't know what it is, dear.  But you're able to keep up with my little Loppe, while no other person that we've met so far can.  I suppose that's also part of the reason she chose to make you her official [boyfriend].  Much to the chagrin of her admirers.</i>\"  Uma chuckles.\n\n");
        DisplayText("You can't resist a wry joke about Loppe having admirers when she's known to be so untameable in bed.\n\n");
        DisplayText("\"<i>You'd be surprised with how much people actually enjoy Loppe's stamina.  Though anything more than a one night stand with her would probably put them in a coma for a few days.</i>\"  Uma chuckles.\n\n");
        DisplayText("You thank Uma for telling you about her daughter's life and then apologize, as it's time for you to head back to camp.\n\n");
        DisplayText("\"<i>Not a problem, dear.  I hope you will continue to maintain a healthy relationship with my daughter.</i>\" Uma chuckles.\n\n");
        DisplayText("You promise her that you'll try, gather yourself together, and then politely head back to camp.\n\n");
    ...
    public talkLoppesFirstBoyfriend(): void {
        ...
        DisplayText("You can't resist joking that, if you didn't know about Uma's tastes in lovers, hearing her talking about him in such glowing praises would make you half expect the reason they broke up to be because Loppe found him fucking her mother one day.\n\n");
        DisplayText("\"<i>Don't be silly, dear.  If you knew him as well as I do, you'd know there is absolutely no way there could ever be anything between us.</i>\"\n\n");
        DisplayText("You ask her exactly what she means, feeling she's talking about more than sexual incompatibilities here.\n\n");
        DisplayText("\"<i>If you really want to know, you'll just have to listen to my story.</i>\"  Uma smiles.\n\n");
        DisplayText("You laugh softly and promise to shut up and listen.\n\n");
        ...
        DisplayText("You note with admiration that Loppe must have worked hard; she dances so wonderfully now, you'd hardly believe it was entirely hard work instead of at least a little natural talent for it.\n\n");
        DisplayText("\"<i>Back then, there weren't many people who knew about Loppe's extra appendage, so they all just assumed she was a girl.  Hyou was the same, but...</i>\"\n\n");
        DisplayText("You ask how that could have happened, given the mentions Uma and Loppe have both made of her gender posing... difficulties during puberty.  Did Uma and Loppe end up moving to a new village where they didn't know about Loppe's dual-gendered nature?\n\n");
        DisplayText("\"<i>If you know the right people, changing your gender is not so difficult, dear.  People just assumed she paid a visit to the local shaman. She is not ashamed of her gender, but it's not something you should freely advertise everywhere you go either.</i>\"\n\n");
        DisplayText("Ah, you reply.  So that's it, you note to yourself; her accidents happened before she grew her boobs and female curves, resulting in them believing she was a boy who changed himself into a girl, rather than having been boy and girl at the same time all along.\n\n");
        ...
        DisplayText("You smile and note that's one odd way to get into a girl's good books.\n\n");
        ...
        DisplayText("He asked her if they could make love?  You suggest.\n\n");
        DisplayText("\"<i>No, silly.  He asked her out.</i>\"\n\n");
        DisplayText("Well, that's a surprise, you say; you didn't think people still took it that slow in Mareth.\n\n");
        DisplayText("\"<i>Not everyone is crazy about getting into each other's pants all the time dear</i>\" Uma scolds you.  \"<i>If we did that all the time we wouldn't have to do anything but sleep with each other all the time, you know?</i>\"\n\n"); // I dont even know.
        DisplayText("You apologize; there's so many monsters out in the wilderness who do think precisely that way that it's hard to remember there are still normal people, sometimes.\n\n");
        DisplayText("\"<i>It wasn't always like this, back then we were just simple people trying to live simple lives.</i>\"\n\n");
    ...
    public talkLoppesFirstBoyfriendPart2(): void {
        ...
        DisplayText("\"<i>There's no need to be ashamed Loppe... I'm your boyfriend, and all I want to do is see my beautiful laquine girlfriend in all her glory.  You aren't going to deny me that, are you?</i>\"  He asks hopefully.\n\n");
        ...
        DisplayText("Hyou smiles and closes the distance between them, gently hugging Loppe and pulling her into a tender kiss.  Once they break he whispers in her ear, \"<i>I know what you're hiding in there... and I really want to see it again... won't you show it to me again?  Please? Purrrrrty please?</i>\"\n\n");
        ...
        DisplayText("\"<i>Not quite... but let me help you.</i>\"  He boldly reaches forward and gives Loppe's equine-prick a few strokes, coaxing it into a full blown hard-on.\n\n");
        DisplayText("The rabbit-horse moans softly as it swells to all fourteen inches of mottled pink horse-dick, jutting erect and proud, defiant of its mistress.\n\n");
        DisplayText("\"<i>Now, that's better</i>\" Hyou says, circling Loppe to examine her from every angle.  \"<i>Hmm... yes.  Truly beautiful</i>\"  He comments, purring softly.\n\n");
        DisplayText("The bunny-pony blushes and wriggles.  \"<i>Y-you know, it's really weird you telling me that?</i>\" She protests in a half-hearted fashion.  \"<i>But... If I gotta show you mine, then you gotta show me yours!</i>\" She says, trying to sound more confident than she really is.\n\n");
        DisplayText("Hyou chuckles.  \"<i>I thought you were never going to ask!</i>\"  He slowly strips himself, dancing and prancing as he removes each piece of his garments until, with a flourish, he finally peels off his underwear and carelessly disposes of it, tossing it away.  \"<i>And this is my birthday suit.</i>\"  He grins.\n\n");
        DisplayText("Loppe's eyes lock onto his nakedness like a starving wolf onto a bloody steak, greedily drinking in the sight of him, particularly focusing with eagerness on his jutting, spiky-looking cat-dick.\n\n");
        DisplayText("Hyou looks between his erect kitty-prick and Loppe's own horse-cock, noting the obvious difference in size.  \"<i>Well well... not only are you taller than I am, you're also bigger in that department too.  I guess it's to be expected, I am competing with a horse-bunny after all.</i>\"  He winks at Loppe.\n\n");
        DisplayText("The aforementioned \"<i>horse-bunny</i>\" blinks in confusion, then realizes that the shaft she's been staring at is anywhere from one-third to one-half the length of her own, and she claps her hands over her mouth aghast.  \"<i>Hyou, I'm sorry, I...</i>\"  She begins, half-expecting a rejection.\n\n");
        DisplayText("\"<i>Sorry for what?</i>\"  Hyou interjects.  \"<i>I knew what I was getting into when we started dating.  Relax Loppe.  When I said you were beautiful, I meant all of you, even this hefty pony you carry between your legs.</i>\"  He grins happily.\n\n");
        DisplayText("Loppe smiles softly.  \"<i>You are such a flatterer, you know that?  But, enough with the foreplay - when do we get to the real action?</i>\" She mock-whines.\n\n");
        DisplayText("\"<i>Action?</i>\"  Hyou asks in mock confusion.  \"<i>Whatever do you mean bun?</i>\"\n\n");
        DisplayText("Loppe pouts for a moment, feigning displeasure.  \"<i>Are you taking me to bed, or am I going to have to push you into it?</i>\"  She laughs, giving a playful growl to underscore that her confidence is up and she's ready to fuck.\n\n");
        DisplayText("\"<i>Only if you can catch me.</i>\"  Hyou raspberries Loppe, getting ready to avoid his girlfriend's lusty advances...\n\n");
    ...
    public talkLoppesFirstBoyfriendPart3(): void {
        ...
        DisplayText("Hyou moans as Loppe gyrates her hips.  \"<i>That feels good, even if I'm not in yet.</i>\"  He begins gyrating his hips as well, rubbing himself against Loppe, which only serves to make Loppe's task more difficult.\n\n");
        ...
        DisplayText("Hyou laughs.  \"<i>Okay, okay.  I'm sorry, couldn't resist it!  You look so cute when you're frustrated!  Alright then, I'll hold still...</i>\"  He says, gently guiding the tip of his feline-cock towards Loppe's drooling pussy.  \"<i>There, I'm even helping this time.</i>\"\n\n");
        DisplayText("\"<i>If I could reach you from this position, I'd kiss you.</i>\" Loppe proclaims happily.  Her tail swishes across the cat's belly with anticipation, while the rest of her holds still, ready to be penetrated.\n\n");
        DisplayText("\"<i>Just sit down and I'll slip right in!</i>\" \n\n");
        ...
        DisplayText("Hyou purr-moans, hands moving to hold Loppe's hips steady.  \"<i>You know, as good as your pussy feels, unless you start moving nothing's going to happen, right?</i>\"\n\n");
        DisplayText("Wordlessly the laquine nods and begins to rise up and down, moaning and hissing as she truly loses her feminine virginity, riding her feline lover clumsily, but enthusiastically.  \"<i>This, oh... this feels so good, Hyou!</i>\"\n\n");
        DisplayText("The feline moans.  \"<i>Yeah!  So good.</i>\"\n\n");
        DisplayText("Addled as she is by pleasure, Loppe can still hear the reaction.  \"<i>Hey, what's wrong?  Aren't you enjoying this?  I know I am!</i>\"\n\n");
        DisplayText("\"<i>No!  I mean yes!  Of course I'm enjoying it... wow this feels great!</i>\"  He says, trying to save face.\n\n");
        DisplayText("\"<i>Well, you don't sound too happy, what's wrong?  You just not like this position?</i>\"  Loppe asks, trying to be understanding.\n\n");
        DisplayText("\"<i>I'm sorry Loppe... I don't know what's gotten into me... it does feel nice, but I'm just not feeling... y'know.  Maybe it is the position... try turning around?</i>\"  He suggests.\n\n");
        ...
        DisplayText("Hyou's shaft throbs, dribbling pre within the laquine's depths.  \"<i>Oh yesss</i>\" Hyou purrs.  \"<i>Now that's a sight I can appreciate, and personally?  I don't mind if you do give me a facial... but I appreciate the consideration, now get moving girl!</i>\"  Hyou says, excitedly.\n\n");
        DisplayText("Excited, Loppe resumes her bouncing, unthinkingly rubbing her cock against her lover's belly and shivering at the extra friction on its engorged, sensitive surface.  \"<i>Ah, Hyou, you feel so good inside of me!</i>\"  She whimpers.\n\n");
        DisplayText("Hyou moans and groans, eyes glued to Loppe's bouncing shaft.  \"<i>Yeah!  It feels great!  Slap my belly with that big pony of yours!</i>\"\n\n");
        DisplayText("\"<i>K-kuh!-kinky b-buh-boy!</i>\" Loppe groans, reaching out and grabbing his head and pulling him into an embrace, coincidentally planting his face right amongst her breasts even as she continues to grind her cock into his belly.\n\n");
        DisplayText("\"<i>Oh babe!  You're so sexy! I knew I picked a winner when I first saw you. Ah! Almost there!</i>\"  He yowls, bucking against Loppe.  \"<i>Damn that horse-cock of yours!  Bouncing around!  Slapping my belly!  Teasing me!  Ah!  So hot!</i>\" \n\n");
        DisplayText("A distant part of Loppe's mind catches these words and files them away with suspicion.  The rest of it is too busy melting at the sensations of losing her female virginity.  She continues to eagerly buck and thrust and impale herself, anxious in pushing on to her first <i>real</i> climax as a woman.\n\n");
    ...
    public talkLoppesFirstBoyfriendPart4(): void {
        ...
        DisplayText("\"<i>H-Half an hour!</i>\"  Hyou groans, flopping on Loppe's bed limply.\n\n");
        DisplayText("\"<i>That's normal, isn't it?  I mean, I can go for three times that long before I'm sated</i>\" Loppe asks, nervously.\n\n");
        DisplayText("Hyou rises his head.  \"<i>Normal?  I came once and am already spent... you are kidding right?</i>\"  He asks, laughing nervously at the frustrated laquine.\n\n");
        DisplayText("\"<i>So what am I going to do?  I haven't even cum once yet!</i>\" She whines.\n\n");
        DisplayText("Sighing, Hyou looks at Loppe's cock, then back at Loppe... he smiles.  \"<i>Tell you what.  Since you let me fill you, and I just can't get another erection for a while... how about I let you fill me instead?  Would you like that?</i>\"\n\n");
        DisplayText("\"<i>B-But I wanted to be fucked like a girl! Besides, you're a boy, I can't fuck you with a cock.</i>\"  The laquine whimpers.\n\n");
        DisplayText("Figuring it's pointless to argue with Loppe in her current state, he takes Loppe's cock in his hands and bends over to give it a lick; a task that proves easy, given his feline flexibility.\n\n");
        DisplayText("Loppe moans and shudders, wriggling with pleasure as a spurt of pre oozes from her flared tip to splatter onto her feline lover's face.\n\n");
        DisplayText("Hyou smiles and slurps the top of Loppe's equine member into his mouth, sucking on it like a lollipop.\n\n");
        DisplayText("Mouth opening and closing wordlessly like a fish, the laquine's eyes roll in her head as she is overwhelmed by the delicate touches to her sensetive shaft.\n\n");
        DisplayText("Finally, with one last slurp he lets go of Loppe's cock and, smiling, asks,  \"<i>You sure you don't want to take me instead?</i>\"\n\n");
        DisplayText("\"<i>I - okay... but, how do I do that?</i>\"  The bewildered bunny asks. \"<i>You don't have a pussy, unless you've been hiding something from me, and I don't want to just have you suck and lick on me; that's no fun for you, then.</i>\" She notes.\n\n");
        DisplayText("\"<i>Silly girl,</i>\" he remarks.  \"<i>Mind getting off me for an instant?</i>\" he asks, innocently.\n\n");
        DisplayText("Confused, the laquine pulls herself off of her lover, allowing his cum-slick cock to wetly slurp its way out of her.  She scoots over to the side of the bed, wondering what he has in mind.\n\n");
        DisplayText("Hyou rolls around on his belly, lifting his tail and presenting his ass to Loppe, then casually reaches back and spreads his cheeks apart, giving Loppe a first-hand view of his, yet unused, little rosebud.  \"<i>See?  I got a hole too!</i>\"  He grins.\n\n");
        ...
        DisplayText("Moaning and purring demurely, Hyou replies,  \"<i>S-Sure.  Now jam that wonderful pony of yours in!</i>\"  He says, overwhelmed with lust.\n\n");
        DisplayText("Licking her lips in anticipation of finally being sated, the young laquine begins slowly pushing her cock against the tightness of her lover's virginal ass...\n\n");
        DisplayText("Hyou yowls in a mixture of pain and pleasure.  \"<i>Mrrrow!  That feels great!  Ha... Loppe, babe!  Your cock feels amazing!</i>\"  He bucks back taking in even more of Loppe inside.\n\n");
        DisplayText("\"<i>Excited, are we?  Well, just don't hurt yourself - I'm not exactly teeny-tiny here!</i>\" Loppe giggles, too caught up in the sensations of the cat-morph's hot, tight little anus wrapping itself slowly around her shaft to be suspicious of his reactions.\n\n");
        DisplayText("\"<i>Don't care!  Ah, Marae!  S-Shit, getting hard again!</i>\"\n\n");
        ...
        DisplayText("<b>One very long, messy, multi-orgasmic bout of sex later...</b>\n\n");
    ...
    public talkLoppesFirstBoyfriendPart5(): void {
        ...
        DisplayText("You can't resist dryly pointing out that maybe it wasn't so much the girl part of Loppe that Hyou was interested in when he started dating the young dickgirl.  You would not be too surprised if Uma told you that the \"next time\" never came - or, at least, the version of it that Loppe wanted never came.\n\n");
        DisplayText("\"<i>Yes, dear.  I'm afraid that's true... Hyou is as manly as a harpy, I'm afraid.</i>\"  She chuckles.  \"<i>Now you see why there would never have been anything between the two of us, huh?</i>\"\n\n");
        DisplayText("A gay man and a gay woman; the very opposite of compatibilities.  So, you ask, raising an eyebrow for emphasis; in denial, or just didn't realize it until that first night?\n\n");
        ...
        DisplayText("Same attitude, different sex on the receiving end, you suggest?\n\n");
        ...
        DisplayText("You comment you're surprised Loppe took it so well; for most girls, hearing they \"<i>turned a boy gay by having sex with him</i>\" would be a major wound to their self-esteem.\n\n");
        ...
        DisplayText("He found a guy he liked better and broke up with her as a result?  You suggest casually.\n\n");
        DisplayText("Uma shakes her head.  \"<i>No.  Actually they broke up because he couldn't keep up with Loppe's stamina... it was either break up with her or give up dancing. And walking.</i>\"\n\n");
        DisplayText("You heave a sigh; a somewhat sad outcome, you must concede, but inevitable, you suppose. A truly bisexual herm and a homosexual male probably weren't really that comfortable with each other in a relationship anyway.  You note Loppe was probably happy, deep down, to call an end to it.\n\n");
        ...
        DisplayText("You tell her that turn of events doesn't surprise you; Loppe's got a good heart under her breasts.  And quite a fire in her loins, too, but, hey, nobody's perfect.\n\n");
        DisplayText("Uma laughs.  \"<i>That she does, dear, that she does.  But in case you're curious.  Hyou eventually found another guy, a wandering foreigner, and decided to leave the village with him.  And that was the last time we saw him.  Hope he is ok, wherever he is.</i>\"  Uma looks into the distance.\n\n");
        DisplayText("You tell her that you hope so, too, but it's time for you to leave.\n\n");
        DisplayText("\"<i>Very well, dear.  Hope you don't disappoint.  If you ever have to pick between walking and my daughter, I hope you'll pick my daughter.</i>\"  She jokes, chuckling to herself.\n\n");
        DisplayText("You chuckle and tell her that if Loppe hasn't chased you off despite the fact she's twice as bad as she ever was, if not worse, then you're not likely to make that choice against her favor soon.  That said, you take your things and head back to camp.\n\n");
    ...
    public talkLoppesDad(): void {
        ...
        DisplayText("The mare's stare grows distant, as if staring deep into her past, and she sighs.  \"<i>Ah, Usagi... I loved her so much, you know, [name]?</i>\"\n\n");
        DisplayText("She was special to Uma then, was she, you ask?\n\n");
        ...
        DisplayText("You ask who 'Usagi' was, as a person?  You know she was a herm bunny-morph and that she fathered Loppe, but how did she and Uma meet, and take their relationship that far?\n\n");
        ...
        DisplayText("So, you're guessing Uma found out Usagi had left her a little going-away present some time after the rabbit warrior had left, you suggest?\n\n");
        ...
        DisplayText("You ask if Uma ever tried to send a message after Usagi, let her know about her fatherhood?\n\n");
        ...
        DisplayText("You quietly thank Uma for sharing such intimate details of her life, and politely excuse yourself to leave.\n\n");
        DisplayText("\"<i>I still love her, you know.</i>\"  The mare declares in a conversational tone.  \"<i>I miss her so badly and I want her to come back to me; I dabble in dalliances, to fill the void, but I know they'll never really replace her.</i>\"\n\n");
        ...
        DisplayText("You can't resist noting that it sounds like Uma would end up giving Loppe a little sister if Usagi did come back. \n\n");
    ...
    public sexMenu(): void {
        ...
        if (player.gender === Gender.NONE) {
            DisplayText("You are about to ask if Uma would be willing to have sex with you, but then stop and think. Given you have no genitalia, and she's a lesbian woman, you can't really think of anything the two of you could do together that would be good for both of you.  You decide to ask her something else instead.\n\n");

            buildCoreMenu(true);
            return;
        }

        DisplayText("You tell Uma that, if it's alright with her, you'd like to have sex with her.  Uma looks you over appraisingly.\n\n");

        // Check femininity
        if (player.femininity >= UMA_CONSIDER_PC_FEM) {
            DisplayText("\"<i>Aren't you cute!  Such curves, such full lips!  Oh girl, you have just what it takes to get an old mare going, don't you?</i>\" Uma grins at you.  \"<i>Now, I know better than to just assume, so I have to ask... what are you packing inside that [armorname] of yours?</i>\"\n\n");

            if (player.gender === Gender.MALE) // Femboys
            {
                DisplayText("You admit that, despite the girliness of your appearance, you're actually male.\n\n");
                DisplayText("Uma smirks mischievously at you.  \"<i>Oh, so we've got a pretty femboy here, huh?  Do you like feeling pretty?  Because if you do, I'll make you feel truly beautiful.  All you have to do is get in my office,</i>\" she points beyond the curtains.\n\n");
            }
            else if (player.gender === Gender.FEMALE) // Chicks
            {
                DisplayText("You smirk and tell her that you're just what lesbians love; a girl who knows the loveliness of other women.\n\n");
                DisplayText("Uma grins at you. \"<i>Oh, goodie.  Then you must know what a skilled tongue or a soft caress can do, don't you honey?  All we have to do is get in my office, and I'll show you a good time,</i>\" she points beyond the curtains.\n\n");
            }
            else if (player.gender === Gender.HERM) // Dickchicks
            {
                DisplayText("You shrug carelessly and tell her that you are a girl, for all that you're packing a cock of your own. From what Loppe's said, though, you don't think that's a deal-breaker for Uma, is it?\n\n");
                DisplayText("Uma smiles at you.  \"<i>Of course not.  Just because you have a pecker, doesn't mean you aren't a girl now, does it?  Get in my office and we'll have some fun!</i>\"  She points beyond the curtains.\n\n");
            }
        }
        else if (player.femininity >= UMA_CONSIDER_PC_AND) {
            DisplayText("\"<i>I don't know [name].  I'm pretty sure my little Loppe already told you, but I'm a lesbian, so it all depends on what you're packing inside that [armorname] of yours, dear.</i>\"\n\n");

            if (player.gender === Gender.MALE) // No sexytimes for manns
            {
                DisplayText("You confess that you're actually a male, even if you can pass for a girl with a little work.\n\n");
                DisplayText("Uma looks at you in disappointment.  \"<i>Well then, I'm sorry... but I'm not interested.  While I don't exactly mind the occasional boy I happen to like mine a little prettier than you are,</i>\"  Uma shrugs.\n\n");
            ...
            {
                DisplayText("You're kind of boyish, you admit, but you're all girl, you declare.\n\n");
                DisplayText("Uma claps her hands and smiles at you.  \"<i>Good, let me show you why men have nothing on us girls.  Step into my office dear,</i>\" she points beyond the curtains.\n\n");
            }
            else if (player.gender === Gender.HERM) // Dickchicks
            {
                DisplayText("Yeah, you know people get confused by which you are. You're actually both, with pussy and dick.\n\n");
                DisplayText("Uma looks at you in thought.  \"<i>To be honest, I don't mind herms but I usually like mine a bit more on the girly side, you know?  I think we can make an exception for you though!  Go to my office,</i>\" she points beyond the curtains.\n\n");
            }
        }
        else // Wakkawakka no manns
        {
            DisplayText("\"<i>Sorry [name],  but you're just too manly for my tastes,</i>\" Uma apologizes.\n\n");
            buildCoreMenu(true);
            return;
        }

        // If we made it this far, we've passed all of Uma's preference checks
        DisplayText("You step through into Uma's office, noting a surprisingly comfortable looking flat table-bed, just waiting for you and Uma to have a little fun.\n\n");
        DisplayText("\"<i>Now here's a few 'special services' I can provide you with.  So, which will it be?</i>\"\n\n");
    ...
    private buildSexMenu(): void {
        ...
        if (player.gender >= 2 && player.hips.legs.type != 4) // Vaginas & not centaurs
        {
            MainScreen.addButton(2, "Fingerbang", sexGetFingered);
        }

        if (player.torso.cocks.count > 0) // Has a dick
        {
    ...
    */
    private sexEroticMassage(): void {
        ...
        DisplayText("The milf mare smiles at you.  \"<i>Very well, dear.  Follow me,</i>\" she turns to leave her office and head down the corridor, towards the far back of the clinic, equine tail swishing lazily side to side.  You follow closely in her wake, looking forward to her \"special treatment.\"\n\n");
        DisplayText("The room she leads you to is quite simple; wooden walls and floor, a couple of drains set in the floor that are probably for the more fluid generous clientele, ");

        if (kGAMECLASS.urta.urtaLove()) DisplayText("something that makes you wonder if Urta would like to come and take a spin here, ");
        ...
        DisplayText("You nod your head in understanding and promptly strip down, ");

        if (flags[FlagEnum.PC_FETISH] >= 1) DisplayText("unable to resist either the tingle of lust that runs through you at being naked in front of Uma, nor the urge to flaunt your feminine physique for her own gratification, ");

        DisplayText("and gather your [armorname] up in your arms as you do so. Walking over to the cupboard, you find a couple of folded towels and ample space to store your clothes, which is exactly what you do.\n\n");
        ...
        DisplayText("Even as Uma says this, you realize just how incredibly ");

        if (player.gender === Gender.MALE) DisplayText("hard ");
        else if (player.gender === Gender.FEMALE) DisplayText("wet ");
        else if (player.gender === Gender.HERM) DisplayText("hard and wet ");
        ...
        DisplayText("You groan deep in your throat and obey Uma's commands explicitly, shuddering as the waves of climax rip through your body and culminate in your loins, ");

        if (player.torso.cocks.count > 0) {
            DisplayText("cum ");
            if (player.cumQ() < 50) DisplayText("dribbling ");
            else if (player.cumQ() < 250) DisplayText("pouring ");
            else if (player.cumQ() < 500) DisplayText("spurting ");
            else DisplayText("fountaining ");
            DisplayText("from [eachcock] ");
        }
        if (player.gender === Gender.HERM) DisplayText("and ");
        if (player.torso.vaginas.count > 0) {
            DisplayText("femcum ");
            if (player.torso.vaginas.get(0).wetness <= 2) DisplayText("dripping ");
            else if (player.torso.vaginas.get(0).wetness <= 4) DisplayText("streaming ");
        ...
        if (player.gender === Gender.HERM) DisplayText("and ");
        if (player.torso.vaginas.count > 0) DisplayText("juices ");

        DisplayText("covering her hand and arm.  She smiles knowingly.\n\n");
        DisplayText("\"<i>How was it dear?  Let me guess, you feel like you just exploded and had the longest orgasm, quite possibly dirtying the whole room, right?</i>\"\n\n");
        ...
        DisplayText("You nod absently at her departure and settle down to regain your strength.  Once you feel recovered from your earth-shaking orgasm, you pick yourself up, redress, and quietly make your way back to camp; Uma's already busy with another client as you go.\n\n");
    ...
    public sexGetFingered(): void {
        ...
        DisplayText("\"<i>Very well, dear.  Come with me,</i>\" she turns to leave her office and head down the corridor, towards the far back of the clinic, equine tail swishing lazily side to side.  You follow closely in her wake, looking forward to her \"special treatment\".\n\n");
        DisplayText("The room she leads you to is quite simple; wooden walls and floor, a couple of drains set in the floor that are probably for the more... fluid generous clientele, ");
        ...
        DisplayText("You look at her with a slightly puzzled expression, but then smile, nod your head and approach.  You gently sit yourself down in the milf mare's lap.  ");

        if (player.tallness < 60) DisplayText("feeling very much like a child sat on the lap of her mother.  ");
        if (player.tallness > 84) DisplayText("carefully settling down for fear of squashing her.  ");

        DisplayText("Once settled and comfortable, you ask what to do next.\n\n");

        DisplayText("\"<i>Just relax,</i>\" the mare prompts as she runs her hands over your body.  She gently teases your [nipples] with soft fingers, kneading your [chest] with smooth touches; her delicate grasp gradually increasing in force until she's pawing at your sensitive tit-flesh with authority.\n\n");
        DisplayText("With your attention focused on your chest, you don't notice one of the mares hands ceasing its sensual massage of a breast, ");


        if (player.thickness < 10 && player.tone > 90) DisplayText("her fingertips trailing against your chiseled, muscular abdomen, ");
        else if (player.thickness < 30 && player.tone > 70) DisplayText("her fingertips gliding across your toned midriff, ");
        else if (player.thickness > 90 && player.tone < 10) DisplayText("her fingertips stealing a grope of your chubby belly as they travel lower, ");
        else if (player.thickness > 70 && player.tone < 30) DisplayText("her fingertips sinking into paunch of your belly, ");


        if (player.torso.cocks.count > 0) DisplayText("past [eachCock], and ");

        if (player.torso.vaginas.count > 0) {
            DisplayText("down towards the honeypot ");
            if (player.torso.hips.legs.isNaga()) DisplayText("on your [legs].  ");
            else DisplayText("nestled between your [legs].  ");

            DisplayText("Slowly she spreads your folds open, massaging your labia and gathering moisture from your [vagina].\n\n");
        }
        else DisplayText(".\n\n");
        ...
        DisplayText("The mare's hands gently circle your netherlips, sometimes brushing against your [clit], but only enough to send small jolts of electric pleasure running up your spine.  Slowly one questing finger begins prodding your entrance, before driving itself in.\n\n");
        ...
        if (player.hasVirginVagina()) {
            ...
            DisplayText("You murmur and wriggle in your seat, telling her that you don't doubt her in the slightest.  \"<i>Good, now let's make some room for me to work with,</i>\" she replies, gently thrusting her finger in and out of you in a circular motion, hoping to loosen you so she can add more digits.\n\n");
            ...
            DisplayText("You moan and babble, vaguely spitting out something about definitely promising to come back to her in the future.  Waves of pleasure wash through you, rippling through your clenching, squeezing netherwalls, building a strange tightness in your belly. Oh - you're going to - going to...\n\n");
            DisplayText("With an ecstatic cry, you orgasm, your virginal cunt spasming as it ");

            if (player.torso.vaginas.get(0).wetness <= 2) DisplayText("spatters ");
            else if (player.torso.vaginas.get(0).wetness <= 4) DisplayText("soaks ");
            else DisplayText("drenches ");

            DisplayText(" Uma's probing hand in your female juices");

            if (player.torso.cocks.count > 0) DisplayText(", your forgotten cock spraying cum in a pearlescent arc to splatter onto the floor");
            DisplayText(".\n\n");
            ...
            DisplayText("You can't resist a smile as you promise to remember that, redress yourself, and head back to camp.\n\n");
        }
        else if (player.torso.vaginas.get(0).looseness === 0) // Tight
        {
            DisplayText("\"<i>Hmm tight!  I wonder how long you can keep yourself like that while dating my little Loppe,</i>\" the mare says teasingly.\n\n");
            DisplayText("Loppe isn't that bad, you find yourself saying - and doesn't it feel so weird to be talking about Uma's daughter when you're letting Uma herself do you, you privately note.\n\n");
            DisplayText("\"<i>Oh, but this is where you're mistaken my dear.  Loppe is pretty bad and I should know.  She got that from me,</i>\" the mare laughs lightly, adding another finger to massage your opening.\n\n");
            DisplayText("You moan loudly, wriggling in your seat to allow Uma better access to your more sensitive spots.  Mmm, she's good at this...\n\n");
            DisplayText("\"<i>Thanks dear, but we are just about to get started with the real thing,</i>\" she replies with a chuckle.  Uma begins massaging your inner walls while she roams your insides, trying to find something.\n\n");
            DisplayText("You quickly realize what the mare is searching for, her expertise in matters of pleasure clear as your G-Spot is teased, crying out in delight as she sends the most delicious wave of pleasure rippling through your loins, doing your best to squeeze her fingers with your experienced but still-tight cunt.\n\n");
            DisplayText("\"<i>Aha!  Found it!</i>\" the mare says with delight, \"<i>Now I can finally get started on removing all of this bad tension you've been accumulating, dear.</i>\"  She starts pumping her fingers inside you, making sure to tease your G-Spot with careful touches at every pump.\n\n");
            ...
            DisplayText("Removing her hand from your privates, the mare lifts her wet hand to her face and begins licking it clean.  \"<i>Hmm, I see that my daughter is right to call you sugar.  You really are sweet,</i>\" she chuckles.  \"<i>So how'd you like your... massage?</i>\"\n\n");
            DisplayText("You smile lazily at her and assure her it was wonderful; a real treat to experience.  Maybe she should teach Loppe how to use her fingers like that.\n\n");
            DisplayText("Uma smiles at you.  \"<i>Hmm I might in the future, but my little Loppe has tricks of her own, as I'm sure you've no doubt experienced?</i>\"\n\n");
            DisplayText("You smile demurely and tell her that where you come from, a lady doesn't kiss and tell... then grin to let her know you're just teasing her.  Uma laughs.  \"<i>Oh, you silly girl...  Now if you'll excuse me.  I have to attend to my own problems.</i>\"  The mare motions to her drooling gash.\n\n");
            DisplayText("You smile and tell her you'll shut the door on your way out, getting dressed and then heading back to camp.\n\n");
        }
        else {
            DisplayText("\"<i>Oh, moist and easy.  I wonder how much of this is Loppe's fault?  Maybe I should tell her to be a bit more gentle?</i>\" the mare suggests, adding a couple more fingers inside you.\n\n");
            DisplayText("Well, maybe a little you manage to squeak out; you're really more concerned with just how good Uma's fingers feel inside you - they're not a nice big fat cock, but they're a pretty good substitute.\n\n");
            DisplayText("\"<i>Still feels like I have some room to work with here, so how about another one?</i>\" the mare states, even as she adds another finger to the ones already inside you.  \"<i>If we continue down this road I might just be able to squeeze a hand down there, you don't mind do you, dear?</i>\"\n\n");
            DisplayText("Mmm, the more the merrier you unthinkingly reply.  You didn't get this stretched out by not liking to be filled, after all.\n\n");
            DisplayText("\"<i>Good, I'll see if I can't accommodate you later, but for now there's something I'm looking for,</i>\"  She begins moving her fingers inside of you, feeling around your rippling walls, looking for that special spot within you.\n\n");
            ...
            DisplayText("Uma chuckles to herself, \"<i>Now, that's more like it.  Satisfied yet, dear?  I could always give you another...</i>\" She suggests.\n\n");
            ...
            DisplayText("You chuckle at her, painstakingly hauling yourself up, and get dressed.  Thanking Uma for showing you her magic fingers, you blow her a teasing kiss and then head back to camp.\n\n");
        }
    ...
    private sexHandjob(): void {
        ...
        DisplayText("\"<i>Hmm, I suppose I could, come with me,</i>\" the mare leads you away, out her office and head down the corridor, towards the far back of the clinic, equine tail swishing lazily side to side.  You follow closely in her wake, looking forward to her \"<i>special treatment</i>\".\n\n");
        DisplayText("The room she leads you to is quite simple; wooden walls and floor, a couple of drains set in the floor that are probably for the more... fluid generous clientele, ");

        if (kGAMECLASS.urta.urtaLove()) DisplayText("something that makes you wonder if Urta would like to come and take a spin here, ");

        DisplayText("and a sizable table, made from bamboo; it's covered in a white cloth, and has an upraised headboard with a hole in it that looks like it's big enough to fit your head through.  This is the only piece of furniture in the room, apart from a small cupboard in the corner.  Though spartan in its layout, the room is quite comfortably warm.\n\n");
        DisplayText("She starts stripping and motions for you to do the same.  \"<i>As talented as I am with my hands, I still haven't figured a way to properly take care of you while dressed, dear,</i>\" she giggles.  You nod your head in understanding and promptly strip down, ");

        if (flags[FlagEnum.PC_FETISH] >= 1) DisplayText("unable to resist either the tingle of lust that runs through you at being naked in front of Uma, nor the urge to flaunt your feminine physique for her own gratification, ");

        DisplayText("and gather your [armorname] up in your arms as you do so. Walking over to the cupboard, you find a couple of folded towels and ample space to store your clothes, which is exactly what you do.\n\n");
        DisplayText("\"<i>Be a dear and store mine too, please,</i>\"  Uma asks, handing her folded clothes to you.  You nod your head and place them in the cupboard like she asked, then walk over to the table and sit down, ready to begin.\n\n");
        DisplayText("Uma takes a seat beside you and smiles gently at you.  \"<i>Tell me, dear, how have you been?</i>\"\n\n");
        ...
        DisplayText("Yes, yes it does, you moan, shivering your seat and unable to resist trying to hump the masseur's hand that is caressing you so erotically.\n\n");
        DisplayText("\"<i>Focus dear, I'm trying to strike a conversation here,</i>\" Uma chuckles.  You manage to gasp an apology, but refrain from pointing out that her masterful touch on your burgeoning shaft is rather distracting.\n\n");
        ...
        DisplayText("\"<i>Come on, dear.  Talk to me.</i>\" Uma presses, even as her hands redouble their efforts at pleasuring you.  Between moans you manage to protest that she's making it awfully hard for you to do so, a glow of pride in you for actually being coherent rather than babbling madly.\n\n");
        DisplayText("\"<i>Is that so?  In that case, let's try this!</i>\"  She twists her hand around your shaft, stroking in a corkscrew-like motion, while her other hand continues to massage your [cockHead biggest] and strokes the underside of your strained fuck-pole.\n\n");
        DisplayText("That's the last straw for you and you promptly explode in her hands.\n\n");

        // Normal CumQ
        if (player.cumQ() <= 250) {
            DisplayText("Your cum spurts and spatters onto Uma's hands, getting them nice and sticky with your fluids.  \"<i>There we go, dear.  How are you feeling now?</i>\" the mare asks with a smug smile.\n\n");
            DisplayText("You heave in a relieved breath of air and tell her that you feel wonderful; she truly has magic fingers.  The mare giggles.  \"<i>Thank you, dear.</i>\"\n\n");
        }
        // Medium CumQ
            ...
            DisplayText("Much better you say, once you can speak again, and you thank her for being willing to attend to your little problem.  The mare giggles, \"<i>It was no problem, dear.</i>\"\n\n");
        }
        // High CumQ
        ...
        DisplayText("Once you can stand up again, you get off the table and make your way to the cupboard");

        if (player.cumQ() >= 500) DisplayText(", audibly sloshing through the cum covering the floor, ");

        DisplayText(" to get both your own clothes and Uma's.  You pull yours on");

        if (player.cumQ() >= 1000) DisplayText(", careful to avoid getting them soaked in your prodigious quantity of spunk");

        DisplayText(" and offer Uma's to her, thanking her once again for helping you with your relief.  \"<i>Don't worry about any mess, dear.  I'm just going to need a moment to sort myself out");

        if (player.cumQ() >= 500) DisplayText(", as well as the room");

        DisplayText(".  See you later, dear.  And don't be a stranger,</i>\" the mare tells you as she waves you goodbye.\n\n");
    ...
    private sexGetABJFromDisMilfyLesboSlut(): void {
        ...
        DisplayText().clear();
        DisplayText("Fidgeting in place, very much aware of the cum-filled cock");
        if (player.torso.cocks.count > 1) DisplayText("s");
        DisplayText(" in your pants, you ask whether Uma would be willing to give you a little intimate release.");
        ...
        if (kGAMECLASS.urta.urtaLove()) DisplayText("something that makes you wonder if Urta would like to come and take a spin here, ");
        DisplayText("and a sizable bamboo table.  It's covered in a white cloth and has an upraised board with a hole in it that looks like it’s big enough to fit your head through.  It is the only piece of furniture in the room apart from a small cupboard in the corner. Though spartan in its layout, this odd chamber is quite comfortably warm.");
        ...
        if (flags[FlagEnum.PC_FETISH] >= 1) {
            DisplayText(", unable to resist either the tingle of lust that runs through you at being naked in front of Uma or the urge to flaunt your feminine physique for her own gratification.  Gathering your clothes up is a bit of an afterthought, but you make sure to bend over and proudly present your [butt]");
            if (player.torso.balls.quantity > 0) DisplayText(" and [balls]");
            DisplayText(".");
        }
        else DisplayText(", gathering your clothes up in your arms as you do so.");
        DisplayText("  Walking over to the cupboard, you find a couple of folded towels and ample space to stow your clothes.");
        ...
        //VARIANTS NEEDED
        if (flags[FlagEnum.UMA_TIMES_SUCKED_YOU] < 2) DisplayText("It’s clear that she doesn’t really enjoy the notion that much, considering the way she’s looking at you.  \"<i>All right, let’s get this over with.</i>\"  ");
        else if (flags[FlagEnum.UMA_TIMES_SUCKED_YOU] < 5) DisplayText("She actually seems to be smiling a little as she looks at you.  \"<i>All right, time to see if I can handle this brutish thing.</i>\"  ");
        else DisplayText("It's clear that she doesn't mind doing this for you at all. In fact, she's even smiling down at you as she fondles you one-handed.  \"<i>Time to see if I can make you squirm as hard as Loppe does.</i>\"  ");
        DisplayText("She opens her mouth wide and takes ");
        if (player.torso.cocks.count === 1) DisplayText("your");
        else DisplayText("a single");
        DisplayText(" dick into her mouth, slurping on it.");
        ...
        if (flags[FlagEnum.UMA_TIMES_SUCKED_YOU] >= 2) DisplayText(", but I guess you're changing that, aren't you?");
        else DisplayText(".");
        DisplayText("</i>\"  Then, she playfully licks along the underside of your cock, putting that lengthy tongue to work. \"<i>");
        if (flags[FlagEnum.UMA_TIMES_SUCKED_YOU] < 2) DisplayText("You don't taste bad, all things considered.");
        else if (flags[FlagEnum.UMA_TIMES_SUCKED_YOU] < 5) DisplayText("I think I'm starting to get used to your taste, [name].");
        ...
        else if (flags[FlagEnum.UMA_TIMES_SUCKED_YOU] < 5) DisplayText("Not too bad.");
        else DisplayText("Hmmm, give me more, [name].");
        DisplayText("</i>\"");

        //Bonus handjobbies?
        if (player.torso.cocks.count > 1) {
            DisplayText("\n\nYou politely suggest she put ");
            if (player.torso.cocks.count === 2) DisplayText("one of ");
            DisplayText("her hands to work on your spare prick");
            if (player.torso.cocks.count > 2) DisplayText("s");
            DisplayText(".  The curvacious mare hums at the thought, inadvertently sending pleasant shockwaves through your length as she considers.  Making up her mind, ");
            if (flags[FlagEnum.UMA_TIMES_SUCKED_YOU] < 3) DisplayText("perhaps thinking it will end this sooner");
            else DisplayText("perhaps encouraged by the way you swell in her mouth");
            DisplayText(", she wraps ");
            if (player.torso.cocks.count === 2) DisplayText("one hand around your girthy tool and starts pumping");
            else DisplayText("both hands around your girthy tools and starts pumping");
            DisplayText(", stroking up and down with firm twists of her practiced hand");
            if (player.torso.cocks.count > 2) DisplayText("s");
            DisplayText(".  Her soft palm");
        ...
        if (player.stats.cor <= 33) DisplayText("pleasantly explain");
        else if (player.stats.cor <= 66) DisplayText("explain");
        else DisplayText("harshly explain");
        DisplayText(".  ");
        if (flags[FlagEnum.UMA_TIMES_SUCKED_YOU] < 2) DisplayText("You can feel her nod in agreement through your pole, and soon after, she's plunging rhythmically up and down.");
        else DisplayText("Before you can even finish, she's plunging up and down along your length, letting you know that she's learned this particular song and dance quite well under your tutelage.");
        ...
        if (flags[FlagEnum.UMA_TIMES_SUCKED_YOU] < 5) {
            ...
            if (player.torso.cocks.count > 1) DisplayText("s erupt");
            else DisplayText(" erupts");
            DisplayText(".  Even though you are no longer enclosed in that wonderfully warm, wet hole, you still shoot long, powerful lances of cum.  Uma catches the first across her face before she can move. The second splatters across the breasts that once nursed Loppe, some even falling into the valley of her cleavage.");
            if (player.cumQ() >= 500) DisplayText("  She gets out of the way after that, leaving you to lie there, spraying your seed like a perverted sprinkler.");
            if (player.cumQ() >= 1500) DisplayText("  The massive cumsprays that land on you slowly slough off down towards the drains.  It's hard not to bliss at the sound of your loud noisily draining away.");
        }
        //{More than five blowjobs!}
            ...
            if (player.cumQ() <= 25) DisplayText("She dutifully swallows every drop of your average-sized load, her long tongue slipping and sliding around your shaft as she ensures it is completely cleaned.");
                ...
                if (player.torso.balls.quantity > 0) DisplayText("  It rolls down to your [sack], coating it in warm, wet cum-shine.");
            }
            else {
                ...
                if (player.cumQ() >= 1000) {
                    DisplayText("  By the time you finish shooting, the drains are noisily gurging as they struggle to handle the ");
                    if (player.cumQ() <= 2000) DisplayText("pool");
                    else if (player.cumQ() <= 30000) DisplayText("bathtub worth");
                    else DisplayText("lake");
                    DisplayText(" of semen you've produced.");
                }
                DisplayText("  Your crotch is absolutely glazed with the stuff.");
            }
            //Bonus dicks
            if (player.torso.cocks.count > 1) {
                ...
                if (player.torso.cocks.count > 2) DisplayText("s release");
                else DisplayText(" releases");
                DisplayText(" all over the floor, fitfully sagging, then thickening with each shot.  ");
                if (player.torso.cocks.count === 2) DisplayText("Its ");
                else DisplayText("Their ");
                DisplayText("lewd dance continues on in imitation of your main member's pleasure.  ");
                if (player.torso.cocks.count === 2) DisplayText("It's ropes");
                else DisplayText("Their ropes");
                DisplayText(" aren't anywhere near as thick.");
            }
        }
        //epilogue
        //Came on her face
        if (flags[FlagEnum.UMA_TIMES_SUCKED_YOU] < 2) {
            ...
            if (player.stats.cor <= 40) DisplayText(" apologize, and ");
            DisplayText("get up to start getting dressed before quietly heading back to camp.");
        }
    ...
    private sexEatHerOut(): void {
        ...
        DisplayText("\"<i>Oh so you want to try the goods, so to say?  Well, as long as you stick to a hands-only approach, I personally don't have a problem... but wouldn't you rather have me do something for you?</i>\"\n\n");
        DisplayText("You shake your head; you thought it was time someone showed Uma a good time for a change.  \"<i>Well, if you're sure about that, then I have no problem with that, but care to enlighten me on what exactly you are thinking of, dear?</i>\"\n\n");
        DisplayText("You consider your options, and then pointedly lick your lips, musing aloud how Uma tastes.  \"<i>Hmm, so that's what you were thinking about, huh?  Very well, dear.  Come with me.</i>\"  \n\n");
        DisplayText("The mare leads you away, out her office and down the corridor, towards the far back of the clinic, equine tail swishing lazily side to side.  You follow closely in her wake, looking forward to her \"special treatment\".\n\n");
        DisplayText("The room she leads you to is quite simple; wooden walls and floor, a couple of drains set in the floor that are probably for the more fluid generous clientele, ");
        ...
        DisplayText("You approach the mare and kneel before her, inhaling her scent as you do so.  It smells sweet, enticing and arousing, a fragrance that sends your head reeling with Uma's arousal.  You find the fires of your arousal burn even hotter now.  ");

        if (player.torso.cocks.count > 0) DisplayText("Blood engorges [eachCock],  ");
        if (player.torso.vaginas.count > 0) DisplayText("moisture gathers on your netherlips, drops of your arousal sliding out of your [pussy] and down towards your [feet].  ");
        DisplayText("You gaze up at Uma, silently asking for permission.\n\n");

        DisplayText("With a gentle smile and a seductive wiggle, she gently rubs her sweet cunt.  \"<i>Go on, dear,</i>\" she urges you on letting out a girly giggle immediately afterwards. \n\n");
        DisplayText("You promptly bury your face between her firm thighs, licking around her labia, tasting her juices, before you slowly part her nethers with the tip of your tongue.\n\n");
        DisplayText("She moans appreciatively, thighs gently wrapping themselves around your neck.  \"<i>Mmm my dear, you are such an eager little thing, aren't you?  No need to rush, I'm not going to run away,</i>\" she teases, leaving the obvious add-on hanging in the air.\n\n");
        ...
        DisplayText("Uma moans and groans appreciatively, one hand reaching down to rub your head ");

        if (player.torso.neck.head.earType === 2 || player.torso.neck.head.earType === 9 || player.torso.neck.head.earType === 5 || player.torso.neck.head.earType === 7) DisplayText("between your ");

        if (player.torso.neck.head.earType === 2) DisplayText("canine ");
        if (player.torso.neck.head.earType === 9) DisplayText("vulpine ");
        if (player.torso.neck.head.earType === 5) DisplayText("feline ");
        if (player.torso.neck.head.earType === 7) DisplayText("loporid ");

        if (player.torso.neck.head.earType === 2 || player.torso.neck.head.earType === 9 || player.torso.neck.head.earType === 5 || player.torso.neck.head.earType === 7) DisplayText("ears.  ");

        DisplayText("\"<i>Mmm oh yes dear, yes, that feels good.  It's been awhile since someone would do that for me...</i>\"  She croons in her pleasure.\n\n");
        DisplayText("You take your mouth off her plush netherlips to pant and regain your breath, licking around your mouth to taste more of her.  You don't take long before you plunge yourself back between her legs, licking, slurping, drinking and tasting.\n\n");
        ...
        DisplayText("You rub her thigh affectionately, promising to do so, then redress yourself and head back to camp.\n\n");
