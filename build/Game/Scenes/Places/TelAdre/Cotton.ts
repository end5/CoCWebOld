class Cotton implements TimeAwareInterface {
    ...
    private pregCottonChance(bonusMult: number = 1) {
    ...
    public cottonGreeting() {
        DisplaySprite(12);
        DisplayText().clear();
        DisplayImage(images.showImage("cotton-greeting"));
    ...
    private cottonGreetingCommonEnd() {
    ...
    private centaurNagaBodyBookStuff() {
        DisplaySprite(12);
    ...
    //(If No)
    private turnDownYogaWifCottonFirstTime() {
        DisplaySprite(12);
        DisplayText().clear();
    ...
    private acceptYoga() {
        DisplaySprite(12);
        DisplayText().clear();
        DisplayImage(images.showImage("cotton-yoga"));
        let fuckHer;
        let getFucked;
        let option3;
        let option4;
        ...
        if (Flags.list[FlagEnum.LIFETIME_GYM_MEMBER] === 0 && player.inventory.gems < 10) {
        ...
        //First time
            ...
            //(If PC is male:
            else if (player.torso.cocks.count > 0) DisplayText("  She cradles your " + Desc.Cock.describeCock(player, player.torso.cocks.get(0)) + " and smiles at you, \"<i>Well, we might find a use for that later.</i>\"");
            //(If PC is female:
    ...
    private cottonChat() {
        ...
        //(Edryn chat)
            ...
            else if (Flags.list[FlagEnum.EDRYN_NUMBER_OF_KIDS] > 0) DisplayText("While you're doing your stretches, you find yourself chatting about the folks of Tel'Adre. \"<i>Edryn?</i>\" Cotton says and giggles, \"<i>I hear you knocked her up, good on you. I think she'll make a great mom, and you " + Desc.Gender.mf(player, "a great dad", "as well") + ".</i>\"  She gives you a kiss on the cheek and continues the stretches.\n\n");
    ...
    //(Fuck Her)
    private cottonFirstTimeFuckHer() {
        DisplaySprite(12);
        Flags.list[FlagEnum.COTTON_MET_FUCKED] = 2;
        DisplayText().clear();
        DisplayImage(images.showImage("cotton-first-fuck"));
        ...
        DisplayText("Her pussy quivers and trembles around your tongue. You can tell she's so close to orgasm... but that's not what you want right now.  With a small amount of regret, you pull back from her delicious snatch, wipe the water and juices from your face and stand, stroking your " + Desc.Cock.describeCock(player, x) + " to full attention and pressing it against her ready hole. Grasping her hips firmly, you whisper dirty words into your horse lover's ear before slowly thrusting in. Cotton gives an ever-so-slight whinny and a gasp, her body moving back into yours.\n\n");
    ...
    //(Get fucked, as Male)
    private cottonFucksYou() {
        DisplaySprite(12);
        Flags.list[FlagEnum.COTTON_MET_FUCKED] = 2;
        DisplayText().clear();
        DisplayImage(images.showImage("cotton-fucks-you"));
        player.slimeFeed();
        ...
        //(Get fucked, as Female)
            ...
            DisplayText("Cotton smiles, continuing to massage the soap in until she gets to your rear. There, she gets another handful of soap and presses it into your crevasse, gently soaping you up from " + Desc.Vagina.describeClit(player) + " to tailbone. Then she carefully inserts one finger into your pussy, then two, three, and before long her entire hand is exploring your most personal depths. She giggles and withdraws her hand, \"<i>My my, such an eager little cunt you have, my pet.</i>\"\n\n");

            DisplayText("She reaches between her legs and lifts her cock, letting it rest on the small of your back while she wets it down with water from the shower and strokes it to its full length. You feel it inching across your back, growing hotter and harder. With a glance back, you estimate it must be at least two feet long! You gulp and put your head down, clenching your teeth for the inevitable.\n\n");

            DisplayText("\"<i>Oh now pet, don't be so scared,</i>\" Cotton whispers into your ear, then lifts her cock from your back and places it at your " + Desc.Vagina.describeVagina(player, player.torso.vaginas.get(0)) + ". She reaches forwards and you hear the squeak of the temperature nozzle being turned. Seconds later, the water pouring down on you gets hotter, causing your whole body to heat up in response. Using this time, Cotton presses forwards, her equine cock invading your " + Desc.Vagina.describeVagina(player, player.torso.vaginas.get(0)) + " like a charging army. She thrusts in and out slowly, being careful not to hurt you.");
            Mod.Vagina.displayStretchVagina(player, 72, true, true, false);
            DisplayText("\n\n");
        ...
        //(Get fucked, as Herm)
            ...
            DisplayText("Before long you find yourself moaning beneath her, your cunt clenching and unclenching uncontrollably. \"<i>Ooh, my little pet likes it now, hmmm?</i>\" She whispers into your ear and nibbles on it ever-so-slightly. You can't help but give a breathless \"<i>Yes</i>\" in response. Cotton giggles and speeds up her thrusts. You find yourself pushing back into her, urging her to go deeper and deeper. Your " + Desc.Vagina.describeClit(player) + " twinges with pleasure after every thrust, and your own " + Desc.Cock.describeCock(player, player.torso.cocks.get(0)) + " is completely limp in the presence of this godly cock, but still it tingles with pleasure and anticipation.\n\n");
    ...
    private serviceFirstTimeCotton() {
        DisplaySprite(12);
        Flags.list[FlagEnum.COTTON_MET_FUCKED] = 2;
        player.slimeFeed();
        DisplayText().clear();
        DisplayImage(images.showImage("cotton-first-time-give-her-blowjob"));
    ...
    //(Shower Sex, Fuck Her)
    private fuckCottonInShowerRepeat() {
        Flags.list[FlagEnum.COTTON_MET_FUCKED] = 2;
        DisplaySprite(12);
        DisplayText().clear();
        DisplayImage(images.showImage("cotton-shower-fuck-repeat"));
        ...
        */
        ...
        if (player.torso.hips.legs.isTaur()) {
            ...
            //(If PC has one cock)
            if (x.area >= 100) {
                if (player.torso.cocks.count === 1) DisplayText("You feel your " + Desc.Cock.describeCock(player, x) + " stirring beneath your large body, while Cotton's remains curiously limp.  While her cock dangles, yours strains for attention.");
                //(If PC has multiple cocks)
                else if (player.torso.cocks.count > 1) DisplayText("You feel your " + Desc.Cock.describeMultiCockShort(player) + " stirring beneath your large body, while Cotton's remains curiously limp.  While her cock dangles, your group of cocks strains for attention.");
            }
            else {
                if (player.torso.cocks.count === 1) DisplayText("You feel your " + Desc.Cock.describeCock(player, x) + " stirring beneath your large body, while you watch Cotton's do the same. Her cock rubs against your stomach while yours strains for attention.");
                //(If PC has multiple cocks)
                else if (player.torso.cocks.count > 1) DisplayText("You feel your " + Desc.Cock.describeMultiCockShort(player) + " stirring beneath your large body, while you watch Cotton's do the same. Her cock rubs against your stomach while your group of cocks strains for attention.");
            }
            //(If PC has a pussy, add the following)
            if (player.torso.vaginas.count > 0) DisplayText("  Meanwhile, your " + Desc.Vagina.describeVagina(player, player.torso.vaginas.get(0)) + " behind you moistens both from the steam and from arousal, and your " + Desc.Vagina.describeClit(player) + " aches, craving attention.");
            DisplayText("\n\n");

            //(If PC has breasts)
            if (player.torso.chest.sort(BreastRow.BreastRatingLargest)[0].rating >= 2) {
                DisplayText("Cotton leans down, groping your " + Desc.Breast.describeBreastSize(character.torso.chest.sort(BreastRow.BreastRatingLargest)[0].rating) + ", taking one " + Desc.Breast.describeNipple(character, character.torso.chest.get(0)) + " into her mouth and sucking it greedily.");
                //(and if PC is lactating)
                if (player.torso.chest.sort(BreastRow.LactationMultipierLargest)[0].lactationMultiplier >= 1) {
                    DisplayText("  Her efforts are soon rewarded as milk begins seeping from your " + Desc.Breast.describeNipple(character, character.torso.chest.get(0)) + ". Cotton's eyes turn up to your face in surprise, but she doesn't remove her mouth, instead taking the time to gulp down your tasty milk. It isn't long before she draws back, wipes her mouth and practically tackles your other breast, eager to drain it of its precious cargo. You can't help but moan as a draining sensation overwhelms you. After a moment, Cotton pulls away and smacks her lips. \"<i>That is some tasty, tasty milk, pet, I might have to taste you more often.</i>\"");
                    Flags.list[FlagEnum.COTTON_BREAKFAST_CLUB] = 1;
                }
                //(else is PC is not lactating)
                else DisplayText("  Cotton soon switches to the other breast, teasing your " + Desc.Breast.describeNipple(character, character.torso.chest.get(0)) + " with her talented tongue.");
                DisplayText("\n\n");
            }
            ...
            //(if player is too small (under 4</i>\")
                ...
                DisplayText("</i>\" Letting a little smile cross your lips, you push your " + Desc.Cock.describeCock(player, x) + " fully into her, not a big accomplishment for one of your size, but still enough to make you feel good.");
            }
            ...
            if (x.area >= 100) DisplayText("Oblivious to you, her own limp cock leaks cum down onto the bench as an orgasm rocks her body.");
            ...
            //(If player is too big, add)
            if (x.area > 70) DisplayText("  Even with all the pounding you've been doing, you can't fit your entire girth into her, but she doesn't care. Her eyes seem to roll back and forth like it's hard to focus, and her tongue drips water, sweat and saliva onto her body. She's panting for breath and you are able to make out faint, \"<i>Oh gods, oh gods</i>\" over the running water. Were you able to see her toned stomach, you're sure you could see the outline of your " + Desc.Cock.describeCock(player, x) + " in it. Her back arches under the shower, her red hair messily draped around her face and bench, and she bites her lip as another orgasm rocks her body.");
            DisplayText("\n\n");
            ...
            //(If PC has a pussy)
            if (player.torso.vaginas.count > 0) DisplayText("  Your " + Desc.Cock.describeCock(player, x) + " erupts inside Cotton's warm cunt which clenches you tightly, while your own femme sex twinges and clenches on air, drooling juices down your legs.");
            //(else)
            else DisplayText("   Your " + Desc.Cock.describeCock(player, x) + " erupts inside Cotton's warm cunt which clenches you tightly.");
        ...
        //(Repeat fuck her, for nagas)
            ...
            DisplayText("You decide to take her up on her offer and lead her into the showers, quickly disrobing and turning on an available shower-head. Cotton strips as well and you pull her under the stream of water, sharing a kiss as steam begins to form around you. She runs a hand through your " + Desc.Head.describeHair(player) + " and grips the back of your neck, ");
            if (pregnancy.event > 1) DisplayText("pulling you gently towards her bulging belly, which you can't help but put your hands against as you kiss her. The bulge is firm and solid, almost a drum of solid muscle, and you caress it as you and the mare-morph make out, eliciting soft murmurs of appreciation for your efforts.");
            else DisplayText("pulling you closer.\n\n");

            if (x.area >= 100) {
                //(If PC has one cock)
                if (player.torso.cocks.count === 1) DisplayText("  You feel your " + Desc.Cock.describeCock(player, x) + " stirring beneath you, slowly coming to attention, though Cotton's remains curiously limp.  Your " + Desc.Cock.describeCockHead(x) + " rubs against her belly, sending ripples of pleasure up your spine.");
                //(If PC has multiple cocks)
                else if (player.torso.cocks.count > 1) DisplayText("  You feel your " + Desc.Cock.describeMultiCockShort(player) + " stirring beneath you, slowly coming to attention, though Cotton's remains curiously limp.  The group of cocks rubs together as you make out, sending ripples of pleasure up your spine.");
            }
            else {
                //(If PC has one cock)
                if (player.torso.cocks.count === 1) DisplayText("You feel your " + Desc.Cock.describeCock(player, x) + " stirring beneath you, slowly coming to attention alongside Cotton's equine member.  The two rub together as you make out, sending ripples of pleasure up your spine.");
                //(If PC has multiple cocks)
                else if (player.torso.cocks.count > 1) DisplayText("You feel your " + Desc.Cock.describeMultiCockShort(player) + " stirring beneath you, slowly coming to attention alongside Cotton's equine member. The group of cocks rubs together as you make out, sending ripples of pleasure up your spine.");
            }
            //(If PC has a pussy, add the following)
            if (player.torso.vaginas.count > 0) DisplayText("Your " + Desc.Vagina.describeVagina(player, player.torso.vaginas.get(0)) + " meanwhile moistens both from the water and from arousal, and your " + Desc.Vagina.describeClit(player) + " aches, craving attention.");
            DisplayText("\n\n");
            ...
            DisplayText("Suitably turned on now, you coil your body around Cotton's torso, with your tail spreading her legs apart while you place your " + Desc.Cock.describeCock(player, x) + " at her pussy. You slowly push in, and Cotton bites her lip, looking at you in approval.");
            //(If player has two cocks, add)
            ...
            //(If player is too big, add)
            if (x.area > 70) DisplayText("  Though you are far too big for her, you make sure to stuff her as much as you can. Her cunt, big as it is, squeezes tightly on your " + Desc.Cock.describeCock(player, x) + ". She shivers and quakes, and leans against the shower wall, gripping the shower-head for support. You thrust your overly large tool inside her over and over, stretching her already not insignificant cunt even wider. Her tongue actually rolls out of her snout, lolling to the side while her eyes roll up into her head, lost in the pleasure. Her body rocks with an orgasm while you piston away under the spray of water.");
            //(if player is too small (under 4</i>\") add)
                ...
                DisplayText("</i>\" Giving her a little smile, you push your " + Desc.Cock.describeCock(player, x) + " fully into her, not a big accomplishment for one of your size, but still enough to give you a little smile.");
            }
            //(otherwise add)
            ...
            if (x.area >= 100) DisplayText("Her own cock, still limp, visibly twitches and begins leaking cum onto her belly as an orgasm rocks her body.");
        ...
        //(Repeat Fuck Her, for humanoid bodies)
            ...
            if (player.torso.vaginas.count > 0) DisplayText("  Your " + Desc.Vagina.describeVagina(player, player.torso.vaginas.get(0)) + " moistens both from the water and from arousal, and your " + Desc.Vagina.describeClit(player) + " aches, craving attention.");
            DisplayText("\n\n");
            ...
            DisplayText("Suitably turned on now, you reach down and hook your arm under one of Cotton's legs, lifting it up while you position your " + Desc.Cock.describeCock(player, x) + " at her pussy. You slowly push in, and Cotton bites her lip, looking at you in approval.");
            //(If player has two cocks, add)
            ...
            //(If player is too big, add)
            if (x.area > 70) DisplayText("  Even in the missionary position you can't stuff your entire enormous girth into her, but she doesn't care. Her eyes seem to roll back and forth like it's hard to focus, and her tongue drips water, sweat and saliva onto her body. She's panting for breath and you are able to make out faint, \"<i>Oh gods, oh gods</i>\" over the running water. You can even make out the shape of your cock in Cotton's toned stomach, pumping back and forth, which brings a smile to your face. Her back arches under the shower, her hair messily spread out beneath her and she bites her lip as another orgasm rocks her body.");
            DisplayText("\n\n");
    ...
    private cottonFucksYouInShowerRepeat() {
        DisplaySprite(12);
        player.slimeFeed();
        Flags.list[FlagEnum.COTTON_MET_FUCKED] = 2;
        DisplayText().clear();
        DisplayImage(images.showImage("cotton-shower-fucks-you-repeat"));
        /*OLD SEX SCENES HERE
        ...
        //(Shower Sex, Get Fucked as Female)
            ...
            DisplayText("You decide to take her up on her offer, and she pulls you towards the showers, quickly disrobing the both of you. She turns only one shower-head on and pulls you into an embrace underneath the rapidly heating stream. Cotton's cock stirs between you, and your " +             Desc.Vagina.describeVagina(player, player.torso.vaginas.get(0)) + " burns with anticipation.\n\n");
        ...
        if (player.torso.hips.legs.isTaur()) {
            ...
            if (player.gender === Gender.MALE) DisplayText("  Your " + Desc.Cock.describeCock(player, player.torso.cocks.get(0)) + " tingles betwixt your legs, but remains limp in the presence of Cotton's impressive member.");
            //(If PC has a penis and vagina)
            else if (player.gender === Gender.HERM) DisplayText("  Your " + Desc.Cock.describeCock(player, player.torso.cocks.get(0)) + " tingles betwixt your legs, but remains limp in the presence of Cotton's impressive member, while your " + Desc.Vagina.describeVagina(player, player.torso.vaginas.get(0)) + " moistens almost immediately from the steam and arousal.");
            //(If PC has a vagina and no penis)
            else if (player.gender === Gender.FEMALE) DisplayText("  Your " + Desc.Vagina.describeVagina(player, player.torso.vaginas.get(0)) + " moistens almost immediately as you make out, both from the steam and your increasing arousal.");
            //(If PC is genderless)
            else DisplayText("  A deep aching burns within you, a need your body is ill-equipped to process, but still your nipples harden and you find your " + Desc.Butt.describeButthole(character.torso.butt) + " puckering in anticipation.");
            DisplayText("\n\n");

            //(If PC has breasts)
            if (player.torso.chest.sort(BreastRow.BreastRatingLargest)[0].rating >= 2) {
                DisplayText("Cotton's kisses lead down to your " + Desc.Breast.describeBreastSize(character.torso.chest.sort(BreastRow.BreastRatingLargest)[0].rating) + ", where she takes one " + Desc.Breast.describeNipple(character, character.torso.chest.get(0)) + " into her mouth, sucking it greedily and teasing it masterfully.");
                //(and if PC is lactating)
                if (player.torso.chest.sort(BreastRow.LactationMultipierLargest)[0].lactationMultiplier >= 1) {
            ...
            //(If PC has a vagina)
            if (player.torso.vaginas.count > 0) DisplayText("  Spying your " + Desc.Vagina.describeVagina(player, player.torso.vaginas.get(0)) + ", Cotton smiles and flicks your " + Desc.Vagina.describeClit(player) + " teasingly before slipping two fingers inside your folds and bringing them to her mouth, licking them clean. \"<i>Mmm... I love the taste of your juices, pet...</i>\"");
            //(if PC is genderless)
            ...
            DisplayText("Cotton continues the kisses down to your " + Desc.Leg.describeLegs(player) + " and stands, dragging over a bench from the locker room before standing on it and giving your " + Desc.Butt.describeButt(player) + " a good smack. You turn back and give her a coy look, which she returns and gives your flank another smack.");
            DisplayText("  She takes a moment to get some water from the shower over your rear end before pressing her cock against your " + Desc.Body.assholeOrPussy(player) + ", slipping it in gently, careful not to go too quick. You moan slightly and blush, whispering back at her, urging her to continue.");
            //(Stretch and appropriate virginity check)
            if (player.torso.vaginas.count > 0) Mod.Vagina.displayStretchVagina(player, 72, true, true, false);
            else Mod.Butt.displayStretchButt(player, 72, true, true, false);
            DisplayText("\n\n");
        ...
        //(Repeat get fucked for humanoids and nagas)
            ...
            DisplayText("You decide to take her up on her offer, and she pulls you towards the showers, quickly disrobing you forcibly and then herself. She turns only one shower-head on and pulls you into an embrace underneath the rapidly heating water. She kisses up your neck and playfully bites you with a grin.");
            //(If PC has a penis, no vagina)
            if (player.gender === Gender.MALE) DisplayText("  Your " + Desc.Cock.describeCock(player, player.torso.cocks.get(0)) + " tingles beneath you, but remains limp in the presence of Cotton's impressive member.");
            //(If PC has a penis and vagina)
            else if (player.gender === Gender.HERM) DisplayText("  Your " + Desc.Cock.describeCock(player, player.torso.cocks.get(0)) + " tingles beneath you, but remains limp in the presence of Cotton's impressive member while your " + Desc.Vagina.describeVagina(player, player.torso.vaginas.get(0)) + " moistens almost immediately from the steam and arousal.");
            //(If PC has a vagina and no penis)
            else if (player.gender === Gender.FEMALE) DisplayText("  Your " + Desc.Vagina.describeVagina(player, player.torso.vaginas.get(0)) + " moistens almost immediately as you make out, both from the steam and your increasing arousal.");
            //(If PC is genderless)
            else DisplayText("  A deep aching burns within you, a need your body is ill-equipped to process, but still your nipples harden and you find your " + Desc.Butt.describeButthole(character.torso.butt) + " puckering in anticipation.");
            ...
            if (player.torso.cocks.count > 0) {
                //(If PC has a large penis, bigger than Cotton's capacity, add)
                if (player.torso.cocks.sort(Cock.LargestCockArea)[0].area > 70) DisplayText("  \"<i>Oh my, what's this?</i>\" She puts a hand under your enormous, yet embarrassingly limp cock and lifts it slightly. \"<i>My little pet has such a big dick... Just how I like it. Perhaps next time I'll get to try it out... but not today, hm? This is all about you right now.</i>\"");
                //(If PC has a penis under 4</i>\", add)
            ...
            if (player.torso.hips.legs.isNaga()) {
                DisplayText("Cotton continues the kisses down to your " + Desc.Leg.describeLegs(player) + ", and stands, grabbing you by the waist and lifting you up off the ground.  ");
            ...
            //(If Humanoid body)
                ...
                DisplayText("Cotton continues the kisses down to your " + Desc.Leg.describeLegs(player) + " and stands, hooking an arm underneath each of your legs and lifting you up off the ground.  ");
            ...
            DisplayText("  She gives you a quick kiss and moves her cock to your " + Desc.Body.assholeOrPussy(player) + ", slipping it in gently, careful not to go too quick. You give her a submissive, but encouraging kiss, and whisper in her ear, urging her to continue.");
            //(Stretch and appropriate virginity check)
            if (player.torso.vaginas.count > 0) Mod.Vagina.displayStretchVagina(player, 72, true, true, false);
            else Mod.Butt.displayStretchButt(player, 72, true, true, false);
            DisplayText("\n\n");
            ...
            DisplayText("Exhausted, Cotton sets you down on the shower floor under the spray of water, though cum leaks from your abused hole and your " + Desc.Leg.describeLegs(player) + " quivering so much you nearly collapse. Your partner steadies you, however, and you regain your footing quickly. You return to the task of cleaning yourselves, sensually washing each other's most intimate areas. Yoga, sex and cleanup done, you get dressed and leave the gym, giving Cotton's hand a final squeeze before departing.");
        }
    ...
    //(Tantric Sex)
    public cottonTantricSex() {
        DisplaySprite(12);
        DisplayText().clear();
        DisplayImage(images.showImage("cotton-tantric-sex"));
        player.slimeFeed();
        Flags.list[FlagEnum.COTTON_MET_FUCKED] = 2;
        //OLD TANTRIC SMEX
        ...
        DisplayText(" sensations on an unfamiliar part of your body... well, her body. You stand over her hips and slowly lower yourself down, impaling your " + Desc.Body.assholeOrPussy(player) + " on her meaty tool. In addition to the beautiful sensation of being filled, you also get the sensation of warm, tight constriction on your phantom cock.");
        //(for Naga Body, add)
        ...
        DisplayText("Though there's no real thrusting or vulgar movements of any kind, the feelings are intense, likely heightened by your tantric link. You can simultaneously feel Cotton's long equine cock pulse within you, as well as feel your own " + Desc.Body.assholeOrPussy(player) + " clamping down on a cock that is not your own.");
        if (player.torso.vaginas.count > 0) Mod.Vagina.displayStretchVagina(player, 72, true, true, false);
        else Mod.Butt.displayStretchButt(player, 72, true, true, false);
        //(If PC has a penis, add)
        if (player.torso.cocks.count > 0) DisplayText("  Meanwhile, your own " + Desc.Cock.describeCock(player, player.torso.cocks.get(0)) + " hangs limply in front of you, tingling with arousal, but unable to harden. Cotton gives it a pat and says, \"<i>Worry not, pet, there's only room for one cock right now, but I'll want it some other time.</i>\"");
        DisplayText("\n\n");
        ...
        //(If PC has a penis)
        if (player.torso.cocks.count > 0) DisplayText("  Your " + Desc.Cock.describeCock(player, player.torso.cocks.get(0)) + " twitches and tingles, releasing its pent up seed in a dribbling torrent down your belly and chest, right into your face and pooling around your head.");
        //(If PC has a vagina)
        if (player.torso.vaginas.count > 0) DisplayText("  Your " + Desc.Vagina.describeVagina(player, player.torso.vaginas.get(0)) + " shivers and clamps down hard on the invading cock, pulsing and milking it as it unloads directly into your womb.");
        //(If PC doesn't have a vagina)
        else DisplayText("  Your " + Desc.Butt.describeButthole(character.torso.butt) + " shivers and clamps down hard on the invading cock, pulsing and milking it as it unloads directly into your intestines.");
    ...
    //lactating.)
    public nomSomeTitMilkCereal() {
        DisplaySprite(12);
        DisplayImage(images.showImage("cotton-visits-you-at-camp-drinks-all-your-milk-the-asshole"));
    ...
    private cottonPregnantAlertII() {
        DisplayText().clear();
        DisplayImage(images.showImage("cotton-you-got-her-preggo"));
    ...
    private cottonPopsOutAKid() {
        let kid: number = 0;
        //(Replaces Yoga session)
        DisplayText().clear();
        DisplayImage(images.showImage("cotton-giving-birth"));
        if (Flags.list[FlagEnum.COTTON_KID_COUNT] === 0) {
            ...
            //{Silly Mode:}
            if (User.settings.silly()) DisplayText("As long as the cube shark isn't there.  ");
    ...
    private cottonContraceptionToggle() {
        DisplayText().clear();
        //REPEATS
    ...
    //[=Stop Taking=]
    private tellCottonStopEatingHorsePills() {
        DisplayText().clear();
    ...
    //[=Keep Taking=]
    private tellCottonToKeepFiringBlanksAsshole() {
        DisplayText().clear();
    ...
    //Turn On
    private repeatContraceptionToggleCotton() {
        DisplayText().clear();
    ...
    public goTellCottonShesAMomDad() {
        DisplayText().clear();
