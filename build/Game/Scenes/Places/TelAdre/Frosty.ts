class Frosty {
    ...
    public approachFrosty(): void {
        ...
        if (Flags.list[FlagEnum.MET_FROSTY] === 0) {
            ...
            DisplayText("You go out to Frosty’s stand; she’s there manning it with a huge smile on her face. “<i>Hello there customer, how may I help you?</i>” You greet her with your own smile and hello and take a look at her menu:\n");
            DisplayText("1. Cupcake x 1 = 15gems\n");
            DisplayText("2. Cupcake x 5 = 60gems\n");
            DisplayText("3. Cupcakes x 10 = 110gems\n");
            DisplayText("4. Cupcakes x 20 = 200gems\n");
    ...
    public frostysHandsAreColdHolyShitWhyDontYouWarmTHoseMitsUp(): void {
        ...
        //[If player is Herm]
            ...
            DisplayText("“<i>Okay, one stroke-and-poke comin’ right up</i>” she snickers at her own name for using her hand to pleasure a herm. She ducks under the table and pulls up a big, fancy, cushioned chair that looks like it belongs to a noble and also shouldn’t be able to fit in the tiny space under her booth.");
            ...
            else DisplayText("your pussy lips");
    ...
    public genderlessCatchAllForFrosty(): void {
        ...
        //[If player selects any option besides sex and is Gender-less repeatable]
            ...
            DisplayText("“<i>Sorry customer, you need a cock or a pussy or BOTH if I’m to do that!</i>” she sings in a cheesy jingle tone that makes you go, “<i>ughhhhhh.</i>”");
        }
        //[Back to Frosty’s Special Menu.]
        frostySpecialsMenu();
    }
    ...
    */
    ...
    function analWithACupcakeSloot():void
    {
        ...
        {
            DisplayText("“<i>So you wanna be the pitcher or the catcher?</i>” she ask with devilish smile. What the hell is that suppose to mean?");
            //[pitcher?]  [catcher?]
        }
        else
        {
