class Lottie {
            ...
            if (Flags.list[FlagEnum.UNKNOWN_FLAG_NUMBER_00281] === 0) {
                ...
                if (display) {
                    ...
                    if (Flags.list[FlagEnum.UNKNOWN_FLAG_NUMBER_00280] < 30 && randInt(6) === 0) {
                        ...
                        if (silly()) DisplayText("  What can you say? You love making bacon.");
                    }
                    //[Encouragement 0 – 30]
                        ...
                        if (silly()) DisplayText("  What can you say? Her pork buns are the best.");
                    }
                    //[REPEAT INTROS]
                    else if (randInt(2) === 0) {
    ...
    public encounterLottie(charge: boolean = false): void {
        ...
        DisplayText().clear();
        DisplayText(images.showImage("lottie-encounter"));
        if (charge) {
        ...
        //[REPEAT ENCOUNTER]
            ...
            //[Normal Encounter, Encouragement 60 - 100]
                ...
                //[Figure 60 - 80]
                else if (Flags.list[FlagEnum.UNKNOWN_FLAG_NUMBER_00279] <= 80) DisplayText("\"<i>Yo, " + player.mf("big guy", "babe") + "! I've been waiting for you, so you better be pumped! Ready to get started?</i>\" Lottie leans over, her creamy tits pushed against the table. She seems to be excited for what you've got in store today.");
                //[Figure 80 - 100]
                else DisplayText("\"<i>Hey, " + player.mf("stud", "cutie") + "! You shouldn't keep me waiting, or I'll put you through the burn twice as hard! You ready?</i>\" Lottie winks at you and punches your arm playfully. She seems to be excited for what you've got in store today.");
            }
    ...
    public gotInShapeComedyDeclineLottie(): void {
        DisplaySprite(36);
        DisplayText().clear();
        DisplayText("Haha, of course you fucking aren't, why would you be? Lottie stares at you, tears welling in her eyes. Oh, whoops – you must've said that out loud. Proceeding to not give two shits about the bawling pig-slut in front of you, you take a good squeeze of her cushiony tits before whipping your " + CockDescriptor.describeCock(player, player.torso.cocks.sort(Cock.LargestCockArea)[0]) + " out and slapping her in the face with it.  \"<i>W-w-why... why are you... *sniff* p-please...!</i>\" The pig girl chokes in between sobs. It almost gives you a hard on - almost. You take one final step backwards, before announcing quite loudly to the other cafe-goers that you're going for a home run. Lottie squeaks before you take your " + CockDescriptor.describeCock(player, player.torso.cocks.sort(Cock.LargestCockArea)[0]) + " and swing at her face, hitting dead on and managing to leave a bit of pre-cum on her newly-christened cheek. You stand triumphantly at your latest work of art, though Lottie seems to have other ideas, running out the door in complete misery, pre-cum and all. You decide you'd better return home too, and head back towards the camp – but not before spending the next hour or so chasing after Lottie and taking grabs at her plush ass.");
        //[PC no longer encounters Lottie.]
        Flags.list[FlagEnum.UNKNOWN_FLAG_NUMBER_00278] = 1;
        return { next: Scenes.camp.returnToCampUseOneHour };
    }
    ...
    private drinkLustWithYourHamhock(): void {
        ...
        DisplayText("You take her by the hand and lead her into one of the empty saunas. \"<i>" + player.short + "...</i>\" You grab her by the hips and lean her against the wall, throwing off her towel and revealing her velvety skin underneath. Reaching down, you grab a handful of her luxurious ass, squeezing and slapping it lightly. Lottie moans into your shoulder and reaches towards your groin, removing your " + player.inventory.equipment.armor.displayName + ". She begins stroking " + Desc.Cock.describeMultiCockSimpleEach(character) + " lightly, picking up the pace as you continue to work on her pert rump. You can't help but lust over her full figure, using one of your hands to firmly grope her pillowy jugs and reaching your other towards her glistening pussy. You move your hand over her cushiony rack, before burying your head into her bosom and eagerly sucking on one of her nipples, fondling the other between your thumb and forefinger. Your other hand is already fast at work, fingering her hot cunt. You can feel her legs about to buckle beneath their own weight. Lottie moans in between short, hot breaths, \"<i>Y-you're... really amazing, " + player.mf("guy", "lady") + ".</i>\"  You give her chubby ass a hard slap in agreement.  Lottie squeals in glee, jerking your " + CockDescriptor.describeCock(player, player.torso.cocks.get(0)) + " as it pokes into her soft stomach. The sensation of your tip rubbing against her velvety skin drives you wild.\n\n");
    ...
    public analLottieMilkshake(): void {
        DisplaySprite(36);
        DisplayText().clear();
        DisplayText(images.showImage("lottie-fuck-her-in-teh-butzor"));
        let x: number = player.cockThatFits(40);
        if (x < 0) x = 0;
        ...
        DisplayText("\"<i>A-aa-ah, I-I... AHH!</i>\" Lottie oinks noisily, her eyes rolling to the back of her head and her large thighs slapping against your own, pulling your " + CockDescriptor.describeCock(player, x) + " further in. She shudders in orgasm");
        ...
        if (player.torso.balls.quantity > 0) DisplayText("Your " + BallsDescriptor.describeSack(player) + " begins to swell");
    ...
    public getSuckedOffByAHamSandwich(): void {
        DisplaySprite(36);
        DisplayText().clear();
        DisplayText(images.showImage("lottie-gives-you-a-blowjob"));
        let x: number = player.torso.cocks.sort(Cock.LargestCockArea)[0];

        DisplayText("You grab Lottie's shoulders and firmly move her down towards your crotch. She kneels down, face to face with your " + CockDescriptor.describeCock(player, x) + ".  Feeling her hot breath against your " + player.skinFurScales() + ", you tell her to suck it.\n\n");

        //[If player cock is at or below 4']
        if (player.torso.cocks.get(x).length <= 4) {
            DisplayText("She stares at your " + CockDescriptor.describeCock(player, x) + " and then up at you. \"<i>I... oh, well I guess this is okay.</i>\" She lazily slurps your member into her mouth, and moans at the taste of your " + CockDescriptor.describeCock(player, x) + ". Her agile tongue moves over your entire length, licking gently over your sensitive head and along your shaft. Your " + CockDescriptor.describeCock(player, x) + " sits comfortably inside her warm hole, covered in her saliva");
            if (player.torso.cocks.count > 1) {
        ...
        //[If the player has a cock between 5' – 12']
            ...
            DisplayText("She stares intently at your " + CockDescriptor.describeCock(player, x) + " with hunger in her eyes. A small amount of drool escapes her luscious lips as she moves forward, kissing your ");
            if (player.torso.cocks.count > 1) DisplayText(" biggest head lightly");
            else DisplayText(" head lightly");
            DisplayText(".  Her saliva leaks onto your " + CockDescriptor.describeCock(player, x) + ", though she is quick to lick it up while she works her tongue around the rest of your shaft");
            if (player.torso.cocks.count > 1) DisplayText(", jerking off your " + CockDescriptor.describeCock(player, player.biggestCockIndex2()) + " with both hands");
        ...
        //[If the player has a cock equal to or over 13']
            ...
            DisplayText("She gasps as you lift your " + CockDescriptor.describeCock(player, x) + " and slap her face. \"<i>It's... wow, " + player.short + "!</i>\" You grin before poking her pudgy cheek with the tip of your ");
            if (player.torso.cocks.count > 1) DisplayText("biggest erection");
            else DisplayText("erection");
            DisplayText(".  A small amount of drool escapes her luscious lips as she moves forward, kissing your head lightly. Her saliva leaks onto your " + CockDescriptor.describeCock(player, x) + ", though she is quick to lick it up while she works her tongue around the rest of your lengthy shaft");
            if (player.torso.cocks.count > 1) DisplayText(" - using her hands to massage your leftover " + CockDescriptor.describeCock(player, player.biggestCockIndex2()));
            DisplayText(". She places small licks on the tip of your head, and without warning stuffs as much of your thick girth as she can into her mouth, coughing around your " + CockDescriptor.describeCock(player, x) + ".\n\n");
        }

        DisplayText("She begins fellating your cock at an incredible rate, throatfucking herself on your " + CockDescriptor.describeCock(player, x));
        ...
        DisplayText(". You remark on what a hungry little piggy she must be, and the chubby girl moans in response, the vibrations massaging your member. Relishing the feeling of your " + CockDescriptor.describeCock(player, x) + " in between her hungry lips, you start to thrust into her warm mouth hole, grabbing onto her head as you pound her face against your groin.");
        if (player.torso.cocks.count > 1) {
        ...
        //[if Multi]
        if (player.torso.cocks.count > 1) DisplayText(" stops rubbing your " + CockDescriptor.describeCock(player, x) + " to ");
        //(Otherwise)
        ...
        //If Balls]
        if (player.torso.balls.quantity > 0) DisplayText("knead your " + BallsDescriptor.describeBalls(true, true, player));
        else DisplayText("reach around and squeeze your " + ButtDescriptor.describeButt(player));
        ...
        DisplayText("You slowly take your " + CockDescriptor.describeCock(player, x) + " out of her hot mouth, a small *pop* breaking the silence as it escapes her plump, puckered lips. Grabbing one of her hefty tits in your hands, you rub your cockhead against her erect nipple, eliciting a small moan from the sweaty slut. You slap your " + CockDescriptor.describeCock(player, x) + " against her sweaty chest a few times before burying it in between her cleavage, ");
        //[If the player has a cock equal to or over 13']
        ...
        DisplayText("cum you've painted on her flesh and gulping it all down. \"<i>Thanks for the load, " + player.mf("big guy", "babe") + ",</i>\" she remarks, sucking gently on her fingers. \"<i>I'll... I'll see you again, hey!</i>\" You pat her on the head and begin to make your way out of the gym, making sure to grab a ");
        if (silly()) DisplayText("bacon ");
        DisplayText("shake on the way out.");
        //LOTTIE FIGURE -1, MUSCLE TONE +1, DRAINS PC'S LUST.
        lottieTone(-1);
    ...
    private lotteryAppearance(): void {
        DisplaySprite(36);
        DisplayText().clear();
        DisplayText(images.showImage("lottie-examine-appearance"));
    ...
    private lottieFatLoserCulminationFuckChoice(): void {
        ...
        if (silly()) DisplayText("bacon ");
        DisplayText("shake on the way out.");
        if (silly()) DisplayText("  You fucking love bacon shakes.");
    ...
    private lottieFatLoserCulminationHumiliationChoice(): void {
        ...
        if (silly()) DisplayText("BACON BACON BACON BACON BACON BACON! GOTTA HAVE BACON!");
    ...
    private lottieHighMoraleFatLoveSelfOneTimeEvent(): void {
        ...
        if (player.cockArea(x) <= 40) DisplayText("her ample cheeks resting on your groin as you bottom out in her");
        ...
        DisplayText("  You both lay on the mat, panting in ecstasy while your " + CockDescriptor.describeCock(player, x) + " continues to ejaculate inside her.\n\n");

        DisplayText("A while later, you've both said your goodbyes for the night.");
        if (silly()) DisplayText(" Before you leave, you make sure to head out to the cafe to buy yourself a bacon shake. You love bacon shakes.\n\n");
        else DisplayText("\n\n");
    ...
    private lottieHighMoraleFatYoullGetThereOneTimeEvent(): void {
        ...
        if (silly()) DisplayText("bacon ");
        DisplayText("shake on the way out.");
        if (silly()) DisplayText("  They're fucking delicious.");
        DisplayText("\n\n");
        //[Unlocks Quickie]
    ...
    private lottieElleThreesomeFirstTime(): void {
        ...
        if (silly()) DisplayText("bacon ");
        DisplayText("shake on the way out.");
        if (silly()) DisplayText("  You only need one of those to satisfy you.");
        player.orgasm();
        player.stats.sens += -2;
        //[Unlocks Threesome]
    ...
    private fuckElleInsteadOfThatFatSlutFirstTime(): void {
        ...
        if (player.torso.cocks.count === 1) {
            DisplayText("begins to caress your " + CockDescriptor.describeCock(player, x) + " with two of her hands, while the other sets to work on ");
        ...
        else DisplayText("uses all four of her hands to handle your " + CockDescriptor.describeMultiCockShort(player) + ", jerking each one with ease");
        ...
        if (silly()) DisplayText(", making sure to grab a bacon shake on the way out. You only need one of those to satisfy you");
        DisplayText(".");
        //[Unlocks Netorare]
    ...
    private boastAtLottie(): void {
        ...
        if (silly()) DisplayText("large *pomf =3*");
    ...
    private waitAndShowLottieYourPoolBoner(): void {
        DisplaySprite(36);
        DisplayText().clear();
        DisplayText("You figure it can't do much harm to let " + CockDescriptor.describeMultiCockSimpleOne(player) + " fly, so you decide to leave it be, even leaning back so as to accentuate the hardening length. It doesn't take long for Lottie to notice, letting out a little gasp as she observes your ");
        if (player.torso.cocks.biggestCocks[0].area >= 15) DisplayText("pride and joy");
        else if (player.torso.cocks.biggestCocks[0].area < 5) DisplayText("secret shame");
    ...
    public hamSammitchTimeBIATCH(): void {
        ...
        if (Flags.list[FlagEnum.UNKNOWN_FLAG_NUMBER_00324] === 0) {
            ...
            if (silly()) DisplayText(", mumbling something about lifetime members receiving free pig-related food items");
    ...
    public lottieFuck(): void {
        ...
        //[If Encouragement 30 – 60]
            ...
            DisplayText("You ask Lottie if she's keen for a little 'extracurricular workout', earning a giggle and a tilt of the head from the pig-girl. \"<i>What do you mean, " + player.mf("big guy", "babe") + "?</i>\" she asks. You sigh and stand up, revealing your hardening member");
            if (player.torso.cocks.count > 1) DisplayText("s");
        ...
        //[If Encouragement 60 – 100]
            ...
            DisplayText("Lottie whimpers in between short, hot breaths, \"<i>You're driving me crazy here, babe...</i>\" You give her chubby ass a hard slap in agreement. Lottie squeals in glee, jerking your " + CockDescriptor.describeCock(player, x) + " as it pokes up through her ass. The sensation of your tip rubbing against her velvety skin drives you wild.\n\n");
    ...
    public lottieRepeatDoggieStyle(): void {
        DisplaySprite(36);
        DisplayText().clear();
        DisplayText(images.showImage("lottie-fuck-her-doggie-style-repeat"));
        let x: number = player.cockThatFits(40);
        if (x < 0) x = 0;
    ...
    public lottieRepeatWalkies(): void {
        DisplaySprite(36);
        DisplayText().clear();
        DisplayText(images.showImage("lottie-fuck-her-in-public-repeat"));
        let x: number = player.cockThatFits(40);
        if (x < 0) x = 0;
        ...
        if (silly()) DisplayText("bacon ");
        DisplayText("shake.");
        if (silly()) DisplayText("  You sure do love spit roasting a pig, but nothing can beat a bacon shake.");
        player.orgasm();
        player.stats.sens += -2;
        player.stats.cor += 1;
        return { next: Scenes.camp.returnToCampUseOneHour };
    ...
    public lottieRepeatCowGirl(): void {
        DisplaySprite(36);
        DisplayText().clear();
        DisplayText(images.showImage("lottie-fuck-her-cowgirl-repeat"));
        let x: number = player.cockThatFits(40);
        if (x < 0) x = 0;
        ...
        if (silly()) DisplayText("bacon ");
        DisplayText("shake.");
        if (silly()) DisplayText("  You love bacon shakes.");
        player.orgasm();
        player.stats.sens += -2;
    ...
    public lottieRepeatQuickie(): void {
        ...
        DisplayText("In moments flat you remove your clothes to jump the piggy, whipping out your " + CockDescriptor.describeCock(player, x) + " and pushing it against Lottie's wet slit, the pig-girl lying on her back while her legs rest upon your shoulders. With a hearty thrust you drive yourself into her, eliciting a loud moan while you pork her insides with your meat. Her thick thighs slap against you as you bend over to take a lustful grab at her melons, sucking at her nipple and pinching the other, her sweet taste enveloping your mouth. Lottie buries you in her cleavage, yelping as you piledrive her tight pussy into submission – but you've got more in store. Flipping her over, Lottie lies face down with her soft butt jutting up in the air, your persistent fucking driving her wild. You continue gripping onto her tits as you pound her flesh, every thrust accompanied by her pleasured grunts. Back and forth you mount her until the familiar sensation in your loins signal your release. You increase your pace, pounding her pussy until you pull your head back and ejaculate inside her inner walls, slamming in harder every few seconds with each burst.");
        if (player.torso.cocks.count > 1) {
            DisplayText("  Your other cock");
            if (player.torso.cocks.count === 2) DisplayText(" twitches ");
            else DisplayText("s twitch ");
    ...
    public lottieRepeatThreesome(): void {
        DisplaySprite(36);
        DisplayText().clear();
        DisplayText(images.showImage("lottie-fuck-her-threesome-repeat"));
        let x: number = player.cockThatFits(40);
        if (x < 0) x = 0;
    ...
    public lottieRepeatSUPERNEATORARES(): void {
        ...
        if (player.torso.cocks.count === 1) {
            DisplayText("begins to caress your " + CockDescriptor.describeCock(player, x) + " with two of her hands, while the other sets to work on massaging your ");
        ...
        else DisplayText("uses all four of her hands to handle " + CockDescriptor.describeMultiCockSimpleOne(player) + ", jerking each one with ease");
        ...
        DisplayText("  Elle follows suit, groaning in pleasure as she reaches her own peak, her hole tightening around your length and trapping the rest of your spunk inside. The spinnerets upon her shoulder pulse in orgasm, spurting sticky globs of what appears to be thread up into the air and back down onto the pig, spunk pooling around her cleavage. You both relax, letting the spider-girl down off of you to collapse on the floor. You bend down, looking at Lottie before shoving your " + CockDescriptor.describeCock(player, x) + " inside of her and letting one final spurt of your seed fill her up. \"<i>Satisfactory.</i>\" You mumble, redressing and heading out the door, making sure to grab a ");
        if (silly()) DisplayText("bacon ");
        DisplayText("shake on the way out.");
        if (silly()) DisplayText("  You only need one of those to satisfy you.");
        player.orgasm();
    ...
    public lottieRepeatBackwardsAssCowgirl(): void {
        ...
        let x: number = player.cockThatFits(40);
        if (x < 0) x = 0;
        DisplayText("You both walk into the yoga area, met with the smell of sweat and flowers pervading the room. Lottie gently asks for you to lie down on your back, to which you comply quite easily. You're comfortable, folding your arms behind your head to give you leverage as you watch your lover walk slowly to you. Lottie turns around, her thick thighs straddling you as she sits down on your groin with her back facing your direction, giving you  a perfect view of her curvy body and plump ass. Your " + CockDescriptor.describeCock(player, x) + " nestles gently between her rosy cheeks, pulsing with lustful intent as the girl grabs her hips and begins to pleasure you through her ass. The silence of the room breaks at your fevered pants and grunts as Lottie's skillful assjob sends you through fits of ecstasy, every curve of her bottom jiggling against the heat of your member. Her pace picks up while she bounces upon you, squeezing and squashing her perfect ass until one final lift in the air is met with her plunging your length up into her hot interior. The feeling of your molten cock inside her immediately sends Lottie into fits of orgasmic bliss, the intense heat filling the pig-girl with pleasure. Her attempts to continue are thwarted by your " + CockDescriptor.describeCock(player, x) + " scraping against her inner walls, her thick thighs clenched together while she slowly moves up and down upon you. Deciding to take things into your own hands, you thrust upwards, almost pushing the girl off with your strength and causing Lottie to squeal as you begin pounding her irresistible hole. Her lush buttcheeks jiggle with every movement you make, the rising and falling of her body moving in accordance to your own will. You pump in and out, keeping a steady rhythm inside the hot and bothered woman.\n\n");
    ...
    public lottieRepeatFEMDOMFEMFDOM(): void {
        ...
        //[If Cum Production High]
            ...
            DisplayText("Unfortunately for her, you have far too much built up to stop now. With another thrust, your " + CockDescriptor.describeCock(player, x) + " pulses in delight, exploding in orgasm as ropes of spunk splatter upon Lottie's face and tits. The girl gasps, the sheer amount of your seed painting her white. \"<i>N-no, stop! Oh god!</i>\" she yelps, before her mouth is filled with your hot essence. She forces herself to swallow, coughing as you grin at the defeated slut. \"<i>O-okay, y-you win, " + player.short + ".</i>\" she looks up at you and smiles, before untying your binds and setting you free. \"<i>But you have to admit, this was pretty fun, right?</i>\" You give her a thumbs up before walking out the door, leaving her to clean your thick mess. On the way out, a milkshake vendor waves over to you – it's the guy from the cafe. You buy a ");
            if (silly()) DisplayText("bacon ");
            DisplayText("shake before deciding to head home.");
            if (silly()) DisplayText("  You fucking love bacon shakes.");
        }
    ...
    public tentaDickLottieButtFuckbuttFuckButtFUCKBUTTFUCKBUTTFUCK(): void {
        DisplayText().clear();
        DisplayText(images.showImage("lottie-fuck-her-with-tentacle-dick"));
        let x: number = -1;
        let y: number = -1;
        let z: number = -1;
        let zz: number = -1;
        ...
        if (y >= 0) {
            DisplayText("Seeing that you have extra junk left to be used, and she has some vacant holes, you quickly remedy this problematic situation; guiding your " + CockDescriptor.describeCock(player, y) + " toward her moist butthole, you press the tip of your tree-like beast against her plush buttocks, literally stabbing her flesh with your penile flora.  The butt-slut doesn't seem to care: if anything, she squirms all the more, visibly aroused.  Her ass seems to stretch on its own as it braces itself for the imminent butt-devastation.  You welcome Lottie's efforts to comply to your anal needs and with a single thrust, you push ");
            if (player.cockArea(y) <= 80) DisplayText("the entirety of your " + CockDescriptor.describeCock(player, y));
            else DisplayText("as many inches of your " + CockDescriptor.describeCock(player, y));
                    ...
                    if (zzz >= 0) {
                        ...
                        if (zzzz >= 0) {
                            ...
                            if (zzzzz >= 0) {
                                ...
                                if (zzzzzz >= 0) DisplayText("  Seeing the effect your junk had on her, you move your " + CockDescriptor.describeCock(player, zzzzzz) + " to her remaining hand and she grips it likewise.");
        ...
        // generic
        else DisplayText("You stand exhausted, trembling slightly from the after-effects of your climax while your tree-like junk slows its movements.  Retracting your " + CockDescriptor.describeCock(player, x) + ", you slowly change back into your " + player.inventory.equipment.armor.displayName + " while Lottie comes to.  She hazily opens her eyes, the smell of hot semen in the air while she lifts herself upwards, remembering the sequence of events leading to where she is now. \"<i>H-huh? " + player.short + "...</i>\" the girl mumbles, struggling to move out only to find she's still underneath the small weighted mattress.  \"<i>H-hey! I'm still stuck!</i>\"\n\n");
        //[if enc. 100]
        if (lottieMorale() >= 99) {
            ...
            if (silly()) DisplayText("  Before you leave, you make sure to grab a bacon shake from the clerk, high-fiving her as you backflip back to camp.");
            DisplayText("\n\n");
        }
        //[if enc. 0]
        else {
            ...
            if (silly()) DisplayText("  Unfortunately for the spider-clerk, you've raided her cart of bacon shakes on the way out.  You try to backflip back to camp before accidentally dropping the majority of your shakes onto the floor, ultimately deciding to walk back normally - the last beverage you could save gripped firmly in your hands.");
        }
        player.orgasm();
        player.stats.sens += -2;
        return { next: Scenes.camp.returnToCampUseOneHour };
    ...
    public ifrisAndLottieGetsNTRedLiftingWeights(): void {
        DisplayText().clear();
        DisplayText(images.showImage("lottie-ifris-threesome"));
    ...
    private lottieAndIfrisNTREpilogue(): void {
        ...
        if (silly()) DisplayText("  You'll make damn sure to buy Urta a bacon shake tomorrow.");
        return { next: Scenes.camp.returnToCampUseOneHour };
    }
