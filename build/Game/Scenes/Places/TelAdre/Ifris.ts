class Ifris {
    ...
    public approachIfris(): void {
        ...
        if (Flags.list[FlagEnum.MET_IFRIS] === 0) {
            ...
            DisplayText("\"<i>Hello, darling. I'm so glad you decided to join me... You can call me Ifris.</i>\" She tilts her head to the side cutely, gazing up at you through her lashes.\n\n");

            DisplayText("You give her your name, mouth suddenly feeling a little too dry for some reason as she gives you that sultry smile and lingering gaze.\n\n");

            DisplayText("\"<i>It's nice to meet you. Are you here to use the machines, or were you just hoping to watch the pretty bodies working up a sweat?</i>\" she giggles cutely, two of her clawed fingers covering her mouth demurely.\n\n");
        }
        //2a-Repeat approach, no sex-
            ...
            DisplayText("Ifris grins as you walk over again, the devil girl's dark tongue dabbing at her even darker lips as she all but coos up at you.\n\n");

            if (Flags.list[FlagEnum.IFRIS_SHOWED_OFF] === 0) DisplayText("\"<i>Hello darling... here to actually give me a show?</i>\"\n\n");
            else DisplayText("\"<i>Hello darling... here to give another show? I did so enjoy your last performance.</i>\"\n\n");
        }
        //2b-Repeat approach, had oral-
        else {
            DisplayText("Ifris grins as you walk over again, the devil girl's dark tongue dabbing at her even darker lips. A small shudder runs through you as you imagine her remembering your flavor...\n\n");

            DisplayText("\"<i>Hello darling... so lovely to see you. Are you here to give me a show this time? Or do you think you want to try to beat your last record?</i>\"\n\n");

            DisplayText("A bit confused, you ask her what record she's talking about, only to evoke a small, cute laugh from her.\n\n");

            DisplayText("\"<i>How long you can lift that much before my attentions are too distracting, of course.</i>\"\n\n");
        }
        DisplayText("(You could go ahead and work out while she watches, ask her to join you, or leave.)");
    ...
    private workOutForIfris(): void {
        ...
        if (player.fatigue > 70) {
            DisplayText("There's no way you could work out as tired as you are.  Maybe you could come back to flirt with the demonic-looking girl during your next workout.");
            return { next: telAdre.gymDesc };
            return;
        }
        DisplayText("You smile to the devil-looking-girl and tell her you're just here to get your work-out on.\n\n");

        DisplayText("\"<i>Oh, don't mind me, then. Please, by all means.</i>\" She gestures to the bench-press, stepping back and watching you with a smile.\n\n");

        DisplayText("\"<i>I hope you don't mind if I keep you company. I'd love to... see you in action.</i>\"\n\n");
    ...
    private askIfrisToJoinYou(): void {
        ...
        DisplayText("You ask Ifris if she'd like to join you in some exercises. Her eyes glint mischievously, obviously finding unintended meaning in your words, and you can't help but blush.\n\n");

        DisplayText("\"<i>That's sweet of you, darling... but I don't want to get in the way. I'll just wait my turn. Don't worry about me at all.</i>\"\n\n");

        DisplayText("You shrug at her response, but there's something about the way she eyes you now...");
        //WORK OUT or SHOW OFF?
        MainScreen.simpleChoices(["Work Out", "Show Off", "", "", ""], [liftWhileIfrisWatches, showOffForIfris, null, null, null]);
    }
    ...
    private liftWhileIfrisWatches(): void {
        ...
        DisplayText("As you finish your sets, she smiles a little wider at you, reaching over and tracing one fingertip teasingly along your jawline.\n\n");
    ...
    private showOffForIfris(): void {
        ...
        if (player.stats.str < 40) {
            ...
            DisplayText("Ifris only rolls her eyes, flipping a hand at you dismissively as she walks away, murmuring.\n\n");

            DisplayText("\"<i>I've no time for show-offs who can't back it up, darling.</i>\"\n\n");

            DisplayText("Humiliated, you stand and leave, nursing your sore body and ego.");
        ...
        if (player.stats.str < 75) {
            ...
            DisplayText("\"<i>Oh well...</i>\" She sighs, clearly crestfallen. Cocking one fist on her hip, she gives your " + LegDescriptor.describeLeg(player) + " a light pat as she leaves your presence, vanishing out the door within moments.\n\n");

            DisplayText("Well, at least you had the good sense to stop before you hurt yourself...\n\n");
            return { next: Scenes.camp.returnToCampUseOneHour };
            Flags.list[FlagEnum.IFRIS_SHOWED_OFF] = 0;
            return;
        }
        //4b5-PC masculinity > 60, corruption > 75, has cow features-
        if (player.gender === Gender.NONE || (player.femininity < 40 && player.stats.cor > 75 && player.torso.neck.head.face.type === FaceType.COW_MINOTAUR)) {
        ...
        if (player.torso.cocks.count > 0) {
            //Double dickings!
            if (player.torso.cocks.count > 1 && randInt(2) === 0 && player.cockThatFits(70) != -1 && player.cockThatFits2(70) != -1) {
                ifrisDP();
                return;
            }
            //First time
            if (Flags.list[FlagEnum.TIMES_FUCKED_IFRIS_BLOWJOB] === 0) {
                ...
                DisplayText("\"<i>Mmm, keep going, darling... I like what I see,</i>\" she all but purrs out.\n\n");

                DisplayText("Spurred on by your ego, you lift the huge weight with seeming effortlessness.  The devil-girl seems to move closer as your muscles burn and strain. Suddenly you feel one of her slender hands sliding up your " + LegDescriptor.describeLeg(player) + ", the smooth palm stroking your thigh, and then cupping your crotch. A surge of arousal ripples through your cock, making the length twitch and immediately begin to swell as she squeezes, making you pause in your efforts.\n\n");
        ...
        //4b4-PC succeeds! Is female!-
            ...
            //5b-Repeat oral scene, female-
                ...
                DisplayText("\"<i>Always a pleasure, darling. I can't wait to see you again soon...</i>\" And she's leaving you once more, her butt swaying more than usual, moisture leaking down her long, slender legs...");
            }
    ...
    private ifrisDP(): void {
        ...
        if (player.torso.cocks.filter(Cock.FilterType(CockType.DOG) >= 2)).length {
            DisplayText("Both your canine cocks bloat with seed, the knot's distending and stretching so wide that Ifris couldn't pull off if she wanted.  A moment later, the twin dog-dicks explode pillars of alabaster cream, painting the truly knotted woman's innards white.  ");
            ...
            DisplayText("Throughout the massive release, you're softly grunting, held immobile by your animalistic body's instincts as your peckers try their damnedest to impregnate your overly fit mate.  You're still cumming, but your knots are starting to deflate at last.  ");
        }
        //(Nodule growing, unholy demonocity)
        else if (player.torso.cocks.filter(Cock.FilterType(CockType.DEMON) >= 2)).length {
            DisplayText("Both your demonic cocks explode inside Ifris, the nodules along each shaft swelling out, thickening to stroke and caress your oily lover's inner walls.  A moment later, the tainted tips explode out, spurting demon-spunk into both silky tunnels.  ");
            if (player.cumQ() >= 1000) DisplayText("She groans and moans as she's filled, her body distending to deal with the unholy amount of seed your cocks can spew.  ");
        ...
        else if (player.torso.cocks.filter(Cock.FilterType(CockType.HORSE) >= 2)).length {
            DisplayText("Both your equine cocks explode inside Ifris, their tips swelling outward into thick flares that plug her stuffed channels.  A moment later, the swollen tips unleash pillars of alabaster cream, painting everything above the flares white.  ");
            if (player.cumQ() >= 1000) DisplayText("She groans and moans as she's filled, her body distending to deal with the unholy amount of seed your cocks can spew.  ");
            DisplayText("Your hips begin to rock and thrust, and no matter what you try to do, you cannot seem to still your body, your animal instincts owning your waist as you inseminate your seductive, teasing lover's body.  ");
        }
        ...
        //(Anemone - stinging funtimes)
            ...
            DisplayText("Both your unusual, aquatic cocks explode inside Ifris, their shafts thickening as the prepare for release.  A moment later, they explode out twin pillars of alabaster cum, painting her inner walls with gooey spunk.  ");
            if (player.cumQ() >= 1000) DisplayText("She groans and moans as she's filled, her body distending to deal with the unholy amount of seed your cocks can spew.  ");
        ...
        //(Standard)
            ...
            DisplayText("Both your cocks explode inside Ifris, submitting alabaster pillars to her request for your release.  The red-hued sexpot exhales a happy hum and rocks her hips back and forth, her oily, lubricated holes squeezing your dicks for every drop of delectable seed.  ");
            if (player.torso.cocks.count > 2) {
                DisplayText("The ");
                if (player.torso.cocks.count === 1) DisplayText("one unbound prick remaining paints the muscular woman's lower back with goo, but she doesn't seem to mind.");
                else DisplayText("other, unbound pricks paint the muscular woman's lower back in goo, but she doesn't seem to mind.");
                DisplayText("  ");
            }
        }
        //(ALL GO HERE - NOT NEW PG) 
        DisplayText("She purrs, \"<i>Delightful,</i>\" into your ear and plants a wet kiss on you, surely leaving a dusky, black lip-print on your neck.\n\n");

        DisplayText("The last few contractions work through you, emptying the last of your load inside Ifris and allowing you to feel utterly, completely at peace.  Sliding up, she lets your slowly-deflating cocks ");
        if (player.torso.cocks.filter(Cock.FilterType(CockType.DOG) >= 2) DisplayText("noisily pop free")).length;
        else DisplayText("slide");
        DisplayText(" from her sperm-glazed snatch and anus.  Her body's warmth vanishes as she stands, and with a wink, she reattaches her bikini bottom, the tight garment moulding to her soaked camel-toe and holding in all of your leavings.  She walks away without another word, ");
        if (player.cumQ() >= 1000) DisplayText("her body bloated with cum and sloshing audibly with every step");
        else if (player.cumQ() >= 500) DisplayText("her belly bloated and gurgling with every step");
        else DisplayText("her body double-stuffed with seed");
        DisplayText(".  You slump back and breathe heavy, feeling like you've just run a marathon.\n\n");

        DisplayText("It is some time until you gain the energy to rise.");
        fatigue(10);
        //Stat changes HERE!
