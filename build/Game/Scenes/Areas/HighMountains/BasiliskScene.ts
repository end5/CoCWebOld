...
export class BasiliskScene {
	...
	private defeatBasiliskAndAnal(): void {
		...
		if (player.torso.cocks.count > 0) {
			...
			if (player.torso.cocks.get(x).length <= 13) {
				DisplayText("Soon your " + LowerBodyDescriptor.describeHips(player) + " are clapping a staccato rhythm against its warm, muscly butt,");
				if (player.torso.balls.quantity > 0) DisplayText(" your " + BallsDescriptor.describeBalls(true, true, player) + " slapping against it,");
			...
			//(More than 13 inches:)
				...
				//[(if balls)
				if (player.torso.balls.quantity > 0) DisplayText("Your " + BallsDescriptor.describeBalls(true, true, player) + " swing heavily underneath your shaft, swelling as your rhythm picks up.  ");
	...
	private defaultBasiliskRape(): void {
		...
		//Male/Herm: 
		if (player.torso.cocks.count > 0) {
			DisplayText("With surprising gentleness and deftness, the basilisk rubs your " + CockDescriptor.describeCock(player, player.torso.cocks.get(0)) + " with one palm");
			if (player.torso.vaginas.count > 0) DisplayText(" and sticks some of the smaller fingers of its other hand in your " + VaginaDescriptor.describeVagina(player, player.torso.vaginas.get(0)));
			DisplayText(", thankfully angling its sickle claw away.  You can't do anything against it, and some of its mental compulsion remains; a backwash of erotic images from your past fill your head, and you can't even grit your teeth as the gentle, insistent pressure brushing your prick makes you rock hard.  It stops when you are erect and then, with the very faintest of smiles playing over its cruel mouth, leaves. You're naked, your " + CockDescriptor.describeCock(player, player.torso.cocks.get(0)) + " is begging for release; you're utterly helpless... you can only hope that the spell will wear off, and before anything else in the mountain finds you.\n\n");
		}
		//Female: 
		else if (player.torso.vaginas.count > 0) {
			DisplayText("With surprising gentleness and deftness, the basilisk slips the smaller fingers of one hand into your " + VaginaDescriptor.describeVagina(player, player.torso.vaginas.get(0)) + ", and carefully flicks at your " + VaginaDescriptor.describeClit(player) + " with the other, thankfully holding its sickle claws away from you.  You can't do anything against it, and some of its mental compulsion remains; a backwash of erotic images from your past fill your head, and you can't even grit your teeth as the gentle, insistent caresses make you wet.  It stops when you are beading moisture involuntarily onto its hand and then, with the very faintest of smiles playing over its cruel mouth, leaves. You're naked, your " + VaginaDescriptor.describeVagina(player, player.torso.vaginas.get(0)) + " begs to be filled; you're utterly helpless. You can only hope that its spell will wear off, and before anything else in the mountain finds you...\n\n");
		}
		//Genderless: 
	...
	public basiliskBirth(): void {
		...
		if (player.perks.has(PerkType.BasiliskWomb)) {
			...
			//(eggNumber) 
			DisplayText(num2Text(Math.floor(player.totalFertility() / 10)));
	...
	private basiliskBadEnd(): void {
		...
		if (player.gender === Gender.HERM) DisplayText("  You moan through your still throat as you feel blood rushing to your groin, your " + CockDescriptor.describeMultiCockShort(player) + " stiffening and your " + VaginaDescriptor.describeVagina(player, player.torso.vaginas.get(0)) + " beginning to drip.");
		if (player.gender === Gender.MALE) DisplayText("  You moan through your still throat as you feel blood rushing to your groin, your " + CockDescriptor.describeMultiCockShort(player) + " stiffening.");
		if (player.gender === Gender.FEMALE) DisplayText("  You moan through your still throat as you feel blood rushing to your groin, your " + VaginaDescriptor.describeVagina(player, player.torso.vaginas.get(0)) + " beginning to drip.");
	...
	private basiliskAdvantageHarpy(): void {
		...
		//Genderless: 
			...
			DisplayText("The harpy comes to a halt behind you and begins to eagerly run her cold but soft hands over your bottom half, stroking your thighs and squeezing your " + ButtDescriptor.describeButt(player) + ", as if appraising a piece of meat.  Whilst caressing your neck she runs her hands between your legs and grabs around your groin, searching for something that isn't there.  She lets loose a squawk of pure frustration and wheels around you to glare in your eyes angrily.  The sex-crazed harridan is clearly deeply irritated about finding such a helpless victim only to further discover they lack a cock which she can abuse.  She shifts her eyes to your mouth, but quickly arrives at the same conclusion you've already come to: unable to move your mouth, you can't even be forced to give oral pleasure.  You feel a bizarre sense of triumph over the creature; you stare into space smugly as the harpy paces in front of you, glaring, thwarted but unwilling to give up her prize.  Perhaps eventually she will leave you alone...?\n\n");
	...
	private basiliskAdvantageGoblin(): void {
		...
		//Unsexed: 
			...
			DisplayText("\"<i>Get caught with our pants down by a basilisk, did we?</i>\" the goblin purrs.  \"<i>Well, not to worry. I'll take good c- hey, what gives?!</i>\" From behind you, you feel her hands thread their way around your " + LegDescriptor.describeLegs(player) + " before feeling and slapping all around your featureless groin.  \"<i>This is fucking bullshit!</i>\" she howls.  \"<i>I get a toy that can't stop me all to my lonesome, and it's some colossal jerkoff who thinks it's funny to have no sex!</i>\"  She stomps around to your front and glares at you, simmering with rage.  \"<i>I bet you think you're a real smartass, you bastard... you bitch... you... whatever!  Ooh, I'll fix you!</i>\"  With a look of complete disgust she storms off.  Having faced down this bizarre rant, you allow yourself to feel a tiny bit of relief.  You were worried for a moment there she'd go for your ass... a short distance away, you hear the goblin calling to someone.\n\n");
			...
			DisplayText("The huge bull-man is not one to look a gift fuck in the mouth.  Without bothering to take you in, bar a long wet sniff of your " + HeadDescriptor.describeHair(player) + ", he sticks his cock between your ass cheeks.  He grunts as he forces his head past your sphincter, squirting pre-cum into your passage as he does so.  Your body is incapable of clenching instinctively against the invasion, but there is no escaping how huge the dong feels as he impatiently forces your ass open.");
			...
			DisplayText("Eventually the minotaur's balls swell against your " + ButtDescriptor.describeButt(player) + " and with a long, satisfied moo, he reaches his peak, holding you down so his cum jets forth deep inside you.  The sensual high it has already instilled in you amplifies by tenfold as the warm, oozing fluid finds its mark and you moan as you spontaneously orgasm, your anus helplessly milking the creature for all it can get.\n\n");
		...
		//Female: 
			...
			DisplayText("  You feel the goblin crawl on top of you, pulling the dildo upwards so it rubs against your " + VaginaDescriptor.describeClit(player) + " and then with a squealing giggle impales herself on the other end.  Her lustful movements translate through the artificial cock buried in your dripping sex, sending tremors and waves of pleasure to your very core.  A gush of female fluid splatters over your own sex as the goblin works herself right down the shaft connecting you until she is squelching against you wetly.  The goblin twists, grinding and scissoring her thighs, the hard bud of her clit rubbing back and forth over your own.  By now your passage feels as stuffed as it ever has been, crammed totally full of the squishy expanded double-dong.  Every motion the tiny slut makes is amplified directly into the fuck-stick plugging your " + VaginaDescriptor.describeVagina(player, player.torso.vaginas.get(0)) + ".  Judging by how wonderful it feels rubbing and twisting against your sensitive walls, the aphrodisiac it is leaking into you is definitely having an effect.  You whine at the goblin twists herself and her dildo around, rubbing and riding you so effectively, the involuntary tide of erotic memories building again...\n\n");
	...
	private basiliskAdvantageMinotaur(): void {
		...
		DisplayText("Eventually the minotaur's balls swell against your " + ButtDescriptor.describeButt(player) + " and with a long, satisfied moo, it reaches its peak, holding you down so its cum jets forth deep inside you.  ");
		if (player.gender === Gender.MALE) DisplayText("The sensual high it has already instilled in you amplifies by tenfold; the warm, oozing fluid finds its mark and you moan as you spontaneously ejaculate, ropes of your own cum spattering on the ground and your own nerveless " + LowerBodyDescriptor.describeFeet(player) + ".");
	...
	private driderPCEggLaysBasilisk(): void {
		...
		if (silly()) DisplayText("Pinning him between a rock and a hardening place, ");
