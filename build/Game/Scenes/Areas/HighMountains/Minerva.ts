...
export class Minerva extends Character {
    public constructor() {
        ...
        this.inventory.equipment.defaultArmorSlot.equip(new Armor("comfortable clothes" as ArmorName, undefined, "comfortable clothes", 1, 5));
        this.inventory.equipment.defaultWeaponSlot.equip(new Weapon("halberd" as WeaponName, undefined, "halberd", "slash", 30, 150));
        this.baseStats.bonusHP = 470;
        this.baseStats.lust = 20;
        this.baseStats.lustVuln = .2;
        // this.temperment = TEMPERMENT_LOVE_GRAPPLES;
        this.baseStats.level = 16;
        this.inventory.gems = randInt(25) + 10;
        this.baseStats.additionalXP = 50;
        // this.drop = new WeightedDrop(consumables.PURPEAC, 1);
        this.torso.wings.type = WingType.HARPY;
        this.torso.wings.desc = "fluffy feathery";
    }
}
