...
export class Gnoll extends Character {
    public constructor() {
        ...
        this.inventory.equipment.defaultArmorSlot.equip(new Armor("skin" as ArmorName, undefined, "skin", 2));
        this.inventory.equipment.defaultWeaponSlot.equip(new Weapon("twisted club" as WeaponName, undefined, "twisted club", "smash", 0, 25));
        this.baseStats.bonusHP = 250;
        this.baseStats.lust = 30;
        this.baseStats.lustVuln = .35;
