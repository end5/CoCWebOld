...
export class FrogGirlScene {
    ...
    // Follow:
    private followDatFrog(player: Character) {
        DisplayText().clear();
    ...
    private getFrogButtFilled(player: Character) {
        DisplayText().clear();
    ...
    private questDatFrogGirl(player: Character) {
        DisplayText().clear();
    ...
    private carryBeeGirlsEggsVoluntarilyYouButtSlut(player: Character) {
        DisplayText().clear();
    ...
    // **
    private voluntarilyGetEggedEpilogue(player: Character) {
        DisplayText().clear();
        DisplayText("You wake up an hour later and it takes a while for you remember anything.  Gradually, you piece the last hour together, remembering the frog girl, her hypnotic song, and hallucinogenic slime.  You’re floating on your back in a crystal-clear pool, and above you, between the mangrove canopies, Mareth’s sky drifting lazily far overhead.");
    ...
    private lessonFollowup(player: Character) {
        DisplayText().clear();
    ...
    // Laying the Eggs
    public birthFrogEggsAnal(player: Character) {
    ...
    private superBonusFrogEggsInYerCooch(player: Character) {
        DisplayText().clear();
    ...
    // Vaginal Egg birth
    public layFrogEggs(player: Character) {
