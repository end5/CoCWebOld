...
// 			game.simpleChoices("Fuck it", game.mountain.hellHoundScene.hellHoundGetsRaped, "", null, "", null, "", null, "Leave", game.Scenes.camp.returnToCampUseOneHour);
// 		}
// 		else {
...
export class InfestedHellhound extends Character {
    public constructor() {
        super(CharacterType.InfestedHellhound);
        this.description = new CharacterDescription(this, "the ", "infested hellhound", "It looks like a large four-legged demon with two heads placed side-by-side. Its eyes and mouth are filled with flames, and covering each of its paws are large and menacing claws. A thick layer of dark fur covers his entire body like armor.  Both heads are looking at you hungrily as the hellhound circles around you.  A pair of black, slightly pointed cocks hang exposed, dripping with cum and worms.  You get the feeling reasoning with this beast will be impossible.");
        this.torso.cocks.add(new Cock(9, 2, CockType.DOG));
        this.torso.cocks.add(new Cock(9, 2, CockType.DOG));
        this.torso.balls.quantity = 2;
        this.torso.balls.size = 5;
        this.cumMultiplier = 8;
        this.torso.chest.add(new BreastRow());
        this.torso.chest.add(new BreastRow());
        this.torso.chest.add(new BreastRow());
        ...
        this.inventory.equipment.defaultWeaponSlot.equip(new Weapon("claws" as WeaponName, undefined, "claws", "claw", 5));
        this.baseStats.lust = 50;
        this.baseStats.lustVuln = 0.87;
        // this.temperment = TEMPERMENT_LOVE_GRAPPLES;
        this.baseStats.level = 5;
        this.inventory.gems = 10 + randInt(10);
