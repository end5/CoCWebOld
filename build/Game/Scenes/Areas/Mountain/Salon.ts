export class Salon implements TimeAwareInterface {
	...
	private favoriteSalonMenu() {
		salonPurchaseMenu();
		MainScreen.addButton(6, "Payments", salonFavoritesPaymentMenu);
	}

	private salonFavoritesPaymentMenu() {
		let blow;
	...
	private hairDresserRepeatGreeting() {
		DisplayText().clear();
		DisplaySprite(38);
	...
	private goblinHairDresserFacefuck() {
		DisplaySprite(38);
		DisplayText("Lynnette licks her lips and practically tears her way into your " + player.inventory.equipment.armor.displayName + ", having your crotch exposed in seconds.  Your " + Desc.Cock.describeCock(player, player.torso.cocks.get(0)) + " flops out immediately, slapping her on the nose as it grows hard.  She wraps both hands around you and begins pumping with practiced ease, flicking her tongue over your crown and wrapping her lips ", true);
	...
	private cutShort() {
		...
		DisplayText("Lynnette and her daughters crowd around you with razor-sharp scissors, effortlessly paring down your " + Desc.Head.describeHair(player) + ".  When they've finished, you're left with ", true);
	...
	private minotaurCumBukkakeInSalon() {
		DisplayText().clear();
		player.minoCumAddiction(10);
		player.slimeFeed();
