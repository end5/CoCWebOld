export class NagaScene {
	...
	public nagaEncounter() {
		DisplaySprite(45);
		//Create status if needed
		if (!player.statusAffects.has(StatusAffectType.Naga)) player.statusAffects.add(StatusAffectType.Naga, 0, 0, 0, 0);
		DisplayText().clear();
		if (player.hips.legs.type === LegType.NAGA) {
			...
			if (player.statusAffects.get(StatusAffectType.Naga).value2 === 0) {
				...
				DisplayText("You wander into the desert, noting how good the sand feels on your underbelly compared to rocks and dirt. You are wondering to yourself if maybe it wouldn't be a bad idea to come out here more often when you spot something moving a little farther ahead of you.\n\n");
			...
			//[If player has fangs]
			if (player.torso.neck.head.face.type === FaceType.SNAKE_FANGS) DisplayText("your own.");
			//[player has no fangs]
			else DisplayText("the inside of your mouth.");
			DisplayText("\n\n");
			//dude secks
			if (player.gender === Gender.MALE || (player.gender === Gender.HERM && randInt(2) === 0)) {
				//[Player cock is too big]
				if (player.torso.cocks.get(0).area > 35) {
					DisplayText("The kiss continues as both of your bodies rub together sensually, your tails continuing to wrap around one another. There is a pulsing in your " + Desc.Cock.describeCock(player, player.torso.cocks.get(0)) + " as it starts to grow hard against the naga's soft belly. Feeling this, the naga gently pulls away, slowly letting your tongue out of her mouth as she does so. Her hands make their way over your shoulders, down your abs, and stop at your " + Desc.Cock.describeMultiCockShort(player) + ".\n\n");
					DisplayText("\"<i>You're quite the big boy, aren't you?</i>\" she says as she wraps both of her hands around your now throbbing " + Desc.Cock.describeCock(player, player.torso.cocks.get(0)) + ". She starts to slide her hands up and down your length. Sticking out her tongue, she wraps it around the tip and licks at the pre that is starting to leak out.\n\n");
					DisplayText("A hiss of pleasure escapes your lips as the naga strokes and licks at your " + Desc.Cock.describeCock(player, player.torso.cocks.get(0)) + ", her talented fingers and tongue bringing you into a further state of arousal. The naga stops her caressing and brings your " + Desc.Cock.describeCock(player, player.torso.cocks.get(0)) + " to her chest, pressing her breasts around it. She slowly starts to slide her body up and down your shaft, using her tongue to bring some of your pre and lubricate her body. Once she is satisfied with her body's slickness, she quickens her pace.\n\n");
					DisplayText("You moan in pleasure as the naga takes the tip of your member into her mouth and starts to suck. You can feel her deft tongue licking every inch of your cock head.\n\n");
					DisplayText("At your limit, you let out a yell as you cum into her mouth. ");
					//[lots of jizz]
					if (player.cumQ() > 250) DisplayText("Her cheeks bulge with the volume and she struggles to swallow as much of it as she can. ");
					//[JIZZOFTHEGODS]
					if (player.cumQ() > 1000) DisplayText("Her cheeks bulge out with the sheer volume of your cum and she is forced to release you from her mouth to avoid drowning in your seed. ");
					DisplayText("You collapse onto the sand and lay there, basking in the warm glow of your orgasm. The naga slides onto your chest and gives you a kiss. \"<i>I rather enjoyed that,</i>\" she hisses into your ear, \"<i>We should do this more often.</i>\"\n\n");
					DisplayText("She gives you one last kiss before slithering off into the desert. You watch as she leaves and blow her a kiss goodbye before she disappears from your sight.\n\n");
				}
				//[Cock isn't too big]
				else {
					DisplayText("The kiss continues and both of your bodies rub together sensually, your tails continuing to wrap around one another. There is a pulsing in your " + Desc.Cock.describeMultiCockShort(player) + " as ");
					if (player.torso.cocks.count === 1) DisplayText("it starts ");
					else DisplayText("they start ");
					DisplayText("to grow hard against the naga's soft belly. Feeling this, the naga gently pulls away, slowly letting your tongue out of her mouth as she does so. Her hands make their way over your shoulders, down your abs, and stop at your " + Desc.Cock.describeMultiCockShort(player) + ".\n\n");
					//[player has one dick]
					if (player.torso.cocks.count === 1) DisplayText("Gently she starts to stroke the length of your " + Desc.Cock.describeCock(player, player.torso.cocks.get(0)) + " with one hand while circling the tip with the other. ");
					//[player has two dicks]
					if (player.torso.cocks.count === 2) DisplayText("She takes one in each of her hands and gently strokes them up and down. Every few seconds she stops at the tip to rub her palms over them. ");
					//[player has three or more dicks]
					if (player.torso.cocks.count >= 3) DisplayText("She takes one in each hand, stroking them slowly and making sure to pay attention to the tip. Every so often she switches to a different dick to make sure that each and every one of your throbbing cocks has some love given to them. ");
					DisplayText("A hiss of pleasure escapes your lips as the naga strokes your " + Desc.Cock.describeMultiCockShort(player) + ", her talented fingers bringing you further into a state of arousal. She stops her caress and brings her hand to a scaly covering at her crotch, spreading it wide to reveal her soft pussy.\n\n");

					//[player has one dick] 
					if (player.torso.cocks.count === 1) DisplayText("She carefully lines it up with your member and starts to tease the tip before gently inserting the first few inches. ");
					//[player has two dicks]
					if (player.torso.cocks.count === 2) DisplayText("She carefully lines it up with both of your members and starts to tease their tips before gently inserting the first few inches. ");
					//[player has three or more dicks]
					if (player.torso.cocks.count >= 3) DisplayText("She carefully lines it up with one of your members and starts to tease the tip before gently inserting the first few inches. ");
					DisplayText("She pulls her hips back slightly before pushing them back down, swallowing a bit more of you into her.  As she pulls back the second time, she shifts her arms to rest on your shoulders and grips your back tightly as she pushes you deeper inside of her.\n\n");
					...
					//[lots of jizz]
					if (player.cumQ() > 250) DisplayText("You quickly fill her with your seed to the point where she overflows, leaving her pussy dripping with semen afterwards.");
					//[JIZZ, JIZZ EVERYWHERE] 
					else if (player.cumQ() > 1000) DisplayText("Her stomach quickly swells from the sheer volume of seed pumped into her. The sperm that her womb is unable to hold starts to gush out from her stuffed cunt.");
			...
			//chick secks
				...
				DisplayText("The kiss continues and you can feel your " + Desc.Breast.describeBreastRow(player.torso.chest.get(0)) + " pressing against her own. You kiss her harder, pressing your body as close to her as you can, enjoying the feeling of your two bodies entwined together. You wrap your tail around hers, trying to make every part of your body touch every part of hers.  The feeling of her scaled tail rubbing against your body sends shivers of ecstasy down your spine. You pull away from her mouth and move your head to kiss at her neck, ");
				//(if player has fangs)
				if (player.torso.neck.head.face.type === FaceType.SNAKE_FANGS) DisplayText("carefully nibbling at it so as to not break the skin.  ");
				else DisplayText("nibbling gently at it.  ");
				...
				if (player.statusAffects.get(StatusAffectType.Naga).value2 === 0) {
					DisplayText("As you start to unveil her innermost recess, it appears to you that she must have lost the habit of such intimate contact after spending all these years deprived of any contact.  ");
				}
				...
				DisplayText("You slide your fingers out of her and lift yourself up to look into her flushed face. \"<i>N-no,</i>\" she pants. \"<i>Don't stop... So close...</i>\"\n\n");
				DisplayText("You place a finger onto her luscious lips. \"<i>Shhhhh,</i>\" you say lovingly. \"<i>All good things must come to an end, but I'm not done yet.</i>\"\n\n");
				DisplayText("You untangle the end of your tail from hers and bring it up between the two of you, sliding it between your " + Desc.Breast.describeBreastRow(player.torso.chest.get(0)) + " and inserting it sensually into your mouth. You suck on the end, making sure to coat it liberally before bringing it down to the naga's awaiting slit.\n\n");
				...
				DisplayText("You simply run your tongue around her ear, gently nibbling on it as you slowly impale your naga lover on your thick, nimble tail. Her tail whips back and forth across the sand as she slowly succumbs to the intense pleasure of your deep, intimate penetration. You begin to wriggle your own tail inside your naga friend and her response is immediate. First, she shudders as a chill of excitement rushes up her spine. As the sensation overwhelms her, she lets out a wail of satisfaction followed by a series of loud moans in time with your tail's various jerks and twists inside her. As the naga girl begins to climax, driven over the edge by your tail's intense sensations, her tail begins to flick about wildly. In a stroke of genius, you manage to grab the end of her tail, holding it more or less steady against your own " + Desc.Vagina.describeClit(player) + ". As her tail wiggles back and forth, it drives your " + Desc.Vagina.describeClit(player) + " insane, rubbing it back and forth over and over again. You prolong your friend's climax by driving your wriggling tail ever deeper inside her and soon you find yourself close to orgasm. As you feel your own climax commence, you clench your teeth and lean against your partner, your breasts mashing together and your juices beginning to intermingle. As you both begin to calm down again, chests heaving, the only thing you can think to do is kiss your partner.\n\n");
				DisplayText("She returns your kiss, but while you are distracted she prepares herself to help you in the same way you helped her. She begins to rub her tail along your " + Desc.Vagina.describeVagina(player, player.torso.vaginas.get(0)) + ", getting it wet. As you feel her scaly member begin to slide inside your own " + Desc.Vagina.describeVagina(player, player.torso.vaginas.get(0)) + ", the very thought gets you excited. Although somewhat jumpy, she is able to push at a modest rate, slowly inching her tail inside you, very much like the way you did to her. As you continue to passionately kiss each other, your tongues wrapping around one another and your arms wrapped around each other's warm bodies, you cannot think of a better place to be. Soon, you and your partner are tail-fucking each other in unison, your lips never parting, your bodies never separating. The both of you collapse upon the sand, too focused on one another to care about the surroundings.  That is how it carried on for what seemed like a beautiful, passionate eternity. You wake up several hours later, lying on the sand next to your friend, and you can't help but notice how cute she looks asleep. Your tails are still buried within one another, testament to the intensity of your lovemaking. You loved until the both of you collapsed, side by side, juices dripping out into the dry desert sands. You slowly remove your tail from inside her body, and simultaneously pull hers from your " + Desc.Vagina.describeVagina(player, player.torso.vaginas.get(0)) + ". You kiss her on the cheek, and are just close enough to hear her whisper, \"<i>Will we ever meet again?</i>\"  You lean in close, and whisper a simple \"<i>Yes.</i>\" Then, you leave her to her well-deserved rest, and slowly meander back to your camp, your brain still intoxicated with passion.\n\n");
				Mod.Vagina.displayStretchVagina(player, 30, true, false, true);
				player.orgasm();
				DisplayText("You think it would be a very good idea to come to the desert more often.");
				return { next: Scenes.camp.returnToCampUseFourHours };
				return;
			}
			//Genderleast
			else {
				DisplayText("The naga looks down and suddenly giggles at your stark lack of fun-bits. You turn away in embarrassment and start to head back to your camp.\n\n");
				DisplayText("\"<i>Wait,</i>\" the naga reaches out and places a hand on your shoulder. \"<i>I didn't mean to insult you. I've never seen anyone else quite like you.</i>\" She slides her hand down your body. \"<i>I wonder if you can show me just what a body like yours can do.</i>\"\n\n");
				...
				//(If tongue is forked)
				//9999 - BLAH!
				if (1 === 0) DisplayText("You move your tongue faster and deeper into her pussy, your forked tongue reaching deeper than any human tongue ever could.  ");
				//(Otherwise)
				else DisplayText("You move your tongue faster and faster into her pussy, reaching as far in as you possibly can.  ");
				DisplayText("The naga grips your head tightly to her and suddenly thrusts her hips in orgasm, her girl cum coating your tongue and mouth.\n\n");
				DisplayText("You uncoil yourself and slowly gather your things, the naga lying on the sand panting.\n\n");
				DisplayText("\"<i>We should do this more often,</i>\" she says before you head off.\n\n");
			}
			DisplayText("You think it would be a very good idea to come to the desert more often.");
		...
		if (player.statusAffects.get(StatusAffectType.Naga).value1 === 0) {
			if (!player.statusAffects.has(StatusAffectType.Naga)) player.statusAffects.add(StatusAffectType.Naga, 0, 0, 0, 0);
			DisplayText("You are walking through the shifting sands of the desert when you hear a sudden hiss behind you.  Expecting to be attacked by a snake, you quickly leap forward and turn around.\n\n");
	...
	private gooNagaRape() {
		DisplayText().clear();
		player.orgasm();
		DisplayText("You look over at the prone form of the naga lying in the sand, her ");
		if (monster.stats.HP < 0) DisplayText("weak ");
		else DisplayText("flushed ");
		DisplayText("form only serving to arouse you further. You slide over to her, your gooey lower half leaving a wet trail behind you. As you stand over the defeated form of the snake woman, an idea pops into your head, ");
		if (player.stats.cor > 50) {
			//(if corrupt male)
			if (player.gender === Gender.MALE) {
				DisplayText("your " + Desc.Cock.describeCock(player, player.torso.cocks.get(0)) + " growing harder at the thought.");
			}
			//(if corrupt female)
			else if (player.gender === Gender.FEMALE) {
				DisplayText("your cunt grows moist at the thought.");
			}
			else if (player.gender === Gender.HERM) {
				DisplayText("your cock twitches and your pussy becomes moist from the thought.");
			}
			else DisplayText("you feel a tingle at your groin from the thought.");
		}
		//(if not corrupt)
		else {
			DisplayText("the thought is almost too horrible to consider, but still...");
		}
		DisplayText("  You slide your gooey form over her body, resting at her crotch. She tries to push you off, but you easily resist her.\n\n");
		...
		DisplayText("Soon you feel yourself hit a wall as your body hits the opening of the naga's cervix. A stray thought crosses your mind as you think that maybe this is far enough, ");
		//(if corrupt)
		if (player.stats.cor > 50) DisplayText("but immediately after, you decide that this is going to be too much fun to not push on.");
		//(if not corrupt)
		else DisplayText("but a nagging voice at the back of your head urges you to push further.");
		...
		DisplayText("You pause for a moment, enjoying the sensation of filling someone up with your body, surprised at just how good it feels. Grabbing the naga's hips you slowly push yourself in and out of her now full pussy, ");
		//(if male)
		if (player.torso.cocks.count > 0) {
			if (player.torso.cocks.count === 1) DisplayText("your " + Desc.Cock.describeCock(player, player.torso.cocks.get(0)));
			else DisplayText("one of your " + Desc.Cock.describeMultiCockShort(player));
			DisplayText(" hitting the naga's pleasure buzzer with each downward thrust.");
		}
		//(if female)
		else if (player.gender === Gender.FEMALE) {
			DisplayText("your clit rubbing against the naga's pleasure buzzer with each downward thrust.");
		}
		//(if herm) 
		else if (player.gender === Gender.HERM) {
			if (player.torso.cocks.count === 1) DisplayText("your " + Desc.Cock.describeCock(player, player.torso.cocks.get(0)));
			else DisplayText("your " + Desc.Cock.describeMultiCockShort(player));
			DisplayText(" and clit rubbing against the naga's pleasure buzzer with each downward thrust.");
		}
		//(if genderless)
		else {
			DisplayText("your bare crotch hitting the naga's pleasure buzzer with each downward thrust.");
		}

		DisplayText("\n\nYou continue to relentlessly push yourself into the naga, stretching her wide.  ");
		//(if male)
		if (player.gender === Gender.MALE) {
			DisplayText("You let out a yell as ");
			//(normal) 
			if (player.cumQ() < 250) DisplayText("you come all over the naga's stomach.");
			else if (player.cumQ() < 1000) DisplayText("you come all over the naga's face and stomach.");
			//(if THE LEVEYS HAVE BROKE RUN FOR THE HILLS) 
			else DisplayText("you come violently, covering the naga in a layer of your sperm.");
		}
		//(if female)
		else if (player.gender === Gender.FEMALE) {
			DisplayText("You shriek in delight as wave after wave of orgasms rush over you");
			//(if squirter)
			if (player.torso.vaginas.get(0).wetness === VaginaWetness.SLAVERING) DisplayText(", your girlcum gushing out and pooling on the stomach of the naga");
			DisplayText(".");
		}
		//(if herm)
		if (player.gender === Gender.HERM) {
			DisplayText("You scream in ecstasy as you hit your peak, your girlcum ");
			if (player.torso.vaginas.get(0).wetness < VaginaWetness.SLAVERING) DisplayText("leaking out");
			else DisplayText("gushing out to form a pool on the naga's stomach");
			DisplayText(" and your " + Desc.Cock.describeMultiCockShort(player));
			//(normal)
			if (player.cumQ() < 250) DisplayText(" spurting onto her stomach as well.");
			//(lots of jizz)
			else if (player.cumQ() < 1000) DisplayText(" spurting onto her stomach and face.");
			else DisplayText(" completely covering the naga in a layer of your spooge.");
		}
		//(if genderless)
		if (player.gender === Gender.NONE) {
			DisplayText("You cry out and shudder as you feel wave after wave of the naga's orgasm rushing over your body, bringing you to a strange orgasmic bliss of your own.");
		}
	...
	private nagaVictoryMale() {
		...
		if (player.torso.cocks.count > 0) {
			...
			if (player.hips.legs.type === LegType.CENTAUR) {
				DisplayText("As your massive bulk looms over the defeated naga, your eyes gleam with desire. Your heart pounds in your ears as lusty thoughts echo in your head. You lift the snakewoman up into your arms, bringing her close before licking her neck and tasting her smooth scaly skin as her tail dangles down to the sand. As you touch her, she recovers, and her tail slowly wraps around your equine half to support her own weight. She returns your attentions by running her long forked tongue down your chest. Her scaly tail rubs sensually over your flesh as she continues to wind around you, caressing your " + Desc.Cock.describeCock(player, player.torso.cocks.get(0)) + "  with her tip, making you hard in a flash. The naga wriggles free from your embrace and coils behind you. Her entire length is now wrapped around various portions of both your human and equine halves, and she uses her grip to dangle underneath you. Her hands reach out to take a firm hold of your " + Desc.Cock.describeCock(player, player.torso.cocks.get(0)) + ".  You shiver as her tongue darts out and slides around your cock, pre-cum dripping from your head as she licks you. The agile naga lowers more of herself beneath you, spreading her pussy wide open before sliding onto your " + Desc.Cock.describeCock(player, player.torso.cocks.get(0)) + " and letting out a hissy moan as you penetrate her. Your body tingles as her entire length quivers in pleasure, sending ripples over the flesh her tail is wrapped around.  Jolts of pleasure run through you as the naga woman grinds her hips against your " + Desc.Cock.describeCock(player, player.torso.cocks.get(0)) + " , driving it into her as far as she can take.  With a loud and drawn-out moan, ");
				//[normal cum load]
				if (player.cumQ() < 250) DisplayText("you cum inside of her, ");
				//[extra cum]
				else if (player.cumQ() < 1000) DisplayText("you fill her insides with huge spurts of cum, ");
				//[SUPER CUM]
				else DisplayText("you explode with huge fountains of cum spurting from your " + Desc.Cock.describeCock(player, player.torso.cocks.get(0)) + ", gushing out from where the two of you are joined to rain on the sands below, ");
				DisplayText("as she squeezes you tightly in a climax of her own that steals your breath away.\n\n");

				DisplayText("Exhausted from her gymnastics, the naga slowly unwinds from you and lies on the sand, cum dripping from her pussy onto the dry desert beneath her.\n\n");
			}
			//Uncorrupted  
			else if (player.stats.cor < 50) {
				DisplayText("You almost feel pity as you behold the defeated creature lying before you, but your growing arousal pushes the thought from your mind. Leaning forward to get a closer look, your thoughts wander, and you find yourself wondering what her flexible body could do. Unable to contain your lust, you remove your " + player.inventory.equipment.armor.displayName + " and slowly lay on top of her, moving your hands across her scaly form in search of her pussy. As you rub your hands across the underside of her scaly belly, you notice that she is beginning to blush and moan softly. She is visibly trying to hold the feelings back, but whatever it is you're doing to her is definitely making that difficult. For the moment, you decide to abandon the search, content with simply running your hands along her tail's soft underside and watching her face as she tries in vain to hold her passion back. As you run your fingers up the center of her tail's underside, you notice a strange bump just a few inches below where her skin and scales meet. On further inspection, you realize that this is the thing you have been searching for - her warm, wet lovehole. Your touches seem to have had an effect on her; she is already rather moist, ready to take your " + Desc.Cock.describeCock(player, player.torso.cocks.get(0)) + ". You gingerly slide one of your fingers inside her, feeling for depth as well as for wetness. The naga coos softly, unable to withhold her moans.\n\n");

				DisplayText("You slowly begin moving your fingers in and out of her wet snatch, petting her underbelly with your free hand. You can tell that she is still tense; the look on her face is a mix of passion and fear. She struggles weakly, terrified as you place your warm " + Desc.Cock.describeCock(player, player.torso.cocks.get(0)) + " against her belly. You feel her grow still as your length rubs against her. You look deeply into her amber eyes as you wrap your arms around her, and after a moment's hesitation, kiss her passionately. Surprised at your own decision, your mind quickly conjures an image of her biting you. Instead, she relaxes in your arms and returns the kiss, abandoning herself to your will.\n\n");

				//[if cock fits] 
				if (player.torso.cocks.get(0).area <= monster.vaginalCapacity()) {
					DisplayText("Chills run down your spine as her delicate forked tongue tangles with your own, and you gently press the tip of your " + Desc.Cock.describeCock(player, player.torso.cocks.get(0)) + " against her moist pussy-lips. Her tail slowly wraps around your legs as she moans in a soft and mildly hissing voice. You sink your engorged member into her depths, pausing for a moment to let her adapt to your presence, before pumping away and kissing her passionately as you both get caught up in the wonderful sensations of your entwined bodies. Her tight passage massages your length, and her scaly body rubbing on your skin only encourages you to go further while you rock back and forth in her embrace. You gradually increase your pace, hearing her moans become louder as she moves her hips in time with yours. Your fingers dig into her smooth backside as you continue thrusting into her, pleasure building for what seems like a wonderful eternity. You finally reach your limit, thrusting frantically until you climax, ");
					//[normal cum load]
					if (player.cumQ() < 250) DisplayText("shooting thick ropes of sperm deep inside her as the both of you wail with excitement.");
					//[lots of cum]
					else if (player.cumQ() < 500) DisplayText("pumping large amounts of cum deep inside her as both your voices rise in screams of pleasure.");
					//[Spermageddon]
					else DisplayText("your " + Desc.Cock.describeCock(player, player.torso.cocks.get(0)) + " erupting, blasting a violent torrent of semen deep inside her petite frame, filling her up completely as both your voices rise in screams of pleasure.");
				}
				//[If cock too large]
				else {
					DisplayText("You draw away from her lips and return to your upright posture. Relaxed as she is, the naga looks nervously at your " + Desc.Cock.describeCock(player, player.torso.cocks.get(0)) + ", fully aware that it won't fit inside her small body. This occurs to you as well, and you begin to formulate a different plan. You move up onto her body so that you're straddling her stomach, fitting your " + Desc.Cock.describeCock(player, player.torso.cocks.get(0)) + " neatly between her small C-cup breasts. You gently coax her hands to her breasts, and she begins to comprehend your intentions. She begins to squeeze your " + Desc.Cock.describeCock(player, player.torso.cocks.get(0)) + " between her two warm mounds of flesh, doing her best to keep it snugly between them. Of her own accord, the naga begins to run her tongue across the " + (Desc.Cock.describeCockHead(player.torso.cocks.get(0)) + ", obviously understanding what you want. She looks up at you with an unsure look, as if asking whether or not she is doing it right. You nod to her, and that's all the encouragement she needs. She begins to stroke your " + Desc.Cock.describeCock(player, player.torso.cocks.get(0)) + " with her breasts as if it came naturally to her, covering as much of your " + (Desc.Cock.describeCockHead(player.torso.cocks.get(0)) + " as she can with her warm and trembling mouth.\n\n");
					...
					//[normal cum load]
					if (player.cumQ() < 250) DisplayText("filling her mouth with your warm seed.");
					//[lots of cum]
					else if (player.cumQ() < 500) DisplayText("pumping her mouth full of your sticky seed, some of which she is forced to swallow to avoid choking.");
					//[Oh God, it just keeps coming out, help me!]
					else DisplayText("easily flooding her mouth with your seed. Your seed gushes from her nose, with still more rushing down her throat. She gags and chokes a bit, a large amount of your seed leaking out onto her chest.");
					DisplayText("  The naga removes your " + Desc.Cock.describeCock(player, player.torso.cocks.get(0)) + " from her mouth");
					//[lots of cum OR more]
					if (player.cumQ() > 500) DisplayText(", the last sticky blasts of your semen splashing across her face,");
					DisplayText(" and looks to you for instruction. You simply nod and she understands, ");
					//[normal cum load]
					if (player.cumQ() < 250) DisplayText(" gulping down the warm sperm in her mouth.");
					//[lots of cum OR more]
					else DisplayText(" doing the best she can to swallow her mouthful of cum.");
				}
			...
			//Corrupted (event raises fatigue by 20)
				...
				if (player.cumQ() > 250) DisplayText("  Your spooge explodes from the naga's abused cunt, flooding the desert sands as you black out.\n\n");
				else DisplayText("\n\n");

				DisplayText("When you awaken, the naga is long gone. All that remains of your encounter is a depression in the landscape");
				//[lots of jizz] 
				if (player.cumQ() > 250) DisplayText(" with traces of semen in it");
				//[if OMGWTFBBQGALLONSOFCUM]
				else if (player.cumQ() > 2000) DisplayText(" that's filled with your thick seed");
				DisplayText(".\n\n");
				DisplayText("As you retrieve your clothes, you notice red marks around your chest and arms. It seems that while the naga did have the opportunity to kill you while you were unconscious, she preferred to keep you alive.\n\n");
			}
		}
		DisplayText("You think it would be a very good idea to come to the desert more often.");
		player.orgasm();
		...
		if (player.torso.vaginas.count > 0) {
			...
			if (player.hips.legs.type === LegType.CENTAUR) {
				...
				if (monster.lust > 99) {
					...
					if (player.gender === Gender.HERM) DisplayText("  As her tail gently squeezes your body, it draws your own " + Desc.Cock.describeMultiCockShort(player) + " up against your body, her soft underbelly stimulating the sensitive skin.");
					DisplayText("  With the added support, you are able to move your arm away from her stomach, moving your hand down to her covered snatch. It isn't hard to find as there is practically a river of her juices dripping from it. You peel away the scaly covering, and reveal her soaking wet lovehole. As you begin to play with her engorged clit, her soft moans begin to become more pronounced and you can feel her tail begin to wrap more tightly around your body. You feel a strange sensation as her tail brushes past your own " + Desc.Vagina.describeVagina(player, player.torso.vaginas.get(0)) + ", causing you to tense up a bit. It seems that she noticed, because she does it again a few seconds later. As she begins to rub your " + Desc.Vagina.describeVagina(player, player.torso.vaginas.get(0)) + " with her tail, your body begins to betray your own lusts.\n\n");
					DisplayText("She begins to gently toy with your " + Desc.Vagina.describeClit(player) + " using the very end of her tail, flicking it back and forth. You can't help but start moaning softly yourself. You respond by slowly teasing two of your fingers inside her waiting pussy, slowly beginning to move them in and out. As you begin to accelerate the motion of your fingers, the naga steps it up as well, sliding the tip of her tail inside your " + Desc.Vagina.describeVagina(player, player.torso.vaginas.get(0)) + ".  ");
					Mod.Vagina.displayStretchVagina(player, 20, true, false, true);
					DisplayText("You and the naga remain entwined like this for what seems like hours; your fingers buried inside her pussy, her tail buried inside yours");
					//(If PC is Herm i.e. Has a cock(s)){
					if (player.gender === Gender.HERM) DisplayText(" and your " + Desc.Cock.describeMultiCockShort(player) + " constantly stimulated by the tail wrapped around your body");
					DisplayText(". As you accelerate your finger-thrusts, you can feel her approaching climax, and she begins to accelerate her own motions in response. It only takes a few more minutes before you feel she's ready to cum. Suddenly she throws herself free from your grasp, turning her body one hundred and eighty degrees, and plants a kiss firmly on your lips. As she begins to passionately make out with you, your tongues intertwining and your lips interlocking in a heated show of lust for each other. She begins to climax, her muscles tensing and her tail beginning to writhe inside your " + Desc.Vagina.describeVagina(player, player.torso.vaginas.get(0)) + ". Soon, the both of you are experiencing wonderful, simultaneous orgasms, each driving the other onwards. Finally, after several minutes of bliss, the two of you finally separate, the sexually exhausted naga slumping to the sandy earth, her desires fulfilled. She looks up at you meekly, her eyes showing a sort of gratitude that words might never be able to describe. She turns her back, and slithers slowly away, a trail of her love juices tracing her path through the sand.\n\n");
				}
				else {
					DisplayText("No matter how hard you try, you can't think of a way to make this work.  You give up for now, disatisfied.\n\n");
				}
			}
			//a) Uncorrupted
			if (player.stats.cor < 50) {
			...
			//b) Corrupted
				...
				if (!player.statusAffects.has(StatusAffectType.MeanToNaga)) player.statusAffects.add(StatusAffectType.MeanToNaga, 0, 0, 0, 0);
				DisplayText("As you watch the writhing form of the defeated naga, you cannot help but feel turned on by it. You step forward, grabbing the naga by the shoulders and forcing her down against the sand, face up. Then, pinning her arms under your knees, you straddle her chest, crushing her modest breasts against her constricted ribcage. You can already see the panic in her face as you begin to unfasten the lower part of your " + player.inventory.equipment.armor.displayName + ". Once your dripping-wet pussy is exposed to the dry desert air, you pull up the naga's head by her hair and pull it close to your hot snatch. \"<i>C'mon, you horny little snake-tailed slut, what are you waiting for?</i>\" The naga remains frozen in a panic, not sure what to do. As encouragement you tug at her hair, pulling her head even closer to your " + Desc.Vagina.describeVagina(player, player.torso.vaginas.get(0)) + ". \"<i>I said LICK IT!</i>\" you shout, rubbing your " + Desc.Vagina.describeVagina(player, player.torso.vaginas.get(0)) + " into her face. Finally, the naga gets the message and her thin tongue darts from her mouth, making contact with your hot flesh. You shudder with excitement as the slick surface brushes past your " + Desc.Vagina.describeClit(player) + " and along your slit. As one hand manages the naga's head, you move your other hand to your breasts, beginning to squeeze and massage them with reckless abandon. As the naga continues to lick at your " + Desc.Vagina.describeVagina(player, player.torso.vaginas.get(0)) + ", you begin to gently buck your hips, bouncing up and down on her chest and forcing the air from her lungs. She squeaks every time this happens, in obvious discomfort.\n\n");
				DisplayText("Her face is beginning to turn red, and her breath is shortening by the second. Yet, you find all this very arousing. Instead of letting up, you force yourself onto her even more, pushing your " + Desc.Vagina.describeVagina(player, player.torso.vaginas.get(0)) + " up and grinding it against her face. You continue to moan and play with your breasts in the meantime, your climax drawing closer with every tongue stroke. The naga's tongue eventually finds its way inside your " + Desc.Vagina.describeVagina(player, player.torso.vaginas.get(0)) + ", its forked tip tickling your soft walls as it advances forwards. All the while the naga is desperately sucking at your " + Desc.Vagina.describeClit(player) + ", in an attempt to satisfy you, and possibly save herself. Your eyes roll back in your head and you throw your head back as an orgasm finally takes your body. You yell with delight as the naga's tongue tickles your insides, your girlcum splashing all over her face and dripping down into the dry sand below. As your climax slowly fades, you finally get up off the naga, which is met by a large gasp of relief. However, you are not done yet. You weren't going to suffocate your new fucktoy, now were you? After recovering from your first of hopefully many orgasms, you move back overtop the girl, this time straddling her face and facing the opposite direction. Your dripping snatch covers her face, situated directly above her mouth. The naga's arms are still pinned down by your legs at this point, and her tail is simply too weak after the fight to be of much help.\n\n");
				DisplayText("As you kneel over her face, you realize that if you bend forward enough, the naga's pussy is available to play with. After you manage to get the naga girl to begin licking and poking at your " + Desc.Vagina.describeVagina(player, player.torso.vaginas.get(0)) + ", you turn your focus to her semi-protected pussy. You peel away the thick covering, revealing her hot, moist fuckhole, and a thousand evil things jump to mind. Forming your hand into a spear shape, you begin to tease her tight slit. You can hear her as her muffled moans are drowned in your " + Desc.Vagina.describeVagina(player, player.torso.vaginas.get(0)) + ", and it brings a smile to your face. \"<i>Yeah, you like that, don't you? You scaly little...</i>\"  You begin to push your hand into her rather unprepared lovehole, to which she responds by flailing her tail about, trying in vain to shake you off. You keep pushing, until your arm is buried elbow-deep inside her. As you begin to fist-fuck her pussy, you can hear her wail into your " + Desc.Vagina.describeVagina(player, player.torso.vaginas.get(0)) + ", obviously complaining about the rough treatment. You continue like this for several minutes, with the naga's pussy becoming ever wetter and her moans becoming ever more earnest.\n\n");
				DisplayText("You stop after what you think is her third climax, pulling your arm almost all of the way out. You lean forward, lifting your " + Desc.Vagina.describeVagina(player, player.torso.vaginas.get(0)) + " from her face a little. You push even deeper, and are able to reach all the way to her cervix, your closed fist coming to rest against it. You slowly begin to move your fist in and out, getting faster as time progresses. After about a minute or two of this progressive increase, you're fist-fucking her so fast that you're practically punching her cervix, causing her to squeal and try to get away. As her mouth bashes against your " + Desc.Vagina.describeClit(player) + ", her forked tongue caressing you from inside your " + Desc.Vagina.describeVagina(player, player.torso.vaginas.get(0)) + ", you find yourself nearing your climax. You right yourself, putting one arm to the sand for balance, and moving the other to begin massaging your breasts.\n\n");
				DisplayText("It doesn't take much; soon your hips are bucking, bashing into the naga's face, your " + Desc.Vagina.describeVagina(player, player.torso.vaginas.get(0)) + " coating her face with your love juice. Your mission accomplished, you decide to wrap things up. As soon as you recover, you grab the poor naga's tail, and begin shoving it roughly into the naga's pussy. She wails in protest with each violent thrust, but at this point she is too weak to resist. You push inch after inch inside her, until you meet a sort of wall, what you can only assume is her cervix.");
				//(If str > 50)
				if (player.stats.str > 50) {
					...
					//(If high corr)
					if (player.stats.cor > 80) DisplayText("  As a parting gift, you kick sand in her face, and walk away without a care in the world.");
					//(If low corr )
					else DisplayText("  You think to yourself, \"<i>Was all that really necessary?</i>\"  But, in the end you decide that yes, it was.");
				}
	...
	private nagaVictoryGenderless() {
		...
		if (player.hips.legs.type === LegType.CENTAUR) {
			...
			DisplayText("You speed up your licking and thrust your tongue deeper into her, her walls now slick. She presses your face deep into her pussy as her hips buck in orgasm.\n\n");
			DisplayText("The tail of the naga slides out of you as she lies back in the sand of the desert, exhausted from her orgasm. You stand up and gather your things, thinking that maybe it wouldn't be too bad of an idea to come back.\n\n");
		}
		//a)Uncorrupted
		else if (player.stats.cor < 50) {
			...
			DisplayText("You straddle the naga, placing your bare, featureless crotch against the slit of her vagina. Slowly you rock your hips back and forth against her, drawing out a gasp of pleasure from her. Leaning over her you start to massage her breasts.\n\n");
			...
			DisplayText("You stand up over her, your crotch now wet from her girl cum. You pick up your things and put your clothes back on, leaving the naga lying there in bliss.\n\n");
		    }
		//b)Corrupted
		else {
			if (!player.statusAffects.has(StatusAffectType.MeanToNaga)) player.statusAffects.add(StatusAffectType.MeanToNaga, 0, 0, 0, 0);
			...
			DisplayText("But you can't give up now. You've gotten this far, now you need to finish the deed. At the end of this, there WILL be sex.\n\n");
	...
	internal function nagaFUCKSJOOOOOO() {
		...
		if ((player.perks.has(PerkType.BimboBrains) || player.perks.has(PerkType.FutaFaculties)) && player.torso.vaginas.count > 0) {
			...
			DisplayText("You continue your assault on her love canal as the naga's moans gradually become louder. Her hands make their way to your head and she curls her fingers through your " + Desc.Head.describeHair(player) + " to get a better grip on your air-filled head as you bring your mouth up to her clit. You give one final, slow lick up the length of her pussy and twirl your tongue around her now engorged bud. The naga involuntarily bucks her hips into your face as you start to suck on her " + Desc.Vagina.describeClit(player) + ". As you continue to play with her clit, she begins to lose control, grinding her soaking pussy against your face. She forces herself onto you so hard, it becomes hard to breathe, but thankfully you've had a bit of practice with this sort of thing, so the warm juices of her excited love-slit don't bother you. After a while, you attempt to pull away from her hot snatch, pulling your mouth from her swollen clit. She pushes you back down upon it. You roll your eyes and giggle lightly, sending vibrations through her clit that make her moan. The feeling of your warm, wet, bimbo lips as they rub against her clit is apparently just enough for her as it pushes her past her limit, sending her into a passionate orgasm. You finally pull away from her as her body is wracked with powerful contractions, wiping the excess ladycum from your face, which is stuck in a dumb-looking, open mouthed stare.\n\n");

			DisplayText("After the naga manages to calm herself, her breathing becoming regular and her muscles loosening up, she smiles a genuine grin and hisses something to you. She leans in close, her head only inches from your and suddenly shifts her tone, adopting a much more seductive one. She pulls you into an upright position, facing her, your " + Desc.Breast.describeAllBreasts(player) + " pushed up by her snake-like coils. Your " + Desc.Vagina.describeVagina(player, player.torso.vaginas.get(0)) + " rubs against her tail's scaly skin as she moves her own body closer to yours. She wraps the end of her tail around so that it stands erect between the two of you. The naga hisses something at you, and, seeing the brain-dead look on your face, begins to demonstrate what she means. She leans in close to her tail and begins to run her thin tongue along its length, as far as she can. Now THIS you are able to, like, understand! You run your tongue along her smooth, scaly, tail-tip.\n\n");

			DisplayText("You do your, like, very best to follow her lead, but you just, like, don't get why she's doing it! Eventually, she stops, and nudges you to do so as well. Like... whatever...\n\n");

			DisplayText("The naga then lies flat on the sandy ground, pulling you down with her. She lays you down on her body, face up, with your head resting on her soft breasts. She reaches around your body, placing her soft hands on your own " + Desc.Breast.describeAllBreasts(player) + ", gently holding you in place as her tail moves closer to your " + Desc.Vagina.describeVagina(player, player.torso.vaginas.get(0)) + ". Her now slick tail begins to rub against your clit and as the scaly skin runs along your " + Desc.Vagina.describeClit(player) + ", you begin to moan air-headedly. There is no holding it back, this feeling is one of the best you have experienced. Her tail continues to flick and rub your clit as you begin to buck your hips gently. The naga pokes and rubs at your hard clit for some time, eventually driving you to the first of many coming orgasms. After your breath has become even again and your muscles have relaxed, the naga resumes her advances. She begins to rub the tip of her tail up and down along your " + Desc.Vagina.describeVagina(player, player.torso.vaginas.get(0)) + ", and you FINALLY get what she is trying to do.\n\n");

			DisplayText("As the tail begins to penetrate you, you cannot help but let out another passionate, bimbo-like moan.");
			//Take virginity.  Proper stretching further down.
			Mod.Vagina.displayStretchVagina(player, 1, true, true, false);
			DisplayText("  The scaly skin rubs at your soft vaginal walls like nothing else you have experienced, and the feeling begins to drive you mad with pleasure. It only takes a few minutes of this gentle tail-fucking to drive you to another climax. This time, however, the naga doesn't wait for your recovery. Instead, she responds by plunging deeper, forcing her ever-thickening tail deeper inside your " + Desc.Vagina.describeVagina(player, player.torso.vaginas.get(0)) + ". As she stuffs more and more of her scaly tail inside you, her hands begin to work on your " + Desc.Breast.describeNipple(character, character.torso.chest.get(0)) + "s, gently caressing and massaging them.\n\n");

			//[If Lactating]
			if (player.lactationQ() >= 50 && player.torso.chest.sort(BreastRow.LactationMultipierLargest)[0].lactationMultiplier >= 1) DisplayText("Your warm milk is leaking from your " + Desc.Breast.describeNipple(character, character.torso.chest.get(0)) + "s the entire time, coating your skin and soaking her hands. At one point, she withdraws a hand and licks the milk from it. You can only assume that she liked it, as she begins to focus even more on your breasts.\n\n");
			//-------

			DisplayText("The naga lifts you from her body with her tail, placing you onto the warm sand where she had been laying. She moves her own body above yours, her tail buried deep inside your " + Desc.Vagina.describeVagina(player, player.torso.vaginas.get(0)) + " the entire time. She holds you in place with one hand, her other hand moving to resume playing with your " + Desc.Breast.describeAllBreasts(player) + ". She moves her head in, her hot breath washing over your neck, and looks up into your eyes for a moment. She smiles, giggles, and then wraps her mouth around your " + Desc.Breast.describeNipple(character, character.torso.chest.get(0)) + ", letting her slender tongue tickle your sensitive areola.\n\n");
			//-----

			//[If lactating] 
			if (player.lactationQ() >= 50 && player.torso.chest.sort(BreastRow.LactationMultipierLargest)[0].lactationMultiplier >= 1) DisplayText("As her mouth sucks and plays with your nipple, your warm, sweet milk begins to flow forth once again, filling her mouth with your delectable cream. Her hand is also absolutely covered by it, and the excess drips down to the dry sand below, absorbed in seconds by the thirsty earth.\n\n");
			//------

			DisplayText("All this time, her tail has been working its way slowly inside you, stretching you farther with every thrust. As you open your mouth wide to let out another passionate wail, she moves in, pushing her lips over yours and kissing you passionately.\n\n");

			//----
			//[If Lactating]
			if (player.lactationQ() >= 50 && player.torso.chest.sort(BreastRow.LactationMultipierLargest)[0].lactationMultiplier >= 1) DisplayText("She shares a mouthful of your delicious milk with you.\n\n");
			//------
			...
			//PROPER stretched.
			Mod.Vagina.displayStretchVagina(player, (player.vaginalCapacity() + 5), true, true, false);
			DisplayText("\n\n");

			DisplayText("Then, like, your wish totally comes true! The naga's tail begins to bash itself against your cervix, searching for the weak point. Her hands hold you steady as her thrusts begin to increase in intensity. It's not long into this rough tail-fucking that you find yourself on the verge of orgasm again, totally turned on by the sight of your own " + Desc.Breast.describeAllBreasts(player) + " bouncing as she fucks you. The naga grits her teeth, and, with one last, powerful thrust, forces her tail inside of your womb, pushing through your well-pounded, well-used cervix. She manages to stuff enough tail inside you to cause a visible bulge in your stomach. This combination of sensations is too much for your tiny brain, and sends your head spinning as your climax reaches its peak. Your already weak mind slips even further, your vision fading. The last thing you see is the naga's smiling face, her cheeks flushed and her eyes full of passion.");
		}
		//a) male (slightly modified could be good for centaurs 
		//too)
		else if (player.gender === Gender.MALE || (player.gender === Gender.HERM && randInt(2) === 0)) {
			//(If defeated by lust)
			if (player.stats.lust > 99) DisplayText("You fall to your knees, your body shaking with desire.\n\n");
			//(If defeated by KO)
			else DisplayText("You fall to your knees, your battered body unable to hold itself up any longer.\n\n");
			DisplayText("You hear the hiss of the naga's laughter as she slithers over to your prone form. Her long tail twists around you and tightens suddenly, pinning your arms to your sides");
			//(if centaur)
			if (player.hips.legs.type === LegType.CENTAUR) {
				DisplayText(" and clamping your legs to your stomach");
			}
			DisplayText(". You struggle weakly against her grip, but ");
			//(if defeated by lust)
			if (player.stats.lust > 99) DisplayText("all your resistance seems to do is make your " + Desc.Cock.describeCock(player, player.torso.cocks.get(0)) + " harder.");
			//if defeated by KO)
			else DisplayText("you are too weak to do anything to stop her squeezing.");
			DisplayText("  She leans towards you, gripping your shoulders as she brings her face to your ear. You can feel her serpentine tongue flicking over your ear as she hisses coldly into it.\n\n");
			...
			if (player.stats.cor > 75) DisplayText("  The thought somehow makes your " + Desc.Cock.describeCock(player, player.torso.cocks.get(0)) + " throb even more.");
			DisplayText("\n\n");
			DisplayText("You close your eyes and ready yourself to meet your fate. Instead, you feel the hand of the naga at your crotch, sliding your " + player.inventory.equipment.armor.displayName + " down to give her better access to your " + Desc.Cock.describeCock(player, player.torso.cocks.get(0)) + ". A gasp of surprise escapes you as the naga grabs ahold of your " + Desc.Cock.describeCock(player, player.torso.cocks.get(0)) + " and starts to stroke it, licking at the " + (Desc.Cock.describeCockHead(player.torso.cocks.get(0)) + " with her serpentine tongue. You moan as she quickens her pace, causing a wave of heat to rise through your shaft.\n\n");

			//(Cock fits)
			if (player.torso.cocks.get(0).area <= monster.vaginalCapacity()) {
				DisplayText("She stops suddenly and you look at her, a pleading look in your eyes despite yourself. The naga isn't done with you yet, and she makes this known by opening up the scaly slit at her crotch to reveal her moist cunt. She rubs the opening on to the " + (Desc.Cock.describeCockHead(player.torso.cocks.get(0)) + " of your " + Desc.Cock.describeCock(player, player.torso.cocks.get(0)) + ", teasing your throbbing member before slowly sliding it in. She carefully lowers herself onto you, swallowing up the first few inches of your " + Desc.Cock.describeCock(player, player.torso.cocks.get(0)) + ". Her hips slide back, before bringing them back down and sliding more of your cock into her. She continues to gently swallow more of you inside of her, the folds of her love canal massaging you with each progressive thrust. Finally there is no more of you that she can push into her, her stomach presses against you in an attempt to try to bring more of you inside her.\n\n");
				DisplayText("You feel the hands of the snake woman firmly grab your shoulders and watch as she pulls away from you, shouting with pleasure as she thrusts herself down on the full length of your shaft. Unable to move or do anything to help her, you watch helplessly as she manipulates your body, her slick netherlips completely enveloping your " + Desc.Cock.describeCock(player, player.torso.cocks.get(0)) + ".  Again and again she thrusts her hips onto your " + Desc.Cock.describeCock(player, player.torso.cocks.get(0)) + ", her pussy squeezing you almost as tightly as her tail. She continues to impale herself on your " + Desc.Cock.describeCock(player, player.torso.cocks.get(0)) + ", her thrusts becoming more intense by the moment. Finally she gives one last squeeze and tilts her head back with a yell. Unable to hold back, her tight walls begin to convulse, squeezing your " + Desc.Cock.describeCock(player, player.torso.cocks.get(0)) + " tighter than ever before. You can feel a pressure welling up inside as her soaking pussy attempts to milk your " + Desc.Cock.describeCock(player, player.torso.cocks.get(0)) + " of its tasty seed. You try to hold back, but it's no use. As she continues to pump at your " + Desc.Cock.describeCock(player, player.torso.cocks.get(0)) + ", a torrent of warm, sticky cum ");
				//Cum variants
				if (player.cumQ() < 250) DisplayText("pours");
				else if (player.cumQ() < 1000) DisplayText("spurts");
				else DisplayText("erupts");
				DisplayText(" into her body. She ");
				//(Normal)
				if (player.cumQ() < 250) DisplayText("moans and pants");
				//(Lots of cum)
				else if (player.cumQ() < 1000) DisplayText("squeals with joy");
				//(It's gonna take weeks to clean this up!)
				else DisplayText("screams in delight");
				DisplayText(" as your hot, gooey sperm ");
				//(Normal)
				if (player.cumQ() < 250) DisplayText("coats her womb.");
				//(Lots of cum)
				else if (player.cumQ() < 1000) DisplayText("completely fills her.");
				//(Indonesia called, they're flooded again)
				else DisplayText("absolutely engorges her, with the excess spurting out in torrents from her pussy.");
			}
			//(Cock too big)
			else {
				DisplayText("As she continues to stroke your " + Desc.Cock.describeCock(player, player.torso.cocks.get(0)) + ", her nimble fingers doing their best to wrap around your prodigious girth, she moves her head in closer to wrap her lips around the tip of your " + Desc.Cock.describeCock(player, player.torso.cocks.get(0)) + ". She begins to gently suck at the head of your " + Desc.Cock.describeCock(player, player.torso.cocks.get(0)) + ", her thin, reptilian tongue dancing across the slick surface. ");
				//(if PC has balls)
				if (player.torso.balls.quantity > 0) {
					DisplayText("She shifts one of her hands down from your " + Desc.Cock.describeCock(player, player.torso.cocks.get(0)) + ", to your " + Desc.Balls.describeBalls(true, true, player) + ", cupping them in her slick palm.  ");
				}
				DisplayText("As her tongue continues to slide across the " + (Desc.Cock.describeCockHead(player.torso.cocks.get(0)) + " of your " + Desc.Cock.describeCock(player, player.torso.cocks.get(0)) + ", her slender tongue wanders ever so closely to the center. You feel a strange sensation as her tongue wanders inside the hole at the tip of your " + Desc.Cock.describeCock(player, player.torso.cocks.get(0)) + ", just barely tickling the inside. You try to pull away, but her tail binds you too tightly to move much. The naga notices your reaction and begins to exploit it as much as she can. She begins to force the rest of her tongue inside of your urethra, her forked tip tickling you from the inside as she pushes deeper. The naga, now that her tongue is completely buried inside your " + Desc.Cock.describeCock(player, player.torso.cocks.get(0)) + ", turns her attentions to the actual shaft, attempting to sandwich it between her modest C-cup breasts. She begins to stroke them up and down along your " + Desc.Cock.describeCock(player, player.torso.cocks.get(0)) + ", sucking at the " + (Desc.Cock.describeCockHead(player.torso.cocks.get(0)) + " and tickling your urethra at the same time.\n\n");
				...
				//OH SHIT MOAR CUM
				//(Normal)
				if (player.cumQ() < 250) DisplayText("The naga manages to hold the warm cum within her mouth, only causing her cheeks to bulge a little.");
				//(Lots of cum)
				else if (player.cumQ() < 1000) DisplayText("The naga's cheeks balloon as her mouth is filled with your hot, gooey sperm, forced to swallow some of it as her cheeks reach their full capacity.");
				//(Cumception, we need to go deeper)
				else DisplayText("Hot semen blasts from the naga's nose as her mouth is completely filled in seconds. Much of your warm cum is forced down her throat and into her stomach, causing it to distend slightly within her thin frame.");
				DisplayText("  The naga pulls away, her tongue slowly sliding from your " + Desc.Cock.describeCock(player, player.torso.cocks.get(0)) + " and dripping with cum, allowing the last few drops of cum to splash across her face and breasts. Her cheeks are still full of seed and  as she moves in closer, you wonder what she has planned. She grabs your shoulders with her still-slick hands, and leans in all the way for a final, passionate kiss. As your lips are pushed apart by her own, you feel a large amount of your still-warm sperm enter your mouth. You try to resist, but she begins to massage your throat, forcing you to swallow it all.\n\n");
				//(If you've been a bad boy during victory scenes)
				if (player.statusAffects.has(StatusAffectType.MeanToNaga))
				...
				//(If you've been nice to her: Default setting)
					...
					DisplayText("You end up enjoying the whole thing. She then gets back up and leave you there, not without looking back. You stay there, lying on the sand for a few moments before you doze off in a nap.  After you wake, you finally decide to head back to your camp.");
			}
		}
		//b) female //http://nekomimichan.org/mg/src/12844585127.jpg
			...
			if (player.stats.lust > 99) {
				DisplayText("You fall to your knees, your body shaking with desire.\n\n");
			}
			//If defeated by KO)
			else {
				DisplayText("You fall to your knees, your battered body unable to hold itself up any longer.\n\n");
			}
			...
			//(if corrupted)
			if (player.stats.cor > 50) {
				DisplayText("and the sheer thought of it is making you wet already.  ");
			}
			//(if uncorrupted)
			else DisplayText("and while you know you probably won't like it, your " + Desc.Vagina.describeVagina(player, player.torso.vaginas.get(0)) + " says otherwise.  ");
			...
			//(If defeated by lust) 
			if (player.stats.lust > 99) {
				DisplayText("and you can feel the need to have sex with her burn inside you. You quickly strip yourself of your " + player.inventory.equipment.armor.displayName + " and throw yourself on her awaiting pussy.");
			}
			//(If defeated by KO)
			else {
				DisplayText("and you're too weak to resist anyway; you might as well just comply. You attempt to remove your " + player.inventory.equipment.armor.displayName + " before the naga grabs you in pity and decides to help you with it. Now naked,  she lays you down on her tail and you let her guide you to her awaiting pussy.");
			}
			DisplayText("  Without any further complaints, you pull her lips apart and start licking. The creature lets out a sigh of pleasure as you move your tongue around the outside of her netherlips.\n\n");
			...
			DisplayText("  You finally pull away from her as her body is wracked with powerful contractions, wiping the excess ladycum from your face.\n\n");
			...
			if (player.stats.cor > 50) {
				DisplayText("You close your eyes, and imagine that the tail is just another big cock to be sucked. You begin to suck at the tip, as well as run your tongue up and down along its length.  ");
			}
			//(If you are a good girl)
			else {
				DisplayText("You do your best to follow the naga's example, but you are not sure why she is doing it.  ");
			}
			DisplayText("Eventually, it appears that the naga is satisfied, and she stops, nudging you to do so as well.\n\n");

			DisplayText("Then the naga lies flat on the sandy ground, pulling your body down onto on hers, face up, with your head resting between her soft breasts. She reaches around your body, placing her hands on your own " + Desc.Breast.describeBreastSize(character.torso.chest.sort(BreastRow.BreastRatingLargest)[0].rating) + " gently holding you in place as her tail moves closer to your " + Desc.Vagina.describeVagina(player, player.torso.vaginas.get(0)) + ". As she begins to rub her presently-slick tail against your slit, the scaly tip brushes your " + Desc.Vagina.describeClit(player) + " and you moan with passion in response.  There is no holding it back; this feeling is one of the best you have experienced. Her tail continues to flick and rub your " + Desc.Vagina.describeClit(player) + " as you begin to buck your hips gently. The naga pokes and rubs at your " + Desc.Vagina.describeClit(player) + " for some time, eventually driving you to the first of many coming orgasms. After your breath has become even again and your muscles have become relaxed, the naga resumes her advances. She begins to rub the tip of her tail up and down along your " + Desc.Vagina.describeVagina(player, player.torso.vaginas.get(0)) + ", and you finally understand her intentions.\n\n");

			DisplayText("As the tail begins to penetrate you, you cannot help but let out another passionate moan. The scaly skin rubs at your tender vaginal walls like nothing else you have experienced, and the feeling begins to drive you mad with pleasure. It only takes a few minutes of this gentle tail-fucking to drive you to another climax. This time, however, the naga doesn't wait for your recovery. Instead, she responds by plunging deeper, forcing her ever-thickening tail further into your " + Desc.Vagina.describeVagina(player, player.torso.vaginas.get(0)) + ". As she stuffs more and more of her scaly tail inside you, her hands begin to work on your " + Desc.Breast.describeBreastSize(character.torso.chest.sort(BreastRow.BreastRatingLargest)[0].rating) + ", gently caressing and massaging them.");
			//(If fuckable nipples)
			if (player.torso.chest.find(BreastRow.FuckableNipples)) {
				DisplayText("  As her hands rub across your " + Desc.Breast.describeBreastSize(character.torso.chest.sort(BreastRow.BreastRatingLargest)[0].rating) + ", the naga takes notice of the size of your nipples. She begins to press on them with her fingers, and, to her surprise, her fingers begin to disappear inside your breasts. It doesn't take her long to figure it out, and before you know it she is finger-fucking both your " + Desc.Breast.describeNipple(character, character.torso.chest.get(0)) + " in sync with the thrusts of her tail.");
			}
			//(If lactating)
			if (player.torso.chest.sort(BreastRow.LactationMultipierLargest)[0].lactationMultiplier > 1) {
				DisplayText("  Your warm milk is leaking from your " + Desc.Breast.describeNipple(character, character.torso.chest.get(0)) + " the entire time, coating your " + player.skin.desc + " and soaking her hands. At one point, she withdraws a hand and licks the milk from it. You can only assume that she liked it, as she begins to focus even more on your breasts.");
			}
			DisplayText("\n\n");

			DisplayText("The naga lifts you from her body with her tail, placing you onto the warm sand where she had been laying. She moves her own body above yours, her tail buried deep inside your " + Desc.Vagina.describeVagina(player, player.torso.vaginas.get(0)) + " the entire time. She holds you in place with one hand, her other hand moving to resume playing with your " + Desc.Breast.describeBreastSize(character.torso.chest.sort(BreastRow.BreastRatingLargest)[0].rating) + ". She moves her head in, her hot breath washing over your other breast, and looks up into your eyes for a moment. She smiles, giggles, and then wraps her mouth around your " + Desc.Breast.describeNipple(character, character.torso.chest.get(0)) + ", letting her slender tongue tickle your sensitive skin there.");
			//(If fuckable nipples)
			if (player.torso.chest.find(BreastRow.FuckableNipples)) {
				DisplayText("It isn't long before she decides to take it one step further, pushing her tongue inside your " + Desc.Breast.describeNipple(character, character.torso.chest.get(0)) + " and wriggling it around inside. Meanwhile, her other hand begins to work its way into your other " + Desc.Breast.describeNipple(character, character.torso.chest.get(0)) + ", finger-fucking it for all it's worth.");
			}
			//(If lactating)
			if (player.torso.chest.sort(BreastRow.LactationMultipierLargest)[0].lactationMultiplier > 1) {
				DisplayText("  As her mouth sucks at and plays with your " + Desc.Breast.describeNipple(character, character.torso.chest.get(0)) + ", your warm, sweet milk begins to flow forth once again, filling her mouth with your delectable cream. Her hand is also absolutely covered by it, and the excess drips down to the dry sand below, absorbed in seconds by the thirsty earth.");
			}
			DisplayText("\n\n");
			DisplayText("All this time, her tail has been working its way slowly inside you, stretching you farther with every thrust. As you open your mouth to let out another passionate wail, she moves in, pushing her lips over yours and kissing you passionately");
			//(If lactating)
			if (player.torso.chest.sort(BreastRow.LactationMultipierLargest)[0].lactationMultiplier > 1) {
				DisplayText(", sharing with you some of your delicious milk");
			}
			DisplayText(".");
			//(If pregnant)
			if (player.pregnancyIncubation > 0) {
				DisplayText("  As you finally reach your next climax, the naga pokes her tongue a little bit deeper inside your mouth, reaching to the back of your throat.");
				//(If you have been a bad girl in past encounters)
				if (player.statusAffects.has(StatusAffectType.MeanToNaga)) {
					DisplayText("  Down this slippery rope, she drops only a few drops of her potent poison, which completely bypass your gag reflex and drop straight down your throat. You hardly notice, too busy bucking your hips against the massive tail buried within your " + Desc.Vagina.describeVagina(player, player.torso.vaginas.get(0)) + ". It's only as your vision fades that you realize that the naga has done something. She pulls away from you and hisses something into your ear. The last thing you can make out is the naga giggling as she continues to play with your breasts before your vision clouds over and your head is filled with fuzzy feelings. You black out, now nothing more than a fuckdoll for the naga to explore. She has her fun with your limp body, and eventually leaves you there, lying on the warm sand, your " + Desc.Vagina.describeVagina(player, player.torso.vaginas.get(0)) + " horribly abused by the naga's thick tail, and dripping with your own juices.");
				}
				//(If you've been a good girl during past encounters)
				else {
					DisplayText("  She tickles the back of your throat with her tongue, massaging your " + Desc.Breast.describeBreastSize(character.torso.chest.sort(BreastRow.BreastRatingLargest)[0].rating) + " with her hands and thrusting her tail in and out of your " + Desc.Vagina.describeVagina(player, player.torso.vaginas.get(0)) + ". Eventually, even she gets tired and with a pop, she pulls her massive tail from your " + Desc.Vagina.describeVagina(player, player.torso.vaginas.get(0)) + ", raising the tip to her mouth and sucking on it, savoring your juices. She slides off of you, laying on the sand next to you. Exhausted, it is not long before she is asleep, a big smile on her face and a finger in her snatch. You decide to rest as well, collapsing beside her. There's no way you could make it back to camp in this condition. As you doze off, her warm, scaly body gently wraps around your own, pulling you close.  When you eventually wake up, the naga is nowhere to be seen so you simply return to camp, still somewhat tired, but rather happy.");
				}
			}
			//(If not pregnant)
			else {
				DisplayText("  As the tip of her tail finally comes to rest against your cervix, you find yourself succumbing to another orgasm, your wails of pleasure encouraging the naga to continue. As you begin to calm down again, you believe that this is the deepest the naga will go. Then, as she reaches her hand to grab your other shoulder, you realize she still has plans. Her tail begins to bash itself against your cervix, the tip searching for the weak point. Her hands hold you steady, as her thrusts begin to increase in intensity, sometimes even shaking your entire body. It is not long into this rough tail-fuck that you find yourself on the verge of orgasm yet again, as the scaly surface of her tail rubs across the soft flesh of your " + Desc.Vagina.describeVagina(player, player.torso.vaginas.get(0)) + ".  The naga grits her teeth, and, with one last, powerful thrust, forces her tail inside your womb, forcing her way through your cervix. She manages to stuff enough tail inside you to cause a visible bulge in your stomach. This combination of sensations is enough to send your head spinning and as your climax reaches its peak, you feel your mind begin to weaken, your vision fading. The last thing you see is the naga's smiling face, her cheeks flushed and her eyes full of passion.");
			}
			DisplayText("  ");
		...
		//d) genderless
			...
			DisplayText("After a moment of chuckling, the naga brings your face down to a scaly covering at her crotch and opens it to reveal her awaiting netherlips. ");
			//(If player not corrupted)
			if (player.stats.cor < 50) DisplayText("You try to turn your head away, but she forcefully shoves it down into her soft folds.  ");
			//if player is corrupted) 
			else DisplayText("You eagerly bring your mouth to her glistening pussy. ");
	...
	internal function nagaRapeChoice() {
		if (monster.stats.HP < 1) DisplayText("You've defeated the naga!  ", true);
		else DisplayText("The naga writhes in the sand, masturbating feverishly!  She's completely forgotten about fighting you.  ", true);
	...
	public nagaPlayerConstrict() {
		DisplayText().clear();
		if (player.fatigue + kGAMECLASS.physicalCost(10) > 100) {
			DisplayText("You just don't have the energy to wrap yourself so tightly around someone right now...", true);
			//Gone		menuLoc = 1;
		...
		if (monster.plural) {
			DisplayText("You launch yourself at " + monster.a + monster.short + ", but with multiple enemies, wrapping one up would leave you completely open to attack.  You hastily slither backwards before you expose yourself to danger.", true);
			DisplayText("\n\n");
			kGAMECLASS.enemyAI();
			return;
		}
		if (monster.short === "pod") {
			DisplayText("You can't constrict something you're trapped inside of!", true);
			//Gone		menuLoc = 1;
		...
		if (monster.statusAffects.has(StatusAffectType.Concentration)) {
			DisplayText("Amily easily glides around your attack thanks to her complete concentration on your movements.", true);
			kGAMECLASS.enemyAI();
			return;
		}
		//WRAP IT UPPP
		if (randInt(player.stats.spe + 40) > monster.spe) {
			...
			//(Otherwise)
				...
				DisplayText("You launch yourself at " + monster.a + monster.short + " and wrap yourself around " + monster.pronoun2 + ". You squeeze " + monster.pronoun2 + " tightly and hear " + monster.pronoun2 + " cry out in pain.");
			}
			monster.statusAffects.set(new StatusAffect("Constricted", 1 + randInt(4))), 0, 0, 0);
		}
		//Failure
		else {
			//Failure (-10 HPs) -
			DisplayText("You launch yourself at your opponent and attempt to wrap yourself around " + monster.pronoun2 + ". Before you can even get close enough, " + monster.a + monster.short + " jumps out of the way, causing you to fall flat on your face. You quickly pick yourself up and jump back.");
			player.takeDamage(5);
			if (player.stats.HP <= 0) {
				return { next: kGAMECLASS.endHpLoss };
				return;
			}
		}
		DisplayText("\n\n");
	...
	public naggaSqueeze() {
		DisplayText().clear();
		//Squeeze -
		DisplayText("Your coils wrap tighter around your prey, leaving " + monster.pronoun2 + " short of breath. You can feel it in your tail as " + monster.pronoun3 + " struggles are briefly intensified.");
		    monster.stats.HP -= monster.eMaxHP() * (.10 + randInt(15) / 100);
		//Enemy faints -
	...
	public naggaTease() {
		...
		if (monster.statusAffects.has(StatusAffectType.NagaVenom)) {
			DisplayText("You attempt to stimulate " + monster.a + monster.short + " by rubbing " + monster.pronoun3 + " nether regions, but " + monster.pronoun3 + " seems too affected by your poison to react.\n\n");
		}
		else if (monster.gender === Gender.NONE) {
			DisplayText("You look over " + monster.a + monster.short + ", but can't figure out how to tease such an unusual foe.\n\n");
		}
		//(Otherwise)
		else {
			...
			//+ slutty armor bonus
			if (player.perks.has(PerkType.SluttySeduction)) damage += player.perkv1(PerkLib.SluttySeduction);
			//10% for bimbo shits
			if (bimbo || bro || futa) {
				damage += 5;
				bimbo = true;
			...
			//Normal cases for other monsters
				...
				if (monster.gender === Gender.MALE) {
					DisplayText("Your nimble tail begins to gently stroke his " + monster.cockDescriptShort(0) + ", and you can see it on his face as he tries to hold back the fact that it feels good.");
				}
				if (monster.gender === Gender.FEMALE) {
	...
	public nagaLeggoMyEggo() {
		DisplayText().clear();
		DisplayText("You release " + monster.a + monster.short + " from " + monster.pronoun3 + " bonds, and " + monster.pronoun1 + " drops to the ground, catching " + monster.pronoun3 + " breath before " + monster.pronoun1 + " stands back up, apparently prepared to fight some more.");
		DisplayText("\n\n");
	...
	private eggUpANagaSpiderLike() {
		DisplayText().clear();
		DisplayText("As the shiny-scaled girl collapses against the sand, you scramble forward, panting not so much with the exertion of the fight as with lust and excitement.  Surely a creature as large as her has enough room to fit all your eggs?  You feel so full, and it's been so long since you last had release.");
		...
		if (player.gender > 0) {
			DisplayText(", ");
			if (player.torso.cocks.count > 0) DisplayText("jizz");
			if (player.gender === Gender.HERM) DisplayText(" and ");
			if (player.torso.vaginas.count > 0) DisplayText("femcum");
			DisplayText(" raining down on the prone naga");
		}
		DisplayText(".  You crumple into a heap on top of your reptilian lover, unconscious before you hit the sand.  Her eyes drift closed as well, as she coils around you, settling in for a well-deserved rest.");
	...
	private beePositANagaPlease() {
		...
		if (player.torso.cocks.count > 0) DisplayText("  [EachCock] erupts to splatter her with white");
		if (player.torso.cocks.count > 0 && player.torso.vaginas.count > 0) DisplayText(" and y");
		else if (player.torso.vaginas.count > 0) DisplayText("  Y");
		if (player.torso.vaginas.count > 0) {
			DisplayText("our [vagina] ");
			if (player.torso.vaginas.get(0).wetness < 3) DisplayText("drools");
			else if (player.torso.vaginas.get(0).wetness < 5) DisplayText("gushes");
			else DisplayText("splatters");
			DisplayText(" clear femcum over the Naga's tight belly");
			if (player.torso.cocks.count > 0) DisplayText(" as well");
		}
		...
		if (player.eggs() > 30) DisplayText(" from the outside at least.  You stuffed her so full that she looks positively pregnant, bulging to a picture of utter fertility");
		DisplayText(".  She idly runs her hands across her body, pinching her nipples and gasping in delight.  Your venom is clearly keeping her quite aroused, even with such a powerful orgasm.  After such a workout, you feel like you might have a little bit of venom left, so you give the new ");
		if (player.fertilizedEggs() === 0) DisplayText("egg-bearer");
		else DisplayText("mother");
		DisplayText(" a parting sting.  Her moans of excitement jump an octave, and you listen to them with a happy, almost gloating smile while you get dressed.");
