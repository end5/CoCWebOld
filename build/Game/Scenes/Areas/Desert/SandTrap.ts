...
// 	DisplayText("Instead of attacking, you turn away from the monster.desc.and doggedly attempt to climb back up the pit, digging all of your limbs into the soft powder as you climb against the sandslide.");
// 	if (trapLevel() === 4) {
...
export class SandTrap extends Character {
    public SandTrap() {
        ...
        this.statusAffects.add(StatusAffectType.Level, 4, 0, 0, 0);
    }
}
