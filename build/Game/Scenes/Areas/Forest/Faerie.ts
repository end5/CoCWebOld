...
export default class Faerie {
    // faerie Encounter
    public encounterFaerie(character: Character): void {
    ...
    private faerieRAEP(character: Character): void {
        DisplaySprite(SpriteName.Faerie);
        // Count secksins
    ...
    private faerieDoNothing(character: Character): void {
        DisplaySprite(SpriteName.Faerie);
        DisplayText().clear();
    ...
    private faerieCaptureHJ(character: Character): void {
        DisplaySprite(SpriteName.Faerie);
