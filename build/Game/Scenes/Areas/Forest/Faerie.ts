...
function faerieCaptureHJ(character: Character): NextScreenChoices {
    ...
    // Non-taurs
        ...
        if (character.torso.cocks.find(Cock.HasKnot)) DisplayText("climbs atop your knot, wrapping her legs around the narrower shaft to hold on.  You can feel her cheeks resting atop the 'bulb' of your canine anatomy, teasing you with feminine features you're far too large to penetrate.  ");
