...
//         }
//         game.simpleChoices("Fuck", game.forest.tamaniScene.tamaniSexWon, "Buttfuck", temp, "", null, "Lay Eggs", temp2, "Leave", game.Scenes.camp.returnToCampUseOneHour);
//     }
...
//             else game.forest.tamaniScene.tamaniSexLetHer(player, true);
//         } else {
...
export class Tamani extends Goblin {
    public constructor() {
        ...
        this.inventory.gems = randInt(25) + 5;
