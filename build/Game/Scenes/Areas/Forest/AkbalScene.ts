...
export function akbalWon(player: Character, hpVictory: boolean, pcCameWorms: boolean): NextScreenChoices {
    akbalFlags.submissionState = -1;
    akbalFlags.bitchQ = 0;
    DisplayText().clear();
    if (pcCameWorms) {
        ...
        return loseToAckballllllz(player);
    }
}
...
function rapeAkbalForcedFemaleOral(player: Character): NextScreenChoices {
    ...
    if (player.torso.hips.legs.isNaga()) {
        ...
        DisplayText("Your scent causes the growl ripping out of Akbal's chest to quiver.  You lay before him, reaching up to smash his furry lips into your " + Desc.Vagina.describeVagina(player, player.torso.vaginas.get(0)) + ".  The demon, unable to escape his debilitating arousal, begins to lap at your " + Desc.Vagina.describeVagina(player, player.torso.vaginas.get(0)) + ".  He shoves his face against your " + Desc.Vagina.describeVagina(player, player.torso.vaginas.get(0)) + " twisting his lips and drilling his tongue into you, mercilessly attacking your " + Desc.Vagina.describeClit(player) + " as you scream, howl and cringe in ecstasy.\n\n");

        DisplayText("He begins to lift up, probably to get into position above you and sake his lust, but you force his face back down into your " + Desc.Vagina.describeVagina(player, player.torso.vaginas.get(0)) + ".  After dropping a line about how he has to make your cum or get his head ripped off Akbal whines, obviously distressed at not being able to slip his aching member into your " + Desc.Vagina.describeVagina(player, player.torso.vaginas.get(0)) + ".\n\n");

        DisplayText("With a sadistic laugh you ride out your orgasm until you're reduced to a shuddering heap on the floor.  After you've recovered you gather your " + player.inventory.equipment.armor.displayName + ", leaving Akbal in a groaning mess behind you.  He howls as he claws the ground, his barbed cock still rock hard beneath him.  Just as you begin to leave you notice a group of imps watching you and the jaguar demon, their cocks out and leaking as their jagged teeth spread into feral grins.  You even spy a few goblins mixed in the crowd, each twirling a bottle of liquid and playing with her snatch.\n\n");
    ...
    // Centaur RAPPUUUUU
        ...
        DisplayText("Akbal gives a muffled scream at first but soon he gets the message. His tongue slithers into your " + Desc.Vagina.describeVagina(player, player.torso.vaginas.get(0)) + ".  You lift yourself a little; well... you lean forward a bit to let the demon actually breath.  This proves to be the right choice as Akbal is ravenous for your " + Desc.Vagina.describeVagina(player, player.torso.vaginas.get(0)) + ".\n\n");

        DisplayText("He drills his tonuge into you, mercilessly attacking your " + Desc.Vagina.describeClit(player) + " as you scream, howl and cringe in ecstasy.  He begins to lift up, probably to get the weight of your body off of the rest of his face, but you grab his tender furry balls in your hand and he stops before you're forced to do something drastic.\n\n");

        DisplayText("After dropping a line about how he has to make you cum or get his head ripped off Akbal whines, obviously distressed at not being able to slip his aching member into your " + Desc.Vagina.describeVagina(player, player.torso.vaginas.get(0)) + ".\n\n");

        DisplayText("With a sadistic laugh you ride out your orgasm until you're reduced to a shuddering heap.  After you've recovered you stand and gather your " + player.inventory.equipment.armor.displayName + ", leaving Akbal in a groaning mess behind you.  He howls as he claws the ground, his barbed cock still rock hard beneath him.  Just as you begin to leave you notice a group of imps watching you and the jaguar demon, their cocks out and leaking as their jagged teeth spread into feral grins.  You even spy a few goblins mixed in the crowd, each twirling a bottle of liquid and playing with her snatch.\n\n");
    ...
    // Everybody else
        ...
        DisplayText("Your scent causes Akbal's growling to quiver.  You lay down before him, grabbing his head and smashing his furry lips into your " + Desc.Vagina.describeVagina(player, player.torso.vaginas.get(0)) + ".  The demon, unable to escape his debilitating arousal, begins to lap at your " + Desc.Vagina.describeVagina(player, player.torso.vaginas.get(0)) + ".  He twists his lips and drills his tongue into you, mercilessly attacking your " + Desc.Vagina.describeClit(player) + ", and you scream, howl and cringe in ecstasy.  He begins to lift up, probably to get into position above you, but you force his face back down into your " + Desc.Vagina.describeVagina(player, player.torso.vaginas.get(0)) + ".  After dropping a line about how he has to make your cum or get his head ripped off, Akbal whines, obviously distressed at not being able to slip his aching member into your " + Desc.Vagina.describeVagina(player, player.torso.vaginas.get(0)) + ".\n\n");

        DisplayText("With a sadistic laugh you ride out your orgasm until you're reduced to a shuddering heap on the floor.  After you've recovered, you stand and gather your " + player.inventory.equipment.armor.displayName + ", leaving Akbal in a groaning mess behind you.  He howls as he claws the ground, his barbed cock still rock hard beneath him.  As you walk away, you notice a group of imps watching you and the jaguar demon with their cocks out and leaking, their jagged teeth spread into feral grins.  You even spy a few goblins mixed in the crowd, and each is twirling a bottle of liquid while playing with her snatches.\n\n");
...
function rapeAkbal(player: Character): NextScreenChoices {
    ...
    const cockThatFits = cocksThatFit.length > 0 ? cocksThatFit[0] : player.torso.cocks.get(0);
    DisplayText().clear();
    // Naga RAPPUUUUUU
    if (player.torso.hips.legs.type === LegType.NAGA) {
        DisplayText("You slither around the demon cat's form, wrapping him up until a scared whimper rises from his chest.  You continue to tighten your coils around Akbal until he's gasping for breath.  You ask him if he's going to be a good little demon for you.  He nods.\n\n");
        ...
        if (player.torso.cocks.count > 0) {
            ...
            if (cockThatFits.length <= 7) {
                DisplayText("As you uncoil you can't help but bump into the slimy leaking faucet Akbal calls his dick.  At your command he raises his hind quarters, giving you a perfect view of his tight pucker.  From the looks of it nothing has ever even touched the tightly sealed rim.  First you poke it with your finger, causing Akbal to flinch at the sensation.  Taking your " + Desc.Cock.describeCock(player, cockThatFits) + " in hand you shove in without hesitation or mercy.  The virginally-tight hole clamps shut and Akbal hisses in pain as you force him open.  In no time at all you're sawing your " + Desc.Cock.describeCock(player, cockThatFits) + " in and out of the demon's virginally-tight hole, relishing in the way it quivers and squirms around your embedded " + Desc.Cock.describeCock(player, cockThatFits) + ".\n\n");
            }
            // (Md Penis: 8-12 inches)
            else if (cockThatFits.length <= 12) {
                DisplayText("As you uncoil you can't help but bump into the slimy leaking faucet Akbal calls his dick.  At your command he raises his hind quarters, giving you a perfect view of his tight pucker.  From the looks of it nothing has ever even touched the tightly sealed rim.  A light tap of your finger causes the tiny hole to constrict in fear as Akbal's entire body flinches away from you.  You grab your " + Desc.Cock.describeCock(player, cockThatFits) + " with a cruel smile.\n\n");

                DisplayText("As you shove your " + Desc.Cock.describeCock(player, cockThatFits) + " into his tight pucker you are not surprised to find your " + Desc.Cock.describeCock(player, cockThatFits) + " barely able to breach the tightly sealed walls.  Grunting with effort you slowly inch forward, Akbal howling and squirming beneath you as he is taken without regard for his own pleasure.\n\n");

                DisplayText("After a dozen achingly slow thrusts Akbal's asshole begins to loosen and you begin to saw your " + Desc.Cock.describeCock(player, cockThatFits) + " in and out of his pucker with force as the demon cat's howls range from pained to pleased.\n\n");
            }
            // (Lg Penis: 13 inches and up)
            else {
                DisplayText("As you uncoil you can't help but bump into the slimy leaking faucet Akbal calls his dick.  At your command he raises his hind quarters, giving you a perfect view of his tight pucker.  A short glance tells you your " + Desc.Cock.describeCock(player, cockThatFits) + " won't fit... but since when has that stopped you from trying?\n\n");
                ...
                DisplayText("You twist Akbal's tail into your fist and laugh as a scared whimper rises out of the jaguar demon's throat.  You begin to push your huge cock in with one hand as your other pulls Akbal's tail.  The creature wines and howls as you invade its clenching sphincter, forcibly stretching its tight pink hole to a dangerous degree with your " + Desc.Cock.describeCock(player, cockThatFits) + ".  All too soon you are halted, barely able to fit more than a foot of your huge cock into Akbal's virginally-tight hole.  Deciding that's good enough you pull out and push forward, meeting the same resistance as before.\n\n");
            ...
            // (transition)
            DisplayText("You rape the jaguar demon's tight hole with steadily mounting force, your " + Desc.Hip.describeHips(player) + " smashing into his body with freight train force and causing him to cry out.  Despite this his 15 inch swollen sex organ pumps pre beneath him, letting you know that his pain is mixed with plenty of unwilling pleasure.\n\n");

            // (With Fertility/Lots of Jizz Perk)
            if (player.cumQ() > 1000) {
                DisplayText("The crushing tightness of Akbal's quivering hole pushes you over the edge and with a titanic howl you begin hosing down his insides.  The jaguar demon erupts as well, his body convulsing in time with your still thrusting " + Desc.Cock.describeCock(player, cockThatFits) + ".\n\n");
            ...
            // (Ending)
            DisplayText("As you stand you gather your " + player.inventory.equipment.armor.displayName + " and turn to leave the weakened demon behind you.  Just as you begin to walk away you notice a group of imps watching you and the jaguar demon, their cocks out and leaking.  Mixed in with the crowd are several goblins, each with a vial of liquid and a malicious grin.\n\n");
    ...
    // Centaur RAPPUUUUU
        ...
        if (player.torso.cocks.count > 0) {
            ...
            // (Sm Penis: 7 inches or less)
            if (cockThatFits.length <= 7) {
                DisplayText("Akbal snarls pitifully as you shove him stomach down against a log.  Your " + Desc.Cock.describeCock(player, cockThatFits) + " leaks at the thought of bringing this \"god\" down a notch .  At your command he arches his back and lifts his tail, giving you a perfect view of his tight pucker.  From the looks of it nothing has ever even touched the tightly sealed rim.  As you lightly tap it with your finger it flinches, becoming even tighter as Akbal's body jerks away in fear.\n\n");

                DisplayText("You rear up, standing on two legs for a moment before your hooves fall to the ground, Akbal's head between your front legs with his hair tickling your belly.  You give a few experimental thrusts.  The first one causes your " + Desc.Cock.describeCock(player, cockThatFits) + " to slide up Akbal's upturned cheeks, making him cringe.  The second one, however, catches.\n\n");

                DisplayText("The virginally-tight hole clamps shut and Akbal hisses in pain as you force him open.  In no time at all you're sawing your " + Desc.Cock.describeCock(player, cockThatFits) + " in and out of the demon's virginally-tight hole, relishing in the way it quivers and squirms around your embedded " + Desc.Cock.describeCock(player, cockThatFits) + ".  The sounds coming from Akbal's throat are varied but include many unwillingly pleased groans.  He's obviously liking this more  than he's willing to admit.\n\n");
            }
            // (Md Penis: 8-12 inches)
            else if (cockThatFits.length <= 12) {
                DisplayText("Akbal snarls pitifully as you shove him stomach down against a log.  Your " + Desc.Cock.describeCock(player, cockThatFits) + " leaks at the thought of bringing this \"god\" down a notch.  At your command he arches his back and lifts his tail, giving you a perfect view of his tight pucker.  From the looks of it nothing has ever even touched the tightly sealed rim.  As you lightly tap it with your finger it flinches, becoming even tighter as Akbal's body jerks away in fear.\n\n");
                ...
                DisplayText("As you shove your " + Desc.Cock.describeCock(player, cockThatFits) + " forward into his virginally-tight pucker you are not surprised to find your " + Desc.Cock.describeCock(player, cockThatFits) + " barely able to breach the tightly sealed walls.  Grunting with effort you slowly inch forward, Akbal howling and squirming beneath you as he is taken without regard for his own pleasure.\n\n");

                DisplayText("After a dozen achingly slow thrusts Akbal's asshole begins to loosen and you begin to saw your " + Desc.Cock.describeCock(player, cockThatFits) + " in and out of his pucker.  The demon cat's howls range from pained to pleased, obviously enjoying his butt rape more than he is willing to admit.\n\n");
            }
            // (Lg Penis: 13 inches and up)
            else {
                DisplayText("Akbal snarls pitifully as you shove him stomach down against a log. Your " + Desc.Cock.describeCock(player, cockThatFits) + " leaks at the thought of bringing this \"god\" down a notch .  At your command he arches his back and lifts his tail, giving you a perfect view of his tight pucker.  From the looks of it nothing has ever even touched the tightly sealed rim.  As you lightly tap it with your finger it flinches, becoming even tighter as Akbal's body jerks away in fear.  There's no way in hell your " + Desc.Cock.describeCock(player, cockThatFits) + " can fit inside something so incredibly tight but... since when has that stopped you?\n\n");
    ...
    if (player.torso.cocks.count > 0) {
        ...
        if (firstCock.area < 13) {
            DisplayText("You first poke it with your finger, causing Akbal to flinch at the sensation.  Taking your " + Desc.Cock.describeCock(player, firstCock) + " in hand, you shove it in without hesitation or mercy.  The virgin-like hole clamps shut and Akbal hisses in pain as you force him open.  In no time at all you're sawing your " + Desc.Cock.describeCock(player, firstCock) + " in and out of the demon's tight hole, relishing in the way it quivers and squirms around your embedded " + Desc.Cock.describeCock(player, firstCock) + ".\n\n");
        }
        // [Medium penis (8-12 inches)]
        else if (firstCock.area < 25) {
            DisplayText("A light tap of your finger causes the tiny hole to constrict and Akbal's entire body flinches in fear.  You grab your " + Desc.Cock.describeCock(player, firstCock) + " with a cruel smile.  As you shove yourself into his tight pucker, you aren't surprised to find that your " + Desc.Cock.describeCock(player, firstCock) + " is barely able to breach the tightly sealed walls.  Grunting with effort you slowly inch forward, Akbal howling and squirming beneath you as he is taken without regard for his own pleasure.\n\n");
            DisplayText("After a dozen achingly slow thrusts, Akbal's asshole begins to loosen and you start sawing your " + Desc.Cock.describeCock(player, firstCock) + " in and out of his pucker with force. The demon cat's howls fluctuate between yelps of pain and moans of pleasure.\n\n");
        }
        // [Large penis (13 inches and up)]
        else {
            DisplayText("A single look tells you your " + Desc.Cock.describeCock(player, firstCock) + " won't fit... but since when has that stopped you from trying?  You slide a single finger against the virginally-tight hole and Akbal flinches. His already tight hole clamps shut in fear, as if doing so will somehow stop the inevitable intrusion.\n\n");
            DisplayText("You twist Akbal's tail into your fist and laugh as a scared whimper escapes from the jaguar demon's throat.  You begin to push your " + Desc.Cock.describeCock(player, firstCock) + " in with one hand as you pull Akbal's tail with the other.  The demon whines and howls as you invade his clenching sphincter, forcibly stretching the tight pink hole to a dangerous degree.  You are halted all too soon, barely able to fit more than a foot of your " + Desc.Cock.describeCock(player, firstCock) + " into Akbal's virginally-tight hole.  Deciding that's good enough, you pull out before pushing forward again, meeting the same resistance as before.\n\n");
            DisplayText("After what seems like hours of resistance and howling, Akbal's body shudders and his asshole relaxes from complete exhaustion.  Battling with your " + Desc.Cock.describeCock(player, firstCock) + " seems to have nearly made him pass out, and he no longer has the energy to resist you.  The jaguar demon's body flinches with your every thrust as you pound him raw – without lube, and without mercy.\n\n");
        }
        ...
        // [With Fertility/Lots of Jizz Perk]
        if (player.cumQ() > 1000) {
            DisplayText("You continue to slide your still-swollen " + Desc.Cock.describeCock(player, player.torso.cocks.get(0)) + " inside his quivering hole as you pump massive tons of liquid into the false god's stomach and bowels.  Beneath the two of you, his belly begins to bulge as he is filled to a dangerous degree.\n\n");
        ...
        DisplayText("Standing up, you gather your " + player.inventory.equipment.armor.displayName + " and turn to leave the weakened demon behind you.  As you walk away, you notice a group of imps watching you and the jaguar demon with their cocks out and leaking.  Mixed in with the crowd are several goblins, each with a vial of liquid and a malicious grin.\n\n");
    ...
    // [Player has a vagina]
        ...
        DisplayText("With a sadistic laugh you ride out your orgasm until you're reduced to a shuddering heap on the floor.  After you've recovered, you stand and gather your " + player.inventory.equipment.armor.displayName + ", leaving Akbal in a groaning mess behind you.  He howls as he claws the ground, his barbed cock still rock hard beneath him.  As you walk away, you notice a group of imps watching you and the jaguar demon with their cocks out and leaking, their jagged teeth spread into feral grins.  You even spy a few goblins mixed in the crowd, and each is twirling a bottle of liquid while playing with their snatches.\n\n");
        DisplayText("Akbal snarls as you leave, the creatures that once feared him using his aroused state to get revenge on the 'god' of the terrestrial fire.  Even after you've reached the edge of the forest, the jaguar demon's pained howls can still be heard – though, just barely over the high-pitched laughter of the demon imps and the cackling of the goblin females.");
    }
    player.orgasm();
    player.stats.cor += 1;
...
function girlsRapeAkbal(player: Character, akbal: Character): NextScreenChoices {
    ...
    if (player.torso.hips.legs.isTaur()) {
        ...
        if (player.torso.cocks.count > 0)
            DisplayText(" " + Desc.Cock.describeMultiCockSimpleOne(player) + " hanging beneath, twitching in anticipation");
    ...
    // {If Pussy is <loose}
    else if (player.vaginalCapacity() < akbal.torso.cocks.get(0).area) {
        ...
        // {If Goo}
            ...
            DisplayText("Lifting up your " + Desc.Leg.describeLeg(player) + ", you firmly place the sole of your foot against his barbed flesh, pressing it against his stomach, forcing the jaguar to let out a low moan which you quickly take advantage of, ");

        DisplayText("stuffing his own tail into his maw.  As he tries to push his tail back out, you remove your " + Desc.Leg.describeFoot(player) + " pointedly, staring down at the demon. Lifting his hips back up weakly towards you, he meekly begins to suckle on his own appendage, closing his vibrant emerald eyes as you return your attention to his shaft.\n\n");
    }
    // {If Pussy >= Loose}
    else {
...
function girlsRapeAkbalPart2(player: Character, akbal: Character): NextScreenChoices {
    ...
    if (player.torso.hips.legs.isTaur()) {
        ...
        if (player.torso.cocks.count > 0)
            DisplayText(", " + Desc.Cock.describeMultiCockSimpleOne(player) + " swinging back and forth, occasionally bumping into his bound legs");
        ...
        // Imp pregnancy
        // Preggers chance!
        player.pregnancy.womb.knockUp(new Pregnancy(PregnancyType.IMP, IncubationTime.IMP), 101);
        // character.knockUp(PregnancyType.IMP, PregnancyType.INCUBATION_IMP, 101);

        Mod.Vagina.displayStretchVagina(player, akbal.torso.cocks.get(0).area, true, true, false);
    ...
    // TOIGHT
        ...
        if (player.gender === Gender.HERM)
            DisplayText("stroking " + Desc.Cock.describeMultiCockSimpleEach(player) + " roughly, ");
        ...
        if (player.torso.cocks.count > 0)
            DisplayText(" as " + Desc.Cock.describeMultiCockSimpleOne(player) + " offers up its bounty, spasming and adding to the mess");
        ...
        DisplayText("Your " + Desc.Breast.describeChest(player) + " chest heaves as you struggle to gulp air, " + Desc.Leg.describeLegs(player) + " quivering from the sheer power of the orgasm the cat's tail gave you.  ");
        ...
        DisplayText(" as he sags against the tree trunk, overwhelmed by the pleasure. With a satisfied grin of your own, you pick up your " + player.inventory.equipment.armor.displayName + " and head out. Perhaps you should look out for the \"<i>God of Terrestrial fire</i>\" again sometime...");
    ...
    // Loose
        ...
        DisplayText("You groan loudly as Akbal's impressive shaft stretches your pussy wide, instantly thankful that you had the idea to lube him up beforehand. Your less-than-willing partner adds his own groan to yours, the twitching of his meat signalling that he's not quite to opposed to the idea as he makes out. Maybe he's got a thing about dominance, from either angle. Nevertheless, you continue to push down until your hips reach his with a light bump. The sensation of his immense cock filling you up causes you to shudder, before leaning into the demon, pressing your " + Desc.Breast.describeChest(player) + " against his, revealing in his silky fur stroking multiple parts of your body all at once. The yowling male takes off, ducking his head to lick and nip at your " + Desc.Breast.describeNipple(player, player.torso.chest.get(0)) + "s");
        // ({If Lactating}
...
function loseToAckballllllz(player: Character): NextScreenChoices {
    // [Defeat via Lust]
    ...
    // Centaurs R SPECIALZ
        ...
        // (Small/Virgin Pucker)
        if (player.torso.butt.looseness < 3) {
            DisplayText("Akbal begins to push into you, the barbs on his massive head causing you to howl as your " + Desc.Butt.describeButthole(player.torso.butt) + " is forcibly stretched. His jaguar claws grab your sides as he uses your body as leverage to force his demonic erection into you.\n\n");
        ...
        Mod.Butt.displayStretchButt(player, User.npcs.get(CharacterType.Akbal).torso.cocks.get(0).area, true);
    ...
    if (player.torso.butt.looseness < 3) // [Small/virgin pucker]
    {
        DisplayText("Akbal begins to push into you, the barbs on his massive cockhead causing you to howl as your " + Desc.Butt.describeButthole(player.torso.butt) + " is forcibly stretched.  His jaguar claws grab your shoulders, and he uses your body as leverage to force his demonic erection into you.\n\n");
...
export function supahAkabalEdition(player: Character, akbal: Character): NextScreenChoices {
    ...
    if (akbalFlags.bitchQ >= 2) {
        return akbitchEncounter(player, akbal);
    }
...
function akbalDeny(player: Character): NextScreenChoices {
    DisplaySprite(SpriteName.Akbal);
    DisplayText().clear();
    DisplayText("You shake your head and rub the lust-filled jaguar behind the ear as you tell him you're busy.  The demon's eyes roll, and he licks your " + Desc.Leg.describeLeg(player) + " before his eyes find an imp in the trees above the two of you.\n\n");
...
function startuAkabalFightomon(player: Character): NextScreenChoices {
    DisplaySprite(SpriteName.Akbal);
    DisplayText().clear();
    DisplayText("You ready your " + player.inventory.equipment.weapon.displayname + " and prepare to battle the demon jaguar.");
    // [battle ensues]
...
function akbalSubmit(player: Character, akbal: Character): NextScreenChoices {
    ...
    akbalFlags.bitchQ = -1;
    // Big booty special
    if (akbalFlags.submissionCounter > 5 && akbalFlags.playerResisted < 2 && player.torso.butt.rating >= 13 && player.tone < 80) {
    ...
    if (player.torso.hips.legs.type === LegType.NAGA) {
        ...
        // (Medium Pucker)
            ...
            DisplayText("You feel him poking around your " + Desc.Butt.describeButthole(player.torso.butt) + " and quickly realize his member is not only quite large but covered in almost a dozen tiny barbs. Yet, thanks to the weird spit he slathered your innards with, there is none as his gargantuan member forcibly widens your " + Desc.Butt.describeButthole(player.torso.butt) + ".\n\n");

            DisplayText("Akbal's titanic member stretches your " + Desc.Butt.describeButthole(player.torso.butt) + " and makes you groan beneath him, reveling in the slick heat and fullness of your bowels. His saliva heats up, creating a steamy,pleasurable warmth inside your body. As he begins to pump his huge sex organ in and out of you the barbs covering his head begin to vibrate and hit your body with tidal waves of unbearable pleasure, feeling more like vibrating sex beads than punishing spikes. Your body begins to act of its own accord, your " + Desc.Butt.describeButt(player) + " grinding against his thrusts as his large sex pump slides in with his trunk slamming into your " + Desc.Butt.describeButt(player) + " in rhythmic, echoing claps.");
        }
        // (Gapping Pucker - Akbal's dick = 15 inches)
        else {
            DisplayText("You feel him poking around your " + Desc.Butt.describeButthole(player.torso.butt) + " and quickly realize his member is not only quite large but covered in almost a dozen tiny barbs. When Akbal begins to penetrate you he is surprised when his trunk suddenly slams into your " + Desc.Butt.describeButt(player) + ", the sudden invasion causing you to croon.\n\n");

            DisplayText("The weird spit he slathered your insides with begins to heat up instantly and the barbs covering his cock head start vibrating. The sensation of the vibrating barbs is like a dozen small slimy sex beads spinning and shaking as they are pushed inside you. Akbal wastes no time and begins forcibly fucking your " + Desc.Butt.describeButthole(player.torso.butt) + " with reckless abandon, his every brutal thrust causing your body to slide forward through the dirt. You try to meet his deep thrusts but the jaguar fucks you with speed and force befitting a cheetah and the constantly vibrating barbs make your body shiver with each hammer blow to your insides.");
        }
        Mod.Butt.displayStretchButt(player, akbal.torso.cocks.get(0).area, true);
        // character.displayStretchButt(akbal.torso.cocks.get(0).area, true);
        DisplayText("\n\n");

        // (ending)
        DisplayText("Akbal works his hips fast, piston-pumping his long demon-cat dick in and out of your " + Desc.Butt.describeButthole(player.torso.butt) + ". Your voice rises and falls with his frantic thrusts. Your body is racked by orgasm after orgasm and soon you're lying on your chest and knees in a pool of your own love juices.\n\n");
        ...
        if (player.torso.butt.rating < 8) {
            DisplayText("\n\nIn your sleep, your ass plumps up slightly, growing to accomodate the demon's wishes...");
            player.torso.butt.rating++;
        }
        player.statusAffects.add(StatusAffectType.PostAkbalSubmission, 0, 0, 0, 0);
        return { next: Scenes.camp.returnToCampUseEightHours };
    }
    // Taur variant goez here
    if (player.torso.hips.legs.type === LegType.CENTAUR) {
        DisplayImage(ImageName.akbal_deepwoods_taur_sumbitanal);
        DisplayText("After a few moments of thinking you nod to Akbal.  The deep voice in your head commands you to disrobe.  You take off your " + player.inventory.equipment.armor.displayName + ", setting it aside while mentally preparing yourself for whatever this demon has in mind.\n\n");
        ...
        if (player.torso.tails.count <= 0)
            DisplayText("  As he makes his way to your hind quarters he grabs you by the tail, pulling it up and out the way with a feral, jaguar grin.  His free hand slides a finger across your " + Desc.Butt.describeButthole(player.torso.butt) + " making you paw the ground with your hooves.");

        // (No tail)
        else
            DisplayText("  As he makes his way to your hind quarters he grabs your " + Desc.Butt.describeButt(player) + ", groping the mass of flesh with one hand and sliding a finger across your exposed " + Desc.Butt.describeButthole(player.torso.butt) + ", making you paw the ground with your hooves.");
        DisplayText("\n\n");
        // (Transition)

        DisplayText("The jaguar demon begins pushing you forward with his powerful hips, his demon-cat-dick sliding up the crevice of your " + Desc.Butt.describeButt(player) + ".  He steers you towards a tree, forcing you chest-first against the rough bark.\n\n");

        DisplayText("Looking back you watch Akbal bend low, losing sight of the jaguar demon as he disappears behind you.  For a moment you wonder what he's doing but soon you feel him shove his face into your " + Desc.Butt.describeButt(player) + " with a snarl.  He begins working his slippery wet tongue into your " + Desc.Butt.describeButthole(player.torso.butt) + ", greedily lapping at your exposed backside as if it were a quickly-melting ice cream cone.  The sensation causes you to groan and grind against the tongue, suddenly lost in ecstasy.  You are surprised at the strength in the demon's neck as he smashes your body against the tree with nothing but his mouth.  You feel his saliva, thick and warm like melted candy, sliding inside of you and coating your insides.");
        // (If Player has Vagina)
        if (player.torso.vaginas.count > 0)
            DisplayText("  Akbal slurps his way down to your " + Desc.Vagina.describeVagina(player, player.torso.vaginas.get(0)) + " twisting his face and drilling his tongue into you, mercilessly attacking your " + Desc.Vagina.describeClit(player) + " as you scream, howl, and cringe in ecstasy.  He then uses his lips to gently suck your " + Desc.Vagina.describeClit(player) + " into his mouth and twirl his tongue on it, making your grind your swollen sex against his jaguar lips.");
        // (If Player has balls)
        if (player.torso.balls.quantity > 0)
            DisplayText("  Akbal slurps his way down to your " + Desc.Balls.describeSack(player) + " where he slathers his thick, heated saliva over your orbs, making you groan as your sensitive " + Desc.Balls.describeBalls(true, true, player) + " are teased and gently juggled by Akbal's masterful tongue.  He sucks both orbs into his mouth.  The sensation sends your eyes to the back of your skull and makes your entire body shiver.");
        // (transition)
        ...
        // (Medium Pucker)
            ...
            DisplayText("You feel him poking around your " + Desc.Butt.describeButthole(player.torso.butt) + " and quickly realize his member is not only quite large but covered in almost a dozen tiny barbs.  Yet,  thanks to the weird spit he slathered your innards with, there is none as his gargantuan member forcibly widens your " + Desc.Butt.describeButthole(player.torso.butt) + ".\n\n");
            DisplayText("Akbal's titanic member stretches your " + Desc.Butt.describeButthole(player.torso.butt) + " and makes you groan and claw at the tree he has you pressed against, reveling in the slick heat and fullness of your bowels.  His saliva heats up, creating a steamy yet pleasurable warmth inside your body.  As he begins to pump his huge sex organ in and out of you the barbs covering his head begin to vibrate and hit your body with tidal waves of unbearable pleasure, feeling more like vibrating sex beads than punishing spikes.  You lean back into his thrusts as his trunk begins slamming into your " + Desc.Butt.describeButt(player) + " in rhythmic claps that echo throughout the forest.");
        }
        // (Gapping Pucker - Remember Akbal's dick is 15 inches)
        else {
            DisplayText("You feel him poking around your " + Desc.Butt.describeButthole(player.torso.butt) + " and quickly realize his member is not only quite large but covered in almost a dozen tiny barbs.  When Akbal begins to penetrate you he groans in surprise as his large dick sinks into your " + Desc.Butt.describeButt(player) + " easily, the sudden invasion causing you to croon.\n\n");
            DisplayText("The weird spit he slathered your insides with begins to heat up instantly and the barbs covering his cock head start vibrating.  The sensation is like a dozen small slimy sex beads spinning and shaking as they are pushed inside you.  Akbal wastes no time and begins forcibly fucking your " + Desc.Butt.describeButthole(player.torso.butt) + " with reckless abandon, his every brutal thrust causing the tree you're shoved up against to shake back and forth.  You try to meet his deep thrusts but the jaguar fucks you with speed and force befitting a cheetah and the constantly vibrating barbs make your body shiver with each hammer blow to your insides.");
        }
        Mod.Butt.displayStretchButt(player, akbal.torso.cocks.get(0).area, true);
        // character.displayStretchButt(akbal.torso.cocks.get(0).area, true);
        DisplayText("\n\n");
        ...
        // (ending)
        DisplayText("Akbal works his hips fast, piston-pumping his long demon-cat dick in and out of your " + Desc.Butt.describeButthole(player.torso.butt) + ".  Your body is racked by orgasm after orgasm and soon the ground beneath your pawing hooves is covered in a thick layer of your own love juices.  Then Akbal releases a harsh growl and you feel the large feline member twitching and swelling inside you.  A growl sounds in your own chest as the hot, corrupted seed of the demon cat shoots into you.  The feeling of the hot, wet warmth being fucked deeper into you is so close to supreme bliss you can scarcely tell the difference.\n\n");

        DisplayText("After a few moments you realize Akbal isn't slowing down.  His piston pumping hips drive right through his orgasm and never stop slamming into your " + Desc.Butt.describeButt(player) + ".  He continues until he's erupted no less than eight times, masterfully working your hole the entire time.\n\n");
    ...
    DisplayText("After thinking for a minute, you nod to Akbal.  The deep voice in your head commands you to disrobe.  You obediently take off your " + player.inventory.equipment.armor.displayName + " and set it aside just before the demon is upon you.\n\n");
    ...
    DisplayText("He suddenly yanks your upturned bottom half toward himself and shoves his face into your " + Desc.Butt.describeButt(player) + ".  His slippery wet tongue begins to work its way into your " + Desc.Butt.describeButthole(player.torso.butt) + ", greedily lapping at your exposed backside as though it were a quickly-melting ice cream cone.  The sensation causes you to groan and grind against the tongue, quickly losing yourself into ecstasy.  You spread your " + Desc.Leg.describeLegs(player) + " and arch your back, allowing his long and thick jaguar tongue to drill deeper into your " + Desc.Butt.describeButthole(player.torso.butt) + ".  You feel his thick and warm saliva sliding into you and coating your insides.\n\n");

    // [Player has a vagina]
    if (player.torso.vaginas.count > 0) {
        DisplayText("Akbal slurps his way down to your " + Desc.Vagina.describeVagina(player, player.torso.vaginas.get(0)) + ", twisting his face and drilling his tongue into you, mercilessly attacking your " + Desc.Vagina.describeClit(player) + " as you scream, howl and cringe from the stimulation.  He then gently sucks your " + Desc.Vagina.describeClit(player) + " into his mouth and twirls his tongue around it, making you grind your swollen sex against his jaguar lips.  ");
    }
    // [Player has balls]
    else if (player.torso.balls.quantity > 0) {
        DisplayText("Akbal slurps his way down to your " + Desc.Balls.describeSack(player) + ", slathering his heated saliva over your orbs and making you groan as your sensitive " + Desc.Balls.describeBalls(true, true, player) + " are teased and gently juggled by Akbal's masterful tongue.  Your body continually twitches with pleasure from the sensations.  ");
    }
    ...
    DisplayText("You feel him poking around your " + Desc.Butt.describeButthole(player.torso.butt) + ", learning quickly that not only is his member insanely large, but its head is covered in dozens of tiny barbs.  ");
    // [Small/virgin pucker]
    if (player.torso.butt.looseness < 3) {
        DisplayText("You grit your teeth, expecting pain. However, thanks to the weird saliva he slathered your innards with, you feel none as his gargantuan member forcibly widens your " + Desc.Butt.describeButthole(player.torso.butt) + ".");
        Mod.Butt.displayStretchButt(player, akbal.torso.cocks.get(0).area, true);
        // character.displayStretchButt(akbal.torso.cocks.get(0).area, true);
        DisplayText("\n\n");
    ...
    // [Medium Pucker]
        ...
        DisplayText("Thanks to the weird saliva he slathered your innards with, you feel no pain as his gargantuan member forcibly widens your " + Desc.Butt.describeButthole(player.torso.butt) + ".");
        Mod.Butt.displayStretchButt(player, akbal.torso.cocks.get(0).area, true);
        // character.displayStretchButt(akbal.torso.cocks.get(0).area, true);
        DisplayText("\n\n");

        DisplayText("Akbal's titanic member stretching your " + Desc.Butt.describeButthole(player.torso.butt) + " makes you groan beneath him, reveling in the slick heat and the fullness of your bowels.  His saliva heats up, creating a steamy and pleasurable warmth inside your body.  As he begins to pump his huge member in and out of you, the barbs covering his head begin to vibrate.  Your body is hit with waves of unbearable pleasure, the wicked-looking barbs acting more like humming sex beads than barbs.  Your body begins to act of its own accord; your " + Desc.Butt.describeButt(player) + " grinds against his thrusts as his large sex slides in, his trunk slamming into your " + Desc.Butt.describeButt(player) + " with rhythmic claps that echo throughout the forest.\n\n");
    }
    // [Gapping Pucker - Remember Akbal's dick is 15 inches]
    else {
        DisplayText("As Akbal begins to penetrate you, he groans in surprise at how easily his large dick sinks into your " + Desc.Butt.describeButt(player) + ", and the sudden invasion causes you to croon.\n\n");
    ...
    DisplayText("Akbal works his hips fast, piston-pumping his long demon cat-dick in and out of your " + Desc.Butt.describeButthole(player.torso.butt) + ".  The rampant babbling coming from your mouth breaks with his every thrust, and your body is racked by orgasm after orgasm. You're soon on your chest and knees ");
    ...
    DisplayText("After the sensation begins to settle, you realize Akbal isn't slowing down.  His hips carry on with their pistoning right through his orgasm and continually slam into your " + Desc.Butt.describeButt(player) + ".  He persists until he's erupted no less than eight times, masterfully working your hole the entire time.\n\n");

    DisplayText("After his final massive eruption, the jaguar demon pulls out. His copious load is released from your happy hole in an oddly satisfying cascade of thick white cream, rushing like a waterfall down your " + Desc.Leg.describeLegs(player) + ".\n\n");
...
export function akbalSubmissionFollowup(player: Character): NextScreenChoices {
    ...
    // (fighting Akbal disables this scene, but you retain the ability if you rape him after)
    else if (akbalFlags.playerResisted === 0 && akbalFlags.submissionCounter >= 8 && player.stats.cor > 80) {
        if (player.stats.cor < 80 || player.perks.has(PerkType.FireLord)) {
            ...
            player.perks.add(PerkType.FireLord, 0, 0, 0, 0);
        }
    }
    // [After 4th submission if corruption is greater than 40%]
        ...
        if (!player.perks.has(PerkType.Whispered)) {
            ...
            player.perks.add(PerkType.Whispered, 0, 0, 0, 0);
...
function akbalBigButtSubmit(player: Character): NextScreenChoices {
    ...
    if (player.torso.cocks.count > 0 && player.cumQ() >= 1000)
        DisplayText("dry, ");
    ...
    if (player.torso.butt.rating < 20) {
        ...
        Mod.Body.displayModTone(player, 30, 5);
    }
    player.orgasm();
    player.stats.cor += 5;
    player.slimeFeed();
...
function akbitchEncounter(player: Character, akbal: Character): NextScreenChoices {
    DisplayText().clear();
...
function akbitchNoThnxClear(player: Character): NextScreenChoices {
    DisplayText().clear();
    return akbitchNoThnx(player);
}

function akbitchNoThnx(player: Character): NextScreenChoices {
...
// {Choose Rape}
export function takeAdvantageOfAkbitch(player: Character, akbal: Character): NextScreenChoices {
    DisplayText().clear();
    ...
    if (player.stats.str < 50) {
        ...
        akbal.combat.perform.physicalSpecials.use(akbal, player);
    ...
    if (player.stats.int < 60) {
        ...
        akbal.combat.perform.attack.use(akbal, player);
        return CombatManager.beginBattle(player, [], [akbal]);
        // startCombat(akbal);
    }
    // {intelligence > 60}
    ...
    return {
        choices: [
            ...
            ["Strong", player.stats.str >= 70 ? akbitchHighStrengthVariant : undefined],
            ["Fast", player.stats.spe >= 70 ? akbalBitchSpeed : undefined],
            ["Toughness", player.stats.tou >= 70 ? akbitchToughness : undefined],
        ]
    };
}
...
function basicAkbitchScene(player: Character): NextScreenChoices {
    ...
    return {
        choices: [
            ["Fuck Him", player.torso.cocks.count > 0 ? buttFuckbuttFuckbuttFuckAkbal : undefined],
...
function topAkbitchFromBottomDuex(player: Character): NextScreenChoices {
    ...
    if ((player.torso.vaginas.count <= 0 && player.torso.butt.looseness < 2) || (player.torso.vaginas.count > 0 && player.torso.vaginas.get(0).looseness <= 2))
    ...
    // {medium vag/ass}
    else if ((player.torso.vaginas.count <= 0 && player.torso.butt.looseness < 4) || (player.torso.vaginas.count > 0 && player.torso.vaginas.get(0).looseness < 4))
    ...
    if (player.torso.vaginas.count > 0)
        Mod.Vagina.displayStretchVagina(player, 16, true, true, false);
    ...
    player.orgasm();
    player.stats.cor += 3;
    if (player.pregnancy.womb.canKnockUp())
        player.pregnancy.womb.knockUp(new Pregnancy(PregnancyType.IMP, IncubationTime.IMP), 101);
    // character.knockUp(PregnancyType.IMP, PregnancyType.INCUBATION_IMP, 101);
    return { next: Scenes.camp.returnToCampUseOneHour };
}
...
function akbitchHighStrengthVariant(player: Character): NextScreenChoices {
    ...
    if (player.torso.cocks.count > 0) {
        ...
        // {medium vagorAss}
        if ((player.torso.vaginas.count <= 0 && player.torso.butt.looseness < 4) || (player.torso.vaginas.count > 0 && player.torso.vaginas.get(0).looseness < 4))
...
function akbitchToughness(player: Character): NextScreenChoices {
    ...
    // {female/genderless}
        ...
        if (player.torso.chest.filter(BreastRow.FuckableNipples).length <= 0)
            DisplayText("\n\nThe demon gently teases your erect [nipples] with his hands before rubbing your [fullChest] in large circular motions.  The feeling of his soft fur gliding across your " + Desc.Skin.skinFurScales(player) + " in combination with his mouth and tongue attacking your [vagOrAss] is making your body convulse.");
        else
