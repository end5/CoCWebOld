...
export class TamainsDaughtersScene implements TimeAwareInterface {
    ...
    public tamaniPresent: boolean = false;
    ...
    // [Play Dumb]
    private playDumbToTamanisDaughters(character: Character) {
        DisplaySprite(SpriteName.Tamani_Daughters);
        DisplayText().clear();
    ...
    private tamaniDaughtersBadEndChoice(character: Character) {
        DisplaySprite(SpriteName.Tamani_Daughters);
    ...
    // [Yes]
    private tamaniDaughtersYesBadEndMePlease(character: Character) {
        DisplaySprite(SpriteName.Tamani_Daughters);
        DisplayText().clear();
    ...
    // [NO]
    private tamaniDaughtersDeclineBadEnd(character: Character) {
        DisplaySprite(SpriteName.Tamani_Daughters);
        DisplayText().clear();
    ...
    private tamanisDaughtersFillIndividuallyBADEND(character: Character) {
        DisplaySprite(SpriteName.Tamani_Daughters);
        DisplayText().clear();
    ...
    private knockUpDaughters(character: Character) {
    ...
    private loseToDaughters(character: Character) {
        DisplaySprite(SpriteName.Tamani_Daughters);
        if (character.stats.lust > 99) {
