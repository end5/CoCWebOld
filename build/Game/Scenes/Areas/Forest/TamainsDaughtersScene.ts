export class TamainsDaughtersScene implements TimeAwareInterface {
    ...
    public pregnancy: PregnancyType;
    ...
    public tamaniPresent: boolean = false; // Used to communicate between this class and TamanisDaughters.as
    ...
    // ENCOUNTER:
    public encounterTamanisDaughters(character: Character): void {
        DisplaySprite(57);
        Flags.list[FlagEnum.TIMES_ENCOUNTED_TAMANIS_DAUGHTERS]++;
        DisplayText().clear();
        const tamaniDaughterCount = Utils.numToCardinalText(Math.floor(Flags.list[FlagEnum.TAMANI_NUMBER_OF_DAUGHTERS] / 4));
    ...
    // [Play Dumb]
    private playDumbToTamanisDaughters(character: Character): void {
        DisplaySprite(57);
        DisplayText().clear();
        DisplayText("You shrug and ask, \"<i>What exactly is it you want again?  I'm not sure you have the right " + character.mf("guy", "person") + ".</i>\"\n\n");
        ...
        MainScreen.simpleChoices(["Fuck Them", "Fight", "", "Let Them", ""], [fuckYoDaughtersHomie, fightTamanisDaughters, null, legTamanisDaughtersRAEPYou, null]);
    }
    ...
    // [Fuck them]
    private fuckYoDaughtersHomie(character: Character): void {
        DisplaySprite(57);
        ...
        DisplayText(CockDescriptor.describeMultiCockShort(character) + ", swinging it around as it hardens, teasing the crowd of lusty bitches.\n\n");
        ...
        // (Fits)
        if (primary >= 0) {
            DisplayText("You pick a random body from the crowd, impaling her on your " + CockDescriptor.describeCock(character, primary) + ".  The others crowd around, jealous of your chosen cock-sleeve.   She looks up at you, blissful as she hugs against you and grinds her tight body down, raping her virginal hole on the firmness of your " + CockDescriptor.describeCock(character, primary) + ".   The others massage your " + LegDescriptor.describeLegs(character) + ", licking and nibbling your skin as they compete to tempt you into taking them next.");
            if (tamaniPresent) {
                DisplayText("  Tamani pushes aside the smaller sluts and ");
                if (character.torso.balls.quantity > 0) DisplayText("cups your " + BallsDescriptor.describeBalls(true, true, character) + ".");
            ...
            if (character.cumQ() >= 500) DisplayText(", bloating her belly until she gurgles and squishes on top of you");
            ...
            if (tamaniPresent) {
                ...
                if (character.tallness >= 60) DisplayText("scrabbling up enough to ");
                ...
                DisplayText("  Another mounts you, launching herself at you with such force that she knocks you off your " + LowerBodyDescriptor.describeFeet(character) + " and onto your back.  A hand clamps over your mouth and jams something inside while another massages your throat, forcing you to swallow it.  Numbness flows through most of your body, robbing you of strength and feeling in all but one place...\n\n");
            }
            ...
            if (tamaniPresent) {
                DisplayText("Tamani's massive jugs rest against your " + BreastDescriptor.describeBreastRow(character.torso.chest.get(0)) + ", bouncing and wobbling.  She crosses her arms over them and sucks on a finger, watching your expression with a mix of amusement and arousal.  She asks, \"<i>So what do you think of your daughters, sweet stuff?  They're just aching for a taste of their daddy's spunk, and it's hard to keep so many rambunctious sluts under control.</i>\"\n\n");
            }
            ...
            if (character.stats.cor < 33) DisplayText("You were supposed to save the village from corruption, not breed tiny sluts to overrun it... y");
            else if (character.stats.cor < 66) DisplayText("You came here to make things better for everyone... well, at least you're helping these girls. Y");
            ...
            DisplayText(" in her waiting womb, painting her walls white.  Each successive glob mixes into the slurry of sexual fluids brewing in her slit, until it starts to dribble out.  The goblin on your face cums noisily, filling your mouth with female moisture.   With no other choice, you swallow it down while your tongue keeps trying to pleasure her.  A sudden void of sensation and cold air overtakes your " + CockDescriptor.describeCock(character, primary) + " as you hear the goblins squabbling.  In no time flat a fresh cunt is squeezing over your still-orgasming member, clamping down to form a tight seal as you pump it full of even more fertile seed.\n\n");

            // (Go to End if < 10 daughters), else keep goin
            if (daughters > 10) {
                DisplayText("As your orgasm trails off, your green cock-sleeve is removed.  You sigh happily, glad the ordeal is over.  Your " + CockDescriptor.describeCock(character, character.torso.cocks.get(0)) + " manages to continue to throb, and you wonder just how long you'll have to wait for the goblin drugs to wear off.  The answer comes sooner than you think, in the form of a large vial of sweet-tasting liquid.  Your nose is pinched shut by a teal hand and your throat is massaged until you swallow the entire thing.  The result is immediate.  Slight shakes work their way through your body as it reacts to the corrupted drugs.  ");
                if (character.torso.balls.quantity > 0) DisplayText("Your balls visibly puff up and slosh as one of your daughters plays with them, filling with more seed than ever before.");
                ...
                if (tamaniPresent) {
                    DisplayText("Tamani pushes the slut on your face off and plants herself there, smearing your " + HeadDescriptor.describeFace(character) + " with a mixture of cum and vaginal wetness.  ");
                ...
                DisplayText("As your ");
                if (character.torso.balls.quantity > 0) DisplayText(BallsDescriptor.describeBalls(true, true, character) + " empty");
                ...
                if (daughters > 20) {
                    ...
                    DisplayText(", but a few of the little sluts don't look satisfied yet.  They crowd around.  One straddles your chest and begins dancing in an erotic display.  Somehow, your " + CockDescriptor.describeCock(character, primary) + " still manages to twitch weakly in response.  Another goblin opens a satchel and pulls out some fruit and a canteen.  She delicately begins feeding you, clearing wanting you to regain your strength.  It seems they aren't finished with you yet.  You down what feels like gallons of water, and then find yourself presented with another flask of pink goo.  Shrugging, you gulp it down willingly, enjoying the sensation of your " + CockDescriptor.describeCock(character, character.torso.cocks.get(0)) + " re-inflating to its maximum, turgid size.\n\n");
        ...
        // [DOESNT FIT]
            ...
            if (tamaniPresent) {
                ...
                DisplayText("Your expression of disdain is ruined when one of the sluts stretches wide and slurps your " + character.cockHead() + " into her mouth.  Her tongue feels like heaven as it slides over your tip, and her sister works the shaft, jerking the spit-lubed monster off with fast strokes.   Your enjoyment is interrupted by a sudden intrusion at your backdoor.  The rubbery flared horse-toy presses against your " + ButtDescriptor.describeButthole(character.torso.butt) + ", dribbling a little bit of its strange lubricants into your backdoor as Tamani pushes it forward.   Tiny hands grab your " + ButtDescriptor.describeButt(character) + " as it's pushed forward, and you have no choice but to relax and allow it inside.\n\n");
                ...
                DisplayText("Spent, your " + CockDescriptor.describeCock(character, character.torso.cocks.get(0)) + " wilts, drooping downward as it drips the last of its seed.  Tamani seems oblivious to that fact though, and continues to violate you from behind.  You're about to reach around to dislodge the tiny anal rapist when another squirt of aphrodisiacs releases inside you, catching some of your prostate with the goop.  A torrent of blood rushes to your " + CockDescriptor.describeCock(character, character.torso.cocks.get(0)) + " and you're suddenly achingly hard again.");
                if (character.torso.balls.quantity > 0) DisplayText("  Your " + BallsDescriptor.describeBalls(true, true, character) + " ache from the strain, but struggle to churn up more sperm.  ");
            ...
            DisplayText("A third goblin suddenly attacks your taint, licking between your " + ButtDescriptor.describeButthole(character.torso.butt) + " and ");
            ...
            DisplayText(" as she presses her hard nipples up against your " + LegDescriptor.describeLegs(character) + ". ");
            // (No Tamani:
            if (!tamaniPresent) DisplayText("She presses something against your backdoor and before you have a chance to react, something hot and wet is filling your " + ButtDescriptor.describeButthole(character.torso.butt) + ".  You look down as she pulls out a tube of pink residue, and sways with burning desire.\n\n");
            ...
            DisplayText("You explode, coming harder than ever from the pressure and drugs buried against your prostate.  One of the twins, tired of waiting, pulls your " + CockDescriptor.describeCock(character, character.torso.cocks.get(0)) + " over and shoves your tip against her slickened folds.  You manage to pump a thick blob of cum deep inside her before her sister snatches it away, grinding her own hungry twat against you until her entire groin is stained white.  They glare at each other, but after seemingly being sated, they return to fondling your " + CockDescriptor.describeCock(character, character.torso.cocks.get(0)) + " together, using it like a hose to drench their smiling sisters with the remaining cum.\n\n");
            ...
            DisplayText(" feeling hornier and hornier, as ready now as you were when you got here.  Twitching, your " + CockDescriptor.describeCock(character, character.torso.cocks.get(0)) + " announces its readiness to repaint these living cum-sponges.  A trio of goblin tongues slip over your shaft, and lip-gloss smeared lips worship every ounce of your life-giving rod.  One of the girls, an older one with prominent breasts, breaks off and begins to scale her way up your body.  She doesn't stop until she's sitting on your shoulders with her hot messy cunt pressed against your face.\n\n");

            DisplayText("One of the girls on your " + CockDescriptor.describeCock(character, character.torso.cocks.get(0)) + " gets an idea and mashes her tits against it you while she licks and strokes you.  The combined goblin assault once again achieves its goal, and you are brought to a body shaking orgasm AGAIN.   The swarm of goblins giggles happily as they gather your falling spunk into their waiting cunts.  What doesn't fit inside is slurped up, and soon you're covering a writhing orgy of curvy green women with a thick coat of spunk.\n\n");
    ...
    private legTamanisDaughtersRAEPYou(character: Character): void {
        ...
        DisplayText(" your " + CockDescriptor.describeMultiCockShort(character) + ", teasing you as it near-instantly rises, \"<i>Mommy never told me you were such an easy " + character.mf("man-", "") + "slut.</i>\"\n\n");

        DisplayText("A slippery gash mounts your " + HeadDescriptor.describeFace(character) + ", blocking your view of anything but a cute navel as pungent pussy slobbers over your lips.  With a resigned sigh, you open your mouth and bury your tongue into one of your many daughters' snatches.  It's tangy and sweet, and juicier than fresh fruit.   The girlish moans you hear let you know how successful your tongue is, and you work harder than ever to kiss and lick her slippery lips, pausing only to suck the tiny bud of her clit into your mouth.\n\n");
        ...
        if (primary >= 0) {
            ...
            else if (cocks > 2) DisplayText("More and more hands latch onto the rest of your " + CockDescriptor.describeMultiCockShort(character) + ", guiding each of them into a tight cunt-hole.   If you could see around the tight body of the slut on your face, you're sure the scene on your crotch would push you over the edge.");
            else DisplayText("You stiffen as a tongue suddenly presses against your " + assholeOrPussy() + " sliding inside and intensifying the feelings radiating down your fuck-pole until you're unable to hold on.");
            DisplayText("\n\n");

            DisplayText("A sudden flow of fluids soaks your " + HeadDescriptor.describeFace(character) + " and dribbles from your chin.  The face-riding goblin bucks like a bronco, nearly breaking your nose before the strength drains from her body and she slides off into the dirt, panting weakly.   Confronted with the sight of ");
            ...
            else DisplayText("the sultry gaze of Tamani's oldest daughter as she rides your " + CockDescriptor.describeCock(character, primary));
            ...
            if (tamaniPresent) {
                ...
                if (cocks > 1) DisplayText("one of ");
                DisplayText("your deflating " + CockDescriptor.describeMultiCockShort(character) + " a playful slap, smirking when it stiffens in response, \"<i>Honestly, you're so shameful, getting hard again from such an innocent touch.  I didn't know you wanted to make our little family that much bigger.</i>\"\n\n");

                DisplayText("Pantomiming a sigh, Tamani drags her finger from your ");
                if (!character.torso.cocks.hasSheath()) DisplayText("base");
                ...
                else DisplayText(BreastDescriptor.describeAllBreasts(character));
                DisplayText(" as she mounts you, ");
                DisplayText("squeezing her dripping wet cunt around your " + CockDescriptor.describeCock(character, primary) + ".  She explains, caressing your cheek as you start to drool, \"<i>You see, " + character.short + ", this potion is a special one.  You can probably feel it now, emptying your mind and shutting down your thought processes.  That's what it's supposed to do.  You won't remember anything when I'm done either, aside from how great my pussy feels on your " + CockDescriptor.describeCock(character, primary) + "</i>.\"\n\n");
            ...
            // NO TAMANI:
                ...
                if (daughters < 20) {
                    ...
                    DisplayText("  Disappointed moans rise up from the others as they realize they've lost the cum-lottery.   The winner, patting her belly happily, stands up, filling the air with a loud 'slurrrrrp' as her twat noisily releases your " + CockDescriptor.describeCock(character, primary) + ".");
                    if (character.cumQ() >= 500) DisplayText("  A few enterprising goblins gather around, gathering up the loose spunk and shoveling it into their holes.");
                    DisplayText("\n\n");

                    DisplayText("Tired from the sexual acrobatics, your daughters gather up their possessions and begin dispersing, but a few stick around to lick your " + CockDescriptor.describeCock(character, primary) + " clean and give you deep french-kisses.  Exhausted as well, you begin to doze off, but not before a girlish voice whispers in your ear, \"<i>Thanks daddy!  I'll bring your daughters back once they've grown up so you can have their cherries too.</i>\"\n\n");
                }
                // (MEDIUM PACK (or bigger))
                else {
                    DisplayText("The smaller girls take turns, mounting your cum-soaked rod one after another, using their hungry cunts like cum-sponges until your " + CockDescriptor.describeCock(character, primary) + " is polished with feminine fluids and cleaned of any residual jism.  After so many repeated mountings, you're hard and ready to cum again, and the horny sluts know it.   You're crammed back into each one of them, one after another in a barrage of quick fucks.  Each girl is only given a few seconds on your rod before she's pulled off by her peers and replaced by another ecstatic goblin.  While waiting for their next turn, the spare girls tease you, tweaking your " + BreastDescriptor.describeNipple(character, character.torso.chest.get(0)) + "s while licking your ears and whispering, \"<i>Don't cum for her, it'll be much better in my hot little box,</i>\" or, \"<i>You won't cum for that skank, will you?  Save your babby-batter for me!</i>\"\n\n");

                    DisplayText("Amazingly, you orgasm again.  An orgiastic squeal erupts from your " + CockDescriptor.describeCock(character, character.torso.cocks.get(0)) + "'s current owner, breaking off into pants and gasps ");
                    if (character.cumQ() < 100) DisplayText("as you twitch underneath her, emptying the last of your cum inside her.");
                    else if (character.cumQ() < 500) DisplayText("as you twitch underneath her, pumping her full of cum, thoroughly seeding her womb with spunk.");
                    else DisplayText("as you twitch underneath her in powerful spasms, blasting huge gouts of cum into her waiting body until her belly is bloated with seed and it begins to squirt out around you in time with each eruption of spunk.");
                    DisplayText("  Disappointed moans rise up from the others as they realize they've lost the cum-lottery.   The winner, patting her belly happily, stands up, filling the air with a loud 'slurrrrrp' as her twat noisily releases your " + CockDescriptor.describeCock(character, primary) + ".");
                    ...
                    if (character.torso.balls.quantity > 0) DisplayText("balls begin swelling, trembling as they visibly inflate, preparing a massive load of seed.");
                    else DisplayText("groin shifts uncomfortably, trembling as it begins preparing a massive load of seed.");
                    DisplayText("  Your " + CockDescriptor.describeMultiCockShort(character) + " spasms, twitching as unearned pleasures fill the flesh and bring you to climax.\n\n");
                    ...
                    if (daughters < 40) {
                        ...
                        if (character.torso.balls.quantity > 0) DisplayText(BallsDescriptor.describeBalls(true, true, character) + " hurt");
        ...
        // [NO FIT]
            ...
            // 	[No Tamani]
            if (!tamaniPresent) {
                DisplayText("Effortlessly, Tamani's daughter launches herself onto you, straddling your body as she tries to work your " + CockDescriptor.describeCock(character, character.torso.cocks.get(0)) + " into her tight gash.  No matter how hard she tries, she just can't get it in.  She looks up at you in confusion and asks, \"<i>How in Marae's cunt can my Mom take this beast?</i>\"\n\n");

                DisplayText("Frowning in consternation, she presses it down onto your belly and sits on top, spreading her cunt as wide as she can around the bulge your urethra makes on the underside of your " + CockDescriptor.describeCock(character, character.torso.cocks.get(0)) + ".  Though you can't see her, the feeling of her starting to slide along your length is wonderfully pleasurable.  After a few moments you can feel her getting into it, leaning over and pressing her taut body and heavy breasts against you as well.  Incredibly turned on by the mental picture you're forced to form, you attack the cunt riding your " + HeadDescriptor.describeFace(character) + ", licking it with feverish intensity.\n\n");

                DisplayText("A sudden flow of fluids soaks your " + HeadDescriptor.describeFace(character) + " and dribbles from your chin.  The face-riding goblin bucks like a bronco, nearly breaking your nose before the strength drains from her body and she slides off into the dirt, panting weakly.  Now freed from your juicy prison, you can see the oldest daughter as she's squeezing on your " + CockDescriptor.describeCock(character, character.torso.cocks.get(0)) + ", sliding her gash and ");
                if (daughters < 20) DisplayText("pert ");
                else if (daughters > 40) DisplayText("heavy ");
                DisplayText("breasts over every part of it.");
                if (cocks === 2) DisplayText("  Another one of the petite sluts climbs aboard your " + CockDescriptor.describeCock(character, 1) + ", squealing happily to her sister as she joins her in riding you.");
                if (cocks > 2) {
                    DisplayText("  A third, wearing slutty pink make-up with platinum blonde hair, lays out across your ");
                    if (cocks > 3) DisplayText("remaining " + CockDescriptor.describeMultiCockShort(character));
                    else DisplayText(CockDescriptor.describeCock(character, 2));
                    DisplayText(".");
                }
                DisplayText("\n\n");
                ...
                DisplayText(", sending a fresh surge of arousal through your " + CockDescriptor.describeMultiCockShort(character) + ".   Another one of the girls leans down between your " + LegDescriptor.describeLegs(character) + " licking your ");
                if (character.torso.balls.quantity > 0) DisplayText("balls");
                else if (character.torso.vaginas.count > 0) DisplayText("pussy");
                else DisplayText("taint");
                DisplayText(", massaging your ");
                if (character.torso.cocks.hasSheath()) DisplayText("sheath");
                else DisplayText("crotch");
                DisplayText(", and the sensitive " + character.skinDesc + " around your crotch.   The busty girl on your " + CockDescriptor.describeCock(character, character.torso.cocks.get(0)) + " teases, \"<i>Go ahead and let it out " + character.mf("stud", "sexy") + ".  I'm tired of getting your cream second-hand, so squirt it right into my hot little cunt.</i>\"\n\n");
                ...
                DisplayText("Your body caves into their demands.  The girl between your " + LegDescriptor.describeLegs(character) + " licks hard as your muscles tense with orgasm.  ");
                ...
                if (cocks === 1) {
                    ...
                    // Cum stuff
                    if (character.cumQ() < 100) DisplayText("your orgasm ends, pulsing weakly inside the sloppy goblin flesh.");
                    else if (character.cumQ() < 500) DisplayText("your orgasm drags on, pumping the slut up until she looks slightly pregnant.");
                    else {
                        DisplayText("your orgasm drags on, splattering cum everywhere as you plump up the girl until she looks pregnant.");
                        if (character.cumQ() > 1000) DisplayText("  Seed gushes out her opening, actually pushing the goblin away as your orgasm splatters cum into the grass.");
                        if (character.cumQ() > 5000) DisplayText("  The other goblins frolic around in the stuff, greedily shoveling it into their dripping pussies with both hands as you form a small lake of seed.");
                    }
                }
                // Multi jizz scene
                else {
                    ...
                    // Orgazmo
                    if (character.cumQ() < 100) DisplayText("your orgasm ends, pulsing weakly inside the sloppy goblin flesh.");
                    else if (character.cumQ() < 500) DisplayText("your orgasm drags on, pumping the sluts up till they look slightly pregnant.");
                    else {
                        DisplayText("your orgasm drags on, splattering cum everywhere as you plump up the girls until they look pregnant.");
                        if (character.cumQ() > 1000) DisplayText("  Seed gushes out their openings, actually pushing the goblins away as your orgasm splatters cum into the grass.");
                        if (character.cumQ() > 5000) DisplayText("  The other goblins frolic around in the stuff, greedily shoveling it into their dripping pussies with both hands as you form a small lake of seed.");
                    }
                }
                DisplayText("\n\n");
                ...
                DisplayText("our " + CockDescriptor.describeMultiCockShort(character) + " is now rock solid and beading pre-cum at the tip.  ");
                // (single)
                if (cocks === 1) DisplayText("The purple-lipped cock-slut grabs your " + CockDescriptor.describeCock(character, character.torso.cocks.get(0)) + " and makes a show of smearing the slippery fluid over your shaft, lubricating it as she jacks you off.  Her warm lips form a tight seal on your " + character.cockHead() + " as the young goblin begins lapping at your pre-cum as she sucks it from your urethra.   It feels heavenly, and your " + HipDescriptor.describeHips(character) + " pump weakly into the air in an instinctive bid to enhance the sensation.");
                // (multiple)
                else {
                    DisplayText("The purple-lipped cock-slut grabs hold of one of your " + CockDescriptor.describeMultiCockShort(character) + " and makes a show of smearing the slippering fluid over the shaft, lubricating it as she begins to jack you off.  Her sisters, taking the cue, step over the other sated sluts and grab hold of your " + CockDescriptor.describeCock(character, 1) + ", fondling it lovingly.  ");
                    if (cocks > 2) DisplayText("They spread out until every one of your " + CockDescriptor.describeMultiCockShort(character) + " has at least one goblin hanging off it, stroking and touching you.  ");
                    DisplayText("It feels heavenly, and your " + LowerBodyDescriptor.describeHips(character) + " pump weakly into the air in an instinctive bid to enhance the sensation.");
                }
                DisplayText("\n\n");

                DisplayText("The goblin who served between the legs crawls back into position, and you realize she must be the youngest, and therefore the lowest on the goblin totem-pole.  Her eager tongue is just as skilled as it was minutes ago, and between her attentions and the tongues on your " + CockDescriptor.describeMultiCockShort(character) + ", you're leaking streamers of liquid lust.  Hands run over your ");
                if (character.torso.chest.sort(BreastRow.BreastRatingLargest)[0].rating < 1) DisplayText("chest");
                else DisplayText(BreastDescriptor.describeAllBreasts(character));
                ...
                // (single)
                if (cocks === 1) DisplayText(CockDescriptor.describeCock(character, character.torso.cocks.get(0)) + " blasts a wave of seed directly into your cock-obsessed daughter's mouth, flooding it until she falls off of it with jism dripping from her nostrils.  You squirt a massive spurt high into the air overhead, and more than a few goblins are running around with their tongues out, trying to catch it in their mouths.   Each wave of seed is larger than the last, erupting from your " + CockDescriptor.describeCock(character, character.torso.cocks.get(0)) + " like a geyser.   Soon everyone is spattered in a layer of the stuff, and your gut-clenching orgasm tapers down to a more reasonable, but constant, slow flow of semen.  Each of your daughters comes up and takes turns angling your shaft into her waiting cunt, allowing the thick fluid to fill her to capacity before waddling off.  Then the next girl does the same, and the next, and the next...");
                // (Multi)
                else DisplayText(CockDescriptor.describeMultiCockShort(character) + " blast waves of seed directly into your cock-obsessed daughters' mouths, flooding them until they fall off with jism dripping from their nostrils.   You spurt massive loads high into the air overhead, and more than a few goblins are running around with their tongues out, trying to catch the seed in their mouths.  Each wave is larger than the last, erupting from your " + CockDescriptor.describeMultiCockShort(character) + " like a geyser.  Soon everyone is covered in a thick coating of the stuff, and your gut-clenching orgasm tapers down to a more reasonable, but constant, slow flow of semen.  Each of your daughters comes up and guides a shaft into her waiting cunt, filling herself to capacity with the thick fluid before waddling off.   Then the next set of girls does the same, and the next, and the next....");
                DisplayText("You're done in by the effort, and quickly lose consciousness.");
            }
            // [Tamani is There]
            else {
                DisplayText("A scuffle in the crowd breaks out to your right, and though you can hear it, the jiggling ass and delicious pussy of the goblin slut on your face makes it impossible to see what's going on.  You do what any horny " + character.mf("male", "herm") + " would do in your position – groan into the slippery box and ignore it, focusing on the feel of skilled hands fondling ");
                ...
                DisplayText("your " + CockDescriptor.describeMultiCockShort(character) + ".  Your eyes roll back in blissful pleasure as Tamani declares, \"<i>Tamani will take care of you, husband.  You're going to cum into these girls' hungry twats until they have to waddle home, and then you're going to remember why Tamani's cunt owns your " + CockDescriptor.nounCock(CockType.HUMAN) + ", forever.</i>\"\n\n");

                DisplayText("Tamani pulls out a ring gag, shoves it into your protesting mouth, and pulls the straps securely around the back of your neck.  She tousles your " + HeadDescriptor.describeHair(character) + " as you squirm, but the crowd of goblins easily keeps you subdued, assisting their mother now that they know her plans.   You ");
                if (character.stats.cor > 66) DisplayText("sigh, actually anticipating what's about to come");
                else if (character.stats.cor > 33) DisplayText("don't resist, knowing there's no way to stop what's about to happen");
                ...
                if (cocks > 2) {
                    ...
                    if (character.torso.chest.sort(BreastRow.LactationMultipierLargest)[0].lactationMultiplier >= 1) {
                        ...
                        if (character.torso.chest.sort(BreastRow.LactationMultipierLargest)[0].lactationMultiplier < 2) DisplayText("leak");
                        else if (character.torso.chest.sort(BreastRow.LactationMultipierLargest)[0].lactationMultiplier < 3) DisplayText("drip");
                        else if (character.torso.chest.sort(BreastRow.LactationMultipierLargest)[0].lactationMultiplier < 5) DisplayText("spew");
                ...
                // (SINGLE EXTRA)
                    ...
                    DisplayText("Meanwhile your other " + CockDescriptor.nounCock(CockType.HUMAN) + " is wasting its spunk over your belly, so one of the waiting girls grabs it and pulls it to the side, ramming its tip deep inside her seemingly bottomless fuck-hole.  She giggle and runs their manicured nails over your ");
                    if (character.torso.chest.sort(BreastRow.BreastRatingLargest)[0].rating < 1) DisplayText("chest");
                    else DisplayText(BreastDescriptor.describeAllBreasts(character));
                    DisplayText(", circling your sensitive nipples");
                    if (character.torso.chest.sort(BreastRow.LactationMultipierLargest)[0].lactationMultiplier >= 1) {
                ...
                DisplayText("Tamani slides her jiggling body overtop of you, placing her sopping wet pussy directly over-top of your " + CockDescriptor.describeCock(character, character.torso.cocks.get(0)) + ".  The warm wet fluids of her desire slowly drip down onto you until your entire surface is coated in her clear feminine-drool and the entire area smells like her cunt.  She shivers and looks into your eyes, smiling at your mindless expression as she lectures, \"<i>Feel how hard your dick is?  That's because it smells my hungry, wet pussy.  It knows that it wants to cum for my pussy.  Your cock wants nothing more than to touch my cunt, worship it and bathe it with cum.</i>\"\n\n");
    ...
    private tamaniDaughtersCombatLossDrain(character: Character): void {
        DisplaySprite(57);
        Flags.list[FlagEnum.TIMES_FUCKED_TAMANIS_DAUGHTERS]++;
        DisplayText().clear();
        ...
        if (character.stats.lust > 99) {
            ...
            if (character.torso.balls.quantity > 0) DisplayText("fondling your balls and ");
        ...
        if (cocks > 1) DisplayText("one of ");
        DisplayText("your " + CockDescriptor.describeMultiCockShort(character) + ", keeping your more than turned on enough to go along with whatever they have planned.\n\n");

        // (regular lower body)
        if (character.hips.legs.type !== LegType.CENTAUR) {
            DisplayText("The hands holding you slowly lower you into a comfortable feeling chair, securing your " + LegDescriptor.describeLegs(character) + " into tightly bound stirrups.  A moment later, your hands are strapped into equally firm cuffs.  By this point, your lust-dulled mind has begun to worry, and you start to struggle, but binding leather straps are passed over your chest, midsection, and upper thighs, then tightened against the chair to completely restrain you.  Perhaps the only ");
            if (cocks > 1) DisplayText(" things not restrained are your " + CockDescriptor.describeMultiCockShort(character) + ", standing at attention despite, or perhaps because of, your predicament.\n\n");
            else DisplayText(" thing not restrained is your " + CockDescriptor.describeMultiCockShort(character) + ", standing at attention despite, or perhaps because of, your predicament.\n\n");
        }
        // (Shit taurs go!)
        else {
            DisplayText("The hands holding you slowly lower you down onto your back, guiding you into a combination chair and harness designed to accommodate a centuar's size and shape.  Before you know it, straps secure your " + LegDescriptor.describeLegs(character) + " into tightly bound restraints.  A moment later your, hands are strapped into equally firm cuffs.  By this point, your lust-dulled mind has begun to worry, and you start to struggle, but binding leather straps are passed over your chest, midsection, and hindquarters, then tightened against the chair to completely restrain you.  Perhaps the only ");
            if (cocks > 1) DisplayText(" things not restrained are your " + CockDescriptor.describeMultiCockShort(character) + ", standing at attention despite, or perhaps because of, your predicament.\n\n");
            else DisplayText(" thing not restrained is your " + CockDescriptor.describeMultiCockShort(character) + ", standing at attention despite, or perhaps because of, your predicament.\n\n");
        }
        ...
        if (cocks > 1) DisplayText("each of ");
        DisplayText("your " + CockDescriptor.describeMultiCockShort(character) + " until it feels much harder and thicker than normal.  You stifle an involuntary groan, but fail to conceal your lust-filled pants from your audience.   A daring girl leaps onto your ");
        if (character.torso.chest.sort(BreastRow.BreastRatingLargest)[0].rating < 1) DisplayText("chest");
        else DisplayText(BreastDescriptor.describeAllBreasts(character));
        ...
        else DisplayText("Relax Dad, we're just giving you your cummy medicine.  I know you're a sexy, virile " + character.mf("stud", "slut") + "and all, but take your medicine and you'll have more than enough cum for us!</i>\"\n\n");
        ...
        if (character.torso.balls.quantity > 0) DisplayText("Your balls tighten inside your sack and swell up like sponges, slowly increasing in size in time with your desire.");
        else DisplayText("Your body feels tight and needy, your gut clenching as your body adjusts to the drugs it's absorbing so readily through your " + ButtDescriptor.describeButthole(character.torso.butt) + ".");
        DisplayText("  The suckling pleasure around ");
        if (cocks > 1) DisplayText("each of ");
        DisplayText("your " + CockDescriptor.describeMultiCockShort(character) + " seems to slowly increase as more of the drugs are absorbed by your body, until escaping the straps for your freedom is longer a concern.   Now all that matters is getting free so that you can fuck ");
        ...
        DisplayText("The goblins, upon seeing your change in demeanor, begin smiling to one another and congratulating each other on their hard work.  The girl at the console twists a few more levers and the warmth inside you seems to double as more drugs are forced into your captive frame.  You start " + character.mf("laughing", "giggling") + ", the narcotics and pleasure overwhelming your thought processes, leaving you feeling like you're floating in heaven.  To anyone watching, you're panting and moaning in between the laughter, slobbering all over the milky goblin-tit in your mouth as your body begins squirting pre-cum into the cock-milker.\n\n");
        ...
        if (character.torso.balls.quantity > 0) DisplayText("Straining and shaking, your " + BallsDescriptor.describeBalls(true, true, character) + " clench against you, feeling tight as your body struggles to pump out the spooge they're producing.");
        ...
        if (cocks > 1) DisplayText("each of ");
        DisplayText("your " + CockDescriptor.describeMultiCockShort(character) + " has your brain flooded with pleasure, blocking any other thoughts or feelings from arising from the swirling morass of fuck.\n\n");
        ...
        if (Flags.list[FlagEnum.UNKNOWN_FLAG_NUMBER_00058] < 4) {
            ...
            if (Flags.list[FlagEnum.UNKNOWN_FLAG_NUMBER_00058] === 0) {
                DisplayText("<i>   " + character.mf("Husband", "Baby") + ",\n");
    ...
    private tamaniDaughtersBadEndChoice(character: Character): void {
        ...
        if (character.statusAffects.get(StatusAffectType.Exgartuan).value1 === 1) DisplayText("Exgartuan barks, \"<i>Hell yes I do!</i>\" but the goblin only smirks down for a moment before looking back at you.\n\n");

        DisplayText("(Options: Yes, No, I'd rather fill your cunts individually & personally)");
        MainScreen.simpleChoices(["Yes", "No", "Individual", "", ""], [tamaniDaughtersYesBadEndMePlease, tamaniDaughtersDeclineBadEnd, tamanisDaughtersFillIndividuallyBADEND, null, null]);
    }

    // [Yes]
    private tamaniDaughtersYesBadEndMePlease(character: Character): void {
        DisplaySprite(57);
        DisplayText().clear();
        DisplayText("\"<i>Wonderful!</i>\" cries the excited pregnant slut.   She gives you a quick peck on the cheek as she prances back over to the machine.  You brace yourself in anticipation, eager to lose yourself to an eternal orgasm.  A switch clicks, and a dial whirs as it's turned up to the maximum.  The fluids pumping into your backside and directly into your veins suddenly jump in pressure, stinging painfully for a moment before the pleasure returns.  Your eyes slowly roll back, your jaw goes slack, and your " + CockDescriptor.describeMultiCockShort(character) + " spew");
    ...
    private tamaniDaughtersDeclineBadEnd(): void {
        ...
        DisplayText("The restraints pop off you at once, and you pull the tubes and IV's from your skin.  You grunt with discomfort and remove the final tube from your " + ButtDescriptor.describeButthole(character.torso.butt) + ".  Climbing off the table, your " + LegDescriptor.describeLegs(character) + " wobble unsteadily as you try to get your balance.   The goblin says, \"<i>Go on home dad before I strap you back down and teach you to enjoy my gifts!</i>\"\n\n");
    ...
    private tamanisDaughtersFillIndividuallyBADEND(): void {
        ...
        DisplayText("your " + CockDescriptor.describeMultiCockShort(character) + " rising to full hardness in anticipation.  Your daughter pats ");
        if (character.torso.cocks.count > 1) DisplayText("one of them");
        else DisplayText("it");
        DisplayText(" as if it were a person and smiles as she pops the restraints from your chair.  She helps you as you stagger up to your " + LowerBodyDescriptor.describeFeet(character) + ", though the feeling of her hand stroking ");
        if (character.torso.cocks.count > 1) DisplayText("a");
        else DisplayText("your");
        DisplayText(" " + CockDescriptor.describeCock(character, character.torso.cocks.get(0)) + " doesn't make it easy.  The pair of you journey deeper into the caves to a massive antechamber filled with pregnant goblins.  Some are eating, others are sewing at tables, tinkering with machinery, or fiddling with alchemical equipment.  All of them turn to look at you as you enter.\n\n");
    ...
    private loseToDaughtersWithTamaniThere(): void {
        ...
        if (character.stats.HP < 1) DisplayText("Lying in the dirt, too hurt to fight back, you can only tremble in anticipation of what pleasures they're going to force upon you this time.");
        else {
            ...
            DisplayText("your trembling " + CockDescriptor.describeMultiCockShort(character) + ", feeling it leak pre-cum in anticipation of getting to knock up some of these beautiful curvy women.");
        }
        ...
        if (character.cumQ() < 50) DisplayText("Cum splatters and drips down Tamani's hand, forming a tiny puddle on your chest.");
        // (ALT)
        else if (character.cumQ() < 250) DisplayText("Cum splatters over Tamani's hand and forearm, even hitting her ass and hips as you form a thick puddle over your torso that drips to the ground.");
        // (ALT2)
        else if (character.cumQ() < 600) DisplayText("Cum splatters out in thick waves, soaking Tamani's hand, forearm, and hips with thick puddles of the stuff.  It pools on your belly for a moment, then rolls off you, forming a small pool on the ground as you keep squirting.");
        // (ALT3)
        else {
            ...
            if (character.cumQ() >= 2000) DisplayText("  Eventually it stops, but by then the pool is huge and nearly five inches deep.");
        }
        ...
        if (character.torso.cocks.count > 1) DisplayText("each of ");
        DisplayText("your " + CockDescriptor.describeMultiCockShort(character) + " grows back to full erectness and trembles with desire, ready to seed a womb.  The girls ");
        if (character.torso.cocks.count === 1) DisplayText("grab your " + CockDescriptor.describeMultiCockShort(character) + " and stroke it with long slow strokes, just like their mother.  Unlike her, they don't seem content to wait, and in seconds a slippery gash is stretching to accommodate your cock-head.\n\n");
        else DisplayText("each grab one of your " + CockDescriptor.describeMultiCockShort(character) + " and stroke it with long slow strokes, just like their mother.  Unlike her, they don't seem content to wait, and in seconds a slippery gash is stretching to accommodate each cock-tip.\n\n");
        ...
        if (primary < 0) {
            ...
            if (character.torso.cocks.count === 1) {
                ...
                if (character.cumQ() > 700) DisplayText("It gets everywhere as her womb fails to contain your massive load, even after you've bloated her belly with the stuff.");
                if (character.cumQ() > 2000) DisplayText("After a few more seconds the puddle from before gets even deeper, and your daughters kindly prop up your head to keep you from drowning in the jism pool.");
            }
            else {
                ...
                if (character.cumQ() > 700) DisplayText("It gets everywhere as their wombs fail to contain your massive load, even after you've bloated their bellies with the stuff.");
                if (character.cumQ() > 2000) DisplayText("After a few more seconds the puddle from before gets even deeper, and your daughters kindly prop up your head to keep you from drowning in the jism pool.");
            }
            DisplayText("\n\n");
        ...
        // (FITS)
            ...
            DisplayText("Thankfully, the hungry goblin twat is able to devour your " + CockDescriptor.describeCock(character, character.torso.cocks.get(0)) + " with ease.  Those pliable, fluid-slicked cunt-walls clench ever-so-tightly around you");
            if (character.torso.cocks.biggestCocks[0].area < 30) DisplayText(" in spite of the large sizes they usually handle.");
    ...
    public internal; function combatWinAgainstDaughters(): void {
        DisplaySprite(57);
        if (monster.stats.HP < 1) {
            DisplayText("You smile in satisfaction as " + monster.a + monster.short + " collapses, unable to continue fighting.", true);
...
internal; function loseToDaughters(): void {
    ...
    if (character.stats.lust > 99) {
        ...
        if (tamaniPresent) {
            ...
            else return { next: legTamanisDaughtersRAEPYou };
            return;
        }
        else {
