...
export function loseKitsuneImpFight(player: Character, kitsune: Character): NextScreenChoices {
    ...
    return { next: partial(loseToKitsunes, player, kitsune) };
}
...
function followTheWillOWispFirstTime(player: Character): NextScreenChoices {
    return followTheWillOWisp(player, true);
}

function followTheWillOWispNotFirstTime(player: Character): NextScreenChoices {
    return followTheWillOWisp(player, false);
}
...
function talkAfterResistingKitsunellusion(player: Character): NextScreenChoices {
    ...
    // Redhead
        ...
        DisplayText("\n\nYou cast her a dirty look, feeling slightly offended, but she brushes you off with a sly grin.  She strolls around you casually, her tails slipping in under your " + player.inventory.equipment.armor.displayName + " and tickling your erogenous zones while she teases you with a glance down the front of her skimpy robes.\n\n");
    }
    // MERGE
    ...
    DisplayText("Self-preservation battles with curiosity " + ((player.stats.lust > 50) ? "and lust " : "") + "as you consider her offer, " + ((player.stats.lib < 50) ? "weighing your chances against the possible dangers." : "eying the voluptuous curves that fill out her robes."));

    // [Follow { mansion(willing = true) }] [Leave]
    return { choices: [["Follow", partial(mansion, player, true, false)]], persistantChoices: [["Leave", partial(leaveKitsune, player, true)]] };
}
...
function leaveKitsune(player: Character, talked: boolean = false): NextScreenChoices {
    ...
    return player.inventory.items.createAdd(player, ItemType.Consumable, ConsumableName.KitsuneGift, Scenes.camp.returnToCampUseOneHour);
}
...
function mansion(player: Character, willing: boolean, firstTime: boolean = false): NextScreenChoices {
    ...
    if (kitsuneFlags.MANSION_VISITED > 0) DisplayText(" back");
    DisplayText(",</i>\" you hear as you enter the courtyard, startling you a little.  There to greet you at the mansion's door stands ");
    if (kitsuneFlags.MANSION_VISITED > 0) DisplayText("the trio of familiar kitsune sisters.");
    else {
    ...
    // next
    return { next: partial(nonTentaclePCMansion, player, willing) };
}
...
function nonTentaclePCMansion(player: Character, willing: boolean): NextScreenChoices {
    ...
    if (player.torso.cocks.filter(Cock.FilterType(CockType.TENTACLE)).length >= 3) {
        ...
        if (player.torso.cocks.count > 0) return { next: partial(kitsuneMaleOrHermMansion, player, willing) };
        else return { next: partial(kitsuneFemaleOrGenderless, player, willing) };
    }
}
...
function kitsuneMaleOrHermMansion(player: Character, willing: boolean): NextScreenChoices {
    ...
    DisplayText("Three tails envelop [eachCock], squeezing " + ((player.torso.cocks.count > 1) ? "them" : "it") + " tightly, while several more constrict your limbs, binding you helplessly.  Your liquor-addled mind is too foggy by now to resist their advances, their disarming caresses breaking down your inhibitions and replacing them with lust and desire.  In unison, the fluffy appendages begin to pump up and down while the sisters continue to lavish you with affection, running their fingers " + ((player.torso.neck.head.hair.length > 0) ? "through your hair" : "across your scalp") + " sensually and teasing your neck with small, affectionate nips.\n\n");
    ...
    DisplayText("The three tails recede from [eachCock] with an agonizing slowness as the black-haired girl lowers the voluptuous globes of her ass down against your " + Desc.Cock.describeCock(player, player.torso.cocks.sort(Cock.LargestCockArea)[0]) + ".  Her hips rise and fall slowly, teasing the underside of your cock with the silky soft flesh of her rear, and the sight of her tattooed hindquarters gently cradling your prick sends fresh blood to your groin.  Your pleasure is only amplified when the blonde begins to stroke and knead it, casting you a sultry smirk as she lowers her lips toward the " + Desc.Cock.describeCockHead(player.torso.cocks.sort(Cock.LargestCockArea)[0]) + ".  Her soft tongue slides warmly along the top edge, traveling from base to tip and back again, each and every movement carefully measured and controlled to tease and excite you.\n\n");
...
function kitSuneLetHerMansion(player: Character, willing: boolean = true): NextScreenChoices {
    ...
    DisplayText("The blonde's prodigious posterior bounces and jiggles as she pumps her hips up and down instinctively.  The quivering cheeks entice you, drawing you in almost hypnotizingly, and before you know it your " + Desc.Cock.describeCock(player, player.torso.cocks.sort(Cock.LargestCockArea)[0]) + " is already " + ((player.torso.balls.quantity > 0) ? "balls" : "hip") + "-deep in her slippery snatch.\n\n");
    DisplayText("The voluptuous fox-woman groans in pleasure as your " + Desc.Cock.describeCock(player, player.torso.cocks.sort(Cock.LargestCockArea)[0]) + " plunges into her deepest fathoms, her warm flesh enveloping your hot prick and squeezing tightly as a rush of feminine fluids spills over the black-haired girl's face." + ((player.torso.cocks.sort(Cock.LargestCockArea)[0].area > 50) ? "  Her folds seem to stretch forever, swallowing your engorged tool like a bottomless pit of warmth and pleasure." : "") + "  Your hands sink deep into the pillowy mounds of her mountainous ass, mashing them together as you knead her cheeks like warm dough.\n\n");
    DisplayText("Slender fingers close around your " + Desc.Hip.describeHips(player) + " as the redhead pulls herself tight against your [butt], attempting to line up against you while your pelvis mashes wildly against her sister's rippling rump.  Her cock slides up between your cheeks, dripping pre-cum that tingles on your flesh, and she finally manages to align herself to your ");
    if (player.gender >= 2) DisplayText(Desc.Vagina.describeVagina(player, player.torso.vaginas.get(0)));
    else DisplayText(Desc.Butt.describeButthole(player.torso.butt));
    DisplayText(" and thrust in, spearing you on twelve inches of throbbing futa rod.  Buried to the hilt in your ");
    if (player.gender === Gender.MALE) DisplayText("hindquarters");
    ...
    if (player.gender === Gender.MALE) Mod.Butt.displayStretchButt(player, 14, true, true, false);
    else Mod.Vagina.displayStretchVagina(player, 14, true, true, false);
    DisplayText("\n\n");
    DisplayText("Sandwiched between the two amorous kitsune, you shudder in pleasure, feeling the blonde's slick pussy squeeze and milk along your length while the redhead bucks up against your twitching hips with an animalistic fervor.  You feel something slick sliding along the " + ((player.torso.cocks.find(Cock.HasSheath)) ? "sheath" : "base") + " of your " + Desc.Cock.describeCock(player, player.torso.cocks.sort(Cock.LargestCockArea)[0]) + ", the black-haired kitsune's long tongue wrapping around and slurping the blonde's juices off of it hungrily." + ((player.torso.balls.quantity > 0) ? "  Her pillowy lips press up against your " + Desc.Balls.describeBalls(true, true, player) + " lovingly, slurping loudly and humming through them with glee." : "") + "\n\n");
    ...
    if (player.torso.cocks.count > 1) {
        ...
        DisplayText("your remaining " + numToCardinalText(player.torso.cocks.count - 1) + " cock");
    ...
    if (player.gender >= 2) DisplayText("cunt");
    else DisplayText("rectum");
    DisplayText(" around her shaft sends her over the edge, and she begins to groan loudly in your ear, digging her fingertips into your " + Desc.Hip.describeHips(player) + ".  Her turgid rod trembles in your ");
    if (player.gender >= 2) DisplayText(Desc.Vagina.describeVagina(player, player.torso.vaginas.get(0)));
    else DisplayText(Desc.Butt.describeButthole(player.torso.butt));
    DisplayText(", a thick bulge passing through the shaft and erupting into your ");
    if (player.gender >= 2) DisplayText("slippery hole");
    else DisplayText("innards");
    DisplayText(" forcefully.  The thick cum hits your ");
    if (player.gender >= 2) DisplayText("womb");
    ...
    DisplayText("The pleasant pressure in your expanding belly pushes your pleasure to new extremes, and you begin mashing your pelvis into the blonde's quivering ass cheeks in pursuit of your glorious release." + ((player.torso.cocks.sort(Cock.LargestCockArea)[0].area > 80) ? "  She lurches forward, her fingers clawing at the wooden deck that runs along the edge of the pool, her entire body heaving with pleasure." : "  As you feel the coiling spring in your lower body near its limit, you suddenly feel the redhead's hand wrap around your " + Desc.Cock.describeCock(player, player.torso.cocks.sort(Cock.LargestCockArea)[0]) + ".  She slyly leans over your shoulder, raising a finger to her lips and whispering to you, \"<i>Shh...</i>\"\n\nWithout warning, she yanks you back, pulling you from the blonde's quivering cunt just as you begin to climax, adjusting the angle quickly and bucking her hips forward to slam your twitching shaft into the blonde's ass!  The soft ring of her anus yields to the invasion with surprising ease, spreading open as if by reflex and then clamping shut around your base when your hips make contact with her quivering cheeks again.  She lurches forward, releasing a surprised gasp and nearly collapsing under your compulsory anal assault, her entire body heaving with a combination of shock and pleasure.") + "\n\n");
    if (player.cumQ() <= 150)
        DisplayText("A few virile streams spurt into her, sloppily smearing her " + ((player.torso.cocks.sort(Cock.LargestCockArea)[0].area > 80) ? "passage" : "intestines") + " with your thick load.  Her inner muscles squeeze you involuntarily, a deep crimson blush spreading across her cheeks as a thick spray of girlcum erupts from her pussy.  It splatters over the black-haired girl's face, and she opens her mouth to catch it all, pressing her plump lips against her sister's quivering cunt and drinking deeply as she hums a satisfied melody into her clitoris.");
    else if (player.cumQ() <= 350) DisplayText("Numerous streams spurt into her, sloppily smearing her tunnel with your thick load.  Her inner muscles squeeze you greedily, massaging your shaft to draw your seed " + ((player.torso.cocks.sort(Cock.LargestCockArea)[0].area > 80) ? "toward her convulsing womb." : "deeper into her convulsing bowels.") + "  A deep crimson blush spreads across her cheeks as a thick spray of girlcum erupts from her pussy, splattering over the black-haired girl's face, and she opens her mouth to catch it all, pressing her plump lips against her sister's quivering cunt and drinking deeply as she hums a satisfied melody into her clitoris.");
    else if (player.cumQ() <= 1000) DisplayText("Thick ribbons of cum spurt into her, sloppily smearing her " + ((player.torso.cocks.sort(Cock.LargestCockArea)[0].area > 80) ? "passage" : "intestines") + " with your potent load.  Her inner muscles squeeze you greedily, massaging your shaft to draw your seed " + ((player.torso.cocks.sort(Cock.LargestCockArea)[0].area > 80) ? "toward her convulsing womb.  Her pussy" : "deeper into her convulsing bowels.  Her rectum") + " clenches involuntarily as your cloying seed erupts into her " + ((player.torso.cocks.sort(Cock.LargestCockArea)[0].area > 80) ? "quivering cunt and floods her passage" : "ass and floods her intestines") + ", a deep crimson blush spreading across her cheeks as a thick spray of girlcum erupts from her pussy.  It splatters over the black-haired girl's face, and she opens her mouth to catch it all, pressing her plump lips against her sister's quivering cunt and drinking deeply as she hums a satisfied melody into her clitoris.");
    else if (player.cumQ() <= 2500) DisplayText("Hot ropes of cum splash into her " + ((player.torso.cocks.sort(Cock.LargestCockArea)[0].area > 80) ? "slit" : "ass") + ", smearing her with your thick load.  Her inner muscles squeeze you greedily, massaging your shaft as it swells with virile seed over and over again, thick streams spurting out of her hole as her stomach begins to distend into a jiggling round belly from the pressure.  Her " + ((player.torso.cocks.sort(Cock.LargestCockArea)[0].area > 80) ? "pussy" : "rectum") + " clenches involuntarily as your cloying seed erupts into her " + ((player.torso.cocks.sort(Cock.LargestCockArea)[0].area > 80) ? "quivering cunt and floods her passage" : "ass and floods her intestines") + ", her stomach expanding with a jiggle and hanging low and heavy with the weight of your seed.  A deep crimson blush spreads across her cheeks as a thick spray of girlcum erupts from her pussy, splattering over the black-haired girl's face, and she opens her mouth to catch it all, pressing her plump lips against her sister's quivering cunt and drinking deeply as she hums a satisfied melody into her clitoris.");
    else if (player.cumQ() > 2500) DisplayText("Hot waves of cum crest against her " + ((player.torso.cocks.sort(Cock.LargestCockArea)[0].area > 80) ? "cervix, flooding her womb" : "sphincter, flooding her ass") + " with your thick load.  Her inner muscles squeeze you greedily, massaging your shaft as it swells with virile seed over and over again, pressurized streams erupting from her " + ((player.torso.cocks.sort(Cock.LargestCockArea)[0].area > 80) ? "snatch" : "butt") + " as her abdomen swells to an obscene size.  Her " + ((player.torso.cocks.sort(Cock.LargestCockArea)[0].area > 80) ? "pussy" : "rectum") + " squeezes you involuntarily as your cloying seed erupts into her " + ((player.torso.cocks.sort(Cock.LargestCockArea)[0].area > 80) ? "quivering cunt and floods her passage" : "ass and floods her intestines") + ", her stomach rapidly swelling into a heavy, gravid belly, sloshing audibly.  A deep crimson blush spreads across her cheeks as a thick spray of girlcum erupts from her pussy, splattering over the black-haired girl's face, and she opens her mouth to catch it all, pressing her plump lips against her sister's quivering cunt and drinking deeply as she hums a satisfied melody into her clitoris.");
    ...
    DisplayText("Her warm " + ((player.torso.cocks.sort(Cock.LargestCockArea)[0].area > 80) ? "cunt" : "asshole") + " still grips your cock tightly, dragging you down with her.  You collapse on top of her, sliding off of the redhead's cock as you tumble into the golden curls of the blonde's hair.");
    if (player.gender >= 2) DisplayText("  A flood of seed begins to spill from your abused pussy, gushing over the redhead's groin and spreading into the water.  The flow is soon stemmed by the introduction of the black-haired girl's tongue, plush lips pressed against your cunt as she hungrily sucks down the outpouring of semen.  She gulps loudly and gluttonously, spreading your lips with her thumbs and swallowing every last delicious salty morsel, her stomach swelling and quivering as your own overfull abdomen begins to deflate in equal measure.");
    DisplayText("  As your twitching cock relieves itself of the last of your seed inside the blonde's " + ((player.torso.cocks.sort(Cock.LargestCockArea)[0].area > 80) ? "pussy" : "ass") + ", you feel your strength slipping away from you with each spasm, your eyelids growing heavy with an uncommon weariness.\n\n");
    player.orgasm();
...
function kitsuneShoveHerMansion(player: Character, willing: boolean = true): NextScreenChoices {
    ...
    if (player.gender === Gender.MALE || ((player.gender === Gender.HERM) && kitsuneFlags.redheadIsFuta === 0)) {
        ...
        DisplayText("You edge closer and closer to your climax, shivering with pleasure as pressure builds in your " + ((player.torso.balls.quantity > 0) ? Desc.Balls.describeBalls(true, true, player) : "prostate") + ".  The " + ((player.torso.cocks.find(Cock.HasSheath)) ? "sheath" : "base") + " of your " + Desc.Cock.describeCock(player, player.torso.cocks.sort(Cock.LargestCockArea)[0]) + " bulges outwardly as the first thick glob of cum swells through it, forcing its way into the blonde's unprotected womb.  ");
        if (player.cumQ() <= 150) {
            DisplayText("A few virile streams spurt into her, sloppily smearing her tunnel with your thick load.  Just as your potency begins to wane, you feel her golden tail constrict around your base, blocking the flow.  You groan deeply in protest as your shaft spasms dryly, her muscular snatch forcing you out with a loud 'plop!'  As the remainder of your seed builds up painfully behind her tail, she raises a finger to her lips, leering at you slyly.  Before you know what is going on, her tail directs your throbbing shaft downward and you feel yourself plunge into the redhead's " + ((player.torso.cocks.sort(Cock.LargestCockArea)[0].area > 80) ? "vagina!" : "defenseless anus!") + "  The unsuspecting girl lurches forward with a moan, and at the same time the blonde releases her grip on your " + ((player.torso.cocks.find(Cock.HasSheath)) ? "sheath" : "base") + ", allowing your load to freely spill into her sister's tender " + ((player.torso.cocks.sort(Cock.LargestCockArea)[0].area > 80) ? "pussy. Her slit " : "butt. Her rectum") + " squeezes you involuntarily, her face caught halfway between shock and orgasmic pleasure.");
        }
        else if (player.cumQ() <= 350) {
            DisplayText("Numerous streams spurt into her, sloppily smearing her tunnel with your thick load.  Her inner muscles squeeze you greedily, massaging your shaft to draw your seed toward her convulsing womb.  Just as your potency begins to wane, you feel her golden tail constrict around your base, blocking the flow.  You groan deeply in protest as your shaft spasms dryly, her muscular snatch forcing you out with a loud 'plop!'  As the remainder of your seed builds up painfully behind her tail, she raises a finger to her lips, leering at you slyly.  Before you know what is going on, her tail directs your throbbing shaft downward and you feel yourself plunge into the redhead's " + ((player.torso.cocks.sort(Cock.LargestCockArea)[0].area > 80) ? "vagina!" : "defenseless anus!") + "  The unsuspecting girl lurches forward with a moan, and at the same time the blonde releases her grip on your " + ((player.torso.cocks.find(Cock.HasSheath)) ? "sheath" : "base") + ", allowing your load to freely spill into her sister's tender " + ((player.torso.cocks.sort(Cock.LargestCockArea)[0].area > 80) ? "pussy. Her slit " : "butt. Her rectum") + " squeezes you involuntarily as a final glut of seed erupts into her " + ((player.torso.cocks.sort(Cock.LargestCockArea)[0].area > 80) ? "passage" : "intestines") + ", her face caught halfway between shock and orgasmic pleasure.");
        }
        else if (player.cumQ() <= 1000) {
            DisplayText("Thick ribbons of cum spurt into her, sloppily smearing her tunnel with your potent load.  Her inner muscles squeeze you greedily, massaging your shaft to draw your virile seed toward her convulsing womb, thin streams messily spurting from her entrance as her abdomen begins to bulge from the pressure.  Just as your potency begins to peak, you feel her golden tail constrict around your base, blocking the flow.  You groan deeply in protest as your shaft spasms dryly,  her muscular snatch forcing you out with a loud 'plop!'  One particularly eager spurt of seed manages to escape and dribbles weakly down the tip, and as the remainder of your seed builds up painfully behind her tail, she raises a finger to her lips, leering at you slyly.  Before you know what is going on, her tail directs your throbbing shaft downward and you feel yourself plunge into the redhead's " + ((player.torso.cocks.sort(Cock.LargestCockArea)[0].area > 80) ? "vagina!" : "defenseless anus!") + "  The unsuspecting girl lurches forward with a moan, and at the same time the blonde releases her grip on your " + ((player.torso.cocks.find(Cock.HasSheath)) ? "sheath" : "base") + ", allowing your load to freely spill into her sister's tender " + ((player.torso.cocks.sort(Cock.LargestCockArea)[0].area > 80) ? "pussy. Her slit " : "butt. Her rectum") + " squeezes you involuntarily as your cloying seed erupts into her " + ((player.torso.cocks.sort(Cock.LargestCockArea)[0].area > 80) ? "pussy and floods her womb" : "ass and floods into intestines") + ", her face caught halfway between shock and orgasmic pleasure as her stomach begins to swell slightly.");
        }
        else if (player.cumQ() <= 2500) {
            DisplayText("Hot ropes of cum splash into her womb, smearing her with your thick load.  Her inner muscles squeeze you greedily, massaging your shaft as it swells with virile seed over and over again, thick streams spurting out of her entrance as her stomach begins to distend into a jiggling round belly from the pressure.  At the peak of your orgasm, you feel her golden tail constrict around your base, blocking the flow.  You groan deeply in protest as your shaft spasms valiantly, her muscular snatch forcing you out with a loud 'plop!'  The pressure in your " + ((player.torso.balls.quantity > 0) ? Desc.Balls.describeBalls(true, true, player) : "prostate") + " is too great for her to hold all of it back, and a number of pressurized streams force their way by, streaking her body with hot seed.  She opens her mouth and happily catches an errant stream on her tongue, then raises a finger to her lips and leers at you slyly.  Before you know what is going on, her tail directs your throbbing shaft downward and you feel yourself plunge into the redhead's " + ((player.torso.cocks.sort(Cock.LargestCockArea)[0].area > 80) ? "vagina!" : "defenseless anus!") + "  The unsuspecting girl lurches forward with a moan, and at the same time the blonde releases her grip on your " + ((player.torso.cocks.find(Cock.HasSheath)) ? "sheath" : "base") + ", allowing your load to freely spill into her sister's tender " + ((player.torso.cocks.sort(Cock.LargestCockArea)[0].area > 80) ? "pussy. Her slit " : "butt. Her rectum") + "  squeezes you involuntarily as your cloying seed erupts into her " + ((player.torso.cocks.sort(Cock.LargestCockArea)[0].area > 80) ? "pussy and floods into her passage" : "ass and floods her intestines") + ", her face caught halfway between shock and orgasmic pleasure as her stomach expands with a jiggle, hanging low and heavy with the weight of your seed.");
        }
        else if (player.cumQ() > 2500) {
            DisplayText("Hot waves of cum crest against her " + ((player.torso.cocks.sort(Cock.LargestCockArea)[0].area > 80) ? "cervix" : "sphincter") + ", flooding her " + ((player.torso.cocks.sort(Cock.LargestCockArea)[0].area > 80) ? "womb" : "anus") + " with your thick load.  Her inner muscles squeeze you greedily, massaging your shaft as it swells with virile seed over and over again, pressurized streams erupting from her " + ((player.torso.cocks.sort(Cock.LargestCockArea)[0].area > 80) ? "snatch" : "pucker") + " as her abdomen swells to an obscene size.  At the peak of your orgasm, you feel her golden tail constrict around your base, trying in vain to stem the flow.  You groan deeply in protest as your shaft spasms violently, her muscular " + ((player.torso.cocks.sort(Cock.LargestCockArea)[0].area > 80) ? "snatch" : "pucker") + " forcing you out with a loud 'plop!'  The pressure in your " + ((player.torso.balls.quantity > 0) ? Desc.Balls.describeBalls(true, true, player) : "prostate") + " is far too much for her to hold back, and her efforts only succeed in turning your eruptive streams into a sporadic shower of semen that streaks her front with a percussive patter.  She revels in the showering seed, happily catching a few streams on her tongue, then raises a finger to her lips and leers at you slyly.  Before you know what is going on, her tail directs your throbbing shaft downward and you feel yourself plunge into the redhead's " + ((player.torso.cocks.sort(Cock.LargestCockArea)[0].area > 80) ? "vagina!" : "defenseless anus!") + "  The unsuspecting girl lurches forward with a moan, and at the same time the blonde releases her grip on your " + ((player.torso.cocks.find(Cock.HasSheath)) ? "sheath" : "base") + ", allowing your abundant load to freely splatter into her sister's tender " + ((player.torso.cocks.sort(Cock.LargestCockArea)[0].area > 80) ? "pussy" : "butt") + ".  Her " + ((player.torso.cocks.sort(Cock.LargestCockArea)[0].area > 80) ? "slit" : "rectum") + " squeezes you involuntarily as your cloying seed erupts into her " + ((player.torso.cocks.sort(Cock.LargestCockArea)[0].area > 80) ? "pussy" : "ass") + " and floods her " + ((player.torso.cocks.sort(Cock.LargestCockArea)[0].area > 80) ? "passage" : "intestines") + ", her face caught halfway between shock and orgasmic pleasure as her stomach rapidly swells into a heavy, gravid belly, sloshing audibly.");
        }
        DisplayText("\n\nThe sudden intrusion " + ((player.torso.cocks.sort(Cock.LargestCockArea)[0].area > 80) ? "" : "into her behind ") + "drives her over the edge in an instant, and soon your ears are met with the sound of hungry slurping.  " + (kitsuneFlags.redheadIsFuta > 0 ? "The black-haired kitsune swallows eagerly around her sister's engorged cock, slurping down stream after stream of thick futa-jizz.  She raises her hand up and slides two fingers into the girl's convulsing cleft, moaning in approval as the copious fountain of semen in her throat thickens even more.  Her other hand slowly massages her gradually expanding stomach, caressing the growing bulge while she pounds her fingertips into her sister's pussy, sucking out every creamy, salty morsel." : "The black-haired kitsune laps eagerly at her sister's convulsing pussy, a thick spray of girlcum splattering across her face as she tries her best to catch it in her mouth.  Her lips wrap around the girl's quivering cunt, and she begins to drink deeply from the viscous fountain, humming her pleasure the entire time.") + "  After what certainly must have felt like an eternity, the girl's climax begins to ebb, and she collapses fantastically beneath the blonde's weight with a splash, narrowly avoiding the raven-haired girl's face on the way down.\n\n");
        DisplayText("Her warm " + ((player.torso.cocks.sort(Cock.LargestCockArea)[0].area > 80) ? "cunt" : "asshole") + " still grips your cock tightly, dragging you down with her.  You collapse into the blonde's open arms, finding yourself pressed into the marshmallowy embrace of her mountainous breasts.  As your twitching cock relieves itself of the last of your seed inside the redhead's " + ((player.torso.cocks.sort(Cock.LargestCockArea)[0].area > 80) ? "pussy" : "ass") + ", you feel your strength slipping away from you with each spasm, your eyelids growing heavy with an uncommon weariness.\n\n");
    }
    else if (player.gender === Gender.HERM && kitsuneFlags.redheadIsFuta > 0) {
        DisplayText("\n\nThe blonde casually wades over to the redhead, flipping her onto her back and sliding onto her sister's hips with a haughty smirk.  The poor redhead is pinned under her weight, flushing with wanton desire, her cock twitching needfully between the blonde's ass cheeks.  One of the blonde's tails winds around the " + ((player.torso.cocks.find(Cock.HasSheath)) ? "sheath" : "base") + " of your " + Desc.Cock.describeCock(player, player.torso.cocks.sort(Cock.LargestCockArea)[0]) + ", pulling it into the shimmering tangle of golden coils, and though a fluffy forest obscures your view, you can feel the " + Desc.Cock.describeCockHead(player.torso.cocks.sort(Cock.LargestCockArea)[0]) + " pressing up against the blonde's warm, inviting snatch.\n\n");
        DisplayText("Her tail coils and constricts around your member, drawing you forward to plunge into the waiting folds with a wet slurp." + ((player.torso.cocks.sort(Cock.LargestCockArea)[0].area > 80) ? "  Her walls draw you inward for ages, rippling sensually along your length as her cavernous cunt seems to go on forever.  Impossible though it might sound, it seems she intends to take ALL of you." : "") + "  She shudders with satisfaction as your hips lightly press against hers, a few of her tails lashing around your " + Desc.Hip.describeHips(player) + " to draw you in as far as possible" + ((player.torso.cocks.count > 1) ? ", [eachCock] entangled in a jungle of gold that caresses and tickles them teasingly." : ".") + "  The redhead's tails flail sporadically beneath her, bristling with pleasure as your " + Desc.Vagina.describeVagina(player, player.torso.vaginas.get(0)) + " slides across the tip of her cock teasingly, sending a shiver up her spine and a blush to her cheeks.\n\n");
        DisplayText("You feel something brushing against you and look down to find the black-haired girl pressing her face against your [butt], running her hands up and down your " + Desc.Hip.describeHips(player) + " and smacking your cheek once lightly for good measure.  An involuntary shudder zigzags up your spine as her slick tongue runs up your crack, lining your [asshole] with saliva.  Her fingertips dig into the flesh of your bottom, the other hand sliding along your " + Desc.Vagina.describeVagina(player, player.torso.vaginas.get(0)) + ", pinching and rolling your " + Desc.Vagina.describeClit(player) + ".  A moment later, you rise an inch or two off the ground as a squirming invader spears your ass.  Her plush lips press against you like soft pillows, a muffled giggle vibrating up her tongue and into your prostate.  Your strength gives out as she prods your prostate, dragging you down with her weight at the same time to impale you on the redhead's cock.");
...
function kitsuneStillHungryMansion(player: Character): NextScreenChoices {
    ...
    DisplayText(((player.torso.balls.quantity > 0) ? "She exposes her upturned palms, rubbing them together for a moment and then blowing into them lightly.  With a snapping crackle, a bright blue flame bursts to life in her hands, and she presses her palms to your " + Desc.Balls.describeBalls(true, true, player) + ", massaging them gently." : "She extends her index and middle fingers, and with a snapping crackle, a bright blue flame bursts to life at her fingertips.  Before you can protest, your [butt] is invaded by her pyrotechnic digits, pressing against your prostate insistently.") + "  As the cooling tingle of her mystical flame spreads across your " + ((player.torso.balls.quantity > 0) ? Desc.Balls.describeBalls(true, true, player) : "prostate") + ", you can feel a tense pressure building up, pleasure coursing through you as your spent stores of seed miraculously begin to replenish themselves, your flagging " + Desc.Cock.describeCock(player, largestCock) + " springing to readiness instantly!\n\n");
    ...
    DisplayText("Still overly sensitive from the exhilarating romp you had just taken part in, your " + Desc.Cock.describeCock(player, largestCock) + " begins to throb and twitch excitedly within the black-haired girl's throat, already being pushed to the limits of your endurance.  ");
    if (kitsuneFlags.redheadIsFuta > 0) {
...
function kitsuneFemaleOrGenderless(player: Character, willing: boolean): NextScreenChoices {
    DisplayText().clear();
    kitsuneSprite();
    DisplayText("\"<i>Just relax, darling,</i>\" the blonde says in a crooning tone, sliding her hand down along your " + Desc.Hip.describeHips(player) + " under the water.  Her silky-soft fingertips gently circles your " + ((player.gender >= 2) ? Desc.Vagina.describeClit(player) : Desc.Butt.describeButthole(player.torso.butt)) + ", making you shudder.  Any reservations you still had are naught but memories now as you" + ((player.torso.hips.legs.isBiped()) ? " spread your legs and" : "") + " give yourself over completely to her tender touch.\n\n");
    ...
    DisplayText("One fingertip is shortly followed by a second, gently invading your " + ((player.gender >= 2) ? Desc.Vagina.describeVagina(player, player.torso.vaginas.get(0)) : Desc.Butt.describeButthole(player.torso.butt)) + " up to the second knuckle and making you moan and clench in pleasure.  Tender caresses slide down your [fullChest] as the sisters lavish you with affection - a gentle tweak here, a nip there, every action carefully measured to tease and arouse you.  The black-haired one carefully climbs on top of you, wrapping her lips around one of your " + Desc.Breast.describeNipple(player, player.torso.chest.get(0)) + "s and flicking it gently with her tongue." + ((player.lactationQ() > 0) ? "  She titters with excitement as your fresh cream begins to pour into her mouth, massaging your [chest] gently to stimulate the flow and drinking it down eagerly.\n\n\"<i>Mmmm...  So very tasty,</i>\" she says with a smirk, dipping down for another drink." : "Her teeth gently play along the tender flesh, sending shocks of pleasure through you.  Pale blue flames spread from the corners of her lips, elevating the pleasure even further, and you find it hard to stop shivering.") + "\n\n");
    ...
    if (willing) {
        ...
        const letHer = partial(kitsunesGenderlessLetHer, player, willing);
        const shoveHer = partial(kitsunesGenderlessShoverHer, player, willing);
        return { choices: [["Let Her", letHer], ["Shove Her", shoveHer]] };
    }
    else {
        return { next: partial(kitsunesGenderlessLetHer, player, true) };
    }
}
...
function kitsunesGenderlessLetHer(player: Character, willing: boolean): NextScreenChoices {
    DisplayText().clear();
    kitsuneSprite();
    DisplayText(((willing) ? "You decide to let the girl have her fun, allowing her to shift positions to begin rubbing her throbbing shaft against your " + ((player.gender === Gender.FEMALE) ? Desc.Vagina.describeVagina(player, player.torso.vaginas.get(0)) : "featureless groin") + " eagerly." : "You shake your head sluggishly, but your slurred protests fall on deaf ears.  She easily sidesteps your " + Desc.Leg.describeLeg(player) + " as you try to shove her away, sliding forward to lay a disarming kiss on your cheek.  A bright blue wisp of flame crackles from her lips, and that is that - the resulting spark of pleasure that arcs up your spine shatters the last of your resistance, and your cares melt like butter.") + "  While she grinds her pulsating shaft against you slowly, her sisters close in around you to join in the fun.\n\n");
    DisplayText("Your head is drawn into the blonde's lap, fingers softly gliding " + ((player.torso.neck.head.hair.length > 0) ? "through your " + Desc.Head.describeHair(player) : "across the sides of your face") + ", brushing you lightly with her mystical flames.  A pair of large, shapely ass cheeks emblazoned with a sun-shaped tattoo enters your field of vision, and soon your view is entirely blocked by the black-haired girl's expansive behind, save for a sliver of light filtering down between her and the blonde.  Her slick pussy glides across your lips, coaxing your tongue from your mouth as she bends down, pulling the redhead's cock into her mouth for a moment to slather it with saliva, spreading your " + ((player.gender === Gender.FEMALE) ? "labia" : "butt cheeks") + " with her first two fingers, egging her on.\n\n");
    DisplayText("The redhead wastes no time taking the invitation, spearing your " + ((player.gender >= 2) ? Desc.Vagina.describeVagina(player, player.torso.vaginas.get(0)) : Desc.Butt.describeButthole(player.torso.butt)) + " in a single thrust.  Her thick rod pierces your waiting hole, bringing with it a distinctive effervescent tingle.  Her hands close around your " + Desc.Hip.describeHips(player) + ", and she begins to thrust wantonly, playing up her pleasure with an exaggerated moan as her breasts jiggle to and fro with each buck of her hips.");
    if (player.gender >= 2) Mod.Vagina.displayStretchVagina(player, 14, true, true, false);
    else Mod.Butt.displayStretchButt(player, 14, true, true, false);
    ...
    DisplayText("The base of the redhead's shaft swells with a vast load, backing up just behind her sister's tongue.  She pumps into your " + ((player.gender >= 2) ? Desc.Vagina.describeVagina(player, player.torso.vaginas.get(0)) : Desc.Butt.describeButthole(player.torso.butt)) + " once, twice, thrice more before the black-haired girl releases the tension around the base, though whether by choice or due to the furious orgasm roaring through her loins, it is hard to tell.  You have only a split-second to muse on the subject before a tingling glut of seed comes rushing into your " + ((player.gender === Gender.FEMALE) ? "womb" : "intestines") + ", sending you into a shivering fit.  Saliva and sexual fluids flow in rivers, the blonde's soaked cunt drenching your face as her pussy quivers and squeezes around your tongue.  The ravenette begins to rise upward, lifted by your expanding abdomen as she twitches in ecstasy, the blonde's tails deeply embedded in her holes.\n\n");
    DisplayText("Passionate moans from all four of you fill the air as you ride the waves of pleasure, finally collapsing together in ecstasy after what feels like ages.  Each twitching tremble of your muscles sees you a bit more fatigued, your eyelids feeling as though they weigh a thousand pounds each." + ((player.gender === Gender.HERM) ? "  A flood of seed begins to spill from your abused pussy, gushing over the redhead's groin and spreading into the water.  The flow is soon stemmed by the introduction of the black-haired girl's tongue, plush lips pressed against your cunt as she hungrily sucks down the outpouring of semen.  She gulps loudly and gluttonously, spreading your lips with her thumbs and swallowing every last delicious salty morsel, her stomach swelling and quivering as your own overfull abdomen begins to deflate in equal measure." : "") + "  Hands resting on your" + ((player.gender === Gender.NONE) ? " swollen" : " deflating") + " belly, you begin to succumb to exhaustion, your strength fading as you are overcome with an uncommon weariness.\n\n");
    return { next: partial(genderlessKitsuneStillHungry, player, willing) };
} // end letHer()
...
function kitsunesGenderlessShoverHer(player: Character, willing: boolean): NextScreenChoices {
    ...
    DisplayText("Her tails coil and constrict around your thighs, drawing you forward to press against her quivering lips while the tips sensually brush your sensitive nethers, sending light tingles up and down your spine.  " + ((player.torso.clit.length > 4) ? "You groan a bit as you feel your " + Desc.Vagina.describeClit(player) + " gently slipping between the moist folds of her cunt, caressed on all sides by warm, wet flesh, the muscles squeezing down to conform to its shape perfectly.  " : "") + "She shudders with satisfaction as you lightly press against her, a few of her tails lashing around your " + Desc.Hip.describeHips(player) + " to hold you tight.  The redhead's tails flail sporadically beneath her, bristling with pleasure as " + (kitsuneFlags.redheadIsFuta > 0 ? "your " + ((player.gender >= 2) ? Desc.Vagina.describeVagina(player, player.torso.vaginas.get(0)) : Desc.Butt.describeButthole(player.torso.butt)) + " slides across the tip of her cock teasingly" : "you are rubbed against her slavering slit") + ", sending a shiver up her spine and a blush to her cheeks.\n\n");
    DisplayText("You feel something brushing against you and look down to find the black-haired girl pressing her face against your [butt], running her hands up and down your " + Desc.Hip.describeHips(player) + " and smacking your cheek once lightly for good measure.  An involuntary shudder zigzags up your spine as her slick tongue runs up your crack, lining your [asshole] with saliva.  Her fingertips dig into the flesh of your bottom, " + ((player.gender === Gender.FEMALE) ? "the other hand sliding along your " + Desc.Vagina.describeVagina(player, player.torso.vaginas.get(0)) + ", pinching and rolling your " + Desc.Vagina.describeClit(player) + "." : "a fingertip gently tracing the curvature of your cheek as sparks snap and pop in its wake.") + "  A moment later, you rise an inch or two off the ground as a squirming invader spears your ass.  Her plush lips press against you like soft pillows, a muffled giggle vibrating up her tongue.  Your strength gives out as she prods your innards, " + (kitsuneFlags.redheadIsFuta > 0 ? "dragging you down with her weight at the same time" + ((player.gender === Gender.FEMALE) ? " to impale you on the redhead's cock." : ", her tongue receding just as you are impaled on the redhead's cock.  The slick organ slides around the base of her cock, constricting tightly, and you can feel it swell as the veins and ridges become more pronounced.") : "and while you are at your most vulnerable, she twists two of the redhead's tails into a tight bundle, thrusting it into your " + ((player.gender === Gender.FEMALE) ? "vagina." : "ass.")));
    Mod.Vagina.displayStretchVagina(player, 24, true, true, false);
    DisplayText("\n\n");
    DisplayText("The redhead squeals with pleasure " + (kitsuneFlags.redheadIsFuta > 0 ? "as her throbbing shaft spears your " : "as her tails are thrust unmercifully into your ") + ((player.gender === Gender.FEMALE) ? "cunt" : "ass") + ", her hands rising up to the blonde's shoulders and digging into them passionately.  Caught between the blonde's sopping pussy, the redhead's " + (kitsuneFlags.redheadIsFuta > 0 ? "cock" : "tails") + ", and the ravenette's swirling tongue, you are ensconced in such pleasure that you can no longer distinguish the source.  Your body bucks and trembles from the trio's indulgent onslaught, hips grinding and mashing against each other in a passionate spectacle.\n\n");
    DisplayText("Holding the blonde's shapely hips, you begin to grind against her slippery gash, moaning shamelessly as the heat washes over you.  She licks her lips hungrily, rolling her eyes back and groaning in ecstasy, playing up the pleasure to extremes in order to tease her sisters.  Smirking deviously, she raises an index finger into the air and presses it to your " + ((player.gender === Gender.FEMALE) ? Desc.Vagina.describeClit(player) : "bare crotch") + ", a pale blue flame sending a spark of pleasure through you.\n\n");
...
function genderlessKitsuneStillHungry(player: Character, willing: boolean): NextScreenChoices {
    ...
    DisplayText("\"<i>Still hungry...</i>\" she says softly, rubbing her chubby stomach gently, a quiet rumble issuing forth.\n\n");
    DisplayText("She exposes her upturned palms, rubbing them together for a moment and then blowing into them lightly.  With a snapping crackle, a bright blue flame bursts to life in her hands, and she presses her palms to your [chest], massaging gently.  As the cooling tingle of her mystical flame spreads across your chest, you can feel a tense pressure building up, pleasure coursing through you.  Your " + ((player.torso.chest.sort(BreastRow.BreastRatingLargest)[0].rating < 3) ? ((player.torso.chest.sort(BreastRow.BreastRatingLargest)[0].rating === 0) ? "flat chest begins" : "breasts begin") + " to swell, jiggling titflesh spilling out with a tense tingle until you are the proud new owner of a sizeable pair of C cups" : "breasts seem to plump up a bit, your nipples growing hard as a tense tingle spreads through them.") + "  You arch your back, clutching your chest as the tingling intensifies, an inferno of pleasure burning in your chest.  At the height of ecstasy, your milk begins to spurt from your nipples, flying into the air like a lewd fountain.\n\n");
...
function outro(player: Character, tentacles: boolean = false): NextScreenChoices {
    ...
    if (player.stats.fatigue >= 100) {
        ...
        if (player.cumQ() < 10000 || (player.torso.cocks.count <= 0 && player.lactationQ() < 10000)) {
            ...
            if (player.torso.cocks.count > 0) {
                ...
                DisplayText("milk ");
                if (player.lactationQ() < 500) Mod.Breast.boostLactation(player, 3);
                if (player.lactationQ() < 2000) Mod.Breast.boostLactation(player, 2);
                if (player.lactationQ() < 10000) Mod.Breast.boostLactation(player, 1);
            }
...
function mansionBadEnd(player: Character): NextScreenChoices {
    ...
    DisplayText("\n\nThe realization hits you like a bag full of rocks, and you spring to " + ((player.torso.hips.legs.isBiped()) ? "your feet" : "action") + " immediately, leaping off the comfortable bed.  Your " + player.inventory.equipment.armor.displayName + " are gone, replaced by exotic robes woven of fine silk.  What's more, you have no weapon to speak of!  Still reeling a bit from your hangover, you stumble out into the hallway, looking for a way out before the mansion's mysterious owners get wind of your egress.\n\n");
...
function fightSomeKitsunes(player: Character): NextScreenChoices {
    DisplayText().clear();
    DisplayText("Something just doesn't sit right with you about this woman, and you cautiously raise your " + player.inventory.equipment.weapon.displayname + ", watching her carefully.\n\n");
    kitsuneSprite();
    // Blonde
    ...
    return CombatManager.beginBattle(player, [], [new Kitsune(hairColor)]);
}
...
export function loseToKitsunes(player: Character, kitsune: Character): NextScreenChoices {
    ...
    // Shared Scenes
    // For Males and Herms
    if (player.torso.cocks.count > 0) scene.push(loseFightToHerms);
    // For Females and Genderless
    if (player.gender !== 1) scene.push(femalesAndNuetersLoseToKitsunes);
    // Blonde-exclusive
    // Single cock < 9 inches long
    if (hairColor === "blonde" && player.torso.cocks.count === 1 && player.torso.cocks.sort(Cock.LongestCocks)[0].length < 9) {
    ...
    if (hairColor === "black" && player.lactationQ() >= 50) {
    ...
    if (player.torso.cocks.count > 0 && player.torso.balls.quantity > 0 && player.cumQ() > 1000) {
    ...
    return scene[randInt(scene.length)](player);
}
...
function loseFightToHerms(player: Character): NextScreenChoices {
    ...
    DisplayText("\n\nSighing deeply in utter satisfaction" + ((player.cumQ() > 350) ? " with one hand resting on her stomach" : "") + ", she leans back, swiveling her hips a little to tease your spent cock.  Drenched in her " + ((hairColor === "red") ? "musky futa-cum" : "feminine juices") + ", you twitch lightly as bliss and fatigue spread through your body in equal measure.  She leans forward again, dropping her lips to your ear, and whispers a short incantation while stroking the side of your face.\n\n");
...
function femalesAndNuetersLoseToKitsunes(player: Character): NextScreenChoices {
    ...
    DisplayText("Humming quietly, she carefully removes your " + player.inventory.equipment.armor.displayName + ", neatly arranging them into a pile and shoving them off to the side.  Eying your nude form hungrily, she begins to slowly trail her hands down your [fullChest], letting her fingertips cascade over every ridge and curve of your body while painting streaks of blue fire across your flesh.  Her touch sends tingles up and down your spine, making you shiver and moan involuntarily.  Slowly but surely her hands work their way down toward your loins, teasing around your [hips] very gently" + ((player.torso.hips.legs.isBiped()) ? ", tickling the insides of your thighs" : "") + " before trailing up to your " + ((player.gender === Gender.FEMALE) ? "rapidly moistening cleft.  Her fingers dance along the inside of your labia" : Desc.Butt.describeButthole(player.torso.butt) + ".  Her fingers dance along between your cheeks") + ", circling the entrance and nearly - but never quite - pushing a fingertip inside, snickering in satisfaction as you release a small rush of fluids into her palm." + ((player.gender === Gender.FEMALE) ? "  She glides the tip of one of her tails across your [clit] delicately, like a feather, flicking it up and down." : "") + "\n\n");
    DisplayText("The tip of her index finger presses " + ((player.gender === Gender.FEMALE) ? "into the end of your clitoris" : "against your pucker gently") + ", leaving behind a tiny bead of fire that tingles incredibly as the azure tongues lick at your nethers.  It doesn't take but a few moments of this treatment before you are teetering on the edge, but the skillful seductress has other plans for you, and dials back the pleasure mere moments before your release.\n\n");
    DisplayText("\"<i>Oh no dear, the fun's only just begun,</i>\" she says with a mock chastising tone, smirking mischievously.\n\n");
    DisplayText("She slides forward, daintily settling down on your hips and pinning you under the weight of her expansive behind.  " + ((player.torso.hips.legs.isBiped()) ? "A pair of fluffy tails slides in between your legs, curling around them and spreading them up and apart, the remaining tails taking advantage of your helpless state and beginning to brush up and down the insides of your thighs, one tip sliding up and down " + ((player.gender === Gender.FEMALE) ? "the sensitive cleft of your vagina" : "between the cheeks of your " + Desc.Butt.describeButt(player)) + "." : "Her tails drift over your sensitive crotch, brushing the tip " + ((player.gender === Gender.FEMALE) ? "along the cleft of your vagina" : "between the cheeks of your " + Desc.Butt.describeButt(player)) + " and tickling it sensually.") + "  Sliding her hands down her shoulders and over the jiggling mounds of her breasts, she hooks her fingers into her robes and drags them down so that her perky nipples are just barely contained.  With an agonizing slowness, she strips out of her robes, watching you the entire time and laughing seductively at your reactions to her teasing display.  With her clothes tossed aside and out of the way, you have a full view of her young, lithe body, " + ((hairColor === "blonde") ? "flowing golden locks cascading over her toned, voluptuous hourglass shape." : ((hairColor === "black") ? "a slight pudge around her belly accentuating her voluptuous figure." : "your eyes drawn immediately down to the pulsating, foot long member that now lays across your stomach.")) + "  Grinning coyly, she strikes an alluring pose and leers at you through half-lidded eyes, one corner of her mouth curled up in a mirthful smirk.\n\n");
    DisplayText("\"<i>Mm...  getting all hot and bothered dear?</i>\"  she says, almost in a whisper, her voice dripping with seduction.\n\n");
    DisplayText("As she leans down to press her chest to yours, her tails continue to twist and slither over your groin, teasing and painting your " + ((player.gender === Gender.FEMALE) ? "slick slit " : "anus") + " with their mystical fire.  She starts to gradually grind her hips forward and back on your abdomen, her cheeks quivering gently while she leans forward to caress your face, planting a small kiss just below your chin.  Lush, full lips press against yours, carrying the sweet taste of wintergreen.  Her fingers clasp against the back of your head with a surprisingly strong grip, and she releases a powerful moan into your lips, a tingling coolness spreading over your tongue before moving on to the rest of your body.\n\n");
...
function blondeKitsuneRapesSmallWangs(player: Character): NextScreenChoices {
    ...
    DisplayText("Her fingers trail over your cheek, dazzling sparks bursting to life beneath her fingertips and licking across your skin in their wake, making you shiver comfortably.  Though a small part of your mind still urges you to break away from her tender caress, it is extinguished in short order when she slides her hands under your " + player.inventory.equipment.armor.displayName + ", running her fingertips over your bare body.  You groan involuntarily, shuddering powerfully and feeling your muscles go slack.\n\n");
    DisplayText("Without taking her hands off of you, she skillfully pulls your " + player.inventory.equipment.armor.displayName + " off piece by piece using her tails, slowly easing you backward onto the ground.  Fully nude, you give yourself over to her tender touch, shivering as the cool flames zigzag down your [fullChest] toward your groin.  Your " + Desc.Cock.describeCock(player, player.torso.cocks.get(0)) + " rises up to brush against the underside of her forearm, twitching lightly.  Smirking gleefully, she gives it a gentle squeeze, pushing it back against your stomach and giggling when she lets it go to watch it spring back, slinging a few thin strings of precum into the air.\n\n");
    ...
    DisplayText("Her tails snake forward, curling around your limbs, and you find yourself pinned, struggling in vain against the uncommonly strong furred coils.  She nods, satisfied with your helplessness, and leans down to gently nuzzle your " + Desc.Cock.describeCock(player, player.torso.cocks.get(0)) + ", cooing softly and sliding her soft, wet tongue along the underside from base to tip with a small giggle.  Her tongue swirls back and forth along the underside of your " + Desc.Cock.describeCockHead(player.torso.cocks.get(0)) + ", wrapping around it and slurping up your slick precum.\n\n");
    ...
    DisplayText("Her entire body shudders a bit, and you can now feel her soft breasts squashing against your groin as she leans down to lightly kiss the end of your " + Desc.Cock.describeCock(player, player.torso.cocks.get(0)) + ".  She starts to rock her wide, curvy hips back and forth across your face, grinding her crotch into your mouth and moaning.  The tails that aren't pinning your limbs down gently curl underneath your neck, lifting your head up.  You moan into her pussy as you feel her lips softly wrap around the tip of your shaft, her tongue playing along the " + Desc.Cock.describeCockHead(player.torso.cocks.get(0)) + " lightly.  Her lips make a soft smacking noise as she pulls away, and she starts to toy with your member gleefully, stroking it teasingly with her index finger just to feel your reactions trembling up through her loins.\n\n");
    DisplayText("\"<i>Oh yeah, that's right, just like that!  Be a good " + Desc.Gender.boyGirl(player.gender) + " and lick mama's pussy,</i>\" she groans, mashing her cunt into your face and riding your tongue with an animalistic passion.\n\n");
    ...
    DisplayText("\"<i>No!  You behave, naughty " + Desc.Gender.boyGirl(player.gender) + "!</i>\" she growls.  You can practically feel her scowling, despite the fact that your vision is almost entirely obscured by her colossal keister.  To punish you for your transgression, her tails pull your hands away from her ass, and she sits up, smothering you with it.\n\n");
    ...
    DisplayText("\"<i>Mm, hey there lil' guy,</i>\" she says in a singsong voice, wrapping one arm around her breasts to squash them down and hold them in place while gently fiddling with the tip of your " + Desc.Cock.describeCock(player, player.torso.cocks.get(0)) + " using her index finger.\n\n");

    DisplayText("\"<i>Oooh, right there, lick right there!  If you're a good " + Desc.Gender.boyGirl(player.gender) + ", I might just let you cum on my tits.</i>\"\n\n");
    DisplayText("You nod your agreement before you can stop yourself, realizing that you are not in control of your own body anymore.  Her tails loosen their grip, permitting you to grab handfuls of her plush ass once again, and she begins to slowly slide her precum-lathered tits up and down your pole, giggling incessantly to herself as she watches it twitch within her cleavage.  She rewards your obedience and submission, happily running her tongue across your " + Desc.Cock.describeCockHead(player.torso.cocks.get(0)) + " and matching her pace according to how well you please her.\n\n");
    ...
    DisplayText("Her lips rise and fall around your spasming prick, low moans vibrating through it each time she pulls back.  You can feel her cheeks pulling inward from the strength of her suction, loud smacks filling the air each time a gap forms in the almost airtight seal of her lips.  She squashes her breasts down as much as she can, lowering her lips to kiss your " + ((player.torso.cocks.find(Cock.HasSheath)) ? "sheath" : "base") + ((player.torso.balls.quantity > 0) ? " and reaching down to gently stroke your " + Desc.Balls.describeBalls(true, true, player) : "") + ((player.gender === Gender.HERM) ? ", one of her long, dextrous fingers sliding into your " + Desc.Vagina.describeVagina(player, player.torso.vaginas.get(0)) : "") + "\n\n");
...
function loseToBlackHairLatexWhileMilky(player: Character): NextScreenChoices {
    ...
    if (player.stats.HP < 1) DisplayText("fatigue");
    ...
    DisplayText("The kitsune smirks a bit and quickly goes to work getting you out of your " + player.inventory.equipment.armor.displayName + ", carefully pulling them off and pushing them to the side with one of her tails.  Dragging her fingertips down your [chest] lightly, she leaves little trails of blue fire on your flesh that pop and tingle with each passing second, making you moan with pleasure.  Her index finger circles your [nipple] gently, and her eyes go wide with glee as she sees your creamy milk begin to dribble out, licking her lips hungrily.\n\n");
...
function loseToKitsunesWithBallsAndHighCumQ(player: Character): NextScreenChoices {
    ...
    DisplayText("\"<i>Let's just see...</i>\"  she quietly muses to herself, slipping her hands under your " + player.inventory.equipment.armor.displayName + ", <i>\"what we have here...\"</i>\n\n");
    DisplayText("Her coy grin turns to one of delighted surprise as her fingertips pass over your " + Desc.Balls.describeBalls(true, true, player) + ", giving them a firm but gentle squeeze.  She licks her lips and eagerly pulls your " + player.inventory.equipment.armor.displayName + " off with a hungry glint in her eyes, lifting up your [cock biggest] and flexing it slightly as though examining it.  She leans down, her face close to your balls, and drinks in their scent with a long, drawn-out sigh.\n\n");
    DisplayText("\"<i>Smells like you've got a thick one brewing...</i>\"  she says, softly licking the " + ((player.torso.cocks.find(Cock.HasSheath)) ? "sheath" : "base") + " with a giggle.  Six inky black tails slither forth to bind your limbs, twisting your wrists behind your back.  \"<i>Let's see if we can't help it along...</i>\"\n\n");
    ...
    DisplayText("Giggling at your shuddering moans and desperate bucking, she pushes your hips back down, dropping low and pinning you in place with her elbows.  Her soft, voluptuous breasts slide around your [cock biggest]" + ((player.torso.cocks.sort(Cock.LargestCockArea)[0].length > 8) ? " while she lavishly licks the exposed portion, wrapping her improbably large tongue around it and squeezing in a tight spiral." : ", and she dips her head down to wrap her plump lips around the head, lavishly licking the underside with her improbably large tongue.") + "  Her jiggling rump waggles from side to side cheerfully as she goes down on your cock" + ((player.torso.cocks.sort(Cock.LargestCockArea)[0].area > 70) ? " as far as she can, letting your oversized shaft stuff her throat with a moan." : ", lips pressed tight to your groin, slurping up your precum with a sublime grin lifting the corners of her mouth.") + "\n\n");
    ...
    DisplayText("As if to demonstrate her supreme skill with her tongue, she allows her hands to wander freely along your lower body while she continues to bounce and squeeze your balls with her tongue.  " + ((player.gender === Gender.HERM) ? "The tip snakes down, hugging the curvature of your balls, and then begins to experimentally prod your " + Desc.Vagina.describeVagina(player, player.torso.vaginas.get(0)) + ", gently flicking your clitoris.  " : "") + "Pleasure turns to surprise when you feel her index finger poking around by your " + Desc.Butt.describeButthole(player.torso.butt) + ", and she buries it to the base inside you before you have a chance to formulate a protest.  The sudden intrusion makes your shaft flex, the veins bulging against the surface of the skin as it swells a bit in response.\n\n");
    ...
    if (player.cumQ() <= 2500) {
        ...
        DisplayText("She moans deeply the moment that your first thick streams of seed begin to flow into her throat, cupping your balls softly with both hands.  With her lips sealed tight around your shaft, her tongue swirls to and fro inside her mouth, gathering up your thick seed and funneling it into her gullet.  Overcome by gluttonous desire, she draws your shaft into the back of her throat, massaging your " + Desc.Balls.describeBalls(true, true, player) + " while she drinks them dry.  Even as her stomach begins to swell with the added weight of your seed, she never stops sucking down your thick load.  Your explosive climax continues to flow, and although she puts up a valiant effort to swallow it all, a few thick streams manage to escape from the corners of her mouth and nostrils.  As the lengthy orgasm finally begins to wind down, her tongue coils around your length one last time, and she sucks hard, slurping up the last drop with great embellishment.\n\n");
...
function getRapedByRedHeadFutaKitsune(player: Character): NextScreenChoices {
    ...
    DisplayText("\"<i>Finished already?  I thought a big strong " + Desc.Gender.boyGirl(player.gender) + " like you would put up more of a fight.</i>\"\n\n");
    DisplayText("With a light shrug, she ceases chastising you and gets down to business, carefully pulling off your " + player.inventory.equipment.armor.displayName + " and rolling you over to get a good look at your body.  As her hands cascade over your naked form, you struggle in vain against her incessant pinches and gropes, unable to resist becoming aroused.  Her fingertips slide over your [chest], pressing down lightly as they circle your [nipples].  Ethereal flames crackle along behind her fingers as they drag across your flesh, making your whole body tingle with pleasure and forcing a moan from your throat.\n\n");
    DisplayText("As she begins to examine your nethers, a number of her bushy red tails begin to slither around your limbs, binding your arms behind your back." + ((player.torso.cocks.count > 0) ? "  She idly lifts [oneCock], playfully wobbling it back and forth and giggling at the pleasured grimace you make." : "") + ((player.torso.balls.quantity > 0) ? "  Cupping her hand around your " + Desc.Balls.describeBalls(true, true, player) + ", she hefts them a bit as if sizing them up, using the tip of one of her tails to tickle the underside of your scrotum." : "") + ((player.gender >= 2) ? "  Her fingertips then gently walk along your groin, sliding down to caress and part the lips of your " + Desc.Vagina.describeVagina(player, player.torso.vaginas.get(0)) + ", coming away with a thin thread of your feminine juices." : "") + "\n\n");
    DisplayText("" + ((player.gender === Gender.NONE) ? "\"<i>Heh, well, this is an awkward situation...</i>\" she says, eying your bizarre, featureless groin.  Flipping you over onto your stomach, she smiles, patting your " + Desc.Butt.describeButt(player) + " lightly.  \"<i>But at least it looks like you're still good for </i>some<i> kinds of fun...</i>\"" : "\"<i>Oh, we are gonna have some </i>fun<i>, you and I,</i>\" she says, patting your head softly.") + "\n\n");
    ...
    DisplayText("Though her impressive endowment isn't quite as fearsome as some of the others in this strange land, that eerie blue fire that encircles it gives you reason to worry.  There's little you can do about it though, wrapped up in her tails as you are, unable to resist her advances.  You squirm a bit when you feel her press up against your " + ((player.gender >= 2) ? Desc.Vagina.describeVagina(player, player.torso.vaginas.get(0)) : Desc.Butt.describeButthole(player.torso.butt)) + ", struggling in vain against the tails binding you.  Your fears are assuaged somewhat when you feel the head pushing past your ");
    if (player.torso.vaginas.count > 0) DisplayText("entrance");
    ...
    if (player.torso.vaginas.count > 0) Mod.Vagina.displayStretchVagina(player, 24, true, true, false);
    else Mod.Butt.displayStretchButt(player, 24, true, true, false);
    ...
    if (player.torso.vaginas.count > 0) {
        if (player.vaginalCapacity() < 30) DisplayText("a combination of pain and ");
        ...
        if (player.analCapacity() < 30) DisplayText("a combination of pain and ");
        DisplayText("pleasure.  Your muscles instinctively clench down on the intruder, milking her throbbing shaft in blatant disregard of your own desires, and the kitsune moans in pleasure, rolling her eyes back a little.\n\n");
    }
    // Use same text for anal sex, but using analCapacity instead:
    if (player.gender >= 2) {
        DisplayText(((player.torso.vaginas.get(0).looseness < VaginaLooseness.GAPING) ? "\"<i>Ah!  Nice and tight, just how I like it!</i>\"  she groans, gripping your waist tightly and beginning to strongly pump her hips." : "\"<i>Hmm...  a little loose for my tastes, but I suppose it'll have to do.  You haven't been slutting it up on minotaurs and tentacle beasts, have you cutie?</i>\"  she says teasingly, giving you a patronizing pinch on the cheek."));
    }
    else {
        DisplayText(((player.torso.butt.looseness < 3) ? "\"<i>Ah!  Nice and tight, just how I like it!</i>\"  she groans, gripping your waist tightly and beginning to strongly pump her hips." : "\"<i>Hmm...  a little loose for my tastes, but I suppose it'll have to do.  You haven't been slutting it up on minotaurs and tentacle beasts, have you cutie?</i>\"  she says teasingly, giving you a patronizing pinch on the cheek."));
    }
    ...
    DisplayText("As she uses your " + ((player.gender >= 2) ? Desc.Vagina.describeVagina(player, player.torso.vaginas.get(0)) : Desc.Butt.describeButthole(player.torso.butt)) + " as her own personal fuckhole, her many tails begin to stroke and tease along your naked body, tickling you with their bristly tips and painting trails of fire across your flesh.  You are caught up in shivers each time one of them crosses one of your erogenous zones, the cool flames tickling and tingling across your most sensitive areas.  Thrashing and wriggling underneath her, you belt out a trembling moan, every muscle in your body resonating with pleasure from the odd contrast of the gentle caress of her tails with the rough pistonlike pounding of her cock.\n\n");
    ...
    DisplayText("You feel yourself being lifted off the ground slightly, a single tail gliding up and down your back.  Your muscles clench up involuntarily as it brushes against you, and it is almost as though you can make out every vein and wrinkle on the brash redhead's cock now, feeling the rapid throb of her heartbeat through it.  Her cock swells with a thick load of seed, and you can feel slick hot jets of semen flooding your " + ((player.gender >= 2) ? Desc.Vagina.describeVagina(player, player.torso.vaginas.get(0)) : Desc.Butt.describeButthole(player.torso.butt)) + ".  Your insides milk her swollen member of every ounce of futa-jism she has, her hips pumping continuously and sloppily pounding into you like a horny teenager.  Her voluminous load is so immense that you can feel your abdomen begin to swell as pressurized streams of her seed begin to escape, spilling out onto the ground.\n\n");
    DisplayText("When she finally calms down and pulls out with a satisfied sigh, your " + ((player.gender >= 2) ? Desc.Vagina.describeVagina(player, player.torso.vaginas.get(0)) : Desc.Butt.describeButthole(player.torso.butt)) + " lies agape, a small river of seed slowly pouring out.  Your stomach has swollen to the size of a watermelon, jiggling heavily with the weight of her incredible load of futa-cum.  Her spent cock hangs limply between her thighs, a mixture of cum and feminine juices dripping from the tip.\n\n");
...
export function defeatTheKitsunes(player: Character, kitsune: Character, display: boolean = true): NextScreenChoices {
    ...
    if (player.torso.cocks.filter(Cock.CockThatFits(144)).length >= 0) {
    ...
    if (hairColor === "black") {
        ...
        if (player.torso.cocks.filter(Cock.CockThatFits(108)).length >= 0) {
    ...
    if (hairColor === "red") {
        ...
        if (kitsuneFlags.redheadIsFuta === 0 && player.torso.cocks.count > 0) {
            choices.push(["Lap HJ", nonFutaRedHeadIsWorstRedheadLapsittingHandjobThingIDontKnow]);
        }
        // [Helix] - requires herm
        if (kitsuneFlags.redheadIsFuta > 0 && player.gender === Gender.HERM) {
            choices.push(["Herm Helix", helixZeKitsunes]);
        }

        // [Bring Back Dick] // AKA you don't know dick about dick AKA the dickening
        if (kitsuneFlags.redheadIsFuta === 0) {
            choices.push(["Grow Dick", { func: bringBackDick, args: [kitsune] }]);
        }
        // [Remove Dick]
        else {
            // AKA Lose the dick, schweethaat AKA put that thing away
            choices.push(["Ditch Dick", { func: redheadsDontDeserveToHavePenisesBecauseTheyreTooGayForPenisOrSomethingIDontReallyKnowHowThisWorksOrWhyThisFunctionNameIsSoFuckingLong, args: [kitsune] }]);
        }
        // Redhead-exclusive
        // [Ride] - requires vagina & redheadIsFuta
        if (player.torso.vaginas.count > 0 && kitsuneFlags.redheadIsFuta > 0) {
            choices.push(["RideHerCock", rideDatRedheadKitsuneCockIntoTheSkyDiamonds]);
        }
        if (kitsuneFlags.redheadIsFuta > 0 && player.torso.vaginas.count > 0 && player.torso.chest.sort(BreastRow.BreastRatingLargest)[0].rating >= 4 && player.inventory.equipment.armor.displayName === "lusty maiden's armor") {
            choices.push(["B.Titfuck", { func: lustyMaidenPaizuri, args: [kitsune] }]);
        }
    }
    // [Feeder]
    if (player.perks.has(PerkType.Feeder)) {
...
function putItInAKitsunesAssWin(player: Character): NextScreenChoices {
    DisplayText().clear();
    kitsuneSprite();
    const cockThatFits = player.torso.cocks.filter(Cock.CockThatFits(144))[0];
    ...
    DisplayText("Giving her a firm exploratory slap, you chuckle giddily as the two quivering cheeks shake and jiggle like gelatin for what feels like a full minute before coming to rest.  The kitsune gives a cute cry of arousal, looking back at you and smirking gently, resting her cheek on her arms now.  Far from resistant to your advances, she seems almost delighted when you fish out your " + Desc.Cock.describeCock(player, cockThatFits) + " and lay it across her rounded rump, raising her tails out of the way automatically.\n\n");

    DisplayText("\"<i>Oh, no, such a big, strong cock...  what </i>ever<i> will I do?</i>\"  she says with a wry grin, beginning to slide her plump cheeks up and down your pole, one of her tails coiling down to gently wrap around the " + ((player.torso.cocks.find(Cock.HasSheath)) ? "sheath" : "base") + ".\n\n");
...
function tribbingWithAKitsune(player: Character): NextScreenChoices {
    ...
    DisplayText("She matches your grinding thrusts with her own, her sextet of tails curving toward your body like a group of furred serpents.  They coil around you teasingly, tickling across your body in slow and sensual curls, and then begin to drift southward," + ((player.torso.cocks.count > 0) ? " wrapping around [eachCock] tenderly and" : "") + " slithering their way around to your rear.  The silky fur bristles along your bottom as her tails constrict around you, and one of the bushy coils works its way down to your nethers, teasing the edges of your labia.  The tip of her tail gently flicks across the upper surface of your [clit], sending a shock of pleasure through you, but it doesn't stop there - with the sound of a flint striking against steel, she conjures a blue flame at the end of her tail, and before you can protest, presses it firmly against the base of your womanhood.\n\n");
...
function tailJobKitsuneWin(player: Character): NextScreenChoices {
    DisplayText().clear();
    kitsuneSprite();
    DisplayText("Eying her silky tails, you come up with a wonderful plan to relieve some tension.  Working quickly, you untie the sash around the kitsune's waist and then retie it so that her arms are pinned to her sides.  Turning her onto her back, you prop her up against a tree and then begin to strip out of your " + player.inventory.equipment.armor.displayName + ", reaching down to gather up her six tails in your arms.  She looks up at you curiously, watching as you wrap one of the fluffy coils around [eachCock], slowly dragging your fingertips through the lustrous fur.  As your fingers slide across their fluffy surface, she gives an involuntary shudder, her cheeks flushing a slight pink.  The tail seems to constrict around you automatically, and without any further encouragement needed the tight ring of fur begins to slide up and down, squeezing and massaging your shaft" + ((player.torso.cocks.count > 1) ? "s" : "") + " sensually.\n\n");

    DisplayText("The level of control she has over her tails is absolutely marvelous!  They stroke and tickle along your groin, running their soft, brushlike tips across every inch of exposed flesh that they can find." + ((player.torso.balls.quantity > 0) ? "  One warm coil begins to wrap itself around your " + Desc.Balls.describeBalls(true, true, player) + ", leaving the underside exposed so that the tip can curl down, sliding gently back and forth over the seam to send shivers up your spine." : "") + ((player.torso.cocks.count > 1) ? "  Her remaining tails begin to weave in between your cocks, curling and wrapping around the shafts.  As they slide up and down, they begin to gently constrict, acting like furry cock rings." : "  Her remaining tails wrap themselves around your member, sliding up and down along the shaft.  One of them coils around your " + ((player.torso.cocks.find(Cock.HasSheath)) ? "sheath" : "base") + " and begins to constrict it gently, acting like a furry cock ring.") + "  You feel like you could cum almost instantly from their incredibly delicate touch, but every time you feel your climax coming on, the kitsune holds back.\n\n");
    ...
    DisplayText("It is at the height of one such cycle of pleasure and denial that you feel something cool and tingly washing over you, looking down to see the kitsune's lips pursed at " + ((player.torso.balls.quantity > 0) ? "the underside of your " + Desc.Balls.describeBalls(true, true, player) : "the " + ((player.torso.cocks.find(Cock.HasSheath)) ? "sheath" : "base") + " of your " + Desc.Cock.describeCock(player, player.torso.cocks.get(0))) + ", gently blowing pale flames across your groin.\n\n");

    DisplayText("The intense tingling is all that you needed, hurtling off the edge and into the full force of your climax.  [EachCock] pulses, the tight rings of fur preventing you from achieving your full release even as your muscles spasm in vain." + ((player.torso.balls.quantity > 0) ? "  Thick spunk begins to well up in your " + Desc.Balls.describeBalls(true, true, player) + ", making them swell terribly with backed-up seed." : "") + "  Thankfully she seems to tire of teasing you shortly, and withdraws the offending tails.  ");
    if (player.cumQ() <= 150) {
    ...
    DisplayText("\"<i>Come look me up anytime, dear!</i>\"  she calls back when she is safely out of sight.  You briefly consider giving chase, but decide it is not worth the effort, gathering your " + player.inventory.equipment.armor.displayName + " and turning back toward camp.");
...
function kitsunesGetBonedBy3PlusTentacles(player: Character): NextScreenChoices {
    ...
    DisplayText("\n\nShe lazes in the grass in a relaxed stupor, a huge grin plastered across her face.  Her hands slide down across her skin " + (((player.torso.cocks.count > 3) || (hairColor === "red" && kitsuneFlags.redheadIsFuta > 0)) ? "and draw trails in the semen smearing her front" : "") + ((player.cumQ() > 350) ? ", caressing her cum-filled belly" : "") + " while she moans in satisfaction, uttering a heaving sigh of approval.\n\n");
...
function fuckDraftBlond(player: Character): NextScreenChoices {
    DisplayText().clear();
    kitsuneSprite();
    const dogCocks = player.torso.cocks.filter(Cock.FilterType(CockType.DOG));
    const hasDogCock = dogCocks.length > 0;
    const selectedCock = hasDogCock ? dogCocks[0] : player.torso.cocks.sort(Cock.LargestCockArea)[0];
    ...
    DisplayText("The powerful scent of feminine musk fills the air almost instantly, a viscous puddle spreading between her legs and soaking through the crotch of her robes." + ((hasDogCock) || (player.statusAffects.has(StatusAffectType.Rut)) ? "  As the potent smell fills your nostrils, your " + Desc.Cock.describeCock(player, selectedCock) + " swells in anticipation, reacting instinctively to the scent of a female in heat.  Lurid fantasies of plugging her sloppy snatch with your " + ((hasDogCock) ? "knot" : Desc.Cock.describeCock(player, selectedCock)) + " and stuffing her belly full of kits rush into your mind unbidden" + ((player.stats.cor < 20) ? ", disturbing you slightly" : "") + "." : "") + "  Her body trembles and quakes with carnal need, pure animalistic desire burning in her eyes.  As the effects of her chemical-induced heat come into full swing, she struggles to maintain some semblance of rational thought, desperately willing herself to crawl away.\n\n");
    ...
    DisplayText("You " + ((player.stats.cor < 33) ? "stifle a laugh, observing her somewhat humorous plight." : "laugh uproariously, relishing the proud kitsune's utter humiliation.") + "  Her face twists into a beautiful grimace of climactic pleasure, her tongue lolling out shamelessly as she rolls her eyes back and orgasms, abruptly and violently.  Clear feminine cum pours from her convulsing pussy, splattering on the ground in a thick puddle.\n\n");
    ...
    if (hasDogCock || player.statusAffects.has(StatusAffectType.Rut)) DisplayText("The sweet musk of her voluminous fem-jizz fills your mind with a lustful haze, higher-order thought processes gradually shutting down as animalistic mating instinct begins to take over.  ");
    DisplayText("You slide your " + Desc.Cock.describeCock(player, selectedCock) + " up between the supple mounds of her ass, groaning in pleasure as she begins to glide her hips back and forth along the shaft, cooing softly.  The warm, moist breath radiating off her sodden vagina caresses your ");
    if (player.torso.balls.quantity > 0) DisplayText(Desc.Balls.describeBalls(true, true, player));
    else DisplayText(Desc.Leg.describeLegs(player));
    ...
    DisplayText("  She raises her hips higher, whimpering a little as she desperately tries to line up your " + Desc.Cock.describeCock(player, selectedCock) + " with her hungry fuckhole.\n\n");
    ...
    if (hasDogCock || player.statusAffects.has(StatusAffectType.Rut)) {
    ...
    if (hasDogCock || player.statusAffects.has(StatusAffectType.Rut)) DisplayText("  Vivid fantasies of stuffing her pussy full of your virile semen race through your mind, unable to think of anything else.  Come whatever may, you know you MUST impregnate her - there's simply no other option.");
    ...
    if (player.torso.balls.quantity > 0)
        DisplayText(Desc.Balls.describeBalls(true, true, player));
    else
...
function doseAKitsuneWithOviElixirs(player: Character): NextScreenChoices {
    DisplayText().clear();
    kitsuneSprite();
    const cocksThatFit = player.torso.cocks.filter(Cock.CockThatFits(100));
    const cockThatFits = cocksThatFit.length > 0 ? cocksThatFit[0] : player.torso.cocks.sort(Cock.LargestCockArea)[0];
    ...
    DisplayText("Her words snap you from your reverie, and you rush over, hurriedly stripping out of your " + player.inventory.equipment.armor.displayName + ".  You drop to the ground near her and begin to run your hands across her body, squeezing her massively engorged breasts, eliciting a light moan.  She coos softly as you slide your palms over the gravid swell of her stomach, caressing the taut flesh gently.  Your touch travels downward, cascading over her thighs momentarily before spreading them apart to get at the puffy lady-lips in between them.\n\n");
    ...
    DisplayText("As you prepare to plunge yourself into her quivering lips, a pair of golden tails slither up around your throbbing member, one curling around your " + ((player.torso.cocks.find(Cock.HasSheath)) ? "sheath" : "base") + " while the other slowly tickles across the underside of the shaft." + ((player.gender >= 2) ? "  It travels slowly up and down your prick, then drifts down toward your " + Desc.Vagina.describeVagina(player, player.torso.vaginas.get(0)) + ", teasing your [clit] gently." : "") + "  Her swollen cunt parts around you easily as you delve into her depths, rippling around your member sensually.  The muscular walls stretch around you, a steady trickle of feminine juices spilling out around your " + Desc.Cock.describeCock(player, cockThatFits) + ".\n\n");

    DisplayText(((player.torso.cocks.sort(Cock.LargestCockArea)[0].area > 50) ? "No matter how much pulsating cock meat you stuff into her hungry pussy, her quaking walls continue to stretch on forever, swallowing your shaft greedily.  " : "") + "Your pelvis gently bounces against hers, sending a ripple through her gravid stomach, and you slowly start to buck your hips.  Leaning down over her, you begin to grope and knead her swollen tits, running your hands over the soft, pliable flesh and squeezing firmly to force out a little milk.\n\n");
    ...
    return player.inventory.items.createAdd(player, ItemType.Consumable, egg, Scenes.camp.returnToCampUseOneHour);
}
...
function lactaidDoseAKitSune(player: Character): NextScreenChoices {
    ...
    DisplayText("Pleased with the results of your little experiment, you release her gargantuan jugs, letting them bounce and quiver back into position before standing up.  Shedding your " + player.inventory.equipment.armor.displayName + ", you run your hands down over your groin, lowering yourself down over her once again and scooting up to press against the underside of her breasts.  Laying [eachCock] in between the heaving mounds of titflesh, you gather up her breasts and squash them together again, moaning as the soft skin envelops your throbbing member" + ((player.torso.cocks.count > 1) ? "s" : "") + ".  Warm milk trickles down into her cavernous cleavage, flowing over your shaft" + ((player.torso.cocks.count > 1) ? "s" : "") + " and leaving behind an odd tingling sensation that makes you shudder.\n\n");
    ...
    DisplayText("You slowly begin to thrust [eachCock] through the slippery passage, revelling in the way her tremendous tits squeeze around your throbbing shaft" + ((player.torso.cocks.count > 1) ? "s" : "") + ".  The warmth of her flesh contrasts wonderfully with the cool tingling of her milk coating your cock" + ((player.torso.cocks.count > 1) ? "s" : "") + ", heightening your pleasure to incredible levels and making you groan and shiver.  Her chest rises and falls beneath you with every heaving breath she takes, shuddering with her needy moans.\n\n");
    ...
    if (player.cumQ() <= 150) {
        ...
        if (player.cumQ() >= 2500) DisplayText("  It seems as though your climax goes on forever, fresh streamers of cum flying everywhere until the milky white puddle surrounding her is equal parts milk and seed.");
    }
...
function hotdogAnalInKitsuneButtDontLetTailTickleYourNose(player: Character): NextScreenChoices {
    ...
    DisplayText("She cries out in surprise as you manhandle her into position, but sinks low in submission once you settle into a rhythm, her tails swishing to and fro as they wrap around your body.  The shiny black coils work their way under your " + player.inventory.equipment.armor.displayName + ", pulling them away with a practiced skill.  Fluffy, bushy tails caress [eachCock] gently, drawing " + ((player.torso.cocks.count > 1) ? "them" : "it") + " up between the mountainous cheeks of her derriere, stroking " + ((player.torso.cocks.count > 1) ? "them" : "it") + " fondly with the tips.  Your hands slide along the wide curves of her hips, sinking into her soft love handles as her quivering hind cheeks gently caress the sides of your " + ((player.torso.cocks.count > 1) ? "shafts" : "shaft") + ".\n\n");
    ...
    DisplayText("Another hearty 'crack' echoes through the forest as your palm connects with her ass again, sinking into the pliable flesh and sending ripples through it.  Her tongue lolls out obscenely, the fur on her tails frizzing as she bucks forward, panting heavily.  You feel something warm and wet trickling down the front of your " + Desc.Leg.describeLegs(player) + ", and grin when you realize that she's really getting off on this!\n\n");

    DisplayText("You grip her mountainous cheeks firmly in either hand and squeeze them together around [eachCock], thrusting your hips forward slowly and powerfully.  Her expansive rump is nearly large enough to encompass your " + ((player.torso.cocks.count > 1) ? "shafts" : "shaft") + " all the way around, warm flesh squashing and jiggling against " + ((player.torso.cocks.count > 1) ? "them" : "it") + " on all sides.  Her hips slide back to meet yours with each thrust, eagerly caressing your " + ((player.torso.cocks.count > 1) ? "cocks" : "cock") + " with her quivering bottom, moaning contentedly.\n\n");

    DisplayText("One of her tails slides up against your stomach and curls its way downward, encircling your " + Desc.Cock.describeCock(player, cockThatFits) + " with its fluffy warmth.  It gently constricts the base, squeezing you with just enough pressure to make the veins of your shaft swell against the surface, throbbing gently.  The tip of her tail snaps against the underside once or twice, and with the sound of striking a match, your shaft is suddenly engulfed in azure flames that dance around it, leaving a cooling tingle in their wake.  Every sensation is enhanced by the presence of the flames, icy coolness mixing with an ethereal heat that surrounds [eachCock] on all sides.\n\n");

    DisplayText("You squeeze her hips and thrust forward against her rump a few more times, feeling the tension of your climax approaching.  Enough foreplay, then - it's time for the main event.  Sliding your " + Desc.Cock.describeCock(player, cockThatFits) + " between her shuddering cheeks one last time, you draw back and angle her hips up a bit, lining up against her tight pink asshole.  As you thrust forward, the muscular ring guarding her rectum gives way with a surprising ease, almost drawing you inward of its own volition as it squeezes your throbbing rod.  She licks her lips and pushes her hips back to fully engulf your cock with her warm, tight ass, reaching back to grasp her own ass cheek as she bears down with her anus, trapping you inside.\n\n");
    ...
    DisplayText(((player.stats.cor > 45) ? "Without waiting to confirm if she is unharmed," : "After briefly confirming that she is for the most part unharmed,") + " you readjust your balance and resume your rhythm, holding onto her shoulders for support.  As you pull back for another thrust, she closes her thighs together gently, causing her prominent cheeks to become even more pronounced.  They serve well to cushion the blows as you pump downward powerfully, jiggling like gelatin with each pounding buck of your hips.\n\n");

    DisplayText("You grip her love handles tightly, sinking your fingertips into the soft, plushy flesh, and eagerly pummel her tight ass, slapping your hips into her bountiful butt cheeks over and over.  Her thighs tense and relax in time with your thrusts, working along with the inner muscles to give your " + Desc.Cock.describeCock(player, cockThatFits) + " a sensual massage rivalling that of a master masseuse.  Everything above her waist, however, is utterly relaxed, splayed out into a lewd heap of decadent desire.  The merest hint of a sliver of emerald is visible as her eyes roll into the back of her head, her tongue flopping out of her mouth along with a healthy trail of drool.\n\n");

    DisplayText("One last slap echoes through the clearing when you slam yourself into her ass for the final time, moaning in ecstasy as your " + Desc.Cock.describeCock(player, cockThatFits) + " twitches wildly in climax.  ");
    ...
    if (player.cumQ() <= 150) {
        ...
        DisplayText("The convulsing muscles of her rectum milk your shaft strongly, heavy rippling sensations squeezing you repeatedly from base to tip as you pour out truly monstrous amounts of seed into her innards, stuffing her with your cloying cum.  A husky groan escapes from her throat as she begins to rise off the ground, the obscene amounts of semen filling her stomach like a balloon as your seed surges through her intestines.  Her hindquarters are raised into the air as she tilts forward on her cum-bloated belly, now filled out to the size of an exercise ball.  At the height of your pleasure, you resume your lustful thrusting, her flesh quivering continuously as you fill her to excess, pressurized jets of semen spurting out around your " + Desc.Cock.describeCock(player, cockThatFits) + ".  As the last of your load stuffs her abused asshole, you dig your fingertips into her pliable, cum-streaked flesh and squeeze her ass cheeks together around your shaft.  Her anus clamps down hard around your throbbing rod as you slowly pull back, hungrily milking the last of your load from your urethra.\n\n");
...
function feederTheKitsunes(player: Character): NextScreenChoices {
    ...
    DisplayText("She becomes wetter with each passing moment, a new rush of fluid soaking your " + Desc.Leg.describeLeg(player) + " with each gulp she takes.  Rewarding the girl for her admirable efforts in draining your milk-laden tits, you slide a finger in between her legs and grant her the pleasure she sought for herself earlier, rolling her cherry red clitoris back and forth under your fingertip slowly.  You slip your middle and ring fingers into her entrance, forcing a gasp from her throat that causes her to choke a bit, milk sputtering out and soaking her front.\n\n");
    ...
    DisplayText("You carefully lay her on the ground, standing and donning your " + player.inventory.equipment.armor.displayName + " once again.  The kitsune remains rooted in the spot, weighed down by her oversized tummy.  Something tells you she won't be moving from that spot for some time.");
    // Advance time 1hr and return to camp. +Sensitivity
...
function getABJFromAFoxGirl(player: Character): NextScreenChoices {
    DisplayText().clear();
    kitsuneSprite();
    const cockThatFits = player.torso.cocks.filter(Cock.CockThatFits(108))[0];
    ...
    DisplayText("Stripping out of your " + player.inventory.equipment.armor.displayName + ", you pull her into a kneeling position and press her back against a tree, presenting your " + Desc.Cock.describeCock(player, cockThatFits) + " with a grin.  She ogles it hungrily and licks her lips, eyes wide with desire.  As she reaches up to take it into her hands, you grab her wrists instead and pin them to the trunk of the tree.  You explain that she is to use only her mouth, and that if she does her job properly, <i>then</i> you will satiate her hunger.\n\n");
    ...
    DisplayText("Grinning up at you, she dips underneath your shaft, lifting it up with her nose, flattening out her tongue around the underside of your " + ((player.torso.cocks.find(Cock.HasSheath)) ? "sheath" : "base") + " and running it slowly upward.  Having her wrists restrained doesn't seem to be hampering her ability to pleasure you much at all - it even seems to be turning her on.  She pushes your " + Desc.Cock.describeCock(player, cockThatFits) + " up against your stomach using her nose, kissing along the underside longingly and making wet smacking sounds.\n\n");
    ...
    if (cockThatFits.length > 9) {
        ...
        DisplayText(".  She hungrily swallows along your length, moaning into your engorged prick as she finally presses her lips to your " + ((player.torso.cocks.find(Cock.HasSheath)) ? "sheath" : "base") + " and rolls her eyes back in pleasure, her neck bulging slightly from the presence of your shaft.\n\n");
    }
    else DisplayText("her lips squeezing sensually around the " + ((player.torso.cocks.find(Cock.HasSheath)) ? "sheath" : "base") + " each time she goes down you.  Moaning intensely, she closes her eyes and rolls your " + Desc.Cock.describeCock(player, cockThatFits) + " back and forth in her mouth, swirling her tongue sensually along it.\n\n");
...
function getLickedByKitsunes(player: Character): NextScreenChoices {
    ...
    DisplayText("One hand caressing the back of her head, you lean into the kiss and slide your body passionately against hers, your " + Desc.Breast.describeNipple(player, player.torso.chest.get(0)) + " growing hard with arousal.  As your tongue dances around hers, you rub yourself against her thigh, spreading musky juices across it.  Your hands slide up and down her face and chest, fingertips cascading over every curve, and finally you break your kiss, a line of saliva connecting your bottom lip to hers.\n\n");

    DisplayText("As you stare at the shiny pink pillows, you gently brush your thumb along them, marvelling at how absolutely soft and plump they are.  It isn't long before you begin to wonder how they might feel kissing elsewhere on your body, and you decide to indulge your curiosity, pulling your " + player.inventory.equipment.armor.displayName + " away to reveal your " + Desc.Vagina.describeVagina(player, player.torso.vaginas.get(0)) + ".  She licks her lips almost imperceptibly at the sight of your slick slit, her hungry gaze coming to rest between your legs.\n\n");

    DisplayText("She barely requires any coercion to lower her head " + ((player.torso.hips.legs.isBiped()) ? "between your legs" : "into your crotch") + " as you lie back on the grass.  You rest your hands on the back of her head, merely as a formality, as she dives into your slippery snatch with unabashed zeal.  You are unable to hold back your moans as her plump lips gently wrap around your [clit], the very tip of her tongue flicking across it lightly.  She hooks her thumbs into your lower lips and gently spreads them apart, swirling her tongue across the inner surface of your labia as she works her way downward.  Her plump lips part into a pink O as her tongue slides out for what seems like an eternity, twisting and writhing like an obscene tendril.  The tip circles the fleshy ring guarding your entrance teasingly, as though trying to coax it to open up for her.\n\n");
...
function rideDatRedheadKitsuneCockIntoTheSkyDiamonds(player: Character): NextScreenChoices {
    ...
    DisplayText("You casually discard your " + player.inventory.equipment.armor.displayName + ", tossing them aside in a pile.  By this point, she is putty in your hands, her whole body shaking from head to toe with each teasing stroke of your palms.\n\n");
...
function helixZeKitsunes(player: Character): NextScreenChoices {
    ...
    DisplayText("Reaching down," + ((player.torso.balls.quantity > 0) ? " you lift your " + Desc.Balls.describeBalls(true, true, player) + " out of the way and reach around her underside," : "you reach around her underside,") + " taking hold of her thick prick and bending it gently toward your " + Desc.Vagina.describeVagina(player, player.torso.vaginas.get(0)) + ".  She catches your intention easily enough and slides a tail down to assist, curling the bushy coil around her thick member and guiding it toward your waiting snatch.  It takes a bit of finagling, but a moment or two later, she is moaning in pleasure as the head begins to penetrate you.");
    Mod.Vagina.displayStretchVagina(player, 12, true, true, false);
    DisplayText("\n\n");
    ...
    DisplayText("You turn to gather your " + player.inventory.equipment.armor.displayName + ", cleaning up and dressing once more, then whip around to the sound of rustling leaves.  A set of sticky footprints leads your gaze to the edge of a bush, a flash of red tails and a pair of plump hind cheeks disappearing into the forest.");
    // Advance time 1hr and return to camp. +Sensitivity, +Libido
    player.orgasm();
    player.stats.lib += 1;
    player.stats.sens += 1;
...
export function kitsuneShrine(player: Character): NextScreenChoices {
    ...
    if (player.inventory.items.has(MaterialName.GoldenStatue) || kitsuneFlags.TOOK_KITSUNE_STATUE === 0) {
...
function takeAKitsuneStatue(player: Character): NextScreenChoices {
    ...
    return player.inventory.items.createAdd(player, ItemType.Material, MaterialName.GoldenStatue, Scenes.camp.returnToCampUseOneHour);
}
