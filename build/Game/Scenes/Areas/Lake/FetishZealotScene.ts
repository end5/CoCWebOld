...
export class FetishZealotScene {
    ...
    // Raping the player
    public zealotLossRape(player: Character) {
        DisplayText().clear();
    ...
    public zealotDefeated(player: Character, cultist: Character) {
        // Defeated by health
    ...
    // Raped by the player
    private zealotWinRape(player: Character, cultist: Character) {
        DisplayText().clear();
