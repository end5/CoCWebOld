...
export class GreenSlimeScene {
    private serviceLowCorruption(player: Character) {
        DisplayText().clear();
    ...
    private serviceLowCorruptionHighLust(player: Character) {
        player.slimeFeed();
        DisplayText().clear();
    ...
    private maleRapesOoze(player: Character) {
        DisplayText().clear();
    ...
    private femaleRapesOoze(player: Character) {
        player.slimeFeed();
    ...
    private oozeButtRapesYou(player: Character) {
        player.slimeFeed();
    ...
    private oozeRapesYouOrally(player: Character) {
        player.slimeFeed();
    ...
    private oozeRapesYouVaginally(player: Character) {
        player.slimeFeed();
    ...
    public rapeOozeWithMilk(player: Character) {
        DisplayText().clear();
    ...
    public slimeVictoryRape(player: Character) {
        ...
        // higher corruption raaaaeeeep
            ...
            DisplayText().clear();
            // male or futa
            if (player.gender === Gender.MALE || (player.gender === Gender.HERM && randInt(2) === 0)) maleRapesOoze();
            // female or futa
    ...
    public slimeLoss(player: Character) {
        DisplayText().clear();
