...
export class FetishCultistScene {
	...
	public cultistRapesYou() {
		...
		if (randInt(2) === 0 && !sexed) {
			...
			if (player.torso.vaginas.count > 0 && player.torso.cocks.count > 0) {
				...
				if (player.torso.cocks.count === 2) DisplayText("Your " + Desc.Cock.describeCock(player, 1) + " rubs against her skin pleasantly.  ");
	...
	private plugSwimsuitVag() {
		...
		DisplayText("When you push your " + Desc.Cock.describeCock(player, x) + " inside her, she goes absolutely insane underneath you.  She squirms and wriggles all over your " + Desc.Cock.describeCock(player, x) + ", as you ");
		if (x.area < 50) DisplayText("push further and further until you're all the way inside her.");
		else if (x.area < 200) DisplayText("push further and further, until to your great delight, she manages to take all of your massive member without any trouble!");
		...
		DisplayText("After all the foreplay, the two of you are already reaching your peaks thanks to her incredible, tight cunt and its ministrations to your member.  The cultist is screaming in pleasure, telling you to look at her, to fondle her, and to fuck her; you happily oblige her.  Her interior contracts about your " + Desc.Cock.describeCock(player, x) + " as you loose the proof of your orgasm deep inside her.");
		if (player.torso.cocks.count > 1) {
	...
	internal function cultistBadEnd2() {
	...
	public fetishCultistHasAMilkFetish() {
		DisplayText().clear();
		...
		DisplayText("Soon her thong becomes wet with arousal and her mouth comes off your " + Desc.Breast.describeNipple(character, character.torso.chest.get(0)) + " to ask, \"<i>Please " + Desc.Gender.mf(player, "Master", "Mistress") + ", will you fix the aching in my loins?</i>\"\n\n");
