...
const SWIMSUIT: string = "swimsuit";
const NOBLES_CLOTHING: string = "noble's clothing";
const PERVY_NUNS_CLOTHING: string = "pervy nun's clothing";
...
const FETISHY_OUTFIT: string = "fetishy outfit";
...
export class FetishCultist extends Character {
    public constructor() {
        ...
        this.inventory.equipment.defaultArmorSlot.equip(new Armor(FETISHY_OUTFIT as ArmorName, undefined, FETISHY_OUTFIT, 0));
        this.inventory.equipment.defaultWeaponSlot.equip(new Weapon("whip" as WeaponName, undefined, "whip", "whip-crack", 0));
