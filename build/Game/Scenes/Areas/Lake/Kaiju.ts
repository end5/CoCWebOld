...
export class Kaiju {
    ...
    public kaijuMeeting() {
        ...
        if (Flags.list[FlagEnum.KAIJU_MEETINGS] === 0) {
            ...
            MainScreen.addButton(0, "Yes", this.meetDatKaijuYo);
            MainScreen.addButton(1, "No", this.noMeetingKaijus);
        }
        else {
            if (player.statusAffects.has(StatusAffectType.FactoryOverload) && !this.kaijuCock()) this.kaijuGrowsWangus();
            else if (Flags.list[FlagEnum.KAIJU_BAD_END_COUNTER] >= 5) this.kaijuBadEndToyBOOSH();
    ...
    // [If yes]
    private meetDatKaijuYo(player: Character) {
        DisplayText().clear();
        DisplaySprite(103);
        ...
        MainScreen.addButton(0, "Compliment", this.complimentKaiju);
        if (player.gender > 0) MainScreen.addButton(1, "Flirt", this.flirtWithKaiju);
        MainScreen.addButton(2, "Insult", this.insultTheKaijuFirstMeeting);
    }
    ...
    private insultTheKaijuFirstMeeting() {
        ...
        if (this.kaijuCock()) {
            ...
            if (player.statusAffects.has(StatusAffectType.KnowsWhitefire) && (!player.perks.has(PerkType.BloodMage) && player.fatigue + kGAMECLASS.spellCost(30) > 100)) {
                ...
                MainScreen.addButton(0, "Yes", this.yesBurnDatClit);
                MainScreen.addButton(1, "No", this.corruptKaijuInsertion);
            }
            else {

                MainScreen.addButton(0, "Next", this.corruptKaijuInsertion);
            }
        }
        else {
    ...
    // [If yes]
    private yesBurnDatClit(player: Character) {
        DisplayText().clear();
        DisplaySprite(103);
        fatigue(30, 1);
    ...
    private corruptKaijuInsertion(player: Character) {
        DisplayText().clear();
        DisplaySprite(103);
    ...
    private complimentKaiju() {
        ...
        MainScreen.addButton(0, "Let Her", this.letKaijuHaveWayWithYou);
        MainScreen.addButton(1, "Stop It", this.stopItPlease);
    }
    ...
    // [If let her]
    private letKaijuHaveWayWithYou(player: Character) {
        DisplayText().clear();
        DisplaySprite(103);
    ...
    // [If flirt]
    private flirtWithKaiju(player: Character) {
        DisplayText().clear();
        DisplaySprite(103);
    ...
    private repeatKaijuEncounter(player: Character) {
        DisplayText().clear();
        DisplaySprite(103);
        ...
        if (player.itemCount(consumables.INCUBID) + player.itemCount(consumables.P_DRAFT) >= 10 && !this.kaijuCock()) {
            ...
            MainScreen.addButton(5, "Give Cock", this.yesTurnKaijuFuta);
        }
        // [Peek][Hug Boobs][Fuck][Urethra Fuck (only if Venus is a herm)][Talk][Leave]
        MainScreen.addButton(0, "Peek", this.peekAtSomePhatAssKaijuButt);
        MainScreen.addButton(1, "Hug Boobs", this.kaijuRepeatBoobHug);
        MainScreen.addButton(2, "Fuck", this.fuckThisGiantYouDumbCunt);
        if (this.kaijuCock()) MainScreen.addButton(3, "UrethraFuck", this.urethraFuckDatGiantCock);
        MainScreen.addButton(4, "Talk", this.talkToKaiju);
        MainScreen.addButton(9, "Leave", this.leaveRepeatKaiju);
    }
    // [If Hug Boobs]
    private kaijuRepeatBoobHug(player: Character) {
        DisplayText().clear();
        DisplaySprite(103);
    ...
    // [If Fuck]
    private fuckThisGiantYouDumbCunt(player: Character) {
        DisplayText().clear();
        DisplaySprite(103);
    ...
    // [If Urethra Fuck]
    private urethraFuckDatGiantCock(player: Character) {
        DisplayText().clear();
        DisplaySprite(103);
    ...
    // [If Talk]
    private talkToKaiju(player: Character) {
        DisplayText().clear();
        DisplaySprite(103);
    ...
    // [If Peek]
    private peekAtSomePhatAssKaijuButt(player: Character) {
        DisplayText().clear();
        DisplaySprite(103);
        Flags.list[FlagEnum.KAIJU_BAD_END_COUNTER]++;
        ...
        if (!this.kaijuCock()) DisplayText(" while her thumb begins to rub her clit");
        ...
        if (this.kaijuCock()) {
            ...
            MainScreen.addButton(0, "Yes", this.yesKaijuGimmePeepShowsMoar);
            MainScreen.addButton(1, "No", this.noKaijuPeepShows);
        }
        else {

            MainScreen.addButton(0, "Next", this.noKaijuPeepShows);
        }
    }
    ...
    private noKaijuPeepShows(player: Character) {
        DisplayText().clear();
        DisplaySprite(103);
    ...
    private kaijuGrowsWangus() {
        ...
        MainScreen.addButton(1, "No", this.dontGetFutaTurtlesOffToday);
        MainScreen.addButton(0, "Yes", this.helpNewFutaKaijuGetOff);
        MainScreen.addButton(2, "Mock", this.mockDatTurtleGirl);
    }
    ...
    // [If Mock]
    private mockDatTurtleGirl(player: Character) {
        DisplayText().clear();
        DisplaySprite(103);
    ...
    // [If yes]
    private helpNewFutaKaijuGetOff(player: Character) {
        DisplayText().clear();
        DisplaySprite(103);
        Flags.list[FlagEnum.KAIJU_BAD_END_COUNTER]++;
    ...
    private incubiDraftsDatKaiju() {
        ...
        MainScreen.addButton(0, "Yes", this.yesTurnKaijuFuta);
        MainScreen.addButton(1, "No", this.repeatKaijuEncounter);
    }

    // [If Yes]
    private yesTurnKaijuFuta(player: Character) {
        DisplayText().clear();
        DisplaySprite(103);
    ...
    private kaijuBadEndToyBOOSH(player: Character) {
        DisplayText().clear();
        DisplaySprite(103);
        ...
        // [if Venus is female]
        if (!this.kaijuCock()) DisplayText("clitoris");
        ...
        if (player.canFly()) {
            ...
            MainScreen.addButton(0, "Yes", this.flyAwayFromBadEnd);
            MainScreen.addButton(1, "No", this.badEndPartTwo);
        }
        else {

            MainScreen.addButton(0, "Next", this.badEndPartTwo);
        }
    }
    ...
    // [End wings]
    private badEndPartTwo(player: Character) {
        DisplayText().clear();
        DisplaySprite(103);
